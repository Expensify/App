...
module.exports = {
    ...
    transform: {
        ...
        // and lowers import(). oxc-parser splices top-level jest.mock calls above require()
        // so Jest still intercepts them. Native OXC + esbuild stays fast under Reassure's
