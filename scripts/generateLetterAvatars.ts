 ...
 * background and renders it from the vector at full resolution, so the output stays crisp at
...
/** Compose a full avatar SVG at an explicit pixel size so sharp renders it at that size. */
