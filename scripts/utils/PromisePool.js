...
var PromisePool = /** @class */ (function () {
    function PromisePool(concurrency) {
        if (concurrency === void 0) { concurrency = 8; }
        /**
    ...
    PromisePool.prototype.add = function (task) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.executing.size >= this.concurrency)) return [3 /*break*/, 2];
                        return [4 /*yield*/, Promise.race(this.executing)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
