...
abstract class Translator {
     ...
     */
    public async translate(targetLang: Locale, text: string, context?: string): Promise<string> {
     ...
     * Translate a string to the given locale.
     */
    protected abstract performTranslation(targetLang: Locale, text: string, context?: string): Promise<string>;
