...
- **Oxfmt**: Code formatting - run `npm run oxfmt` after making changes
...
1. **Oxfmt**: Run `npx oxfmt --write <changed files>` on every file you modified. This is mandatory - CI will reject unformatted code.
