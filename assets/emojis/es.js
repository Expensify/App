...
var esEmojis = {
    ...
    ℹ: ℹ
}, _a = void 0,  = _a.name,  = _a["fuente_de_informaci\u00F3n"], _b = _a.keywords,  = _a["i"],  = _a["informaci\u00F3n"];
'🆔';
{
    name: 'carné_de_identidad',
        keywords;
    ['ID', 'identidad', 'símbolo identidad', 'símbolo de identificación'],
    ;
}
'Ⓜ️';
{
...
'🅾️';
{
    name: 'o2',
        keywords;
    ['grupo sanguíneo', 'o', 'grupo sanguíneo tipo O'],
    ;
}
'🆗';
{
...
'🆘';
{
    name: 'llamada_de_socorro',
        keywords;
    ['ayuda', 'símbolo', 'socorro', 'sos', 'símbolo de socorro'],
    ;
}
'🆙';
{
    name: 'arriba',
        keywords;
    ['arriba', 'información', 'novedad', 'símbolo', 'up', 'botón UP!'],
    ;
}
'🆚';
{
    name: 'vs',
        keywords;
    ['contra', 'frente a', 'símbolo', 'versus', 'vs', 'botón VS'],
    ;
}
'🈁';
{
    name: 'koko',
        keywords;
    ['“aquí”', 'japonés', 'katakana', 'ideograma japonés para "aquí"'],
    ;
}
'🈂️';
{
    name: 'sa',
        keywords;
    ['cortesía', 'japonés', 'katakana', 'ideograma japonés para "de cortesía"'],
    ;
}
'🈷️';
{
    name: 'u6708',
        keywords;
    ['“cantidad mensual”', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "cantidad mensual"'],
    ;
}
'🈶';
{
    name: 'u6709',
        keywords;
    ['“de pago”', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "de pago"'],
    ;
}
'🈯';
{
    name: 'u6307',
        keywords;
    ['ideograma', 'japonés', 'kanji', 'reservado', 'ideograma japonés para "reservado"'],
    ;
}
'🉐';
{
    name: 'símbolo_de_ganga',
        keywords;
    ['ganga', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "ganga"'],
    ;
}
'🈹';
{
    name: 'u5272',
        keywords;
    ['descuento', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "descuento"'],
    ;
}
'🈚';
{
    name: 'u7121',
        keywords;
    ['gratis', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "gratis"'],
    ;
}
'🈲';
{
    name: 'u7981',
        keywords;
    ['ideograma', 'japonés', 'kanji', 'prohibido', 'ideograma japonés para "prohibido"'],
    ;
}
'🉑';
{
    name: 'aceptar',
        keywords;
    ['aceptable', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "aceptable"'],
    ;
}
'🈸';
{
    name: 'u7533',
        keywords;
    ['aplicación', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "aplicación"'],
    ;
}
'🈴';
{
    name: 'u5408',
        keywords;
    ['aprobado', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "aprobado"'],
    ;
}
'🈳';
{
    name: 'u7a7a',
        keywords;
    ['ideograma', 'japonés', 'kanji', 'vacante', 'ideograma japonés para "vacante"'],
    ;
}
'㊗️';
{
    name: 'felicitaciones',
        keywords;
    ['enhorabuena', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "enhorabuena"'],
    ;
}
'㊙️';
{
    name: 'secreto',
        keywords;
    ['ideograma', 'japonés', 'kanji', 'secreto', 'ideograma japonés para "secreto"'],
    ;
}
'🈺';
{
    name: 'u55b6',
        keywords;
    ['abierto', 'ideograma', 'japonés', 'kanji', 'ideograma japonés para "abierto"'],
    ;
}
'🈵';
{
    name: 'u6e80',
        keywords;
    ['completo', 'ideograma', 'japonés', 'kanji', 'lleno', 'ideograma japonés para "completo"'],
    ;
}
'🔴';
{
...
'⚫';
{
    name: 'círculo_negro',
        keywords;
    ['círculo', 'geometría', 'círculo negro'],
    ;
}
'⚪';
{
    name: 'círculo_blanco',
        keywords;
    ['círculo', 'geometría', 'círculo blanco'],
    ;
}
'🟥';
{
...
'⬛';
{
    name: 'gran_cuadrado_negro',
        keywords;
    ['cuadrado', 'geometría', 'negro', 'cuadrado negro grande'],
    ;
}
'⬜';
{
    name: 'cuadrado_blanco_grande',
        keywords;
    ['blanco', 'cuadrado', 'geometría', 'cuadrado blanco grande'],
    ;
}
'◼️';
{
    name: 'cuadrado_mediano_negro',
        keywords;
    ['cuadrado', 'geometría', 'negro', 'cuadrado negro mediano'],
    ;
}
'◻️';
{
    name: 'cuadrado_blanco_mediano',
        keywords;
    ['blanco', 'cuadrado', 'geometría', 'cuadrado blanco mediano'],
    ;
}
'◾';
{
    name: 'cuadrado_mediano_pequeño_negro',
        keywords;
    ['cuadrado', 'geometría', 'negro', 'cuadrado negro mediano-pequeño'],
    ;
}
'◽';
{
    name: 'cuadrado_blanco_mediano_pequeño',
        keywords;
    ['blanco', 'cuadrado', 'geometría', 'cuadrado blanco mediano-pequeño'],
    ;
}
'▪️';
{
    name: 'cuadrado_pequeño_negro',
        keywords;
    ['cuadrado', 'geometría', 'negro', 'cuadrado negro pequeño'],
    ;
}
'▫️';
{
    name: 'cuadrado_blanco_pequeño',
        keywords;
    ['blanco', 'cuadrado', 'geometría', 'cuadrado blanco pequeño'],
    ;
}
'🔶';
{
...
'🔳';
{
    name: 'botón_cuadrado_blanco',
        keywords;
    ['botón', 'cuadrado', 'botón cuadrado con borde blanco'],
    ;
}
'🔲';
{
    name: 'botón_cuadrado_negro',
        keywords;
    ['botón', 'cuadrado', 'botón cuadrado con borde negro'],
    ;
}
'🏁';
{
    name: 'bandera_de_cuadros',
        keywords;
    ['bandera', 'carreras', 'cuadros', 'deporte', 'motor', 'bandera de cuadros'],
    ;
}
'🚩';
{
    name: 'mastil_con_bandera_triangular',
        keywords;
    ['bandera', 'bandera de localización triangular', 'bandera informativa de localización', 'localización', 'bandera triangular'],
    ;
}
'🎌';
{
    name: 'banderas_cruzadas',
        keywords;
    ['banderas', 'celebración', 'japón', 'banderas cruzadas'],
    ;
}
'🏴';
{
...
'🏳️‍🌈';
{
    name: 'bandera-arcoíris',
        keywords;
    ['arcoíris', 'bandera', 'bandera del arcoíris'],
    ;
}
'🏳️‍⚧️';
{
    name: 'bandera_transgénero',
        keywords;
    ['azul', 'bandera', 'blanco', 'LGTB', 'rosa', 'transgénero'],
    ;
}
'🏴‍☠️';
{
    name: 'bandera_pirata',
        keywords;
    ['botín', 'Jolly Roger', 'pirata', 'tesoro', 'bandera pirata'],
    ;
}
'🇦🇨';
{
...
'🏴󠁧󠁢󠁷󠁬󠁳󠁿';
{
    name: 'gales',
        keywords;
    ['bandera', 'bandera-gales'],
    ;
}
;
exports["default"] = esEmojis;
