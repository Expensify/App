...
### [react-native+0.86.0+014+fix-mask-persisting-recycling.patch](react-native+0.86.0+014+fix-mask-persisting-recycling.patch)
...
### [react-native+0.86.0+015+fix-text-selecting-on-change.patch](react-native+0.86.0+015+fix-text-selecting-on-change.patch)
...
### [react-native+0.86.0+016+fix-dropping-mutations-in-transactions.patch](react-native+0.86.0+016+fix-dropping-mutations-in-transactions.patch)
...
### [react-native+0.86.0+017+fix-crash-when-deleting-expense.patch](react-native+0.86.0+017+fix-crash-when-deleting-expense.patch)
...
### [react-native+0.86.0+018+publish-gradle.patch](react-native+0.86.0+018+publish-gradle.patch)
...
### [react-native+0.86.0+019+textinput-prevent-focus-on-first-responder.patch](react-native+0.86.0+019+textinput-prevent-focus-on-first-responder.patch)
...
### [react-native+0.86.0+020+fix-modal-transparent-navigation-bar.patch](react-native+0.86.0+020+fix-modal-transparent-navigation-bar.patch)
...
### [react-native+0.86.0+021+restore-interaction-manager.patch](react-native+0.86.0+021+restore-interaction-manager.patch)
...
### [react-native+0.86.0+022+perf-increase-initial-heap-size.patch](react-native+0.86.0+022+perf-increase-initial-heap-size.patch)
...
### [react-native+0.86.0+023+perf-disable-hermes-young-gc-before-tti-reached.patch](react-native+0.86.0+023+perf-disable-hermes-young-gc-before-tti-reached.patch)
...
### [react-native+0.86.0+024+strip-hermes-debug-info.patch](react-native+0.86.0+024+strip-hermes-debug-info.patch)
...
### [react-native+0.86.0+028+fix-hermes-sampling-profiler-pthread-kill-crash.patch](react-native+0.86.0+028+fix-hermes-sampling-profiler-pthread-kill-crash.patch)
...
### [react-native+0.86.0+029+fix-display-contents-dirty-flag.patch](react-native+0.86.0+029+fix-display-contents-dirty-flag.patch)
...
### [react-native+0.86.0+030+fix-fabric-collapsed-accessibility-announcement.patch](react-native+0.86.0+030+fix-fabric-collapsed-accessibility-announcement.patch)
...
### [react-native+0.86.0+031+fix-pressability-new-arch.patch](react-native+0.86.0+031+fix-pressability-new-arch.patch)
...
### [react-native+0.86.0+032+fix-turbomodule-event-emitter-uaf.patch](react-native+0.86.0+032+fix-turbomodule-event-emitter-uaf.patch)
...
### [react-native+0.86.0+033+fix-deadlock-APP-7B2.patch](react-native+0.86.0+033+fix-deadlock-APP-7B2.patch)
...
### [react-native+0.86.0+034+fix-nil-BlobModule-crash-APP-8BM.patch](react-native+0.86.0+034+fix-nil-BlobModule-crash-APP-8BM.patch)
...
### [react-native+0.86.0+035+nested-text-border-radius.patch](react-native+0.86.0+035+nested-text-border-radius.patch)
...
### [react-native+0.86.0+036+fix-recycled-view-stale-frame.patch](react-native+0.86.0+036+fix-recycled-view-stale-frame.patch)
...
### [react-native+0.86.0+037+fix-runtime-scheduler-delegate-uaf-APP-25V.patch](react-native+0.86.0+037+fix-runtime-scheduler-delegate-uaf-APP-25V.patch)
