...
### [react-native+0.81.1+001+initial.patch](react-native+0.81.1+001+initial.patch)
...
### [react-native+0.81.1+002+fixMVCPAndroid.patch](react-native+0.81.1+002+fixMVCPAndroid.patch)
...
### [react-native+0.81.1+003+disableTextInputRecycling.patch](react-native+0.81.1+003+disableTextInputRecycling.patch)
...
### [react-native+0.81.1+004+iOSFontResolution.patch](react-native+0.81.1+004+iOSFontResolution.patch)
...
### [react-native+0.81.1+005+resetAutoresizingOnView.patch](react-native+0.81.1+005+resetAutoresizingOnView.patch)
...
### [react-native+0.81.1+006+disableNonTranslucentStatusBar.patch](react-native+0.81.1+006+disableNonTranslucentStatusBar.patch)
...
### [react-native+0.81.1+007+TextInput.patch](react-native+0.81.1+007+TextInput.patch)
...
### [react-native+0.81.1+008+iOSCoreAnimationBorderRendering.patch](react-native+0.81.1+008+iOSCoreAnimationBorderRendering.patch)
...
### [react-native+0.81.1+009+copyStateOnClone.patch](react-native+0.81.1+009+copyStateOnClone.patch)
...
### [react-native+0.81.1+010+textinput-clear-command.patch](react-native+0.81.1+010+textinput-clear-command.patch)
...
### [react-native+0.81.1+011+Add-onPaste-to-TextInput.patch](react-native+0.81.1+011+Add-onPaste-to-TextInput.patch)
...
### [react-native+0.81.1+012+alert-style.patch](react-native+0.81.1+012+alert-style.patch)
...
### [react-native+0.81.1+013+fixNavigationAnimations.patch](react-native+0.81.1+013+fixNavigationAnimations.patch)
...
### [react-native+0.81.1+014+fixScrollViewState.patch](react-native+0.81.1+014+fixScrollViewState.patch)
...
### [react-native+0.81.1+015+redactAppParameters.patch](react-native+0.81.1+015+redactAppParameters.patch)
...
### [react-native+0.81.1+016+android-keyboard-avoiding-view.patch](react-native+0.81.1+016+android-keyboard-avoiding-view.patch)
...
### [react-native+0.81.1+017+fix-mask-persisting-recycling.patch](react-native+0.81.1+017+fix-mask-persisting-recycling.patch)
...
### [react-native+0.81.1+018+fix-text-selecting-on-change.patch](react-native+0.81.1+018+fix-text-selecting-on-change.patch)
...
### [react-native+0.81.1+019+fix-dropping-mutations-in-transactions.patch](react-native+0.81.1+019+fix-dropping-mutations-in-transactions.patch)
...
### [react-native+0.81.1+020+fix-crash-when-deleting-expense.patch](react-native+0.81.1+020+fix-crash-when-deleting-expense.patch)
...
### [react-native+0.81.1+021+fix-surface-stopped-before-started.patch](react-native+0.81.1+021+fix-surface-stopped-before-started.patch)
...
### [react-native+0.81.1+022+publish-gradle.patch](react-native+0.81.1+022+publish-gradle.patch)
...
### [react-native+0.81.1+023+fix-display-contents-not-updating-nodes.patch](react-native+0.81.1+023+fix-display-contents-not-updating-nodes.patch)
...
### [react-native+0.81.1+024+fix-modal-transparent-navigation-bar.patch](react-native+0.81.1+024+fix-modal-transparent-navigation-bar.patch)
