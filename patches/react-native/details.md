...
### [react-native+0.85.3+008+iOSCoreAnimationBorderRendering.patch](react-native+0.85.3+008+iOSCoreAnimationBorderRendering.patch)
...
### [react-native+0.85.3+009+copyStateOnClone.patch](react-native+0.85.3+009+copyStateOnClone.patch)
...
### [react-native+0.85.3+010+textinput-clear-command.patch](react-native+0.85.3+010+textinput-clear-command.patch)
...
### [react-native+0.85.3+011+Add-onPaste-to-TextInput.patch](react-native+0.85.3+011+Add-onPaste-to-TextInput.patch)
...
### [react-native+0.85.3+012+alert-style.patch](react-native+0.85.3+012+alert-style.patch)
...
### [react-native+0.85.3+015+android-keyboard-avoiding-view.patch](react-native+0.85.3+015+android-keyboard-avoiding-view.patch)
...
### [react-native+0.85.3+016+fix-mask-persisting-recycling.patch](react-native+0.85.3+016+fix-mask-persisting-recycling.patch)
...
### [react-native+0.85.3+017+fix-text-selecting-on-change.patch](react-native+0.85.3+017+fix-text-selecting-on-change.patch)
...
### [react-native+0.85.3+018+fix-dropping-mutations-in-transactions.patch](react-native+0.85.3+018+fix-dropping-mutations-in-transactions.patch)
...
### [react-native+0.85.3+019+fix-crash-when-deleting-expense.patch](react-native+0.85.3+019+fix-crash-when-deleting-expense.patch)
...
### [react-native+0.85.3+020+publish-gradle.patch](react-native+0.85.3+020+publish-gradle.patch)
...
### [react-native+0.85.3+021+textinput-prevent-focus-on-first-responder.patch](react-native+0.85.3+021+textinput-prevent-focus-on-first-responder.patch)
...
### [react-native+0.85.3+022+fix-modal-transparent-navigation-bar.patch](react-native+0.85.3+022+fix-modal-transparent-navigation-bar.patch)
...
### [react-native+0.85.3+023+restore-interaction-manager.patch](react-native+0.85.3+023+restore-interaction-manager.patch)
...
### [react-native+0.85.3+024+perf-increase-initial-heap-size.patch](react-native+0.85.3+024+perf-increase-initial-heap-size.patch)
...
### [react-native+0.85.3+025+perf-disable-hermes-young-gc-before-tti-reached.patch](react-native+0.85.3+025+perf-disable-hermes-young-gc-before-tti-reached.patch)
...
### [react-native+0.85.3+026+strip-hermes-debug-info.patch](react-native+0.85.3+026+strip-hermes-debug-info.patch)
...
### [react-native+0.85.3+027+log-soft-exception-if-viewState-not-found.patch](react-native+0.85.3+027+log-soft-exception-if-viewState-not-found.patch)
...
### [react-native+0.85.3+031+fix-hermes-sampling-profiler-disable.patch](react-native+0.85.3+031+fix-hermes-sampling-profiler-disable.patch)
...
### [react-native+0.85.3+032+fix-hermes-sampling-profiler-pthread-kill-crash.patch](react-native+0.85.3+032+fix-hermes-sampling-profiler-pthread-kill-crash.patch)
...
### [react-native+0.85.3+033+fix-display-contents-dirty-flag.patch](react-native+0.85.3+033+fix-display-contents-dirty-flag.patch)
...
### [react-native+0.85.3+034+fix-fabric-collapsed-accessibility-announcement.patch](react-native+0.85.3+034+fix-fabric-collapsed-accessibility-announcement.patch)
...
### [react-native+0.85.3+035+fix-pressability-new-arch.patch](react-native+0.85.3+035+fix-pressability-new-arch.patch)
...
### [react-native+0.85.3+036+fix-turbomodule-event-emitter-uaf.patch](react-native+0.85.3+036+fix-turbomodule-event-emitter-uaf.patch)
...
### [react-native+0.85.3+037+fix-deadlock-APP-7B2.patch](react-native+0.85.3+037+fix-deadlock-APP-7B2.patch)
...
### [react-native+0.85.3+038+fix-nil-BlobModule-crash-APP-8BM.patch](react-native+0.85.3+038+fix-nil-BlobModule-crash-APP-8BM.patch)
...
### [react-native+0.85.3+039+nested-text-border-radius.patch](react-native+0.85.3+039+nested-text-border-radius.patch)
...
### [react-native+0.85.3+041+fix-runtime-scheduler-delegate-uaf-APP-25V.patch](react-native+0.85.3+041+fix-runtime-scheduler-delegate-uaf-APP-25V.patch)
