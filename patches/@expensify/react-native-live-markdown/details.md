...
- Upstream PR/issue: not filed yet, the same fix is needed upstream in `src/MarkdownTextInput.tsx` (still asymmetric on `main` at 0.1.338); the issue text is drafted in `repo/activity-home-migration/live-markdown-issues.md`
...
- Upstream PR/issue: not filed yet, belongs in the same upstream issue as patch 001 (drafted in `repo/activity-home-migration/live-markdown-issues.md`)
- E/App issue: not filed yet, drafted in `repo/activity-home-migration/live-markdown-issues.md`
- PR introducing patch: https://github.com/Expensify/App/pull/100318
