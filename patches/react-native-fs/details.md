...
### [react-native-fs+2.20.0.patch](react-native-fs+2.20.0.patch)
...
- Fork carrying the fix: https://github.com/birdofpreyru/react-native-fs/pull/6 (commit [`bbcab23`](https://github.com/birdofpreyru/react-native-fs/commit/bbcab23848195296ab9e200590b6180bba0f3a18), released in `@dr.pogodin/react-native-fs` v2.22.0). This patch backports that line. The fork is a separate npm package, so there is no version of `react-native-fs` to upgrade to.
- Upstream PR/issue: 🛑, `itinance/react-native-fs` is unmaintained. Last pushed 2024-03-18, 630 open issues, and npm `latest` is still the 2.20.0 we depend on.
- E/App issue: 🛑, tracked internally
