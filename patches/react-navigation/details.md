...
#### [@react-navigation+material-top-tabs+7.4.18+001+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+material-top-tabs+7.4.18+001+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+native-stack+7.14.4+002+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+native-stack+7.14.4+002+fix-failing-jest-by-disabling-esmodule.patch)
...
#### [@react-navigation+stack+7.8.4+003+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+stack+7.8.4+003+fix-failing-jest-by-disabling-esmodule.patch)
...
### [@react-navigation+core+7.16.1+002+platform-navigation-stack-types.patch](@react-navigation+core+7.16.1+002+platform-navigation-stack-types.patch)
...
### [@react-navigation+native-stack+7.14.4+001+added-interaction-manager-integration.patch](@react-navigation+native-stack+7.14.4+001+added-interaction-manager-integration.patch)
...
### [@react-navigation+stack+7.8.4+001+edge-drag-gesture.patch](@react-navigation+stack+7.8.4+001+edge-drag-gesture.patch)
...
### [@react-navigation+stack+7.8.4+002+dontDetachScreen.patch](@react-navigation+stack+7.8.4+002+dontDetachScreen.patch)
