...
#### [@react-navigation+core+7.13.7+001+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+core+7.13.7+001+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+elements+2.9.3+001+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+elements+2.9.3+001+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+material-top-tabs+7.4.11+001+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+material-top-tabs+7.4.11+001+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+native-stack+7.9.0+002+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+native-stack+7.9.0+002+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+native+7.1.26+002+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+native+7.1.26+002+fix-failing-jest-by-disabling-esmodule.patch)
...
#### [@react-navigation+stack+7.6.13+003+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+stack+7.6.13+003+fix-failing-jest-by-disabling-esmodule.patch)
...
### [@react-navigation+core+7.13.7+002+platform-navigation-stack-types.patch](@react-navigation+core+7.13.7+002+platform-navigation-stack-types.patch)
...
### [@react-navigation+core+7.13.7+003+fix-clearing-preloaded-routes-after-logout.patch](@react-navigation+core+7.13.7+003+fix-clearing-preloaded-routes-after-logout.patch)
...
### [@react-navigation+native-stack+7.9.0+001+added-interaction-manager-integration.patch](@react-navigation+native-stack+7.9.0+001+added-interaction-manager-integration.patch)
...
### [@react-navigation+native+7.1.26+001+initial.patch](@react-navigation+native+7.1.26+001+initial.patch)
...
### [@react-navigation+stack+7.6.13+001+edge-drag-gesture.patch](@react-navigation+stack+7.6.13+001+edge-drag-gesture.patch)
...
### [@react-navigation+stack+7.6.13+002+dontDetachScreen.patch](@react-navigation+stack+7.6.13+002+dontDetachScreen.patch)
