# `@typescript-eslint/type-utils` patches

### [@typescript-eslint+type-utils+8.58.1+001+require-typescript6.patch](@typescript-eslint+type-utils+8.58.1+001+require-typescript6.patch)
