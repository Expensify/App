# `@typescript-eslint/typescript-estree` patches

### [@typescript-eslint+typescript-estree+8.61.0+001+require-typescript6.patch](@typescript-eslint+typescript-estree+8.61.0+001+require-typescript6.patch)
