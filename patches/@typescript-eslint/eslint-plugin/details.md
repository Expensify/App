# `@typescript-eslint/eslint-plugin` patches

### [@typescript-eslint+eslint-plugin+8.58.1+001+require-typescript6.patch](@typescript-eslint+eslint-plugin+8.58.1+001+require-typescript6.patch)
