...
describe('getBestMatchingPath', () => {
    ...
    it('redirects old settings tag routes to the new dynamic suffix shape', () => {
        expect(getMatchingNewRoute('/settings/p123/tags/10/edit')).toBe('/settings/p123/tags/settings-tags-settings/settings-tags-edit/10');
        ...
        expect(getMatchingNewRoute('/settings/p123/tags/settings/edit/0')).toBe('/settings/p123/tags/settings-tags-settings/settings-tags-edit/0');
    ...
    it('preserves query params when redirecting old settings tag routes', () => {
        expect(getMatchingNewRoute('/settings/p123/tags/10/edit?backTo=/home')).toBe('/settings/p123/tags/settings-tags-settings/settings-tags-edit/10?backTo=/home');
