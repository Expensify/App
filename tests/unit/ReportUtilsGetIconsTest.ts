...
describe('getIcons', () => {
    it('should return a fallback icon if the report is empty', () => {
        ...
        const icons = getIcons(report, localeCompare, FAKE_PERSONAL_DETAILS);
    ...
    it('should return the correct icons for an expense request', () => {
        ...
        const icons = getIcons(report, localeCompare, FAKE_PERSONAL_DETAILS, null, '', -1, policy);
    ...
    it('should return the correct icons for archived non expense request/report', () => {
        ...
        const icons = getIcons(report, localeCompare, FAKE_PERSONAL_DETAILS, null, '', -1, policy, undefined, true);
        expect(icons).toHaveLength(1);
    ...
    it('should return the correct icons for an invoice room with business receiver', () => {
        ...
        const policy = LHNTestUtils.getFakePolicy('1');
        const icons = getIcons(report, localeCompare, FAKE_PERSONAL_DETAILS, null, '', -1, policy, receiverPolicy);
