...
describe('OptionsListUtils', () => {
    ...
    it('getValidOptions()', () => {
        ...
        return waitForBatchedUpdates()
            .then(() => Onyx.set(ONYXKEYS.NVP_DISMISSED_PRODUCT_TRAINING, {[CONST.PRODUCT_TRAINING_TOOLTIP_NAMES.SCAN_TEST_TOOLTIP]: {
                dismissedTime: DateUtils.getDBTime(new Date().valueOf()),
            }}))
            .then(() => {
