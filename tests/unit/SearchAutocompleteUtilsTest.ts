...
describe('SearchAutocompleteUtils', () => {
    describe('parseForLiveMarkdown', () => {
        ...
        const mockTranslatedStatusMap = createSharedValueMock<Record<string, boolean>>({});

        it('should highlight valid filters with correct values', () => {
            const input = 'type:expense from:john@example.com currency:USD';

            const result = parseForLiveMarkdown(input, currentUserName, mockSubstitutionMap, mockUserLogins, mockCurrencyList, mockCategoryList, mockTagList, mockTranslatedStatusMap);
        ...
        it('should return empty array for empty input', () => {
            const result = parseForLiveMarkdown('', currentUserName, mockSubstitutionMap, mockUserLogins, mockCurrencyList, mockCategoryList, mockTagList, mockTranslatedStatusMap);
