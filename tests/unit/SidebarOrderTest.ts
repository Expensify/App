...
describe('Sidebar', () => {
    ...
    describe('in default mode', () => {
        ...
        it('orders items with most recently updated on top', () => {
            ...
            addComment(report1, report1.reportID, [], 'Hi, this is a comment', CONST.DEFAULT_TIME_ZONE, 1);
            addComment(report2, report2.reportID, [], 'Hi, this is a comment', CONST.DEFAULT_TIME_ZONE, 1);
            addComment(report3, report3.reportID, [], 'Hi, this is a comment', CONST.DEFAULT_TIME_ZONE, 1);
        ...
        it('sorts chats by pinned / GBR > draft > rest', () => {
            ...
            addComment(report4, report4.reportID, [], 'Hi, this is a comment', CONST.DEFAULT_TIME_ZONE, 1);
