            ...
            it('should navigate to the category step if the active policy is valid and not restricted', async () => {
                ...
                expect(Navigation.navigate).toHaveBeenCalledWith(
                    createDynamicRoute(
                        ...
                        ROUTES.MONEY_REQUEST_STEP_CONFIRMATION.getRoute(CONST.IOU.ACTION.CATEGORIZE, CONST.IOU.TYPE.SUBMIT, transaction.transactionID, policyExpenseReport.reportID),
                    ),
                );
            });
