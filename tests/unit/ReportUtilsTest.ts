...
describe('ReportUtils', () => {
    ...
    describe('getChatRoomSubtitle', () => {
        ...
        it('should return empty string for chat thread', () => {
            ...
            const result = getChatRoomSubtitle(report, policy, undefined, false, false, translateLocal);
            expect(result).toBe('');
        });
        ...
        it('should return empty string for expense report in create expense flow (not default/user-created/policy-expense)', () => {
            const report = createExpenseReport(1);
            report.policyID = policy.id;
            const result = getChatRoomSubtitle(report, policy, undefined, true, false, translateLocal);
            expect(result).toBe('');
        });
        ...
        it('should return oldPolicyName when report is archived', () => {
            ...
            const result = getChatRoomSubtitle(report, policy, undefined, false, true, translateLocal);
        ...
        it('should prioritize isReportArchived over other conditions', () => {
            ...
            const result = getChatRoomSubtitle(report, policy, undefined, true, true, translateLocal);
        ...
        it('should return "Concierge support" when the report is the Concierge chat passed via conciergeReportID', () => {
            ...
            const result = getChatRoomSubtitle(report, policy, report.reportID, false, false, translateLocal);
        ...
        it('should not return "Concierge support" when conciergeReportID does not match the report', () => {
            const report = createRegularChat(1, [currentUserAccountID, CONST.ACCOUNT_ID.CONCIERGE]);
            const result = getChatRoomSubtitle(report, policy, 'some-other-report-id', false, false, translateLocal);
