...
describe('navigateToSubmitWorkspaceAfterOnboardingWithMicrotaskQueue', () => {
    ...
    it('navigates to HOME with the expanded side panel when not using narrow layout', () => {
    ...
    it('navigates to HOME with the collapsed side panel when using narrow layout', () => {
