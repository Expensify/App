...
describe('NativeBiometricsHSM helpers', () => {
    ...
    describe('mapSignErrorCodeToReason', () => {
        ...
        it('should return CANCELED for user cancel error codes', () => {
            ...
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.USER_CANCEL)).toBe(VALUES.REASON.HSM.CANCELED);
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.USER_CANCELED)).toBe(VALUES.REASON.HSM.CANCELED);
        });
        ...
        it('should return CANCELED for system cancel error codes', () => {
            ...
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.SYSTEM_CANCEL)).toBe(VALUES.REASON.HSM.CANCELED);
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.SYSTEM_CANCELED)).toBe(VALUES.REASON.HSM.CANCELED);
        });
        ...
        it('should return NOT_AVAILABLE for biometric unavailability error codes', () => {
            ...
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.BIOMETRY_NOT_AVAILABLE)).toBe(VALUES.REASON.HSM.NOT_AVAILABLE);
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.BIOMETRIC_NOT_AVAILABLE)).toBe(VALUES.REASON.HSM.NOT_AVAILABLE);
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.BIOMETRIC_UNAVAILABLE)).toBe(VALUES.REASON.HSM.NOT_AVAILABLE);
        });
        ...
        it('should return LOCKOUT for temporary lockout error codes', () => {
            ...
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.BIOMETRY_LOCKOUT)).toBe(VALUES.REASON.HSM.LOCKOUT);
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.BIOMETRIC_LOCKOUT)).toBe(VALUES.REASON.HSM.LOCKOUT);
        });
        ...
        it('should return LOCKOUT_PERMANENT for permanent lockout error codes', () => {
            ...
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.BIOMETRY_LOCKOUT_PERMANENT)).toBe(VALUES.REASON.HSM.LOCKOUT_PERMANENT);
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.BIOMETRIC_LOCKOUT_PERMANENT)).toBe(VALUES.REASON.HSM.LOCKOUT_PERMANENT);
        });
        ...
        it('should return SIGNATURE_FAILED for signature creation failure', () => {
            ...
            expect(mapSignErrorCodeToReason(NATIVE_BIOMETRIC_HSM_VALUES.ERROR_CODE.SIGNATURE_CREATION_FAILED)).toBe(VALUES.REASON.HSM.SIGNATURE_FAILED);
        });
