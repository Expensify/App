...
jest.mock('@libs/ReportUtils', () => ({
    ...
    isSettled: jest.requireActual<typeof ReportUtils>('@libs/ReportUtils').isSettled,
    isReportOwner: jest.requireActual<typeof ReportUtils>('@libs/ReportUtils').isReportOwner,
    hasReportViolations: jest.requireActual<typeof ReportUtils>('@libs/ReportUtils').hasReportViolations,
