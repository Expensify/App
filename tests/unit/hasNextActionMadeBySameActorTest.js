...
var accountID = 1;
describe('hasNextActionMadeBySameActor', function () {
    beforeEach(function () {
        jest.clearAllMocks();
    });
    it("returns false if we're inspecting first item on the list", function () {
        var result = (0, ReportActionsUtils_1.hasNextActionMadeBySameActor)([], 0);
        expect(result).toBe(false);
    });
    it('returns false if actions are more than 5 minutes apart', function () {
        var actions = [(0, ReportTestUtils_1.getFakeReportAction)(accountID, { created: '2025-01-01T01:01:00Z' }), (0, ReportTestUtils_1.getFakeReportAction)(accountID, { created: '2025-01-01T02:00:00Z' })];
        var result = (0, ReportActionsUtils_1.hasNextActionMadeBySameActor)(actions, 1);
        expect(result).toBe(false);
    });
    it('returns false if next action is CREATED', function () {
        var actions = [(0, ReportTestUtils_1.getFakeReportAction)(accountID, { actionName: CONST_1.default.REPORT.ACTIONS.TYPE.CREATED }), (0, ReportTestUtils_1.getFakeReportAction)(accountID)];
        var result = (0, ReportActionsUtils_1.hasNextActionMadeBySameActor)(actions, 1);
        expect(result).toBe(false);
    });
    ...
    it('returns false if the current action is SUBMITTED and the current action adminID is different than previous action actorID', function () {
        var actions = [(0, ReportTestUtils_1.getFakeReportAction)(accountID, { adminAccountID: 3, actionName: CONST_1.default.REPORT.ACTIONS.TYPE.ADD_COMMENT }), (0, ReportTestUtils_1.getFakeReportAction)(2)];
        var isConsecutiveActionMadeByPreviousActor = (0, ReportActionsUtils_1.hasNextActionMadeBySameActor)(actions, 1);
    ...
    it('returns false if the current action is SUBMITTED and the previous action was made by a different actor', function () {
        var actions = [(0, ReportTestUtils_1.getFakeReportAction)(accountID), (0, ReportTestUtils_1.getFakeReportAction)(2, { actionName: CONST_1.default.REPORT.ACTIONS.TYPE.ADD_COMMENT })];
        var isConsecutiveActionMadeByPreviousActor = (0, ReportActionsUtils_1.hasNextActionMadeBySameActor)(actions, 1);
        expect(isConsecutiveActionMadeByPreviousActor).toBe(false);
    });
