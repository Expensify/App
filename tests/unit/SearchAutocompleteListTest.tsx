...
const mockLibraryLegendList = jest.mocked(LibraryLegendList);
const libraryLegendListImplementation = mockLibraryLegendList.getMockImplementation();

mockLibraryLegendList.mockImplementation((props) => {
    mockLegendListContentContainerStyles.push(props.contentContainerStyle);
    return libraryLegendListImplementation?.(props) ?? null;
});
