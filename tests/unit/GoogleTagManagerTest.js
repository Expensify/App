...
describe('GoogleTagManagerTest', function () {
    ...
    test('sign_up', function () {
        ...
        var rerender = (0, react_native_1.render)(<native_1.NavigationContainer>
    ...
    test('workspace_created - categorizeTrackedExpense', function () {
    ...
    test('paid_adoption - addPaymentCard', function () {
    ...
    test('paid_adoption - addSubscriptionPaymentCard', function () {
        // When we add a payment card
