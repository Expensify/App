...
describe('groupTransactionsByCategory', () => {
    it('returns empty array when transactions array is empty', () => {
        expect(groupTransactionsByCategory([], 'USD', mockLocaleCompare)).toEqual([]);
    });
    ...
    it('groups transactions by category', () => {
        ...
        const result = groupTransactionsByCategory(transactions, 'USD', mockLocaleCompare);
...
describe('groupTransactionsByTag', () => {
    it('returns empty array when transactions array is empty', () => {
        expect(groupTransactionsByTag([], 'USD', mockLocaleCompare)).toEqual([]);
    });
    ...
    it('groups transactions by tag', () => {
        ...
        const result = groupTransactionsByTag(transactions, 'USD', mockLocaleCompare);
