...
} from "@components/PopoverMenu/v2/content/ContentContext";
...
jest.mock("@components/PopoverWithMeasuredContent", () => {
  function MockPopoverWithMeasuredContent({
    ...
    return (
      <RNView testID={isVisible ? "mock-popover-open" : "mock-popover-closed"}>
        {children}
      </RNView>
    );
  }
...
const mockModalState: {
  value:
    | { willAlertModalBecomeVisible?: boolean; isPopover?: boolean }
    | undefined;
  listeners: Set<() => void>;
...
describe("PopoverMenu V2", () => {
  describe("Root", () => {
    it("renders the popover in the closed state when not open", () => {
      render(
        <Harness>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="Hidden" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
    ...
    it("renders Content when open", () => {
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="Visible" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
    ...
    it("mounts visible with `defaultOpen` (uncontrolled)", () => {
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="Default" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
    ...
    it("closes on screen blur via navigation.addListener", () => {
      ...
      render(
        <Harness initialOpen onOpenChange={onOpenChange}>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="A" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
    ...
    it("closes when a non-popover modal is about to become visible", () => {
      ...
      onOpenChange.mockClear();
      act(() =>
        setMockModal({ willAlertModalBecomeVisible: true, isPopover: false }),
      );
      expect(onOpenChange).toHaveBeenCalledWith(false);
    });
    ...
    it("does not close when the covering modal is itself a popover", () => {
      ...
      onOpenChange.mockClear();
      act(() =>
        setMockModal({ willAlertModalBecomeVisible: true, isPopover: true }),
      );
  ...
  describe("Trigger", () => {
    ...
    beforeAll(() => {
      const proto = (View as unknown as { prototype: Record<string, unknown> })
        .prototype;
      originalGetBoundingClientRect =
        proto.getBoundingClientRect as typeof originalGetBoundingClientRect;
  ...
  describe("SecondaryInteractionTrigger", () => {
    ...
    it("opens the popover when the slotted child receives a long-press", () => {
      ...
      fireEvent(
        screen.getByTestId("secondary-trigger"),
        "longPress",
        longPressEvent,
      );
    ...
    it("still opens when the slotted child calls event.preventDefault() (framework reserves preventDefault for OS suppression)", () => {
      const onOpenChange = jest.fn();
      const consumerOnSecondary = jest.fn(
        (event: { preventDefault: () => void }) => event.preventDefault(),
      );
      render(
        <NavigationContext.Provider value={mockNavigation}>
    ...
    it("warns when a descendant pressable consumes props but never calls useResponderRef", () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith(
        expect.stringContaining("useResponderRef"),
      );
      warnSpy.mockRestore();
    });
  });
          ...
          <PopoverMenu.Content>
            <PopoverMenu.Sub id="sub-test">
              ...
              <PopoverMenu.Sub.Content>
                <PopoverMenu.Item text="X" onSelect={() => {}} />
              </PopoverMenu.Sub.Content>
            </PopoverMenu.Sub>
          </PopoverMenu.Content>
        </Harness>,
        ...
        <Harness initialOpen>
          <PopoverMenu.Content>
            ...
            <PopoverMenu.Sub id="speed-sub">
              <ProbeHook />
              <PopoverMenu.Sub.Content>
                <PopoverMenu.Item text="Fast" onSelect={() => {}} />
              </PopoverMenu.Sub.Content>
            </PopoverMenu.Sub>
          </PopoverMenu.Content>
        </Harness>,
  ...
  describe("Item", () => {
    it("fires onSelect when pressed", () => {
      ...
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="Pay" onSelect={onSelect} />
          </PopoverMenu.Content>
        </Harness>,
      );
      press("Pay");
    ...
    it("closes the menu by default after onSelect", () => {
      ...
      render(
        <Harness initialOpen onOpenChange={onOpenChange}>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="Pay" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
      onOpenChange.mockClear();
    ...
    it("skips onSelect when disabled", () => {
      ...
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="Disabled" disabled onSelect={onSelect} />
          </PopoverMenu.Content>
        </Harness>,
      );
      press("Disabled");
    ...
    it("does not mark the last item as focused when no row is focused", () => {
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="A" onSelect={() => {}} />
            <PopoverMenu.Item text="B" onSelect={() => {}} />
            <PopoverMenu.Item text="Last" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
  ...
  describe("CheckmarkItem", () => {
    ...
    it("renders the radio indicator with isSelected=false when not selected", () => {
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.CheckmarkItem text="Wallet" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
      const item = findItemByTitle("Wallet");
    ...
    it("fires onSelect and closes the menu by default", () => {
      ...
      render(
        <Harness initialOpen onOpenChange={onOpenChange}>
          <PopoverMenu.Content>
            <PopoverMenu.CheckmarkItem text="Pick" onSelect={onSelect} />
          </PopoverMenu.Content>
        </Harness>,
      );
      onOpenChange.mockClear();
      ...
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            ...
            <PopoverMenu.Item text="Below" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
      ...
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            ...
            <PopoverMenu.Item text="Wallet" onSelect={() => {}} />
          </PopoverMenu.Content>
        </Harness>,
      );
          ...
          <PopoverMenu.Content>
            ...
            <PopoverMenu.Sub id="sub-test">
              ...
              <PopoverMenu.Sub.Content>
                ...
                <PopoverMenu.Item text="Inner" onSelect={() => {}} />
              </PopoverMenu.Sub.Content>
            </PopoverMenu.Sub>
          </PopoverMenu.Content>
        </Harness>,
  ...
  describe("Sub", () => {
    const renderTwoLevelMenu = () => (
      <Harness initialOpen>
        <PopoverMenu.Content>
          <PopoverMenu.Item text="Top 1" onSelect={() => {}} />
          <PopoverMenu.Sub id="sub-test">
            <PopoverMenu.Sub.Trigger text="Pay as business" />
            <PopoverMenu.Sub.Content>
              <PopoverMenu.Sub.BackButton text="Business" />
              <PopoverMenu.Item text="Sub option" onSelect={() => {}} />
            </PopoverMenu.Sub.Content>
          </PopoverMenu.Sub>
          <PopoverMenu.Item text="Top 2" onSelect={() => {}} />
        </PopoverMenu.Content>
      </Harness>
    );
        ...
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Sub id="sub-gated">
              <PopoverMenu.Sub.Trigger text="Drill" onPress={consumerOnPress} />
              <PopoverMenu.Sub.Content>
        ...
        <Harness initialOpen onOpenChange={onOpenChange}>
          <PopoverMenu.Content>
            <PopoverMenu.Sub id="sub-test">
              ...
              <PopoverMenu.Sub.Content>
                <PopoverMenu.Item text="Choose" onSelect={() => {}} />
              </PopoverMenu.Sub.Content>
            </PopoverMenu.Sub>
          </PopoverMenu.Content>
        </Harness>,
    ...
    it("resets to top level when the menu closes via item selection and reopens", () => {
      ...
      function RemountingHarness({ remountKey }: { remountKey: number }) {
        return (
          <Harness key={remountKey} initialOpen>
            <PopoverMenu.Content>
    ...
    it("pops to parent when an active <Sub> unmounts mid-flight", () => {
      function SubMenuWithToggle({ showSub }: { showSub: boolean }) {
        return (
          <Harness initialOpen>
            <PopoverMenu.Content>
              <PopoverMenu.Item text="Top" onSelect={() => {}} />
              {showSub && (
                <PopoverMenu.Sub id="A">
                  <PopoverMenu.Sub.Trigger text="Open A" />
                  <PopoverMenu.Sub.Content>
            ...
            <PopoverMenu.Sub id="outer">
              ...
              <PopoverMenu.Sub.Content>
                ...
                <PopoverMenu.Sub id="inner">
                  ...
                  <PopoverMenu.Sub.Content>
                    <PopoverMenu.Item text="Innermost" onSelect={() => {}} />
                  </PopoverMenu.Sub.Content>
                </PopoverMenu.Sub>
              </PopoverMenu.Sub.Content>
            </PopoverMenu.Sub>
    ...
    it("resets focus when entering a submenu", () => {
      render(
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Item text="Above" onSelect={() => {}} />
            <PopoverMenu.Sub id="sub-test">
              <PopoverMenu.Sub.Trigger text="Trigger" />
              <PopoverMenu.Sub.Content>
                <PopoverMenu.Sub.BackButton text="Back" />
    ...
    it("keeps registerSub identity stable across unrelated parent re-renders (RC mutation guard)", () => {
      ...
      function TickHarness({ tick }: { tick: number }) {
        return (
          <Harness initialOpen>
            <PopoverMenu.Content>
              <PopoverMenu.Item text={`tick-${tick}`} onSelect={() => {}} />
              <RegisterSubProbe />
            </PopoverMenu.Content>
          </Harness>
        );
        ...
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Sub id="sub">
              ...
              <PopoverMenu.Sub.Content>
                <PopoverMenu.Sub.BackButton text="Back" />
                <PopoverMenu.Item text="First" onSelect={() => {}} />
                <PopoverMenu.Item text="Second" onSelect={() => {}} />
              </PopoverMenu.Sub.Content>
            </PopoverMenu.Sub>
          </PopoverMenu.Content>
        </Harness>,
    ...
    it("resets focus when an active sub unmounts mid-flight", () => {
      function SubMenuWithToggle({ showSub }: { showSub: boolean }) {
        return (
          <Harness initialOpen>
            <PopoverMenu.Content>
              <PopoverMenu.Item text="Outer-A" onSelect={() => {}} />
              <PopoverMenu.Item text="Outer-B" onSelect={() => {}} />
              {showSub && (
                <PopoverMenu.Sub id="sub">
                  <PopoverMenu.Sub.Trigger text="Open" />
                  <PopoverMenu.Sub.Content>
                    <PopoverMenu.Item text="Inner-A" onSelect={() => {}} />
                    <PopoverMenu.Item text="Inner-B" onSelect={() => {}} />
                  </PopoverMenu.Sub.Content>
                </PopoverMenu.Sub>
              )}
            </PopoverMenu.Content>
  ...
  describe("ScrollableContent", () => {
    it("warns when the child count exceeds the virtualization threshold", () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith(
        expect.stringMatching(/received 51 children/),
      );
      warnSpy.mockRestore();
    });
          ...
          <PopoverMenu.Content>
            <PopoverMenu.Group>
              <PopoverMenu.Sub id="sub-test">
                <PopoverMenu.Sub.Trigger text="Open" />
                <PopoverMenu.Sub.Content>
                  <PopoverMenu.Item text="Inside" onSelect={() => {}} />
                </PopoverMenu.Sub.Content>
              </PopoverMenu.Sub>
            </PopoverMenu.Group>
          </PopoverMenu.Content>
        ...
        <Harness initialOpen>
          <PopoverMenu.Content>
            <PopoverMenu.Group>
              ...
              <PopoverMenu.Item text="USD" onSelect={() => {}} />
            </PopoverMenu.Group>
          </PopoverMenu.Content>
        </Harness>,
      );
  ...
  describe("Composition invariants", () => {
    ...
    it("throws when Trigger is rendered outside Root", () => {
      expect(() =>
        ...
        /PopoverMenu\.Trigger\(\) must be called inside <PopoverMenu\.Root>/,
      );
    });
    ...
    it("throws when SecondaryInteractionTrigger is rendered outside Root", () => {
      expect(() =>
        ...
        /PopoverMenu\.SecondaryInteractionTrigger\(\) must be called inside <PopoverMenu\.Root>/,
      );
    });
    ...
    it("throws when useIsPopoverVisible is called outside Root", () => {
      ...
      expect(() => render(<CallVisibilityHook />)).toThrow(
        /useIsPopoverVisible\(\) must be called inside <PopoverMenu\.Root>/,
      );
    });
    ...
    it("throws when Content is rendered outside Root", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Content> must be rendered inside <PopoverMenu\.Root>/,
      );
    });
    ...
    it("throws when Item is rendered outside Content", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Item> must be rendered inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when Group is rendered outside Content", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Group> must be rendered inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when Sub is rendered outside Content", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Sub> must be rendered inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when Sub.Trigger is rendered outside Sub", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Sub\.Trigger> must be rendered inside <PopoverMenu\.Sub>/,
      );
    });
    ...
    it("throws when useSelectableRow is called outside Content", () => {
      ...
      expect(() =>
        ...
        /useSelectableRow\(\) must be called inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when useClosePopover is called outside Content", () => {
      ...
      expect(() =>
        ...
        /useClosePopover\(\) must be called inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when useSubBackButton is called outside Sub", () => {
      ...
      expect(() =>
        ...
        /useSubBackButton\(\) must be called inside <PopoverMenu\.Sub>/,
      );
    });
    ...
    it("throws when Sub.Content is rendered outside Sub", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Sub\.Content> must be rendered inside <PopoverMenu\.Sub>/,
      );
    });
    ...
    it("throws when Header is rendered outside Content", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Header> must be rendered inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when Label is rendered outside Content", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Label> must be rendered inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when CheckmarkItem is rendered outside Content", () => {
      expect(() =>
        render(
          <Harness initialOpen>
            <PopoverMenu.CheckmarkItem text="X" onSelect={() => {}} />
          </Harness>,
        ),
      ).toThrow(
        /<PopoverMenu\.CheckmarkItem> must be rendered inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when Separator is rendered outside Content", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Separator> must be rendered inside <PopoverMenu\.Content>/,
      );
    });
    ...
    it("throws when Sub.BackButton is rendered outside Sub", () => {
      expect(() =>
        ...
        /<PopoverMenu\.Sub\.BackButton> must be rendered inside <PopoverMenu\.Sub>/,
      );
    });
    ...
    it("throws when ScrollableContent is rendered outside Root", () => {
      expect(() =>
        ...
        /<PopoverMenu\.ScrollableContent> must be rendered inside <PopoverMenu\.Root>/,
      );
    });
  });
});
