...
describe('Empty Report Selection', () => {
    ...
    it('should call onCheckboxPress when checkbox is clicked on an empty report', async () => {
        ...
        expect(mockOnCheckboxPress).toHaveBeenCalledWith(mockEmptyReport, undefined, false);
    });
    ...
    it('should handle selecting both empty and non-empty reports', async () => {
        ...
        expect(mockOnCheckboxPress).toHaveBeenCalledTimes(1);
        expect(mockOnCheckboxPress).toHaveBeenCalledWith(mockNonEmptyReport, undefined, false);
    ...
    it('should track the number of checkbox presses for multiple selections', async () => {
        ...
        expect(mockOnCheckboxPress).toHaveBeenNthCalledWith(1, mockEmptyReport, undefined, false);
        expect(mockOnCheckboxPress).toHaveBeenNthCalledWith(2, mockEmptyReport, undefined, false);
        expect(mockOnCheckboxPress).toHaveBeenNthCalledWith(3, mockEmptyReport, undefined, false);
    });
