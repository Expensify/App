...
describe('getSecondaryAction', () => {
    ...
    it('does not include APPROVE option when DEW approval is pending', async () => {
        ...
        expect(resultWithPending.includes(CONST.REPORT.SECONDARY_ACTIONS.APPROVE)).toBe(false);
    });
