...
describe('getSecondaryAction', () => {
    ...
    it('should always return default options', () => {
        ...
        expect(getSecondaryReportActions({currentUserEmail: EMPLOYEE_EMAIL, report, chatReport, reportTransactions: [], originalTransaction: {} as Transaction, violations: {}, policy})).toEqual(result);
    });
    ...
    it('includes ADD_EXPENSE option for empty report', async () => {
        ...
        const result = getSecondaryReportActions({currentUserEmail: EMPLOYEE_EMAIL, report, chatReport, reportTransactions: [transaction], originalTransaction: {} as Transaction, violations: {}, policy});
