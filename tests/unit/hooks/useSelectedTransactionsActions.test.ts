...
describe('useSelectedTransactionsActions', () => {
    ...
    it('should show unhold option and handle unhold action', async () => {
        ...
        expect(unholdRequest).toHaveBeenCalledWith(transactionID, 'child123', undefined, false, undefined, CURRENT_USER_LOGIN, CURRENT_USER_ACCOUNT_ID);
        expect(mockClearSelectedTransactions).toHaveBeenCalledWith(true);
    });
    ...
    it('should pass isOffline=true to unholdRequest when offline', async () => {
        ...
        expect(unholdRequest).toHaveBeenCalledWith(transactionID, 'child123', undefined, true, undefined, CURRENT_USER_LOGIN, CURRENT_USER_ACCOUNT_ID);
        expect(mockClearSelectedTransactions).toHaveBeenCalledWith(true);
    });
