...
describe('mkarAllReportsAsRead', () => {
    ...
    it('should mark all unread report', async () => {
        ...
        const reportCollections: Record<`${typeof ONYXKEYS.COLLECTION.REPORT}${string}`, Report> = createCollection<Report>(
            ...
            (index) => {
                if (index % 2 === 0) {
                    ...
                    return {
                        ...
                        lastVisibleActionCreated: DateUtils.addMillisecondsFromDateTime(currentTime, 10),
                    };
                }
