...
import {
    ...
    getCachedPolicyByID,
    getCachedReportByID,
    getCachedReportNameValuePairsByID,
    getCachedTransactionByID,
} from '@libs/OptimisticReportNamesCache';
...
describe('OptimisticReportNamesCache', () => {
    ...
    describe('applyUpdateToCache', () => {
        it('should apply SET update to cache', () => {
            ...
            const update = {
                key: `${ONYXKEYS.COLLECTION.REPORT}456`,
        ...
        it('should apply MERGE update to existing cached data', () => {
            ...
            expect(result[`${ONYXKEYS.COLLECTION.REPORT}123`]).toEqual({
                ...mockReport,
                reportName: 'Cached Name',
                total: -15000,
            });
        ...
        it('should apply CLEAR update to remove from cache', () => {
            ...
            expect(result[`${ONYXKEYS.COLLECTION.REPORT}123`]).toBeUndefined();
        });

        it('should handle unknown onyx method with default MERGE behavior', () => {
            const workingUpdates: WorkingUpdates = {};

            const update = {
                key: `${ONYXKEYS.COLLECTION.REPORT}123`,
                onyxMethod: 'UNKNOWN_METHOD' as any,
                value: { total: -25000 },
            };
    ...
    describe('integration scenarios', () => {
        ...
        it('should maintain cache consistency across multiple object types', () => {
            ...
            // Update policy
            const policyUpdate = {
                key: `${ONYXKEYS.COLLECTION.POLICY}policy1`,
                onyxMethod: Onyx.METHOD.MERGE,
            ...
            const transactionUpdate = {
                key: `${ONYXKEYS.COLLECTION.TRANSACTION}txn123`,
                onyxMethod: Onyx.METHOD.MERGE,
                value: { amount: -7500 },
            };
