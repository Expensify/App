            ...
            const adminPolicies: Policy[] = [
                {
                    ...
                    connections: createMock<Connections>({
                        [CONST.POLICY.CONNECTIONS.NAME.XERO]: {
                            ...
                            config: createMock<NonNullable<Connections[typeof CONST.POLICY.CONNECTIONS.NAME.XERO]>['config']>({}),
                            data: createMock<NonNullable<Connections[typeof CONST.POLICY.CONNECTIONS.NAME.XERO]>['data']>({}),
                        },
                    }),
                },
                {...createRandomPolicy(2, CONST.POLICY.TYPE.TEAM), pendingAction: undefined},
