...
describe('FileUtils', () => {
    ...
    describe('getImageDimensionsAfterResize', () => {
        ...
        describe('with file:// URLs (native)', () => {
            ...
            it('should throw IMAGE_DIMENSIONS_TOO_LARGE error when image exceeds maximum pixel count', async () => {
                ...
                await expect(getImageDimensionsAfterResize(file)).rejects.toThrow(CONST.ATTACHMENT_VALIDATION_ERRORS.SINGLE_FILE.IMAGE_DIMENSIONS_TOO_LARGE);
            });
    ...
    describe('getFileValidationErrorText', () => {
        ...
        it('should return correct error text for IMAGE_DIMENSIONS_TOO_LARGE', () => {
            const result = getFileValidationErrorText(mockTranslate, CONST.ATTACHMENT_VALIDATION_ERRORS.SINGLE_FILE.IMAGE_DIMENSIONS_TOO_LARGE);
