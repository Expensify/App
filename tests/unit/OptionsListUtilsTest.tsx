...
describe('OptionsListUtils', () => {
    ...
    describe('getReportOption', () => {
        ...
        it('should handle draft reports', async () => {
            ...
            const option = getReportOption(participant, reportNameValuePair?.private_isArchived, POLICY, undefined, undefined, undefined, draftReports);
    ...
    describe('getReportDisplayOption', () => {
        ...
        it('should include chat receiver policy in policies lookup for invoice reports with chat report', async () => {
            ...
            const option = getReportOption(participant, undefined, senderPolicy, undefined, chatReceiverPolicy, undefined);
