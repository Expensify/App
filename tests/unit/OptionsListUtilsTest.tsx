...
describe('OptionsListUtils', () => {
    ...
    describe('filterAndOrderOptions()', () => {
        ...
        it('should not return userToInvite for plain text name when shouldAcceptName is false', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'Jeff Amazon', COUNTRY_CODE, loginList, {
        ...
        it('should return userToInvite for plain text name when shouldAcceptName is true', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'Jeff', COUNTRY_CODE, loginList, {
    ...
    describe('getReportDisplayOption', () => {
        it('should use reportNameValuePair parameter for archived reports', async () => {
            ...
            const option = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, reportNameValuePair?.private_isArchived);
        ...
        it('should handle undefined reportNameValuePair', async () => {
            ...
            const option = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, undefined);
