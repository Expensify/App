...
describe('OptionsListUtils', () => {
    ...
    describe('getValidOptions()', () => {
        ...
        it('should use personalDetails parameter when passed to getValidOptions', () => {
            ...
            const results = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, {}, nvpDismissedProductTraining, undefined, translateLocal, loginList, {
    ...
    describe('getReportDisplayOption', () => {
        ...
        it('should return option with isSelfDM alternateText when report is a self DM', () => {
            ...
            const result = getReportDisplayOption(report, undefined, undefined, personalDetails, undefined);
        ...
        it('should return option with unknownUserDetails when provided', () => {
            ...
            // When we call getReportDisplayOption
            const result = getReportDisplayOption(report, unknownUserDetails, undefined, personalDetails, undefined);
        ...
        it('should use personalDetails parameter instead of Onyx.connect data', () => {
            ...
            const result = getReportDisplayOption(report, undefined, undefined, customPersonalDetails, undefined);
        ...
        it('should handle empty personalDetails gracefully', () => {
            ...
            // When we call getReportDisplayOption
            const result = getReportDisplayOption(report, undefined, undefined, emptyPersonalDetails, undefined);
        ...
        it('should handle undefined report gracefully', () => {
            ...
            const result = getReportDisplayOption(undefined, undefined, undefined, personalDetails, undefined);
    ...
    describe('getReportOption', () => {
        ...
        it('should handle self DM reports correctly', async () => {
            ...
            const option = getReportOption(participant, undefined, undefined, POLICY, personalDetails);
    ...
    describe('getReportDisplayOption', () => {
        ...
        it('should use personalDetails to populate participant display names', async () => {
            ...
            const option = getReportOption(participant, undefined, undefined, POLICY, testPersonalDetails);
        ...
        it('should fall back gracefully when personalDetails is undefined', async () => {
            ...
            const option = getReportOption(participant, undefined, undefined, POLICY, undefined);
    ...
    describe('getPolicyExpenseReportOption', () => {
        it('should return option with policy expense chat details', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, translateLocal, testPersonalDetails);
        ...
        it('should handle empty personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, translateLocal, {});
        ...
        it('should handle undefined personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, translateLocal, undefined);
        ...
        it('should preserve selected state from participant', async () => {
            ...
            const optionSelected = getPolicyExpenseReportOption(participantSelected, undefined, translateLocal, {});

            // eslint-disable-next-line rulesdir/no-negated-variables
            const optionNotSelected = getPolicyExpenseReportOption(participantNotSelected, undefined, translateLocal, {});
