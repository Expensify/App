...
describe('OptionsListUtils', () => {
    ...
    describe('getSearchOptions()', () => {
        it('should return all options when no search value is provided', () => {
            ...
            const results = getSearchOptions({options: OPTIONS, draftComments: {}, nvpDismissedProductTraining, betas: [CONST.BETAS.ALL], policyTags: undefined});
    ...
    describe('getValidOptions()', () => {
        it('should return empty options when no reports or personal details are provided', () => {
            ...
            // When we call getValidOptions()
            const results = getValidOptions({reports: [], personalDetails: []}, {}, nvpDismissedProductTraining, undefined);
        ...
        it('should include Concierge by default in results', () => {
            ...
            // When we call getValidOptions()
            const results = getValidOptions({reports: OPTIONS_WITH_CONCIERGE.reports, personalDetails: OPTIONS_WITH_CONCIERGE.personalDetails}, {}, nvpDismissedProductTraining, undefined);
        ...
        it('should exclude Chronos when excludedLogins is specified', () => {
            ...
            // When we call getValidOptions()
            const results = getValidOptions({reports: OPTIONS_WITH_CHRONOS.reports, personalDetails: OPTIONS_WITH_CHRONOS.personalDetails}, {}, nvpDismissedProductTraining, undefined, {
        ...
        it('should keep admin rooms if specified', () => {
            ...
            const results = getValidOptions({reports: [adminRoom], personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined, {
        ...
        it('should include brickRoadIndicator if showRBR is true', () => {
            ...
            const results = getValidOptions({reports: [workspaceChat], personalDetails: []}, {}, nvpDismissedProductTraining, undefined, {
                includeMultipleParticipantReports: true,
                showRBR: true,
            });
        ...
        it('should mark unread report as bold when shouldUnreadBeBold is true', async () => {
            ...
            const results = getValidOptions({reports: [inputOption], personalDetails: []}, {}, nvpDismissedProductTraining, undefined, {
                includeRecentReports: true,
    ...
    describe('getValidOptions() for chat room', () => {
        it('should include all reports by default', () => {
            ...
            // When we call getValidOptions()
            const results = getValidOptions(OPTIONS_WITH_WORKSPACE_ROOM, {}, nvpDismissedProductTraining, undefined, {
                includeRecentReports: true,
                includeMultipleParticipantReports: true,
                includeP2P: true,
    ...
    describe('getValidOptions() for group Chat', () => {
        it('should exclude users with recent reports from personalDetails', () => {
            ...
            const results = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined);
        ...
        it('should show all reports when maxRecentReportElements is not specified', () => {
            ...
            const resultsWithoutLimit = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined);
            const resultsWithLimit = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined, {
    ...
    describe('getShareDestinationsOptions()', () => {
        it('should exclude archived rooms and hidden threads from share destinations', () => {
            ...
            const results = getValidOptions({reports: filteredReports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined, {
                betas: [],
                includeMultipleParticipantReports: true,
        ...
        it('should include DMS, group chats, and workspace rooms in share destinations', () => {
            ...
            // When we call getValidOptions for share destination with an empty search value
            const results = getValidOptions({reports: filteredReportsWithWorkspaceRooms, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined, {
                betas: [],
                includeMultipleParticipantReports: true,
                showChatPreviewLine: true,
                forcePolicyNamePreview: true,
    ...
    describe('getMemberInviteOptions()', () => {
        it('should sort personal details alphabetically', () => {
            ...
            const results = getMemberInviteOptions(OPTIONS.personalDetails, nvpDismissedProductTraining, undefined, []);
    ...
    describe('filterAndOrderOptions()', () => {
        it('should return all options when search is empty', () => {
            // Given a set of options
            // When we call getSearchOptions with all betas
            const options = getSearchOptions({options: OPTIONS, draftComments: {}, nvpDismissedProductTraining, betas: [CONST.BETAS.ALL], policyTags: undefined});
            // When we pass the returned options to filterAndOrderOptions with an empty search value
            const filteredOptions = filterAndOrderOptions(options, '', COUNTRY_CODE, undefined);
        ...
        it('should return filtered options in correct order', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined, {sortByReportTypeInSearch: true});
        ...
        it('should filter users by email', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined);
        ...
        it('should filter options by email if dot is skipped in the email', () => {
            ...
            // When we call getSearchOptions with all betas
            const options = getSearchOptions({options: OPTIONS_WITH_PERIODS, draftComments: {}, nvpDismissedProductTraining, betas: [CONST.BETAS.ALL], policyTags: undefined});
            // When we pass the returned options to filterAndOrderOptions with a search value and sortByReportTypeInSearch param
            const filteredOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined, {sortByReportTypeInSearch: true});
        ...
        it('should include workspace rooms in the search results', () => {
            ...
            // When we call getSearchOptions with all betas
            const options = getSearchOptions({options: OPTIONS_WITH_WORKSPACE_ROOM, draftComments: {}, nvpDismissedProductTraining, betas: [CONST.BETAS.ALL], policyTags: undefined});
            // When we pass the returned options to filterAndOrderOptions with a search value
            const filteredOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined);
        ...
        it('should prioritize options with matching display name over chat rooms', () => {
            ...
            // When we call getSearchOptions with all betas
            const options = getSearchOptions({options: OPTIONS_WITH_CHAT_ROOMS, draftComments: {}, nvpDismissedProductTraining, betas: [CONST.BETAS.ALL], policyTags: undefined});
            // When we pass the returned options to filterAndOrderOptions with a search value
            const filterOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined);
        ...
        it('should put the item with latest lastVisibleActionCreated on top when search value match multiple items', () => {
            ...
            // Given a set of options
            const options = getSearchOptions({options: OPTIONS, draftComments: {}, nvpDismissedProductTraining, policyTags: undefined});
        ...
        it('should not return any results if the search value is on an excluded logins list', () => {
            ...
            const options = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined, {
                excludeLogins: CONST.EXPENSIFY_EMAILS_OBJECT,
            });
            // When we call filterAndOrderOptions with a search value and excluded logins list
            const filterOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined, {excludeLogins: CONST.EXPENSIFY_EMAILS_OBJECT});
        ...
        it('should return the user to invite when the search value is a valid, non-existent email and the user is not excluded', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined, {excludeLogins: CONST.EXPENSIFY_EMAILS_OBJECT});
        ...
        it('should return limited amount of recent reports if the limit is set', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined, {maxRecentReportsToShow: 2});
            ...
            const limitToZeroOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, undefined, {maxRecentReportsToShow: 0});
        ...
        it('should not return any options if search value does not match any personal details (getMemberInviteOptions)', () => {
            // Given a set of options
            const options = getMemberInviteOptions(OPTIONS.personalDetails, nvpDismissedProductTraining, undefined, []);
            // When we call filterAndOrderOptions with a search value that does not match any personal details
            const filteredOptions = filterAndOrderOptions(options, 'magneto', COUNTRY_CODE, undefined);
        ...
        it('should return one personal detail if search value matches an email (getMemberInviteOptions)', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'peterparker@expensify.com', COUNTRY_CODE, undefined);
        ...
        it('should not show any recent reports if a search value does not match the group chat name (getShareDestinationsOptions)', () => {
            ...
            const options = getValidOptions({reports: filteredReports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined, {
                betas: [],
                includeMultipleParticipantReports: true,
                showChatPreviewLine: true,
                forcePolicyNamePreview: true,
            ...
            const filteredOptions = filterAndOrderOptions(options, 'mutants', COUNTRY_CODE, undefined);
        ...
        it('should return a workspace room when we search for a workspace room(getShareDestinationsOptions)', () => {
            ...
            // When we call getValidOptions for share destination with the filteredReports
            const options = getValidOptions({reports: filteredReportsWithWorkspaceRooms, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined, {
                betas: [],
                includeMultipleParticipantReports: true,
                showChatPreviewLine: true,
                forcePolicyNamePreview: true,
            ...
            const filteredOptions = filterAndOrderOptions(options, 'Avengers Room', COUNTRY_CODE, undefined);
        ...
        it('should not show any results if searching for a non-existing workspace room(getShareDestinationOptions)', () => {
            ...
            // When we pass the returned options to filterAndOrderOptions with a search value that does not match the group chat name
            const filteredOptions = filterAndOrderOptions(options, 'Mutants Lair', COUNTRY_CODE, undefined);
        ...
        it('should show the option from personal details when searching for personal detail with no existing report', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'hulk', COUNTRY_CODE, undefined);
        ...
        it('should not return any options or user to invite if there are no search results and the string does not match a potential email or phone', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'marc@expensify', COUNTRY_CODE, undefined);
        ...
        it('should not return any options but should return an user to invite if no matching options exist and the search value is a potential email', () => {
            ...
            const options = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined);
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports
            const filteredOptions = filterAndOrderOptions(options, 'marc@expensify.com', COUNTRY_CODE, undefined);
        ...
        it('should return user to invite when search term has a period with options for it that do not contain the period', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'peter.parker@expensify.com', COUNTRY_CODE, undefined);
        ...
        it('should return user which has displayName with accent mark when search value without accent mark', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'Timothee', COUNTRY_CODE, undefined);
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number', () => {
            ...
            const options = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined);
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = filterAndOrderOptions(options, '5005550006', COUNTRY_CODE, undefined);
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number with country code added', () => {
            ...
            const options = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined);
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = filterAndOrderOptions(options, '+15005550006', COUNTRY_CODE, undefined);
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number with special characters added', () => {
            ...
            const options = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined);
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = filterAndOrderOptions(options, '+1 (800)324-3233', COUNTRY_CODE, undefined);
        ...
        it('should not return any options or user to invite if contact number contains alphabet characters', () => {
            ...
            const options = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined);
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports
            const filteredOptions = filterAndOrderOptions(options, '998243aaaa', COUNTRY_CODE, undefined);
        ...
        it('should return one recent report and no personal details if a search value provides an email', () => {
            ...
            const options = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, undefined);
            // When we call filterAndOrderOptions with a search value that matches an email
            const filteredOptions = filterAndOrderOptions(options, 'peterparker@expensify.com', COUNTRY_CODE, undefined, {sortByReportTypeInSearch: true});
        ...
        it('should return all matching reports and personal details', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, '.com', COUNTRY_CODE, undefined, {maxRecentReportsToShow: 5});
        ...
        it('should return matching option when searching (getSearchOptions)', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'spider', COUNTRY_CODE, undefined);
        ...
        it('should return latest lastVisibleActionCreated item on top when search value matches multiple items (getSearchOptions)', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'fantastic', COUNTRY_CODE, undefined);
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    const OPTIONS_WITH_PERIODS = createOptionList(PERSONAL_DETAILS_WITH_PERIODS, undefined, REPORTS) as OptionList;
                    // When we call getSearchOptions
                    const results = getSearchOptions({options: OPTIONS_WITH_PERIODS, draftComments: {}, nvpDismissedProductTraining, policyTags: undefined});
                    // When we pass the returned options to filterAndOrderOptions with a search value
                    const filteredResults = filterAndOrderOptions(results, 'barry.allen@expensify.com', COUNTRY_CODE, undefined, {sortByReportTypeInSearch: true});
        ...
        it('should order self dm always on top if the search matches with the self dm login', () => {
            ...
            const options = getSearchOptions({options: OPTIONS_WITH_SELF_DM, draftComments: {}, nvpDismissedProductTraining, betas: [CONST.BETAS.ALL], policyTags: undefined});
            // When we call filterAndOrderOptions with a search value
            const filteredOptions = filterAndOrderOptions(options, searchTerm, COUNTRY_CODE, undefined);
    ...
    describe('getLastMessageTextForReport', () => {
        describe('REPORT_PREVIEW action', () => {
            it('should show report preview message for non-policy expense chat', async () => {
                ...
                const lastMessage = getLastMessageTextForReport({report, lastActorDetails: null, isReportArchived: false, policyTags: undefined});
