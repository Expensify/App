...
describe('OptionsListUtils', () => {
    ...
    describe('canCreateOptimisticPersonalDetailOption()', () => {
        ...
        it('createFilteredOptionList() localization', async () => {
            ...
            const reports = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, allPolicies, CURRENT_USER_ACCOUNT_ID, {
                conciergeReportID: undefined,
                isSearching: true,
            }).reports;
    ...
    describe('Alternative text', () => {
        it("The text should not contain the last actor's name at prefix if the report is archived.", async () => {
            ...
            const reports = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, archivedMap, undefined, CURRENT_USER_ACCOUNT_ID, {
                conciergeReportID: undefined,
                isSearching: true,
            }).reports;
    ...
    describe('createFilteredOptionList()', () => {
        ...
        it('should not set private_isArchived on personal details options when privateIsArchivedMap is empty', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, emptyMap, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined, isSearching: true});
        ...
        it('should set private_isArchived on report options when privateIsArchivedMap is provided', () => {
            ...
            // When we call createFilteredOptionList with this privateIsArchivedMap
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, privateIsArchivedMap, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
        ...
        it('should not set private_isArchived from map when privateIsArchivedMap is empty', () => {
            ...
            // When we call createFilteredOptionList with an empty privateIsArchivedMap
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, emptyMap, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
    ...
    describe('createOptionFromReport', () => {
        ...
        it('should create an option from a report with all required parameters', () => {
            ...
            const result = createOptionFromReport({report, personalDetails: PERSONAL_DETAILS, privateIsArchived: undefined, policy: undefined, sortedActions, conciergeReportID: undefined});
        ...
        it('should mark report as archived when privateIsArchived is provided', () => {
            ...
            const result = createOptionFromReport({report, personalDetails: PERSONAL_DETAILS, privateIsArchived: true, policy: undefined, sortedActions, conciergeReportID: undefined});
    ...
    describe('createFilteredOptionList', () => {
        ...
        it('should return report options limited by maxRecentReports', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined, maxRecentReports: 5});
        ...
        it('should include personal details when includeP2P is true', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined, includeP2P: true});
        ...
        it('should exclude personal details when includeP2P is false', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined, includeP2P: false});
        ...
        it('should handle empty reports collection', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, {}, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
        ...
        it('should handle undefined reports collection', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, undefined, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
        ...
        it('should use privateIsArchivedMap to determine archived status', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, reportsCollection, undefined, privateIsArchivedMap, undefined, CURRENT_USER_ACCOUNT_ID, {
                conciergeReportID: undefined,
                maxRecentReports: 10,
            });
        ...
        it('should handle isSearching filtering', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined, isSearching: true});
        ...
        it('should return both reports and personal details', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
        ...
        it('should keep top-level fields of returned options mutable while the cached entry stays pristine', () => {
            const first = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
            ...
            const second = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
        ...
        it('should recompute cached options when only conciergeReportID changes', () => {
            const first = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
            const second = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: '1'});
        ...
        it('should throw when a nested object shared with the cache is mutated', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID, {conciergeReportID: undefined});
    ...
    describe('policy parameter passing', () => {
        ...
        it('createOptionFromReport should accept policy parameter', () => {
            ...
            const result = createOptionFromReport({report, personalDetails: PERSONAL_DETAILS, privateIsArchived: undefined, policy: POLICY, sortedActions, conciergeReportID: undefined});
            expect(result).toBeDefined();
