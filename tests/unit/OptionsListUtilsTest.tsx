...
describe('OptionsListUtils', () => {
    ...
    describe('getValidOptions() with lazy contact options', () => {
        ...
        it('should handle empty personal details', () => {
            ...
            const {options: results} = getValidOptions(lazyList, allPolicies, {}, loginList, CURRENT_USER_ACCOUNT_ID, CURRENT_USER_EMAIL, undefined, {}, translateLocal);
