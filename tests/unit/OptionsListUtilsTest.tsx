...
describe('OptionsListUtils', () => {
    ...
    beforeAll(async () => {
        ...
        OPTIONS = createOptionList(PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, EMPTY_PRIVATE_IS_ARCHIVED_MAP, REPORTS, undefined, MOCK_REPORT_ATTRIBUTES_DERIVED);
    ...
    describe('filterAndOrderOptions()', () => {
        ...
        it('should filter options by email if dot is skipped in the email', () => {
            ...
            const OPTIONS_WITH_PERIODS = createOptionList(PERSONAL_DETAILS_WITH_PERIODS, CURRENT_USER_ACCOUNT_ID, EMPTY_PRIVATE_IS_ARCHIVED_MAP, REPORTS, undefined);
            // When we call getSearchOptions with all betas
            const options = getSearchOptions({
        ...
        it('should find group chat when searching by participant display name', () => {
            ...
            const OPTIONS_WITH_GROUP_CHAT = createOptionList(PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, EMPTY_PRIVATE_IS_ARCHIVED_MAP, REPORTS_WITH_GROUP_CHAT, undefined);
        ...
        it('should order self dm always on top if the search matches with the self dm login', () => {
            ...
            const OPTIONS_WITH_SELF_DM = createOptionList(PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, EMPTY_PRIVATE_IS_ARCHIVED_MAP, REPORTS_WITH_SELF_DM, undefined);
    ...
    describe('canCreateOptimisticPersonalDetailOption()', () => {
        ...
        it('createOptionList() localization', () => {
            ...
            const reports = createOptionList(PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, EMPTY_PRIVATE_IS_ARCHIVED_MAP, REPORTS, undefined).reports;
    ...
    describe('Alternative text', () => {
        ...
        it('should set private_isArchived on personal details options when privateIsArchivedMap is provided', () => {
            ...
            const result = createOptionList(PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, privateIsArchivedMap, REPORTS, undefined);
        ...
        it('should not set private_isArchived when privateIsArchivedMap is empty', () => {
            ...
            const result = createOptionList(PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, emptyMap, REPORTS, undefined);
    ...
    describe('createFilteredOptionList()', () => {
        ...
        it('should not set private_isArchived from map when privateIsArchivedMap is empty', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, CURRENT_USER_ACCOUNT_ID, undefined, emptyMap, undefined);
    ...
    describe('createOption', () => {
        ...
        it('should work correctly when reports collection with chatReport is passed', async () => {
            ...
            const result = createOption([1, 2], PERSONAL_DETAILS, report, 1, chatReport, undefined);
    ...
    describe('getReportDisplayOption', () => {
        ...
        it('should return option with isSelfDM alternateText when report is a self DM', () => {
            ...
            const result = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, personalDetails, undefined, undefined, undefined);
        ...
        it('should return option with unknownUserDetails when provided', () => {
            ...
            // When we call getReportDisplayOption
            const result = getReportDisplayOption(report, unknownUserDetails, CURRENT_USER_ACCOUNT_ID, personalDetails, undefined, undefined, undefined);
        ...
        it('should use personalDetails parameter instead of Onyx.connect data', () => {
            ...
            const result = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, customPersonalDetails, undefined, undefined, undefined);
        ...
        it('should handle empty personalDetails gracefully', () => {
            ...
            // When we call getReportDisplayOption
            const result = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, emptyPersonalDetails, undefined, undefined, undefined);
        ...
        it('should handle undefined report gracefully', () => {
            ...
            const result = getReportDisplayOption(undefined, undefined, CURRENT_USER_ACCOUNT_ID, personalDetails, undefined, undefined, undefined);
    ...
    describe('getReportDisplayOption', () => {
        it('should use reportNameValuePair parameter for archived reports', async () => {
            ...
            const option = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, PERSONAL_DETAILS, reportNameValuePair?.private_isArchived, undefined, undefined);
        ...
        it('should handle undefined reportNameValuePair', async () => {
            ...
            const option = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, PERSONAL_DETAILS, undefined, undefined, undefined);
    ...
    describe('getPolicyExpenseReportOption', () => {
        it('should return option with policy expense chat details', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, CURRENT_USER_ACCOUNT_ID, testPersonalDetails, report, undefined, undefined);
        ...
        it('should handle empty personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, CURRENT_USER_ACCOUNT_ID, {}, report, undefined, undefined);
        ...
        it('should handle undefined personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, CURRENT_USER_ACCOUNT_ID, undefined, report, undefined, undefined);
        ...
        it('should preserve selected state from participant', async () => {
            ...
            const optionSelected = getPolicyExpenseReportOption(participantSelected, undefined, CURRENT_USER_ACCOUNT_ID, {}, report, undefined, undefined);

            // eslint-disable-next-line rulesdir/no-negated-variables
            const optionNotSelected = getPolicyExpenseReportOption(participantNotSelected, undefined, CURRENT_USER_ACCOUNT_ID, {}, report, undefined, undefined);
    ...
    describe('getPolicyExpenseReportOption with privateIsArchived', () => {
        it('should set private_isArchived on the option when privateIsArchived is provided', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, archivedTimestamp, CURRENT_USER_ACCOUNT_ID, testPersonalDetails, report, undefined, undefined);
    ...
    describe('reports parameter functionality', () => {
        ...
        it('createOption should look up chatReport from reports collection when report has chatReportID', async () => {
            ...
            const result = createOption([1, 2], PERSONAL_DETAILS, expenseReport, CURRENT_USER_ACCOUNT_ID, linkedChatReport, undefined);
        ...
        it('getReportDisplayOption should use reports parameter to look up chat report', async () => {
            ...
            const option = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, PERSONAL_DETAILS, undefined, chatReport, undefined);
        ...
        it('getPolicyExpenseReportOption should use reports parameter correctly', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, CURRENT_USER_ACCOUNT_ID, PERSONAL_DETAILS, report, undefined, undefined);
    ...
    describe('createOptionFromReport', () => {
        ...
        it('should mark report as archived when privateIsArchived is provided', () => {
            ...
            const result = createOptionFromReport(report, PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, undefined, privateIsArchived, undefined);
        ...
        it('should accept reportAttributesDerived parameter', () => {
            ...
            const result = createOptionFromReport(report, PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, undefined, undefined, undefined, undefined);
        ...
        it('should apply config options when provided', () => {
            ...
            const result = createOptionFromReport(report, PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, undefined, undefined, undefined, undefined, config);
    ...
    describe('createFilteredOptionList', () => {
        it('should return report options limited by maxRecentReports', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, CURRENT_USER_ACCOUNT_ID, undefined, {}, undefined, {maxRecentReports: 5});
        ...
        it('should sort reports by lastVisibleActionCreated (most recent first)', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, reportsWithDates, CURRENT_USER_ACCOUNT_ID, undefined, {}, undefined, {maxRecentReports: 3});

            expect(result.reports.length).toBeGreaterThan(0);
        });

        it('should include personal details when includeP2P is true', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, CURRENT_USER_ACCOUNT_ID, undefined, {}, undefined, {includeP2P: true});
        ...
        it('should exclude personal details when includeP2P is false', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, CURRENT_USER_ACCOUNT_ID, undefined, {}, undefined, {includeP2P: false});
        ...
        it('should handle empty reports collection', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, {}, CURRENT_USER_ACCOUNT_ID, undefined, {}, undefined);
        ...
        it('should handle undefined reports collection', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, undefined, CURRENT_USER_ACCOUNT_ID, undefined, {}, undefined);
        ...
        it('should use privateIsArchivedMap to determine archived status', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, reportsCollection, CURRENT_USER_ACCOUNT_ID, undefined, privateIsArchivedMap, undefined, {maxRecentReports: 10});
        ...
        it('should return both reports and personal details', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, CURRENT_USER_ACCOUNT_ID, undefined, {}, undefined);
    ...
    describe('policy parameter passing', () => {
        it('createOptionList should accept policiesCollection parameter', () => {
            const result = createOptionList(PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, EMPTY_PRIVATE_IS_ARCHIVED_MAP, REPORTS, allPolicies, MOCK_REPORT_ATTRIBUTES_DERIVED);
            expect(result).toBeDefined();
        ...
        it('createFilteredOptionList should accept policiesCollection parameter', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, CURRENT_USER_ACCOUNT_ID, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, allPolicies);
            expect(result).toBeDefined();
            expect(result.reports).toBeDefined();
            expect(result.personalDetails).toBeDefined();
        });
        ...
        it('createOptionFromReport should accept policy parameter', () => {
            ...
            const result = createOptionFromReport(report, PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, undefined, undefined, POLICY);
            expect(result).toBeDefined();
        ...
        it('getReportDisplayOption should accept policy parameter', () => {
            ...
            const result = getReportDisplayOption(report, undefined, CURRENT_USER_ACCOUNT_ID, PERSONAL_DETAILS, undefined, undefined, POLICY);
            expect(result).toBeDefined();
            expect(result.policyID).toBe(policyID);
        });
        ...
        it('getPolicyExpenseReportOption should accept policy parameter', () => {
            ...
            const result = getPolicyExpenseReportOption(participant, undefined, CURRENT_USER_ACCOUNT_ID, PERSONAL_DETAILS, report, undefined, POLICY);
            expect(result).toBeDefined();
            expect(result.policyID).toBe(policyID);
        });

        it('formatSectionsFromSearchTerm should accept policy parameter', () => {
            const result = formatSectionsFromSearchTerm('', [], [], [], {}, CURRENT_USER_ACCOUNT_ID, POLICY, PERSONAL_DETAILS, true);
            expect(result).toBeDefined();
