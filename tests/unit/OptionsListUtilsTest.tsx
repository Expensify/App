...
describe('OptionsListUtils', () => {
    ...
    describe('getReportOption', () => {
        ...
        it('should return option with correct workspace name when policy is provided', async () => {
            ...
            const option = getReportOption(participant, undefined, policy, undefined, undefined, CURRENT_USER_ACCOUNT_ID, {});
        ...
        it('should handle self DM reports correctly', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, undefined, undefined, CURRENT_USER_ACCOUNT_ID, personalDetails);
        ...
        it('should return option with correct text for workspace chat', async () => {
            ...
            const option = getReportOption(participant, reportNameValuePair?.private_isArchived, POLICY, undefined, undefined, CURRENT_USER_ACCOUNT_ID, {});
        ...
        it('should handle draft reports', async () => {
            ...
            const option = getReportOption(participant, reportNameValuePair?.private_isArchived, POLICY, undefined, undefined, CURRENT_USER_ACCOUNT_ID, {}, undefined, draftReports);
    ...
    describe('getReportDisplayOption', () => {
        ...
        it('should handle policy parameter being null', async () => {
            ...
            const option = getReportOption(participant, undefined, undefined, undefined, undefined, CURRENT_USER_ACCOUNT_ID, {});
        ...
        it('should include receiver policy in policies lookup for invoice reports', async () => {
            ...
            const option = getReportOption(participant, undefined, senderPolicy, receiverPolicy, undefined, CURRENT_USER_ACCOUNT_ID, undefined);
        ...
        it('should include chat receiver policy in policies lookup for invoice reports with chat report', async () => {
            ...
            const option = getReportOption(participant, undefined, senderPolicy, undefined, chatReceiverPolicy, CURRENT_USER_ACCOUNT_ID, undefined);

            expect(option).toBeDefined();
            expect(option.isInvoiceRoom).toBe(true);
        });
        it('should include all policies in policies lookup when both receiverPolicy and chatReceiverPolicy are provided', async () => {
            const reportID = '112';
            const senderPolicyID = 'senderPolicy3';
            const receiverPolicyID = 'receiverPolicy3';
            const chatReceiverPolicyID = 'chatReceiverPolicy3';
            const senderPolicy: Policy = {
                id: senderPolicyID,
                name: 'Sender Workspace 3',
                role: 'admin',
                type: CONST.POLICY.TYPE.TEAM,
                owner: 'sender3@test.com',
                outputCurrency: 'USD',
                approvalMode: CONST.POLICY.APPROVAL_MODE.OPTIONAL,
                isPolicyExpenseChatEnabled: true,
            };
            const receiverPolicy: Policy = {
                id: receiverPolicyID,
                name: 'Receiver Workspace 3',
                role: 'admin',
                type: CONST.POLICY.TYPE.TEAM,
                owner: 'receiver3@test.com',
                outputCurrency: 'USD',
                approvalMode: CONST.POLICY.APPROVAL_MODE.OPTIONAL,
                isPolicyExpenseChatEnabled: true,
            };
            const chatReceiverPolicy: Policy = {
                id: chatReceiverPolicyID,
                name: 'Chat Receiver Workspace 3',
                role: 'admin',
                type: CONST.POLICY.TYPE.TEAM,
                owner: 'chatreceiver3@test.com',
                outputCurrency: 'USD',
                approvalMode: CONST.POLICY.APPROVAL_MODE.OPTIONAL,
                isPolicyExpenseChatEnabled: true,
            };
            ...
            // Test with both receiverPolicy and chatReceiverPolicy provided
            const option = getReportOption(participant, undefined, senderPolicy, receiverPolicy, chatReceiverPolicy, CURRENT_USER_ACCOUNT_ID, undefined);
        ...
        it('should use personalDetails to populate participant display names', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, undefined, undefined, CURRENT_USER_ACCOUNT_ID, testPersonalDetails);
        ...
        it('should fall back gracefully when personalDetails is undefined', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, undefined, undefined, CURRENT_USER_ACCOUNT_ID, undefined);
    ...
    describe('createOptionFromReport', () => {
        it('should create an option from a report with all required parameters', () => {
            ...
            const result = createOptionFromReport(report, PERSONAL_DETAILS, CURRENT_USER_ACCOUNT_ID, undefined);
