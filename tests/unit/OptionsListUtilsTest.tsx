...
describe('OptionsListUtils', () => {
    ...
    describe('getPolicyExpenseReportOption', () => {
        it('should return option with policy expense chat details', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, testPersonalDetails);
        ...
        it('should handle undefined personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, undefined);
        ...
        it('should preserve selected state from participant', async () => {
            ...
            const optionSelected = getPolicyExpenseReportOption(participantSelected, undefined, {});

            // eslint-disable-next-line rulesdir/no-negated-variables
            const optionNotSelected = getPolicyExpenseReportOption(participantNotSelected, undefined, {});
