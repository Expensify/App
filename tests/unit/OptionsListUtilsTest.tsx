...
describe('OptionsListUtils', () => {
    ...
    describe('filterAndOrderOptions()', () => {
        ...
        it('should not return userToInvite for plain text name when shouldAcceptName is false', () => {
            // Given a set of options
            const options = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, {}, nvpDismissedProductTraining, undefined, translateLocal, loginList, {
                includeUserToInvite: true,
            });

            // When we call filterAndOrderOptions with a plain text name (not email or phone) without shouldAcceptName
            const filteredOptions = filterAndOrderOptions(options, 'Jeff Amazon', translateLocal, COUNTRY_CODE, loginList, {shouldAcceptName: false});
        ...
        it('should return userToInvite for plain text name when shouldAcceptName is true', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'Jeff', translateLocal, COUNTRY_CODE, loginList, {shouldAcceptName: true});
