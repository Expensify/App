...
describe('OptionsListUtils', () => {
    ...
    describe('getLastMessageTextForReport', () => {
        ...
        it('MOVED_TRANSACTION action', async () => {
            ...
            expect(lastMessage).toBe(Parser.htmlToText(getMovedTransactionMessage(translateLocal, movedTransactionAction, undefined, undefined, undefined)));
        });
        it('MOVED_TRANSACTION action with policy uses policy for report name', async () => {
            ...
            expect(lastMessage).toBe(Parser.htmlToText(getMovedTransactionMessage(translateLocal, movedTransactionActionWithPolicy, policy, undefined, undefined)));
        });
