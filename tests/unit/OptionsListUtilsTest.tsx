...
describe('OptionsListUtils', () => {
    ...
    beforeAll(async () => {
        ...
        OPTIONS = createOptionList(PERSONAL_DETAILS, undefined, REPORTS);
        OPTIONS_WITH_CONCIERGE = createOptionList(PERSONAL_DETAILS_WITH_CONCIERGE, undefined, REPORTS_WITH_CONCIERGE);
        OPTIONS_WITH_CHRONOS = createOptionList(PERSONAL_DETAILS_WITH_CHRONOS, undefined, REPORTS_WITH_CHRONOS);
        OPTIONS_WITH_RECEIPTS = createOptionList(PERSONAL_DETAILS_WITH_RECEIPTS, undefined, REPORTS_WITH_RECEIPTS);
        OPTIONS_WITH_WORKSPACE_ROOM = createOptionList(PERSONAL_DETAILS, undefined, REPORTS_WITH_WORKSPACE_ROOMS);
        OPTIONS_WITH_MANAGER_MCTEST = createOptionList(PERSONAL_DETAILS_WITH_MANAGER_MCTEST, undefined);
    });
    ...
    describe('getSearchOptions()', () => {
        it('should return all options when no search value is provided', () => {
            ...
            const results = getSearchOptions({
                ...
                currentUserEmail: 'tonystark@expensify.com',
            });
    ...
    describe('orderOptions()', () => {
        it('should sort options alphabetically and preserves reportID for personal details with existing reports', () => {
            ...
            let results: Pick<Options, 'personalDetails' | 'recentReports'> = getValidOptions(
                ...
                nvpDismissedProductTraining,
                loginList,
                {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'},
            );
    ...
    describe('getValidOptions()', () => {
        it('should return empty options when no reports or personal details are provided', () => {
            ...
            // When we call getValidOptions()
            const results = getValidOptions({reports: [], personalDetails: []}, {}, nvpDismissedProductTraining, loginList, {
                currentUserAccountID: 2,
                currentUserEmail: 'tonystark@expensify.com',
            });
        ...
        it('should include Concierge by default in results', () => {
            ...
            // When we call getValidOptions()
            const results = getValidOptions({reports: OPTIONS_WITH_CONCIERGE.reports, personalDetails: OPTIONS_WITH_CONCIERGE.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
                currentUserAccountID: 2,
                currentUserEmail: 'tonystark@expensify.com',
            });
        ...
        it('should exclude Chronos when excludedLogins is specified', () => {
            ...
            // When we call getValidOptions()
            const results = getValidOptions({reports: OPTIONS_WITH_CHRONOS.reports, personalDetails: OPTIONS_WITH_CHRONOS.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    const optionsWhenUserAlreadySubmittedExpense = getValidOptions(
                        ...
                        nvpDismissedProductTraining,
                        loginList,
                        {includeP2P: true, canShowManagerMcTest: true, betas: [CONST.BETAS.NEWDOT_MANAGER_MCTEST], currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'},
                    );
        ...
        it('should keep admin rooms if specified', () => {
            ...
            const results = getValidOptions({reports: [adminRoom], personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
        ...
        it('should include brickRoadIndicator if showRBR is true', () => {
            ...
            const results = getValidOptions({reports: [workspaceChat], personalDetails: []}, {}, nvpDismissedProductTraining, loginList, {
                includeMultipleParticipantReports: true,
                showRBR: true,
                currentUserAccountID: 2,
                currentUserEmail: 'tonystark@expensify.com',
        ...
        it('should mark unread report as bold when shouldUnreadBeBold is true', async () => {
            ...
            const results = getValidOptions({reports: [inputOption], personalDetails: []}, {}, nvpDismissedProductTraining, loginList, {
                includeRecentReports: true,
    ...
    describe('getValidOptions() for chat room', () => {
        it('should include all reports by default', () => {
            ...
            // When we call getValidOptions()
            const results = getValidOptions(OPTIONS_WITH_WORKSPACE_ROOM, {}, nvpDismissedProductTraining, loginList, {
                includeRecentReports: true,
                includeMultipleParticipantReports: true,
                includeP2P: true,
    ...
    describe('getValidOptions() for group Chat', () => {
        ...
        it('should show all reports when maxRecentReportElements is not specified', () => {
            ...
            const resultsWithoutLimit = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
                currentUserAccountID: 2,
                currentUserEmail: 'tonystark@expensify.com',
            });
            const resultsWithLimit = getValidOptions({reports: OPTIONS.reports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
    ...
    describe('getShareDestinationsOptions()', () => {
        it('should exclude archived rooms and hidden threads from share destinations', () => {
            ...
            const results = getValidOptions({reports: filteredReports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
                betas: [],
                includeMultipleParticipantReports: true,
        ...
        it('should include DMS, group chats, and workspace rooms in share destinations', () => {
            ...
            // When we call getValidOptions for share destination with an empty search value
            const results = getValidOptions({reports: filteredReportsWithWorkspaceRooms, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
                betas: [],
                includeMultipleParticipantReports: true,
                showChatPreviewLine: true,
                forcePolicyNamePreview: true,
    ...
    describe('getMemberInviteOptions()', () => {
        it('should sort personal details alphabetically', () => {
            ...
            const results = getMemberInviteOptions(OPTIONS.personalDetails, nvpDismissedProductTraining, loginList, 2, 'tonystark@expensify.com', [], {}, false, COUNTRY_CODE);
    ...
    describe('getLastActorDisplayName()', () => {
        it('should return correct display name', () => {
            ...
            // When we call getLastActorDisplayName with currentUserAccountID = 2
            const result1 = getLastActorDisplayName(PERSONAL_DETAILS['2'], 2);
            const result2 = getLastActorDisplayName(PERSONAL_DETAILS['3'], 2);
    ...
    describe('shouldShowLastActorDisplayName()', () => {
        it('should return false when lastReportAction is not available', () => {
            ...
            const result = shouldShowLastActorDisplayName(report, lastActorDetails, undefined, 2);
        ...
        it('should return false when lastActorDetails is null', () => {
            ...
            const result = shouldShowLastActorDisplayName(report, null, lastAction, 2);
            expect(result).toBe(false);
        });
        ...
        it('should return false when report is a self DM', () => {
            ...
            const result = shouldShowLastActorDisplayName(report, lastActorDetails, lastAction, 2);
            expect(result).toBe(false);
        });
    ...
    describe('filterAndOrderOptions()', () => {
        it('should return all options when search is empty', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, '', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should return filtered options in correct order', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, loginList, {
                currentUserAccountID: 2,
        ...
        it('should filter users by email', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should filter options by email if dot is skipped in the email', () => {
            ...
            const OPTIONS_WITH_PERIODS = createOptionList(PERSONAL_DETAILS_WITH_PERIODS, undefined, REPORTS);
            // When we call getSearchOptions with all betas
            const options = getSearchOptions({
        ...
        it('should prioritize options with matching display name over chat rooms', () => {
            ...
            const OPTIONS_WITH_CHAT_ROOMS = createOptionList(PERSONAL_DETAILS, undefined, REPORTS_WITH_CHAT_ROOM);
            // When we call getSearchOptions with all betas
            const options = getSearchOptions({
            ...
            // When we pass the returned options to filterAndOrderOptions with a search value
            const filterOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should not return any results if the search value is on an excluded logins list', () => {
            ...
            const filterOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, loginList, {
                currentUserAccountID: 2,
                excludeLogins: CONST.EXPENSIFY_EMAILS_OBJECT,
                currentUserEmail: 'tonystark@expensify.com',
            });
        ...
        it('should return limited amount of recent reports if the limit is set', () => {
            ...
            const limitToZeroOptions = filterAndOrderOptions(options, searchText, COUNTRY_CODE, loginList, {
                currentUserAccountID: 2,
        ...
        it('should not return any options if search value does not match any personal details (getMemberInviteOptions)', () => {
            // Given a set of options
            const options = getMemberInviteOptions(OPTIONS.personalDetails, nvpDismissedProductTraining, loginList, 2, 'tonystark@expensify.com', [], {}, false, COUNTRY_CODE);
            // When we call filterAndOrderOptions with a search value that does not match any personal details
            const filteredOptions = filterAndOrderOptions(options, 'magneto', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should return one personal detail if search value matches an email (getMemberInviteOptions)', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'peterparker@expensify.com', COUNTRY_CODE, loginList, {
                currentUserAccountID: 2,
                currentUserEmail: 'tonystark@expensify.com',
            });
        ...
        it('should not show any recent reports if a search value does not match the group chat name (getShareDestinationsOptions)', () => {
            ...
            const options = getValidOptions({reports: filteredReports, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
                betas: [],
                includeMultipleParticipantReports: true,
                showChatPreviewLine: true,
                forcePolicyNamePreview: true,
            ...
            const filteredOptions = filterAndOrderOptions(options, 'mutants', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should return a workspace room when we search for a workspace room(getShareDestinationsOptions)', () => {
            ...
            // When we call getValidOptions for share destination with the filteredReports
            const options = getValidOptions({reports: filteredReportsWithWorkspaceRooms, personalDetails: OPTIONS.personalDetails}, {}, nvpDismissedProductTraining, loginList, {
                betas: [],
                includeMultipleParticipantReports: true,
                showChatPreviewLine: true,
                forcePolicyNamePreview: true,
            ...
            const filteredOptions = filterAndOrderOptions(options, 'Avengers Room', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should not show any results if searching for a non-existing workspace room(getShareDestinationOptions)', () => {
            ...
            // When we pass the returned options to filterAndOrderOptions with a search value that does not match the group chat name
            const filteredOptions = filterAndOrderOptions(options, 'Mutants Lair', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should show the option from personal details when searching for personal detail with no existing report', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'hulk', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should not return any options or user to invite if there are no search results and the string does not match a potential email or phone', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'marc@expensify', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should not return any options but should return an user to invite if no matching options exist and the search value is a potential email', () => {
            ...
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports
            const filteredOptions = filterAndOrderOptions(options, 'marc@expensify.com', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should return user to invite when search term has a period with options for it that do not contain the period', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'peter.parker@expensify.com', COUNTRY_CODE, loginList, {
                currentUserAccountID: 2,
                currentUserEmail: 'tonystark@expensify.com',
            });
        ...
        it('should return user which has displayName with accent mark when search value without accent mark', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'Timothee', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number', () => {
            ...
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = filterAndOrderOptions(options, '5005550006', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number with country code added', () => {
            ...
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = filterAndOrderOptions(options, '+15005550006', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should not return options but should return an user to invite if no matching options exist and the search value is a potential phone number with special characters added', () => {
            ...
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports but matches user to invite
            const filteredOptions = filterAndOrderOptions(options, '+1 (800)324-3233', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should not return any options or user to invite if contact number contains alphabet characters', () => {
            ...
            // When we call filterAndOrderOptions with a search value that does not match any personal details or reports
            const filteredOptions = filterAndOrderOptions(options, '998243aaaa', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should return all matching reports and personal details', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, '.com', COUNTRY_CODE, loginList, {
                currentUserAccountID: 2,
        ...
        it('should return matching option when searching (getSearchOptions)', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'spider', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
        ...
        it('should return latest lastVisibleActionCreated item on top when search value matches multiple items (getSearchOptions)', () => {
            ...
            const filteredOptions = filterAndOrderOptions(options, 'fantastic', COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    // When we pass the returned options to filterAndOrderOptions with a search value
                    const filteredResults = filterAndOrderOptions(results, 'barry.allen@expensify.com', COUNTRY_CODE, loginList, {
                        currentUserAccountID: 2,
                        sortByReportTypeInSearch: true,
                        currentUserEmail: 'tonystark@expensify.com',
                    });
        ...
        it('should order self dm always on top if the search matches with the self dm login', () => {
            ...
            const OPTIONS_WITH_SELF_DM = createOptionList(PERSONAL_DETAILS, undefined, REPORTS_WITH_SELF_DM);
            ...
            // When we call filterAndOrderOptions with a search value
            const filteredOptions = filterAndOrderOptions(options, searchTerm, COUNTRY_CODE, loginList, {currentUserAccountID: 2, currentUserEmail: 'tonystark@expensify.com'});
    ...
    describe('canCreateOptimisticPersonalDetailOption()', () => {
        ...
        it('createOptionList() localization', () => {
            ...
            const reports = createOptionList(PERSONAL_DETAILS, undefined, REPORTS).reports;
            ...
            return (
                waitForBatchedUpdates()
                    ...
                    .then(() => {
                        ...
                        const newReports = createOptionList(PERSONAL_DETAILS, undefined, REPORTS).reports;
    ...
    describe('createOption', () => {
        it('should return alternative text correctly when the last action is report preview action', async () => {
            ...
            const result = createOption([1, 2], PERSONAL_DETAILS, report, undefined, {showChatPreviewLine: true});
    ...
    describe('getLastMessageTextForReport', () => {
        describe('REPORT_PREVIEW action', () => {
            it('should show report preview message for non-policy expense chat', async () => {
                ...
                const lastMessage = getLastMessageTextForReport({report, lastActorDetails: null, isReportArchived: false, currentUserAccountID: undefined});
        ...
        describe('DEW (Dynamic External Workflow)', () => {
            ...
            it('should show queued message for SUBMITTED action with DEW policy when offline and pending submit', async () => {
                ...
                const lastMessage = getLastMessageTextForReport({report, lastActorDetails: null, isReportArchived: false, policy, reportMetadata, currentUserAccountID: undefined});
    ...
    describe('getPersonalDetailSearchTerms', () => {
        it('should include display name', () => {
            ...
            const searchTerms = getPersonalDetailSearchTerms({displayName}, 2);
            expect(searchTerms.includes(displayName)).toBe(true);
            const searchTerms2 = getPersonalDetailSearchTerms({participantsList: [{displayName, accountID: 123}]}, 2);
    ...
    describe('getReportOption', () => {
        ...
        it('should return option with correct workspace name when policy is provided', async () => {
            ...
            const option = getReportOption(participant, policy, undefined);
