...
describe('OptionsListUtils', () => {
    ...
    describe('getLastMessageTextForReport', () => {
        ...
        describe('canonical money request preview fallback', () => {
            ...
            it('should use the linked transaction merchant when the canonical money request has no comment', async () => {
                const report: Report = {
                    ...createRandomReport(0, undefined),
                    reportID: 'expense-report-merchant-fallback',
                    type: CONST.REPORT.TYPE.EXPENSE,
                    currency: CONST.CURRENCY.USD,
                    transactionCount: 1,
                };
                const createdAction: ReportAction = {
                    ...createRandomReportAction(19),
                    reportID: report.reportID,
                    actionName: CONST.REPORT.ACTIONS.TYPE.CREATED,
                    message: [{type: 'COMMENT', text: ''}],
                    originalMessage: {},
                ...
                const moneyRequestAction: ReportAction = {
                    ...
                    reportID: report.reportID,
                    actionName: CONST.REPORT.ACTIONS.TYPE.IOU,
                    created: '2026-04-01 17:00:00.000',
                    message: [{type: 'COMMENT', text: ''}],
                    originalMessage: {
                        amount: 0,
                        currency: CONST.CURRENCY.USD,
                ...
                expect(lastMessage).toBe('$0.00 for Coffee');
            });

            it('should use the linked transaction amount when the canonical money request amount is stale', async () => {
                const report: Report = {
                    ...createRandomReport(0, undefined),
                    reportID: 'expense-report-edited-amount',
                    type: CONST.REPORT.TYPE.EXPENSE,
                    currency: CONST.CURRENCY.USD,
                    transactionCount: 1,
                };
                ...
                const moneyRequestAction: ReportAction = {
                    ...
                    reportID: report.reportID,
                    actionName: CONST.REPORT.ACTIONS.TYPE.IOU,
                    created: '2026-04-01 18:00:00.000',
                    message: [{type: 'COMMENT', text: ''}],
                    originalMessage: {
                        amount: -1000,
                        currency: CONST.CURRENCY.USD,
                ...
                expect(lastMessage).toBe('-$25.00 for Coffee');
            });
