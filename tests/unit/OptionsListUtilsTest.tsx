...
describe('OptionsListUtils', () => {
    ...
    beforeAll(async () => {
        ...
        OPTIONS = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, MOCK_REPORT_ATTRIBUTES_DERIVED, EMPTY_PRIVATE_IS_ARCHIVED_MAP, allPolicies, CURRENT_USER_ACCOUNT_ID, {
            isSearching: true,
        });
    ...
    describe('filterAndOrderOptions()', () => {
        ...
        it('should find archived chats', () => {
            ...
            const OPTIONS_WITH_ARCHIVED = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, MOCK_REPORT_ATTRIBUTES_DERIVED, archivedMap, undefined, CURRENT_USER_ACCOUNT_ID, {
                isSearching: true,
            });
            // When we call getSearchOptions with all betas
            const {options} = getSearchOptions({
        ...
        it('should filter options by email if dot is skipped in the email', () => {
            ...
            const OPTIONS_WITH_PERIODS = createFilteredOptionList(PERSONAL_DETAILS_WITH_PERIODS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID, {
                isSearching: true,
            });
            // When we call getSearchOptions with all betas
            const {options} = getSearchOptions({
        ...
        it('should order self dm always on top if the search matches with the self dm login', () => {
            ...
            const OPTIONS_WITH_SELF_DM = createFilteredOptionList(PERSONAL_DETAILS, REPORTS_WITH_SELF_DM, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID, {
                isSearching: true,
            });
    ...
    describe('canCreateOptimisticPersonalDetailOption()', () => {
        ...
        it('createFilteredOptionList() localization', async () => {
            ...
            const reports = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, allPolicies, CURRENT_USER_ACCOUNT_ID, {isSearching: true}).reports;
            ...
            const newReports = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, allPolicies, CURRENT_USER_ACCOUNT_ID, {
                isSearching: true,
            }).reports;
    ...
    describe('Alternative text', () => {
        it("The text should not contain the last actor's name at prefix if the report is archived.", async () => {
            ...
            const reports = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, archivedMap, undefined, CURRENT_USER_ACCOUNT_ID, {isSearching: true}).reports;
    ...
    describe('createFilteredOptionList()', () => {
        it('should set private_isArchived on personal details options when privateIsArchivedMap is provided', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, privateIsArchivedMap, undefined, CURRENT_USER_ACCOUNT_ID, {isSearching: true});
        ...
        it('should not set private_isArchived on personal details options when privateIsArchivedMap is empty', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, emptyMap, undefined, CURRENT_USER_ACCOUNT_ID, {isSearching: true});
        ...
        it('should set private_isArchived on report options when privateIsArchivedMap is provided', () => {
            ...
            // When we call createFilteredOptionList with this privateIsArchivedMap
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, privateIsArchivedMap, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should not set private_isArchived from map when privateIsArchivedMap is empty', () => {
            ...
            // When we call createFilteredOptionList with an empty privateIsArchivedMap
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, emptyMap, undefined, CURRENT_USER_ACCOUNT_ID);
    ...
    describe('getReportDisplayOption', () => {
        ...
        it('should return option with isSelfDM alternateText when report is a self DM', () => {
            ...
            const result = getReportDisplayOption(report, undefined, personalDetails, undefined, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should return option with unknownUserDetails when provided', () => {
            ...
            // When we call getReportDisplayOption
            const result = getReportDisplayOption(report, unknownUserDetails, personalDetails, undefined, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should use personalDetails parameter instead of Onyx.connect data', () => {
            ...
            const result = getReportDisplayOption(report, undefined, customPersonalDetails, undefined, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle empty personalDetails gracefully', () => {
            ...
            // When we call getReportDisplayOption
            const result = getReportDisplayOption(report, undefined, emptyPersonalDetails, undefined, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle undefined report gracefully', () => {
            ...
            const result = getReportDisplayOption(undefined, undefined, personalDetails, undefined, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
    ...
    describe('getValidOptions with policies parameter', () => {
        ...
        it('should work with undefined policies', () => {
            ...
            const {options: results} = getValidOptions(options, undefined, undefined, loginList, CURRENT_USER_ACCOUNT_ID, CURRENT_USER_EMAIL, undefined, {}, translateLocal);
        ...
        it('should work with empty policies collection', () => {
            const options = {reports: [], personalDetails: []};
            const {options: results} = getValidOptions(options, {}, undefined, loginList, CURRENT_USER_ACCOUNT_ID, CURRENT_USER_EMAIL, undefined, {}, translateLocal);
    ...
    describe('getReportOption', () => {
        it('should return option with correct workspace name when policy is provided', async () => {
            ...
            const option = getReportOption(participant, undefined, policy, {}, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should show submits to info when policy has approval workflow', async () => {
            ...
            const option = getReportOption(participant, undefined, policy, personalDetails, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should mark draft reports as disabled', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, {}, undefined, undefined, report, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should return option with correct text for workspace chat', async () => {
            ...
            const option = getReportOption(participant, !!reportNameValuePair?.private_isArchived, POLICY, {}, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should handle draft reports', async () => {
            ...
            const option = getReportOption(participant, !!reportNameValuePair?.private_isArchived, POLICY, {}, undefined, {}, draftReport, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should disable option when reportDraft is explicitly passed', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, {}, undefined, undefined, draftReport, CONST.DEFAULT_NUMBER_ID, translateLocal);
    ...
    describe('getReportDisplayOption', () => {
        it('should use reportNameValuePair parameter for archived reports', async () => {
            ...
            const option = getReportDisplayOption(report, undefined, PERSONAL_DETAILS, !!reportNameValuePair?.private_isArchived, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle undefined reportNameValuePair', async () => {
            ...
            const option = getReportDisplayOption(report, undefined, PERSONAL_DETAILS, undefined, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle policy parameter being null', async () => {
            ...
            const option = getReportOption(participant, undefined, undefined, {}, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should use personalDetails to populate participant display names', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, testPersonalDetails, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should fall back gracefully when personalDetails is undefined', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, undefined, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should accept conciergeReportID and create a valid option', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, {}, conciergeReportID, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should use Concierge display name in lastMessageText when conciergeReportID matches a referenced report', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, testPersonalDetails, conciergeReportID, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
        ...
        it('should not treat report as concierge chat when conciergeReportID does not match reportID', async () => {
            ...
            const optionWithConcierge = getReportOption(participant, undefined, POLICY, {}, differentConciergeReportID, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
            const optionWithoutConcierge = getReportOption(participant, undefined, POLICY, {}, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal);
    ...
    describe('getPolicyExpenseReportOption', () => {
        it('should return option with policy expense chat details', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, testPersonalDetails, report, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('routes the workspace subtitle through the injected translate function', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, {}, report, undefined, translateWithMarker, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle empty personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, {}, report, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle undefined personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, undefined, report, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should preserve selected state from participant', async () => {
            ...
            const optionSelected = getPolicyExpenseReportOption(participantSelected, undefined, {}, report, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);

            // eslint-disable-next-line rulesdir/no-negated-variables
            const optionNotSelected = getPolicyExpenseReportOption(participantNotSelected, undefined, {}, report, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should return a valid option when called with different currentUserAccountID values', async () => {
            ...
            const optionWithCurrentUser = getPolicyExpenseReportOption(participant, undefined, testPersonalDetails, report, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
            const optionWithDifferentUser = getPolicyExpenseReportOption(participant, undefined, testPersonalDetails, report, undefined, translateLocal, 9999);
    ...
    describe('getPolicyExpenseReportOption with privateIsArchived', () => {
        it('should set private_isArchived on the option when privateIsArchived is provided', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, true, testPersonalDetails, report, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
    ...
    describe('reports parameter functionality', () => {
        ...
        it('getPolicyExpenseReportOption should use reports parameter correctly', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, PERSONAL_DETAILS, report, undefined, translateLocal, CURRENT_USER_ACCOUNT_ID);
    ...
    describe('createFilteredOptionList', () => {
        ...
        it('returns the most recent reports when maxRecentReports is less than the input size', () => {
            ...
            const result = createFilteredOptionList({}, reportsToCollection(reports), undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {maxRecentReports: 2, includeP2P: false});
        ...
        it('prioritizes self-DM over newer non-self-DM reports', () => {
            ...
            const result = createFilteredOptionList({}, reportsToCollection(reports), undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {maxRecentReports: 1, includeP2P: false});
        ...
        it('prioritizes non-archived reports over newer archived reports', () => {
            ...
            const result = createFilteredOptionList({}, reportsToCollection(reports), undefined, privateIsArchivedMap, undefined, CURRENT_USER_ACCOUNT_ID, {
                maxRecentReports: 1,
                includeP2P: false,
            });
        ...
        it('returns all reports when isSearching is true', () => {
            ...
            const result = createFilteredOptionList({}, reportsToCollection(reports), undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {
                maxRecentReports: 1,
                isSearching: true,
                includeP2P: false,
            });
        ...
        it('returns an empty array when maxRecentReports is zero', () => {
            ...
            const result = createFilteredOptionList({}, reportsToCollection(reports), undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {maxRecentReports: 0, includeP2P: false});

            expect(result.reports).toEqual([]);
        });
        it('should return report options limited by maxRecentReports', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {maxRecentReports: 5});
        ...
        it('should sort reports by lastVisibleActionCreated (most recent first)', () => {
            ...
            const result = createFilteredOptionList({}, Object.fromEntries(reportsWithDates.map((report) => [report.reportID, report])), undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {
                maxRecentReports: 3,
                includeP2P: false,
            });
        ...
        it('should include personal details when includeP2P is true', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {includeP2P: true});
        ...
        it('should exclude personal details when includeP2P is false', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {includeP2P: false});
        ...
        it('should handle empty reports collection', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, {}, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle undefined reports collection', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, undefined, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should use privateIsArchivedMap to determine archived status', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, reportsCollection, undefined, privateIsArchivedMap, undefined, CURRENT_USER_ACCOUNT_ID, {maxRecentReports: 10});

            expect(result).toBeDefined();
        });

        it('should handle isSearching filtering', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {isSearching: true});
        ...
        it('should return all reports when isSearching is true', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, {}, CURRENT_USER_ACCOUNT_ID, {
                isSearching: true,
                maxRecentReports: 2,
            });
        ...
        it('should return both reports and personal details', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should not build personal details when deferContactsUntilSearch is true and not searching', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {deferContactsUntilSearch: true});
        ...
        it('should build personal details when deferContactsUntilSearch is true and searching', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, CURRENT_USER_ACCOUNT_ID, {deferContactsUntilSearch: true, isSearching: true});

            expect(result.personalDetails.length).toBeGreaterThan(0);
        });

        it('should keep top-level fields of returned options mutable while the cached entry stays pristine', () => {
            const first = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID);
            ...
            const second = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should throw when a nested object shared with the cache is mutated', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, CURRENT_USER_ACCOUNT_ID);
    ...
    describe('policy parameter passing', () => {
        it('createFilteredOptionList should accept policiesCollection parameter', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, allPolicies, CURRENT_USER_ACCOUNT_ID);
            expect(result).toBeDefined();
        ...
        it('getReportDisplayOption should accept policy parameter', () => {
            ...
            const result = getReportDisplayOption(report, undefined, PERSONAL_DETAILS, undefined, POLICY, translateLocal, CURRENT_USER_ACCOUNT_ID);
            expect(result).toBeDefined();
            expect(result.policyID).toBe(policyID);
        });
        ...
        it('getPolicyExpenseReportOption should accept policy parameter', () => {
            ...
            const result = getPolicyExpenseReportOption(participant, undefined, PERSONAL_DETAILS, report, POLICY, translateLocal, CURRENT_USER_ACCOUNT_ID);
            expect(result).toBeDefined();
            expect(result.policyID).toBe(policyID);
        });
