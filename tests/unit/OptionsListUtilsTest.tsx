...
describe('OptionsListUtils', () => {
    ...
    beforeAll(async () => {
        ...
        OPTIONS_WITH_CONCIERGE = createFilteredOptionList(
            ...
            undefined,
            {dateFnsLocale: undefined, conciergeReportID: undefined, isSearching: true},
        );
    ...
    describe('createFilteredOptionList()', () => {
        ...
        it('should not set private_isArchived on personal details options when privateIsArchivedMap is empty', () => {
            ...
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, emptyMap, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined, isSearching: true});
        ...
        it('should set private_isArchived on report options when privateIsArchivedMap is provided', () => {
            ...
            // When we call createFilteredOptionList with this privateIsArchivedMap
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, privateIsArchivedMap, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
        ...
        it('should not set private_isArchived from map when privateIsArchivedMap is empty', () => {
            ...
            // When we call createFilteredOptionList with an empty privateIsArchivedMap
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, emptyMap, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
    ...
    describe('getReportOption', () => {
        it('should return option with correct workspace name when policy is provided', async () => {
            ...
            const option = getReportOption(participant, undefined, policy, {}, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
        ...
        it('should title a self DM with "<display name> (you)" even when the derived report name is empty', async () => {
            ...
            const option = getReportOption({reportID}, undefined, undefined, selfPersonalDetails, undefined, undefined, undefined, ownerAccountID, translateLocal, undefined);
        ...
        it('should show submits to info when policy has approval workflow', async () => {
            ...
            const option = getReportOption(participant, undefined, policy, personalDetails, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
        ...
        it('should mark draft reports as disabled', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, {}, undefined, undefined, report, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
        ...
        it('should disable option when reportDraft is explicitly passed', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, {}, undefined, undefined, draftReport, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
    ...
    describe('getReportDisplayOption', () => {
        ...
        it('should handle policy parameter being null', async () => {
            ...
            const option = getReportOption(participant, undefined, undefined, {}, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
        ...
        it('should use personalDetails to populate participant display names', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, testPersonalDetails, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
        ...
        it('should fall back gracefully when personalDetails is undefined', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, undefined, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
        ...
        it('should accept conciergeReportID and create a valid option', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, {}, conciergeReportID, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
        ...
        it('should use Concierge display name in lastMessageText when conciergeReportID matches a referenced report', async () => {
            ...
            const option = getReportOption(participant, undefined, POLICY, testPersonalDetails, conciergeReportID, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
        ...
        it('should not treat report as concierge chat when conciergeReportID does not match reportID', async () => {
            ...
            const optionWithoutConcierge = getReportOption(participant, undefined, POLICY, {}, undefined, undefined, undefined, CONST.DEFAULT_NUMBER_ID, translateLocal, undefined);
    ...
    describe('getPolicyExpenseReportOption', () => {
        it('should return option with policy expense chat details', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, testPersonalDetails, report, undefined, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('routes the workspace subtitle through the injected translate function', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, {}, report, undefined, translateWithMarker, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle empty personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, {}, report, undefined, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should handle undefined personalDetails gracefully', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, undefined, report, undefined, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should preserve selected state from participant', async () => {
            ...
            const optionSelected = getPolicyExpenseReportOption(participantSelected, undefined, {}, report, undefined, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);

            // eslint-disable-next-line rulesdir/no-negated-variables
            const optionNotSelected = getPolicyExpenseReportOption(participantNotSelected, undefined, {}, report, undefined, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);
        ...
        it('should return a valid option when called with different currentUserAccountID values', async () => {
            ...
            const optionWithCurrentUser = getPolicyExpenseReportOption(participant, undefined, testPersonalDetails, report, undefined, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);
            const optionWithDifferentUser = getPolicyExpenseReportOption(participant, undefined, testPersonalDetails, report, undefined, translateLocal, undefined, 9999);
    ...
    describe('getPolicyExpenseReportOption with privateIsArchived', () => {
        it('should set private_isArchived on the option when privateIsArchived is provided', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, true, testPersonalDetails, report, undefined, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);
    ...
    describe('reports parameter functionality', () => {
        ...
        it('getPolicyExpenseReportOption should use reports parameter correctly', async () => {
            ...
            const option = getPolicyExpenseReportOption(participant, undefined, PERSONAL_DETAILS, report, undefined, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);
    ...
    describe('createFilteredOptionList', () => {
        ...
        it('should return report options limited by maxRecentReports', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined, maxRecentReports: 5});
        ...
        it('should include personal details when includeP2P is true', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined, includeP2P: true});
        ...
        it('should exclude personal details when includeP2P is false', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined, includeP2P: false});
        ...
        it('should handle empty reports collection', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, {}, undefined, {}, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
        ...
        it('should handle undefined reports collection', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, undefined, undefined, {}, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
        ...
        it('should handle isSearching filtering', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined, isSearching: true});
        ...
        it('should return all reports when isSearching is true', () => {
            const result = createFilteredOptionList(
                ...
                {},
                {},
                {dateFnsLocale: undefined, conciergeReportID: undefined, isSearching: true, maxRecentReports: 2},
            );
        ...
        it('should return both reports and personal details', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, {}, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
        ...
        it('should keep top-level fields of returned options mutable while the cached entry stays pristine', () => {
            const first = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
            ...
            const second = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
        ...
        it('should recompute cached options when only conciergeReportID changes', () => {
            const first = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
            const second = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, {dateFnsLocale: undefined, conciergeReportID: '1'});
        ...
        it('should throw when a nested object shared with the cache is mutated', () => {
            const result = createFilteredOptionList(PERSONAL_DETAILS, REPORTS, undefined, EMPTY_PRIVATE_IS_ARCHIVED_MAP, undefined, {dateFnsLocale: undefined, conciergeReportID: undefined});
    ...
    describe('policy parameter passing', () => {
        ...
        it('getPolicyExpenseReportOption should accept policy parameter', () => {
            ...
            const result = getPolicyExpenseReportOption(participant, undefined, PERSONAL_DETAILS, report, POLICY, translateLocal, undefined, CURRENT_USER_ACCOUNT_ID);
            expect(result).toBeDefined();
            expect(result.policyID).toBe(policyID);
        });
