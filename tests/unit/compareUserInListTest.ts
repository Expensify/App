...
describe('compareUserInList', () => {
    it('Should compare the weight if the weight is different', () => {
        ...
        expect(compareUserInList(first, second, formatPhoneNumber)).toBe(-1);
        expect(compareUserInList(second, first, formatPhoneNumber)).toBe(1);
    });
    ...
    it('Should compare the displayName if the weight is the same', () => {
        ...
        expect(compareUserInList(first, second, formatPhoneNumber)).toBe(-1);
        expect(compareUserInList(first, third, formatPhoneNumber)).toBe(-1);
        expect(compareUserInList(second, third, formatPhoneNumber)).toBe(-1);

        expect(compareUserInList(second, first, formatPhoneNumber)).toBe(1);
        expect(compareUserInList(third, first, formatPhoneNumber)).toBe(1);
        expect(compareUserInList(third, second, formatPhoneNumber)).toBe(1);
    });
