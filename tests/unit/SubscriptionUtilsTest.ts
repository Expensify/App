...
describe('SubscriptionUtils', () => {
    ...
    describe('getSubscriptionStatus', () => {
        ...
        it('should return undefined by default', () => {
            ...
            expect(getSubscriptionStatus(stripeCustomerIdForDefault, undefined, undefined, undefined, undefined)).toBeUndefined();
        });
        ...
        it('should return POLICY_OWNER_WITH_AMOUNT_OWED status', async () => {
            ...
            expect(getSubscriptionStatus(stripeCustomerId, false, undefined, undefined, undefined)).toEqual({
        ...
        it('should return BILLING_DISPUTE_PENDING status', async () => {
            ...
            expect(getSubscriptionStatus(stripeCustomerId, false, 1, undefined, undefined)).toEqual({
        ...
        it('should return CARD_AUTHENTICATION_REQUIRED status', async () => {
            ...
            expect(getSubscriptionStatus(stripeCustomerId, false, 0, undefined, undefined)).toEqual({
        ...
        it('should return INSUFFICIENT_FUNDS status', async () => {
            ...
            expect(getSubscriptionStatus(stripeCustomerId, false, undefined, undefined, BILLING_STATUS_INSUFFICIENT_FUNDS)).toEqual({
        ...
        it('should return CARD_EXPIRED status', async () => {
            ...
            // @ts-expect-error - This is a test case
            expect(getSubscriptionStatus(stripeCustomerIdForCardExpired, undefined, undefined, undefined, BILLING_STATUS_EXPIRED_CARD)).toEqual({
        ...
        it('should return CARD_EXPIRE_SOON status', async () => {
            ...
            // @ts-expect-error - This is a test case
            expect(getSubscriptionStatus(stripeCustomerIdForCardExpireSoon, undefined, undefined, undefined, {})).toEqual({
