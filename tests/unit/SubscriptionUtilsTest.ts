...
describe('SubscriptionUtils', () => {
    ...
    describe('shouldRestrictUserBillableActions', () => {
        ...
        it("should return false if the user is the workspace's owner but is not past due billing", async () => {
            ...
            expect(shouldRestrictUserBillableActions(policyID, getUnixTime(addDays(new Date(), 3)), undefined, undefined, policy, accountID)).toBeFalsy();
        });
        ...
        it("should return false if the user is the workspace's owner that is past due billing but isn't owning any amount", async () => {
            ...
            expect(shouldRestrictUserBillableActions(policyID, getUnixTime(subDays(new Date(), 3)), undefined, undefined, policy, accountID)).toBeFalsy();
        });
        ...
        it("should return true if the user is the workspace's owner that is past due billing and is owning some amount", async () => {
            ...
            expect(shouldRestrictUserBillableActions(policyID, getUnixTime(subDays(new Date(), 3)), undefined, undefined, policy, accountID)).toBeTruthy();
        });
        ...
        it('should restrict when amountOwed is passed directly and is greater than 0', async () => {
            ...
            expect(shouldRestrictUserBillableActions(policyID, getUnixTime(subDays(new Date(), 3)), undefined, 500, policy, accountID)).toBeTruthy();
        });
        ...
        it('should not restrict when amountOwed is passed directly as 0', async () => {
            ...
            expect(shouldRestrictUserBillableActions(policyID, getUnixTime(subDays(new Date(), 3)), undefined, 0, policy, accountID)).toBeFalsy();
        });
    ...
    describe('shouldRestrictUserBillableActions - policy parameter', () => {
        ...
        it('should use passed policy and ignore Onyx-stored policies', async () => {
            ...
            expect(shouldRestrictUserBillableActions(policyID, getUnixTime(subDays(new Date(), 3)), undefined, undefined, differentOwnerPolicy, accountID)).toBeFalsy();
        });
    });
