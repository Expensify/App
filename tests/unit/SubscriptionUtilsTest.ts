...
describe('SubscriptionUtils', () => {
    ...
    describe('getSubscriptionStatus', () => {
        ...
        it('should return undefined by default', () => {
            ...
            expect(getSubscriptionStatus(stripeCustomerIdForDefault, false, undefined, undefined, undefined)).toBeUndefined();
        });
        ...
        it('should return CARD_EXPIRED status', async () => {
            ...
            // @ts-expect-error - This is a test case
            expect(getSubscriptionStatus(stripeCustomerIdForCardExpired, false, undefined, undefined, undefined)).toEqual({
        ...
        it('should return RETRY_BILLING_SUCCESS status', async () => {
            ...
            // @ts-expect-error - This is a test case
            expect(getSubscriptionStatus(stripeCustomerIdForRetryBillingSuccess, true, undefined, undefined, {})).toEqual({
        ...
        it('should return RETRY_BILLING_ERROR status', async () => {
            ...
            // @ts-expect-error - This is a test case
            expect(getSubscriptionStatus(stripeCustomerIdForRetryBillingError, false, undefined, true, {})).toEqual({
