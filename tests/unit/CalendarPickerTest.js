...
describe('CalendarPicker', () => {
    ...
    test('displays the current month and year', () => {
        ...
        const {getByText} = render(<MockedCalendarPicker maxDate={maxDate} minDate={minDate} />);
    ...
    test('clicking next month arrow updates the displayed month', () => {
        ...
        const {getByTestId, getByText} = render(<MockedCalendarPicker minDate={minDate} maxDate={maxDate} />);
    ...
    test('clicking a day updates the selected date', () => {
        ...
        const {getByText} = render(<MockedCalendarPicker value={value} minDate={minDate} maxDate={maxDate} onSelected={onSelectedMock} />);
    ...
    test('clicking previous month arrow and selecting day updates the selected date', () => {
        ...
        const minDate = new Date('2022-01-01');
        const maxDate = new Date('2030-01-01');
        const {getByText, getByTestId} = render(<MockedCalendarPicker value={value} minDate={minDate} maxDate={maxDate} onSelected={onSelectedMock} />);
    ...
    test('should block the next arrow when there is no available dates in the next month', () => {
        ...
        const value = new Date('2003-02-17');
        const {getByTestId} = render(<MockedCalendarPicker maxDate={maxDate} value={value} />);
    ...
    test('should open the calendar on a month from max date if it is earlier than current month', () => {
        ...
        const {getByText} = render(<MockedCalendarPicker onSelected={onSelectedMock} maxDate={maxDate} />);
    ...
    test('should not allow to press earlier day than minDate', () => {
        ...
        const {getByLabelText} = render(<MockedCalendarPicker minDate={minDate} value={date} />);
    ...
    test('should not allow to press later day than max', () => {
        const date = new Date('2003-02-17');
        const maxDate = new Date('2003-02-24');
        const {getByLabelText} = render(<MockedCalendarPicker maxDate={maxDate} value={date} />);
