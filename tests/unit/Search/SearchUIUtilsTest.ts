...
describe('SearchUIUtils', () => {
    ...
    describe('Test createTypeMenuItems', () => {
        ...
        it('should generate correct routes', () => {
            ...
            const expectedQueries = ['type:expense sortBy:date sortOrder:desc', 'type:expense groupBy:reports sortBy:date sortOrder:desc', 'type:chat sortBy:date sortOrder:desc'];
