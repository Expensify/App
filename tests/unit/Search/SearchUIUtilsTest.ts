...
describe('SearchUIUtils', () => {
    ...
    describe('shouldShowSearchPageFooter', () => {
        test('Should always show footer for saved searches', () => {
            expect(
        ...
        test('Should show footer when there are results and not the default expenses search', () => {
            expect(
                SearchUIUtils.shouldShowSearchPageFooter({
                    isSavedSearch: false,
                    resultsCount: 10,
        ...
        test('Should not show footer when there are no results and nothing is selected', () => {
            expect(
                SearchUIUtils.shouldShowSearchPageFooter({
                    isSavedSearch: false,
                    resultsCount: 0,
