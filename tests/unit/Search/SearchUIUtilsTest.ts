...
describe('SearchUIUtils', () => {
    ...
    describe('Test createTypeMenuItems', () => {
        ...
        it('should generate correct routes', () => {
            ...
            const expectedQueries = ['type:expense sortBy:date sortOrder:desc', 'type:expense sortBy:date sortOrder:desc group-by:reports', 'type:chat sortBy:date sortOrder:desc'];
