...
describe('buildSubstitutionsMap should return correct substitutions map', () => {
    test('when there were no substitutions', () => {
        ...
        const result = buildSubstitutionsMap(userQuery, personalDetailsMock, reportsMock, taxRatesMock, {}, cardFeedsMock, {}, undefined, 12345);
    ...
    test('when query has a single substitution', () => {
        ...
        const result = buildSubstitutionsMap(userQuery, personalDetailsMock, reportsMock, taxRatesMock, {}, cardFeedsMock, {}, undefined, 11111);
    ...
    test('when query has multiple substitutions of different types', () => {
        ...
        const result = buildSubstitutionsMap(userQuery, personalDetailsMock, reportsMock, taxRatesMock, cardListMock, cardFeedsMock, {}, undefined, 11111);
    ...
    test('when query has a substitution for the current user', () => {
        ...
        const result = buildSubstitutionsMap(userQuery, personalDetailsMock, reportsMock, taxRatesMock, cardListMock, cardFeedsMock, {}, undefined, 12345);
