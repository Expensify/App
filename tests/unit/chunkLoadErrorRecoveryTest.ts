...
describe('ChunkLoadError recovery', () => {
    ...
    describe('usePageRefresh (web)', () => {
        it('calls clearWorkboxRecoveryCaches before reload when isChunkLoadError is true', async () => {
    ...
    describe('lazyRetry', () => {
        it('calls clearWorkboxRecoveryCaches before reload on the first chunk load failure', async () => {
