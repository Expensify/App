...
describe('Sidebar', () => {
    ...
    describe('in default mode', () => {
            ...
            return (
                waitForPromisesToResolve()
                    ...
                    .then(() => {
                        ...
                        expect(
                            lodashGet(displayNames, [2, 'props', 'children']),
                        ).toBe('One, Two');
                    })
            );
        });
        ...
        it('changes the order when adding a draft to the active report', () => {
            ...
            return (
                waitForPromisesToResolve()
                    ...
                    .then(() => {
                        const pencilIcon =
                            screen.getAllByAccessibilityHint('Pencil Icon');
                        ...
                        expect(
                            lodashGet(displayNames, [0, 'props', 'children']),
                        ).toBe('One, Two'); // this has `hasDraft` flag enabled so it will be on top
                        expect(
                            lodashGet(displayNames, [1, 'props', 'children']),
                        ).toBe('Five, Six');
                        expect(
        ...
        it('removes the pencil icon when draft is removed', () => {
            ...
            return (
                waitForPromisesToResolve()
                    ...
                    .then(() => {
                        expect(
                            screen.queryAllByAccessibilityHint('Pencil Icon'),
                        ).toHaveLength(0);
                    })
            );
        });
        ...
        it('removes the pin icon when chat is unpinned', () => {
            ...
            return (
                waitForPromisesToResolve()
                    ...
                    .then(() => {
                        expect(
                            screen.getAllByAccessibilityHint('Pin Icon'),
                        ).toHaveLength(1);
                    })
                    ...
                    .then(() => {
                        expect(
                            screen.queryAllByAccessibilityHint('Pin Icon'),
                        ).toHaveLength(0);
                    })
            );
        });
        ...
        it('alphabetizes all the chats that are pinned', () => {
            ...
            const report4 = {
                ...LHNTestUtils.getFakeReport(
                    ['email7@test.com', 'email8@test.com'],
                    0,
                ),
                isPinned: true,
            };
            ...
            return (
                waitForPromisesToResolve()
                    ...
                    .then(() =>
                        Onyx.merge(
                            `${ONYXKEYS.COLLECTION.REPORT}${report4.reportID}`,
                            report4,
                        ),
                    )
                    ...
                    .then(() => {
                        ...
                        expect(
                            lodashGet(displayNames, [3, 'props', 'children']),
                        ).toBe('Three, Four');
                    })
            );
        });
    ...
    describe('in #focus mode', () => {
        it('alphabetizes chats', () => {
            ...
            const report4 = LHNTestUtils.getFakeReport(
                ['email7@test.com', 'email8@test.com'],
                0,
                true,
            );
                ...
                waitForPromisesToResolve()
                    ...
                    .then(() =>
                        Onyx.multiSet({
                            ...
                            [`${ONYXKEYS.COLLECTION.REPORT}${report3.reportID}`]:
                                report3,
                            [`${ONYXKEYS.COLLECTION.REPORT}${iouReport1.reportID}`]:
                                iouReport1,
                            [`${ONYXKEYS.COLLECTION.REPORT}${iouReport2.reportID}`]:
                                iouReport2,
                            [`${ONYXKEYS.COLLECTION.REPORT}${iouReport3.reportID}`]:
                                iouReport3,
                        }),
                    )
