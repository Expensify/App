...
describe('MultifactorAuthentication Scenarios Config', () => {
    ...
    it('should have BIOMETRICS_TEST scenario properly configured', () => {
        ...
        expect(biometricsTestScenario.allowedAuthenticationMethods).toStrictEqual([CONST.MULTIFACTOR_AUTHENTICATION.TYPE.BIOMETRIC_HSM, CONST.MULTIFACTOR_AUTHENTICATION.TYPE.PASSKEYS]);
    ...
    describe('SET_PIN_ORDER_CARD scenario', () => {
        ...
        it('should have SET_PIN_ORDER_CARD scenario properly configured', () => {
            ...
            expect(setPinScenario.allowedAuthenticationMethods).toStrictEqual([CONST.MULTIFACTOR_AUTHENTICATION.TYPE.BIOMETRIC_HSM, CONST.MULTIFACTOR_AUTHENTICATION.TYPE.PASSKEYS]);
