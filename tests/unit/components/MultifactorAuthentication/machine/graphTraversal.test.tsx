...
// event added to the machine gains specs here without edits. The suites prove that every settleable
// leaf state is reachable, that the real modal UI follows every generated path, and that the
// generated coverage itself stays complete: leaves, UI-drivable transitions, and the per-state view
// config.
