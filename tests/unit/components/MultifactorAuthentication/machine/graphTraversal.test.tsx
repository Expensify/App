...
// settleable state is reachable; `settleableLeafStates.ts` defines which states count as settleable),
// the pinned endpoints of the driving journeys, the contract between the machine and the rendered
...
// Every generated expectation in this file follows the machine under test, so a retargeted transition
