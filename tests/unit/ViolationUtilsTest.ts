...
describe('getViolations', () => {
    ...
    it('should check if violation is dismissed or not', async () => {
        ...
        const isSmartScanDismissed = isViolationDismissed(transaction, smartScanFailedViolation, CARLOS_EMAIL);
        const isDuplicateViolationDismissed = isViolationDismissed(transaction, duplicatedTransactionViolation, CARLOS_EMAIL);
    ...
    it('should return filtered out dismissed violations', async () => {
        ...
        const filteredViolations = getTransactionViolations(transaction, transactionViolationsCollection, CARLOS_EMAIL);
