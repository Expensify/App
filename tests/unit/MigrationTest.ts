...
describe('Migrations', () => {
    ...
    describe('KeyReportActionsDraftByReportActionID', () => {
        ...
        it('Should move individual draft to a draft collection of report', () => {
            ...
            setQueries[`${ONYXKEYS.COLLECTION.REPORT_ACTIONS_DRAFTS}1_1`] = 'a' as unknown as OnyxInput<OnyxTypes.ReportActionsDrafts>;
            setQueries[`${ONYXKEYS.COLLECTION.REPORT_ACTIONS_DRAFTS}1_2`] = 'b' as unknown as OnyxInput<OnyxTypes.ReportActionsDrafts>;
            setQueries[`${ONYXKEYS.COLLECTION.REPORT_ACTIONS_DRAFTS}2`] = {3: 'c'};
            setQueries[`${ONYXKEYS.COLLECTION.REPORT_ACTIONS_DRAFTS}2_4`] = 'd' as unknown as OnyxInput<OnyxTypes.ReportActionsDrafts>;
        ...
        it("Shouldn't move empty individual draft to a draft collection of report", () => {
            ...
            setQueries[`${ONYXKEYS.COLLECTION.REPORT_ACTIONS_DRAFTS}1_1`] = '' as unknown as OnyxInput<OnyxTypes.ReportActionsDrafts>;
