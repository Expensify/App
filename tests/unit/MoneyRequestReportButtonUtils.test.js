...
var mockedReportID = reports_1.iouReportR14932.reportID;
jest.mock('@libs/ReportUtils', function () { return ({
    getNonHeldAndFullAmount: jest.fn().mockReturnValue({ nonHeldAmount: "$".concat(50, ".00"), hasValidNonHeldAmount: true, fullAmount: "$100.00", currency: 'USD' }),
...
jest.mock('@libs/CurrencyUtils', function () { return ({
    convertToDisplayString: jest.fn().mockImplementation(function (amountInCents) {
        if (amountInCents === void 0) { amountInCents = 0; }
        return "$".concat(amountInCents, ".00");
    }),
}); });
describe('ReportButtonUtils', function () {
    describe('getTotalAmountForIOUReportPreviewButton', function () {
        ...
        it('returns total reimbursable spend for PAY & total value for other buttons', function () {
