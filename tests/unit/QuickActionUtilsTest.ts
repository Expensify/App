    ...
    describe('isQuickActionAllowed', () => {
        describe('Preferred policy restrictions', () => {
            ...
            it('should restrict REQUEST action on DMs', () => {
                const withoutRestrictionsResult = isQuickActionAllowed(requestManualAction, DMReport, undefined, false, undefined, false);
                const withRestrictionsResult = isQuickActionAllowed(requestManualAction, DMReport, undefined, false, undefined, true);
            ...
            it('should restrict SPLIT action on DMs', () => {
                const withoutRestrictionsResult = isQuickActionAllowed(splitManualAction, DMReport, undefined, false, undefined, false);
                const withRestrictionsResult = isQuickActionAllowed(splitManualAction, DMReport, undefined, false, undefined, true);
            ...
            it('should restrict SEND_MONEY action on DMs', () => {
                const withoutRestrictionsResult = isQuickActionAllowed(sendMoneyAction, DMReport, undefined, false, undefined, false);
                const withRestrictionsResult = isQuickActionAllowed(sendMoneyAction, DMReport, undefined, false, undefined, true);
            ...
            it('should restrict SPLIT action on Group chats', () => {
                ...
                const withoutRestrictionsResult = isQuickActionAllowed(splitManualAction, groupChatReport, undefined, false, undefined, false);
                const withRestrictionsResult = isQuickActionAllowed(splitManualAction, groupChatReport, undefined, false, undefined, true);
            ...
            it('should restrict SPLIT action on user-created policy rooms', () => {
                ...
                const withoutRestrictionsResult = isQuickActionAllowed(splitManualAction, policyRoomReport, undefined, false, undefined, false);
                const withRestrictionsResult = isQuickActionAllowed(splitManualAction, policyRoomReport, undefined, false, undefined, true);
        ...
        describe('Policy with per diem', () => {
            ...
            it('should allow per diem action when policy has per diem rates', () => {
                ...
                expect(isQuickActionAllowed(perDiemAction, report, policy, false, undefined, false)).toBe(true);
            });
            it("should not allow per diem action when policy doesn't have per diem rates", () => {
                ...
                expect(isQuickActionAllowed(perDiemAction, report, policy, false, undefined, false)).toBe(false);
            });
