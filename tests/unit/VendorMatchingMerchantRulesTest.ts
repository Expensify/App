...
describe('Vendor matching on merchant rules', () => {
    ...
    describe('legacy MerchantRulesSection.getRuleDescription vendor summary', () => {
        ...
        const describeRule = (policy: Policy, vendorID: string) => getRuleDescription(buildVendorRule(policy, vendorID), translateLocal, buildLabels(policy), policy, undefined);
