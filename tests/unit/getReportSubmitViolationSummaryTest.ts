...
describe('getReportSubmitViolationSummary', () => {
    it('returns all-false/empty when there are no violations', () => {
        ...
        const summary = getReportSubmitViolationSummary([transaction('1')], {[violationsKey('1')]: []});
    ...
    it('flags a rejected expense violation', () => {
        ...
        const summary = getReportSubmitViolationSummary([transaction('1')], {[violationsKey('1')]: [violation(CONST.VIOLATIONS.AUTO_REPORTED_REJECTED_EXPENSE)]});
    ...
    it('flags a pending RTER card-match violation', () => {
        ...
        const summary = getReportSubmitViolationSummary([transaction('1')], {[violationsKey('1')]: [violation(CONST.VIOLATIONS.RTER, {pendingPattern: true})]});
    ...
    it('buckets a broken-connection RTER violation as an "other" violation instead of dropping it', () => {
        ...
        const summary = getReportSubmitViolationSummary([transaction('1')], {
    ...
    it('buckets any other violation name into otherViolationNames', () => {
        ...
        const summary = getReportSubmitViolationSummary([transaction('1')], {[violationsKey('1')]: [violation(CONST.VIOLATIONS.OVER_CATEGORY_LIMIT)]});
    ...
    it('aggregates violations across multiple transactions', () => {
        ...
        const summary = getReportSubmitViolationSummary([transaction('1'), transaction('2')], {
