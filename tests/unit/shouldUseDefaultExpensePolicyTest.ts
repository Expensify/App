...
describe('shouldUseDefaultExpensePolicy', () => {
    ...
    it('returns false when iouType is not CREATE', () => {
        ...
        expect(shouldUseDefaultExpensePolicy(CONST.IOU.TYPE.SUBMIT, policy, undefined, undefined, undefined, OWNER_ACCOUNT_ID)).toBeFalsy();
        expect(shouldUseDefaultExpensePolicy(CONST.IOU.TYPE.TRACK, policy, undefined, undefined, undefined, OWNER_ACCOUNT_ID)).toBeFalsy();
    });

    it('returns false when defaultExpensePolicy is null', () => {
        expect(shouldUseDefaultExpensePolicy(CONST.IOU.TYPE.CREATE, null, undefined, undefined, undefined, OWNER_ACCOUNT_ID)).toBeFalsy();
    });
    ...
    it('returns false when defaultExpensePolicy is not a paid group policy (personal type)', () => {
        ...
        expect(shouldUseDefaultExpensePolicy(CONST.IOU.TYPE.CREATE, policy, undefined, undefined, undefined, OWNER_ACCOUNT_ID)).toBeFalsy();
    });
    ...
    it('returns true when all conditions are met and user is not restricted', () => {
        const policy = makePaidGroupPolicy();
        expect(shouldUseDefaultExpensePolicy(CONST.IOU.TYPE.CREATE, policy, undefined, undefined, undefined, OWNER_ACCOUNT_ID)).toBeTruthy();
    });
