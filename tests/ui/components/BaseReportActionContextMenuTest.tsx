...
describe('BaseReportActionContextMenu hold/unhold action', () => {
    ...
    it('calls unholdRequest when pressing the unhold action', async () => {
        ...
        expect(mockUnholdRequest).toHaveBeenCalledWith(transactionID, childReportID, expect.objectContaining({id: policyID}), false, undefined, currentUserLogin, currentUserAccountID);
    });
});
