...
describe('IOURequestStepAmount - invoice receiver policy coverage', () => {
    beforeAll(() => {
        Onyx.init({
            keys: ONYXKEYS,
                ...
                <HTMLProviderWrapper>
                    <CurrentUserPersonalDetailsProvider>
                        <LocaleContextProvider>
                            <IOURequestStepAmountWithFullTransactionOrNotFound
                                route={{
                                    key: 'Money_Request_Step_Amount--test',
                                    name: 'Money_Request_Step_Amount',
                                    params: {
                                        action: 'create',
                                        iouType: 'submit',
                                        transactionID: TRANSACTION_ID,
                                        reportID: REPORT_ID,
                                        backTo: 'Money_Request_Step_Amount' as Route,
                                    },
                                }}
