...
const SCREEN_WRAPPER_STATUS = {didScreenTransitionEnd: true, shouldUseNarrowLayout: false, isSafeAreaTopPaddingApplied: true, isSafeAreaBottomPaddingApplied: true};
