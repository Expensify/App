...
const mockGetUnreadMarkerReportAction = jest.mocked(getUnreadMarkerReportAction);
...
describe('MoneyRequestReportActionsList - Reject Educational Modal', () => {
    ...
    it('passes read state to the unread marker', async () => {
        ...
        await waitFor(() => expect(mockGetUnreadMarkerReportAction).toHaveBeenLastCalledWith(expect.objectContaining({isReportUnread: false})));
    });
