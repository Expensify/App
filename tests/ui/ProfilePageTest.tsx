...
// This page presses buttons and asserts on the resulting side effects/disabled state, not on
// the double-tap-prevention mechanism itself, which relies on a real (non-fake) timer to clear
