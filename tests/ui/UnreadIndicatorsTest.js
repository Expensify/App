...
describe('Unread Indicators', () => {
    ...
    it('Display bold in the LHN for unread chat and new line indicator above the chat message when we navigate to it', () => signInAndGetAppWithUnreadChat()
        .then(() => {
            ...
            const optionRows = screen.queryAllByA11yHint('Navigates to a chat');
    ...
    it('Manually marking a chat message as read shows the new line indicator and updates the LHN', () => signInAndGetAppWithUnreadChat()
