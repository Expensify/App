...
describe('MoneyRequestReportView', () => {
    ...
    it('uses the animated bottom-padded cover while the report is waiting for transactions', () => {
    ...
    it('uses the static bottom-padded cover while report actions are empty', () => {
    ...
    it('uses the animated bottom-padded cover while the app is loading', () => {
