...
const createReportListItem = (type: ValueOf<typeof CONST.REPORT.TYPE>, from?: string, to?: string, options: Partial<TransactionGroupListItemType> = {}): TransactionGroupListItemType => ({
...
const renderReportListItemHeader = (reportItem: TransactionGroupListItemType) => {
    return render(
