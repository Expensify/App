        ...
        test("should update the transaction thread report's lastVisibleActionCreated to the optimistically added hold comment report action created timestamp", () => {
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    putOnHold(transaction.transactionID, comment, transactionThread.reportID, false, undefined, RORY_EMAIL, RORY_ACCOUNT_ID);
                    return waitForBatchedUpdates();
                })
                .then(() => {
        ...
        test('should create transaction thread optimistically when initialReportID is undefined', () => {
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    putOnHold(transaction.transactionID, comment, undefined, false, undefined, RORY_EMAIL, RORY_ACCOUNT_ID);
                    return waitForBatchedUpdates();
                })
                .then(() => {
                    return new Promise<void>((resolve) => {
        ...
        test('should call putOnHold for each transaction ID', () => {
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    putTransactionsOnHold([transaction1.transactionID, transaction2.transactionID], comment, iouReport.reportID, false, undefined, RORY_EMAIL, RORY_ACCOUNT_ID);
                    return waitForBatchedUpdates();
                })
                .then(() => {
                    return new Promise<void>((resolve) => {
        ...
        test('should invoke navigation for each transaction when isOffline is true', () => {
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    putTransactionsOnHold([transaction1.transactionID, transaction2.transactionID], comment, iouReport.reportID, true, undefined, RORY_EMAIL, RORY_ACCOUNT_ID);
                    return waitForBatchedUpdates();
                })
                .then(() => {
        ...
        test('should pass isOffline to getDisplayedReportID affecting which reportID is used for navigation', () => {
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    jest.mocked(Navigation.setNavigationActionToMicrotaskQueue).mockClear();
                    putOnHold(transaction.transactionID, comment, transactionThread.reportID, true, undefined, RORY_EMAIL, RORY_ACCOUNT_ID);
                    return waitForBatchedUpdates();
                })
                .then(() => {
        ...
        test("should update the transaction thread report's lastVisibleActionCreated to the optimistically added unhold report action created timestamp", () => {
            ...
            return waitForBatchedUpdates()
                ...
                .then(() => {
                    ...
                    unholdRequest(transaction.transactionID, transactionThread.reportID, policy, false, undefined, RORY_EMAIL, RORY_ACCOUNT_ID);
                    return waitForBatchedUpdates();
                })
                .then(() => {
                    return new Promise<void>((resolve) => {
