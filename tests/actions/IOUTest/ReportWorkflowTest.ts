...
import type {} from '@src/types/onyx/PersonalDetails';
import type {} from '@src/types/onyx/Report';
...
jest.mock('@libs/PolicyUtils', () => ({
    ...
    isPolicyOwner: jest.fn().mockImplementation((policy?: OnyxEntry<Policy>) => !!RORY_ACCOUNT_ID && policy?.ownerAccountID === RORY_ACCOUNT_ID),
}));
