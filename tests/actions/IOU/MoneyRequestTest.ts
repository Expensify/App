...
describe('MoneyRequest', () => {
    ...
    describe('handleMoneyRequestStepScanParticipants', () => {
        ...
        beforeEach(async () => {
            ...
            baseParams.recentWaypoints = (await getOnyxValue(ONYXKEYS.NVP_RECENT_WAYPOINTS)) ?? [];
            baseParams.participants = getMoneyRequestParticipantOptions(baseParams.currentUserAccountID, baseParams.report, baseParams.policy, baseParams.personalDetails, undefined, undefined);
            await getOnyxData({
