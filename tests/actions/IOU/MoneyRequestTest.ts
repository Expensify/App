...
describe('MoneyRequest', () => {
    ...
    describe('shouldUseDefaultExpensePolicy', () => {
        ...
        it('should return true when iouType is CREATE with a paid group policy that has expense chat enabled and no billing restrictions', () => {
            ...
            expect(shouldUseDefaultExpensePolicy(currentUserAccountID, CONST.IOU.TYPE.CREATE, policy, 0, undefined, undefined)).toBe(true);
        });
        ...
        it('should return false when policy is undefined', () => {
            expect(shouldUseDefaultExpensePolicy(currentUserAccountID, CONST.IOU.TYPE.CREATE, undefined, 0, undefined, undefined)).toBe(false);
        });

        it('should return false when policy is null', () => {
            expect(shouldUseDefaultExpensePolicy(currentUserAccountID, CONST.IOU.TYPE.CREATE, null, 0, undefined, undefined)).toBe(false);
        });
        ...
        it('should handle amountOwed being undefined', () => {
            ...
            expect(shouldUseDefaultExpensePolicy(currentUserAccountID, CONST.IOU.TYPE.CREATE, policy, undefined, undefined, undefined)).toBe(true);
        });
