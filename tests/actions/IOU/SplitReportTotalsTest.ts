        ...
        it('registers new split transaction IDs for highlighting', async () => {
            ...
            const params = buildBaseParams({
                transactionData: {
                    ...
                    originalTransactionID: ORIGINAL_TX_ID,
                    splitExpenses: [
                        {transactionID: 'new-tx-1', reportID: EXPENSE_REPORT_ID, statusNum: 0, amount: 500} as SplitExpense,
                        {transactionID: 'new-tx-2', reportID: EXPENSE_REPORT_ID, statusNum: 0, amount: 500} as SplitExpense,
                    ],
        ...
        it('skips transaction IDs that already exist as child transactions', async () => {
            ...
            const params = buildBaseParams({
                ...
                transactionData: {
                    ...
                    originalTransactionID: ORIGINAL_TX_ID,
                    splitExpenses: [
                        {transactionID: 'existing-tx-1', reportID: EXPENSE_REPORT_ID, statusNum: 0, amount: 500} as SplitExpense,
                        {transactionID: 'new-tx-2', reportID: EXPENSE_REPORT_ID, statusNum: 0, amount: 500} as SplitExpense,
                    ],
                    splitExpensesTotal: 1000,
                },
        ...
        it('skips registration during a reverse split operation', async () => {
            ...
            const params = buildBaseParams({
                ...
                transactionData: {
                    reportID: EXPENSE_REPORT_ID,
                    originalTransactionID: ORIGINAL_TX_ID,
                    splitExpenses: [{transactionID: 'new-merged-tx', reportID: EXPENSE_REPORT_ID, statusNum: 0, amount: 1000} as SplitExpense],
                    splitExpensesTotal: 1000,
                },
            });
        ...
        it('skips registration when the expense report will become empty after the split', async () => {
            ...
            const params = buildBaseParams({
                ...
                transactionData: {
                    ...
                    originalTransactionID: ORIGINAL_TX_ID,
                    splitExpenses: [
                        {transactionID: 'new-tx-1', reportID: 'other-report-1', statusNum: 0, amount: 500} as SplitExpense,
                        {transactionID: 'new-tx-2', reportID: 'other-report-2', statusNum: 0, amount: 500} as SplitExpense,
                    ],
                    splitExpensesTotal: 1000,
                },
            });
