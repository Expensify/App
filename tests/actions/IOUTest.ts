...
describe('actions/IOU', () => {
    ...
    describe('submitReport', () => {
        ...
        it('correctly submits a report with Dynamic External Workflow policy in Submit and Close mode without setting nextStep', () => {
            const amount = 10000;
            const comment = '💸💸💸💸';
            const merchant = 'NASDAQ';
            let expenseReport: OnyxEntry<Report>;
            ...
            return waitForBatchedUpdates()
                .then(() => {
                    ...
                    createWorkspace({
                        policyOwnerEmail: CARLOS_EMAIL,
                        makeMeAdmin: true,
                        policyName: 'Test Workspace with Dynamic External Workflow and Submit and Close',
                        policyID,
                        engagementChoice: CONST.ONBOARDING_CHOICES.CHAT_SPLIT,
                    });
                    return waitForBatchedUpdates();
