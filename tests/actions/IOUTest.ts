...
describe('actions/IOU', () => {
    ...
    describe('updateMoneyRequestCategory', () => {
        ...
        // This test is flaky and not passing, so it's being skipped until it can be fixed in https://github.com/Expensify/App/issues/77687
        it.skip('should remove all existing category violations when the transaction "Category" is unset', async () => {
            const transactionID = '1';
            const policyID = '2';
            const transactionThreadReportID = '3';
            const category = '';
