...
describe('actions/IOU', () => {
    ...
    describe('approveMoneyRequest with take control', () => {
        ...
        it('should set report to approved when admin takes control and approves', async () => {
            ...
            approveMoneyRequest(expenseReport, policy, adminAccountID, adminEmail, false, false, undefined, [CONST.BETAS.ALL], undefined, 0);
            await waitForBatchedUpdates();
        ...
        it('should invalidate take control when report is resubmitted after take control', async () => {
            ...
            approveMoneyRequest(expenseReport, policy, managerAccountID, managerEmail, false, false, undefined, [CONST.BETAS.ALL], undefined, 0);
            await waitForBatchedUpdates();
    ...
    describe('approveMoneyRequest with normal approval chain', () => {
        ...
        it('should handle multi-step approval chain correctly', async () => {
            ...
            approveMoneyRequest(updatedReport, policy, adminAccountID, adminEmail, false, false, undefined, [CONST.BETAS.ALL], undefined, 0);
            await waitForBatchedUpdates();
        ...
        it('should fully approve report when single approver approves', async () => {
            ...
            // Manager approves the report
            approveMoneyRequest(singleApproverReport, singleApproverPolicy, managerAccountID, managerEmail, false, false, undefined, [CONST.BETAS.ALL], undefined, 0);
            await waitForBatchedUpdates();
    ...
    describe('approveMoneyRequest partially', () => {
        ...
        it('the new expense report should be an outstanding report when approving partially', async () => {
            ...
            const newExpenseReportID = approveMoneyRequest(expenseReport, policy, adminAccountID, adminEmail, false, false, undefined, [CONST.BETAS.ALL], undefined, 0, false);
            await waitForBatchedUpdates();
