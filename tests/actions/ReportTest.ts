...
describe('actions/Report', () => {
    ...
    describe('navigateToConciergeChat', () => {
        ...
        it('should navigate to concierge chat with provided conciergeReportID', async () => {
            ...
            Report.navigateToConciergeChat(CONCIERGE_REPORT_ID, testIntroSelected, TEST_USER_ACCOUNT_ID, false);
        ...
        it('should navigate with shouldDismissModal=true when provided', async () => {
            ...
            Report.navigateToConciergeChat(CONCIERGE_REPORT_ID, testIntroSelected, TEST_USER_ACCOUNT_ID, true);
        ...
        it('should handle undefined conciergeReportID gracefully', async () => {
            ...
            expect(() => {
                Report.navigateToConciergeChat(undefined, testIntroSelected, TEST_USER_ACCOUNT_ID, false);
            }).not.toThrow();
        });
        ...
        it('should navigate with reportActionID when provided', async () => {
            ...
            Report.navigateToConciergeChat(CONCIERGE_REPORT_ID, testIntroSelected, TEST_USER_ACCOUNT_ID, true, undefined, undefined, reportActionID);
        ...
        it('should navigate with linkToOptions when provided', async () => {
            ...
            Report.navigateToConciergeChat(CONCIERGE_REPORT_ID, testIntroSelected, TEST_USER_ACCOUNT_ID, false, undefined, linkToOptions);
        ...
        it('should respect checkIfCurrentPageActive callback when creating new concierge chat', async () => {
            ...
            Report.navigateToConciergeChat(undefined, testIntroSelected, TEST_USER_ACCOUNT_ID, false, checkIfCurrentPageActive);
        ...
        it('should handle empty string conciergeReportID gracefully', async () => {
            ...
            expect(() => {
                Report.navigateToConciergeChat('', testIntroSelected, TEST_USER_ACCOUNT_ID, false);
            }).not.toThrow();
        });
        ...
        it('should work with all optional parameters provided', async () => {
            ...
            Report.navigateToConciergeChat(CONCIERGE_REPORT_ID, testIntroSelected, TEST_USER_ACCOUNT_ID, true, checkIfCurrentPageActive, linkToOptions, reportActionID);
        ...
        it('should prioritize provided conciergeReportID over Onyx value', async () => {
            ...
            Report.navigateToConciergeChat(providedConciergeReportID, testIntroSelected, TEST_USER_ACCOUNT_ID, false);
    ...
    describe('toggleSubscribeToChildReport', () => {
        ...
        it('should subscribe to an existing child report with introSelected', async () => {
            ...
            expect(() => {
                Report.toggleSubscribeToChildReport(CHILD_REPORT_ID, TEST_USER_ACCOUNT_ID, PARENT_REPORT_ACTION, PARENT_REPORT, INTRO_SELECTED, false, 'hidden');
            }).not.toThrow();
        });
        ...
        it('should create a new child report when childReportID is undefined', async () => {
            ...
            expect(() => {
                Report.toggleSubscribeToChildReport(undefined, TEST_USER_ACCOUNT_ID, PARENT_REPORT_ACTION, PARENT_REPORT, INTRO_SELECTED, false);
            }).not.toThrow();
        });
        ...
        it('should handle undefined introSelected', async () => {
            ...
            expect(() => {
                Report.toggleSubscribeToChildReport(CHILD_REPORT_ID, TEST_USER_ACCOUNT_ID, PARENT_REPORT_ACTION, PARENT_REPORT, undefined, true, 'hidden');
            }).not.toThrow();
        });
        ...
        it('should pass isSelfTourViewed=true when creating new child report', async () => {
            ...
            expect(() => {
                Report.toggleSubscribeToChildReport(undefined, TEST_USER_ACCOUNT_ID, PARENT_REPORT_ACTION, PARENT_REPORT, INTRO_SELECTED, true);
            }).not.toThrow();
        });
        ...
        it('should handle isSelfTourViewed with existing child report and hidden preference', async () => {
            ...
            expect(() => {
                Report.toggleSubscribeToChildReport(CHILD_REPORT_ID, TEST_USER_ACCOUNT_ID, PARENT_REPORT_ACTION, PARENT_REPORT, INTRO_SELECTED, true, 'hidden');
            }).not.toThrow();
        });
        ...
        it('should handle isSelfTourViewed with existing child report and no previous notification preference', async () => {
            ...
            expect(() => {
                Report.toggleSubscribeToChildReport(CHILD_REPORT_ID, TEST_USER_ACCOUNT_ID, PARENT_REPORT_ACTION, PARENT_REPORT, INTRO_SELECTED, false);
            }).not.toThrow();
        });
    });
