...
describe('actions/Report', () => {
    ...
    it('should be updated correctly when new comments are added, deleted or marked as unread', () => {
        ...
        const setPromise = Onyx.set(`${ONYXKEYS.COLLECTION.REPORT}${REPORT_ID}`, {reportName: 'Test', reportID: REPORT_ID})
            ...
            .then(() => {
                ...
                Report.openReport({reportID: REPORT_ID, participants: [], introSelected: TEST_INTRO_SELECTED});
    ...
    it('openReport legacy preview fallback stores action under correct Onyx key and preserves existing actions', async () => {
        ...
        Report.openReport({reportID: CHILD_REPORT_ID, participants: [], introSelected: undefined, transaction: transaction ?? undefined, parentReportID: SELF_DM_ID});
        await waitForBatchedUpdates();
    ...
    describe('openReport with introSelected', () => {
        ...
        it('should handle openReport when introSelected is undefined', async () => {
            ...
            Report.openReport({reportID: REPORT_ID, participants: [], introSelected: undefined});
            await waitForBatchedUpdates();
    ...
    describe('navigateToAndOpenReport', () => {
        ...
        it('should not create new chat when there is an existing chat with the participant', async () => {
            ...
            Report.navigateToAndOpenReport([PARTICIPANT_LOGIN], undefined, TEST_USER_ACCOUNT_ID, testIntroSelected);
            await waitForBatchedUpdates();
        ...
        it('should respect shouldDismissModal parameter', async () => {
            ...
            Report.navigateToAndOpenReport([PARTICIPANT_LOGIN], undefined, TEST_USER_ACCOUNT_ID, testIntroSelected, false);
            await waitForBatchedUpdates();
