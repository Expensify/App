...
describe('actions/Report', () => {
    ...
    describe('explain', () => {
        ...
        it('should return early if reportAction is not provided', () => {
            const result = Report.explain(undefined, undefined, undefined, TestHelper.translateLocal, TEST_USER_ACCOUNT_ID, INTRO_SELECTED, undefined, CONST.DEFAULT_TIME_ZONE, undefined);
        ...
        it('should work with new explain thread scenario', async () => {
            ...
            Report.explain(undefined, PARENT_REPORT, REPORT_ACTION, TestHelper.translateLocal, TEST_USER_ACCOUNT_ID, INTRO_SELECTED, undefined, CONST.DEFAULT_TIME_ZONE, undefined);
            await waitForBatchedUpdates();
        ...
        it('should handle undefined introSelected', async () => {
            ...
            Report.explain(EXISTING_CHILD_REPORT, PARENT_REPORT, REPORT_ACTION, TestHelper.translateLocal, TEST_USER_ACCOUNT_ID, undefined, undefined, CONST.DEFAULT_TIME_ZONE, undefined);
            await waitForBatchedUpdates();
        ...
        it('should pass betas through to createChildReport when creating a new explain thread', async () => {
            ...
            Report.explain(undefined, PARENT_REPORT, REPORT_ACTION, TestHelper.translateLocal, TEST_USER_ACCOUNT_ID, INTRO_SELECTED, testBetas, CONST.DEFAULT_TIME_ZONE, undefined);
            await waitForBatchedUpdates();
        ...
        it('should pass isSelfTourViewed=true through to createChildReport when creating a new explain thread', async () => {
            ...
            Report.explain(undefined, PARENT_REPORT, REPORT_ACTION, TestHelper.translateLocal, TEST_USER_ACCOUNT_ID, INTRO_SELECTED, undefined, CONST.DEFAULT_TIME_ZONE, true);
            await waitForBatchedUpdates();
        ...
        it('should pass isSelfTourViewed=false through to createChildReport when creating a new explain thread', async () => {
            ...
            Report.explain(undefined, PARENT_REPORT, REPORT_ACTION, TestHelper.translateLocal, TEST_USER_ACCOUNT_ID, INTRO_SELECTED, undefined, CONST.DEFAULT_TIME_ZONE, false);
            await waitForBatchedUpdates();
