...
test('[ModifiedExpenseMessage] getForReportAction on 1k reports and policies', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, (0, reassure_1.measureFunction)(function () { return ModifiedExpenseMessage_1.default.getForReportAction({ reportOrID: report.reportID, reportAction: reportAction }); })];
            case 3:
                _a.sent();
                return [2 /*return*/];
        }
