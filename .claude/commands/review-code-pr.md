---
allowed-tools: Bash(gh pr comment:*),Bash(gh pr diff:*),Bash(gh pr view:*),Bash(addPrReaction.sh:*),Bash(checkReactCompilerOptimization.sh:*),mcp__github_inline_comment__create_inline_comment
