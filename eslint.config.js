            ...
            '@typescript-eslint/no-floating-promises': [
                'error',
                {
                    allowForKnownSafeCalls: [
                        {
                            from: 'package',
                            package: 'react-native-onyx',
                            name: ['connect', 'connectWithoutView', 'disconnect', 'set', 'multiSet', 'merge', 'mergeCollection', 'setCollection', 'update', 'clear', 'init'],
                        },
                        {
                            from: 'package',
                        ...
                        {from: 'file', path: './src/libs/fileDownload/index.ts', name: 'fileDownload'},
                        {from: 'file', path: './src/libs/Sound/index.ts', name: 'playSound'},
                        {
                            from: 'file',
                            path: './src/libs/Navigation/Navigation.ts',
                            name: [
