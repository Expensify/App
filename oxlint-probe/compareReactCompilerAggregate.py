...
Usage (normally via oxlint-probe/measureReactCompilerCost.sh, which produces both reports):
    python3 oxlint-probe/compareReactCompilerAggregate.py /tmp/rc-a-1.json /tmp/rc-d-1.json
