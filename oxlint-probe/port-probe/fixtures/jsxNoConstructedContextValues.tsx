...
function Provider({children}: {children: React.ReactNode}) {
    ...
    // (oxlint-probe/reactCompilerGate.mjs), which drops every finding in a file both compilers
    ...
    // oxlint-probe/checkReactCompilerGate.py, which needs both a memoized and an opted-out file.
    'use no memo';
