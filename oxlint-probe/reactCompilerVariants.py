"""Config variants and per-run bookkeeping for oxlint-probe/measureReactCompilerCost.sh.

    python3 oxlint-probe/reactCompilerVariants.py write
    python3 oxlint-probe/reactCompilerVariants.py record <report.json> <run> <variant> <seconds> <results.tsv>
