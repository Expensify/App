"""Replays the upstream RuleTester cases for every custom rule through BOTH linters.
    ...
    python3 oxlint-probe/rule-tester/compareRuleTester.py [--keep] [--rule <name>]
...
sys.path.insert(0, os.path.join(ROOT, 'oxlint-probe'))
...
EXPECTED_BRIDGE_DIFFS = {
    ('prefer-locale-compare-from-context', 'valid-1'): (
        ...
        'divergence, asserted in full by oxlint-probe/checkLocaleComparePort.py'
    ),
}
