...
//
//     node oxlint-probe/rule-tester/buildTree.mjs <treeDir> <rulesJson>
//
...
function writeConfigs() {
    const plugin = path.relative(treeDir, path.join(REPO, 'oxlint-probe/expensify-rules.mjs')).split(path.sep).join('/');
