...
json.dump(override_files, open(os.path.join(ROOT, 'oxlint-probe', 'dep-override-files.json'), 'w'), indent=4)
print('applied; override file list written to oxlint-probe/dep-override-files.json')
