...
- (void)requestSAMLReauthentication:(RCTPromiseResolveBlock)resolve
                             reject:(RCTPromiseRejectBlock)reject {
    NSLog(@"[ReactNativeHybridApp] `requestSAMLReauthentication` should never be called in standalone `New Expensify` app");
    reject(@"NOT_IMPLEMENTED", @"This method is not available in standalone New Expensify app", nil);
}
