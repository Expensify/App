///
/// UtilsModule-Swift-Cxx-Bridge.cpp
...
namespace margelo::nitro::utils::bridge::swift {
  ...
  Func_void_std__vector_Contact_ create_Func_void_std__vector_Contact_(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = UtilsModule::Func_void_std__vector_Contact_::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_std__exception_ptr create_Func_void_std__exception_ptr(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = UtilsModule::Func_void_std__exception_ptr::fromUnsafe(swiftClosureWrapper);
  ...
  std::shared_ptr<margelo::nitro::utils::HybridContactsModuleSpec> create_std__shared_ptr_margelo__nitro__utils__HybridContactsModuleSpec_(void* _Nonnull swiftUnsafePointer) {
    UtilsModule::HybridContactsModuleSpec_cxx swiftPart = UtilsModule::HybridContactsModuleSpec_cxx::fromUnsafe(swiftUnsafePointer);
