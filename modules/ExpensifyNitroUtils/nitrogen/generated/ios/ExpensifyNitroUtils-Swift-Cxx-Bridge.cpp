...
namespace margelo::nitro::utils::bridge::swift {
  ...
  std::shared_ptr<HybridAppStartTimeModuleSpec> create_std__shared_ptr_HybridAppStartTimeModuleSpec_(void* _Nonnull swiftUnsafePointer) noexcept {
    ExpensifyNitroUtils::HybridAppStartTimeModuleSpec_cxx swiftPart = ExpensifyNitroUtils::HybridAppStartTimeModuleSpec_cxx::fromUnsafe(swiftUnsafePointer);
    return std::make_shared<margelo::nitro::utils::HybridAppStartTimeModuleSpecSwift>(swiftPart);
  }
  void* _Nonnull get_std__shared_ptr_HybridAppStartTimeModuleSpec_(std__shared_ptr_HybridAppStartTimeModuleSpec_ cppType) noexcept {
    std::shared_ptr<margelo::nitro::utils::HybridAppStartTimeModuleSpecSwift> swiftWrapper = std::dynamic_pointer_cast<margelo::nitro::utils::HybridAppStartTimeModuleSpecSwift>(cppType);
    #ifdef NITRO_DEBUG
    if (swiftWrapper == nullptr) [[unlikely]] {
      throw std::runtime_error("Class \"HybridAppStartTimeModuleSpec\" is not implemented in Swift!");
    }
    #endif
    ExpensifyNitroUtils::HybridAppStartTimeModuleSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
