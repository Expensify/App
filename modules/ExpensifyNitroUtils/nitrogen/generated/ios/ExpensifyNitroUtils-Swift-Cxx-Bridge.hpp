...
namespace margelo::nitro::utils::bridge::swift {
  ...
  std::shared_ptr<HybridAppStartTimeModuleSpec> create_std__shared_ptr_HybridAppStartTimeModuleSpec_(void* NON_NULL swiftUnsafePointer) noexcept;
  void* NON_NULL get_std__shared_ptr_HybridAppStartTimeModuleSpec_(std__shared_ptr_HybridAppStartTimeModuleSpec_ cppType);
