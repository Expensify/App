...
// Forward declaration of `HybridAppStartTimeModuleSpec` to properly resolve imports.
namespace margelo::nitro::utils { class HybridAppStartTimeModuleSpec; }
...
namespace margelo::nitro::utils::bridge::swift {
   ...
   */
  using std__shared_ptr_HybridAppStartTimeModuleSpec_ = std::shared_ptr<HybridAppStartTimeModuleSpec>;
  std::shared_ptr<HybridAppStartTimeModuleSpec> create_std__shared_ptr_HybridAppStartTimeModuleSpec_(void* _Nonnull swiftUnsafePointer) noexcept;
  void* _Nonnull get_std__shared_ptr_HybridAppStartTimeModuleSpec_(std__shared_ptr_HybridAppStartTimeModuleSpec_ cppType) noexcept;
  
  // pragma MARK: std::weak_ptr<HybridAppStartTimeModuleSpec>
  using std__weak_ptr_HybridAppStartTimeModuleSpec_ = std::weak_ptr<HybridAppStartTimeModuleSpec>;
  inline std__weak_ptr_HybridAppStartTimeModuleSpec_ weakify_std__shared_ptr_HybridAppStartTimeModuleSpec_(const std::shared_ptr<HybridAppStartTimeModuleSpec>& strong) noexcept { return strong; }
