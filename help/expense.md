...
### [Troubleshooting QuickBooks Online Exports] How do I handle export issues with QuickBooks Online?
If an error occurs preventing a report from automatically exporting to QuickBooks Online:
...
- For auto-sync errors, a message will be posted in the related #admins room with a link to the workspace’s accounting settings where an explanation for the error appears.

An error on a report will prevent it from automatically exporting. Make the necessary changes to the report and manually export it by pressing **Details > Export**, then select QuickBooks Online.

To manually export a report, ensure it is in the Approved, Closed, or Reimbursed state. If the report is in the Open status, press to submit it, or if in Processing, ensure approval by an admin.

### [Disconnect QuickBooks Online] How do I disconnect the QuickBooks Online connection?
...
5. Press the three-dot menu icon next to QuickBooks Online and select **Disconnect**.
...
To configure QuickBooks Online settings within Expensify, follow these steps:

#### Import Settings
1. Navigate to **Settings > Workspaces > [Workspace Name] > Accounting**.
2. Press **Import** under QuickBooks Online.
3. Configure your import preferences for Chart of Accounts, Classes, Customers/Projects, Locations, and Taxes.

#### Export Settings
1. Go to **Settings > Workspaces > [Workspace Name] > Accounting** and press **Export** under QuickBooks Online.
2. Choose your Preferred Exporter, Date configuration, and methods for exporting out-of-pocket and company card expenses.
3. Set preferences for invoices and foreign currency amounts.

#### Advanced Settings
1. Access the advanced settings by pressing **Advanced** under QuickBooks Online.
...
To configure NetSuite settings within Expensify, follow these steps:

#### Import Settings
1. Navigate to **Settings > Workspaces > [Workspace Name] > Accounting**.
2. Press **Import** under NetSuite.
3. Configure your import preferences for Expense Categories, Departments, Classes, Locations, Customers, Projects, Tax, and Custom Segments or Records.

#### Export Settings
1. Go to **Settings > Workspaces > [Workspace Name] > Accounting** and press **Export** under NetSuite.
2. Choose your Preferred Exporter, Date configuration, and methods for exporting out-of-pocket and company card expenses.
3. Set preferences for invoices and foreign currency amounts.

#### Advanced Settings
1. Access the advanced settings by pressing **Advanced** under NetSuite.
2. Enable features such as Auto-sync, Sync reimbursed reports, Invite employees, and Auto-create employees/vendors.
3. Set approval levels and enable or disable newly imported categories.
