...
### [Admin and Announce Rooms] What are the #admins and #announce rooms?
When a workspace is created, two special chat rooms are automatically generated: `#admins` and `#announce`.

* **#admins**: Exclusively for Workspace Admins to collaborate on workspace management. It includes:
  - Communication with your dedicated Expensify Setup Specialist.
  - Interaction with an Account Manager for subscriptions with 10 or more members.
  - Tracking changes made to Workspace settings.
...
### Start a thread
You can start a private conversation thread from a group chat or room by replying directly to a message. This allows you to engage in a one-on-one chat with another member about the message.

To start a conversation thread:
1. Open the chat in your inbox.
2. Press and hold the message (on mobile) or right-click the message (on desktop) and select **Reply in thread**.
...
### [Create new chat] Create a new chat
Expensify Chat allows you to connect with individuals or groups through private chats, group chats, or public chat rooms.
...
4. Update the group image or name.
   - **Name**: Press **Group Name** and enter a new name. Then press **Save**.
   - **Image**: Press the profile image and select **Upload Image**. Choose a new image from your files and select the desired image zoom.
5. Press **Start group**.
...
5. Press **Workspace** to select the workspace for the room.
6. Press **Who can post** to determine if all members can post or only Admins.
7. Press **Visibility** to determine who can find the room.
...
### [Invite members] Invite Members to a Chat Group or Room
You can invite people to a chat group or room in several ways:
