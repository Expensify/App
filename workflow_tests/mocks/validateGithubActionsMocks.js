...
// verify
const VALIDATEGITHUBACTIONS__VERIFY__CHECKOUT__STEP_MOCK = utils.createMockStep(
    'Checkout',
    'Checkout',
    'VERIFY',
    ['fetch-depth'],
...
const VALIDATEGITHUBACTIONS__VERIFY__SETUP_NODE__STEP_MOCK = utils.createMockStep(
    'Setup Node',
    'Setup Node',
    'VERIFY',
    [],
...
const VALIDATEGITHUBACTIONS__VERIFY__VALIDATE_ACTIONS_AND_WORKFLOWS__STEP_MOCK = utils.createMockStep(
