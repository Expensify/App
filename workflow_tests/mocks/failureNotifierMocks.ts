...
const FAILURENOTIFIER__NOTIFYFAILURE_FETCH_PREVIOUS_WORKFLOW_RUN_JOBS__STEP_MOCK = createMockStep('Fetch Previous Workflow Run Jobs', 'Fetch Previous Workflow Run Jobs', 'NOTIFYFAILURE', [], []);
