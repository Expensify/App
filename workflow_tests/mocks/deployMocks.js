...
const VALIDATE__GET_MERGED_PR__STEP_MOCK = utils.createMockStep(
...
const VALIDATE__GET_MERGED_PR__OSBOTIFY__STEP_MOCK = utils.createMockStep(
    'Get merged pull request',
    'Getting merged PR',
    'VALIDATE',
    ['github_token'],
...
const DEPLOY_STAGING__CHECKOUT__STEP_MOCK = utils.createMockStep(
    'Checkout staging branch',
    'Checking out staging branch',
    'DEPLOY_STAGING',
    ['ref', 'token'],
);
const DEPLOY_STAGING__SETUP_GIT__STEP_MOCK = utils.createMockStep(
    'Setup git for OSBotify',
    'Setting up git for OSBotify',
    'DEPLOY_STAGING',
    ['GPG_PASSPHRASE'],
);
const DEPLOY_STAGING__TAG_VERSION__STEP_MOCK = utils.createMockStep(
    'Tag version',
    'Tagging new version',
    'DEPLOY_STAGING',
);
const DEPLOY_STAGING__PUSH_TAG__STEP_MOCK = utils.createMockStep(
...
const DEPLOY_PRODUCTION__CHECKOUT__STEP_MOCK = utils.createMockStep(
    'Checkout',
    'Checking out',
    'DEPLOY_PRODUCTION',
    ['fetch-depth', 'token'],
...
const DEPLOY_PRODUCTION__CHECKOUT_PRODUCTION__STEP_MOCK = utils.createMockStep(
    'Checkout production branch',
    'Checking out production branch',
    'DEPLOY_PRODUCTION',
);
const DEPLOY_PRODUCTION__CURRENT_APP_VERSION__STEP_MOCK = utils.createMockStep(
...
const DEPLOY_PRODUCTION__GENERATE_RELEASE_BODY__STEP_MOCK = utils.createMockStep(
