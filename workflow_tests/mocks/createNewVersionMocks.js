...
// validateactor
const CREATENEWVERSION__VALIDATEACTOR__GET_USER_PERMISSIONS__ADMIN__STEP_MOCK = utils.getMockStep(
...
const CREATENEWVERSION__VALIDATEACTOR__GET_USER_PERMISSIONS__WRITE__STEP_MOCK = utils.getMockStep(
    'Get user permissions',
    'Get user permissions',
    'VALIDATEACTOR',
    [],
...
const CREATENEWVERSION__VALIDATEACTOR__GET_USER_PERMISSIONS__NONE__STEP_MOCK = utils.getMockStep(
    'Get user permissions',
    'Get user permissions',
    'VALIDATEACTOR',
    [],
...
// createnewversion
const CREATENEWVERSION__CREATENEWVERSION__CHECK_OUT__STEP_MOCK = utils.getMockStep(
    'Check out',
    'Check out',
    'CREATENEWVERSION',
    ['fetch-depth'],
...
const CREATENEWVERSION__CREATENEWVERSION__SETUP_GIT_FOR_OSBOTIFY__STEP_MOCK = utils.getMockStep(
...
const CREATENEWVERSION__CREATENEWVERSION__RUN_TURNSTYLE__STEP_MOCK = utils.getMockStep(
    'Run turnstyle',
    'Run turnstyle',
    'CREATENEWVERSION',
...
const CREATENEWVERSION__CREATENEWVERSION__CREATE_NEW_BRANCH__STEP_MOCK = utils.getMockStep(
    'Create new branch',
    'Create new branch',
    'CREATENEWVERSION',
    [],
...
const CREATENEWVERSION__CREATENEWVERSION__GENERATE_VERSION__STEP_MOCK = utils.getMockStep(
    'Generate version',
    'Generate version',
    'CREATENEWVERSION',
...
const CREATENEWVERSION__CREATENEWVERSION__COMMIT_NEW_VERSION__STEP_MOCK = utils.getMockStep(
    'Commit new version',
    'Commit new version',
    'CREATENEWVERSION',
    [],
...
const CREATENEWVERSION__CREATENEWVERSION__UPDATE_MAIN_BRANCH__STEP_MOCK = utils.getMockStep(
    'Update main branch',
    'Update main branch',
    'CREATENEWVERSION',
...
const CREATENEWVERSION__CREATENEWVERSION__ANNOUNCE_FAILED_WORKFLOW_IN_SLACK__STEP_MOCK = utils.getMockStep(
