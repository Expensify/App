...
const getCherryPickMockSteps = (upToDate, isMergeable, shouldMerge) => [
    ...
    upToDate
        ? CHERRYPICK__CHERRYPICK__CHECK_IF_SHORTVERSIONSTRING_IS_UP_TO_DATE_TRUE__STEP_MOCK
        : CHERRYPICK__CHERRYPICK__CHECK_IF_SHORTVERSIONSTRING_IS_UP_TO_DATE_FALSE__STEP_MOCK,
    ...
    isMergeable
        ? CHERRYPICK__CHERRYPICK__CHECK_IF_PULL_REQUEST_IS_MERGEABLE_TRUE__STEP_MOCK
        : CHERRYPICK__CHERRYPICK__CHECK_IF_PULL_REQUEST_IS_MERGEABLE_FALSE__STEP_MOCK,
