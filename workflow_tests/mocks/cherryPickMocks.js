...
const CHERRYPICK__CHERRYPICK__PUSH_CHANGES_TO_CP_BRANCH__STEP_MOCK = utils.createMockStep('Push changes to CP branch', 'Pushing changes to CP branch', 'CHERRYPICK', [], []);
const CHERRYPICK__CHERRYPICK__CREATE_PULL_REQUEST__STEP_MOCK = utils.createMockStep('Create Pull Request', 'Creating Pull Request', 'CHERRYPICK', [], ['GITHUB_TOKEN'], {PR_NUMBER: '1234'});
...
const CHERRYPICK__CHERRYPICK__AUTO_APPROVE_THE_PR__STEP_MOCK = utils.createMockStep('Auto-approve the PR', 'Auto-approving the PR', 'CHERRYPICK', [], ['GITHUB_TOKEN']);
...
const CHERRYPICK__CHERRYPICK__AUTO_MERGE_THE_PR__STEP_MOCK = utils.createMockStep('Auto-merge the PR', 'Auto-merging the PR', 'CHERRYPICK', [], ['GITHUB_TOKEN']);
...
const getCherryPickMockSteps = (upToDate, isMergeable, shouldMerge) => [
    ...
    shouldMerge
        ? CHERRYPICK__CHERRYPICK__CHERRY_PICK_THE_MERGE_COMMIT_OF_TARGET_PR_TO_NEW_BRANCH__SHOULD_MERGE__STEP_MOCK
