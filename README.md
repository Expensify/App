...
* Before installing iOS dependencies, you need to obtain a token from a Mapbox to download their SDKs. Please run `npm run configure-mapbox` and follow the instructions.
...
* Before installing Android dependencies, you need to obtain a token from a Mapbox to download their SDKs. Please run `npm run configure-mapbox` and follow the instructions. If you already did this step for iOS, there is no need to repeat this step.
