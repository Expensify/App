...
* Before installing iOS dependencies, make sure that you have setup Mapbox SDK credentials. Please refer to [Setting up Mapbox SDK Credentials](#setting-up-mapbox-sdk-credentials).
