...
```yaml
# Bad
- uses: getblacksmith/checkout@c9796daa2a4bdebdab5bd16be2c09a70cd4e1121 # v1
  with:
    fetch-depth: 0
...
1. Do **not ever** write a `pull_request_target` trigger with an explicit PR checkout, e.g. using `getblacksmith/checkout@c9796daa2a4bdebdab5bd16be2c09a70cd4e1121`. This is [discussed further here](https://securitylab.github.com/research/github-actions-preventing-pwn-requests)
...
- When calling your GitHub Action from one of our workflows, you must:
    - First call `getblacksmith/checkout@c9796daa2a4bdebdab5bd16be2c09a70cd4e1121` (`# v1`).
