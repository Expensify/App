...
```yaml
# Bad
- uses: getblacksmith/checkout@41cdeedae8edb2e684ba22896a5fd2a3cb85db6b # v1
  with:
    fetch-depth: 0
...
1. Do **not ever** write a `pull_request_target` trigger with an explicit PR checkout, e.g. using `getblacksmith/checkout@41cdeedae8edb2e684ba22896a5fd2a3cb85db6b`. This is [discussed further here](https://securitylab.github.com/research/github-actions-preventing-pwn-requests)
...
- When calling your GitHub Action from one of our workflows, you must:
    - First call `getblacksmith/checkout@41cdeedae8edb2e684ba22896a5fd2a3cb85db6b` (`# v1`).
