...
The complete coding-standards ruleset is **appended to this prompt below**. Use it directly to review changed files - you do not need to load any rule files.
...
1. **Build your rule checklist from the ruleset appended below in this prompt:**
   - Every rule is already in your context - do NOT Glob or Read rule files
   - Build an explicit checklist of all rules (ruleId + title) from the YAML frontmatter of each appended rule
