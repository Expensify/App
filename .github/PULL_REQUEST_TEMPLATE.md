...
- [ ] If a new CSS style is added I verified that (check these off if they do not apply):
    - [ ] A similar style doesn't already exist
    - [ ] The style can’t be created with an existing [StyleUtils](https://github.com/Expensify/App/blob/main/src/styles/StyleUtils.js) function (i.e. `StyleUtils.getBackgroundAndBorderStyle(themeColors.componentBG`)
- [ ] If the PR modifies a generic component, I tested and verified that those changes do not break usages of that component in the rest of the App (i.e. if a shared library or component like `Avatar` is modified, I verified that `Avatar` is working as expected in all cases). Check this off if it does not apply. 
- [ ] If the PR modifies a component related to any of the existing Storybook stories, I tested and verified all stories for that component are still working as expected. Check this off if it does not apply.


<details>
<summary><h4>PR Reviewer Checklist to be copy/pasted into a new comment, and completed by a Contributor+</h4></summary>
