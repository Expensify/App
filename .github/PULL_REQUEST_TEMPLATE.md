...
- [ ] I wrote clear testing steps that cover the changes made in this PR
    ...
    - [ ] I added steps for the expected offline behavior in the Offline steps section, if the PR is calling any API command, the steps can't be blank, n/a or "same as tests", they have to have real testing steps that include doing the action that calls the API command offline and testing the case when the server returns an error
