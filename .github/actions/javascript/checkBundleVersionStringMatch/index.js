...
module.exports = /******/ (() => {
    ...
    /******/ var __webpack_modules__ = {
        /***/ 855: /***/ (__unused_webpack_module, __unused_webpack_exports, __nccwpck_require__) => {
        ...
        /***/ 322: /***/ (__unused_webpack_module, exports, __nccwpck_require__) => {
            const {execSync} = __nccwpck_require__(129);
        ...
        /***/ 427: /***/ (module) => {
            const debug =
                typeof process === 'object' && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...args) => console.error('SEMVER', ...args) : () => {};
        ...
        /***/ 521: /***/ (__unused_webpack_module, __webpack_exports__, __nccwpck_require__) => {
            'use strict';
            // ESM COMPAT FLAG
