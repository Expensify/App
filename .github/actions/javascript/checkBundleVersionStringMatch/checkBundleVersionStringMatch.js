...
const bundleVersion = execSync(
    `grep -A1 'CFBundleVersion' ${PLIST_PATH} | grep -v 'CFBundleVersion' | sed 's|[</string>,]||g'`,
)
    .toString()
    .trim();
const shortBundleVersion = execSync(
    `grep -A1 'CFBundleShortVersionString' ${PLIST_PATH} | grep -v 'CFBundleShortVersionString' | sed 's|[</string>,]||g'`,
)
    .toString()
    .trim();
