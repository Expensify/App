...
async function run(): Promise<IssuesCreateResponse | void> {
    ...
    try {
        ...
        let mobileMergedPRs = await GitUtils.getPullRequestsDeployedBetween(previousChecklistData.tag, newStagingTag, 'Mobile-Expensify-Test-Fork'); // CONST.MOBILE_EXPENSIFY_REPO);
