...
// .github/actions/javascript/verifySignedCommits/verifySignedCommits.ts
var core2 = __toESM(require_core());
var github = __toESM(require_github());
var PR_NUMBER = Number.parseInt(core2.getInput("PR_NUMBER"), 10) || github.context.payload.pull_request?.number;
GithubUtils_default.paginate(
  GithubUtils_default.octokit.pulls.listCommits,
  {
    owner: CONST_default.GITHUB_OWNER,
    repo: CONST_default.APP_REPO,
  ...
  if (unsignedCommits.length > 0) {
    ...
    console.log("All commits signed! \u{1F389}");
  }
});
