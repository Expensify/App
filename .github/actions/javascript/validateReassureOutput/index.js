...
var validateReassureOutput_exports = {};
__export(validateReassureOutput_exports, {
  default: () => validateReassureOutput_default
});
module.exports = __toCommonJS(validateReassureOutput_exports);
var core = __toESM(require_core());
var import_fs = __toESM(require("fs"));
var run = () => {
  const regressionOutput = JSON.parse(import_fs.default.readFileSync(".reassure/output.json", "utf8"));
