...
function execSync(command, options) {
  const optionsWithEncoding = {
    ...
    // Large diffs (e.g. bundled action output) can exceed Node's 1MB default.
    ...options,
    encoding: "utf8",
    cwd: process.cwd()
  };
...
var import_request_error2 = __toESM(require_dist_node13(), 1);
async function run() {
...
export {
  getPullRequestIncrementalChanges_default as default
};
