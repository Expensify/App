...
// .github/actions/javascript/checkExplanationVerbosity/checkExplanationVerbosity.ts
var EXPLANATION_SECTION_START = "### Explanation of Change";
var EXPLANATION_SECTION_END = "### Fixed Issues";
var WORD_COUNT_THRESHOLD = 800;
var DELETION_RATIO_THRESHOLD = 0.7;
function extractExplanationSection(body) {
...
function getDeletionRatio(additions, deletions) {
...
function run() {
  ...
  setOutput("SHOULD_COMMENT", shouldComment);
  setOutput("WORD_COUNT", wordCount);
  setOutput("DELETION_RATIO", deletionRatio.toFixed(2));
}
if (import.meta.main) {
  run();
}
var checkExplanationVerbosity_default = run;
export {
  checkExplanationVerbosity_default as default
};
