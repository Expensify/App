    ...
    return {
        ...
        module: {
            rules: [
                ...
                {
                    test: /\.css$/i,
                    use: isDevelopment ? ['style-loader', 'css-loader'] : [rspack.CssExtractRspackPlugin.loader, 'css-loader'],
                },
                {
                    test: /\.(woff2|ttf)$/i,
                    type: 'asset',
        ...
        optimization: {
            minimizer: [
                ...
                // options used in the webpack config. rspack's types only declare `keep_classnames` as a
            ...
            splitChunks: {
                cacheGroups: {
                    ...
                    // When dependencies don't change rspack would produce the same js file (and content hash)
