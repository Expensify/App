 ...
 * populate EXPO_PUBLIC_* values at runtime. That integration does not exist under Re.Pack, leaving
 * them undefined. Most importantly, `expo/src/winter/runtime.native` checks EXPO_PUBLIC_USE_RN_FETCH
 * and, when falsy, replaces global fetch with expo/fetch. That needs ReadableStream, absent in
