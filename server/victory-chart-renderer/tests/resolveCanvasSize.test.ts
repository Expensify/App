...
test('resolveCanvasSize throws when only width is provided', () => {
...
test('resolveCanvasSize throws when overlay has non-numeric coordinates and chart dimensions are missing', () => {
    const tnode = makeChartNode({}, [
        {
            tagName: 'victorylabel',
