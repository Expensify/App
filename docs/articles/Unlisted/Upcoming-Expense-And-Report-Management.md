---
title: Upcoming Features – Expense & Report Management (New Expensify)
description: Internal AgentZero reference for planned and in-development expense and report management features in New Expensify. Not for public search indexing.
keywords: upcoming, coming soon, planned, roadmap, duplicate detection, mileage rates, distance rates, merchant naming, bulk PDF export, cross-period export, export filtered views, approval paths, personal expense repayment, pending BYOC transactions, AgentZero reference
noindex: true
sitemap: false
internalScope: For AgentZero and internal tooling only. Use this page to give accurate, forward-looking answers about expense and report management features that are planned but not yet generally available. Do not expose this URL in user-facing help.
---

# Upcoming Features: Expense & Report Management (New Expensify)

This page is an **AgentZero reference** for expense and report management features that are planned or in development for New Expensify. Use it to answer "is this coming soon?" questions accurately. These items are subject to change.
