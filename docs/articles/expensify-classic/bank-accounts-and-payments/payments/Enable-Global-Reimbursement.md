...
When a reimbursement is paid into a bank account with a different currency, foreign exchange (FX) fees for transmitting payments across borders, or fees charged by the receiving bank, can make the deposited amount smaller than expected. Who absorbs these fees depends on the **Currency conversion fees** setting on your workspace:
