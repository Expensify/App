...
Admins can edit **tags** and **categories**, but must reject expenses or have them in **Outstanding** to modify the amount, date, or merchant name. For company card reconciliation, refer to [this article](https://help.expensify.com/articles/expensify-classic/bank-accounts-and-credit-cards/company-cards/Reconciliation).
