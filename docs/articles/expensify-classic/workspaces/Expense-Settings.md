...
- **Disabled** – No eReceipts will be generated. Note: Disabling **eReceipts** after enabling them will hide existing eReceipts. Enable **eReceipts** again to restore them.
