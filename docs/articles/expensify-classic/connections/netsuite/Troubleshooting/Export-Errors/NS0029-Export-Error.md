...
This means there is a connection issue between Expensify and NetSuite that is preventing the report from exporting.
...
- An authentication or token-related problem.
- A permission or role configuration issue in NetSuite.
- A backend processing error during export.
