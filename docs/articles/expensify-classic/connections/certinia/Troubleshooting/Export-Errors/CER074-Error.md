---
title: CER074 Error in Certinia Integration
description: Learn what the CER074 error means in Certinia and how to configure the required Permission Controls to restore successful exports.
keywords: CER074, Certinia export error, insufficient permissions for resource, Certinia permission controls, report creator permission error, Expensify Certinia sync error, Workspace Admin
internalScope: Audience is Workspace Admins using the Certinia integration. Covers resolving the CER074 error caused by missing or incorrect Permission Controls. Does not cover other Certinia error codes.
---

# CER074 Error in Certinia Integration
...
## Why the CER074 Error Happens in Certinia
...
Ensure the Permission Control applies to the report creator or submitter and the specific Resource associated with the export.
