...
description: Learn what the CER047 export error means in Certinia and how to enable the Expense Ops Edit permission to restore successful exports.
keywords: CER047, Certinia export error, Ops Edit permission required, Expense Ops Edit permission, approved records permission error, Expensify Certinia sync error, Workspace Admin
...
## Why the CER047 Export Error Happens in Certinia
...
## How to Fix the CER047 Export Error
...
Yes. After enabling **Expense Ops Edit** and selecting **Sync Now**, retry the export. If the error persists, confirm the permission is applied to the correct user.

## Does CER047 Mean My Expense Was Deleted?

No. The report remains in Expensify. The export failed because Certinia blocked the update due to missing permissions.
