...
description: Learn how to fix the DESK08 error in QuickBooks Desktop when Expensify cannot reach the Web Connector or company file.
...
Expensify relies on the Web Connector to communicate with QuickBooks Desktop. If either application is not running or accessible, the sync will fail.
