...
description: Learn how to fix the DESK15 sync error in QuickBooks Desktop when a request cannot be executed through the Web Connector.
keywords: DESK15, QuickBooks Desktop sync error, could not execute request, Web Connector log file, QBWC error log, Expensify QuickBooks Desktop connection issue, Workspace Admin
...
This means QuickBooks Web Connector was unable to process a request from Expensify during a sync.
...
- Permissions or hosting restrictions block the request.

To determine the root cause, you must review the QuickBooks Web Connector log file.
...
In most cases, no. The log file is required to determine why the request failed.

## Does DESK15 Mean My Data Is Lost?

No. This error indicates a failed request. Your data remains intact in both Expensify and QuickBooks Desktop.
