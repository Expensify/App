...
- If QuickBooks Desktop is installed locally, the Web Connector must also be installed locally.
...
2. Use **Task Manager** to ensure it is no longer running.
...
After completing these steps, the connection should sync successfully.
...
Both errors indicate connection issues between Expensify and QuickBooks Desktop, but they may occur under slightly different circumstances. The troubleshooting steps are similar.
