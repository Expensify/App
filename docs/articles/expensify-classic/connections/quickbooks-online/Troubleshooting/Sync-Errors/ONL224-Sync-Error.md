...
keywords: ONL224, QuickBooks Online sync error, not listed as admin QuickBooks, QuickBooks Online admin required, connect QuickBooks Online Expensify, Workspace Admin
...
This means the QuickBooks Online user attempting to connect the integration does not have Company Admin access, preventing the connection from completing.
...
Only QuickBooks Online Company Admin users can connect a QuickBooks account to a Workspace.
...
5. Click **Sync Now** to confirm the integration is working properly.
...
No. You can reconnect directly using a QuickBooks Online Company Admin account.
