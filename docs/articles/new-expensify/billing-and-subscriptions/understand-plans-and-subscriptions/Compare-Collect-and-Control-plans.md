...
## When should you choose the Collect plan?
...
Yes. The Expensify Card is available with both plans. However, only the Control plan offers subscription pricing that varies based on qualifying Expensify Card usage.
