...
**View payment history** appears only when both are true: you're the billing owner, and your account has been billed at least once. If your account hasn't been charged yet, no receipts exist. If someone else is the billing owner, check the **Billing owner** column on the **Workspaces** tab to confirm who can access the receipts.
