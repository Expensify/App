...
To learn which plan is right for your organization, see [Compare Collect and Control Plans](/articles/new-expensify/billing-and-subscriptions/learn-about-plans-subscriptions-and-pricing/Compare-Collect-and-Control-Plans).
...
## How to switch between the Collect and Control plans

1. In the navigation tabs (on the left on web, at the bottom on mobile), go to **Workspaces > [workspace name]**.
2. Select **Overview**. 
3. Select **Plan type**. 
4. Choose **Collect** or **Control**.
5. Confirm your selection. 

**Note:** If your workspace is on the Control plan with an Annual subscription, you can't downgrade to Collect until your subscription term ends. To learn more, see When You Can Change Your Plan. 
...
## Related articles
 ...
 - [Understand Expensify pricing](/articles/new-expensify/billing-and-subscriptions/learn-about-plans-subscriptions-and-pricing/Understand-Expensify-Pricing)
