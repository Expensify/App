...
- **Submitters** can split any editable expense they've created, including unreported expenses
...
Yes. You can split unreported expenses that appear in your self-DM. Open the expense, tap **More > Split**, and follow the same steps as any other split.
