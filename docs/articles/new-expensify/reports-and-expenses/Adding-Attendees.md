...
3. Choose **Edit multiple**:
   - **On web:** Select **Edit multiple** in the bar that appears at the bottom of the list. If you don't see it, select **More** first.
   - **On mobile:** Tap **Selected**, then select **Edit multiple**.
