...
3. In the bulk action bar at the bottom of the list, click **Export**. If you don't see it, click **More**, then **Export**.
...
Once you initiate the export, you can choose to wait for the download to finish or have **Concierge** send it to you in a chat message once it's ready.
...
5. Select **Export**:
   - **Web:** In the bulk action bar at the bottom of the list, click **Export**. If you don't see it, click **More**, then **Export**.
...
3. Select **Download reports**:
   - **Web:** In the bulk action bar at the bottom of the list, click **Download reports**. If you don't see it, click **More**, then **Download reports**.
...
3. Select **Download receipts**:
   - **Web:** In the bulk action bar at the bottom of the list, click **Download receipts**. If you don't see it, click **More**, then **Download receipts**.
...
Yes. On the **Spend** page, select multiple expenses or reports, then choose **Download receipts**. On web the action sits in the bulk action bar at the bottom of the list, behind **More** if the bar has no room to show it as a button. On mobile, tap **Selected** to find it. The receipts are packaged into a single ZIP file.
