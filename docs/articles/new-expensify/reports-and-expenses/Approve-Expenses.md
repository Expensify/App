...
3. Select **Change approver**:
   - **Web:** In the bulk action bar at the bottom of the list, select **Change approver**. If you don't see it, select **More**, then **Change approver**.
   - **Mobile:** Tap **Selected**, then tap **Change approver**.
