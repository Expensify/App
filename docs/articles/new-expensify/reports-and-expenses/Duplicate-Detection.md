...
Duplicate Detection helps prevent accidental double-submission of expenses by flagging entries within a member's account that have the same **date** and **amount**. When a potential duplicate is found, a red dot appears in the navigation tabs or next to the chat where the expense lives, and the expense is placed on **hold**.
...
1. From the navigation tabs, click the red dot or open the chat containing the flagged expense.
