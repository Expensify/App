...
2. Select **Create report** to open a draft report on your default workspace.
  ...
  - If you don't have a workspace yet, you'll be prompted to create one first. Select **Upgrade**, then select **Got it, thanks** to confirm. A new workspace is created automatically and your report opens on it.
