...
If all transactions on your report are pending Expensify Card transactions, you'll see the **Submit** button but clicking it displays an **Unable to submit report** error. Pending transactions may take a few days to post. Once at least one transaction has posted, you can submit the report.
