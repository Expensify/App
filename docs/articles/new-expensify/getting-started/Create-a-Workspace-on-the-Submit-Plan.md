---
title: Create a Workspace on the Submit Plan
description: Learn how to create a Submit workspace in Expensify to track expenses, submit reports to a manager, and collaborate with teammates for free.
keywords: submit plan Expensify, create submit workspace, free expense reporting, submit expenses to manager, employee expense tracking, Expensify Submit workspace, upgrade to Collect
internalScope:
  Audience: Employees, individual contributors, small teams exploring Expensify without admin approval
  What it covers: Creating a Submit workspace, submitting expenses, inviting teammates, upgrading to paid plans
  What it does not cover: Advanced approvals, accounting integrations, company cards, or admin-level billing setup
---
