...
|---|---|---|
| Fix a broken company card connection | Open the **Home** tab and review the **Time sensitive** section. Select **Fix** next to the connection that needs attention. | [Learn how to fix a broken company card feed connection](/articles/new-expensify/connect-credit-cards/Fix-a-Broken-Company-Card-Feed-Connection). |
| Assign company cards | Within your Workspace, select **Company Cards**, then select **Assign** next to the card you want to assign. | [Learn how to assign company cards](/articles/new-expensify/connect-credit-cards/Assign-Company-Cards). |
