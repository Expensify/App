...
Rooms may have restricted posting permissions for Admins only. In these rooms, you can still edit your own previously sent messages, but you cannot send new ones. In other cases, the conversation may be read-only, and you’ll see a "This conversation is read-only" banner at the bottom of the chat.
