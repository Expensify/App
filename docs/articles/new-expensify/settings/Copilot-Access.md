...
internalScope: Audience is all Expensify members. Covers how to add, remove, update, and navigate as a Copilot. Does not cover troubleshooting or instructions for taking actions outside of Copilot management. 
---
...
2. Click **Add a copilot to your account**.
...
1. In the navigation tabs (on the left on web, and at the bottom on mobile), click **Account > Copilot**.
2. In the **These members can access your account** section, click the three dots **(⋮)** next to their name.
...
If you've been added as a Copilot, you can switch into the other user's account from the Copilot page.

1. In the navigation tabs (on the left on web, and at the bottom on mobile), click **Account > Copilot**.
2. In the **You can access these accounts** section, click **Switch** next to the account you want to access.
