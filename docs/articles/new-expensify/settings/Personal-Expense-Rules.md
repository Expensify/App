...
description: Set up personal Expense Rules to automatically categorize and code your expenses based on the merchant name.
keywords: [New Expensify, expense rules, personal rules, auto-categorize, merchant matching, account settings, reimbursable, billable, report assignment, auto-apply, automatically code]
internalScope: Audience is individual members. Covers creating, editing, deleting, and managing personal Expense Rules. Does not cover Workspace Merchant Rules configuration.
---
...
1. Click **Account** in the navigation tabs (on the left on web, and at the bottom on mobile)
2. Select **Expense Rules**
...
2. Click or tap **New rule**
3. Under **If expense contains**, enter the merchant name
4. Under **Then apply these updates**, configure at least one of the following:
   - Merchant name
   - Category
   - Tag
   - Tax rate
...
1. Go to **Account > Expense Rules**
2. Select the checkbox next to the rule(s)
3. Click the **Selected** dropdown
4. Select **Delete rule(s)**
5. Confirm deletion
...
1. Create an Expense Rule using the merchant name (for example, “Uber”)
2. Set the appropriate Category
3. Click **Save rule**
