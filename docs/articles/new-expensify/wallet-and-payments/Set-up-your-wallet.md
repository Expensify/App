...
**Note:** If you enter a phone number that is different from the one already saved on your account, you’ll be asked to verify the change with a magic code before continuing. A prompt titled **Let's make sure it's you** appears—enter the security code sent to your primary contact method to proceed. No code is required if you’re adding a phone number for the first time or leaving it unchanged.
