...
internalScope: Audience is Domain Admins and IT admins. Covers enabling and configuring SAML SSO for a verified domain, plus common configuration checks. Does not cover end-user login troubleshooting outside SAML configuration.
...
⚠️ **Note:** Your domain must be verified before you can enable SAML. [Learn how to claim and verify a domain](https://help.expensify.com/articles/new-expensify/domains/Claim-and-Verify-a-Domain)
