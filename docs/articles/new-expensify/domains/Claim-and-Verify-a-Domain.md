...
2. Click the **New domain** button.
   - If you have already claimed one or more domains, click the **New** button in the upper-right corner to add a new domain.
...
- A three dots menu **(⋮)** with management options
