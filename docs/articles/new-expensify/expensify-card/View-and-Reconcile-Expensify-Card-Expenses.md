...
2. Select **Export**:
   - **Web:** In the bulk action bar at the bottom of the results, click **Export**. If you don't see it, click **More**, then **Export**.
...
2. Select **Download statement**:
   - **Web:** In the bulk action bar at the bottom of the results, click **Download statement**. If you don't see it, click **More**, then **Download statement**.
   - **Mobile:** Tap **Selected**, then tap **Download statement**.
