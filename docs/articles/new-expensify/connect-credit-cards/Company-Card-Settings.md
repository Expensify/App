...
- **Assign new cards** (direct feeds only): Reconnects to your bank to refresh the card list so newly issued cards appear in the assignment UI. Click **Assign new cards** and complete the bank re-authentication to pull the latest cards from your bank
