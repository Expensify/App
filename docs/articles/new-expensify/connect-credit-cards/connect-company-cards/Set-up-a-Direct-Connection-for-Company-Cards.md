...
retrievalIntent: How to set up a direct connection to a bank or card provider for company cards.
contentType: task
platform: new
order: 2
---
...
If your bank isn't supported, you can [import company card transactions from a spreadsheet](/articles/new-expensify/connect-credit-cards/connect-company-cards/Import-Company-Card-Transactions-From-a-Spreadsheet) instead.
...
- Cards with recent expenses appear as a list and can be assigned to workspace members.
...
3. Complete the bank reauthentication to pull the latest cards from your bank.
...
Plaid enables connections with hundreds of additional banks across the U.S., Canada, and Europe. Check the [Plaid coverage page for US/Canada](https://plaid.com/docs/institutions/) or the [Plaid coverage page for UK/Europe](https://plaid.com/docs/institutions/europe/) to see if your bank is supported.
