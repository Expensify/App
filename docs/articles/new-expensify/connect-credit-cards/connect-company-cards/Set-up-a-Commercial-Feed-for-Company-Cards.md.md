...
3. Select **Add cards** to set up your first connection.
    -  If you don't see **Add cards**, select your existing company card feed connection then **Add cards**.
...
## What happens after a commercial card feed is connected 
 ...
 - All cards with transactions posted after feed enablement date will appear as a list and can be assigned to workspace members.
