...
description: Learn the difference between direct connections and commercial card feeds for importing company card transactions from your bank or card provider into Expensify.
...
internalScope: Audience is workspace admins and card admins. Covers the differences between direct connections and commercial card feeds for importing company card transactions. Does not cover setting up a company card connection or assigning company cards to members.
retrievalIntent: The difference between a direct connection and a commercial card feed for company cards.
contentType: topic
platform: new
order: 1
---
...
To check whether Expensify supports a direct connection with your bank, see [Check Supported Banks](/articles/new-expensify/connect-credit-cards/Check-Supported-Banks).
...
Yes. Once a company card connection is established, you can share it with other workspaces instead of setting up the connection again. [Learn how to share a company card connection across workspaces](/articles/new-expensify/connect-credit-cards/connect-company-cards/Share-a-Company-Card-Connection-Across-Workspaces).
