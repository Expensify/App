...
keywords: [New Expensify, fringe benefits, payroll code]
---
...
4. Follow [these instructions](https://help.expensify.com/articles/new-expensify/workspaces/Create-expense-tags) to add tags.  

## Add Payroll Code  
1. Navigate to **Workspaces > [Workspace Name] > Categories**.  
2. Select the category on which you want to track FBT.  
...
To extract the data:  
1. Use a **CSV Export** to format your report.  
...
For more details, visit our [CSV export guide](https://help.expensify.com/articles/new-expensify/reports-and-expenses/Search-and-Download-Expenses).  
