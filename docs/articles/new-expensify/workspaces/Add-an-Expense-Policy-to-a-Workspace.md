---
title: Add an expense policy to a workspace 
description: Add a PDF expense policy document or create a text-based expense policy so workspace members can view your company's expense guidelines.
keywords: [New Expensify, expense policy, policy document, policy text, upload expense policy PDF, workspace expense guidelines, workspace policy]
