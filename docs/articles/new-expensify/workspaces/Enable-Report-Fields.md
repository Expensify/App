...
Once the fields exist, members fill them out on the report itself. [Learn how to fill out Report fields on a report](/articles/new-expensify/reports-and-expenses/Fill-Out-Report-Fields-on-a-Report).
...
3. Click **Reports**.
4. Under **Report fields**, turn on the toggle.
...
2. Under **Report fields**, click **Add field**.
...
1. Go to **Workspaces > [Workspace Name] > Reports**.
2. Under **Report fields**, click the field you want to update.
