...
6. Stay on the page and wait for the sync to complete. The **HiBob sync complete** screen then opens with the **Added**, **Removed**, and **Skipped** employee counts.
...
Employees may be skipped if they do not have a work email address in HiBob, or if they are not active employees. On the **HiBob sync complete** screen, click **Skipped** to see each skipped employee and the reason they were skipped.
