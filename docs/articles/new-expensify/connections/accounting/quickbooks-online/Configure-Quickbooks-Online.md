...
- **Export company card expenses as**:
  - Credit card (default)
  - Debit card
    - Optionally set a **Default vendor** as a fallback for expenses that don't have a vendor set. Learn how vendors are imported, matched, and exported in [QuickBooks Online Vendor Matching](/articles/new-expensify/connections/accounting/quickbooks-online/Manage-Vendor-Matching-for-QuickBooks-Online.md).
  - Vendor bill
