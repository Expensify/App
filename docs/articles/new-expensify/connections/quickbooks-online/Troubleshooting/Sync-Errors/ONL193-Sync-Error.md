...
- Security settings or multi-factor authentication were modified.
...
Tip: Before reconnecting, consider taking a screenshot of your current accounting configuration so you can restore settings if needed.
...
No. Selecting **Reconnect** during the sync process reauthorizes the connection without fully disconnecting the integration.

## Will Reconnecting Remove My Settings?

In some cases, you may need to reconfigure export settings or reselect categories and tags after reconnecting.
