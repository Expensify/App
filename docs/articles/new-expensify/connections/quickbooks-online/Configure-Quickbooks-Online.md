...
- **Export Consolidated Travel Billing expenses as**: This option appears only when [Consolidated Travel Billing](https://help.expensify.com/travel/hubs/consolidated-travel-billing/) is enabled. Travel expenses export as credit card charges. Click it, then select the **Credit card account** where travel expenses will post in QuickBooks Online.
...
- **Sync Consolidated Travel Billing settlements**: This option appears only when [Consolidated Travel Billing](https://help.expensify.com/travel/hubs/consolidated-travel-billing/) is enabled. Turn on this toggle to continuously reconcile settlements through QuickBooks Online. When enabled, select a **Reconciliation account** to match your settlement account. Auto-sync must be enabled to use this setting.
