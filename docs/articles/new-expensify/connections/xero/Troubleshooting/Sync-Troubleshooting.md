...
keywords: [New Expensify, Xero, sync error, troubleshooting, decision tree, connection error, export error, XERO error, sync failed, integration sync, Xero troubleshooting]
---
...
- **The Xero connection is active.** Open your workspace settings and verify the connection is listed under Accounting. If it is not connected, follow the steps in [Connect to Xero](https://help.expensify.com/articles/new-expensify/connections/xero/Connect-to-Xero).
...
- **No** — The connection may have been removed or was never set up. Go to [Connect to Xero](https://help.expensify.com/articles/new-expensify/connections/xero/Connect-to-Xero) and follow the setup steps.
...
- **Yes** — Look up the error code in the appropriate Troubleshooting subfolder:
  - [Sync Errors](https://help.expensify.com/articles/new-expensify/connections/xero/Troubleshooting/Sync-Errors) for XERO sync error codes.
  - [Export Errors](https://help.expensify.com/articles/new-expensify/connections/xero/Troubleshooting/Export-Errors) for XERO export error codes.
  - [Authentication and Login Errors](https://help.expensify.com/articles/new-expensify/connections/xero/Troubleshooting/Authentication-and-Login-errors) for login-related codes.
  - [Connection Errors](https://help.expensify.com/articles/new-expensify/connections/xero/Troubleshooting/Connection-errors) for connection-related codes.
...
- **Xero password was changed or OAuth2 access was revoked** — Disconnect and reconnect in Expensify. See [Connect to Xero](https://help.expensify.com/articles/new-expensify/connections/xero/Connect-to-Xero).
...
2. **Disconnect and reconnect.** Remove the Xero connection from your workspace and set it up again following [Connect to Xero](https://help.expensify.com/articles/new-expensify/connections/xero/Connect-to-Xero).
3. **Review your Xero configuration.** Compare your settings in Expensify against your Xero setup using [Configure Xero](https://help.expensify.com/articles/new-expensify/connections/xero/Configure-Xero).
