---
title: Error NS0844 - Permission error querying NetSuite for Vendor
description: Resolve the error "Permission error querying NetSuite for Vendor" by update NetSuite role permissions to allow Vendor record access.
