!(function (t, e) {
    ...
    return (
        (t = {
            918: (t) => {
                t.exports = {
                    getChildPosition: (t) => {
                        ...
                        for (let o = 0; o < e.children.length; o++) if (e.children[o] === t) return o;
                    },
            ...
            613: (t, e, o) => {
                const {activateTabFromUrl: a, updateUrlWithActiveTab: n, handleTabClicked: s, addCopyToClipboardButtons: r, syncTabsWithSameLabels: l, appendToastMessageHTML: i} = o(925);
                t.exports = {
                    init: (t = {}) => {
                        const e = {
                                ...
                                copyToClipboardSettings: {buttonHTML: '<button>Copy</button>', showToastMessageOnCopy: !1, toastMessage: 'Code copied to clipboard', toastDuration: 3e3},
                            },
                            o = {...e, ...t, copyToClipboardSettings: {...e.copyToClipboardSettings, ...t.copyToClipboardSettings}},
            ...
            925: (t, e, o) => {
                const {getChildPosition: a, createElementFromHTML: n, findElementsWithTextContent: s, addClass: r} = o(918),
                    l = (t) => {
                ...
                t.exports = {
                    ...
                    handleTabClicked: i,
                    copyToClipboard: c,
                    addCopyToClipboardButtons: ({buttonHTML: t, showToastMessageOnCopy: e, toastDuration: o}) => {
                    ...
                    appendToastMessageHTML: (t) => {
                        ...
                        (e.id = 'jekyll-tabs-copy-to-clipboard-message'), (e.textContent = t), document.getElementsByTagName('body')[0].appendChild(e);
                    },
                };
            },
        }),
