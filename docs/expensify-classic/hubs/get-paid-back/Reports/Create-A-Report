...
*Note:* You may be unable to edit your reports' titles based on the policy settings. 
...
## Changing the report policy

To change the report policy, click *Details* in the top-right of the report on the web app, then select the correct policy from the *Policy* drop-down. 
...
Your Company Admin can answer this one, and they may have configured the policy’s [Scheduled Submit] setting to enforce a regular cadence for you. If not, you can still set this up under your [Individual Policy].
