...
1. In the root folder of the repository, execute `bun run createDocsRoutes` to generate the file which contains the routes for the articles (without this, the site will appear empty).
