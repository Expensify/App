...
export default {
    ...
    PUSHER: {
        ...
        AUTH_URL: IS_IN_PRODUCTION ? 'https://www.expensify.com' : 'https://3181268f341d.ngrok.io',
        CLUSTER: 'mt1',
    },
    EXPENSIFY: {
        ...
        API_ROOT: IS_IN_PRODUCTION ? 'https://www.expensify.com/api?' : 'https://3181268f341d.ngrok.io/api?',
    }
};
