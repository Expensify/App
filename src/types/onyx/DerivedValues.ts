...
/**
 * Maps a participant set to the reportID of its 1:1 (or system) chat. Keys come from `getParticipantsChatKey`.
 */
type OneOnOneChatReportIDsDerivedValue = Record<string, string>;
