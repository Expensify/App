...
const CONST = {
     ...
     * If you are using the `role` prop, then try `CONST.ARIA.ROLE` instead.
     *
     */
    ARIA: {
        ACCESSIBILITY_ROLE: {
     ...
     * If you are looking for values for the `accessibilityRole` prop, try `CONST.ARIA.ACCESSIBILITY_ROLE` instead.
     */
        ROLE: {
