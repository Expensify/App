...
const CONST = {
    ...
    ATTACHMENT_MODAL_TYPE: {
        REPORT_ATTACHMENT: SCREENS.ATTACHMENTS,
        TRANSACTION_RECEIPT: SCREENS.TRANSACTION_RECEIPT,
        PROFILE_AVATAR: SCREENS.PROFILE_AVATAR,
        WORKSPACE_AVATAR: SCREENS.WORKSPACE_AVATAR,
        REPORT_AVATAR: SCREENS.REPORT_AVATAR,
    },
