...
/**
 * A screen in the active tab counts as visible while an RHP is topmost, taken to be the pane beside it. That is only true above about 1230px, and never under a super-wide RHP.
