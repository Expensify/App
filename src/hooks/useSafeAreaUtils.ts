 ...
 * }
 */
function useSafeAreaUtils(): SafeAreaUtils {
    ...
    return {
        ...
        safeAreaPaddingBottomStyle: {paddingBottom: adaptedPaddingBottom},
    };
}

export default useSafeAreaUtils;
export type {SafeAreaUtils};
