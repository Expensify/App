...
type UsePersonalBankAccountDetailsFormSubmit = Pick<SubStepProps, 'onNext'> & {
    formId?: OnyxFormKey;
    fieldIds: Array<FormOnyxKeys<typeof ONYXKEYS.FORMS.PERSONAL_BANK_ACCOUNT_FORM>>;
...
export default function usePersonalBankAccountDetailsFormSubmit({onNext, fieldIds, shouldSaveDraft}: UsePersonalBankAccountDetailsFormSubmit) {
    return useStepFormSubmit<typeof ONYXKEYS.FORMS.PERSONAL_BANK_ACCOUNT_FORM>({
