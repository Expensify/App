...
/**
 * @deprecated This hook is will be removed once the refactor (https://github.com/Expensify/App/issues/79039) is complete. Use useSubPage hook instead (see NAVIGATION.md for details).
