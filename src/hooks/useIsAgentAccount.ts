...
function useIsAgentAccount(): boolean | undefined {
    ...
    // switch, whereas IS_LOADING_APP is optimistically set to `true` by *every* OpenApp - including ones that fire
    // mid-session, long after identity is known. Gating on IS_LOADING_APP alone therefore makes consumers
