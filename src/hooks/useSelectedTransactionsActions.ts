...
function useSelectedTransactionsActions({
    ...
    if (selectedTransactionIDs.length) {
        ...
        const canSelectedExpensesBeMoved = selectedTransactionsList.every((transaction) => {
            ...
            const canMoveExpense = canEditFieldOfMoneyRequest(iouReportAction, CONST.EDIT_REQUEST_FIELD.REPORT, undefined, undefined, outstandingReportsByPolicyID, transaction);
