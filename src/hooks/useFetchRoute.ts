...
import {getValidWaypoints, hasRoute as hasRouteTransactionUtils, isDistanceRequest, isGPSDistanceRequest, isManualDistanceRequest} from '@libs/TransactionUtils';
...
export default function useFetchRoute(
    ...
    const isMapDistanceRequest = isDistanceRequest(transaction) && !isManualDistanceRequest(transaction) && !isGPSDistanceRequest(transaction);
