...
const useSearchTypeMenuSections = () => {
    ...
    const hasViolations = hasViolationsReportUtils(undefined, transactionViolations, currentUserLoginAndAccountID?.accountID ?? CONST.DEFAULT_NUMBER_ID, currentUserLoginAndAccountID?.email ?? '');
