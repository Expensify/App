    ...
    const headerButtonsOptions = useMemo(() => {
        ...
        if (canSplitTransaction) {
            options.push({
                ...
                onSelected: () => {
                    initSplitExpense(firstTransaction, firstTransactionPolicy, accountID);
                },
            });
        }
            ...
            options.push({
                ...
                onSelected: () => {
                    if (shouldShowEditSplitOnDeleteAction && firstTransaction) {
                        initSplitExpense(firstTransaction, firstTransactionPolicy, accountID, {navigateToEditSplitExpense: true});
                        return;
                    }
