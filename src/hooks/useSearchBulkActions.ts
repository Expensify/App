    ...
    return items
        ...
        .find(
            (policyID): policyID is string =>
                !!policyID &&
                shouldRestrictUserBillableActions(allPolicies?.[`${ONYXKEYS.COLLECTION.POLICY}${policyID}`], ownerBillingGracePeriodEnd, billingGracePeriods, amountOwed, currentUserAccountID),
        );
}
