...
/**
 * Custom React hook created to handle sync of focus on an element when the user navigate through the app with keyboard.
 * When the user navigate through an app using the arrows and then the tab button, the focus on the element and the native focus of the browser differs.
