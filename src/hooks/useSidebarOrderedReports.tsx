...
function SidebarOrderedReportsContextProvider({
    ...
    const getOrderedReportIDs = useCallback(
        () => SidebarUtils.sortReportsToDisplayInLHN(reportsToDisplayInLHN, priorityMode, localeCompare, formatPhoneNumber, hasDraftByReportID, reportNameValuePairs, reportAttributes),
        // Rule disabled intentionally - reports should be sorted only when the reportsToDisplayInLHN changes
        // eslint-disable-next-line react-hooks/exhaustive-deps
        [reportsToDisplayInLHN, localeCompare, hasDraftByReportID, reportAttributes, formatPhoneNumber],
    );
