...
import type {CompanyCardFeedName, CompanyCardsList} from '@src/types/onyx';
import useOnyx from './useOnyx';

/* Custom hook that retrieves a list of company cards for the given selected feed. */
const useCardsList = (selectedFeed: CompanyCardFeedName | undefined): [CompanyCardsList | undefined, ResultMetadata<CompanyCardsList>] => {
