...
const FILLER_MESSAGE_POOLS: Record<string, string[]> = {
    data: [
        ...
        'Concierge is indexing results...',
        'Concierge is querying services...',
        'Concierge is correlating sources...',
        'Concierge is crunching numbers...',
        'Concierge is reviewing logs...',
        'Concierge is aggregating insights...',
        'Concierge is reconciling data...',
        'Concierge is scanning for updates...',
    ...
    expenseAction: [
        ...
        'Concierge is attaching your receipt...',
        'Concierge is creating line items...',
        'Concierge is classifying the expense...',
        'Concierge is checking limits...',
        'Concierge is queuing submission...',
        'Concierge is recording the transaction...',
        'Concierge is confirming allocations...',
        'Concierge is reconciling totals...',
        'Concierge is preparing reimbursement...',
    ...
    expenseUpdate: [
        ...
        'Concierge is recalculating totals...',
        'Concierge is refreshing exchange rates...',
        'Concierge is validating changes...',
        'Concierge is syncing policy updates...',
        'Concierge is updating allocations...',
        'Concierge is normalizing data...',
        'Concierge is confirming amounts...',
        'Concierge is revalidating receipts...',
    ...
    comment: [
        ...
        'Concierge is trimming redundancies...',
