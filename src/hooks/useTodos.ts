...
export default function useTodos() {
    ...
    return useMemo(() => {
        ...
        for (const report of reports) {
            ...
            if (isPrimaryPayAction(report, accountID, login, policy, reportNameValuePair)) {
        ...
        return {reportsToSubmit, reportsToApprove, reportsToPay, reportsToExport};
    }, [allReports, allTransactions, allPolicies, allReportNameValuePairs, allReportActions, accountID, login]);
}
