 ...
 * change where new cards are issued. Reconciliation only reads settings, so its selection stays local to these pages
 * and resets to the default feed on the next visit.
 */
