...
function useSettingsStatus(): SettingsStatus {
  ...
  const errorChecking = {
    ...
    [CONST.SETTINGS_STATUS.HAS_POLICY_ERRORS]: Object.values(cleanPolicies).some(PolicyUtils.hasPolicyError),
    [CONST.SETTINGS_STATUS.HAS_CUSTOM_UNITS_ERROR]: Object.values(cleanPolicies).some(PolicyUtils.hasCustomUnitsError),
    [CONST.SETTINGS_STATUS.HAS_EMPLOYEE_LIST_ERROR]: Object.values(cleanPolicies).some(PolicyUtils.hasEmployeeListError),
    [CONST.SETTINGS_STATUS.HAS_SYNC_ERRORS]: Object.values(cleanPolicies).some((cleanPolicy) =>
