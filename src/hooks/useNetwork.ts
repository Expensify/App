...
export default function useNetwork({onReconnect = () => {}}: UseNetworkProps = {}): UseNetwork {
    ...
    const {networkStatus, isBackendReachable} = useContext(NetworkContext) ?? {...CONST.DEFAULT_NETWORK_DATA, networkStatus: CONST.NETWORK.NETWORK_STATUS.UNKNOWN};
    ...
    return {isOffline, isBackendReachable: isBackendReachable ?? true};
}
