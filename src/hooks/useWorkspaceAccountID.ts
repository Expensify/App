...
const policyWorkspaceAccountIDSelector = (policy: OnyxEntry<Policy>) => policy?.policyAccountID ?? (policy as OnyxEntry<Policy & {workspaceAccountID?: number}>)?.workspaceAccountID;
