...
function getIconDetails({
    ...
    policy,
    formatPhoneNumber,
}: AvatarDetailsProps & {reportPreviewSenderID: number | undefined} & {formatPhoneNumber: FormatPhoneNumberType}) {
    ...
    const getSecondaryAvatar = () => {
        ...
        if (displayAllActors) {
            ...
            const secondaryDisplayName = getDisplayNameForParticipant({accountID: secondaryAccountId, formatPhoneNumber});
    ...
    if (action?.actionName !== CONST.REPORT.ACTIONS.TYPE.REPORT_PREVIEW) {
        return {
            ...
            ...getIconDetails({
                ...
                iouReport,
                reportPreviewSenderID: undefined,
                formatPhoneNumber: rest.formatPhoneNumber,
            }),
        };
    }
