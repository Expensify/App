...
const SCREENS = {
    ...
    SETTINGS: {
        ...
        PROFILE: {
            ...
            STATUS_CLEAR_AFTER_DATE_YEAR: 'Settings_Status_Clear_After_Date_Year',
            ...
            PERSONAL_DETAILS: {
                ...
                DATE_OF_BIRTH_YEAR: 'Settings_PersonalDetails_DateOfBirth_Year',
    ...
    MONEY_REQUEST: {
        ...
        STEP_DATE_YEAR: 'Money_Request_Step_Date_Year',
