...
const SCREENS = {
    ...
    WORKSPACE: {
        ACCOUNTING: {
            ...
            XERO_TRAVEL_INVOICING_CONFIGURATION: 'Workspace_Accounting_Xero_Travel_Invoicing_Configuration',
            XERO_TRAVEL_INVOICING_PAYABLE_ACCOUNT_SELECT: 'Workspace_Accounting_Xero_Travel_Invoicing_Payable_Account_Select',
