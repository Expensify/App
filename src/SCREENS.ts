...
const SCREENS = {
    ...
    WORKSPACE: {
        ACCOUNTING: {
            ...
            DYNAMIC_QUICKBOOKS_DESKTOP_COMPANY_CARD_EXPENSE_ACCOUNT_COMPANY_CARD_SELECT: 'Dynamic_Workspace_Accounting_Quickbooks_Desktop_Export_Company_Card_Expense_Select',
