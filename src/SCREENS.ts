...
const SCREENS = {
    ...
    WORKSPACE: {
        ACCOUNTING: {
            ...
            QUICKBOOKS_DESKTOP_TRAVEL_INVOICING_CONFIGURATION: 'Workspace_Accounting_Quickbooks_Desktop_Travel_Invoicing_Configuration',
            QUICKBOOKS_DESKTOP_TRAVEL_INVOICING_VENDOR_SELECT: 'Workspace_Accounting_Quickbooks_Desktop_Travel_Invoicing_Vendor_Select',
            QUICKBOOKS_DESKTOP_TRAVEL_INVOICING_PAYABLE_ACCOUNT_SELECT: 'Workspace_Accounting_Quickbooks_Desktop_Travel_Invoicing_Payable_Account_Select',
