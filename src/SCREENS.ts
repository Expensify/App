...
const SCREENS = {
    ...
    WORKSPACE: {
        ACCOUNTING: {
            ...
            DUALENTRY_TRAVEL_INVOICING_SETTLEMENT_ACCOUNT: 'Policy_Accounting_DualEntry_Travel_Invoicing_Settlement_Account',
            DUALENTRY_TRAVEL_INVOICING_PAYABLE_ACCOUNT: 'Policy_Accounting_DualEntry_Travel_Invoicing_Payable_Account',
