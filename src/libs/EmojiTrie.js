...
function addKeywordsToTrie(trie, keywords, item, name, shouldPrependKeyword) {
    ...
    keywords.forEach(function (keyword) {
        ...
        if (!keywordNode) {
            ...
            var suggestions = shouldPrependKeyword ? __spreadArrays([suggestion], ((_a = keywordNode.metaData.suggestions) !== null && _a !== void 0 ? _a : [])) : __spreadArrays(((_b = keywordNode.metaData.suggestions) !== null && _b !== void 0 ? _b : []), [suggestion]);
