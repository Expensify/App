...
function getMatchingFullScreenRoute(route, policyID) {
    ...
    if (RELATIONS_1.RHP_TO_SIDEBAR[route.name]) {
        ...
        }, undefined, policyID ? { policyID: policyID } : undefined);
    }
...
function getDefaultFullScreenRoute(route, policyID) {
    ...
    if (route && isRouteWithReportID(route)) {
        ...
        if (!((_a = allReports === null || allReports === void 0 ? void 0 : allReports["" + ONYXKEYS_1["default"].COLLECTION.REPORT + reportID]) === null || _a === void 0 ? void 0 : _a.reportID)) {
...
function getAdaptedState(state, policyID) {
    var fullScreenRoute = state.routes.find(function (route) { return isNavigatorName_1.isFullScreenName(route.name); });
