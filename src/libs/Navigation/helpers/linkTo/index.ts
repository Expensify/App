 ...
 */
const ROOT_TAB_SCREENS = new Set<string>([SCREENS.HOME, SCREENS.INBOX, SCREENS.SEARCH.ROOT, SCREENS.INSIGHTS, SCREENS.MORE, SCREENS.SETTINGS.ROOT, SCREENS.WORKSPACES_LIST]);
