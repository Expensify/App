...
function areNamesAndParamsEqual(currentState, stateFromPath) {
    ...
    var areParamsEqual = ObjectUtils_1.shallowCompare(currentFocusedRoute === null || currentFocusedRoute === void 0 ? void 0 : currentFocusedRoute.params, targetFocusedRoute === null || targetFocusedRoute === void 0 ? void 0 : targetFocusedRoute.params);
...
function linkTo(navigation, path, options) {
    ...
    if (shouldCheckFullScreenRouteMatching(action)) {
        ...
        if (newFocusedRoute) {
            ...
            var lastFullScreenRoute = currentState.routes.findLast(function (route) { return getAdaptedStateFromPath_1.isFullScreenName(route.name); });
