...
function linkTo(navigation, path, options) {
    ...
    if (shouldCheckFullScreenRouteMatching(action)) {
        ...
        if (newFocusedRoute) {
            var matchingFullScreenRoute = (0, getAdaptedStateFromPath_1.getMatchingFullScreenRoute)(newFocusedRoute);
            ...
            if (matchingFullScreenRoute && lastFullScreenRoute && matchingFullScreenRoute.name !== lastFullScreenRoute.name) {
                var lastRouteInMatchingFullScreen = (_c = (_b = matchingFullScreenRoute.state) === null || _b === void 0 ? void 0 : _b.routes) === null || _c === void 0 ? void 0 : _c.at(-1);
