...
const FULL_SCREENS_SET = new Set(__spreadArrays(Object.values(RELATIONS_1.SIDEBAR_TO_SPLIT), [NAVIGATORS_1['default'].SEARCH_FULLSCREEN_NAVIGATOR]));
...
const SETTINGS_TAB_SET = new Set(Object.values([NAVIGATORS_1['default'].SETTINGS_SPLIT_NAVIGATOR, NAVIGATORS_1['default'].WORKSPACE_SPLIT_NAVIGATOR]));
/**
