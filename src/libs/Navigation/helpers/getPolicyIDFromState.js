...
var getPolicyIDFromState = function (state) {
    var _a, _b, _c, _d;
    var lastPolicyRoute = (_a = state === null || state === void 0 ? void 0 : state.routes) === null || _a === void 0 ? void 0 : _a.findLast(function (route) { return route.name === NAVIGATORS_1["default"].REPORTS_SPLIT_NAVIGATOR || route.name === NAVIGATORS_1["default"].SEARCH_FULLSCREEN_NAVIGATOR; });
    ...
    var lastSearchRoute = (_d = (_c = lastPolicyRoute === null || lastPolicyRoute === void 0 ? void 0 : lastPolicyRoute.state) === null || _c === void 0 ? void 0 : _c.routes) === null || _d === void 0 ? void 0 : _d.findLast(function (route) { return route.name === SCREENS_1["default"].SEARCH.ROOT; });
    if (lastSearchRoute) {
