        ...
        screens: {
            ...
            [NAVIGATORS.CENTRAL_PANE_NAVIGATOR]: {
                screens: {
                    ...
                    [SCREENS.INDIVIDUAL_WORKSPACE_OLDDOT]: ROUTES.INDIVIDUAL_OLDDOT,
                    ...
                    // Breadcrumb screens
                    [SCREENS.WORKSPACE_OVERVIEW_OLDDOT]: ROUTES.WORKSPACE_OVERVIEW_OLDDOT,
                    [SCREENS.WORKSPACE_EXPENSES_OLDDOT]: ROUTES.WORKSPACE_EXPENSES_OLDDOT,
                    [SCREENS.WORKSPACE_REPORTS_OLDDOT]: ROUTES.WORKSPACE_REPORTS_OLDDOT,
                    [SCREENS.WORKSPACE_CONNECTIONS_OLDDOT]: ROUTES.WORKSPACE_CONNECTIONS_OLDDOT,
                    [SCREENS.WORKSPACE_CATEGORIES_OLDDOT]: ROUTES.WORKSPACE_CATEGORIES_OLDDOT,
                    [SCREENS.WORKSPACE_TAGS_OLDDOT]: ROUTES.WORKSPACE_TAGS_OLDDOT,
                    [SCREENS.WORKSPACE_TAX_OLDDOT]: ROUTES.WORKSPACE_TAX_OLDDOT,
                    [SCREENS.WORKSPACE_MEMBERS_OLDDOT]: ROUTES.WORKSPACE_MEMBERS_OLDDOT,
                    [SCREENS.WORKSPACE_REIMBURSEMENT_OLDDOT]: ROUTES.WORKSPACE_REIMBURSEMENT_OLDDOT,
                    [SCREENS.WORKSPACE_TRAVEL_OLDDOT]: ROUTES.WORKSPACE_TRAVEL_OLDDOT,
                    [SCREENS.WORKSPACE_PER_DIEM_OLDDOT]: ROUTES.WORKSPACE_PER_DIEM_OLDDOT,
                    [SCREENS.WORKSPACE_EXPORT_FORMATS_OLDDOT]: ROUTES.WORKSPACE_EXPORT_FORMATS_OLDDOT,
                    [SCREENS.WORKSPACE_INVOICES_OLDDOT]: ROUTES.WORKSPACE_INVOICES_OLDDOT,
                    [SCREENS.WORKSPACE_PLAN_OLDDOT]: ROUTES.WORKSPACE_PLAN_OLDDOT,

                    [SCREENS.DOMAIN_COMPANY_CARDS_OLDDOT]: ROUTES.DOMAIN_COMPANY_CARDS_OLDDOT,
                    [SCREENS.DOMAIN_ADMINS_OLDDOT]: ROUTES.DOMAIN_ADMINS_OLDDOT,
                    [SCREENS.DOMAIN_MEMBERS_OLDDOT]: ROUTES.DOMAIN_MEMBERS_OLDDOT,
                    [SCREENS.DOMAIN_GROUPS_OLDDOT]: ROUTES.DOMAIN_GROUPS_OLDDOT,
                    [SCREENS.DOMAIN_REPORTING_TOOLS_OLDDOT]: ROUTES.DOMAIN_REPORTING_TOOLS_OLDDOT,
                    [SCREENS.DOMAIN_SAML_OLDDOT]: ROUTES.DOMAIN_SAML_OLDDOT,
                },
            },
            [SCREENS.NOT_FOUND]: '*',
