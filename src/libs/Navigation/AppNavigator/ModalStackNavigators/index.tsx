...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.ACCOUNTING.XERO_TRACK_CATEGORIES]: () => require('../../../../pages/workspace/accounting/xero/XeroTrackCategoriesPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.ACCOUNTING.XERO_MAP_COST_CENTERS]: () => require('../../../../pages/workspace/accounting/xero/XeroMapCostCentersToPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.ACCOUNTING.XERO_MAP_REGIONS]: () => require('../../../../pages/workspace/accounting/xero/XeroMapRegionsToPage').default as React.ComponentType,
