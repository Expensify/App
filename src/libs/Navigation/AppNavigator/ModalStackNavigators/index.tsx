...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.COMPANY_CARD_ADD_WORK_EMAIL]: () => require<ReactComponentModule>('../../../../pages/workspace/cardFeed/WorkspaceCardFeedAddWorkEmailPage').default,
    ...
    [SCREENS.WORKSPACE.EXPENSIFY_CARD_ADD_WORK_EMAIL]: () => require<ReactComponentModule>('../../../../pages/workspace/cardFeed/WorkspaceCardFeedAddWorkEmailPage').default,
