...
const TagsModalStackNavigator = createModalStackNavigator({
    [SCREENS.SETTINGS_TAGS.DYNAMIC_SETTINGS_TAGS_SETTINGS]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/DynamicWorkspaceTagsSettingsPage').default,
    ...
    [SCREENS.SETTINGS_TAGS.SETTINGS_TAGS_IMPORT]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/DynamicImportTagsPage').default,
    [SCREENS.WORKSPACE.TAGS_IMPORT_OPTIONS]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/ImportTagsOptionsPage').default,
    [SCREENS.SETTINGS_TAGS.SETTINGS_TAGS_IMPORTED]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/DynamicImportedTagsPage').default,
...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.DYNAMIC_TAGS_IMPORT]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/DynamicImportTagsPage').default,
    [SCREENS.WORKSPACE.TAGS_IMPORT_OPTIONS]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/ImportTagsOptionsPage').default,
    ...
    [SCREENS.WORKSPACE.DYNAMIC_TAGS_IMPORTED]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/DynamicImportedTagsPage').default,
    ...
    [SCREENS.WORKSPACE.DYNAMIC_TAGS_SETTINGS]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/DynamicWorkspaceTagsSettingsPage').default,
    [SCREENS.WORKSPACE.TAG_SETTINGS]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/TagSettingsPage').default,
    [SCREENS.WORKSPACE.DYNAMIC_WORKSPACE_TAG_LIST_VIEW]: () => require<ReactComponentModule>('../../../../pages/workspace/tags/DynamicWorkspaceViewTagsPage').default,
...
const SearchAdvancedFiltersModalStackNavigator = createModalStackNavigator({
    ...
    [SCREENS.SEARCH.ADVANCED_FILTERS_RECEIPT_TYPE_RHP]: () => require<ReactComponentModule>('../../../../pages/Search/SearchAdvancedFiltersPage/SearchFiltersReceiptTypePage').default,
