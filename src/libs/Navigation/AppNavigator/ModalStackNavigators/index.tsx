...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.QUICKBOOKS_ONLINE_EXPORT]: () => require('@pages/workspace/accounting/qbo/export/QuickbooksExportConfigurationPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.QUICKBOOKS_ONLINE_EXPORT_DATE_SELECT]: () => require('@pages/workspace/accounting/qbo/export/QuickbooksExportDateSelectPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.QUICKBOOKS_ONLINE_EXPORT_INVOICE_ACCOUNT_SELECT]: () =>
        require('@pages/workspace/accounting/qbo/export/QuickbooksInvoiceAccountSelectPage').default as React.ComponentType,
    ...
    [SCREENS.WORKSPACE.QUICKBOOKS_ONLINE_EXPORT_COMPANY_CARD_EXPENSE]: () =>
        require('@pages/workspace/accounting/qbo/export/QuickbooksCompanyCardExpenseConfigurationPage').default as React.ComponentType,
