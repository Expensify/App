...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.SETTINGS.WALLET.SHARE_BANK_ACCOUNT_SUCCESS]: () => require<ReactComponentModule>('../../../../pages/settings/Wallet/ShareBankAccount/ShareBankAccountSuccess').default,
