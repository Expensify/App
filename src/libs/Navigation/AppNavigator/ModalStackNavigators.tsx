...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.RATE_AND_UNIT.ROOT]: () => require('../../../pages/workspace/reimburse/WorkspaceRateAndUnitPage/BasePage').default as React.ComponentType,
    [SCREENS.WORKSPACE.RATE_AND_UNIT.RATE]: () => require('../../../pages/workspace/reimburse/WorkspaceRateAndUnitPage/RatePage').default as React.ComponentType,
    [SCREENS.WORKSPACE.RATE_AND_UNIT.UNIT]: () => require('../../../pages/workspace/reimburse/WorkspaceRateAndUnitPage/UnitPage').default as React.ComponentType,
