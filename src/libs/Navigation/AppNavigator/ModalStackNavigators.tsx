...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.WORKSPACE.QUICKBOOKSONLINE_IMPORT]: () => require('../../../pages/workspace/accounting/qbo/QuickbooksImportPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.QUICKBOOKSONLINE_CHART_OF_ACCOUNTS]: () => require('@pages/workspace/accounting/qbo/QuickbooksChartOfAccountsPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.QUICKBOOKSONLINE_CUSTOMERS]: () => require('../../../pages/workspace/accounting/qbo/QuickbooksCustomersPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.QUICKBOOKSONLINE_TAXES]: () => require('../../../pages/workspace/accounting/qbo/QuickbooksTaxesPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.QUICKBOOKSONLINE_LOCATIONS]: () => require('../../../pages/workspace/accounting/qbo/QuickbooksLocationsPage').default as React.ComponentType,
    [SCREENS.WORKSPACE.QUICKBOOKSONLINE_CLASSES]: () => require('../../../pages/workspace/accounting/qbo/QuickbooksClassesPage').default as React.ComponentType,
