...
const MoneyRequestModalStackNavigator = createModalStackNavigator<MoneyRequestNavigatorParamList>({
    ...
    [SCREENS.MONEY_REQUEST.TAX_AMOUNT]: () => require('../../../pages/iou/steps/IOURequestStepTaxAmountPage').default as React.ComponentType,
    [SCREENS.MONEY_REQUEST.TAX_RATE]: () => require('../../../pages/iou/steps/IOURequestStepTaxRatePage').default as React.ComponentType,
