...
const MoneyRequestModalStackNavigator = createModalStackNavigator<MoneyRequestNavigatorParamList>({
    ...
    [SCREENS.MONEY_REQUEST.STEP_DATE_YEAR]: () => require('../../../pages/iou/request/step/IOURequestStepDateYear').default as React.ComponentType,
...
const SettingsModalStackNavigator = createModalStackNavigator<SettingsNavigatorParamList>({
    ...
    [SCREENS.SETTINGS.PROFILE.PERSONAL_DETAILS.DATE_OF_BIRTH_YEAR]: () => require('../../../pages/settings/Profile/PersonalDetails/DOBYearPickerPage').default as React.ComponentType,
    ...
    [SCREENS.SETTINGS.PROFILE.STATUS_CLEAR_AFTER_DATE_YEAR]: () => require('../../../pages/settings/Profile/CustomStatus/SetDateYearPage').default as React.ComponentType,
