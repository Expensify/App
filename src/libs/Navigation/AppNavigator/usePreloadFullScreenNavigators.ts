...
// Currently, only the Account, Inbox and Workspaces tabs are preloaded. The remaining tabs will be supported soon.
const TABS_TO_PRELOAD = [NAVIGATION_TABS.SETTINGS, NAVIGATION_TABS.WORKSPACES, NAVIGATION_TABS.HOME];
