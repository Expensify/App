...
import {isCentralPaneName, isHomeTab, isSearchTab, isSettingsTab} from '@libs/NavigationUtils';
    ...
    return (
        <View style={styles.bottomTabBarContainer}>
                ...
                >
                    <View>
                        <Icon
                            ...
                            fill={isHomeTab(activeBottomTabRoute?.name) ? theme.iconMenu : theme.icon}
            ...
            <Tooltip text={translate('common.search')}>
                <PressableWithFeedback
                    onPress={() => {
                        if (isSearchTab(activeBottomTabRoute?.name)) {
                            return;
                        }
                ...
                >
                    <View>
                        <Icon
                            ...
                            fill={isSearchTab(activeBottomTabRoute?.name) ? theme.iconMenu : theme.icon}
                            width={variables.iconBottomBar}
                            height={variables.iconBottomBar}
                        />
                    </View>
            ...
            <BottomTabAvatar isSelected={isSettingsTab(activeBottomTabRoute?.name)} />
