        ...
        if (SessionUtils.didUserLogInDuringSession() || delegatorEmail) {
            if (delegatorEmail) {
                ...
                if (reportID && !isAuthenticatedAtStartup) {
                    Report.openReport(reportID, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined,undefined, undefined,accountDelegateEmail);
