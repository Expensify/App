...
const MoneyRequestModalStackNavigator = createModalStackNavigator([
    ...
    {
        getComponent: () => {
            const NewDistanceRequestWaypointEditorPage = require('../../../pages/iou/NewDistanceRequestWaypointEditorPage').default;
            return NewDistanceRequestWaypointEditorPage;
        },
        name: 'Money_Request_Waypoint',
    },
    {
        getComponent: () => {
            const MoneyRequestEditWaypointPage = require('../../../pages/iou/MoneyRequestEditWaypointPage').default;
            return MoneyRequestEditWaypointPage;
        },
        name: 'Money_Request_Edit_Waypoint',
    },
    {
        getComponent: () => {
            const NewDistanceRequestPage = require('../../../pages/iou/NewDistanceRequestPage').default;
            return NewDistanceRequestPage;
        },
