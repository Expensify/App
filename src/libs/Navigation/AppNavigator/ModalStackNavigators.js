...
import WorkspaceNameEditorPage from '../../../pages/workspace/WorkspaceNameEditorPage';
...
const WorkspaceNameEditorNavigator = createModalStackNavigator([{
    Component: WorkspaceNameEditorPage,
    name: 'WorkspaceNameEditor_Root',
}]);
