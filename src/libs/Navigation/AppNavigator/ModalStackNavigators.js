...
const MoneyRequestModalStackNavigator = createModalStackNavigator({
    ...
    MoneyTemporaryForRefactor_Request_Step_Confirmation: () => require('../../../pages/iou/request/step/IOURequestStepConfirmation').default,
    MoneyTemporaryForRefactor_Request_Step_Amount: () => require('../../../pages/iou/request/step/IOURequestStepAmount').default,
    MoneyTemporaryForRefactor_Request_Step_Category: () => require('../../../pages/iou/request/step/IOURequestStepCategory').default,
    MoneyTemporaryForRefactor_Request_Step_Currency: () => require('../../../pages/iou/request/step/IOURequestStepCurrency').default,
    MoneyTemporaryForRefactor_Request_Step_Date: () => require('../../../pages/iou/request/step/IOURequestStepDate').default,
    MoneyTemporaryForRefactor_Request_Step_Description: () => require('../../../pages/iou/request/step/IOURequestStepDescription').default,
    MoneyTemporaryForRefactor_Request_Step_Distance: () => require('../../../pages/iou/request/step/IOURequestStepDistance').default,
    MoneyTemporaryForRefactor_Request_Step_Merchant: () => require('../../../pages/iou/request/step/IOURequestStepMerchant').default,
    MoneyTemporaryForRefactor_Request_Step_Participants: () => require('../../../pages/iou/request/step/IOURequestStepParticipants').default,
    MoneyTemporaryForRefactor_Request_Step_Scan: () => require('../../../pages/iou/request/step/IOURequestStepScan').default,
    MoneyTemporaryForRefactor_Request_Step_Tag: () => require('../../../pages/iou/request/step/IOURequestStepTag').default,
    MoneyTemporaryForRefactor_Request_Step_Waypoint: () => require('../../../pages/iou/request/step/IOURequestStepWaypoint').default,
