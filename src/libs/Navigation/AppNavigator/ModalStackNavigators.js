...
const SettingsModalStackNavigator = createModalStackNavigator({
    ...
    [SCREENS.SETTINGS.WALLET.CARDS.GET_PHYSICAL.NAME]: () => require('../../../pages/settings/Wallet/Cards/GetPhysicalCardName').default,
    [SCREENS.SETTINGS.WALLET.CARDS.GET_PHYSICAL.PHONE]: () => require('../../../pages/settings/Wallet/Cards/GetPhysicalCardPhone').default,
    [SCREENS.SETTINGS.WALLET.CARDS.GET_PHYSICAL.ADDRESS]: () => require('../../../pages/settings/Wallet/Cards/GetPhysicalCardAddress').default,
    [SCREENS.SETTINGS.WALLET.CARDS.GET_PHYSICAL.CONFIRM]: () => require('../../../pages/settings/Wallet/Cards/GetPhysicalCardConfirm').default,
