...
const MoneyRequestModalStackNavigator = createModalStackNavigator({
    Money_Request_Create: () => require('../../../pages/iou/request/IOURequestStartPage').default,
    Money_Request_Step_Confirmation: () => require('../../../pages/iou/request/step/IOURequestStepConfirmation').default,
    Money_Request_Step_Amount: () => require('../../../pages/iou/request/step/IOURequestStepAmount').default,
    Money_Request_Step_Category: () => require('../../../pages/iou/request/step/IOURequestStepCategory').default,
    Money_Request_Step_Currency: () => require('../../../pages/iou/request/step/IOURequestStepCurrency').default,
    Money_Request_Step_Date: () => require('../../../pages/iou/request/step/IOURequestStepDate').default,
    Money_Request_Step_Description: () => require('../../../pages/iou/request/step/IOURequestStepDescription').default,
    Money_Request_Step_Distance: () => require('../../../pages/iou/request/step/IOURequestStepDistance').default,
    Money_Request_Step_Merchant: () => require('../../../pages/iou/request/step/IOURequestStepMerchant').default,
    Money_Request_Step_Participants: () => require('../../../pages/iou/request/step/IOURequestStepParticipants').default,
    Money_Request_Step_Scan: () => require('../../../pages/iou/request/step/IOURequestStepScan').default,
    Money_Request_Step_Tag: () => require('../../../pages/iou/request/step/IOURequestStepTag').default,
    Money_Request_Step_Waypoint: () => require('../../../pages/iou/request/step/IOURequestStepWaypoint').default,
