...
function convertToWebNavigationOptions(screenOptions) {
    ...
    if ((0, types_1.isRouteBasedScreenOptions)(screenOptions)) {
        ...
        return function (props) {
            ...
            return __assign(__assign({}, (0, buildPlatformSpecificNavigationOptions_1.default)(routeBasedScreenOptions)), routeBasedScreenOptions.web);
        };
    }
    return __assign(__assign({}, (0, buildPlatformSpecificNavigationOptions_1.default)(screenOptions)), screenOptions.web);
}
