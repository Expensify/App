...
type PlatformNavigatorImplProps<RouterOptions extends PlatformStackRouterOptions = PlatformStackRouterOptions> = PlatformStackNavigatorProps<ParamListBase, RouterOptions> & {
    ...
    shouldWrapPersistentScreens?: CreatePlatformStackNavigatorComponentOptions<RouterOptions>['shouldWrapPersistentScreens'];
    displayName: string;
};
...
function PlatformNavigatorImpl<RouterOptions extends PlatformStackRouterOptions = PlatformStackRouterOptions>({
    ...
    const wrappedDescriptors = nonTopScreensBehavior
        ? wrapDescriptorsWithNonTopScreensBehavior(descriptors, state, nonTopScreensBehavior, shouldWrapPersistentScreens ? undefined : persistentScreens)
        : descriptors;
    ...
    function PlatformNavigator(props: PlatformStackNavigatorProps<ParamListBase>) {
        return (
            <PlatformNavigatorImpl
                ...
                shouldWrapPersistentScreens={options?.shouldWrapPersistentScreens}
