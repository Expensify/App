...
var convertToWebNavigationOptions_1 = require("@libs/Navigation/PlatformStackNavigation/navigationOptions/convertToWebNavigationOptions");
function createPlatformStackNavigatorComponent(displayName, options) {
    ...
    function PlatformNavigator(_a) {
        ...
        var _b = (0, native_1.useNavigationBuilder)(createRouter, {
            ...
            persistentScreens: persistentScreens,
        }, convertToWebNavigationOptions_1.default), navigation = _b.navigation, originalState = _b.state, descriptors = _b.descriptors, describe = _b.describe, NavigationContent = _b.NavigationContent;
        ...
        var mappedState = (0, react_1.useMemo)(function () {
            return __assign(__assign({}, state), { routes: state.routes.map(function (route) {
                    // eslint-disable-next-line rulesdir/no-negated-variables
                    var dontDetachScreen = (persistentScreens === null || persistentScreens === void 0 ? void 0 : persistentScreens.includes(route.name)) ? { dontDetachScreen: true } : {};
                    return __assign(__assign({}, route), dontDetachScreen);
                }) });
