 ...
 *
 * The painted content is stale for as long as the screen is covered, so it is marked inert for that whole time,
 * which keeps it out of the accessibility tree and out of the reach of touches. The flag follows the navigation
 * state rather than the Activity mode, because a reveal is deferred until the transition ends and the screen the
 * user is already looking at has to be usable right away.
 */
