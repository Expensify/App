...
type BookEventsNavigatorParamList = {
    [SCREENS.EVENTS.BOOK_EVENTS]: undefined;
};
...
type RightModalNavigatorParamList = {
    ...
    [SCREENS.RIGHT_MODAL.EVENTS]: NavigatorScreenParams<BookEventsNavigatorParamList>;
