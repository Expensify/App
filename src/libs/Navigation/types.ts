...
type SettingsNavigatorParamList = {
    ...
    [SCREENS.WORKSPACE.QUICKBOOKS_ONLINE_EXPORT_DATE]: {
        policyID: string;
    };
    [SCREENS.WORKSPACE.QUICKBOOKS_ONLINE_EXPORT_INVOICES]: {
        policyID: string;
    };
    [SCREENS.WORKSPACE.QUICKBOOKS_ONLINE_EXPORT_COMPANY_CARDS]: {
        policyID: string;
    };
    [SCREENS.WORKSPACE.QUICKBOOKS_ONLINE_EXPORT_COMPANY_CARD]: {
        policyID: string;
    };
