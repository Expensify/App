...
const SETTINGS_TO_RHP: Partial<Record<keyof SettingsSplitNavigatorParamList, string[]>> = {
    ...
    [SCREENS.SETTINGS.TROUBLESHOOT]: [SCREENS.SETTINGS.DYNAMIC_EXIT_SURVEY_REASON, SCREENS.SETTINGS.DYNAMIC_EXIT_SURVEY_CONFIRM, SCREENS.SETTINGS.TROUBLESHOOT_SERVER],
