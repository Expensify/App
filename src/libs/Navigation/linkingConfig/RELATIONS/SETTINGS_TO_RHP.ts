...
const SETTINGS_TO_RHP: Partial<Record<keyof SettingsSplitNavigatorParamList, string[]>> = {
    ...
    [SCREENS.SETTINGS.AGENTS.ROOT]: [SCREENS.SETTINGS.AGENTS.ADD, SCREENS.SETTINGS.AGENTS.EDIT, SCREENS.SETTINGS.AGENTS.EDIT_NAME, SCREENS.SETTINGS.AGENTS.EDIT_PROMPT],
