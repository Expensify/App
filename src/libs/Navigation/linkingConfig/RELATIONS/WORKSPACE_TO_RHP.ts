...
const WORKSPACE_TO_RHP: Partial<Record<keyof WorkspaceSplitNavigatorParamList, string[]>> = {
    ...
    [SCREENS.WORKSPACE.RECRUITING]: [SCREENS.WORKSPACE.RECRUITING_MERGE_APPROVAL_MODE, SCREENS.WORKSPACE.RECRUITING_MERGE_APPROVER_FIELD, SCREENS.WORKSPACE.RECRUITING_MERGE_FINAL_APPROVER],
