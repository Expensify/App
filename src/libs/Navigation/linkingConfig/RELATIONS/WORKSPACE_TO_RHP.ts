...
const WORKSPACE_TO_RHP: Partial<Record<keyof WorkspaceSplitNavigatorParamList, string[]>> = {
    ...
    [SCREENS.WORKSPACE.RECEIPT_PARTNERS]: [SCREENS.WORKSPACE.RECEIPT_PARTNERS_INVITE, SCREENS.WORKSPACE.RECEIPT_PARTNERS_INVITE_CONFIRM, SCREENS.WORKSPACE.RECEIPT_PARTNERS_INVITE_EDIT],
