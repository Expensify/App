...
const WORKSPACE_TO_RHP: Partial<Record<keyof WorkspaceSplitNavigatorParamList, string[]>> = {
    ...
    [SCREENS.WORKSPACE.TRAVEL]: [SCREENS.WORKSPACE.TRAVEL_SETTINGS_ACCOUNT, SCREENS.WORKSPACE.TRAVEL_SETTINGS_FREQUENCY, SCREENS.WORKSPACE.TRAVEL_EXPORT, SCREENS.WORKSPACE.TRAVEL_MISSING_PERSONAL_DETAILS],
