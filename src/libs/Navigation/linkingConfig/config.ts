                ...
                [SCREENS.RIGHT_MODAL.SETTINGS]: {
                    screens: {
                        ...
                        [SCREENS.WORKSPACE.EXPENSIFY_CARD_SPEND_RULE_SELECTION]: {
                            path: ROUTES.WORKSPACE_EXPENSIFY_CARD_SPEND_RULE_SELECTION.route,
                        },
                        [SCREENS.WORKSPACE.EXPENSIFY_CARD_SPEND_RULE_MERCHANTS]: {
                            path: ROUTES.WORKSPACE_EXPENSIFY_CARD_SPEND_RULE_MERCHANTS.route,
                        },
                        [SCREENS.WORKSPACE.EXPENSIFY_CARD_SPEND_RULE_MERCHANT_EDIT]: {
                            path: ROUTES.WORKSPACE_EXPENSIFY_CARD_SPEND_RULE_MERCHANT_EDIT.route,
                        },
                        [SCREENS.WORKSPACE.EXPENSIFY_CARD_SPEND_RULE_CATEGORY]: {
                            path: ROUTES.WORKSPACE_EXPENSIFY_CARD_SPEND_RULE_CATEGORY.route,
                        },
                        [SCREENS.WORKSPACE.EXPENSIFY_CARD_SPEND_RULE_MAX_AMOUNT]: {
                            path: ROUTES.WORKSPACE_EXPENSIFY_CARD_SPEND_RULE_MAX_AMOUNT.route,
                        },
