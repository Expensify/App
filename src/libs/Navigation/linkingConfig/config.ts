                ...
                [SCREENS.RIGHT_MODAL.SETTINGS]: {
                    screens: {
                        ...
                        [SCREENS.WORKSPACE.ACCOUNTING.DYNAMIC_SAGE_INTACCT_REIMBURSABLE_DESTINATION]: {
                            path: `workspaces/:policyID/accounting/sage-intacct/export/reimbursable/${DYNAMIC_ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_REIMBURSABLE_DESTINATION.path}`,
                        },
                        [SCREENS.WORKSPACE.ACCOUNTING.DYNAMIC_SAGE_INTACCT_NON_REIMBURSABLE_DESTINATION]: {
                            path: `workspaces/:policyID/accounting/sage-intacct/export/nonreimbursable/${DYNAMIC_ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_NON_REIMBURSABLE_DESTINATION.path}`,
                        },
                        ...
                        [SCREENS.WORKSPACE.ACCOUNTING.DYNAMIC_SAGE_INTACCT_NON_REIMBURSABLE_CREDIT_CARD_ACCOUNT]: {
                            path: `workspaces/:policyID/accounting/sage-intacct/export/nonreimbursable/${DYNAMIC_ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_NON_REIMBURSABLE_CREDIT_CARD_ACCOUNT.path}`,
                        },
