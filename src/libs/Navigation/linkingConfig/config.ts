            ...
            screens: {
                [SCREENS.RIGHT_MODAL.SETTINGS]: {
                    screens: {
                        ...
                        [SCREENS.WORKSPACE.ACCOUNTING.DUALENTRY_TRAVEL_INVOICING_SETTLEMENT_ACCOUNT]: {path: ROUTES.POLICY_ACCOUNTING_DUALENTRY_TRAVEL_INVOICING_SETTLEMENT_ACCOUNT.route},
                        [SCREENS.WORKSPACE.ACCOUNTING.DUALENTRY_TRAVEL_INVOICING_PAYABLE_ACCOUNT]: {path: ROUTES.POLICY_ACCOUNTING_DUALENTRY_TRAVEL_INVOICING_PAYABLE_ACCOUNT.route},
