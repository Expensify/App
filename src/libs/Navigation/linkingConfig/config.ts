    ...
    screens: {
        ...
        [NAVIGATORS.FEATURE_TRAINING_MODAL_NAVIGATOR]: {
            screens: {
                ...
                [SCREENS.DYNAMIC_HOLD_EDUCATIONAL_ROOT]: DYNAMIC_ROUTES.HOLD_EDUCATIONAL.path,
                [SCREENS.DYNAMIC_HOLD_EDUCATIONAL_BULK_ROOT]: DYNAMIC_ROUTES.HOLD_EDUCATIONAL_BULK.path,
            },
        },
