            ...
            screens: {
                ...
                [SCREENS.RIGHT_MODAL.MONEY_REQUEST]: {
                    screens: {
                        ...
                        [SCREENS.MONEY_REQUEST.DYNAMIC_STEP_ATTENDEES]: DYNAMIC_ROUTES.MONEY_REQUEST_STEP_ATTENDEES.path,
                        [SCREENS.MONEY_REQUEST.DYNAMIC_STEP_ACCOUNTANT]: DYNAMIC_ROUTES.MONEY_REQUEST_STEP_ACCOUNTANT.path,
                        [SCREENS.MONEY_REQUEST.DYNAMIC_STEP_UPGRADE]: DYNAMIC_ROUTES.MONEY_REQUEST_STEP_UPGRADE.path,
