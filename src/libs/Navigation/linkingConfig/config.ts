            ...
            screens: {
                [SCREENS.RIGHT_MODAL.SETTINGS]: {
                    screens: {
                        ...
                        [SCREENS.WORKSPACE.QUICKBOOKSONLINE_EXPORT_INVOICES]: {path: ROUTES.WORKSPACE_ACCOUNTING_QUICKBOOKSONLINE_INVOICES.route},
                        [SCREENS.WORKSPACE.QUICKBOOKSONLINE_EXPORT_COMPANY_CARDS]: {path: ROUTES.WORKSPACE_ACCOUNTING_QUICKBOOKSONLINE_COMPANY_CARDS.route},
                        [SCREENS.WORKSPACE.QUICKBOOKSONLINE_EXPORT_COMPANY_CARD]: {path: ROUTES.WORKSPACE_ACCOUNTING_QUICKBOOKSONLINE_COMPANY_CARD.route},
