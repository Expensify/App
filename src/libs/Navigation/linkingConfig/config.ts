            ...
            screens: {
                [SCREENS.RIGHT_MODAL.SETTINGS]: {
                    screens: {
                        ...
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_EXPORT]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_EXPORT.path},
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_PREFERRED_EXPORTER]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_PREFERRED_EXPORTER.path},
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_VENDOR_BILL_DATE]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_VENDOR_BILL_DATE.path},
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_COMPANY_CARD_ACCOUNT]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_COMPANY_CARD_ACCOUNT.path},
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_DEFAULT_COMPANY_CARD_VENDOR]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_DEFAULT_COMPANY_CARD_VENDOR.path},
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_CARD_PROGRAM_ACCOUNT]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_CARD_PROGRAM_ACCOUNT.path},
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_CARD_PROGRAM_ACCOUNT_SELECTOR]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_CARD_PROGRAM_ACCOUNT_SELECTOR.path},
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_CARD_ACCOUNT]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_CARD_ACCOUNT.path},
                        [SCREENS.WORKSPACE.ACCOUNTING.RILLET_CARD_ACCOUNT_CARD_LIST]: {path: DYNAMIC_ROUTES.POLICY_ACCOUNTING_RILLET_CARD_ACCOUNT_CARD_LIST.path},
