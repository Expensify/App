...
const FULL_SCREEN_TO_RHP_MAPPING: Partial<Record<FullScreenName, string[]>> = {
    ...
    [SCREENS.WORKSPACE.ACCOUNTING]: [SCREENS.WORKSPACE.QUICKBOOKSONLINE_EXPORT, SCREENS.WORKSPACE.QUICKBOOKSONLINE_EXPORT_DATE, SCREENS.WORKSPACE.QUICKBOOKSONLINE_EXPORT_INVOICES],
