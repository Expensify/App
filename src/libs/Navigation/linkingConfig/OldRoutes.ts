const oldRoutes: Record<string, string> = {
    ...
    '/settings/*/category/*/gl-code': '/settings/$1/categories/category-settings/$2/gl-code',
    '/settings/*/category/*/payroll-code': '/settings/$1/categories/category-settings/$2/payroll-code',
