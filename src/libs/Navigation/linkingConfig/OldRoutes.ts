const oldRoutes: Record<string, string> = {
    ...
    // The entry below is a guard, not a redirect: the report participant-details route has the same segment count
    // as `/*/*/participants/*/*`, and the matcher picks the longest pattern, so this identity pattern wins.
