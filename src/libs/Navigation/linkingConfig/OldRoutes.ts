const oldRoutes: Record<string, string> = {
    ...
    '/merge/*/receipt': '/merge/$1/merge-transaction-receipt',
    '/merge/*/details': '/merge/$1/merge-transaction-details',
    '/merge/*/confirmation': '/merge/$1/merge-transaction-confirmation',
