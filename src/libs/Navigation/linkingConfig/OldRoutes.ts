const oldRoutes: Record<string, string> = {
    ...
    '/settings/*/tags/*/edit': '/settings/$1/tags/settings-tags-settings/settings-tags-edit/$2',
    ...
    '/settings/*/tags/settings-tags-settings/edit/*': '/settings/$1/tags/settings-tags-settings/settings-tags-edit/$2',
    ...
    '/workspaces/*/tags/workspace-tag-list/*': '/workspaces/$1/tags/workspace-tag-list/$2',
