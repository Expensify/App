...
function signInToOldDotAndChooseExperience(
    ...
    startSpan(CONST.TELEMETRY.SPAN_OD_ND_TRANSITION_STAGES.SIGN_IN_OLD_DOT, {
        name: CONST.TELEMETRY.SPAN_OD_ND_TRANSITION_STAGES.SIGN_IN_OLD_DOT,
        op: CONST.TELEMETRY.SPAN_OD_ND_TRANSITION_STAGES.SIGN_IN_OLD_DOT,
    ...
    if (tryNewDot !== undefined) {
        setUseNewDotSignInPage(false).then(() => {
            endSpan(CONST.TELEMETRY.SPAN_OD_ND_TRANSITION_STAGES.SIGN_IN_OLD_DOT);
