...
const translations_1 = require('@src/languages/translations');
const ONYXKEYS_1 = require('@src/ONYXKEYS');
const EmptyObject_1 = require('@src/types/utils/EmptyObject');
const LocaleListener_1 = require('./LocaleListener');
const BaseLocaleListener_1 = require('./LocaleListener/BaseLocaleListener');
...
function getTranslatedPhrase(language, phraseKey, fallbackLanguage) {
    ...
    const translatedPhrase =
        (_a = translations_1['default'] === null || translations_1['default'] === void 0 ? void 0 : translations_1['default'][language]) === null || _a === void 0 ? void 0 : _a[phraseKey];
    if (translatedPhrase) {
        if (typeof translatedPhrase === 'function') {
            ...
            const translateResult = translateFunction.apply(void 0, parameters);
    ...
    const fallbackTranslatedPhrase = getTranslatedPhrase.apply(void 0, __spreadArrays([fallbackLanguage, phraseKey, null], parameters));
...
const memoizedGetTranslatedPhrase = memoize_1['default'](getTranslatedPhrase, {
    maxArgs: 2,
    equality: 'shallow',
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    skipCache (params) {
        return !EmptyObject_1.isEmptyObject(params.at(3));
    },
});
/**
...
function translate(desiredLanguage, path) {
    ...
    const language = desiredLanguage === CONST_1['default'].LOCALES.ES_ES_ONFIDO ? CONST_1['default'].LOCALES.ES_ES : desiredLanguage;
    // Phrase is not found in full locale, search it in fallback language e.g. es
    const languageAbbreviation = desiredLanguage.substring(0, 2);
    const translatedPhrase = memoizedGetTranslatedPhrase.apply(void 0, __spreadArrays([language, path, languageAbbreviation], parameters));
...
function formatMessageElementList(elements) {
    const listFormat = getPreferredListFormat();
    const parts = listFormat.formatToParts(
...
function getDevicePreferredLocale() {
    let _a; let _b;
    return (_b = (_a = RNLocalize.findBestAvailableLanguage([CONST_1['default'].LOCALES.EN, CONST_1['default'].LOCALES.ES])) === null || _a === void 0 ? void 0 : _a.languageTag) !== null &&
        _b !== void 0
        ? _b
