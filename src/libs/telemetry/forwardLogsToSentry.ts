 ...
 */
const FORWARDED_LOG_PREFIXES = ['[MFA]', '[OnyxUpdateManagerError]', '[Receipt]', '[PDFStall]', '[OpenReportStall]', '[createDynamicRoute]'] as const;
...
const PREFIX_SCOPED_PARAMETERS_WHITELIST = new Map<ForwardedLogPrefix, ReadonlyArray<string | RegExp>>([
    ...
    ['[createDynamicRoute]', ['key', 'baseValue', 'suffixValue', 'stack']],
]);
