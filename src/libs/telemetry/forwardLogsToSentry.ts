 ...
 * There is no redaction / filtering of sensitive data implemented yet. When you'll implement any log forwarding logic, make sure that you do not leak any sensitive data.
 */
