...
exports.getReportFieldInitialValue =
    exports.generateFieldID =
    exports.validateReportFieldListValueName =
...
function validateReportFieldListValueName(valueName, priorValueName, listValues, inputID) {
    ...
    if (!ValidationUtils.isRequiredFulfilled(valueName)) {
        ...
        priorValueName !== valueName &&
        listValues.some(function (currentValueName) {
            return currentValueName === valueName;
        })
    ) {
        ...
        ErrorUtils.addErrorMessage(
            errors,
            inputID,
            Localize.translateLocal('common.error.characterLimitExceedCounter', {
                length: __spreadArrays(valueName).length,
