...
const ROUTE_NAME_MAPPING = {
    ...
    [CONST.POLICY.CONNECTIONS.ROUTE.BUSINESS_CENTRAL]: CONST.POLICY.CONNECTIONS.NAME.BUSINESS_CENTRAL,
};
...
const NAME_ROUTE_MAPPING = {
    ...
    [CONST.POLICY.CONNECTIONS.NAME.BUSINESS_CENTRAL]: CONST.POLICY.CONNECTIONS.ROUTE.BUSINESS_CENTRAL,
};
...
const STANDARD_EXPORT_TEMPLATE_NAME_MAPPING = {
    ...
    [CONST.REPORT.EXPORT_OPTIONS.RECONCILIATION_ALL_EXPENSES]: CONST.REPORT.EXPORT_OPTION_LABELS.RECONCILIATION_ALL_EXPENSES,
};
