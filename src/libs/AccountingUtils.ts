...
const ROUTE_NAME_MAPPING = {
    ...
    [CONST.POLICY.CONNECTIONS.ROUTE.MERGE_HR_WORKDAY]: CONST.POLICY.CONNECTIONS.NAME.MERGE_HR_WORKDAY,
    [CONST.POLICY.CONNECTIONS.ROUTE.MERGE_HR_BAMBOOHR]: CONST.POLICY.CONNECTIONS.NAME.MERGE_HR_BAMBOOHR,
    [CONST.POLICY.CONNECTIONS.ROUTE.MERGE_HR_HIBOB]: CONST.POLICY.CONNECTIONS.NAME.MERGE_HR_HIBOB,
};
...
const NAME_ROUTE_MAPPING = {
    ...
    [CONST.POLICY.CONNECTIONS.NAME.MERGE_HR_WORKDAY]: CONST.POLICY.CONNECTIONS.ROUTE.MERGE_HR_WORKDAY,
    [CONST.POLICY.CONNECTIONS.NAME.MERGE_HR_BAMBOOHR]: CONST.POLICY.CONNECTIONS.ROUTE.MERGE_HR_BAMBOOHR,
    [CONST.POLICY.CONNECTIONS.NAME.MERGE_HR_HIBOB]: CONST.POLICY.CONNECTIONS.ROUTE.MERGE_HR_HIBOB,
};
