...
function changeTransactionsReport(transactionIDs: string[], reportID: string, currentUserEmail: string, policy?: OnyxEntry<Policy>, reportNextStep?: OnyxEntry<ReportNextStep>) {
