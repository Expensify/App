...
function getDraftTransactionByID(transactionID: string): OnyxEntry<Transaction> {
    return allTransactionDrafts?.[`${ONYXKEYS.COLLECTION.TRANSACTION_DRAFT}${transactionID}`];
}
