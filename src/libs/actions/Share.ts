 ...
 */
function addValidatedShareFile(file: FileObject | FileObject[]) {
    const fileItems = Array.isArray(file) ? file : [file];
    Onyx.set(ONYXKEYS.VALIDATED_FILE_OBJECT, fileItems.at(0));
}
