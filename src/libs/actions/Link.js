...
exports.openExternalLinkWithToken = exports.buildTravelDotURL = exports.openTravelDotLink = exports.getInternalExpensifyPath = exports.getInternalNewExpensifyPath = exports.openLink = exports.openExternalLink = exports.openOldDotLink = exports.buildOldDotURL = void 0;
...
function openOldDotLink(url, shouldOpenInSameTab) {
    ...
    API.makeRequestWithSideEffects(types_1.SIDE_EFFECT_REQUEST_COMMANDS.OPEN_OLD_DOT_LINK, {}, {})
        .then(function (response) { return (response ? buildOldDotURL(url, response.shortLivedAuthToken) : buildOldDotURL(url)); })["catch"](function () { return buildOldDotURL(url); }), function (oldDotURL) { return oldDotURL; }, undefined, shouldOpenInSameTab);
}
...
function openExternalLinkWithToken(url, shouldSkipCustomSafariLogic) {
    ...
    // eslint-disable-next-line rulesdir/no-api-side-effects-method
    API.makeRequestWithSideEffects(types_1.SIDE_EFFECT_REQUEST_COMMANDS.OPEN_OLD_DOT_LINK, {}, {})
        .then(function (response) { return (response ? buildURLWithAuthToken(url, response.shortLivedAuthToken) : buildURLWithAuthToken(url)); })["catch"](function () { return buildURLWithAuthToken(url); }), function (link) { return link; }, shouldSkipCustomSafariLogic);
}
