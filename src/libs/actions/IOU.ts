...
function reopenReport(expenseReport: OnyxEntry<OnyxTypes.Report>) {
    ...
    const currentNextStep = allNextSteps[`${ONYXKEYS.COLLECTION.NEXT_STEP}${expenseReport.reportID}`] ?? null;
    const optimisticReopenReportAction = buildOptimisticReopenedReportAction();
    ...
    const optimisticReportActionsData: OnyxUpdate = {
        ...
        key: `${ONYXKEYS.COLLECTION.REPORT_ACTIONS}${expenseReport.reportID}`,
        value: {
            [optimisticReopenReportAction.reportActionID]: {
                ...(optimisticReopenReportAction as OnyxTypes.ReportAction),
                pendingAction: CONST.RED_BRICK_ROAD_PENDING_ACTION.ADD,
            },
        },
    };
    ...
    const optimisticIOUReportData: OnyxUpdate = {
        ...
        value: {
            ...expenseReport,
            lastMessageText: getReportActionText(optimisticReopenReportAction),
            lastMessageHtml: getReportActionHtml(optimisticReopenReportAction),
            stateNum: predictedNextState,
            statusNum: predictedNextStatus,
            pendingFields: {
