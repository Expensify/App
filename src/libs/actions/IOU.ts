...
function deleteMoneyRequest(transactionID: string, reportAction: OnyxTypes.ReportAction, isSingleTransactionView = false) {
    ...
    let secondToLastAction = null;
    if (iouReport) {
        secondToLastAction = ReportActionsUtils.getLastVisibleAction(iouReport.reportID, {}, 1);
    }
    ...
    if (updatedReportPreviewAction?.message?.[0]) {
        ...
        if (secondToLastAction) {
            updatedReportPreviewAction.created = secondToLastAction.created;
        }
    }
