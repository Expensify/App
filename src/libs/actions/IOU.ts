...
function saveSplitTransactions(draftTransaction: OnyxEntry<OnyxTypes.Transaction>, hash: number, policyCategories: PolicyCategories | undefined, policy: OnyxTypes.Policy | undefined) {
