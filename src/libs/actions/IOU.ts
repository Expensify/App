...
function cancelPayment(
    ...
    const stateNum: ValueOf<typeof CONST.REPORT.STATE_NUM> = approvalMode === CONST.POLICY.APPROVAL_MODE.OPTIONAL ? CONST.REPORT.STATE_NUM.APPROVED : CONST.REPORT.STATE_NUM.APPROVED;
