...
function getMoneyRequestInformation(
    ...
    const optimisticNextStep = NextStepUtils.buildNextStep(iouReport, needsToBeManuallySubmitted(iouReport) ? CONST.REPORT.STATUS_NUM.OPEN : CONST.REPORT.STATUS_NUM.SUBMITTED);
