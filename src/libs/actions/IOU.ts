...
function deleteTrackExpense(
    ...
    const urlToNavigateBack = getNavigationUrlAfterTrackExpenseDelete(chatReport, transactionID, reportAction, iouReport, chatIOUReport, isChatIOUReportArchived, isSingleTransactionView);
