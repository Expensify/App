 ...
 * Put expense on HOLD
 */
function putOnHold(transactionID: string, comment: string, reportID: string, hash?: number) {
    const currentTime = DateUtils.getDBTime();
 ...
 */
function unholdRequest(transactionID: string, reportID: string, hash?: number) {
