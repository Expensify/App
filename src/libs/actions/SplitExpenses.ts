...
function initSplitExpense(
    ...
    const splitAmounts = [
        calculateAmount(1, transactionDetailsAmount, transactionDetails?.currency ?? '', getCurrencyDecimals, false),
        calculateAmount(1, transactionDetailsAmount, transactionDetails?.currency ?? '', getCurrencyDecimals, true),
    ];
