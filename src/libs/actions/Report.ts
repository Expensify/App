...
function deleteReportComment(reportID: string | undefined, reportAction: ReportAction, ancestors: Ancestor[], isReportArchived = false, isOriginalReportArchived = false) {
