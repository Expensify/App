...
import {getDefaultApprover, getMemberAccountIDsForWorkspace, isPaidGroupPolicy, isPolicyAdmin as isPolicyAdminPolicyUtils, isPolicyMember, isSubmitAndClose} from '@libs/PolicyUtils';
...
function buildOptimisticChangePolicyData(
    ...
    if ((isProcessingReport(report) || isOpenExpenseReport(report)) && isSubmitAndCloseLocal) {
