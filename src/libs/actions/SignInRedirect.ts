...
function clearStorageAndRedirect(errorMessage?: string, isSAMLReauthentication?: boolean): Promise<void> {
    ...
    if (isSAMLReauthentication) {
        ...
        // A forced re-auth is involuntary, so an in-progress GPS trip is kept and offered back on return.
        // Voluntary sign-out still discards it, and the draft's accountID gates who can resume it.
