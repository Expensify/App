...
type TrackedExpenseParams = {
    onyxData?: OnyxData<
        BuildOnyxDataForTrackExpenseKeys | BuildPolicyDataKeys | typeof ONYXKEYS.NVP_RECENT_WAYPOINTS | typeof ONYXKEYS.NVP_LAST_DISTANCE_EXPENSE_TYPE | typeof ONYXKEYS.GPS_DRAFT_DETAILS
    >;
