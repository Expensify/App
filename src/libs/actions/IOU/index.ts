...
import {completeOnboarding, createTransactionThreadReport, notifyNewAction} from '@userActions/Report';
...
function approveMoneyRequest(params: ApproveMoneyRequestFunctionParams) {
    ...
    if (expenseReport.policyID && shouldRestrictUserBillableActions(currentUserAccountIDParam, expenseReport.policyID, ownerBillingGracePeriodEnd, userBillingGracePeriodEnds, amountOwed)) {
...
function payMoneyRequest(params: PayMoneyRequestFunctionParams) {
    ...
    if (chatReport.policyID && shouldRestrictUserBillableActions(currentUserAccountID, chatReport.policyID, ownerBillingGracePeriodEnd, userBillingGracePeriodEnds, amountOwed)) {
