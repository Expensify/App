...
import type {AddReportApproverParams, AssignReportToMeParams, CreateDistanceRequestParams, PayInvoiceParams, PayMoneyRequestParams, UpdateMoneyRequestParams} from '@libs/API/parameters';
