...
function getPerDiemExpenseInformation(perDiemExpenseInformation: PerDiemExpenseInformationParams): MoneyRequestInformation {
    ...
    if (reportPreviewAction) {
        ...
        reportPreviewAction = buildOptimisticReportPreview(chatReport, iouReport, undefined, comment, optimisticTransaction, undefined, optimisticReportPreviewActionID, conciergeReportID);
