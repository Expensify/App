...
function updateMoneyRequestDate({
    ...
    if (shouldRecalculateRate) {
        const distanceRateTaxUpdates =
            !isTrackExpense && isTaxTrackingEnabled(true, effectivePolicy, true) && transaction
                ? getDistanceRateTaxUpdates(effectivePolicy, transaction, newRateID, getCurrencyDecimals)
                : undefined;
...
function updateMoneyRequestBillable({
    ...
    trackMerchantRuleSuggestion(transactionID, CONST.MERCHANT_RULE_SUGGESTION_FIELDS.BILLABLE, [transactionThreadReport.reportID, parentReport?.reportID], policy, policyCategories);
}
...
function updateMoneyRequestReimbursable({
    ...
    trackMerchantRuleSuggestion(transactionID, CONST.MERCHANT_RULE_SUGGESTION_FIELDS.REIMBURSABLE, [transactionThreadReport.reportID, parentReport?.reportID], policy, policyCategories);
}
...
function updateMoneyRequestTag({
    ...
    trackMerchantRuleSuggestion(transactionID, CONST.MERCHANT_RULE_SUGGESTION_FIELDS.TAG, [transactionThreadReport?.reportID, parentReport?.reportID], policy, policyCategories);
}
...
function updateMoneyRequestTaxRate({
    ...
    trackMerchantRuleSuggestion(transactionID, CONST.MERCHANT_RULE_SUGGESTION_FIELDS.TAX, [transactionThreadReport?.reportID, parentReport?.reportID], policy, policyCategories);
}
...
function updateMoneyRequestCategory({
    ...
    trackMerchantRuleSuggestion(transactionID, CONST.MERCHANT_RULE_SUGGESTION_FIELDS.CATEGORY, [transactionThreadReport?.reportID, parentReport?.reportID], policy, policyCategories);
}
...
function updateMoneyRequestDescription({
    ...
    trackMerchantRuleSuggestion(transactionID, CONST.MERCHANT_RULE_SUGGESTION_FIELDS.DESCRIPTION, [transactionThreadReport?.reportID, parentReport?.reportID], policy, policyCategories);
}
