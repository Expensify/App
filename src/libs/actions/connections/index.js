...
exports.setConnectionError = exports.hasSynchronizationErrorMessage = exports.isConnectionInProgress = exports.isConnectionUnverified = exports.copyExistingPolicyConnection = exports.syncConnection = exports.isAuthenticationError = exports.updateManyPolicyConnectionConfigs = exports.updatePolicyConnectionConfig = exports.removePolicyConnection = void 0;
...
function isConnectionUnverified(policy, connectionName) {
    ...
    if (EmptyObject_1.isEmptyObject((_e = (_d = policy === null || policy === void 0 ? void 0 : policy.connections) === null || _d === void 0 ? void 0 : _d[connectionName]) === null || _e === void 0 ? void 0 : _e.lastSync)) {
        return true;
    }
...
function isConnectionInProgress(connectionSyncProgress, policy) {
    ...
    var lastSyncProgressDate = date_fns_1.parseISO((_b = connectionSyncProgress === null || connectionSyncProgress === void 0 ? void 0 : connectionSyncProgress.timestamp) !== null && _b !== void 0 ? _b : '');
