...
function openReportFromDeepLink(
    ...
    if (reportID && !isAuthenticated) {
        // Remember the public-room deeplink reportID so the ReportsSplitNavigator keeps this
        ...
        // Not a signed-out public-room deeplink — make sure no stale pending reportID lingers.
...
/**
 * Clear the pending signed-out public-room deeplink reportID.
 */
