...
function navigateToQuickAction(params: NavigateToQuickActionParams) {
    ...
    switch (quickAction?.action) {
        ...
        case CONST.QUICK_ACTIONS.PER_DIEM:
            selectOption(() => startMoneyRequest(CONST.IOU.TYPE.SUBMIT, reportID, requestType, true, undefined, draftTransactions), true);
            break;
        case CONST.QUICK_ACTIONS.SPLIT_MANUAL:
        case CONST.QUICK_ACTIONS.SPLIT_SCAN:
        case CONST.QUICK_ACTIONS.SPLIT_DISTANCE:
            selectOption(() => startMoneyRequest(CONST.IOU.TYPE.SPLIT, reportID, requestType, true, undefined, draftTransactions), true);
            break;
        case CONST.QUICK_ACTIONS.SEND_MONEY:
            selectOption(() => startMoneyRequest(CONST.IOU.TYPE.PAY, reportID, undefined, true, undefined, draftTransactions), false);
            break;
        ...
        case CONST.QUICK_ACTIONS.TRACK_SCAN:
            selectOption(() => startMoneyRequest(CONST.IOU.TYPE.TRACK, reportID, requestType, true, undefined, draftTransactions), false);
            break;
