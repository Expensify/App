            ...
            .then(() => {
                ...
                return Onyx.multiSet({
                    [ONYXKEYS.STASHED_SESSION]: {
                        email: oldDotOriginalAccountEmail,
                        accountID: Number(oldDotOriginalAccountID),
                    },
                    [ONYXKEYS.STASHED_CREDENTIALS]: {autoGeneratedLogin, autoGeneratedPassword, accountID: Number(oldDotOriginalAccountID)},
                });
            })
            .then(() =>
                Onyx.multiSet({
