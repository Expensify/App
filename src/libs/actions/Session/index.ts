 ...
 */
function signOut(): Promise<void | Response<never>> {
...
function signOutAndRedirectToSignIn(shouldResetToHome?: boolean, shouldStashSession?: boolean, shouldSignOutFromOldDot = true, shouldForceUseStashedSession?: boolean) {
    ...
    // session.
    const signOutPromise: Promise<void | Response<never>> = !shouldRestoreStashedSession && !shouldStashSession ? signOut() : Promise.resolve();
