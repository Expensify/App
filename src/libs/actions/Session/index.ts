...
function signInAfterTransitionFromOldDot(transitionURL: string) {
    ...
    const {email, authToken, encryptedAuthToken, accountID, autoGeneratedLogin, autoGeneratedPassword, clearOnyxOnStart, completedHybridAppOnboarding, isSingleNewDotEntry} =
        Object.fromEntries(
