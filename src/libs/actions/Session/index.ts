...
function signInWithOldDotData(email: string, authToken: string, encryptedAuthToken: string, accountID: number, autoGeneratedLogin: string, autoGeneratedPassword: string) {
    Onyx.set(ONYXKEYS.SESSION, {email, authToken, encryptedAuthToken, accountID});
