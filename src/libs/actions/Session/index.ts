...
function signOutAndRedirectToSignIn(
    ...
    // session.
    // Without an auth token there is nothing to invalidate, yet the LogOut is still routed and sent —
    // and on a QA build a QA-pinned request waits on the Cloudflare gate before it can fail, which
    // stalls the storage clear and the redirect behind it.
