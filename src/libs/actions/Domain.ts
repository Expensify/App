...
import type {AddAdminToDomainParams, RemoveDomainAdminParams, AddMemberToDomainParams, SetTechnicalContactEmailParams, ToggleConsolidatedDomainBillingParams} from '@libs/API/parameters';
