import {mediaDevices, MediaStream, MediaStreamTrack, RTCDataChannel, RTCPeerConnection, RTCSessionDescription} from 'react-native-webrtc-web-shim';
import * as API from '@libs/API';
import {SIDE_EFFECT_REQUEST_COMMANDS} from '@libs/API/types';
import {playStreamSound} from '@libs/Sound';
import type {ConnectionResult, OpenAIRealtimeMessage, WebRTCConnections} from './types';
...
export {initializeConnection, getConnection, handleOpenAIMessage, stopConnection};
