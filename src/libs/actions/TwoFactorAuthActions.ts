...
function clearTwoFactorAuthData() {
    Onyx.merge(ONYXKEYS.ACCOUNT, {recoveryCodes: '', twoFactorAuthSecretKey: '', codesAreCopied: false});
}
...
export {clearTwoFactorAuthData, quitAndNavigateBackToSettings, setCodesAreCopied};
