 ...
 *
 * @param {Object} authenticateResponse
 */
function createTemporaryLogin(authenticateResponse) {
...
function signIn(password, twoFactorAuthCode) {
    ...
    API.Authenticate({
        ...
        .then((authenticateResponse) => {
            createTemporaryLogin(authenticateResponse);
        })
        .catch((error) => {
