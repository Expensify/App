    ...
    API.Authenticate({
        ...
        .then((authenticateResponse) => {
            ...
            API.CreateLogin({
                ...
                .catch((error) => {
                    Onyx.merge(ONYXKEYS.ACCOUNT, {error: getSignInErrorMessage(error.message)});
                })
                .finally(() => {
                    Onyx.merge(ONYXKEYS.ACCOUNT, {loading: false});
                });
        ...
        .catch((error) => {
            Onyx.merge(ONYXKEYS.ACCOUNT, {error: getSignInErrorMessage(error.message), loading: false});
        });
}
