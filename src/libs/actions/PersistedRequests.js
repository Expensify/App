...
exports.deleteRequestsByIndices = exports.rollbackOngoingRequest = exports.updateOngoingRequest = exports.processNextRequest = exports.getOngoingRequest = exports.getLength = exports.update = exports.endRequestAndRemoveFromQueue = exports.getAll = exports.save = exports.clear = void 0;
...
function endRequestAndRemoveFromQueue(requestToRemove) {
    ...
    var index = requests.findIndex(function (persistedRequest) { return isEqual_1["default"](persistedRequest, requestToRemove); });
    if (index !== -1) {
