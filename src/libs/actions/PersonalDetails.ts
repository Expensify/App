...
function setDisplayName(firstName: string, lastName: string, formatPhoneNumber: LocaleActionsContextValue['formatPhoneNumber'], currentUserAccountID: number, currentUserEmail: string) {
    if (!currentUserAccountID) {
        return;
    }
...
function updateDisplayName(firstName: string, lastName: string, formatPhoneNumber: LocaleActionsContextValue['formatPhoneNumber'], currentUserAccountID: number, currentUserEmail: string) {
    if (!currentUserAccountID) {
        return;
    }
