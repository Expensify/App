...
function handleActionButtonPress({
    ...
    switch (item.action) {
        case CONST.SEARCH.ACTION_TYPES.PAY:
            ...
            if (snapshotReport.policyID && shouldRestrictUserBillableActions(snapshotReport.policyID, ownerBillingGracePeriodEnd, userBillingGracePeriodEnds, amountOwed, currentUserAccountID)) {
