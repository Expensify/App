...
function handleActionButtonPress({
    ...
    // Approve is excluded because ApproveActionCell renders its own dropdown for held expenses and never routes here.
    if (hasHeldExpense && item.action !== CONST.SEARCH.ACTION_TYPES.SUBMIT && item.action !== CONST.SEARCH.ACTION_TYPES.UNDELETE && item.action !== CONST.SEARCH.ACTION_TYPES.APPROVE) {
        goToItem();
        return;
    }
