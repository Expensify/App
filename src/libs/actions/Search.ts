...
import type {LastPaymentMethod, LastPaymentMethodType, Policy, ReportAction, ReportActions, Transaction} from '@src/types/onyx';
...
function holdMoneyRequestOnSearch(
    hash: number,
