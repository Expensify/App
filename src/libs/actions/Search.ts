...
function handleActionButtonPress({
    ...
    switch (item.action) {
        case CONST.SEARCH.ACTION_TYPES.PAY:
            ...
            if (snapshotReport.policyID && shouldRestrictUserBillableActions(snapshotReport.policyID, ownerBillingGracePeriodEnd, userBillingGracePeriodEnds, undefined, undefined, currentUserAccountID)) {
...
function handleBulkPayItemSelected(params: {
    ...
    if (policy && shouldRestrictUserBillableActions(policy?.id, ownerBillingGracePeriodEnd, userBillingGracePeriodEnds, amountOwed, undefined, currentUserAccountID)) {
