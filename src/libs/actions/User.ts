...
function revokeDevice(login: NewLogin, autoGeneratedLogin: string | undefined) {
    ...
    const parameters: RevokeDeviceParams = {
...
function requestContactMethodValidateCode(contactMethod: string) {
    ...
    getDeviceInfoWithID().then((deviceInfo) => {
        const parameters: RequestContactMethodValidateCodeParams = {
            email: contactMethod,
            deviceInfo,
        };
        API.write(WRITE_COMMANDS.REQUEST_CONTACT_METHOD_VALIDATE_CODE, parameters, {
            optimisticData,
            successData,
            failureData,
        });
...
function deleteContactMethod(contactMethod: string, loginList: Record<string, Login>, backTo?: string) {
    ...
    const parameters: DeleteContactMethodParams = {
        partnerUserID: contactMethod,
    };

    API.write(WRITE_COMMANDS.DELETE_CONTACT_METHOD, parameters, {
        optimisticData,
        successData,
        failureData,
    });
...
function addNewContactMethod(contactMethod: string, validateCode = '') {
    ...
    const parameters: AddNewContactMethodParams = {
        partnerUserID: contactMethod,
        validateCode,
    };

    API.write(WRITE_COMMANDS.ADD_NEW_CONTACT_METHOD, parameters, {
        optimisticData,
        successData,
        failureData,
    });
...
function requestValidateCodeAction(params?: ResendValidateCodeParams) {
    ...
    API.write(WRITE_COMMANDS.RESEND_VALIDATE_CODE, params ?? null, {
        optimisticData,
        successData,
        failureData,
    });
...
function validateSecondaryLogin(contactMethod: string, validateCode: string) {
    ...
    getDeviceInfoWithID().then((deviceInfo) => {
        const parameters: ValidateSecondaryLoginParams = {
            partnerUserID: contactMethod,
            validateCode,
            deviceInfo,
        };
        API.write(WRITE_COMMANDS.VALIDATE_SECONDARY_LOGIN, parameters, {
            optimisticData,
            successData,
            failureData,
        });
...
function updatePreferredSkinTone(skinTone: number) {
    ...
    API.write(WRITE_COMMANDS.UPDATE_PREFERRED_EMOJI_SKIN_TONE, parameters, {
        optimisticData,
    });
}
...
function updateChatPriorityMode(mode: ValueOf<typeof CONST.PRIORITY_MODE>, automatic = false) {
    ...
    API.write(WRITE_COMMANDS.UPDATE_CHAT_PRIORITY_MODE, parameters, {
        optimisticData,
    });
...
function updateCustomStatus(currentUserAccountID: number, status: Status) {
    ...
    const parameters: UpdateStatusParams = {
        text: status.text,
...
function clearDraftCustomStatus() {
    Onyx.merge(ONYXKEYS.CUSTOM_STATUS_DRAFT, {
        text: '',
        emojiCode: '',
        clearAfter: '',
    });
...
function verifyAddSecondaryLoginCode(validateCode: string) {
    ...
    API.write(WRITE_COMMANDS.VERIFY_ADD_SECONDARY_LOGIN_CODE, parameters, {
        optimisticData,
        successData,
        failureData,
    });
