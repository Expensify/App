 ...
 * @param loginList
 */
function deleteContactMethod(contactMethod: string, loginList: Record<string, Login>, navigateBackTo?: Route) {
    ...
    Navigation.goBack(navigateBackTo ?? ROUTES.SETTINGS_CONTACT_METHODS.route);
}
