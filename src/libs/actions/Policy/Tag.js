...
exports.getPolicyTagsData = exports.downloadTagsCSV = exports.importPolicyTags = exports.setPolicyTagApprover = exports.setPolicyTagGLCode = exports.setWorkspaceTagEnabled = exports.renamePolicyTaglist = exports.renamePolicyTag = exports.openPolicyTagsPage = exports.enablePolicyTags = exports.deletePolicyTags = exports.clearPolicyTagListErrorField = exports.clearPolicyTagListErrors = exports.clearPolicyTagErrors = exports.createPolicyTag = exports.setPolicyTagsRequired = exports.setPolicyRequiresTag = exports.buildOptimisticPolicyRecentlyUsedTags = void 0;
...
function buildOptimisticPolicyRecentlyUsedTags(policyID, transactionTags) {
    ...
    var policyTags = (_a = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) !== null && _a !== void 0 ? _a : {};
    var policyTagKeys = PolicyUtils.getSortedTagKeys(policyTags);
    var policyRecentlyUsedTags = (_b = allRecentlyUsedTags === null || allRecentlyUsedTags === void 0 ? void 0 : allRecentlyUsedTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_RECENTLY_USED_TAGS + policyID]) !== null && _b !== void 0 ? _b : {};
...
function createPolicyTag(policyID, tagName) {
    ...
    var _g, _h, _j;
    var policyTag = (_j = (_h = PolicyUtils.getTagLists((_g = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) !== null && _g !== void 0 ? _g : {})) === null || _h === void 0 ? void 0 : _h.at(0)) !== null && _j !== void 0 ? _j : {};
...
function setWorkspaceTagEnabled(policyID, tagsToUpdate, tagListIndex) {
    var _a, _b, _c;
    var _d, _e;
    var policyTag = (_e = PolicyUtils.getTagLists((_d = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) !== null && _d !== void 0 ? _d : {})) === null || _e === void 0 ? void 0 : _e.at(tagListIndex);
        ...
        optimisticData: [
            {
                ...
                key: "" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID,
                value: (_a = {},
                    _a[policyTag.name] = __assign(__assign({}, (shouldDisableRequiredTag ? { required: false, pendingFields: { required: CONST_1["default"].RED_BRICK_ROAD_PENDING_ACTION.UPDATE } } : {})), { tags: optimisticPolicyTagsData }),
                    _a)
            },
        ],
        successData: [
            {
                ...
                key: "" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID,
                value: (_b = {},
                    _b[policyTag.name] = __assign(__assign({}, (shouldDisableRequiredTag ? { pendingFields: { required: null } } : {})), { tags: __assign({}, Object.keys(tagsToUpdate).reduce(function (acc, key) {
        ...
        failureData: [
            {
                ...
                key: "" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID,
                value: (_c = {},
                    _c[policyTag.name] = __assign(__assign({}, (shouldDisableRequiredTag ? { pendingFields: { required: null }, required: policyTag.required } : {})), { tags: __assign({}, Object.keys(tagsToUpdate).reduce(function (acc, key) {
...
function deletePolicyTags(policyID, tagsToDelete) {
    var _a, _b, _c;
    var _d, _e;
    var policyTag = (_e = PolicyUtils.getTagLists((_d = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) !== null && _d !== void 0 ? _d : {})) === null || _e === void 0 ? void 0 : _e.at(0);
    if (!policyTag) {
        return;
    }
    var onyxData = {
...
function clearPolicyTagErrors(policyID, tagName, tagListIndex) {
    var _a, _b, _c, _d;
    var _e, _f;
    var tagListName = PolicyUtils.getTagListName(allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID], tagListIndex);
    var tag = (_f = (_e = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) === null || _e === void 0 ? void 0 : _e[tagListName].tags) === null || _f === void 0 ? void 0 : _f[tagName];
    if (!tag) {
        return;
    }
    if (tag.pendingAction === CONST_1["default"].RED_BRICK_ROAD_PENDING_ACTION.ADD) {
        react_native_onyx_1["default"].merge("" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID, (_a = {},
            _a[tagListName] = {
                tags: (_b = {},
                    _b[tagName] = null,
                    _b)
    ...
    react_native_onyx_1["default"].merge("" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID, (_c = {},
        _c[tagListName] = {
            tags: (_d = {},
                _d[tagName] = {
                    errors: null,
...
function clearPolicyTagListErrorField(policyID, tagListIndex, errorField) {
    var _a, _b;
    var _c, _d;
    var policyTag = (_d = PolicyUtils.getTagLists((_c = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) !== null && _c !== void 0 ? _c : {})) === null || _d === void 0 ? void 0 : _d.at(tagListIndex);
    if (!policyTag) {
        return;
    }
    if (!policyTag.name) {
...
function clearPolicyTagListErrors(policyID, tagListIndex) {
    var _a;
    var _b, _c;
    var policyTag = (_c = PolicyUtils.getTagLists((_b = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) !== null && _b !== void 0 ? _b : {})) === null || _c === void 0 ? void 0 : _c.at(tagListIndex);
    if (!policyTag) {
        return;
    }
    if (!policyTag.name) {
...
function renamePolicyTag(policyID, policyTag, tagListIndex) {
    ...
    var tagList = (_h = PolicyUtils.getTagLists((_g = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) !== null && _g !== void 0 ? _g : {})) === null || _h === void 0 ? void 0 : _h.at(tagListIndex);
    if (!tagList) {
        return;
    }
...
function enablePolicyTags(policyID, enabled) {
    ...
    API.write(types_1.WRITE_COMMANDS.ENABLE_POLICY_TAGS, parameters, onyxData, {
        checkAndFixConflictingRequest: function (persistedRequests) { return RequestConflictUtils_1.resolveEnableFeatureConflicts(types_1.WRITE_COMMANDS.ENABLE_POLICY_TAGS, persistedRequests, parameters); }
    });
...
function setPolicyTagGLCode(policyID, tagName, tagListIndex, glCode) {
    ...
    var _g, _h, _j, _k;
    var tagListName = PolicyUtils.getTagListName(allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID], tagListIndex);
    var policyTagToUpdate = (_k = (_j = (_h = (_g = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) === null || _g === void 0 ? void 0 : _g[tagListName]) === null || _h === void 0 ? void 0 : _h.tags) === null || _j === void 0 ? void 0 : _j[tagName]) !== null && _k !== void 0 ? _k : {};
    var onyxData = {
        optimisticData: [
            {
                onyxMethod: react_native_onyx_1["default"].METHOD.MERGE,
...
function downloadTagsCSV(policyID, onDownloadFailed) {
    ...
    fileDownload_1["default"](ApiUtils.getCommandURL({ command: types_1.WRITE_COMMANDS.EXPORT_TAGS_CSV }), fileName, '', false, formData, CONST_1["default"].NETWORK.METHOD.POST, onDownloadFailed);
}
exports.downloadTagsCSV = downloadTagsCSV;
function getPolicyTagsData(policyID) {
    var _a;
    return (_a = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["" + ONYXKEYS_1["default"].COLLECTION.POLICY_TAGS + policyID]) !== null && _a !== void 0 ? _a : {};
}
