        ...
        failureData: [
            {
                ...
                value: {
                    pendingAction: null,
                    errors: ErrorUtils.getMicroSecondOnyxErrorWithTranslationKey('workspace.receiptPartners.invitationFailure'),
                },
            },
        ],
    };

    API.write(WRITE_COMMANDS.INVITE_WORKSPACE_EMPLOYEES_TO_UBER, params, onyxData);
}
