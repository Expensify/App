    ...
    > = [
        {
            ...
            value: {
                ...
                reimbursementChoice:
                    engagementChoice === CONST.ONBOARDING_CHOICES.PERSONAL_SPEND ? CONST.POLICY.REIMBURSEMENT_CHOICES.REIMBURSEMENT_NO : CONST.POLICY.REIMBURSEMENT_CHOICES.REIMBURSEMENT_YES,
