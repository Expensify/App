...
function navigateToConciergeChat(
    ...
    if (!conciergeReportID) {
        ...
        onServerDataReady().then(() => {
            ...
            navigateToAndOpenReport([CONST.EMAIL.CONCIERGE], allPersonalDetails, currentUserAccountID, introSelected, undefined, betas, shouldDismissModal);
        });
...
function navigateToMostRecentReport(
    ...
    if (lastAccessedReportID) {
        ...
        navigateToConciergeChat(conciergeReportID, introSelected, currentUserAccountID, betas, false, () => true, {forceReplace: true});
    }
}
