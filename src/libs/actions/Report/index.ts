...
function navigateToMostRecentReport(currentReport: OnyxEntry<Report>, conciergeReportID: string | undefined, currentUserAccountID: number, archivedReportsIDSet: ArchivedReportsIDSet) {
...
function leaveGroupChat(report: Report, shouldClearQuickAction: boolean, currentUserAccountID: number, conciergeReportID: string | undefined, archivedReportsIDSet: ArchivedReportsIDSet) {
    const reportID = report.reportID;
    ...
    navigateToMostRecentReport(report, conciergeReportID, currentUserAccountID, archivedReportsIDSet);
