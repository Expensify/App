...
function navigateToAndOpenReport(
    ...
    if (isEmptyObject(chat)) {
        ...
        openReport({reportID: newChat?.reportID, introSelected, reportActionID: '', participants, personalDetails, newReportObject: newChat, isSelfTourViewed});
    }
...
function navigateToAndOpenChildReport(
    ...
    const report = childReport ?? createChildReport(childReport, parentReportAction, parentReport, currentUserAccountID, introSelected, personalDetails);
...
function navigateToConciergeChat(
    ...
    if (!conciergeReportID) {
        ...
        onServerDataReady().then(() => {
            ...
            navigateToAndOpenReport([CONST.EMAIL.CONCIERGE], allPersonalDetails, currentUserAccountID, introSelected, undefined, shouldDismissModal);
        });
