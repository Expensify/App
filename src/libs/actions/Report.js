...
function markCommentAsUnread(reportID, created) {
    ...
    const lastReadTimestamp = moment(created).utc().valueOf();
...
function deleteReportComment(reportID, reportAction) {
    ...
    const lastMessageTimestamp = ReportActionsUtils.getLastVisibleMessageTimestamp(reportID, optimisticReportActions);
    const optimisticReport = {
        lastMessageText,
