...
const test = () => {
    ...
    console.log('[E2E] App is ready, logging in…');
    ...
    E2ELogin(email, password).then((neededLogin) => {
        ...
        console.log('[E2E] Logged in, getting metrics and submitting them…');
        ...
        Promise.all(
            ...
            console.log('[E2E] Done, exiting…');
            E2EClient.submitTestDone();
        }).catch((err) => {
            console.log('[E2E] Error while submitting test results:', err);
        });
    });
};
