...
function sortCardsByCardholderName(cards: Card[], personalDetails: OnyxEntry<PersonalDetailsList>, localeCompare: LocaleActionsContextValue['localeCompare']): Card[] {
