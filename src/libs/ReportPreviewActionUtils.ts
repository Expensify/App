...
function canApprove(
    ...
    const hasAnyVisibleViolations = hasMissingSmartscanFields(report.reportID, transactions) || ViolationsUtils.hasVisibleViolationsForUser(report, violations, currentUserEmail, policy);
