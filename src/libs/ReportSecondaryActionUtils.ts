...
function getSecondaryExportReportActions(report: Report, policy?: Policy, reportActions?: ReportAction[]): Array<ValueOf<typeof CONST.REPORT.EXPORT_OPTIONS>> {
    ...
    options.push(CONST.REPORT.EXPORT_OPTIONS.DOWNLOAD_CSV, CONST.REPORT.EXPORT_OPTIONS.REPORT_LEVEL_EXPORT, CONST.REPORT.EXPORT_OPTIONS.EXPENSE_LEVEL_EXPORT);
