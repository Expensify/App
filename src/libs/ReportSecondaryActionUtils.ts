...
function getSecondaryReportActions({
    ...
    if (isPrimaryPayAction(report, policy, reportNameValuePairs, isChatReportArchived, undefined, reportActions) && (hasOnlyHeldExpenses(report?.reportID) || isExportedAndHasExportError)) {
