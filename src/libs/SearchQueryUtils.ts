...
const UserFriendlyKeyMap: Record<SearchFilterKey | typeof CONST.SEARCH.SYNTAX_ROOT_KEYS.SORT_BY | typeof CONST.SEARCH.SYNTAX_ROOT_KEYS.SORT_ORDER, UserFriendlyKey> = {
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.TYPE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.TYPE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.STATUS]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.STATUS,
    [CONST.SEARCH.SYNTAX_ROOT_KEYS.SORT_BY]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.SORT_BY,
    [CONST.SEARCH.SYNTAX_ROOT_KEYS.SORT_ORDER]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.SORT_ORDER,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.POLICY_ID]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.POLICY_ID,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.DATE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.DATE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.AMOUNT]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.AMOUNT,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.EXPENSE_TYPE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.EXPENSE_TYPE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.CURRENCY]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.CURRENCY,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.MERCHANT]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.MERCHANT,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.DESCRIPTION]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.DESCRIPTION,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.FROM]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.FROM,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.TO]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.TO,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.PAYER]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.PAYER,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.EXPORTER]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.EXPORTER,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.CATEGORY]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.CATEGORY,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.TAG]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.TAG,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.TAX_RATE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.TAX_RATE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.CARD_ID]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.CARD_ID,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.FEED]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.FEED,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.REPORT_ID]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.REPORT_ID,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.KEYWORD]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.KEYWORD,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.IN]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.IN,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.SUBMITTED]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.SUBMITTED,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.APPROVED]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.APPROVED,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.PAID]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.PAID,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.EXPORTED]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.EXPORTED,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.POSTED]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.POSTED,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.WITHDRAWAL_TYPE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.WITHDRAWAL_TYPE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.WITHDRAWN]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.WITHDRAWN,
    [CONST.SEARCH.SYNTAX_ROOT_KEYS.GROUP_BY]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.GROUP_BY,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.TITLE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.TITLE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.ASSIGNEE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.ASSIGNEE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.BILLABLE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.BILLABLE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.REIMBURSABLE]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.REIMBURSABLE,
    [CONST.SEARCH.SYNTAX_FILTER_KEYS.ACTION]: CONST.SEARCH.SEARCH_USER_FRIENDLY_KEYS.ACTION,
};
