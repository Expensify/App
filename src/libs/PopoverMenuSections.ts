...
const REPORT_MORE_MENU_SECTIONS = [
    [
        ...
        REPORT_SECONDARY_ACTIONS.RECEIVED_PAYMENT,
    ...
    [REPORT_SECONDARY_ACTIONS.EXPORT, REPORT_SECONDARY_ACTIONS.DOWNLOAD_PDF, REPORT_SECONDARY_ACTIONS.DOWNLOAD_RECEIPTS, REPORT_SECONDARY_ACTIONS.PRINT],
...
const TRANSACTION_MORE_MENU_SECTIONS = [
    ...
    [TRANSACTION_SECONDARY_ACTIONS.DUPLICATE, TRANSACTION_SECONDARY_ACTIONS.MOVE_EXPENSE, TRANSACTION_SECONDARY_ACTIONS.SEND_TO_SOMEONE],
