...
import {isLayoutPendingForReport} from './deferredLayoutWrite';
...
function shouldWaitForTransactions(
    ...
    const hasPendingDismissWrite = isLayoutPendingForReport(CONST.DEFERRED_LAYOUT_WRITE_KEYS.DISMISS_MODAL, report?.reportID);
