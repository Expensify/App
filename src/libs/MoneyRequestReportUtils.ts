 ...
 * at the top
 */
const IOU_ACTIONS_TO_FILTER_OUT: Array<OnyxTypes.OriginalMessageIOU['type']> = [CONST.IOU.REPORT_ACTION_TYPE.CREATE, CONST.IOU.REPORT_ACTION_TYPE.TRACK];
 ...
 */
function isActionVisibleOnMoneyRequestReport(action: OnyxTypes.ReportAction) {
...
export {isActionVisibleOnMoneyRequestReport};
