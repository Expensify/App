...
function processNetworkRequestQueue() {
    ...
    _.each(networkRequestQueue, (queuedRequest) => {
        ...
        HttpUtils.xhr(queuedRequest.command, finalParameters, queuedRequest.type, queuedRequest.useSecureAPI)
 ...
 * @param {*} [data]
 * @param {String} [type]
 * @param {Boolean} [useSecureAPI]
 * @returns {Promise}
 */
function post(command, data = {}, type = 'post', useSecureAPI = false) {
