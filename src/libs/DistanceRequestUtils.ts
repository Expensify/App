 ...
 */
function getRateForP2P(currency: string, transaction: ReadonlyOnyxEntry<Transaction>): MileageRate {
...
function getDistanceUnit(transaction: ReadonlyOnyxEntry<Transaction>, mileageRate: OnyxEntry<MileageRate>): Unit {
 ...
 */
function getUpdatedDistanceUnit({transaction, policy, policyDraft}: {transaction: ReadonlyOnyxEntry<Transaction>; policy: OnyxEntry<Policy>; policyDraft?: OnyxEntry<Policy>}) {
