...
const safeOnyxKeys = new Set<string>([
    ...
    ONYXKEYS.COLLECTION.TRAVEL_BILLING_CONTINUOUS_RECONCILIATION_CONNECTION,
    ONYXKEYS.COLLECTION.TRAVEL_BILLING_RECONCILIATION_BANK_ACCOUNT_ID,
    ONYXKEYS.COLLECTION.TRAVEL_BILLING_USE_CONTINUOUS_RECONCILIATION,
    ONYXKEYS.COLLECTION.TRAVEL_BILLING_USE_CONTINUOUS_RECONCILIATION_PENDING_ACTION,
    ...
    ONYXKEYS.EXPENSIFY_CARD_STATEMENT,
    ...
    ONYXKEYS.IS_LOADING_AGENT_TEMPLATES,
    ...
    ONYXKEYS.IS_SEARCH_FILTERS_CATEGORY_DATA_LOADED,
    ...
    ONYXKEYS.ONBOARDING_ACCOUNTING_ENABLED,
    ...
    ONYXKEYS.ONBOARDING_INTERESTED_FEATURES_MAP,
...
const onyxKeysToMaskFragileData = new Set<string>([
    ...
    ONYXKEYS.REIMBURSEMENT_ACCOUNT_BACKUP,
