...
import {LETTER_AVATAR_COLOR_OPTIONS} from './letterAvatarPalette';
import type {AvatarEntry, BotAvatarIDs, DefaultAvatarIDs, LetterAvatarIDs, PresetAvatarID, SeasonF1AvatarIDs} from './PresetAvatarCatalog.types';
