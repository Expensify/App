...
function getForExpenseMovedFromSelfDM(destinationReportID) {
    var destinationReport = allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(destinationReportID)];
...
function getForReportAction(_a) {
    ...
    if (typeof reportOrID === 'string') {
        report = searchReports ? searchReports.find(function (r) { return r.reportID === reportOrID; }) : allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportOrID)];
    }
    else {
        report = reportOrID;
    }
    ...
    if (reportActionOriginalMessage === null || reportActionOriginalMessage === void 0 ? void 0 : reportActionOriginalMessage.movedFromReport) {
        var reportName = (0, ReportUtils_1.getReportName)(allReports === null || allReports === void 0 ? void 0 : allReports["".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportActionOriginalMessage === null || reportActionOriginalMessage === void 0 ? void 0 : reportActionOriginalMessage.movedFromReport)]);
        return (0, Localize_1.translateLocal)('iou.movedFromReport', { reportName: reportName !== null && reportName !== void 0 ? reportName : '' });
    }
    ...
    if (hasModifiedTag) {
        var policyTags_1 = (_p = allPolicyTags === null || allPolicyTags === void 0 ? void 0 : allPolicyTags["".concat(ONYXKEYS_1.default.COLLECTION.POLICY_TAGS).concat(report === null || report === void 0 ? void 0 : report.policyID)]) !== null && _p !== void 0 ? _p : {};
    ...
    if (hasModifiedReimbursable) {
        buildMessageFragmentForValue(getBooleanLiteralMessage(reportActionOriginalMessage === null || reportActionOriginalMessage === void 0 ? void 0 : reportActionOriginalMessage.reimbursable, (0, Localize_1.translateLocal)('iou.reimbursable'), (0, Localize_1.translateLocal)('iou.nonReimbursable')), getBooleanLiteralMessage(reportActionOriginalMessage === null || reportActionOriginalMessage === void 0 ? void 0 : reportActionOriginalMessage.oldReimbursable, (0, Localize_1.translateLocal)('iou.reimbursable'), (0, Localize_1.translateLocal)('iou.nonReimbursable')), (0, Localize_1.translateLocal)('iou.expense'), true, setFragments, removalFragments, changeFragments);
    }
    ...
    if (hasModifiedAttendees) {
        var _y = (0, TransactionUtils_1.getFormattedAttendees)(reportActionOriginalMessage.newAttendees, reportActionOriginalMessage.oldAttendees), oldAttendees = _y[0], attendees = _y[1];
