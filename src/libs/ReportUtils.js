...
function getChannelLogMemberMessage(reportAction) {
    ...
    if (mentions.length === 0) {
        ...
        message = `${verb} ${mentions[0]} ${Localize.translateLocal('workspace.invite.and')} ${lastMention}`;
    } else {
        message = `${verb} ${mentions.join(', ')}, ${Localize.translateLocal('workspace.invite.and')} ${lastMention}`;
    }
