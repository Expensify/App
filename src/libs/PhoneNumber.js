...
function parsePhoneNumber(phoneNumber, options) {
    ...
    return __assign(__assign({}, parsedPhoneNumber), { valid: false, possible: false, number: __assign(__assign({}, parsedPhoneNumber.number), { 
            ...
            e164: phoneNumberWithoutSpecialChars, international: countryCode + " " + phoneNumberWithoutCountryCode, national: phoneNumberWithoutCountryCode, rfc3966: "tel:" + countryCode + "-" + phoneNumberWithoutCountryCode, significant: phoneNumberWithoutCountryCode }) });
}
