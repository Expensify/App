...
const ORIGINS_TO_REPLACE = ['/+', Config.EXPENSIFY.EXPENSIFY_URL, Config.EXPENSIFY.STAGING_API_ROOT];
...
export default function tryResolveUrlFromApiRoot(url) {
    return url.replace(ORIGIN_PATTERN, Config.EXPENSIFY.PRODUCTION_API_ROOT);
}
