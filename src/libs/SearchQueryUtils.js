...
function buildSearchQueryJSON(query) {
    try {
        ...
        var _a = getQueryHashes(result),
            primaryHash = _a.primaryHash,
            recentSearchHash = _a.recentSearchHash;
...
function buildQueryStringFromFilterFormValues(filterValues) {
    ...
    var type = filterValues.type,
        ...
        policyID = filterValues.policyID,
        otherFilters = __rest(filterValues, ['type', 'status', 'policyID']);
    var filtersString = [];
...
function buildFilterFormValuesFromQuery(queryJSON, policyCategories, policyTags, currencyList, personalDetails, cardList, reports, taxRates) {
    ...
    var _loop_1 = function (queryFilter) {
        ...
        var filterValues = filterList.map(function (item) {
...
function buildUserReadableQueryStringWithPolicyID(queryJSON, PersonalDetails, reports, taxRates, cardList, cardFeedNamesWithType, policies) {
    ...
    var _loop_2 = function (filterObject) {
        ...
        if (key === CONST_1['default'].SEARCH.SYNTAX_FILTER_KEYS.TAX_RATE) {
            var taxRateIDs = queryFilter.map(function (filter) {
...
function buildCannedSearchQuery(_a) {
    var _b = _a === void 0 ? {} : _a,
        _c = _b.type,
        type = _c === void 0 ? CONST_1['default'].SEARCH.DATA_TYPES.EXPENSE : _c,
        _d = _b.status,
        status = _d === void 0 ? CONST_1['default'].SEARCH.STATUS.EXPENSE.ALL : _d,
        policyID = _b.policyID,
        cardID = _b.cardID,
        groupBy = _b.groupBy;
