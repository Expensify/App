...
function getOptionData(reportID) {
    ...
    let lastMessageText =
        lastMessageTextFromReport && hasMultipleParticipants && lastActorDetails && Number(lastActorDetails.accountID) !== currentUserAccountID ? `${lastActorDetails.displayName}: ` : '';
