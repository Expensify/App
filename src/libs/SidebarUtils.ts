...
function shouldShowRedBrickRoad(report: Report, reportActions: OnyxEntry<ReportActions>, transactionViolations?: OnyxCollection<TransactionViolation[]>, isReportArchived = false) {
    return !!getReasonAndReportActionThatHasRedBrickRoad(report, reportActions, transactionViolations, isReportArchived);
}
