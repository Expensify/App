...
function createOption(
    ...
    if (report) {
        ...
        const computedReportName = computeReportName(report, reports, allPolicies, undefined, allReportNameValuePairs, personalDetailsForCompute, allReportActions, currentUserAccountID);
