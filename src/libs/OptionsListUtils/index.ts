...
function processReport(
    ...
    return {
        ...
        reportOption: {
            item: report,
            ...createOption(accountIDs, personalDetails, report, currentUserAccountID, policy, privateIsArchived, undefined, reportAttributesDerived, visibleReportActionsData),
        },
    };
}
...
function createOptionList(
    ...
    if (reports) {
        for (const report of Object.values(reports)) {
            ...
            const {reportMapEntry, reportOption} = processReport(report, personalDetails, privateIsArchived, currentUserAccountID, policy, reportAttributesDerived, visibleReportActionsData);
...
function createOptionFromReport(
    ...
    return {
        item: report,
        ...createOption(accountIDs, personalDetails, report, currentUserAccountID, policy, privateIsArchived, config, reportAttributesDerived, visibleReportActionsData),
    };
}
                ...
                data: shouldGetOptionDetails
                    ? selectedOptions.map((participant) => {
                          ...
                          if (isReportPolicyExpenseChat) {
                              ...
                              return getPolicyExpenseReportOption(participant, privateIsArchived, currentUserAccountID, personalDetails, expenseReport, policy, reportAttributesDerived);
                          }
