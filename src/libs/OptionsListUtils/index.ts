...
function formatSectionsFromSearchTerm(
    ...
    const selectedOptionsMapper = (participant: Participant) => {
        ...
        if (isReportPolicyExpenseChat) {
            ...
            return getPolicyExpenseReportOption(participant, privateIsArchived, currentUserAccountID, personalDetails, expenseReport, expenseReportPolicy, reportAttributesDerived);
        }
