...
function createOption(
    ...
    if (report) {
        ...
        const computedReportName = computeReportNameWithoutFormula(report, undefined, undefined, undefined, allReportNameValuePairs, personalDetailsForCompute, undefined);
