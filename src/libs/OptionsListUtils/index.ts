 ...
 */
// eslint-disable-next-line max-params, @typescript-eslint/max-params -- this should be handled in the seperate issue
...
function createOptionFromReport(
    ...
    return {
        item: report,
        ...createOption(accountIDs, personalDetails, report, currentUserAccountID, chatReport, config, reportAttributesDerived, privateIsArchived, policyTags, visibleReportActionsData),
    };
}
