...
function processReport(
    ...
    return {
        ...
        reportOption: {
            item: report,
            ...createOption(accountIDs, personalDetails, report, policyTags, currentUserAccountID, undefined, reportAttributesDerived, undefined, visibleReportActionsData),
        },
    };
}
...
function createOptionList(
    ...
    if (reports) {
        for (const report of Object.values(reports)) {
            ...
            const {reportMapEntry, reportOption} = processReport(report, personalDetails, reportPolicyTags, currentUserAccountID, reportAttributesDerived, visibleReportActionsData);
...
function createOptionFromReport(
    ...
    return {
        item: report,
        ...createOption(accountIDs, personalDetails, report, policyTags, currentUserAccountID, config, reportAttributesDerived, undefined, visibleReportActionsData),
    };
}
