...
import type {OptionData as PersonalDetailOption} from '@libs/PersonalDetailsOptionsListUtils';
...
function extendPersonalDetailOption(option: PersonalDetailOption): SearchOption<PersonalDetails> {
    const userDetails = {
