...
function createOption(
    ...
    if (report) {
        ...
        const computedReportName = computeReportName(report, allReports, policyCollection ?? allPolicies, undefined, allReportNameValuePairs, personalDetailsForCompute, allReportActions, currentUserAccountID);
