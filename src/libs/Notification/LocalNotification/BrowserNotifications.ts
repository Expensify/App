...
export default {
     ...
     */
    pushReportCommentNotification(report: Report, reportAction: ReportAction, onClick: LocalNotificationClickHandler, formatPhoneNumber: FormatPhoneNumberType, usesIcon = false) {
        let title;
        let body;
        ...
        if (isChatRoom) {
            const roomName = ReportUtils.getReportName(report, formatPhoneNumber);
            title = roomName;
    ...
    pushModifiedExpenseNotification(report: Report, reportAction: ReportAction, onClick: LocalNotificationClickHandler, formatPhoneNumber: FormatPhoneNumberType, usesIcon = false) {
