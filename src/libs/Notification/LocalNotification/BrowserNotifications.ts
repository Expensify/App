...
export default {
     ...
     */
    pushReportCommentNotification(report: Report, reportAction: ReportAction<typeof CONST.REPORT.ACTIONS.TYPE.ADD_COMMENT>, onClick: LocalNotificationClickHandler, usesIcon = false) {
        let title;
        let body;
