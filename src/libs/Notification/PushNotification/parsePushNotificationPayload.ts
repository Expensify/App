 ...
 */
export default function parsePushNotificationPayload(payload: JsonValue | undefined): AnyPushNotificationData | undefined {
    ...
    if (typeof payload !== 'string') {
        return payload as AnyPushNotificationData;
    }
    ...
    try {
        ...
        return jsonObject as AnyPushNotificationData;
    } catch {
    ...
    // JSON String
    try {
        return JSON.parse(payload) as JsonObject as AnyPushNotificationData;
    } catch {
