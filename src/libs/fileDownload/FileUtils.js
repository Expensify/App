...
exports.validateReceipt =
    exports.createFile =
    exports.resizeImageIfNeeded =
    exports.getImageDimensionsAfterResize =
    exports.verifyFileFormat =
    exports.isHighResolutionImage =
    exports.getFileResolution =
    exports.isImage =
    exports.validateImageForCorruption =
    exports.isLocalFile =
    exports.base64ToFile =
    exports.readFileAsync =
    exports.appendTimeToFileName =
    exports.cleanFileName =
    exports.getFileType =
    exports.getFileName =
    exports.splitExtensionFromFileName =
    exports.showCameraPermissionsAlert =
...
function showSuccessAlert(successMessage) {
    react_native_1.Alert.alert(
        Localize_1.translateLocal('fileDownload.success.title'),
...
function showCameraPermissionsAlert() {
    react_native_1.Alert.alert(
        Localize_1.translateLocal('attachmentPicker.cameraPermissionRequired'),
        Localize_1.translateLocal('attachmentPicker.expensifyDoesntHaveAccessToCamera'),
        [
            {
                text: Localize_1.translateLocal('common.cancel'),
                style: 'cancel',
...
function verifyFileFormat(_a) {
    ...
    return fetch(fileUri)
        ...
        .then(function (hexSignature) {
            return formatSignatures.some(function (signature) {
                return hexSignature.startsWith(signature);
            });
        });
}
...
function isLocalFile(receiptUri) {
    ...
    return (
        typeof receiptUri === 'number' ||
        (receiptUri === null || receiptUri === void 0 ? void 0 : receiptUri.startsWith('blob:')) ||
        (receiptUri === null || receiptUri === void 0 ? void 0 : receiptUri.startsWith('file:')) ||
        (receiptUri === null || receiptUri === void 0 ? void 0 : receiptUri.startsWith('/'))
    );
}
...
const resizeImageIfNeeded = function (file) {
    ...
    if (
        ...
        ((_b = file === null || file === void 0 ? void 0 : file.size) !== null && _b !== void 0 ? _b : 0) <= CONST_1['default'].API_ATTACHMENT_VALIDATIONS.MAX_SIZE
    ) {
...
const validateReceipt = function (file, setUploadReceiptError) {
    return validateImageForCorruption(file)
        .then(function () {
            ...
            if (
                !expensify_common_1.Str.isImage((_b = file.name) !== null && _b !== void 0 ? _b : '') &&
                ((_c = file === null || file === void 0 ? void 0 : file.size) !== null && _c !== void 0 ? _c : 0) > CONST_1['default'].API_ATTACHMENT_VALIDATIONS.RECEIPT_MAX_SIZE
            ) {
