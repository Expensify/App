 ...
 */
function getReportOrDraftReport(reportID: string | undefined, searchReports?: SearchReport[], fallbackReport?: Report, reportDrafts?: OnyxCollection<Report>): OnyxEntry<Report> | SearchReport {
