    ...
    return [
        {
            ...
            onSelected: () => {
                ...
                startMoneyRequest(CONST.IOU.TYPE.SUBMIT, iouReportID, undefined, false, iouRequestBackToReport, draftTransactionIDs);
            },
        },
        {
            ...
            onSelected: () => {
                ...
                startDistanceRequest(CONST.IOU.TYPE.SUBMIT, iouReportID, lastDistanceExpenseType, false, iouRequestBackToReport, draftTransactionIDs);
            },
        },
        {
