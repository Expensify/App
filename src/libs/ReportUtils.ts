...
import {canApproveIOU, canIOUBePaid, canSubmitReport, createDraftTransaction, getIOUReportActionToApproveOrPay, setMoneyRequestParticipants, setMoneyRequestParticipantsFromReport, unholdRequest} from './actions/IOU';
...
function canCreateRequest(
    ...
    const requestOptions = getMoneyRequestOptions(report, policy, participantAccountIDs, false, isReportArchived, isRestrictedToPreferredWorkspace);
