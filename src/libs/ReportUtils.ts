...
function getMovedTransactionMessageUsingDependencyData(action: ReportAction) {
    ...
    const report = allReports?.[`${ONYXKEYS.COLLECTION.REPORT}${toReportID}`];
...
export {
    ...
    getMovedTransactionMessageUsingDependencyData,
};
