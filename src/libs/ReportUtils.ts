    ...
    return [
        {
            ...
            onSelected: () => {
                ...
                if (policy && policy.type !== CONST.POLICY.TYPE.PERSONAL && shouldRestrictUserBillableActions(policy.id, userBillingGraceEndPeriodCollection, ownerBillingGraceEndPeriod)) {
