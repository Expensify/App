...
function buildOptimisticEmptyReport(
    ...
    const titleReportFieldFormula = titleReportField?.defaultValue ?? CONST.POLICY.DEFAULT_REPORT_NAME_PATTERN;
    const formulaContext: FormulaContext = {
        report: optimisticEmptyReport,
        policy,
        allTransactions: reportTransactions ?? {},
    };
    const optimisticReportName = compute(titleReportFieldFormula, formulaContext);
