 ...
 */
function isAllowedToComment(report: OnyxEntry<Report> | EmptyObject): boolean {
...
export type {ExpenseOriginalMessage, OptionData, OptimisticChatReport, DisplayNameWithTooltips, OptimisticTaskReportAction};
