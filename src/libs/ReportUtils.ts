...
function getMovedTransactionMessage(translate: LocalizedTranslate, action: ReportAction) {
    ...
    const reportName = getReportName(report, reportAttributesDerivedValue) ?? report?.reportName ?? '';
...
function getUnreportedTransactionMessage(translate: LocalizedTranslate, action: ReportAction) {
    ...
    const reportName = getReportName(fromReport, reportAttributesDerivedValue) ?? fromReport?.reportName ?? '';
...
function getMoneyReportPreviewName(action: ReportAction, iouReport: OnyxEntry<Report>, isInvoice?: boolean) {
    ...
    return getReportName(iouReport, reportAttributesDerivedValue) || action.childReportName;
}
