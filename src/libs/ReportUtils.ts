    ...
    return [
        {
            ...
            onSelected: () => {
                ...
                if (
                    ...
                    shouldRestrictUserBillableActions(policy.id, ownerBillingGracePeriodEnd, userBillingGraceEndPeriods, amountOwed)
                ) {
...
function createDraftTransactionAndNavigateToParticipantSelector({
    ...
    if (actionName === CONST.IOU.ACTION.CATEGORIZE) {
        if (activePolicy && shouldRestrictUserBillableActions(activePolicy.id, ownerBillingGracePeriodEnd, userBillingGraceEndPeriods, amountOwed)) {
