...
const changeMoneyRequestHoldStatus = (reportAction: OnyxEntry<ReportAction>, iouTransaction: OnyxEntry<Transaction>, bankAccountList?: OnyxEntry<BankAccountList>): void => {
    if (!isMoneyRequestAction(reportAction)) {
        return;
    }
