...
function getTransactionDetails(transaction: OnyxEntry<Transaction> | undefined, createdDateFormat: string = CONST.DATE.FNS_FORMAT_STRING): TransactionDetails | undefined {
    if (!transaction) {
        return;
    }
