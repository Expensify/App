...
function findLastAccessedReportSelector(
    ...
    const {ignoreDomainRooms, openOnAdminRoom = false, excludeReportID} = options;
...
function findLastAccessedReport(
    ...
    return findLastAccessedReportSelector(deprecatedAllReports, reportNameValuePairs ?? allReportNameValuePair, allReportLastVisitTimes, {
        ignoreDomainRooms,
        openOnAdminRoom,
        excludeReportID,
    });
