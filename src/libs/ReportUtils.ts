...
function getReportOrDraftReport(
    ...
    const resolvedDraft = isEmptyObject(reportDraft) ? undefined : ((reportDraft as OnyxEntry<Report>) ?? deprecatedAllReportsDraft?.[`${ONYXKEYS.COLLECTION.REPORT_DRAFT}${reportID}`]);
