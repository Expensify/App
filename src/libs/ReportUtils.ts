...
function reasonForReportToBeInOptionList({
    ...
    if (isInFocusMode) {
        ...
        return isUnread(report, oneTransactionThreadReport, isReportArchived, undefined) && getReportNotificationPreference(report) !== CONST.REPORT.NOTIFICATION_PREFERENCE.MUTE
