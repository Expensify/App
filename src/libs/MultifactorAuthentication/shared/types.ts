 ...
 */
type AuthTypeName = ValueOf<typeof NATIVE_BIOMETRIC_HSM_VALUES.AUTH_TYPE>['NAME'] | (typeof PASSKEY_AUTH_TYPE)['NAME'];

type MarqetaAuthTypeName = ValueOf<typeof NATIVE_BIOMETRIC_HSM_VALUES.AUTH_TYPE>['MARQETA_VALUE'] | (typeof PASSKEY_AUTH_TYPE)['MARQETA_VALUE'];
...
type MultifactorAuthenticationMethodCode = ValueOf<typeof NATIVE_BIOMETRIC_HSM_VALUES.AUTH_TYPE>['CODE'];
