type ImportMerchantRulesSpreadsheetParams = {
     ...
     * Record<string, {filters: {left: string; operator: string; right: string}; merchant?: string; category?: string; comment?: string; reimbursable?: boolean; billable?: boolean; vendorID?: string}>
     */
    rules: string;
};
