...
const SIDE_EFFECT_REQUEST_COMMANDS = {
    ...
    GET_MISSING_ONYX_MESSAGES_FOR_PUSH_NOTIFICATION: 'GetMissingOnyxMessagesForPushNotification',
    JOIN_POLICY_VIA_INVITE_LINK: 'JoinWorkspaceViaInviteLink',
    RECONNECT_APP: 'ReconnectApp',
} as const;
...
type SideEffectRequestCommandParameters = {
    ...
    [SIDE_EFFECT_REQUEST_COMMANDS.GET_MISSING_ONYX_MESSAGES_FOR_PUSH_NOTIFICATION]: Parameters.GetMissingOnyxMessagesParams;
