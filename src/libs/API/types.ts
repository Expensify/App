...
const WRITE_COMMANDS = {
    ...
    UPDATE_QUICKBOOKS_DESKTOP_RECEIVABLE_ACCOUNT: 'UpdateQuickbooksDesktopReceivableAccount',
...
type WriteCommandParameters = {
    ...
    [WRITE_COMMANDS.UPDATE_QUICKBOOKS_DESKTOP_RECEIVABLE_ACCOUNT]: Parameters.UpdateQuickbooksDesktopGenericTypeParams;
