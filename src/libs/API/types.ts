...
const WRITE_COMMANDS = {
    ...
    UPDATE_QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT: 'UpdateQuickbooksDesktopReimbursableAccount',
...
type WriteCommandParameters = {
    ...
    [WRITE_COMMANDS.UPDATE_QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT]: Parameters.UpdateQuickbooksDesktopGenericTypeParams;
