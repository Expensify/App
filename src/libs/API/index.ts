...
function write<TCommand extends WriteCommand>(
    ...
    const workspaceCommands: WriteCommand[] = [
        ...
        WRITE_COMMANDS.SET_WORKSPACE_CATEGORY_DESCRIPTION_HINT,
        WRITE_COMMANDS.SET_POLICY_CATEGORY_RECEIPTS_REQUIRED,
        WRITE_COMMANDS.REMOVE_POLICY_CATEGORY_RECEIPTS_REQUIRED,
        ...
        WRITE_COMMANDS.UPDATE_MANY_POLICY_CONNECTION_CONFIGS,
        WRITE_COMMANDS.UPDATE_POLICY_DISTANCE_RATE_VALUE,
        WRITE_COMMANDS.UPDATE_POLICY_DISTANCE_RATE_NAME,
        WRITE_COMMANDS.UPDATE_POLICY_DISTANCE_TAX_RATE_VALUE,
        WRITE_COMMANDS.UPDATE_DISTANCE_TAX_CLAIMABLE_VALUE,
        ...
        WRITE_COMMANDS.CONNECT_POLICY_TO_SAGE_INTACCT,
        WRITE_COMMANDS.CREATE_WORKSPACE_REPORT_FIELD,
        WRITE_COMMANDS.UPDATE_WORKSPACE_REPORT_FIELD_INITIAL_VALUE,
        WRITE_COMMANDS.ENABLE_WORKSPACE_REPORT_FIELD_LIST_VALUE,
        WRITE_COMMANDS.CREATE_WORKSPACE_REPORT_FIELD_LIST_VALUE,
        WRITE_COMMANDS.REMOVE_WORKSPACE_REPORT_FIELD_LIST_VALUE,
    ] as WriteCommand[];
