...
// RecordFullReconnectTime - Records the full-reconnect time into an OpenApp/full-ReconnectApp response so the app doesn't read itself as stale right after a full download. Must run before SaveResponseInOnyx applies the response.
