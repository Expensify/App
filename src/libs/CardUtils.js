...
exports.getFundIdFromSettingsKey =
    exports.filterInactiveCards =
    exports.isExpensifyCardFullySetUp =
    exports.hasCardListObject =
    exports.hasIssuedExpensifyCard =
    exports.lastFourNumbersFromCardName =
    exports.isSmartLimitEnabled =
    exports.checkIfFeedConnectionIsBroken =
    exports.flatAllCardsList =
    exports.getFeedType =
    exports.isCardHiddenFromSearch =
    exports.isCardIssued =
    exports.getAllCardsForWorkspace =
    exports.isCard =
    exports.mergeCardListWithWorkspaceFeeds =
    exports.getDefaultCardName =
    exports.checkIfNewFeedConnected =
    exports.hasOnlyOneCardToAssign =
    exports.getFilteredCardList =
    exports.isCardClosed =
    exports.getCustomOrFormattedFeedName =
    exports.getCorrectStepForSelectedBank =
    exports.getSelectedFeed =
    exports.getBankCardDetailsImage =
    exports.isCustomFeed =
    exports.getCompanyFeeds =
    exports.isSelectedFeedExpired =
    exports.getBankName =
    exports.getCardFeedIcon =
    exports.sortCardsByCardholderName =
    exports.getEligibleBankAccountsForCard =
    exports.getTranslationKeyForLimitType =
    exports.getMCardNumberString =
    exports.hasDetectedFraud =
    exports.findPhysicalCard =
    exports.getCardDescription =
    exports.maskCardNumber =
    exports.maskCard =
    exports.getYearFromExpirationDateString =
    exports.getMonthFromExpirationDateString =
    exports.formatCardExpiration =
    exports.getDomainCards =
...
function getDomainCards(cardList) {
    ...
    return groupBy_1['default'](activeCards, function (card) {
...
function hasDetectedFraud(cardList) {
    return Object.values(cardList).some(function (card) {
        return card.fraud !== CONST_1['default'].EXPENSIFY_CARD.FRAUD_TYPES.NONE;
    });
}
...
function isCustomFeed(feed) {
    return [CONST_1['default'].COMPANY_CARD.FEED_BANK_NAME.MASTER_CARD, CONST_1['default'].COMPANY_CARD.FEED_BANK_NAME.VISA, CONST_1['default'].COMPANY_CARD.FEED_BANK_NAME.AMEX].some(
        function (value) {
            return feed.startsWith(value);
        },
    );
}
...
function getCompanyFeeds(cardFeeds, shouldFilterOutRemovedFeeds, shouldFilterOutPendingFeeds) {
    ...
    if (shouldFilterOutPendingFeeds === void 0) {
        shouldFilterOutPendingFeeds = false;
    }
...
function getFilteredCardList(list, directFeed, workspaceCardFeeds) {
    ...
    if (directFeed) {
        ...
        return Object.fromEntries(
            unassignedDirectFeedCards.map(function (cardNumber) {
...
function checkIfNewFeedConnected(prevFeedsData, currentFeedsData) {
    ...
    return {
        ...
        newFeed: currentFeeds.find(function (feed) {
            return !prevFeeds.includes(feed);
        }),
    };
}
...
function checkIfFeedConnectionIsBroken(feedCards, feedToExclude) {
    ...
    return Object.values(feedCards).some(function (card) {
        return !EmptyObject_1.isEmptyObject(card) && card.bank !== feedToExclude && card.lastScrapeResult !== 200;
    });
}
...
function isExpensifyCardFullySetUp(policy, cardSettings) {
    return !!(
        (policy === null || policy === void 0 ? void 0 : policy.areExpensifyCardsEnabled) && (cardSettings === null || cardSettings === void 0 ? void 0 : cardSettings.paymentBankAccountID)
    );
}
