...
import PersonalDetailsToCollection from './migrations/PersonalDetailsToCollection';
...
export default function () {
    ...
    return new Promise((resolve) => {
        ...
        const migrationPromises = [PersonalDetailsByAccountID, RenameReceiptFilename, KeyReportActionsDraftByReportActionID, PersonalDetailsToCollection];
