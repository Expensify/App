...
exports.updateCategoryInMccGroup =
    exports.getCategoryDefaultTaxRate =
    exports.getCategoryExpenseRule =
    exports.getCategoryApproverRule =
...
function formatRequireReceiptsOverText(translate, policy, categoryMaxAmountNoReceipt) {
    ...
    return translate('workspace.rules.categoryRules.requireReceiptsOverList.default', {
        defaultAmount: CurrencyUtils.convertToShortDisplayString(
            maxExpenseAmountToDisplay,
            (_a = policy === null || policy === void 0 ? void 0 : policy.outputCurrency) !== null && _a !== void 0 ? _a : CONST_1['default'].CURRENCY.USD,
        ),
    });
}
        ...
        (_c =
            (_b =
                (_a =
                    ...
                    ? void 0
                    : _a.tax) === null || _b === void 0
                ? void 0
                : _b.field_id_TAX) === null || _c === void 0
            ? void 0
            : _c.externalID;
