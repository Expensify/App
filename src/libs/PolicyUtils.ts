...
function getPersonalPolicy(policies?: OnyxCollection<Policy> | null) {
    return Object.values(policies ?? allPolicies ?? {}).find((policy) => policy?.type === CONST.POLICY.TYPE.PERSONAL);
}
