...
const purposeSuffixes = {
    [ONBOARDING_CHOICES.MANAGE_TEAM]: [ONBOARDING.DYNAMIC_EMPLOYEES, ONBOARDING.ACCOUNTING, ONBOARDING.INTERESTED_FEATURES],
...
const qualifierSuffixes = {
    ...
    [ONBOARDING_SIGNUP_QUALIFIERS.SMB]: [ONBOARDING.DYNAMIC_EMPLOYEES, ONBOARDING.ACCOUNTING, ONBOARDING.INTERESTED_FEATURES],
