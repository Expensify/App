...
const screenResolution: Record<OnboardingScreen, OnboardingScreen> = {
    ...
    [ONBOARDING.WORKSPACE_CONFIRMATION]: ONBOARDING.DYNAMIC_WORKSPACE_OPTIONAL,
    [ONBOARDING.WORKSPACE_CURRENCY]: ONBOARDING.DYNAMIC_WORKSPACE_OPTIONAL,
    [ONBOARDING.WORKSPACE_INVITE]: ONBOARDING.DYNAMIC_WORKSPACE_OPTIONAL,
};
