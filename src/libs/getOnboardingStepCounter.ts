...
const purposeSuffixes = {
    [ONBOARDING_CHOICES.MANAGE_TEAM]: [ONBOARDING.DYNAMIC_EMPLOYEES, ONBOARDING.DYNAMIC_ACCOUNTING, ONBOARDING.INTERESTED_FEATURES],
...
const qualifierSuffixes = {
    [ONBOARDING_SIGNUP_QUALIFIERS.VSB]: [ONBOARDING.DYNAMIC_ACCOUNTING, ONBOARDING.INTERESTED_FEATURES],
    [ONBOARDING_SIGNUP_QUALIFIERS.SMB]: [ONBOARDING.DYNAMIC_EMPLOYEES, ONBOARDING.DYNAMIC_ACCOUNTING, ONBOARDING.INTERESTED_FEATURES],
