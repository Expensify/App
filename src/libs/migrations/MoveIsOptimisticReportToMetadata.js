        ...
        var connection = react_native_onyx_1.default.connect({
            ...
            callback: function (reports) {
                ...
                Object.entries(reports).forEach(function (_a) {
                    ...
                    if ((report === null || report === void 0 ? void 0 : report.isOptimisticReport) === undefined) {
                        return;
                    }
                    promises.push(Promise.all([
                        // @ts-expect-error isOptimisticReport is not a valid property of Report anymore
                        // eslint-disable-next-line rulesdir/prefer-actions-set-data
                        react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT).concat(reportID), { isOptimisticReport: null }),
                        // eslint-disable-next-line rulesdir/prefer-actions-set-data
                        react_native_onyx_1.default.merge("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_METADATA).concat(reportID), { isOptimisticReport: report.isOptimisticReport }),
                    ]).then(function () {
                        Log_1.default.info("[Migrate Onyx] Successfully moved isOptimisticReport to reportMetadata for ".concat(reportID));
                    }));
                });
