...
/** Per-token cadence for the optimistic reveal, a constant ~30 chars/sec. */
...
/** Reveal duration for the optimistic path in usePendingConciergeResponse. The rate is constant, so duration scales linearly with reply length. Server-streamed reveals are paced separately by getRevealDurationMS and easeOut. */
