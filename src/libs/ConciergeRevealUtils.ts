...
export {ACCELERATED_REMAINING_MS, DEFAULT_STREAM_DURATION_MS, easeOut, getRevealDurationMS, MIN_TRICKLE_TOKEN_COUNT, OPTIMISTIC_FLAT_MS_PER_TOKEN, TICK_INTERVAL_MS, TRICKLE_HARD_CAP_MS};
