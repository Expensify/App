...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(field, op, value) { return buildFilter(op, field, value); };
  ...
  var peg$f14 = function(parts) { return parts.join(""); };
  ...
  function peg$parsefilter() {
    ...
    if (s1 === peg$FAILED) {
      s1 = peg$parsequotedStringFilter();
      if (s1 === peg$FAILED) {
  ...
  function peg$parsequotedStringFilter() {
    var s0, s1, s2, s3, s4, s5, s6;
