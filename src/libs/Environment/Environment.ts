...
const ENVIRONMENT_URLS = {
    [CONST.ENVIRONMENT.DEV]: CONFIG.EXPENSIFY.NEW_EXPENSIFY_URL?.includes('.dev') ? CONFIG.EXPENSIFY.NEW_EXPENSIFY_URL : CONST.DEV_NEW_EXPENSIFY_URL + CONFIG.DEV_PORT,
    [CONST.ENVIRONMENT.STAGING]: CONST.STAGING_NEW_EXPENSIFY_URL,
    [CONST.ENVIRONMENT.QA]: CONST.QA_NEW_EXPENSIFY_URL,
...
const OLDDOT_ENVIRONMENT_URLS = {
    ...
    [CONST.ENVIRONMENT.QA]: CONST.QA_EXPENSIFY_URL,
