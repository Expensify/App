...
exports.isPolicyMember = exports.isPolicyOwner = exports.isPolicyFeatureEnabled = exports.isPolicyEmployee = exports.isPolicyAuditor = exports.isPolicyUser = exports.isPolicyAdmin = exports.isUserPolicyAdmin = exports.isPendingDeletePolicy = exports.isPaidGroupPolicy = exports.getCorrectedAutoReportingFrequency = exports.isInstantSubmitEnabled = exports.isDeletedPolicyEmployee = exports.isExpensifyTeam = exports.isControlOnAdvancedApprovalMode = exports.shouldShowTaxRateError = exports.shouldShowPolicyErrorFields = exports.shouldShowPolicyError = exports.hasPolicyCategoriesError = exports.hasIntegrationAutoSync = exports.shouldShowEmployeeListError = exports.shouldShowCustomUnitsError = exports.shouldShowSyncError = exports.hasAccountingConnections = exports.goBackFromInvalidPolicy = exports.getRateDisplayValue = exports.getUnitRateValue = exports.getTaxByID = exports.getTagLists = exports.getTagListName = exports.getTagList = exports.getSortedTagKeys = exports.getPolicyEmployeeListByIdWithoutCurrentUser = exports.getPolicyBrickRoadIndicatorStatus = exports.getPolicy = exports.getPersonalPolicy = exports.getPathWithoutPolicyID = exports.isMultiLevelTags = exports.getNumericValue = exports.getMemberAccountIDsForWorkspace = exports.getIneligibleInvitees = exports.getCountOfEnabledTagsOfList = exports.getConnectedIntegration = exports.getCleanedTagName = exports.getAdminEmployees = exports.getPerDiemCustomUnits = exports.getActivePolicies = exports.escapeTagName = exports.extractPolicyIDFromPath = exports.canEditTaxRate = void 0;
exports.getApprovalWorkflow = exports.getDefaultApprover = exports.getCustomersOrJobsLabelNetSuite = exports.getCurrentConnectionName = exports.getIntegrationLastSuccessfulDate = exports.navigateToExpensifyCardPage = exports.goBackWhenEnableFeature = exports.removePendingFieldsFromCustomUnit = exports.sortWorkspacesBySelected = exports.getDistanceRateCustomUnitRate = exports.getPerDiemCustomUnit = exports.getDistanceRateCustomUnit = exports.getSageIntacctBankAccounts = exports.getSageIntacctCreditCards = exports.getSageIntacctNonReimbursableActiveDefaultVendor = exports.getSageIntacctVendors = exports.getNetSuiteTaxAccountOptions = exports.getNetSuiteInvoiceItemOptions = exports.getNetSuiteReceivableAccountOptions = exports.getNetSuitePayableAccountOptions = exports.getNetSuiteApprovalAccountOptions = exports.getFilteredApprovalAccountOptions = exports.getNetSuiteCollectionAccountOptions = exports.getFilteredCollectionAccountOptions = exports.getNetSuiteReimbursableAccountOptions = exports.getFilteredReimbursableAccountOptions = exports.canUseProvincialTaxNetSuite = exports.canUseTaxNetSuite = exports.getNetSuiteVendorOptions = exports.hasPolicyWithXeroConnection = exports.findSelectedSageVendorWithDefaultSelect = exports.findSelectedTaxAccountWithDefaultSelect = exports.findSelectedInvoiceItemWithDefaultSelect = exports.findSelectedBankAccountWithDefaultSelect = exports.findSelectedVendorWithDefaultSelect = exports.getXeroBankAccounts = exports.getCurrentXeroOrganizationName = exports.findCurrentXeroOrganization = exports.getXeroTenants = exports.hasVBBA = exports.hasDependentTags = exports.canSendInvoice = exports.canSubmitPerDiemExpenseFromWorkspace = exports.canSendInvoiceFromWorkspace = exports.getOwnedPaidPolicies = exports.getActiveAdminWorkspaces = exports.shouldShowPolicy = exports.isTaxTrackingEnabled = exports.isSubmitAndClose = exports.arePaymentsEnabled = void 0;
exports.areAllGroupPoliciesExpenseChatDisabled = exports.isAutoSyncEnabled = exports.isPrefferedExporter = exports.getManagerAccountID = exports.isWorkspaceEligibleForReportChange = exports.getDescriptionForPolicyDomainCard = exports.getMostFrequentEmailDomain = exports.getPolicyNameByID = exports.getAdminsPrivateEmailDomains = exports.canModifyPlan = exports.getRuleApprovers = exports.getManagerAccountEmail = exports.hasOtherControlWorkspaces = exports.shouldDisplayPolicyNotFoundPage = exports.isPolicyAccessible = exports.getUserFriendlyWorkspaceType = exports.getActivePolicy = exports.getAllPoliciesLength = exports.getNetSuiteImportCustomFieldLabel = exports.getWorkflowApprovalsUnavailable = exports.hasUnsupportedIntegration = exports.getDomainNameForPolicy = exports.getTagApproverRule = exports.getTagNamesFromTagsLists = exports.getAllTaxRates = exports.getWorkspaceAccountID = exports.getSubmitToAccountID = exports.getForwardsToAccount = exports.getGroupPaidPoliciesWithExpenseChatEnabled = exports.settingsPendingAction = exports.areSettingsInErrorFields = exports.getCurrentTaxID = exports.hasNoPolicyOtherThanPersonalType = exports.getCurrentSageIntacctEntityName = exports.isNetSuiteCustomFieldPropertyEditable = exports.getNameFromNetSuiteCustomField = exports.isNetSuiteCustomSegmentRecord = exports.isCollectPolicy = exports.isControlPolicy = exports.getReimburserAccountID = void 0;
...
function getPerDiemCustomUnits(policies, email) {
    return getActivePolicies(policies, email)
...
function shouldShowSyncError(policy, isSyncInProgress) {
    var _a;
    return isPolicyAdmin(policy) && Object.keys((_a = policy === null || policy === void 0 ? void 0 : policy.connections) !== null && _a !== void 0 ? _a : {}).some(function (connection) { return !!connections_1.hasSynchronizationErrorMessage(policy, connection, isSyncInProgress); });
}
...
function getPolicyNameByID(policyID) {
    var _a, _b;
    return (_b = (_a = allPolicies === null || allPolicies === void 0 ? void 0 : allPolicies["" + ONYXKEYS_1["default"].COLLECTION.POLICY + policyID]) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : policyID;
}
...
function isPolicyMember(currentUserLogin, policyID) {
    var _a, _b;
    return !!currentUserLogin && !!policyID && !!((_b = (_a = allPolicies === null || allPolicies === void 0 ? void 0 : allPolicies["" + ONYXKEYS_1["default"].COLLECTION.POLICY + policyID]) === null || _a === void 0 ? void 0 : _a.employeeList) === null || _b === void 0 ? void 0 : _b[currentUserLogin]);
}
...
var isPolicyEmployee = function (policyID, policies) {
    ...
    return Object.values(policies !== null && policies !== void 0 ? policies : {}).some(function (policy) { return (policy === null || policy === void 0 ? void 0 : policy.id) === policyID; });
};
...
function isPolicyFeatureEnabled(policy, featureName) {
    ...
    if (featureName === CONST_1["default"].POLICY.MORE_FEATURES.ARE_CONNECTIONS_ENABLED) {
        return (policy === null || policy === void 0 ? void 0 : policy[featureName]) ? !!(policy === null || policy === void 0 ? void 0 : policy[featureName]) : !EmptyObject_1.isEmptyObject(policy === null || policy === void 0 ? void 0 : policy.connections);
    }
...
function getRuleApprovers(policy, expenseReport) {
    ...
    for (var i = 0; i < allReportTransactions.length; i++) {
        ...
        var categoryAppover = (_c = CategoryUtils_1.getCategoryApproverRule((_b = (_a = policy === null || policy === void 0 ? void 0 : policy.rules) === null || _a === void 0 ? void 0 : _a.approvalRules) !== null && _b !== void 0 ? _b : [], category)) === null || _c === void 0 ? void 0 : _c.approver;
...
function getManagerAccountID(policy, expenseReport) {
    ...
    return (_f = PersonalDetailsUtils_1.getAccountIDsByLogins([(_e = employee === null || employee === void 0 ? void 0 : employee.submitsTo) !== null && _e !== void 0 ? _e : defaultApprover]).at(0)) !== null && _f !== void 0 ? _f : -1;
}
...
function getActiveAdminWorkspaces(policies, currentUserLogin) {
    ...
    return activePolicies.filter(function (policy) { return shouldShowPolicy(policy, NetworkStore_1.isOffline(), currentUserLogin) && isPolicyAdmin(policy, currentUserLogin); });
}
...
function getNetSuiteImportCustomFieldLabel(policy, importField, translate) {
    ...
    var importedTypes = Array.from(mappingSet)
        ...
        .map(function (mapping) { return translate("workspace.netsuite.import.importTypes." + (mapping !== '' ? mapping : 'TAG') + ".label").toLowerCase(); });
...
function getIntegrationLastSuccessfulDate(connection, connectionSyncProgress) {
    ...
    var connectionSyncTimeStamp = DateUtils_1["default"].getLocalDateFromDatetime(preferredLocale !== null && preferredLocale !== void 0 ? preferredLocale : CONST_1["default"].LOCALES.DEFAULT, connectionSyncProgress === null || connectionSyncProgress === void 0 ? void 0 : connectionSyncProgress.timestamp).toISOString();
    if (connectionSyncProgress &&
        ...
        syncSuccessfulDate &&
        connectionSyncTimeStamp > DateUtils_1["default"].getLocalDateFromDatetime(preferredLocale !== null && preferredLocale !== void 0 ? preferredLocale : CONST_1["default"].LOCALES.DEFAULT, syncSuccessfulDate).toISOString()) {
...
var isWorkspaceEligibleForReportChange = function (newPolicy, report, oldPolicy, currentUserLogin) {
    ...
    var isCurrentUserMember = !!currentUserLogin && !!((_a = newPolicy === null || newPolicy === void 0 ? void 0 : newPolicy.employeeList) === null || _a === void 0 ? void 0 : _a[currentUserLogin]);
    ...
    if (isCurrentUserApprover) {
        var reportSubmitterLogin = (report === null || report === void 0 ? void 0 : report.ownerAccountID) ? PersonalDetailsUtils_1.getLoginByAccountID(report === null || report === void 0 ? void 0 : report.ownerAccountID) : undefined;
        var isReportSubmitterMember = !!reportSubmitterLogin && !!((_b = newPolicy === null || newPolicy === void 0 ? void 0 : newPolicy.employeeList) === null || _b === void 0 ? void 0 : _b[reportSubmitterLogin]);
...
function isPolicyAccessible(policy) {
    return (!EmptyObject_1.isEmptyObject(policy) && (Object.keys(policy).length !== 1 || EmptyObject_1.isEmptyObject(policy.errors)) && !!(policy === null || policy === void 0 ? void 0 : policy.id) && (policy === null || policy === void 0 ? void 0 : policy.pendingAction) !== CONST_1["default"].RED_BRICK_ROAD_PENDING_ACTION.DELETE);
}
...
function getAdminsPrivateEmailDomains(policy) {
    ...
    var privateDomains = __spreadArrays(new Set(adminDomains.concat(ownerDomains))).filter(function (domain) { return !ValidationUtils_1.isPublicDomain(domain); });
...
function isAutoSyncEnabled(policy) {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v;
    var values = [
        (_d = (_c = (_b = (_a = policy.connections) === null || _a === void 0 ? void 0 : _a.intacct) === null || _b === void 0 ? void 0 : _b.config) === null || _c === void 0 ? void 0 : _c.autoSync) === null || _d === void 0 ? void 0 : _d.enabled,
        (_h = (_g = (_f = (_e = policy.connections) === null || _e === void 0 ? void 0 : _e.netsuite) === null || _f === void 0 ? void 0 : _f.config) === null || _g === void 0 ? void 0 : _g.autoSync) === null || _h === void 0 ? void 0 : _h.enabled,
        (_m = (_l = (_k = (_j = policy.connections) === null || _j === void 0 ? void 0 : _j.quickbooksDesktop) === null || _k === void 0 ? void 0 : _k.config) === null || _l === void 0 ? void 0 : _l.autoSync) === null || _m === void 0 ? void 0 : _m.enabled,
        (_r = (_q = (_p = (_o = policy.connections) === null || _o === void 0 ? void 0 : _o.quickbooksOnline) === null || _p === void 0 ? void 0 : _p.config) === null || _q === void 0 ? void 0 : _q.autoSync) === null || _r === void 0 ? void 0 : _r.enabled,
        (_v = (_u = (_t = (_s = policy.connections) === null || _s === void 0 ? void 0 : _s.xero) === null || _t === void 0 ? void 0 : _t.config) === null || _u === void 0 ? void 0 : _u.autoSync) === null || _v === void 0 ? void 0 : _v.enabled,
    ];
