...
function getPersonalDetailsOnyxDataForOptimisticUsers(newLogins, newAccountIDs) {
    ...
    newLogins.forEach(function (login, index) {
        ...
        personalDetailsNew[accountID] = {
            login: login,
            accountID: accountID,
            displayName: (0, LocalePhoneNumber_1.formatPhoneNumber)(login),
...
function getEffectiveDisplayName(personalDetail) {
    var _a;
    if (personalDetail) {
        return (0, LocalePhoneNumber_1.formatPhoneNumber)((_a = personalDetail === null || personalDetail === void 0 ? void 0 : personalDetail.login) !== null && _a !== void 0 ? _a : '') || personalDetail.displayName;
    }
    return undefined;
}
/**
...
function createDisplayName(login, passedPersonalDetails) {
    ...
    var userLogin = (0, LocalePhoneNumber_1.formatPhoneNumber)(login);
