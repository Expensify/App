...
function shouldShowDeleteOption(
    ...
    return selectedReports.length && searchDataType !== CONST.SEARCH.DATA_TYPES.EXPENSE
        ? selectedReports.every((selectedReport) => {
              ...
              return canDeleteMoneyRequestReport(fullReport, reportTransactions, reportActionsArray, currentUserAccountID, policy);
          })
        : selectedTransactionsKeys.every((id) => {
              ...
              return canDeleteMoneyRequestReport(parentReport, [transaction], parentReportAction ? [parentReportAction] : [], currentUserAccountID, policy);
          });
}
