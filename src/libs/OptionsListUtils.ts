 ...
 */
function getAllReportErrors(report: OnyxEntry<Report>, reportActions: OnyxEntry<ReportActions> | undefined, transactions: OnyxCollection<Transaction> = allTransactions): OnyxCommon.Errors {
