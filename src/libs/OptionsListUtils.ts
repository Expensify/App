...
function createOption(
    ...
    if (report) {
        ...
        result.alternateText = showPersonalDetails ? personalDetail.login : getAlternateTextOption(result, {showChatPreviewLine, forcePolicyNamePreview, lastMessageTextFromReport});
