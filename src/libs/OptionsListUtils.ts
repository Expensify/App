...
import {OriginalMessageMovedTransaction} from '@src/types/onyx/OriginalMessage';
...
function getLastMessageTextForReport(report: OnyxEntry<Report>, lastActorDetails: Partial<PersonalDetails> | null, policy?: OnyxEntry<Policy>, isReportArchived = false): string {
    ...
    if (isArchivedNonExpenseReport(report, isReportArchived)) {
        ...
        const movedTransactionOriginalMessage = getOriginalMessage(lastReportAction as OnyxTypes.ReportAction<typeof CONST.REPORT.ACTIONS.TYPE.MOVED_TRANSACTION>) ?? {};
        ...
        lastMessageTextFromReport = getMovedTransactionMessage(report);
