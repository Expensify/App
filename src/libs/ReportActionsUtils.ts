 ...
 */
function getParentReportAction(report: OnyxEntry<Report> | EmptyObject, allReportActionsParam?: OnyxCollection<ReportActions>): ReportAction | Record<string, never> {
