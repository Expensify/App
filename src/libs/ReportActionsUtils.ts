...
function getChangedApproverActionMessage<T extends typeof CONST.REPORT.ACTIONS.TYPE.TAKE_CONTROL | typeof CONST.REPORT.ACTIONS.TYPE.ACTION_REROUTE>(reportAction: OnyxEntry<ReportAction>) {
