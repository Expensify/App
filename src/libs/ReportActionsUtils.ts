...
import {
    ...
    convertToDisplayString as convertToDisplayStringCurrencyUtils,
    convertToDisplayStringWithoutCurrency as convertToDisplayStringWithoutCurrencyCurrencyUtils,
...
function getAutoReimbursementMessage(
    translate: LocalizedTranslate,
    action: ReportAction,
    convertToDisplayString: CurrencyListActionsContextType['convertToDisplayString'] = convertToDisplayStringCurrencyUtils,
): string {
...
function getUpdatedTimeRateMessage(
    translate: LocalizedTranslate,
    reportAction: OnyxEntry<ReportAction>,
    convertToDisplayString: CurrencyListActionsContextType['convertToDisplayString'] = convertToDisplayStringCurrencyUtils,
) {
...
function getActionableCard3DSTransactionApprovalMessage(
    ...
    convertToDisplayString: CurrencyListActionsContextType['convertToDisplayString'] = convertToDisplayStringCurrencyUtils,
    convertToDisplayStringWithoutCurrency: CurrencyListActionsContextType['convertToDisplayStringWithoutCurrency'] = convertToDisplayStringWithoutCurrencyCurrencyUtils,
) {
    const originalMessage = getOriginalMessage(reportAction);
    if (!originalMessage) {
        return undefined;
