...
function navigateAfterOnboardingWithMicrotaskQueue(
    ...
    Navigation.setNavigationActionToMicrotaskQueue(() => {
        navigateAfterOnboarding(isSmallScreenWidth, canUseDefaultRooms, conciergeReportID, onboardingPolicyID, onboardingAdminsChatReportID, shouldPreventOpenAdminRoom, variantOverride);
    });
}
