...
function buildOptimisticTransaction(params: BuildOptimisticTransactionParams): Transaction {
    ...
    return {
        ...
        receipt: receipt?.source ? {source: receipt.source, filename: (receipt?.name ?? filename), state: receipt.state ?? CONST.IOU.RECEIPT_STATE.SCAN_READY, isTestDriveReceipt: receipt.isTestDriveReceipt} : {},
