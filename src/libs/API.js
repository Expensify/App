...
function reauthenticate(command = '') {
    ...
    return Authenticate({
        ...
        .catch((error) => {
            ...
            Log.alert(`${CONST.ERROR.ENSURE_BUGBOT} Redirecting to Sign In because we failed to reauthenticate`, {
                command,
                error: error.message,
                hasAutoGeneratedLogin: Boolean(credentials.autoGeneratedLogin),
                hasAutoGeneratedPassword: Boolean(credentials.autoGeneratedPassword),
            });
        });
}
