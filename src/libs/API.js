...
function reauthenticate(command = '') {
    return Authenticate({
        ...
        .catch((error) => {
            // When fetch() fails and the "API is offline" error is thrown we won't log the user out. Most likely they
            // have a spotty connection and will need to try to reauthenticate when they come back online.
