...
const INSIGHTS_TAB_ORDER: InsightTabScreen[] = [SCREENS.INSIGHTS.TOP_SPENDERS, SCREENS.INSIGHTS.TOP_CATEGORIES, SCREENS.INSIGHTS.TOP_MERCHANTS, SCREENS.INSIGHTS.SPEND_OVER_TIME];

const DEFAULT_INSIGHTS_SCREEN: InsightTabScreen = SCREENS.INSIGHTS.TOP_SPENDERS;
