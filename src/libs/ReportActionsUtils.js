...
exports.isAddCommentAction = exports.isResolvedConciergeCategoryOptions = exports.isConciergeCategoryOptions = exports.isActionableTrackExpense = exports.isActionableReportMentionWhisper = exports.isActionableMentionWhisper = exports.isActionableJoinRequestPending = exports.isActionableJoinRequest = exports.isActionableWhisper = exports.isActionOfType = exports.hasRequestFromCurrentAccount = exports.getWhisperedTo = exports.getTrackExpenseActionableWhisper = exports.getTextFromHtml = exports.getSortedReportActionsForDisplay = exports.getSortedReportActions = exports.getReportPreviewAction = exports.getReportActionText = exports.getReportActionMessageText = exports.getReportActionMessage = exports.getReportActionHtml = exports.getReportAction = exports.getDemotedFromWorkspaceMessage = exports.getRemovedFromApprovalChainMessage = exports.getOriginalMessage = exports.getOneTransactionThreadReportID = exports.getNumberOfMoneyRequests = exports.getMostRecentIOURequestActionID = exports.getMessageOfOldDotReportAction = exports.getReportActionMessageFragments = exports.getUpdateRoomDescriptionFragment = exports.getMemberChangeMessageFragment = exports.getLinkedTransactionID = exports.getLatestReportActionFromOnyxData = exports.getLastVisibleMessage = exports.getLastVisibleAction = exports.getLastClosedReportAction = exports.getIOUReportIDFromReportActionPreview = exports.getIOUActionForTransactionID = exports.getIOUActionForReportID = exports.getFirstVisibleReportActionID = exports.getDismissedViolationMessageText = exports.getCombinedReportActions = exports.getAllReportActions = exports.getActionableMentionWhisperMessage = exports.getHtmlWithAttachmentID = exports.isReportActionUnread = exports.formatLastMessageText = exports.extractLinksFromMessageHtml = exports.doesReportHaveVisibleActions = void 0;
exports.shouldHideNewMarker = exports.isResolvedActionableWhisper = exports.isTagModificationAction = exports.isWhisperActionTargetedToOthers = exports.isForwardedAction = exports.isUnapprovedAction = exports.isApprovedAction = exports.isSubmittedAndClosedAction = exports.isSubmittedAction = exports.isWhisperAction = exports.isTripPreview = exports.isTransactionThread = exports.isTrackExpenseAction = exports.isThreadParentMessage = exports.isTaskAction = exports.isSplitBillAction = exports.isSentMoneyReportAction = exports.isRoomChangeLogAction = exports.isReversedTransaction = exports.isReportPreviewAction = exports.isReportActionDeprecated = exports.isReportActionAttachment = exports.isRenamedAction = exports.isReimbursementQueuedAction = exports.isReimbursementDeQueuedOrCanceledAction = exports.isReimbursementDeQueuedAction = exports.isReimbursementCanceledAction = exports.isPolicyChangeLogAction = exports.isPendingRemove = exports.isPayAction = exports.isOldDotReportAction = exports.isNotifiableReportAction = exports.isMoneyRequestAction = exports.isModifiedExpenseAction = exports.useNewTableReportViewActionRenderConditionals = exports.isMessageDeleted = exports.isExportIntegrationAction = exports.isMemberChangeAction = exports.isLinkedTransactionHeld = exports.isDeletedParentAction = exports.isDeletedAction = exports.isCurrentActionUnread = exports.isCreatedTaskReportAction = exports.isCreatedAction = exports.hasNextActionMadeBySameActor = exports.isConsecutiveChronosAutomaticTimerAction = exports.isConsecutiveActionMadeByPreviousActor = exports.isClosedAction = exports.isChronosOOOListAction = exports.isApprovedOrSubmittedReportAction = void 0;
exports.getReportActions = exports.getWorkspaceReportFieldDeleteMessage = exports.getWorkspaceReportFieldUpdateMessage = exports.getWorkspaceTagUpdateMessage = exports.getWorkspaceCustomUnitRateAddedMessage = exports.getWorkspaceReportFieldAddMessage = exports.getWorkspaceDescriptionUpdatedMessage = exports.getPolicyChangeLogDefaultTitleEnforcedMessage = exports.getPolicyChangeLogDefaultBillableMessage = exports.getPolicyChangeLogMaxExpenseAmountMessage = exports.getPolicyChangeLogMaxExpesnseAmountNoReceiptMessage = exports.getWorkspaceFrequencyUpdateMessage = exports.getWorkspaceCurrencyUpdateMessage = exports.getWorkspaceUpdateFieldMessage = exports.getWorkspaceCategoryUpdateMessage = exports.shouldShowAddMissingDetails = exports.wasMessageReceivedWhileOffline = exports.getReportActionsLength = exports.getActionableJoinRequestPendingReportAction = exports.getRemovedConnectionMessage = exports.getCardIssuedMessage = exports.isCardIssuedAction = exports.getRenamedAction = exports.getPolicyChangeLogEmployeeLeftMessage = exports.getPolicyChangeLogDeleteMemberMessage = exports.getPolicyChangeLogChangeRoleMessage = exports.getPolicyChangeLogAddEmployeeMessage = exports.didMessageMentionCurrentUser = exports.getUpdateRoomDescriptionMessage = exports.getExportIntegrationMessageHTML = exports.getExportIntegrationLastMessageText = exports.getExportIntegrationActionFragments = exports.isActionableAddPaymentCard = exports.isInviteOrRemovedAction = exports.wasActionTakenByCurrentUser = exports.shouldReportActionBeVisibleAsLastAction = exports.shouldReportActionBeVisible = void 0;
...
var environmentURL;
Environment_1.getEnvironmentURL().then(function (url) { return (environmentURL = url); });
/*
...
function getHtmlWithAttachmentID(html, reportActionID) {
    ...
    var attachmentID = 0;
    return html.replace(/<img |<video /g, function (m) { return m.concat(CONST_1["default"].ATTACHMENT_ID_ATTRIBUTE + "=\"" + reportActionID + "_" + ++attachmentID + "\" "); });
}
...
function isReversedTransaction(reportAction) {
    var _a, _b, _c, _d;
    return ((_b = (_a = getReportActionMessage(reportAction)) === null || _a === void 0 ? void 0 : _a.isReversedTransaction) !== null && _b !== void 0 ? _b : false) && ((_d = (_c = reportAction) === null || _c === void 0 ? void 0 : _c.childVisibleActionCount) !== null && _d !== void 0 ? _d : 0) > 0;
}
...
function isMemberChangeAction(reportAction) {
    return isActionOfType(reportAction, CONST_1["default"].REPORT.ACTIONS.TYPE.ROOM_CHANGE_LOG.INVITE_TO_ROOM, CONST_1["default"].REPORT.ACTIONS.TYPE.ROOM_CHANGE_LOG.REMOVE_FROM_ROOM, CONST_1["default"].REPORT.ACTIONS.TYPE.POLICY_CHANGE_LOG.INVITE_TO_ROOM, CONST_1["default"].REPORT.ACTIONS.TYPE.POLICY_CHANGE_LOG.REMOVE_FROM_ROOM, CONST_1["default"].REPORT.ACTIONS.TYPE.POLICY_CHANGE_LOG.LEAVE_POLICY);
}
...
function isInviteOrRemovedAction(reportAction) {
    return isActionOfType(reportAction, CONST_1["default"].REPORT.ACTIONS.TYPE.ROOM_CHANGE_LOG.INVITE_TO_ROOM, CONST_1["default"].REPORT.ACTIONS.TYPE.ROOM_CHANGE_LOG.REMOVE_FROM_ROOM, CONST_1["default"].REPORT.ACTIONS.TYPE.POLICY_CHANGE_LOG.INVITE_TO_ROOM, CONST_1["default"].REPORT.ACTIONS.TYPE.POLICY_CHANGE_LOG.REMOVE_FROM_ROOM);
}
...
function getCombinedReportActions(reportActions, transactionThreadReportID, transactionThreadReportActions, reportID, shouldFilterIOUAction) {
    if (shouldFilterIOUAction === void 0) { shouldFilterIOUAction = true; }
...
function extractLinksFromMessageHtml(reportAction) {
    ...
    return __spreadArrays(htmlContent.matchAll(regex)).map(function (match) { return match[1]; });
}
...
function getLastVisibleAction(reportID, canUserPerformWriteAction, actionsToMerge, reportActionsParam) {
    ...
    if (!isEmpty_1["default"](actionsToMerge)) {
        reportActions = Object.values(expensify_common_1.fastMerge((_a = reportActionsParam === null || reportActionsParam === void 0 ? void 0 : reportActionsParam["" + ONYXKEYS_1["default"].COLLECTION.REPORT_ACTIONS + reportID]) !== null && _a !== void 0 ? _a : {}, actionsToMerge !== null && actionsToMerge !== void 0 ? actionsToMerge : {}, true));
    }
    else {
        reportActions = Object.values((_b = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions["" + ONYXKEYS_1["default"].COLLECTION.REPORT_ACTIONS + reportID]) !== null && _b !== void 0 ? _b : {});
    }
...
function getLastClosedReportAction(reportActions) {
    ...
    if (!Object.values(reportActions !== null && reportActions !== void 0 ? reportActions : {}).some(function (action) { return action.actionName === CONST_1["default"].REPORT.ACTIONS.TYPE.CLOSED; })) {
        return undefined;
    }
    ...
    return findLast_1["default"](sortedReportActions, function (action) { return action.actionName === CONST_1["default"].REPORT.ACTIONS.TYPE.CLOSED; });
}
...
function getLinkedTransactionID(reportActionOrID, reportID) {
    var _a, _b;
    var reportAction = typeof reportActionOrID === 'string' ? (_a = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions["" + ONYXKEYS_1["default"].COLLECTION.REPORT_ACTIONS + reportID]) === null || _a === void 0 ? void 0 : _a[reportActionOrID] : reportActionOrID;
...
function getReportAction(reportID, reportActionID) {
    ...
    return (_a = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions["" + ONYXKEYS_1["default"].COLLECTION.REPORT_ACTIONS + reportID]) === null || _a === void 0 ? void 0 : _a[reportActionID];
}
...
function getReportPreviewAction(chatReportID, iouReportID) {
    ...
    return Object.values((_a = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions["" + ONYXKEYS_1["default"].COLLECTION.REPORT_ACTIONS + chatReportID]) !== null && _a !== void 0 ? _a : {}).find(function (reportAction) { var _a; return reportAction && isActionOfType(reportAction, CONST_1["default"].REPORT.ACTIONS.TYPE.REPORT_PREVIEW) && ((_a = getOriginalMessage(reportAction)) === null || _a === void 0 ? void 0 : _a.linkedReportID) === iouReportID; });
}
...
function getOneTransactionThreadReportID(reportID, reportActions, isOffline) {
    ...
    if ((((_a = originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.deleted) !== null && _a !== void 0 ? _a : '') !== '' || isDeletedAction(singleAction)) && isMoneyRequestAction(singleAction)) {
        return;
    }
...
function doesReportHaveVisibleActions(reportID, canUserPerformWriteAction, actionsToMerge) {
    var _a;
    if (actionsToMerge === void 0) { actionsToMerge = {}; }
    var reportActions = Object.values(expensify_common_1.fastMerge((_a = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions["" + ONYXKEYS_1["default"].COLLECTION.REPORT_ACTIONS + reportID]) !== null && _a !== void 0 ? _a : {}, actionsToMerge, true));
...
function getAllReportActions(reportID) {
    var _a;
    return (_a = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions["" + ONYXKEYS_1["default"].COLLECTION.REPORT_ACTIONS + reportID]) !== null && _a !== void 0 ? _a : {};
}
...
function getMemberChangeMessageElements(reportAction, getReportNameCallback) {
    ...
    var buildRoomElements = function () {
        var roomName = getReportNameCallback(allReports === null || allReports === void 0 ? void 0 : allReports["" + ONYXKEYS_1["default"].COLLECTION.REPORT + (originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.reportID)]) || (originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.roomName);
    ...
    ], Localize_1.formatMessageElementList(mentionElements), buildRoomElements());
}
...
function getReportActionMessageText(reportAction) {
    ...
    // Sometime html can be an empty string
    // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing
    return (_b = (_a = reportAction === null || reportAction === void 0 ? void 0 : reportAction.message) === null || _a === void 0 ? void 0 : _a.reduce(function (acc, curr) { return "" + acc + getTextFromHtml((curr === null || curr === void 0 ? void 0 : curr.html) || (curr === null || curr === void 0 ? void 0 : curr.text)); }, '')) !== null && _b !== void 0 ? _b : '';
}
...
function getTrackExpenseActionableWhisper(transactionID, chatReportID) {
    ...
    var chatReportActions = (_a = allReportActions === null || allReportActions === void 0 ? void 0 : allReportActions["" + ONYXKEYS_1["default"].COLLECTION.REPORT_ACTIONS + chatReportID]) !== null && _a !== void 0 ? _a : {};
...
function getExportIntegrationLastMessageText(reportAction) {
    ...
    return fragments.reduce(function (acc, fragment) { return acc + " " + fragment.text; }, '');
}
...
function getExportIntegrationMessageHTML(reportAction) {
    var fragments = getExportIntegrationActionFragments(reportAction);
    var htmlFragments = fragments.map(function (fragment) { return (fragment.url ? "<a href=\"" + fragment.url + "\">" + fragment.text + "</a>" : fragment.text); });
...
function getPolicyChangeLogAddEmployeeMessage(reportAction) {
    ...
    var role = Localize_1.translateLocal('workspace.common.roleName', { role: (_b = originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.role) !== null && _b !== void 0 ? _b : '' }).toLowerCase();
...
function getPolicyChangeLogChangeRoleMessage(reportAction) {
    ...
    var originalMessage = getOriginalMessage(reportAction);
    var email = (_a = originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.email) !== null && _a !== void 0 ? _a : '';
    var newRole = Localize_1.translateLocal('workspace.common.roleName', { role: typeof (originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.newValue) === 'string' ? originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.newValue : '' }).toLowerCase();
    var oldRole = Localize_1.translateLocal('workspace.common.roleName', { role: typeof (originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.oldValue) === 'string' ? originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.oldValue : '' }).toLowerCase();
...
function getPolicyChangeLogEmployeeLeftMessage(reportAction, useName) {
    ...
    var originalMessage = getOriginalMessage(reportAction);
    var personalDetails = (_a = PersonalDetailsUtils_1.getPersonalDetailsByIDs({ accountIDs: reportAction.actorAccountID ? [reportAction.actorAccountID] : [], currentUserAccountID: 0 })) === null || _a === void 0 ? void 0 : _a.at(0);
    ...
    var nameOrEmail = useName && !!(personalDetails === null || personalDetails === void 0 ? void 0 : personalDetails.firstName) ? (personalDetails === null || personalDetails === void 0 ? void 0 : personalDetails.firstName) + ":" : (_b = originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.email) !== null && _b !== void 0 ? _b : '';
...
function getWorkspaceDescriptionUpdatedMessage(action) {
    ...
    var message = typeof oldDescription === 'string' && newDescription ? Localize_1.translateLocal('workspaceActions.updateWorkspaceDescription', { newDescription: newDescription, oldDescription: oldDescription }) : getReportActionText(action);
    return message;
}
...
function getWorkspaceCurrencyUpdateMessage(action) {
    ...
    var message = oldCurrency && newCurrency ? Localize_1.translateLocal('workspaceActions.updatedWorkspaceCurrencyAction', { oldCurrency: oldCurrency, newCurrency: newCurrency }) : getReportActionText(action);
    return message;
}
...
function getWorkspaceCategoryUpdateMessage(action) {
    var _a;
    var _b = (_a = getOriginalMessage(action)) !== null && _a !== void 0 ? _a : {}, categoryName = _b.categoryName, oldValue = _b.oldValue, newName = _b.newName, oldName = _b.oldName;
...
function getWorkspaceReportFieldUpdateMessage(action) {
    var _a;
    var _b = (_a = getOriginalMessage(action)) !== null && _a !== void 0 ? _a : {}, updateType = _b.updateType, fieldName = _b.fieldName, defaultValue = _b.defaultValue;
...
function getDemotedFromWorkspaceMessage(reportAction) {
    var _a;
    var originalMessage = getOriginalMessage(reportAction);
    var policyName = (_a = originalMessage === null || originalMessage === void 0 ? void 0 : originalMessage.policyName) !== null && _a !== void 0 ? _a : Localize_1.translateLocal('workspace.common.workspace');
...
function isCardIssuedAction(reportAction) {
    return isActionOfType(reportAction, CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_ISSUED, CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_ISSUED_VIRTUAL, CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_MISSING_ADDRESS, CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_ASSIGNED);
}
...
function getCardIssuedMessage(_a) {
    ...
    var cardIssuedActionOriginalMessage = isActionOfType(reportAction, CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_ISSUED, CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_ISSUED_VIRTUAL, CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_ASSIGNED, CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_MISSING_ADDRESS)
    ...
    var navigateRoute = isPolicyAdmin ? ROUTES_1["default"].EXPENSIFY_CARD_DETAILS.getRoute(policyID, String(cardID)) : ROUTES_1["default"].SETTINGS_DOMAINCARD_DETAIL.getRoute(String(cardID));
    var expensifyCardLink = shouldRenderHTML && !!card ? "<a href='" + environmentURL + "/" + navigateRoute + "'>" + Localize_1.translateLocal('cardPage.expensifyCard') + "</a>" : Localize_1.translateLocal('cardPage.expensifyCard');
    ...
    switch (reportAction === null || reportAction === void 0 ? void 0 : reportAction.actionName) {
        ...
        case CONST_1["default"].REPORT.ACTIONS.TYPE.CARD_MISSING_ADDRESS:
            return Localize_1.translateLocal("workspace.expensifyCard." + (shouldShowAddMissingDetailsMessage ? 'issuedCardNoShippingDetails' : 'addedShippingDetails'), { assignee: assignee });
        default:
            return '';
    }
}
