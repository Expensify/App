...
type PopoverActionsContextType = {
    ...
    close: (anchorRef?: RefObject<React.ComponentRef<typeof View> | HTMLElement | React.ComponentRef<typeof Text> | null>) => void;
    setActivePopoverExtraAnchorRef: (ref?: RefObject<React.ComponentRef<typeof View> | HTMLDivElement | React.ComponentRef<typeof Text> | null>) => void;
};
...
function elementContains(ref: RefObject<React.ComponentRef<typeof View> | HTMLElement | React.ComponentRef<typeof Text> | null> | undefined, target: EventTarget | null) {
...
function PopoverContextProvider(props: PopoverContextProps) {
    ...
    const closePopover = useCallback((anchorRef?: RefObject<React.ComponentRef<typeof View> | HTMLElement | React.ComponentRef<typeof Text> | null>): boolean => {
    ...
    useEffect(() => {
        const listener = (e: Event) => {
            ...
            if (
                activePopoverExtraAnchorRefs?.some((ref: RefObject<React.ComponentRef<typeof View> | HTMLElement | React.ComponentRef<typeof Text> | null>) => elementContains(ref, e.target))
            ) {
                return;
            }
    ...
    const setActivePopoverExtraAnchorRef = useCallback((extraAnchorRef?: RefObject<React.ComponentRef<typeof View> | HTMLDivElement | React.ComponentRef<typeof Text> | null>) => {
        if (!extraAnchorRef) {
            return;
        }
