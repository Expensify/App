                ...
                <DropZoneWrapper onDrop={onAttachmentDrop}>
                    {({isDraggingOver}) => (
                        <DropZoneUI
                            ...
                            dashedBorderStyles={[styles.dropzoneArea, styles.activeDropzoneDashedBorder(theme.attachmentDropBorderColorActive, isDraggingOver)]}
                        />
                    )}
                </DropZoneWrapper>
                <DropZoneWrapper onDrop={onReceiptDrop}>
                    {({isDraggingOver}) => (
                        <DropZoneUI
                            ...
                            dashedBorderStyles={[styles.dropzoneArea, styles.activeDropzoneDashedBorder(theme.receiptDropBorderColorActive, isDraggingOver)]}
                        />
                    )}
                </DropZoneWrapper>
            </View>
