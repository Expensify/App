...
const defaultOnFormatAmount = useCallback((amount: number, currency?: string) => CurrencyUtils.convertToFrontendAmountAsString(amount, currency?? CONST.CURRENCY.USD), []);
