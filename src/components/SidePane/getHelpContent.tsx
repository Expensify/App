    ...
    r: {
        content: (styles: ThemeStyles) => (
            <>
                ...
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>React</Text> - Throw a ♥️😂🔥or anything you like on anything!
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                ...
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Markdown</Text> - Format text using <Text style={styles.textBold}>*bold*</Text>, <Text style={styles.textItalic}>_italics_</Text>, and
                    more.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Mention</Text> - Invite or tag anyone in the world to any chat by putting an @ in front of their email address or phone number (eg,
    ...
    search: {
        content: (styles: ThemeStyles) => (
            <>
                ...
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>All</Text> - Everything in every state.
                </Text>

                <Text style={[styles.textLarge, styles.mt5]}>Expenses/Expense Reports/Invoices</Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Draft</Text> - Only you can see that hasn't been shared yet.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Outstanding</Text> - Submitted to someone and awaiting action.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Approved</Text> - Approved, but awaiting payment.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Done</Text> - Fully processed, no further action needed.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Paid</Text> - Fully paid, no further action needed.
                </Text>

                <Text style={[styles.textLarge, styles.mt5]}>Chats</Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Unread</Text> - Not seen yet by you.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Sent</Text> - Sent by you.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Attachments</Text> - Image, movie, or document.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Links</Text> - Hyperlinks.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Pinned</Text> - Highlighted by you as important.
                </Text>

                <Text style={[styles.textLarge, styles.mt5]}>Trips</Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Current</Text> - Happening or in the future.
                </Text>
                <Text style={[styles.textNormal, styles.mt2]}>
                    • <Text style={styles.textBold}>Past</Text> - Already happened.
                </Text>
                ...
                <Text style={[styles.textNormal, styles.mt2]}>• Select a row to see additional options.</Text>
                <Text style={[styles.textNormal, styles.mt2]}>• Tap on a row to see more detail.</Text>
            </>
        ),
    },
    settings: {
        ...
        children: {
            workspaces: {
                content: (styles: ThemeStyles) => (
                    <>
                        <Text style={[styles.textHeadlineH1, styles.mv4]}>Settings &gt; Workspaces</Text>
                        ...
                        <Text style={[styles.textNormal, styles.mt2]}>• … and lots more!</Text>
