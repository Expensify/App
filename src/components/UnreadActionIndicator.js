...
const UnreadActionIndicator = props => (
    <View accessibilityLabel={props.translate('accessibilityLabel.newMessageLineIndicator')} data-action-id={props.reportActionID} style={styles.unreadIndicatorContainer}>
