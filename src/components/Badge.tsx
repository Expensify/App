...
function Badge({
    ...
    // Determine icon size: condensed = 8px, regular = 12px (unless overridden by shouldUseXXSmallIcon)
    ...
    const wrapperStyles: (state: PressableStateCallbackType) => StyleProp<ViewStyle> = useCallback(
        ...
        [styles.defaultBadge, styles.condensedBadge, styles.condensedBadgeWithIcon, styles.alignSelfCenter, styles.ml2, StyleUtils, success, error, environment, badgeStyles, isCondensed, isStrong, icon],
    );
