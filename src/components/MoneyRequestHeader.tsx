    ...
    return (
        <View style={[styles.pl0, styles.borderBottom]}>
            ...
            >
                ...
                {shouldDisplayTransactionNavigation && !!transaction && <MoneyRequestReportTransactionsNavigation currentTransactionID={transaction.transactionID} isFromReviewDuplicates={isFromReviewDuplicates}/>}
            </HeaderWithBackButton>
            {!shouldDisplayNarrowMoreButton && (
