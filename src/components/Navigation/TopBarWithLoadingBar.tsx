 ...
 */
function TopBarWithLoadingBar({breadcrumbLabel, shouldDisplaySearch, shouldDisplayHelpButton, shouldDisplayAccountButton, cancelSearch, children}: TopBarWithLoadingBarProps) {
