 ...
 */
function TopBarWithLoadingBar({breadcrumbLabel, shouldDisplaySearch, shouldDisplayHelpButton, cancelSearch, children, breadcrumbAnimatedStyle}: TopBarWithLoadingBarProps) {
