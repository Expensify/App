...
function InboxNavigationTabBar({selectedTab, isTopLevelBar = false, shouldShowFloatingButtons = true}: NavigationTabBarProps) {
...
export default memo(InboxNavigationTabBar);
