...
const CHART_FONT_MANAGER_FAMILIES: Record<string, DataModule[]> = {
    ExpensifyNeue: [EXPENSIFY_NEUE_REGULAR, EXPENSIFY_NEUE_BOLD, EXPENSIFY_NEUE_ITALIC, EXPENSIFY_NEUE_BOLD_ITALIC],
    ExpensifyMono: [EXPENSIFY_MONO_REGULAR, EXPENSIFY_MONO_BOLD, EXPENSIFY_MONO_ITALIC, EXPENSIFY_MONO_BOLD_ITALIC],
    ExpensifyNewKansas: [EXPENSIFY_NEW_KANSAS_MEDIUM, EXPENSIFY_NEW_KANSAS_MEDIUM_ITALIC],
    NotoSansSymbols: [SANS_SYMBOLS_FONT],
    NotoSansSCMonths: [SANS_SC_MONTHS_FONT],
};

export {CHART_FONT_MANAGER_FAMILIES, CHART_SKIA_TYPEFACE_ASSETS};
