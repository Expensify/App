...
function LeftFrameLine({chartBounds, yTicks, yScale, color}: LeftFrameLineProps) {
    ...
    // victory-native's nice() and ticks() use different step sizes (nice uses count=10, ticks
    // uses our configured tick count), causing the domain minimum to land below the first tick.
