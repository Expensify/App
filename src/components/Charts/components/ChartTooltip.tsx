...
function clampRightPlacementTooltipLeft(
  anchorX: number,
  chartWidth: number,
  tooltipWidth: number,
): number {
...
function ChartTooltip({
  ...
  useLayoutEffect(() => {
    tooltipWrapperRef.current?.measure(
  ...
  const pointerStyle = useAnimatedStyle(() => {
    ...
    if (placement === "right") {
      ...
      const relativeOffset =
        x - clampedLeft - VictoryTheme.tooltip.pointerWidth;
  ...
  return (
    ...
    >
      <View
        style={[
          styles.chartTooltipWrapper,
          placement === "right" && styles.chartTooltipWrapperRight,
        ]}
      >
        {placement === "right" && (
          <Animated.View
