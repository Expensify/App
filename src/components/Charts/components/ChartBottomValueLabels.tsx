...
type ChartBottomValueLabelsProps = {
    /** Tick values on the X axis. */
    xTicks: number[];

    /** Maps a tick value to its x-pixel position on the chart. */
    xScale: Scale;
...
function ChartBottomValueLabels({xTicks, xScale, chartBoundsBottom, fontSize, fontMgr, labelColor, formatValue}: ChartBottomValueLabelsProps) {
...
export default ChartBottomValueLabels;
