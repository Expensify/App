...
import type {ChartDataPoint, ChartTooltipPlacement} from '@components/Charts/types';
 ...
 */
function ChartTooltipLayer({matchedIndex, isTooltipActive, data, formatValue, chartWidth, initialTooltipPosition, placement}: ChartTooltipLayerProps) {
