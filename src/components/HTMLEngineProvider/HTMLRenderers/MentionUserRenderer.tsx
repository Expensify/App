                ...
                >
                    ...
                    >
                        <Text
                            ...
                            style={[styles.link, styleWithoutColor, StyleUtils.getMentionStyle(isOurMention), {color: StyleUtils.getMentionTextColor(isOurMention)}, styles.breakWord, styles.textWrap]}
                            role={CONST.ROLE.LINK}
                            testID="mention-user"
