...
function BaseSelectionList<TItem extends ListItem>(
    ...
    const paddingBottomStyle = useMemo(() => (!isKeyboardShown || !!footerContent) && safeAreaPaddingBottomStyle, [footerContent, isKeyboardShown, safeAreaPaddingBottomStyle]);
            ...
            {flattenedSections.allOptions.length === 0 && (showLoadingPlaceholder || shouldShowListEmptyContent) ? (
                ...
                <>
                    ...
                    <SectionList
                        ...
                        addOfflineIndicatorBottomSafeAreaPadding={!shouldHideContentBottomSafeAreaPadding}
