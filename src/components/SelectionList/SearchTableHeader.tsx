...
const shouldShowColumnConfig: Record<SortableColumnName, ShouldShowSearchColumnFn> = {
    ...
    [CONST.SEARCH.TABLE_COLUMNS.DESCRIPTION]: (_, metadata) => metadata?.columnsToShow?.shouldShowDescriptionColumn ?? false,
    [CONST.SEARCH.TABLE_COLUMNS.FROM]: (_, metadata) => metadata?.columnsToShow?.shouldShowFromColumn ?? false,
    [CONST.SEARCH.TABLE_COLUMNS.TO]: (_, metadata) => metadata?.columnsToShow?.shouldShowToColumn ?? false,
    [CONST.SEARCH.TABLE_COLUMNS.CATEGORY]: (_, metadata) => metadata?.columnsToShow?.shouldShowCategoryColumn ?? false,
    [CONST.SEARCH.TABLE_COLUMNS.TAG]: (_, metadata) => metadata?.columnsToShow?.shouldShowTagColumn ?? false,
    [CONST.SEARCH.TABLE_COLUMNS.TAX_AMOUNT]: (_, metadata) => metadata?.columnsToShow?.shouldShowTaxColumn ?? false,
