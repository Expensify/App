...
function DistanceRateListItem<TItem extends ListItem>({
    item,
    isFocused,
    showTooltip,
    isDisabled,
                    ...
                    <>
                        ...
                        {shouldSplitAccessibilityForAppleVoiceOver ? (
                            <PressableWithFeedback
                                ...
                                hoverDimmingValue={1}
                                pressDimmingValue={1}
                                sentryLabel="DistanceRateListItemSummary"
...
DistanceRateListItem.displayName = 'DistanceRateListItem';

export default DistanceRateListItem;
