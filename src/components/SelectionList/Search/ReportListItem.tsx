...
// function reportHeder()=>{
//     return <Text>COKOLWIEK</Text>
// }
...
function ReportListItem<TItem extends ListItem>({
    ...
    console.log('duuupa duuupa dupa');
    console.log(reportItem.transactions.length);
