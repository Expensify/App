...
import type {ListItem, TransactionGroupListItemType} from '@components/SelectionList/types';
...
type ReportListItemHeaderProps<TItem extends ListItem> = {
    ...
    report: TransactionGroupListItemType;
...
type ReportCellProps = {
    ...
    reportItem: TransactionGroupListItemType;
};
