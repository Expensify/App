...
type SingleSearchStatus = ExpenseSearchStatus | InvoiceSearchStatus | TripSearchStatus | ChatSearchStatus;
type SearchStatus = SingleSearchStatus | SingleSearchStatus[];
