...
function Search({queryJSON, searchResults, onSearchListScroll, contentContainerStyle, handleSearch, isMobileSelectionModeEnabled}: SearchProps) {
    ...
    const data = useMemo(() => {
        ...
        return getSections(type, searchResults.data, searchResults.search, countryCodeByIP, groupBy, exportReportActions, currentSearchKey);
    }, [currentSearchKey, exportReportActions, groupBy, isDataLoaded, searchResults, type, countryCodeByIP]);
