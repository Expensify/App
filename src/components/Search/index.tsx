...
import {selectArchivedReportsIdSet, selectFilteredReportActions, canEditFieldOfMoneyRequest} from '@libs/ReportUtils';
...
function Search({queryJSON, searchResults, onSearchListScroll, contentContainerStyle, handleSearch, isMobileSelectionModeEnabled}: SearchProps) {
    ...
    useEffect(() => {
        ...
        const results = searchResults
            ...
            : [];
        handleSearch({queryJSON, searchKey, offset, shouldCalculateTotals, prevReportsLength: results.length});
