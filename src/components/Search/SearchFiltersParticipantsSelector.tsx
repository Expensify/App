...
function SearchFiltersParticipantsSelector({initialAccountIDs, onFiltersUpdate, shouldAllowNameOnlyOptions = false}: SearchFiltersParticipantsSelectorProps) {
    ...
    const chatOptions = useMemo(() => {
        const filteredOptions = filterAndOrderOptions(unselectedOptions, cleanSearchTerm, translate, countryCode, loginList, {
            selectedOptions,
            excludeLogins: CONST.EXPENSIFY_EMAILS_OBJECT,
    ...
    }, [unselectedOptions, cleanSearchTerm, translate, countryCode, loginList, selectedOptions, shouldAllowNameOnlyOptions]);
