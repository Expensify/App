 ...
 */
function getExpenseReportRowDisplayValues(item: ExpenseReportRowDisplayItem, {translate, convertToDisplayString, preferredLocale}: ExpenseReportRowDisplayValuesDeps) {
