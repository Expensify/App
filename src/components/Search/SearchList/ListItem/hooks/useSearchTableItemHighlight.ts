...
function useSearchTableItemHighlight({shouldHighlight = false, isSelected = false, isLastItem = false}: UseSearchTableItemHighlightParams = {}) {
    ...
    return {
        ...
        pressableWrapperStyle: [isLargeScreenWidth ? styles.mh5 : styles.mh4, animatedHighlightStyle, isLargeScreenWidth && isLastItem && [styles.tableBottomRadius, styles.overflowHidden]],
    };
}
