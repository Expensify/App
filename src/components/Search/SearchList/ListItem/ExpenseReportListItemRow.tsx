                        ...
                        <View style={[styles.flexRow, styles.alignItemsCenter, styles.mnh40, styles.flex1, styles.gap3]}>
                            {!!canSelectMultiple && (
                                <Checkbox
                                    ...
                                    containerStyle={[StyleUtils.getMultiselectListStyles(!!item.isSelected, !!item.isDisabled), styles.m0]}
                                    disabled={isDisabledCheckbox}
                                    accessibilityLabel={item.text ?? ''}
                                    shouldStopMouseDownPropagation
                                    style={[styles.cursorUnset, StyleUtils.getSelectionButtonPressableStyle(), isDisabledCheckbox && styles.cursorDisabled]}
