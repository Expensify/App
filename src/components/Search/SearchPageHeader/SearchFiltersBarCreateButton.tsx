                ...
                onSelected: () =>
                    interceptAnonymousUser(() => {
                        ...
                        if (
                            ...
                            (shouldRestrictUserBillableActions(workspaceIDForReportCreation, userBillingGraceEndPeriods, undefined, ownerBillingGraceEndPeriod) && groupPoliciesWithChatEnabled.length > 1)
                        ) {
