 ...
 */
function CollapsibleHeaderOnKeyboard({children, collapsibleHeaderOffset = 0, alwaysCollapseHeaderOnKeyboard = false, minHeaderHeightOnCollapse = 0}: CollapsibleHeaderOnKeyboardProps) {
    ...
    useAnimatedReaction(
        ...
        ({keyboardHeight, keyboardProgress, windowHeightValue}, previous) => {
            ...
            const targetHeight = alwaysCollapseHeaderOnKeyboard
                ? minHeaderHeightOnCollapse
                : Math.max(minHeaderHeightOnCollapse, keyboardTop - VERTICAL_SPACE_FOR_FOCUSED_INPUT - collapsibleHeaderOffsetSV.get());
            const naturalHeightValue = naturalHeight.get();
