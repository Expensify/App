...
function MoneyRequestReportTransactionList({
    ...
    const addExpenseDropdownOptions = useMemo(
        () => getAddExpenseDropdownOptions(expensifyIcons, report?.reportID, policy, undefined, undefined, lastDistanceExpenseType, ownerBillingGraceEndPeriod),
        [report?.reportID, policy, lastDistanceExpenseType, expensifyIcons.Location, ownerBillingGraceEndPeriod],
    );
