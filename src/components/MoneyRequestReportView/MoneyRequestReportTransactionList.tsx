...
function MoneyRequestReportTransactionList({
    ...
    const addExpenseDropdownOptions = useMemo(
        () => getAddExpenseDropdownOptions(expensifyIcons, report?.reportID, policy, undefined, undefined, lastDistanceExpenseType, allTransactionDrafts),
        [report?.reportID, policy, lastDistanceExpenseType, expensifyIcons.Location, allTransactionDrafts],
    );
