...
type MoneyRequestReportTransactionItemBodyProps =
...
function MoneyRequestReportTransactionItemBody({
  ...
  const wasEditingOnMouseDownRef =
    inlineEdit?.wasEditingOnMouseDownRef ?? fallbackEditingOnMouseDownRef;
  ...
  return (
    ...
    >
      <PressableWithFeedback
        ...
        sentryLabel={
          CONST.SENTRY_LABEL.REPORT.MONEY_REQUEST_REPORT_TRANSACTION_ITEM
        }
        ...
        onPressIn={() => {
          wasEditingOnMouseDownRef.current =
            wasEditingOnMouseDownRef.current || isEditingCell;
        ...
        wrapperStyle={[
          ...
          shouldUseNarrowLayout &&
            !isLastItem &&
            StyleUtils.getSelectedBorderBottomStyle(isSelected),
        ]}
      >
        {({ hovered }) => (
          <TransactionItemRow
            ...
            onArrowRightPress={() =>
              onArrowRightPress?.(transaction.transactionID)
            }
            isHover={hovered}
...
function MoneyRequestReportTransactionItemWithInlineEdit(
  props: Omit<MoneyRequestReportTransactionItemBodyProps, "inlineEdit">,
) {
  ...
  return (
    <MoneyRequestReportTransactionItemBody {...props} inlineEdit={inlineEdit} />
  );
}

function MoneyRequestReportTransactionItem(
  props: MoneyRequestReportTransactionItemProps,
) {
  ...
  const isNarrowLayout =
    shouldUseNarrowLayout ||
    (isMediumScreenWidth && !props.shouldScrollHorizontally);
