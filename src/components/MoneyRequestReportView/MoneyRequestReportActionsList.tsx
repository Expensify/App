...
import useReportVerticalScrollTracking from '@pages/home/report/useReportVerticalScrollTracking';
...
function MoneyRequestReportActionsList({report, policy, reportActions = [], transactions = [], hasNewerActions, hasOlderActions}: MoneyRequestReportListProps) {
    ...
    const {isFloatingMessageCounterVisible, setIsFloatingMessageCounterVisible, trackVerticalScrolling} = useReportVerticalScrollTracking({
        reportID: report.reportID,
        currentVerticalScrollingOffset: scrollingVerticalBottomOffset,
