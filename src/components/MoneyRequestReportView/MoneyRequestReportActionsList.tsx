...
function MoneyRequestReportActionsList({onLayout, composerHeight = 0}: MoneyRequestReportListProps) {
    ...
    const currentVerticalScrollingOffset = useDerivedValue(() => contentSizeHeight.get() - layoutMeasurementHeight.get() - scrollY.get());
    ...
    const listRef = useActionListRef<UnifiedListItem>();
    ...
    const trackVerticalScrolling = useCallback(
        ...
        [reportID, reportLoadingState?.hasOnceLoadedReportActions, scrollOffsetRef],
    );
    ...
    useScrollToEndOnNewMessageReceived({
        ...
        scrollingVerticalOffsetRef: scrollOffsetRef,
