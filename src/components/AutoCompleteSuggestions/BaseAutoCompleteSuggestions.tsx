...
import type {AutoCompleteSuggestionsProps, Suggestion} from './types';
...
type GetItemLayout = FlatListProps<Suggestion>['getItemLayout'];
...
function BaseAutoCompleteSuggestions(
    {highlightedSuggestionIndex, onSelect, accessibilityLabelExtractor, renderSuggestionMenuItem, suggestions, isSuggestionPickerLarge, keyExtractor}: AutoCompleteSuggestionsProps,
     ...
     */
    const getItemLayout: GetItemLayout = (data, index) => ({
