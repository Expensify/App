        ...
        [CONST.REPORT.PRIMARY_ACTIONS.SUBMIT]: (
            <AnimatedSubmitButton
                ...
                onPress={() => {
                    ...
                    submitReport(moneyRequestReport, policy, accountID, email ?? '', hasViolations, isASAPSubmitBetaEnabled, nextStep, userBillingGraceEndPeriods, startSubmittingAnimation);
                    if (currentSearchQueryJSON && !isOffline) {
                        search({
                            searchKey: currentSearchKey,
                            shouldCalculateTotals,
