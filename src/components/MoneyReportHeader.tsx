...
function MoneyReportHeader({
    ...
    const addExpenseDropdownOptions = useMemo(
        () => getAddExpenseDropdownOptions(expensifyIcons, moneyRequestReport?.reportID, policy, undefined, undefined, lastDistanceExpenseType, allTransactionDrafts),
        [moneyRequestReport?.reportID, policy, lastDistanceExpenseType, expensifyIcons, allTransactionDrafts],
    );
