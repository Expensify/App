...
function MoneyReportHeader({
    ...
    const confirmPayment = useCallback(
        (type?: PaymentMethodType | undefined, payAsBusiness?: boolean, methodID?: number, paymentMethod?: PaymentMethod) => {
            ...
            if (isDelegateAccessRestricted) {
                ...
                startAnimation();
                payMoneyRequest(type, chatReport, moneyRequestReport, introSelected, allBetas, undefined, true, activePolicy, policy);
    ...
    const duplicateExpenseTransaction = useCallback(
        ...
        [activePolicyExpenseChat, allPolicyCategories, defaultExpensePolicy, isASAPSubmitBetaEnabled, quickAction, policyRecentlyUsedCurrencies, allBetas],
    );
