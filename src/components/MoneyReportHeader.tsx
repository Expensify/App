...
function MoneyReportHeader({
    ...
    const {selectedTransactionIDs, currentSearchQueryJSON, currentSearchKey, currentSearchHash, currentSearchResults} = state;
    const {removeTransaction, clearSelectedTransactions} = actions;
