...
import {useSearchActionsContext, useSearchResultsContext, useSearchStateContext} from './Search/SearchContext';
...
function MoneyReportHeader({
    ...
    const {selectedTransactionIDs, currentSearchQueryJSON, currentSearchKey, currentSearchHash} = useSearchStateContext();
