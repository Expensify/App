...
const useProductTrainingContext = (tooltipName: ProductTrainingTooltipName, shouldShow = true) => {
    ...
    }, [styles.alignItemsCenter, styles.flex1, styles.flexRow, styles.flexWrap, styles.gap3, styles.justifyContentBetween, styles.justifyContentCenter, styles.mw100, styles.p2, styles.pb2, styles.ph1, styles.productTrainingTooltipText, styles.pt1, styles.textAlignCenter, styles.textBold, styles.textWrap, theme.tooltipHighlightText, tooltipName, translate]);
