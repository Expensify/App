...
const TOOLTIPS: Record<ProductTrainingTooltipName, TooltipData> = {
    ...
    [SCAN_TEST_TOOLTIP_MANAGER]: {
        ...
        onHideTooltip: (isDismissedUsingX = false) => dismissProductTraining(SCAN_TEST_TOOLTIP_MANAGER, isDismissedUsingX),
    ...
    [SCAN_TEST_CONFIRMATION]: {
        ...
        onHideTooltip: (isDismissedUsingX = false) => dismissProductTraining(SCAN_TEST_CONFIRMATION, isDismissedUsingX),
