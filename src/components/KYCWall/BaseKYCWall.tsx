            ...
            if (paymentMethod === CONST.PAYMENT_METHODS.PERSONAL_BANK_ACCOUNT) {
                ...
                if (iouReport && isIOUReport(iouReport)) {
                    ...
                    const {policyID, workspaceChatReportID, reportPreviewReportActionID, adminsChatReportID} =
                        createWorkspaceFromIOUPayment(iouReport, reportPreviewAction, currentUserEmail, employeeEmail, conciergeReportID, localCurrency, lastWorkspaceNumber, translate) ??
                        {};
