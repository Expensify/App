        ...
        (paymentMethod?: PaymentMethod, policy?: Policy) => {
            ...
            if (paymentMethod === CONST.PAYMENT_METHODS.PERSONAL_BANK_ACCOUNT) {
                ...
                if (iouReport && isIOUReport(iouReport)) {
                    ...
                    if (adminPolicy) {
                        const inviteResult = moveIOUReportToPolicyAndInviteSubmitter(iouReport?.reportID, adminPolicy, formatPhoneNumber, reportTransactions);
                        if (inviteResult?.policyExpenseChatReportID) {
                            ...
                            const moveResult = moveIOUReportToPolicy(iouReport?.reportID, adminPolicy, true, reportTransactions);
