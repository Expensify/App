...
function IllustratedHeaderPageLayout({backgroundColor, children, illustration, footer, overlayContent, shouldShowOfflineIndicatorInWideScreen, ...propsToPassToHeader}) {
