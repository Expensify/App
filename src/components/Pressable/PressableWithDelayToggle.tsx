...
function PressableWithDelayToggle({
    ...
    const effectiveIconChecked = iconChecked ?? icons.Checkmark;
    ...
    const shouldShowIcon = !!icon || (!isActive && !!effectiveIconChecked);
    const labelText =
    ...
    const shouldShowText = !(effectiveIconChecked && !icon && !isActive);
                    ...
                    >
                        {({hovered, pressed}) => (
                            <>
                                ...
                                {shouldShowIcon && (
                                    <Icon
                                        src={!isActive ? effectiveIconChecked : (icon ?? effectiveIconChecked)}
