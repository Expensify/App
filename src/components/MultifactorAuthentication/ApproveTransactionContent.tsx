...
type MultifactorAuthenticationApproveTransactionContentProps = {
    transactionID: string;
};

function MultifactorAuthenticationApproveTransactionContent({transactionID}: MultifactorAuthenticationApproveTransactionContentProps) {
