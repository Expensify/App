...
type MultifactorAuthenticationFactorAuthenticatorFormProps = {
...
function MultifactorAuthenticationFactorAuthenticatorForm({
    twoFactorAuthCode,
    formError,
    inputRef,
...
}: MultifactorAuthenticationFactorAuthenticatorFormProps) {
...
MultifactorAuthenticationFactorAuthenticatorForm.displayName = 'MultifactorAuthenticationFactorAuthenticatorForm';

export default memo(MultifactorAuthenticationFactorAuthenticatorForm);
