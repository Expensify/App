...
/**
 * Determines if biometric authentication method is allowed for a given authentication type.
 * @param allowedAuthentication - The authentication type configuration to check.
...
/**
 * Converts a notification path to a navigation route.
 * Returns a notification route if path exists, otherwise returns the not found route.
 * @param path - The notification path (e.g., 'biometrics-test-success').
 * @returns The navigation route for the notification or not found page.
 */
