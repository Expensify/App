...
function BaseModal({
    ...
    const backdropOpacityAdjusted =
        !shouldForceBackdrop && (hideBackdrop || shouldSuppressRightDockedBackdrop || isFullWidthNarrowSheet) // right_docked modals & full-width narrow sheets shouldn't add backdrops when opened in same-width RHP
            ? 0
            : backdropOpacity;
