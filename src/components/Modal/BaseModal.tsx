...
function BaseModal(
    ...
    const sidePanelStyle = !shouldUseReanimatedModal && !shouldUseReanimatedModal && shouldApplySidePanelOffset && !isSmallScreenWidth ? {paddingRight: sidePanelOffset.current} : undefined;
