...
function HoldMenuModalWrapper({
    ...
    return (
        <DecisionModal
            ...
            // Callers pass `undefined` when the non-held amount isn't meaningfully different from the full amount,
            // so gate on the amount itself rather than on `hasNonHeldExpenses` — otherwise a report whose unheld
            // expenses net out to nothing offers a partial option for a zero amount.
