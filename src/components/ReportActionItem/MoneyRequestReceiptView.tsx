...
function MoneyRequestReceiptView({allReports, report, readonly = false, updatedTransaction, isFromReviewDuplicates = false, fillSpace = false}: MoneyRequestReceiptViewProps) {
