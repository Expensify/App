...
function ReportPreview(props) {
    ...
    return (
        <OfflineWithFeedback pendingAction={lodashGet(props, 'iouReport.pendingFields.preview')} shouldDisableOpacity={props.action.pendingAction || props.action.isOptimisticAction}>
