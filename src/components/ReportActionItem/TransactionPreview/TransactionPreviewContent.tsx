...
function TransactionPreviewContent({
    ...
    const previewSupportingText = [previewText.previewDateText, shouldShowCategory && category ? {text: getDecodedFullCategoryName(category)} : undefined, ...previewText.previewStatusText]
