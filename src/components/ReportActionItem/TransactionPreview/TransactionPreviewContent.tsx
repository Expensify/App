...
function TransactionPreviewContent({
    ...
    const iouData = getIOUData(managerID, ownerAccountID, isIOUReport(iouReport) || reportPreviewAction?.childType === CONST.REPORT.TYPE.IOU, personalDetails, transaction?.amount ?? 0);
