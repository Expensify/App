...
function MoneyRequestView({
    ...
    } = useMemo<Partial<TransactionDetails>>(() => getTransactionDetails(transaction, CONST.DATE.FNS_FORMAT_STRING, undefined, preferredLocale) ?? {}, [preferredLocale, transaction]);
