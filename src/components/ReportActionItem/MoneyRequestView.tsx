...
function MoneyRequestView({
    ...
    const formattedTaxAmount =
        updatedTransaction?.taxAmount !== undefined
            ? convertToDisplayString(Math.abs(updatedTransaction?.taxAmount), actualCurrency, false, currencyList)
            : convertToDisplayString(Math.abs(transactionTaxAmount ?? 0), actualCurrency, false, currencyList);
