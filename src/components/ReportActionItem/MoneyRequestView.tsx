...
function MoneyRequestView({
    ...
    } = useMemo<Partial<TransactionDetails>>(() => getTransactionDetails(transaction, undefined, undefined, undefined, allowNegativeAmount, preferredLocale) ?? {}, [allowNegativeAmount, preferredLocale, transaction]);
