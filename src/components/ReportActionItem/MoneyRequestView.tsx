...
function MoneyRequestView({
    ...
    const distanceOriginalPolicy = useDistanceRateOriginalPolicy(isDistanceRequestTransactionUtils(transaction) ? transaction?.comment?.customUnit?.customUnitRateID : undefined);
