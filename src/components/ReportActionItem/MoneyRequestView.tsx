...
function MoneyRequestView({
    ...
    } = useMemo<Partial<TransactionDetails>>(() => getTransactionDetails(transaction, undefined, undefined, allowNegativeAmount, preferredLocale) ?? {}, [allowNegativeAmount, preferredLocale, transaction]);
