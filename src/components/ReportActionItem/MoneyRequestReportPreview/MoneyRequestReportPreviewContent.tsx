...
function MoneyRequestReportPreviewContent({
    ...
    const reportStatus = useMemo(() => getReportStatusTranslation(iouReport?.stateNum ?? action?.childStateNum, iouReport?.statusNum ?? action?.childStatusNum), [action?.childStateNum, action?.childStatusNum, iouReport?.stateNum, iouReport?.statusNum]);
