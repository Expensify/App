        ...
        (type: PaymentMethodType | undefined, payAsBusiness?: boolean) => {
            ...
            if (isDelegateAccessRestricted) {
                ...
                if (isInvoiceReportUtils(iouReport)) {
                    payInvoice(type, chatReport, chatReportRNVP, iouReport, introSelected, payAsBusiness, existingB2BInvoiceReport);
                } else {
                    payMoneyRequest(type, chatReport, chatReportRNVP, iouReport, introSelected);
                }
            }
        },
        [isDelegateAccessRestricted, iouReport, chatReport, showDelegateNoAccessModal, startAnimation, chatReportRNVP, introSelected, existingB2BInvoiceReport],
    );
