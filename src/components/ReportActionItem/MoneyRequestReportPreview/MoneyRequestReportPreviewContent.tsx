...
function MoneyRequestReportPreviewContent({
    ...
    const reportPreviewAction = useMemo(() => {
        ...
        return getReportPreviewAction(violations, iouReport, policy, transactions, isIouReportArchived || isChatReportArchived, reportActions, invoiceReceiverPolicy, isChatReportArchived);
