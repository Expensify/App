...
function MoneyRequestAction({
    ...
    const onMoneyRequestPreviewPressed = () => {
        ...
        if (!action?.childReportID && transactionID && action.reportActionID) {
            ...
            Navigation.navigate(ROUTES.REPORT_WITH_ID.getRoute(optimisticReportID, undefined, undefined, action.reportActionID, transactionID, undefined, requestReportID));
            return;
        }
