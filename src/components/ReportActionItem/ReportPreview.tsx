                ...
                <PressableWithoutFeedback
                    onPress={() => {
                        if (numberOfRequests === 1) {
                            ...
                            const moneyRequestReportID = ReportUtils.getOneExpenseMoneyRequestReportID(iouReportID) ?? iouReportID;
                            Navigation.navigate(ROUTES.REPORT_WITH_ID.getRoute(moneyRequestReportID ?? iouReportID));
                        } else {
