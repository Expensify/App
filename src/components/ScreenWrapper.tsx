...
type ScreenWrapperStatusContextType = {didScreenTransitionEnd: boolean; isSafeAreaTopPaddingApplied: boolean; isSafeAreaBottomPaddingApplied: boolean};
...
function ScreenWrapper(
    ...
    const {insets, paddingTop, paddingBottom, safeAreaPaddingBottomStyle} = useSafeAreaUtils();
