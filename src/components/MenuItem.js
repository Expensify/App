...
const MenuItem = (props) => {
    ...
    const descriptionTextStyle = StyleUtils.combineStyles([styles.textLabelSupporting, props.icon ? styles.ml3 : undefined, styles.breakAll, styles.lineHeightNormal], props.style);
                        ...
                        {props.icon && (
                            <View style={[styles.popoverMenuIcon, ...props.iconStyles]}>
                                ...
                                {props.iconType === CONST.ICON_TYPE_AVATAR && (
                                    <Avatar imageStyles={[styles.avatarNormal, styles.alignSelfCenter]} source={props.icon} fallbackIcon={props.fallbackIcon} />
                                )}
                            </View>
                        )}
