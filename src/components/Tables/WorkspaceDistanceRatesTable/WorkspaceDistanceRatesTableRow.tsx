...
function formatDate(dateString: string | null | undefined, preferredLocale: Locale): string {
    if (!dateString) {
        return '';
    }
...
function WorkspaceDistanceRatesTableRow({item, rowIndex, shouldUseNarrowTableLayout, shouldShowDateColumns, statusLabels}: WorkspaceDistanceRatesTableRowProps) {
    ...
    const dateLabelText = DistanceRequestUtils.getRateDateLabel({...rate, unit: CONST.CUSTOM_UNITS.DISTANCE_UNIT_MILES}, translate, preferredLocale);
                    ...
                    {!shouldUseNarrowTableLayout && shouldShowDateColumns && (
                        ...
                        >
                            <TextWithTooltip
                                shouldShowTooltip
                                numberOfLines={1}
                                text={formatDate(rate.startDate, preferredLocale)}
                                style={[styles.lh16, styles.optionDisplayName, styles.pre]}
                            />
                        </View>
                    )}
                    ...
                    {!shouldUseNarrowTableLayout && shouldShowDateColumns && (
                        ...
                        >
                            <TextWithTooltip
                                shouldShowTooltip
                                numberOfLines={1}
                                text={formatDate(rate.endDate, preferredLocale)}
                                style={[styles.lh16, styles.optionDisplayName, styles.pre]}
                            />
                        </View>
                    )}
