...
export default function WorkspaceTaxesTable({
  taxes,
  selectionEnabled,
  selectedKeys,
  onRowSelectionChange,
}: WorkspaceTaxesTableProps) {
  ...
  const compareItems: CompareItemsCallback<
    WorkspaceTaxTableRowData,
    WorkspaceTaxTableColumnKey
  ...
  const isItemInSearch: IsItemInSearchCallback<WorkspaceTaxTableRowData> = (
    item,
    searchValue,
  ) => {
  ...
  const renderTaxItem = ({
    item,
    index,
  }: ListRenderItemInfo<WorkspaceTaxTableRowData>) => (
