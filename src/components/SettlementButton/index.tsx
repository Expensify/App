...
function SettlementButton({
    ...
    const lastPaymentMethodIsInitialized = lastPaymentMethod !== '-1';
    ...
    const paymentButtonOptions = useMemo(() => {
        ...
        // We don't want to reorder the options when the preferred payment method changes while the button is still visible except for component initialization when	the last payment method is not set yet.
        // We need to be sure that onPress should be wrapped in an useCallback to prevent unnecessary updates
        // eslint-disable-next-line react-compiler/react-compiler, react-hooks/exhaustive-deps
    }, [
        lastPaymentMethodIsInitialized,
        iouReport,
        translate,
        formattedAmount,
