 ...
 */
function AttachmentPicker({type = CONST.ATTACHMENT_PICKER_TYPE.FILE, children, shouldHideCameraOption = false, lastScreen = undefined}: AttachmentPickerProps) {
                ...
                imagePickerFunc(getImagePickerOptions(type), (response: ImagePickerResponse) => {
                    ...
                    if (response.errorCode) {
                        switch (response.errorCode) {
                            case 'permission':
                                FileUtils.showCameraPermissionsAlert(lastScreen);
                                return resolve();
                            default:
                                showGeneralAlert();
                                break;
