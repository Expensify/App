...
const Actions = {
    ...
    CLOSE_ATTACHMENTS_PICKER_POPOVER: 'CLOSE_ATTACHMENTS_PICKER_POPOVER',
...
const States = {
    ...
    ATTACHMENTS_POPOVER_OPEN: 'attachmentsPopoverOpen',
    ATTACHMENTS_POPOVER_CLOSED: 'attachmentsPopoverClosed',
...
const STATE_MACHINE = {
    [States.IDLE]: {
        ...
        [Actions.OPEN_EMOJI_PICKER_POPOVER_STANDALONE]: States.EMOJI_PICKER_POPOVER_OPEN,
        [Actions.SHOW_ATTACHMENTS_POPOVER]: States.ATTACHMENTS_POPOVER_OPEN,
    },
    [States.POPOVER_OPEN]: {
    ...
    [States.EMOJI_PICKER_POPOVER_OPEN]: {
        ...
        [Actions.CLOSE_EMOJI_PICKER_POPOVER_STANDALONE]: States.POPOVER_CLOSED,
    },
    ...
    [States.ATTACHMENTS_POPOVER_OPEN]: {
        [Actions.MEASURE_POPOVER]: States.ATTACHMENTS_POPOVER_OPEN,
        [Actions.MEASURE_COMPOSER]: States.ATTACHMENTS_POPOVER_OPEN,
        [Actions.CLOSE_ATTACHMENTS_POPOVER]: States.POPOVER_CLOSED,
    },
