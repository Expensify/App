...
function AttachmentViewImage({source, file, isAuthTokenRequired, isUsedInCarousel, isSingleCarouselItem, isFocused, loadComplete, onPress, onError, isImage, onScaleChanged, translate}) {
