...
function AttachmentViewPdf({file, encryptedSourceUrl, isFocused, onPress, onToggleKeyboard, onLoadComplete, errorLabelStyles, style, isUsedAsChatAttachment, onError}) {
    return (
        <PDFView
            onPress={onPress}
            isFocused={isFocused}
