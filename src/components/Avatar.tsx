...
function Avatar({
    ...
    const iconFillColor = isWorkspace ? StyleUtils.getDefaultWorkspaceAvatarColor(iconID?.toString() ?? '').fill : fill;
                ...
                <View style={iconStyle}>
                    <Icon
                        ...
                        additionalStyles={[
                            ...
                            isWorkspace && StyleUtils.getDefaultWorkspaceAvatarColor(iconID?.toString() ?? ''),
