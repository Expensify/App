...
function Avatar({
    ...
    const imageStyle = [ThemeStyleUtils.getAvatarStyle(size), imageStyles, styles.noBorderRadius];
    const iconStyle = imageStyles ? [ThemeStyleUtils.getAvatarStyle(size), styles.bgTransparent, imageStyles] : undefined;
