...
function Avatar({
    ...
    const isEmptySource = typeof source !== 'function' && typeof source !== 'number' && isEmptyObject(source);
    const useFallBackAvatar = imageError || source === Expensicons.FallbackAvatar || isEmptySource;
