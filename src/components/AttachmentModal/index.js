...
import ModalWithoutChildren from './ModalWithoutChildren';
    ...
    return (
        <>
            <ModalWithoutChildren
                isAttachmentReceipt={isAttachmentReceipt}
                closeModal={closeModal}
                downloadAttachment={downloadAttachment}
                source={source}
                setIsDeleteReceiptConfirmModalVisible={setIsDeleteReceiptConfirmModalVisible}
                modalType={modalType}
                ...
                sourceForAttachmentView={sourceForAttachmentView}
                isAuthTokenRequired={isAuthTokenRequired}
                file={file}
                confirmButtonFadeAnimation={confirmButtonFadeAnimation}
                ...
                isAttachmentInvalid={isAttachmentInvalid}
