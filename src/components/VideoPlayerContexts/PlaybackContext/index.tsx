...
function PlaybackContextProvider({children}: ChildrenProps) {
    ...
    const contextValue: PlaybackContext = useMemo(
        ...
        [updateCurrentURLAndReportID, currentlyPlayingURL, currentRouteReportID, originalParent, sharedElement, video.ref, video.play, video.pause, video.stop, video.isPlaying, video.resumeTryNumberRef, video.resetPlayerData, shareVideoPlayerElements],
    );
