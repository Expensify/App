            ...
            return (
                <Button
                    ...
                    onPress={() => {
                        ...
                        Navigation.navigate(
                            createDynamicRoute(DYNAMIC_ROUTES.TRANSACTION_DUPLICATE_REVIEW.path, ROUTES.REPORT_WITH_ID.getRoute(reportID, undefined, Navigation.getReportRHPActiveRoute())),
                        );
                    }}
                />
            );
