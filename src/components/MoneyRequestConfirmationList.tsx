...
function MoneyRequestConfirmationList({
    ...
    const {shouldSelectPolicy, policyForMovingExpenses} = usePolicyForMovingExpenses(undefined, undefined, isTrackExpense && isDistanceRequest, isMovingTransactionFromTrackExpense);

    // A flag for showing the categories field
    const shouldShowCategories = isTrackExpense
        ? (!policy || shouldSelectPolicy || hasEnabledOptions(Object.values(policyCategories ?? {}))) && (!isDistanceRequest || isMovingTransactionFromTrackExpense)
