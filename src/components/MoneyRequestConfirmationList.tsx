...
function MoneyRequestConfirmationList({
    ...
    useEffect(() => {
        ...
        */
        ...
        const distanceMerchant = DistanceRequestUtils.getDistanceMerchant(hasRoute, distance, unit, rate ?? 0, currency ?? CONST.CURRENCY.USD, translate, toLocaleDigit, true);
