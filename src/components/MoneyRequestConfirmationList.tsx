...
type DropdownValueType = DeepValueOf<typeof CONST.IOU.TYPE>;
...
function MoneyRequestConfirmationList({
    ...
    const splitOrRequestOptions: Array<DropdownOption<DropdownValueType>> = useMemo(() => {
        let text;
    ...
    const footerContent = useMemo(() => {
        ...
        const button = shouldShowSettlementButton ? (
            ...
            <ButtonWithDropdownMenu<DropdownValueType>
                pressOnEnter
                buttonRef={buttonRef}
                isDisabled={shouldDisableButton}
