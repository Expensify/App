...
export default function useFlashListScrollKey<T>({data, keyExtractor, initialScrollKey}: FlashListScrollKeyProps<T>) {
    ...
    return {displayedData: data.slice(targetIndex)};
}
