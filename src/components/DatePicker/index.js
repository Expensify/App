...
class DatePicker extends React.Component {
    ...
    componentDidMount() {
        ...
        this.inputRef.setAttribute('max', this.props.maxDate ? moment(this.props.maxDate).format(CONST.DATE.MOMENT_FORMAT_STRING) : CONST.DATE.MAX_DATE);
        this.inputRef.setAttribute('min', this.props.minDate ? moment(this.props.minDate).format(CONST.DATE.MOMENT_FORMAT_STRING) : CONST.DATE.MIN_DATE);
