...
function MoneyRequestConfirmationListFooter({
    ...
    const shouldShowMap = isDistanceRequest && !isManualDistanceRequest && !isOdometerDistanceRequest && !!(hasErrors || hasPendingWaypoints || iouType !== CONST.IOU.TYPE.SPLIT || !isReadOnly);
                ...
                <MenuItemWithTopDescription
                    ...
                    onPress={() => {
                        ...
                        if (isOdometerDistanceRequest) {
                            Navigation.navigate(ROUTES.MONEY_REQUEST_STEP_DISTANCE_ODOMETER.getRoute(action, iouType, transactionID, reportID, Navigation.getActiveRoute(), reportActionID) as Route);
                            return;
                        }
