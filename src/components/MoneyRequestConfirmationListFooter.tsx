...
function MoneyRequestConfirmationListFooter({
    ...
    const shouldShowReceiptEmptyState = (iouType === CONST.IOU.TYPE.SUBMIT || (iouType === CONST.IOU.TYPE.TRACK && !isMovingTransactionFromTrackExpense(action))) && !isPerDiemRequest;
