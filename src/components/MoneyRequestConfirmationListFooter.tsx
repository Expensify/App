...
function MoneyRequestConfirmationListFooter({
    ...
    const shouldShowReimbursable = isPolicyExpenseChat && isPaidGroupPolicy(policy) && policy?.disabledFields?.reimbursable === false && !isCardTransaction(transaction) && !isTypeInvoice;
