...
import {getTagForDisplay, getTaxAmount, getTaxName, isAmountMissing, isCreatedMissing, shouldShowAttendees as shouldShowAttendeesTransactionsUtils} from '@libs/TransactionUtils';
...
function MoneyRequestConfirmationListFooter({
    ...
    const shouldShowAttendees = useMemo(() => shouldShowAttendeesTransactionsUtils(iouType, policy), [iouType, policy]);
