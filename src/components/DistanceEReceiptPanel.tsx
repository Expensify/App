...
type DistanceEReceiptPanelProps = {
    /** The transaction for the distance expense */
    transaction: Transaction;
};

/**
 * The distance e-receipt card on its own, at its natural height. `DistanceEReceipt` wraps it in a scrolling layout that
 * fills its parent; `ScaledDistanceEReceipt` measures the card to scale it, so it renders this directly, because inside a
 * parent with no height of its own the filling layout resolves to zero height on native.
 */
...
export default DistanceEReceiptPanel;
