...
function AmountField({
    ...
    const {isEditingSplitBill, isReadOnly, didConfirm, transactionID, action, iouType, reportID, reportActionID, onSignDirtyChange, onInputFocus} = useConfirmationFields();
            ...
            {!isAmountFieldDisabled ? (
                <View style={[styles.mh4, styles.mv2]}>
                    <NumberWithSymbolForm
                        ...
                        onFocus={() => {
                            onInputFocus?.(() => amountInputRef.current?.focus());
                        }}
