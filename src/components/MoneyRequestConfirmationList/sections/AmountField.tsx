...
function AmountField({
    ...
    const shouldShowEmptyAmount = (!transactionSlice?.isAmountSet && transactionSlice?.iouRequestType === CONST.IOU.REQUEST_TYPE.MANUAL) || !!transactionSlice?.isFailedScanAmountPlaceholder;
