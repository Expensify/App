...
class Hoverable extends Component {
    ...
    componentDidMount() {
        ...
        document.addEventListener('scroll', this.setScrollingAndStartUnsetListener, true);
    ...
    componentWillUnmount() {
        ...
        document.removeEventListener('scroll', this.setScrollingAndStartUnsetListener, true);
    }
