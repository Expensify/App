...
function MultiGestureCanvas({canvasSize, isActive, onScaleChanged, onTap, children, shouldDisableTransformationGestures: shouldDisableTransformationGesturesProp, pagerRef, ...props}) {
