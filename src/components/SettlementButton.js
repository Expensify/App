...
function SettlementButton({
    ...
    }, [betas, currency, formattedAmount, iouReport, nvp_lastPaymentMethod, policyID, shouldShowPaymentOptions, translate, nextStepButtons.approve, nextStepButtons.reimburse]);
