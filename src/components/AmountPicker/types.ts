...
type AmountSelectorModalProps = {
    ...
    Pick<
        ...
        'decimals' | 'maxLength' | 'symbol' | 'currency' | 'symbolPosition' | 'isSymbolPressable' | 'style' | 'containerStyle' | 'touchableInputWrapperStyle' | 'autoGrowExtraSpace' | 'autoGrowMarginSide'
    >;
