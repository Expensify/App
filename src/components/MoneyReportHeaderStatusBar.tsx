...
function MoneyReportHeaderStatusBar({nextStep}: MoneyReportHeaderStatusBarProps) {
    ...
    const messageContent = useMemo(() => {
        ...
        return buildNextStepMessage(nextStep, translate, preferredLocale, currentUserAccountID, formatPhoneNumber);
    }, [nextStep, translate, preferredLocale, currentUserAccountID, formatPhoneNumber]);
