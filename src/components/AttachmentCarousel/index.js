...
class AttachmentCarousel extends React.Component {
    ...
    renderCell(props) {
        ...
        const style = [props.style, styles.h100, {width: this.props.windowWidth - (modalStyles.marginHorizontal + modalStyles.borderWidth) * 2}];
    ...
    render() {
        ...
        return (
            <View
                ...
                onLayout={({nativeEvent}) => this.setState({containerWidth: nativeEvent.layout.width})}
