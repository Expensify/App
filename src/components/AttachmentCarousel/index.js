...
class AttachmentCarousel extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={[styles.attachmentModalArrowsContainer]} onMouseEnter={() => this.toggleArrowsVisibility(true)} onMouseLeave={() => this.toggleArrowsVisibility(false)}>
                ...
                >
                    <AttachmentView onPress={() => this.toggleArrowsVisibility(!this.state.shouldShowArrow)} source={authSource} file={this.state.file} />
                </CarouselActions>
            </View>
        );
    }
