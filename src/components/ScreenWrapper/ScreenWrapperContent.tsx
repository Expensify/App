...
type ScreenWrapperContentProps = ScreenWrapperContainerProps &
    Omit<ScreenWrapperOfflineIndicatorsProps, 'isExtraContentVisible' | 'addBottomSafeAreaPadding' | 'addWideScreenBottomSafeAreaPadding'> & {
        /** A ref to the screen wrapper content */
...
ScreenWrapperContent.displayName = 'ScreenWrapperContent';

export default React.memo(ScreenWrapperContent);
export type {ScreenWrapperContentProps};
