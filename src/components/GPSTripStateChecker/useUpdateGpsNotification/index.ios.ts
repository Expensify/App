...
function useUpdateGpsNotificationOnUnitChange() {
    ...
    const shouldUseDefaultExpensePolicy = shouldUseDefaultExpensePolicyUtil(CONST.IOU.TYPE.CREATE, defaultExpensePolicy, amountOwed, ownerBillingGracePeriodEnd);
