        ...
        <View style={[styles.flex1]}>
            {shouldUseNarrowLayout ? (
                <Animated.View style={[animatedHighlightStyle]}>
                    <Hoverable>
                        {(hovered) => (
                            <View style={containerStyles ?? [styles.expenseWidgetRadius, styles.justifyContentEvenly, styles.gap3, hovered && styles.hoveredComponentBG, isSelected && styles.buttonDefaultBG]}>
                                {' '}
                ...
                <Animated.View style={[animatedHighlightStyle]}>
                    <Hoverable>
                        {(hovered) => (
                            <View style={containerStyles ?? [styles.p3, styles.gap2, styles.expenseWidgetRadius, hovered && styles.hoveredComponentBG, isSelected && styles.buttonDefaultBG]}>
