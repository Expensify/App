...
function EReceipt({transactionID, transactionItem, onLoad, isThumbnail = false}: EReceiptProps) {
    ...
    const cardDescription = getCompanyCardDescription(transactionCardName, transactionCardID, cardList) ?? (transactionCardID ? getCardDescription(cardList?.[transactionCardID], translate) : '');
