...
function LocaleContextProvider({children}: LocaleContextProviderProps) {
    ...
    const [countryCodeByIP = CONST.DEFAULT_COUNTRY_CODE] = useOnyx(ONYXKEYS.COUNTRY_CODE);
    ...
    const formatPhoneNumber: LocaleContextProps['formatPhoneNumber'] = (phoneNumber) => formatPhoneNumberUtil(phoneNumber, countryCodeByIP);
