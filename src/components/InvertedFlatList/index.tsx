import type {LegendList} from '@legendapp/list';
...
function InvertedFlatList<T>({onScroll: onScrollProp = () => {}, ...props}: BaseInvertedFlatListProps<T>, ref: ForwardedRef<typeof LegendList>) {
