...
const WelcomeText = (props) => {
    ...
    return (
        <>
            <Text style={[textSize, styles.textStrong, styles.mb1]}>{props.translate('welcomeText.welcome')}</Text>
            <Text style={[textSize]}>
                {props.translate('welcomeText.phrase2')} {props.translate('welcomeText.phrase3')}
            </Text>
        </>
    );
};
