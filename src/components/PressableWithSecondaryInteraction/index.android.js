...
function handleLongPress(event, props) {
    ...
    // The constant effectHeavyClick is added in API level 29. Docs: https://developer.android.com/reference/android/os/VibrationEffect#EFFECT_HEAVY_CLICK 
    // We use keyboardTap added in API level 8 as a fallback. Docs: https://developer.android.com/reference/android/view/HapticFeedbackConstants#KEYBOARD_TAP
