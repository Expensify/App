...
class EmojiPickerMenu extends Component {
    ...
    render() {
        ...
        return (
            <View style={[styles.emojiPickerContainer, StyleUtils.getEmojiPickerStyle(this.props.isSmallScreenWidth)]} pointerEvents={this.state.arePointerEventsDisabled ? 'none' : 'auto'}>
                ...
                {!isFiltered && <CategoryShortcutBar headerEmojis={this.headerEmojis} onPress={this.scrollToHeader} />}
