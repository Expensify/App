...
function AvatarWithDisplayName({
    ...
    const parentNavigationSubtitleData = getParentNavigationSubtitle(report, policy, conciergeReportID, formatPhoneNumber, isParentReportArchived, reportAttributes);
