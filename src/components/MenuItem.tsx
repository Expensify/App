...
type AvatarProps = {
  iconType?:
    | typeof CONST.ICON_TYPE_AVATAR
    | typeof CONST.ICON_TYPE_WORKSPACE
    | typeof CONST.ICON_TYPE_PLAID;
...
const getSubscriptAvatarBackgroundColor = (
  isHovered: boolean,
  isPressed: boolean,
...
function MenuItem({
  ...
  const isDeleted =
    style && Array.isArray(style)
      ? style.includes(styles.offlineFeedbackDeleted)
      : false;
  const descriptionVerticalMargin = shouldShowDescriptionOnTop
    ? styles.mb1
    : styles.mt1;
  const defaultAccessibilityLabel = (
    shouldShowDescriptionOnTop ? [description, title] : [title, description]
  )
    .filter(Boolean)
    .join(", ");
  ...
  const combinedTitleTextStyle = StyleUtils.combineStyles<TextStyle>(
    [
      ...
      shouldPutLeftPaddingWhenNoIcon || (icon && !Array.isArray(icon))
  ...
  const descriptionTextStyles = StyleUtils.combineStyles<TextStyle>([
    ...
    title
      ...
      : StyleUtils.getLineHeightStyle(variables.fontSizeNormalHeight),
  ...
  const processedTitle = useMemo(() => {
    ...
    if (shouldTruncateTitle) {
      titleToWrap = Parser.truncateHTML(
        `<comment>${titleToWrap}</comment>`,
        characterLimit,
        { ellipsis: "..." },
      );
      return titleToWrap;
  ...
  const processedHelperText = useMemo(() => {
    ...
    return textToWrap
      ? `<comment><muted-text-label>${textToWrap}</muted-text-label></comment>`
      : "";
  }, [shouldParseHelperText, helperHtml]);

  const hasPressableRightComponent =
  ...
  const renderTitleContent = () => {
    if (
      title &&
      titleWithTooltips &&
      Array.isArray(titleWithTooltips) &&
      titleWithTooltips.length > 0
    ) {
      return (
        <DisplayNames
          fullTitle={title}
    ...
    const titleContainsTextAndCustomEmoji =
  ...
  const isIDPassed =
    !!iconReportID ||
    !!iconAccountID ||
    iconAccountID === CONST.DEFAULT_NUMBER_ID;

  const isNewWindowIcon = iconRight === icons.NewWindow;
  let enhancedAccessibilityLabel =
  ...
  return (
    <View style={rootWrapperStyle} onBlur={onBlur}>
          ...
          <Hoverable isFocused={isFocused}>
            {(isHovered) => (
              <PressableWithSecondaryInteraction
                ...
                onSecondaryInteraction={
                  copyable && !deviceHasHoverSupport
                ...
                disabledStyle={
                  shouldUseDefaultCursorWhenDisabled && [styles.cursorDefault]
                }
                    ...
                    <View style={[styles.flexRow]}>
                      <View style={[styles.flexColumn, styles.flex1]}>
                        {!!label && isLabelHoverable && (
                          ...
                          <View
                            style={[isIDPassed ? styles.mb2 : null, labelStyle]}
                          >
                            <Text
                              style={StyleUtils.combineStyles([
                                styles.sidebarLinkText,
                        ...
                        >
                          {!!leftComponent && (
                            <View style={[styles.mr3]}>{leftComponent}</View>
                          )}
                          {/* eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing */}
                          {isIDPassed && (
                            <ReportActionAvatars
                              ...
                              accountIDs={
                                iconAccountID ? [iconAccountID] : undefined
                              }
                            />
                          )}
                            ...
                            <View
                              style={[
                                ...
                                shouldIconUseAutoWidthStyle
                                  ? styles.wAuto
                                  : StyleUtils.getAvatarWidthStyle(avatarSize),
                              ]}
                            />
                          )}
                          ...
                          <View
                            style={[
                              ...
                              StyleUtils.getMenuItemTextContainerStyle(
                                isSmallAvatarSubscriptMenu || isCompact,
                              ),
                              titleContainerStyle,
                            ]}
                          >
                                ...
                                {!shouldRenderAsHTML &&
                                  ...
                                  !!title && (
                                    <Text
                                      ...
                                      dataSet={{
                                        [CONST.SELECTION_SCRAPER_HIDDEN_ELEMENT]:
                      ...
                      <View
                        style={[
                          ...
                          !hasPressableRightComponent &&
                            styles.pointerEventsNone,
                        ]}
                      >
                        {!!badgeText &&
                          !shouldShowBadgeInSeparateRow &&
                        ...
                        {(subtitle === 0 || !!subtitle) && (
                          <View
                            style={[styles.justifyContentCenter, styles.mr1]}
                          >
                            <Text
                              style={[
                                styles.textLabelSupporting,
                                ...(combinedStyle as TextStyle[]),
                              ]}
                            >
                              {subtitle}
                            </Text>
                        ...
                        {(!!rightIconAccountID || !!rightIconReportID) && (
                          <View
                            style={[
                              styles.alignItemsCenter,
                              styles.justifyContentCenter,
                              brickRoadIndicator ? styles.mr2 : styles.mrn2,
                            ]}
                          >
                            <ReportActionAvatars
                              ...
                              accountIDs={
                                !!rightIconAccountID &&
                                Number(rightIconAccountID) > 0
                                  ? [Number(rightIconAccountID)]
                                  : undefined
                              }
                        ...
                        {!title && !!rightLabel && !errorText && (
                          ...
                          >
                            ...
                            <Text style={styles.rightLabelMenuItem}>
                              {rightLabel}
                            </Text>
                          </View>
                        )}
