...
function ImageTransformer({canvasWidth, canvasHeight, imageWidth, imageHeight, imageScaleX, imageScaleY, scaledImageWidth, scaledImageHeight, isActive = true, children, ...props}) {
