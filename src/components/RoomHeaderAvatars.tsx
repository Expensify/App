...
function RoomHeaderAvatars({icons, report, policy, participants}: RoomHeaderAvatarsProps) {
    ...
    const expensifyIcons = useMemoizedLazyExpensifyIcons(['Camera', 'ImageCropSquareMask'] as const);
        ...
        if (canEditRoomAvatar) {
            return (
                <AvatarWithImagePicker
                    ...
                    style={[styles.mb3, styles.sectionMenuItemTopDescription, styles.w100, styles.alignItemsCenter]}
                    type={icon.type}
