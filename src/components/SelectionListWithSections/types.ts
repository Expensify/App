...
import type {SearchCardGroup, SearchDataTypes, SearchMemberGroup, SearchMerchantGroup, SearchTask, SearchTransactionAction, SearchWithdrawalIDGroup} from '@src/types/onyx/SearchResults';
