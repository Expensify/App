...
function TransactionGroupListItem<TItem extends ListItem>({
    ...
    }, [groupItem, onCheckboxPress, isDisabled, isFocused, canSelectMultiple, isSelectAllChecked, isIndeterminate, isDisabledOrEmpty, groupBy, onSelectRow, transactionPreviewData]);
