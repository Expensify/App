                ...
                {({hovered}) => (
                    <>
                        ...
                        <TransactionItemRow
                            ...
                            style={[styles.p3, isLargeScreenWidth && styles.noBorderRadius, styles.pv2, shouldUseNarrowLayout ? styles.pt2 : {}, isLargeScreenWidth && isLastItem && {borderBottomLeftRadius: 8, borderBottomRightRadius: 8}]}
