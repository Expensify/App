...
function ExpenseReportListItemRow({
    ...
    const columnComponents = {
        ...
        [CONST.SEARCH.TABLE_COLUMNS.SUBMITTED]: (<View style={[StyleUtils.getReportTableColumnStyles(CONST.SEARCH.TABLE_COLUMNS.SUBMITTED, false, false, false, false, item.shouldShowYearSubmitted)]}>
                    <DateCell
                        date={item.submitted ?? ''}
                        showTooltip
                        isLargeScreenWidth
