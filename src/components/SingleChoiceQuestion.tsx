...
function SingleChoiceQuestion({prompt, errorText, possibleAnswers, currentQuestionIndex, onInputChange, forwardedFSClass}: SingleChoiceQuestionProps, ref: ForwardedRef<RNText>) {
