...
function PDFThumbnailImpl({previewSourceURL, style, isAuthTokenRequired = false, enabled = true, onPassword}: PDFThumbnailProps) {
...
PDFThumbnailImpl.displayName = 'PDFThumbnailImpl';
export default React.memo(PDFThumbnailImpl);
