 ...
 */
function OptionRowLHNDataReport({
    isFocused,
    fullReport,
    reportActions,
    personalDetails,
...
OptionRowLHNDataReport.propTypes = propTypes;
OptionRowLHNDataReport.defaultProps = defaultProps;
OptionRowLHNDataReport.displayName = 'OptionRowLHNDataReport';
