...
class OptionRow extends Component {
    ...
    render() {
        ...
        return (
            <OfflineWithFeedback pendingAction={this.props.option.pendingAction} errors={this.props.option.allReportErrors} shouldShowErrorMessages={false}>
                        ...
                        >
                                ...
                                <View style={[styles.flexRow, styles.alignItemsCenter]}>
                                    ...
                                    <View style={contentContainerStyles}>
                                        ...
                                        {this.props.option.alternateText ? (
                                            <Text style={alternateTextStyle} numberOfLines={lodashGet(this.props.option, 'alternateTextMaxLines', 1)}>
                                                {this.props.option.alternateText}
                                            </Text>
                                        ) : null}
                                    </View>
                                    ...
                                    {this.props.option.brickRoadIndicator === CONST.BRICK_ROAD_INDICATOR_STATUS.ERROR && (
                                        <View style={[styles.alignItemsCenter, styles.justifyContentCenter]}>
                                            <Icon src={Expensicons.DotIndicator} fill={themeColors.danger} height={variables.iconSizeSmall} width={variables.iconSizeSmall} />
                                        </View>
                                    )}
                            ...
                            {this.props.option.customIcon && (
                                <View style={[styles.flexRow, styles.alignItemsCenter]} accessible={false}>
                                    <View>
                                        <Icon src={lodashGet(this.props.option, 'customIcon.src', '')} height={16} width={16} fill={lodashGet(this.props.option, 'customIcon.color')} />
                                    </View>
                                </View>
                            )}
                        </TouchableOpacity>
