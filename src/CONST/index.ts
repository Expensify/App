    ...
    SEARCH: {
        ...
        get DEFAULT_COLUMNS() {
            return {
                ...
                EXPENSE_REPORT: [this.TABLE_COLUMNS.DATE, this.TABLE_COLUMNS.STATUS, this.TABLE_COLUMNS.TITLE, this.TABLE_COLUMNS.FROM, this.TABLE_COLUMNS.TO, this.TABLE_COLUMNS.TOTAL, this.TABLE_COLUMNS.ACTION],
                INVOICE: [],
                TASK: [],
                TRIP: [],
                CHAT: [],
