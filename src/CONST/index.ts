...
const CONST = {
    ...
    TELEMETRY: {
        ...
        SPAN_OD_ND_TRANSITION_STAGES: {
            ...
            CLEAR_ONYX: 'OdNdClearOnyx',
            ACCOUNT_SWITCH: 'OdNdAccountSwitch',
            ONYX_BATCH_UPDATE: 'OdNdOnyxBatchUpdate',
            SIGN_IN_OLD_DOT: 'OdNdSignInOldDot',
            AUTH_SCREENS_MOUNT: 'OdNdAuthScreensMount',
            SPLASH_HIDE: 'OdNdSplashHide',
        },
