...
const CONST = {
    ...
    /* If we update these values, let's ensure this logic is consistent with the logic in Auth, since we're using the same method to calculate distance expenses created via Concierge. */
