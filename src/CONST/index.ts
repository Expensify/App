    ...
    SEARCH: {
        ...
        get SEARCH_USER_FRIENDLY_VALUES_MAP() {
            return {
                ...
                [this.TABLE_COLUMNS.TAX_RATE]: 'taxrate',
                ...
                [this.TABLE_COLUMNS.REPORT_ID]: 'report-id',
                [this.TABLE_COLUMNS.BASE_62_REPORT_ID]: 'base62-report-id',
                [this.TABLE_COLUMNS.TAX]: 'tax',
