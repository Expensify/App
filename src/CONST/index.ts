...
const CONST = {
    ...
    SEARCH: {
        ...
        get EXPENSE_CUSTOM_COLUMN_AVAILABILITY() {
            return {
                RECEIPT: {column: this.TABLE_COLUMNS.RECEIPT, search: true, reportDetails: true},
                DATE: {column: this.TABLE_COLUMNS.DATE, search: true, reportDetails: true},
                STATUS: {column: this.TABLE_COLUMNS.STATUS, search: true, reportDetails: false},
                SUBMITTED: {column: this.TABLE_COLUMNS.SUBMITTED, search: true, reportDetails: false},
                APPROVED: {column: this.TABLE_COLUMNS.APPROVED, search: true, reportDetails: false},
                POSTED: {column: this.TABLE_COLUMNS.POSTED, search: true, reportDetails: true},
                EXPORTED: {column: this.TABLE_COLUMNS.EXPORTED, search: true, reportDetails: false},
                MERCHANT: {column: this.TABLE_COLUMNS.MERCHANT, search: true, reportDetails: true},
                DESCRIPTION: {column: this.TABLE_COLUMNS.DESCRIPTION, search: true, reportDetails: true},
                FROM: {column: this.TABLE_COLUMNS.FROM, search: true, reportDetails: false},
                TO: {column: this.TABLE_COLUMNS.TO, search: true, reportDetails: false},
                POLICY_NAME: {column: this.TABLE_COLUMNS.POLICY_NAME, search: true, reportDetails: false},
                CARD: {column: this.TABLE_COLUMNS.CARD, search: true, reportDetails: true},
                CATEGORY: {column: this.TABLE_COLUMNS.CATEGORY, search: true, reportDetails: true},
                CATEGORY_GL_CODE: {column: this.TABLE_COLUMNS.CATEGORY_GL_CODE, search: true, reportDetails: true},
                ATTENDEES: {column: this.TABLE_COLUMNS.ATTENDEES, search: true, reportDetails: true},
                TOTAL_PER_ATTENDEE: {column: this.TABLE_COLUMNS.TOTAL_PER_ATTENDEE, search: true, reportDetails: true},
                TAG: {column: this.TABLE_COLUMNS.TAG, search: true, reportDetails: true},
                EXCHANGE_RATE: {column: this.TABLE_COLUMNS.EXCHANGE_RATE, search: true, reportDetails: true},
                ORIGINAL_AMOUNT: {column: this.TABLE_COLUMNS.ORIGINAL_AMOUNT, search: true, reportDetails: true},
                REPORT_ID: {column: this.TABLE_COLUMNS.REPORT_ID, search: true, reportDetails: false},
                BASE_62_REPORT_ID: {column: this.TABLE_COLUMNS.BASE_62_REPORT_ID, search: true, reportDetails: false},
                REIMBURSABLE: {column: this.TABLE_COLUMNS.REIMBURSABLE, search: true, reportDetails: true},
                BILLABLE: {column: this.TABLE_COLUMNS.BILLABLE, search: true, reportDetails: true},
                MCC: {column: this.TABLE_COLUMNS.MCC, search: true, reportDetails: true},
                TAX_CODE: {column: this.TABLE_COLUMNS.TAX_CODE, search: true, reportDetails: true},
                TAX_RATE: {column: this.TABLE_COLUMNS.TAX_RATE, search: true, reportDetails: true},
                TAX_AMOUNT: {column: this.TABLE_COLUMNS.TAX_AMOUNT, search: true, reportDetails: true},
                TITLE: {column: this.TABLE_COLUMNS.TITLE, search: true, reportDetails: false},
                AMOUNT: {column: this.TABLE_COLUMNS.TOTAL_AMOUNT, search: true, reportDetails: true},
                EXPORTED_TO: {column: this.TABLE_COLUMNS.EXPORTED_TO, search: true, reportDetails: false},
                ACTION: {column: this.TABLE_COLUMNS.ACTION, search: true, reportDetails: false},
                WITHDRAWAL_ID: {column: this.TABLE_COLUMNS.WITHDRAWAL_ID, search: true, reportDetails: true},
                TOTAL: {column: this.TABLE_COLUMNS.TOTAL, search: false, reportDetails: true},
            };
        },
