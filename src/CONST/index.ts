...
const CONST = {
    ...
    TELEMETRY: {
        ...
        SPAN_APP_STARTUP_REQUEST_WAIT: 'ManualAppStartupRequestWait',
        SPAN_APP_STARTUP_RESPONSE_DOWNLOAD: 'ManualAppStartupResponseDownload',
        SPAN_APP_STARTUP_RESPONSE_APPLY: 'ManualAppStartupResponseApply',
        SPAN_APP_STARTUP_RESPONSE_RENDER: 'ManualAppStartupResponseRender',
