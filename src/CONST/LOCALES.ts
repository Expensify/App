...
const SORTED_LOCALES = [
    LOCALE_TO_LANGUAGE_STRING[FULLY_SUPPORTED_LOCALES.EN],
    ...sortAlphabetically(Object.values(TRANSLATION_TARGET_LOCALES).map((localeCode) => LOCALE_TO_LANGUAGE_STRING[localeCode])),
] as Locale[];
