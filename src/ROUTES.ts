...
const DYNAMIC_ROUTES = {
    ...
    CARD_AUTHENTICATION: {
        ...
        entryScreens: [SCREENS.SETTINGS.SUBSCRIPTION.ROOT, SCREENS.SETTINGS.SUBSCRIPTION.ADD_PAYMENT_CARD, SCREENS.SAVE_THE_WORLD.ADD_PAYMENT_CARD, SCREENS.WORKSPACE.OWNER_CHANGE_CHECK],
    },
    OWNER_SELECTOR: {
        path: 'owner-selector',
