...
const ROUTES = {
    ...
    WORKSPACE_ACCOUNTING_QUICKBOOKSONLINE_CHART_OF_ACCOUNTS: {
    ...
    WORKSPACE_ACCOUNTING_QUICKBOOKSONLINE_CLASSES: {
    ...
    WORKSPACE_ACCOUNTING_QUICKBOOKSONLINE_CUSTOMERS: {
    ...
    WORKSPACE_ACCOUNTING_QUICKBOOKSONLINE_LOCATIONS: {
