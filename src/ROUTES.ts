...
export default {
    ...
    SETTINGS_WALLET_CARD_ACTIVATE: 'settings/wallet/cards/:domain/activate',
    getSettingsWalletCardActivateRoute: (domain: string) => `settings/wallet/cards/${domain}/activate`,
