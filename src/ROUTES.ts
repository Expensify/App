...
export default {
    ...
    getEditSplitBillRoute: (reportID: number, reportActionID: number, field: ValueOf<typeof CONST.EDIT_REQUEST_FIELD>) => `r/${reportID}/split/${reportActionID}/edit/${field}`,
    ...
    EDIT_SPLIT_REQUEST_CURRENCY: 'r/:reportID/split/:reportActionID/edit/currency',
    getEditSplitRequestCurrencyRoute: (reportID: number, reportActionID: number, currency: string, backTo: string) =>
        `r/${reportID}/split/${reportActionID}/edit/currency?currency=${currency}&backTo=${backTo}`,
    ...
    EDIT_SPLIT_BILL_REQUEST: `r/:reportID/split/:reportActionID/edit/:field`,
