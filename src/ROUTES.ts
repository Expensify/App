...
const ROUTES = {
    ...
    POLICY_ACCOUNTING_XERO_EXPORT_BILL_DATE_SELECT: {
        route: 'settings/workspaces/:policyID/accounting/xero/export/bill-date-select',
        getRoute: (policyID: string) => `settings/workspaces/${policyID}/accounting/xero/export/bill-date-select` as const,
    },
