...
const ROUTES = {
    ...
    SETTINGS_EXIT_SURVEY_RESPONSE: {
        ...
        getRoute: (reason: ValueOf<typeof CONST.EXIT_SURVEY.REASONS>, backTo: string) => getUrlWithBackToParam(`settings/exit-survey/response?reason=${encodeURIComponent(reason)}`, backTo),
    },
