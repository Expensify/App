...
const ROUTES = {
    ...
    WORKSPACE_WORKFLOWS_SPEND_APPROVER: {
        route: 'workspace/:policyId/workflows/spend/approver',
        getRoute: (policyId: string) => `workspace/${policyId}/workflows/spend/approver` as const,
    },
    WORKSPACE_CARD: {
