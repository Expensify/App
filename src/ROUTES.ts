...
const ROUTES = {
    ...
    WORKSPACE_REPORT_FIELDS_EDIT_NAME: {
        route: 'workspaces/:policyID/reports/:reportFieldID/editName',
        getRoute: (policyID: string, reportFieldID: string) => `workspaces/${policyID}/reports/${encodeURIComponent(reportFieldID)}/editName` as const,
    },
    WORKSPACE_REPORT_FIELDS_EDIT_TYPE: {
        route: 'workspaces/:policyID/reports/:reportFieldID/editType',
        getRoute: (policyID: string, reportFieldID: string) => `workspaces/${policyID}/reports/${encodeURIComponent(reportFieldID)}/editType` as const,
    },
