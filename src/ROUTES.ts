 ...
 *
 */
const TRANSACTION_DUPLICATE_EXTERNAL_ENTRY_SCREENS = [
    SCREENS.REPORT,
...
/** Includes external entry screens and all transaction-duplicate dynamic screens so layered suffixes resolve during the review flow. */
const TRANSACTION_DUPLICATE_FLOW_ENTRY_SCREENS = [
    ...TRANSACTION_DUPLICATE_EXTERNAL_ENTRY_SCREENS,
...
const DYNAMIC_ROUTES = {
    ...
    TRANSACTION_DUPLICATE_REVIEW: {
        ...
        entryScreens: TRANSACTION_DUPLICATE_EXTERNAL_ENTRY_SCREENS,
    },
    TRANSACTION_DUPLICATE_REVIEW_MERCHANT: {
        path: 'review-field/merchant',
        entryScreens: TRANSACTION_DUPLICATE_FLOW_ENTRY_SCREENS,
    },
    TRANSACTION_DUPLICATE_REVIEW_CATEGORY: {
        path: 'review-field/category',
        entryScreens: TRANSACTION_DUPLICATE_FLOW_ENTRY_SCREENS,
    },
    TRANSACTION_DUPLICATE_REVIEW_TAG: {
        path: 'review-field/tag',
        entryScreens: TRANSACTION_DUPLICATE_FLOW_ENTRY_SCREENS,
    },
    TRANSACTION_DUPLICATE_REVIEW_DESCRIPTION: {
        path: 'review-field/description',
        entryScreens: TRANSACTION_DUPLICATE_FLOW_ENTRY_SCREENS,
    },
    TRANSACTION_DUPLICATE_REVIEW_TAX_CODE: {
        path: 'review-field/tax-code',
        entryScreens: TRANSACTION_DUPLICATE_FLOW_ENTRY_SCREENS,
    },
    TRANSACTION_DUPLICATE_REVIEW_REIMBURSABLE: {
        path: 'review-field/reimbursable',
        entryScreens: TRANSACTION_DUPLICATE_FLOW_ENTRY_SCREENS,
    },
    TRANSACTION_DUPLICATE_REVIEW_BILLABLE: {
        path: 'review-field/billable',
        entryScreens: TRANSACTION_DUPLICATE_FLOW_ENTRY_SCREENS,
    },
