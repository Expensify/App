...
export default {
    ...
    getSettingsAddLoginRoute: (type: string): string => `settings/addlogin/${type}`,
    ...
    getEditContactMethodRoute: (contactMethod: string): string => `${SETTINGS_CONTACT_METHODS}/${encodeURIComponent(contactMethod)}/details`,
    ...
    getEditRequestCurrencyRoute: (threadReportID: string, currency: string, backTo: string): string => `r/${threadReportID}/edit/currency?currency=${currency}&backTo=${backTo}`,
    getReportRoute: (reportID: string): string => `r/${reportID}`,
    REPORT_WITH_ID_DETAILS_SHARE_CODE: 'r/:reportID/details/shareCode',
    getReportShareCodeRoute: (reportID: string): string => `r/${reportID}/details/shareCode`,
    REPORT_ATTACHMENTS: 'r/:reportID/attachment',
    getReportAttachmentRoute: (reportID: string, source: string): string => `r/${reportID}/attachment?source=${encodeURI(source)}`,
    ...
    getMoneyRequestRoute: (iouType: string, reportID = ''): string => `${iouType}/new/${reportID}`,
    getMoneyRequestAmountRoute: (iouType: string, reportID = ''): string => `${iouType}/new/amount/${reportID}`,
    getMoneyRequestParticipantsRoute: (iouType: string, reportID = ''): string => `${iouType}/new/participants/${reportID}`,
    getMoneyRequestConfirmationRoute: (iouType: string, reportID = ''): string => `${iouType}/new/confirmation/${reportID}`,
    getMoneyRequestCreatedRoute: (iouType: string, reportID = ''): string => `${iouType}/new/date/${reportID}`,
    getMoneyRequestCurrencyRoute: (iouType: string, reportID: string, currency: string, backTo: string): string =>
        `${iouType}/new/currency/${reportID}?currency=${currency}&backTo=${backTo}`,
    getMoneyRequestDescriptionRoute: (iouType: string, reportID = ''): string => `${iouType}/new/description/${reportID}`,
    getMoneyRequestMerchantRoute: (iouType: string, reportID = ''): string => `${iouType}/new/merchant/${reportID}`,
    getMoneyRequestDistanceTabRoute: (iouType: string, reportID = ''): string => `${iouType}/new/${reportID}/distance`,
    getMoneyRequestWaypointRoute: (iouType: string, waypointIndex: number): string => `${iouType}/new/waypoint/${waypointIndex}`,
    ...
    getNewTaskRoute: (reportID: string): string => `${NEW_TASK}/${reportID}`,
    ...
    getTaskReportTitleRoute: (reportID: string): string => `r/${reportID}/title`,
    getTaskReportDescriptionRoute: (reportID: string): string => `r/${reportID}/description`,
    getTaskReportAssigneeRoute: (reportID: string): string => `r/${reportID}/assignee`,
    ...
    getFlagCommentRoute: (reportID: string, reportActionID: string): string => `flag/${reportID}/${reportActionID}`,
    SEARCH: 'search',
    DETAILS: 'details',
    ...
    getReportParticipantsRoute: (reportID: string): string => `r/${reportID}/participants`,
    REPORT_WITH_ID_DETAILS: 'r/:reportID/details',
    getReportDetailsRoute: (reportID: string): string => `r/${reportID}/details`,
    REPORT_SETTINGS: 'r/:reportID/settings',
    getReportSettingsRoute: (reportID: string): string => `r/${reportID}/settings`,
    REPORT_SETTINGS_ROOM_NAME: 'r/:reportID/settings/room-name',
    getReportSettingsRoomNameRoute: (reportID: string): string => `r/${reportID}/settings/room-name`,
    REPORT_SETTINGS_NOTIFICATION_PREFERENCES: 'r/:reportID/settings/notification-preferences',
    getReportSettingsNotificationPreferencesRoute: (reportID: string): string => `r/${reportID}/settings/notification-preferences`,
    REPORT_WELCOME_MESSAGE: 'r/:reportID/welcomeMessage',
    getReportWelcomeMessageRoute: (reportID: string): string => `r/${reportID}/welcomeMessage`,
    REPORT_SETTINGS_WRITE_CAPABILITY: 'r/:reportID/settings/who-can-post',
    getReportSettingsWriteCapabilityRoute: (reportID: string): string => `r/${reportID}/settings/who-can-post`,
    TRANSITION_BETWEEN_APPS: 'transition',
    VALIDATE_LOGIN: 'v/:accountID/:validateCode',
    GET_ASSISTANCE: 'get-assistance/:taskID',
    getGetAssistanceRoute: (taskID: string): string => `get-assistance/${taskID}`,
    ...
    getWorkspaceInitialRoute: (policyID: string): string => `workspace/${policyID}`,
    getWorkspaceInviteRoute: (policyID: string): string => `workspace/${policyID}/invite`,
    getWorkspaceInviteMessageRoute: (policyID: string): string => `workspace/${policyID}/invite-message`,
    getWorkspaceSettingsRoute: (policyID: string): string => `workspace/${policyID}/settings`,
    getWorkspaceCardRoute: (policyID: string): string => `workspace/${policyID}/card`,
    getWorkspaceReimburseRoute: (policyID: string): string => `workspace/${policyID}/reimburse`,
    getWorkspaceRateAndUnitRoute: (policyID: string): string => `workspace/${policyID}/rateandunit`,
    getWorkspaceBillsRoute: (policyID: string): string => `workspace/${policyID}/bills`,
    getWorkspaceInvoicesRoute: (policyID: string): string => `workspace/${policyID}/invoices`,
    getWorkspaceTravelRoute: (policyID: string): string => `workspace/${policyID}/travel`,
    getWorkspaceMembersRoute: (policyID: string): string => `workspace/${policyID}/members`,
