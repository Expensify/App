...
export default {
    ...
    IOU_DETAILS_SPLIT_BILL: `${IOU_DETAILS}/split/:chatReportID/:reportActionID`,
    getSplitBillDetailsRoute: (chatReportID, reportActionID) => `${IOU_DETAILS}/split/${chatReportID}/${reportActionID}`,
