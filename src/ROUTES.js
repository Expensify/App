...
export default {
    ...
    MONEY_REQUEST_WAYPOINT: ':iouType/new/waypoint/:transactionID/:waypointIndex',
    ...
    getMoneyRequestWaypointRoute: (iouType, transactionID, waypointIndex) => `${iouType}/new/waypoint/${transactionID}/${waypointIndex}`,
