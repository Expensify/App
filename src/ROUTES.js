...
export default {
    ...
    MONEY_REQUEST: ':iouType/:reportID?',
    MONEY_REQUEST_AMOUNT: ':iouType/:transactionType/amount/:reportID?',
    MONEY_REQUEST_PARTICIPANTS: ':iouType/:transactionType/participants/:reportID?',
    MONEY_REQUEST_CONFIRMATION: ':iouType/:transactionType/confirmation/:reportID?',
    MONEY_REQUEST_DATE: ':iouType/:transactionType/date/:reportID?',
    MONEY_REQUEST_CURRENCY: ':iouType/:transactionType/currency/:reportID?',
    MONEY_REQUEST_DESCRIPTION: ':iouType/:transactionType/description/:reportID?',
    MONEY_REQUEST_CATEGORY: ':iouType/:transactionType/category/:reportID?',
    MONEY_REQUEST_MERCHANT: ':iouType/:transactionType/merchant/:reportID?',
    MONEY_REQUEST_MANUAL_TAB: ':iouType/manual/:reportID?',
    MONEY_REQUEST_SCAN_TAB: ':iouType/scan/:reportID?',
    MONEY_REQUEST_DISTANCE_TAB: ':iouType/distance/:reportID?',
    MONEY_REQUEST_WAYPOINT: ':iouType/distance/waypoint/:waypointIndex',
    ...
    getMoneyRequestRoute: (iouType, reportID = '') => `${iouType}/${reportID}`,
    getMoneyRequestAmountRoute: (iouType, transactionType, reportID = '') => `${iouType}/${transactionType}/amount/${reportID}`,
    getMoneyRequestParticipantsRoute: (iouType, transactionType, reportID = '') => `${iouType}/${transactionType}/participants/${reportID}`,
    getMoneyRequestConfirmationRoute: (iouType, transactionType, reportID = '') => `${iouType}/${transactionType}/confirmation/${reportID}`,
    getMoneyRequestCreatedRoute: (iouType, transactionType, reportID = '') => `${iouType}/${transactionType}/date/${reportID}`,
    getMoneyRequestCurrencyRoute: (iouType, transactionType, reportID = '', currency, backTo) => `${iouType}/${transactionType}/currency/${reportID}?currency=${currency}&backTo=${backTo}`,
    getMoneyRequestDescriptionRoute: (iouType, transactionType, reportID = '') => `${iouType}/${transactionType}/description/${reportID}`,
    getMoneyRequestCategoryRoute: (iouType, transactionType, reportID = '') => `${iouType}/${transactionType}/category/${reportID}`,
    getMoneyRequestMerchantRoute: (iouType, transactionType, reportID = '') => `${iouType}/${transactionType}/merchant/${reportID}`,
    getMoneyRequestDistanceTabRoute: (iouType, reportID = '') => `${iouType}/distance/${reportID}`,
    getMoneyRequestWaypointRoute: (iouType, waypointIndex) => `${iouType}/distance/waypoint/${waypointIndex}`,
