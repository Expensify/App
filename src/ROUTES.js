...
export default {
    ...
    getIouRequestCurrencyRoute: (reportID, currCurrency, backTo) => `${IOU_REQUEST_CURRENCY}/${reportID}?currency=${currCurrency}&backTo=${backTo}`,
    getIouBillCurrencyRoute: (reportID, currCurrency, backTo) => `${IOU_BILL_CURRENCY}/${reportID}?currency=${currCurrency}&backTo=${backTo}`,
    getIouSendCurrencyRoute: (reportID, currCurrency, backTo) => `${IOU_SEND_CURRENCY}/${reportID}?currency=${currCurrency}&backTo=${backTo}`,
    IOU_DETAILS,
