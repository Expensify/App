...
const createStyleUtils = (theme: ThemeColors, styles: ThemeStyles) => ({
    ...
    getAutoGrowHeightInputStyle: (textInputHeight: number, maxHeight: number): ViewStyle => {
        ...
        return {
            ...
            height: maxHeight - styles.textInputMultilineContainer.paddingTop - styles.textInputContainer.borderWidth + 8,
        };
    },
    ...
    getMarkdownMaxHeight: (maxAutoGrowHeight: number | undefined): TextStyle => {
        // maxHeight is not of the input only but the of the whole input container
        // which also includes the top padding and bottom border
        return maxAutoGrowHeight ? {maxHeight: maxAutoGrowHeight - styles.textInputMultilineContainer.paddingTop - styles.textInputContainer.borderWidth + 8} : {};
    },
     ...
     */
    getHeightOfMagicCodeInput: (): ViewStyle => ({height: styles.magicCodeInputContainer.minHeight - styles.textInputContainer.borderWidth}),
