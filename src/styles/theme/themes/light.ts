...
const lightTheme = {
    ...
    shadowTop: '0px 6px 16px -2px rgba(2,18,4,0.04)',
    floatingTabBarBG: 'rgba(252,251,249,0.65)',
    floatingTabBarBGWeb: 'rgba(249,249,249,0.72)',
    floatingTabBarBorder: colors.productLight400,
    floatingTabBarSelectedBG: 'rgba(230,225,218,0.50)',
    floatingTabBarSelectedBGWeb: colors.productLight400,
