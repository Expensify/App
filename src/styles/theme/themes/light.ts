...
const lightTheme = {
    ...
    border: colors.productLight300,
    borderLight: colors.productLight300,
    ...
    buttonDefaultBG: colors.productLight300,
    buttonHoveredBG: colors.productLight400,
    buttonPressedBG: colors.productLight500,
    ...
    shadowLight: '0px 2px 8px 0px rgba(2,18,4,0.02)',
    componentBG: colors.productLight100,
    messageHighlightBG: colors.yellow100,
    hoverComponentBG: 'rgba(242, 237, 231, 0.5)',
