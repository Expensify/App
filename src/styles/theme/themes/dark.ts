...
const darkTheme = {
    ...
    border: colors.productDark300,
    borderLight: colors.productDark300,
    ...
    buttonDefaultBG: colors.productDark300,
    buttonHoveredBG: colors.productDark400,
    buttonPressedBG: colors.productDark500,
    ...
    shadowLight: '0px 2px 8px 0px rgba(2,18,4,0.08)',
    componentBG: colors.productDark100,
    hoverComponentBG: 'rgba(10, 46, 37, 0.5)',
