...
const darkTheme = {
    ...
    searchRowSelectedBG: colors.green700,
    ...
    widgetIconBG: colors.green700,
    widgetIconFill: colors.green200,
    widgetIconUrgentBG: colors.tangerine700,
    widgetIconUrgentFill: colors.tangerine200,
