...
import FileImportTable from '@assets/images/companyCards/table-light.svg';
...
import IceCreamBackgroundImage from '@assets/images/themeDependent/ice-cream_background-fade-light.svg';
