import FallbackAvatar from '@assets/images/avatars/fallback/themeDependent/fallback-avatar-light.svg';
import FallbackWorkspaceAvatar from '@assets/images/avatars/fallback/themeDependent/fallback-workspace-avatar-light.svg';
