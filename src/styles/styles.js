...
const styles = (theme) => ({
    ...
    tabActiveOpacity: (hovered, isFocused, activeOpacity) => ({
        opacity: hovered && !isFocused ? 1 : activeOpacity,
    }),

    tabInactiveOpacity: (hovered, isFocused, inactiveOpacity) => ({
        opacity: hovered && !isFocused ? 0 : inactiveOpacity,
    }),
