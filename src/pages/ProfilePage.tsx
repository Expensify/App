...
function ProfilePage({route}: ProfilePageProps) {
    ...
    if ((!isCurrentUser || report) && !isAnonymousUserSession()) {
        promotedActions.push(PromotedActions.message({reportID: report?.reportID, personalDetails, accountID, login: loginParams, currentUserAccountID, introSelected, isSelfTourViewed}));
    }
