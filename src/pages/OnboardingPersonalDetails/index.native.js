...
var BaseOnboardingPersonalDetails_1 = require("./BaseOnboardingPersonalDetails");
function OnboardingPersonalDetails(_a) {
    var rest = __rest(_a, []);
    var routeIndex = rest.navigation.getState().index;
