...
function BaseOnboardingWorkspaceOptional({shouldUseNativeStyles}: BaseOnboardingWorkspaceOptionalProps) {
    ...
    const onboardingStep = useOnboardingStepCounter(SCREENS.ONBOARDING.DYNAMIC_WORKSPACE_OPTIONAL);
                    ...
                    <View>
                        <Button
                            ...
                            onPress={() => {
                                ...
                                Navigation.navigate(createDynamicRoute(DYNAMIC_ROUTES.ONBOARDING_WORKSPACE_CONFIRMATION.path));
                            }}
