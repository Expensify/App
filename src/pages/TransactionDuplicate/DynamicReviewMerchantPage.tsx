...
function DynamicReviewMerchantPage() {
    ...
    const {currentScreenIndex, goBack, navigateToNextScreen} = useReviewDuplicatesNavigation(Object.keys(compareResult.change ?? {}), 'merchant', threadReportID);
...
export default DynamicReviewMerchantPage;
