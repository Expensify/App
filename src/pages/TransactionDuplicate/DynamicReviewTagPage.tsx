...
function DynamicReviewTagPage() {
    ...
    const {currentScreenIndex, goBack, navigateToNextScreen} = useReviewDuplicatesNavigation(Object.keys(compareResult.change ?? {}), 'tag', threadReportID);
...
export default DynamicReviewTagPage;
