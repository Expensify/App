...
function DynamicReviewTag() {
    ...
    const {currentScreenIndex, goBack, navigateToNextScreen} = useReviewDuplicatesNavigation(Object.keys(compareResult.change ?? {}), 'tag', route.params.reportID);
...
export default DynamicReviewTag;
