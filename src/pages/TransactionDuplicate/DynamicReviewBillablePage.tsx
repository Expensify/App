...
function DynamicReviewBillablePage() {
    ...
    const {currentScreenIndex, navigateToNextScreen} = useReviewDuplicatesNavigation(Object.keys(compareResult.change ?? {}), 'billable', route.params.threadReportID, route.params.backTo);
    ...
    return (
        <ScreenWrapper testID="DynamicReviewBillablePage">
...
export default DynamicReviewBillablePage;
