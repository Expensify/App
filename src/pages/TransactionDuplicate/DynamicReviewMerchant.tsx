...
function DynamicReviewMerchant() {
    ...
    const {currentScreenIndex, goBack, navigateToNextScreen} = useReviewDuplicatesNavigation(Object.keys(compareResult.change ?? {}), 'merchant', route.params.reportID);
...
export default DynamicReviewMerchant;
