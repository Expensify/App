...
function DynamicReviewTaxCodePage() {
    ...
    const [transactionThreadReport] = useOnyx(`${ONYXKEYS.COLLECTION.REPORT}${threadReportID}`);
    ...
    const {currentScreenIndex, goBack, navigateToNextScreen} = useReviewDuplicatesNavigation(Object.keys(compareResult.change ?? {}), 'taxCode', threadReportID);
...
export default DynamicReviewTaxCodePage;
