...
function DynamicNewTaskTitlePage({ route }: NewTaskTitlePageProps) {
  ...
  const validate = (
    values: FormOnyxValues<typeof ONYXKEYS.FORMS.NEW_TASK_FORM>,
  ): FormInputErrors<typeof ONYXKEYS.FORMS.NEW_TASK_FORM> => {
    const errors = {};
    ...
    if (!values.taskTitle) {
      ...
      addErrorMessage(
        errors,
        "taskTitle",
        translate("newTaskPage.pleaseEnterTaskName"),
      );
      ...
      addErrorMessage(
        ...
        translate(
          ...
          parsedTitleLength,
          CONST.TASK_TITLE_CHARACTER_LIMIT,
        ),
      );
    }
