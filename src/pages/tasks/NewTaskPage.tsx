...
function NewTaskPage({route}: NewTaskPageProps) {
    ...
    const shareDestination = task?.shareDestination ? getShareDestination(parentReport, personalDetails, localeCompare, policy, translate, reportAttributes) : undefined;
