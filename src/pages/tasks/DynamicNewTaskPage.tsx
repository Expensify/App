...
function DynamicNewTaskPage() {
    ...
    const shareDestinationReportName = useDerivedReportNameByReportID(task?.shareDestination);
    ...
    const shareDestination = task?.shareDestination
        ? getShareDestination(parentReport, personalDetails, localeCompare, formatPhoneNumber, policy, conciergeReportID, translate, shareDestinationReportName)
        : undefined;
