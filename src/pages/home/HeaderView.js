...
function HeaderView(props) {
    ...
    const title = ReportUtils.isGroupChat(props.report)
        ? ReportUtils.getDisplayNamesStringFromTooltips(displayNamesWithTooltips)
        : ReportUtils.getReportName(reportHeaderData, undefined, true);
                        ...
                        >
                            ...
                            <View style={[styles.flex1, styles.flexColumn]}>
                                <DisplayNames
                                    ...
                                    tooltipEnabled
                                    numberOfLines={1}
                                    textStyles={[styles.headerText, styles.pre, styles.mw100]}
