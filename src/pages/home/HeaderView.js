...
function HeaderView(props) {
    ...
    const isGroupChat = ReportUtils.isGroupChat(props.report) || ReportUtils.isGroupChatType(props.report);
    ...
    const title = isGroupChat ? getGroupChatName(props.report) : ReportUtils.getReportName(reportHeaderData);
