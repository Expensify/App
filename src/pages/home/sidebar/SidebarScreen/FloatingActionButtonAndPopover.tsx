...
function FloatingActionButtonAndPopover(
    {onHideCreateMenu, onShowCreateMenu, isLoading = false, allPolicies, quickAction, session, personalDetails, quickActionReport}: FloatingActionButtonAndPopoverProps,
