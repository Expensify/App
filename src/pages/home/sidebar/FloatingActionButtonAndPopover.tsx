...
import {
    ...
    isPaidGroupPolicy,
    isPolicyMember,
    shouldRedirectToExpensifyClassic as shouldRedirectToExpensifyClassicUtil,
    shouldShowPolicy,
...
function FloatingActionButtonAndPopover({onHideCreateMenu, onShowCreateMenu, isTooltipAllowed, ref}: FloatingActionButtonAndPopoverProps) {
    ...
    const shouldRedirectToExpensifyClassic = useMemo(() => {
        return shouldRedirectToExpensifyClassicUtil(allPolicies as OnyxCollection<OnyxTypes.Policy>, tryNewDotRaw);
