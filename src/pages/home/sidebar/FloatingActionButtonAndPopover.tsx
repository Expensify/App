            ...
            const onSelected = () => {
                interceptAnonymousUser(() => {
                    ...
                    navigateToQuickAction({
                        ...
                        draftTransactions: allTransactionDrafts,
                    });
                });
            };
            return [
        ...
        ...expenseMenuItems,
        {
            ...
            onSelected: () => {
                interceptAnonymousUser(() => {
                    ...
                    startDistanceRequest(CONST.IOU.TYPE.CREATE, reportID, lastDistanceExpenseType, false, undefined, allTransactionDrafts);
                });
            },
