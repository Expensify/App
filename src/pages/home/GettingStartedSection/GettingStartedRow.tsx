...
function GettingStartedRow({item}: GettingStartedRowProps) {
    ...
    return (
        ...
        >
            {({hovered}) => (
                <View style={[styles.flexRow, styles.alignItemsCenter, styles.gap3, styles.cardPaddingHorizontal(shouldUseNarrowLayout), styles.pv3, hovered && styles.hoveredComponentBG]}>
