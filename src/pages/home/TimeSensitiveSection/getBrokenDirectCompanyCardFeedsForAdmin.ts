 ...
 */
function getBrokenDirectCompanyCardFeedsForAdmin(cardsWithBrokenConnection: Record<string, Card> | undefined, adminPolicies: Policy[] | undefined): BrokenCompanyCardConnection[] {
...
export default getBrokenDirectCompanyCardFeedsForAdmin;
