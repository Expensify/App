...
function ReportActionItem(props) {
    ...
    const renderItemContent = (hovered = false, isWhisper = false, hasErrors = false) => {
        ...
        if (
            ...
            const submitterDisplayName = PersonalDetailsUtils.getDisplayNameOrDefault(lodashGet(personalDetails, [props.report.ownerAccountID, 'displayName']), props.report.ownerEmail);
