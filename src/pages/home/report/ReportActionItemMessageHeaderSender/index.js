...
function ReportActionItemMessageHeaderSender(_a) {
    var fragmentText = _a.fragmentText, accountID = _a.accountID, delegateAccountID = _a.delegateAccountID, actorIcon = _a.actorIcon, isSingleLine = _a.isSingleLine, shouldShowTooltip = _a.shouldShowTooltip;
