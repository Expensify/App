        ...
        if (
            ...
            children = (
                <ReportActionItemBasicMessage
                    message={translate(paymentType === CONST.IOU.PAYMENT_TYPE.EXPENSIFY ? 'iou.waitingOnEnabledWallet' : 'iou.waitingOnBankAccount', {LocalePhoneNumber.formatPhoneNumber(submitterDisplayName)})}
                >
                    <>
