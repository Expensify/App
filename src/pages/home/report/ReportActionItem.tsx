...
function ReportActionItem({
    ...
    const renderItemContent = (hovered = false, isWhisper = false, hasErrors = false): React.JSX.Element => {
        ...
        } else if (action.actionName === CONST.REPORT.ACTIONS.TYPE.SELFDM_REJECTEDTRANSACTION) {
            children = <ReportActionItemBasicMessage message={ReportUtils.getSelfDMRejectedTransactionReportActionMessage(action)} />;
