...
import type {ParticipantsNavigatorParamList, PrivateNotesNavigatorParamList, ReportDescriptionNavigatorParamList, RoomMemberDetailsNavigatorParamList} from '@navigation/types';
...
type WithReportOrNotFoundProps = WithReportOrNotFoundOnyxProps & {
    route:
        ...
        | RouteProp<RoomMemberDetailsNavigatorParamList, typeof SCREENS.ROOM_MEMBERS.DETAILS>;
