...
function ReportActionsList({
    ...
    const extraData = useMemo(() => [shouldUseNarrowLayout ? currentUnreadMarker : undefined, ReportUtils.isArchivedRoom(report)], [currentUnreadMarker, shouldUseNarrowLayout, report]);
