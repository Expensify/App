...
function ReportActionsView(props) {
    ...
    const report = useMemo(
        () => ({
            ...
            statusNum: props.report.statusNum,
            stateNum: props.report.stateNum,
            writeCapability: props.report.writeCapability,
            type: props.report.type,
            errorFields: props.report.errorFields,
            isPolicyExpenseChat: props.report.isPolicyExpenseChat,
            parentReportID: props.report.parentReportID,
            parentReportActionID: props.report.parentReportActionID,
            chatType: props.report.chatType,
            pendingFields: props.report.pendingFields,
            isDeletedParentAction: props.report.isDeletedParentAction,
            reportName: props.report.reportName,
            description: props.report.description,
            managerID: props.report.managerID,
            total: props.report.total,
            nonReimbursableTotal: props.report.nonReimbursableTotal,
            reportFields: props.report.reportFields,
            ownerAccountID: props.report.ownerAccountID,
            currency: props.report.currency,
            participantAccountIDs: props.report.participantAccountIDs,
            isWaitingOnBankAccount: props.report.isWaitingOnBankAccount,
            iouReportID: props.report.iouReportID,
            isOwnPolicyExpenseChat: props.report.isOwnPolicyExpenseChat,
        }),
        [
            props.report.lastReadTime,
            props.report.reportID,
            props.report.policyID,
            props.report.lastVisibleActionCreated,
            props.report.statusNum,
            props.report.stateNum,
            props.report.writeCapability,
            props.report.type,
            props.report.errorFields,
            props.report.isPolicyExpenseChat,
            props.report.parentReportID,
            props.report.parentReportActionID,
            props.report.chatType,
            props.report.pendingFields,
            props.report.isDeletedParentAction,
            props.report.reportName,
            props.report.description,
            props.report.managerID,
            props.report.total,
            props.report.nonReimbursableTotal,
            props.report.reportFields,
            props.report.ownerAccountID,
            props.report.currency,
            props.report.participantAccountIDs,
            props.report.isWaitingOnBankAccount,
            props.report.iouReportID,
