...
function ReportActionItemSingle(props) {
    ...
    console.log(actorAccountID);
    console.log(CONST.ACCOUNT_ID.NOTIFICATIONS);
    const shouldDisableDetailPage = useMemo(
        () => actorAccountID === CONST.ACCOUNT_ID.NOTIFICATIONS || (!isWorkspaceActor && ReportUtils.isOptimisticPersonalDetail(props.action.delegateAccountID ? props.action.delegateAccountID : actorAccountID)),
