...
function ReportActionItemMessageEdit(props) {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            openReportActionComposeViewWhenClosingMessageEdit(props.action.reportActionID, true);
        };
                    ...
                    <View style={styles.textInputComposeSpacing}>
                        <Composer
                            ...
                            onFocus={() => {
                                ...
                                openReportActionComposeViewWhenClosingMessageEdit(props.action.reportActionID, false);
                            }}
                            onBlur={(event) => {
                                setIsFocused(false);
