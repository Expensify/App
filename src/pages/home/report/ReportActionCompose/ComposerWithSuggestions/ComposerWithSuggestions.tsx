...
function ComposerWithSuggestions(
    ...
    }, [isFocused, isMenuVisible, modal?.isVisible, modal?.willAlertModalBecomeVisible]);
    ...
    useEffect(() => {
        ...
        focus(true);
    }, [focus, prevIsFocused, editFocused, prevIsModalVisible, isFocused, isNextModalWillOpenRef, shouldAutoFocus, modal?.isVisible]);
