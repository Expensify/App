...
function ComposerWithSuggestions({
    ...
    const shouldAutoFocus = (shouldFocusInputOnScreenFocus || !!draftComment) && !modal?.isPopover && shouldShowComposeInput && areAllModalsHidden() && isFocused && !didHideComposerInput;
