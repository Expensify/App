...
function PopoverReportActionContextMenu({ref}: PopoverReportActionContextMenuProps) {
    ...
    const [report] = useOnyx(`${ONYXKEYS.COLLECTION.REPORT}${reportIDRef.current}`, {canBeMissing: true});
    ...
    const confirmDeleteAndHideModal = useCallback(() => {
        ...
        if (isMoneyRequestAction(reportAction)) {
            ...
            if (isTrackExpenseAction(reportAction)) {
                deleteTrackExpense(report, originalMessage?.IOUTransactionID, reportAction, duplicateTransactions, duplicateTransactionViolations, isReportArchived);
            } else {
                deleteMoneyRequest(
    ...
    }, [duplicateTransactions, duplicateTransactionViolations, isReportArchived, isOriginalReportArchived, isChatIOUReportArchived, chatIOUReport]);
