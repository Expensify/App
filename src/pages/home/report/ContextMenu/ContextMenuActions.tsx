...
const ContextMenuActions: ContextMenuAction[] = [
    ...
    },
    {
        ...
        // the `text` and `icon`
        onPress: (closePopover, {reportAction, transaction, selection, report, reportID, card, originalReport, hasInTryNewDot}) => {
            ...
            if (!isAttachment) {
                ...
                if (isReportPreviewAction) {
                    ...
                    setClipboardMessage(getIntegrationSyncFailedMessage(reportAction, report?.policyID, hasInTryNewDot));
