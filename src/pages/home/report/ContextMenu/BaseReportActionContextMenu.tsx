...
import {getLinkedTransactionID, getOneTransactionThreadReportID, isSentMoneyReportAction, isTransactionThread} from '@libs/ReportActionsUtils';
import {
...
function BaseReportActionContextMenu({
    ...
    const isParentActionOfRequest = isTransactionThread(reportAction) && !isSentMoneyReportAction(reportAction);
