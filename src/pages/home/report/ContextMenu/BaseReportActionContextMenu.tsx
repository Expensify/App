...
import shouldEnableEnterShortcut from '@libs/shouldEnableEnterShortcut';
...
function BaseReportActionContextMenu({
    ...
    useKeyboardShortcut(
        ...
        {isActive: shouldEnableArrowNavigation && shouldEnableEnterShortcut, shouldPreventDefault: false},
    );
