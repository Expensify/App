...
type RHPReportScreenProps = PlatformStackScreenProps<RightModalNavigatorParamList, typeof SCREENS.RIGHT_MODAL.SEARCH_REPORT>;
...
export default function RHPReportScreen({route, navigation}: RHPReportScreenProps) {
    return (
        <ReportScreen
