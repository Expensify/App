...
function HeaderView({report, personalDetails, parentReport, policy, session, reportID, guideCalendarLink, onNavigationMenuButtonClicked}: HeaderViewProps) {
    ...
    const isGroupChat = ReportUtils.isGroupChat(report) || ReportUtils.isGroupChatType(report);
    ...
    const title = isGroupChat ? getGroupChatName(report) : ReportUtils.getReportName(reportHeaderData);
