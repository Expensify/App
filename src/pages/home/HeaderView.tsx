...
function HeaderView({report, parentReportAction, onNavigationMenuButtonClicked, shouldUseNarrowLayout = false}: HeaderViewProps) {
    ...
    const shouldShowOnBoardingHelpDropdownButton = ((shouldShowTalkToSales && !isNativePlatform) || shouldShowRegisterForWebinar || shouldShowGuideBooking) && !isArchivedReport(reportNameValuePairs);
