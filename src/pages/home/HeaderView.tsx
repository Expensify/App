...
import {getDiscountTimeRemaining, shouldShowDiscountBanner} from '@libs/SubscriptionUtils';
...
import BillingBanner from '@src/pages/settings/Subscription/CardSection/BillingBanner/BillingBanner';
