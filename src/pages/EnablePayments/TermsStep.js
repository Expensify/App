...
class TermsStep extends React.Component {
    ...
    toggleDisclosure() {
        this.setState(
            (prevState) => ({
                hasAcceptedDisclosure: !prevState.hasAcceptedDisclosure,
            }),
            () => this.clearError(),
        );
    }
    ...
    render() {
        ...
        return (
            <>
                <HeaderWithCloseButton title={this.props.translate('termsStep.headerTitle')} onCloseButtonPress={() => Navigation.dismissModal()} />
