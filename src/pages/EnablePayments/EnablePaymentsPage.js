    ...
    render() {
        ...
        return (
            <ScreenWrapper includeSafeAreaPaddingBottom={false}>
                {() => {
                    if (
                        this.props.userWallet.errorCode ===
                        CONST.WALLET.ERROR.KYC
                    ) {
                        return (
                            <>
                    ...
                    if (
                        this.props.userWallet.shouldShowWalletActivationSuccess
                    ) {
                        return (
                    ...
                    const currentStep =
                        this.props.userWallet.currentStep ||
