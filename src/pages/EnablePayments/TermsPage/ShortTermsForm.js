        ...
        <View style={[styles.shortTermsBorder, styles.p2, styles.mb6]}>
            <View style={[styles.shortTermsRow, styles.mb4]}>
                <View style={[styles.flex2]}>
                    ...
                    <View style={styles.flexRow}>
                        <Text
                            style={[styles.textHeadline, styles.textXXXLarge]}
                        >
                ...
                <View style={[styles.flex2]}>
                    <View style={[styles.flex2]}>
                        <View style={[styles.flexRow, styles.mb1]}>
                            <Text style={styles.textLarge}>
                                {Localize.translateLocal(
                                    'termsStep.shortTermsForm.perPurchase',
                                )}
                            </Text>
                        </View>
                        <View style={styles.flexRow}>
            ...
            <View style={[styles.shortTermsRow, styles.mb6]}>
                <View style={[styles.flex2]}>
                    <View style={[styles.flexRow, styles.mb1]}>
                        <Text style={styles.textLarge}>
                            {Localize.translateLocal(
                                'termsStep.shortTermsForm.atmWithdrawal',
                            )}
                        </Text>
                    </View>
                    <View style={styles.flexRow}>
                    ...
                    <View style={styles.flexRow}>
                        <Text style={styles.textLabelSupporting}>
                            {Localize.translateLocal(
                                'termsStep.shortTermsForm.inNetwork',
                            )}
                        </Text>
                    </View>
                    ...
                    <View style={styles.flexRow}>
                        <Text style={styles.textLabelSupporting}>
                            {Localize.translateLocal(
                                'termsStep.shortTermsForm.outOfNetwork',
                            )}
                        </Text>
                    </View>
                </View>
                <View style={[styles.flex2]}>
                    <View style={[styles.flex2]}>
                        <View style={[styles.flexRow, styles.mb1]}>
                            <Text style={styles.textLarge}>
                                {Localize.translateLocal(
                                    'termsStep.shortTermsForm.cashReload',
                                )}
                            </Text>
                        </View>
                        <View style={styles.flexRow}>
            ...
            <View style={styles.shortTermsRow}>
                <View style={[styles.flex3, styles.pr4]}>
                    <Text>
                        {Localize.translateLocal(
                            'termsStep.shortTermsForm.atmBalanceInquiry',
                        )}{' '}
                        {Localize.translateLocal(
                            'termsStep.shortTermsForm.inOrOutOfNetwork',
                        )}
                    </Text>
                </View>
            ...
            <View style={styles.shortTermsRow}>
                <View style={[styles.flex3, styles.pr4]}>
                    <Text>
                        {Localize.translateLocal(
                            'termsStep.shortTermsForm.customerService',
                        )}{' '}
                        {Localize.translateLocal(
                            'termsStep.shortTermsForm.automatedOrLive',
                        )}
                    </Text>
                </View>
                <View style={styles.flex1}>
            ...
            <View style={[styles.shortTermsRow, styles.mb4]}>
                <View style={[styles.flex3, styles.pr4]}>
                    <Text>
                        ...
                        {Localize.translateLocal(
                            'termsStep.shortTermsForm.afterTwelveMonths',
                        )}
                    </Text>
                </View>
                <View style={styles.flex1}>
            ...
            <View style={[styles.shortTermsBoldHeadingSection, styles.mb3]}>
                <Text style={styles.textStrong}>
                    {Localize.translateLocal(
                        'termsStep.shortTermsForm.weChargeOneFee',
                    )}
                </Text>
            </View>
            ...
            <View style={styles.shortTermsRow}>
                <View style={[styles.flex3, styles.pr4]}>
                    <Text>
                        {Localize.translateLocal(
                            'termsStep.electronicFundsWithdrawal',
                        )}{' '}
                        {Localize.translateLocal(
                            'termsStep.shortTermsForm.instant',
                        )}
                    </Text>
                </View>
                <View style={[styles.flex1, styles.termsCenterRight]}>
                    ...
                    <Text style={styles.label}>
                        {Localize.translateLocal(
                            'termsStep.shortTermsForm.electronicFundsInstantFeeMin',
                        )}
                    </Text>
                </View>
            </View>
            <View style={[styles.shortTermsBoldHeadingSection, styles.mb4]}>
                ...
                <Text style={styles.mb3}>
                    {Localize.translateLocal(
                        'termsStep.shortTermsForm.fdicInsurance',
                    )}
                </Text>
                <Text style={styles.mb3}>
                    {Localize.translateLocal(
                        'termsStep.shortTermsForm.generalInfo',
                    )}{' '}
                ...
                <Text>
                    {Localize.translateLocal(
                        'termsStep.shortTermsForm.conditionsDetails',
                    )}{' '}
                    <TextLink href={CONST.FEES_URL}>
                        {CONST.TERMS.USE_EXPENSIFY_FEES}
                    </TextLink>{' '}
                    {Localize.translateLocal(
                        'termsStep.shortTermsForm.conditionsPhone',
                    )}
                </Text>
            </View>
        </View>
