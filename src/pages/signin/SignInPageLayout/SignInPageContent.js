    ...
    >
        <KeyboardAvoidingView
            ...
            style={[
                ...
                styles.signInPageWelcomeFormContainer,
            ]}
        ...
        >
            ...
            <View
                style={[styles.flexGrow1, styles.signInPageContentTopSpacer]}
            />
        ...
        <View
            style={[
                styles.mb5,
                styles.signInPageWelcomeTextContainer,
                styles.alignSelfCenter,
            ]}
        >
            <OfflineIndicator
