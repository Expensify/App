...
import {clearAccountMessages, signIn, signInWithValidateCode} from '@userActions/Session';
import {resendValidateCode as resendValidateCodeAction} from '@userActions/User';
...
function BaseValidateCodeForm({autoComplete, isUsingRecoveryCode, setIsUsingRecoveryCode, isVisible}: BaseValidateCodeFormProps, forwardedRef: ForwardedRef<BaseValidateCodeFormRef>) {
    ...
    const resendValidateCode = () => {
        resendValidateCodeAction(credentials?.login);
        inputValidateCodeRef.current?.clear();
