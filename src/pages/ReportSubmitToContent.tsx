...
function ReportSubmitToContent({
    ...
    }, [countryCode, currentUserDetails.email, searchTerm, filteredWorkspaceMembers.length, loginList, managerEmail, personalDetails, formatPhoneNumber, dateFnsLocale]);
