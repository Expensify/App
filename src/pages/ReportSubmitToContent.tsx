...
function ReportSubmitToContent({
    ...
    }, [countryCode, currentUserDetails.email, searchTerm, filteredWorkspaceMembers.length, loginList, managerEmail, personalDetails, preferredLocale, convertToDisplayString, rules]);
