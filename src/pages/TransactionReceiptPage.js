...
function TransactionReceipt(_a) {
    ...
    var _g = (0, useOnyx_1.default)("".concat(ONYXKEYS_1.default.COLLECTION.REPORT_METADATA).concat(reportID), { canBeMissing: true })[0], reportMetadata = _g === void 0 ? { isLoadingInitialReportActions: true } : _g;
    ...
    var isFromReviewDuplicates = route.params.isFromReviewDuplicates === 'true';
    ...
    var iouType = route.params.iouType;
