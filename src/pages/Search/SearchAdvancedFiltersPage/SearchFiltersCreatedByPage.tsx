...
function SearchFiltersCreatedByPage() {
    ...
    return (
        <ScreenWrapper
            testID={SearchFiltersCreatedByPage.displayName}
        ...
        >
            ...
            <View style={[styles.flex1]}>
                <SearchFiltersParticipantsSelector
                    initialAccountIDs={searchAdvancedFiltersForm?.createdBy ?? []}
                    onFiltersUpdate={(selectedAccountIDs) => {
                        updateAdvancedFilters({
                            createdBy: selectedAccountIDs,
                        });
                    }}
                />
            </View>
...
SearchFiltersCreatedByPage.displayName = 'SearchFiltersCreatedByPage';

export default SearchFiltersCreatedByPage;
