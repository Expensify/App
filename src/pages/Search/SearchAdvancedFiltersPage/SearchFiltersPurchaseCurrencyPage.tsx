...
function SearchFiltersPurchaseCurrencyPage() {
    ...
    const selectedCurrenciesCodes = searchAdvancedFiltersForm?.purchaseCurrency;
    ...
    return (
        <ScreenWrapper
            testID={SearchFiltersPurchaseCurrencyPage.displayName}
        ...
        >
            <HeaderWithBackButton
                title={translate('search.filters.purchaseCurrency')}
                onBackButtonPress={() => {
