...
function SearchFiltersExportedRootView({value, applyChanges, resetChanges, setView, setValue}: RootViewProps) {
    ...
    const dateOn = useMemo(() => {
        if (!unformattedDateOn || unformattedDateOn === CONST.SEARCH.DATE_PRESETS.NEVER) {
            return undefined;
        }
        ...
        >
            ...
            <SingleSelectListItem
                ...
                item={{
                    ...
                    isSelected: unformattedDateOn === CONST.SEARCH.DATE_PRESETS.NEVER,
                }}
                onSelectRow={() => setValue(CONST.SEARCH.DATE_MODIFIERS.ON, CONST.SEARCH.DATE_PRESETS.NEVER)}
            />
