                                          ...
                                          buttonAction: () => {
                                              interceptAnonymousUser(() => {
                                                  ...
                                                  if (
                                                      ...
                                                      (shouldRestrictUserBillableActions(workspaceIDForReportCreation, accountID) && groupPoliciesWithChatEnabled.length > 1)
                                                  ) {
                                                  ...
                                                  if (!shouldRestrictUserBillableActions(workspaceIDForReportCreation, accountID)) {
