...
function SearchRejectReasonPage({route}: SearchRejectReasonPageProps) {
    ...
    const onSubmit = useCallback(
        ({comment}: FormOnyxValues<typeof ONYXKEYS.FORMS.MONEY_REQUEST_REJECT_FORM>) => {
            ...
            const urlToNavigateBack = rejectMoneyRequestsOnSearch(context.currentSearchHash, selectedTransactionsForReject, comment, allPolicies, allReports, allBetas, currentUserAccountID);
        ...
        [context, allPolicies, allReports, route.name, selectedTransactionsForReject, allBetas, isDelegateAccessRestricted, showDelegateNoAccessModal],
    );
