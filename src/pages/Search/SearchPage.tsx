...
function SearchPage({route}: SearchPageProps) {
    ...
    // The results area renders the current query directly (no holding of the previously resolved search).
    const contentQueryJSON = currentSearchQueryJSON;
    const contentSearchResults = searchResults;
