...
function SearchPage({route}: SearchPageProps) {
    ...
    const expensifyIcons = useMemoizedLazyExpensifyIcons(['ThumbsUp', 'Stopwatch', 'Exclamation', 'Table', 'Export', 'ArrowRight', 'Send', 'MoneyBag', 'DocumentMerge', 'Trashcan', 'SmartScan'] as const);
