...
class SignInWithValidateLinkPage extends Component {
    constructor(props) {
        super(props);
...
SignInWithValidateLinkPage.propTypes = propTypes;
SignInWithValidateLinkPage.defaultProps = defaultProps;
