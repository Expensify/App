...
function NewReportWorkspaceSelectionPage({route}: NewReportWorkspaceSelectionPageProps) {
    ...
    const selectPolicy = (policy?: WorkspaceListItem) => {
        ...
        if (shouldRestrictUserBillableActions(policy.policyID, ownerBillingGracePeriodEnd, userBillingGracePeriods, amountOwed, undefined, currentUserPersonalDetails.accountID)) {
