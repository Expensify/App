...
function ShareDetailsPage({route}: ShareDetailsPageProps) {
    ...
    const displayReport = useMemo(
        () => getReportDisplayOption(report, unknownUserDetails, personalDetail.accountID, personalDetails, privateIsArchived, policy, formatPhoneNumber, reportAttributesDerived),
        [report, unknownUserDetails, personalDetails, privateIsArchived, reportAttributesDerived, personalDetail.accountID, policy, formatPhoneNumber],
    );
