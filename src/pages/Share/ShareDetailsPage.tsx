...
function ShareDetailsPage({route}: ShareDetailsPageProps) {
    ...
    const displayReport = useMemo(
        () => getReportDisplayOption(report, unknownUserDetails, personalDetails, privateIsArchived, policy, conciergeReportID, translate, reportAttributesDerived),
        [report, unknownUserDetails, personalDetails, privateIsArchived, reportAttributesDerived, policy, translate, conciergeReportID],
    );
