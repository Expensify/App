...
function ShareDetailsPage({route}: ShareDetailsPageProps) {
    ...
    const displayReport = useMemo(
        () => getReportDisplayOption(report, unknownUserDetails, personalDetail.accountID, privateIsArchived, reportAttributesDerived),
        [report, unknownUserDetails, personalDetail.accountID, privateIsArchived, reportAttributesDerived],
    );
