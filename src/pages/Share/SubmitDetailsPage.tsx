...
function SubmitDetailsPage({
    ...
    const participants = selectedParticipants.map((participant) => {
        ...
        return participant?.accountID ? getParticipantsOption(participant, personalDetails) : getReportOption(participant, privateIsArchived, policy, personalDetails, reportAttributesDerived);
    });
