        ...
        return (
            <ScreenWrapper includeSafeAreaPaddingBottom={hasFixedFooter}>
                {({safeAreaPaddingBottomStyle}) => (
                    <FullPageNotFoundView shouldShow={_.isEmpty(this.props.iouReport)} subtitleKey="notFound.iouReportNotFound" onBackButtonPress={Navigation.dismissModal}>
                        <HeaderWithCloseButton title={this.props.translate('common.details')} onCloseButtonPress={Navigation.dismissModal} />
