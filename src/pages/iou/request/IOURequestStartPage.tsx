...
function IOURequestStartPage({
    ...
    const tabTitles = {
        ...
        [CONST.IOU.TYPE.SEND]: translate('iou.paySomeone', getPayeeName(report, translate, formatPhoneNumber, currentUserPersonalDetails.accountID)),
        [CONST.IOU.TYPE.PAY]: translate('iou.paySomeone', getPayeeName(report, translate, formatPhoneNumber, currentUserPersonalDetails.accountID)),
