...
import {getDistanceRateCustomUnitRate, getGroupPaidPolicies, isGroupPolicyByType, isTaxTrackingEnabled} from '@libs/PolicyUtils';
import {
    calculateTaxAmount,
    getCurrency,
    getDefaultTaxCode,
...
function IOURequestStepDistanceRate({
    ...
    const policy = policyForTransaction ?? policyByCustomUnitID ?? policyByCustomUnitRateID ?? fallbackAvailablePolicy ?? fallbackMovingExpensesPolicy;
