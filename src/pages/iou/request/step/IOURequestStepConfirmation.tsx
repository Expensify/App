...
import {generateReportID, getBankAccountRoute, getReportOrDraftReport, isProcessingReport, isReportOutsanding, isSelectedManagerMcTest} from '@libs/ReportUtils';
...
function IOURequestStepConfirmation({
    ...
    const shouldUseTransactionReport =
        transactionReport && !(isProcessingReport(transactionReport) && !policyReal?.harvesting?.enabled) && isReportOutsanding(transactionReport, policyReal?.id);
