        ...
        () =>
            transaction?.participants?.map((participant) => {
                ...
                return participant.accountID
                    ...
                    : getReportOption(participant, policyTags, privateIsArchived, policy, personalDetails, reportAttributesDerived, reportDrafts);
            }) ?? [],
        [transaction?.participants, iouType, privateIsArchivedMap, personalDetails, policyTags, policy, reportAttributesDerived, reportDrafts],
    );
