    ...
    const participants = useMemo(
        () =>
            transaction?.participants?.map((participant) => {
                ...
                return participant.accountID ? getParticipantsOption(participant, personalDetails, true) : getReportOption(participant, policyTags, reportAttributesDerived, reportDrafts);
            }) ?? [],
