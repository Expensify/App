        ...
        () =>
            transaction?.participants?.map((participant) => {
                ...
                return participant.accountID
                    ...
                    : getReportOption(participant, policy, receiverPolicy, chatReceiverPolicy, reportAttributesDerived, reportDrafts);
            }) ?? [],
        [transaction?.participants, iouType, personalDetails, reportAttributesDerived, reportDrafts, policy, receiverPolicy, chatReceiverPolicy],
    );
