    ...
    const afterUpgradeAcknowledged = useCallback(() => {
        ...
        switch (upgradePath) {
            ...
            case CONST.UPGRADE_PATHS.CATEGORIES:
                Navigation.navigate(backTo ?? ROUTES.MONEY_REQUEST_STEP_CATEGORY.getRoute(action, CONST.IOU.TYPE.SUBMIT, transactionID, reportID, ROUTES.REPORT_WITH_ID.getRoute(reportID)));
                break;
            default:
        }
