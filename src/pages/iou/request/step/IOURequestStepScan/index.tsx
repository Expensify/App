...
import {findSelfDMReportID, generateReportID, getInvoiceReceiverPolicyID, getPolicyExpenseChat, isArchivedReport, isPolicyExpenseChat} from '@libs/ReportUtils';
...
function IOURequestStepScan({
    ...
    const navigateToConfirmationStep = useCallback(
        (files: ReceiptFile[], locationPermissionGranted = false, isTestTransaction = false) => {
            ...
            if (!initialTransaction?.isFromGlobalCreate && !isArchived && iouType !== CONST.IOU.TYPE.CREATE) {
