...
function IOURequestStepScan(_a) {
    ...
    var _h = (0, react_1.useState)(0), receiptImageTopPosition = _h[0], setReceiptImageTopPosition = _h[1];
    ...
    var isReplacingReceipt = isEditing && (0, TransactionUtils_1.hasReceipt)(initialTransaction);
    ...
    var canUseMultiDragAndDrop = isBetaEnabled(CONST_1.default.BETAS.NEWDOT_MULTI_FILES_DRAG_AND_DROP);
    var shouldAcceptMultipleFiles = canUseMultiDragAndDrop && !isEditing && !backTo;
    ...
    var getScreenshot = (0, react_1.useCallback)(function () {
        ...
        var filename = "receipt_".concat(Date.now(), ".png");
        var file = (0, FileUtils_1.base64ToFile)(imageBase64 !== null && imageBase64 !== void 0 ? imageBase64 : '', filename);
        var source = URL.createObjectURL(file);
        ...
        (0, IOU_1.setMoneyRequestReceipt)(transactionID, source, file.name, !isEditing);
        setReceiptFiles(newReceiptFiles);
        if (isMultiScanEnabled) {
            return;
        }
    ...
    var mobileCameraView = function () { return (<>
            <react_native_1.View style={[styles.cameraView]}>
                ...
                {cameraPermissionState === 'granted' && !(0, EmptyObject_1.isEmptyObject)(videoConstraints) && (<react_native_1.View style={styles.flex1}>
    ...
    var desktopUploadView = function () { return (<>
            {PDFValidationComponent}
            <react_native_1.View onLayout={function (_a) {
        var nativeEvent = _a.nativeEvent;
        return setReceiptImageTopPosition(react_native_1.PixelRatio.roundToNearestPixel(nativeEvent.layout.top));
    }}>
    ...
    return (<StepScreenDragAndDropWrapper_1.default headerTitle={translate('common.receipt')} onBackButtonPress={navigateBack} shouldShowWrapper={!!backTo || isEditing} testID={IOURequestStepScan.displayName}>
            {function (isDraggingOverWrapper) { return (<react_native_1.View onLayout={function () {
                if (!onLayout) {
                    return;
                }
                onLayout(setTestReceiptAndNavigate);
                    ...
                    {canUseMultiDragAndDrop ? (<Consumer_1.default onDrop={handleDropReceipt}>
                        ...
                        </Consumer_1.default>) : (<ReceiptDropUI_1.default onDrop={function (e) {
                    var _a;
                    ...
                    {!(0, Browser_1.isMobile)() && <DownloadAppBanner_1.default />}
                    {ErrorModal}
