...
function IOURequestStepAmount({
    ...
    const shouldSkipConfirmation: boolean = useMemo(() => {
        ...
        return !(ReportUtils.isArchivedAnyReport(report, reportNameValuePairs) || ReportUtils.isPolicyExpenseChat(report));
    ...
    const navigateToNextPage = ({amount, paymentMethod}: AmountParams) => {
        ...
        if (report?.reportID && !ReportUtils.isArchivedAnyReport(report, reportNameValuePairs) && iouType !== CONST.IOU.TYPE.CREATE) {
