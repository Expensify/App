...
function ReceiptFileValidator({
    ...
    useEffect(() => {
        ...
        Promise.all(
            ...
            // Odometer receipts are regenerated by the stitcher while source images are alive.
            // A failed fetch here is mid-stitch transience, not a dead blob — skip recovery.
