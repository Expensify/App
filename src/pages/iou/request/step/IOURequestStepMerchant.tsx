...
function IOURequestStepMerchant({
    ...
    useEffect(() => {
        ...
        // Skip focus-restore on the save path so the re-focused Merchant row doesn't consume the next Enter (which should hit "Create expense"). Back/Esc still restore.
