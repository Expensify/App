...
function IOURequestStepMerchant({
    ...
    const isMerchantRequired = ReportUtils.isReportInGroupPolicy(report) || transaction?.participants?.some((participant) => Boolean(participant.isPolicyExpenseChat)) || isTypeInvoice;
    const navigateBack = () => {
