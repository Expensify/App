...
const FOREGROUND_LOCATION_TRACKING_INTERVAL_MS = 5000;

export {BACKGROUND_LOCATION_TASK_OPTIONS, BACKGROUND_LOCATION_TRACKING_TASK_NAME, GPS_DISTANCE_INTERVAL_METERS, FOREGROUND_LOCATION_TRACKING_INTERVAL_MS};
