...
type Props = {
    ...
    isUnreportedManagedCardTransactions?: boolean;
};
...
function IOURequestEditReportCommon({
    ...
    isPerDiemRequest,
    isTimeRequest = false,
    isUnreportedManagedCardTransactions = false,
}: Props) {
    ...
    const {policyForMovingExpenses} = usePolicyForMovingExpenses(isPerDiemRequest, isTimeRequest, transactionPolicyID, isUnreportedManagedCardTransactions);
