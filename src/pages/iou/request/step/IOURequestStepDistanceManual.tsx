...
function IOURequestStepDistanceManual({
    ...
    const distance = typeof currentTransaction?.comment?.customUnit?.quantity === 'number' ? roundToTwoDecimalPlaces(currentTransaction.comment.customUnit.quantity) : undefined;
