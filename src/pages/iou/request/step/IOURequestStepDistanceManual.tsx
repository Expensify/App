...
import {getPolicyExpenseChat, isArchivedReport, isPolicyExpenseChat as isPolicyExpenseChatUtils, isSelfDM} from '@libs/ReportUtils';
    ...
    const navigateToNextPage = useCallback(
        (amount: string) => {
            ...
            if (shouldUseDefaultExpensePolicy) {
                ...
                setMoneyRequestParticipantsFromReport(transactionID, targetReport, currentUserAccountIDParam).then(() => {
