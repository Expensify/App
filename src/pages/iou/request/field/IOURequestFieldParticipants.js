...
import MoneyRequestParticipantsSelector from '../../steps/MoneyRequstParticipantsPage/MoneyRequestParticipantsSelector';
...
function IOURequestFieldParticipants({route, transaction, transaction: {transactionID, reportID}}) {
    ...
    const headerTitle = headerTitles[TransactionUtils.getRequestType(transaction)];
