...
function SplitBillDetailsPage({route, report, reportAction}: SplitBillDetailsPageProps) {
    ...
    if (isPolicyExpenseChat(report)) {
        participants = [
            ...
            getPolicyExpenseReportOption({...report, selected: true, reportID}, policyTags, translate, currentUserPersonalDetails.accountID, personalDetails, reportAttributesDerived),
        ];
    } else {
