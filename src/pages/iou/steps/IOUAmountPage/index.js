...
class IOUAmountPage extends React.Component {
    ...
    updateAmountNumberPad(key) {
        return this.setState((prevState) => {
            const {amount, selection} = AmountUtils.calculateAmountAndSelection(key, this.selection, prevState.amount);
    ...
    render() {
        const formattedAmount = AmountUtils.replaceAllDigits(this.state.amount, this.props.toLocaleDigit);
        return (
            <>
                <View style={[
                    styles.flex1,
