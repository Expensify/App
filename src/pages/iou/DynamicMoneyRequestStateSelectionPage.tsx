...
type DynamicMoneyRequestStateSelectionPageProps = PlatformStackScreenProps<MoneyRequestNavigatorParamList, typeof SCREENS.MONEY_REQUEST.DYNAMIC_STATE_SELECTOR>;

function DynamicMoneyRequestStateSelectionPage({route}: DynamicMoneyRequestStateSelectionPageProps) {
    ...
    return (
        <ScreenWrapper
            testID="DynamicMoneyRequestStateSelectionPage"
