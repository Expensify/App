...
function HoldReasonPage({route}: HoldReasonPageProps) {
    ...
    const onSubmit = (values: FormOnyxValues<typeof ONYXKEYS.FORMS.MONEY_REQUEST_HOLD_FORM>) => {
        ...
        if (ReportActionsUtils.isMoneyRequestAction(parentReportAction) && !ReportUtils.canEditMoneyRequest(parentReportAction, isChatReportArchived, report, policy, transaction) && isWorkspaceRequest) {
            return;
        }
