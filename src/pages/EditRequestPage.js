...
function EditRequestPage({betas, report, route, parentReport, policy, session, policyCategories, policyTags, parentReportActions, transaction, isLoadingReportData}) {
    ...
    useEffect(() => {
        ...
        if (isLoadingReportData && ReportUtils.canEditFieldOfMoneyRequest(parentReportAction, parentReport.reportID, fieldToEdit)) {
            return;
        }
    ...
    }, [isLoadingReportData, parentReportAction, parentReport.reportID, fieldToEdit]);
