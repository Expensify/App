...
function ReportActions({composerHeight = 0}: ReportActionsProps) {
    ...
    if (shouldDisplayMoneyRequestActionsList) {
        return <MoneyRequestReportActionsList composerHeight={composerHeight} />;
    }
...
function ReportActionsWithInboxTabDeferredMount({reportID, shouldDefer, composerHeight = 0}: ReportActionsWithInboxTabDeferredMountProps) {
    if (!shouldDefer) {
        return <ReportActions composerHeight={composerHeight} />;
    }
    ...
    return (
        ...
        >
            <ReportActions composerHeight={composerHeight} />
        </NavigationDeferredMount>
    );
}
