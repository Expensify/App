...
function ReportActionsView({reportID, onLayout}: ReportActionsViewProps) {
    ...
    const reportTransactionIDsForThread = latchedThreadIDs
        ? visibleTransactionsForThreadID?.filter((t) => latchedThreadIDs.has(t.transactionID)).map((t) => t.transactionID)
