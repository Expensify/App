    ...
    return (
        <View style={[styles.pRelative]}>
            ...
            <OfflineWithFeedback
                ...
                onClose={() => navigateToConciergeChatAndDeleteReport(report?.reportID, conciergeReportID, currentUserAccountID, introSelected, isSelfTourViewed, true, true)}
            >
                {ancestors.map((ancestor) => {
                    ...
                    return (
                        <OfflineWithFeedback
                            ...
                            errorRowStyles={[styles.ml10, styles.mr2]}
                            onClose={() => navigateToConciergeChatAndDeleteReport(ancestorReport.reportID, conciergeReportID, currentUserAccountID, introSelected, isSelfTourViewed)}
                        >
