...
function PureReportActionItem({
    ...
    const showPopover = useCallback(
        (event: GestureResponderEvent | MouseEvent) => {
            ...
            const hasOnlyReceiptErrors =
                !isEmptyValueObject(action.errors) && Object.values(action.errors ?? {}).every((error) => error === null || isReceiptError(error));
            if (draftMessage !== undefined || (!isEmptyValueObject(action.errors) && !hasOnlyReceiptErrors) || !shouldDisplayContextMenu) {
                return;
            }
