        ...
        onPress: (
            ...
            if (!isAttachment) {
                ...
                if (selection) {
                    ...
                    const displayMessage = getReimbursementDeQueuedOrCanceledActionMessage(translate, formatPhoneNumber, reportAction, report?.ownerAccountID, convertToDisplayString);
                    Clipboard.setString(displayMessage);
