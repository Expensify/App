...
import {isLayoutPendingForReport} from '@libs/deferredLayoutWrite';
    ...
    return (
        ...
        >
            <View style={[styles.pRelative]}>
                {/* isLayoutPendingForReport is non-reactive (reads a module-level Map, not tracked by React).
                   ...
                   animation here. */}
                {!isLayoutPendingForReport(CONST.DEFERRED_LAYOUT_WRITE_KEYS.DISMISS_MODAL, report?.reportID) && <AnimatedEmptyStateBackground />}
                <View
