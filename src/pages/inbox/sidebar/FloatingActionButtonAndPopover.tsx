...
function FloatingActionButtonAndPopover({onHideCreateMenu, onShowCreateMenu, ref}: FloatingActionButtonAndPopoverProps) {
    ...
    const selectOption = useCallback(
        (onSelected: () => void, shouldRestrictAction: boolean) => {
            if (shouldRestrictAction && quickActionReport?.policyID && shouldRestrictUserBillableActions(quickActionReport.policyID, userBillingGraceEndPeriods)) {
            ...
            ? [
                  {
                      ...
                      onSelected: () => {
                          interceptAnonymousUser(() => {
                              ...
                              if (!workspaceIDForReportCreation || (shouldRestrictUserBillableActions(workspaceIDForReportCreation, userBillingGraceEndPeriods) && groupPoliciesWithChatEnabled.length > 1)) {
                              ...
                              if (!shouldRestrictUserBillableActions(workspaceIDForReportCreation, userBillingGraceEndPeriods)) {
