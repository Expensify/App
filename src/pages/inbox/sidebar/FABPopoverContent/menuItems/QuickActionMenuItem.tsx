...
function QuickActionMenuItem({reportID}: QuickActionMenuItemProps) {
    ...
    const selectOption = (onSelected: () => void, shouldRestrictAction: boolean) => {
        if (shouldRestrictAction && quickActionReportPolicyID && shouldRestrictUserBillableActions(quickActionReportPolicyID, ownerBillingGracePeriodEnd, userBillingGraceEndPeriods)) {
            ...
            onPress={() =>
                interceptAnonymousUser(() => {
                    if (
                        ...
                        shouldRestrictUserBillableActions(policyChatForActivePolicy.policyID, ownerBillingGracePeriodEnd, userBillingGraceEndPeriods)
                    ) {
