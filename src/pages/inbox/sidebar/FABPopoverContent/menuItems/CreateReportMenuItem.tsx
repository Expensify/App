        ...
        <FABFocusableMenuItem
            ...
            onPress={() => {
                interceptAnonymousUser(() => {
                    ...
                    if (!defaultChatEnabledPolicy || !shouldRestrictUserBillableActions(defaultChatEnabledPolicy, ownerBillingGracePeriodEnd, userBillingGracePeriodEnds, amountOwed, currentUserPersonalDetails.accountID)) {
