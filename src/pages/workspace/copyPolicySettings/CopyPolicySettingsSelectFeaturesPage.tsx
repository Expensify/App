...
function CopyPolicySettingsSelectFeaturesPage() {
    ...
    const reportFieldsCount = Object.values(getReportFieldsByPolicyID(sourcePolicyID, sourcePolicy) ?? {}).filter((field) => field.pendingAction !== CONST.RED_BRICK_ROAD_PENDING_ACTION.DELETE).length;
