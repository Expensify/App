...
const payableAccountSetting = [CONST.XERO_CONFIG.TRAVEL_BILLING_PAYABLE_ACCOUNT];

function DynamicXeroTravelBillingConfigurationPage({policy}: WithPolicyConnectionsProps) {
    ...
    return (
        <ConnectionLayout
            displayName="DynamicXeroTravelBillingConfigurationPage"
...
export default withPolicyConnections(DynamicXeroTravelBillingConfigurationPage);
