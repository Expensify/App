...
const payableAccountSetting = [CONST.NETSUITE_CONFIG.TRAVEL_BILLING_PAYABLE_ACCOUNT];
const journalPostingPreferenceSetting = [CONST.NETSUITE_CONFIG.TRAVEL_BILLING_JOURNAL_POSTING_PREFERENCE];

function NetSuiteTravelBillingConfigurationPage({policy}: WithPolicyConnectionsProps) {
    ...
    const sections: NetSuiteSectionType[] = [
        {
            ...
            onPress: () => {
                ...
                Navigation.navigate(ROUTES.POLICY_ACCOUNTING_NETSUITE_TRAVEL_BILLING_PAYABLE_ACCOUNT_SELECT.getRoute(policyID));
            },
        ...
        },
        {
            ...
            onPress: () => {
                ...
                Navigation.navigate(ROUTES.POLICY_ACCOUNTING_NETSUITE_TRAVEL_BILLING_JOURNAL_POSTING_PREFERENCE_SELECT.getRoute(policyID));
            },
    ...
    return (
        <ConnectionLayout
            displayName="NetSuiteTravelBillingConfigurationPage"
...
export default withPolicyConnections(NetSuiteTravelBillingConfigurationPage);
