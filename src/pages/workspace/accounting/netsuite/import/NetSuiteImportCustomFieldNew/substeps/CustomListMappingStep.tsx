...
function CustomListMappingStep({importCustomField, customSegmentType, onNext, isEditing, netSuiteCustomFieldFormValues, isCustomlist}: CustomFieldSubStepWithPolicy) {
