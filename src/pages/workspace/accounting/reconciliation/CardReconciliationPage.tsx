    ...
    const accountingAdvancedSettingsLink = useMemo(() => {
        ...
        switch (connection) {
            ...
            case CONST.POLICY.CONNECTIONS.ROUTE.SAGE_INTACCT:
                return `${environmentURL}/${ROUTES.POLICY_ACCOUNTING_SAGE_INTACCT_AUTO_SYNC.getRoute(policyID, backTo)}`;
            case CONST.POLICY.CONNECTIONS.ROUTE.QBD:
                return `${environmentURL}/${ROUTES.POLICY_ACCOUNTING_QUICKBOOKS_DESKTOP_AUTO_SYNC.getRoute(policyID, backTo)}`;
            default:
                return '';
        }
