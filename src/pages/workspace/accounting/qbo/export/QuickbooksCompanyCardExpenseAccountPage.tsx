                ...
                <ScrollView contentContainerStyle={styles.pb2}>
                    ...
                    <OfflineWithFeedback pendingAction={pendingFields?.exportCompanyCard}>
                        <MenuItemWithTopDescription
                            title={exportCompanyCard ? translate(`workspace.qbo.exportCompanyCardAccountType.${exportCompanyCard}`) : undefined}
                    ...
                    {!!exportCompanyCard && (
                        <Text style={[styles.ph5, styles.mutedNormalTextLabel, styles.pt1, styles.pb2]}>
                            {translate(`workspace.qbo.exportCompanyCardAccountType.${exportCompanyCard}Description`)}
                        </Text>
                    )}
                    {isVendorSelected && (
                        <>
