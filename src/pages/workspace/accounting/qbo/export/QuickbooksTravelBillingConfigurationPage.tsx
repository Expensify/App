...
const payableAccount = [CONST.QUICKBOOKS_CONFIG.TRAVEL_BILLING_PAYABLE_ACCOUNT];

function QuickbooksTravelBillingConfigurationPage({policy}: WithPolicyConnectionsProps) {
    ...
    return (
        <ConnectionLayout
            displayName="QuickbooksTravelBillingConfigurationPage"
        ...
        >
            <MenuItemField description={translate('workspace.accounting.exportAs')}>
                <MenuItem.TitleBasic>{translate(`workspace.qbo.accounts.${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}`)}</MenuItem.TitleBasic>
            </MenuItemField>
            <OfflineWithFeedback
...
export default withPolicyConnections(QuickbooksTravelBillingConfigurationPage);
