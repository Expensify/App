                ...
                <ScrollView contentContainerStyle={styles.pb2}>
                    ...
                    <OfflineWithFeedback pendingAction={pendingFields?.exportEntity}>
                        <MenuItemWithTopDescription
                            title={exportEntity ? translate(`workspace.qbo.outOfPocketExpenseAccountType.${exportEntity}`) : undefined}
                            description={translate('workspace.qbo.exportAs')}
                            error={hasErrors && exportEntity ? translate(`workspace.qbo.outOfPocketExpenseAccountType.${exportEntity}Error`) : undefined}
