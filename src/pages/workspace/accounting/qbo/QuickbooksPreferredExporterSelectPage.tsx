...
function QuickBooksExportPreferredExporterListPage({policy}: WithPolicyProps) {
    ...
    return (
        <ScreenWrapper
            ...
            testID={QuickBooksExportPreferredExporterListPage.displayName}
        >
...
QuickBooksExportPreferredExporterListPage.displayName = 'QuickBooksExportPreferredExporterListPage';

export default withPolicy(QuickBooksExportPreferredExporterListPage);
