...
type TravelBillingVendorSelectPageProps = {
    policyID: string;
    displayName: string;
...
function TravelBillingVendorSelectPage({
    policyID,
    displayName,
    data,
    connectionName,
    ...
    onBack,
    onClose,
}: TravelBillingVendorSelectPageProps) {
...
export default TravelBillingVendorSelectPage;
