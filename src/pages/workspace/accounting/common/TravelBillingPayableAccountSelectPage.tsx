...
type TravelBillingPayableAccountSelectPageProps = {
    policyID: string;
    displayName: string;
...
function TravelBillingPayableAccountSelectPage({
    policyID,
    displayName,
    ...
    onBack,
    onClose,
}: TravelBillingPayableAccountSelectPageProps) {
...
export default TravelBillingPayableAccountSelectPage;
