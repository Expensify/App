    ...
    switch (connectionName) {
        case CONST.POLICY.CONNECTIONS.NAME.QBO:
            return {
                ...
                onCardReconciliationPagePress: () => Navigation.navigate(ROUTES.WORKSPACE_ACCOUNTING_RECONCILIATION_ACCOUNT_SETTINGS.getRoute(policyID, CONST.POLICY.CONNECTIONS.NAME.QBO)),
        ...
        case CONST.POLICY.CONNECTIONS.NAME.XERO:
            return {
                ...
                onCardReconciliationPagePress: () => Navigation.navigate(ROUTES.WORKSPACE_ACCOUNTING_RECONCILIATION_ACCOUNT_SETTINGS.getRoute(policyID, CONST.POLICY.CONNECTIONS.NAME.XERO)),
        ...
        case CONST.POLICY.CONNECTIONS.NAME.NETSUITE:
            return {
                ...
                onCardReconciliationPagePress: () =>
                    Navigation.navigate(ROUTES.WORKSPACE_ACCOUNTING_RECONCILIATION_ACCOUNT_SETTINGS.getRoute(policyID, CONST.POLICY.CONNECTIONS.NAME.NETSUITE)),
        ...
        case CONST.POLICY.CONNECTIONS.NAME.SAGE_INTACCT:
            return {
                ...
                onCardReconciliationPagePress: () =>
                    Navigation.navigate(ROUTES.WORKSPACE_ACCOUNTING_RECONCILIATION_ACCOUNT_SETTINGS.getRoute(policyID, CONST.POLICY.CONNECTIONS.NAME.SAGE_INTACCT)),
