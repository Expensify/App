...
function DynamicSageIntacctExportPage({policy}: WithPolicyProps) {
    ...
    const exportDate = getSageIntacctExportDate(exportConfig?.exportDate);
    ...
    const sections = [
        ...
        },
        {
            ...
            title: exportDate ? translate(`workspace.sageIntacct.exportDate.values.${exportDate}.label`) : undefined,
