...
const payableAccount = [CONST.QUICKBOOKS_DESKTOP_CONFIG.TRAVEL_BILLING_PAYABLE_ACCOUNT];

function QuickbooksDesktopTravelBillingConfigurationPage({policy}: WithPolicyConnectionsProps) {
    ...
    return (
        <ConnectionLayout
            displayName="QuickbooksDesktopTravelBillingConfigurationPage"
...
export default withPolicyConnections(QuickbooksDesktopTravelBillingConfigurationPage);
