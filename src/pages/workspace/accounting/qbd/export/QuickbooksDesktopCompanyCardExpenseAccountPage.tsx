...
function QuickbooksDesktopCompanyCardExpenseAccountPage({policy}: WithPolicyConnectionsProps) {
    ...
    const sections = [
        ...
        {
            title: accountName,
            description: translate(getQBDNonReimbursableExportAccountType(nonReimbursable)),
            ...
            keyForList: translate(getQBDNonReimbursableExportAccountType(nonReimbursable)),
        },
    ];
