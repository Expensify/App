...
type WorkspaceTravelBillingSettlementAccountPageProps = PlatformStackScreenProps<SettingsNavigatorParamList, typeof SCREENS.WORKSPACE.TRAVEL_SETTINGS_ACCOUNT>;

function WorkspaceTravelBillingSettlementAccountPage({route}: WorkspaceTravelBillingSettlementAccountPageProps) {
    ...
    return (
        ...
        >
            <ScreenWrapper
                testID="WorkspaceTravelBillingSettlementAccountPage"
...
export default WorkspaceTravelBillingSettlementAccountPage;
