...
import {getTravelBillingCardSettingsKey, getTravelSettlementFrequency} from '@libs/TravelBillingUtils';
...
type WorkspaceTravelBillingSettlementFrequencyPageProps = PlatformStackScreenProps<SettingsNavigatorParamList, typeof SCREENS.WORKSPACE.TRAVEL_SETTINGS_FREQUENCY>;

type FrequencyItem = ListItem & {
    value: ValueOf<typeof CONST.EXPENSIFY_CARD.FREQUENCY_SETTING>;
};

function WorkspaceTravelBillingSettlementFrequencyPage({route}: WorkspaceTravelBillingSettlementFrequencyPageProps) {
...
export default WorkspaceTravelBillingSettlementFrequencyPage;
