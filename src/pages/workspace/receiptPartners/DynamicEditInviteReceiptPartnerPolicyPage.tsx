...
type DynamicEditInviteReceiptPartnerPolicyPageProps = PlatformStackScreenProps<SettingsNavigatorParamList, typeof SCREENS.WORKSPACE.DYNAMIC_RECEIPT_PARTNERS_INVITE_EDIT>;
...
function DynamicEditInviteReceiptPartnerPolicyPage({route}: DynamicEditInviteReceiptPartnerPolicyPageProps) {
    ...
    const dynamicBackPath = useDynamicBackPath(DYNAMIC_ROUTES.WORKSPACE_RECEIPT_PARTNERS_INVITE_EDIT.path);
