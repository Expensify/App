...
function ReportFieldsListValuesPage({
    ...
    const canSelectMultiple = !hasAccountingConnections && (isSmallScreenWidth ? !!selectionMode : true);
    ...
    const getHeaderButtons = () => {
        ...
        if (isSmallScreenWidth ? !!selectionMode : selectedValuesArray.length > 0) {
