...
function CategoryRequireItemizedReceiptsOverPage({
    ...
    const requireItemizedReceiptsOverListData = [
        {
            value: null,
            text: translate(`workspace.rules.categoryRules.requireItemizedReceiptsOverList.default`, {
    ...
    return (
        ...
        >
            <ScreenWrapper
                ...
                testID={CategoryRequireItemizedReceiptsOverPage.displayName}
            ...
            >
                ...
                />
                <SelectionList
                    sections={[{data: requireItemizedReceiptsOverListData}]}
...
CategoryRequireItemizedReceiptsOverPage.displayName = 'CategoryRequireItemizedReceiptsOverPage';
