...
function PolicyDistanceRateEditPage({route}: PolicyDistanceRateEditPageProps) {
    ...
    const validate = useCallback(
        (values: FormOnyxValues<typeof ONYXKEYS.FORMS.POLICY_DISTANCE_RATE_EDIT_FORM>) => validateRateValue(values, customUnit?.rates ?? {}, currency, toLocaleDigit, rate?.rate),
        [currency, toLocaleDigit, customUnit?.rates, rate?.rate],
    );
