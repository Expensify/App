...
type PolicyDistanceRateEndDateEditPageProps = PlatformStackScreenProps<SettingsNavigatorParamList, typeof SCREENS.WORKSPACE.DISTANCE_RATE_END_DATE_EDIT>;

function PolicyDistanceRateEndDateEditPage({route}: PolicyDistanceRateEndDateEditPageProps) {
    ...
    const currentStartDate = useMemo(() => rate?.startDate, [rate?.startDate]);
    ...
    const validate = useCallback(
        (values: FormOnyxValues<typeof ONYXKEYS.FORMS.POLICY_DISTANCE_RATE_EDIT_FORM>) => {
            ...
            if (currentStartDate && values.endDate && currentStartDate > values.endDate) {
                errors.endDate = translate('workspace.distanceRates.errors.startDateMustBeBeforeEndDate');
            }
            return errors;
        },
        [translate, currentStartDate],
    );
    ...
    return (
        ...
        >
            <ScreenWrapper
                ...
                testID="PolicyDistanceRateEndDateEditPage"
                shouldEnableMaxHeight
            >
                <HeaderWithBackButton
                    title={translate('workspace.distanceRates.endDate')}
...
export default PolicyDistanceRateEndDateEditPage;
