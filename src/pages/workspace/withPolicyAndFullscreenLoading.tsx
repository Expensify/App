...
import withPolicy, {WithPolicyProps} from './withPolicy';
...
export default function withPolicyAndFullscreenLoading<TProps extends WithPolicyAndFullscreenLoadingProps, TRef>(WrappedComponent: ComponentType<TProps & RefAttributes<TRef>>) {
