...
type WorkspaceCreateTagPageProps =
    ...
    | PlatformStackScreenProps<SettingsNavigatorParamList, typeof SCREENS.SETTINGS_TAGS.DYNAMIC_TAG_CREATE>;
...
function WorkspaceCreateTagPage({route}: WorkspaceCreateTagPageProps) {
    ...
    const isQuickSettingsFlow = route.name === SCREENS.SETTINGS_TAGS.DYNAMIC_TAG_CREATE;
