            ...
            >
                ...
                <FullPageOfflineBlockingView>
                    ...
                    <View style={[styles.flexRow, styles.mh5, styles.mv4, styles.alignItemsCenter, styles.justifyContentBetween]}>
                        <Text style={[styles.textNormal, styles.flex1]} accessible={false}>{translate('workspace.tags.importMultiLevelTags.firstRowTitle')}</Text>
                        <Switch
                    ...
                    <View style={[styles.flexRow, styles.mh5, styles.mv4, styles.alignItemsCenter, styles.justifyContentBetween]}>
                        <Text style={[styles.textNormal, styles.flex1, styles.mr2]} accessible={false}>{translate('workspace.tags.importMultiLevelTags.independentTags')}</Text>
                        <Switch
                    ...
                    <View style={[styles.flexRow, styles.mh5, styles.mv4, styles.alignItemsCenter, styles.justifyContentBetween]}>
                        <Text style={[styles.textNormal, styles.flex1, styles.mr2]} accessible={false}>{translate('workspace.tags.importMultiLevelTags.glAdjacentColumn')}</Text>
                        <Switch
