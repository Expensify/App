        ...
        <View style={styles.flexGrow1}>
            ...
            >
                <View style={[styles.flexRow, styles.mh5, styles.mv4, styles.alignItemsCenter, styles.justifyContentBetween]}>
                    <Text style={[styles.textNormal, styles.flex1, styles.mr2]} accessible={false}>{translate('workspace.tags.requiresTag')}</Text>
                    <Switch
            ...
            <OfflineWithFeedback pendingAction={billableExpensesPending(policy)}>
                <View style={[styles.flexRow, styles.mh5, styles.mv4, styles.alignItemsCenter, styles.justifyContentBetween]}>
                    <Text style={[styles.textNormal, styles.flex1, styles.mr2]} accessible={false}>{translate('workspace.tags.trackBillable')}</Text>
                    <Switch
