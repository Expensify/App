...
type WorkspaceEditTagsPageProps =
    ...
    | PlatformStackScreenProps<SettingsNavigatorParamList, typeof SCREENS.SETTINGS_TAGS.DYNAMIC_TAGS_EDIT>;
...
function WorkspaceEditTagsPage({route}: WorkspaceEditTagsPageProps) {
    ...
    const isQuickSettingsFlow = route.name === SCREENS.SETTINGS_TAGS.DYNAMIC_TAGS_EDIT;
