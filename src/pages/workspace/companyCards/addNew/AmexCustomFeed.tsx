...
type AmexCustomFeedProps = PlatformStackScreenProps<WorkspaceSplitNavigatorParamList, typeof SCREENS.WORKSPACE.COMPANY_CARDS_ADD_NEW_AMEX_CUSTOM_FEED>;

function AmexCustomFeed({route}: AmexCustomFeedProps) {
