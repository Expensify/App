...
type CountryStepProps = PlatformStackScreenProps<WorkspaceSplitNavigatorParamList, typeof SCREENS.WORKSPACE.COMPANY_CARDS_ADD_NEW_SELECT_COUNTRY>;

function SelectCountryStep({route}: CountryStepProps) {
