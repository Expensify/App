...
import {getOriginalFeedName, getPlaidCountry, getPlaidInstitutionId, isSelectedFeedExpired, lastFourNumbersFromCardName, maskCardNumber} from '@libs/CardUtils';
...
function ConfirmationStep({policyID, feed, backTo}: ConfirmationStepProps) {
    ...
    const bankName = assignCard?.data?.bankName ?? getOriginalFeedName(feed);
