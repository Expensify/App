...
function TransactionStartDateSelectorPage({route}: TransactionStartDateSelectorModalProps) {
    ...
    const goBack = () => {
        Navigation.goBack(ROUTES.WORKSPACE_COMPANY_CARDS_ASSIGN_CARD.getRoute(policyID, route.params.feed));
    };
...
TransactionStartDateSelectorPage.displayName = 'TransactionStartDateSelectorModal';
