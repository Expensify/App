...
import {getCardProgramKey, getCardSettings, getMonthlySettlementDate} from '@libs/CardUtils';
...
function WorkspaceSettlementFrequencyPage({route}: WorkspaceSettlementFrequencyPageProps) {
    ...
    const saveSettlementFrequency = () => {
        ...
        updateSettlementFrequencyUtil(defaultFundID, programKey, currentFrequency, getMonthlySettlementDate(settings?.monthlySettlementDate));
        Navigation.goBack();
    };
