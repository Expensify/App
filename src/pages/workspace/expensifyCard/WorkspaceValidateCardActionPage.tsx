...
function WorkspaceValidateCardActionPage() {
    ...
    return (
        <ScreenWrapper
            ...
            testID={WorkspaceValidateCardActionPage.displayName}
            offlineIndicatorStyle={themeStyles.mtAuto}
        >
            <HeaderWithBackButton
                title={translate('workspace.card.validateCardTitle')}
            ...
            <View style={[themeStyles.ph5, themeStyles.mt3, themeStyles.mb7]}>
                <DotIndicatorMessage
                    ...
                    messages={{0: translate('workspace.card.enterMagicCode', {contactMethod: account?.primaryLogin ?? ''})}}
                />
                <ValidateCodeForm
                    isValidatingAction
                    loginList={loginList}
...
WorkspaceValidateCardActionPage.displayName = 'WorkspaceValidateCardActionPage';

export default WorkspaceValidateCardActionPage;