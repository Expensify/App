...
function WorkspaceCardSettingsPage({route}: WorkspaceCardSettingsPageProps) {
    ...
    const monthlySettlementDate = getMonthlySettlementDate(settings?.monthlySettlementDate);
    ...
    const monthlySettlementDateText =
        settlementFrequency === CONST.EXPENSIFY_CARD.FREQUENCY_SETTING.MONTHLY && monthlySettlementDate
            ? translate('workspace.expensifyCard.monthlySettlementDate', format(monthlySettlementDate, CONST.DATE.ORDINAL_DAY_OF_MONTH, {locale: dateFnsLocale}))
            : undefined;
