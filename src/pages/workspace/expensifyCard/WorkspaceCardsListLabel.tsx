...
function WorkspaceCardsListLabel({type, value, style}: WorkspaceCardsListLabelProps) {
    ...
    const requestLimitIncrease = () => {
        ...
        if (isGuidedSetupPending && !conciergeReportID) {
            ...
            navigateToConciergeChat({conciergeReportID, introSelected, currentUserAccountID, isSelfTourViewed, hasCompletedGuidedSetupFlow, betas, shouldDismissModal: false}).then(() => {
