...
function WorkspaceWorkflowsPage({policy, route}: WorkspaceWorkflowsPageProps) {
    ...
    const confirmDisableApprovals = useCallback(() => {
        setWorkspaceApprovalMode(policy, policy?.owner ?? '', CONST.POLICY.APPROVAL_MODE.OPTIONAL, formatPhoneNumber, {
            reportNextSteps: allReportNextSteps,
            transactionViolations,
            betas,
        });
    }, [allReportNextSteps, betas, policy, transactionViolations, formatPhoneNumber]);
        ...
        return [
            ...
            },
            {
                ...
                onToggle: (isEnabled: boolean) => {
                    ...
                    setWorkspaceApprovalMode(policy, policy?.owner ?? '', isEnabled ? updateApprovalMode : CONST.POLICY.APPROVAL_MODE.OPTIONAL, formatPhoneNumber, {
                        reportNextSteps: allReportNextSteps,
                        transactionViolations,
                        betas,
                    });
