...
function WorkspaceWorkflowsPage({policy, route}: WorkspaceWorkflowsPageProps) {
    ...
    const optionItems: ToggleSettingOptionRowProps[] = useMemo(() => {
        ...
        const shouldShowBankAccount = (!!bankAccount || !!bankAccountID) && policy?.reimbursementChoice !== CONST.POLICY.REIMBURSEMENT_CHOICES.REIMBURSEMENT_NO && policy?.achAccount?.reimburser === currentUserLogin;
