...
function MergeATSApprovalModePage({
    ...
    const saveApprovalMode = () => {
        ...
        updateMergeApprovalMode({
            ...
            ...(selectedApprovalMode !== CONST.MERGE.APPROVAL_MODE.CUSTOM &&
                !!finalApprover && {finalApprover, currentFinalApprover: getMergeFinalApprover(policy, CONST.POLICY.CONNECTIONS.NAME.MERGE_ATS)}),
        });
