...
function WorkspacesListPage() {
    ...
    const ownedPaidPoliciesCountsSelector = useMemo(() => createOwnedPaidPoliciesCountsSelector(currentUserPersonalDetails.accountID), [currentUserPersonalDetails.accountID]);
    const [ownedPaidPoliciesCounts] = useOnyx(ONYXKEYS.COLLECTION.POLICY, {selector: ownedPaidPoliciesCountsSelector});
