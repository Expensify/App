...
function WorkspacesListPage() {
    ...
    const route = useRoute<PlatformStackRouteProp<RootTabNavigatorParamList, typeof SCREENS.WORKSPACES_LIST>>();
    ...
    const tabBarContent = useTabBarBottomContent(NAVIGATION_TABS.WORKSPACES);
