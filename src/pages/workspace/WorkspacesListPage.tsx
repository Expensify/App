...
function WorkspacesListPage() {
    ...
    }, [reimbursementAccount?.errors, policies, session?.email, allConnectionSyncProgresses, theme.textLight, navigateToWorkspace, expensifyIcons.FallbackWorkspaceAvatar]);
