...
function FlagForReviewRuleExpenseLimitTypePageBase({policyID, categoryName}: FlagForReviewRuleExpenseLimitTypePageBaseProps) {
...
export default FlagForReviewRuleExpenseLimitTypePageBase;
