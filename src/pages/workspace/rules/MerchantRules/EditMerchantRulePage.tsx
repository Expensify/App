...
import {setDraftMerchantRule, clearDraftMerchantRule} from '@libs/actions/User';
...
function EditMerchantRulePage({route}: EditMerchantRulePageProps) {
    ...
    // Get the existing rule from the policy
    ...
    return (
        ...
        >
            ...
            >
                <HeaderWithBackButton title={translate('workspace.rules.merchantRules.editRuleTitle')} />
