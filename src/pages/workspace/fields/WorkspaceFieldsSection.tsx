...
function WorkspaceFieldsSection({
    ...
    const hasImportedField = useMemo(() => Object.values(fieldList ?? {}).some((field) => fieldFilter(field) && isReportFieldImportedFromIntegration(field, policy)), [fieldFilter, fieldList, policy]);
