    ...
    return (
            ...
            menuItems={[
                {
                    ...
                    onPress: () =>
                        Link.openOldDotLink(
                            `reports?policyID=${props.policyID}&from=all&type=bill&showStates=Open,Processing,Approved,Reimbursed,Archived&isAdvancedFilterMode=true`,
                        ),
        ...
        >
            <View style={[styles.mv3]}>
                <Text>
                    {props.translate(
                        'workspace.bills.askYourVendorsBeforeEmail',
                    )}
                    {props.user.isFromPublicDomain ? (
                        <TextLink
                            onPress={() =>
                                Link.openExternalLink(
                                    'https://community.expensify.com/discussion/7500/how-to-pay-your-company-bills-in-expensify/',
                                )
                            }
                        >
