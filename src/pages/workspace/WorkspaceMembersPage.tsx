    ...
    const getUsers = useCallback((): MemberOption[] => {
        ...
        Object.entries(policy?.employeeList ?? {}).forEach(([email, policyEmployee]) => {
            ...
            result.push({
                ...
                isDisabled: details.isOptimisticPersonalDetail || (isPolicyAdmin && (policyEmployee.pendingAction === CONST.RED_BRICK_ROAD_PENDING_ACTION.DELETE || !isEmptyObject(policyEmployee.errors))),
