...
function WorkspaceInitialPage({policyDraft, policy: policyProp, route}: WorkspaceInitialPageProps) {
    ...
    const policyFeatureStates = useMemo(
        ...
        [policy?.areDistanceRatesEnabled, policy?.areWorkflowsEnabled, policy?.areCategoriesEnabled, policy?.areTagsEnabled, policy?.tax?.trackingEnabled, policy?.areCompanyCardsEnabled, policy?.areConnectionsEnabled, policy?.connections, policy?.areExpensifyCardsEnabled, policy?.areReportFieldsEnabled, policy?.areRulesEnabled, policy?.areInvoicesEnabled, policy?.arePerDiemRatesEnabled, policy?.receiptPartners?.enabled, isUberForBusinessEnabled],
