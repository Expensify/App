...
function WorkspaceMoreFeaturesPage({policy, route}: WorkspaceMoreFeaturesPageProps) {
    ...
    const getDisabledAction = (disabledAction?: () => void | Promise<void>) => {
                ...
                <ScrollView addBottomSafeAreaPadding>
                    ...
                    <MoreFeaturesSection title={translate('workspace.moreFeatures.integrateSection.title')}>
                        <MoreFeatureToggle
                            ...
                            disabledAction={getDisabledAction(warnDisconnectAccountingFirst)}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                        ...
                        <MoreFeatureToggle
                            ...
                            disabledAction={getDisabledAction(warnReceiptPartnersStillConnected)}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                        ...
                        {(isBetaEnabled(CONST.BETAS.GUSTO) || isBetaEnabled(CONST.BETAS.ZENEFITS) || isBetaEnabled(CONST.BETAS.MERGE_HR)) && (
                            <MoreFeatureToggle
                                ...
                                disabledAction={getDisabledAction(warnDisconnectHRFirst)}
                                onToggle={(isEnabled) => {
                                    if (!policyID) {
                                        return;
                                    }
                    ...
                    <MoreFeaturesSection title={translate('workspace.moreFeatures.organizeSection.title')}>
                        <MoreFeatureToggle
                            ...
                            disabled={!canWriteMoreFeatures || hasAccountingConnection}
                            disabledAction={getDisabledAction(warnAccountingManagesOrganizeFeature)}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                    ...
                    <MoreFeaturesSection title={translate('workspace.moreFeatures.manageSection.title')}>
                        <MoreFeatureToggle
                            ...
                            disabledAction={getDisabledAction(promptDisableSmartLimitForWorkflows)}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                        ...
                        <MoreFeatureToggle
                            ...
                            disabledAction={getDisabledAction()}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                    ...
                    <MoreFeaturesSection title={translate('workspace.moreFeatures.spendSection.title')}>
                        ...
                        <MoreFeatureToggle
                            ...
                            disabledAction={getDisabledAction(promptDisableExpensifyCardViaConcierge)}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                        ...
                        <MoreFeatureToggle
                            ...
                            disabledAction={getDisabledAction(promptDisableCompanyCardsViaConcierge)}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
