...
function WorkspaceMoreFeaturesPage({policy, route}: WorkspaceMoreFeaturesPageProps) {
    ...
    const canWriteMoreFeatures = canMemberWrite(policy, currentUserEmail, CONST.POLICY.POLICY_FEATURE.MORE_FEATURES);
                ...
                <ScrollView addBottomSafeAreaPadding>
                    ...
                    <MoreFeaturesSection title={translate('workspace.moreFeatures.integrateSection.title')}>
                        <MoreFeatureToggle
                            ...
                            disabledAction={canWriteMoreFeatures ? warnDisconnectAccountingFirst : undefined}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                        ...
                        <MoreFeatureToggle
                            ...
                            disabledAction={canWriteMoreFeatures ? warnReceiptPartnersStillConnected : undefined}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                        ...
                        {(isBetaEnabled(CONST.BETAS.GUSTO) || isBetaEnabled(CONST.BETAS.ZENEFITS) || isBetaEnabled(CONST.BETAS.MERGE_HR)) && (
                            <MoreFeatureToggle
                                ...
                                disabledAction={canWriteMoreFeatures ? warnDisconnectHRFirst : undefined}
                                onToggle={(isEnabled) => {
                                    if (!policyID) {
                                        return;
                                    }
                    ...
                    <MoreFeaturesSection title={translate('workspace.moreFeatures.organizeSection.title')}>
                        <MoreFeatureToggle
                            ...
                            disabled={!canWriteMoreFeatures || hasAccountingConnection}
                            disabledAction={canWriteMoreFeatures ? warnAccountingManagesOrganizeFeature : undefined}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                    ...
                    <MoreFeaturesSection title={translate('workspace.moreFeatures.manageSection.title')}>
                        <MoreFeatureToggle
                            ...
                            disabledAction={canWriteMoreFeatures ? promptDisableSmartLimitForWorkflows : undefined}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                    ...
                    <MoreFeaturesSection title={translate('workspace.moreFeatures.spendSection.title')}>
                        ...
                        <MoreFeatureToggle
                            ...
                            disabledAction={canWriteMoreFeatures ? promptDisableExpensifyCardViaConcierge : undefined}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
                        ...
                        <MoreFeatureToggle
                            ...
                            disabledAction={canWriteMoreFeatures ? promptDisableCompanyCardsViaConcierge : undefined}
                            onToggle={(isEnabled) => {
                                if (!policyID) {
                                    return;
                                }
