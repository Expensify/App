...
type PolicyRouteName =
    ...
    | typeof SCREENS.WORKSPACE.WORKFLOWS_CURRENCY_CONVERSION_FEES
    | typeof SCREENS.WORKSPACE.MEMBER_DETAILS
    | typeof SCREENS.WORKSPACE.MEMBER_DETAILS_ROLE
    | typeof SCREENS.WORKSPACE.MEMBER_WORK_ARRANGEMENT
    ...
    | typeof SCREENS.WORKSPACE.VENDORS
    | typeof SCREENS.WORKSPACE.ACCOUNTING.RILLET_CARD_PROGRAM_ACCOUNT_SELECTOR
    | typeof SCREENS.WORKSPACE.ACCOUNTING.RILLET_CARD_ACCOUNT_CARD_LIST
    | typeof SCREENS.WORKSPACE.ACCOUNTING.DUALENTRY_CARD_PROGRAM_ACCOUNT_SELECTOR
    | typeof SCREENS.WORKSPACE.ACCOUNTING.DUALENTRY_CARD_ACCOUNT_CARD_LIST;
