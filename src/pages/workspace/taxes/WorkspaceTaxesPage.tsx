...
function WorkspaceTaxesPage({
    ...
    const canSelectMultiple = shouldUseNarrowLayout ? !!selectionMode : true;
    ...
    const shouldShowBulkActionsButton = shouldUseNarrowLayout ? !!selectionMode : selectedTaxesIDs.length > 0;
