...
function WorkspaceTaxesSettingsWorkspaceCurrency(_a) {
    var _b, _c;
    var policyID = _a.route.params.policyID, policy = _a.policy;
    var translate = (0, useLocalize_1.default)().translate;
    var styles = (0, useThemeStyles_1.default)();
    var defaultExternalID = (_c = (_b = policy === null || policy === void 0 ? void 0 : policy.taxRates) === null || _b === void 0 ? void 0 : _b.defaultExternalID) !== null && _c !== void 0 ? _c : '';
    var selectedTaxRate = (policy === null || policy === void 0 ? void 0 : policy.taxRates) && TransactionUtils.getWorkspaceTaxesSettingsName(policy, defaultExternalID);
    var submit = function (taxes) {
        var _a;
        (0, Policy_1.setWorkspaceCurrencyDefault)(policyID, (_a = taxes.code) !== null && _a !== void 0 ? _a : '');
    ...
    return (<AccessOrNotFoundWrapper_1.default accessVariants={[CONST_1.default.POLICY.ACCESS_VARIANTS.ADMIN, CONST_1.default.POLICY.ACCESS_VARIANTS.PAID]} policyID={policyID} featureName={CONST_1.default.POLICY.MORE_FEATURES.ARE_TAXES_ENABLED}>
            <ScreenWrapper_1.default enableEdgeToEdgeBottomSafeAreaPadding shouldEnableMaxHeight testID={WorkspaceTaxesSettingsWorkspaceCurrency.displayName} style={styles.defaultModalContainer}>
                <HeaderWithBackButton_1.default title={translate('workspace.taxes.workspaceDefault')}/>
...
exports.default = (0, withPolicyAndFullscreenLoading_1.default)(WorkspaceTaxesSettingsWorkspaceCurrency);
