...
function ReportFieldsAddListValuePage({
    ...
    return (
        <AccessOrNotFoundWrapper
            ...
            shouldBeBlocked={isReportFieldImportedFromIntegration(reportFieldID ? policy?.fieldList?.[getReportFieldKey(reportFieldID)] : undefined, hasAccountingConnections(policy))}
        >
            <ScreenWrapper
