...
type WorkspaceProfileCurrencyPageOnyxProps = {
    /** Constant, list of available currencies */
    currencyList: OnyxEntry<CurrencyList>;
};

type WorkspaceProfileCurrencyPageProps = WithPolicyAndFullscreenLoadingProps & WorkspaceProfileCurrencyPageOnyxProps;
...
function WorkspaceProfileCurrencyPage({currencyList, policy, isLoadingReportData = true}: WorkspaceProfileCurrencyPageProps) {
...
export default withPolicyAndFullscreenLoading(
    withOnyx<WorkspaceProfileCurrencyPageProps, WorkspaceProfileCurrencyPageOnyxProps>({
