...
import mapCurrencyToCountry from './utils/mapCurrencyToCountry';

const {COUNTRY} = INPUT_IDS.ADDITIONAL_DATA;

type CountryConfirmationSubStepProps = {
    /** ID of current policy */
    policyID: string | undefined;
} & SubStepProps;

function CountryConfirmationSubStep({onNext, policyID}: CountryConfirmationSubStepProps) {
...
CountryConfirmationSubStep.displayName = 'CountryConfirmationSubStep';

export default CountryConfirmationSubStep;
