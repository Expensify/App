...
const {DESTINATION_COUNTRY, COUNTRY} = INPUT_IDS.ADDITIONAL_DATA;
...
function BankInfo({onBackButtonPress, onSubmit}: BankInfoProps) {
    ...
    const country = reimbursementAccountDraft?.[COUNTRY] ?? reimbursementAccountDraft?.[DESTINATION_COUNTRY] ?? '';
