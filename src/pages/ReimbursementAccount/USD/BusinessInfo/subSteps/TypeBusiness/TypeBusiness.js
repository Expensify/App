...
var BusinessTypePicker_1 = require("./BusinessTypePicker");
var COMPANY_INCORPORATION_TYPE_KEY = ReimbursementAccountForm_1.default.BUSINESS_INFO_STEP.INCORPORATION_TYPE;
var STEP_FIELDS = [COMPANY_INCORPORATION_TYPE_KEY];
function TypeBusiness(_a) {
    var _b, _c;
    ...
    var defaultIncorporationType = (_c = (_b = reimbursementAccount === null || reimbursementAccount === void 0 ? void 0 : reimbursementAccount.achData) === null || _b === void 0 ? void 0 : _b.incorporationType) !== null && _c !== void 0 ? _c : '';
