        ...
        <ScreenWrapper includeSafeAreaPaddingBottom={false}>
            <View style={[styles.flex1, styles.justifyContentBetween]}>
                ...
                <ScrollView style={[styles.flex1]}>
                    <Section icon={Illustrations.MoneyWings} title={props.translate('workspace.bankAccount.streamlinePayments')}>
                        ...
                        <Button
                            ...
                            large
                        />
                        {props.error && <Text style={[styles.formError, styles.mh5]}>{props.error}</Text>}
                        <View style={[styles.mv3]}>
                            <MenuItem
