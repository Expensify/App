...
export default function PlaidOnyx(props: Omit<PlaidProps, keyof PlaidOnyxProps>) {
    ...
    if (isLoadingOnyxValue(reimbursementAccountMetadata, reimbursementAccountDraftMetadata, plaidDataMetadata)) {
        return null;
    }
