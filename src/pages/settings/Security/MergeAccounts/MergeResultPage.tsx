...
function MergeResultPage() {
    ...
    }, [login, translate, userEmailOrPhone, styles, closeReactNativeAppWithGPSCheck, environmentURL, lazyIllustrations.LockClosedOrange, lazyIllustrations.RunningTurtle]);
