                ...
                <View style={[styles.ph5, styles.mt3]}>
                    ...
                    <View style={[styles.mt11, styles.flexRow, styles.alignItemsCenter, styles.justifyContentBetween]}>
                        ...
                        <PressableWithDelayToggle
                            ...
                            tooltipText={`${translate('twoFactorAuth.copy')} ${translate('twoFactorAuth.secretKey')}`}
                            tooltipTextChecked={`${translate('common.copied')} ${translate('twoFactorAuth.secretKey')}`}
                            icon={icons.Copy}
                            inline={false}
