...
function BaseTwoFactorAuthForm({account, autoComplete}: BaseTwoFactorAuthFormProps, ref: ForwardedRef<BaseTwoFactorAuthFormRef>) {
    ...
    const shouldResetData = account?.needsTwoFactorAuthSetup;
    ...
    const validateAndSubmitForm = useCallback(() => {
        ...
        setFormError({});
        Session.validateTwoFactorAuth(twoFactorAuthCode, shouldResetData);
    }, [twoFactorAuthCode, shouldResetData, translate]);
