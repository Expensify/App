...
function DelegateMagicCodeModal({login, role, onClose, isValidateCodeActionModalVisible, disableAnimation}: DelegateMagicCodeModalProps) {
    ...
    return (
        <ValidateCodeActionModal
            ...
            navigationHistoryID="delegateMagicCodeModal"
