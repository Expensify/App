            ...
            delegates
                ...
                .map(({email, role, pendingAction, pendingFields}) => {
                    ...
                    return {
                        ...
                        onPendingActionDismiss: () => clearDelegateErrorsByField(email, 'addDelegate', account?.delegatedAccess),
                        error,
                        onPress,
                    ...
                    <ScrollView contentContainerStyle={styles.pt3}>
                        <View style={[styles.flex1, shouldUseNarrowLayout ? styles.workspaceSectionMobile : styles.workspaceSection]}>
                            ...
                            <ConfirmModal
                                ...
                                danger
                                onConfirm={() => {
                                    removeDelegate(selectedDelegate?.email ?? '', account?.delegatedAccess);
