            ...
            return (
                <PlaidLink
                    ...
                    onSuccess={({publicToken, metadata}) => {
                        ...
                        if (feed) {
                            if (plaidConnectedFeed && addNewPersonalCard?.data?.selectedCountry && plaidConnectedFeedName) {
                                importPlaidAccounts(
                                    publicToken,
                                    plaidConnectedFeed,
                                    plaidConnectedFeedName,
                                    addNewPersonalCard.data.selectedCountry,
                                    '',
                                ...
                                InteractionManager.runAfterInteractions(() => {
                                    setAssignCardStepAndData({
                                        ...
                                        currentStep: CONST.PERSONAL_CARDS.STEP.BANK_CONNECTION,
                                    });
                                });
                                return;
                            }
