...
const isAccountLoadingSelector = (personalBankAccount: OnyxEntry<PersonalBankAccount> | null) => personalBankAccount?.isLoading;
...
function InternationalDepositAccount() {
    ...
    const [country, countryMetadata] = useOnyx(ONYXKEYS.COUNTRY, {canBeMissing: false});
    const [isAccountLoading, isLoadingMetadata] = useOnyx(ONYXKEYS.PERSONAL_BANK_ACCOUNT, {selector: isAccountLoadingSelector, canBeMissing: true});
