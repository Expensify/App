...
function BankInformation(_a) {
    ...
    return (<FormProvider_1.default formID={ONYXKEYS_1.default.FORMS.INTERNATIONAL_BANK_ACCOUNT_FORM} submitButtonText={translate(isEditing ? 'common.confirm' : 'common.next')} onSubmit={handleSubmit} validate={validate} style={[styles.flexGrow1, styles.mt3]} submitButtonStyles={[styles.ph5, styles.mb0]} enabledWhenOffline>
            ...
            .sort(function (a, b) { return CONST_1.default.CORPAY_FIELDS.BANK_INFORMATION_FIELDS.indexOf(a.id) - CONST_1.default.CORPAY_FIELDS.BANK_INFORMATION_FIELDS.indexOf(b.id); })
            .map(function (field, index) {
            var _a, _b, _c, _d;
            return (<react_native_1.View style={getStyle(field, index)} key={field.id}>
                            <InputWrapper_1.default InputComponent={getInputComponent(field)} inputID={field.id} defaultValue={formValues[field.id]} label={field.label + (field.isRequired ? '' : " (".concat(translate('common.optional'), ")"))} items={getItems(field)} shouldSaveDraft={!isEditing} renamedInputKeys={{
                    street: (0, EmptyObject_1.isEmptyObject)((_a = fieldsMap[CONST_1.default.CORPAY_FIELDS.STEPS_NAME.BANK_INFORMATION]) === null || _a === void 0 ? void 0 : _a.bankAddressLine1) ? '' : 'bankAddressLine1',
                    street2: (0, EmptyObject_1.isEmptyObject)((_b = fieldsMap[CONST_1.default.CORPAY_FIELDS.STEPS_NAME.BANK_INFORMATION]) === null || _b === void 0 ? void 0 : _b.bankAddressLine2) ? '' : 'bankAddressLine2',
                    city: (0, EmptyObject_1.isEmptyObject)((_c = fieldsMap[CONST_1.default.CORPAY_FIELDS.STEPS_NAME.BANK_INFORMATION]) === null || _c === void 0 ? void 0 : _c.bankCity) ? '' : 'bankCity',
                    state: '',
                    zipCode: (0, EmptyObject_1.isEmptyObject)((_d = fieldsMap[CONST_1.default.CORPAY_FIELDS.STEPS_NAME.BANK_INFORMATION]) === null || _d === void 0 ? void 0 : _d.bankPostal) ? '' : 'bankPostal',
                    country: '',
                    lat: '',
                    lng: '',
                }}/>
