...
import type {BankAccount, BankAccountList, Card, CardList, CompanyCardFeedBankName} from '@src/types/onyx';
    ...
    const filteredPaymentMethods = useMemo(() => {
        if (shouldShowAssignedCards) {
            ...
            for (const card of assignedCardsSorted) {
                ...
                const icon = getCardFeedIcon(card.bank as CompanyCardFeedBankName, illustrations, companyCardFeedIcons);
