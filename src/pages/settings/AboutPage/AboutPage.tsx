...
function AboutPage() {
    const icons = useMemoizedLazyExpensifyIcons(['Keyboard', 'NewWindow', 'MoneyBag'] as const);
    ...
    }, [icons.Keyboard, icons.NewWindow, icons.MoneyBag, styles, translate, waitForNavigate]);
