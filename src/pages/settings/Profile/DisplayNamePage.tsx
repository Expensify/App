...
import {updateDisplayName as updateDisplayNameAction} from '@userActions/PersonalDetails';
 ...
 */
const updateDisplayName = (values: FormOnyxValues<typeof ONYXKEYS.FORMS.DISPLAY_NAME_FORM>, formatPhoneNumber: FormatPhoneNumberType) => {
    updateDisplayNameAction(values.firstName.trim(), values.lastName.trim(), formatPhoneNumber);
    Navigation.goBack();
};
