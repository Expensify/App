...
function ProfilePage() {
    ...
    const privateOptions = [
        ...
        },
        {
            ...
            brickRoadIndicator: (privatePersonalDetails?.errorFields?.addressStreet || privatePersonalDetails?.errorFields?.addressCity || privatePersonalDetails?.errorFields?.addressState || privatePersonalDetails?.errorFields?.addressZipCode) ? CONST.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined,
        },
    ];
