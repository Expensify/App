...
type ContactMethodsPageBaseProps = {
    /** Back path for navigation when used as dynamic route or from screens with backTo param */
    navigateBackTo?: Route;
};

function ContactMethodsPageBase({navigateBackTo}: ContactMethodsPageBaseProps) {
...
export default ContactMethodsPageBase;
