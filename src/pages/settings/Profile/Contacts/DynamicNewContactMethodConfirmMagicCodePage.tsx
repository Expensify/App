...
function DynamicNewContactMethodConfirmMagicCodePage() {
    const {translate} = useLocalize();
    const contactMethodsBackPath = useDynamicBackPath(DYNAMIC_ROUTES.NEW_CONTACT_METHOD_CONFIRM_MAGIC_CODE.path);
    ...
    useEffect(() => {
        ...
        Navigation.navigate(createDynamicRoute(DYNAMIC_ROUTES.NEW_CONTACT_METHOD.path, contactMethodsBackPath));
    }, [contactMethodsBackPath, pendingContactAction?.isVerifiedValidateActionCode]);
    ...
    return (
        <ValidateCodeActionContent
            ...
            onClose={() => {
                ...
                Navigation.goBack(contactMethodsBackPath);
            }}
...
export default DynamicNewContactMethodConfirmMagicCodePage;
