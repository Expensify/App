...
import {updateLegalName as updateLegalNameAction} from '@userActions/PersonalDetails';
...
const updateLegalName = (values: PrivatePersonalDetails) => {
    updateLegalNameAction(values.legalFirstName?.trim() ?? '', values.legalLastName?.trim() ?? '');
};
