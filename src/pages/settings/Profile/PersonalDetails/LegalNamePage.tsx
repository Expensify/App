...
import {updateLegalName} from '@userActions/PersonalDetails';
...
const updateLegalNameFromDetails = (values: PrivatePersonalDetails) => {
    updateLegalName(values.legalFirstName?.trim() ?? '', values.legalLastName?.trim() ?? '');
};
    ...
    const validate = useCallback(
        (values: FormOnyxValues<typeof ONYXKEYS.FORMS.LEGAL_NAME_FORM>) => {
            ...
            if (typeof values.legalFirstName === 'string') {
                if (!isValidLegalName(values.legalFirstName)) {
            ...
            if (typeof values.legalLastName === 'string') {
                if (!isValidLegalName(values.legalLastName)) {
            ...
            <DelegateNoAccessWrapper accessDeniedVariants={[CONST.DELEGATE.DENIED_ACCESS_VARIANTS.DELEGATE]}>
                ...
                {isLoadingApp ? (
                    ...
                    <FormProvider
                        ...
                        validate={validate}
                        onSubmit={updateLegalNameFromDetails}
