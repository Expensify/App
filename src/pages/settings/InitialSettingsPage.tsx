...
import {setIsSigningIn, setOldDotSignInError, setShouldResetSigningInLogic} from '@userActions/HybridApp';
...
function InitialSettingsPage({currentUserPersonalDetails}: InitialSettingsPageProps) {
        ...
        return {
            ...
            items: [
                ...
                },
                {
                    ...
                    shouldShowRightComponent: hybridApp?.isSigningIn,
                    rightComponent: (
                        <ActivityIndicator
                            size="small"
                            color={theme.spinner}
                    ...
                    brickRoadIndicator: hybridApp?.oldDotSignInError ? CONST.BRICK_ROAD_INDICATOR_STATUS.ERROR : undefined,
                              ...
                              action: () => {
                                  if (!hybridApp?.readyToSwitchToClassicExperience) {
                                      if (credentials?.autoGeneratedLogin && credentials?.autoGeneratedPassword) {
                                          // jeszcze logika handlująca poprawne zalogowanie, jak po takim kliknięciu się zaloguje to zamykaj apkę!!!!
    ...
    }, [styles.pt4, hybridApp?.isSigningIn, hybridApp?.oldDotSignInError, hybridApp?.readyToSwitchToClassicExperience, theme.spinner, credentials, setInitialURL, signOut]);
