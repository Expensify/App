...
import {getRequestType, hasEReceipt, hasMissingSmartscanFields, hasReceipt, hasReceiptSource, isReceiptBeingScanned, isOdometerDistanceRequest} from '@libs/TransactionUtils';
