...
function useDownloadAttachment(props?: UseDownloadAttachmentProps) {
    const {isAuthTokenRequired = false, type, draftTransactionID} = props ?? {isAuthTokenRequired: false, type: undefined, draftTransactionID: undefined};
