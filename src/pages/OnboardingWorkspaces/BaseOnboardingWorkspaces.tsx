...
function BaseOnboardingWorkspaces({route, shouldUseNativeStyles}: BaseOnboardingWorkspacesProps) {
    ...
    const handleJoinWorkspace = useCallback(
        (policy: JoinablePolicy) => {
            ...
            navigateAfterOnboarding(CONST.ONBOARDING_CHOICES.LOOKING_AROUND, isSmallScreenWidth, canUseDefaultRooms, policy.automaticJoiningEnabled ? policy.policyID : undefined);
        },
