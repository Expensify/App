...
import useOnyxWithMountReset from './hooks/useOnyxWithMountReset';
...
function Expensify() {
    ...
    const [isCheckingPublicRoom = true] = useOnyxWithMountReset(ONYXKEYS.IS_CHECKING_PUBLIC_ROOM, true);
