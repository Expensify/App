...
function Expensify() {
    ...
    useEffect(() => {
        ...
        Linking.getInitialURL().then((url) => {
            ...
            if (url) {
                openReportFromDeepLink(url, currentOnboardingPurposeSelected, currentOnboardingCompanySize, onboardingInitialPath, allReports, isAuthenticated, introSelected);
            } else {
        ...
        linkingChangeListener.current = Linking.addEventListener('url', (state) => {
            ...
            openReportFromDeepLink(state.url, currentOnboardingPurposeSelected, currentOnboardingCompanySize, onboardingInitialPath, allReports, isCurrentlyAuthenticated, introSelected);
        });
