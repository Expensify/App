    ...
    useEffect(() => {
        ...
        Linking.getInitialURL().then((url) => {
            ...
            if (url) {
                ...
                openReportFromDeepLink(url, allReports, isAuthenticated, introSelected, conciergeReportID);
            } else {
        ...
        linkingChangeListener.current = Linking.addEventListener('url', (state) => {
            ...
            openReportFromDeepLink(state.url, allReports, isCurrentlyAuthenticated, introSelected, conciergeReportID);
        });
