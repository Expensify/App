...
type OnyxValues = {
    ...
    [ONYXKEYS.FORMS.MONEY_REQUEST_HOLD_FORM]: OnyxTypes.MoneyRequestHoldReasonForm;
    [ONYXKEYS.FORMS.MONEY_REQUEST_HOLD_FORM_DRAFT]: OnyxTypes.MoneyRequestHoldReasonForm;
