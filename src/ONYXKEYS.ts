...
const ONYXKEYS = {
    ...
    /** Holds the saved view that is currently being edited via the "Edit filters" flow (null when not editing) */
    SEARCH_EDITING_SAVED_VIEW: 'searchEditingSavedView',

    /** The edited query string the narrow "Save as new view" flow carries to the save page (so it saves the edited filters without changing the active search) */
    SEARCH_SAVE_AS_NEW_VIEW_QUERY: 'searchSaveAsNewViewQuery',
...
type OnyxValuesMapping = {
    ...
    [ONYXKEYS.SEARCH_EDITING_SAVED_VIEW]: OnyxTypes.EditingSavedSearch;
    [ONYXKEYS.SEARCH_SAVE_AS_NEW_VIEW_QUERY]: string;
