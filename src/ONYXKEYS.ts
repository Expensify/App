...
const ONYXKEYS = {
    ...
    COLLECTION: {
        ...
        /** Stores the card's metadata, such as isLoading */
        WORKSPACE_CARDS_LIST_METADATA: 'cardsMetadata_',
...
type OnyxCollectionValuesMapping = {
    ...
    [ONYXKEYS.COLLECTION.WORKSPACE_CARDS_LIST_METADATA]: OnyxTypes.WorkspaceCardsList;
