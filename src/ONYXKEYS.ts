...
const ONYXKEYS = {
    ...
    COLLECTION: {
        ...
        /** Number of submitted but not yet approved expenses on a policy, used to offer applying a new/edited agent rule to them */
        POLICY_UNAPPROVED_EXPENSE_COUNT: 'policyUnapprovedExpenseCount_',
...
type OnyxCollectionValuesMapping = {
    ...
    [ONYXKEYS.COLLECTION.POLICY_UNAPPROVED_EXPENSE_COUNT]: number;
