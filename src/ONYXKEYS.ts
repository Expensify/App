...
const ONYXKEYS = {
    ...
    /** The app version that was confirmed to be a beta build. Equal to the running version while the app is in beta. */
    BETA_BUILD_VERSION: 'betaBuildVersion',
    ...
    /** The last OldDot staging toggle generation this app has accepted. Deliberate OldDot toggle changes arrive with
     * a higher generation; the ambient value OldDot sends on every transition carries none and is ignored. */
...
type OnyxValuesMapping = {
    ...
    [ONYXKEYS.BETA_BUILD_VERSION]: string;
