...
const ONYXKEYS = {
    ...
    FORMS: {
        ...
        FEEDBACK_SURVEY_FORM: 'feedbackSurveyForm',
        FEEDBACK_SURVEY_FORM_DRAFT: 'feedbackSurveyFormDraft',
...
type OnyxFormValuesMapping = {
    ...
    [ONYXKEYS.FORMS.FEEDBACK_SURVEY_FORM]: FormTypes.FeedbackSurveyForm;
