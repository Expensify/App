...
const ONYXKEYS = {
    ...
    COLLECTION: {
        ...
        REPORT_CANCEL_REIMBURSEMENT_STATUS: 'reportCancelReimbursementStatus_',
...
type OnyxCollectionValuesMapping = {
    ...
    [ONYXKEYS.COLLECTION.REPORT_CANCEL_REIMBURSEMENT_STATUS]: OnyxTypes.ReportCancelReimbursementStatus;
