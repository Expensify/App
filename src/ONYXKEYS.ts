...
const ONYXKEYS = {
    ...
    /** Set when we are fetching the card details for a single card from the server */
    IS_LOADING_CARD_DETAILS: 'isLoadingCardDetails',
...
type OnyxValuesMapping = {
    ...
    [ONYXKEYS.IS_LOADING_CARD_DETAILS]: boolean;
