...
const ONYXKEYS = {
    ...
    /** Stores the user's proactive app review prompt state and response */
    NVP_PROACTIVE_APP_REVIEW: 'nvp_proactiveAppReview',
...
type OnyxValuesMapping = {
    ...
    [ONYXKEYS.NVP_PROACTIVE_APP_REVIEW]: OnyxTypes.ProactiveAppReview;
