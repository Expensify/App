...
const ONYXKEYS = {
    ...
    COLLECTION: {
        ...
        /** Number of unsubmitted expenses on a policy, used to offer applying a new/edited agent rule to them */
        POLICY_UNSUBMITTED_EXPENSE_COUNT: 'policyUnsubmittedExpenseCount_',
...
type OnyxCollectionValuesMapping = {
    ...
    [ONYXKEYS.COLLECTION.POLICY_UNSUBMITTED_EXPENSE_COUNT]: number;
