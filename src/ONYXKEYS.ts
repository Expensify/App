...
const ONYXKEYS = {
    ...
    COLLECTION: {
        ...
        POLICY_MERGE_HR_COMPLETE_SETUP_AUTO_NAVIGATED: 'policyMergeHRCompleteSetupAutoNavigated_',
...
type OnyxCollectionValuesMapping = {
    ...
    [ONYXKEYS.COLLECTION.POLICY_MERGE_HR_COMPLETE_SETUP_AUTO_NAVIGATED]: boolean;
