...
const transactionData = {
    [`${ONYXKEYS.COLLECTION.TRANSACTION}FAKE_1`]: {transactionID: 'FAKE_1', amount: 1000, currency: 'USD', cardID: 4, merchant: 'United Airlines', mccGroup: 'Goods', created: '2023-07-24 13:46:20'},
    ...
    [`${ONYXKEYS.COLLECTION.TRANSACTION}FAKE_6`]: {transactionID: 'FAKE_6', amount: 333333, currency: 'USD', cardID: 4, merchant: 'Trader Joes', mccGroup: 'Groceries', created: '2023-12-24 13:46:20'},
    [`${ONYXKEYS.COLLECTION.TRANSACTION}FAKE_7`]: {transactionID: 'FAKE_7', amount: 1000, currency: 'USD', cardID: 4, merchant: "Linda's Place", mccGroup: 'Hotel', created: '2023-03-24 13:46:20'},
    [`${ONYXKEYS.COLLECTION.TRANSACTION}FAKE_8`]: {transactionID: 'FAKE_8', amount: 2000, currency: 'USD', cardID: 4, merchant: 'United Post Office', mccGroup: 'Mail', created: '2023-09-24 13:46:20'},
    [`${ONYXKEYS.COLLECTION.TRANSACTION}FAKE_9`]: {transactionID: 'FAKE_9', amount: 40884002, currency: 'USD', cardID: 4, merchant: 'Dishoom', mccGroup: 'Meals', created: '2023-07-24 13:46:20'},
    [`${ONYXKEYS.COLLECTION.TRANSACTION}FAKE_10`]: {transactionID: 'FAKE_10', amount: 300000, currency: 'USD', cardID: 4, merchant: 'Hertz', mccGroup: 'Rental', created: '2023-07-24 13:46:20'},
    [`${ONYXKEYS.COLLECTION.TRANSACTION}FAKE_11`]: {transactionID: 'FAKE_11', amount: 1000, currency: 'USD', cardID: 4, merchant: 'Laundromat', mccGroup: 'Services', created: '2023-07-24 13:46:20'},
    ...
    [`${ONYXKEYS.COLLECTION.TRANSACTION}FAKE_15`]: {transactionID: 'FAKE_15', amount: 200, currency: 'USD', cardID: 4, merchant: 'Invalid MCC', mccGroup: 'invalidMCC', created: '2023-01-11 13:46:20'},
