...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. 使用 ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} 按钮发送发票。`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `只需使用 ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} 按钮。`,
