...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            accountManager: '[zh-hans] Account Manager',
            accountManagerDescription: '提问并获取客户支持',
            partnerManager: '[zh-hans] Partner Manager',
            partnerManagerDescription: '最大化合作关系并推动推荐',
            guideDescription: '您的设置专员',
            approvedPartnerTeamTitle: '认识你的 Approved! 合作团队',
            approvedPartnerTeamDescription: '一支专注服务的专业团队，帮助贵公司成长、更快为客户办理开户，并在您需要时随时提供专家支持。',
            accountExecutive: '[zh-hans] Account Executive',
