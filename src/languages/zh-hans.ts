...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    multifactorAuthentication: {
        ...
        revoke: {
            title: '面容/指纹和通行密钥',
            explanation: '一个或多个设备上已启用面部/指纹或通行密钥验证。撤销访问权限后，该设备下次验证时需要输入魔法验证码。',
            confirmationPrompt: '确定要这样做吗？下次在该设备上验证时，您需要输入魔法验证码。',
            cta: '撤销访问权限',
            noDevices: '您尚未注册用于面容 / 指纹或通行密钥验证的任何设备。如果注册了设备，您就可以在此撤销其访问权限。',
            dismiss: '知道了',
            error: '请求失败。请稍后重试。',
            revoke: '撤销',
            confirmationPromptAll: '你确定吗？你在任何设备上进行下一次验证时都需要一个魔法代码。',
            ctaAll: '全部撤销',
            thisDevice: '此设备',
