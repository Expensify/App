...
${amount}，商户：${merchant} - 日期：${date}`,
        ...
        enterFourDigitPin: '为您的卡设置一个 4 位数的 PIN。',
        reenterPinToConfirm: '请重新输入 PIN 以确认。',
...
这里有一张*测试收据*，来展示它是如何运作的：`,
    ...
    domain: {
        ...
        members: {
            ...
            cannotSetVacationDelegateForMember: (email: string) => `无法为 ${email} 设置休假代理，因为 TA 目前是以下成员的代理：`,
        },
        common: {settings: '设置'},
