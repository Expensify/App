...
添加更多消费规则以保护公司现金流。`,
                ...
                maxAmountCurrencyMismatchPrompt: '要设置最高金额，请选择结算货币相同的卡片。',
                ...
                allCurrencies: '所有货币',
                permittedCurrenciesSubtitle: '选择允许所有货币或指定货币',
                settlementCurrencyPermittedSubtitle: '始终允许使用卡片结算货币',
                currenciesCurrencyMismatchTitle: '货币不匹配',
                currenciesCurrencyMismatchPrompt: '要设置首选货币，请选择以相同货币结算的银行卡。',
            },
            agentRules: {
                title: '代理规则',
