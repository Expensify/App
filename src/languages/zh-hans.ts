...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            addHomeAddress: {title: '添加您的家庭住址以进行距离追踪', subtitle: '账户', cta: '添加地址'},
    ...
    iou: {
        homeAddressRequired: {
            ...
            prompt: ({workspaceName}: {workspaceName: string}) =>
                workspaceName
                    ? `在开始记录出行距离之前，您需要在个人资料中添加家庭住址。${workspaceName} 会使用此地址计算通勤减免。`
                    : '在开始记录行程前，您需要在个人资料中添加家庭住址。此工作区会使用该地址计算通勤抵扣。',
            cta: '添加家庭住址',
        },
        amount: '金额',
        percent: '百分比',
...
${amount}，商户：${merchant} - 日期：${date}`,
    ...
    privatePersonalDetails: {
        ...
        legalLastName: '法定姓氏',
        address: '家庭住址',
        commuterExclusionsHint: ({workspaceName}: {workspaceName: string}) => `${workspaceName} 使用此地址来设置通勤免税项目。`,
        error: {
...
3. 订阅源启用后，点击下方的“提交”，我们会开始为你添加它。`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionDisabledHelp: '未从报销中排除任何通勤路程。',
                optionFixedDistanceTitle: '为每笔报销排除固定距离',
                optionFixedDistanceHelp: '从每笔报销中扣除相同的通勤距离。最适合每个工作日提交一笔报销的成员使用。',
                distanceLabel: '距离',
                summaryHomeAndOffice: '使用家庭和办公室地址',
                optionHomeAndOfficeTitle: '按家庭与办公室计算',
                optionHomeAndOfficeHelp: '使用成员的家庭住址、工作安排和办公地点分配来计算通勤排除项。',
                workspaceAddressRequired: {
                    title: '先别急…',
                    promptStart: '在先在 中添加办公地点之前，您无法启用“按家庭和办公室计算”设置',
                    linkText: '概览',
