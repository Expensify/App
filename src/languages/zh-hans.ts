...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        calendarOpened: '[zh-hans] calendar opened',
        send: '[zh-hans] Send',
        na: '[zh-hans] N/A',
...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        revealCardDetail: {
            couldNotReveal: "[zh-hans] We couldn't reveal your card details. Please try again.",
        },
    },
    validateCodeModal: {
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            unlockBankAccount: {
                workspaceTitle: '[zh-hans] Your business bank account has been locked',
                personalTitle: '[zh-hans] Your bank account has been locked',
                workspaceSubtitle: ({policyName}: {policyName: string}) => policyName,
                personalSubtitle: '[zh-hans] Wallet',
            },
        },
        freeTrialSection: {
        ...
        yourSpend: {
            title: '[zh-hans] Your spend',
            awaitingApproval: '[zh-hans] Awaiting approval',
            repaidLast30Days: '[zh-hans] Repaid in the last 30 days',
            recentTransactions: ({lastFour}: {lastFour: string}) => `[zh-hans] Recent transactions • ${lastFour}`,
        },
        seeMore: ({count}: {count: number}) => `[zh-hans] See ${count} more`,
        ...
        gettingStartedSection: {
            ...
            inviteAccountant: '[zh-hans] Invite your accountant',
    ...
    spreadsheet: {
        ...
        importCompanyCardTransactionsPendingMessage: '[zh-hans] New cards and transactions may take some time to appear, please hang tight.',
    ...
    iou: {
        ...
        movedFromReport: (reportName: string) => `[zh-hans] moved an expense from ${reportName}`,
        movedFromReportNoName: '[zh-hans] moved an expense',
        movedTransactionTo: (reportUrl: string, reportName: string) => `[zh-hans] moved this expense to <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionToAnotherReport: '[zh-hans] moved this expense to another report',
        movedTransactionFrom: (reportUrl: string, reportName: string) => `[zh-hans] moved this expense from <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionFromAnotherReport: '[zh-hans] moved this expense from another report',
        ...
        allTransactionsPendingNextStep: "[zh-hans] All transactions are pending. You can't submit this report until they post in a few days.",
        ...
        confirmPaymentReceivedModalTitle: '[zh-hans] Confirm payment received',
        receivedPayment: '[zh-hans] Received payment',
        receivedPaymentConfirmation: "[zh-hans] Please proceed only if you've already received payment outside of Expensify.",
        confirmReceivedPayment: "[zh-hans] Yes, I've received payment",
        ...
        updatedTheRequest: (valueName: string, newValueToDisplay: string, oldValueToDisplay: string) =>
        ...
        error: {
            ...
            invalidReadings: '[zh-hans] Please enter both start & end readings to continue',
            ...
            unableToSubmitReport: '[zh-hans] Unable to submit report',
            allTransactionsPendingDescription: "[zh-hans] You can't submit this report because all transactions are pending. They may take a few days to post.",
            failedToSaveOdometerDraft: "[zh-hans] Couldn't save your odometer draft. Please try again.",
            ...
            receiptUploadFailedMessage: '[zh-hans] Receipt upload failed. Save the receipt, or delete the expense and lose it.',
            saveReceipt: '[zh-hans] Save receipt',
        ...
        changeApprover: {
            ...
            reassignedApproverMessage: (managerID: number) => `[zh-hans] reassigned the approver to <mention-user accountID="${managerID}"/> via a workflow update`,
            actions: {
    ...
    deviceManagementPage: {
        title: '[zh-hans] Device management',
        description:
            '[zh-hans] Manage all the devices that you have logged into with your Expensify Account. <a href="https://help.expensify.com/articles/new-expensify/settings/Manage-Logged-in-Devices">Learn more</a>.',
        revoke: '[zh-hans] Revoke',
        unknownDevice: '[zh-hans] Unknown Device',
    },
    twoFactorAuth: {
        ...
        downloadCodes: '[zh-hans] Download codes',
        ...
        keepCodesSafe: '[zh-hans] Keep these codes safe!',
        ...
        `),
        screenshotTip: '[zh-hans] Tip: Screenshot this to save it to your photo library',
    ...
    walletPage: {
        ...
        cardActive: '[zh-hans] Active',
        bankAccountStatus: {
            active: '[zh-hans] Active',
            incomplete: '[zh-hans] Incomplete',
            pending: '[zh-hans] Pending',
            verifying: '[zh-hans] Verifying',
            locked: '[zh-hans] Locked',
            incompleteDescription: '[zh-hans] Finish adding bank account',
            pendingDescription: '[zh-hans] Please confirm test transactions',
            verifyingDescription: "[zh-hans] We're reviewing your documentation",
            lockedDescription: '[zh-hans] This account requires attention',
            finish: '[zh-hans] Finish',
            confirm: '[zh-hans] Confirm',
            unlock: '[zh-hans] Unlock',
        },
        cardFixConnection: '[zh-hans] Please fix this connection',
        cardAskAdminToFix: '[zh-hans] Please ask an admin to fix this connection',
        cardAdminFixConnection: '[zh-hans] Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `[zh-hans] Last synced ${dateStr}`,
        assignedCards: '[zh-hans] Cards',
        assignedCardsDescription: '[zh-hans] Transactions from assigned cards sync automatically.',
...
${amount} for ${merchant} - ${date}`,
        ...
        cardUnblocked: '[zh-hans] Card unblocked!',
        cardUnblockedDescription: '[zh-hans] You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: '[zh-hans] Your card was blocked due to incorrect PIN entries.',
        unblock: '[zh-hans] Unblock',
        unblockCard: '[zh-hans] Unblock card',
    ...
    workflowsPage: {
        ...
        configureViaHR: ({provider}: {provider: string}) => `[zh-hans] Configure via ${provider}.`,
        hrApprovalWorkflowLockedPrompt: ({provider}: {provider: string}) =>
            `[zh-hans] Approvals are managed by your ${provider} integration. To update your approval workflow, head to your ${provider} connection settings.`,
        goToHRSettings: ({provider}: {provider: string}) => `[zh-hans] Go to ${provider} settings`,
    ...
    reportFraudConfirmationPage: {
        ...
        descriptionCardNotReplaced: '[zh-hans] Your card was permanently deactivated. Please contact an admin to issue a new card.',
    ...
    agentsPage: {
        title: '[zh-hans] Agents',
        subtitle: '[zh-hans] Create agents to handle your workflow. Skip the manual work and get hours back in your day.',
        newAgent: '[zh-hans] New agent',
        emptyAgents: {
            title: '[zh-hans] No agents created',
            subtitle: '[zh-hans] Stop manually doing stuff. Instruct an agent instead and save yourself lots of time.',
        },
        error: {
            genericAdd: '[zh-hans] There was a problem adding this agent',
            genericUpdate: '[zh-hans] There was a problem updating this agent',
            updateName: "[zh-hans] There was a problem updating this agent's name",
            updatePrompt: "[zh-hans] There was a problem updating this agent's instructions",
            updateAvatar: "[zh-hans] There was a problem updating this agent's avatar",
        },
    },
    addAgentPage: {
        title: '[zh-hans] New agent',
        agentName: '[zh-hans] Agent name',
        instructions: '[zh-hans] Write custom instructions',
        createAgent: '[zh-hans] Create agent',
        editAvatar: '[zh-hans] Edit avatar',
        defaultAgentName: (displayName: string) => `[zh-hans] ${displayName}'s Agent`,
        defaultPrompt:
            "[zh-hans] Reject expenses that are for gambling, movies, or other obvious non-business reasons.\n\nRemind the user to always include a receipt image that makes the tip clear.\n\nApprove the report if it's very similar to previous reports from the same user.\n\nReject reports with more than $500 in travel expenses.",
    },
    editAgentPage: {
        title: '[zh-hans] Edit agent',
        agentName: '[zh-hans] Agent name',
        instructions: '[zh-hans] Write custom instructions',
        deleteAgent: '[zh-hans] Delete agent',
        deleteAgentTitle: '[zh-hans] Delete agent?',
        deleteAgentMessage: '[zh-hans] Are you sure you want to delete this agent? This action cannot be undone.',
    },
    editAgentAvatarPage: {
        title: '[zh-hans] Edit avatar',
    },
    editAgentNamePage: {
        title: '[zh-hans] Agent name',
    },
    editAgentPromptPage: {
        title: '[zh-hans] Write custom instructions',
        error: {
            emptyPrompt: '[zh-hans] Please enter instructions for your agent.',
        },
    },
    expenseRulesPage: {
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '[zh-hans] <strong>Avoid scams. Do not share your code with anyone.</strong> Our team will never call, text, or email you for this code.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[zh-hans] Here's the list of workspaces you can join.",
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: '[zh-hans] Submit expenses to my employer',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "[zh-hans] Manage my team's expenses",
            [CONST.ONBOARDING_CHOICES.TRACK_BUSINESS]: '[zh-hans] Track expenses for my business',
            [CONST.ONBOARDING_CHOICES.TRACK_PERSONAL]: '[zh-hans] Organize my personal spending',
        ...
        workEmail2FAError: '[zh-hans] This login is an existing account with Two-Factor Authentication (2FA) enabled.',
        mergeBlockScreen: {
            ...
            workAccountClosedSubtitle:
                '[zh-hans] The work account associated with this email is closed. Please contact your company admin to reactivate it, or sign up with a different email.',
        },
        tasks: {
            testDriveAdminTask: {
    ...
    statusPage: {
        ...
        addVacationDelegate: '[zh-hans] Add vacation delegate',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    addPersonalBankAccount: {
        ...
        updatePersonalInfo: '[zh-hans] Update bank account',
        updatePersonalInfoFailure: '[zh-hans] Unable to update bank account information. Please try again later.',
        updateSuccessTitle: '[zh-hans] Bank account updated!',
        updateSuccessHeader: '[zh-hans] Bank account updated',
        updateSuccessMessage: '[zh-hans] Congrats, your bank account is set up and ready to receive reimbursements.',
    },
    ...
    messages: {
        ...
        userIsAlreadyMember: (login: string, name: string) => `[zh-hans] ${login} is already a member of ${name}`,
        userIsAlreadyAnAdmin: (login: string, name: string) => `[zh-hans] ${login} is already an admin of ${name}`,
    },
    onfidoStep: {
    ...
    workspace: {
        common: {
            ...
            cardAdminAlternateText: '[zh-hans] Manage workspace cards.',
            peopleAdminAlternateText: '[zh-hans] Manage members and approval workflows.',
            paymentsAdminAlternateText: '[zh-hans] Manage workflow payments.',
            reimbursementChoice: {
            ...
            roleName: (role?: string) => {
                switch (role) {
                    ...
                    case CONST.POLICY.ROLE.CARD_ADMIN:
                        return '[zh-hans] Card Admin';
                    case CONST.POLICY.ROLE.PEOPLE_ADMIN:
                        return '[zh-hans] People Admin';
                    case CONST.POLICY.ROLE.PAYMENTS_ADMIN:
                        return '[zh-hans] Payments Admin';
            ...
            travelInvoicing: '[zh-hans] Export travel invoicing expenses as',
            travelInvoicingVendor: '[zh-hans] Travel vendor',
            travelInvoicingPayableAccount: '[zh-hans] Travel payable account',
        },
        createdForClient: {
            title: "[zh-hans] You've created a workspace for your client!",
            description: '[zh-hans] Great news 🎉. Reach out to us if they need any help with the setup.',
        },
        receiptPartners: {
            uber: {
        ...
        qbo: {
            ...
            bankAccountDescription: '[zh-hans] Choose where to send checks from.',
            creditCardAccount: '[zh-hans] Credit card account',
            travelInvoicingDescription: '[zh-hans] Travel expenses will export as credit card charges to the QuickBooks Online account specified below.',
        ...
        xero: {
            ...
            travelInvoicingDescription: '[zh-hans] Travel expenses will export as bank transactions to the Xero account specified below.',
        ...
        sageIntacct: {
            ...
            travelInvoicingDescription: '[zh-hans] Travel expenses will export as credit card charges to the Sage Intacct account specified below.',
            creditCardAccount: '[zh-hans] Credit card account',
        ...
        certinia: {
            title: '[zh-hans] Certinia',
            prerequisites: {
                title: '[zh-hans] Before you connect',
                installBundle: '[zh-hans] For FFA Connections',
                installBundleDescription: ({href, version}: {href: string; version: string}) =>
                    `[zh-hans] Install the Expensify bundle in Salesforce by clicking this link: <a href="${href}">Install FFA Expensify Bundle (Version ${version})</a>`,
                installBundleConfirm: "[zh-hans] I've installed the bundle",
                setupContacts: '[zh-hans] Set up user and contacts',
                setupContactsBullet1:
                    "[zh-hans] Create both a User and a Contact for yourself if these don't already exist in Certinia making sure the email matches your primary email in Expensify.\n\n",
                setupContactsBullet2:
                    "[zh-hans] Create contacts for each employee who will be submitting expense reports and for each report approver. Make sure each contact's email address corresponds with the email address on the employee's Expensify account.\n\n",
                setupContactsBullet3: '[zh-hans] Set permission controls for your user for each contact/resource.\n\n',
                setupContactsConfirm: "[zh-hans] I've set up the user and contacts",
                oauth: '[zh-hans] Log in through Salesforce',
                oauthDescription: "[zh-hans] To finish setup, you'll have to sign in through Salesforce and Certinia.\n\nUse the button below to continue.",
                connectButton: '[zh-hans] Connect to Certinia',
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '[zh-hans] Single entry for each expense',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '[zh-hans] Single, itemized entry for each report',
                },
            },
            invoiceItem: {
...
_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                fileImportDescription: "[zh-hans] A manual option if your bank can't send a feed.",
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                duplicateFeedModal: {
                    title: '[zh-hans] Card feed already connected',
                    prompt: "[zh-hans] You can't add the same card feed to the same workspace twice.",
                },
                csvColumns: {
        ...
        expensifyCard: {
            ...
            exportAsCSV: '[zh-hans] Export as CSV',
            csvColumnType: '[zh-hans] Type',
            csvColumnLimitType: '[zh-hans] Limit type',
            csvColumnLimit: '[zh-hans] Limit',
            findCard: '[zh-hans] Find card',
            ...
            applyCashbackToBill: '[zh-hans] Apply cash back to my Expensify bill',
            applyCashbackToBillDescription: '[zh-hans] Cash back from the Expensify Card will be used towards payment for your Expensify bill.',
            frequency: {
                daily: '[zh-hans] Daily',
                monthly: '[zh-hans] Monthly',
            },
        ...
        moreFeatures: {
            ...
            travel: {
                ...
                travelInvoicing: {
                    ...
                    travelInvoicingSection: {
                        title: '[zh-hans] Travel invoicing',
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[zh-hans] We weren't able to provision some of the members of your workspace for travel invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[zh-hans] Travel Invoicing enabled!',
            ...
            hrWarningModal: {
                disconnectText: ({integration}: {integration: string}) => `[zh-hans] To disable HR, please disconnect ${integration} from this workspace first.`,
            },
        ...
        copyPolicySettings: {
            error: '[zh-hans] An error occurred while copying workspace settings. Please try again.',
            title: '[zh-hans] Copy settings',
            selectWorkspaces: '[zh-hans] Select workspaces',
            description: '[zh-hans] Choose the workspaces you want to copy settings to, then select the settings you’d like to copy.',
            searchPlaceholder: '[zh-hans] Search workspaces',
        },
        emptyWorkspace: {
        ...
        people: {
            ...
            configureHRSync: (providerName: string) => `[zh-hans] Configure ${providerName} sync.`,
            syncWithHR: (providerName: string) => `[zh-hans] Sync with ${providerName}`,
            allMembers: '[zh-hans] All members',
            admins: '[zh-hans] Admins',
            approvers: '[zh-hans] Approvers',
            auditors: '[zh-hans] Auditors',
            emptyRoleFilter: {
                title: '[zh-hans] No members match this filter',
                subtitle: '[zh-hans] Invite a member or change the filter above.',
            },
        ...
        accounting: {
            ...
            updateCredentials: '[zh-hans] Update credentials',
            claimOffer: {
            ...
            syncTravelInvoicingSettlements: '[zh-hans] Sync travel invoicing settlements',
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '[zh-hans] Choose the bank account that your travel invoicing payments will be reconciled against.',
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `[zh-hans] Make sure this account matches your travel invoicing settlement account (ending in ${lastFourPAN}) so Continuous Reconciliation works properly.`,
            },
        },
        hr: {
            title: '[zh-hans] HR',
            connections: '[zh-hans] Connections',
            subtitle: '[zh-hans] Connect HR tools and keep employee approvals in sync.',
            connect: '[zh-hans] Connect',
            syncNow: '[zh-hans] Sync now',
            disconnect: '[zh-hans] Disconnect',
            disconnectTitle: (providerName: string) => `[zh-hans] Disconnect ${providerName}`,
            disconnectPrompt: (providerName: string) => `[zh-hans] Are you sure you want to disconnect ${providerName}?`,
            alreadyConnectedTitle: '[zh-hans] Cannot connect to multiple HR platforms',
            alreadyConnectedPrompt: '[zh-hans] You must disconnect your current HR platform before connecting another.',
            lastSync: (relativeDate: string) => `[zh-hans] Last synced ${relativeDate}`,
            syncError: (providerName: string) => `[zh-hans] Can't connect to ${providerName}`,
            connectionDescription: (providerName: string) => `[zh-hans] Connect ${providerName} to keep employee approvals in sync with your workspace.`,
            approvalMode: '[zh-hans] Approval mode',
            providerApprovalMode: (providerName: string) => `[zh-hans] ${providerName} approval mode`,
            finalApprover: '[zh-hans] Final approver',
            providerFinalApprover: (providerName: string) => `[zh-hans] ${providerName} final approver`,
            notSet: '[zh-hans] Not set',
            syncing: '[zh-hans] Syncing employees',
            syncingModalTitle: '[zh-hans] Your connection is syncing',
            syncingModalDescription: "[zh-hans] The first connection can take some time. You'll be notified of any errors.",
            approvalModeDescription: (providerName: string) => `[zh-hans] Members and managers are set up to sync with ${providerName}.`,
            approvalModeWarningTitle: '[zh-hans] Change approval mode?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `[zh-hans] Are you sure you would like to change the approval mode for this workspace? Learn more about the different ${providerName}-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
            approvalModeWarningConfirm: '[zh-hans] Change approval mode',
            approvalModes: {
                basic: {label: '[zh-hans] Basic approval', description: '[zh-hans] All users submit to a single person for processing and approval.'},
                manager: {
                    label: '[zh-hans] Manager approval',
                    description: (providerName: string) => `[zh-hans] Employees submit reports to their direct manager configured in ${providerName}.`,
                },
                custom: {label: '[zh-hans] Custom approval', description: "[zh-hans] I'll manually setup approval workflows in Expensify."},
            },
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
                        return '[zh-hans] Synchronizing Gusto Employees';
                    case 'gustoSyncLoadData':
                        return '[zh-hans] Loading data from Gusto';
                    case 'gustoSyncProvisioning':
                        return '[zh-hans] Provisioning employees in policy';
                    case 'zenefitsSyncTitle':
                        return '[zh-hans] Synchronizing TriNet Employees';
                    case 'zenefitsSyncLoadData':
                        return '[zh-hans] Loading data from TriNet';
            ...
            syncResults: {
                title: (provider: string) => `[zh-hans] ${provider} sync complete`,
                successTitle: (provider: string) => `[zh-hans] Successfully synced your ${provider} connection!`,
                added: '[zh-hans] Added',
                removed: '[zh-hans] Removed',
                skipped: '[zh-hans] Skipped',
                employeeCount: () => ({
                    one: '[zh-hans] 1 employee',
                    other: (count: number) => `[zh-hans] ${count} employees`,
                }),
            },
            gusto: {
                title: '[zh-hans] Gusto',
        ...
        distanceRates: {
            ...
            amountPerUnit: (unit: string) => `[zh-hans] Amount per ${unit}`,
            startDate: '[zh-hans] Start date',
            endDate: '[zh-hans] End date',
            errors: {
                rateNameRequired: '[zh-hans] Rate name is required',
                existingRateName: '[zh-hans] A distance rate with this name already exists',
                nameRequired: '[zh-hans] Name is required',
                amountRequired: '[zh-hans] Amount is required',
                startDateMustBeBeforeEndDate: '[zh-hans] Start date must be before end date',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            yourWorkspace: `[zh-hans] Your workspace is set to an unsupported currency. View the <a href="${CONST.ENABLE_GLOBAL_REIMBURSEMENT_HELP_URL}">list of supported currencies</a>.`,
...
Are you sure you want to export them again?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.CERTINIA]: {
                title: '[zh-hans] Certinia',
                description: `[zh-hans] Enjoy automated syncing and reduce manual entries with the Expensify + Certinia integration. Align expense coding dimensions and tax sync with your Certinia setup for clearer financial visibility.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>Our Certinia integration is only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            ...
            approvalSubmit: {
                title: '[zh-hans] Approvals',
                description: '[zh-hans] Centrally configure who all members submit to by enabling approvals.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>Approvals are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            categories: {
                title: '[zh-hans] Categories',
            ...
            companyCardSubmit: {
                title: '[zh-hans] Company cards',
                description: `[zh-hans] Bring your own company card to Expensify to get automatic import, automatic categorization, customizable rule support, and integrated reconciliation.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>Company card import is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            rules: {
                title: '[zh-hans] Rules',
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            travelSubmit: {
                title: '[zh-hans] Expensify Travel',
                description: '[zh-hans] Book discounted flights, hotels, cars, and trains globally from within Expensify, with duty of care reporting and integrated expense management.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>Expensify Travel is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            reports: {
            ...
            roles: {
                title: '[zh-hans] Roles',
                description: '[zh-hans] Assign different roles to different members to increase or decrease visibility and control as appropriate.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>Roles are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            payments: {
                title: '[zh-hans] Payments',
                description: '[zh-hans] Reimburse employees directly from your business bank account.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>Payments are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            accounting: {
                title: '[zh-hans] Accounting',
                description:
                    '[zh-hans] Sync categories, tags, tax rates, and more from your accounting system to Expensify, as well as export expense reports and card transactions – no typing (or typos) involved!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>Accounting is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            expensifyCard: {
                title: '[zh-hans] Expensify Card',
                description:
                    '[zh-hans] Issue company cards (including virtual cards) directly from your own bank account to get realtime spend control with an unbreakable connection, and up to 2% cashback!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>The Expensify Card is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
                upgradeButton: '[zh-hans] Upgrade and enable',
            },
            invoicing: {
                title: '[zh-hans] Invoicing',
                description: '[zh-hans] Create, send, and track professional invoices, all inside Expensify. Get paid faster with integrated payments and real-time visibility.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[zh-hans] <muted-text>Invoicing is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[zh-hans] per member per month.` : `[zh-hans] per active member per month.`}</muted-text>`,
            },
            pricing: {
                perActiveMember: '[zh-hans] per active member per month.',
                perMember: '[zh-hans] per member per month.',
            },
            note: (subscriptionLink: string) => `[zh-hans] <muted-text><a href="${subscriptionLink}">Learn more</a> about our plans and pricing.</muted-text>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                giftCard: '[zh-hans] Gift card purchases',
                handwrittenReceipt: '[zh-hans] Handwritten receipts',
...
Add more spend rules to protect company cash flow.`,
        ...
        planTypePage: {
            planTypes: {
                ...
                submit2026: {
                    label: '[zh-hans] Submit',
                    description: '[zh-hans] For employees looking to submit expenses to their employer.',
                },
            },
            description: "[zh-hans] Choose a plan that's right for you.",
            subscriptionLink: '[zh-hans] Learn more',
    ...
    workspaceActions: {
        ...
        updatedRequireCompanyCards: ({enabled}: {enabled: boolean}) => `[zh-hans] ${enabled ? '[zh-hans] enabled' : '[zh-hans] disabled'} the company card purchases requirement`,
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `[zh-hans] set itemized receipt required amount to "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) => `[zh-hans] changed itemized receipt required amount to "${newValue}" (previously "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `[zh-hans] removed itemized receipt required amount (previously "${oldValue}")`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            editMultipleDescription: '[zh-hans] Changes will be set for all selected expenses and will override any previously set values.',
            approve: '[zh-hans] Approve',
            pay: '[zh-hans] Pay',
            delete: '[zh-hans] Delete',
            hold: '[zh-hans] Hold',
        ...
        filters: {
            ...
            card: {
                ...
                travelInvoicing: '[zh-hans] Travel invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[zh-hans] Travel invoicing',
            },
            is: '[zh-hans] Is',
            action: {
        ...
        askConcierge: (message: string) => `[zh-hans] Ask Concierge “${message}”`,
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    travelCardLink: '[zh-hans] travel card expenses',
    ...
    chronos: {
        ...
        stopTimer: (duration: string) => `[zh-hans] Stop Timer (${duration})`,
    ...
    accessibilityHints: {
        ...
        openActionsMenu: '[zh-hans] Open actions menu',
        selectAllCategories: '[zh-hans] Select all categories',
        selectAllDistanceRates: '[zh-hans] Select all distance rates',
        selectAllTags: '[zh-hans] Select all tags',
        selectAllTaxes: '[zh-hans] Select all taxes',
        selectAllPerDiemRates: '[zh-hans] Select all per diem rates',
        selectAllMembers: '[zh-hans] Select all members',
        selectAllValues: '[zh-hans] Select all values',
        selectAllRules: '[zh-hans] Select all rules',
    },
    parentReportAction: {
    ...
    cardTransactions: {
        ...
        expensifyCard: '[zh-hans] Expensify Card',
        travelInvoicing: '[zh-hans] Travel invoicing',
        travelCard: '[zh-hans] Travel Card',
    },
    distance: {
    ...
    gps: {
        ...
        liveActivity: {
            ...
            lockScreenBadgeText: '[zh-hans] Distance',
            lockScreenTrackingText: '[zh-hans] Tracking...',
    ...
    violations: {
        ...
        missingTag: (tagName?: string) => `[zh-hans] Missing ${tagName ?? '[zh-hans] tag'}`,
        ...
        prohibitedExpense: (prohibitedExpenseTypes: string | string[]) => {
            ...
            const getProhibitedExpenseTypeText = (prohibitedExpenseType: string) => {
                switch (prohibitedExpenseType) {
                    ...
                    case 'giftCard':
                        return `[zh-hans] gift card purchases`;
                    case 'handwrittenReceipt':
                        return `[zh-hans] handwritten receipts`;
                    default:
        ...
        smartscanFailed: ({canEdit = true, missingFields = []}: {canEdit?: boolean; missingFields?: string[]}) => {
            if (missingFields.length > 0) {
                const fieldNames: Record<string, string> = {merchant: '[zh-hans] merchant', date: '[zh-hans] date', amount: '[zh-hans] amount'};
                const translated = missingFields.map((f) => fieldNames[f] ?? f);
                let fieldList = '';
                if (translated.length === 1) {
                    fieldList = translated.at(0) ?? '';
                } else if (translated.length === 2) {
                    fieldList = translated.join('[zh-hans]  and ');
                } else {
                    fieldList = `${translated.slice(0, translated.length - 1).join(', ')}, and ${translated.at(-1)}`;
                }
                return `[zh-hans] Receipt scanning failed — missing ${fieldList}.${canEdit ? '[zh-hans]  Enter details manually.' : ''}`;
            }
            return `[zh-hans] Receipt scanning failed.${canEdit ? '[zh-hans]  Enter details manually.' : ''}`;
        },
    ...
    exitSurvey: {
        ...
        goBackJustOnce: '[zh-hans] Go back just once',
    },
    listBoundary: {
    ...
    delegate: {
        ...
        switch: '[zh-hans] Switch',
        copilot: '[zh-hans] Copilot',
        ...
        addCopilot: '[zh-hans] Add a copilot to your account',
        membersCanAccessYourAccount: '[zh-hans] These members can access your account:',
        youCanAccessTheseAccounts: '[zh-hans] You can access these accounts:',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            error: {
                ...
                moveMemberNotPolicyAdmin:
                    '[zh-hans] Cannot move member to the domain group. You must be a Policy Admin for the Preferred Policy set on the domain group you are trying to move this user to.',
            },
        ...
        groups: {
            ...
            createGroupError: '[zh-hans] Unable to create this group. Please try again.',
            permissions: '[zh-hans] Group permissions',
            createNewGroupButton: '[zh-hans] New group',
            createGroupSubmitButton: '[zh-hans] Create group',
            expensifyCardPreferredWorkspace: '[zh-hans] Expensify Card preferred workspace',
            expensifyCardPreferredWorkspaceDescription:
                '[zh-hans] All Expensify Card transactions will be created on the Expensify Card Preferred Workspace instead of the Preferred Workspace. Enabling this feature will override the Preferred Workspace setting for Expensify Card transactions only.',
            strictlyEnforceWorkspaceRules: '[zh-hans] Strictly enforce workspace rules',
            strictlyEnforceWorkspaceRulesDescription: '[zh-hans] All workspace rules must be met before submitting a report. No manual exceptions allowed.',
            restrictExpenseWorkspaceCreation: '[zh-hans] Restrict expense workspace creation/removal',
            restrictExpenseWorkspaceCreationDescription:
                '[zh-hans] Prevent members from being able to create an expense workspace or remove themselves from an expense workspace. This is useful for preventing people from using Expensify to submit reports for use outside your domain when combined with strict workspace enforcement.',
            deleteGroup: '[zh-hans] Delete Group',
            deleteGroupDangerConfirmationModal: '[zh-hans] Delete Group',
            deleteGroupDangerConfirmationModalDescription: (defaultGroupName: string) =>
                `[zh-hans] Are you sure? This will reassign all members to the default group (${defaultGroupName}) and can't be undone.`,
            deleteGroupError: '[zh-hans] Unable to delete this group. Please try again.',
            preferredWorkspace: '[zh-hans] Preferred Workspace',
            preferredWorkspaceDescription: (enabled: boolean) =>
                `[zh-hans] All new reports and expenses will be created on ${enabled ? '[zh-hans] selected preferred' : '[zh-hans] this'} workspace.`,
            preferredWorkspaceSelectDescription: '[zh-hans] All new expenses and reports will be created on this workspace.',
            noWorkspacesMessage: '[zh-hans] There are no workspaces on this domain. A workspace is required to enable this restriction.',
            restrictDefaultLoginSelection: '[zh-hans] Restrict default login selection',
            restrictDefaultLoginSelectionDescription: '[zh-hans] Prevent members from changing their login email away from their company domain to avoid policy restrictions.',
            expensifyCardPreferredWorkspaceDisabledMessage: '[zh-hans] To enable this setting, please first enable a preferred workspace and set up Expensify Cards on your domain.',
            findGroup: '[zh-hans] Find group',
        },
    },
};
