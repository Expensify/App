        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    ...
                    noRegularWorkplaceHelp: '成员远程工作或没有固定工作地点，因此通勤规则不适用。',
                    startingPrompt: {
                        title: '设置常规工作安排',
                        prompt: '选择最适用于当前大多数成员的安排。您之后可以单独或批量更新成员。',
                        officeBasedHelp: '大多数成员通勤到办公室。普通通勤不包括在内。',
                        noRegularWorkplaceHelp: '大多数成员远程工作，因此通常不适用“从家到工作地点”的排除规则。',
                        confirm: '应用',
                    },
                },
            },
