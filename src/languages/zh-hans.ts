...
${amount}，商户：${merchant} - 日期：${date}`,
    ...
    privatePersonalDetails: {
        ...
        address: '地址',
        homeAddress: '家庭地址',
        commuterExclusionsNote: ({workspaceName}: {workspaceName: string}) => `${workspaceName} 将此地址用于通勤排除规则。`,
        error: {
...
3. 订阅源启用后，点击下方的“提交”，我们会开始为你添加它。`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: '从每次距离申报中扣除每位成员住所与工作区地址之间的通勤距离。',
                workspaceAddressRequired: {
                    title: '哎呀，等一下...',
                    prompt: '此工作区还没有地址。请添加一个，以便通勤排除规则可以使用它。',
                    cta: '添加地址',
                },
                errors: {
                    distanceMustBePositive: '距离必须大于 0。',
