...
添加更多消费规则以保护公司现金流。`,
                ...
                maxAmountCurrencyMismatchPrompt: '要设置最大金额，请选择结算货币相同的卡片。',
                ...
                currenciesCurrencyMismatchPrompt: '要设置首选货币，请选择以相同货币结算的卡片。',
                restrictMerchantsOffSubtitle: '在允许的货币中，金额不超过上限的消费将获批准',
                restrictMerchantsAllowSubtitle: '在货币被允许且金额不超过最高限额，并且商户或商户类型匹配的情况下，消费会被批准。',
                restrictMerchantsBlockSubtitle: '对于允许的货币中，若消费金额不超过最大限额，或商户/商户类型匹配，则费用将被批准。',
            },
            agentRules: {
                title: '代理规则',
