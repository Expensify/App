...
添加更多消费规则以保护公司现金流。`,
                ...
                restrictionTypeHelpAllow: '如果消费匹配任意商户或类别，且未超过最高金额，则会被批准。',
                restrictionTypeHelpBlock: '如果消费与任一商家或类别匹配，或超出最高金额限制，将被拒付。',
                addMerchant: '添加商家',
                merchantContains: '商户包含',
                merchantExactlyMatches: '商家完全匹配',
                noBlockedMerchants: '没有被拦截的商家',
                addMerchantToBlockSpend: '添加要拦截消费的商家',
                noAllowedMerchants: '无允许的商家',
                addMerchantToAllowSpend: '添加商家以允许消费',
                matchType: '匹配类型',
                matchTypeContains: '包含',
                matchTypeExact: '完全匹配',
                spendCategory: '支出类别',
                ...
                currencyMismatchPrompt: '要设置最高金额，请选择以相同货币结算的卡片。',
                reviewSelectedCards: '查看已选卡片',
                merchantsMoreCount: ({summary, count}: {summary: string; count: number}) => `${summary}，还有 +${count} 个`,
                confirmErrorApplyAtLeastOneSpendRuleToOneCard: '至少将一条消费规则应用到一张卡片',
                confirmErrorCardRequired: '卡是必填字段',
                confirmErrorApplyAtLeastOneSpendRule: '请至少应用一条支出规则',
                categories: '类别',
                merchants: '商家',
                max: '最大',
            },
