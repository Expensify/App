...
添加更多消费规则以保护公司现金流。`,
                ...
                restrictionTypeHelpAllow: '如果符合任一商户或类别，且未超过最大金额，则费用将被批准。',
                restrictionTypeHelpBlock: '如果交易符合任一商户或类别，或超过最高金额，将被拒绝。',
                addMerchant: '添加商户',
                merchantContains: '商家包含',
                merchantExactlyMatches: '商户完全匹配',
                noBlockedMerchants: '没有被屏蔽的商户',
                addMerchantToBlockSpend: '添加要限制消费的商户',
                ...
                spendCategory: '支出类别',
                maxAmount: '最高金额',
                maxAmountHelp: '无论商户或支出类别限制如何，任何超过此金额的消费都会被拒绝。',
                currencyMismatchTitle: '货币不匹配',
                currencyMismatchPrompt: '要设置最高金额，请选择以同一货币结算的卡。',
                reviewSelectedCards: '查看已选择的卡片',
                merchantsMoreCount: ({summary, count}: {summary: string; count: number}) => `${summary}，以及另外 +${count} 项`,
            },
        },
        planTypePage: {
            planTypes: {
