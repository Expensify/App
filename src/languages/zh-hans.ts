        ...
        recruiting: {
            ...
            filters: {
                ...
                stages: {
                    ...
                    toggleTitle: '导入作业阶段',
                    allSelected: '所有职位阶段',
                    emptySelectionError: '请至少选择一个职位阶段',
                },
                tags: {title: '标签', description: '选择要与此工作区同步的候选人标签', toggleTitle: '导入标签', allSelected: '所有标签', emptySelectionError: '请至少选择一个标签'},
                offices: {title: '办公室', description: '选择你想与此工作区同步的候选人办公室', toggleTitle: '导入办公室（可选）', allSelected: '所有办公室'},
            },
