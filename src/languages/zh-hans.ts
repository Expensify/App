...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        changeApprover: {
            ...
            addApprover: {subtitle: '在我们将此报告路由到其余审批工作流之前，为此报告选择一个额外的审批人。', bulkSubtitle: '在我们将这些报告通过其余审批流程之前，选择一位额外的审批人。'},
            bulkSubtitle: '选择一个选项来更改这些报告的审批人。',
        },
...
${merchant}的${amount} - ${date}`,
    ...
    workflowsPage: {
        ...
        emptyContent: {
            ...
            bulkApproverSubtitle: '没有审批人符合所选报告的条件。',
        },
    },
