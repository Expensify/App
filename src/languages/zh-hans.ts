    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            biometrics: {
                ...
                test: '测试',
                softPromptTitle: '使用您的面部或指纹验证交易',
                softPromptContent: '使用您的面部或指纹启用快速、安全的验证 - 无需密码或代码。',
                notificationTitle: '身份验证成功',
                notificationContent: '您已成功使用面容 ID 进行身份验证。',
                biometricsTest: '生物识别测试',
                errorPageTitle: '糟糕，出现错误',
                errorPageContent: '您的设备无法注册。',
            },
        },
        debugConsole: {
            saveLog: '保存日志',
