...
添加更多消费规则以保护公司现金流。`,
        ...
        campfire: {
            ...
            accountingMethods: {
                ...
                alternateText: {
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]: '自付报销将在最终批准后导出',
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]: '自付报销将在标记为已支付时导出',
                },
            },
            syncReimbursedReports: '同步已报销报表',
            syncReimbursedReportsDescription: '当通过 ACH 支付报表时，将在此账户中生成一笔账单付款。',
            billPaymentAccount: {label: '账单支付账户', description: '选择用于支付账单的账户，我们会在 Campfire 中为你创建付款。'},
            syncExpensifyCardSettlements: '同步 Expensify 卡清算',
            settlementAccount: {label: 'Expensify 卡结算账户', description: '选择您的结算账户，我们将在 Campfire 中创建这笔付款。'},
            syncTravelInvoicingSettlements: '同步差旅开票结算',
            travelInvoicingSettlementAccount: {label: '差旅开票结算账户', description: '选择您的结算账户，我们将在 Campfire 中创建这笔付款。'},
            travelInvoicingPayableAccount: {label: '差旅开票应付账户'},
        },
        businessCentral: {
