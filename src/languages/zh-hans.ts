...
你可以要求报销包含收据和说明等详细信息，设置限额和默认值，并将审批和付款流程自动化——全部在一个地方完成。`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                confirmErrorConditionAndDefault: '请选择商家或类别，并至少应用一个默认值',
                turnOnTaxesFirstTitle: '请先开启税费',
                turnOnTaxesFirstPrompt: '类别规则会设置默认税率。请在工作区设置中启用税费以使用此功能。',
                categoryRulesApplyGoingForwardTitle: '类别规则将从现在开始生效',
                categoryRulesApplyGoingForwardPrompt: '此类别中的新报销将应用默认税率，已存在的报销将不会更改。',
            },
            categoryRules: {
                title: '类别规则',
                approver: '审批人',
...
添加更多消费规则以保护公司现金流。`,
            ...
            newRule: {
                ...
                createAgentRuleDescription: '创建可灵活运行、按需触发的规则。',
            },
            ...
            expenseDefaultType: {
                ...
                subtitle: '此规则应匹配什么条件？',
                merchant: '商家',
                merchantDescription: '更新特定商家的报销项目字段',
                category: '类别',
                categoryDescription: '为特定类别设置默认税率',
            },
            taxesDisabledEmptyState: {title: '税务未启用', subtitle: '启用税费以记录并追回符合条件的税款。', cta: '启用税费'},
        },
        planTypePage: {
            planTypes: {
                team: {
