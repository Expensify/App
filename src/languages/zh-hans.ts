...
${amount}，商户：${merchant} - 日期：${date}`,
    ...
    workspace: {
        ...
        sageIntacct: {
            ...
            creditCardMiscFallback: `否则，它们将以“Credit Card Misc”导出。`,
...
3. 订阅源启用后，点击下方的“提交”，我们会开始为你添加它。`,
        ...
        accounting: {
            ...
            exportDate: '导出日期',
            defaultVendor: '默认供应商',
            defaultVendorHelperText: ({connectionName}: ConnectionDisplayNameParams) => `未自动匹配的报销将默认归入此 ${connectionName} 供应商。`,
