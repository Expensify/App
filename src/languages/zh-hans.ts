...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                fireworksTitle: '[zh-hans] All caught up',
                fireworksDescription: '[zh-hans] Upcoming to-dos will appear here.',
            },
        },
    ...
    iou: {
        ...
        error: {
            ...
            nonReimbursablePayment: '[zh-hans] Cannot pay via Expensify',
            nonReimbursablePaymentDescription: (isMultiple?: boolean) =>
                isMultiple
                    ? "[zh-hans] One or more selected reports don't have reimbursable expenses. Double check the expenses, or manually mark as paid."
                    : "[zh-hans] The report doesn't have reimbursable expenses. Double check the expenses, or manually mark as paid.",
        },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        emptyWorkspace: {
            title: '[zh-hans] You have no workspaces',
            subtitle: '[zh-hans] Track receipts, reimburse expenses, manage travel, send invoices, and more.',
