...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            connectionsSubtitle:
                "[zh-hans] Connect to your HR system to sync employee data, auto-match reimbursements to the right people, and keep your team's expenses accurate without the manual work.",
...
Add more spend rules to protect company cash flow.`,
    ...
    search: {
        ...
        applyFilters: '[zh-hans] Apply filters',
            ...
            amount: {
                ...
                between: (greaterThan?: string, lessThan?: string) => {
                    if (greaterThan && lessThan) {
                        return `[zh-hans] Between ${greaterThan} and ${lessThan}`;
                    }
                    return '[zh-hans] Between';
                },
