...
const translations = {
    ...
    cardPage: {
        ...
        missingPrivateDetails: ({profileSettingsLink}: {profileSettingsLink: string}) => `请在 <a href="${profileSettingsLink}">账户 > 个人资料 > 私密</a> 中添加您的个人信息，然后重试。`,
...
${merchant}的${amount} - ${date}`,
    ...
    workspace: {
        ...
        expensifyCard: {
            ...
            issuedCardNoShippingDetails: ({assignee}: AssigneeParams) => `已向${assignee}发放一张Expensify卡！添加邮寄信息后将寄出该卡。`,
