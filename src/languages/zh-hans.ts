...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    samlSignIn: {
        ...
        orContinueWithSecurityCode: '您也可以使用安全代码登录',
    ...
    contacts: {
        ...
        enterSecurityCode: (contactMethod: string) => `请输入发送至 ${contactMethod} 的安全验证码。它应会在一两分钟内送达。`,
        setAsDefault: '设为默认',
    ...
    mergeAccountsPage: {
        ...
        accountValidate: {
            ...
            enterSecurityCode: (login: string) => `要继续，请输入发送到 <strong>${login}</strong> 的安全代码。`,
    ...
    cardPage: {
        ...
        enterSecurityCode: (contactMethod: string) => `请输入发送到 ${contactMethod} 的安全代码以查看您的卡片详情。验证码应会在一两分钟内送达。`,
...
${amount}，商户：${merchant} - 日期：${date}`,
    ...
    onboarding: {
        ...
        workEmailValidation: {title: '验证你的工作邮箱', securityCodeSent: (workEmail: string | undefined) => `请输入发送到 ${workEmail} 的安全代码。邮件应会在一两分钟内送达。`},
    ...
    resendValidationForm: {
        ...
        weSentYouSecuritySignInLink: (login: string, loginType: string) => `我已向 ${login} 发送了一封安全登录链接。请检查你的 ${loginType} 以完成登录。`,
        resendLink: '重新发送链接',
    },
    unlinkLoginForm: {
...
添加更多消费规则以保护公司现金流。`,
    ...
    delegate: {
        ...
        enterSecurityCode: (contactMethod: string) => `请输入发送到 ${contactMethod} 的安全码以添加协助者。它应会在一两分钟内送达。`,
        enterSecurityCodeUpdate: (contactMethod: string) => `请输入发送到 ${contactMethod} 的安全验证码以更新您的副驾驶。`,
        notAllowed: '别急……',
