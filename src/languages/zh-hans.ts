        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    ...
                    officeBasedHelp: '成员需通勤至办公室。日常通勤不予报销。',
                    noRegularWorkplaceTitle: '无固定工作地点',
                    noRegularWorkplaceHelp: '成员远程办公或没有固定工作地点，因此不适用家庭到办公地点的通勤规则。',
                    startingPrompt: {
                        title: '设置常见的工作安排',
                        prompt: '选择适用于大多数现有成员的工作安排。之后可以单独或批量更新成员。',
                        officeBasedHelp: '大多数成员需通勤至办公室。日常通勤不予报销。',
                        noRegularWorkplaceHelp: '大多数成员远程办公，因此通常不适用通勤扣除。',
                        confirm: '应用',
                    },
                },
            },
...
添加更多消费规则以保护公司现金流。`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            officeBased: '办公室办公',
            noRegularWorkplace: '无固定工作地点',
            set: ({arrangement}: {arrangement: string}) => `将默认工作安排设置为“${arrangement}”`,
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) => `将默认工作安排更改为“${arrangement}”（此前为“${previousArrangement}”）`,
        },
        commuterExclusions: {
