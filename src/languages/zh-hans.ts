...
添加更多消费规则以保护公司现金流。`,
        ...
        campfire: {
            ...
            exportReimbursable: {label: '报销费用导出为', values: {label: '供应商账单'}},
            exportDate: {label: '供应商账单日期', description: '导出报表到 Campfire 时使用此日期。', values: {label: '提交日期', description: '报表提交审批的日期。'}},
            exportNonReimbursable: {label: '导出公司卡费用为', values: {label: '日记账分录'}},
            defaultCompanyCardVendor: {label: '所有公司卡的默认供应商', description: '为无法自动匹配的报销选择一个默认的 Campfire 供应商。'},
