...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    iou: {
        ...
        submitReportPolicyViolationsTitle: '提交报告？',
        submitReportPolicyViolationsDescription: '此报告存在违反政策的情况。您确定要在不做任何更改的情况下提交吗？',
        pendingMatchSubmitDescription: '部分费用正在等待与信用卡交易匹配。您要将它们标记为现金吗？',
        sevenDayHoldSubmitDescription: '费用正在等待与卡交易的潜在匹配',
        rejectedExpenseSubmitDescription: '被拒绝的费用未标记为已解决',
        submitAnyway: '仍然提交',
        routePending: '路由处理中…',
