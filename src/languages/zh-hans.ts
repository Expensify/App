...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            validationFailedFallback: '您的银行已拦截发往此账户的测试交易。<concierge-link>联系 Concierge</concierge-link>',
        },
        fixBankAccount: {
            title: '修复银行账户',
            debitBlockedBody:
                '您的银行拦截了发往此账户的测试交易。<br/><br/>请联系银行将 Expensify 的 ACH ID 加入白名单：<bullet-list><bullet-item>1270239450</bullet-item><bullet-item>2270239450</bullet-item><bullet-item>4270239450</bullet-item></bullet-list>然后，重新发送下方的测试交易。',
...
添加更多消费规则以保护公司现金流。`,
    ...
    debug: {
        ...
        indicatorStatus: {
            ...
            aBankAccountFailedValidation: '银行账户验证失败',
        },
    },
    emptySearchView: {
        takeATestDrive: '试用体验',
