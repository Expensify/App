...
3. 订阅源启用后，点击下方的“提交”，我们会开始为你添加它。`,
        ...
        accounting: {
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '选择用于核对集中开票付款的银行账户。',
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) => `请确保此账户与您的集中开票结算账户（以 ${lastFourPAN} 结尾）一致，以确保持续对账功能正常运行。`,
            },
            syncTravelInvoicingSettlements: '同步集中开票结算',
        },
        export: {
