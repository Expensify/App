...
const translations = {
    common: {
        ...
        leaveWorkspaceConfirmation: '如果你离开此工作区，将无法向其提交费用。',
        leaveWorkspaceConfirmationAuditor: '如果您离开此工作区，您将无法查看其报告和设置。',
        ...
        leaveWorkspaceConfirmationExporter: ({workspaceOwner}: {workspaceOwner: string}) => `如果你离开此工作区，你作为首选导出者将由工作区所有者 ${workspaceOwner} 取代。`,
        leaveWorkspaceConfirmationTechContact: ({workspaceOwner}: {workspaceOwner: string}) => `如果你离开此工作空间，你的技术联系人身份将由工作空间所有者 ${workspaceOwner} 接替。`,
        leaveWorkspaceReimburser: '您作为报销付款人，无法离开此工作区。请在“工作区 > 进行或跟踪付款”中设置新的报销付款人，然后重试。',
        cannotLeaveWorkspaceOutstandingReport: '在离开此工作区之前，请批准提交给您的所有待处理的报销单。',
        reimbursable: '可报销的',
    ...
    workspace: {
        ...
        people: {
            ...
            removeMemberPromptApprover: ({approver, workspaceOwner}: {approver: string; workspaceOwner: string}) =>
                `如果你将${approver}从此工作区中移除，我们会在审批流程中由${workspaceOwner}（工作区所有者）替代其角色。`,
            removeMemberPromptPendingApproval: ({memberName}: {memberName: string}) => `${memberName} 有待审批的报销单。请在将其从工作区移除之前，要求其完成审批，或接管其报销单。`,
            removeMemberPromptReimburser: ({memberName}: {memberName: string}) => `您无法从此工作区中移除 ${memberName}。请在 工作流程 > 进行或跟踪付款 中设置新的报销人，然后重试。`,
            removeMemberPromptExporter: ({memberName, workspaceOwner}: {memberName: string; workspaceOwner: string}) =>
                `如果你将${memberName}从此工作区移除，我们会由工作区所有者${workspaceOwner}取代其作为首选导出者。`,
            removeMemberPromptTechContact: ({memberName, workspaceOwner}: {memberName: string; workspaceOwner: string}) =>
                `如果您将${memberName}从此工作区中移除，我们会将技术联系人更改为工作区所有者${workspaceOwner}。`,
            cannotRemoveUserDueToReport: ({memberName}: {memberName: string}) => `${memberName} 有一份待处理的报告需要采取行动。请在将其从工作区移除之前，让他们完成所需操作。`,
        },
        card: {
            getStartedIssuing: '通过申请您的第一张虚拟或实体卡来开始。',
            issueCard: '发卡',
