...
const translations = {
    common: {
        ...
        skip: '跳过',
        chatWithAccountManager: ({accountManagerDisplayName}: ChatWithAccountManagerParams) => `需要具体的帮助吗？请与您的客户经理 ${accountManagerDisplayName} 联系。`,
        chatNow: '立即聊天',
        workEmail: '工作邮箱',
        destination: '目的地',
        subrate: 'Subrate',
    ...
    lockedAccount: {
        title: '账户已锁定',
        description: '您无权完成此操作，因为该账户已被锁定。请联系 concierge@expensify.com 获取后续步骤。',
    },
    location: {
        useCurrent: '使用当前位置',
    ...
    contact: {
        ...
        importContactsText: '从您的手机导入联系人，让您最喜欢的人随时触手可及。',
        importContactsExplanation: '这样你最喜欢的人总是在指尖触及之处。',
        importContactsNativeText: '只差最后一步！请授权我们导入您的联系人。',
    },
    ...
    attachmentPicker: {
        ...
        attachmentImageResized: '此图片已调整大小以供预览。下载以获取全分辨率版本。',
        attachmentImageTooLarge: '此图片过大，无法在上传前预览。',
        tooManyFiles: ({fileLimit}: FileLimitParams) => `您一次最多只能上传 ${fileLimit} 个文件。`,
        sizeExceededWithValue: ({maxUploadSizeInMB}: SizeExceededParams) => `文件大小超过 ${maxUploadSizeInMB} MB。请重试。`,
    },
    dropzone: {
        addAttachments: '添加附件',
        scanReceipts: '扫描收据',
    ...
    avatarCropModal: {
        title: '编辑照片',
        description: '拖动、缩放并旋转您的图片，随心所欲。',
    },
    composer: {
        noExtensionFoundForMimeType: '未找到 mime 类型的扩展名',
    ...
    emptyList: {
        [CONST.IOU.TYPE.CREATE]: {
            title: '提交报销，推荐给您的老板',
            subtitleText: '想让您的老板也使用 Expensify 吗？只需向他们提交一笔报销费用，剩下的交给我们处理。',
        },
    },
    ...
    welcomeText: {
        ...
        anotherLoginPageIsOpenExplanation: '您已在另一个标签页打开登录页面。请从该标签页登录。',
        welcome: '欢迎！',
        welcomeWithoutExclamation: '欢迎',
        phrase2: '金钱会说话。现在聊天和支付合而为一，也变得简单了。',
        phrase3: '您的付款速度快如您表达观点的速度。',
        enterPassword: '请输入您的密码',
        welcomeNewFace: ({login}: SignUpNewFaceCodeParams) => `${login}，很高兴在这里看到新面孔！`,
        welcomeEnterMagicCode: ({login}: WelcomeEnterMagicCodeParams) => `请输入发送到 ${login} 的验证码。验证码应在一两分钟内收到。`,
    },
    login: {
        hero: {
            header: '差旅和报销，聊天般的速度',
            body: '欢迎来到下一代 Expensify，在这里，借助情境化的实时聊天，您的差旅和费用处理将更加快捷。',
        },
    },
    thirdPartySignIn: {
        ...
        redirectToDesktopMessage: '完成登录后，我们将重定向您到桌面应用程序。',
    ...
    samlSignIn: {
        ...
        orContinueWithMagicCode: '您也可以使用魔法码登录',
    ...
    reportActionCompose: {
        ...
        localTime: ({user, time}: LocalTimeParams) => `现在是${user}的${time}时间`,
        edited: '(edited)',
        emoji: '表情符号',
        collapse: '折叠',
        expand: '展开',
    ...
    reportActionsView: {
        ...
        beginningOfArchivedRoomPartTwo: '，这里没有任何内容可看。',
        beginningOfChatHistoryDomainRoomPartOne: ({domainRoom}: BeginningOfChatHistoryDomainRoomPartOneParams) => `此聊天包含所有 ${domainRoom} 域上的 Expensify 成员。`,
        ...
        beginningOfChatHistoryAdminRoomPartTwo: '用它来聊天关于工作区设置及更多内容。',
        ...
        beginningOfChatHistoryPolicyExpenseChatPartOne: '这里是',
    ...
    sidebarScreen: {
        ...
        redirectToExpensifyClassicModal: {
            title: '即将推出',
            description: '我们正在微调 New Expensify 的一些细节以适应您的特定设置。与此同时，请前往 Expensify Classic。',
        },
    },
    allSettingsScreen: {
        subscription: '订阅',
    ...
    spreadsheet: {
        ...
        importPerDiemRatesSuccessfulDescription: ({rates}: ImportPerDiemRatesSuccessfulDescriptionParams) => (rates > 1 ? `已添加 ${rates} 日津贴费率。` : '已添加1个每日津贴标准。'),
        importFailedTitle: '导入失败',
        importFailedDescription: '请确保所有字段均已正确填写，然后重试。如果问题仍然存在，请联系 Concierge。',
        importDescription: '通过点击下面每个导入列旁的下拉菜单，选择要从电子表格映射的字段。',
        sizeNotMet: '文件大小必须大于 0 字节',
        invalidFileMessage: '您上传的文件为空或包含无效数据。请确保文件格式正确并包含必要的信息后，再次上传。',
    ...
    receipt: {
        ...
        deniedCameraAccess: '摄像头访问权限仍未授予，请按照以下步骤操作',
    ...
    iou: {
        ...
        createExpenseWithAmount: ({amount}: {amount: string}) => `创建 ${amount} 报销费用`,
        confirmDetails: '确认详情',
        pay: '支付',
        cancelPayment: '取消付款',
        ...
        duplicateTransaction: ({isSubmitted}: DuplicateTransactionParams) =>
            !isSubmitted ? '检测到潜在的重复费用。请审核重复项以启用提交。' : '已识别潜在重复费用。请审核重复项以启用批准。',
        receiptIssuesFound: () => ({
            one: '发现问题',
            other: '发现问题',
        }),
        ...
        yourCompanyWebsiteNote: '如果您没有网站，可以提供贵公司的 LinkedIn 或社交媒体资料。',
        invalidDomainError: '您输入了一个无效的域名。要继续，请输入一个有效的域名。',
        ...
        settlePersonal: ({formattedAmount}: SettleExpensifyCardParams) => (formattedAmount ? `以个人身份支付 ${formattedAmount}` : `作为个人付款`),
        settlePayment: ({formattedAmount}: SettleExpensifyCardParams) => `支付 ${formattedAmount}`,
        settleBusiness: ({formattedAmount}: SettleExpensifyCardParams) => (formattedAmount ? `以企业身份支付 ${formattedAmount}` : `作为企业付款`),
        ...
        canceledRequest: ({amount, submitterDisplayName}: CanceledRequestParams) => `取消了${amount}的付款，因为${submitterDisplayName}未在30天内启用他们的Expensify Wallet。`,
        ...
        paidWithExpensify: ({payer}: PaidWithExpensifyParams = {}) => `${payer ? `${payer} ` : ''} 使用 Expensify 支付`,
        ...
        updatedTheRequest: ({valueName, newValueToDisplay, oldValueToDisplay}: UpdatedTheRequestParams) => `${valueName} 改为 ${newValueToDisplay}（之前是 ${oldValueToDisplay}）`,
        ...
        error: {
            ...
            invalidTagLength: '标签名称超过了255个字符。请缩短它或选择一个不同的标签。',
            invalidAmount: '请输入有效金额后再继续',
            invalidIntegerAmount: '请输入完整的美元金额后继续',
            invalidTaxAmount: ({amount}: RequestAmountParams) => `最高税额为 ${amount}`,
            invalidSplit: '拆分金额的总和必须等于总金额',
            invalidSplitParticipants: '请输入至少两位参与者的大于零的金额。',
            invalidSplitYourself: '请输入非零金额以进行拆分',
            ...
            genericUnholdExpenseFailureMessage: '取消此费用保留时发生意外错误。请稍后再试。',
            ...
            invalidRate: '此工作区的费率无效。请从工作区中选择一个可用的费率。',
        },
        dismissReceiptError: '忽略错误',
        dismissReceiptErrorConfirmation: '提醒！忽略此错误将完全删除您上传的收据。您确定吗？',
        ...
        reopened: '重新打开',
        reopenReport: '重新打开报告',
        reopenExportedReportConfirmation: ({connectionName}: {connectionName: string}) => `该报告已导出到 ${connectionName}。更改可能导致数据不一致。您确定要重新打开此报告吗？`,
        reason: '原因',
        ...
        expenseDuplicate: '此费用与另一笔费用的详细信息相似。请审核重复项以继续。',
        someDuplicatesArePaid: '其中一些重复项已被批准或已付款。',
        ...
        confirmPay: '确认付款金额',
        confirmPayAmount: '支付未被暂停的部分，或支付整个报销单。',
        ...
        whatIsHoldExplain: '暂停就像是在费用上按下“暂停”键，以便在批准或付款前请求更多详细信息。',
        ...
        unapproveWithIntegrationWarning: ({accountingIntegration}: UnapproveWithIntegrationWarningParams) =>
            `此报告已导出到 ${accountingIntegration}。更改可能导致数据不一致。您确定要取消批准此报告吗？`,
        reimbursable: '可报销',
        ...
        tripLengthText: () => ({
            one: `行程：1整天`,
            other: (count: number) => `行程：${count} 全天`,
        }),
        dates: '日期',
        rates: '费率',
    ...
    avatarWithImagePicker: {
        ...
        sizeExceeded: ({maxUploadSizeInMB}: SizeExceededParams) => `所选图片超过最大上传大小 ${maxUploadSizeInMB} MB。`,
    ...
    profilePage: {
        ...
        timezone: '时区',
        invalidFileMessage: '无效的文件。请尝试使用其他图片。',
        ...
        publicSection: {
            title: '公开',
            subtitle: '这些信息会显示在您的公开资料上，任何人都可以查看。',
        },
        privateSection: {
            title: '私人',
    ...
    contacts: {
        ...
        helpTextBeforeEmail: '添加更多方式让人们找到您，并转发收据至',
        ...
        genericFailureMessages: {
            ...
            validateSecondaryLogin: '魔术码错误或无效。请重试或请求新的验证码。',
    ...
    pronouns: {
        ...
        faeFaer: 'Fae / Faer',
        heHimHis: '他 / 他 / 他的',
        heHimHisTheyThemTheirs: '他 / 他的 / 他们 / 他们的',
        sheHerHers: '她 / 她的 / 她的',
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            usingImportedState: '您正在使用导入的状态。点击此处以清除。',
            debugMode: '调试模式',
            invalidFile: '无效的文件',
    ...
    closeAccountPage: {
        closeAccount: '关闭账户',
        reasonForLeavingPrompt: '我们不希望您离开！您能告诉我们原因吗？以便我们改进。',
    ...
    mergeAccountsPage: {
        mergeAccount: '合并账户',
        accountDetails: {
            accountToMergeInto: '输入您想合并的账户',
            notReversibleConsent: '我明白这是不可逆的。',
        },
        accountValidate: {
            confirmMerge: '您确定要合并账户吗？',
            lossOfUnsubmittedData: `合并您的账户是不可逆的，并且将导致任何未提交的费用丢失，适用于`,
            enterMagicCode: `要继续，请输入发送到的魔术代码`,
            errors: {
                incorrectMagicCode: '魔术码错误或无效。请重试或请求新的验证码。',
        ...
        mergeFailure2FA: {
            oldAccount2FAEnabled: {
                ...
                beforeSecondEmail: '已启用两步验证 (2FA)。请为  禁用 2FA。',
                afterSecondEmail: '并再试一次。',
            },
        ...
        mergeFailureInvoicedAccount: {
            beforeEmail: '您无法合并',
            afterEmail: '因为它是已开票账户的账单所有者，所以不能合并到其他账户。请将其他账户合并到该账户中。',
        },
    ...
    lockAccountPage: {
        lockAccount: '锁定账户',
        unlockAccount: '解锁账户',
        compromisedDescription: '如果您怀疑您的 Expensify 账户被入侵，您可以锁定账户以防止新的 Expensify 卡交易并阻止不必要的账户更改。',
        ...
        warning: `一旦您的账户被锁定，我们的团队将进行调查并移除任何未经授权的访问。要重新获得访问权限，您需要与 Concierge 合作以保护您的账户安全。`,
    },
    ...
    twoFactorAuth: {
        ...
        whatIsTwoFactorAuth: '两步验证（2FA）有助于保护您的账户安全。登录时，您需要输入由您首选的身份验证应用生成的代码。',
        disableTwoFactorAuth: '禁用两步验证',
        explainProcessToRemove: '为了禁用双因素认证（2FA），请输入您认证应用中的有效代码。',
        disabled: '双重身份验证现已禁用',
        noAuthenticatorApp: '您将不再需要使用身份验证器应用程序登录 Expensify。',
        stepCodes: '恢复代码',
        keepCodesSafe: '请妥善保管这些恢复代码！',
        codesLoseAccess: '如果您丢失了对身份验证器应用的访问权限且没有这些代码，您将无法访问您的账户。\n\n注意：设置两步验证将使您退出所有其他活跃的会话。',
        ...
        twoFactorAuthIsRequiredDescription: '出于安全考虑，Xero 需要双因素认证才能连接集成。',
        twoFactorAuthIsRequiredForAdminsHeader: '需要双因素身份验证',
        twoFactorAuthIsRequiredForAdminsTitle: '请启用两步验证',
        twoFactorAuthIsRequiredForAdminsDescription: '您的 Xero 会计连接需要使用双因素身份验证。要继续使用 Expensify，请启用该功能。',
        twoFactorAuthCannotDisable: '无法禁用双重身份验证',
        twoFactorAuthRequired: '您的 Xero 连接需要双因素认证 (2FA)，且无法禁用。',
    },
    recoveryCodeForm: {
        error: {
            pleaseFillRecoveryCode: '请输入您的恢复码',
            incorrectRecoveryCode: '恢复码错误。请再试一次。',
        },
    ...
    privateNotes: {
        title: '私人笔记',
        personalNoteMessage: '在此处记录有关此聊天的备注。只有您可以添加、编辑或查看这些备注。',
    ...
    billingCurrency: {
        ...
        paymentCurrencyDescription: '选择所有个人费用应转换为的标准货币',
        note: '注意：更改您的支付货币可能会影响您支付给 Expensify 的金额。请参阅我们的',
        noteLink: '定价页面',
        noteDetails: '查看完整详情。',
    },
    addDebitCardPage: {
    ...
    walletPage: {
        ...
        error: {
            notOwnerOfBankAccount: '将此银行账户设置为您的默认付款方式时发生错误',
            invalidBankAccount: '该银行账户已被暂时暂停',
            notOwnerOfFund: '设置此卡为您的默认付款方式时发生错误',
            setDefaultFailure: '出现了问题。请与 Concierge 聊天以获取进一步的帮助。',
        },
        addBankAccountFailure: '尝试添加您的银行账户时发生了意外错误。请重试。',
        getPaidFaster: '更快收款',
        addPaymentMethod: '添加付款方式以便在应用内直接发送和接收付款。',
        ...
        enableWallet: '启用钱包',
        addBankAccountToSendAndReceive: '报销您提交到工作区的费用。',
        addBankAccount: '添加银行账户',
        assignedCards: '已分配的卡片',
        assignedCardsDescription: '这些卡片由工作区管理员分配，用于管理公司支出。',
        ...
        chooseAccountBody: '请确保您选择了正确的选项。',
    ...
    cardPage: {
        ...
        fixedLimit: {
            name: '固定限额',
            title: ({formattedLimit}: ViolationsOverLimitParams) => `您最多可以在此卡上消费 ${formattedLimit}，然后该卡将被停用。`,
        },
        monthlyLimit: {
            name: '每月限额',
        ...
        enterMagicCode: ({contactMethod}: EnterMagicCodeParams) => `请输入发送到 ${contactMethod} 的验证码以查看您的卡片详情。验证码应在一两分钟内送达。`,
    },
    workflowsPage: {
        workflowTitle: '支出',
        workflowDescription: '配置一个从发生支出开始，包括审批和付款的工作流程。',
        delaySubmissionTitle: '延迟提交',
        delaySubmissionDescription: '选择自定义提交费用的时间表，或关闭此选项以实时更新支出。',
        ...
        makeOrTrackPaymentsDescription: '添加一个授权付款人，用于在 Expensify 中进行付款或跟踪在其他地方进行的付款。',
        editor: {
            submissionFrequency: '选择 Expensify 在共享无错误支出前应等待的时间。',
        },
        ...
        approverCircularReference: ({name1, name2}: ApprovalWorkflowErrorParams) =>
            `<strong>${name1}</strong> 已经批准了 <strong>${name2}</strong> 的报告。请选择其他审批人以避免循环工作流程。`,
        emptyContent: {
            title: '无成员可显示',
    ...
    workflowsEditApprovalsPage: {
        title: '编辑审批流程',
        deleteTitle: '删除审批流程',
        deletePrompt: '您确定要删除此审批流程吗？所有成员随后将遵循默认流程。',
    },
    ...
    reportFraudPage: {
        title: '报告虚拟卡欺诈',
        description: '如果您的虚拟卡信息被盗用或泄露，我们将永久停用您现有的卡，并为您提供一张新的虚拟卡及卡号。',
        deactivateCard: '停用卡片',
        reportVirtualCardFraud: '报告虚拟卡欺诈',
    },
    reportFraudConfirmationPage: {
        title: '报告了信用卡欺诈',
        description: '我们已永久停用您现有的卡。当您返回查看您的卡详情时，您将有一张新的虚拟卡可用。',
        buttonText: '明白了，谢谢！',
    },
    activateCardPage: {
        activateCard: '激活卡片',
    ...
    paymentMethodList: {
        ...
        cardLastFour: '卡号结尾为',
        addFirstPaymentMethod: '添加付款方式以便在应用内直接发送和接收付款。',
    ...
    priorityModePage: {
        priorityMode: '优先模式',
        explainerText: '选择是#只关注未读和置顶聊天，还是显示所有聊天，并将最新和置顶聊天置于顶部。',
        priorityModes: {
            default: {
                label: '最近的',
    ...
    groupChat: {
        lastMemberTitle: '提醒！',
        lastMemberWarning: '既然您是这里的最后一位成员，离开将导致所有成员无法访问此聊天。您确定要离开吗？',
    ...
    passwordForm: {
        ...
        error: {
            ...
            incorrect2fa: '双重身份验证代码错误。请再试一次。',
            twoFactorAuthenticationEnabled: '您已在此账户启用双重身份验证。请使用您的电子邮件或电话号码登录。',
            invalidLoginOrPassword: '登录名或密码无效。请重试或重置您的密码。',
            unableToResetPassword:
                '我们无法更改您的密码。这很可能是由于旧密码重置邮件中的密码重置链接已过期。我们已向您发送了一封包含新链接的邮件，您可以再次尝试。请检查您的收件箱和垃圾邮件文件夹；邮件应在几分钟内到达。',
    ...
    loginForm: {
        ...
        error: {
            invalidFormatEmailLogin: '输入的电子邮件无效。请修正格式后再试。',
        },
        cannotGetAccountDetails: '无法检索账户详细信息。请重试登录。',
        loginForm: '登录表单',
    ...
    onboarding: {
        ...
        welcomeVideo: {
            title: '欢迎使用 Expensify',
            description: '一个应用程序，通过聊天处理您所有的商务和个人支出。为您的业务、团队和朋友打造。',
        },
        getStarted: '开始使用',
        whatsYourName: '你叫什么名字？',
        peopleYouMayKnow: '您可能认识的人已经在这里！验证您的电子邮件以加入他们。',
        workspaceYouMayJoin: ({domain, email}: WorkspaceYouMayJoin) => `${domain} 的某人已经创建了一个工作区。请输入发送到 ${email} 的魔法代码。`,
        joinAWorkspace: '加入工作区',
        listOfWorkspaces: '这是您可以加入的工作区列表。别担心，如果您愿意，稍后也可以加入它们。',
        ...
        workEmail: {
            title: '你的工作邮箱是什么？',
            subtitle: '当您连接工作邮箱时，Expensify 的效果最佳。',
            explanationModal: {
                descriptionOne: '转发至 receipts@expensify.com 进行扫描',
                descriptionTwo: '加入已经在使用 Expensify 的同事行列',
        ...
        workEmailValidation: {
            title: '验证您的工作邮箱',
            magicCodeSent: ({workEmail}: WorkEmailResendCodeParams) => `请输入发送到 ${workEmail} 的验证码。验证码应在一两分钟内到达。`,
        },
        ...
        workspace: {
            ...
            explanationModal: {
                ...
                descriptionTwo: '分类并标记费用',
                descriptionThree: '创建并分享报告',
            },
            price: '免费试用30天，然后仅需<strong>$5/月</strong>升级。',
    ...
    resendValidationForm: {
        ...
        weSentYouMagicSignInLink: ({login, loginType}: WeSentYouMagicSignInLinkParams) => `我已向 ${login} 发送了魔法登录链接。请检查您的 ${loginType} 以登录。`,
        resendLink: '重新发送链接',
    },
    unlinkLoginForm: {
        toValidateLogin: ({primaryLogin, secondaryLogin}: ToValidateLoginParams) => `要验证 ${secondaryLogin}，请从 ${primaryLogin} 的账户设置中重新发送魔术码。`,
        noLongerHaveAccess: ({primaryLogin}: NoLongerHaveAccessParams) => `如果您不再能访问 ${primaryLogin}，请取消关联您的账户。`,
        unlink: '取消链接',
        linkSent: '链接已发送！',
        successfullyUnlinkedLogin: '辅助登录已成功解除绑定！',
    },
    ...
    focusModeUpdateModal: {
        title: '欢迎进入#focus模式！',
        prompt: '通过仅查看未读聊天或需要您关注的聊天，保持事务的掌控。不用担心，您可以随时在  更改此设置。',
        settings: '设置',
    },
    notFound: {
    ...
    bankAccount: {
        ...
        toGetStarted: '添加银行账户，以便从一个地方报销费用、发放 Expensify 卡、收取发票付款和支付账单。',
    ...
    messages: {
        errorMessageInvalidPhone: `请输入有效的电话号码，不要包含括号或短横线。如果您在美国以外地区，请包含您的国家代码（例如 ${CONST.EXAMPLE_PHONE_NUMBER}）。`,
    ...
    additionalDetailsStep: {
        ...
        helpLink: '了解我们为什么需要这个的更多信息。',
        legalFirstNameLabel: '法定名字',
        legalMiddleNameLabel: '法定中间名',
        legalLastNameLabel: '法定姓氏',
        selectAnswer: '请选择一个回复以继续',
        ssnFull9Error: '请输入有效的九位数社会安全号码（SSN）',
        needSSNFull9: '我们在验证您的社会保障号码时遇到问题。请输入完整的九位社会保障号码。',
    ...
    termsStep: {
        ...
        longTermsForm: {
            ...
            sendingFundsTitle: '向另一账户持有人汇款',
            sendingFundsDetails: '使用您的余额、银行账户或借记卡向另一账户持有人转账无需支付费用。',
    ...
    activateStep: {
        ...
        activatedMessage: '恭喜，您的钱包已设置完毕，可以开始付款。',
    ...
    companyStep: {
        ...
        confirmCompanyIsNot: '我确认这家公司不在名单上',
    ...
    businessInfoStep: {
        ...
        whereWasTheBusinessIncorporated: '公司注册地在哪里？',
    ...
    beneficialOwnerInfoStep: {
        doYouOwn25percent: '您是否拥有 25% 或以上的股份',
        doAnyIndividualOwn25percent: '是否有个人拥有25%或以上的股份',
        areThereMoreIndividualsWhoOwn25percent: '拥有25%或以上股份的个人更多吗？',
        regulationRequiresUsToVerifyTheIdentity: '法规要求我们核实任何拥有超过25%企业所有权的个人的身份。',
        companyOwner: '企业主',
        enterLegalFirstAndLastName: '业主的法定名称是什么？',
        legalFirstName: '法定名字',
        legalLastName: '法定姓氏',
        enterTheDateOfBirthOfTheOwner: '业主的出生日期是什么？',
        enterTheLast4: '所有者社会保障号码的最后四位数字是多少？',
        last4SSN: '社会保障号码后4位',
        dontWorry: '别担心，我们不会进行任何个人信用检查！',
    ...
    ownershipInfoStep: {
        ...
        regulationsRequire: '法规要求我们核实任何拥有超过25%企业所有权的个人的身份。',
        legalFirstName: '法定名字',
        legalLastName: '法定姓氏',
        whatsTheOwnersName: '业主的法定名称是什么？',
        whatsYourName: '你的法定姓名是什么？',
        whatPercentage: '业主拥有该企业的百分之多少？',
        ...
        whatsYourAddress: '你的地址是什么？',
        whatAreTheLast: '业主的社会保障号码的最后四位数字是什么？',
        ...
        areThereOther: ({companyName}: CompanyNameParams) => `是否还有其他个人拥有 ${companyName} 25% 或以上的股份？`,
        owners: '所有者',
        addCertified: '添加显示实际受益所有者的认证组织结构图',
        regulationRequiresChart: '法规要求我们收集一份经认证的所有权结构图副本，显示拥有该企业25%或以上股份的每个个人或实体。',
        ...
        acceptedFiles: '接受的文件格式：PDF、PNG、JPEG。每个部分的总文件大小不得超过5 MB。',
        proofOfBeneficialOwner: '受益所有权证明',
        proofOfBeneficialOwnerDescription:
            '请提供一份由注册会计师、公证人或律师签署的声明书和组织结构图，证明拥有公司25%或以上的所有权。该文件必须是最近三个月内签发的，并包含签署人的执照号码。',
        ...
        codiceFiscaleDescription: '请上传一次现场访问的视频或与签署官员的录音通话。官员必须提供：全名、出生日期、公司名称、注册号码、税务代码、注册地址、业务性质和账户用途。',
    },
    validationStep: {
        headerTitle: '验证银行账户',
        buttonText: '完成设置',
        ...
        descriptionCTA: '请在以下字段中输入每笔交易金额。示例：1.51。',
        reviewingInfo: '谢谢！我们正在审核您的信息，并将尽快与您联系。请查看您与 Concierge 的聊天记录。',
        forNextStep: '完成设置您的银行账户的下一步操作。',
        letsChatCTA: '是的，我们聊聊吧',
        letsChatText: '快完成了！我们需要您通过聊天帮忙核实最后几条信息。准备好了吗？',
        letsChatTitle: '我们来聊聊吧！',
        enable2FATitle: '防止欺诈，启用两步验证（2FA）',
        enable2FAText: '我们非常重视您的安全。请立即设置双重身份验证（2FA），为您的账户增加一层额外保护。',
        secureYourAccount: '保护您的账户安全',
    },
    ...
    completeVerificationStep: {
        ...
        isAuthorizedToUseBankAccountError: '您必须是具有授权操作公司银行账户权限的管理人员。',
        termsAndConditions: '条款和条件',
    },
    connectBankAccountStep: {
        ...
        description: `在1-2个工作日内，我们将从类似“Expensify, Inc. Validation”的名称向您的银行账户发送三（3）笔小额交易。`,
        descriptionCTA: '请在以下字段中输入每笔交易金额。示例：1.51。',
        reviewingInfo: '谢谢！我们正在审核您的信息，稍后会与您联系。请查看您与 Concierge 的聊天记录。',
        forNextSteps: '完成设置您的银行账户的下一步操作。',
        letsChatCTA: '是的，我们聊聊吧',
        letsChatText: '快完成了！我们需要您通过聊天帮忙核实最后几条信息。准备好了吗？',
        letsChatTitle: '我们来聊聊吧！',
        enable2FATitle: '防止欺诈，启用两步验证（2FA）',
    ...
    bankInfoStep: {
        ...
        letsDoubleCheck: '让我们再仔细检查一下，确保一切正常。',
        thisBankAccount: '此银行账户将用于您工作区的业务付款。',
        accountNumber: '账号号码',
    ...
    signerInfoStep: {
        ...
        regulationRequiresUs: '法规要求我们验证签署人是否有权代表企业采取此行动。',
        ...
        codiceFiscaleDescription: '签署人、授权用户和受益所有人的税号。',
        PDSandFSG: 'PDS + FSG 披露文件',
        PDSandFSGDescription:
            '我们与 Corpay 的合作利用 API 连接，借助其庞大的国际银行合作伙伴网络，为 Expensify 提供全球报销服务。根据澳大利亚法规，我们向您提供 Corpay 的金融服务指南（FSG）和产品披露声明（PDS）。\n\n请仔细阅读 FSG 和 PDS 文件，因为其中包含 Corpay 提供的产品和服务的完整详情及重要信息。请妥善保存这些文件以备将来参考。',
        pleaseUpload: '请在下方上传更多文件，以帮助我们验证您作为企业实体董事或高级管理人员的身份。',
    },
    agreementsStep: {
        agreements: '协议',
        pleaseConfirm: '请确认以下协议',
        regulationRequiresUs: '法规要求我们核实任何拥有超过25%企业所有权的个人的身份。',
        ...
        privacyNotice: '隐私声明',
        error: {
            authorized: '您必须是具有授权操作公司银行账户权限的管理人员。',
            certify: '请确认信息真实准确。',
            consent: '请同意隐私声明',
        },
    },
    finishStep: {
        ...
        thanksFor: '感谢您提供的详细信息。专属支持代理将会审核您的信息。如果我们需要您提供其他资料，会再次与您联系。与此同时，如有任何疑问，欢迎随时联系我们。',
        iHaveA: '我有一个问题',
    ...
    reimbursementAccountLoadingAnimation: {
        oneMoment: '请稍候',
        explanationLine: '我们正在审核您的信息。您很快就可以继续下一步操作。',
    },
    session: {
    ...
    travel: {
        header: '预订旅行',
        title: '聪明旅行',
        subtitle: '使用 Expensify Travel 获取最佳旅行优惠，并在一个地方管理您的所有商务费用。',
        features: {
            saveMoney: '在预订时节省费用',
            alerts: '获取实时更新和提醒',
        },
        ...
        termsAndConditions: {
            ...
            agree: '我同意该条款',
            error: '您必须同意 Expensify Travel 条款与条件才能继续。',
            defaultWorkspaceError: '您需要设置一个默认工作区以启用 Expensify Travel。请前往 设置 > 工作区 > 点击某个工作区旁的三个竖点 > 设为默认工作区，然后再试一次！',
        },
        flight: '航班',
        flightDetails: {
            passenger: '乘客',
            layover: ({layover}: FlightLayoverParams) => `<muted-text-label>您在此航班前有一个 <strong>${layover} 中转</strong></muted-text-label>`,
            takeOff: '起飞',
            landing: '登录页',
            seat: '座位',
            class: '舱位等级',
        ...
        phoneError: {
            phrase1: '请',
            link: '添加工作邮箱作为您的主要登录账号',
            phrase2: '预订旅行。',
        },
        domainSelector: {
            title: '域',
            subtitle: '选择 Expensify Travel 设置的域名。',
            recommended: '推荐',
        },
        ...
        publicDomainError: {
            ...
            message: `您需要使用您的工作邮箱（例如，name@company.com）登录 Expensify Travel，而不是您的个人邮箱（例如，name@gmail.com）。`,
        },
        blockedFeatureModal: {
            title: 'Expensify Travel 已被禁用',
            message: `您的管理员已关闭 Expensify Travel。请遵循贵公司的差旅预订政策进行安排。`,
        },
        verifyCompany: {
            title: '今天就开始您的旅行吧！',
            message: `请联系您的客户经理或发送邮件至 salesteam@expensify.com，获取旅行功能的演示并为您的公司启用该功能。`,
        },
        updates: {
            ...
            flightUpdated: ({airlineCode, origin, destination, startDate}: FlightParams) => `您的航班 ${airlineCode} (${origin} → ${destination}) 于 ${startDate} 已更新。`,
            flightCabinChanged: ({airlineCode, cabinClass}: AirlineParams) => `您的航班 ${airlineCode} 的舱位等级已更新为 ${cabinClass}。`,
    ...
    workspace: {
        common: {
            ...
            deleteWithCardsConfirmation: '您确定要删除此工作区吗？这将移除所有卡片动态和已分配的卡片。',
            unavailable: '工作区不可用',
            ...
            requested: '已请求',
            distanceRates: '距离费率',
            defaultDescription: '一个地方管理您的所有收据和费用。',
            ...
            reportLevel: '报告级别',
            topLevel: '顶级',
            appliedOnExport: '未导入Expensify，已应用于导出',
            shareNote: {
                header: '与其他成员共享您的工作区',
                content: {
            ...
            existingConnectionsDescription: ({connectionName}: ConnectionNameParams) =>
                `由于您之前已连接到 ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}，您可以选择重用现有连接或创建一个新连接。`,
        ...
        perDiem: {
            ...
            emptyList: {
                title: '每日津贴',
                subtitle: '设置每日津贴标准以控制员工每日支出。导入电子表格中的费率以开始操作。',
            },
            errors: {
            ...
            editCurrencySubtitle: ({destination}: EditDestinationSubtitleParams) => `更新此货币将更改所有 ${destination} 日津贴子费率。`,
        },
        qbd: {
            exportOutOfPocketExpensesDescription: '设置自付费用如何导出到 QuickBooks Desktop。',
            exportOutOfPocketExpensesCheckToggle: '将标记为“稍后打印”',
            ...
            exportVendorBillDescription: '我们将为每个 Expensify 报告创建一份详细的供应商账单，并将其添加到账户中。如果该期间已关闭，我们将记入下一个开放期间的第一天。',
            deepDiveExpensifyCard: 'Expensify Card 交易将自动导出到使用创建的“Expensify Card 负债账户”',
            deepDiveExpensifyCardIntegration: '我们的集成。',
            outOfPocketTaxEnabledDescription: 'QuickBooks Desktop 不支持在日记账分录导出中使用税务。由于您的工作区启用了税务，此导出选项不可用。',
            ...
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK}描述`]: '我们将为每个 Expensify 报告创建一张明细支票，并从以下银行账户发送。',
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}描述`]:
                    '我们将自动将信用卡交易上的商户名称与 QuickBooks 中的相应供应商进行匹配。如果没有现有供应商，我们将创建一个“信用卡杂项”供应商进行关联。',
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}描述`]:
                    '我们将为每个 Expensify 报告创建一个明细供应商账单，账单日期为最后一笔费用的日期，并将其添加到账户下方。如果该期间已关闭，我们将记入下一个开放期间的第一天。',
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}账户描述`]: '选择导出信用卡交易的地点。',
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}账户描述`]: '选择一个供应商以应用于所有信用卡交易。',
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}账户描述`]: '选择支票的发送地点。',
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}错误`]: '启用地点时，供应商账单不可用。请选择其他导出选项。',
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}错误`]: '启用地点时支票不可用。请选择其他导出选项。',
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY}错误`]: '启用税务时，日记账分录不可用。请选择其他导出选项。',
            },
            ...
            items: '项目',
            customers: '客户/项目',
            exportCompanyCardsDescription: '设置公司卡采购如何导出到 QuickBooks Desktop。',
        ...
        qbo: {
            ...
            locations: '地点',
            customers: '客户/项目',
            accountsDescription: '您的 QuickBooks Online 账户分类表将作为类别导入到 Expensify 中。',
            accountsSwitchTitle: '选择将新账户导入为启用或禁用类别。',
            accountsSwitchDescription: '启用的类别将在成员创建费用时可供选择。',
            classesDescription: '选择如何在 Expensify 中处理 QuickBooks Online 分类。',
            ...
            outOfPocketTaxEnabledDescription: 'QuickBooks Online 不支持在日记账分录导出时包含税费。由于您的工作区启用了税费，此导出选项不可用。',
            outOfPocketTaxEnabledError: '启用税务时，日记账分录不可用。请选择其他导出选项。',
            advancedConfig: {
                ...
                createEntities: '自动创建实体',
                createEntitiesDescription: '如果供应商尚不存在，Expensify 会自动在 QuickBooks Online 中创建供应商，并在导出发票时自动创建客户。',
                reimbursedReportsDescription: '每当使用 Expensify ACH 支付报销单时，相关的账单付款将会在以下 QuickBooks Online 账户中创建。',
                qboBillPaymentAccount: 'QuickBooks 账单支付账户',
                qboInvoiceCollectionAccount: 'QuickBooks 发票催收账户',
                accountSelectDescription: '选择付款账户，我们将会在 QuickBooks Online 中创建付款。',
            ...
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}描述`]:
                    '我们将为每个 Expensify 报告创建一个明细供应商账单，账单日期为最后一笔费用的日期，并将其添加到账户下方。如果该期间已关闭，我们将记入下一个开放期间的第一天。',
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}账户描述`]: '选择导出借记卡交易的地点。',
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}账户描述`]: '选择导出信用卡交易的地点。',
                [`${CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}账户描述`]: '选择一个供应商以应用于所有信用卡交易。',
                [`${CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}错误`]: '启用地点时，供应商账单不可用。请选择其他导出选项。',
                [`${CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK}错误`]: '启用地点时支票不可用。请选择其他导出选项。',
                [`${CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY}错误`]: '启用税务时，日记账分录不可用。请选择其他导出选项。',
            },
            exportDestinationAccountsMisconfigurationError: {
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]: '请选择一个有效账户用于供应商账单导出',
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: '请选择一个有效账户以导出日记账分录',
            ...
            noAccountsFound: '未找到账户',
            noAccountsFoundDescription: '在 QuickBooks Online 中添加账户，然后重新同步连接。',
            accountingMethods: {
                label: '何时导出',
                ...
                alternateText: {
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]: '报销外支出将在最终批准时导出',
        ...
        xero: {
            ...
            mapTrackingCategoryToDescription: ({categoryName}: CategoryNameParams) => `选择导出到 Xero 时映射 ${categoryName} 的位置。`,
            customers: '重新向客户开账单',
            ...
            purchaseBill: '采购账单',
            exportDeepDiveCompanyCard: '导出的费用将作为银行交易发布到以下 Xero 银行账户，交易日期将与您的银行对账单上的日期相匹配。',
            bankTransactions: '银行交易',
            xeroBankAccount: 'Xero 银行账户',
            xeroBankAccountDescription: '选择费用将作为银行交易发布的位置。',
            exportExpensesDescription: '报告将导出为采购账单，日期和状态如下方所选。',
            ...
            exportDate: {
                label: '采购账单日期',
                description: '导出报告到 Xero 时请使用此日期。',
                values: {
            ...
            invoiceStatus: {
                label: '采购账单状态',
                description: '导出采购账单到 Xero 时请使用此状态。',
                values: {
        ...
        sageIntacct: {
            ...
            exportDate: {
                label: '导出日期',
                description: '导出报告到 Sage Intacct 时请使用此日期。',
                values: {
            ...
            defaultVendorDescription: ({isReimbursable}: DefaultVendorDescriptionParams) =>
                `设置一个默认供应商，该供应商将应用于在 Sage Intacct 中没有匹配供应商的 ${isReimbursable ? '' : 'non-'} 可报销费用。`,
            ...
            inviteEmployees: '邀请员工',
            inviteEmployeesDescription: '导入 Sage Intacct 员工记录并邀请员工加入此工作区。您的审批流程将默认为经理审批，且可在成员页面进一步配置。',
            syncReimbursedReports: '同步已报销的报销单',
            syncReimbursedReportsDescription: '每当使用 Expensify ACH 支付报销单时，相应的账单付款将会在以下 Sage Intacct 账户中创建。',
            paymentAccount: 'Sage Intacct 付款账户',
        },
        netsuite: {
            subsidiary: '子公司',
            subsidiarySelectDescription: '选择您想从中导入数据的 NetSuite 子公司。',
            exportDescription: '配置 Expensify 数据如何导出到 NetSuite。',
            exportInvoices: '导出发票到',
            journalEntriesTaxPostingAccount: '日记账分录税务过账账户',
            journalEntriesProvTaxPostingAccount: '日记账分录省级税务过账账户',
            foreignCurrencyAmount: '导出外币金额',
            exportToNextOpenPeriod: '导出到下一个开放期间',
            nonReimbursableJournalPostingAccount: '不可报销的日记账入账账户',
            reimbursableJournalPostingAccount: '可报销的日记账过账账户',
            journalPostingPreference: {
                label: '日记账分录过账偏好',
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '每个报告的单独明细条目',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '每笔费用仅输入一次',
                },
            },
            invoiceItem: {
                label: '发票项目',
                values: {
                    [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
                        label: '为我创建一个',
                        description: '导出时我们将为您创建一个“Expensify 发票条目”（如果尚不存在）。',
                    },
                    [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.SELECT]: {
                        label: '选择现有的',
                        description: '我们将把来自 Expensify 的发票与下面选择的项目关联起来。',
                    },
                },
            },
            exportDate: {
                label: '导出日期',
                description: '导出报告到 NetSuite 时使用此日期。',
                values: {
            ...
            advancedConfig: {
                ...
                reimbursedReportsDescription: '每当使用 Expensify ACH 支付报告时，相应的账单付款将会在以下 NetSuite 账户中创建。',
                reimbursementsAccount: '报销账户',
                reimbursementsAccountDescription: '选择您将用于报销的银行账户，我们将会在 NetSuite 中创建相关的付款。',
                collectionsAccount: '催收账户',
                collectionsAccountDescription: '一旦发票在 Expensify 中标记为已支付并导出到 NetSuite，它将显示在以下账户中。',
                approvalAccount: '应付账款审批账户',
                approvalAccountDescription: '选择将在 NetSuite 中批准交易的账户。如果您正在同步已报销的报告，这也是将创建账单付款的账户。',
                ...
                customFormIDDescription: '默认情况下，Expensify 将使用 NetSuite 中设置的首选交易表单创建条目。或者，您可以指定使用特定的交易表单。',
                customFormIDReimbursable: '自付费用',
                customFormIDNonReimbursable: '公司卡费用',
                exportReportsTo: {
                    label: '费用报告审批级别',
                    description: '一旦费用报告在 Expensify 中获得批准并导出到 NetSuite，您可以在 NetSuite 中设置额外的审批级别，然后再进行过账。',
                    values: {
                ...
                exportJournalsTo: {
                    label: '日记账分录审批级别',
                    description: '一旦在 Expensify 中的日记账分录被批准并导出到 NetSuite，您可以在 NetSuite 中设置一个额外的审批级别，之后再进行过账。',
                    values: {
            ...
            tokenInput: {
                ...
                formSteps: {
                    installBundle: {
                        ...
                        description: '在 NetSuite 中，转到 *Customization > SuiteBundler > Search & Install Bundles* > 搜索 "Expensify" > 安装该捆绑包。',
                    },
            ...
            import: {
                ...
                importFields: {
                    ...
                    classes: {
                        title: '课程',
                        subtitle: '选择如何处理 Expensify 中的*类别*。',
                    },
                    locations: {
                        title: '地点',
                        subtitle: '选择如何处理 Expensify 中的*地点*。',
                    },
                },
                customersOrJobs: {
                    title: '客户/项目',
                ...
                importCustomFields: {
                    ...
                    customSegments: {
                        ...
                        addForm: {
                            ...
                            customSegmentNameTitle: '自定义细分名称是什么？',
                ...
                importTypes: {
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]: {
                        ...
                        description: '未导入Expensify，已应用于导出',
                        footerContent: ({importField}: ImportFieldParams) => `如果您在 NetSuite 中使用 ${importField}，我们将在导出到费用报告或日记账分录时应用员工记录上设置的默认值。`,
                    },
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
                        label: '标签',
                        description: '分项级别',
                        footerContent: ({importField}: ImportFieldParams) => `${startCase(importField)} 将可供选择，用于员工报销单上的每一笔费用。`,
                    },
        ...
        intacct: {
            ...
            followSteps: '请按照我们的操作指南：连接到 Sage Intacct 中的步骤进行操作',
            ...
            displayedAsTagDescription: '部门将可在员工报销单的每笔费用中单独选择。',
            ...
            userDimensionsAdded: () => ({
                one: '已添加 1 UDD',
                other: (count: number) => `已添加 ${count} 个 UDDs`,
            }),
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                enableFeed: {
                    ...
                    visa: '我们与Visa有全球集成，但资格因银行和卡片计划而异。\n\n要开始，只需：',
                    mastercard: '我们与 Mastercard 有全球集成，但资格因银行和卡片项目而异。\n\n要开始，只需：',
                    vcf: `1. 访问[这篇帮助文章](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP})，获取有关如何设置您的Visa商业卡的详细说明。\n\n2. [联系您的银行](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP})，确认他们是否支持您的项目的商业数据传输，并请求他们启用该功能。\n\n3. *一旦数据传输启用并且您获得了相关信息，请继续下一屏。*`,
                    ...
                    cdf: `1. 请访问[此帮助文章](${CONST.COMPANY_CARDS_MASTERCARD_COMMERCIAL_CARDS})，了解如何设置您的 Mastercard 商业卡的详细说明。\n\n2. [联系您的银行](${CONST.COMPANY_CARDS_MASTERCARD_COMMERCIAL_CARDS})，确认他们是否支持您的项目的商业数据传输，并请求他们启用该功能。\n\n3. *一旦数据传输启用并且您获得了相关信息，请继续下一屏。*`,
            ...
            startDateDescription: '我们将从此日期开始导入所有交易。如果未指定日期，我们将回溯至您的银行允许的最早日期。',
            ...
            card: '卡片',
            cardName: '卡片名称',
            brokenConnectionErrorFirstPart: `卡片提要连接已断开。请重新连接。`,
            brokenConnectionErrorLink: '登录您的银行账户',
            brokenConnectionErrorSecondPart: '这样我们就可以重新建立连接。',
            assignedCard: ({assignee, link}: AssignedCardParams) => `将${assignee}分配了一个${link}！导入的交易将显示在此聊天中。`,
            companyCard: '公司卡',
            chooseCardFeed: '选择卡片动态',
            ukRegulation:
                'Expensify, Inc. 是 Plaid Financial Ltd. 的代理机构，Plaid Financial Ltd. 是一家经金融行为监管局根据2017年支付服务条例（公司参考编号：804718）授权的支付机构。Plaid 通过其代理机构 Expensify Limited 向您提供受监管的账户信息服务。',
        },
        expensifyCard: {
            issueAndManageCards: '发行和管理您的 Expensify 卡',
            getStartedIssuing: '通过发行您的第一张虚拟卡或实体卡开始吧。',
            ...
            limit: '限制',
            currentBalance: '当前余额',
            currentBalanceDescription: '当前余额是自上次结算日期以来所有已入账的 Expensify 卡交易的总和。',
            balanceWillBeSettledOn: ({settlementDate}: SettlementDateParams) => `余额将于 ${settlementDate} 结算`,
            settleBalance: '结清余额',
            cardLimit: '卡片限额',
            remainingLimit: '剩余额度',
            requestLimitIncrease: '请求增加请求限制',
            remainingLimitDescription:
                '我们在计算您的剩余额度时会考虑多个因素：您作为客户的服务期限、您在注册时提供的与业务相关的信息，以及您企业银行账户中的可用现金。您的剩余额度可能会每日波动。',
            earnedCashback: '返现',
            earnedCashbackDescription: '现金返还余额基于您工作区内已结算的每月 Expensify 卡消费金额。',
            issueNewCard: '发行新卡',
            finishSetup: '完成设置',
            ...
            settlementAccountInfoPt2: '这样连续对账才能正常工作。',
            reconciliationAccount: '对账账户',
            settlementFrequency: '结算频率',
            settlementFrequencyDescription: '选择您支付 Expensify Card 余额的频率。',
            settlementFrequencyInfo: '如果您想切换到按月结算，您需要通过 Plaid 连接您的银行账户，并且在过去90天内保持正余额记录。',
            frequency: {
                daily: '每日',
                monthly: '每月',
            },
            ...
            issuedCard: ({assignee}: AssigneeParams) => `已向${assignee}发放了一张Expensify卡！卡片将在2-3个工作日内送达。`,
            issuedCardNoShippingDetails: ({assignee}: AssigneeParams) => `已向 ${assignee} 发放 Expensify 卡！卡片将在添加送货详情后发出。`,
            issuedCardVirtual: ({assignee, link}: IssueVirtualCardParams) => `已向 ${assignee} 发放了一个虚拟的 ${link}！该卡可以立即使用。`,
            addedShippingDetails: ({assignee}: AssigneeParams) => `${assignee} 添加了运输详情。Expensify 卡将在 2-3 个工作日内送达。`,
            verifyingHeader: '验证中',
        ...
        categories: {
            ...
            subtitle: '更好地了解资金的使用去向。使用我们的默认类别或添加您自己的类别。',
            emptyCategories: {
                title: '您还没有创建任何类别',
                subtitle: '添加一个类别以组织您的支出。',
            },
            emptyCategoriesWithAccounting: {
                subtitle1: '您的分类当前正从会计连接导入。请前往',
                subtitle2: '会计',
                subtitle3: '进行任何更改。',
            },
        ...
        moreFeatures: {
            ...
            expensifyCard: {
                ...
                feed: {
                    ...
                    subTitle: '简化您的业务开支，节省高达50%的Expensify账单费用，此外还包括：',
                    features: {
                        cashBack: '每笔美国消费均返现',
                        unlimited: '无限虚拟卡',
                        spend: '支出控制和自定义限额',
            ...
            companyCards: {
                ...
                disableCardPrompt: '您无法禁用公司卡，因为此功能正在使用中。请联系 Concierge 了解下一步操作。',
                disableCardButton: '与 Concierge 聊天',
                cardDetails: '卡片详情',
                cardNumber: '卡号',
                cardholder: '持卡人',
                ...
                assignCard: '分配卡片',
                cardFeedName: '卡片提要名称',
                cardFeedNameDescription: '给卡片订阅源起一个独特的名称，以便您能将其与其他订阅源区分开来。',
                ...
                removeCardFeedDescription: '您确定要删除此卡片源吗？这将取消所有卡片的分配。',
                error: {
                    feedNameRequired: '卡片提要名称为必填项',
                },
                corporate: '限制删除交易',
                personal: '允许删除交易',
                setFeedNameDescription: '给卡片订阅源起一个独特的名称，以便您能区分它与其他订阅源。',
                ...
                downgradeSubTitleFirstPart: `此工作区无法降级，因为连接了多个卡片信息源（不包括 Expensify Cards）。请`,
                downgradeSubTitleMiddlePart: `只保留一个卡片信息流`,
                downgradeSubTitleLastPart: '继续。',
                noAccountsFoundDescription: ({connection}: ConnectionParams) => `请在 ${connection} 中添加账户，然后重新同步连接。`,
                expensifyCardBannerTitle: '获取 Expensify 卡',
                expensifyCardBannerSubtitle: '享受每笔美国消费的现金返还，最高可享受高达50%的Expensify账单折扣，无限虚拟卡，以及更多优惠。',
        ...
        reportFields: {
            ...
            subtitle: '报告字段适用于所有支出，当您希望提示输入额外信息时，这些字段会很有帮助。',
            ...
            initialValueInputSubtitle: '输入报告字段中显示的起始值。',
        ...
        tags: {
            ...
            importTags: '导入标签',
            importTagsSupportingText: '使用一种或多种标签为您的费用分类。',
            configureMultiLevelTags: '配置您的标签列表以实现多级标签。',
            importMultiLevelTagsSupportingText: `这是您的标签预览。如果一切正常，请点击下方导入。`,
            ...
            importedTagsMessage: ({columnCounts}: ImportedTagsMessageParams) =>
                `我们在您的电子表格中找到了*${columnCounts} 列*。请选择包含标签名称的列旁边的*Name*。您也可以选择设置标签状态的列旁边的*Enabled*。`,
            ...
            cannotMakeAllTagsOptional: {
                title: '无法使所有标签可选',
                description: `至少必须保留一个标签为必填，因为您的工作区设置要求必须填写标签。`,
            },
            tagCount: () => ({
                one: '1 天',
        ...
        taxes: {
            ...
            error: {
                ...
                createFailureMessage: '创建税率时发生错误。请重试或联系 Concierge 寻求帮助。',
        ...
        emptyWorkspace: {
            title: '创建工作区',
            subtitle: '创建一个工作区，用于跟踪收据、报销费用、管理差旅、发送发票等——一切尽在聊天速度之中。',
        ...
        people: {
            ...
            addedWithPrimary: '一些成员已使用其主要登录添加。',
        ...
        card: {
            ...
            issueNewCard: {
                ...
                smartLimit: '智能限额',
                smartLimitDescription: '在需要批准之前，最多花费一定金额',
                monthly: '每月',
                monthlyDescription: '每月最多花费一定金额',
                fixedAmount: '固定金额',
                fixedAmountDescription: '一次性消费至多某个金额',
                setLimit: '设置限制',
                cardLimitError: '请输入小于 $21,474,836 的金额',
                giveItName: '给它起个名字',
                giveItNameInstruction: '使其足够独特，以便与其他卡片区分开来。具体的使用场景更佳！',
                cardName: '卡片名称',
                letsDoubleCheck: '让我们再仔细检查一下，确保一切正确无误。',
                willBeReady: '此卡将立即可用。',
                cardholder: '持卡人',
        ...
        accounting: {
            ...
            importTypes: {
                ...
                [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: '导入为报表字段',
            ...
            reimbursedReports: '同步已报销的报销单',
            cardReconciliation: '卡片对账',
            reconciliationAccount: '对账账户',
            continuousReconciliation: '持续对账',
            saveHoursOnReconciliation: '通过让 Expensify 持续为您对账 Expensify 卡的账单和结算，每个会计期间节省数小时的对账时间。',
            enableContinuousReconciliation: '要启用持续对账，请启用',
            chooseReconciliationAccount: {
                chooseBankAccount: '选择您的 Expensify 卡支付将进行对账的银行账户。',
                accountMatches: '确保此账户与您的',
                settlementAccount: 'Expensify Card 结算账户',
                reconciliationWorks: ({lastFourPAN}: ReconciliationWorksParams) => `（以 ${lastFourPAN} 结尾），以确保连续对账正常进行。`,
            },
        },
        export: {
        ...
        invoices: {
            ...
            paymentMethods: {
                personal: '个人',
                business: '商务',
                chooseInvoiceMethod: '请选择以下一种付款方式：',
                addBankAccount: '添加银行账户',
                payingAsIndividual: '作为个人付款',
                payingAsBusiness: '以企业身份付款',
            },
            invoiceBalance: '发票余额',
            invoiceBalanceSubtitle: '这是您从收取发票付款中获得的当前余额。如果您已添加银行账户，余额将自动转入您的银行账户。',
        ...
        invite: {
            ...
            members: '邀请成员',
            invitePeople: '邀请新成员',
            genericFailureMessage: '邀请成员加入工作区时发生错误。请重试。',
        ...
        editor: {
            ...
            currencyInputHelpText: '此工作区中的所有费用将转换为此货币。',
        ...
        bankAccount: {
            ...
            youAreAlmostDone: '您几乎完成了银行账户的设置，这将使您能够发放企业卡、报销费用、收取发票和支付账单。',
            streamlinePayments: '简化支付流程',
            connectBankAccountNote: '注意：个人银行账户不能用于工作区的付款。',
            oneMoreThing: '还有一件事！',
            allSet: '您已全部设置完成！',
            accountDescriptionWithCards: '该银行账户将用于发放企业信用卡、报销费用、收取发票和支付账单。',
            ...
            disconnectYour: '断开您的',
            bankAccountAnyTransactions: '银行账户。该账户的任何未结交易仍将完成。',
            ...
            yourWorkspace: '您的工作区设置为不支持的货币。查看 the',
            listOfSupportedCurrencies: '支持的货币列表',
        },
        changeOwner: {
            changeOwnerPageTitle: '转移所有者',
            addPaymentCardTitle: '请输入您的支付卡以转移所有权',
            ...
            amountOwedText: '该账户存在上个月的未结余额。\n\n您是否希望清除余额并接管此工作区的账单？',
            ownerOwesAmountTitle: '未结余额',
            ownerOwesAmountButtonText: '转账余额',
            ownerOwesAmountText: ({email, amount}: OwnerOwesAmountParams) =>
                `拥有此工作区的账户（${email}）有上个月的未结余额。\n\n您是否想转移此金额（${amount}）以接管此工作区的账单？您的付款卡将立即被扣款。`,
            subscriptionTitle: '接管年度订阅',
            subscriptionButtonText: '转移订阅',
            subscriptionText: ({usersCount, finalCount}: ChangeOwnerSubscriptionParams) =>
                `接管此工作区将把其年度订阅与您当前的订阅合并。这将使您的订阅成员数量增加 ${usersCount} 人，您的新订阅成员总数将为 ${finalCount}。您想继续吗？`,
            ...
            hasFailedSettlementsText: ({email}: ChangeOwnerHasFailedSettlementsParams) =>
                `您无法接管账单，因为 ${email} 有一笔逾期的 Expensify 卡结算。请让他们联系 concierge@expensify.com 以解决该问题。然后，您就可以接管此工作区的账单。`,
        ...
        upgrade: {
            reportFields: {
                title: '报告字段',
                description: `报告字段允许您指定报表级别的详细信息，这些信息不同于针对单个条目费用的标签。这些详细信息可以包括特定的项目名称、出差信息、地点等。`,
                onlyAvailableOnPlan: '报告字段仅在 Control 计划中提供，起价为',
            },
            [CONST.POLICY.CONNECTIONS.NAME.NETSUITE]: {
                title: 'NetSuite',
                description: `通过 Expensify + NetSuite 集成，享受自动同步，减少手动输入。利用原生和自定义细分支持（包括项目和客户映射），获得深入的实时财务洞察。`,
                onlyAvailableOnPlan: '我们的 NetSuite 集成仅在 Control 计划中提供，起价为',
            },
            [CONST.POLICY.CONNECTIONS.NAME.SAGE_INTACCT]: {
                title: 'Sage Intacct',
                description: `通过 Expensify 与 Sage Intacct 的集成，享受自动同步，减少手动输入。利用用户定义的维度以及按部门、类别、地点、客户和项目（工作）进行的费用编码，获得深入的实时财务洞察。`,
                onlyAvailableOnPlan: '我们的 Sage Intacct 集成仅在 Control 计划中提供，起价为',
            },
            [CONST.POLICY.CONNECTIONS.NAME.QBD]: {
                title: 'QuickBooks Desktop',
                description: `通过 Expensify + QuickBooks Desktop 集成，享受自动同步，减少手动输入。通过实时双向连接以及按类别、项目、客户和项目进行费用编码，实现终极效率。`,
                onlyAvailableOnPlan: '我们的 QuickBooks Desktop 集成仅在 Control 计划中提供，起价为',
            },
            [CONST.UPGRADE_FEATURE_INTRO_MAPPING.approvals.id]: {
                title: '高级审批',
                description: `如果您想增加更多的审批层级，或者只是想确保最大的开支得到额外的审核，我们都能为您提供支持。高级审批功能帮助您在每个层级设置合适的审核机制，从而让您更好地控制团队的支出。`,
                onlyAvailableOnPlan: '高级审批仅在 Control 计划中提供，起价为',
            },
            categories: {
                title: '类别',
                description: `类别帮助您更好地组织费用，以便跟踪您的资金花费去向。您可以使用我们建议的类别列表或创建您自己的类别。`,
                onlyAvailableOnPlan: '分类在 Collect 计划中可用，起价为',
            },
            glCodes: {
                title: 'GL 代码',
                description: `为您的类别和标签添加总账代码，便于将费用轻松导出到您的会计和薪资系统。`,
            ...
            taxCodes: {
                title: '税务代码',
                description: `将税码添加到您的税务中，便于将费用轻松导出到您的会计和薪资系统。`,
                onlyAvailableOnPlan: '税务代码仅在 Control 计划中提供，起价为',
            },
            companyCards: {
                title: '无限公司卡',
                description: `需要添加更多卡片信息源？解锁无限公司卡，同步所有主要发卡机构的交易。`,
                onlyAvailableOnPlan: '此功能仅在 Control 计划中提供，起价为',
            },
            rules: {
                title: '规则',
                description: `规则在后台运行，帮助您控制支出，让您无需为琐事烦恼。\n\n要求提供费用详情，如收据和说明，设置限制和默认值，并自动化审批和支付——所有操作尽在一处完成。`,
                onlyAvailableOnPlan: '规则仅适用于起价为 的 Control 计划，开始于',
            },
            perDiem: {
                title: '每日津贴',
                description: '每日津贴是确保员工出差期间每日费用合规且可预测的绝佳方式。享受自定义费率、默认类别以及更细化的详情，如目的地和子费率等功能。',
                onlyAvailableOnPlan: '每日津贴仅适用于起价为 Control 计划的方案，开始于',
            },
            travel: {
                title: '旅行',
                description: 'Expensify Travel 是一个新的企业差旅预订和管理平台，允许成员预订住宿、航班、交通等。',
                onlyAvailableOnPlan: '旅行功能在 Collect 计划中可用，起价为',
            },
            multiLevelTags: {
                title: '多级标签',
                description:
                    '多级标签帮助您更精确地跟踪费用。为每个明细项分配多个标签——例如部门、客户或成本中心——以捕捉每笔费用的完整背景。这使得报告更详细，审批流程更顺畅，且会计导出更全面。',
        ...
        downgrade: {
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit4: '增强的安全控制',
                    headsUp: '提醒！',
                    multiWorkspaceNote: '您需要在首次月度付款之前将所有工作区降级，以开始按 Collect 费率订阅。点击',
        ...
        restrictedAction: {
            restricted: '受限',
            actionsAreCurrentlyRestricted: ({workspaceName}: ActionsAreCurrentlyRestricted) => `${workspaceName} 工作区的操作当前受到限制`,
            workspaceOwnerWillNeedToAddOrUpdatePaymentCard: ({workspaceOwnerName}: WorkspaceOwnerWillNeedToAddOrUpdatePaymentCardParams) =>
                `工作区所有者 ${workspaceOwnerName} 需要添加或更新已存档的付款卡，以解锁新的工作区活动。`,
            youWillNeedToAddOrUpdatePaymentCard: '您需要添加或更新已保存的付款卡，以解锁新的工作区活动。',
        ...
        rules: {
            individualExpenseRules: {
                title: '费用',
                subtitle: '为单个费用设置支出控制和默认值。您还可以为以下内容创建规则',
                ...
                billableDefaultDescription: '选择现金和信用卡费用是否应默认可计费。可计费费用在以下位置启用或禁用',
                billable: '可计费',
            ...
            expenseReportRules: {
                ...
                preventSelfApprovalsSubtitle: '防止工作区成员审批自己的报销单。',
                autoApproveCompliantReportsTitle: '自动批准合规报告',
                autoApproveCompliantReportsSubtitle: '配置哪些报销单符合自动审批条件。',
                autoApproveReportsUnderTitle: '自动批准以下报告',
                autoApproveReportsUnderDescription: '低于此金额的完全合规的报销单将自动获得批准。',
                randomReportAuditTitle: '随机报告审核',
                randomReportAuditDescription: '要求某些报告必须手动批准，即使符合自动批准条件。',
                autoPayApprovedReportsTitle: '自动支付已批准的报销单',
                autoPayApprovedReportsSubtitle: '配置哪些费用报销单符合自动支付资格。',
                ...
                autoPayReportsUnderDescription: '低于此金额的完全合规的费用报告将自动支付。',
                unlockFeatureGoToSubtitle: '前往',
                unlockFeatureEnableWorkflowsSubtitle: ({featureName}: FeatureNameParams) => `并启用工作流，然后添加 ${featureName} 以解锁此功能。`,
        ...
        planTypePage: {
            ...
            lockedPlanDescription: ({count, annualSubscriptionEndDate}: WorkspaceLockedPlanTypeParams) => ({
                one: `您已承诺在控制计划中拥有1名活跃成员，直到您的年度订阅于${annualSubscriptionEndDate}结束。您可以在${annualSubscriptionEndDate}起通过关闭自动续订，切换为按使用付费订阅并降级到收集计划。`,
                other: `您已承诺在控制计划中拥有 ${count} 名活跃成员，直到您的年度订阅于 ${annualSubscriptionEndDate} 结束。您可以在 ${annualSubscriptionEndDate} 开始通过关闭自动续订切换到按使用付费订阅并降级到收集计划。`,
            }),
            subscriptions: '订阅',
        },
    },
    ...
    workspaceActions: {
        ...
        deleteApprovalRule: ({approverEmail, approverName, field, name}: AddedPolicyApprovalRuleParams) => `已将 ${approverName} (${approverEmail}) 从 "${name}" 的 ${field} 审批人中移除`,
        ...
        updateAreCommentsRequired: ({oldValue, categoryName}: UpdatedPolicyCategoryParams) => {
            return `将 "${categoryName}" 类别描述更改为 ${!oldValue ? '必填' : '不需要'}（之前为 ${!oldValue ? '不需要' : '必填'}）`;
        },
        ...
        updatedDescriptionHint: ({categoryName, oldValue, newValue}: UpdatedPolicyCategoryDescriptionHintTypeParams) => {
            ...
            return !oldValue ? `已将描述提示 "${newValue}" 添加到类别 "${categoryName}"` : `将“${categoryName}”类别描述提示更改为“${newValue}”（之前为“${oldValue}”）`;
        },
        ...
        updateTagName: ({tagListName, newName, oldName}: UpdatedPolicyTagNameParams) => `更新了标签列表 "${tagListName}"，将标签 "${oldName}" 更改为 "${newName}"`,
        ...
        updateTag: ({tagListName, newValue, tagName, updatedField, oldValue}: UpdatedPolicyTagFieldParams) => {
            if (oldValue) {
                return `通过将${updatedField}更改为"${newValue}"（之前为"${oldValue}"），更新了列表"${tagListName}"上的标签"${tagName}"。`;
            }
        ...
        updatedCustomUnitTaxClaimablePercentage: ({customUnitRateName, newValue, oldValue}: UpdatedPolicyCustomUnitTaxClaimablePercentageParams) => {
            if (oldValue) {
                return `将距离费率 "${customUnitRateName}" 上可退税部分更改为 "${newValue}"（之前为 "${oldValue}"）`;
            }
            return `已向距离费率 "${customUnitRateName}" 添加了可退税部分 "${newValue}"`;
        },
        ...
        preventSelfApproval: ({oldValue, newValue}: UpdatedPolicyPreventSelfApprovalParams) =>
            `updated "Prevent self-approval" to "${newValue === 'true' ? '已启用' : '已禁用'}" (previously "${oldValue === 'true' ? '已启用' : '已禁用'}")`,
        updateMaxExpenseAmountNoReceipt: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `将最大收据所需的报销金额更改为 ${newValue}（之前为 ${oldValue}）`,
        ...
        updateDefaultBillable: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `已将“Re-bill expenses to clients”更新为“${newValue}”（之前为“${oldValue}”）`,
        ...
        removedFromApprovalWorkflow: ({submittersNames}: RemovedFromApprovalWorkflowParams) => {
            ...
            return {
                ...
                other: `已将您从 ${joinedNames} 的审批工作流和费用聊天中移除。之前提交的报告仍将保留在您的收件箱中供审批。`,
            };
        },
        ...
        updatedAuditRate: ({oldAuditRate, newAuditRate}: UpdatedPolicyAuditRateParams) =>
            `随机路由到手动审批的报告比例已更改为 ${Math.round(newAuditRate * 100)}%（之前为 ${Math.round(oldAuditRate * 100)}%）`,
    ...
    roomMembersPage: {
        ...
        notAuthorized: `您无权访问此页面。如果您想加入此房间，请直接请求房间成员将您添加。还有其他问题？请联系 ${CONST.EMAIL.CONCIERGE}。`,
        removeMembersPrompt: ({memberName}: {memberName: string}) => ({
            one: `您确定要将 ${memberName} 从房间中移除吗？`,
            other: '您确定要将选定的成员移出房间吗？',
        }),
        error: {
    ...
    search: {
        ...
        filters: {
            date: {
                ...
                on: ({date}: OptionalParam<DateParams> = {}) => `于 ${date ?? ''}`,
            },
            status: '状态',
            keyword: '关键词',
            hasKeywords: '有关键词',
            ...
            card: {
                ...
                cardFeedNameCSV: ({cardFeedLabel}: {cardFeedLabel?: string}) => `所有CSV导入的卡片${cardFeedLabel ? ` - ${cardFeedLabel}` : ''}`,
            },
            current: '当前',
            past: '过去',
            submitted: '提交日期',
        ...
        exportSearchResults: {
            title: '创建导出',
            description: '哇，物品真多！我们会帮你打包，Concierge 很快会发送文件给你。',
        },
        exportAll: {
    ...
    fileDownload: {
        success: {
            title: '已下载！',
            message: '附件下载成功！',
            qrMessage: '检查您的照片或下载文件夹，查找您的二维码副本。小贴士：将其添加到演示文稿中，方便观众扫描并直接与您连接。',
        },
        generalError: {
            title: '附件错误',
            message: '无法下载附件',
        ...
        permissionError: {
            title: '存储访问',
            message: 'Expensify 无法在没有存储权限的情况下保存附件。点击设置以更新权限。',
        },
    },
    desktopApplicationMenu: {
        mainMenu: '新的 Expensify',
        about: '关于 New Expensify',
        update: '更新新的 Expensify',
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                delegateSubmit: ({delegateUser, originalManager}: DelegateSubmitParams) => `将此报告发送给${delegateUser}，因为${originalManager}正在休假`,
                ...
                integrationsMessage: ({errorMessage, label, linkText, linkURL}: IntegrationSyncFailedParams) =>
                    `无法导出此报告到 ${label} ("${errorMessage} ${linkText ? `<a href="${linkURL}">${linkText}</a>` : ''}")`,
                managerAttachReceipt: `添加了收据`,
                ...
                selectedForRandomAuditMarkdown: `[randomly selected](https://help.expensify.com/articles/expensify-classic/reports/Set-a-random-report-audit-schedule) 进行审核`,
                ...
                updatedCustomField1: ({email, previousValue, newValue}: UpdatedCustomFieldParams) => {
                    ...
                    return !previousValue ? `将 "${newValue}" 添加到 ${email} 的自定义字段 1` : `将 ${email} 的自定义字段1更改为 "${newValue}"（之前为 "${previousValue}"）`;
                },
    ...
    moderation: {
        flagDescription: '所有标记的消息将发送给版主进行审核。',
    ...
    teachersUnitePage: {
        teachersUnite: '教师联合',
        joinExpensifyOrg: '加入 Expensify.org，一起消除全球的不公。当前的“教师联合”活动通过分摊必需学校用品的费用，支持各地的教育工作者。',
        iKnowATeacher: '我认识一位老师',
        iAmATeacher: '我是老师',
        getInTouch: '太好了！请分享他们的信息，以便我们与他们联系。',
        introSchoolPrincipal: '向您的学校校长介绍',
        schoolPrincipalVerifyExpense: 'Expensify.org 分摊基本学习用品的费用，以便来自低收入家庭的学生能够获得更好的学习体验。您的校长将被要求核实您的费用。',
        principalFirstName: '主要负责人名字',
        ...
        error: {
            ...
            tryDifferentEmail: '请尝试使用不同的电子邮件地址',
        },
    },
    cardTransactions: {
        notActivated: '未激活',
    ...
    distance: {
        ...
        mapPending: {
            title: '映射待处理',
            subtitle: '当您重新上线时，地图将被生成',
            onlineSubtitle: '请稍候，我们正在设置地图',
            errorTitle: '映射错误',
            errorSubtitle: '加载地图时出错。请再试一次。',
        },
        error: {
    ...
    referralProgram: {
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
            ...
            buttonText2: '推荐朋友。',
            header: '开始聊天，推荐朋友',
            body: '想让你的朋友们也使用 Expensify 吗？只需与他们开始聊天，剩下的交给我们处理。',
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
            buttonText1: '提交一笔费用，',
            buttonText2: '推荐给您的老板。',
            header: '提交报销，推荐给您的老板',
            body: '想让您的老板也使用 Expensify 吗？只需向他们提交一笔报销费用，剩下的交给我们处理。',
        },
    ...
    violations: {
        ...
        autoReportedRejectedExpense: ({rejectReason, rejectedBy}: ViolationsAutoReportedRejectedExpenseParams) => `${rejectedBy} 拒绝了此费用，理由是“${rejectReason}”`,
        ...
        customUnitOutOfPolicy: '该工作区的费率无效',
        ...
        rter: ({brokenBankConnection, email, isAdmin, isTransactionOlderThan7Days, member, rterType}: ViolationsRterParams) => {
            ...
            if (brokenBankConnection) {
                return isAdmin ? `由于银行连接中断，无法自动匹配收据，需由 ${email} 进行修复。` : '由于银行连接中断，无法自动匹配收据，您需要修复该连接。';
            }
        ...
        confirmDuplicatesInfo: `您未保留的重复请求将由成员删除`,
        hold: '此费用已被搁置',
    ...
    exitSurvey: {
        ...
        reasons: {
            [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]: '我需要一个仅在 Expensify Classic 中可用的功能。',
        ...
        thankYou: '感谢您的反馈！',
        thankYouSubtitle: '您的反馈将帮助我们打造更高效的产品。非常感谢！',
        ...
        bookACallTextBottom: '我们非常期待与您通话，了解原因。您可以预约与我们的高级产品经理之一通话，讨论您的需求。',
    ...
    subscription: {
        ...
        billingBanner: {
            ...
            policyOwnerAmountOwedOverdue: {
                ...
                subtitle: ({date, purchaseAmountOwed}: BillingBannerOwnerAmountOwedOverdueParams) =>
                    date && purchaseAmountOwed ? `您在${date}的${purchaseAmountOwed}费用未能处理。请添加一张付款卡以清除所欠金额。` : '请添加一张支付卡以清除所欠金额。',
            },
            ...
            insufficientFunds: {
                title: '您的卡无法扣款',
                subtitle: ({amountOwed}: BillingBannerInsufficientFundsParams) => `您的付款卡因资金不足被拒绝。请重试或添加新的付款卡以清除您未结清的 ${amountOwed} 余额。`,
            },
            cardExpired: {
                title: '您的卡无法扣款',
        ...
        cardSection: {
            ...
            requestRefund: '请求退款',
            requestRefundModal: {
                phrase1: '退款很简单，只需在下一个计费日期之前降级您的账户，您就会收到退款。',
                phrase2: '提醒：降级您的账户意味着您的工作区将被删除。此操作无法撤销，但如果您改变主意，您可以随时创建新的工作区。',
                confirm: '删除工作区并降级',
            },
        ...
        yourPlan: {
            ...
            pricePerMemberMonth: ({price}: YourPlanPriceValueParams) => `每位成员/月 ${price}`,
            pricePerMemberPerMonth: ({price}: YourPlanPriceValueParams) => `每位成员每月 ${price}`,
            perMemberMonth: '每位成员/月',
            collect: {
                title: '收集',
                description: '为您提供费用、差旅和聊天功能的小型企业计划。',
                priceAnnual: ({lower, upper}: YourPlanPriceParams) => `拥有 Expensify 卡的活跃成员中有 ${lower}，没有 Expensify 卡的活跃成员中有 ${upper}。`,
                pricePayPerUse: ({lower, upper}: YourPlanPriceParams) => `拥有 Expensify 卡的活跃成员中有 ${lower}，没有 Expensify 卡的活跃成员中有 ${upper}。`,
                benefit1: '收据扫描',
                benefit2: '报销',
                benefit3: '企业卡管理',
                benefit4: '费用和差旅审批',
        ...
        compareModal: {
            comparePlans: '比较计划',
            unlockTheFeatures: '通过适合您的计划解锁所需功能。',
        ...
        details: {
            ...
            headsUp:
                '提醒：如果您现在不设置订阅规模，我们将自动根据您第一个月的活跃成员数量来设置。之后，您需要在接下来的12个月内至少支付该数量成员的费用。您可以随时增加订阅规模，但在订阅期结束之前，无法减少订阅规模。',
        ...
        paymentCard: {
            ...
            security: 'Expensify 符合 PCI-DSS 标准，使用银行级加密，并利用冗余基础设施来保护您的数据。',
        ...
        subscriptionSettings: {
            ...
            pricingConfiguration: '价格取决于配置。选择年度订阅并获取 Expensify 卡，即可享受最低价格。',
            learnMore: {
                part1: '了解更多关于我们的',
                pricingPage: '定价页面',
                part2: '或在您的  中与我们的团队聊天',
                adminsRoom: '#管理员室。',
            },
            estimatedPrice: '预计价格',
            changesBasedOn: '这取决于您的 Expensify 卡使用情况以及以下订阅选项。',
        },
        requestEarlyCancellation: {
            ...
            subscriptionCanceled: {
                title: '订阅已取消',
                subtitle: '您的年度订阅已被取消。',
                info: '如果您想继续按使用付费的方式使用您的工作区，您已经准备好了。',
            ...
            requestSubmitted: {
                title: '请求已提交',
                subtitle: {
                    part1: '感谢您告知我们您有意取消订阅。我们正在审核您的请求，并将通过您与 的聊天尽快与您联系。',
                    link: 'Concierge',
                    part2: '.',
                },
            },
    ...
    delegate: {
        ...
        accessLevelDescription: '请选择以下访问级别。完全访问和有限访问都允许助理查看所有对话和费用。',
        roleDescription: ({role}: OptionalParam<DelegateRoleParams> = {}) => {
            switch (role) {
                case CONST.DELEGATE_ROLE.ALL:
                    return '允许其他成员代表您在您的账户中执行所有操作。包括聊天、提交、审批、付款、设置更新等。';
                case CONST.DELEGATE_ROLE.SUBMITTER:
                    return '允许其他成员代表您在您的账户中执行大部分操作。不包括审批、付款、拒绝和保留。';
                default:
                    return '';
            }
        },
        removeCopilot: '移除 copilot',
        removeCopilotConfirmation: '您确定要移除此助手吗？',
        changeAccessLevel: '更改访问级别',
        makeSureItIsYou: '让我们确认是您本人',
        enterMagicCode: ({contactMethod}: EnterMagicCodeParams) => `请输入发送到 ${contactMethod} 的验证码以添加副驾驶。验证码应在一两分钟内收到。`,
    ...
    debug: {
        ...
        reasonVisibleInLHN: {
            ...
            hasRBR: '有 RBR',
            pinnedByUser: '由成员置顶',
            hasIOUViolations: '存在 IOU 违规行为',
            hasAddWorkspaceRoomErrors: '有添加工作区房间的错误',
            isUnread: '未读（专注模式）',
            isArchived: '已归档（最新模式）',
            isSelfDM: '是自我私信',
            isFocused: '暂时专注于',
    ...
    migratedUserWelcomeModal: {
        title: '差旅和报销，聊天般的速度',
        subtitle: '新版 Expensify 拥有同样出色的自动化功能，同时实现了惊人的协作体验：',
        confirmText: '我们走吧！',
        features: {
            chat: '<strong>直接在任何费用</strong>、报告或工作区上聊天',
            scanReceipt: '<strong>扫描收据</strong>并获得报销',
            crossPlatform: '从您的手机或浏览器<strong>完成所有操作</strong>',
        },
    },
    ...
    scheduledCall: {
        ...
        confirmation: {
            title: '确认通话',
            description: '请确保以下详细信息对您来说没问题。一旦您确认通话，我们将发送包含更多信息的邀请。',
    ...
    autoSubmitModal: {
        ...
        pendingExpensesDescription: '任何待处理的卡片费用已被移至单独的报告，直到它们入账。',
    },
    testDrive: {
        quickAction: {
            takeATwoMinuteTestDrive: '进行2分钟试用体验',
        },
        modal: {
            title: '带我们试驾一下',
            description: '快速体验产品导览，迅速上手。无需中途停留！',
            confirmText: '开始试驾',
            helpText: '跳过',
            employee: {
                description: '<muted-text>让您的团队享受<strong>3个月免费的Expensify！</strong>只需在下面输入您老板的电子邮件并发送一笔测试报销即可。</muted-text>',
                email: '请输入您老板的电子邮件',
        ...
        employeeInviteMessage: ({name}: EmployeeInviteMessageParams) =>
            `# ${name} 邀请您试用 Expensify\n嘿！我刚刚为我们获得了 *3 个月免费* 试用 Expensify，这是处理报销最快的方法。\n\n这里有一张 *测试收据*，向您展示它是如何工作的：`,
    },
};
