...
添加更多消费规则以保护公司现金流。`,
                ...
                saveRule: '保存规则',
                allow: '允许',
                spendRuleSectionTitle: '消费规则',
                restrictionType: '限制类型',
                restrictionTypeHelpAllow: '如果消费与任一商户或类别匹配，且未超过最高金额，则会被批准。',
                restrictionTypeHelpBlock: '如果交易符合任一商户或类别，或超过最高金额，就会被拒付。',
                addMerchant: '添加商户',
                merchantContains: '商家包含',
                merchantExactlyMatches: '商家完全匹配',
                noBlockedMerchants: '没有被拦截的商家',
                addMerchantToBlockSpend: '添加要拦截消费的商户',
                noAllowedMerchants: '无允许的商户',
                ...
                spendCategory: '支出类别',
                maxAmount: '最高金额',
                maxAmountHelp: '超过此金额的任何消费都会被拒绝，与商户和支出类别限制无关。',
                currencyMismatchTitle: '货币不匹配',
                currencyMismatchPrompt: '若要设置最高金额，请选择以同一货币结算的卡片。',
                reviewSelectedCards: '查看所选卡片',
                merchantsMoreCount: ({summary, count}: {summary: string; count: number}) => `${summary}，还有 +${count} 条`,
                confirmErrorApplyAtLeastOneSpendRuleToOneCard: '至少将一条支出规则应用到一张卡片',
                confirmErrorCardRequired: '“卡”是必填字段',
                confirmErrorApplyAtLeastOneSpendRule: '应用至少一条支出规则',
                categories: '类别',
                merchants: '商家',
                max: '最大',
                categoryOptions: {
                    [CONST.SPEND_RULES.CATEGORIES.AIRLINES]: '航空公司',
                    [CONST.SPEND_RULES.CATEGORIES.ALCOHOL_AND_BARS]: '酒类和酒吧',
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.PARKING_AND_TOLLS]: '停车和通行费',
                    [CONST.SPEND_RULES.CATEGORIES.PROFESSIONAL_SERVICES]: '专业服务',
                    [CONST.SPEND_RULES.CATEGORIES.RETAIL]: '零售',
                    [CONST.SPEND_RULES.CATEGORIES.SHIPPING_AND_DELIVERY]: '运输和配送',
                    [CONST.SPEND_RULES.CATEGORIES.SOFTWARE]: '软件',
                    [CONST.SPEND_RULES.CATEGORIES.TRANSIT_AND_RIDESHARE]: '交通和网约车',
