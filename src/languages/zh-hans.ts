...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            verifying: '验证中',
            locked: '已锁定',
            incompleteDescription: '完成银行账户添加',
            pendingDescription: '请确认测试交易',
            verifyingDescription: '我们正在审核您的文件',
            lockedDescription: '此账户需要处理',
            finish: '完成',
            confirm: '确认',
            unlock: '解锁',
        },
        cardFixConnection: '请修复此连接',
        cardAskAdminToFix: '请让管理员修复此连接',
        cardAdminFixConnection: '请在公司卡中修复此连接',
        lastSynced: (dateStr: string) => `最后同步 ${dateStr}`,
        assignedCards: '卡片',
