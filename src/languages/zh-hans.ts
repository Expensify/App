...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    sidebarScreen: {
        ...
        fabScanReceiptExplained: '扫描收据（悬浮操作）',
        chatPinned: '聊天已置顶',
    ...
    iou: {
        ...
        changeApprover: {
            ...
            description: ({workflowSettingLink}: WorkflowSettingsParam) => `您也可以在<a href="${workflowSettingLink}">工作流设置</a>中为所有报表永久更改审批人。`,
    ...
    passwordPage: {
        changePassword: '更改密码',
        changingYourPasswordPrompt: '更改密码将同时更新您在 Expensify.com 和 New Expensify 上的账户密码。',
...
${
    ...
    setPasswordPage: {
        ...
        passwordNotSet: '我们无法设置您的新密码。我们已向您发送一个新的密码链接，请再次尝试。',
        setPasswordLinkInvalid: '此设置密码链接无效或已过期。新的链接已发送到您的电子邮箱！',
...
3. 数据馈送启用后，点击下方的 Submit，我们会开始添加。`,
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                changeTransactionStartDateWarning: '更改开始日期将删除所有未报销/草稿报表中的交易，并从新的开始日期重新导入所有交易。这可能会导致重复交易。',
                updateCard: '更新卡片',
                unassignCard: '取消分配卡片',
                unassign: '取消分配',
