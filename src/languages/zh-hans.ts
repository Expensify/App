    ...
    onboarding: {
        ...
        mergeBlockScreen: {
            ...
            validatedPublicDomainSubtitle: (workEmail: string | undefined) =>
                `我们无法添加 ${workEmail}。要合并这些账户，请先退出登录，然后使用您的 ${workEmail} 邮箱登录，并前往账户 > 安全 > 合并账户以完成此流程。`,
            ...
            addWorkEmailTask: {
                ...
                description: ({workEmailLink = ''}) =>
                    Str.dedent(`
                        ...
                        2. 输入你的公司邮箱地址。
                        3. 输入我们发给你的验证码。
                        4. 选择要加入的工作区，或点击 *请求加入* 以向工作区所有者发送请求。
                    `),
            },
            validateEmailTask: {
                title: '验证您的邮箱',
                description: ({validateEmailLink = '', workEmail = ''}) =>
                    Str.dedent(`
                        ...
                        3. 选择一个要加入的工作区，或者点击 *请求加入* 向工作区所有者发送请求。
                    `),
            },
            joinWorkspaceTask: {
                title: '加入你们公司的工作区',
                description: ({joinWorkspaceLink = ''}) =>
                    Str.dedent(`
                        ...
                        2. 在列表中找到你的团队。每个团队都会显示其所有者和成员人数，并按人数从多到少排序。如果没看到你的团队，请点击 *显示更多*。
