...
3. 订阅源启用后，点击下方的“提交”，我们会开始为你添加它。`,
        ...
        distanceRates: {
            ...
            governmentRateCountries: {US: '美国', CA: '加拿大', GB: '英国', AU: '澳大利亚', AT: '奥地利', BE: '比利时', FI: '芬兰', DE: '德国', NL: '荷兰', PT: '葡萄牙', ES: '西班牙'},
            governmentRateCountryGeneric: '您的国家',
            governmentRateCountrySelectionPrompt: '要继续使用政府里程费率自动更新功能，请确认您以后要使用的国家。',
            governmentRateCountryCreationPrompt: '要在此工作区使用政府里程费率自动更新功能，请确认您要使用的国家。',
