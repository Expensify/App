...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            confirmDigitalWalletAddition: {
                title: ({walletName}: {walletName: string}) => `将卡添加到 ${walletName} 需要你的批准`,
    ...
    addCardToDigitalWallet: {
        ...
        appleWallet: 'Apple Wallet',
        googleWallet: 'Google Wallet',
        digitalWallet: '你的数字钱包',
        confirmHeading: '确认你的请求',
        confirmDescription: ({walletName, lastFourDigits}: {walletName: string; lastFourDigits: string}) => `要将你的 Expensify 卡（尾号 ${lastFourDigits}）添加到 ${walletName} 吗？`,
        deny: '拒绝',
        confirm: '确认',
        verifyTitle: '让我们验证是你本人',
        enterSecurityCode: (contactMethod: string) => `请输入发送到 ${contactMethod} 的安全码以确认此请求。一两分钟内即会送达。`,
        successHeading: '成功！',
        successDescription: ({walletName}: {walletName: string}) => `你的卡现在可以在 ${walletName} 中使用了。`,
        deniedHeading: '请求已拒绝',
        deniedDescription: ({walletName}: {walletName: string}) => `你的卡未添加到 ${walletName}。`,
    },
    cardPage: {
        expensifyCard: 'Expensify 卡',
