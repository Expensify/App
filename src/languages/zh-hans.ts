...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        keepSelected: '[zh-hans] Keep selected',
    ...
    deviceManagementPage: {
        ...
        description: '[zh-hans] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[zh-hans] Revoke',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        people: {
            ...
            configureGustoSync: '[zh-hans] Configure Gusto sync.',
            syncWithGusto: '[zh-hans] Sync with Gusto',
            ...
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    ...
                    case 'mergeHRSyncTitle':
                        return '[zh-hans] Synchronizing HR Employees';
                    case 'jobDone':
                        return '[zh-hans] Waiting for imported data to load';
                    default: {
                        return `[zh-hans] Translation missing for stage: ${stage}`;
...
Add more spend rules to protect company cash flow.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateName: (customUnitName: string, oldValue: string, newValue: string) => `[zh-hans] renamed the ${customUnitName} rate "${oldValue}" to "${newValue}"`,
