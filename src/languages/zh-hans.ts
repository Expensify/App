...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSite: '帮助网站',
            helpSiteDescription: '文章、教程及更多内容',
            ...
            approvedPartnerTeamTitle: '认识您的 Approved! 合作伙伴团队',
            approvedPartnerTeamDescription: '一支专注于帮助您的公司成长、更快地接入客户并获得专家支持的专业团队。',
            partnerManagerApprovedDescription: '最大化您的合作关系并推动推荐',
            accountExecutiveDescription: '帮助客户成功设置',
            accountManagerApprovedDescription: '提问并获取客户支持',
            moreResources: '更多资源',
        },
    },
    closeAccountPage: {
