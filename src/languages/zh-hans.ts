...
3. 订阅源启用后，点击下方的“提交”，我们会开始为你添加它。`,
        ...
        tags: {
            ...
            subtitleWithDependentTags: `标签可用于以更细致的方式分类成本。您正在使用<a href="${CONST.IMPORT_TAGS_EXPENSIFY_URL_DEPENDENT_TAGS}">依赖标签</a>。`,
            subtitleWithDependentTagsImport: (importSpreadsheetLink: string) => `您可以<a href="${importSpreadsheetLink}">重新导入电子表格</a>来更新您的标签。`,
            emptyTags: {
                title: '尚无标签',
