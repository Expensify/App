...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[zh-hans] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[zh-hans] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[zh-hans] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[zh-hans] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[zh-hans] Get clients setup successfully',
            accountManagerApprovedDescription: '[zh-hans] Ask questions and get client support',
            moreResources: '[zh-hans] More resources',
        },
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[zh-hans] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[zh-hans] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[zh-hans] Go to Gusto settings',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            gusto: {
                ...
                disconnect: '[zh-hans] Disconnect',
                lastSync: (relativeDate: string) => `[zh-hans] Last synced ${relativeDate}`,
                syncError: "[zh-hans] Can't connect to Gusto",
                disconnectTitle: '[zh-hans] Disconnect Gusto',
                disconnectPrompt: '[zh-hans] Are you sure you want to disconnect Gusto?',
                ...
                approvalModeDescription: '[zh-hans] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[zh-hans] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[zh-hans] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[zh-hans] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[zh-hans] Basic approval',
                        description: '[zh-hans] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[zh-hans] Manager approval',
                        description: '[zh-hans] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[zh-hans] Custom approval',
                        description: '[zh-hans] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[zh-hans] Gusto sync results',
                    successTitle: '[zh-hans] Successfully synced your Gusto connection!',
                    added: '[zh-hans] Added',
                    removed: '[zh-hans] Removed',
            ...
            zenefits: {
                ...
                disconnect: '[zh-hans] Disconnect',
                lastSync: (relativeDate: string) => `[zh-hans] Last synced ${relativeDate}`,
                syncError: "[zh-hans] Can't connect to TriNet",
                disconnectTitle: '[zh-hans] Disconnect TriNet',
                disconnectPrompt: '[zh-hans] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[zh-hans] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[zh-hans] Approval mode',
                finalApprover: '[zh-hans] Final approver',
                notSet: '[zh-hans] Not set',
                approvalModeDescription: '[zh-hans] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[zh-hans] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[zh-hans] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[zh-hans] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[zh-hans] Basic approval',
                    ...
                    manager: {
                        label: '[zh-hans] Manager approval',
                        description: '[zh-hans] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[zh-hans] Custom approval',
                        description: "[zh-hans] I'll manually setup approval workflows in Expensify.",
    ...
    search: {
        ...
        filters: {
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[zh-hans] Central invoicing',
            },
            is: '[zh-hans] Is',
            action: {
