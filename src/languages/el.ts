...
Προσθέστε περισσότερους κανόνες δαπανών για να προστατεύσετε τις ταμειακές ροές της εταιρείας.`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            markAsExportedAllMatchingTitle: 'Δεν είναι δυνατή ακόμη η επισήμανση όλων των αναφορών',
            markAsExportedAllMatchingPrompt: ({total}: {total: number}) =>
                `Προς το παρόν, μόνο οι αναφορές που έχουν φορτωθεί σε αυτήν τη σελίδα μπορούν να επισημανθούν ως εξαγόμενες, όχι και οι ${total} αναφορές που ταιριάζουν. Φιλτράρετε ή επιλέξτε αναφορές μεμονωμένα για να τις επισημάνετε όλες.`,
        },
