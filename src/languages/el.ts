    ...
    violations: {
        ...
        rter: (
            ...
            if (rterType === CONST.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION_530) {
                return 'Δεν είναι δυνατή η αυτόματη αντιστοίχιση της απόδειξης λόγω προβληματικής σύνδεσης με την τράπεζα.';
            }
            ...
            if (isPersonalCard && (rterType === CONST.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION || brokenBankConnection)) {
                ...
                return isMarkAsCash
                    ? `Δεν είναι δυνατή η αυτόματη αντιστοίχιση της απόδειξης λόγω προβλήματος σύνδεσης της κάρτας. Επισημάνετε την ως μετρητά για να την αγνοήσετε ή <a href="${connectionLink}">διορθώστε την κάρτα</a> για να αντιστοιχίσετε την απόδειξη.`
                    : `Δεν είναι δυνατή η αυτόματη αντιστοίχιση της απόδειξης λόγω κατεστραμμένης σύνδεσης κάρτας. <a href="${connectionLink}">Επιδιορθώστε την κάρτα</a> για να αντιστοιχίσετε την απόδειξη.`;
            }
            if (brokenBankConnection || rterType === CONST.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? `Η σύνδεση με την τράπεζα έχει διακοπεί. <a href="${companyCardPageURL}">Επανασυνδέστε για να αντιστοιχίσετε την απόδειξη</a>`
                    : 'Η σύνδεση με την τράπεζα διακόπηκε. Ζητήστε από έναν διαχειριστή να την επανασυνδέσει για να αντιστοιχίσει την απόδειξη.';
            }
            if (!isTransactionOlderThan7Days) {
                return isAdmin ? `Ζητήστε από τον/την ${member} να το σημειώσει ως μετρητά ή περιμένετε 7 ημέρες και δοκιμάστε ξανά` : 'Σε αναμονή για συγχώνευση με συναλλαγή κάρτας.';
            }
            return '';
        },
