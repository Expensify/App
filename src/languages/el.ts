...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            addHomeAddress: {
                title: 'Προσθέστε διεύθυνση κατοικίας',
                subtitle:
                    'Ο διαχειριστής σας ενεργοποίησε τις εξαιρέσεις μετακίνησης για τα έξοδα απόστασης. Προσθέστε μια διεύθυνση κατοικίας ώστε να μπορούμε να τις εφαρμόσουμε στα αιτήματά σας.',
                cta: 'Προσθήκη διεύθυνσης',
            },
            fixFailedBilling: {
    ...
    iou: {
        homeAddressRequired: {
            ...
            prompt: ({workspaceName}: {workspaceName: string}) =>
                workspaceName
                    ? `Προτού καταγράψετε απόσταση, πρέπει να προσθέσετε τη διεύθυνση κατοικίας σας στο ιδιωτικό σας προφίλ. Ο χώρος εργασίας ${workspaceName} χρησιμοποιεί αυτή τη διεύθυνση για τις εκπτώσεις μετακίνησης.`
                    : 'Προτού καταγράψετε απόσταση, πρέπει να προσθέσετε τη διεύθυνση κατοικίας σας στο ιδιωτικό σας προφίλ. Αυτός ο χώρος εργασίας χρησιμοποιεί αυτή τη διεύθυνση για τις εκπτώσεις μετακίνησης.',
...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: 'Χρησιμοποιήστε τη διεύθυνση κατοικίας του μέλους, τη διευθέτηση εργασίας και την ανάθεση γραφείου για τον υπολογισμό των εξαιρέσεων μετακίνησης.',
                ...
                errors: {
                    ...
                    invalidAddress: 'Παρακαλώ εισαγάγετε μια έγκυρη διεύθυνση',
