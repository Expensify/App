...
Προσθέστε περισσότερους κανόνες δαπανών για να προστατεύσετε τις ταμειακές ροές της εταιρείας.`,
        ...
        campfire: {
            ...
            exportDescription: 'Ρυθμίστε τον τρόπο με τον οποίο τα δεδομένα του Expensify εξαχθούν στο Campfire.',
            exportReimbursable: {label: 'Εξαγωγή επιστρεπτέων εξόδων ως', values: {label: 'Τιμολόγια προμηθευτή'}},
            exportDate: {
                label: 'Ημερομηνία τιμολογίου προμηθευτή',
            ...
            exportNonReimbursable: {label: 'Εξαγωγή εξόδων εταιρικής κάρτας ως', values: {label: 'Λογιστικές εγγραφές'}},
            defaultCompanyCardVendor: {
                label: 'Προεπιλεγμένος προμηθευτής για όλες τις εταιρικές κάρτες',
                description: 'Επιλέξτε έναν προεπιλεγμένο προμηθευτή Campfire για δαπάνες που δεν αντιστοιχίζονται αυτόματα.',
            },
            companyCardAccount: {label: 'Λογαριασμός εταιρικής κάρτας', description: 'Επιλέξτε πού θα εξαχθούν οι κινήσεις της εταιρικής κάρτας.'},
            noVendorsFound: 'Δεν βρέθηκαν προμηθευτές',
            noVendorsFoundDescription: 'Παρακαλούμε προσθέστε προμηθευτές στο Campfire και συγχρονίστε ξανά τη σύνδεση',
            noAccountsFound: 'Δεν βρέθηκαν λογαριασμοί',
            noAccountsFoundDescription: 'Παρακαλώ προσθέστε λογαριασμούς στο Campfire και συγχρονίστε ξανά τη σύνδεση',
        },
        businessCentral: {
