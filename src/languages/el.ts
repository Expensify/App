...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        distanceRates: {
            ...
            requireMapOrGPS: 'Απαίτηση καταχώρισης μέσω GPS ή χάρτη',
            requireMapOrGPSDescription: 'Η μη αυτόματη καταχώριση και η καταχώριση μέσω οδομέτρου θα απενεργοποιηθούν.',
            requireMapOrGPSLockedByCommuterExclusions:
                'Η εξαίρεση των μετακινήσεων προς την εργασία απαιτεί χαρτογραφημένη διαδρομή, οπότε η καταχώριση μέσω GPS ή χάρτη απαιτείται ήδη. Σταματήστε να εξαιρείτε τις μετακινήσεις προς την εργασία για να αλλάξετε αυτή τη ρύθμιση.',
            commuterExclusions: {
