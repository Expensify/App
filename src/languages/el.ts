...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        error: {
            ...
            reportsNotMarkedAsDoneTitle: 'Σήμανση αναφορών ως ολοκληρωμένων',
            reportsNotSubmittedDescription: 'Δεν ήταν δυνατή η υποβολή αυτών των αναφορών. Ελέγξτε ότι καμία δαπάνη δεν είναι σε αναμονή ή σε εκκρεμότητα και δοκιμάστε ξανά.',
            reportsNotMarkedAsDoneDescription:
                'Δεν ήταν δυνατή η σήμανση αυτών των αναφορών ως ολοκληρωμένων. Ελέγξτε ότι καμία δαπάνη δεν είναι σε αναμονή ή σε εκκρεμότητα και δοκιμάστε ξανά.',
