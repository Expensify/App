...
Προσθέστε περισσότερους κανόνες δαπανών για να προστατεύσετε τις ταμειακές ροές της εταιρείας.`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            markAsExportedAllMatchingTitle: 'Δεν είναι δυνατή ακόμη η εξαγωγή όλων των αναφορών',
            markAsExportedAllMatchingPrompt: ({total}: {total?: number}) =>
                `Προς το παρόν, μόνο οι αναφορές που έχουν φορτωθεί σε αυτήν τη σελίδα μπορούν να εξαχθούν${total ? `, όχι και οι ${total} αναφορές που ταιριάζουν` : ''}. Φιλτράρετε ή επιλέξτε αναφορές μεμονωμένα για να τις εξαγάγετε όλες.`,
        },
