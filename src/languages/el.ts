...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        recruiting: {
            ...
            filters: {
                description: (providerName: string) => `Επιλέξτε ποια μέλη θα εισαχθούν από το ${providerName}. Μπορείτε να επιλέξετε με βάση στάδια θέσης, ετικέτες και γραφεία.`,
                chooseAtLeastOneItem: 'Επιλέξτε τουλάχιστον ένα στοιχείο για εισαγωγή',
                stages: {
                    title: 'Στάδιο εργασίας',
                    description: 'Επιλέξτε το στάδιο θέσης εργασίας των υποψηφίων που θέλετε να συγχρονίσετε με αυτόν τον χώρο εργασίας',
                    toggleTitle: 'Στάδια εργασίας εισαγωγής',
                    allSelected: 'Όλα τα στάδια εργασίας',
                    emptySelectionError: 'Παρακαλώ επιλέξτε τουλάχιστον ένα στάδιο εργασίας',
                },
                tags: {
                    title: 'Ετικέτα',
                    description: 'Επιλέξτε τις ετικέτες των υποψηφίων που θέλετε να συγχρονίσετε με αυτόν τον χώρο εργασίας',
                    toggleTitle: 'Εισαγωγή ετικετών',
                    allSelected: 'Όλες οι ετικέτες',
                    emptySelectionError: 'Παρακαλώ επιλέξτε τουλάχιστον μία ετικέτα',
                },
                offices: {
                    title: 'Γραφείο',
                    description: 'Επιλέξτε τα γραφεία των υποψηφίων που θέλετε να συγχρονίσετε με αυτόν τον χώρο εργασίας',
                    toggleTitle: 'Εισαγωγή γραφείων (προαιρετικό)',
