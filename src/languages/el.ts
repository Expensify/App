    ...
    search: {
        ...
        bulkActions: {
            ...
            markAsExportedAllMatchingPrompt: ({total}: {total: number}) =>
                `Προς το παρόν, μόνο οι αναφορές που έχουν φορτωθεί σε αυτήν τη σελίδα μπορούν να εξαχθούν, όχι και οι ${total} αναφορές που ταιριάζουν. Φιλτράρετε ή επιλέξτε αναφορές μεμονωμένα για να τις εξαγάγετε όλες.`,
        },
