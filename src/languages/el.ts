...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        error: {
            ...
            unableToSubmitSomeReports: 'Δεν είναι δυνατή η υποβολή ορισμένων αναφορών',
            unableToMarkSomeReportsAsDone: 'Δεν είναι δυνατή η σήμανση ορισμένων αναφορών ως ολοκληρωμένων',
            someReportsOnHoldDescription: () => ({
                one: '1 από τις επιλεγμένες αναφορές δεν μπορεί να υποβληθεί, επειδή όλες οι δαπάνες της είναι σε αναμονή. Υποβολή των υπόλοιπων αναφορών;',
                other: (count: number) => `${count} από τις επιλεγμένες αναφορές δεν μπορούν να υποβληθούν, επειδή όλες οι δαπάνες τους είναι σε αναμονή. Υποβολή των υπόλοιπων αναφορών;`,
            }),
            someReportsOnHoldMarkAsDoneDescription: () => ({
                one: '1 από τις επιλεγμένες αναφορές δεν μπορεί να επισημανθεί ως ολοκληρωμένη, επειδή όλες οι δαπάνες της είναι σε αναμονή. Επισήμανση των υπόλοιπων αναφορών ως ολοκληρωμένων;',
                other: (count: number) =>
                    `${count} από τις επιλεγμένες αναφορές δεν μπορούν να επισημανθούν ως ολοκληρωμένες, επειδή όλες οι δαπάνες τους είναι σε αναμονή. Επισήμανση των υπόλοιπων αναφορών ως ολοκληρωμένων;`,
            }),
            someReportsPendingDescription: () => ({
                one: '1 από τις επιλεγμένες αναφορές δεν μπορεί να υποβληθεί, επειδή όλες οι συναλλαγές της είναι σε εκκρεμότητα. Υποβολή των υπόλοιπων αναφορών;',
                other: (count: number) =>
                    `${count} από τις επιλεγμένες αναφορές δεν μπορούν να υποβληθούν, επειδή όλες οι συναλλαγές τους είναι σε εκκρεμότητα. Υποβολή των υπόλοιπων αναφορών;`,
            }),
            someReportsPendingMarkAsDoneDescription: () => ({
                one: '1 από τις επιλεγμένες αναφορές δεν μπορεί να επισημανθεί ως ολοκληρωμένη, επειδή όλες οι συναλλαγές της είναι σε εκκρεμότητα. Επισήμανση των υπόλοιπων αναφορών ως ολοκληρωμένων;',
                other: (count: number) =>
                    `${count} από τις επιλεγμένες αναφορές δεν μπορούν να επισημανθούν ως ολοκληρωμένες, επειδή όλες οι συναλλαγές τους είναι σε εκκρεμότητα. Επισήμανση των υπόλοιπων αναφορών ως ολοκληρωμένων;`,
            }),
            someReportsOnHoldOrPendingDescription: () => ({
                one: '1 από τις επιλεγμένες αναφορές δεν μπορεί να υποβληθεί, επειδή όλες οι δαπάνες της είναι σε αναμονή ή σε εκκρεμότητα. Υποβολή των υπόλοιπων αναφορών;',
                other: (count: number) =>
                    `${count} από τις επιλεγμένες αναφορές δεν μπορούν να υποβληθούν, επειδή όλες οι δαπάνες τους είναι σε αναμονή ή σε εκκρεμότητα. Υποβολή των υπόλοιπων αναφορών;`,
            }),
            someReportsOnHoldOrPendingMarkAsDoneDescription: () => ({
                one: '1 από τις επιλεγμένες αναφορές δεν μπορεί να επισημανθεί ως ολοκληρωμένη, επειδή όλες οι δαπάνες της είναι σε αναμονή ή σε εκκρεμότητα. Επισήμανση των υπόλοιπων αναφορών ως ολοκληρωμένων;',
                other: (count: number) =>
                    `${count} από τις επιλεγμένες αναφορές δεν μπορούν να επισημανθούν ως ολοκληρωμένες, επειδή όλες οι δαπάνες τους είναι σε αναμονή ή σε εκκρεμότητα. Επισήμανση των υπόλοιπων αναφορών ως ολοκληρωμένων;`,
            }),
