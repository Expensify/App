...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        distanceRates: {
            ...
            governmentRateCountryCreationPrompt:
                'Για να χρησιμοποιήσετε τη λειτουργία αυτόματης ενημέρωσης κρατικών τιμών απόστασης σε αυτόν τον χώρο εργασίας, επιβεβαιώστε ποια χώρα θέλετε να χρησιμοποιείτε.',
