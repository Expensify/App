...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        distanceRates: {
            ...
            restrictDistanceToMapsAndGPS: 'Περιορισμός απόστασης σε χάρτες και GPS',
            restrictDistanceToMapsAndGPSLockedByCommuterExclusions:
                'Η εξαίρεση των μετακινήσεων προς την εργασία απαιτεί χαρτογραφημένη διαδρομή, οπότε η απόσταση περιορίζεται ήδη σε χάρτες και GPS. Σταματήστε να εξαιρείτε τις μετακινήσεις προς την εργασία για να αλλάξετε αυτή τη ρύθμιση.',
            commuterExclusions: {
