...
Προσθέστε περισσότερους κανόνες δαπανών για να προστατεύσετε τις ταμειακές ροές της εταιρείας.`,
    ...
    violations: {
        ...
        shortName: {
            ...
            customUnitOutOfPolicy: 'Η τιμή δεν είναι έγκυρη για αυτόν τον χώρο εργασίας',
            customUnitRateOutOfDateRange: 'Η τιμή είναι εκτός ισχυρών ημερομηνιών',
            duplicatedTransaction: 'Πιθανό διπλότυπο',
            fieldRequired: 'Τα πεδία αναφοράς είναι υποχρεωτικά',
            futureDate: 'Η μελλοντική ημερομηνία δεν επιτρέπεται',
            hold: 'Σε αναμονή',
            ...
            invoiceMarkup: 'Το τιμολόγιο έχει προσαυξηθεί',
            ...
            missingTag: 'Λείπει ετικέτα',
            modifiedAmount: 'Το ποσό τροποποιήθηκε',
            modifiedDate: 'Η ημερομηνία τροποποιήθηκε',
            ...
            overTripLimit: 'Πέρα από το όριο ταξιδιού',
            perDayLimit: 'Πέρα από το ημερήσιο όριο',
            prohibitedExpense: 'Απαγορευμένη δαπάνη',
            receiptGeneratedWithAI: 'Πιθανή απόδειξη από ΤΝ',
            receiptNotSmartScanned: 'Η απόδειξη προστέθηκε χειροκίνητα',
            receiptRequired: 'Απαιτείται απόδειξη',
            rter: 'Αναμονή για αντιστοίχιση κάρτας',
            ...
            overLimitAttendee: 'Πέρα από το όριο ανά άτομο',
