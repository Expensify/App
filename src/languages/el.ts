...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            insufficientFunds: 'Οι δοκιμαστικές συναλλαγές απέτυχαν λόγω ανεπαρκούς υπολοίπου χρήματος',
        },
        fixBankAccount: {
            ...
            debitBlockedBody:
                'Η τράπεζά σας μπλόκαρε τις δοκιμαστικές συναλλαγές σε αυτόν τον λογαριασμό.<br/><br/>Παρακαλούμε ζητήστε τους να προσθέσουν στις εξαιρέσεις τα ACH IDs της Expensify:<bullet-list><bullet-item>1270239450</bullet-item><bullet-item>2270239450</bullet-item><bullet-item>4270239450</bullet-item></bullet-list>Έπειτα, στείλτε ξανά τις δοκιμαστικές συναλλαγές παρακάτω.',
            insufficientFundsBody:
                '<muted-text>Οι δοκιμαστικές συναλλαγές απέτυχαν λόγω ανεπαρκών κεφαλαίων.<br/>Μόλις υπάρχουν διαθέσιμα κεφάλαια, χρησιμοποιήστε το παρακάτω κουμπί.</muted-text>',
        },
    },
    cardPage: {
        expensifyCard: 'Κάρτα Expensify',
