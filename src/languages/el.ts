...
Απαιτήστε στοιχεία δαπανών όπως αποδείξεις και περιγραφές, ορίστε όρια και προεπιλογές και αυτοματοποιήστε εγκρίσεις και πληρωμές – όλα σε ένα σημείο.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                categoryRulesApplyGoingForwardTitle: 'Οι κανόνες κατηγορίας εφαρμόζονται από εδώ και στο εξής',
                categoryRulesApplyGoingForwardPrompt:
                    'Ένας προεπιλεγμένος φορολογικός συντελεστής ισχύει για τις νέες δαπάνες σε αυτήν την κατηγορία. Οι δαπάνες που υπάρχουν ήδη δεν θα αλλάξουν.',
            },
            newRule: {
                title: 'Νέος κανόνας',
...
Προσθέστε περισσότερους κανόνες δαπανών για να προστατεύσετε τις ταμειακές ροές της εταιρείας.`,
            ...
            expenseDefaultType: {
                ...
                merchant: 'Έμπορος',
                merchantDescription: 'Ενημέρωση πεδίων σε έξοδα από συγκεκριμένο έμπορο',
                category: 'Κατηγορία',
                categoryDescription: 'Ορίστε προεπιλεγμένο φορολογικό συντελεστή για συγκεκριμένη κατηγορία',
            },
            taxesDisabledEmptyState: {
                title: 'Οι φόροι δεν είναι ενεργοποιημένοι',
                subtitle: 'Ενεργοποιήστε τους φόρους για να καταγράφετε και να διεκδικείτε τους επιλέξιμους φόρους.',
