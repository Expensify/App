            ...
            mergeHR: {
                groups: {
                    ...
                    staleSelectionError: (providerName: string) =>
                        `Ορισμένες από τις ομάδες που επιλέξατε δεν υπάρχουν πλέον στο ${providerName}, επομένως οι εργαζόμενοι σε αυτές έχουν σταματήσει να συγχρονίζονται.`,
                    updateSelectionLink: 'Ενημερώστε τις ομάδες σας.',
                    noGroupsFound: 'Δεν βρέθηκαν ομάδες',
                    noGroupsFoundDescription:
                        'Δεν υπάρχουν ομάδες για επιλογή αυτήν τη στιγμή. Αποθηκεύστε χωρίς επιλεγμένες ομάδες για να συγχρονίσετε όλους τους υπαλλήλους ή συγχρονίστε ξανά τη σύνδεση όταν υπάρχουν νέες ομάδες.',
                },
            },
        },
        recruiting: {
