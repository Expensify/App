...
${amount} για ${merchant} - ${date}`,
    ...
    activateCardPage: {
        ...
        fillInAllDetails: 'Παρακαλούμε συμπληρώστε όλα τα παρακάτω στοιχεία',
    },
    getPhysicalCard: {
...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                shippingAddressDescription: 'Πείτε μας πού πρέπει να στείλουμε τη νέα κάρτα.',
                promptCardholder: 'Προτροπή κατόχου κάρτας',
                promptCardholderDescription: 'Θα ζητηθεί από τον κάτοχο της κάρτας να εισαγάγει ή να επιβεβαιώσει τη διεύθυνση αποστολής του.',
                enterAddress: 'Εισαγάγετε διεύθυνση',
                enterAddressDescription: 'Εισαγάγετε μια ταχυδρομική διεύθυνση για την κάρτα (π.χ. την οικιακή διεύθυνση του κατόχου της κάρτας ή μια διεύθυνση γραφείου).',
