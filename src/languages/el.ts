...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            addHomeAddress: {
                title: 'Προσθέστε μια διεύθυνση κατοικίας',
                subtitle:
                    'Ο διαχειριστής σας ενεργοποίησε τις εξαιρέσεις μετακίνησης για τις δαπάνες απόστασης. Προσθέστε μια διεύθυνση κατοικίας, ώστε να μπορούμε να τις εφαρμόζουμε στα αιτήματά σας.',
                cta: 'Προσθήκη διεύθυνσης',
            },
            fixFailedBilling: {
    ...
    iou: {
        homeAddressRequired: {
            title: 'Απαιτείται διεύθυνση κατοικίας',
            prompt: ({workspaceName}: {workspaceName: string}) =>
                workspaceName
                    ? `Προτού καταγράψετε αποστάσεις, πρέπει να προσθέσετε τη διεύθυνση κατοικίας σας στο ιδιωτικό σας προφίλ. Ο χώρος εργασίας ${workspaceName} χρησιμοποιεί αυτή τη διεύθυνση για τις εκπτώσεις μετακίνησης προς και από την εργασία.`
                    : 'Προτού καταγράψετε αποστάσεις, πρέπει να προσθέσετε τη διεύθυνση κατοικίας σας στο ιδιωτικό σας προφίλ. Αυτός ο χώρος εργασίας χρησιμοποιεί αυτή τη διεύθυνση για τις εκπτώσεις μετακίνησης προς και από την εργασία.',
...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                summaryHomeAndOffice: 'Χρήση τοποθεσιών κατοικίας και γραφείου',
                optionDisabledTitle: 'Να μην εξαιρούνται οι μετακινήσεις από και προς την εργασία',
                optionDisabledHelp: 'Καμία μετακίνηση δεν αφαιρείται από τα αιτήματα.',
                ...
                optionHomeAndOfficeTitle: 'Υπολογισμός βάσει κατοικίας και γραφείου',
                optionHomeAndOfficeHelp: 'Χρησιμοποιήστε τη διεύθυνση κατοικίας του μέλους, το καθεστώς εργασίας και την ανάθεση γραφείου για τον υπολογισμό των εξαιρέσεων μετακίνησης.',
                distanceLabel: 'Απόσταση',
                workspaceAddressRequired: {
                    title: 'Όχι τόσο γρήγορα...',
                    promptStart: 'Δεν μπορείτε να ενεργοποιήσετε τη ρύθμιση υπολογισμού βάσει κατοικίας και γραφείου έως ότου προσθέσετε πρώτα μια τοποθεσία γραφείου στην ',
                    linkText: 'Επισκόπηση',
                    promptEnd: '.',
                    cta: 'Το κατάλαβα',
                },
                errors: {
                    ...
                    invalidAddress: 'Παρακαλούμε εισαγάγετε μια έγκυρη διεύθυνση',
