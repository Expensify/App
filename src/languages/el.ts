    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription:
                'Οι παρακάμψεις ισχύουν μόνο για αυτή τη συσκευή και επηρεάζουν μόνο τους ελέγχους του frontend. Η εναλλαγή καρφιτσώνει μια beta σε αυτή την τιμή μέχρι να την επαναφέρετε. Η «Επαναφορά όλων των παρακάμψεων» επαναφέρει τις τιμές του λογαριασμού σας. Ορισμένες beta ελέγχονται και από το backend, οπότε μπορεί να αποτύχουν σε επίπεδο αιτήματος.',
