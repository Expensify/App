...
${amount} για ${merchant} - ${date}`,
    ...
    workflowsExpensesFromPage: {
        ...
        moveEveryoneToThisWorkflowTitle: 'Μετακίνηση όλων σε αυτήν τη ροή εργασίας',
        moveEveryoneToThisWorkflowPrompt:
            'Πρόκειται να μετακινήσετε όλους σε αυτήν τη ροή έγκρισης. Αυτό θα διαγράψει όλες τις άλλες ροές έγκρισης και θα μετακινήσει όλους σε αυτήν. Αυτή η ενέργεια δεν μπορεί να αναιρεθεί.',
    },
