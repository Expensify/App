...
Απαιτήστε στοιχεία δαπανών όπως αποδείξεις και περιγραφές, ορίστε όρια και προεπιλογές και αυτοματοποιήστε εγκρίσεις και πληρωμές – όλα σε ένα σημείο.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                confirmErrorCategoryTax: 'Παρακαλώ επιλέξτε έναν φορολογικό συντελεστή',
                confirmErrorCondition: 'Παρακαλώ επιλέξτε έναν έμπορο ή κατηγορία',
                confirmErrorConditionAndDefault: 'Επιλέξτε έναν έμπορο ή κατηγορία και εφαρμόστε τουλάχιστον μία προεπιλογή',
                oneConditionPerRuleTitle: 'Μόνο μία συνθήκη ανά κανόνα',
                alreadyMatchesMerchantPrompt: 'Αυτός ο κανόνας ήδη ταιριάζει με έναν έμπορο. Επαναφέρετε τον κανόνα ώστε να ταιριάζει με μια κατηγορία.',
                alreadyMatchesCategoryPrompt: 'Αυτός ο κανόνας ταιριάζει ήδη με μια κατηγορία. Επαναφέρετε τον κανόνα ώστε να ταιριάζει με έναν έμπορο.',
                turnOnTaxesFirstTitle: 'Ενεργοποιήστε πρώτα τους φόρους',
                turnOnTaxesFirstPrompt:
                    'Οι κανόνες κατηγορίας ορίζουν ένα προεπιλεγμένο φορολογικό συντελεστή. Ενεργοποιήστε τους φόρους στις ρυθμίσεις του χώρου εργασίας σας για να τους χρησιμοποιήσετε.',
                onlyTaxForCategoryRulesTitle: 'Μόνο ο φόρος είναι διαθέσιμος για κανόνες κατηγορίας',
                onlyTaxForCategoryRulesPrompt:
                    'Οι κανόνες κατηγορίας μπορούν να ορίσουν έναν προεπιλεγμένο φορολογικό συντελεστή. Για να ορίσετε άλλες προεπιλογές, αντιστοιχίστε με βάση έναν έμπορο.',
                clearIncompatibleDefaultsTitle: 'Να διαγραφούν οι άλλες προεπιλογές;',
                clearIncompatibleDefaultsPrompt: 'Αυτά τα πεδία δεν είναι συμβατά με την κατηγορία. Θέλετε να διαγράψετε όλα τα πεδία;',
                ...
                categoryRulesApplyGoingForwardPrompt:
                    'Ένας προεπιλεγμένος φορολογικός συντελεστής εφαρμόζεται σε νέες δαπάνες σε αυτήν την κατηγορία. Οι ήδη υπάρχουσες δαπάνες δεν θα αλλάξουν.',
            },
            newRule: {
                title: 'Νέος κανόνας',
                ...
                requireFields: 'Ορίστε τις απαιτήσεις πεδίου',
                ...
                createAgentRule: 'Περιγραφή κανόνα αντιπροσώπου',
