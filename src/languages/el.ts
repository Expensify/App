        ...
        rules: {
            ...
            categoryRules: {
                ...
                expenseLimitTypes: {
                    ...
                    expenseSubtitle:
                        'Επισημάνετε ποσά δαπανών ανά κατηγορία. Αυτός ο κανόνας παρακάμπτει τον γενικό κανόνα χώρου εργασίας για το μέγιστο ποσό δαπάνης. Οι κρατήσεις πολλών ημερών αξιολογούνται με βάση τον μέσο όρο ανά διανυκτέρευση.',
