...
Προσθέστε περισσότερους κανόνες δαπανών για να προστατεύσετε τις ταμειακές ροές της εταιρείας.`,
        ...
        campfire: {
            ...
            accountingMethods: {
                ...
                alternateText: {
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]: 'Οι εκτός τσέπης δαπάνες θα εξαχθούν όταν εγκριθούν οριστικά',
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]: 'Οι προσωπικές δαπάνες θα εξαχθούν μόλις πληρωθούν',
                },
            },
            syncReimbursedReports: 'Συγχρονισμός αποζημιωμένων αναφορών',
            syncReimbursedReportsDescription: 'Όταν μια αναφορά εξοφληθεί μέσω ACH, θα δημιουργηθεί μια πληρωμή λογαριασμού σε αυτόν τον λογαριασμό.',
            billPaymentAccount: {label: 'Λογαριασμός πληρωμής λογαριασμών', description: 'Επιλέξτε από πού θα πληρώνονται οι λογαριασμοί και θα δημιουργήσουμε την πληρωμή στο Campfire.'},
            syncExpensifyCardSettlements: 'Συγχρονισμός διακανονισμών κάρτας Expensify',
            settlementAccount: {label: 'λογαριασμός εκκαθάρισης κάρτας Expensify', description: 'Επιλέξτε τον λογαριασμό εκκαθάρισης και θα δημιουργήσουμε την πληρωμή στο Campfire.'},
            syncTravelInvoicingSettlements: 'Συγχρονισμός διακανονισμών τιμολόγησης ταξιδιών',
            travelInvoicingSettlementAccount: {
                label: 'Λογαριασμός διακανονισμού τιμολόγησης ταξιδιών',
                description: 'Επιλέξτε τον λογαριασμό εκκαθάρισης και θα δημιουργήσουμε την πληρωμή στο Campfire.',
            },
            travelInvoicingPayableAccount: {label: 'Λογαριασμός πληρωτέων τιμολόγησης ταξιδίων'},
        },
        businessCentral: {
