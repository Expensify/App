...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            addHomeAddress: {title: 'Προσθέστε τη διεύθυνση κατοικίας σας για καταγραφή αποστάσεων', subtitle: 'Λογαριασμός', cta: 'Προσθήκη διεύθυνσης'},
            fixFailedBilling: {
    ...
    iou: {
        homeAddressRequired: {
            ...
            prompt: ({workspaceName}: {workspaceName: string}) =>
                workspaceName
                    ? `Πριν καταγράψετε αποστάσεις, πρέπει να προσθέσετε τη διεύθυνση κατοικίας σας στο ιδιωτικό προφίλ σας. Το ${workspaceName} χρησιμοποιεί αυτήν τη διεύθυνση για φορολογικές εκπτώσεις μετακίνησης.`
                    : 'Πριν καταγράψετε αποστάσεις, πρέπει να προσθέσετε τη διεύθυνση κατοικίας σας στο ιδιωτικό προφίλ σας. Ο χώρος εργασίας αυτός χρησιμοποιεί αυτήν τη διεύθυνση για εκπτώσεις μετακίνησης προς και από την εργασία.',
...
${amount} για ${merchant} - ${date}`,
    ...
    privatePersonalDetails: {
        ...
        commuterExclusionsHint: ({workspaceName}: {workspaceName: string}) => `Ο χώρος εργασίας ${workspaceName} χρησιμοποιεί αυτή τη διεύθυνση για τις εξαιρέσεις μετακίνησης.`,
        error: {
...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionDisabledHelp: 'Καμία μετακίνηση δεν αφαιρείται από τις αξιώσεις.',
                ...
                optionHomeAndOfficeHelp: 'Χρησιμοποιήστε τη διεύθυνση κατοικίας μέλους, τη ρύθμιση εργασίας και την ανάθεση γραφείου για τον υπολογισμό των εξαιρέσεων μετακίνησης.',
                distanceLabel: 'Απόσταση',
                workspaceAddressRequired: {
                    title: 'Όχι και τόσο γρήγορα...',
