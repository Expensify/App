...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        fixBankAccount: {
            title: 'Διορθώστε τον τραπεζικό λογαριασμό',
            debitBlockedBody:
                'Η τράπεζά σας μπλόκαρε τις δοκιμαστικές συναλλαγές σε αυτόν τον λογαριασμό.<br/><br/>Παρακαλούμε ζητήστε τους να προσθέσουν στις λίστες επιτρεπόμενων τα ACH IDs της Expensify:<bullet-list><bullet-item>1270239450</bullet-item><bullet-item>2270239450</bullet-item><bullet-item>4270239450</bullet-item></bullet-list>Στη συνέχεια, στείλτε ξανά τις δοκιμαστικές συναλλαγές παρακάτω.',
            insufficientFundsBody: 'Οι δοκιμαστικές συναλλαγές απέτυχαν λόγω ανεπαρκών διαθέσιμων χρημάτων. Μόλις υπάρχουν διαθέσιμα χρήματα, χρησιμοποιήστε το παρακάτω κουμπί.',
            resendButton: 'Επαναποστολή συναλλαγών',
            successTitle: 'Οι συναλλαγές εστάλησαν!',
...
Προσθέστε περισσότερους κανόνες δαπανών για να προστατεύσετε τις ταμειακές ροές της εταιρείας.`,
    ...
    debug: {
        ...
        indicatorStatus: {
            ...
            aBankAccountFailedValidation: 'Ένας τραπεζικός λογαριασμός απέτυχε στην επαλήθευση',
        },
    },
    emptySearchView: {
