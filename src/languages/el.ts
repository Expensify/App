        ...
        moreFeatures: {
            ...
            travel: {
                ...
                settings: {
                    ...
                    codingSync: {
                        title: 'Κωδικοποιήστε τα επαγγελματικά ταξίδια κατά την κράτηση',
                        subtitle:
                            'Ζητήστε από τους ταξιδιώτες, κατά την ολοκλήρωση κράτησης, τις κατηγορίες, τις ετικέτες και τα πεδία αναφορών αυτού του χώρου εργασίας, ώστε τα ταξίδια να φτάνουν ήδη κωδικοποιημένα.',
                    },
                },
                travelInvoicing: {
