...
${amount} για ${merchant} - ${date}`,
        ...
        invalidCardLimit: 'Το όριο της κάρτας σας είναι $0. Ζητήστε από τον διαχειριστή του χώρου εργασίας σας να ορίσει ένα όριο δαπανών διαφορετικό από το μηδέν και δοκιμάστε ξανά.',
