...
Απαιτήστε στοιχεία δαπανών όπως αποδείξεις και περιγραφές, ορίστε όρια και προεπιλογές και αυτοματοποιήστε εγκρίσεις και πληρωμές – όλα σε ένα σημείο.`,
        ...
        rules: {
            ...
            newRule: {
                ...
                createRuleHeadline: 'Δημιουργία νέου κανόνα',
                describeRule: 'Περιγράψτε τον κανόνα σας και ο Concierge θα τον δημιουργήσει',
                buildManually: 'Μη αυτόματη δημιουργία κανόνα',
                createAgentRuleInstead: 'Δημιουργία κανόνα πράκτορα αντ’ αυτού',
                promptErrors: {
                    unsupported: ({area}) =>
                        area
                            ? `Οι κανόνες ${area} δεν υποστηρίζονται ακόμη — το δουλεύουμε. Δοκιμάστε προς το παρόν έναν διαφορετικό κανόνα.`
                            : 'Αυτός ο κανόνας δεν υποστηρίζεται ακόμη — το δουλεύουμε. Δοκιμάστε προς το παρόν έναν διαφορετικό κανόνα.',
                    unintelligible: 'Δοκιμάστε να διατυπώσετε τον κανόνα σας έτσι: αν οι δαπάνες ξεπερνούν τα 100 $, να απαιτείται απόδειξη.',
                    multipleRules: 'Έναν κανόνα τη φορά — δοκιμάστε να περιγράψετε έναν μόνο κανόνα, π.χ.: αποκλεισμός αγορών λιανικής σε όλες τις κάρτες.',
                },
            },
