...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        accounting: {
            ...
            defaultVendorHelperText: (isSet, fallbackVendorName) =>
                isSet || !fallbackVendorName
                    ...
                    : `Τα έξοδα που δεν αντιστοιχίζονται αυτόματα θα αντιστοιχίζονται από προεπιλογή σε αυτόν τον προμηθευτή. Διαφορετικά, θα εξαχθούν ως ${fallbackVendorName}`,
