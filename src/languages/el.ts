...
Σας ευχαριστούμε που υποβάλατε αίτημα για ξεκλείδωμα του τραπεζικού σας λογαριασμού. Τα αιτήματα ανάληψης ενδέχεται να απορριφθούν λόγω ανεπαρκών διαθέσιμων κεφαλαίων ή αν ο τραπεζικός λογαριασμός δεν έχει ενεργοποιηθεί για άμεση χρέωση. Θα εξετάσουμε την περίπτωσή σας και θα επικοινωνήσουμε μαζί σας αν χρειαστούμε οτιδήποτε επιπλέον για την επίλυση αυτού του ζητήματος.`,
    ...
    signerInfoStep: {
        ...
        bothSignersMustBeOnIllionReport: 'Και οι δύο υπογράφοντες πρέπει να αναφέρονται ως διευθυντές στην αναφορά illion της εταιρείας. Δεν μπορεί να είναι οποιαδήποτε δύο άτομα της επιχείρησης.',
        signerMustBeOnIllionReport: 'Ο διευθυντής που προσθέτετε ως υπογράφοντα πρέπει να αναφέρεται στην αναφορά illion της εταιρείας.',
    ...
    agreementsStep: {
        bankStatement: 'Τραπεζικό αντίγραφο κίνησης',
        bankStatementDescription: 'Παρακαλούμε παρέχετε ένα πρόσφατο τραπεζικό αντίγραφο κίνησης, με ημερομηνία εντός των τελευταίων τριών μηνών, για τον επιχειρηματικό τραπεζικό λογαριασμό που συνδέετε.',
