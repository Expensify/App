...
(π.χ. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            insufficientFunds: 'Οι δοκιμαστικές συναλλαγές απέτυχαν λόγω ανεπαρκών κεφαλαίων',
        },
        fixBankAccount: {
            title: 'Διόρθωση τραπεζικού λογαριασμού',
            actionRequired: 'Απαιτείται ενέργεια',
            debitBlockedIntro: 'Η τράπεζά σας μπλόκαρε τις δοκιμαστικές συναλλαγές σε αυτόν τον λογαριασμό.',
            debitBlockedPrompt: 'Παρακαλούμε ζητήστε τους να προσθέσουν τα ACH IDs της Expensify στη λίστα επιτρεπόμενων:',
            debitBlockedResendPrompt: 'Στη συνέχεια, στείλτε ξανά τις παρακάτω δοκιμαστικές συναλλαγές.',
            insufficientFundsIntro: 'Οι δοκιμαστικές συναλλαγές απέτυχαν λόγω ανεπαρκών διαθέσιμων χρημάτων.',
            insufficientFundsPrompt: 'Μόλις τα χρήματα είναι διαθέσιμα, χρησιμοποιήστε το παρακάτω κουμπί.',
            ...
            debitBlockedBody:
                'Η τράπεζά σας μπλόκαρε τις δοκιμαστικές συναλλαγές σε αυτόν τον λογαριασμό.<br/><br/>Παρακαλούμε ζητήστε τους να προσθέσουν στις λίστες επιτρεπόμενων τα ACH IDs της Expensify:<bullet-list><bullet-item>1270239450</bullet-item><bullet-item>2270239450</bullet-item><bullet-item>4270239450</bullet-item></bullet-list>Στη συνέχεια, στείλτε ξανά τις παρακάτω δοκιμαστικές συναλλαγές.',
            insufficientFundsBody: 'Οι δοκιμαστικές συναλλαγές απέτυχαν λόγω ανεπαρκών διαθέσιμων κεφαλαίων.<br/>Μόλις υπάρχουν διαθέσιμα κεφάλαια, χρησιμοποιήστε το παρακάτω κουμπί.',
        },
    },
    cardPage: {
        expensifyCard: 'Κάρτα Expensify',
