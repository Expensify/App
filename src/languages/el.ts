    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription:
                'Οι παρακάμψεις ισχύουν μόνο για αυτή τη συσκευή και επηρεάζουν μόνο τους ελέγχους του frontend. Η εναλλαγή μιας beta την καρφιτσώνει σε αυτή την τιμή και παραμένει έτσι μέχρι να την επαναφέρετε. Η «Επαναφορά όλων των παρακάμψεων» τις διαγράφει όλες και επαναφέρει κάθε beta στην τιμή που έχει ο λογαριασμός σας στο backend. Ορισμένες λειτουργίες ελέγχονται επίσης από το backend, οπότε η αναγκαστική ενεργοποίηση μιας beta που δεν έχει ο λογαριασμός σας μπορεί να αποτύχει σε επίπεδο αιτήματος.',
