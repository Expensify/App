...
Προσθέστε περισσότερους κανόνες δαπανών για να προστατεύσετε τις ταμειακές ροές της εταιρείας.`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            markAsExportedAllMatchingTitle: 'Δεν είναι ακόμη δυνατή η εξαγωγή όλων των αναφορών',
            markAsExportedAllMatchingPrompt: ({total}: {total?: number}) =>
                `Μόνο οι αναφορές που έχουν φορτωθεί σε αυτή τη σελίδα μπορούν να εξαχθούν προς το παρόν${total ? `, όχι όλες οι ${total} αντιστοιχούσες αναφορές` : ''}. Περιορίστε το φίλτρο σας ή επιλέξτε τις αναφορές μία προς μία για να τις εξαγάγετε όλες.`,
        },
