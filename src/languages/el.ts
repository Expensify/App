    ...
    workspace: {
        ...
        xero: {
            ...
            advancedConfig: {
                ...
                xeroFxExpenseAccount: 'Λογαριασμός προμήθειας μετατροπής νομίσματος Xero',
                fxExpenseAccountDescription:
                    'Όταν η εταιρεία σας καλύπτει το κόστος μετατροπής συναλλάγματος για μια πληρωμή που έγινε στο εξωτερικό, θα καταχωρούμε αυτό το κόστος σε αυτόν τον λογαριασμό στο Xero ως χειροκίνητη εγγραφή ημερολογίου.',
            },
            exportDate: {
