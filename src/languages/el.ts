    ...
    iou: {
        ...
        changeApprover: {
            ...
            delegateSubmitNotOnPolicyAsOriginalManager: (originalManager: string, delegate: string) =>
                `Αυτή η αναφορά στάλθηκε στον/στην <mention-user>@${originalManager}</mention-user> αντί στον Αντιπρόσωπο Άδειας σας <mention-user>@${delegate}</mention-user> επειδή δεν είναι μέλος της πολιτικής αυτής της αναφοράς`,
            ...
            delegateSubmitCannotApproveOwnReportAsOriginalManager: (originalManager: string, delegate: string) =>
                `Αυτή η αναφορά στάλθηκε στον/στην <mention-user>@${originalManager}</mention-user> για έγκριση επειδή ο Αντιπρόσωπος Άδειας σας, <mention-user>@${delegate}</mention-user>, δεν μπορεί να εγκρίνει τις δικές του/της αναφορές`,
