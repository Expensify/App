...
Το πρόγραμμα Control ξεκινά από $9 ανά ενεργό μέλος τον μήνα.`,
        ...
        recruiting: {
            ...
            filters: {
                description: (providerName: string) => `Επιλέξτε ποια μέλη θα εισαχθούν από το ${providerName}. Μπορείτε να επιλέξετε βάσει σταδίων θέσης, ετικετών και γραφείων.`,
                skipImport: 'Να μην εισαχθεί',
                chooseAtLeastOneItem: 'Επιλέξτε τουλάχιστον ένα στοιχείο για εισαγωγή',
                stages: {title: 'Στάδιο εργασίας', description: 'Επιλέξτε το στάδιο πρόσληψης των υποψηφίων που θέλετε να συγχρονίσετε με αυτόν τον χώρο εργασίας'},
                tags: {title: 'Ετικέτα', description: 'Επιλέξτε τις ετικέτες υποψηφίων που θέλετε να συγχρονίσετε με αυτόν τον χώρο εργασίας'},
                offices: {title: 'Γραφείο', optionalTitle: 'Γραφείο (προαιρετικό)', description: 'Επιλέξτε τα γραφεία των υποψηφίων που θέλετε να συγχρονίσετε με αυτόν τον χώρο εργασίας'},
            },
