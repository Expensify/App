...
${
    ...
    businessInfoStep: {
        ...
        annualPaymentVolumeInCurrency: ({currencyCode}: CurrencyCodeParams) => `Volume annuale dei pagamenti in ${currencyCode}`,
    ...
    signerInfoStep: {
        ...
        enterOneEmail: ({companyName}: CompanyNameParams) => `Inserisci l'email di un direttore di ${companyName}`,
...
3. Una volta che il feed è stato abilitato, clicca su Invia qui sotto e noi procederemo ad aggiungerlo.`,
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                noAccountsFoundDescription: ({connection}: ConnectionParams) => `Aggiungi l’account in ${connection} e sincronizza di nuovo la connessione`,
        ...
        editor: {
            ...
            currencyInputDisabledText: ({currency}: CurrencyInputDisabledTextParams) =>
                `La valuta predefinita non può essere modificata perché questo workspace è collegato a un conto bancario in ${currency}.`,
            save: 'Salva',
...
Richiedi dettagli di spesa come ricevute e descrizioni, imposta limiti e valori predefiniti e automatizza approvazioni e pagamenti, tutto in un unico posto.`,
        ...
        payAndDowngrade: {
            ...
            description2: ({date}: DateParams) => `Vedi il tuo riepilogo qui sotto per ${date}:`,
            subscription:
    ...
    workspaceActions: {
        ...
        updateCurrencyDefaultTax: ({oldName, newName}: UpdatedPolicyCurrencyDefaultTaxParams) =>
            `ha modificato l’imposta predefinita della valuta dello spazio di lavoro in "${newName}" (in precedenza "${oldName}")`,
        updateForeignCurrencyDefaultTax: ({oldName, newName}: UpdatedPolicyForeignCurrencyDefaultTaxParams) =>
            `ha modificato l’imposta predefinita per la valuta estera in "${newName}" (precedentemente "${oldName}")`,
    },
    roomMembersPage: {
