...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    deviceManagementPage: {
        ...
        description: '[it] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[it] Revoke',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        people: {
            ...
            configureGustoSync: '[it] Configure Gusto sync.',
            syncWithGusto: '[it] Sync with Gusto',
            ...
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    ...
                    case 'mergeHRSyncTitle':
                        return '[it] Synchronizing HR Employees';
                    case 'jobDone':
                        return '[it] Waiting for imported data to load';
                    default: {
                        return `[it] Translation missing for stage: ${stage}`;
...
Add more spend rules to protect company cash flow.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateName: (customUnitName: string, oldValue: string, newValue: string) => `[it] renamed the ${customUnitName} rate "${oldValue}" to "${newValue}"`,
