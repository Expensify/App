...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    personalCard: {
        ...
        lookingForCompanyCards: 'Cerchi carte aziendali?',
        lookingForCompanyCardsDescription: "Assegna carte di tutti i principali fornitori di carte di credito all'intero team dalle impostazioni dell'area di lavoro.",
        ...
        warningDescription: ({isAdmin}: {isAdmin?: boolean}) =>
            `Se sì, ottimo! Ma se è una carta aziendale, ${isAdmin ? 'assegnala dal tuo spazio di lavoro.' : 'chiedi al tuo amministratore di assegnartela dallo spazio di lavoro.'}`,
