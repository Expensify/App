...
${amount} per ${merchant} - ${date}`,
    ...
    expenseRulesPage: {
        ...
        changes: {
            updateBillable: (value: boolean) => `Aggiorna spesa ${value ? 'fatturabile' : 'non fatturabile'}`,
            updateCategory: (value: string) => `Aggiorna categoria in "${value}"`,
            updateComment: (value: string) => `Modifica la descrizione in "${value}"`,
            updateMerchant: (value: string) => `Aggiorna esercente in "${value}"`,
            updateReimbursable: (value: boolean) => `Aggiorna la spesa ${value ? 'rimborsabile' : 'non rimborsabile'}`,
            updateTag: (value: string) => `Aggiorna etichetta in "${value}"`,
            updateTax: (value: string) => `Aggiorna l’aliquota fiscale a ${value}`,
