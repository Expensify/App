...
${amount} per ${merchant} - ${date}`,
    ...
    onboarding: {
        ...
        peopleYouMayKnow: 'Verifica se il tuo team è già qui',
        workspaceYouMayJoin: (domain: string, email: string) =>
            `Verifica la tua email per controllare se qualcuno di ${domain} ha uno spazio di lavoro a cui puoi unirti. Inserisci il codice magico inviato a ${email}.`,
