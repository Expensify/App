...
Richiedi dettagli di spesa come ricevute e descrizioni, imposta limiti e valori predefiniti e automatizza approvazioni e pagamenti, tutto in un unico posto.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                ruleSummaryTitleContains: (merchantName: string) => `Se l’esercente contiene "${merchantName}"`,
                ruleSummaryTitleExact: (merchantName: string) => \`Se l'esercente è esattamente "\${merchantName}"\`,
                matchType: 'Tipo di corrispondenza',
                matchTypeContains: 'Contiene',
                matchTypeContainsDescription: "Corrispondenza delle spese in cui il nome dell'esercente contiene il testo specificato (senza distinzione tra maiuscole e minuscole)",
                matchTypeExact: 'Corrisponde esattamente',
                matchTypeExactDescription: "Corrispondenza delle spese in cui il nome dell'esercente corrisponde esattamente al testo specificato",
