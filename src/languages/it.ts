...
const translations = {
    ...
    lockAccountPage: {
        ...
        onceLocked: 'Una volta bloccato, il tuo account sarà limitato fino a quando non verrà effettuata una richiesta di sblocco e una revisione della sicurezza',
    },
