...
const translations: TranslationDeepObject<typeof en> = {
  common: {
    ...
    noResultsFoundMatching: (searchString: string) =>
      `Nessun risultato trovato per "${searchString}"`,
    ...
    conjunctionTo: "a",
    genericErrorMessage:
      "Ops... qualcosa è andato storto e la tua richiesta non può essere completata. Riprova più tardi.",
...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
      ...
      characterLimitExceedCounter: (length: number, limit: number) =>
        `Limite di caratteri superato (${length}/${limit})`,
      ...
      invalidTimeRange:
        "Inserisci un orario usando il formato a 12 ore (ad es. 2:30 PM)",
    ...
    thisFeatureRequiresInternet:
      "Questa funzione richiede una connessione Internet attiva.",
    attachmentWillBeAvailableOnceBackOnline:
      "L’allegato sarà disponibile quando tornerai online.",
    errorOccurredWhileTryingToPlayVideo:
      "Si è verificato un errore durante il tentativo di riprodurre questo video.",
    ...
    zipCodeExampleFormat: ({ zipSampleFormat }: ZipCodeExampleFormatParams) =>
      zipSampleFormat ? `ad es. ${zipSampleFormat}` : "",
    ...
    downloadFailedDescription:
      "Il tuo download non può essere completato. Riprova più tardi.",
    ...
    leaveWorkspaceConfirmation:
      "Se lasci questo spazio di lavoro, non potrai più inviarvi note spese.",
    leaveWorkspaceConfirmationAuditor:
      "Se lasci questo spazio di lavoro, non potrai visualizzarne i report e le impostazioni.",
    leaveWorkspaceConfirmationAdmin:
      "Se lasci questo spazio di lavoro, non potrai più gestirne le impostazioni.",
    ...
    unstableInternetConnection:
      "Connessione Internet instabile. Controlla la rete e riprova.",
  ...
  lockedAccount: {
    ...
    description:
      "Non puoi completare questa azione perché questo account è stato bloccato. Contatta concierge@expensify.com per i prossimi passi.",
  },
  location: {
    useCurrent: "Usa posizione attuale",
    notFound:
      "Impossibile trovare la tua posizione. Riprova oppure inserisci un indirizzo manualmente.",
    permissionDenied:
      "Sembra che tu abbia negato l’accesso alla tua posizione.",
    please: "Per favore",
  ...
  contact: {
    ...
    importContactsText:
      "Importa i contatti dal tuo telefono così le persone preferite sono sempre a portata di tocco.",
    importContactsExplanation:
      "così le tue persone preferite sono sempre a portata di tocco.",
    importContactsNativeText:
      "Ancora un ultimo passaggio! Dacci il via libera per importare i tuoi contatti.",
  },
  ...
  attachmentPicker: {
    ...
    expensifyDoesNotHaveAccessToCamera:
      "Expensify non può scattare foto senza l’accesso alla fotocamera. Tocca impostazioni per aggiornare le autorizzazioni.",
    attachmentError: "Errore allegato",
    errorWhileSelectingAttachment:
      "Si è verificato un errore durante la selezione di un allegato. Riprova.",
    errorWhileSelectingCorruptedAttachment:
      "Si è verificato un errore durante la selezione di un allegato danneggiato. Riprova con un altro file.",
    ...
    sizeExceededWithLimit: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `La dimensione dell'allegato supera il limite di ${maxUploadSizeInMB} MB`,
    ...
    notAllowedExtension:
      "Questo tipo di file non è consentito. Prova con un tipo di file diverso.",
    folderNotAllowedMessage:
      "Il caricamento di una cartella non è consentito. Prova con un file diverso.",
    protectedPDFNotSupported: "I PDF protetti da password non sono supportati",
    attachmentImageResized:
      "Questa immagine è stata ridimensionata per l’anteprima. Scarica per la risoluzione completa.",
    attachmentImageTooLarge:
      "Questa immagine è troppo grande per essere visualizzata in anteprima prima del caricamento.",
    imageDimensionsTooLarge:
      "Le dimensioni dell'immagine sono troppo grandi per essere elaborate. Utilizza un'immagine più piccola.",
    tooManyFiles: (fileLimit: number) =>
      `Puoi caricare al massimo ${fileLimit} file alla volta.`,
    sizeExceededWithValue: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `I file superano ${maxUploadSizeInMB} MB. Riprova.`,
    someFilesCantBeUploaded: "Impossibile caricare alcuni file",
    sizeLimitExceeded: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `I file devono essere inferiori a ${maxUploadSizeInMB} MB. I file più grandi non verranno caricati.`,
    maxFileLimitExceeded:
      "Puoi caricare fino a 30 ricevute alla volta. Le eventuali aggiuntive non verranno caricate.",
    unsupportedFileType: (fileType: string) =>
      `I file ${fileType} non sono supportati. Verranno caricati solo i tipi di file supportati.`,
    learnMoreAboutSupportedFiles:
      "Ulteriori informazioni sui formati supportati.",
    passwordProtected:
      "I PDF protetti da password non sono supportati. Verranno caricati solo i file supportati.",
  },
  dropzone: {
  ...
  filePicker: {
    ...
    errorWhileSelectingFile:
      "Si è verificato un errore durante la selezione di un file. Riprova.",
  },
  connectionComplete: {
    title: "Connessione completata",
    supportingText:
      "Puoi chiudere questa finestra e tornare all’app Expensify.",
  },
  avatarCropModal: {
    title: "Modifica foto",
    description:
      "Trascina, ingrandisci e ruota la tua immagine come preferisci.",
  },
  composer: {
    noExtensionFoundForMimeType: "Nessuna estensione trovata per il tipo MIME",
    problemGettingImageYouPasted:
      "Si è verificato un problema nel recuperare l'immagine che hai incollato",
    commentExceededMaxLength: (formattedMaxLength: string) =>
      `La lunghezza massima del commento è di ${formattedMaxLength} caratteri.`,
    taskTitleExceededMaxLength: (formattedMaxLength: string) =>
      `La lunghezza massima del titolo dell'attività è di ${formattedMaxLength} caratteri.`,
  },
  baseUpdateAppModal: {
    updateApp: "Aggiorna app",
    updatePrompt:
      "È disponibile una nuova versione di questa app.\nAggiorna ora o riavvia l’app più tardi per scaricare le modifiche più recenti.",
  },
  deeplinkWrapper: {
  ...
  multifactorAuthentication: {
    reviewTransaction: {
      ...
      requiresYourReview:
        "Una transazione con Expensify Card richiede la tua revisione qui sotto.",
      ...
      areYouSureToDeny:
        "Sei sicuro? La transazione verrà rifiutata se chiudi questa schermata.",
      ...
      youNeedToTryAgainAtMerchant:
        "Questa transazione non è stata verificata, quindi l’abbiamo rifiutata. Dovrai riprovare direttamente presso l’esercente.",
      goBackToTheMerchant:
        "Torna al sito dell’esercente per continuare la transazione.",
      attemptedTransaction: "Transazione tentata",
      transactionFailed: "Transazione non riuscita",
      transactionCouldNotBeCompleted:
        "Impossibile completare la transazione. Riprova presso l’esercente.",
    ...
    biometricsTest: {
      ...
      successfullyAuthenticatedUsing: ({
        ...
        `Autenticazione completata correttamente tramite ${authType}.`,
      troubleshootBiometricsStatus: ({
        registered,
      }: MultifactorAuthenticationTranslationParams) =>
        `Dati biometrici (${registered ? "Registrato" : "Non registrato"})`,
      yourAttemptWasUnsuccessful:
        "Il tentativo di autenticazione non è andato a buon fine.",
      youCouldNotBeAuthenticated: "Autenticazione non riuscita",
      areYouSureToReject:
        "Sei sicuro? Il tentativo di autenticazione verrà rifiutato se chiudi questa schermata.",
    ...
    pleaseEnableInSystemSettings: {
      start:
        "Abilita la verifica tramite volto/impronta digitale oppure imposta un codice di sblocco del dispositivo nel tuo",
      link: "impostazioni di sistema",
      end: ".",
    },
    oops: "Ops, qualcosa è andato storto",
    looksLikeYouRanOutOfTime:
      "Sembra che il tempo sia scaduto! Riprova presso l’esercente.",
    ...
    enableQuickVerification: {
      biometrics:
        "Attiva una verifica rapida e sicura utilizzando il volto o l’impronta digitale. Nessuna password o codice richiesto.",
    },
    revoke: {
      ...
      confirmationPrompt:
        "Sei sicuro? Avrai bisogno di un codice magico per la prossima verifica su qualsiasi dispositivo.",
      cta: "Revoca accesso",
      noDevices:
  ...
  validateCodeModal: {
    ...
    expiredCodeDescription:
      "Torna al dispositivo originale e richiedi un nuovo codice",
  ...
  customApprovalWorkflow: {
    ...
    description:
      "La tua azienda utilizza un flusso di approvazione personalizzato in questo spazio di lavoro. Esegui questa azione in Expensify Classic",
  ...
  emptyList: {
    [CONST.IOU.TYPE.CREATE]: {
      ...
      subtitleText:
        "Vuoi che anche il tuo team usi Expensify? Invia loro una spesa e noi ci occuperemo del resto.",
    },
  },
  ...
  welcomeText: {
    ...
    anotherLoginPageIsOpenExplanation:
      "Hai aperto la pagina di accesso in una scheda separata. Accedi da quella scheda.",
    welcome: "Benvenuto!",
    welcomeWithoutExclamation: "Benvenuto",
    phrase2:
      "I soldi parlano. E ora che chat e pagamenti sono in un unico posto, è anche facile.",
    phrase3: "I tuoi rimborsi arrivano veloci quanto riesci a farti capire.",
    enterPassword: "Inserisci la tua password",
    welcomeNewFace: (login: string) =>
      `${login}, è sempre un piacere vedere un volto nuovo da queste parti!`,
    welcomeEnterMagicCode: ({ login }: WelcomeEnterMagicCodeParams) =>
      `Inserisci il codice magico inviato a ${login}. Dovrebbe arrivare entro uno o due minuti.`,
  },
  login: {
    hero: {
  ...
  samlSignIn: {
    ...
    oneMoment:
      "Un momento mentre ti reindirizziamo al portale single sign-on della tua azienda.",
  },
  reportActionCompose: {
  ...
  reportActionContextMenu: {
    ...
    editAction: ({ action }: EditActionParams) =>
      `Modifica ${action?.actionName === CONST.REPORT.ACTIONS.TYPE.IOU ? "spesa" : "commento"}`,
  ...
  reportActionsView: {
    ...
    beginningOfChatHistorySelfDM:
      "Questo è il tuo spazio personale. Usalo per note, attività, bozze e promemoria.",
    beginningOfChatHistorySystemDM:
      "Benvenuto/a! Procediamo con la configurazione.",
    ...
    welcomeToRoom: ({ roomName }: WelcomeToRoomParams) =>
      `Benvenuto in ${roomName}!`,
    usePlusButton: ({ additionalText }: UsePlusButtonParams) =>
      `Usa il pulsante + per ${additionalText} una spesa.`,
    askConcierge:
      "Questa è la tua chat con Concierge, il tuo agente IA personale. Posso fare quasi tutto, mettimi alla prova!",
  ...
  adminOnlyCanPost:
    "Solo gli amministratori possono inviare messaggi in questa stanza.",
  reportAction: {
  ...
  reportArchiveReasons: {
    [CONST.REPORT.ARCHIVE_REASON.DEFAULT]:
      "Questa chat room è stata archiviata.",
    [CONST.REPORT.ARCHIVE_REASON.ACCOUNT_CLOSED]: ({
      displayName,
    }: ReportArchiveReasonsClosedParams) =>
      `Questa chat non è più attiva perché ${displayName} ha chiuso il proprio account.`,
    ...
    [CONST.REPORT.ARCHIVE_REASON.BOOKING_END_DATE_HAS_PASSED]:
      "Questa prenotazione è archiviata.",
  },
  writeCapabilityPage: {
  ...
  sidebarScreen: {
    ...
    redirectToExpensifyClassicModal: {
      title: "Prossimamente",
      description:
        "Stiamo rifinendo ancora alcuni dettagli della nuova Expensify per adattarla alla tua configurazione specifica. Nel frattempo, passa a Expensify Classic.",
    },
  },
  homePage: {
    forYou: "Per te",
    timeSensitiveSection: {
      ...
      addPaymentCard: {
        title:
          "Aggiungi una carta di pagamento per continuare a usare Expensify",
      ...
      reviewCardFraud: {
        ...
        titleWithDetails: ({
          ...
          amount: string;
          merchant: string;
        }) => `Verifica ${amount} di potenziale frode presso ${merchant}`,
      ...
      fixCompanyCardConnection: {
        title: ({ feedName }: { feedName: string }) =>
          feedName
            ? `Correggi la connessione della carta aziendale ${feedName}`
            : "Correggi connessione carta aziendale",
        defaultSubtitle: "Area di lavoro",
        subtitle: ({ policyName }: { policyName: string }) =>
          `${policyName} > Carte aziendali`,
      },
      fixAccountingConnection: {
        title: ({ integrationName }: { integrationName: string }) =>
          `Correggi connessione ${integrationName}`,
        defaultSubtitle: "Area di lavoro",
        subtitle: ({ policyName }: { policyName: string }) =>
          `${policyName} > Contabilità`,
      },
      fixPersonalCardConnection: {
        title: ({ cardName }: { cardName?: string }) =>
          cardName
            ? `Correggi la connessione della carta personale ${cardName}`
            : "Correggi connessione carta personale",
    ...
    discoverSection: {
      ...
      menuItemTitleAdmin:
        "Scopri come invitare i membri, modificare i flussi di approvazione e riconciliare le carte aziendali.",
      menuItemDescription: "Scopri cosa può fare Expensify in 2 minuti",
    },
    forYouSection: {
      submit: ({ count }: { count: number }) =>
        `Invia ${count} ${count === 1 ? "report" : "report"}`,
      approve: ({ count }: { count: number }) =>
        `Approva ${count} ${count === 1 ? "report" : "report"}`,
      pay: ({ count }: { count: number }) =>
        `Paga ${count} ${count === 1 ? "report" : "report"}`,
      export: ({ count }: { count: number }) =>
        `Esporta ${count} ${count === 1 ? "report" : "report"}`,
      begin: "Inizia",
      emptyStateMessages: {
        thumbsUpStarsTitle: "Hai finito!",
        thumbsUpStarsDescription:
          "Pollice in su per te, resta in attesa di altre attività.",
        smallRocketTitle: "Tutto a posto",
        smallRocketDescription:
          "Le prossime attività da fare verranno visualizzate qui.",
        cowboyHatTitle: "Hai finito!",
        cowboyHatDescription:
          "Tutte le attività sono sotto controllo, tieni d’occhio le prossime.",
        trophy1Title: "Niente da mostrare",
        trophy1Description:
          "Ce l’hai fatta! Tieni d’occhio le prossime cose da fare.",
        palmTreeTitle: "Tutto a posto",
        palmTreeDescription:
          "È il momento di rilassarsi, ma resta in attesa di future attività.",
        fishbowlBlueTitle: "Hai finito!",
        fishbowlBlueDescription: "Le future attività appariranno qui.",
        targetTitle: "Tutto a posto",
        targetDescription:
          "Ottimo, resti sulla giusta rotta. Ricontrolla per altre attività!",
        chairTitle: "Niente da mostrare",
        chairDescription:
          "Vai a rilassarti, elencheremo le prossime cose da fare qui.",
        broomTitle: "Hai finito!",
        broomDescription:
          "Le attività sono a posto, ma resta in attesa di altre cose da fare.",
        ...
        conciergeBotDescription:
          "Beep boop beep boop, ricontrolla per altre attività!",
        ...
        sunglassesDescription:
          "È il momento di rilassarti, ma resta in attesa di ciò che arriva!",
  ...
  spreadsheet: {
    ...
    dragAndDrop:
      "<muted-link>Trascina e rilascia qui il tuo foglio di calcolo oppure scegli un file qui sotto. Formati supportati: .csv, .txt, .xls e .xlsx.</muted-link>",
    ...
    chooseSpreadsheet:
      "<muted-link>Seleziona un file di foglio di calcolo da importare. Formati supportati: .csv, .txt, .xls e .xlsx.</muted-link>",
    ...
    fieldNotMapped: (fieldName: string) =>
      `Ops! Un campo obbligatorio ("${fieldName}") non è stato mappato. Controlla e riprova.`,
    singleFieldMultipleColumns: (fieldName: string) =>
      `Ops! Hai associato un singolo campo ("${fieldName}") a più colonne. Controlla e riprova.`,
    emptyMappedField: (fieldName: string) =>
      `Ops! Il campo ("${fieldName}") contiene uno o più valori vuoti. Controlla e riprova.`,
    ...
    importCategoriesSuccessfulDescription: ({
      ...
      if (added) {
        return added === 1
          ? "È stata aggiunta 1 categoria."
          : `Sono state aggiunte ${added} categorie.`;
      }

      return updated === 1
        ? "È stata aggiornata 1 categoria."
        : `Sono state aggiornate ${updated} categorie.`;
    },
    importMembersSuccessfulDescription: ({
      ...
      if (updated) {
        return updated > 1
          ? `${updated} membri sono stati aggiornati.`
          : "1 membro è stato aggiornato.";
      }
      return added > 1
        ? `${added} membri sono stati aggiunti.`
        : "È stato aggiunto 1 membro.";
    },
    importTagsSuccessfulDescription: ({ tags }: { tags: number }) =>
      tags > 1 ? `Sono stati aggiunti ${tags} tag.` : "È stato aggiunto 1 tag.",
    importMultiLevelTagsSuccessfulDescription:
      "Sono state aggiunte etichette multilivello.",
    importPerDiemRatesSuccessfulDescription: ({ rates }: { rates: number }) =>
      rates > 1
        ? `Sono state aggiunte le diarie giornaliere ${rates}.`
        : "È stata aggiunta 1 diaria.",
    importTransactionsSuccessfulDescription: ({
      ...
      transactions > 1
        ? `${transactions} transazioni sono state importate.`
        : "1 transazione è stata importata.",
    importFailedTitle: "Importazione non riuscita",
    importFailedDescription:
      "Assicurati che tutti i campi siano compilati correttamente e riprova. Se il problema persiste, contatta Concierge.",
    importDescription:
      "Scegli quali campi mappare dal tuo foglio di calcolo facendo clic sul menu a discesa accanto a ciascuna colonna importata qui sotto.",
    ...
    importSpreadsheetLibraryError:
      "Caricamento del modulo foglio di calcolo non riuscito. Controlla la connessione a Internet e riprova.",
  ...
  receipt: {
    ...
    alternativeMethodsDownloadApp: ({ downloadUrl }: { downloadUrl: string }) =>
      `<label-text><a href="${downloadUrl}">Scarica l'app</a> per scansionare dal tuo telefono</label-text>`,
    alternativeMethodsForwardReceipts: ({ email }: { email: string }) =>
      `<label-text>Inoltra le ricevute a <a href="mailto:${email}">${email}</a></label-text>`,
    ...
    alternativeMethodsTextReceipts: ({
      ...
      `<label-text>Invia le ricevute via SMS al ${phoneNumber} (solo numeri USA)</label-text>`,
    takePhoto: "Scatta una foto",
    cameraAccess:
      "Per scattare foto delle ricevute è necessario l’accesso alla fotocamera.",
    ...
    cameraErrorMessage:
      "Si è verificato un errore durante l'acquisizione della foto. Riprova.",
    locationAccessTitle: "Consenti l’accesso alla posizione",
    locationAccessMessage:
      "L’accesso alla posizione ci aiuta a mantenere fuso orario e valuta corretti ovunque tu vada.",
    ...
    addReceipt: "Aggiungi ricevuta",
    scanFailed:
      "La ricevuta non può essere acquisita perché manca il nome dell’esercente, la data o l’importo.",
    crop: "Ritaglia",
    addAReceipt: {
  ...
  quickAction: {
    ...
    noLongerHaveReportAccess:
      "Non hai più accesso alla precedente destinazione dell’azione rapida. Selezionane una nuova qui sotto.",
  ...
  iou: {
    ...
    splitDateRange: (startDate: string, endDate: string, count: number) =>
      `dal ${startDate} al ${endDate} (${count} giorni)`,
    ...
    totalAmountGreaterThanOriginal: (amount: string) =>
      `L’importo totale è ${amount} superiore rispetto alla spesa originale.`,
    totalAmountLessThanOriginal: (amount: string) =>
      `L’importo totale è di ${amount} inferiore rispetto alla spesa originale.`,
    splitExpenseZeroAmount: "Inserisci un importo valido prima di continuare.",
    splitExpenseOneMoreSplit:
      "Nessuna suddivisione aggiunta. Aggiungine almeno una per salvare.",
    splitExpenseEditTitle: (amount: string, merchant: string) =>
      `Modifica ${amount} per ${merchant}`,
    removeSplit: "Rimuovi suddivisione",
    splitExpenseCannotBeEditedModalTitle:
      "Questa spesa non può essere modificata",
    splitExpenseCannotBeEditedModalDescription:
      "Le spese approvate o pagate non possono essere modificate",
    splitExpenseDistanceErrorModalDescription:
      "Correggi l’errore nella tariffa distanza e riprova.",
    splitExpensePerDiemRateErrorModalDescription:
      "Correggi l’errore nella tariffa diaria e riprova.",
    paySomeone: (name?: string) => `Paga ${name ?? "qualcuno"}`,
    expense: "Spesa",
    ...
    removeExpenseConfirmation:
      "Sei sicuro di voler rimuovere questa ricevuta? Questa azione non può essere annullata.",
    addExpense: "Aggiungi spesa",
    chooseRecipient: "Scegli destinatario",
    createExpenseWithAmount: ({ amount }: { amount: string }) =>
      `Crea spesa da ${amount}`,
    ...
    deletedTransaction: (amount: string, merchant: string) =>
      `ha eliminato una spesa (${amount} per ${merchant})`,
    movedFromReport: (reportName: string) =>
      `ha spostato una spesa${reportName ? `da ${reportName}` : ""}`,
    movedTransactionTo: (reportUrl: string, reportName?: string) =>
      `ha spostato questa spesa${reportName ? `a <a href="${reportUrl}">${reportName}</a>` : ""}`,
    movedTransactionFrom: (reportUrl: string, reportName?: string) =>
      `ha spostato questa spesa${reportName ? `da <a href="${reportUrl}">${reportName}</a>` : ""}`,
    unreportedTransaction: (reportUrl: string) =>
      `ha spostato questa spesa nel tuo <a href="${reportUrl}">spazio personale</a>`,
    movedAction: (
    ...
    pendingMatchWithCreditCard:
      "Ricevuta in attesa di abbinamento con transazione della carta",
    pendingMatch: "Corrispondenza in sospeso",
    pendingMatchWithCreditCardDescription:
      "Ricevuta in attesa di abbinamento con la transazione della carta. Contrassegna come contante per annullare.",
    markAsCash: "Segna come contante",
    routePending: "Instradamento in sospeso...",
    automaticallyEnterExpenseDetails:
      "Concierge inserirà automaticamente i dettagli della spesa per te, oppure puoi aggiungerli manualmente.",
    receiptScanning: () => ({
    ...
    scanMultipleReceiptsDescription:
      "Scatta foto di tutte le tue ricevute in una volta sola, poi conferma i dettagli tu oppure lascia che ce ne occupiamo noi.",
    receiptScanInProgress: "Scansione della ricevuta in corso",
    receiptScanInProgressDescription:
      "Scansione della ricevuta in corso. Riprova più tardi o inserisci ora i dettagli.",
    ...
    receiptStatusText:
      "Solo tu puoi vedere questa ricevuta mentre viene scansionata. Controlla più tardi o inserisci i dettagli ora.",
    receiptScanningFailed:
      "Scansione della ricevuta non riuscita. Inserisci i dettagli manualmente.",
    transactionPendingDescription:
      "Transazione in sospeso. Potrebbero essere necessari alcuni giorni prima che venga registrata.",
    companyInfo: "Informazioni azienda",
    companyInfoDescription:
      "Ci servono ancora alcuni dettagli prima che tu possa inviare la tua prima fattura.",
    yourCompanyName: "Nome dell’azienda",
    yourCompanyWebsite: "Sito web della tua azienda",
    yourCompanyWebsiteNote:
      "Se non hai un sito web, puoi fornire invece il profilo LinkedIn o il profilo sui social media della tua azienda.",
    invalidDomainError:
      "Hai inserito un dominio non valido. Per continuare, inserisci un dominio valido.",
    publicDomainError:
      "Hai inserito un dominio pubblico. Per continuare, inserisci un dominio privato.",
    expenseCount: () => {
      return {
        one: "1 spesa",
    ...
    settlePersonal: (formattedAmount?: string) =>
      formattedAmount
        ? `Paga ${formattedAmount} come persona fisica`
        : `Paga con conto personale`,
    settleWallet: (formattedAmount?: string) =>
      formattedAmount
        ? `Paga ${formattedAmount} con il wallet`
        : `Paga con portafoglio`,
    settlePayment: (formattedAmount: string) => `Paga ${formattedAmount}`,
    settleBusiness: (formattedAmount?: string) =>
      formattedAmount
        ? `Paga ${formattedAmount} come azienda`
        : `Paga con conto aziendale`,
    payElsewhere: (formattedAmount?: string) =>
      formattedAmount
        ? `Segna ${formattedAmount} come pagato`
        : `Segna come pagata`,
    settleInvoicePersonal: (amount?: string, last4Digits?: string) =>
      amount
        ? `pagato ${amount} con conto personale ${last4Digits}`
        : `Pagato con conto personale`,
    settleInvoiceBusiness: (amount?: string, last4Digits?: string) =>
      amount
        ? `ha pagato ${amount} con il conto aziendale ${last4Digits}`
        : `Pagato con conto aziendale`,
    payWithPolicy: (policyName: string, formattedAmount?: string) =>
      formattedAmount
        ? `Paga ${formattedAmount} tramite ${policyName}`
        : `Paga tramite ${policyName}`,
    businessBankAccount: (amount?: string, last4Digits?: string) =>
      amount
        ? `pagato ${amount} con il conto bancario ${last4Digits}`
        : `pagato con conto bancario ${last4Digits}`,
    ...
    expenseAmount: (formattedAmount: string, comment?: string) =>
      `${formattedAmount}${comment ? `per ${comment}` : ""}`,
    ...
    waitingOnBankAccount: ({
      ...
      `ha avviato il pagamento, ma sta aspettando che ${submitterDisplayName} aggiunga un conto bancario.`,
    ...
    paidElsewhere: ({ payer, comment }: PaidElsewhereParams = {}) =>
      `${payer ? `${payer} ` : ""}contrassegnato come pagato${comment ? `, dicendo «${comment}»` : ""}`,
    paidWithExpensify: (payer?: string) =>
      `${payer ? `${payer} ` : ""}pagato con portafoglio`,
    ...
    removedTheRequest: (valueName: string, oldValueToDisplay: string) =>
      `il/la ${valueName} (precedentemente ${oldValueToDisplay})`,
    updatedTheRequest: ({
      valueName,
      newValueToDisplay,
      oldValueToDisplay,
    }: UpdatedTheRequestParams) =>
      `${valueName} a ${newValueToDisplay} (in precedenza ${oldValueToDisplay})`,
    ...
    basedOnMCC: ({ rulesLink }: { rulesLink: string }) =>
      rulesLink
        ? `in base alle <a href="${rulesLink}">regole dello spazio di lavoro</a>`
        : "in base alle regole della workspace",
    threadExpenseReportName: (formattedAmount: string, comment?: string) =>
      `${formattedAmount} ${comment ? `per ${comment}` : "spesa"}`,
    invoiceReportName: ({
      linkedReportID,
    }: OriginalMessage<typeof CONST.REPORT.ACTIONS.TYPE.REPORT_PREVIEW>) =>
      `Report fattura n. ${linkedReportID}`,
    threadPaySomeoneReportName: (formattedAmount: string, comment?: string) =>
      `${formattedAmount} inviato${comment ? `per ${comment}` : ""}`,
    movedFromPersonalSpace: ({
      workspaceName,
      reportName,
    }: MovedFromPersonalSpaceParams) =>
      `ha spostato la spesa dallo spazio personale a ${workspaceName ?? `chatta con ${reportName}`}`,
    movedToPersonalSpace: "ha spostato la spesa nello spazio personale",
    error: {
      invalidCategoryLength:
        "Il nome della categoria supera i 255 caratteri. Accorcialo oppure scegli un’altra categoria.",
      invalidTagLength:
        "Il nome del tag supera i 255 caratteri. Per favore accorcialo o scegli un tag diverso.",
      ...
      negativeDistanceNotAllowed:
        "La lettura finale deve essere maggiore della lettura iniziale",
      distanceAmountTooLarge:
        "L'importo totale è troppo alto. Riduci la distanza o abbassa la tariffa.",
      distanceAmountTooLargeReduceDistance:
        "L'importo totale è troppo alto. Riduci la distanza.",
      distanceAmountTooLargeReduceRate:
        "L'importo totale è troppo alto. Abbassa la tariffa.",
      odometerReadingTooLarge: (formattedMax: string) =>
        `Le letture del contachilometri non possono superare ${formattedMax}.`,
      invalidIntegerAmount:
        "Inserisci un importo in dollari intero prima di continuare",
      invalidTaxAmount: (amount: string) =>
        `L’importo massimo dell’imposta è ${amount}`,
      invalidSplit:
        "La somma delle suddivisioni deve essere uguale all’importo totale",
      invalidSplitParticipants:
        "Inserisci un importo maggiore di zero per almeno due partecipanti",
      invalidSplitYourself:
        "Inserisci un importo diverso da zero per la tua suddivisione",
      noParticipantSelected: "Seleziona un partecipante",
      other: "Errore imprevisto. Riprova più tardi.",
      genericCreateFailureMessage:
        "Errore imprevisto durante l’invio di questa nota spese. Riprova più tardi.",
      genericCreateInvoiceFailureMessage:
        "Errore imprevisto nell’invio di questa fattura. Riprova più tardi.",
      genericHoldExpenseFailureMessage:
        "Errore imprevisto durante il blocco di questa spesa. Riprova più tardi.",
      genericUnholdExpenseFailureMessage:
        "Errore imprevisto durante la rimozione della sospensione di questa spesa. Riprova più tardi.",
      receiptDeleteFailureError:
        "Errore imprevisto durante l’eliminazione di questa ricevuta. Riprova più tardi.",
      ...
      receiptFailureMessageShort:
        "Si è verificato un errore durante il caricamento della ricevuta.",
      genericDeleteFailureMessage:
        "Errore imprevisto durante l’eliminazione di questa spesa. Riprova più tardi.",
      genericEditFailureMessage:
        "Errore imprevisto durante la modifica di questa spesa. Riprova più tardi.",
      ...
      splitExpenseMultipleParticipantsErrorMessage:
        "Una spesa non può essere suddivisa tra uno spazio di lavoro e altri membri. Aggiorna la tua selezione.",
      ...
      invalidRate:
        "Tariffa non valida per questo workspace. Seleziona una tariffa disponibile dal workspace.",
      endDateBeforeStartDate:
        "La data di fine non può essere precedente alla data di inizio",
      endDateSameAsStartDate:
        "La data di fine non può essere uguale alla data di inizio",
    ...
    dismissReceiptErrorConfirmation:
      "Attenzione! Chiudere questo errore rimuoverà completamente la ricevuta che hai caricato. Sei sicuro?",
    ...
    selectUnreportedExpense:
      "Seleziona almeno una spesa da aggiungere al rapporto.",
    emptyStateUnreportedExpenseTitle: "Nessuna spesa non dichiarata",
    emptyStateUnreportedExpenseSubtitle:
      "Sembra che tu non abbia alcuna spesa non rendicontata. Prova a crearne una qui sotto.",
    ...
    reason: "Motivo",
    holdReasonRequired:
      "È necessario fornire un motivo quando si mette in attesa.",
    expenseWasPutOnHold: "La spesa è stata sospesa",
    expenseOnHold:
      "Questa nota spese è stata messa in sospeso. Controlla i commenti per i prossimi passi.",
    expensesOnHold:
      "Tutte le spese sono state messe in sospeso. Controlla i commenti per conoscere i prossimi passaggi.",
    expenseDuplicate:
      "Questa spesa ha dettagli simili a un’altra. Controlla i duplicati per continuare.",
    someDuplicatesArePaid:
      "Alcuni di questi duplicati sono già stati approvati o pagati.",
    reviewDuplicates: "Controlla duplicati",
    keepAll: "Mantieni tutto",
    noDuplicatesTitle: "Tutto a posto!",
    noDuplicatesDescription:
      "Non ci sono transazioni duplicate da verificare qui.",
    confirmApprove: "Conferma l’importo approvato",
    confirmApprovalAmount:
      "Approva solo le spese conformi oppure approva l’intero rapporto.",
    ...
    confirmPayAmount:
      "Paga le voci non in sospeso oppure paga l’intero resoconto.",
    ...
    whatIsHoldExplain:
      "La funzione “Metti in sospeso” è come premere “pausa” su una spesa finché non sei prontə a inviarla.",
    holdIsLeftBehind:
      "Le spese in sospeso vengono lasciate indietro anche se invii un intero resoconto.",
    unholdWhenReady: "Sblocca le spese quando sei pronto a inviarle.",
    changePolicyEducational: {
      title: "Hai spostato questo report!",
      description:
        "Ricontrolla questi elementi, che tendono a cambiare quando si spostano i report in un nuovo workspace.",
      reCategorize:
        "<strong>Ricategorizza qualsiasi spesa</strong> per rispettare le regole dello spazio di lavoro.",
      workflows:
        "Questo rimborso potrebbe ora essere soggetto a un diverso <strong>flusso di approvazione.</strong>",
    },
    ...
    chooseARate:
      "Seleziona una tariffa di rimborso per miglio o chilometro per lo spazio di lavoro",
    ...
    bookingPendingDescription:
      "Questa prenotazione è in sospeso perché non è stata ancora pagata.",
    bookingArchived: "Questa prenotazione è archiviata",
    bookingArchivedDescription:
      "Questa prenotazione è archiviata perché la data del viaggio è passata. Aggiungi una spesa per l’importo finale, se necessario.",
    ...
    deleteSubrateConfirmation:
      "Sei sicuro di voler eliminare questa subtariffa?",
    quantity: "Quantità",
    ...
    reject: {
      ...
      educationalText:
        "Se non sei prontə ad approvare o pagare una spesa, puoi metterla in sospeso o rifiutarla.",
      holdExpenseTitle:
        "Metti in sospeso una spesa per chiedere maggiori dettagli prima dell’approvazione o del pagamento.",
      approveExpenseTitle:
        "Approva le altre spese mentre le spese in sospeso restano assegnate a te.",
      heldExpenseLeftBehindTitle:
        "Le spese in sospeso vengono escluse quando approvi l’intero report.",
      rejectExpenseTitle:
        "Rifiuta una spesa che non intendi approvare o pagare.",
      ...
      rejectedStatus:
        "Questa spesa è stata rifiutata. In attesa che tu risolva i problemi e la contrassegni come risolta per consentirne l’invio.",
      reportActions: {
    ...
    moveExpensesError:
      "Non puoi spostare le spese di diaria nei report di altri spazi di lavoro, perché le tariffe di diaria possono variare tra gli spazi di lavoro.",
    changeApprover: {
      ...
      changedApproverMessage: (managerID: number) =>
        `ha cambiato l’approvatore in <mention-user accountID="${managerID}"/>`,
      actions: {
        addApprover: "Aggiungi approvatore",
        addApproverSubtitle:
          "Aggiungi un ulteriore approvatore al flusso di approvazione esistente.",
        bypassApprovers: "Ignora approvatori",
        bypassApproversSubtitle:
          "Impostati come approvatore finale e salta tutti gli approvatori rimanenti.",
      },
      addApprover: {
        subtitle:
          "Scegli un approvatore aggiuntivo per questo report prima che venga instradato attraverso il resto del flusso di approvazione.",
      },
    },
    chooseWorkspace: "Scegli uno spazio di lavoro",
    routedDueToDEW: (to: string) =>
      `rendiconto instradato a ${to} a causa del flusso di approvazione personalizzato`,
    timeTracking: {
      hoursAt: (hours: number, rate: string) =>
        `${hours} ${hours === 1 ? "ora" : "ore"} @ ${rate} / ora`,
      hrs: "ore",
      hours: "Ore",
      ratePreview: (rate: string) => `${rate} / ora`,
      amountTooLargeError:
        "L’importo totale è troppo alto. Riduci le ore o abbassa la tariffa.",
    },
    ...
    duplicateNonDefaultWorkspacePerDiemError:
      "Non puoi duplicare le spese di diaria tra diversi spazi di lavoro perché le tariffe potrebbero essere diverse tra gli spazi di lavoro.",
    rulesModifiedFields: {
      reimbursable: (value: boolean) =>
        value
          ? 'ha contrassegnato la spesa come "rimborsabile"'
          : 'ha contrassegnato la spesa come "non rimborsabile"',
      billable: (value: boolean) =>
        value
          ? 'ha contrassegnato la spesa come "fatturabile"'
          : 'ha contrassegnato la spesa come "non fatturabile"',
      tax: (value: string, isFirst: boolean) =>
        isFirst
          ? `imposta l’aliquota fiscale su "${value}"`
          : `aliquota fiscale a "${value}"`,
      reportName: (value: string) =>
        `ha spostato questa spesa nel report "${value}"`,
      common: (
        key:
        ...
        return isFirst
          ? `imposta ${field} su "${value}"`
          : `${field} a "${value}"`;
      },
      formatPersonalRules: (fragments: string, route: string) =>
        `${fragments} tramite <a href="${route}">regole spese personali</a>`,
      formatPolicyRules: (fragments: string, route: string) =>
        `${fragments} tramite <a href="${route}">regole spazio di lavoro</a>`,
    },
    failedToAutoSubmitViaDEW: (reason: string) =>
      `invio del resoconto non riuscito tramite <a href="${CONST.SELECT_WORKFLOWS_HELP_URL}">rimanda invii</a>. ${reason}`,
    failedToSubmitViaDEW: (reason: string) =>
      `invio del rapporto non riuscito. ${reason}`,
    ...
    failedToApproveViaDEW: (reason: string) =>
      `approvazione non riuscita. ${reason}`,
    cannotDuplicateDistanceExpense:
      "Non puoi duplicare le spese chilometriche tra diversi spazi di lavoro perché le tariffe potrebbero essere diverse.",
  },
  transactionMerge: {
    listPage: {
      header: "Unisci spese",
    ...
    confirmationPage: {
      ...
      pageTitle:
        "Conferma i dettagli che vuoi mantenere. I dettagli che non mantieni verranno eliminati.",
  ...
  loginField: {
    numberHasNotBeenValidated:
      "Il numero non è stato convalidato. Fai clic sul pulsante per inviare di nuovo il link di convalida tramite SMS.",
    emailHasNotBeenValidated:
      "L'email non è stata convalidata. Fai clic sul pulsante per inviare di nuovo il link di convalida via SMS.",
  },
  avatarWithImagePicker: {
    ...
    deleteWorkspaceError:
      "Spiacenti, si è verificato un problema imprevisto durante l’eliminazione dell’avatar del tuo workspace",
    sizeExceeded: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `L'immagine selezionata supera la dimensione massima di caricamento di ${maxUploadSizeInMB} MB.`,
    ...
    notAllowedExtension: ({ allowedExtensions }: NotAllowedExtensionParams) =>
      `L’immagine del profilo deve essere di uno dei seguenti tipi: ${allowedExtensions.join(", ")}.`,
  },
  avatarPage: {
  ...
  profilePage: {
    ...
    avatarUploadFailureMessage:
      "Si è verificato un errore durante il caricamento dell’avatar. Riprova.",
    online: "Online",
    offline: "Offline",
    ...
    publicSection: {
      title: "Pubblico",
      subtitle:
        "Questi dettagli vengono visualizzati nel tuo profilo pubblico. Chiunque può vederli.",
    },
    privateSection: {
      title: "Privato",
      subtitle:
        "Questi dettagli vengono utilizzati per i viaggi e i pagamenti. Non vengono mai mostrati sul tuo profilo pubblico.",
    },
  },
  securityPage: {
    title: "Opzioni di sicurezza",
    subtitle:
      "Attiva l’autenticazione a due fattori per mantenere al sicuro il tuo account.",
    goToSecurity: "Torna alla pagina di sicurezza",
  },
  shareCodePage: {
    title: "Il tuo codice",
    subtitle:
      "Invita membri su Expensify condividendo il tuo codice QR personale o il tuo link di riferimento.",
  },
  pronounsPage: {
    pronouns: "Pronomi",
  ...
  contacts: {
    ...
    featureRequiresValidate:
      "Questa funzione richiede la verifica del tuo account.",
    ...
    enterMagicCode: (contactMethod: string) =>
      `Inserisci il codice magico inviato a ${contactMethod}. Dovrebbe arrivare entro uno o due minuti.`,
    ...
    removeAreYouSure:
      "Sei sicuro di voler rimuovere questo metodo di contatto? Questa azione non può essere annullata.",
    failedNewContact: "Impossibile aggiungere questo metodo di contatto.",
    genericFailureMessages: {
      requestContactMethodValidateCode:
        "Invio di un nuovo codice magico non riuscito. Attendi un momento e riprova.",
      validateSecondaryLogin:
        "Codice magico errato o non valido. Riprova o richiedi un nuovo codice.",
      deleteContactMethod:
        "Impossibile eliminare il metodo di contatto. Contatta Concierge per ricevere aiuto.",
      setDefaultContactMethod:
        "Impossibile impostare un nuovo metodo di contatto predefinito. Contatta Concierge per ricevere assistenza.",
      addContactMethod:
        "Impossibile aggiungere questo metodo di contatto. Contatta Concierge per assistenza.",
    ...
    yourDefaultContactMethodRestrictedSwitch:
      "Questo è il tuo metodo di contatto predefinito attuale. La tua azienda ne ha limitato la rimozione o la modifica.",
  },
  pronouns: {
    coCos: "Co / Cos",
  ...
  displayNamePage: {
    ...
    isShownOnProfile:
      "Il tuo nome visualizzato viene mostrato sul tuo profilo.",
  },
  timezonePage: {
    timezone: "Fuso orario",
  ...
  updateRequiredView: {
    ...
    toGetLatestChanges:
      "Per mobile, scarica e installa la versione più recente. Per il web, aggiorna il browser.",
  ...
  initialSettingsPage: {
    ...
    aboutPage: {
      description:
        "La nuova app Expensify è creata da una community di sviluppatori open source da tutto il mondo. Aiutaci a costruire il futuro di Expensify.",
    ...
    troubleshoot: {
      ...
      confirmResetDescription:
        "Tutti i messaggi in bozza non inviati andranno persi, ma il resto dei tuoi dati è al sicuro.",
      ...
      simulateFailingNetworkRequests:
        "Simula le richieste di rete non riuscite",
      ...
      maskExportOnyxStateData:
        "Offusca i dati sensibili dei membri durante l’esportazione dello stato di Onyx",
      ...
      usingImportedState:
        "Stai utilizzando uno stato importato. Premi qui per cancellarlo.",
      debugMode: "Modalità debug",
      invalidFile: "File non valido",
      invalidFileDescription:
        "Il file che stai tentando di importare non è valido. Riprova.",
      ...
      sentryHighlightedSpanOpsPlaceholder:
        "ui.interaction.click, navigazione, ui.load",
    },
    security: "Sicurezza",
    signOut: "Esci",
  ...
  closeAccountPage: {
    ...
    reasonForLeavingPrompt:
      "Ci dispiacerebbe vederti andare via! Potresti gentilmente dirci il motivo, così possiamo migliorarci?",
    enterMessageHere: "Inserisci il messaggio qui",
    closeAccountWarning:
      "La chiusura del tuo account non può essere annullata.",
    closeAccountPermanentlyDeleteData:
      "Sei sicuro di voler eliminare il tuo account? Questo eliminerà in modo permanente tutte le spese in sospeso.",
    enterDefaultContactToConfirm:
      "Inserisci il tuo metodo di contatto predefinito per confermare che desideri chiudere il tuo account. Il tuo metodo di contatto predefinito è:",
    ...
    enterYourDefaultContactMethod:
      "Inserisci il tuo metodo di contatto predefinito per chiudere il tuo account.",
  },
  mergeAccountsPage: {
    mergeAccount: "Unisci account",
    accountDetails: {
      accountToMergeInto: (login: string) =>
        `Inserisci l’account che vuoi unire a <strong>${login}</strong>.`,
    ...
    accountValidate: {
      ...
      enterMagicCode: (login: string) =>
        `Per continuare, inserisci il codice magico inviato a <strong>${login}</strong>.`,
      errors: {
        incorrectMagicCode:
          "Codice magico errato o non valido. Riprova o richiedi un nuovo codice.",
    ...
    mergePendingSAML: {
      ...
      limitedSupport:
        "Al momento non supportiamo ancora l’unione degli account in New Expensify. Esegui questa operazione su Expensify Classic.",
      reachOutForHelp:
        "<muted-text><centered-text>Sentiti liberə di <concierge-link>contattare Concierge</concierge-link> se hai domande!</centered-text></muted-text>",
    ...
    mergeFailureTooManyAttempts: {
      ...
      description:
        "Sono stati effettuati troppi tentativi di unire gli account. Riprova più tardi.",
    },
    mergeFailureUnvalidatedAccount: {
      description:
        "Non puoi unire in altri account perché non è convalidato. Convalida l’account e riprova.",
    },
  ...
  lockAccountPage: {
    ...
    onceLocked:
      "Una volta bloccato, il tuo account sarà limitato in attesa di una richiesta di sblocco e di una revisione di sicurezza",
    unlockTitle: "Abbiamo ricevuto la tua richiesta",
    unlockDescription:
      "Esamineremo l’account per verificare che sia sicuro sbloccarlo e ti contatteremo tramite Concierge per qualsiasi domanda.",
  },
  ...
  unlockAccountPage: {
    ...
    chatToConciergeToUnlock:
      "Chatta con Concierge per risolvere i problemi di sicurezza e sbloccare il tuo account.",
    chatWithConcierge: "Chatta con Concierge",
  },
  twoFactorAuth: {
    ...
    explainProcessToRemove:
      "Per disabilitare l’autenticazione a due fattori (2FA), inserisci un codice valido dalla tua app di autenticazione.",
    explainProcessToRemoveWithRecovery:
      "Per disabilitare l’autenticazione a due fattori (2FA), inserisci un codice di recupero valido.",
    disabled: "L'autenticazione a due fattori è ora disattivata",
    noAuthenticatorApp:
      "Non sarà più necessaria un’app di autenticazione per accedere a Expensify.",
    ...
    addKey:
      "Oppure aggiungi questa chiave segreta alla tua app di autenticazione:",
    enterCode:
      "Quindi inserisci il codice a sei cifre generato dalla tua app di autenticazione.",
    ...
    twoFactorAuthIsRequiredDescription:
      "Per motivi di sicurezza, Xero richiede l’autenticazione a due fattori per connettere l’integrazione.",
    ...
    twoFactorAuthIsRequiredXero:
      "La tua connessione contabile Xero richiede l’autenticazione a due fattori.",
    twoFactorAuthIsRequiredCompany:
      "La tua azienda richiede l’autenticazione a due fattori.",
    twoFactorAuthCannotDisable:
      "Impossibile disabilitare l'autenticazione a due fattori",
    twoFactorAuthRequired:
      "Per la connessione a Xero è richiesta l’autenticazione a due fattori (2FA) e non può essere disattivata.",
  },
  recoveryCodeForm: {
    error: {
  ...
  twoFactorAuthForm: {
    error: {
      ...
      incorrect2fa:
        "Codice di autenticazione a due fattori non corretto. Riprova.",
    },
  },
  ...
  privateNotes: {
    title: "Note private",
    personalNoteMessage:
      "Tieni qui le note su questa chat. Solo tu puoi aggiungere, modificare o visualizzare queste note.",
    sharedNoteMessage:
      "Tieni traccia delle note su questa chat qui. I dipendenti Expensify e gli altri membri con dominio team.expensify.com possono visualizzare queste note.",
    composerLabel: "Note",
    myNote: "La mia nota",
    error: {
  ...
  billingCurrency: {
    ...
    paymentCurrencyDescription:
      "Seleziona una valuta standardizzata a cui convertire tutte le spese personali",
  ...
  addDebitCardPage: {
    ...
    error: {
      ...
      securityCode: "Inserisci un codice di sicurezza valido",
      addressStreet:
        "Inserisci un indirizzo di fatturazione valido che non sia una casella postale",
      addressState: "Seleziona uno stato",
      addressCity: "Inserisci una città",
      genericFailureMessage:
        "Si è verificato un errore durante l’aggiunta della tua carta. Riprova.",
  ...
  addPaymentCardPage: {
    ...
    billingAddress: "Indirizzo di fatturazione",
    growlMessageOnSave:
      "La tua carta di pagamento è stata aggiunta correttamente",
    expensifyPassword: "Password Expensify",
    error: {
      invalidName: "Il nome può includere solo lettere",
      addressZipCode: "Inserisci un codice postale valido",
  ...
  walletPage: {
    ...
    error: {
      notOwnerOfBankAccount:
        "Si è verificato un errore durante l'impostazione di questo conto bancario come metodo di pagamento predefinito",
      invalidBankAccount: "Questo conto bancario è temporaneamente sospeso",
      notOwnerOfFund:
        "Si è verificato un errore durante l’impostazione di questa carta come metodo di pagamento predefinito",
      setDefaultFailure:
        "Qualcosa è andato storto. Chatta con Concierge per ulteriore assistenza.",
    },
    addBankAccountFailure:
      "Si è verificato un errore imprevisto durante il tentativo di aggiungere il tuo conto bancario. Riprova.",
    getPaidFaster: "Ricevi i pagamenti più velocemente",
    addPaymentMethod:
      "Aggiungi un metodo di pagamento per inviare e ricevere pagamenti direttamente nell’app.",
    ...
    sendAndReceiveMoney:
      "Invia e ricevi denaro con gli amici. Solo conti bancari USA.",
    enableWallet: "Abilita portafoglio",
    addBankAccountToSendAndReceive:
      "Aggiungi un conto bancario per effettuare o ricevere pagamenti.",
    addDebitOrCreditCard: "Aggiungi carta di debito o di credito",
    assignedCards: "Carte assegnate",
    assignedCardsDescription:
      "Le transazioni di queste carte si sincronizzano automaticamente.",
    expensifyCard: "Carta Expensify",
    walletActivationPending:
      "Stiamo verificando le tue informazioni. Riprova tra qualche minuto!",
    walletActivationFailed:
      "Sfortunatamente, il tuo portafoglio non può essere abilitato in questo momento. Chatta con Concierge per ulteriore assistenza.",
    addYourBankAccount: "Aggiungi il tuo conto bancario",
    addBankAccountBody:
      "Colleghiamo il tuo conto bancario a Expensify così sarà più facile che mai inviare e ricevere pagamenti direttamente nell’app.",
    ...
    shareBankAccountTitle:
      "Seleziona gli amministratori con cui condividere questo conto bancario:",
    shareBankAccountSuccess: "Conto bancario condiviso!",
    shareBankAccountSuccessDescription:
      "Gli amministratori selezionati riceveranno un messaggio di conferma da Concierge.",
    shareBankAccountFailure:
      "Si è verificato un errore imprevisto durante il tentativo di condividere il conto bancario. Riprova.",
    shareBankAccountEmptyTitle: "Nessun amministratore disponibile",
    shareBankAccountEmptyDescription:
      "Non ci sono amministratori dello spazio di lavoro con cui puoi condividere questo conto bancario.",
    shareBankAccountNoAdminsSelected:
      "Seleziona un amministratore prima di continuare",
    ...
    unshareBankAccountWarning: ({ admin }: { admin?: string | null }) =>
      `${admin} perderà l’accesso a questo conto bancario aziendale. Completeremo comunque tutti i pagamenti in corso.`,
    reachOutForHelp:
      "Viene utilizzata con la Carta Expensify. <concierge-link>Contatta Concierge</concierge-link> se hai bisogno di interrompere la condivisione.",
    unshareErrorModalTitle:
      "Impossibile annullare la condivisione del conto bancario",
    travelCVV: {
      title: "CVV di viaggio",
      subtitle: "Usa questo quando prenoti viaggi",
      description:
        "Usa questa carta per le tue prenotazioni con Expensify Travel. Verrà visualizzata come “Travel Card” al momento del pagamento.",
    },
  ...
  cardPage: {
    ...
    fixedLimit: {
      name: "Limite fisso",
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
        `Puoi spendere fino a ${formattedLimit} con questa carta, dopodiché verrà disattivata.`,
    },
    monthlyLimit: {
      name: "Limite mensile",
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
    ...
    suspiciousBannerDescription:
      "Abbiamo notato transazioni sospette sulla tua carta. Tocca qui sotto per esaminarle.",
    cardLocked:
      "La tua carta è temporaneamente bloccata mentre il nostro team esamina l’account della tua azienda.",
    markTransactionsAsReimbursable:
      "Contrassegna le transazioni come rimborsabili",
    markTransactionsDescription:
      "Quando è abilitata, le transazioni importate da questa carta sono contrassegnate come rimborsabili per impostazione predefinita.",
    ...
    cardAddedToWallet: ({ platform }: { platform: "Google" | "Apple" }) =>
      `Aggiunto al portafoglio ${platform}`,
    cardDetailsLoadingFailure:
      "Si è verificato un errore durante il caricamento dei dettagli della carta. Controlla la connessione a Internet e riprova.",
    ...
    missingPrivateDetails: ({
      ...
      `Per favore <a href="${missingDetailsLink}">aggiungi i tuoi dati personali</a>, quindi riprova.`,
    unexpectedError:
      "Si è verificato un errore durante il recupero dei dettagli della tua carta Expensify. Riprova.",
    cardFraudAlert: {
      ...
      deactivatedMessage: ({ cardLastFour }: { cardLastFour: string }) =>
        `ha disattivato la carta che termina con ${cardLastFour}`,
      alertMessage: ({
        cardLastFour,
        amount,
        merchant,
...
${amount} per ${merchant} - ${date}`,
    ...
    freezeDescription:
      "Una carta bloccata non può essere usata per acquisti e transazioni. Puoi sbloccarla in qualsiasi momento.",
    unfreezeDescription:
      "Sbloccando questa carta torneranno ad essere consentiti acquisti e transazioni. Procedi solo se sei sicuro che la carta sia sicura da usare.",
    frozen: "Bloccata",
    youFroze: ({ date }: { date: string }) =>
      `Hai bloccato questa carta il ${date}.`,
    frozenBy: ({ person, date }: { person: string; date: string }) =>
      `${person} ha bloccato questa carta il ${date}.`,
  },
  workflowsPage: {
    workflowTitle: "Spesa",
    workflowDescription:
      "Configura un flusso di lavoro dal momento in cui si verifica la spesa, includendo approvazione e pagamento.",
    submissionFrequency: "Invii",
    submissionFrequencyDescription:
      "Scegli una pianificazione personalizzata per l’invio delle spese.",
    submissionFrequencyDateOfMonth: "Data del mese",
    disableApprovalPromptDescription:
      "La disattivazione delle approvazioni eliminerà tutti i flussi di lavoro di approvazione esistenti.",
    ...
    accessibilityLabel: ({
      ...
      members: string;
      approvers: string;
    }) => `spese di ${members} e l'approvatore è ${approvers}`,
    addApprovalButton: "Aggiungi flusso di approvazione",
    findWorkflow: "Cerca flusso di lavoro",
    addApprovalTip:
      "Questo flusso di lavoro predefinito si applica a tutti i membri, a meno che non esista un flusso di lavoro più specifico.",
    approver: "Approvante",
    addApprovalsDescription:
      "Richiedi un’approvazione aggiuntiva prima di autorizzare un pagamento.",
    makeOrTrackPaymentsTitle: "Pagamenti",
    makeOrTrackPaymentsDescription:
      "Aggiungi un pagatore autorizzato per i pagamenti effettuati in Expensify o tieni traccia dei pagamenti effettuati altrove.",
    ...
    editor: {
      submissionFrequency:
        "Scegli per quanto tempo Expensify deve attendere prima di condividere le spese senza errori.",
    },
    frequencyDescription:
      "Scegli la frequenza con cui desideri inviare automaticamente le spese oppure imposta l’invio manuale",
    frequencies: {
    ...
    approverInMultipleWorkflows:
      "Questo membro appartiene già a un altro flusso di approvazione. Qualsiasi aggiornamento effettuato qui verrà applicato anche lì.",
    ...
    emptyContent: {
      ...
      expensesFromSubtitle:
        "Tutti i membri dello spazio di lavoro appartengono già a un flusso di approvazione esistente.",
      approverSubtitle:
        "Tutti gli approvatori appartengono a un workflow esistente.",
    },
  },
  workflowsDelayedSubmissionPage: {
    autoReportingFrequencyErrorMessage:
      "Impossibile modificare la frequenza di invio. Riprova oppure contatta l’assistenza.",
    monthlyOffsetErrorMessage:
      "Impossibile modificare la frequenza mensile. Riprova oppure contatta l’assistenza.",
  },
  ...
  workflowsEditApprovalsPage: {
    ...
    deletePrompt:
      "Sei sicuro di voler eliminare questo flusso di approvazione? Tutti i membri seguiranno successivamente il flusso predefinito.",
  },
  ...
  workflowsApproverPage: {
    genericErrorMessage:
      "Non è stato possibile modificare l'approvatore. Riprova o contatta l'assistenza.",
  ...
  workflowsApprovalLimitPage: {
    ...
    enterApproverError:
      "È necessario un approvatore quando imposti un limite di rendiconto",
    enterBothError:
      "Inserisci un importo del report e un approvatore aggiuntivo",
  ...
  workflowsPayerPage: {
    ...
    genericErrorMessage:
      "Non è stato possibile modificare il pagatore autorizzato. Riprova.",
  ...
  reportFraudConfirmationPage: {
    ...
    description:
      "Abbiamo disattivato definitivamente la tua carta esistente. Quando tornerai a visualizzare i dettagli della carta, avrai a disposizione una nuova carta virtuale.",
  ...
  activateCardPage: {
    ...
    error: {
      thatDidNotMatch:
        "Quello non corrispondeva alle ultime 4 cifre della tua carta. Riprova.",
      throttled:
  ...
  getPhysicalCard: {
    ...
    nameMessage:
      "Inserisci il tuo nome e cognome, poiché verranno mostrati sulla tua carta.",
    ...
    estimatedDeliveryMessage:
      "La tua carta fisica arriverà entro 2-3 giorni lavorativi.",
    next: "Avanti",
    getPhysicalCard: "Richiedi carta fisica",
  ...
  transferAmountPage: {
    ...
    instantSummary: (rate: string, minAmount: string) =>
      `Commissione del ${rate}% (${minAmount} minimo)`,
    ...
    transferDetailBankAccount:
      "Il tuo denaro dovrebbe arrivare entro 1-3 giorni lavorativi.",
    transferDetailDebitCard: "Il tuo denaro dovrebbe arrivare immediatamente.",
    failedTransfer:
      "Il tuo saldo non è completamente saldato. Trasferisci i fondi su un conto bancario.",
  ...
  expenseRulesPage: {
    ...
    emptyRules: {
      ...
      subtitle:
        "Aggiungi una regola per automatizzare la rendicontazione delle spese.",
    },
    changes: {
      billableUpdate: (value: boolean) =>
        `Aggiorna spesa ${value ? "fatturabile" : "non fatturabile"}`,
      ...
      reimbursable: (value: boolean) =>
        `spesa ${value ? "rimborsabile" : "non rimborsabile"}`,
    ...
    addRule: {
      ...
      merchantHint:
        "Digita . per creare una regola che si applica a tutti gli esercenti",
  ...
  preferencesPage: {
    ...
    testSection: {
      ...
      subtitle:
        "Impostazioni per aiutare a eseguire il debug e testare l’app in staging.",
    },
    receiveRelevantFeatureUpdatesAndExpensifyNews:
      "Ricevi aggiornamenti rilevanti sulle funzionalità e notizie su Expensify",
    muteAllSounds: "Disattiva tutti i suoni da Expensify",
  },
  priorityModePage: {
    priorityMode: "Modalità prioritaria",
    explainerText:
      "Scegli se #concentrarti solo sulle chat non lette e fissate, oppure mostrare tutto con le chat più recenti e fissate in alto.",
    priorityModes: {
      default: {
        label: "Più recenti",
  ...
  reportDetailsPage: {
    ...
    errorPDF:
      "Si è verificato un errore durante il tentativo di generare il tuo PDF",
    successPDF:
      "Il tuo PDF è stato generato! Se non è stato scaricato automaticamente, usa il pulsante qui sotto.",
  },
  ...
  groupChat: {
    ...
    lastMemberWarning:
      "Dato che sei l’ultima persona qui, se lasci la chat diventerà inaccessibile a tutti i membri. Sei sicuro di voler uscire?",
    defaultReportName: ({ displayName }: ReportArchiveReasonsClosedParams) =>
      `Chat di gruppo di ${displayName}`,
  },
  languagePage: {
    language: "Lingua",
    aiGenerated:
      "Le traduzioni per questa lingua sono generate automaticamente e potrebbero contenere errori.",
  },
  themePage: {
    theme: "Tema",
    themes: {
    ...
    chooseThemeBelowOrSync:
      "Scegli un tema qui sotto o sincronizza con le impostazioni del tuo dispositivo.",
  },
  termsOfUse: {
  ...
  validateCodeForm: {
    ...
    requiredWhen2FAEnabled:
      "Obbligatorio quando l’autenticazione a due fattori è abilitata",
    requestNewCode: ({ timeRemaining }: { timeRemaining: string }) =>
      `Richiedi un nuovo codice tra <a>${timeRemaining}</a>`,
  ...
  passwordForm: {
    ...
    enterYourTwoFactorAuthenticationCodeToContinue:
      "Inserisci il tuo codice di autenticazione a due fattori per continuare",
    ...
    error: {
      ...
      twoFactorAuthenticationEnabled:
        "Hai l’autenticazione a due fattori (2FA) abilitata su questo account. Accedi usando la tua email o il tuo numero di telefono.",
      invalidLoginOrPassword:
        "Accesso o password non validi. Riprova oppure reimposta la password.",
      ...
      noAccess:
        "Non hai accesso a questa applicazione. Aggiungi il tuo nome utente GitHub per ottenere l’accesso.",
      accountLocked:
        "Il tuo account è stato bloccato dopo troppi tentativi non riusciti. Riprova tra 1 ora.",
      fallback: "Si è verificato un errore. Riprova più tardi.",
    },
  },
  loginForm: {
    ...
    error: {
      invalidFormatEmailLogin:
        "L’email inserita non è valida. Correggi il formato e riprova.",
    },
    cannotGetAccountDetails:
      "Impossibile recuperare i dettagli dell’account. Prova ad accedere di nuovo.",
  ...
  onboarding: {
    ...
    welcomeSignOffTitleManageTeam:
      "Una volta completate le attività sopra, potremo esplorare altre funzionalità come i flussi di approvazione e le regole!",
    welcomeSignOffTitle: "È un piacere conoscerti!",
    explanationModal: {
      title: "Benvenuto in Expensify",
      description:
        "Un’unica app per gestire le spese aziendali e personali alla velocità di una chat. Provala e facci sapere cosa ne pensi. E non è che l’inizio!",
      secondaryDescription:
        "Per tornare a Expensify Classic, tocca l’immagine del tuo profilo > Vai a Expensify Classic.",
    },
    getStarted: "Inizia",
    whatsYourName: "Come ti chiami?",
    peopleYouMayKnow:
      "Alcune persone che potresti conoscere sono già qui! Verifica la tua email per unirti a loro.",
    workspaceYouMayJoin: ({ domain, email }: WorkspaceYouMayJoin) =>
      `Qualcuno di ${domain} ha già creato uno spazio di lavoro. Inserisci il codice magico inviato a ${email}.`,
    joinAWorkspace: "Unisciti a uno spazio di lavoro",
    listOfWorkspaces:
      "Ecco l'elenco degli spazi di lavoro a cui puoi unirti. Non preoccuparti, potrai sempre unirti anche in un secondo momento, se preferisci.",
    workspaceMemberList: ({
      employeeCount,
      policyOwner,
    }: WorkspaceMemberList) =>
    ...
    purpose: {
      ...
      errorBackButton:
        "Completa le domande di configurazione per iniziare a usare l’app",
      [CONST.ONBOARDING_CHOICES.EMPLOYER]:
        "Essere rimborsato dal mio datore di lavoro",
      [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "Gestisci le spese del mio team",
      [CONST.ONBOARDING_CHOICES.PERSONAL_SPEND]:
        "Tieni traccia delle spese e del budget",
      [CONST.ONBOARDING_CHOICES.CHAT_SPLIT]:
        "Chatta e dividi le spese con gli amici",
    ...
    workEmail: {
      ...
      subtitle:
        "Expensify funziona al meglio quando colleghi la tua email di lavoro.",
      explanationModal: {
    ...
    workEmailValidation: {
      ...
      magicCodeSent: ({ workEmail }: WorkEmailResendCodeParams) =>
        `Inserisci il codice magico inviato a ${workEmail}. Dovrebbe arrivare tra un minuto o due.`,
    },
    workEmailValidationError: {
      publicEmail:
        "Inserisci un’email di lavoro valida con dominio privato, ad es. mitch@company.com",
      offline:
        "Non è stato possibile aggiungere la tua email di lavoro perché sembri offline",
    },
    mergeBlockScreen: {
    ...
    tasks: {
      testDriveAdminTask: {
        ...
        description: ({ testDriveURL }) =>
          `[Fai un breve tour del prodotto](${testDriveURL}) per scoprire perché Expensify è il modo più veloce per gestire le tue spese.`,
      },
      testDriveEmployeeTask: {
        title: ({ testDriveURL }) => `Fai un [giro di prova](${testDriveURL})`,
        description: ({ testDriveURL }) =>
          `Fai un [test drive](${testDriveURL}) con noi e ottieni per il tuo team *3 mesi gratis di Expensify!*`,
      },
      ...
      createTestDriveAdminWorkspaceTask: {
        title: ({ workspaceConfirmationLink }) =>
          `[Crea](${workspaceConfirmationLink}) uno spazio di lavoro`,
        description:
          "Crea uno spazio di lavoro e configura le impostazioni con l’aiuto del tuo/tuа specialista di configurazione!",
      },
      createWorkspaceTask: {
        title: ({ workspaceSettingsLink }) =>
          `Crea uno [spazio di lavoro](${workspaceSettingsLink})`,
      ...
      setupCategoriesTask: {
        title: ({ workspaceCategoriesLink }) =>
          `Configura le [categorie](${workspaceCategoriesLink})`,
...
${
  integrationName && CONST.connectionsVideoPaths[integrationName]
    ...
    : `[Portami alla contabilità](${workspaceAccountingLink}).`
      ...
      connectCorporateCardTask: {
        title: ({ corporateCardLink }) =>
          `Collega [le tue carte aziendali](${corporateCardLink})`,
      ...
      inviteTeamTask: {
        title: ({ workspaceMembersLink }) =>
          `Invita [il tuo team](${workspaceMembersLink})`,
      ...
      setupCategoriesAndTags: {
        title: ({ workspaceCategoriesLink, workspaceTagsLink }) =>
          `Configura [categorie](${workspaceCategoriesLink}) e [tag](${workspaceTagsLink})`,
      ...
      setupTagsTask: {
        title: ({ workspaceTagsLink }) =>
          `Configura i [tag](${workspaceTagsLink})`,
        description: ({ workspaceMoreFeaturesLink }) =>
          dedent(`
      ...
      inviteAccountantTask: {
        title: ({ workspaceMembersLink }) =>
          `Invita il tuo [commercialista](${workspaceMembersLink})`,
        description: ({ workspaceMembersLink }) =>
          dedent(`
      ...
      reviewWorkspaceSettingsTask: {
        title: ({ workspaceSettingsLink }) =>
          `Controlla le impostazioni del tuo [spazio di lavoro](${workspaceSettingsLink})`,
        description: ({ workspaceSettingsLink }) =>
          dedent(`
    ...
    testDrive: {
      name: ({ testDriveURL }: { testDriveURL?: string }) =>
        testDriveURL
          ? `Fai un [giro di prova](${testDriveURL})`
    ...
    messages: {
      onboardingEmployerOrSubmitMessage:
        "Essere rimborsati è facile quanto inviare un messaggio. Vediamo le basi.",
      onboardingPersonalSpendMessage:
        "Ecco come tenere traccia delle tue spese in pochi clic.",
      ...
      onboardingChatSplitMessage:
        "Dividere le spese con gli amici è facile come inviare un messaggio. Ecco come fare.",
      onboardingAdminMessage:
        "Scopri come gestire lo spazio di lavoro del tuo team come amministratore e inviare le tue spese.",
      ...
      onboardingTestDriveReceiverMessage:
        "*Hai 3 mesi gratis! Inizia qui sotto.*",
    },
    workspace: {
      title: "Resta organizzato con uno spazio di lavoro",
      subtitle:
        "Sblocca potenti strumenti per semplificare la gestione delle spese, tutto in un unico posto. Con un workspace puoi:",
      explanationModal: {
      ...
      price:
        "Provalo gratis per 30 giorni, poi passa al piano a soli <strong>$5/utente/mese</strong>.",
      createWorkspace: "Crea spazio di lavoro",
    },
    confirmWorkspace: {
      title: "Conferma spazio di lavoro",
      subtitle:
        "Crea uno spazio di lavoro per tenere traccia delle ricevute, rimborsare le spese, gestire i viaggi, creare report e altro ancora, tutto alla velocità della chat.",
    },
    inviteMembers: {
      title: "Invita membri",
      subtitle:
        "Aggiungi il tuo team o invita il tuo commercialista. Più siamo, meglio è!",
    },
  },
  featureTraining: {
  ...
  personalDetails: {
    error: {
      ...
      containsReservedWord:
        "Il nome non può contenere le parole Expensify o Concierge",
      hasInvalidCharacter:
        "Il nome non può contenere una virgola o un punto e virgola",
  ...
  privatePersonalDetails: {
    ...
    privateDataMessage:
      "Questi dettagli vengono utilizzati per viaggi e pagamenti. Non vengono mai mostrati sul tuo profilo pubblico.",
    legalName: "Nome legale",
    legalFirstName: "Nome legale di battesimo",
    legalLastName: "Cognome legale",
    address: "Indirizzo",
    error: {
      dateShouldBeBefore: (dateString: string) =>
        `La data deve essere precedente a ${dateString}`,
      dateShouldBeAfter: (dateString: string) =>
        `La data deve essere successiva a ${dateString}`,
      hasInvalidCharacter: "Il nome può includere solo caratteri latini",
      incorrectZipFormat: (zipFormat?: string) =>
        `Formato del codice postale non valido${zipFormat ? `Formato accettabile: ${zipFormat}` : ""}`,
  ...
  resendValidationForm: {
    ...
    weSentYouMagicSignInLink: ({
      ...
      `Ho inviato un link magico di accesso a ${login}. Controlla il tuo ${loginType} per accedere.`,
  ...
  unlinkLoginForm: {
    ...
    noLongerHaveAccess: (primaryLogin: string) =>
      `Se non hai più accesso a ${primaryLogin}, scollega i tuoi account.`,
    unlink: "Scollega",
  ...
  smsDeliveryFailurePage: {
    ...
    validationSuccess:
      "Il tuo numero è stato convalidato! Fai clic qui sotto per inviare un nuovo codice magico di accesso.",
    validationFailed: ({
      timeData,
    }: {
      timeData?: {
      ...
      if (timeData.days) {
        timeParts.push(
          `${timeData.days} ${timeData.days === 1 ? "giorno" : "giorni"}`,
        );
      }
      if (timeData.hours) {
        timeParts.push(
          `${timeData.hours} ${timeData.hours === 1 ? "ora" : "ore"}`,
        );
      }
      if (timeData.minutes) {
        timeParts.push(
          `${timeData.minutes} ${timeData.minutes === 1 ? "minuto" : "minuti"}`,
        );
      }
      let timeText = "";
  ...
  notFound: {
    chatYouLookingForCannotBeFound:
      "La chat che stai cercando non può essere trovata.",
    getMeOutOfHere: "Fammi uscire di qui",
    iouReportNotFound:
      "Impossibile trovare i dettagli di pagamento che stai cercando.",
    notHere: "Mh... non è qui",
    pageNotFound: "Ops, questa pagina non può essere trovata",
    noAccess:
      "Questa chat o questa spesa potrebbero essere state eliminate oppure non hai accesso a questo contenuto.\n\nPer qualsiasi domanda contatta concierge@expensify.com",
    goBackHome: "Torna alla home page",
    commentYouLookingForCannotBeFound:
      "Il commento che stai cercando non può essere trovato.",
  ...
  errorPage: {
    ...
    wrongTypeSubtitle:
      "Questa ricerca non è valida. Prova a modificare i criteri di ricerca.",
  },
  statusPage: {
    status: "Stato",
    statusExplanation:
      "Aggiungi un'emoji per dare a colleghi e amici un modo semplice per capire cosa sta succedendo. Puoi anche aggiungere un messaggio, se vuoi!",
    today: "Oggi",
    ...
    vacationDelegateError:
      "Si è verificato un errore durante l’aggiornamento del tuo delegato per le ferie.",
    asVacationDelegate: ({ nameOrEmail }: VacationDelegateParams) =>
      `come delegato per le ferie di ${nameOrEmail}`,
    toAsVacationDelegate: (
      submittedToName: string,
      vacationDelegateName: string,
    ) => `a ${submittedToName} come delegato ferie per ${vacationDelegateName}`,
  ...
  bankAccount: {
    ...
    thisBankAccount:
      "Questo conto bancario sarà utilizzato per i pagamenti aziendali nel tuo spazio di lavoro",
    ...
    desktopConnection:
      "Nota: per collegarti con Chase, Wells Fargo, Capital One o Bank of America, fai clic qui per completare questo processo in un browser.",
    yourDataIsSecure: "I tuoi dati sono al sicuro",
    toGetStarted:
      "Aggiungi un conto bancario per rimborsare le spese, emettere Carte Expensify, riscuotere i pagamenti delle fatture e pagare le bollette tutto da un unico posto.",
    plaidBodyCopy:
      "Offri ai tuoi dipendenti un modo più semplice per pagare — e farsi rimborsare — le spese aziendali.",
    checkHelpLine:
      "Il numero di instradamento e il numero di conto si trovano su un assegno relativo al conto.",
    ...
    hasBeenThrottledError:
      "Si è verificato un errore durante l’aggiunta del tuo conto bancario. Attendi qualche minuto e riprova.",
    ...
    error: {
      ...
      noBankAccountAvailable:
        "Spiacenti, non è disponibile alcun conto bancario",
      ...
      incorporationDateFuture:
        "La data di costituzione non può essere nel futuro",
      incorporationState: "Seleziona uno stato valido",
      industryCode:
        "Inserisci un codice di classificazione del settore valido di sei cifre",
      restrictedBusiness:
        "Conferma che l’azienda non sia nell’elenco delle attività soggette a restrizioni",
      ...
      routingAndAccountNumberCannotBeSame:
        "I numeri di routing e di conto non possono coincidere",
      companyType: "Seleziona un tipo di azienda valido",
      tooManyAttempts:
        "A causa di un numero elevato di tentativi di accesso, questa opzione è stata disabilitata per 24 ore. Riprova più tardi o inserisci invece i dati manualmente.",
      ...
      noDefaultDepositAccountOrDebitCardAvailable:
        "Aggiungi un conto di deposito predefinito o una carta di debito",
      validationAmounts:
        "Gli importi di verifica inseriti non sono corretti. Controlla nuovamente il tuo estratto conto bancario e riprova.",
      ...
      sameDepositAndWithdrawalAccount:
        "I conti di deposito e prelievo sono gli stessi.",
    },
  },
  addPersonalBankAccount: {
    ...
    accountHolderInformationStepHeader:
      "Quali sono i dati dell’intestatario del conto?",
    ...
    confirmationStepSubHeader:
      "Controlla attentamente i dettagli qui sotto e seleziona la casella delle condizioni per confermare.",
    toGetStarted:
      "Aggiungi un conto bancario personale per ricevere rimborsi, pagare fatture o attivare l’Expensify Wallet.",
  },
  addPersonalBankAccountPage: {
    ...
    successMessage:
      "Complimenti, il tuo conto bancario è configurato ed è pronto a ricevere i rimborsi.",
  },
  attachmentView: {
  ...
  messages: {
    ...
    userIsAlreadyMember: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} è già membro di ${name}`,
    userIsAlreadyAnAdmin: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} è già un amministratore di ${name}`,
  },
  onfidoStep: {
    acceptTerms:
      "Continuando con la richiesta di attivazione del tuo Expensify Wallet, confermi di aver letto, compreso e accettato",
    ...
    genericError:
      "Si è verificato un errore durante l’elaborazione di questo passaggio. Riprova.",
    cameraPermissionsNotGranted: "Abilita l’accesso alla fotocamera",
    cameraRequestMessage:
      "Abbiamo bisogno di accedere alla fotocamera per completare la verifica del conto bancario. Abilitala in Impostazioni > New Expensify.",
    microphonePermissionsNotGranted: "Abilita l’accesso al microfono",
    microphoneRequestMessage:
      "Abbiamo bisogno di accedere al tuo microfono per completare la verifica del conto bancario. Abilitalo tramite Impostazioni > New Expensify.",
    originalDocumentNeeded:
      "Carica un’immagine originale del tuo documento d’identità invece di uno screenshot o di una scansione.",
    ...
    imageNeedsBetterQuality:
      "C’è un problema con la qualità dell’immagine del tuo documento. Carica una nuova immagine in cui l’intero documento sia visibile chiaramente.",
    selfieIssue:
      "C’è un problema con il tuo selfie/video. Carica un selfie/video in diretta.",
    selfieNotMatching:
      "Il tuo selfie/video non corrisponde al tuo documento d’identità. Carica un nuovo selfie/video in cui il tuo viso sia chiaramente visibile.",
    selfieNotLive:
      "Il tuo selfie/video non sembra essere una foto/video in tempo reale. Carica un selfie/video in tempo reale.",
  },
  additionalDetailsStep: {
    headerTitle: "Dettagli aggiuntivi",
    helpText:
      "Dobbiamo confermare le seguenti informazioni prima che tu possa inviare e ricevere denaro dal tuo wallet.",
    helpTextIdologyQuestions:
      "Dobbiamo farti ancora poche domande per completare la verifica della tua identità.",
    ...
    needSSNFull9:
      "Non riusciamo a verificare il tuo SSN. Inserisci tutte e nove le cifre del tuo SSN.",
  ...
  termsStep: {
    ...
    haveReadAndAgreePlain:
      "Ho letto e accetto di ricevere comunicazioni elettroniche.",
    haveReadAndAgree: `Ho letto e accetto di ricevere le <a href="${CONST.ELECTRONIC_DISCLOSURES_URL}">informative elettroniche</a>.`,
    agreeToThePlain:
      "Accetto l’Informativa sulla privacy e l’Accordo sul portafoglio.",
    ...
    shortTermsForm: {
      expensifyPaymentsAccount: ({ walletProgram }: WalletProgramParams) =>
        `Il Portafoglio Expensify è emesso da ${walletProgram}.`,
      ...
      inactivityAfterTwelveMonths:
        "Inattività (dopo 12 mesi senza transazioni)",
      weChargeOneFee: "Addebitiamo 1 altro tipo di commissione. È:",
      fdicInsurance:
        "I tuoi fondi hanno diritto alla copertura assicurativa FDIC.",
      ...
      electronicFundsWithdrawalInstant:
        "Prelievo elettronico di fondi (immediato)",
    ...
    longTermsForm: {
      ...
      openingAccountDetails:
        "Non è prevista alcuna commissione per aprire un conto.",
      monthlyFeeDetails: "Non c’è alcun costo mensile.",
      customerServiceTitle: "Servizio clienti",
      customerServiceDetails:
        "Non sono previsti costi per il servizio clienti.",
      ...
      sendingFundsDetails:
        "Non è prevista alcuna commissione per inviare fondi a un altro titolare di conto utilizzando il tuo saldo, conto bancario o carta di debito.",
  ...
  activateStep: {
    ...
    activatedMessage:
      "Complimenti, il tuo portafoglio è configurato ed è pronto per effettuare pagamenti.",
    checkBackLaterTitle: "Solo un minuto...",
    checkBackLaterMessage:
      "Stiamo ancora esaminando le tue informazioni. Per favore, riprova più tardi.",
  ...
  companyStep: {
    ...
    subtitle:
      "Quasi finito! Per motivi di sicurezza, dobbiamo confermare alcune informazioni:",
    ...
    confirmCompanyIsNot:
      "Confermo che questa azienda non è presente nell’elenco",
    ...
    industryClassificationCodePlaceholder:
      "Cerca il codice di classificazione dell’industria",
  },
  requestorStep: {
  ...
  personalInfoStep: {
    ...
    enterTheLast4:
      "Quali sono le ultime quattro cifre del tuo codice di previdenza sociale?",
    dontWorry:
      "Non preoccuparti, non effettuiamo alcun controllo del credito personale!",
    last4SSN: "Ultime 4 cifre del SSN",
    enterYourAddress: "Qual è il tuo indirizzo?",
    address: "Indirizzo",
    letsDoubleCheck: "Controlliamo che sia tutto corretto.",
    byAddingThisBankAccount:
      "Aggiungendo questo conto bancario, confermi di aver letto, compreso e accettato",
    ...
    whatsYourSSN:
      "Quali sono le ultime quattro cifre del tuo codice di previdenza sociale?",
    noPersonalChecks:
      "Non preoccuparti, qui non facciamo controlli del credito personale!",
  ...
  businessInfoStep: {
    ...
    enterYourCompanyTaxIdNumber:
      "Qual è il numero di partita IVA della tua azienda?",
    taxIDNumber: "Partita IVA",
    taxIDNumberPlaceholder: "9 cifre",
    enterYourCompanyWebsite: "Qual è il sito web della tua azienda?",
    companyWebsite: "Sito web aziendale",
    enterYourCompanyPhoneNumber:
      "Qual è il numero di telefono della tua azienda?",
    ...
    selectYourCompanyIncorporationDate:
      "Qual è la data di costituzione della tua azienda?",
    incorporationDate: "Data di costituzione",
    incorporationDatePlaceholder: "Data di inizio (aaaa-mm-gg)",
    incorporationState: "Stato di costituzione",
    pleaseSelectTheStateYourCompanyWasIncorporatedIn:
      "In quale stato è stata costituita la tua azienda?",
    letsDoubleCheck: "Controlliamo che sia tutto corretto.",
    companyAddress: "Indirizzo dell’azienda",
    listOfRestrictedBusinesses: "elenco delle attività soggette a restrizioni",
    confirmCompanyIsNot:
    ...
    whatsTheBusinessContactInformation:
      "Quali sono le informazioni di contatto dell’azienda?",
    ...
    whatsTheBusinessAnnualPayment:
      "Qual è il volume annuo dei pagamenti dell’azienda?",
    whatsYourExpectedAverageReimbursements:
      "Qual è l’importo medio di rimborso previsto?",
  ...
  beneficialOwnerInfoStep: {
    doYouOwn25percent: (companyName: string) =>
      `Possiedi il 25% o più di ${companyName}?`,
    doAnyIndividualOwn25percent: (companyName: string) =>
      `Alcuna persona possiede il 25% o più di ${companyName}?`,
    areThereMoreIndividualsWhoOwn25percent: (companyName: string) =>
      `Ci sono altre persone che possiedono il 25% o più di ${companyName}?`,
    regulationRequiresUsToVerifyTheIdentity:
      "La normativa ci impone di verificare l’identità di ogni persona fisica che possiede più del 25% dell’attività.",
    ...
    enterTheLast4:
      "Quali sono le ultime 4 cifre del codice fiscale del titolare?",
    last4SSN: "Ultime 4 cifre del SSN",
    dontWorry:
      "Non preoccuparti, non effettuiamo alcun controllo del credito personale!",
  ...
  ownershipInfoStep: {
    ...
    doesAnyoneOwn: (companyName: string) =>
      `Alcuna persona possiede il 25% o più di ${companyName}?`,
    regulationsRequire:
      "I regolamenti ci impongono di verificare l’identità di ogni persona fisica che possiede oltre il 25% dell’azienda.",
    legalFirstName: "Nome legale di battesimo",
    legalLastName: "Cognome legale",
    ...
    whatsYourAddress: "Qual è il tuo indirizzo?",
    whatAreTheLast:
      "Quali sono le ultime 4 cifre del numero di previdenza sociale del titolare?",
    whatsYourLast:
      "Quali sono le ultime 4 cifre del tuo numero di previdenza sociale?",
    ...
    owners: "Proprietari",
    addCertified:
      "Aggiungi un organigramma certificato che mostri i titolari effettivi",
    ...
    noteEntity:
      "Nota: il diagramma di proprietà dell’entità deve essere firmato dal tuo commercialista, dal tuo legale o essere notarizzato.",
    ...
    pleaseUpload:
      "Carica qui sotto la documentazione aggiuntiva per aiutarci a verificare la tua identità come titolare diretto o indiretto del 25% o più dell’entità aziendale.",
    acceptedFiles:
      "Formati di file accettati: PDF, PNG, JPEG. La dimensione totale dei file per ogni sezione non può superare 5 MB.",
    ...
    proofOfAddressDescription:
      "Esempi: bolletta delle utenze, contratto d’affitto, ecc.",
  ...
  completeVerificationStep: {
    ...
    certifyTrueAndAccurate:
      "Dichiaro che le informazioni fornite sono veritiere e accurate",
    certifyTrueAndAccurateError:
      "Conferma che le informazioni siano veritiere e accurate",
    isAuthorizedToUseBankAccount:
      "Sono autorizzato/a a utilizzare questo conto bancario aziendale per spese aziendali",
    isAuthorizedToUseBankAccountError:
      "Devi essere un responsabile con autorizzazione a operare sul conto bancario aziendale",
  ...
  connectBankAccountStep: {
    ...
    maxAttemptsReached:
      "La verifica per questo conto bancario è stata disattivata a causa di troppi tentativi non corretti.",
    ...
    descriptionCTA:
      "Inserisci l’importo di ogni transazione nei campi sottostanti. Esempio: 1,51.",
    letsChatText:
      "Ci siamo quasi! Abbiamo bisogno del tuo aiuto per verificare le ultime informazioni in chat. Pronto?",
    enable2FATitle:
      "Previeni le frodi, abilita l’autenticazione a due fattori (2FA)",
    enable2FAText:
      "Prendiamo molto sul serio la tua sicurezza. Configura ora l’autenticazione a due fattori (2FA) per aggiungere un ulteriore livello di protezione al tuo account.",
  ...
  countryStep: {
    ...
    yourBusiness:
      "La valuta del conto bancario della tua azienda deve corrispondere alla valuta del tuo spazio di lavoro.",
  ...
  signerInfoStep: {
    ...
    areYouDirector: (companyName: string) =>
      `Sei un direttore presso ${companyName}?`,
    regulationRequiresUs:
      "La normativa ci impone di verificare che la persona firmataria abbia l’autorità per intraprendere questa azione per conto dell’azienda.",
    whatsYourName: "Qual è il tuo nome legale",
    ...
    personalAddress:
      "Prova dell’indirizzo personale (ad es. bolletta di utenze)",
    letsDoubleCheck: "Controlliamo che sia tutto a posto.",
    legalName: "Nome legale",
    proofOf: "Prova di indirizzo personale",
    enterOneEmail: (companyName: string) =>
      `Inserisci l’email di un direttore di ${companyName}`,
    regulationRequiresOneMoreDirector:
      "La normativa richiede almeno un altro direttore come firmatario.",
    hangTight: "Un attimo...",
    enterTwoEmails: (companyName: string) =>
      `Inserisci le email di due direttori di ${companyName}`,
    sendReminder: "Invia un promemoria",
    chooseFile: "Scegli file",
    weAreWaiting:
      "Stiamo aspettando che altre persone verifichino la loro identità come dirigenti dell’azienda.",
    id: "Copia di documento d'identità",
    proofOfDirectors: "Prova del/i direttore/i",
    proofOfDirectorsDescription:
      "Esempi: profilo aziendale Oncorp o registrazione dell’impresa.",
    codiceFiscale: "Codice fiscale",
    codiceFiscaleDescription:
      "Codice fiscale per firmatari, utenti autorizzati e titolari effettivi.",
    ...
    PDSandFSGDescription: dedent(`
        ...
        `),
    pleaseUpload:
      "Carica ulteriore documentazione qui sotto per aiutarci a verificare la tua identità come amministratore dell’azienda.",
  ...
  agreementsStep: {
    ...
    regulationRequiresUs:
      "La normativa ci impone di verificare l’identità di ogni persona fisica che possiede più del 25% dell’attività.",
    iAmAuthorized:
      "Sono autorizzato/a a usare il conto bancario aziendale per le spese aziendali.",
    ...
    iConsentToThePrivacyNotice:
      'Acconsento all’<a href="https://payments.corpay.com/compliance">informativa sulla privacy</a>.',
  ...
  docusignStep: {
    ...
    pleaseCompleteTheBusinessAccount:
      "Completa l’Applicazione di Conto Business per l’Accordo di Addebito Diretto",
    ...
    pleaseUploadTheDirect:
      "Carica la disposizione di addebito diretto e la pagina della firma DocuSign",
  },
  finishStep: {
    ...
    enable2FA:
      "Abilita l’autenticazione a due fattori (2FA) per prevenire le frodi",
    weTake:
      "Prendiamo molto sul serio la tua sicurezza. Configura ora l’autenticazione a due fattori (2FA) per aggiungere un ulteriore livello di protezione al tuo account.",
  ...
  reimbursementAccountLoadingAnimation: {
    ...
    explanationLine:
      "Stiamo esaminando le tue informazioni. Potrai procedere con i prossimi passaggi a breve.",
  },
  session: {
    offlineMessageRetry:
  ...
  travel: {
    ...
    subtitle:
      "Usa Expensify Travel per ottenere le migliori offerte di viaggio e gestire tutte le tue spese aziendali in un unico posto.",
    features: {
      saveMoney: "Risparmia denaro sulle tue prenotazioni",
      alerts:
        "Ricevi avvisi in tempo reale se i tuoi piani di viaggio cambiano",
    },
    ...
    termsAndConditions: {
      ...
      error:
        "Devi accettare i termini e le condizioni di Expensify Travel per continuare",
    ...
    flightDetails: {
      ...
      layover: (layover: string) =>
        `<muted-text-label>Hai uno <strong>scalo di ${layover}</strong> prima di questo volo</muted-text-label>`,
      takeOff: "Decollo",
    ...
    verifyCompany: {
      ...
      conciergeMessage: ({ domain }: { domain: string }) =>
        `Abilitazione dei viaggi non riuscita per il dominio: ${domain}. Verifica e abilita i viaggi per questo dominio.`,
    },
    updates: {
      bookingTicketed: (
        airlineCode: string,
      ...
      flightScheduleChangePending: (airlineCode: string) =>
        `La compagnia aerea ha proposto una modifica dell’orario per il volo ${airlineCode}; siamo in attesa di conferma.`,
      flightScheduleChangeClosed: (airlineCode: string, startDate?: string) =>
        `Cambio di programma confermato: il volo ${airlineCode} ora parte alle ${startDate}.`,
      flightUpdated: (
        airlineCode: string,
        origin: string,
        destination: string,
      ...
      flightCabinChanged: (airlineCode: string, cabinClass?: string) =>
        `La tua classe di cabina è stata aggiornata a ${cabinClass} sul volo ${airlineCode}.`,
      flightSeatConfirmed: (airlineCode: string) =>
        `La tua assegnazione del posto sul volo ${airlineCode} è stata confermata.`,
      flightSeatChanged: (airlineCode: string) =>
        `La tua assegnazione del posto sul volo ${airlineCode} è stata modificata.`,
      flightSeatCancelled: (airlineCode: string) =>
        `La tua assegnazione del posto sul volo ${airlineCode} è stata rimossa.`,
      paymentDeclined:
        "Il pagamento per la tua prenotazione aerea non è andato a buon fine. Riprova.",
      bookingCancelledByTraveler: (type: string, id = "") =>
        `Hai annullato la tua prenotazione ${type} ${id}.`,
      bookingCancelledByVendor: (type: string, id = "") =>
        `Il fornitore ha annullato la tua prenotazione ${type} ${id}.`,
      bookingRebooked: (type: string, id = "") =>
        `La tua prenotazione ${type} è stata nuovamente effettuata. Nuovo numero di conferma: ${id}.`,
      bookingUpdated: (type: string) =>
        `La tua prenotazione ${type} è stata aggiornata. Controlla i nuovi dettagli nell’itinerario.`,
      railTicketRefund: (
        origin: string,
        destination: string,
        startDate: string,
      ...
      railTicketUpdate: (
        ...
        `Il tuo biglietto del treno per ${origin} → ${destination} del ${startDate} è stato aggiornato.`,
      defaultUpdate: (type: string) =>
        `La tua prenotazione ${type} è stata aggiornata.`,
    },
    flightTo: "Volo per",
    trainTo: "Treno per",
  ...
  workspace: {
    common: {
      ...
      customFieldHint:
        "Aggiungi una codifica personalizzata che si applichi a tutte le spese di questo membro.",
      reports: "Report",
      ...
      deleteConfirmation:
        "Sei sicuro di voler eliminare questo spazio di lavoro?",
      deleteWithCardsConfirmation:
        "Sei sicuro di voler eliminare questo spazio di lavoro? Questa azione rimuoverà tutti i feed delle carte e le carte assegnate.",
      unavailable: "Spazio di lavoro non disponibile",
      memberNotFound:
        "Membro non trovato. Per invitare un nuovo membro allo spazio di lavoro, usa il pulsante di invito qui sopra.",
      ...
      mustBeOnlineToViewMembers:
        "Devi essere online per visualizzare i membri di questo spazio di lavoro.",
      ...
      descriptionHint:
        "Condividi informazioni su questo workspace con tutti i membri.",
      welcomeNote:
        "Usa Expensify per inviare le tue ricevute per il rimborso, grazie!",
      subscription: "Abbonamento",
      ...
      exportIntegrationSelected: ({
        ...
        `Esporta in ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      letsDoubleCheck: "Controlliamo che sia tutto corretto.",
      ...
      connectTo: ({ connectionName }: ConnectionNameParams) =>
        `Connetti a ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      ...
      lastSyncDate: (connectionName: string, formattedDate: string) =>
        `${connectionName} - Ultima sincronizzazione ${formattedDate}`,
      authenticationError: (connectionName: string) =>
        `Impossibile connettersi a ${connectionName} a causa di un errore di autenticazione.`,
      learnMore: "Scopri di più",
      memberAlternateText: "Invia e approva i report.",
      adminAlternateText:
        "Gestisci i report e le impostazioni dello spazio di lavoro.",
    ...
    receiptPartners: {
      uber: {
        subtitle: (organizationName: string) =>
          organizationName
            ? `Connesso a ${organizationName}`
            : "Automatizza le spese di viaggio e di consegna dei pasti in tutta la tua organizzazione.",
        ...
        takeBusinessRideMessage:
          "Fai una corsa di lavoro e le tue ricevute Uber verranno importate in Expensify. Vai!",
        all: "Tutto",
        linked: "Collegato",
        outstanding: "In sospeso",
        status: {
          ...
          [CONST.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS
            .LINKED_PENDING_APPROVAL]: "In sospeso",
        ...
        centralBillingDescription:
          "Scegli dove importare tutte le ricevute Uber.",
        ...
        autoRemove:
          "Disattiva i membri rimossi dello spazio di lavoro da Uber for Business",
        emptyContent: {
          title: "Nessun invito in sospeso",
          subtitle:
            "Urrà! Abbiamo cercato ovunque e non abbiamo trovato alcun invito in sospeso.",
        },
      },
    },
    perDiem: {
      ...
      emptyList: {
        title: "Diaria",
        subtitle:
          "Imposta le tariffe di diaria per controllare la spesa giornaliera dei dipendenti. Importa le tariffe da un foglio di calcolo per iniziare.",
      },
      ...
      editCurrencySubtitle: (destination: string) =>
        `L’aggiornamento di questa valuta la modificherà per tutte le sottotariffe di diaria ${destination}.`,
    },
    qbd: {
      exportOutOfPocketExpensesDescription:
        "Imposta come esportare le spese anticipate in QuickBooks Desktop.",
      exportOutOfPocketExpensesCheckToggle:
        'Contrassegna assegni come "stampa in seguito"',
      exportDescription:
        "Configura come i dati di Expensify vengono esportati in QuickBooks Desktop.",
      ...
      exportDate: {
        ...
        description:
          "Usa questa data quando esporti i report in QuickBooks Desktop.",
        values: {
          ...
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Data di esportazione",
            description:
              "Data in cui il resoconto è stato esportato in QuickBooks Desktop.",
          },
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_SUBMITTED]: {
            label: "Data di invio",
            description:
              "Data in cui il report è stato inviato per l'approvazione.",
          },
        },
      },
      ...
      exportJournalEntryDescription:
        "Creeremo una registrazione contabile dettagliata per ogni report di Expensify e la registreremo sul conto qui sotto.",
      ...
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}AccountDescription`]:
          "Scegli dove esportare le transazioni della carta di credito.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}AccountDescription`]:
          "Scegli un fornitore da applicare a tutte le transazioni con carta di credito.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}AccountDescription`]:
          "Scegli da dove inviare gli assegni.",
      ...
      noAccountsFoundDescription:
        "Aggiungi il conto in QuickBooks Desktop e sincronizza di nuovo la connessione",
      qbdSetup: "Configurazione QuickBooks Desktop",
      requiredSetupDevice: {
        title: "Impossibile connettersi da questo dispositivo",
        body1:
          "Dovrai configurare questa connessione dal computer che ospita il file aziendale di QuickBooks Desktop.",
        body2:
          "Una volta connesso, potrai sincronizzare ed esportare da qualsiasi luogo.",
      },
      setupPage: {
      ...
      importDescription:
        "Scegli quali configurazioni di codifica importare da QuickBooks Desktop in Expensify.",
      classes: "Classi",
      items: "Elementi",
      customers: "Clienti/progetti",
      exportCompanyCardsDescription:
        "Imposta come le spese con carta aziendale vengono esportate in QuickBooks Desktop.",
      defaultVendorDescription:
        "Imposta un fornitore predefinito che verrà applicato a tutte le transazioni con carta di credito al momento dell’esportazione.",
      accountsDescription:
        "Il tuo piano dei conti di QuickBooks Desktop verrà importato in Expensify come categorie.",
      accountsSwitchTitle:
        "Scegli se importare i nuovi conti come categorie abilitate o disabilitate.",
      accountsSwitchDescription:
        "Le categorie abilitate saranno disponibili per i membri da selezionare quando creano le loro spese.",
      classesDescription:
        "Scegli come gestire le classi di QuickBooks Desktop in Expensify.",
      tagsDisplayedAsDescription: "Livello voce di dettaglio",
      reportFieldsDisplayedAsDescription: "Livello report",
      customersDescription:
        "Scegli come gestire i clienti/progetti di QuickBooks Desktop in Expensify.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify si sincronizzerà automaticamente con QuickBooks Desktop ogni giorno.",
        createEntities: "Crea automaticamente le entità",
        createEntitiesDescription:
          "Expensify creerà automaticamente i fornitori in QuickBooks Desktop se non esistono già.",
      },
      itemsDescription:
        "Scegli come gestire gli elementi di QuickBooks Desktop in Expensify.",
      accountingMethods: {
        ...
        alternateText: {
          [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]:
            "Le spese anticipate verranno esportate una volta approvate definitivamente",
          [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]:
            "Le spese anticipate verranno esportate al momento del pagamento",
        },
      },
    },
    qbo: {
      ...
      importDescription:
        "Scegli quali configurazioni di codifica importare da QuickBooks Online in Expensify.",
      classes: "Classi",
      locations: "Sedi",
      customers: "Clienti/progetti",
      accountsDescription:
        "Il tuo piano dei conti di QuickBooks Online verrà importato in Expensify come categorie.",
      accountsSwitchTitle:
        "Scegli se importare i nuovi conti come categorie abilitate o disabilitate.",
      accountsSwitchDescription:
        "Le categorie abilitate saranno disponibili per i membri da selezionare quando creano le loro spese.",
      classesDescription:
        "Scegli come gestire le classi di QuickBooks Online in Expensify.",
      customersDescription:
        "Scegli come gestire i clienti/progetti di QuickBooks Online in Expensify.",
      locationsDescription:
        "Scegli come gestire le sedi di QuickBooks Online in Expensify.",
      taxesDescription:
        "Scegli come gestire le imposte di QuickBooks Online in Expensify.",
      ...
      taxesJournalEntrySwitchNote:
        "QuickBooks Online non supporta le imposte sulle registrazioni contabili. Modifica l’opzione di esportazione in fattura fornitore o assegno.",
      exportDescription:
        "Configura come i dati di Expensify vengono esportati in QuickBooks Online.",
      date: "Data di esportazione",
      exportInvoices: "Esporta fatture in",
      exportExpensifyCard: "Esporta le transazioni Carta Expensify come",
      exportDate: {
        label: "Data di esportazione",
        description:
          "Usa questa data quando esporti i report in QuickBooks Online.",
        values: {
          [CONST.QUICKBOOKS_EXPORT_DATE.LAST_EXPENSE]: {
            label: "Data dell'ultima spesa",
            description: "Data della spesa più recente nel rendiconto.",
          ...
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Data di esportazione",
            description:
              "Data in cui il report è stato esportato in QuickBooks Online.",
          },
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_SUBMITTED]: {
            label: "Data di invio",
            description:
      ...
      exportInvoicesDescription:
        "Usa questo conto quando esporti le fatture in QuickBooks Online.",
      exportCompanyCardsDescription:
        "Imposta come esportare gli acquisti con carta aziendale in QuickBooks Online.",
      vendor: "Fornitore",
      defaultVendorDescription:
        "Imposta un fornitore predefinito che verrà applicato a tutte le transazioni con carta di credito al momento dell’esportazione.",
      exportOutOfPocketExpensesDescription:
        "Imposta come esportare le spese anticipate in QuickBooks Online.",
      exportCheckDescription:
        "Creeremo un assegno dettagliato per ogni report di Expensify e lo invieremo dal conto bancario qui sotto.",
      exportJournalEntryDescription:
        "Creeremo una registrazione contabile dettagliata per ogni report di Expensify e la registreremo sul conto qui sotto.",
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify si sincronizzerà automaticamente con QuickBooks Online ogni giorno.",
        inviteEmployees: "Invita dipendenti",
        inviteEmployeesDescription:
          "Importa i record dei dipendenti da QuickBooks Online e invita i dipendenti a questo workspace.",
        createEntities: "Crea automaticamente le entità",
        createEntitiesDescription:
        ...
        accountSelectDescription:
          "Scegli da dove pagare le fatture e creeremo il pagamento in QuickBooks Online.",
        invoiceAccountSelectorDescription:
          "Scegli dove ricevere i pagamenti delle fatture e creeremo il pagamento in QuickBooks Online.",
      },
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]:
          "Scegli dove esportare le transazioni della carta di debito.",
      ...
      exportDestinationAccountsMisconfigurationError: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Scegli un conto valido per l’esportazione delle fatture fornitore",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Scegli un conto valido per l’esportazione della registrazione contabile",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Scegli un conto valido per l’esportazione degli assegni",
      },
      exportDestinationSetupAccountsInfo: {
        ...
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Per utilizzare l’esportazione delle registrazioni contabili, configura un conto contabile in QuickBooks Online",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Per usare l’esportazione degli assegni, configura un conto bancario in QuickBooks Online",
      },
      noAccountsFound: "Nessun account trovato",
      noAccountsFoundDescription:
        "Aggiungi il conto in QuickBooks Online e sincronizza nuovamente la connessione.",
      accountingMethods: {
        label: "Quando esportare",
        description: "Scegli quando esportare le spese:",
        values: {
    ...
    xero: {
      ...
      organizationDescription:
        "Scegli l'organizzazione Xero da cui desideri importare i dati.",
      importDescription:
        "Scegli quali configurazioni di codifica importare da Xero in Expensify.",
      accountsDescription:
        "Il tuo piano dei conti Xero verrà importato in Expensify come categorie.",
      accountsSwitchTitle:
        "Scegli se importare i nuovi conti come categorie abilitate o disabilitate.",
      accountsSwitchDescription:
        "Le categorie abilitate saranno disponibili per i membri da selezionare quando creano le loro spese.",
      ...
      trackingCategoriesDescription:
        "Scegli come gestire le categorie di monitoraggio Xero in Expensify.",
      mapTrackingCategoryTo: (categoryName: string) =>
        `Mappa ${categoryName} di Xero a`,
      mapTrackingCategoryToDescription: (categoryName: string) =>
        `Scegli dove mappare ${categoryName} quando esporti in Xero.`,
      ...
      xeroBankAccountDescription:
        "Scegli dove registrare le spese come transazioni bancarie.",
      exportExpensesDescription:
        "I report verranno esportati come note di acquisto con la data e lo stato selezionati di seguito.",
      purchaseBillDate: "Data fattura di acquisto",
      exportInvoices: "Esporta fatture come",
      salesInvoice: "Fattura di vendita",
      exportInvoicesDescription:
        "Le fatture di vendita mostrano sempre la data in cui la fattura è stata inviata.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify si sincronizzerà automaticamente con Xero ogni giorno.",
        purchaseBillStatusTitle: "Stato della fattura di acquisto",
        reimbursedReportsDescription:
          "Ogni volta che un report viene pagato tramite Expensify ACH, il corrispondente pagamento della fattura verrà creato nel conto Xero qui sotto.",
        ...
        xeroBillPaymentAccountDescription:
          "Scegli da dove pagare le fatture e creeremo il pagamento in Xero.",
        invoiceAccountSelectorDescription:
          "Scegli dove ricevere i pagamenti delle fatture e creeremo il pagamento in Xero.",
      },
      exportDate: {
      ...
      invoiceStatus: {
        ...
        description:
          "Usa questo stato quando esporti le fatture di acquisto in Xero.",
        values: {
      ...
      noAccountsFound: "Nessun account trovato",
      noAccountsFoundDescription:
        "Aggiungi l’account in Xero e sincronizza nuovamente la connessione",
      accountingMethods: {
        label: "Quando esportare",
        description: "Scegli quando esportare le spese:",
        values: {
    ...
    sageIntacct: {
      ...
      exportDate: {
        ...
        values: {
          ...
          [CONST.SAGE_INTACCT_EXPORT_DATE.EXPORTED]: {
            label: "Data di esportazione",
            description:
              "Data in cui il report è stato esportato in Sage Intacct.",
          },
      ...
      reimbursableExpenses: {
        description:
          "Imposta come esportare le spese anticipate in Sage Intacct.",
        values: {
      ...
      nonReimbursableExpenses: {
        description:
          "Imposta come esportare in Sage Intacct gli acquisti effettuati con carte aziendali.",
        values: {
      ...
      exportDescription:
        "Configura come i dati di Expensify vengono esportati in Sage Intacct.",
      ...
      exportPreferredExporterSubNote:
        "Una volta impostato, l’esportatore preferito vedrà nel proprio account i report da esportare.",
      noAccountsFound: "Nessun account trovato",
      ...
      autoSyncDescription:
        "Expensify si sincronizzerà automaticamente con Sage Intacct ogni giorno.",
      inviteEmployees: "Invita dipendenti",
      inviteEmployeesDescription:
    ...
    netsuite: {
      ...
      subsidiarySelectDescription:
        "Scegli la consociata in NetSuite da cui desideri importare i dati.",
      exportDescription:
        "Configura come i dati di Expensify vengono esportati in NetSuite.",
      exportInvoices: "Esporta fatture in",
      journalEntriesTaxPostingAccount:
        "Conto di registrazione imposte nelle scritture contabili",
      journalEntriesProvTaxPostingAccount:
        "Conto di registrazione contabile dell’imposta provinciale",
      ...
      nonReimbursableJournalPostingAccount:
        "Conto di registrazione per spese non rimborsabili",
      reimbursableJournalPostingAccount:
        "Conto di registrazione per rimborsabili",
      journalPostingPreference: {
        ...
        values: {
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            ...
            "Voce singola, con dettagli per ogni report",
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            .JOURNALS_POSTING_TOTAL_LINE]: "Voce singola per ogni spesa",
        },
      },
      invoiceItem: {
        ...
        values: {
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
            ...
            description:
              "Creeremo una “voce di riga fattura Expensify” per te all’esportazione (se non ne esiste già una).",
          },
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.SELECT]: {
            label: "Seleziona esistente",
            description:
              "Collegheremo le fatture da Expensify all’elemento selezionato qui sotto.",
          },
        },
      },
      exportDate: {
        ...
        values: {
          [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
            ...
            reimbursableDescription:
              "Le spese anticipate dal dipendente verranno esportate come note spese in NetSuite.",
            nonReimbursableDescription:
              "Le spese con carta aziendale verranno esportate come note spese in NetSuite.",
          },
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify si sincronizzerà automaticamente con NetSuite ogni giorno.",
        reimbursedReportsDescription:
        ...
        reimbursementsAccountDescription:
          "Scegli il conto bancario che utilizzerai per i rimborsi e creeremo il pagamento associato in NetSuite.",
        collectionsAccount: "Account di riscossione",
        collectionsAccountDescription:
          "Una volta che una fattura è contrassegnata come pagata in Expensify ed esportata in NetSuite, verrà visualizzata nel conto sottostante.",
        ...
        exportVendorBillsTo: {
          ...
          values: {
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVED_NONE]: "Preferenza predefinita NetSuite",
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVAL_PENDING]: "Approvazione in sospeso",
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED]:
              "Approvato per la registrazione",
          },
        },
        exportJournalsTo: {
        ...
        error: {
          customFormID:
            "Inserisci un ID del modulo personalizzato numerico valido",
        },
      },
      noAccountsFound: "Nessun account trovato",
      noAccountsFoundDescription:
        "Aggiungi l’account in NetSuite e sincronizza nuovamente la connessione",
      noVendorsFound: "Nessun fornitore trovato",
      noVendorsFoundDescription:
        "Aggiungi fornitori in NetSuite e sincronizza di nuovo la connessione",
      noItemsFound: "Nessuna voce di fattura trovata",
      noItemsFoundDescription:
        "Aggiungi le voci della fattura in NetSuite e sincronizza di nuovo la connessione",
      noSubsidiariesFound: "Nessuna consociata trovata",
      noSubsidiariesFoundDescription:
        "Aggiungi una consociata in NetSuite e sincronizza di nuovo la connessione",
      tokenInput: {
        ...
        formSteps: {
          installBundle: {
            ...
            description:
              'In NetSuite, vai su *Customization > SuiteBundler > Search & Install Bundles* > cerca "Expensify" > installa il bundle.',
          },
          enableTokenAuthentication: {
            title: "Abilita l’autenticazione basata su token",
            description:
              "In NetSuite, vai a *Setup > Company > Enable Features > SuiteCloud* > abilita *token-based authentication*.",
          },
          enableSoapServices: {
            title: "Abilita i servizi web SOAP",
            description:
              "In NetSuite, vai a *Setup > Company > Enable Features > SuiteCloud* > abilita *SOAP Web Services*.",
          },
          createAccessToken: {
          ...
          enterCredentials: {
            ...
            netSuiteAccountIDDescription:
              "In NetSuite, vai a *Setup > Integration > SOAP Web Services Preferences*.",
          },
        },
      },
      import: {
        ...
        expenseCategoriesDescription:
          "Le tue categorie di spesa NetSuite verranno importate in Expensify come categorie.",
        crossSubsidiaryCustomers: "Clienti/progetti inter-sussidiaria",
        importFields: {
          departments: {
            title: "Reparti",
            subtitle:
              "Scegli come gestire i *dipartimenti* di NetSuite in Expensify.",
          },
          classes: {
            title: "Classi",
        ...
        customersOrJobs: {
          ...
          subtitle:
            "Scegli come gestire i *clienti* e i *progetti* di NetSuite in Expensify.",
        ...
        importCustomFields: {
          ...
          label: (importedTypes: string[]) =>
            `Importato come ${importedTypes.join("e")}`,
          ...
          customSegments: {
            ...
            emptyTitle:
              "Aggiungi un segmento personalizzato o un record personalizzato",
            fields: {
              segmentName: "Nome",
            ...
            removePrompt:
              "Sei sicuro di voler rimuovere questo segmento/record personalizzato?",
            addForm: {
              ...
              segmentRecordType:
                "Vuoi aggiungere un segmento personalizzato o un record personalizzato?",
              customSegmentNameTitle:
                "Qual è il nome del segmento personalizzato?",
              customRecordNameTitle:
                "Qual è il nome del record personalizzato?",
...
_Per istruzioni più dettagliate, [visita il nostro sito di assistenza](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
              customRecordScriptIDTitle:
                "Qual è l'ID della colonna della transazione?",
...
_Per istruzioni più dettagliate, [visita il nostro sito di assistenza](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
              customSegmentMappingTitle:
                "Come deve essere visualizzato questo segmento personalizzato in Expensify?",
              customRecordMappingTitle:
                "Come deve essere visualizzato questo record personalizzato in Expensify?",
            },
            errors: {
              uniqueFieldError: (fieldName: string) =>
                `Esiste già un segmento/record personalizzato con questo ${fieldName?.toLowerCase()}`,
            },
          },
          customLists: {
            ...
            removePrompt:
              "Sei sicuro di voler rimuovere questa lista personalizzata?",
            addForm: {
...
_Per istruzioni più dettagliate, [visita il nostro sito di assistenza](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
              mappingTitle:
                "Come deve essere visualizzato questo elenco personalizzato in Expensify?",
            },
            errors: {
        ...
        importTypes: {
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]: {
            ...
            description:
              "Non importato in Expensify, applicato all’esportazione",
          ...
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
            ...
            footerContent: (importField: string) =>
              `${startCase(importField)} sarà selezionabile per ogni singola spesa nel report di un dipendente.`,
          },
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
            label: "Campi del report",
            description: "Livello report",
            footerContent: (importField: string) =>
              `La selezione ${startCase(importField)} verrà applicata a tutte le spese nel report di un dipendente.`,
          },
        },
      },
    },
    intacct: {
      ...
      downloadExpensifyPackage:
        "Scarica il pacchetto Expensify per Sage Intacct",
      followSteps:
        "Segui i passaggi nelle nostre istruzioni della guida: Come connettersi a Sage Intacct",
      ...
      employeeDefaultDescription:
        "Il reparto predefinito del dipendente verrà applicato alle sue spese in Sage Intacct, se esiste.",
      displayedAsTagDescription:
        "Il reparto sarà selezionabile per ogni singola spesa nel report di un dipendente.",
      displayedAsReportFieldDescription:
        "La selezione del reparto verrà applicata a tutte le spese nel report di un dipendente.",
      toggleImportTitle: (mappingTitle: string) =>
        `Scegli come gestire Sage Intacct <strong>${mappingTitle}</strong> in Expensify.`,
      expenseTypes: "Tipi di spesa",
      expenseTypesDescription:
        "I tuoi tipi di spesa Sage Intacct verranno importati in Expensify come categorie.",
      accountTypesDescription:
        "Il tuo piano dei conti di Sage Intacct verrà importato in Expensify come categorie.",
      importTaxDescription:
        "Importa l'aliquota dell'imposta sugli acquisti da Sage Intacct.",
      ...
      removeDimensionPrompt:
        "Sei sicuro di voler rimuovere questa dimensione definita dall’utente?",
      ...
      detailedInstructionsRestOfSentence:
        "sull’aggiunta di dimensioni definite dall’utente.",
      userDimensionsAdded: () => ({
        one: "1 UDD aggiunto",
    ...
    companyCards: {
      ...
      error: {
        workspaceFeedsCouldNotBeLoadedTitle:
          "Impossibile caricare i feed della carta",
        ...
        feedCouldNotBeLoadedMessage:
          "Si è verificato un errore durante il caricamento di questo feed. Riprova oppure contatta il tuo amministratore.",
        tryAgain: "Riprova",
      },
      addNewCard: {
        other: "Altro",
        ...
        directFeedDetails:
          "L’approccio più semplice. Connettiti subito utilizzando le tue credenziali principali. Questo metodo è il più comune.",
        enableFeed: {
          ...
          mastercard:
            "Abbiamo integrazioni globali con Mastercard, anche se l'idoneità varia in base alla banca e al programma della carta.\n\nPer iniziare, è sufficiente:",
...
3. Una volta che il feed è abilitato, fai clic su Invia qui sotto e noi ci occuperemo di aggiungerlo.`,
        ...
        amexCorporate:
          "Seleziona questa opzione se sul fronte delle tue carte è presente la dicitura “Corporate”",
        amexBusiness:
          "Seleziona questa opzione se sul fronte delle tue carte è presente la dicitura “Business”",
        amexPersonal: "Seleziona questa opzione se le tue carte sono personali",
        error: {
          pleaseSelectProvider:
            "Seleziona un fornitore di carte prima di continuare",
          pleaseSelectBankAccount:
            "Seleziona un conto bancario prima di continuare",
        ...
        exitModal: {
          ...
          prompt:
            "Abbiamo notato che non hai finito di aggiungere le tue carte. Se hai riscontrato un problema, faccelo sapere così possiamo aiutarti a rimettere le cose in carreggiata.",
      ...
      statementCloseDate: {
        ...
        [CONST.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH]:
          "Giorno personalizzato del mese",
      },
      assign: "Assegna",
      ...
      startDateDescription:
        "Scegli la data di inizio per l’importazione. Sincronizzeremo tutte le transazioni da questa data in poi.",
      editStartDateDescription:
        "Scegli una nuova data di inizio transazione. Sincronizzeremo tutte le transazioni da quella data in poi, escludendo quelle già importate.",
      ...
      confirmationDescription:
        "Inizieremo immediatamente a importare le transazioni.",
      card: "Carta",
      cardName: "Nome della carta",
      brokenConnectionError:
        '<rbr>La connessione al feed della carta è interrotta. Per favore <a href="#">accedi alla tua banca</a> così possiamo ristabilire la connessione.</rbr>',
      assignedCard: (assignee: string, link: string) =>
        `ha assegnato a ${assignee} un ${link}! Le transazioni importate appariranno in questa chat.`,
      ...
      cardAlreadyAssignedError:
        "Questa carta è già assegnata a un utente in un altro spazio di lavoro.",
      importTransactions: {
        title: "Importa transazioni da file",
        description:
          "Modifica le impostazioni per il tuo file che verranno applicate durante l’importazione.",
    ...
    expensifyCard: {
      ...
      getStartedIssuing:
        "Inizia emettendo la tua prima carta virtuale o fisica.",
      verificationInProgress: "Verifica in corso...",
      verifyingTheDetails:
        "Stiamo verificando alcuni dettagli. Concierge ti avviserà quando le Carte Expensify saranno pronte per essere emesse.",
      disclaimer:
      ...
      currentBalanceDescription:
        "Il saldo attuale è la somma di tutte le transazioni contabilizzate della Carta Expensify che si sono verificate dalla data dell’ultima liquidazione.",
      balanceWillBeSettledOn: (settlementDate: string) =>
        `Il saldo sarà regolato il ${settlementDate}`,
      ...
      earnedCashbackDescription:
        "Il saldo del cashback si basa sulle spese mensili consolidate della Carta Expensify nel tuo spazio di lavoro.",
      issueNewCard: "Emetti nuova carta",
      finishSetup: "Completa configurazione",
      chooseBankAccount: "Scegli il conto bancario",
      chooseExistingBank:
        "Scegli un conto bancario aziendale esistente per pagare il saldo della tua Carta Expensify oppure aggiungi un nuovo conto bancario",
      ...
      settlementAccountDescription:
        "Scegli un conto da cui pagare il saldo della tua Carta Expensify.",
      ...
      settlementFrequencyDescription:
        "Scegli con quale frequenza pagherai il saldo della tua Carta Expensify.",
      ...
      cardPending: ({ name }: { name: string }) =>
        `La carta è al momento in sospeso e verrà emessa non appena l'account di ${name} sarà convalidato.`,
      virtual: "Virtuale",
      physical: "Fisico",
      ...
      monthlyLimitWarning: (limit: number | string) =>
        `Se cambi il limite di questa carta a ${limit}, le nuove transazioni verranno rifiutate fino al mese prossimo.`,
      fixedLimitWarning: (limit: number | string) =>
        `Se cambi il limite di questa carta a ${limit}, le nuove transazioni verranno rifiutate.`,
      ...
      issuedCard: (assignee: string) =>
        `ha emesso una Carta Expensify per ${assignee}! La carta arriverà entro 2-3 giorni lavorativi.`,
      issuedCardNoShippingDetails: (assignee: string) =>
        `ha assegnato a ${assignee} una Carta Expensify! La carta sarà spedita una volta confermati i dettagli di spedizione.`,
      issuedCardVirtual: (assignee: string, link: string) =>
        `ha emesso una Carta Expensify virtuale per ${assignee}! Puoi usare subito il ${link}.`,
      addedShippingDetails: (assignee: string) =>
        `${assignee} ha aggiunto i dettagli di spedizione. La Carta Expensify arriverà in 2-3 giorni lavorativi.`,
      replacedCard: (assignee: string) =>
        `${assignee} ha sostituito la propria Carta Expensify. La nuova carta arriverà tra 2-3 giorni lavorativi.`,
      replacedVirtualCard: (assignee: string, link: string) =>
        `${assignee} ha sostituito la sua Carta Expensify virtuale! Il ${link} può essere usato subito.`,
      card: "carta",
      ...
      verifyingBankAccountDescription:
        "Attendi mentre verifichiamo che questo conto possa essere usato per emettere Carte Expensify.",
      bankAccountVerified: "Conto bancario verificato!",
      bankAccountVerifiedDescription:
        "Ora puoi emettere Carte Expensify ai membri del tuo spazio di lavoro.",
      oneMoreStep: "Ancora un passo...",
      oneMoreStepDescription:
        "Sembra che dobbiamo verificare manualmente il tuo conto bancario. Vai su Concierge, dove ti aspettano le istruzioni.",
      gotIt: "Ho capito",
    ...
    categories: {
      ...
      spendCategoriesDescription:
        "Personalizza come viene categorizzata la spesa dei fornitori per le transazioni con carta di credito e le ricevute scansionate.",
      deleteFailureMessage:
        "Si è verificato un errore durante l’eliminazione della categoria, riprova per favore",
      ...
      subtitle:
        "Ottieni una panoramica migliore di dove viene speso il denaro. Usa le nostre categorie predefinite oppure aggiungi le tue.",
      emptyCategories: {
      ...
      updateFailureMessage:
        "Si è verificato un errore durante l’aggiornamento della categoria, riprova per favore",
      createFailureMessage:
        "Si è verificato un errore durante la creazione della categoria, riprova per favore",
      ...
      importedFromAccountingSoftware:
        "Le categorie sottostanti sono importate dal tuo",
      payrollCode: "Codice paghe",
      updatePayrollCodeFailureMessage:
        "Si è verificato un errore durante l’aggiornamento del codice paghe, riprova.",
      glCode: "Codice CO",
      updateGLCodeFailureMessage:
        "Si è verificato un errore durante l’aggiornamento del codice GL, riprova",
    ...
    moreFeatures: {
      ...
      spendSection: {
        title: "Spesa",
        subtitle:
          "Abilita funzionalità che ti aiutano a far crescere il tuo team su larga scala.",
      },
      manageSection: {
        title: "Gestisci",
        subtitle:
          "Aggiungi controlli che aiutino a mantenere le spese entro il budget.",
      },
      earnSection: {
        title: "Guadagna",
      ...
      organizeSection: {
        title: "Organizza",
        subtitle:
          "Raggruppa e analizza le spese, registra ogni imposta pagata.",
      },
      integrateSection: {
        title: "Integra",
      ...
      perDiem: {
        title: "Diaria",
        subtitle:
          "Imposta le indennità giornaliere per controllare le spese quotidiane dei dipendenti.",
      },
      travel: {
        title: "Viaggi",
        ...
        getStarted: {
          title: "Inizia con Expensify Travel",
          subtitle:
            "Ci servono solo ancora alcune informazioni sulla tua attività, poi sarai pronto al decollo.",
          ctaText: "Andiamo",
        },
        reviewingRequest: {
          title: "Prepara le valigie, abbiamo ricevuto la tua richiesta...",
          subtitle:
            "Stiamo attualmente esaminando la tua richiesta di abilitare Expensify Travel. Non preoccuparti, ti faremo sapere quando sarà pronto.",
          ctaText: "Richiesta inviata",
        },
        bookOrManageYourTrip: {
          title: "Prenotazione di viaggio",
          subtitle:
            "Complimenti! Ora sei pronto per prenotare e gestire i viaggi in questo spazio di lavoro.",
        ...
        settings: {
          autoAddTripName: {
            ...
            subtitle:
              "Aggiungi automaticamente i nomi dei viaggi alle descrizioni delle spese per i viaggi prenotati in Expensify.",
          },
        },
        travelInvoicing: {
          travelBookingSection: {
            ...
            subtitle:
              "Complimenti! Ora sei prontə per prenotare e gestire i viaggi in questo spazio di lavoro.",
            manageTravelLabel: "Gestisci viaggi",
          },
          centralInvoicingSection: {
            title: "Fatturazione centralizzata",
            subtitle:
              "Centralizza tutte le spese di viaggio in una fattura mensile invece di pagare al momento dell’acquisto.",
        ...
        personalDetailsDescription:
          "Per prenotare il viaggio, inserisci il tuo nome legale così come appare sul tuo documento d’identità rilasciato dal governo.",
      },
      expensifyCard: {
        ...
        disableCardPrompt:
          "Non puoi disattivare la Carta Expensify perché è già in uso. Contatta Concierge per i prossimi passi.",
        disableCardButton: "Chatta con Concierge",
        feed: {
          title: "Ottieni la Carta Expensify",
          subTitle:
            "Ottimizza le spese aziendali e risparmia fino al 50% sulla tua fattura Expensify, oltre a:",
          features: {
      ...
      companyCards: {
        ...
        disableCardPrompt:
          "Non puoi disattivare le carte aziendali perché questa funzionalità è in uso. Contatta Concierge per sapere come procedere.",
        disableCardButton: "Chatta con Concierge",
        cardDetails: "Dettagli carta",
        cardNumber: "Numero carta",
        ...
        integrationExport: (integration: string, type?: string) =>
          integration && type
            ? `esportazione ${integration} ${type.toLowerCase()}`
            : `Esportazione ${integration}`,
        integrationExportTitleXero: (integration: string) =>
          `Scegli il conto ${integration} in cui esportare le transazioni.`,
        ...
        unassignCardDescription:
          "La rimozione dell’assegnazione di questa carta eliminerà tutte le transazioni non inviate.",
        assignCard: "Assegna carta",
        removeCard: "Rimuovi carta",
        remove: "Rimuovi",
        removeCardDescription:
          "La rimozione di questa carta eliminerà tutte le transazioni non inviate.",
        cardFeedName: "Nome feed carta",
        cardFeedNameDescription:
          "Dai al feed della carta un nome univoco, così puoi distinguerlo dagli altri.",
        cardFeedTransaction: "Elimina transazioni",
        cardFeedTransactionDescription:
          "Scegli se i titolari di carta possono eliminare le transazioni della carta. Le nuove transazioni seguiranno queste regole.",
        cardFeedRestrictDeletingTransaction:
          "Limita l’eliminazione delle transazioni",
        cardFeedAllowDeletingTransaction:
          "Consenti l’eliminazione delle transazioni",
        removeCardFeed: "Rimuovi flusso carta",
        removeCardFeedTitle: (feedName: string) => `Rimuovi feed ${feedName}`,
        removeCardFeedDescription:
          "Sei sicuro di voler rimuovere questo flusso di carte? Questo rimuoverà l’assegnazione di tutte le carte.",
        error: {
          feedNameRequired: "Il nome del feed della carta è obbligatorio",
          statementCloseDateRequired:
            "Seleziona una data di chiusura dell’estratto conto.",
        },
        ...
        setFeedNameDescription:
          "Dai al feed della carta un nome univoco così potrai distinguerlo dagli altri",
        setTransactionLiabilityDescription:
          "Quando è abilitato, i titolari della carta possono eliminare le transazioni della carta. Le nuove transazioni seguiranno questa regola.",
        emptyAddedFeedTitle: "Nessuna carta in questo feed",
        emptyAddedFeedDescription:
          "Assicurati che ci siano carte nel flusso di carte della tua banca.",
        ...
        pendingBankDescription: (bankName: string) =>
          `Connettiti a ${bankName} tramite la finestra del browser che si è appena aperta. Se non se ne è aperta una,`,
        pendingBankLink: "fai clic qui",
        giveItNameInstruction:
          "Dai alla carta un nome che la distingua dalle altre.",
        ...
        noAccountsFoundDescription: (connection: string) =>
          `Aggiungi l’account in ${connection} e sincronizza nuovamente la connessione`,
        ...
        statementCloseDateDescription:
          "Facci sapere quando si chiude l’estratto conto della tua carta e creeremo un estratto conto corrispondente in Expensify.",
      },
      workflows: {
      ...
      connectionsWarningModal: {
        ...
        featureEnabledText:
          "Per attivare o disattivare questa funzionalità, devi modificare le impostazioni di importazione contabile.",
        disconnectText:
          "Per disattivare la contabilità, devi disconnettere la connessione contabile dal tuo spazio di lavoro.",
        manageSettings: "Gestisci impostazioni",
      },
      receiptPartnersWarningModal: {
        featureEnabledTitle: "Disconnetti Uber",
        disconnectText:
          "Per disattivare questa funzionalità, disconnetti prima l’integrazione Uber for Business.",
      ...
      timeTracking: {
        title: "Ora",
        subtitle:
          "Imposta una tariffa oraria fatturabile per il rilevamento del tempo.",
    ...
    reports: {
      ...
      preventMembersFromChangingCustomNamesTitle:
        "Impedisci ai membri di modificare i titoli personalizzati dei report",
    },
    reportFields: {
      ...
      deleteConfirmation:
        "Sei sicuro di voler eliminare questo campo del report?",
      deleteFieldsConfirmation:
        "Sei sicuro di voler eliminare questi campi del resoconto?",
      emptyReportFields: {
        title: "Non hai creato nessun campo di rendiconto",
        subtitle:
          "Aggiungi un campo personalizzato (testo, data o menu a discesa) che appare nei report.",
      },
      subtitle:
        "I campi del report si applicano a tutte le spese e possono essere utili quando desideri richiedere informazioni aggiuntive.",
      disableReportFields: "Disattiva campi del report",
      disableReportFieldsConfirmation:
        "Sei sicuro? I campi di testo e data verranno eliminati e gli elenchi verranno disattivati.",
      importedFromAccountingSoftware:
        "I campi del report riportati di seguito sono importati dal tuo",
      textType: "Testo",
      dateType: "Data",
      dropdownType: "Elenco",
      formulaType: "Formula",
      ...
      initialValueInputSubtitle:
        "Inserisci un valore iniziale da mostrare nel campo del report.",
      listValuesInputSubtitle:
        "Questi valori verranno visualizzati nel menu a discesa del campo del tuo report. I valori abilitati possono essere selezionati dai membri.",
      listInputSubtitle:
        "Questi valori verranno visualizzati nell’elenco dei campi del tuo report. I valori abilitati possono essere selezionati dai membri.",
      ...
      deleteValuePrompt:
        "Sei sicuro di voler eliminare questo valore dell'elenco?",
      deleteValuesPrompt:
        "Sei sicuro di voler eliminare questi valori dell'elenco?",
      listValueRequiredError: "Inserisci il nome di un valore dell’elenco",
      existingListValueError:
        "Un valore dell’elenco con questo nome esiste già",
      editValue: "Modifica valore",
      listValues: "Elenca valori",
      addValue: "Aggiungi valore",
      existingReportFieldNameError:
        "Un campo del report con questo nome esiste già",
      ...
      circularReferenceError:
        "Questo campo non può fare riferimento a se stesso. Aggiorna per favore.",
      reportFieldInitialValueRequiredError:
        "Scegli un valore iniziale per il campo del resoconto",
      genericFailureMessage:
        "Si è verificato un errore durante l’aggiornamento del campo del report. Riprova.",
    },
    tags: {
      tagName: "Nome tag",
      ...
      findTag: "Trova tag",
      subtitle:
        "I tag aggiungono modi più dettagliati per classificare i costi.",
      ...
      emptyTags: {
        ...
        subtitle:
          "Aggiungi un tag per tenere traccia di progetti, sedi, reparti e altro ancora.",
      ...
      deleteFailureMessage:
        "Si è verificato un errore durante l’eliminazione del tag, riprova per favore",
      tagRequiredError: "Il nome del tag è obbligatorio",
      existingTagError: "Esiste già un tag con questo nome",
      invalidTagNameError:
        "Il nome del tag non può essere 0. Scegli un valore diverso.",
      genericFailureMessage:
        "Si è verificato un errore durante l’aggiornamento del tag, riprova",
      ...
      importTagsSupportingText:
        "Codifica le tue spese con un solo tipo di tag o con molti.",
      configureMultiLevelTags:
        "Configura il tuo elenco di tag per la codifica multilivello.",
      ...
      cannotMakeTagListRequired: {
        ...
        description:
          "Puoi rendere obbligatorio un elenco di tag solo se nella tua polizza sono configurati più livelli di tag.",
      },
      tagCount: () => ({
        one: "1 giorno",
    ...
    taxes: {
      subtitle:
        "Aggiungi nomi e aliquote delle imposte e imposta i valori predefiniti.",
      ...
      error: {
        ...
        valuePercentageRange:
          "Inserisci una percentuale valida compresa tra 0 e 100",
        customNameRequired: "Il nome fiscale personalizzato è obbligatorio",
        deleteFailureMessage:
          "Si è verificato un errore durante l’eliminazione dell’aliquota fiscale. Riprova oppure chiedi aiuto a Concierge.",
        updateFailureMessage:
          "Si è verificato un errore durante l’aggiornamento dell’aliquota fiscale. Riprova oppure chiedi aiuto a Concierge.",
        createFailureMessage:
          "Si è verificato un errore durante la creazione dell’aliquota fiscale. Riprova oppure chiedi aiuto a Concierge.",
        updateTaxClaimableFailureMessage:
          "La parte recuperabile deve essere inferiore all’importo della tariffa chilometrica",
      },
      deleteTaxConfirmation: "Sei sicuro di voler eliminare questa imposta?",
      deleteMultipleTaxConfirmation: (taxAmount: number) =>
        `Sei sicuro di voler eliminare ${taxAmount} imposte?`,
      actions: {
      ...
      importedFromAccountingSoftware:
        "Le imposte sottostanti sono importate dal tuo",
      taxCode: "Codice fiscale",
      updateTaxCodeFailureMessage:
        "Si è verificato un errore durante l’aggiornamento del codice fiscale, riprova.",
    },
    duplicateWorkspace: {
      ...
      error:
        "Si è verificato un errore durante la duplicazione del tuo nuovo workspace. Riprova.",
    },
    emptyWorkspace: {
      title: "Non hai nessuna area di lavoro",
      subtitle:
        "Tieni traccia delle ricevute, rimborsa le spese, gestisci i viaggi, invia le fatture e altro ancora.",
      ...
      description:
        "Le stanze sono un ottimo posto per discutere e lavorare con più persone. Per iniziare a collaborare, crea o unisciti a uno spazio di lavoro",
    },
    new: {
      ...
      myGroupWorkspace: ({ workspaceNumber }: { workspaceNumber?: number }) =>
        `Il mio spazio di lavoro di gruppo${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
      workspaceName: (userName: string, workspaceNumber?: number) =>
        `Workspace di ${userName}${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
    },
    people: {
      genericFailureMessage:
        "Si è verificato un errore durante la rimozione di un membro dallo spazio di lavoro, riprova per favore",
      ...
      removeMemberPrompt: (memberName: string) =>
        `Sei sicuro di voler rimuovere ${memberName}?`,
      ...
      error: {
        genericAdd:
          "Si è verificato un problema nell'aggiungere questo membro dello spazio di lavoro",
        cannotRemove:
          "Non puoi rimuovere te stessə o il proprietario dello spazio di lavoro",
        genericRemove:
          "Si è verificato un problema durante la rimozione di quel membro dello spazio di lavoro",
      },
      addedWithPrimary:
        "Alcuni membri sono stati aggiunti con i loro accessi principali.",
      invitedBySecondaryLogin: (secondaryLogin: string) =>
        `Aggiunto dall’accesso secondario ${secondaryLogin}.`,
      workspaceMembersCount: ({ count }: WorkspaceMembersCountParams) =>
        `Totale membri dello spazio di lavoro: ${count}`,
    ...
    card: {
      ...
      issueNewCard: {
        ...
        smartLimitDescription:
          "Spendi fino a un certo importo prima di richiedere l’approvazione",
        monthly: "Mensile",
        ...
        giveItNameInstruction:
          "Rendila abbastanza unica da poterla distinguere dalle altre carte. Casi d’uso specifici sono ancora meglio!",
        cardName: "Nome della carta",
        letsDoubleCheck: "Controlliamo che sia tutto a posto.",
        willBeReadyToUse: "Questa carta sarà pronta all’uso immediatamente.",
        willBeReadyToShip:
          "Questa carta sarà pronta per la spedizione immediatamente.",
        cardholder: "Titolare della carta",
        cardType: "Tipo di carta",
        limit: "Limite",
        limitType: "Tipo di limite",
        disabledApprovalForSmartLimitError:
          "Abilita le approvazioni in <strong>Flussi di lavoro > Aggiungi approvazioni</strong> prima di configurare i limiti intelligenti",
        singleUse: "Monouso",
        ...
        validFromTo: ({
          ...
          startDate: string;
          endDate: string;
        }) => `Valido dal ${startDate} al ${endDate}`,
        ...
        combineWithExpiration:
          "Combina con le opzioni di scadenza per un controllo aggiuntivo delle spese",
      ...
      deactivateCardModal: {
        ...
        deactivateConfirmation:
          "La disattivazione di questa carta rifiuterà tutte le transazioni future e non può essere annullata.",
      },
    },
    accounting: {
      settings: "impostazioni",
      ...
      talkYourOnboardingSpecialist:
        "Chatta con il tuo specialista di configurazione.",
      ...
      goToODToSettings:
        "Vai a Expensify Classic per gestire le tue impostazioni.",
      setup: "Connetti",
      lastSync: (relativeDate: string) =>
        `Ultima sincronizzazione ${relativeDate}`,
      ...
      connectTitle: ({ connectionName }: ConnectionNameParams) =>
        `Collega ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName] ?? "integrazione contabile"}`,
      ...
      importTypes: {
        ...
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]:
          "Importato come campi del report",
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]:
          "Impostazione predefinita dipendente NetSuite",
      },
      disconnectPrompt: ({
        connectionName,
      }: OptionalParam<ConnectionNameParams> = {}) => {
      ...
      claimOffer: {
        ...
        xero: {
          ...
          description:
            "<muted-text><centered-text>Nuovo su Xero? I clienti Expensify ricevono 6 mesi gratis. Richiedi la tua offerta qui sotto.</centered-text></muted-text>",
      ...
      autoSync: "Sincronizzazione automatica",
      autoSyncDescription:
        "Sincronizza automaticamente NetSuite ed Expensify ogni giorno. Esporta i report finalizzati in tempo reale",
      ...
      chooseReconciliationAccount: {
        chooseBankAccount:
          "Scegli il conto bancario con cui verranno riconciliati i pagamenti della tua Carta Expensify.",
    ...
    export: {
      ...
      notReadyDescription:
        "I report spesa in bozza o in sospeso non possono essere esportati nel sistema contabile. Approva o rimborsa queste spese prima di esportarle.",
    },
    invoices: {
      ...
      invoicingDetailsDescription:
        "Queste informazioni appariranno sulle tue fatture.",
      ...
      invoiceBalanceSubtitle:
        "Questo è il tuo saldo attuale derivante dall’incasso delle fatture. Verrà trasferito automaticamente sul tuo conto bancario se ne hai aggiunto uno.",
      bankAccountsSubtitle:
        "Aggiungi un conto bancario per effettuare e ricevere pagamenti di fatture.",
    },
    invite: {
      ...
      genericFailureMessage:
        "Si è verificato un errore durante l’invito del membro allo spazio di lavoro. Riprova.",
    ...
    inviteMessage: {
      confirmDetails: "Conferma i dettagli",
      inviteMessagePrompt:
        "Rendi il tuo invito ancora più speciale aggiungendo un messaggio qui sotto!",
      ...
      joinRequest: ({
        ...
        user: string;
        workspaceName: string;
      }) => `${user} ha richiesto di unirsi a ${workspaceName}`,
    },
    distanceRates: {
      oopsNotSoFast: "Ops! Non così in fretta...",
      workspaceNeeds:
        "Uno spazio di lavoro necessita di almeno una tariffa distanza abilitata.",
      distance: "Distanza",
      centrallyManage:
        "Gestisci centralmente le tariffe, monitora in miglia o chilometri e imposta una categoria predefinita.",
      rate: "Valuta",
      addRate: "Aggiungi tariffa",
    ...
    editor: {
      ...
      nameInputHelpText:
        "Questo è il nome che vedrai sul tuo spazio di lavoro.",
      ...
      currencyInputHelpText:
        "Tutte le spese in questo workspace verranno convertite in questa valuta.",
      ...
      save: "Salva",
      genericFailureMessage:
        "Si è verificato un errore durante l’aggiornamento dello spazio di lavoro. Riprova.",
      avatarUploadFailureMessage:
        "Si è verificato un errore durante il caricamento dell’avatar. Riprova.",
      addressContext:
        "Per abilitare Expensify Travel è necessario un indirizzo dell’area di lavoro. Inserisci un indirizzo associato alla tua azienda.",
      policy: "Politica di spesa",
    },
    bankAccount: {
      continueWithSetup: "Continua configurazione",
      youAreAlmostDone:
        "Hai quasi finito di configurare il tuo conto bancario, che ti permetterà di emettere carte aziendali, rimborsare spese, incassare fatture e pagare bollette.",
      streamlinePayments: "Rendi i pagamenti più efficienti",
      connectBankAccountNote:
        "Nota: i conti bancari personali non possono essere utilizzati per i pagamenti negli spazi di lavoro.",
      oneMoreThing: "Un’ultima cosa!",
      allSet: "Tutto pronto!",
      accountDescriptionWithCards:
        "Questo conto bancario verrà utilizzato per emettere carte aziendali, rimborsare le spese, riscuotere le fatture e pagare i conti.",
      ...
      clearProgress:
        "Ricominciando da capo verranno cancellati i progressi fatti finora.",
      areYouSure: "Sei sicuro?",
      workspaceCurrency: "Valuta workspace",
      updateCurrencyPrompt:
        "Sembra che al momento l’area di lavoro sia impostata su una valuta diversa da USD. Fai clic sul pulsante qui sotto per aggiornare ora la valuta a USD.",
      updateToUSD: "Aggiorna a USD",
      updateWorkspaceCurrency: "Aggiorna la valuta dello spazio di lavoro",
      workspaceCurrencyNotSupported:
        "Valuta dello spazio di lavoro non supportata",
      ...
      chooseAnExisting:
        "Scegli un conto bancario esistente per pagare le spese oppure aggiungine uno nuovo.",
    },
    changeOwner: {
      changeOwnerPageTitle: "Trasferisci proprietario",
      addPaymentCardTitle:
        "Inserisci la tua carta di pagamento per trasferire la proprietà",
      addPaymentCardButtonText:
        "Accetta i termini e aggiungi la carta di pagamento",
      ...
      amountOwedText:
        "Questo account ha un saldo in sospeso da un mese precedente.\n\nVuoi azzerare il saldo e prendere in carico la fatturazione di questo workspace?",
      ownerOwesAmountTitle: "Saldo in sospeso",
      ownerOwesAmountButtonText: "Trasferisci saldo",
      ownerOwesAmountText: (
        email: string,
        amount: string,
      ) => `L'account proprietario di questo spazio di lavoro (${email}) ha un saldo in sospeso da un mese precedente.
...
Se vuoi assumere la fatturazione per l'intero abbonamento, chiedi loro di aggiungerti prima come amministratore a tutti i loro spazi di lavoro, prima di assumere la fatturazione.`,
      ...
      failedToClearBalanceText:
        "Non è stato possibile azzerare il saldo. Riprova più tardi.",
...
Vuoi davvero esportarli di nuovo?`,
    ...
    upgrade: {
      ...
      categories: {
        title: "Categorie",
        description:
          "Le categorie ti permettono di tenere traccia e organizzare le spese. Usa le nostre categorie predefinite oppure aggiungi le tue.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
...
Richiedi dettagli sulle spese come ricevute e descrizioni, imposta limiti e valori predefiniti e automatizza approvazioni e pagamenti, tutto in un unico posto.`,
      ...
      reports: {
        title: "Report",
        description:
          "I report ti permettono di raggruppare le spese per semplificarne il monitoraggio e l’organizzazione.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      distanceRates: {
        title: "Tariffe chilometriche",
        description:
          "Crea e gestisci le tue tariffe, monitora in miglia o chilometri e imposta le categorie predefinite per le spese di distanza.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      auditor: {
        title: "Revisore",
        description:
          "I revisori ottengono accesso in sola lettura a tutti i report per garantire completa visibilità e monitoraggio della conformità.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      commonFeatures: {
        ...
        benefits: {
          ...
          benefit1:
            "Connessioni avanzate alla contabilità (NetSuite, Sage Intacct e altro)",
          ...
          selectWorkspace:
            "seleziona uno spazio di lavoro e cambia il tipo di piano in",
        },
        ...
        upgradeWorkspaceWarningForRestrictedPolicyCreationPrompt:
          "La tua azienda ha limitato la creazione degli spazi di lavoro. Contatta un amministratore per assistenza.",
      },
    },
    downgrade: {
      commonFeatures: {
        ...
        benefits: {
          ...
          confirm:
            "Sei sicuro di voler eseguire il downgrade e rimuovere le tue configurazioni?",
          warning: "Questa operazione non può essere annullata.",
          benefit1:
            "Connessioni contabilità (eccetto QuickBooks Online e Xero)",
          benefit2: "Regole spesa intelligenti",
          benefit3: "Flussi di approvazione multilivello",
          benefit4: "Controlli di sicurezza avanzati",
          headsUp: "Attenzione!",
          ...
          selectStep:
            "> seleziona ogni spazio di lavoro > cambia il tipo di piano in",
        },
      },
      completed: {
        headline: "Il tuo spazio di lavoro è stato declassato",
        description:
          "Hai altre workspace con il piano Control. Per essere fatturato alla tariffa Collect, devi eseguire il downgrade di tutte le workspace.",
        gotIt: "Ricevuto, grazie",
      },
    },
    payAndDowngrade: {
      ...
      description1: (formattedAmount: string) =>
        `L’importo finale per questo abbonamento sarà di <strong>${formattedAmount}</strong>`,
      description2: (date: string) =>
        `Vedi il tuo dettaglio qui sotto per il ${date}:`,
      subscription:
      ...
      genericFailureMessage:
        "Si è verificato un errore durante il pagamento della tua fattura. Riprova.",
    },
    restrictedAction: {
      restricted: "Limitato",
      actionsAreCurrentlyRestricted: (workspaceName: string) =>
        `Le azioni nello spazio di lavoro ${workspaceName} sono attualmente limitate`,
      ...
      youWillNeedToAddOrUpdatePaymentCard:
        "Dovrai aggiungere o aggiornare la carta di pagamento registrata per sbloccare le nuove attività dello spazio di lavoro.",
      addPaymentCardToUnlock: "Aggiungi una carta di pagamento per sbloccare!",
      addPaymentCardToContinueUsingWorkspace:
        "Aggiungi una carta di pagamento per continuare a usare questo spazio di lavoro",
      pleaseReachOutToYourWorkspaceAdmin:
        "Per qualsiasi domanda, contatta l’amministratore del tuo spazio di lavoro.",
    ...
    rules: {
      individualExpenseRules: {
        ...
        receiptRequiredAmountDescription:
          "Richiedi ricevute quando la spesa supera questo importo, a meno che non sia sostituito da una regola di categoria.",
        receiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `L’importo non può essere superiore all’importo richiesto per la ricevuta dettagliata (${amount})`,
        itemizedReceiptRequiredAmount:
          "Importo richiesto per ricevuta dettagliata",
        itemizedReceiptRequiredAmountDescription:
          "Richiedi ricevute dettagliate quando la spesa supera questo importo, a meno che non venga sostituito da una regola di categoria.",
        itemizedReceiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `L’importo non può essere inferiore all’importo richiesto per le ricevute normali (${amount})`,
        maxExpenseAmount: "Importo massimo spesa",
        maxExpenseAmountDescription:
          "Contrassegna le spese che superano questo importo, a meno che non siano sostituite da una regola di categoria.",
        maxAge: "Età massima",
        maxExpenseAge: "Età massima della spesa",
        maxExpenseAgeDescription:
          "Segnala le spese più vecchie di un numero specifico di giorni.",
        maxExpenseAgeDays: () => ({
          one: "1 giorno",
        ...
        nonBillableDescription:
          "Le spese vengono occasionalmente riaddebitate ai clienti",
        ...
        attendeeTrackingHint:
          "Tieni traccia del costo per persona per ogni spesa.",
        ...
        requireCompanyCard:
          "Richiedi le carte aziendali per tutti gli acquisti",
        requireCompanyCardDescription:
          "Contrassegna tutte le spese in contanti, inclusi chilometraggio e indennità giornaliere.",
        requireCompanyCardDisabledTooltip:
          "Abilita Carte aziendali (in Altre funzionalità) per sbloccare.",
      },
      expenseReportRules: {
        title: "Avanzate",
        subtitle:
          "Automatizza la conformità, le approvazioni e il pagamento dei report spese.",
        preventSelfApprovalsTitle: "Impedisci auto-approvazioni",
        preventSelfApprovalsSubtitle:
          "Impedisci ai membri dello spazio di lavoro di approvare i propri report spese.",
        autoApproveCompliantReportsTitle:
          "Approva automaticamente i report conformi",
        autoApproveCompliantReportsSubtitle:
          "Configura quali note spese sono idonee per l’approvazione automatica.",
        autoApproveReportsUnderTitle:
          "Approva automaticamente i report con tutte le spese inferiori a",
        autoApproveReportsUnderDescription:
          "Le note spese completamente conformi in cui tutte le spese sono inferiori a questo importo verranno approvate automaticamente.",
        randomReportAuditTitle: "Revisione casuale dei report",
        randomReportAuditDescription:
          "Richiedi che alcuni report siano approvati manualmente, anche se idonei per l’approvazione automatica.",
        autoPayApprovedReportsTitle:
          "Pagare automaticamente i resoconti approvati",
        autoPayApprovedReportsSubtitle:
          "Configura quali note spese sono idonee per il pagamento automatico.",
        autoPayApprovedReportsLimitError: (currency?: string) =>
          `Inserisci un importo inferiore a ${currency ?? ""}20.000`,
        autoPayApprovedReportsLockedSubtitle:
          "Vai su Altre funzionalità e abilita i flussi di lavoro, poi aggiungi i pagamenti per sbloccare questa funzione.",
        autoPayReportsUnderTitle: "Paga automaticamente i report sotto",
        autoPayReportsUnderDescription:
          "Le note spese pienamente conformi inferiori a questo importo verranno rimborsate automaticamente.",
        unlockFeatureEnableWorkflowsSubtitle: (featureName: string) =>
          `Aggiungi ${featureName} per sbloccare questa funzione.`,
      ...
      merchantRules: {
        title: "Esercente",
        subtitle:
          "Imposta le regole per l’esercente in modo che le spese arrivino già codificate correttamente e richiedano meno correzioni.",
        addRule: "Aggiungi regola esercente",
        addRuleTitle: "Aggiungi regola",
        editRuleTitle: "Modifica regola",
        expensesWith: "Per le spese con:",
        expensesExactlyMatching:
          "Per le spese che corrispondono esattamente a:",
        ...
        previewMatchesEmptyStateSubtitle:
          "Nessuna spesa non inviata corrisponde a questa regola.",
        ...
        ruleSummaryTitle: (merchantName: string, isExactMatch: boolean) =>
          `Se l’esercente ${isExactMatch ? "corrisponde esattamente" : "contiene"} «${merchantName}»`,
        ruleSummarySubtitleMerchant: (merchantName: string) =>
          `Rinomina esercente in "${merchantName}"`,
        ruleSummarySubtitleUpdateField: (
          fieldName: string,
          fieldValue: string,
        ) => `Aggiorna ${fieldName} in "${fieldValue}"`,
        ruleSummarySubtitleReimbursable: (reimbursable: boolean) =>
          `Contrassegna come "${reimbursable ? "rimborsabile" : "non rimborsabile"}"`,
        ruleSummarySubtitleBillable: (billable: boolean) =>
          `Contrassegna come "${billable ? "fatturabile" : "non fatturabile"}"`,
        ...
        duplicateRulePrompt: (merchantName: string) =>
          `La regola esistente per "${merchantName}" avrà la priorità su questa. Salvare comunque?`,
        saveAnyway: "Salva comunque",
        applyToExistingUnsubmittedExpenses:
          "Applica alle spese esistenti non inviate",
      },
      categoryRules: {
        ...
        requiredFieldsDescription: (categoryName: string) =>
          `Questo verrà applicato a tutte le spese categorizzate come <strong>${categoryName}</strong>.`,
        ...
        flagAmountsOverDescription: (categoryName: string) =>
          `Si applica alla categoria “${categoryName}”.`,
        flagAmountsOverSubtitle:
          "Questo sostituisce l’importo massimo per tutte le spese.",
        expenseLimitTypes: {
          ...
          dailySubtitle:
            "Contrassegna la spesa giornaliera totale per categoria per ogni report spese.",
        },
        requireReceiptsOver: "Richiedi ricevute superiori a",
        requireReceiptsOverList: {
          default: (defaultAmount: string) =>
            `${defaultAmount} ${CONST.DOT_SEPARATOR} Predefinito`,
      ...
      customRules: {
        ...
        cardSubtitle:
          "Qui trovi il regolamento spese del tuo team, così tutti sono allineati su cosa è coperto.",
      },
    },
    planTypePage: {
      planTypes: {
        team: {
          label: "Riscuoti",
          description:
            "Per i team che desiderano automatizzare i propri processi.",
        },
        corporate: {
          label: "Controllo",
      ...
      description:
        "Scegli il piano più adatto a te. Per un elenco dettagliato di funzionalità e prezzi, consulta la nostra",
  ...
  newRoomPage: {
    ...
    restrictedDescription:
      "Le persone nel tuo spazio di lavoro possono trovare questa stanza",
    ...
    roomNameReservedError: (reservedName: string) =>
      `${reservedName} è una stanza predefinita in tutti gli spazi di lavoro. Scegli un altro nome.`,
    roomNameInvalidError:
      "I nomi delle stanze possono includere solo lettere minuscole, numeri e trattini",
    ...
    renamedRoomAction: (
      ...
      return isExpenseReport
        ? `${actor}rinominato in "${newName}" (in precedenza "${oldName}")`
        : `${actor} ha rinominato questa stanza in «${newName}» (in precedenza «${oldName}»)`;
    },
    ...
    growlMessageOnRenameError:
      "Impossibile rinominare la stanza dello spazio di lavoro. Controlla la connessione e riprova.",
    visibilityOptions: {
  ...
  workspaceActions: {
    ...
    changedCompanyAddress: ({
      ...
      previousAddress
        ? `ha modificato l’indirizzo dell’azienda in "${newAddress}" (precedentemente "${previousAddress}")`
        : `imposta l’indirizzo dell’azienda su "${newAddress}"`,
    addApprovalRule: (
    ...
    addCategory: (categoryName: string) =>
      `ha aggiunto la categoria "${categoryName}"`,
    deleteCategory: (categoryName: string) =>
      `ha rimosso la categoria "${categoryName}"`,
    updateCategory: (categoryName: string, oldValue: boolean) =>
      `${oldValue ? "disattivato" : "abilitato"} la categoria "${categoryName}"`,
    ...
    setCategoryName: (oldName: string, newName: string) =>
      `ha rinominato la categoria "${oldName}" in "${newName}"`,
    ...
    updateTagListName: (oldName: string, newName: string) =>
      `ha modificato il nome dell’elenco di tag in "${newName}" (in precedenza "${oldName}")`,
    addTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `ha aggiunto l’etichetta "${tagName}" all’elenco "${tagListName}"`,
    updateTagName: ({
      tagListName,
      newName,
      oldName,
    }: UpdatedPolicyTagNameParams) =>
      `ha aggiornato l'elenco dei tag "${tagListName}" cambiando il tag "${oldName}" in "${newName}"`,
    updateTagEnabled: ({
      tagListName,
      tagName,
      enabled,
    }: UpdatedPolicyTagParams) =>
      `${enabled ? "abilitato" : "disabilitato"} il tag "${tagName}" nella lista "${tagListName}"`,
    deleteTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `ha rimosso il tag "${tagName}" dall'elenco "${tagListName}"`,
    deleteMultipleTags: ({ count, tagListName }: UpdatedPolicyTagParams) =>
      `rimosse le etichette "${count}" dall’elenco "${tagListName}"`,
    updateTag: ({
      tagListName,
      newValue,
      tagName,
    ...
    updateCustomUnitTaxEnabled: ({
      ...
      `${newValue ? "abilitato" : "disabilitato"} monitoraggio delle tasse sulle tariffe chilometriche`,
    addCustomUnitRate: (customUnitName: string, rateName: string) =>
      `ha aggiunto una nuova tariffa ${customUnitName} "${rateName}"`,
    ...
    deleteCustomUnitRate: ({
      ...
      `ha rimosso la tariffa "${rateName}" per l'unità personalizzata "${customUnitName}"`,
    addedReportField: ({
      fieldType,
      fieldName,
    }: AddedOrDeletedPolicyReportFieldParams) =>
      `aggiunto il campo di report ${fieldType} "${fieldName}"`,
    ...
    addedReportFieldOption: (fieldName: string, optionName: string) =>
      `ha aggiunto l’opzione «${optionName}» al campo del rendiconto «${fieldName}»`,
    removedReportFieldOption: (fieldName: string, optionName: string) =>
      `ha rimosso l’opzione «${optionName}» dal campo del report «${fieldName}»`,
    ...
    deleteReportField: ({
      ...
      fieldType: string;
      fieldName?: string;
    }) => `ha rimosso il campo del report ${fieldType} "${fieldName}"`,
    preventSelfApproval: ({
      oldValue,
      newValue,
    }: UpdatedPolicyPreventSelfApprovalParams) =>
    ...
    updateDefaultTitleEnforced: (value: boolean) =>
      `ha attivato "Applica i titoli predefiniti dei report" ${value ? "attivo" : "disattivato"}`,
    ...
    renamedWorkspaceNameAction: (oldName: string, newName: string) =>
      `ha aggiornato il nome di questo spazio di lavoro in "${newName}" (in precedenza "${oldName}")`,
    ...
    updatedWorkspaceCurrencyAction: (
      ...
      `ha aggiornato la valuta predefinita in ${newCurrency} (precedentemente ${oldCurrency})`,
    ...
    updateApprovalMode: ({ newValue, oldValue }: ChangeFieldParams) =>
      `ha aggiornato la modalità di approvazione in "${newValue}" (in precedenza "${oldValue}")`,
    ...
    downgradedWorkspace:
      "ha effettuato il downgrade di questo spazio di lavoro al piano Collect",
    ...
    updatedAttendeeTracking: ({ enabled }: { enabled: boolean }) =>
      `tracciamento partecipanti ${enabled ? "abilitato" : "disattivato"}`,
    updatedAutoPayApprovedReports: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "abilitato" : "disattivato"} report approvati per il pagamento automatico`,
    setAutoPayApprovedReportsLimit: ({ newLimit }: { newLimit: string }) =>
      `imposta la soglia per l'approvazione automatica dei rapporti a "${newLimit}"`,
    ...
    removedAutoPayApprovedReportsLimit:
      "ha rimosso la soglia per l’approvazione automatica dei report di pagamento",
    changedDefaultApprover: ({
      ...
      previousApprover
        ? `ha modificato l'approvatore predefinito in ${newApprover} (in precedenza ${previousApprover})`
    ...
    changedInvoiceCompanyName: ({
      ...
      oldValue
        ? `ha modificato il nome della società in fattura in "${newValue}" (precedentemente "${oldValue}")`
        : `imposta il nome dell’azienda in fattura su «${newValue}»`,
    ...
    updateReimbursementEnabled: ({
      ...
      `Rimborsi ${enabled ? "abilitato" : "disattivato"}`,
    updateCustomTaxName: ({
      oldName,
      newName,
    }: UpdatedPolicyCustomTaxNameParams) =>
      `ha cambiato il nome dell'imposta personalizzata in "${newName}" (precedentemente "${oldName}")`,
    ...
    addTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `ha aggiunto l’imposta “${taxName}”`,
    deleteTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `ha rimosso l'imposta "${taxName}"`,
    updateTax: ({
      oldValue,
      taxName,
      updatedField,
    ...
    setReceiptRequiredAmount: (newValue: string) =>
      `imposta l’importo richiesto per la ricevuta su "${newValue}"`,
    ...
    removedReceiptRequiredAmount: (oldValue: string) =>
      `ha rimosso l’importo richiesto per la ricevuta (in precedenza «${oldValue}»)`,
    setMaxExpenseAmount: (newValue: string) =>
      `imposta l’importo massimo della spesa su "${newValue}"`,
    ...
    removedMaxExpenseAmount: (oldValue: string) =>
      `importo massimo spesa rimosso (precedentemente "${oldValue}")`,
    setMaxExpenseAge: (newValue: string) =>
      `imposta età massima della spesa a "${newValue}" giorni`,
    changedMaxExpenseAge: (oldValue: string, newValue: string) =>
      `età massima della spesa cambiata a "${newValue}" giorni (in precedenza "${oldValue}")`,
    removedMaxExpenseAge: (oldValue: string) =>
      `età massima spesa rimossa (precedentemente "${oldValue}" giorni)`,
    updateCategories: ({ count }: UpdatedPolicyCategoriesParams) =>
      `categorie aggiornate: ${count}`,
    updateTagList: ({ tagListName }: UpdatedPolicyTagListParams) =>
      `tag aggiornati nell’elenco "${tagListName}"`,
    ...
    importCustomUnitRates: ({
      ...
      `tariffe importate per l'unità personalizzata "${customUnitName}"`,
    ...
    addBudget: ({
      ...
      const thresholdSuffix =
        typeof notificationThreshold === "number"
          ? `con soglia di notifica pari al "${notificationThreshold}%"`
          : "";
    ...
    updateBudget: ({
      ...
      if (frequencyChanged) {
        changesList.push(
          `ha modificato la frequenza del budget in "${newFrequency}" (precedentemente "${oldFrequency}")`,
        );
      }
      if (sharedChanged) {
        changesList.push(
          `ha modificato il budget totale dello spazio di lavoro a "${newShared}" (in precedenza "${oldShared}")`,
        );
      }
      if (individualChanged) {
        changesList.push(
          `ha modificato il budget individuale in "${newIndividual}" (in precedenza "${oldIndividual}")`,
        );
      }
      if (thresholdChanged) {
        changesList.push(
          `ha modificato la soglia di notifica a "${newNotificationThreshold}%" (in precedenza "${oldNotificationThreshold}%")`,
        );
      }
      if (
        !frequencyChanged &&
    ...
    }) => `ha aggiunto "${prohibitedExpense}" alle spese vietate`,
    removedProhibitedExpense: ({
      prohibitedExpense,
    }: {
      prohibitedExpense: string;
    }) => `ha rimosso "${prohibitedExpense}" dalle spese vietate`,
    ...
    setAutoJoin: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "abilitato" : "disabilitato"} pre-approvazione delle richieste di adesione allo spazio di lavoro`,
    updatedDefaultTitle: ({
      newDefaultTitle,
      oldDefaultTitle,
    }: UpdatedPolicyDefaultTitleParams) =>
    ...
    updatedOwnership: ({
      ...
      `ha assunto la proprietà di ${policyName} da ${oldOwnerName} (${oldOwnerEmail})`,
    updatedAutoHarvesting: ({ enabled }: UpdatedPolicyAutoHarvestingParams) =>
      `Invio pianificato ${enabled ? "abilitato" : "disabilitato"}`,
  ...
  roomMembersPage: {
    ...
    useInviteButton:
      "Per invitare un nuovo membro alla chat, usa il pulsante di invito qui sopra.",
    ...
    error: {
      genericAdd:
        "Si è verificato un problema nell'aggiunta di questo membro della stanza",
    },
  },
  newTaskPage: {
    assignTask: "Assegna attività",
    ...
    confirmError:
      "Inserisci un titolo e seleziona una destinazione di condivisione",
    descriptionOptional: "Descrizione (facoltativa)",
    pleaseEnterTaskName: "Inserisci un titolo",
    pleaseEnterTaskDestination:
      "Seleziona dove vuoi condividere questa attività",
  },
  task: {
    task: "Attività",
    title: "Titolo",
    ...
    assigneeError:
      "Si è verificato un errore durante l’assegnazione di questa attività. Prova con un altro assegnatario.",
    genericCreateTaskFailureMessage:
      "Si è verificato un errore durante la creazione di questa attività. Riprova più tardi.",
    deleteTask: "Elimina attività",
    deleteConfirmation: "Sei sicuro di voler eliminare questa attività?",
  },
  statementPage: {
    title: (year: number | string, monthName: string) =>
      `Estratto conto di ${monthName} ${year}`,
  },
  ...
  guides: {
    ...
    screenShareRequest:
      "Expensify ti sta invitando a una condivisione dello schermo",
  },
  search: {
    ...
    searchResults: {
      ...
      emptyExpenseResults: {
        ...
        subtitle:
          "Crea una spesa o prova una demo di Expensify per saperne di più.",
        subtitleWithOnlyCreateButton:
          "Usa il pulsante verde qui sotto per creare una spesa.",
      },
      emptyReportResults: {
        title: "Non hai ancora creato alcun rapporto",
        subtitle:
          "Crea un report o fai un giro di prova con Expensify per saperne di più.",
        subtitleWithOnlyCreateButton:
          "Usa il pulsante verde qui sotto per creare un report.",
      },
      emptyInvoiceResults: {
        title: dedent(`
                ...
                `),
        subtitle:
          "Invia una fattura o fai un giro di prova con Expensify per saperne di più.",
        subtitleWithOnlyCreateButton:
          "Usa il pulsante verde qui sotto per inviare una fattura.",
      },
      emptyTripResults: {
    ...
    bulkActions: {
      ...
      reject: "Rifiuta",
      noOptionsAvailable:
        "Nessuna opzione disponibile per il gruppo di spese selezionato.",
    },
    ...
    filters: {
      ...
      card: {
        ...
        cardFeedNameCSV: ({ cardFeedLabel }: { cardFeedLabel?: string }) =>
          `Tutte le carte CSV importate${cardFeedLabel ? ` - ${cardFeedLabel}` : ""}`,
      },
    ...
    exportSearchResults: {
      ...
      description:
        "Wow, sono davvero tanti elementi! Li raggrupperemo e Concierge ti invierà un file a breve.",
    },
  ...
  fileDownload: {
    ...
    permissionError: {
      ...
      message:
        "Expensify non può salvare gli allegati senza l’accesso all’archiviazione. Tocca Impostazioni per aggiornare le autorizzazioni.",
    },
  },
  settlement: {
    status: {
    ...
    failedError: ({ link }: { link: string }) =>
      `Riproveremo a effettuare questa liquidazione quando <a href="${link}">sblocchi il tuo conto</a>.`,
    withdrawalInfo: ({
      date,
      withdrawalID,
    }: {
  ...
  reportLayout: {
    ...
    selectGroup: ({ groupName }: { groupName: string }) =>
      `Seleziona tutte le spese in ${groupName}`,
    groupBy: {
      category: "Categoria",
      tag: "Etichetta",
    },
  ...
  report: {
    ...
    genericCreateReportFailureMessage:
      "Errore imprevisto durante la creazione di questa chat. Riprova più tardi.",
    genericAddCommentFailureMessage:
      "Errore imprevisto durante la pubblicazione del commento. Riprova più tardi.",
    genericUpdateReportFieldFailureMessage:
      "Errore imprevisto durante l'aggiornamento del campo. Riprova più tardi.",
    genericUpdateReportNameEditFailureMessage:
      "Errore imprevisto durante la rinomina del report. Riprova più tardi.",
    ...
    actions: {
      type: {
        changeField: ({ oldValue, newValue, fieldName }: ChangeFieldParams) =>
          `ha modificato ${fieldName} in "${newValue}" (in precedenza "${oldValue}")`,
        changeFieldEmpty: ({ newValue, fieldName }: ChangeFieldParams) =>
          `imposta ${fieldName} su "${newValue}"`,
        ...
        changeType: (oldType: string, newType: string) =>
          `ha modificato il tipo da ${oldType} a ${newType}`,
        ...
        exportedToIntegration: {
          ...
          automaticActionOne: (label: string) =>
            `esportato su ${label} tramite`,
          automaticActionTwo: "impostazioni di contabilità",
          manual: (label: string) =>
            `ha contrassegnato questo resoconto come esportato manualmente in ${label}.`,
          ...
          pending: (label: string) =>
            `ha iniziato a esportare questo resoconto su ${label}...`,
        },
        integrationsMessage: (
          errorMessage: string,
          label: string,
        ...
        markedReimbursed: (amount: string, currency: string) =>
          `pagato ${currency}${amount} altrove`,
        markedReimbursedFromIntegration: ({
          amount,
          currency,
        }: MarkReimbursedFromIntegrationParams) =>
          `pagato ${currency}${amount} tramite integrazione`,
        ...
        addEmployee: (email: string, role: string) =>
          `aggiunto ${email} come ${role === "member" ? "a" : "un"} ${role}`,
        updateRole: ({ email, currentRole, newRole }: UpdateRoleParams) =>
          `ha aggiornato il ruolo di ${email} a ${newRole} (in precedenza ${currentRole})`,
        updatedCustomField1: (
          email: string,
          newValue: string,
        ...
        leftWorkspace: (nameOrEmail: string) =>
          `${nameOrEmail} ha lasciato lo spazio di lavoro`,
        removeMember: (email: string, role: string) =>
          `ha rimosso ${role} ${email}`,
        removedConnection: ({ connectionName }: ConnectionNameParams) =>
          `rimossa connessione a ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        addedConnection: ({ connectionName }: ConnectionNameParams) =>
          `collegato a ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        ...
        leftTheChatWithName: (nameOrEmail: string) =>
          `${nameOrEmail ? `${nameOrEmail}: ` : ""} ha lasciato la chat`,
      ...
      error: {
        invalidCredentials:
          "Credenziali non valide, controlla la configurazione della tua connessione.",
      },
    },
  },
  chronos: {
    oooEventSummaryFullDay: (summary: string, dayCount: number, date: string) =>
      `${summary} per ${dayCount} ${dayCount === 1 ? "giorno" : "giorni"} fino al ${date}`,
    oooEventSummaryPartialDay: (
      summary: string,
      timePeriod: string,
      date: string,
    ) => `${summary} dal ${timePeriod} del ${date}`,
  },
  footer: {
  ...
  threads: {
    ...
    parentNavigationSummary: ({
      ...
      `Da ${reportName}${workspaceName ? `in ${workspaceName}` : ""}`,
  },
  qrCodes: {
    qrCode: "Codice QR",
    copy: "Copia URL",
  ...
  moderation: {
    flagDescription:
      "Tutti i messaggi contrassegnati verranno inviati a un moderatore per la revisione.",
    ...
    inconsiderateDescription:
      "Frasi offensive o irrispettose, con intenzioni discutibili",
    intimidation: "Intimidazione",
    intimidationDescription:
      "Portare avanti un programma in modo aggressivo nonostante obiezioni fondate",
    bullying: "Bullismo",
    bullyingDescription:
      "Prendere di mira un individuo per ottenere obbedienza",
    harassment: "Molestia",
    harassmentDescription:
      "Comportamento razzista, misogino o comunque ampiamente discriminatorio",
    assault: "Aggressione",
    assaultDescription:
      "Attacco emotivo mirato specificamente con l’intenzione di causare danno",
    flaggedContent:
      "Questo messaggio è stato segnalato per violazione delle nostre regole della community e il contenuto è stato nascosto.",
    hideMessage: "Nascondi messaggio",
    revealMessage: "Mostra messaggio",
    levelOneResult:
      "Invia un avviso anonimo e il messaggio viene segnalato per revisione.",
    levelTwoResult:
      "Messaggio nascosto dal canale, con avviso anonimo e segnalazione del messaggio per revisione.",
    levelThreeResult:
      "Messaggio rimosso dal canale, avviso anonimo inviato e messaggio segnalato per revisione.",
  },
  ...
  teachersUnitePage: {
    ...
    getInTouch:
      "Eccellente! Condividi le loro informazioni così possiamo metterci in contatto con loro.",
    ...
    error: {
      enterPhoneEmail:
        "Inserisci un indirizzo email o un numero di telefono validi",
  ...
  distance: {
    ...
    mapPending: {
      ...
      errorSubtitle:
        "Si è verificato un errore durante il caricamento della mappa. Riprova.",
    },
    error: {
      selectSuggestedAddress:
        "Seleziona un indirizzo suggerito o usa la posizione attuale",
    },
    odometer: {
      ...
      startMessageWeb:
        "Aggiungi una foto del contachilometri all’<strong>inizio</strong> del tuo viaggio. Trascina qui un file oppure scegli un file da caricare.",
      endMessageWeb:
        "Aggiungi una foto del contachilometri scattata alla <strong>fine</strong> del viaggio. Trascina qui un file oppure scegli un file da caricare.",
      ...
      deleteOdometerPhotoConfirmation:
        "Sei sicuro di voler eliminare questa foto del contachilometri?",
      cameraAccessRequired:
        "Per scattare foto è necessario l’accesso alla fotocamera.",
      snapPhotoStart:
        "<muted-text-label>Scatta una foto del contachilometri all'<strong>inizio</strong> del viaggio.</muted-text-label>",
      snapPhotoEnd:
        "<muted-text-label>Scatta una foto del contachilometri alla <strong>fine</strong> del viaggio.</muted-text-label>",
    },
  },
  gps: {
    error: {
      ...
      failedToGetPermissions:
        "Impossibile ottenere le autorizzazioni di posizione richieste.",
    },
    ...
    discardDistanceTrackingModal: {
      ...
      prompt:
        "Sei sicuro? Questo eliminerà il tuo percorso attuale e non potrà essere annullato.",
      confirm: "Annulla rilevamento distanza",
    },
    zeroDistanceTripModal: {
      title: "Impossibile creare la spesa",
      prompt:
        "Non puoi creare una spesa con la stessa località di partenza e di arrivo.",
    },
    locationRequiredModal: {
      title: "Accesso alla posizione richiesto",
      prompt:
        "Consenti l’accesso alla posizione nelle impostazioni del dispositivo per iniziare il tracciamento della distanza GPS.",
      allow: "Consenti",
    },
    androidBackgroundLocationRequiredModal: {
      title: "Accesso alla posizione in background richiesto",
      prompt:
        "Consenti l’accesso alla posizione in background nelle impostazioni del tuo dispositivo (opzione “Consenti sempre”) per avviare il tracciamento della distanza tramite GPS.",
    },
    preciseLocationRequiredModal: {
      title: "Posizione precisa richiesta",
      prompt:
        'Abilita "posizione precisa" nelle impostazioni del dispositivo per avviare il tracciamento della distanza tramite GPS.',
    },
    desktop: {
      title: "Tieni traccia della distanza sul tuo telefono",
      subtitle:
        "Registra automaticamente miglia o chilometri con il GPS e trasforma subito i viaggi in spese.",
    ...
    continueGpsTripModal: {
      ...
      prompt:
        "Sembra che l’app si sia chiusa durante il tuo ultimo viaggio GPS. Vuoi continuare la registrazione da quel viaggio?",
    ...
    switchToODWarningTripInProgress: {
      title: "Monitoraggio GPS in corso",
      prompt:
        "Sei sicuro di voler interrompere il tracciamento GPS e passare a Expensify Classic?",
  ...
  reportCardLostOrDamaged: {
    ...
    cardDamagedInfo:
      "La tua nuova carta arriverà tra 2-3 giorni lavorativi. La tua carta attuale continuerà a funzionare finché non attivi quella nuova.",
    ...
    successDescription:
      "Dovrai attivarla quando arriverà tra pochi giorni lavorativi. Nel frattempo, puoi usare una carta virtuale.",
  },
  eReceipt: {
  ...
  referralProgram: {
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
      buttonText:
        "Avvia una chat, <success><strong>presenta un amico</strong></success>.",
    ...
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
      buttonText:
        "Invia una nota spese, <success><strong>presenta il tuo team</strong></success>.",
  ...
  violations: {
    ...
    cashExpenseWithNoReceipt: ({
      ...
      `Ricevuta obbligatoria${formattedLimit ? `oltre ${formattedLimit}` : ""}`,
    categoryOutOfPolicy: "Categoria non più valida",
    conversionSurcharge: ({ surcharge }: ViolationsConversionSurchargeParams) =>
      `Applicato un sovrapprezzo di conversione del ${surcharge}%`,
    ...
    invoiceMarkup: ({ invoiceMarkup }: ViolationsInvoiceMarkupParams) =>
      `Maggiorato del ${invoiceMarkup}%`,
    maxAge: ({ maxAge }: ViolationsMaxAgeParams) =>
      `Data precedente a ${maxAge} giorni`,
    ...
    overAutoApprovalLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `La spesa supera il limite di approvazione automatica di ${formattedLimit}`,
    overCategoryLimit: ({
      formattedLimit,
    }: ViolationsOverCategoryLimitParams) =>
      `Importo superiore al limite di categoria di ${formattedLimit}/persona`,
    overLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Importo oltre il limite di ${formattedLimit}/persona`,
    overTripLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Importo oltre il limite di ${formattedLimit}/viaggio`,
    overLimitAttendee: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Importo oltre il limite di ${formattedLimit}/persona`,
    perDayLimit: ({ formattedLimit }: ViolationsPerDayLimitParams) =>
      `Importo oltre il limite giornaliero di categoria di ${formattedLimit}/persona`,
    receiptNotSmartScanned:
      "Dettagli di ricevuta e spesa aggiunti manualmente.",
    receiptRequired: ({
      formattedLimit,
      category,
    }: ViolationsReceiptRequiredParams) => {
    ...
    itemizedReceiptRequired: ({
      ...
      `Ricevuta dettagliata richiesta${formattedLimit ? `oltre ${formattedLimit}` : ""}`,
    prohibitedExpense: ({
    ...
    rter: ({
      ...
      if (!isTransactionOlderThan7Days) {
        return isAdmin
          ? `Chiedi a ${member} di contrassegnarla come contante oppure attendi 7 giorni e riprova`
          : "In attesa di abbinamento con la transazione della carta.";
      }
      return "";
    },
    brokenConnection530Error:
      "Ricevuta in sospeso a causa di connessione bancaria interrotta",
    ...
    memberBrokenConnectionError:
      "Ricevuta in sospeso a causa di un collegamento bancario interrotto. Chiedi a un amministratore dello spazio di lavoro di risolvere il problema.",
    markAsCashToIgnore:
      "Segna come contante da ignorare e richiedi il pagamento.",
    smartscanFailed: ({ canEdit = true }) =>
      `Scansione della ricevuta non riuscita.${canEdit ? "Inserisci i dettagli manualmente." : ""}`,
  ...
  reportViolations: {
    ...
    reportContainsExpensesWithViolations:
      "Il report contiene spese con violazioni.",
  },
  violationDismissal: {
    rter: {
  ...
  exitSurvey: {
    ...
    reasonPage: {
      ...
      subtitle:
        "Prima di continuare, dicci perché desideri passare a Expensify Classic.",
    },
    reasons: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "Ho bisogno di una funzione disponibile solo in Expensify Classic.",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "Non capisco come usare il nuovo Expensify.",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Capisco come usare il nuovo Expensify, ma preferisco Expensify classico.",
    },
    prompts: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "Quale funzionalità ti serve che non è disponibile nella nuova Expensify?",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "Cosa stai cercando di fare?",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Perché preferisci Expensify Classic?",
    },
    responsePlaceholder: "La tua risposta",
    thankYou: "Grazie per il feedback!",
    thankYouSubtitle:
      "Le tue risposte ci aiuteranno a creare un prodotto migliore per portare a termine le attività. Grazie mille!",
    goToExpensifyClassic: "Passa a Expensify Classic",
    ...
    quickTipSubTitle:
      "Puoi accedere direttamente a Expensify Classic visitando expensify.com. Aggiungilo ai preferiti per un accesso rapido!",
    ...
    benefits: {
      [CONST.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY]:
        "Chatta direttamente su spese e report",
      [CONST.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE]:
        "Possibilità di fare tutto da mobile",
      [CONST.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE]:
        "Viaggi e spese alla velocità della chat",
    },
  ...
  listBoundary: {
    errorMessage:
      "Si è verificato un errore durante il caricamento di altri messaggi",
    tryAgain: "Riprova",
  },
  systemMessage: {
  ...
  subscription: {
    ...
    mobileReducedFunctionalityMessage:
      "Non puoi apportare modifiche al tuo abbonamento nell’app mobile.",
    badge: {
      freeTrial: (numOfDays: number) =>
        `Prova gratuita: ${numOfDays} ${numOfDays === 1 ? "giorno" : "giorni"} rimanenti`,
    },
    billingBanner: {
      policyOwnerAmountOwed: {
        title: "Le tue informazioni di pagamento non sono aggiornate",
        subtitle: (date: string) =>
          `Aggiorna la tua carta di pagamento entro il ${date} per continuare a utilizzare tutte le tue funzioni preferite.`,
      },
      ...
      policyOwnerUnderInvoicing: {
        title: "Le tue informazioni di pagamento non sono aggiornate",
        subtitle: (date: string) =>
          `Il tuo pagamento è scaduto. Paga la tua fattura entro il ${date} per evitare l’interruzione del servizio.`,
      },
      policyOwnerUnderInvoicingOverdue: {
        title: "Le tue informazioni di pagamento non sono aggiornate",
        subtitle:
          "Il tuo pagamento è scaduto. Ti preghiamo di pagare la tua fattura.",
      },
      ...
      cardAuthenticationRequired: {
        title:
          "La tua carta di pagamento non è stata completamente autenticata.",
        subtitle: (cardEnding: string) =>
          `Completa la procedura di autenticazione per attivare la tua carta di pagamento che termina con ${cardEnding}.`,
      },
      insufficientFunds: {
        title: "Non è stato possibile addebitare la tua carta",
      ...
      preTrial: {
        ...
        subtitle:
          'Come prossimo passo, <a href="#">completa la tua checklist di configurazione</a> così il tuo team può iniziare a registrare le spese.',
      },
      trialStarted: {
        title: (numOfDays: number) =>
          `Prova: ${numOfDays} ${numOfDays === 1 ? "giorno" : "giorni"} rimanenti!`,
        subtitle:
          "Aggiungi una carta di pagamento per continuare a usare tutte le tue funzionalità preferite.",
      },
      trialEnded: {
      ...
      earlyDiscount: {
        ...
        onboardingChatTitle: (discountType: number) =>
          `Offerta a tempo limitato: ${discountType}% di sconto sul primo anno!`,
        subtitle: (
          days: number,
          hours: number,
          minutes: number,
          ...
          `Richiedi entro ${days > 0 ? `${days}g :` : ""}${hours}h : ${minutes}m : ${seconds}s`,
      },
    },
    cardSection: {
      title: "Pagamento",
      ...
      cardInfo: (name: string, expiration: string, currency: string) =>
        `Nome: ${name}, Scadenza: ${expiration}, Valuta: ${currency}`,
      cardNextPayment: (nextPaymentDate: string) =>
        `La tua prossima data di pagamento è ${nextPaymentDate}.`,
    ...
    yourPlan: {
      ...
      asLowAs: ({ price }: YourPlanPriceValueParams) =>
        `a partire da ${price} per membro attivo/mese`,
      pricePerMemberMonth: ({ price }: YourPlanPriceValueParams) =>
        `${price} per membro/mese`,
      pricePerMemberPerMonth: ({ price }: YourPlanPriceValueParams) =>
        `${price} per membro al mese`,
      perMemberMonth: "per membro/mese",
      collect: {
        title: "Riscuoti",
        description:
          "Il piano per piccole imprese che ti offre note spese, viaggi e chat.",
        priceAnnual: ({ lower, upper }: YourPlanPriceParams) =>
          `Da ${lower} membro/attivo con la Carta Expensify, ${upper} membro/attivo senza la Carta Expensify.`,
      ...
      saveWithExpensifyDescription:
        "Usa il nostro calcolatore di risparmio per vedere come il cash back della Carta Expensify può ridurre la tua fattura Expensify.",
    ...
    details: {
      ...
      zeroCommitment:
        "Nessun vincolo con il prezzo scontato dell’abbonamento annuale",
    },
    subscriptionSize: {
      title: "Dimensione abbonamento",
      yourSize:
        "La dimensione del tuo abbonamento è il numero di posti disponibili che possono essere occupati da qualsiasi membro attivo in un dato mese.",
      eachMonth:
      ...
      youCantDowngrade:
        "Non puoi effettuare il downgrade durante l’abbonamento annuale.",
      ...
      error: {
        ...
        sameSize:
          "Inserisci un numero diverso dalla dimensione attuale del tuo abbonamento",
      },
    },
    paymentCard: {
      addPaymentCard: "Aggiungi carta di pagamento",
      ...
      security:
        "Expensify è conforme allo standard PCI-DSS, utilizza la crittografia a livello bancario e si avvale di un’infrastruttura ridondante per proteggere i tuoi dati.",
    ...
    expensifyCode: {
      ...
      enterCode:
        "Inserisci un codice Expensify da applicare al tuo abbonamento.",
      apply: "Applica",
      error: {
    ...
    subscriptionSettings: {
      ...
      saveUpTo: (amountWithCurrency: string) =>
        `Risparmia fino a ${amountWithCurrency}/mese per ogni membro attivo`,
      ...
      whatsMainReason:
        "Qual è il motivo principale per cui stai disattivando il rinnovo automatico?",
      renewsOn: (date: string) => `Si rinnova il ${date}.`,
      pricingConfiguration:
        "Il prezzo dipende dalla configurazione. Per il prezzo più basso, scegli un abbonamento annuale e richiedi la Carta Expensify.",
      ...
      changesBasedOn:
        "Questo cambia in base all'utilizzo della tua Carta Expensify e alle opzioni di abbonamento qui sotto.",
    },
    requestEarlyCancellation: {
      title: "Richiedi annullamento anticipato",
      subtitle:
        "Qual è il motivo principale per cui stai richiedendo l’annullamento anticipato?",
  ...
  delegate: {
    ...
    copilotDelegatedAccessDescription:
      "Consenti agli altri membri di accedere al tuo account.",
    addCopilot: "Aggiungi copilota",
    membersCanAccessYourAccount:
      "Questi membri possono accedere al tuo account:",
    youCanAccessTheseAccounts:
      "Puoi accedere a questi account tramite il selettore di account:",
    ...
    enterMagicCodeUpdate: (contactMethod: string) =>
      `Inserisci il codice magico inviato a ${contactMethod} per aggiornare il tuo copilota.`,
  ...
  debug: {
    ...
    missingProperty: ({ propertyName }: MissingPropertyParams) =>
      `${propertyName} mancante`,
    invalidProperty: ({ propertyName, expectedType }: InvalidPropertyParams) =>
      `Proprietà non valida: ${propertyName} - Previsto: ${expectedType}`,
    invalidValue: ({ expectedValues }: InvalidValueParams) =>
      `Valore non valido - previsto: ${expectedValues}`,
    ...
    reasonVisibleInLHN: {
      ...
      hasAddWorkspaceRoomErrors:
        "Ha errori nell'aggiunta di una sala dello spazio di lavoro",
    ...
    reasonGBR: {
      ...
      isWaitingForAssigneeToCompleteAction:
        "In attesa che l’assegnatario completi l’azione",
      hasChildReportAwaitingAction: "Ha un report figlio in attesa di azione",
      hasMissingInvoiceBankAccount:
        "Ha il conto bancario della fattura mancante",
      hasUnresolvedCardFraudAlert:
        "Ha un avviso di frode sulla carta non risolto",
      hasDEWApproveFailed: "Approvazione DEW non riuscita",
    },
    reasonRBR: {
      hasErrors:
        "Presenta errori nei dati del report o delle azioni del report",
      hasViolations: "Presenta violazioni",
      hasTransactionThreadViolations:
        "Presenta violazioni del thread di transazione",
    },
    indicatorStatus: {
      ...
      theresAWorkspaceWithCustomUnitsErrors:
        "C’è uno spazio di lavoro con errori nelle unità personalizzate",
      theresAProblemWithAWorkspaceMember:
        "C’è un problema con un membro dello spazio di lavoro",
      theresAProblemWithAWorkspaceQBOExport:
        "Si è verificato un problema con un'impostazione di esportazione della connessione dello spazio di lavoro.",
      theresAProblemWithAContactMethod:
        "C'è un problema con un metodo di contatto",
      aContactMethodRequiresVerification:
        "Un metodo di contatto richiede la verifica",
      theresAProblemWithAPaymentMethod:
        "C'è un problema con un metodo di pagamento",
      theresAProblemWithAWorkspace: "C'è un problema con uno spazio di lavoro",
      theresAProblemWithYourReimbursementAccount:
        "Si è verificato un problema con il tuo conto di rimborso",
      theresABillingProblemWithYourSubscription:
        "C’è un problema di fatturazione con il tuo abbonamento",
      yourSubscriptionHasBeenSuccessfullyRenewed:
        "Il tuo abbonamento è stato rinnovato correttamente",
      theresWasAProblemDuringAWorkspaceConnectionSync:
        "Si è verificato un problema durante la sincronizzazione della connessione dello spazio di lavoro",
      theresAProblemWithYourWallet:
        "Si è verificato un problema con il tuo portafoglio",
      theresAProblemWithYourWalletTerms:
        "C’è un problema con i termini del tuo portafoglio",
    },
  },
  emptySearchView: {
  ...
  migratedUserWelcomeModal: {
    ...
    subtitle:
      "Ha tutto ciò che ami della nostra esperienza classica, con un sacco di miglioramenti per renderti la vita ancora più semplice:",
    confirmText: "Andiamo!",
    helpText: "Prova demo di 2 minuti",
    features: {
      search: "Ricerca più potente su mobile, web e desktop",
      concierge:
        "Concierge AI integrato per aiutarti ad automatizzare le tue spese",
  ...
  productTrainingTooltip: {
    ...
    saveSearchTooltip:
      "<tooltip><strong>Rinomina qui le ricerche salvate</strong>!</tooltip>",
    accountSwitcher:
      "<tooltip>Accedi ai tuoi <strong>account Copilot</strong> qui</tooltip>",
    scanTestTooltip: {
      main: "<tooltip><strong>Scansiona la nostra ricevuta di prova</strong> per vedere come funziona!</tooltip>",
      manager:
        "<tooltip>Scegli il nostro <strong>test manager</strong> per provarlo!</tooltip>",
      confirmation:
        "<tooltip>Ora, <strong>invia la tua nota spese</strong> e guarda la\nmagia che accade!</tooltip>",
      tryItOut: "Provalo",
    },
    outstandingFilter:
      "<tooltip>Filtra per le spese\nche <strong>necessitano di approvazione</strong></tooltip>",
    scanTestDriveTooltip:
      "<tooltip>Invia questa ricevuta per\n<strong>completare il test drive!</strong></tooltip>",
    gpsTooltip:
      "<tooltip>Tracciamento GPS in corso! Quando hai finito, interrompi il tracciamento qui sotto.</tooltip>",
    hasFilterNegation:
      "<tooltip>Cerca le spese senza ricevute usando <strong>-has:receipt</strong>.</tooltip>",
  },
  ...
  scheduledCall: {
    book: {
      ...
      slots: ({ date }: { date: string }) =>
        `<muted-text>Orari disponibili per il <strong>${date}</strong></muted-text>`,
    },
    confirmation: {
      title: "Conferma chiamata",
      description:
        "Assicurati che i dettagli qui sotto ti sembrino corretti. Una volta confermata la chiamata, ti invieremo un invito con maggiori informazioni.",
  ...
  autoSubmitModal: {
    ...
    submittedExpensesDescription:
      "Queste spese sono state inviate al/la tuo/a approvatore/trice, ma possono ancora essere modificate finché non vengono approvate.",
    pendingExpensesTitle: "Le spese in sospeso sono state spostate",
    pendingExpensesDescription:
      "Eventuali spese in sospeso sulla carta sono state spostate in un report separato finché non verranno contabilizzate.",
  },
  testDrive: {
    quickAction: {
    ...
    modal: {
      ...
      description:
        "Fai un breve tour del prodotto per metterti subito al passo.",
      ...
      employee: {
        ...
        error:
          "Quella persona è titolare di uno spazio di lavoro, inserisci un nuovo membro per effettuare il test.",
      },
    },
    banner: {
...
Ecco una *ricevuta di prova* per mostrarti come funziona:`,
  ...
  domain: {
    ...
    verifyDomain: {
      ...
      accessYourDNS: ({ domainName }: { domainName: string }) =>
        `Accedi al tuo provider DNS e apri le impostazioni DNS per <strong>${domainName}</strong>.`,
      addTXTRecord: "Aggiungi il seguente record TXT:",
      saveChanges:
        "Salva le modifiche e torna qui per verificare il tuo dominio.",
      ...
      warning:
        "Dopo la verifica, tutti i membri di Expensify nel tuo dominio riceveranno un’email che indica che il loro account sarà gestito sotto il tuo dominio.",
      codeFetchError: "Impossibile recuperare il codice di verifica",
      genericError:
        "Non siamo riusciti a verificare il tuo dominio. Riprova e contatta Concierge se il problema persiste.",
    },
    domainVerified: {
    ...
    samlLogin: {
      ...
      anyMemberWillBeRequired:
        "Qualsiasi membro connesso con un metodo diverso dovrà eseguire nuovamente l’autenticazione utilizzando SAML.",
      ...
      requireWithEmptyMetadataError:
        "Aggiungi qui sotto i metadati del provider di identità per abilitare",
    ...
    accessRestricted: {
      ...
      subtitle: (domainName: string) =>
        `Verificati come amministratore autorizzato dell’azienda per <strong>${domainName}</strong> se hai bisogno di controllare:`,
    ...
    addDomain: {
      ...
      subtitle:
        "Inserisci il nome del dominio privato a cui vuoi accedere (ad es. expensify.com).",
    ...
    domainAdded: {
      ...
      description:
        "Successivamente dovrai verificare la proprietà del dominio e regolare le impostazioni di sicurezza.",
      configure: "Configura",
    },
    enhancedSecurity: {
      title: "Sicurezza avanzata",
      subtitle:
        "Richiedi ai membri del tuo dominio di accedere tramite Single Sign-On, limita la creazione di workspace e altro ancora.",
      enable: "Abilita",
    },
    ...
    admins: {
      ...
      setPrimaryContactError:
        "Impossibile impostare il contatto principale. Riprova più tardi.",
      ...
      consolidatedDomainBillingError:
        "La fatturazione consolidata del dominio non può essere modificata. Riprova più tardi.",
      addAdmin: "Aggiungi amministratore",
      addAdminError:
        "Impossibile aggiungere questo membro come amministratore. Riprova.",
      revokeAdminAccess: "Revoca accesso amministratore",
      cantRevokeAdminAccess:
        "Impossibile revocare l’accesso di amministratore al referente tecnico",
      error: {
        removeAdmin:
          "Impossibile rimuovere questo utente come amministratore. Riprova.",
        removeDomain: "Impossibile rimuovere questo dominio. Riprova.",
        removeDomainNameInvalid:
          "Inserisci il nome del tuo dominio per reimpostarlo.",
      },
      resetDomain: "Reimposta dominio",
      resetDomainExplanation: ({ domainName }: { domainName?: string }) =>
        `Digita <strong>${domainName}</strong> per confermare il ripristino del dominio.`,
    ...
    members: {
      ...
      closeAccountInfo: () => ({
        ...
        other:
          "Consigliamo di chiudere gli account in modo sicuro per evitare problemi in caso di: <bullet-list><bullet-item>Approvazioni in sospeso</bullet-item><bullet-item>Rimborsi attivi</bullet-item><bullet-item>Nessun metodo di accesso alternativo</bullet-item></bullet-list>In caso contrario, puoi ignorare le precauzioni di sicurezza sopra indicate e forzare la chiusura degli account selezionati.",
      }),
      error: {
        removeMember: "Impossibile rimuovere questo utente. Riprova.",
        addMember: "Impossibile aggiungere questo membro. Riprova.",
        vacationDelegate:
          "Impossibile impostare questo utente come delegato per le ferie. Riprova.",
      },
      cannotSetVacationDelegateForMember: (email: string) =>
        `Non puoi impostare un delegato per le vacanze per ${email} perché al momento è il delegato per i seguenti membri:`,
    ...
    common: {
      ...
      forceTwoFactorAuthError:
        "Impossibile modificare l’impostazione “Forza l’autenticazione a due fattori”. Riprova più tardi.",
  ...
  proactiveAppReview: {
    ...
    description:
      "Facci sapere così possiamo aiutarti a rendere ancora migliore la tua esperienza di gestione delle spese.",
    positiveButton: "Sì!",
