...
const translations = {
    ...
    bankAccount: {
        ...
        hasPhoneLoginError:
            "Per collegare un conto bancario, per favore <a>aggiungi un'email come login principale</a> e riprova. Puoi aggiungere il tuo numero di telefono come login secondario.",
