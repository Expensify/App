...
Aggiungi altre regole di spesa per proteggere il flusso di cassa aziendale.`,
        ...
        campfire: {
            ...
            exportDate: {
                ...
                values: {label: 'Data di invio', description: "Data di invio del report per l'approvazione."},
            },
            exportNonReimbursable: {label: 'Esporta le spese della carta aziendale come', values: {label: 'Registrazioni contabili'}},
            defaultCompanyCardVendor: {
                label: 'Fornitore predefinito per tutte le carte aziendali',
            ...
            companyCardAccount: {label: 'Conto carta aziendale', description: 'Scegli dove esportare le transazioni delle carte aziendali.'},
            noVendorsFound: 'Nessun fornitore trovato',
            noVendorsFoundDescription: 'Aggiungi i fornitori in Campfire e sincronizza di nuovo la connessione',
            noAccountsFound: 'Nessun conto trovato',
