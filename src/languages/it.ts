...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            accountManager: '[it] Account Manager',
            accountManagerDescription: 'Fai domande e ottieni assistenza clienti',
            partnerManager: '[it] Partner Manager',
            ...
            approvedPartnerTeamDescription:
                'Un team dedicato che ti aiuta a far crescere il tuo studio, ad acquisire clienti più velocemente e a ottenere supporto esperto ogni volta che ne hai bisogno.',
            accountExecutive: '[it] Account Executive',
            accountExecutiveDescription: 'Configura i clienti con successo',
