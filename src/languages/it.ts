...
Il piano Control parte da 9 $ al mese per ogni membro attivo.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    title: 'Configurazione di lavoro predefinita',
                    officeBasedTitle: 'In ufficio',
                    officeBasedHelp: 'Il membro si reca normalmente in ufficio. I tragitti ordinari casa-lavoro sono esclusi dal rimborso.',
                    ...
                    startingPrompt: {
                        ...
                        officeBasedHelp: 'La maggior parte dei membri fa il pendolarismo verso un ufficio. I tragitti ordinari casa-lavoro sono esclusi.',
    ...
    workspaceActions: {
        ...
        workArrangement: {
            ...
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `ha modificato l’impostazione di lavoro predefinita in ${arrangement} (in precedenza ${previousArrangement})`,
        },
        commuterExclusions: {
