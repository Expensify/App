...
${
    ...
    workspaceActions: {
        ...
        forcedCorporateUpgrade: `Questo spazio di lavoro è stato aggiornato al piano Control. Fai clic <a href="${CONST.PLAN_TYPES_AND_PRICING_HELP_URL}">qui</a> per ulteriori informazioni.`,
