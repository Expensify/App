...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            unlock: 'Sblocca',
            debitBlocked: 'La tua banca ha bloccato le transazioni di prova verso questo conto',
        ...
        fixBankAccount: {
            ...
            insufficientFundsBody: 'Le transazioni di prova non sono riuscite per fondi insufficienti. Quando i fondi saranno disponibili, usa il pulsante qui sotto.',
            resendButton: 'Reinvia transazioni',
            successTitle: 'Transazioni inviate!',
            successBody: 'Controlla il tuo conto bancario tra 1-2 giorni lavorativi.',
...
Aggiungi altre regole di spesa per proteggere il flusso di cassa aziendale.`,
    ...
    debug: {
        ...
        indicatorStatus: {
            ...
            aBankAccountFailedValidation: 'La verifica di un conto bancario non è andata a buon fine',
        },
    },
    emptySearchView: {
