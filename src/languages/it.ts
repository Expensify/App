...
Aggiungi altre regole di spesa per proteggere il flusso di cassa aziendale.`,
    ...
    workspaceActions: {
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `ha impostato l’importo richiesto per la ricevuta dettagliata su "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) =>
            `ha modificato l’importo richiesto per la ricevuta dettagliata in "${newValue}" (in precedenza "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `ha rimosso l’importo richiesto per la ricevuta dettagliata (in precedenza "${oldValue}")`,
