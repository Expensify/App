...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. Usa il pulsante ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} per inviare una fattura.`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `. Basta usare il pulsante ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE}.`,
