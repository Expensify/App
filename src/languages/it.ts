...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        calendarOpened: '[it] calendar opened',
        send: '[it] Send',
        na: '[it] N/A',
...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        revealCardDetail: {
            couldNotReveal: "[it] We couldn't reveal your card details. Please try again.",
        },
    },
    validateCodeModal: {
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            unlockBankAccount: {
                workspaceTitle: '[it] Your business bank account has been locked',
                personalTitle: '[it] Your bank account has been locked',
                workspaceSubtitle: ({policyName}: {policyName: string}) => policyName,
                personalSubtitle: '[it] Wallet',
            },
        },
        freeTrialSection: {
        ...
        yourSpend: {
            title: '[it] Your spend',
            awaitingApproval: '[it] Awaiting approval',
            repaidLast30Days: '[it] Repaid in the last 30 days',
            recentTransactions: ({lastFour}: {lastFour: string}) => `[it] Recent transactions • ${lastFour}`,
        },
        seeMore: ({count}: {count: number}) => `[it] See ${count} more`,
        ...
        gettingStartedSection: {
            ...
            inviteAccountant: '[it] Invite your accountant',
    ...
    spreadsheet: {
        ...
        importCompanyCardTransactionsPendingMessage: '[it] New cards and transactions may take some time to appear, please hang tight.',
    ...
    iou: {
        ...
        movedFromReport: (reportName: string) => `[it] moved an expense from ${reportName}`,
        movedFromReportNoName: '[it] moved an expense',
        movedTransactionTo: (reportUrl: string, reportName: string) => `[it] moved this expense to <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionToAnotherReport: '[it] moved this expense to another report',
        movedTransactionFrom: (reportUrl: string, reportName: string) => `[it] moved this expense from <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionFromAnotherReport: '[it] moved this expense from another report',
        ...
        allTransactionsPendingNextStep: "[it] All transactions are pending. You can't submit this report until they post in a few days.",
        ...
        confirmPaymentReceivedModalTitle: '[it] Confirm payment received',
        receivedPayment: '[it] Received payment',
        receivedPaymentConfirmation: "[it] Please proceed only if you've already received payment outside of Expensify.",
        confirmReceivedPayment: "[it] Yes, I've received payment",
        ...
        updatedTheRequest: (valueName: string, newValueToDisplay: string, oldValueToDisplay: string) => `[it] the ${valueName} to ${newValueToDisplay} (previously ${oldValueToDisplay})`,
        ...
        error: {
            ...
            invalidReadings: '[it] Please enter both start & end readings to continue',
            ...
            unableToSubmitReport: '[it] Unable to submit report',
            allTransactionsPendingDescription: "[it] You can't submit this report because all transactions are pending. They may take a few days to post.",
            failedToSaveOdometerDraft: "[it] Couldn't save your odometer draft. Please try again.",
            ...
            receiptUploadFailedMessage: '[it] Receipt upload failed. Save the receipt, or delete the expense and lose it.',
            saveReceipt: '[it] Save receipt',
        ...
        changeApprover: {
            ...
            reassignedApproverMessage: (managerID: number) => `[it] reassigned the approver to <mention-user accountID="${managerID}"/> via a workflow update`,
            actions: {
    ...
    deviceManagementPage: {
        ...
        description:
            '[it] Manage all the devices that you have logged into with your Expensify Account. <a href="https://help.expensify.com/articles/new-expensify/settings/Manage-Logged-in-Devices">Learn more</a>.',
        revoke: '[it] Revoke',
        unknownDevice: '[it] Unknown Device',
    },
    twoFactorAuth: {
        ...
        `),
        screenshotTip: '[it] Tip: Screenshot this to save it to your photo library',
    ...
    walletPage: {
        ...
        cardActive: '[it] Active',
        bankAccountStatus: {
            active: '[it] Active',
            incomplete: '[it] Incomplete',
            pending: '[it] Pending',
            verifying: '[it] Verifying',
            locked: '[it] Locked',
            incompleteDescription: '[it] Finish adding bank account',
            pendingDescription: '[it] Please confirm test transactions',
            verifyingDescription: "[it] We're reviewing your documentation",
            lockedDescription: '[it] This account requires attention',
            finish: '[it] Finish',
            confirm: '[it] Confirm',
            unlock: '[it] Unlock',
        },
        cardFixConnection: '[it] Please fix this connection',
        cardAskAdminToFix: '[it] Please ask an admin to fix this connection',
        cardAdminFixConnection: '[it] Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `[it] Last synced ${dateStr}`,
        assignedCards: '[it] Cards',
        assignedCardsDescription: '[it] Transactions from assigned cards sync automatically.',
...
${amount} for ${merchant} - ${date}`,
        ...
        cardUnblocked: '[it] Card unblocked!',
        cardUnblockedDescription: '[it] You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: '[it] Your card was blocked due to incorrect PIN entries.',
        unblock: '[it] Unblock',
        unblockCard: '[it] Unblock card',
    ...
    workflowsPage: {
        ...
        configureViaHR: ({provider}: {provider: string}) => `[it] Configure via ${provider}.`,
        hrApprovalWorkflowLockedPrompt: ({provider}: {provider: string}) =>
            `[it] Approvals are managed by your ${provider} integration. To update your approval workflow, head to your ${provider} connection settings.`,
        goToHRSettings: ({provider}: {provider: string}) => `[it] Go to ${provider} settings`,
    ...
    reportFraudConfirmationPage: {
        ...
        descriptionCardNotReplaced: '[it] Your card was permanently deactivated. Please contact an admin to issue a new card.',
    ...
    agentsPage: {
        title: '[it] Agents',
        subtitle: '[it] Create agents to handle your workflow. Skip the manual work and get hours back in your day.',
        newAgent: '[it] New agent',
        emptyAgents: {
            title: '[it] No agents created',
            subtitle: '[it] Stop manually doing stuff. Instruct an agent instead and save yourself lots of time.',
        },
        error: {
            genericAdd: '[it] There was a problem adding this agent',
            genericUpdate: '[it] There was a problem updating this agent',
            updateName: "[it] There was a problem updating this agent's name",
            updatePrompt: "[it] There was a problem updating this agent's instructions",
            updateAvatar: "[it] There was a problem updating this agent's avatar",
        },
    },
    addAgentPage: {
        title: '[it] New agent',
        agentName: '[it] Agent name',
        instructions: '[it] Write custom instructions',
        createAgent: '[it] Create agent',
        editAvatar: '[it] Edit avatar',
        defaultAgentName: (displayName: string) => `[it] ${displayName}'s Agent`,
        defaultPrompt:
            "[it] Reject expenses that are for gambling, movies, or other obvious non-business reasons.\n\nRemind the user to always include a receipt image that makes the tip clear.\n\nApprove the report if it's very similar to previous reports from the same user.\n\nReject reports with more than $500 in travel expenses.",
    },
    editAgentPage: {
        title: '[it] Edit agent',
        agentName: '[it] Agent name',
        instructions: '[it] Write custom instructions',
        deleteAgent: '[it] Delete agent',
        deleteAgentTitle: '[it] Delete agent?',
        deleteAgentMessage: '[it] Are you sure you want to delete this agent? This action cannot be undone.',
    },
    editAgentAvatarPage: {
        title: '[it] Edit avatar',
    },
    editAgentNamePage: {
        title: '[it] Agent name',
    },
    editAgentPromptPage: {
        title: '[it] Write custom instructions',
        error: {
            emptyPrompt: '[it] Please enter instructions for your agent.',
        },
    },
    expenseRulesPage: {
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '[it] <strong>Avoid scams. Do not share your code with anyone.</strong> Our team will never call, text, or email you for this code.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[it] Here's the list of workspaces you can join.",
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: '[it] Submit expenses to my employer',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "[it] Manage my team's expenses",
            [CONST.ONBOARDING_CHOICES.TRACK_BUSINESS]: '[it] Track expenses for my business',
            [CONST.ONBOARDING_CHOICES.TRACK_PERSONAL]: '[it] Organize my personal spending',
        ...
        workEmail2FAError: '[it] This login is an existing account with Two-Factor Authentication (2FA) enabled.',
        mergeBlockScreen: {
            ...
            workAccountClosedSubtitle: '[it] The work account associated with this email is closed. Please contact your company admin to reactivate it, or sign up with a different email.',
        },
        tasks: {
            testDriveAdminTask: {
    ...
    statusPage: {
        ...
        addVacationDelegate: '[it] Add vacation delegate',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    addPersonalBankAccount: {
        ...
        updatePersonalInfo: '[it] Update bank account',
        updatePersonalInfoFailure: '[it] Unable to update bank account information. Please try again later.',
        updateSuccessTitle: '[it] Bank account updated!',
        updateSuccessHeader: '[it] Bank account updated',
        updateSuccessMessage: '[it] Congrats, your bank account is set up and ready to receive reimbursements.',
    },
    ...
    messages: {
        ...
        userIsAlreadyMember: (login: string, name: string) => `[it] ${login} is already a member of ${name}`,
        userIsAlreadyAnAdmin: (login: string, name: string) => `[it] ${login} is already an admin of ${name}`,
    },
    onfidoStep: {
    ...
    workspace: {
        common: {
            ...
            cardAdminAlternateText: '[it] Manage workspace cards.',
            peopleAdminAlternateText: '[it] Manage members and approval workflows.',
            paymentsAdminAlternateText: '[it] Manage workflow payments.',
            reimbursementChoice: {
            ...
            roleName: (role?: string) => {
                switch (role) {
                    ...
                    case CONST.POLICY.ROLE.CARD_ADMIN:
                        return '[it] Card Admin';
                    case CONST.POLICY.ROLE.PEOPLE_ADMIN:
                        return '[it] People Admin';
                    case CONST.POLICY.ROLE.PAYMENTS_ADMIN:
                        return '[it] Payments Admin';
            ...
            travelInvoicing: '[it] Export travel invoicing expenses as',
            travelInvoicingVendor: '[it] Travel vendor',
            travelInvoicingPayableAccount: '[it] Travel payable account',
        },
        createdForClient: {
            title: "[it] You've created a workspace for your client!",
            description: '[it] Great news 🎉. Reach out to us if they need any help with the setup.',
        },
        receiptPartners: {
            uber: {
        ...
        qbo: {
            ...
            bankAccountDescription: '[it] Choose where to send checks from.',
            creditCardAccount: '[it] Credit card account',
            travelInvoicingDescription: '[it] Travel expenses will export as credit card charges to the QuickBooks Online account specified below.',
        ...
        xero: {
            ...
            travelInvoicingDescription: '[it] Travel expenses will export as bank transactions to the Xero account specified below.',
        ...
        sageIntacct: {
            ...
            travelInvoicingDescription: '[it] Travel expenses will export as credit card charges to the Sage Intacct account specified below.',
            creditCardAccount: '[it] Credit card account',
        ...
        certinia: {
            title: '[it] Certinia',
            prerequisites: {
                title: '[it] Before you connect',
                installBundle: '[it] For FFA Connections',
                installBundleDescription: ({href, version}: {href: string; version: string}) =>
                    `[it] Install the Expensify bundle in Salesforce by clicking this link: <a href="${href}">Install FFA Expensify Bundle (Version ${version})</a>`,
                installBundleConfirm: "[it] I've installed the bundle",
                setupContacts: '[it] Set up user and contacts',
                setupContactsBullet1:
                    "[it] Create both a User and a Contact for yourself if these don't already exist in Certinia making sure the email matches your primary email in Expensify.\n\n",
                setupContactsBullet2:
                    "[it] Create contacts for each employee who will be submitting expense reports and for each report approver. Make sure each contact's email address corresponds with the email address on the employee's Expensify account.\n\n",
                setupContactsBullet3: '[it] Set permission controls for your user for each contact/resource.\n\n',
                setupContactsConfirm: "[it] I've set up the user and contacts",
                oauth: '[it] Log in through Salesforce',
                oauthDescription: "[it] To finish setup, you'll have to sign in through Salesforce and Certinia.\n\nUse the button below to continue.",
                connectButton: '[it] Connect to Certinia',
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '[it] Single entry for each expense',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '[it] Single, itemized entry for each report',
                },
            },
            invoiceItem: {
...
_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                fileImportDescription: "[it] A manual option if your bank can't send a feed.",
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                duplicateFeedModal: {
                    title: '[it] Card feed already connected',
                    prompt: "[it] You can't add the same card feed to the same workspace twice.",
                },
                csvColumns: {
        ...
        expensifyCard: {
            ...
            exportAsCSV: '[it] Export as CSV',
            csvColumnType: '[it] Type',
            csvColumnLimitType: '[it] Limit type',
            csvColumnLimit: '[it] Limit',
            findCard: '[it] Find card',
            newCard: '[it] New card',
            name: '[it] Name',
            lastFour: '[it] Last 4',
            ...
            applyCashbackToBill: '[it] Apply cash back to my Expensify bill',
            applyCashbackToBillDescription: '[it] Cash back from the Expensify Card will be used towards payment for your Expensify bill.',
            frequency: {
                daily: '[it] Daily',
                monthly: '[it] Monthly',
            },
        ...
        moreFeatures: {
                ...
                travelInvoicing: {
                    ...
                    travelInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[it] We weren't able to provision some of the members of your workspace for travel invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[it] Travel Invoicing enabled!',
            ...
            hrWarningModal: {
                disconnectText: ({integration}: {integration: string}) => `[it] To disable HR, please disconnect ${integration} from this workspace first.`,
            },
        ...
        copyPolicySettings: {
            error: '[it] An error occurred while copying workspace settings. Please try again.',
            title: '[it] Copy settings',
            selectWorkspaces: '[it] Select workspaces',
            description: '[it] Choose the workspaces you want to copy settings to, then select the settings you’d like to copy.',
            searchPlaceholder: '[it] Search workspaces',
        },
        emptyWorkspace: {
        ...
        people: {
            ...
            configureHRSync: (providerName: string) => `[it] Configure ${providerName} sync.`,
            syncWithHR: (providerName: string) => `[it] Sync with ${providerName}`,
            allMembers: '[it] All members',
            admins: '[it] Admins',
            approvers: '[it] Approvers',
            auditors: '[it] Auditors',
            emptyRoleFilter: {
                title: '[it] No members match this filter',
                subtitle: '[it] Invite a member or change the filter above.',
            },
        ...
        accounting: {
            ...
            updateCredentials: '[it] Update credentials',
            claimOffer: {
            ...
            syncTravelInvoicingSettlements: '[it] Sync travel invoicing settlements',
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '[it] Choose the bank account that your travel invoicing payments will be reconciled against.',
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `[it] Make sure this account matches your travel invoicing settlement account (ending in ${lastFourPAN}) so Continuous Reconciliation works properly.`,
            },
        },
        hr: {
            title: '[it] HR',
            ...
            syncNow: '[it] Sync now',
            disconnect: '[it] Disconnect',
            disconnectTitle: (providerName: string) => `[it] Disconnect ${providerName}`,
            disconnectPrompt: (providerName: string) => `[it] Are you sure you want to disconnect ${providerName}?`,
            alreadyConnectedTitle: '[it] Cannot connect to multiple HR platforms',
            alreadyConnectedPrompt: '[it] You must disconnect your current HR platform before connecting another.',
            lastSync: (relativeDate: string) => `[it] Last synced ${relativeDate}`,
            syncError: (providerName: string) => `[it] Can't connect to ${providerName}`,
            connectionDescription: (providerName: string) => `[it] Connect ${providerName} to keep employee approvals in sync with your workspace.`,
            approvalMode: '[it] Approval mode',
            providerApprovalMode: (providerName: string) => `[it] ${providerName} approval mode`,
            finalApprover: '[it] Final approver',
            providerFinalApprover: (providerName: string) => `[it] ${providerName} final approver`,
            notSet: '[it] Not set',
            syncing: '[it] Syncing employees',
            syncingModalTitle: '[it] Your connection is syncing',
            syncingModalDescription: "[it] The first connection can take some time. You'll be notified of any errors.",
            approvalModeDescription: (providerName: string) => `[it] Members and managers are set up to sync with ${providerName}.`,
            approvalModeWarningTitle: '[it] Change approval mode?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `[it] Are you sure you would like to change the approval mode for this workspace? Learn more about the different ${providerName}-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
            approvalModeWarningConfirm: '[it] Change approval mode',
            approvalModes: {
                basic: {label: '[it] Basic approval', description: '[it] All users submit to a single person for processing and approval.'},
                manager: {
                    label: '[it] Manager approval',
                    description: (providerName: string) => `[it] Employees submit reports to their direct manager configured in ${providerName}.`,
                },
                custom: {label: '[it] Custom approval', description: "[it] I'll manually setup approval workflows in Expensify."},
            },
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
                        return '[it] Synchronizing Gusto Employees';
                    case 'gustoSyncLoadData':
                        return '[it] Loading data from Gusto';
                    case 'gustoSyncProvisioning':
                        return '[it] Provisioning employees in policy';
                    case 'zenefitsSyncTitle':
                        return '[it] Synchronizing TriNet Employees';
                    case 'zenefitsSyncLoadData':
                        return '[it] Loading data from TriNet';
            ...
            syncResults: {
                title: (provider: string) => `[it] ${provider} sync complete`,
                successTitle: (provider: string) => `[it] Successfully synced your ${provider} connection!`,
                added: '[it] Added',
                removed: '[it] Removed',
                skipped: '[it] Skipped',
                employeeCount: () => ({
                    one: '[it] 1 employee',
                    other: (count: number) => `[it] ${count} employees`,
                }),
            },
            gusto: {
                title: '[it] Gusto',
        ...
        distanceRates: {
            ...
            amountPerUnit: (unit: string) => `[it] Amount per ${unit}`,
            startDate: '[it] Start date',
            endDate: '[it] End date',
            errors: {
                rateNameRequired: '[it] Rate name is required',
                existingRateName: '[it] A distance rate with this name already exists',
                nameRequired: '[it] Name is required',
                amountRequired: '[it] Amount is required',
                startDateMustBeBeforeEndDate: '[it] Start date must be before end date',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            yourWorkspace: `[it] Your workspace is set to an unsupported currency. View the <a href="${CONST.ENABLE_GLOBAL_REIMBURSEMENT_HELP_URL}">list of supported currencies</a>.`,
...
Are you sure you want to export them again?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.CERTINIA]: {
                title: '[it] Certinia',
                description: `[it] Enjoy automated syncing and reduce manual entries with the Expensify + Certinia integration. Align expense coding dimensions and tax sync with your Certinia setup for clearer financial visibility.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>Our Certinia integration is only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
            },
            ...
            approvalSubmit: {
                title: '[it] Approvals',
                description: '[it] Centrally configure who all members submit to by enabling approvals.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>Approvals are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
            },
            categories: {
                title: '[it] Categories',
            ...
            companyCardSubmit: {
                title: '[it] Company cards',
                description: `[it] Bring your own company card to Expensify to get automatic import, automatic categorization, customizable rule support, and integrated reconciliation.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>Company card import is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
            },
            rules: {
                title: '[it] Rules',
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            travelSubmit: {
                title: '[it] Expensify Travel',
                description: '[it] Book discounted flights, hotels, cars, and trains globally from within Expensify, with duty of care reporting and integrated expense management.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>Expensify Travel is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
            },
            reports: {
                title: '[it] Reports',
            ...
            roles: {
                title: '[it] Roles',
                description: '[it] Assign different roles to different members to increase or decrease visibility and control as appropriate.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>Roles are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
            },
            payments: {
                title: '[it] Payments',
                description: '[it] Reimburse employees directly from your business bank account.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>Payments are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
            },
            accounting: {
                title: '[it] Accounting',
                description:
                    '[it] Sync categories, tags, tax rates, and more from your accounting system to Expensify, as well as export expense reports and card transactions – no typing (or typos) involved!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>Accounting is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
            },
            expensifyCard: {
                title: '[it] Expensify Card',
                description:
                    '[it] Issue company cards (including virtual cards) directly from your own bank account to get realtime spend control with an unbreakable connection, and up to 2% cashback!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>The Expensify Card is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
                upgradeButton: '[it] Upgrade and enable',
            },
            invoicing: {
                title: '[it] Invoicing',
                description: '[it] Create, send, and track professional invoices, all inside Expensify. Get paid faster with integrated payments and real-time visibility.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[it] <muted-text>Invoicing is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[it] per member per month.` : `[it] per active member per month.`}</muted-text>`,
            },
            pricing: {
                perActiveMember: '[it] per active member per month.',
                perMember: '[it] per member per month.',
            },
            note: (subscriptionLink: string) => `[it] <muted-text><a href="${subscriptionLink}">Learn more</a> about our plans and pricing.</muted-text>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                giftCard: '[it] Gift card purchases',
                handwrittenReceipt: '[it] Handwritten receipts',
...
Add more spend rules to protect company cash flow.`,
        ...
        planTypePage: {
            planTypes: {
                ...
                submit2026: {
                    label: '[it] Submit',
                    description: '[it] For employees looking to submit expenses to their employer.',
                },
            },
            description: "[it] Choose a plan that's right for you.",
            subscriptionLink: '[it] Learn more',
    ...
    workspaceActions: {
        ...
        updatedRequireCompanyCards: ({enabled}: {enabled: boolean}) => `[it] ${enabled ? '[it] enabled' : '[it] disabled'} the company card purchases requirement`,
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `[it] set itemized receipt required amount to "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) => `[it] changed itemized receipt required amount to "${newValue}" (previously "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `[it] removed itemized receipt required amount (previously "${oldValue}")`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            editMultipleDescription: '[it] Changes will be set for all selected expenses and will override any previously set values.',
            approve: '[it] Approve',
            pay: '[it] Pay',
            delete: '[it] Delete',
            hold: '[it] Hold',
        ...
        filters: {
            ...
            card: {
                ...
                travelInvoicing: '[it] Travel invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[it] Travel invoicing',
            },
            is: '[it] Is',
            action: {
        ...
        askConcierge: (message: string) => `[it] Ask Concierge “${message}”`,
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    travelCardLink: '[it] travel card expenses',
    ...
    chronos: {
        ...
        stopTimer: (duration: string) => `[it] Stop Timer (${duration})`,
    ...
    accessibilityHints: {
        ...
        openActionsMenu: '[it] Open actions menu',
        selectAllCategories: '[it] Select all categories',
        selectAllDistanceRates: '[it] Select all distance rates',
        selectAllTags: '[it] Select all tags',
        selectAllTaxes: '[it] Select all taxes',
        selectAllPerDiemRates: '[it] Select all per diem rates',
        selectAllMembers: '[it] Select all members',
        selectAllValues: '[it] Select all values',
        selectAllRules: '[it] Select all rules',
    },
    parentReportAction: {
    ...
    gps: {
        ...
        liveActivity: {
            ...
            lockScreenBadgeText: '[it] Distance',
            lockScreenTrackingText: '[it] Tracking...',
    ...
    violations: {
        ...
        missingTag: (tagName?: string) => `[it] Missing ${tagName ?? '[it] tag'}`,
        ...
        prohibitedExpense: (prohibitedExpenseTypes: string | string[]) => {
            ...
            const getProhibitedExpenseTypeText = (prohibitedExpenseType: string) => {
                switch (prohibitedExpenseType) {
                    ...
                    case 'giftCard':
                        return `[it] gift card purchases`;
                    case 'handwrittenReceipt':
                        return `[it] handwritten receipts`;
                    default:
        ...
        smartscanFailed: ({canEdit = true, missingFields = []}: {canEdit?: boolean; missingFields?: string[]}) => {
            if (missingFields.length > 0) {
                const fieldNames: Record<string, string> = {merchant: '[it] merchant', date: '[it] date', amount: '[it] amount'};
                const translated = missingFields.map((f) => fieldNames[f] ?? f);
                let fieldList = '';
                if (translated.length === 1) {
                    fieldList = translated.at(0) ?? '';
                } else if (translated.length === 2) {
                    fieldList = translated.join('[it]  and ');
                } else {
                    fieldList = `${translated.slice(0, translated.length - 1).join(', ')}, and ${translated.at(-1)}`;
                }
                return `[it] Receipt scanning failed — missing ${fieldList}.${canEdit ? '[it]  Enter details manually.' : ''}`;
            }
            return `[it] Receipt scanning failed.${canEdit ? '[it]  Enter details manually.' : ''}`;
        },
    ...
    exitSurvey: {
        ...
        goBackJustOnce: '[it] Go back just once',
    },
    listBoundary: {
    ...
    delegate: {
        ...
        addCopilot: '[it] Add a copilot to your account',
        membersCanAccessYourAccount: '[it] These members can access your account:',
        youCanAccessTheseAccounts: '[it] You can access these accounts:',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            error: {
                ...
                moveMemberNotPolicyAdmin:
                    '[it] Cannot move member to the domain group. You must be a Policy Admin for the Preferred Policy set on the domain group you are trying to move this user to.',
            },
        ...
        groups: {
            ...
            createGroupError: '[it] Unable to create this group. Please try again.',
            permissions: '[it] Group permissions',
            createNewGroupButton: '[it] New group',
            createGroupSubmitButton: '[it] Create group',
            expensifyCardPreferredWorkspace: '[it] Expensify Card preferred workspace',
            expensifyCardPreferredWorkspaceDescription:
                '[it] All Expensify Card transactions will be created on the Expensify Card Preferred Workspace instead of the Preferred Workspace. Enabling this feature will override the Preferred Workspace setting for Expensify Card transactions only.',
            strictlyEnforceWorkspaceRules: '[it] Strictly enforce workspace rules',
            strictlyEnforceWorkspaceRulesDescription: '[it] All workspace rules must be met before submitting a report. No manual exceptions allowed.',
            restrictExpenseWorkspaceCreation: '[it] Restrict expense workspace creation/removal',
            restrictExpenseWorkspaceCreationDescription:
                '[it] Prevent members from being able to create an expense workspace or remove themselves from an expense workspace. This is useful for preventing people from using Expensify to submit reports for use outside your domain when combined with strict workspace enforcement.',
            deleteGroup: '[it] Delete Group',
            deleteGroupDangerConfirmationModal: '[it] Delete Group',
            deleteGroupDangerConfirmationModalDescription: (defaultGroupName: string) =>
                `[it] Are you sure? This will reassign all members to the default group (${defaultGroupName}) and can't be undone.`,
            deleteGroupError: '[it] Unable to delete this group. Please try again.',
            preferredWorkspace: '[it] Preferred Workspace',
            preferredWorkspaceDescription: (enabled: boolean) => `[it] All new reports and expenses will be created on ${enabled ? '[it] selected preferred' : '[it] this'} workspace.`,
            preferredWorkspaceSelectDescription: '[it] All new expenses and reports will be created on this workspace.',
            noWorkspacesMessage: '[it] There are no workspaces on this domain. A workspace is required to enable this restriction.',
            restrictDefaultLoginSelection: '[it] Restrict default login selection',
            restrictDefaultLoginSelectionDescription: '[it] Prevent members from changing their login email away from their company domain to avoid policy restrictions.',
            expensifyCardPreferredWorkspaceDisabledMessage: '[it] To enable this setting, please first enable a preferred workspace and set up Expensify Cards on your domain.',
            findGroup: '[it] Find group',
        },
    },
};
