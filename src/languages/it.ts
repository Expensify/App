...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[it] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[it] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[it] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[it] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[it] Get clients setup successfully',
            accountManagerApprovedDescription: '[it] Ask questions and get client support',
            moreResources: '[it] More resources',
        },
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[it] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[it] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[it] Go to Gusto settings',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            gusto: {
                ...
                disconnect: '[it] Disconnect',
                lastSync: (relativeDate: string) => `[it] Last synced ${relativeDate}`,
                syncError: "[it] Can't connect to Gusto",
                disconnectTitle: '[it] Disconnect Gusto',
                disconnectPrompt: '[it] Are you sure you want to disconnect Gusto?',
                ...
                notSet: '[it] Not set',
                approvalModeDescription: '[it] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[it] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[it] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[it] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[it] Basic approval',
                        description: '[it] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[it] Manager approval',
                        description: '[it] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[it] Custom approval',
                        description: '[it] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[it] Gusto sync results',
                    successTitle: '[it] Successfully synced your Gusto connection!',
                    added: '[it] Added',
                    removed: '[it] Removed',
                    skipped: '[it] Skipped',
                    employeeCount: () => ({
            ...
            zenefits: {
                ...
                disconnect: '[it] Disconnect',
                lastSync: (relativeDate: string) => `[it] Last synced ${relativeDate}`,
                syncError: "[it] Can't connect to TriNet",
                disconnectTitle: '[it] Disconnect TriNet',
                disconnectPrompt: '[it] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[it] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[it] Approval mode',
                finalApprover: '[it] Final approver',
                notSet: '[it] Not set',
                approvalModeDescription: '[it] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[it] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[it] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[it] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[it] Basic approval',
                    ...
                    manager: {
                        label: '[it] Manager approval',
                        description: '[it] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[it] Custom approval',
                        description: "[it] I'll manually setup approval workflows in Expensify.",
    ...
    search: {
        ...
        filters: {
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[it] Central invoicing',
            },
            is: '[it] Is',
            action: {
