...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            approvedPartnerTeamTitle: 'Incontra il tuo team di partner Approved!',
            approvedPartnerTeamDescription: 'Un team dedicato per aiutare il tuo studio a crescere, integrare i clienti più velocemente e ottenere supporto esperto.',
            partnerManagerApprovedDescription: 'Massimizza la tua partnership e incrementa i referral',
            accountExecutiveDescription: 'Aiuta i clienti a configurarsi con successo',
            accountManagerApprovedDescription: 'Fai domande e ottieni supporto per i clienti',
