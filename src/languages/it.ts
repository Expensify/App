...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            locked: 'Bloccato',
            incompleteDescription: "Completa l'aggiunta del conto bancario",
            pendingDescription: 'Conferma le transazioni di prova',
            verifyingDescription: 'Stiamo esaminando la tua documentazione',
            lockedDescription: 'Questo conto richiede attenzione',
            finish: 'Completa',
            confirm: 'Conferma',
            unlock: 'Sblocca',
        },
        cardFixConnection: 'Correggi questa connessione',
        cardAskAdminToFix: 'Chiedi a un amministratore di correggere questa connessione',
        cardAdminFixConnection: 'Correggi questa connessione in Carte aziendali',
        lastSynced: (dateStr: string) => `Ultima sincronizzazione ${dateStr}`,
        assignedCards: 'Carte',
