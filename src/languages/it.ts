...
Richiedi dettagli sulle spese come ricevute e descrizioni, imposta limiti e valori predefiniti e automatizza approvazioni e pagamenti, tutto in un unico posto.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                oneConditionPerRuleTitle: 'Una sola condizione per regola',
                alreadyMatchesMerchantPrompt: 'Questa regola è già associata a un esercente. Reimposta la regola per associarla invece a una categoria.',
                alreadyMatchesCategoryPrompt: 'Questa regola corrisponde già a una categoria. Reimposta la regola per farla corrispondere a un esercente.',
                ...
                onlyTaxForCategoryRulesTitle: "Solo l'imposta è disponibile per le regole di categoria",
                onlyTaxForCategoryRulesPrompt:
                    'Le regole di categoria possono impostare un’aliquota fiscale predefinita. Per impostare altri valori predefiniti, invece, abbina un esercente.',
                clearIncompatibleDefaultsTitle: 'Eliminare le altre impostazioni predefinite?',
                clearIncompatibleDefaultsPrompt: 'Questi campi non sono compatibili con la categoria. Vuoi cancellare tutti i campi?',
...
Aggiungi altre regole di spesa per proteggere il flusso di cassa aziendale.`,
            ...
            newRule: {
                ...
                createAgentRule: 'Descrivi la regola dell’agente',
                createAgentRuleDescription: 'Crea regole flessibili che vengano eseguite quando ne hai bisogno.',
            },
