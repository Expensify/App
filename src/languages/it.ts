...
const translations = {
    ...
    initialSettingsPage: {
        ...
        versionLetter: 'v',
        readTheTermsAndPrivacy: `<muted-micro-text>Leggi il <a href="${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}">Termini di Servizio</a> e <a href="${CONST.OLD_DOT_PUBLIC_URLS.PRIVACY_URL}">Privacy</a>.</muted-micro-text>`,
        help: 'Aiuto',
        whatIsNew: 'Novità',
