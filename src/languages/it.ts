...
${amount} per ${merchant} - ${date}`,
    ...
    privatePersonalDetails: {
        ...
        commuterExclusionsNote: ({workspaceName}: {workspaceName: string}) => `${workspaceName} usa questo indirizzo per le esclusioni dei tragitti.`,
        error: {
...
3. Una volta che il feed è abilitato, fai clic su Invia qui sotto e noi ci occuperemo di aggiungerlo.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: 'Sottrai da ogni richiesta di distanza il tragitto di ciascun membro tra la sua casa e l’indirizzo dell’area di lavoro.',
                workspaceAddressRequired: {
                    title: 'Ops, non così in fretta...',
                    prompt: 'Quest’area di lavoro non ha ancora un indirizzo. Aggiungine uno in modo che le esclusioni dei tragitti possano usarlo.',
                    cta: 'Aggiungi indirizzo',
                },
                errors: {
