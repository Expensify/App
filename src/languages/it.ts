...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                fireworksTitle: '[it] All caught up',
                fireworksDescription: '[it] Upcoming to-dos will appear here.',
            },
        },
    ...
    iou: {
        ...
        error: {
            ...
            nonReimbursablePayment: '[it] Cannot pay via Expensify',
            nonReimbursablePaymentDescription: (isMultiple?: boolean) =>
                isMultiple
                    ? "[it] One or more selected reports don't have reimbursable expenses. Double check the expenses, or manually mark as paid."
                    : "[it] The report doesn't have reimbursable expenses. Double check the expenses, or manually mark as paid.",
        },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        emptyWorkspace: {
            title: '[it] You have no workspaces',
            subtitle: '[it] Track receipts, reimburse expenses, manage travel, send invoices, and more.',
