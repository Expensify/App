...
Richiedi dettagli sulle spese come ricevute e descrizioni, imposta limiti e valori predefiniti e automatizza approvazioni e pagamenti, tutto in un unico posto.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                turnOnTaxesFirstTitle: 'Attiva prima le imposte',
...
Aggiungi altre regole di spesa per proteggere il flusso di cassa aziendale.`,
            ...
            newRule: {
                ...
                createAgentRuleDescription: 'Crea regole flessibili che si attivano quando ne hai bisogno.',
            },
            expenseDefaultsTable: {
                ...
                categoryIs: (category: string) => `Categoria: "${category}"`,
            },
            ...
            expenseDefaultType: {
                title: 'Applica le impostazioni predefinite delle spese',
                subtitle: 'Su cosa deve corrispondere questa regola?',
                merchant: 'Esercente',
            ...
            taxesDisabledEmptyState: {title: 'Le imposte non sono abilitate', subtitle: 'Abilita le imposte per documentare e recuperare le imposte ammissibili.', cta: 'Abilita tasse'},
        },
        planTypePage: {
            planTypes: {
                team: {
