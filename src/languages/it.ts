...
3. Una volta che il feed è stato abilitato, clicca su Invia qui sotto e noi procederemo ad aggiungerlo.`,
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `Segnaposto formula non valido/i: ${placeholders}. Utilizza segnaposto supportati come {report:id}, {report:name}, {report:created}, ecc.`,
