...
Se vuoi assumere la fatturazione per l'intero abbonamento, chiedi loro di aggiungerti prima come amministratore a tutti i loro spazi di lavoro, prima di assumere la fatturazione.`,
        ...
        exportAgainModal: {
            title: 'Attenzione!',
            description: (reportName: string, connectionName: ConnectionName) => `I seguenti report sono già stati esportati in ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}. Sei sicuro di volerli esportare di nuovo?
