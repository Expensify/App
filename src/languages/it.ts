...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
            ...
            invalidDateShouldBeFuture: 'Seleziona la data di oggi o una data futura',
            invalidTimeShouldBeFuture: 'Scegli un orario almeno un minuto dopo',
            ...
            pleaseCompleteForm: 'Compila il modulo sopra per continuare',
        ...
        message: 'Messaggio',
        leaveThread: 'Lascia conversazione',
        you: 'Tu',
        ...
        attachmentWillBeAvailableOnceBackOnline: 'L’allegato sarà disponibile una volta che torni online.',
        ...
        rate: 'Valuta',
        emptyLHN: {
            title: 'Woohoo! Sei in pari con tutto.',
            subtitleText1: 'Trova una chat utilizzando il',
            subtitleText2: 'pulsante sopra o creare qualcosa utilizzando il',
        ...
        import: 'Importa',
        offlinePrompt: 'Al momento non puoi eseguire questa azione.',
        ...
        rateOutOfPolicy: 'Aliquota fuori politica',
        ...
        leaveWorkspaceConfirmationApprover: ({workspaceOwner}: {workspaceOwner: string}) =>
            `Se lasci questo workspace, nel flusso di approvazione verrai sostituito da ${workspaceOwner}, il proprietario del workspace.`,
        ...
        leaveWorkspaceReimburser:
            'Non puoi lasciare questo spazio di lavoro come rimborsatore. Imposta un nuovo rimborsatore in Spazi di lavoro > Effettua o traccia pagamenti, quindi riprova.',
    ...
    lockedAccount: {
        ...
        description: 'Non puoi completare questa azione perché questo account è stato bloccato. Contatta concierge@expensify.com per i prossimi passaggi.',
    },
    location: {
        useCurrent: 'Usa posizione corrente',
    ...
    contact: {
        ...
        importContactsNativeText: 'Solo un altro passaggio! Dacci il via libera per importare i tuoi contatti.',
    },
    ...
    validateCodeModal: {
        ...
        description: dedent(`
            ...
            in cui è stato richiesto originariamente
        `),
        doNotShare: dedent(`
    ...
    customApprovalWorkflow: {
        ...
        description: 'La tua azienda ha un flusso di approvazione personalizzato in questo spazio di lavoro. Esegui questa azione in Expensify Classic',
        goToExpensifyClassic: 'Passa a Expensify Classic',
    },
    emptyList: {
        [CONST.IOU.TYPE.CREATE]: {
            title: 'Invia una nota spese, invita il tuo team',
            subtitleText: 'Vuoi che anche il tuo team usi Expensify? Ti basta inviare loro una nota spese e noi ci occuperemo del resto.',
        },
    },
    ...
    welcomeText: {
        ...
        phrase3: 'I tuoi pagamenti arrivano da te veloci quanto riesci a farti capire.',
    ...
    login: {
        hero: {
            ...
            body: 'Benvenuto nella nuova generazione di Expensify, dove i tuoi viaggi e le tue spese procedono più velocemente grazie a una chat contestuale in tempo reale.',
        },
    },
    thirdPartySignIn: {
        ...
        continueWithMyCurrentSession: 'Continua con la mia sessione corrente',
    ...
    reportActionContextMenu: {
        ...
        flagAsOffensive: 'Contrassegna come offensivo',
        menu: 'Menu',
    },
    emojiReactions: {
    ...
    sidebarScreen: {
        ...
        fabScanReceiptExplained: 'Scansiona ricevuta (Azione rapida flottante)',
        ...
        redirectToExpensifyClassicModal: {
            ...
            description: 'Stiamo perfezionando ancora alcuni dettagli del New Expensify per adattarlo alla tua configurazione specifica. Nel frattempo, passa a Expensify Classic.',
        },
    },
    allSettingsScreen: {
    ...
    spreadsheet: {
        ...
        singleFieldMultipleColumns: ({fieldName}: SpreadFieldNameParams) => `Ops! Hai associato un singolo campo ("${fieldName}") a più colonne. Per favore, controlla e riprova.`,
        ...
        importCategoriesSuccessfulDescription: ({categories}: SpreadCategoriesParams) => (categories > 1 ? `Sono state aggiunte ${categories} categorie.` : 'È stata aggiunta 1 categoria.'),
        importMembersSuccessfulDescription: ({added, updated}: ImportMembersSuccessfulDescriptionParams) => {
            ...
            return added > 1 ? `Sono stati aggiunti ${added} membri.` : '1 membro è stato aggiunto.';
        },
        ...
        importPerDiemRatesSuccessfulDescription: ({rates}: ImportPerDiemRatesSuccessfulDescriptionParams) =>
            rates > 1 ? `Sono state aggiunte tariffe giornaliere pari a ${rates}.` : '1 tariffa diaria è stata aggiunta.',
        ...
        importMemberConfirmation: () => ({
            one: `Conferma i dettagli qui sotto per un nuovo membro dell’area di lavoro che verrà aggiunto come parte di questo caricamento. I membri esistenti non riceveranno aggiornamenti di ruolo né messaggi di invito.`,
            other: (count: number) =>
                `Conferma i dettagli qui sotto per i ${count} nuovi membri dello spazio di lavoro che verranno aggiunti come parte di questo caricamento. I membri già esistenti non riceveranno aggiornamenti di ruolo o messaggi di invito.`,
        }),
    },
    receipt: {
        ...
        allowLocationFromSetting: `L’accesso alla posizione ci aiuta a mantenere sempre accurati il tuo fuso orario e la tua valuta, ovunque tu vada. Consenti l’accesso alla posizione dalle impostazioni dei permessi del tuo dispositivo.`,
        ...
        addReceipt: 'Aggiungi ricevuta',
        scanFailed: 'La ricevuta non può essere acquisita perché mancano l’esercente, la data o l’importo.',
    },
    quickAction: {
        scanReceipt: 'Scansiona ricevuta',
        recordDistance: 'Traccia distanza',
        requestMoney: 'Crea spesa',
        perDiem: 'Crea indennità di diaria',
    ...
    iou: {
        ...
        makeSplitsEven: 'Rendi le quote uguali',
        ...
        routePending: 'Itinerario in sospeso...',
        receiptScanning: () => ({
            one: 'Scansione ricevuta...',
            other: 'Scansione delle ricevute in corso...',
        }),
        scanMultipleReceipts: 'Scansiona più ricevute',
        scanMultipleReceiptsDescription: 'Scatta foto di tutte le tue ricevute in una volta sola, poi conferma tu stesso i dettagli oppure lasciali confermare a noi.',
        receiptScanInProgress: 'Scansione ricevuta in corso',
        receiptScanInProgressDescription: 'Scansione della ricevuta in corso. Controlla più tardi o inserisci ora i dettagli.',
        removeFromReport: 'Rimuovi dal rapporto',
        moveToPersonalSpace: 'Sposta le spese nel tuo spazio personale',
        duplicateTransaction: ({isSubmitted}: DuplicateTransactionParams) =>
            !isSubmitted
                ? 'Potenziali spese duplicate rilevate. Esamina i duplicati per abilitare l’invio.'
                : 'Potenziali spese duplicate individuate. Controlla i duplicati per consentire l’approvazione.',
        receiptIssuesFound: () => ({
        ...
        receiptStatusText: 'Solo tu puoi vedere questa ricevuta mentre viene acquisita. Torna più tardi o inserisci subito i dettagli.',
        ...
        companyInfoDescription: 'Abbiamo bisogno di qualche altro dettaglio prima che tu possa inviare la tua prima fattura.',
        yourCompanyName: 'Nome della tua azienda',
        yourCompanyWebsite: 'Sito web della tua azienda',
        yourCompanyWebsiteNote: 'Se non hai un sito web, puoi fornire il profilo LinkedIn o un profilo social della tua azienda.',
        ...
        expenseCountWithStatus: ({scanningReceipts = 0, pendingReceipts = 0}: RequestCountParams) => {
            ...
            if (scanningReceipts > 0) {
                statusText.push(`${scanningReceipts} in scansione`);
            }
        ...
        submitted: ({memo}: SubmittedWithMemoParams) => `inviata${memo ? `, dicendo ${memo}` : ''}`,
        ...
        automaticallyApproved: `approvata tramite <a href="${CONST.CONFIGURE_EXPENSE_REPORT_RULES_HELP_URL}">regole dell’area di lavoro</a>`,
        approvedAmount: ({amount}: ApprovedAmountParams) => `approvato ${amount}`,
        approvedMessage: `Approvato`,
        unapproved: `Non approvato`,
        automaticallyForwarded: `approvata tramite <a href="${CONST.CONFIGURE_EXPENSE_REPORT_RULES_HELP_URL}">regole dell’area di lavoro</a>`,
        forwarded: `Approvato`,
        rejectedThisReport: 'ha rifiutato questo resoconto',
        waitingOnBankAccount: ({submitterDisplayName}: WaitingOnBankAccountParams) => `pagamento avviato, in attesa che ${submitterDisplayName} aggiunga un conto bancario.`,
        adminCanceledRequest: 'ha annullato il pagamento',
        canceledRequest: ({amount, submitterDisplayName}: CanceledRequestParams) =>
            `ha annullato il pagamento di ${amount}, perché ${submitterDisplayName} non ha attivato il suo Expensify Wallet entro 30 giorni`,
        settledAfterAddedBankAccount: ({submitterDisplayName, amount}: SettledAfterAddedBankAccountParams) =>
            `${submitterDisplayName} ha aggiunto un conto bancario. Il pagamento di ${amount} è stato effettuato.`,
        paidElsewhere: ({payer}: PaidElsewhereParams = {}) => `${payer ? `${payer} ` : ''}contrassegnato come pagato`,
        paidWithExpensify: ({payer}: PaidWithExpensifyParams = {}) => `${payer ? `${payer} ` : ''}pagato con Wallet`,
        ...
        setTheDistanceMerchant: ({translatedChangedField, newMerchant, newAmountToDisplay}: SetTheDistanceMerchantParams) =>
            `imposta ${translatedChangedField} su ${newMerchant}, il che imposta l’importo su ${newAmountToDisplay}`,
        ...
        movedFromPersonalSpace: ({workspaceName, reportName}: MovedFromPersonalSpaceParams) => `spesa spostata dallo spazio personale a ${workspaceName ?? `chat con ${reportName}`}`,
        ...
        error: {
            ...
            invalidTagLength: 'Il nome del tag supera i 255 caratteri. Accorcialo o scegli un tag diverso.',
            ...
            genericHoldExpenseFailureMessage: 'Errore imprevisto durante la messa in sospeso di questa spesa. Riprova più tardi.',
        ...
        waitingOnEnabledWallet: ({submitterDisplayName}: WaitingOnBankAccountParams) =>
            `ha iniziato a saldare il conto. Il pagamento è in sospeso finché ${submitterDisplayName} non abilita il suo portafoglio.`,
        ...
        addUnreportedExpense: 'Aggiungi spesa non riportata',
        ...
        emptyStateUnreportedExpenseSubtitle: 'Sembra che tu non abbia spese non riportate. Prova a crearne una qui sotto.',
        ...
        reopenExportedReportConfirmation: ({connectionName}: {connectionName: string}) =>
            `Questo report è già stato esportato in ${connectionName}. Apportare modifiche potrebbe causare discrepanze nei dati. Sei sicuro di voler riaprire questo report?`,
        reason: 'Motivo',
        ...
        confirmApprove: 'Conferma importo di approvazione',
        ...
        confirmPayAmount: 'Paga ciò che non è bloccato oppure paga l’intero report.',
        confirmPayAllHoldAmount: () => ({
            one: 'Questa spesa è in sospeso. Vuoi pagarla comunque?',
            other: 'Queste spese sono in sospeso. Vuoi comunque procedere al pagamento?',
        }),
        payOnly: 'Paga solo',
        ...
        chooseARate: 'Seleziona una tariffa di rimborso per spazio di lavoro per miglio o chilometro',
        unapprove: 'Revoca approvazione',
        unapproveReport: 'Revoca approvazione report',
        headsUp: 'Attenzione!',
        unapproveWithIntegrationWarning: ({accountingIntegration}: UnapproveWithIntegrationWarningParams) =>
            `Questo report è già stato esportato su ${accountingIntegration}. Modificarlo può causare discrepanze nei dati. Sei sicuro di voler revocare l’approvazione di questo report?`,
        reimbursable: 'rimborsabile',
        ...
        reject: {
            ...
            holdExpenseTitle: 'Metti in sospeso una spesa per chiedere ulteriori dettagli prima dell’approvazione o del pagamento.',
        ...
        changeApprover: {
            title: 'Modifica approvatore',
            subtitle: 'Scegli un’opzione per modificare l’approvatore di questo report.',
            description: ({workflowSettingLink}: WorkflowSettingsParam) =>
                `Puoi anche cambiare in modo permanente l’approvatore per tutti i report nelle tue <a href="${workflowSettingLink}">impostazioni del flusso di lavoro</a>.`,
            changedApproverMessage: ({managerID}: ChangedApproverMessageParams) => `approvatore modificato in <mention-user accountID="${managerID}"/>`,
            actions: {
                ...
                bypassApproversSubtitle: 'Impostati come approvatore finale e salta tutti gli altri approvatori rimanenti.',
            },
            addApprover: {
                subtitle: 'Scegli un approvatore aggiuntivo per questo resoconto prima di instradarlo attraverso il resto del flusso di approvazione.',
            },
        },
    ...
    transactionMerge: {
        ...
        confirmationPage: {
            ...
            pageTitle: 'Conferma i dettagli che manterrai. I dettagli che non manterrai verranno eliminati.',
    ...
    loginField: {
        numberHasNotBeenValidated: 'Il numero non è stato convalidato. Fai clic sul pulsante per rinviare il link di convalida via SMS.',
    ...
    nextStep: {
        message: {
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.NO_FURTHER_ACTION]: (_: NextStepParams) => `Nessun ulteriore intervento richiesto!`,
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_POLICY_BANK_ACCOUNT]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    ...
                    case CONST.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return `In attesa che un amministratore termini la configurazione di un conto bancario aziendale.`;
                }
            },
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_PAYMENT]: ({eta, etaType}: NextStepParams) => {
                ...
                return `In attesa del completamento del pagamento${formattedETA}.`;
            },
        },
        eta: {
    ...
    securityPage: {
        ...
        goToSecurity: 'Torna alla pagina Sicurezza',
    },
    shareCodePage: {
        title: 'Il tuo codice',
        subtitle: 'Invita i membri a Expensify condividendo il tuo codice QR personale o il tuo link di invito.',
    },
    pronounsPage: {
        pronouns: 'Pronomi',
    ...
    contacts: {
        ...
        helpText: ({email}: {email: string}) =>
            `Aggiungi più modalità per accedere e inviare ricevute a Expensify.<br/><br/>Aggiungi un indirizzo email a cui inoltrare le ricevute a <a href="mailto:${email}">${email}</a> oppure aggiungi un numero di telefono per inviare le ricevute tramite SMS al 47777 (solo numeri degli Stati Uniti).`,
    ...
    timezonePage: {
        timezone: 'Fuso orario',
        isShownOnProfile: 'Il tuo fuso orario è visualizzato sul tuo profilo.',
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            description:
                "<muted-text>Utilizza gli strumenti qui sotto per risolvere i problemi dell'esperienza su Expensify. Se riscontri qualsiasi problema, ti preghiamo di <concierge-link>segnalare un bug</concierge-link>.</muted-text>",
            ...
            simulateFailingNetworkRequests: 'Simula errori di rete',
            ...
            resetToOriginalState: 'Ripristina stato originale',
            ...
            softKillTheApp: "Termina l'app in modo soft",
            kill: 'Uccidi',
        },
        debugConsole: {
        ...
        security: 'Sicurezza',
        signOut: 'Disconnetti',
        restoreStashed: 'Ripristina accesso archiviato',
    ...
    mergeAccountsPage: {
        ...
        mergePendingSAML: {
            ...
            limitedSupport: 'Al momento non supportiamo ancora l’unione degli account su New Expensify. Effettua questa operazione su Expensify Classic.',
        ...
        mergeFailureSAMLAccountDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Non puoi unire <strong>${email}</strong> ad altri account perché l’amministratore del tuo dominio l’ha impostata come login principale. Unisci invece gli altri account a questa.</centered-text></muted-text>`,
        mergeFailure2FA: {
            description: ({email}: MergeFailureDescriptionGenericParams) =>
                `<muted-text><centered-text>Non è possibile unire gli account perché <strong>${email}</strong> ha l’autenticazione a due fattori (2FA) abilitata. Disabilita la 2FA per <strong>${email}</strong> e riprova.</centered-text></muted-text>`,
        ...
        mergeFailureUncreatedAccountDescription: ({email, contactMethodLink}: MergeFailureUncreatedAccountDescriptionParams) =>
            `<muted-text><centered-text>Non puoi unire gli account perché <strong>${email}</strong> non ha un account Expensify. Invece, <a href="${contactMethodLink}">aggiungila come metodo di contatto</a>.</centered-text></muted-text>`,
        ...
        mergeFailureInvoicedAccountDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Non puoi unire gli account in <strong>${email}</strong> perché questo account è proprietario di un rapporto di fatturazione con fattura emessa.</centered-text></muted-text>`,
        mergeFailureTooManyAttempts: {
            heading: 'Riprova più tardi',
            description: 'Ci sono stati troppi tentativi di unire gli account. Riprova più tardi.',
        },
        mergeFailureUnvalidatedAccount: {
            description: "Non puoi unire altri account perché non è stato convalidato. Convalida l'account e riprova.",
        },
        mergeFailureSelfMerge: {
            description: 'Non è possibile unire un account con se stesso.',
        },
    ...
    lockAccountPage: {
        ...
        compromisedDescription:
            'Hai notato qualcosa di strano nel tuo account? Segnalarlo bloccherà immediatamente il tuo account, impedirà nuove transazioni con la Expensify Card e preverrà qualsiasi modifica all’account.',
        domainAdminsDescription:
            'Per gli amministratori di dominio: questa azione sospende anche tutta l’attività delle Expensify Card e le azioni amministrative all’interno del/i tuo/i dominio/i.',
    ...
    passwordPage: {
        ...
        changingYourPasswordPrompt: 'Modificare la password aggiornerà la tua password sia per il tuo account Expensify.com che per il tuo account New Expensify.',
    ...
    twoFactorAuth: {
        ...
        whatIsTwoFactorAuth:
            'L’autenticazione a due fattori (2FA) aiuta a mantenere il tuo account al sicuro. Quando effettui l’accesso, dovrai inserire un codice generato dalla tua app di autenticazione preferita.',
        ...
        codesLoseAccess: dedent(`
            ...
            Nota: la configurazione dell’autenticazione a due fattori ti farà disconnettere da tutte le altre sessioni attive.
        `),
        ...
        congrats: 'Congratulazioni! Ora hai quella sicurezza aggiuntiva.',
        copy: 'Copia',
        disable: 'Disattiva',
        ...
        twoFactorAuthIsRequiredForAdminsTitle: 'Per favore abilita l’autenticazione a due fattori',
        twoFactorAuthIsRequiredXero: 'La tua connessione contabile a Xero richiede l’uso dell’autenticazione a due fattori. Per continuare a utilizzare Expensify, abilitala.',
    ...
    privateNotes: {
        ...
        sharedNoteMessage: 'Tieni qui le note su questa chat. I dipendenti di Expensify e gli altri membri del dominio team.expensify.com possono visualizzare queste note.',
        composerLabel: 'Note',
        myNote: 'La mia nota',
        error: {
    ...
    addDebitCardPage: {
        ...
        error: {
            ...
            password: 'Per favore inserisci la tua password Expensify',
        },
    },
    addPaymentCardPage: {
    ...
    walletPage: {
        ...
        getPaidBackFaster: 'Fatti rimborsare più velocemente',
        ...
        addBankAccountBody: 'Colleghiamo il tuo conto bancario a Expensify così sarà più facile che mai inviare e ricevere pagamenti direttamente dall’app.',
    ...
    cardPage: {
        ...
        smartLimit: {
            ...
            title: ({formattedLimit}: ViolationsOverLimitParams) =>
                `Puoi spendere fino a ${formattedLimit} con questa carta e il limite verrà ripristinato man mano che le spese che hai inviato vengono approvate.`,
        },
        fixedLimit: {
            name: 'Limite fisso',
        ...
        monthlyLimit: {
            name: 'Limite mensile',
            title: ({formattedLimit}: ViolationsOverLimitParams) =>
                `Puoi spendere fino a ${formattedLimit} al mese con questa carta. Il limite verrà azzerato il primo giorno di ogni mese di calendario.`,
        },
        ...
        reportFraud: 'Segnala frode sulla carta virtuale',
        ...
        suspiciousBannerDescription: 'Abbiamo rilevato transazioni sospette sulla tua carta. Tocca qui sotto per verificarle.',
...
${amount} per ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        customApprovalWorkflowEnabled:
            '<muted-text-label>Un flusso di approvazione personalizzato è abilitato in questo spazio di lavoro. Per rivedere o modificare questo flusso di lavoro, contatta il tuo <account-manager-link>Account Manager</account-manager-link> o <concierge-link>Concierge</concierge-link>.</muted-text-label>',
        customApprovalWorkflowEnabledConciergeOnly:
            '<muted-text-label>Un flusso di approvazione personalizzato è abilitato per questo spazio di lavoro. Per rivedere o modificare questo flusso di lavoro, contatta <concierge-link>Concierge</concierge-link>.</muted-text-label>',
        editor: {
    ...
    reportFraudPage: {
        title: 'Segnala frode sulla carta virtuale',
        description:
        ...
        reportVirtualCardFraud: 'Segnala frode sulla carta virtuale',
    },
    ...
    activateCardPage: {
        ...
        error: {
            ...
            throttled:
                'Hai inserito le ultime 4 cifre della tua Expensify Card in modo errato troppe volte. Se sei sicuro che i numeri siano corretti, contatta Concierge per risolvere il problema. Altrimenti, riprova più tardi.',
        },
    },
    getPhysicalCard: {
    ...
    transferAmountPage: {
        ...
        instantSummary: ({rate, minAmount}: InstantSummaryParams) => `Commissione del ${rate}% (minimo ${minAmount})`,
        ...
        failedTransfer: 'Il tuo saldo non è completamente saldato. Effettua un trasferimento verso un conto bancario.',
    ...
    groupChat: {
        ...
        lastMemberWarning: 'Dato che sei l’ultima persona qui, se lasci la chat diventerà inaccessibile a tutti i membri. Sei sicuro di voler lasciare?',
    ...
    validateCodeForm: {
        ...
        requiredWhen2FAEnabled: "Obbligatorio quando l'2FA è abilitata",
    ...
    passwordForm: {
        ...
        error: {
            ...
            unableToResetPassword:
                'Non siamo riusciti a cambiare la tua password. Questo è probabilmente dovuto a un link di reimpostazione della password scaduto in una vecchia email di reimpostazione. Ti abbiamo inviato un nuovo link via email in modo che tu possa riprovare. Controlla la Posta in arrivo e la cartella Spam; dovrebbe arrivare tra pochi minuti.',
    ...
    onboarding: {
        ...
        explanationModal: {
            ...
            description: 'Un’unica app per gestire le tue spese aziendali e personali alla velocità di una chat. Provala e facci sapere cosa ne pensi. Molto altro in arrivo!',
        ...
        peopleYouMayKnow: 'Altre persone che potresti conoscere sono già qui! Verifica la tua email per unirti a loro.',
        ...
        mergeBlockScreen: {
            ...
            subtitle: ({workEmail}: WorkEmailMergingBlockedParams) =>
                `Non è stato possibile aggiungere ${workEmail}. Riprova più tardi in Impostazioni oppure chatta con Concierge per assistenza.`,
        },
        tasks: {
            testDriveAdminTask: {
            ...
            testDriveEmployeeTask: {
                title: ({testDriveURL}) => `Fai un [test drive](${testDriveURL})`,
                description: ({testDriveURL}) => `Fai un [giro di prova](${testDriveURL}) e ottieni per il tuo team *3 mesi gratis di Expensify!*`,
            },
            ...
            createTestDriveAdminWorkspaceTask: {
                title: ({workspaceConfirmationLink}) => `[Creare](${workspaceConfirmationLink}) uno spazio di lavoro`,
                description: 'Crea un workspace e configura le impostazioni con l’aiuto del tuo specialista di configurazione!',
            },
            createWorkspaceTask: {
                title: ({workspaceSettingsLink}) => `Crea uno [spazio di lavoro](${workspaceSettingsLink})`,
                description: ({workspaceSettingsLink}) =>
                    dedent(`
                        *Crea un workspace* per tenere traccia delle spese, scansionare ricevute, chattare e altro ancora.

                        1. Fai clic su *Workspaces* > *New workspace*.
            ...
            addAccountingIntegrationTask: {
                ...
                description: ({integrationName, workspaceAccountingLink}) =>
                    dedent(`
                        Collega ${integrationName === CONST.ONBOARDING_ACCOUNTING_MAPPING.other ? 'il tuo' : 'a'} ${integrationName} per la codifica automatica delle spese e la sincronizzazione che rende la chiusura di fine mese semplicissima.
...
${
    integrationName && CONST.connectionsVideoPaths[integrationName]
        ...
        : `[Portami alla contabilità](${workspaceAccountingLink}).`
            ...
            inviteTeamTask: {
                ...
                description: ({workspaceMembersLink}) =>
                    dedent(`
                        *Invita il tuo team* su Expensify così potrà iniziare a tenere traccia delle spese già da oggi.

                        1. Clicca su *Workspaces*.
                        3. Seleziona il tuo workspace.
                        4. Clicca su *Members* > *Invite member*.
                        5. Inserisci email o numeri di telefono.
                        6. Aggiungi un messaggio di invito personalizzato se lo desideri!
            ...
            setupCategoriesAndTags: {
                title: ({workspaceCategoriesLink, workspaceTagsLink}) => `Imposta [categorie](${workspaceCategoriesLink}) e [tag](${workspaceTagsLink})`,
                description: ({workspaceCategoriesLink, workspaceAccountingLink}) =>
                    dedent(`
                        *Configura categorie e tag* in modo che il tuo team possa codificare le spese per semplificare i report.

                        Importale automaticamente [collegando il tuo software di contabilità](${workspaceAccountingLink}), oppure configuarale manualmente nelle [impostazioni dell’area di lavoro](${workspaceCategoriesLink}).`),
            },
            setupTagsTask: {
                title: ({workspaceTagsLink}) => `Imposta [tag](${workspaceTagsLink})`,
                description: ({workspaceMoreFeaturesLink}) =>
                    dedent(`
            ...
            startChatTask: {
                ...
                description: dedent(`
                    *Inizia una chat* con chiunque utilizzando la sua email o il suo numero di telefono.
                    ...
                    Ogni chat diventerà anche un’email o un SMS a cui potranno rispondere direttamente.
                `),
            },
            splitExpenseTask: {
                ...
                description: dedent(`
                    *Dividi le spese* con una o più persone.
                    ...
                    Sentiti libero di aggiungere più dettagli se vuoi, oppure inviala e basta. Così verrai rimborsato!
                `),
            },
            reviewWorkspaceSettingsTask: {
                title: ({workspaceSettingsLink}) => `Rivedi le [impostazioni dell’area di lavoro](${workspaceSettingsLink})`,
                description: ({workspaceSettingsLink}) =>
                    dedent(`
                        Ecco come rivedere e aggiornare le impostazioni del tuo workspace:
                        1. Clicca su Workspaces.
                        2. Seleziona il tuo workspace.
                        3. Controlla e aggiorna le tue impostazioni.
            ...
            createReportTask: {
                ...
                description: dedent(`
                    ...
                    1. Clicca il pulsante ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE}.
        ...
        testDrive: {
            name: ({testDriveURL}: {testDriveURL?: string}) => (testDriveURL ? `Fai un [test drive](${testDriveURL})` : 'Fai una prova'),
        ...
        messages: {
            ...
            onboardingManageTeamMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) =>
                isOnboardingFlow
                    ...
                    : dedent(`
                        ...
                        👋 Ciao, sono il tuo specialista di configurazione Expensify. Ora che hai creato un workspace, sfrutta al massimo la tua prova gratuita di 30 giorni seguendo i passaggi qui sotto!
                    `),
            onboardingTrackWorkspaceMessage:
                '# Configuriamo il tuo account\n👋 Ciao, sono il tuo specialista per la configurazione di Expensify. Ho già creato uno spazio di lavoro per aiutarti a gestire le tue ricevute e spese. Per sfruttare al massimo la tua prova gratuita di 30 giorni, segui semplicemente i passaggi di configurazione rimanenti qui sotto!',
            ...
            onboardingLookingAroundMessage:
                'Expensify è conosciuta soprattutto per la gestione delle note spese, dei viaggi e delle carte aziendali, ma facciamo molto più di questo. Fammi sapere cosa ti interessa e ti aiuterò a iniziare.',
        ...
        workspace: {
            ...
            explanationModal: {
                ...
                descriptionTwo: 'Classifica e assegna tag alle spese',
                descriptionThree: 'Crea e condividi report',
            },
            price: 'Provalo gratis per 30 giorni, poi passa all’upgrade per soli <strong>$5/utente/mese</strong>.',
    ...
    privatePersonalDetails: {
        ...
        privateDataMessage: 'Questi dettagli vengono utilizzati per i viaggi e i pagamenti. Non vengono mai mostrati nel tuo profilo pubblico.',
        legalName: 'Nome legale',
        legalFirstName: 'Nome legale di battesimo',
        legalLastName: 'Cognome legale',
        address: 'Indirizzo',
        error: {
            ...
            incorrectZipFormat: ({zipFormat}: IncorrectZipFormatParams = {}) => `Formato codice postale non corretto${zipFormat ? `Formato accettabile: ${zipFormat}` : ''}`,
            invalidPhoneNumber: `Assicurati che il numero di telefono sia valido (es. ${CONST.EXAMPLE_PHONE_NUMBER})`,
        },
    },
    ...
    emailDeliveryFailurePage: {
        ourEmailProvider: ({login}: OurEmailProviderParams) =>
            `Il nostro provider di email ha temporaneamente sospeso l’invio di email a ${login} a causa di problemi di consegna. Per sbloccare il tuo login, segui questi passaggi:`,
    ...
    openAppFailureModal: {
        ...
        subtitle: `Non siamo riusciti a caricare tutti i tuoi dati. Siamo stati avvisati e stiamo esaminando il problema. Se persiste, contatta`,
    ...
    smsDeliveryFailurePage: {
        ...
        validationFailed: ({
            ...
            return `Resisti! Devi aspettare ${timeText} prima di provare di nuovo a convalidare il tuo numero.`;
        },
    },
    welcomeSignUpForm: {
        join: 'Unisciti',
    ...
    setPasswordPage: {
        ...
        setPasswordLinkInvalid: 'Questo link per impostare la password non è valido o è scaduto. Un nuovo link ti aspetta nella tua casella email!',
    ...
    statusPage: {
        ...
        whenClearStatus: 'Quando dovremmo azzerare il tuo stato?',
        ...
        vacationDelegateWarning: ({nameOrEmail}: VacationDelegateParams) =>
            `Stai assegnando ${nameOrEmail} come delegato per le vacanze. Non è ancora presente in tutti i tuoi spazi di lavoro. Se scegli di continuare, verrà inviata un’email a tutti gli amministratori dei tuoi spazi di lavoro per aggiungerlo.`,
    },
    ...
    bankAccount: {
        ...
        error: {
            ...
            routingNumber: 'Per favore inserisci un numero di instradamento valido',
            ...
            age: 'Deve avere più di 18 anni',
            ssnLast4: 'Inserisci le ultime 4 cifre valide del SSN',
            firstName: 'Per favore inserisci un nome di battesimo valido',
            lastName: 'Inserisci un cognome valido',
            noDefaultDepositAccountOrDebitCardAvailable: 'Aggiungi un conto di accredito predefinito o una carta di debito',
            ...
            ownershipPercentage: 'Per favore inserisci una percentuale valida',
    ...
    addPersonalBankAccountPage: {
        ...
        successMessage: 'Complimenti, il tuo conto bancario è configurato ed è pronto per ricevere rimborsi.',
    },
    attachmentView: {
    ...
    onfidoStep: {
        ...
        butFirst: `Ma prima, le cose noiose. Leggi il gergo legale nel passaggio successivo e fai clic su “Accetta” quando sei pronto.`,
        ...
        cameraRequestMessage: 'Abbiamo bisogno di accedere alla fotocamera per completare la verifica del conto bancario. Abilitala tramite Impostazioni > New Expensify.',
        microphonePermissionsNotGranted: 'Abilita accesso al microfono',
        ...
        documentNeedsBetterQuality:
            'La tua carta d’identità sembra danneggiata o priva di alcune caratteristiche di sicurezza. Carica un’immagine originale di una carta d’identità integra, completamente visibile.',
    ...
    additionalDetailsStep: {
        ...
        needSSNFull9: 'Stiamo riscontrando problemi nel verificare il tuo SSN. Inserisci tutti e nove le cifre del tuo SSN.',
    ...
    termsStep: {
        ...
        haveReadAndAgreePlain: 'Ho letto e accetto di ricevere le comunicazioni elettroniche.',
        ...
        shortTermsForm: {
            ...
            customerService: 'Servizio clienti (automatico o operatore live)',
            ...
            electronicFundsWithdrawalInstant: 'Prelievo elettronico di fondi (istantaneo)',
        ...
        longTermsForm: {
            ...
            openingAccountDetails: 'Non c’è alcuna commissione per aprire un conto.',
            ...
            electronicFundsStandardDetails:
                'Non è prevista alcuna commissione per trasferire fondi dal tuo Wallet Expensify al tuo conto bancario utilizzando l’opzione standard. Questo trasferimento di solito viene completato entro 1-3 giorni lavorativi.',
            ...
            fdicInsuranceBancorp: ({amount}: TermsParams) =>
                ...
                `Una volta lì, i tuoi fondi sono assicurati fino a ${amount} dalla FDIC nel caso in cui ${CONST.WALLET.PROGRAM_ISSUERS.BANCORP_BANK} fallisca, se sono soddisfatti i requisiti specifici dell’assicurazione sui depositi e la tua carta è registrata. Per maggiori dettagli, consulta ${CONST.TERMS.FDIC_PREPAID}.`,
    ...
    personalInfoStep: {
        ...
        weNeedThisToVerify: 'Ci serve questo per verificare il tuo portafoglio.',
    },
    businessInfoStep: {
        ...
        error: {
            ...
            taxIDEIN: ({country}: BusinessTaxIDParams) => {
                switch (country) {
                    case CONST.COUNTRY.US:
                        return 'Per favore, inserisci un numero di identificazione del datore di lavoro (EIN) valido';
                    case CONST.COUNTRY.CA:
                        return 'Inserisci un numero Business Number (BN) valido';
                    case CONST.COUNTRY.GB:
                        return 'Inserisci un numero di partita IVA (VRN) valido';
                    case CONST.COUNTRY.AU:
                        return 'Inserisci un numero di Australian Business Number (ABN) valido';
                    default:
    ...
    beneficialOwnerInfoStep: {
        ...
        companyOwner: "Titolare dell'azienda",
        ...
        letsDoubleCheck: 'Controlliamo di nuovo che sia tutto corretto.',
        legalName: 'Nome legale',
        address: 'Indirizzo',
        byAddingThisBankAccount: 'Aggiungendo questo conto bancario, confermi di aver letto, compreso e accettato',
        owners: 'Proprietari',
    ...
    ownershipInfoStep: {
        ...
        businessOwner: "Titolare dell'azienda",
        ...
        regulationRequiresChart:
            'La normativa ci impone di raccogliere una copia certificata dell’organigramma della proprietà che mostri ogni persona fisica o entità che possiede il 25% o più dell’attività.',
        uploadEntity: 'Carica il grafico di proprietà dell’entità',
        noteEntity: 'Nota: L’organigramma di proprietà dell’entità deve essere firmato dal tuo commercialista, dal tuo consulente legale o essere notarizzato.',
        ...
        pleaseUpload: 'Carica qui sotto ulteriore documentazione per aiutarci a verificare la tua identità come titolare diretto o indiretto del 25% o più dell’entità aziendale.',
        acceptedFiles: 'Formati di file accettati: PDF, PNG, JPEG. La dimensione totale dei file per ciascuna sezione non può superare 5 MB.',
        proofOfBeneficialOwner: 'Prova del titolare effettivo',
        proofOfBeneficialOwnerDescription:
            'Fornisci un’attestazione firmata e un organigramma da parte di un commercialista pubblico, notaio o avvocato che verifichi la proprietà del 25% o più dell’azienda. Il documento deve essere datato negli ultimi tre mesi e includere il numero di licenza del firmatario.',
        ...
        codiceFiscaleDescription:
            'Carica un video di una visita in loco o di una chiamata registrata con il firmatario autorizzato. Il firmatario deve fornire: nome completo, data di nascita, denominazione della società, numero di registrazione, codice fiscale, sede legale, natura dell’attività e finalità del conto.',
    },
    ...
    connectBankAccountStep: {
        ...
        descriptionCTA: 'Inserisci l’importo di ogni transazione nei campi qui sotto. Esempio: 1,51.',
        letsChatText: 'Ci siamo quasi! Abbiamo bisogno del tuo aiuto per verificare ancora qualche informazione tramite chat. Pronto?',
    ...
    bankInfoStep: {
        ...
        thisBankAccount: 'Questo conto bancario verrà utilizzato per i pagamenti aziendali nel tuo spazio di lavoro',
        accountNumber: 'Numero di conto',
        accountHolderNameDescription: 'Nome e cognome del firmatario autorizzato',
    },
    signerInfoStep: {
        signerInfo: 'Info firmatario',
        ...
        regulationRequiresOneMoreDirector: 'Le normative richiedono almeno un altro direttore come firmatario.',
        hangTight: 'Attendi...',
        ...
        chooseFile: 'Scegli file',
        weAreWaiting: 'Stiamo aspettando che gli altri verifichino la propria identità come amministratori dell’azienda.',
        ...
        PDSandFSGDescription: dedent(`
            La nostra partnership con Corpay utilizza una connessione API per sfruttare la loro vasta rete di partner bancari internazionali, al fine di supportare i Rimborsi Globali in Expensify. In conformità con la normativa australiana, ti forniamo la Financial Services Guide (FSG) e il Product Disclosure Statement (PDS) di Corpay.

            Ti preghiamo di leggere attentamente i documenti FSG e PDS, poiché contengono dettagli completi e informazioni importanti sui prodotti e servizi offerti da Corpay. Conserva questi documenti per riferimento futuro.
        `),
        pleaseUpload: 'Carica qui sotto la documentazione aggiuntiva per aiutarci a verificare la tua identità come direttore dell’azienda.',
    ...
    finishStep: {
        ...
        thanksFor:
            'Grazie per queste informazioni. Un agente di supporto dedicato esaminerà ora i tuoi dati. Ti ricontatteremo se avremo bisogno di altro da te ma, nel frattempo, non esitare a contattarci per qualsiasi domanda.',
    ...
    travel: {
        ...
        termsAndConditions: {
            ...
            defaultWorkspaceError:
                'Devi impostare uno spazio di lavoro predefinito per abilitare Expensify Travel. Vai su Impostazioni > Spazi di lavoro > clicca sui tre punti verticali accanto a uno spazio di lavoro > Imposta come spazio di lavoro predefinito, quindi riprova!',
        },
        flight: 'Volo',
        flightDetails: {
            ...
            seat: 'Posto',
            class: 'Classe cabina',
            recordLocator: 'Identificatore record',
            cabinClasses: {
                unknown: 'Sconosciuto',
                economy: 'Economia',
        ...
        phoneError: ({phoneErrorMethodsRoute}: PhoneErrorRouteParams) =>
            `<rbr><a href="${phoneErrorMethodsRoute}">Aggiungi un'email di lavoro come login principale</a> per prenotare viaggi.</rbr>`,
        domainSelector: {
            title: 'Dominio',
        ...
        domainPermissionInfo: {
            ...
            restriction: ({domain}: DomainPermissionInfoRestrictionParams) =>
                `Non hai l'autorizzazione per abilitare Expensify Travel per il dominio <strong>${domain}</strong>. Dovrai chiedere a qualcuno di quel dominio di abilitare invece il servizio di viaggio.`,
            accountantInvitation: `Se sei un commercialista, prendi in considerazione l’idea di unirti al <a href="${CONST.OLD_DOT_PUBLIC_URLS.EXPENSIFY_APPROVED_PROGRAM_URL}">programma per commercialisti ExpensifyApproved!</a> per abilitare i viaggi per questo dominio.`,
        },
        publicDomainError: {
        ...
        blockedFeatureModal: {
            ...
            message: `Il tuo amministratore ha disattivato Expensify Travel. Segui l’informativa della tua azienda sulle prenotazioni per gli spostamenti.`,
        },
        verifyCompany: {
        ...
        updates: {
            ...
            railTicketUpdate: ({origin, destination, startDate}: RailTicketParams) => `Il tuo biglietto ferroviario da ${origin} a ${destination} del ${startDate} è stato aggiornato.`,
            defaultUpdate: ({type}: TravelTypeParams) => `La tua prenotazione ${type} è stata aggiornata.`,
        },
        flightTo: 'Volo per',
        trainTo: 'Addestra per',
    ...
    workspace: {
        common: {
            ...
            memberNotFound: 'Membro non trovato. Per invitare un nuovo membro allo spazio di lavoro, utilizza il pulsante di invito sopra.',
            ...
            shareNote: {
                ...
                content: ({adminsRoomLink}: WorkspaceShareNoteParams) =>
                    `Condividi questo codice QR o copia il link qui sotto per permettere ai membri di richiedere facilmente l’accesso al tuo spazio di lavoro. Tutte le richieste di unirsi allo spazio di lavoro verranno visualizzate nella stanza <a href="${adminsRoomLink}">${CONST.REPORT.WORKSPACE_CHAT_ROOMS.ADMINS}</a> per la tua revisione.`,
            },
        ...
        receiptPartners: {
            ...
            uber: {
                ...
                takeBusinessRideMessage: 'Fai una corsa di lavoro e le ricevute Uber verranno importate in Expensify. Sfreccia!',
                all: 'Tutti',
                linked: 'Collegato',
                outstanding: 'In sospeso',
                status: {
                ...
                bannerDescription: 'Collega Uber for Business per automatizzare le spese di viaggio e di consegna pasti in tutta la tua organizzazione.',
                emptyContent: {
                    title: 'Nessun invito in sospeso',
                    subtitle: 'Urrà! Abbiamo cercato ovunque e non siamo riusciti a trovare alcun invito in sospeso.',
                },
            },
        },
        perDiem: {
            subtitle: `<muted-text>Imposta le tariffe di diaria per controllare le spese giornaliere dei dipendenti. <a href="${CONST.DEEP_DIVE_PER_DIEM}">Scopri di più</a>.</muted-text>`,
            amount: 'Importo',
            deleteRates: () => ({
                one: 'Elimina tariffa',
            ...
            editPerDiemRates: 'Modifica le tariffe forfettarie',
        ...
        qbd: {
            ...
            exportCheckDescription: 'Creeremo un assegno con voci dettagliate per ogni report di Expensify e lo invieremo dal conto bancario qui sotto.',
            exportJournalEntryDescription: 'Creeremo una registrazione contabile dettagliata per ogni report Expensify e la registreremo nel conto qui sotto.',
            exportVendorBillDescription:
                'Creeremo una fattura a fornitore dettagliata per ogni report Expensify e la aggiungeremo al conto qui sotto. Se questo periodo è chiuso, registreremo alla data del 1º del successivo periodo aperto.',
            outOfPocketTaxEnabledDescription:
                'QuickBooks Desktop non supporta le imposte nelle esportazioni delle registrazioni contabili. Poiché hai le imposte abilitate nel tuo spazio di lavoro, questa opzione di esportazione non è disponibile.',
            outOfPocketTaxEnabledError: 'Le registrazioni contabili non sono disponibili quando le imposte sono abilitate. Scegli un’opzione di esportazione diversa.',
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK}Description`]:
                    'Creeremo un assegno con voci dettagliate per ogni report di Expensify e lo invieremo dal conto bancario qui sotto.',
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}Description`]:
                    'Assoceremo automaticamente il nome dell’esercente della transazione con carta di credito ai fornitori corrispondenti in QuickBooks. Se non esistono fornitori, creeremo un fornitore “Credit Card Misc.” per l’associazione.',
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY}Error`]:
                    'Le registrazioni contabili non sono disponibili quando le imposte sono abilitate. Scegli un’opzione di esportazione diversa.',
            },
            ...
            requiredSetupDevice: {
                ...
                body1: 'Dovrai configurare questa connessione dal computer che ospita il file dell’azienda QuickBooks Desktop.',
        ...
        qbo: {
            ...
            locationsDescription: 'Scegli come gestire le località di QuickBooks Online in Expensify.',
            taxesDescription: 'Scegli come gestire le imposte di QuickBooks Online in Expensify.',
            locationsLineItemsRestrictionDescription:
                'QuickBooks Online non supporta le Sedi a livello di riga per Assegni o Fatture Fornitore. Se desideri avere le sedi a livello di riga, assicurati di utilizzare Registrazioni Contabili e spese con Carta di Credito/Debito.',
            taxesJournalEntrySwitchNote: 'QuickBooks Online non supporta le imposte sulle scritture contabili. Modifica l’opzione di esportazione in fattura fornitore o assegno.',
            ...
            vendor: 'Fornitore',
            defaultVendorDescription: 'Imposta un fornitore predefinito che verrà applicato a tutte le transazioni con carta di credito al momento dell’esportazione.',
            exportOutOfPocketExpensesDescription: 'Imposta come esportare in QuickBooks Online le spese anticipate dai dipendenti.',
            exportCheckDescription: 'Creeremo un assegno con voci dettagliate per ogni report di Expensify e lo invieremo dal conto bancario qui sotto.',
            exportJournalEntryDescription: 'Creeremo una registrazione contabile dettagliata per ogni report Expensify e la registreremo nel conto qui sotto.',
            exportVendorBillDescription:
                'Creeremo una fattura a fornitore dettagliata per ogni report Expensify e la aggiungeremo al conto qui sotto. Se questo periodo è chiuso, registreremo alla data del 1º del successivo periodo aperto.',
            ...
            companyCardsLocationEnabledDescription:
                'QuickBooks Online non supporta le sedi nelle esportazioni delle fatture fornitore. Poiché le sedi sono abilitate nel tuo spazio di lavoro, questa opzione di esportazione non è disponibile.',
            outOfPocketTaxEnabledDescription:
                'QuickBooks Online non supporta le imposte nelle esportazioni delle registrazioni contabili. Poiché le imposte sono abilitate nel tuo spazio di lavoro, questa opzione di esportazione non è disponibile.',
            outOfPocketTaxEnabledError: 'Le registrazioni contabili non sono disponibili quando le imposte sono abilitate. Scegli un’opzione di esportazione diversa.',
            advancedConfig: {
                ...
                inviteEmployeesDescription: 'Importa i record dei dipendenti di QuickBooks Online e invita i dipendenti a questo workspace.',
                createEntities: 'Crea automaticamente entità',
            ...
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}Description`]:
                    'Abbineremo automaticamente il nome dell’esercente presente sulla transazione con carta di debito a qualsiasi fornitore corrispondente in QuickBooks. Se non esistono fornitori, creeremo un fornitore “Debit Card Misc.” per l’associazione.',
            ...
            exportDestinationAccountsMisconfigurationError: {
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]: 'Scegli un conto valido per l’esportazione della fattura fornitore',
            ...
            exportDestinationSetupAccountsInfo: {
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
                    'Per utilizzare l’esportazione delle fatture fornitore, configura un conto contabilità fornitori in QuickBooks Online',
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: 'Per utilizzare l’esportazione delle scritture contabili, configura un conto contabile in QuickBooks Online',
        ...
        xero: {
            ...
            mapTrackingCategoryToDescription: ({categoryName}: CategoryNameParams) => `Scegli dove mappare ${categoryName} quando esegui l’esportazione su Xero.`,
            customers: 'Rifattura clienti',
            customersDescription:
                'Scegli se riaddebitare le spese ai clienti in Expensify. I contatti cliente di Xero possono essere associati alle spese e verranno esportati in Xero come fatture di vendita.',
            ...
            purchaseBill: 'Conto d’acquisto',
            exportDeepDiveCompanyCard:
                'Le spese esportate verranno registrate come transazioni bancarie sul seguente conto bancario Xero e le date delle transazioni corrisponderanno alle date presenti sul tuo estratto conto bancario.',
            ...
            advancedConfig: {
                ...
                reimbursedReportsDescription:
                    "Ogni volta che un report viene pagato tramite Expensify ACH, il pagamento della fattura corrispondente verrà creato nell'account Xero qui sotto.",
        ...
        sageIntacct: {
            ...
            defaultVendorDescription: ({isReimbursable}: DefaultVendorDescriptionParams) =>
                `Imposta un fornitore predefinito da applicare alle spese ${isReimbursable ? '' : 'non-'}rimborsabili che non hanno un fornitore corrispondente in Sage Intacct.`,
            ...
            exportPreferredExporterSubNote: 'Una volta impostato, l’esportatore preferito vedrà nel proprio account i report pronti per l’esportazione.',
            noAccountsFound: 'Nessun account trovato',
            ...
            inviteEmployeesDescription:
                'Importa i record dei dipendenti da Sage Intacct e invita i dipendenti a questo spazio di lavoro. Il tuo flusso di approvazione predefinito sarà l’approvazione del responsabile e potrà essere ulteriormente configurato nella pagina Membri.',
            syncReimbursedReports: 'Sincronizza i report rimborsati',
            syncReimbursedReportsDescription:
                'Ogni volta che un report viene pagato utilizzando Expensify ACH, il corrispondente pagamento della fattura verrà creato nell’account Sage Intacct qui sotto.',
        ...
        netsuite: {
            ...
            exportInvoices: 'Esporta fatture in',
            journalEntriesTaxPostingAccount: 'Conto di registrazione delle imposte per le scritture contabili',
            journalEntriesProvTaxPostingAccount: 'Registrazioni contabili conto di imputazione imposta provinciale',
            ...
            reimbursableJournalPostingAccount: 'Conto di registrazione del giornale rimborsabile',
            ...
            invoiceItem: {
                ...
                values: {
                    ...
                    [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.SELECT]: {
                        ...
                        description: 'Collegheremo le fatture di Expensify alla voce selezionata qui sotto.',
                    },
                },
            },
            exportDate: {
            ...
            exportDestination: {
                values: {
                    [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
                        label: 'Note spese',
                        reimbursableDescription: 'Le spese anticipate verranno esportate come note spese su NetSuite.',
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        reimbursableDescription: dedent(`
                            Le spese sostenute di tasca propria verranno esportate come registrazioni contabili sul conto NetSuite specificato di seguito.

                            Se desideri impostare un fornitore specifico per ogni carta, vai su *Impostazioni > Domini > Carte aziendali*.
                        `),
                        nonReimbursableDescription: dedent(`
                            Le spese delle carte aziendali verranno esportate come registrazioni contabili sul conto NetSuite specificato di seguito.
                ...
                expenseReportDestinationConfirmDescription:
                    'Se passi l’impostazione di esportazione delle carte aziendali a “note spese”, i fornitori NetSuite e i conti di registrazione per le singole carte verranno disattivati.\n\nNon preoccuparti, salveremo comunque le tue selezioni precedenti nel caso in cui tu voglia tornare indietro in seguito.',
            },
            advancedConfig: {
                autoSyncDescription: 'Expensify si sincronizzerà automaticamente con NetSuite ogni giorno.',
                reimbursedReportsDescription:
                    "Ogni volta che un report viene pagato utilizzando Expensify ACH, il pagamento della fattura corrispondente verrà creato nell'account NetSuite qui sotto.",
                reimbursementsAccount: 'Conto rimborsi',
                reimbursementsAccountDescription: 'Scegli il conto bancario che userai per i rimborsi e creeremo il pagamento associato in NetSuite.',
                ...
                approvalAccount: "Account per l'approvazione A/P",
                ...
                inviteEmployeesDescription:
                    'Importa i record dei dipendenti da NetSuite e invita i dipendenti in questo spazio di lavoro. Il tuo workflow di approvazione sarà predefinito sull’approvazione del responsabile e potrà essere ulteriormente configurato nella pagina *Membri*.',
                ...
                customFormIDDescription:
                    'Per impostazione predefinita, Expensify creerà le registrazioni utilizzando il modello di transazione preferito impostato in NetSuite. In alternativa, è possibile designare uno specifico modello di transazione da utilizzare.',
                ...
                exportReportsTo: {
                    ...
                    values: {
                        ...
                        [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED]: 'Solo approvati dalla contabilità',
                ...
                exportVendorBillsTo: {
                    ...
                    description:
                        'Una volta che una fattura fornitore è approvata in Expensify ed esportata in NetSuite, è possibile impostare un ulteriore livello di approvazione in NetSuite prima della registrazione.',
                    values: {
            ...
            noItemsFound: 'Nessuna voce della fattura trovata',
            ...
            noSubsidiariesFoundDescription: 'Per favore aggiungi una consociata in NetSuite e sincronizza di nuovo la connessione',
            tokenInput: {
                ...
                formSteps: {
                    ...
                    createAccessToken: {
                        ...
                        description:
                            'In NetSuite, vai su *Setup > Users/Roles > Access Tokens* e crea un token di accesso per l\'app "Expensify" e il ruolo "Expensify Integration" o "Administrator".\n\n*Importante:* Assicurati di salvare il *Token ID* e il *Token Secret* di questo passaggio. Ti serviranno per il passaggio successivo.',
                    },
                    enterCredentials: {
            ...
            import: {
                ...
                crossSubsidiaryCustomers: 'Clienti/progetti interfiliale',
                importFields: {
                    departments: {
                        title: 'Reparti',
                ...
                importCustomFields: {
                    ...
                    customSegments: {
                        ...
                        helpLinkText: 'Visualizza le istruzioni dettagliate',
...
1. *Customization > Lists, Records, & Fields > Custom Segments*.
2. Fai clic su un segmento personalizzato.
3. Fai clic sulla scheda *Application and Sourcing* in basso, quindi:
...
_Per istruzioni più dettagliate, [visita il nostro sito di assistenza](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
                ...
                importTypes: {
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]: {
                        label: 'Valore predefinito dipendente NetSuite',
                        description: "Non importato in Expensify, applicato all'esportazione",
                        footerContent: ({importField}: ImportFieldParams) =>
                            `Se utilizzi ${importField} in NetSuite, applicheremo il valore predefinito impostato sul record del dipendente al momento dell’esportazione in Expense Report o Journal Entry.`,
                    },
                    ...
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
                        ...
                        footerContent: ({importField}: ImportFieldParams) => `La selezione ${startCase(importField)} verrà applicata a tutte le spese nel rapporto di un dipendente.`,
                    },
                },
            },
        },
        intacct: {
            ...
            followSteps: 'Segui i passaggi nelle nostre istruzioni della guida pratica: Come connettersi a Sage Intacct',
            enterCredentials: 'Inserisci le tue credenziali Sage Intacct',
            entity: 'Entità',
            employeeDefault: 'Impostazioni predefinite dipendente Sage Intacct',
            ...
            userDefinedDimensions: "Dimension definite dall'utente",
            ...
            detailedInstructionsLink: 'Visualizza le istruzioni dettagliate',
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                commercialFeedDetails: 'Richiede la configurazione con la tua banca. Di solito è utilizzato dalle aziende più grandi ed è spesso la scelta migliore se soddisfi i requisiti.',
                ...
                enableFeed: {
                    ...
                    heading:
                        'Abbiamo un’integrazione diretta con il tuo emittente della carta e possiamo importare rapidamente e con precisione i tuoi dati di transazione in Expensify.\n\nPer iniziare, ti basta:',
                    ...
                    vcf: `1. Visita [questo articolo di supporto](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP}) per istruzioni dettagliate su come configurare le tue Visa Commercial Cards.
...
2. [Contatta la tua banca](${CONST.COMPANY_CARDS_MASTERCARD_COMMERCIAL_CARDS}) per verificare che supporti un flusso commerciale per il tuo programma e chiedi di abilitarlo.

3. *Una volta che il flusso è stato abilitato e disponi dei relativi dettagli, procedi alla schermata successiva.*`,
                    stripe: `1. Visita la Dashboard di Stripe e vai su [Impostazioni](${CONST.COMPANY_CARDS_STRIPE_HELP}).

2. Integrazioni di prodotto, fai clic su Abilita accanto a Expensify.

3. Una volta che il feed è stato abilitato, fai clic su Invia qui sotto e noi ci occuperemo di aggiungerlo.`,
                },
            ...
            somethingMightBeBroken:
                '<muted-text><centered-text>Oppure qualcosa potrebbe essere danneggiato. In ogni caso, se hai domande, <concierge-link>contatta Concierge</concierge-link>.</centered-text></muted-text>',
            chooseTransactionStartDate: 'Scegli una data di inizio transazione',
            startDateDescription: 'Importeremo tutte le transazioni a partire da questa data. Se non specifichi una data, risaliremo fino al massimo consentito dalla tua banca.',
            ...
            ukRegulation:
                'Expensify Limited è un agente di Plaid Financial Ltd., un’istituzione di pagamento autorizzata e regolamentata dalla Financial Conduct Authority ai sensi delle Payment Services Regulations 2017 (Numero di riferimento dell’impresa: 804718). Plaid ti fornisce servizi regolamentati di informazione sui conti tramite Expensify Limited in qualità di suo agente.',
        },
        expensifyCard: {
            issueAndManageCards: 'Emetti e gestisci le tue Expensify Card',
            getStartedIssuing: 'Inizia richiedendo la tua prima carta virtuale o fisica.',
            verificationInProgress: 'Verifica in corso...',
            verifyingTheDetails: 'Stiamo verificando alcuni dettagli. Concierge ti informerà quando le Expensify Card saranno pronte per essere emesse.',
            disclaimer:
                'La Expensify Visa® Commercial Card è emessa da The Bancorp Bank, N.A., membro FDIC, in virtù di una licenza di Visa U.S.A. Inc. e potrebbe non essere accettata da tutti gli esercenti che accettano carte Visa. Apple® e il logo Apple® sono marchi di Apple Inc., registrati negli Stati Uniti e in altri Paesi. App Store è un marchio di servizio di Apple Inc. Google Play e il logo Google Play sono marchi di Google LLC.',
            euUkDisclaimer:
            ...
            currentBalanceDescription: 'Il saldo attuale è la somma di tutte le transazioni con Expensify Card contabilizzate che si sono verificate dalla data dell’ultima liquidazione.',
            balanceWillBeSettledOn: ({settlementDate}: SettlementDateParams) => `Il saldo sarà regolato il ${settlementDate}`,
            settleBalance: 'Saldo pagamento',
            cardLimit: 'Limite carta',
            remainingLimit: 'Limite rimanente',
            requestLimitIncrease: 'Richiesta aumento limite',
            remainingLimitDescription:
                'Consideriamo diversi fattori quando calcoliamo il tuo limite residuo: la tua anzianità come cliente, le informazioni aziendali fornite durante la registrazione e la liquidità disponibile sul conto bancario della tua azienda. Il tuo limite residuo può variare quotidianamente.',
            earnedCashback: 'Cashback',
            earnedCashbackDescription: 'Il saldo del cashback si basa sulle spese mensili con Expensify Card contabilizzate all’interno del tuo workspace.',
            ...
            monthlyLimitWarning: ({limit}: CharacterLimitParams) => `Se cambi il limite di questa carta a ${limit}, le nuove transazioni verranno rifiutate fino al prossimo mese.`,
            ...
            issuedCardNoShippingDetails: ({assignee}: AssigneeParams) => `ha emesso una Expensify Card a ${assignee}! La carta verrà spedita una volta confermati i dettagli di spedizione.`,
            issuedCardVirtual: ({assignee, link}: IssueVirtualCardParams) => `ha emesso a ${assignee} una carta virtual Expensify! Il ${link} può essere utilizzato subito.`,
            ...
            replacedCard: ({assignee}: AssigneeParams) => `${assignee} ha sostituito la sua Expensify Card. La nuova carta arriverà entro 2-3 giorni lavorativi.`,
            replacedVirtualCard: ({assignee, link}: IssueVirtualCardParams) => `${assignee} ha sostituito la sua Carta Expensify virtuale! La ${link} può essere utilizzata subito.`,
            card: 'carta',
        ...
        categories: {
            ...
            importedFromAccountingSoftware: 'Le categorie seguenti sono importate da tuo',
        ...
        moreFeatures: {
            ...
            perDiem: {
                title: 'Indennità giornaliera',
                subtitle: 'Imposta le tariffe di diaria per controllare le spese giornaliere dei dipendenti.',
            },
            expensifyCard: {
            ...
            companyCards: {
                ...
                bankConnectionDescription: `Riprova ad aggiungere le tue carte. In caso contrario, puoi`,
                disableCardTitle: 'Disabilita carte aziendali',
                disableCardPrompt: 'Non puoi disattivare le carte aziendali perché questa funzionalità è attualmente in uso. Contatta il Concierge per sapere come procedere.',
                disableCardButton: 'Chatta con Concierge',
                cardDetails: 'Dettagli della carta',
                cardNumber: 'Numero carta',
                cardholder: 'Titolare della carta',
                ...
                integrationExportTitle: ({integration, exportPageLink}: IntegrationExportParams) =>
                    `Scegli l’account ${integration} in cui esportare le transazioni. Seleziona una diversa <a href="${exportPageLink}">opzione di esportazione</a> per modificare gli account disponibili.`,
                lastUpdated: 'Ultimo aggiornamento',
                transactionStartDate: 'Data di inizio transazione',
                updateCard: 'Aggiorna carta',
                unassignCard: 'Disassegna carta',
                unassign: 'Rimuovi assegnazione',
                unassignCardDescription: 'La rimozione dell’assegnazione di questa carta eliminerà tutte le transazioni presenti nei report in bozza dall’account del titolare della carta.',
                assignCard: 'Assegna carta',
                ...
                removeCardFeedDescription: 'Sei sicuro di voler rimuovere questo flusso di carte? Questa azione rimuoverà l’assegnazione di tutte le carte.',
                error: {
                ...
                downgradeSubTitle: `Questo spazio di lavoro non può essere declassato perché sono connessi più feed di carte (escludendo le Expensify Card). Per procedere, <a href="#">mantieni un solo feed di carte</a>.`,
            ...
            workflows: {
                ...
                disableApprovalPrompt:
                    'Le Expensify Card di questo workspace attualmente si basano sulle approvazioni per definire i loro Smart Limit. Modifica i tipi di limite di tutte le Expensify Card con Smart Limit prima di disabilitare le approvazioni.',
            },
            invoices: {
                title: 'Fatture',
        ...
        reports: {
            ...
            customNameReportIDExample: 'ID del report: {report:id}',
        ...
        reportFields: {
            ...
            disableReportFields: 'Disabilita campi report',
            disableReportFieldsConfirmation: 'Sei sicuro? I campi di testo e di data verranno eliminati e gli elenchi saranno disattivati.',
            ...
            typeInputSubtitle: 'Scegli il tipo di campo di report da utilizzare.',
            ...
            existingReportFieldNameError: 'Un campo rapporto con questo nome esiste già',
            reportFieldNameRequiredError: 'Inserisci un nome per il campo rapporto',
        ...
        tags: {
            tagName: 'Nome tag',
            requiresTag: 'I membri devono assegnare un tag a tutte le spese',
            ...
            emptyTags: {
                ...
                subtitleHTML: `<muted-text><centered-text>Importa un foglio di calcolo per aggiungere tag per tenere traccia di progetti, sedi, reparti e altro. <a href="${CONST.IMPORT_TAGS_EXPENSIFY_URL}">Scopri di più</a> sul formato dei file dei tag.</centered-text></muted-text>`,
        ...
        taxes: {
            subtitle: 'Aggiungi nomi imposta, aliquote e imposta predefinita.',
            ...
            value: 'Valore',
            taxReclaimableOn: 'Imponibile ai fini del recupero imposte',
            taxRate: 'Aliquota fiscale',
            ...
            error: {
                ...
                customNameRequired: 'È necessario un nome fiscale personalizzato',
            ...
            importedFromAccountingSoftware: 'Le seguenti imposte sono importate dal tuo',
        ...
        duplicateWorkspace: {
            ...
            categories: 'categorie e le tue regole di autocategorizzazione',
        ...
        emptyWorkspace: {
            ...
            notFound: 'Nessuna area di lavoro trovata',
        ...
        people: {
            ...
            workspaceMembersCount: ({count}: WorkspaceMembersCountParams) => `Totale membri dell’area di lavoro: ${count}`,
            ...
            removeMemberPromptReimburser: ({memberName}: {memberName: string}) =>
                `Non puoi rimuovere ${memberName} da questo workspace. Imposta un nuovo rimborsatore in Flussi di lavoro > Effettua o traccia i pagamenti, quindi riprova.`,
            removeMemberPromptExporter: ({memberName, workspaceOwner}: {memberName: string; workspaceOwner: string}) =>
                `Se rimuovi ${memberName} da questo workspace, li sostituiremo come esportatore preferito con ${workspaceOwner}, il proprietario del workspace.`,
            removeMemberPromptTechContact: ({memberName, workspaceOwner}: {memberName: string; workspaceOwner: string}) =>
                `Se rimuovi ${memberName} da questo spazio di lavoro, li sostituiremo come referente tecnico con ${workspaceOwner}, il proprietario dello spazio di lavoro.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                physicalCardDescription: 'Ottima per chi spende spesso',
                virtualCard: 'Carta virtual',
                ...
                cardName: 'Nome della carta',
                letsDoubleCheck: 'Controlliamo di nuovo che sia tutto corretto.',
                willBeReady: "Questa carta sarà pronta all'uso immediatamente.",
                cardholder: 'Titolare della carta',
        ...
        accounting: {
            ...
            title: 'Connessioni',
            subtitle:
                'Collegati al tuo sistema contabile per codificare le transazioni con il tuo piano dei conti, abbinare automaticamente i pagamenti e mantenere le tue finanze sincronizzate.',
            ...
            errorODIntegration: ({oldDotPolicyConnectionsURL}: ErrorODIntegrationParams) =>
                `C’è un errore con una connessione configurata in Expensify Classic. [Vai a Expensify Classic per risolvere questo problema.](${oldDotPolicyConnectionsURL})`,
            ...
            importTypes: {
                ...
                [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: 'Importati come tag',
                ...
                [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]: 'Valore predefinito dipendente NetSuite',
            },
                ...
                syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                    switch (stage) {
                        ...
                        case 'quickbooksOnlineImportMain':
                            return 'Importazione dei dati da QuickBooks Online';
                        ...
                        case 'netSuiteSyncImportSubsidiaries':
                            return 'Importazione delle controllate';
            ...
            saveHoursOnReconciliation:
                'Risparmia ore di riconciliazione a ogni periodo contabile facendo sì che Expensify riconcili in modo continuo per tuo conto gli estratti conto e i pagamenti della Expensify Card.',
            ...
            chooseReconciliationAccount: {
                chooseBankAccount: 'Scegli il conto bancario su cui verranno riconciliate le tue spese con la Expensify Card.',
        ...
        distanceRates: {
            ...
            taxFeatureNotEnabledMessage:
                '<muted-text>Le imposte devono essere abilitate nello spazio di lavoro per utilizzare questa funzione. Vai a <a href="#">Altre funzionalità</a> per apportare questa modifica.</muted-text>',
        ...
        editor: {
            ...
            avatarUploadFailureMessage: 'Si è verificato un errore durante il caricamento dell’avatar. Riprova.',
            addressContext: 'Per abilitare Expensify Travel è richiesto l’indirizzo dello Spazio di lavoro. Inserisci un indirizzo associato alla tua attività.',
        ...
        bankAccount: {
            ...
            clearProgress: 'Ricominciare da capo cancellerà i progressi che hai fatto finora.',
            areYouSure: 'Sei sicuro?',
        ...
        changeOwner: {
            ...
            addPaymentCardReadAndAcceptText: `<muted-text-micro>Leggi e accetta i <a href="${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}">termini</a> e l’<a href="${CONST.OLD_DOT_PUBLIC_URLS.PRIVACY_URL}">informativa</a> sulla privacy per aggiungere la tua carta.</muted-text-micro>`,
            ...
            ownerOwesAmountText: ({email, amount}: OwnerOwesAmountParams) => `L’account che possiede questo spazio di lavoro (${email}) ha un saldo in sospeso da un mese precedente.
...
Vuoi trasferire questo importo (${amount}) per assumerti la fatturazione di questo spazio di lavoro? La tua carta di pagamento verrà addebitata immediatamente.`,
            ...
            subscriptionText: ({usersCount, finalCount}: ChangeOwnerSubscriptionParams) =>
                `Assumere il controllo di questo workspace unirà il suo abbonamento annuale con il tuo abbonamento attuale. Questo aumenterà le dimensioni del tuo abbonamento di ${usersCount} membri, portando la nuova dimensione dell’abbonamento a ${finalCount}. Vuoi continuare?`,
            duplicateSubscriptionTitle: 'Avviso di abbonamento duplicato',
            duplicateSubscriptionButtonText: '- Inglese\n- Spagnolo\n- Tedesco\n- Francese\n- Italiano\n- Giapponese\n- Olandese\n- Polacco\n- Portoghese (BR)\n- Cinese (semplificato)',
...
Fai clic su "Continua" se vuoi solo assumere la gestione della fatturazione per lo spazio di lavoro ${workspaceName}.

Se vuoi assumere la gestione della fatturazione per l’intero abbonamento, chiedi prima a questa persona di aggiungerti come amministratore a tutti i suoi spazi di lavoro, prima di assumere la gestione della fatturazione.`,
            hasFailedSettlementsTitle: 'Impossibile trasferire la proprietà',
            hasFailedSettlementsButtonText: 'Ho capito',
            hasFailedSettlementsText: ({email}: ChangeOwnerHasFailedSettlementsParams) =>
                `Non puoi assumere la fatturazione perché ${email} ha una liquidazione Expensify Card in ritardo. Chiedi loro di contattare concierge@expensify.com per risolvere il problema. Dopodiché, potrai assumere la fatturazione per questo workspace.`,
...
Sei sicuro di volerli esportare di nuovo?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.NETSUITE]: {
                title: 'NetSuite',
                description: `Goditi la sincronizzazione automatica e riduci le immissioni manuali con l’integrazione Expensify + NetSuite. Ottieni approfondite informazioni finanziarie in tempo reale con il supporto per segmenti nativi e personalizzati, inclusa la mappatura di progetti e clienti.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.POLICY.CONNECTIONS.NAME.SAGE_INTACCT]: {
                ...
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>L'integrazione con Sage Intacct è disponibile solo con il piano Control, a partire da <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `per membro al mese.` : `per membro attivo al mese.`}</muted-text>`,
            },
            ...
            glAndPayrollCodes: {
                ...
                description: `Aggiungi i codici Co.Ge. e Payroll alle tue categorie per esportare facilmente le spese nei tuoi sistemi di contabilità e paghe.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            companyCards: {
                ...
                description: `Hai bisogno di aggiungere altri flussi di carte? Sblocca carte aziendali illimitate per sincronizzare le transazioni da tutti i principali emittenti di carte.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Questo è disponibile solo con il piano Control, a partire da <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `per membro al mese.` : `per membro attivo al mese.`}</muted-text>`,
            },
            rules: {
                title: 'Regole',
                description: `Le regole operano in background e tengono sotto controllo le tue spese, così non devi preoccuparti dei piccoli dettagli.

Richiedi informazioni sulle spese come ricevute e descrizioni, imposta limiti e valori predefiniti e automatizza approvazioni e pagamenti – tutto in un unico posto.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            perDiem: {
                title: 'Indennità giornaliera',
                description:
                    'Il per diem è un ottimo modo per mantenere i tuoi costi giornalieri conformi e prevedibili ogni volta che i tuoi dipendenti viaggiano. Approfitta di funzionalità come tariffe personalizzate, categorie predefinite e dettagli più granulari come destinazioni e sottotariffe.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            reports: {
                title: 'Report',
                description: 'I report ti consentono di raggruppare le spese per semplificarne il monitoraggio e l’organizzazione.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            distanceRates: {
                title: 'Tariffe chilometriche',
                description: 'Crea e gestisci le tue tariffe, traccia in miglia o chilometri e imposta le categorie predefinite per le spese di distanza.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.UPGRADE_FEATURE_INTRO_MAPPING.multiApprovalLevels.id]: {
                ...
                description:
                    'Livelli multipli di approvazione è uno strumento di workflow per le aziende che richiedono l’approvazione di più persone su un report prima che possa essere rimborsato.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            note: ({subscriptionLink}: WorkspaceUpgradeNoteParams) =>
                `<muted-text>Passa a un piano superiore per accedere a questa funzione oppure <a href="${subscriptionLink}">scopri di più</a> sui nostri piani e prezzi.</muted-text>`,
            ...
            completed: {
                ...
                distanceRateMessage: `Hai eseguito l’upgrade al piano Collect. Ora puoi modificare la tariffa per distanza!`,
        ...
        payAndDowngrade: {
            ...
            description2: ({date}: DateParams) => `Vedi il dettaglio qui sotto per ${date}:`,
            subscription:
                'Attenzione! Questa azione terminerà il tuo abbonamento a Expensify, eliminerà questo spazio di lavoro e rimuoverà tutti i membri dello spazio di lavoro. Se vuoi mantenere questo spazio di lavoro ed eliminare solo te stesso, fai prima prendere in carico la fatturazione da un altro amministratore.',
        ...
        restrictedAction: {
            ...
            workspaceOwnerWillNeedToAddOrUpdatePaymentCard: ({workspaceOwnerName}: WorkspaceOwnerWillNeedToAddOrUpdatePaymentCardParams) =>
                `Il proprietario dello spazio di lavoro, ${workspaceOwnerName}, dovrà aggiungere o aggiornare la carta di pagamento registrata per sbloccare le nuove attività dello spazio di lavoro.`,
            youWillNeedToAddOrUpdatePaymentCard: 'Dovrai aggiungere o aggiornare la carta di pagamento registrata per sbloccare la nuova attività nello spazio di lavoro.',
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: ({categoriesPageLink, tagsPageLink}: IndividualExpenseRulesSubtitleParams) =>
                    `<muted-text>Imposta i controlli di spesa e i valori predefiniti per le singole spese. Puoi anche creare regole per le <a href="${categoriesPageLink}">categorie</a> e i <a href="${tagsPageLink}">tag</a>.</muted-text>`,
                receiptRequiredAmount: 'Importo che richiede ricevuta',
                ...
                maxExpenseAmountDescription: 'Segnala le spese che superano questo importo, a meno che non siano state sostituite da una regola di categoria.',
                maxAge: 'Età massima',
                ...
                cashExpenseDefaultDescription:
                    'Scegli come devono essere create le spese in contanti. Una spesa è considerata una spesa in contanti se non è una transazione di carta aziendale importata. Questo include spese create manualmente, ricevute, diarie, spese di distanza e spese di tempo.',
                ...
                billableDefaultDescription: ({tagsPageLink}: BillableDefaultDescriptionParams) =>
                    `<muted-text>Scegli se le spese in contanti e con carta di credito devono essere fatturabili per impostazione predefinita. Le spese fatturabili sono abilitate o disabilitate in <a href="${tagsPageLink}">tag</a>.</muted-text>`,
                billable: 'Fatturabile',
                ...
                alcohol: 'Alcol',
                hotelIncidentals: 'Spese accessorie in hotel',
            ...
            expenseReportRules: {
                title: 'Note spese',
                subtitle: 'Automatizza la conformità, le approvazioni e i pagamenti dei report di spesa.',
                ...
                autoApproveCompliantReportsTitle: 'Approvare automaticamente i report conformi',
                ...
                randomReportAuditDescription: 'Richiedi che alcuni report vengano approvati manualmente, anche se idonei per l’approvazione automatica.',
                ...
                unlockFeatureEnableWorkflowsSubtitle: ({featureName, moreFeaturesLink}: FeatureNameParams) =>
                    `Vai su [altre funzionalità](${moreFeaturesLink}) e abilita i flussi di lavoro, quindi aggiungi ${featureName} per sbloccare questa funzione.`,
                enableFeatureSubtitle: ({featureName, moreFeaturesLink}: FeatureNameParams) =>
                    `Vai su [più funzionalità](${moreFeaturesLink}) e abilita ${featureName} per sbloccare questa funzione.`,
            },
            categoryRules: {
                title: 'Regole delle categorie',
                approver: 'Approvatore',
                ...
                descriptionHintSubtitle: 'Consiglio pro: Più è breve, meglio è!',
                maxAmount: 'Importo massimo',
                flagAmountsOver: 'Segnala gli importi superiori a',
                ...
                expenseLimitTypes: {
                    ...
                    dailySubtitle: 'Contrassegna la spesa totale per categoria per ogni report di spesa.',
                },
                ...
                enableWorkflows: ({moreFeaturesLink}: RulesEnableWorkflowsParams) =>
                    `Vai su [Altre funzionalità](${moreFeaturesLink}) e abilita i workflow, quindi aggiungi le approvazioni per sbloccare questa funzionalità.`,
            },
            customRules: {
        ...
        planTypePage: {
            ...
            lockedPlanDescription: ({count, annualSubscriptionEndDate}: WorkspaceLockedPlanTypeParams) => ({
                one: `Hai sottoscritto 1 membro attivo nel piano Control fino alla fine dell’abbonamento annuale il ${annualSubscriptionEndDate}. Puoi passare all’abbonamento a consumo e effettuare il downgrade al piano Collect a partire dal ${annualSubscriptionEndDate} disattivando il rinnovo automatico in`,
    ...
    getAssistancePage: {
        ...
        description: 'Scegli una delle opzioni di supporto riportate di seguito:',
        chatWithConcierge: 'Chatta con Concierge',
        ...
        exploreHelpDocs: 'Esplora la guida in linea',
        registerForWebinar: 'Registrati al webinar',
        onboardingHelp: "Assistenza all'onboarding",
    },
    emojiPicker: {
        skinTonePickerLabel: 'Modifica tono della pelle predefinito',
        headers: {
    ...
    newRoomPage: {
        ...
        growlMessageOnRenameError: 'Impossibile rinominare la stanza dell’area di lavoro. Controlla la connessione e riprova.',
        visibilityOptions: {
            restricted: 'Area di lavoro', // the translation for "restricted" visibility is actually workspace. This is so we can display restricted visibility rooms as "workspace" without having to change what's stored.
            private: 'Privato',
            public: 'Pubblico',
            // eslint-disable-next-line @typescript-eslint/naming-convention
    ...
    workspaceActions: {
        ...
        updateApprovalRule: ({field, name, newApproverEmail, newApproverName, oldApproverEmail, oldApproverName}: UpdatedPolicyApprovalRuleParams) => {
            ...
            return `ha modificato l'approvatore per ${field} "${name}" in ${formatApprover(newApproverName, newApproverEmail)} (in precedenza ${formatApprover(oldApproverName, oldApproverEmail)})`;
        },
        ...
        updateCategoryMaxExpenseAmount: ({categoryName, oldAmount, newAmount}: UpdatedPolicyCategoryMaxExpenseAmountParams) => {
            ...
            return `importo massimo della categoria "${categoryName}" modificato in ${newAmount} (precedentemente ${oldAmount})`;
        },
        ...
        updateTagListName: ({oldName, newName}: UpdatedPolicyCategoryNameParams) => `ha cambiato il nome dell’elenco di tag in "${newName}" (in precedenza "${oldName}")`,
        addTag: ({tagListName, tagName}: UpdatedPolicyTagParams) => `ha aggiunto l’etichetta «${tagName}» all’elenco «${tagListName}»`,
        updateTagName: ({tagListName, newName, oldName}: UpdatedPolicyTagNameParams) => `ha aggiornato l’elenco di tag "${tagListName}" modificando il tag "${oldName}" in "${newName}"`,
        ...
        deleteMultipleTags: ({count, tagListName}: UpdatedPolicyTagParams) => `ha rimosso i tag "${count}" dall'elenco "${tagListName}"`,
        ...
        updateCustomUnitTaxEnabled: ({newValue}: UpdatePolicyCustomUnitTaxEnabledParams) =>
            `${newValue ? 'Abilitato' : 'Disabilitato'} tracciamento delle imposte sulle tariffe chilometriche`,
        addCustomUnitRate: ({customUnitName, rateName}: AddOrDeletePolicyCustomUnitRateParams) => `ha aggiunto una nuova tariffa per "${customUnitName}" "${rateName}"`,
        updatedCustomUnitRate: ({customUnitName, customUnitRateName, newValue, oldValue, updatedField}: UpdatedPolicyCustomUnitRateParams) =>
            `ha modificato la tariffa di ${customUnitName} ${updatedField} "${customUnitRateName}" a "${newValue}" (in precedenza "${oldValue}")`,
        ...
        updatedCustomUnitTaxClaimablePercentage: ({customUnitRateName, newValue, oldValue}: UpdatedPolicyCustomUnitTaxClaimablePercentageParams) => {
            ...
            return `ha aggiunto una parte di imposta rimborsabile di "${newValue}" alla tariffa di distanza "${customUnitRateName}"`;
        },
        ...
        deleteReportField: ({fieldType, fieldName}: AddedOrDeletedPolicyReportFieldParams) => `rimosso campo del report ${fieldType} "${fieldName}"`,
        ...
        updateMaxExpenseAmountNoReceipt: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) =>
            `ha modificato l’importo massimo della spesa che richiede ricevuta a ${newValue} (in precedenza ${oldValue})`,
        ...
        updateMaxExpenseAge: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) =>
            `aggiornato "Età massima della spesa (giorni)" in "${newValue}" (precedentemente "${oldValue === 'false' ? CONST.POLICY.DEFAULT_MAX_EXPENSE_AGE : oldValue}")`,
        updateMonthlyOffset: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => {
            if (!oldValue) {
                return `imposta la data di invio del report mensile su "${newValue}"`;
            }
            return `ha aggiornato la data di invio del report mensile in "${newValue}" (precedentemente "${oldValue}")`;
        },
        ...
        removedFromApprovalWorkflow: ({submittersNames}: RemovedFromApprovalWorkflowParams) => {
            ...
            return {
                one: `ti ha rimosso dal flusso di approvazione e dalla chat delle spese di ${joinedNames}. I report inviati in precedenza resteranno disponibili per l’approvazione nella tua Posta in arrivo.`,
                other: `ti ha rimosso dai flussi di approvazione e dalle chat spese di ${joinedNames}. Le note spese inviate in precedenza rimarranno disponibili per l’approvazione nella tua Posta in arrivo.`,
            };
        },
        demotedFromWorkspace: ({policyName, oldRole}: DemotedFromWorkspaceParams) =>
            `ha aggiornato il tuo ruolo in ${policyName} da ${oldRole} a utente. Sei stato rimosso da tutte le chat spese dei presentatori tranne che dalla tua.`,
        ...
        updatedWorkspaceFrequencyAction: ({oldFrequency, newFrequency}: UpdatedPolicyFrequencyParams) =>
            `ha aggiornato la frequenza di creazione automatica del report in "${newFrequency}" (in precedenza "${oldFrequency}")`,
        ...
        upgradedWorkspace: 'ha effettuato l’upgrade di questo workspace al piano Control',
        ...
        updatedAuditRate: ({oldAuditRate, newAuditRate}: UpdatedPolicyAuditRateParams) =>
            `ha modificato la percentuale di report indirizzati casualmente per l'approvazione manuale al ${Math.round(newAuditRate * 100)}% (in precedenza ${Math.round(oldAuditRate * 100)}%)`,
        ...
        updatedFeatureEnabled: ({enabled, featureName}: {enabled: boolean; featureName: string}) => {
            switch (featureName) {
                ...
                case 'per diem':
                    return `${enabled ? 'Abilitato' : 'Disabilitato'} indennità giornaliera`;
                case 'receipt partners':
                    return `${enabled ? 'Abilitato' : 'Disabilitato'} partner delle ricevute`;
                case 'rules':
                    return `${enabled ? 'Abilitato' : 'Disabilitato'} regole`;
                case 'tax tracking':
                    return `Tracciamento imposte ${enabled ? 'Abilitato' : 'Disabilitato'}`;
                default:
    ...
    keyboardShortcutsPage: {
        ...
        shortcuts: {
            ...
            escape: 'Chiudi finestre di dialogo',
    ...
    search: {
        ...
        searchResults: {
            emptyResults: {
                ...
                subtitle: `Prova ad adattare i criteri di ricerca o a creare qualcosa con il pulsante +.`,
            },
            emptyExpenseResults: {
            ...
            emptyReportResults: {
                ...
                subtitle: 'Crea un report o fai una prova di Expensify per saperne di più.',
            ...
            emptyInvoiceResults: {
                title: dedent(`
                    ...
                    alcuna fattura
                `),
                subtitle: 'Invia una fattura o prova Expensify per scoprirne di più.',
            ...
            emptySubmitResults: {
                ...
                subtitle: 'Tutto a posto. Goditi il giro d’onore!',
            ...
            emptyStatementsResults: {
                title: 'Nessuna spesa da mostrare',
        ...
        exportSearchResults: {
            ...
            description: 'Wow, sono davvero tanti elementi! Li raggruppiamo e Concierge ti invierà un file a breve.',
        },
        exportAll: {
    ...
    fileDownload: {
        success: {
            ...
            qrMessage:
                'Controlla la cartella delle foto o dei download per trovare una copia del tuo codice QR. Suggerimento: aggiungilo a una presentazione, così il tuo pubblico potrà scannerizzarlo e connettersi direttamente con te.',
        },
        generalError: {
    ...
    checkForUpdatesModal: {
        ...
        notAvailable: {
            ...
            message: 'Non ci sono aggiornamenti disponibili al momento. Per favore riprova più tardi!',
            okay: 'Ok',
        },
        error: {
            title: 'Verifica aggiornamenti non riuscita',
            message: 'Impossibile verificare la presenza di un aggiornamento. Riprova tra qualche istante.',
        },
    },
    settlement: {
        status: {
            pending: 'In sospeso',
            cleared: 'Riconciliato',
            failed: 'Non riuscito',
        },
    ...
    report: {
        ...
        actions: {
            type: {
                changeField: ({oldValue, newValue, fieldName}: ChangeFieldParams) => `modificato ${fieldName} in "${newValue}" (precedentemente "${oldValue}")`,
                ...
                changeType: ({oldType, newType}: ChangeTypeParams) => `tipo cambiato da ${oldType} a ${newType}`,
                ...
                exportedToIntegration: {
                    ...
                    reimburseableLink: 'spese anticipate di tasca propria',
                    nonReimbursableLink: 'spese con carta aziendale',
                    pending: ({label}: ExportedToIntegrationParams) => `esportazione di questo report avviata su ${label}...`,
                },
                ...
                selectedForRandomAuditMarkdown: `selezionato casualmente per la revisione`,
                share: ({to}: ShareParams) => `membro invitato ${to}`,
                unshare: ({to}: UnshareParams) => `membro ${to} rimosso`,
                stripePaid: ({amount, currency}: StripePaidParams) => `pagato ${currency}${amount}`,
                takeControl: `ha preso il controllo`,
                integrationSyncFailed: ({label, errorMessage, workspaceAccountingLink}: IntegrationSyncFailedParams) =>
                    `si è verificato un problema durante la sincronizzazione con ${label}${errorMessage ? ` ("${errorMessage}")` : ''}. Risolvi il problema nelle <a href="${workspaceAccountingLink}">impostazioni dell’area di lavoro</a>.`,
                addEmployee: ({email, role}: AddEmployeeParams) => `aggiunto ${email} come ${role === 'member' ? 'a' : 'un'} ${role}`,
                updateRole: ({email, currentRole, newRole}: UpdateRoleParams) => `ruolo di ${email} aggiornato a ${newRole} (precedentemente ${currentRole})`,
                updatedCustomField1: ({email, previousValue, newValue}: UpdatedCustomFieldParams) => {
                    if (!newValue) {
                        return `rimossa la voce "${previousValue}" dal campo personalizzato 1 di ${email}`;
                    }
                ...
                updatedCustomField2: ({email, previousValue, newValue}: UpdatedCustomFieldParams) => {
                    if (!newValue) {
                        return `rimossa la voce personalizzata 2 di ${email} (in precedenza “${previousValue}”)`;
                    }
                    return !previousValue
    ...
    accessibilityHints: {
        ...
        lastChatMessagePreview: 'Anteprima ultimo messaggio della chat',
        workspaceName: 'Nome spazio di lavoro',
    ...
    moderation: {
        ...
        intimidationDescription: 'Portare avanti con insistenza un programma ignorando obiezioni valide',
        bullying: 'Bullismo',
        bullyingDescription: 'Prendere di mira un individuo per ottenere obbedienza',
        harassment: 'Molestie',
        harassmentDescription: 'Comportamento razzista, misogino o ampiamente discriminatorio',
        assault: 'Aggressione',
        assaultDescription: 'Attacco emotivo specificamente mirato con l’intento di causare danno',
        flaggedContent: 'Questo messaggio è stato segnalato come in violazione delle nostre regole della community e il contenuto è stato nascosto.',
    ...
    teachersUnitePage: {
        ...
        schoolPrincipalVerifyExpense:
            'Expensify.org divide il costo del materiale scolastico essenziale in modo che gli studenti provenienti da famiglie a basso reddito possano avere un’esperienza di apprendimento migliore. Al tuo preside verrà richiesto di verificare le tue spese.',
        principalFirstName: 'Nome di battesimo principale',
    ...
    referralProgram: {
        ...
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
            ...
            body: 'Vuoi che anche il tuo team usi Expensify? Ti basta inviare loro una nota spese e noi ci occuperemo del resto.',
        },
    ...
    violations: {
        ...
        missingTag: ({tagName}: ViolationsMissingTagParams = {}) => `Manca ${tagName ?? 'tag'}`,
            ...
            switch (type) {
                ...
                default:
                    if (displayPercentVariance) {
                        return `Importo maggiore del ${displayPercentVariance}% rispetto alla ricevuta scansionata`;
                    }
                    return 'Importo superiore alla ricevuta acquisita';
            }
        },
        modifiedDate: 'La data è diversa rispetto alla ricevuta scansionata',
        ...
        overLimit: ({formattedLimit}: ViolationsOverLimitParams) => `Importo superiore al limite di ${formattedLimit}/persona`,
        overTripLimit: ({formattedLimit}: ViolationsOverLimitParams) => `Importo oltre il limite di ${formattedLimit}/viaggio`,
        overLimitAttendee: ({formattedLimit}: ViolationsOverLimitParams) => `Importo superiore al limite di ${formattedLimit}/persona`,
        ...
        rter: ({brokenBankConnection, isAdmin, isTransactionOlderThan7Days, member, rterType, companyCardPageURL}: ViolationsRterParams) => {
            ...
            if (brokenBankConnection || rterType === CONST.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ...
                    : 'Connessione bancaria interrotta. Chiedi a un amministratore di riconnettere il conto per abbinare la ricevuta.';
            }
        ...
        receiptGeneratedWithAI: 'Ricevuta potenzialmente generata da IA',
        ...
        confirmDuplicatesInfo: `I duplicati che non mantieni saranno conservati per essere eliminati da chi li ha inviati.`,
    ...
    exitSurvey: {
        ...
        prompts: {
            [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]: 'Di quale funzionalità hai bisogno che non è disponibile nella nuova Expensify?',
        ...
        offline:
            'Sembra che tu sia offline. Purtroppo Expensify Classic non funziona offline, ma la Nuova Expensify sì. Se preferisci utilizzare Expensify Classic, riprova quando avrai una connessione a Internet.',
        quickTip: 'Suggerimento rapido...',
        quickTipSubTitle: 'Puoi andare direttamente a Expensify Classic visitando expensify.com. Aggiungilo ai preferiti per avere una scorciatoia rapida!',
        bookACall: 'Prenota una chiamata',
        bookACallTitle: 'Vuoi parlare con un product manager?',
        benefits: {
            [CONST.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY]: 'Chat direttamente sulle spese e sui report',
    ...
    subscription: {
        ...
        billingBanner: {
            ...
            policyOwnerUnderInvoicing: {
                title: 'Le tue informazioni di pagamento non sono aggiornate',
                subtitle: ({date}: BillingBannerSubtitleWithDateParams) =>
                    `Il tuo pagamento è scaduto. Ti preghiamo di pagare la fattura entro il ${date} per evitare l’interruzione del servizio.`,
            },
            ...
            preTrial: {
                ...
                subtitle: 'Come passo successivo, <a href="#">completa la tua checklist di configurazione</a> così il tuo team può iniziare a registrare le spese.',
            },
            trialStarted: {
        ...
        cardSection: {
            ...
            requestRefundModal: {
                full: 'Ottenere un rimborso è semplice: ti basta effettuare il downgrade del tuo account prima della prossima data di fatturazione e riceverai un rimborso. <br /> <br /> Attenzione: Effettuare il downgrade del tuo account significa che il tuo/i tuo(i) workspace verrà/ verranno eliminato/i. Questa azione non può essere annullata, ma potrai sempre creare un nuovo workspace se cambi idea.',
                confirm: 'Elimina area(e) di lavoro e effettua il downgrade',
            },
        ...
        yourPlan: {
            ...
            perMemberMonth: 'per utente/mese',
            collect: {
                title: 'Raccogli',
                description: 'Il piano per le piccole imprese che ti offre note spese, viaggi e chat.',
        ...
        details: {
            ...
            headsUp:
                'Attenzione: se non imposti ora la dimensione del tuo abbonamento, la imposteremo automaticamente in base al numero di membri attivi del tuo primo mese. Sarai quindi tenuto a pagare almeno per questo numero di membri per i prossimi 12 mesi. Puoi aumentare la dimensione del tuo abbonamento in qualsiasi momento, ma non puoi diminuirla fino alla fine dell’abbonamento.',
        ...
        subscriptionSize: {
            ...
            eachMonth:
                'Ogni mese, il tuo abbonamento copre fino al numero di membri attivi impostato sopra. Ogni volta che aumenti le dimensioni del tuo abbonamento, inizierai un nuovo abbonamento di 12 mesi a quella nuova dimensione.',
        ...
        paymentCard: {
            ...
            security: 'Expensify è conforme allo standard PCI-DSS, utilizza crittografia a livello bancario e un’infrastruttura ridondante per proteggere i tuoi dati.',
            learnMoreAboutSecurity: 'Scopri di più sulla nostra sicurezza.',
        },
        subscriptionSettings: {
            title: 'Impostazioni sottoscrizione',
            ...
            automaticallyIncrease:
                'Aumenta automaticamente i posti annuali per tenere conto dei membri attivi che superano le dimensioni del tuo abbonamento. Nota: questo estenderà la data di fine del tuo abbonamento annuale.',
            disableAutoRenew: 'Disattiva rinnovo automatico',
            helpUsImprove: 'Aiutaci a migliorare Expensify',
            whatsMainReason: 'Qual è il motivo principale per cui disattivi il rinnovo automatico?',
        ...
        requestEarlyCancellation: {
            ...
            subtitle: 'Qual è il motivo principale per cui richiedi l’annullamento anticipato?',
            subscriptionCanceled: {
                title: 'Abbonamento annullato',
                subtitle: 'Il tuo abbonamento annuale è stato annullato.',
                info: 'Se desideri continuare a utilizzare il tuo workspace (o i tuoi workspace) con il pagamento a consumo, sei a posto.',
                preventFutureActivity: ({workspacesListRoute}: WorkspacesListRouteParams) =>
                    `Se desideri impedire attività e addebiti futuri, devi <a href="${workspacesListRoute}">eliminare il tuo (i tuoi) workspace</a>. Tieni presente che, quando elimini il tuo (i tuoi) workspace, ti verrà addebitata qualsiasi attività in sospeso sostenuta durante il mese solare in corso.`,
            },
            requestSubmitted: {
                title: 'Richiesta inviata',
                subtitle:
                    'Grazie per averci fatto sapere che sei interessato a cancellare il tuo abbonamento. Stiamo esaminando la tua richiesta e ti ricontatteremo presto tramite la tua chat con <concierge-link>Concierge</concierge-link>.',
            },
            acknowledgement: `Richiedendo la cancellazione anticipata, riconosco e accetto che Expensify non ha alcun obbligo di concedere tale richiesta ai sensi dei <a href=${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}>Termini di servizio</a> di Expensify o di qualsiasi altro contratto di servizi applicabile tra me ed Expensify e che Expensify mantiene la piena ed esclusiva discrezionalità in merito alla concessione di qualsiasi tale richiesta.`,
        },
    },
    feedbackSurvey: {
    ...
    delegate: {
        ...
        accessLevelDescription:
            'Scegli un livello di accesso qui sotto. Sia l’accesso Completo che quello Limitato consentono ai copiloti di visualizzare tutte le conversazioni e tutte le spese.',
    ...
    debug: {
        ...
        createReportAction: 'Crea report azione',
        ...
        reasonVisibleInLHN: {
            ...
            hasGBR: 'Ha GBR',
            hasRBR: 'Ha RBR',
            pinnedByUser: 'Appuntato dal membro',
            ...
            isSelfDM: 'È un messaggio diretto a te stesso',
            isFocused: 'È temporaneamente attivo',
        },
        reasonGBR: {
            hasJoinRequest: 'Ha richiesta di partecipazione (stanza admin)',
        ...
        indicatorStatus: {
            ...
            aContactMethodRequiresVerification: 'È richiesta la verifica di un metodo di contatto',
    ...
    productTrainingTooltip: {
        ...
        scanTestTooltip: {
            ...
            confirmation: '<tooltip>Ora, <strong>invia la tua spesa</strong> e guarda accadere\nla magia!</tooltip>',
            tryItOut: 'Provalo',
        },
    ...
    scheduledCall: {
        ...
        confirmation: {
            ...
            description: 'Assicurati che i dettagli seguenti vadano bene per te. Dopo aver confermato la chiamata, ti invieremo un invito con maggiori informazioni.',
    ...
    autoSubmitModal: {
        ...
        pendingExpensesDescription: 'Le eventuali spese in sospeso sulla carta sono state spostate in un report separato finché non vengono contabilizzate.',
    },
    testDrive: {
        quickAction: {
        ...
        modal: {
            ...
            employee: {
                description:
                    '<muted-text>Ottieni per il tuo team <strong>3 mesi gratuiti di Expensify!</strong> Inserisci l’email del tuo capo qui sotto e inviagli una nota spese di prova.</muted-text>',
...
Ehi! Ho appena ottenuto per noi *3 mesi gratis* per provare Expensify, il modo più veloce per gestire le note spese.
    ...
    domain: {
        ...
        samlFeatureList: {
            ...
            subtitle: ({domainName}: {domainName: string}) =>
                `<muted-text><a href="${CONST.SAML_HELP_URL}">SAML SSO</a> è una funzionalità di sicurezza che ti offre un maggiore controllo sulle modalità di accesso a Expensify dei membri con email <strong>${domainName}</strong>. Per abilitarla, dovrai verificare di essere un amministratore aziendale autorizzato.</muted-text>`,
            fasterAndEasierLogin: 'Accesso più veloce e facile',
        ...
        samlLogin: {
            ...
            anyMemberWillBeRequired: 'Qualsiasi membro che ha effettuato l’accesso con un metodo diverso dovrà eseguire nuovamente l’autenticazione utilizzando SAML.',
