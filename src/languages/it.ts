        ...
        recruiting: {
            ...
            filters: {
                ...
                stages: {
                    ...
                    toggleTitle: 'Fasi del processo di importazione',
                    allSelected: 'Tutte le fasi di lavoro',
                    emptySelectionError: 'Seleziona almeno una fase di lavoro',
                },
                tags: {
                    title: 'Tag',
                    description: 'Scegli i tag dei candidati che vuoi sincronizzare con questo workspace',
                    toggleTitle: 'Importa tag',
                    allSelected: 'Tutte le etichette',
                    emptySelectionError: 'Seleziona almeno un tag',
                },
                offices: {
                    title: 'Ufficio',
                    description: 'Scegli gli uffici dei candidati che vuoi sincronizzare con questo spazio di lavoro',
                    toggleTitle: 'Importa uffici (facoltativo)',
