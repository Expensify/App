...
Il piano Control parte da 9 $ al mese per ogni membro attivo.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    title: 'Modalità di lavoro predefinita',
                    officeBasedTitle: 'In ufficio',
                    officeBasedHelp: 'Il membro si reca in un ufficio. I tragitti casa-lavoro abituali sono esclusi dal rimborso.',
                    noRegularWorkplaceTitle: 'Nessun luogo di lavoro fisso',
                    noRegularWorkplaceHelp: 'Il membro lavora da remoto o non ha un luogo di lavoro fisso, quindi le regole sul tragitto casa-lavoro non si applicano.',
                    startingPrompt: {
                        title: 'Imposta una modalità di lavoro tipica',
                        prompt: 'Scegli la modalità che vale per la maggior parte dei membri attuali. Potrai aggiornare i membri singolarmente o in blocco in seguito.',
                        officeBasedHelp: 'La maggior parte dei membri si reca in un ufficio. I tragitti abituali sono esclusi.',
...
Aggiungi altre regole di spesa per proteggere il flusso di cassa aziendale.`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            ...
            set: ({arrangement}: {arrangement: string}) => `ha impostato la modalità di lavoro predefinita su «${arrangement}»`,
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `ha cambiato la modalità di lavoro predefinita in «${arrangement}» (in precedenza «${previousArrangement}»)`,
        },
        commuterExclusions: {
