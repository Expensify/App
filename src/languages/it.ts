...
const translations = {
    ...
    bankAccount: {
        ...
        hasCurrencyError:
            'Ops! Sembra che la valuta del tuo spazio di lavoro sia impostata su una valuta diversa da USD. Per procedere, vai a <a>le impostazioni del tuo spazio di lavoro</a> impostarlo su USD e riprovare.',
        error: {
