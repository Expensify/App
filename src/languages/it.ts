    ...
    walletPage: {
        ...
        fixBankAccount: {
            ...
            insufficientFundsBody:
                '<muted-text>Le transazioni di prova non sono andate a buon fine per fondi insufficienti.<br/>Quando i fondi saranno disponibili, usa il pulsante qui sotto.</muted-text>',
