...
${amount} per ${merchant} - ${date}`,
    ...
    activateCardPage: {
        ...
        fillInAllDetails: 'Compila tutti i dettagli qui sotto',
    },
    getPhysicalCard: {
...
Il piano Control parte da 9 $ al mese per ogni membro attivo.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                shippingAddressDescription: 'Dicci dove dobbiamo inviare la nuova carta.',
                promptCardholder: 'Richiedi al titolare della carta',
                promptCardholderDescription: 'Al titolare della carta verrà chiesto di inserire o confermare il proprio indirizzo di spedizione.',
