...
${amount} per ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        perDiem: {
            ...
            requestEmptyList: {
                title: 'Nessuna tariffa di diaria per ora',
                subtitle: 'Questo spazio di lavoro non ha tariffe di diaria, chiedi al tuo amministratore di aggiungerne.',
                adminSubtitle: 'Aggiungi tariffe di diaria per organizzare le tue spese.',
            },
