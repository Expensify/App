...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    spreadsheet: {
        ...
        fieldNotMapped: (fieldName: string) => `Ops! Un campo obbligatorio ("${fieldName}") non è stato mappato. Per favore, controlla e riprova.`,
        ...
        importCategoriesSuccessfulDescription: (categories: number) => (categories > 1 ? `Sono state aggiunte ${categories} categorie.` : 'È stata aggiunta 1 categoria.'),
        ...
        importTagsSuccessfulDescription: (tags: number) => (tags > 1 ? `Sono stati aggiunti ${tags} tag.` : 'È stato aggiunto 1 tag.'),
        importMultiLevelTagsSuccessfulDescription: 'Sono stati aggiunti i tag multilivello.',
        importPerDiemRatesSuccessfulDescription: (rates: number) => (rates > 1 ? `Le tariffe di diaria ${rates} sono state aggiunte.` : 'È stata aggiunta 1 indennità giornaliera.'),
...
${amount} per ${merchant} - ${date}`,
    ...
    transferAmountPage: {
        ...
        instantSummary: (rate: string, minAmount: string) => `Commissione ${rate}% (${minAmount} minimo)`,
...
${
    ...
    privatePersonalDetails: {
        ...
        error: {
            ...
            incorrectZipFormat: (zipFormat?: string) => `Formato codice postale non corretto${zipFormat ? `Formato accettabile: ${zipFormat}` : ''}`,
