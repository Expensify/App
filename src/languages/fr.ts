...
${amount} pour ${merchant} - ${date}`,
    ...
    expenseRulesPage: {
        ...
        changes: {
            updateBillable: (value: boolean) => `Mettre à jour la dépense ${value ? 'facturable' : 'non facturable'}`,
            updateCategory: (value: string) => `Mettre à jour la catégorie en « ${value} »`,
            updateComment: (value: string) => `Modifier la description en « ${value} »`,
            updateMerchant: (value: string) => `Mettre à jour le marchand en « ${value} »`,
            updateReimbursable: (value: boolean) => `Mettre à jour la dépense ${value ? 'remboursable' : 'non remboursable'}`,
            updateTag: (value: string) => `Mettre à jour le tag sur « ${value} »`,
            updateTax: (value: string) => `Mettre à jour le taux de taxe à ${value}`,
