...
const translations = {
    ...
    workspace: {
        ...
        changeOwner: {
            ...
            addPaymentCardReadAndAcceptText: `Lire et accepter <a href=${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}>termes</a> & <a href=${CONST.OLD_DOT_PUBLIC_URLS.PRIVACY_URL}>confidentialité</a> politique pour ajouter votre carte`,
