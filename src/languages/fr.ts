...
3. Une fois le flux activé, cliquez sur « Submit » ci-dessous et nous nous chargerons de l’ajouter.`,
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `Espace(s) réservé(s) de formule non valide(s) : ${placeholders}. Veuillez utiliser des espaces réservés pris en charge comme {report:id}, {report:name}, {report:created}, etc.`,
