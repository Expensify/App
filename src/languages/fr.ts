...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        movedFromPersonalSpace: (workspaceName?: string, reportName?: string) => `a déplacé la dépense de l’espace personnel vers ${workspaceName ?? `discuter avec ${reportName}`}`,
...
Si vous souhaitez prendre en charge la facturation de l’ensemble de son abonnement, demandez-lui d’abord de vous ajouter comme administrateur à tous ses espaces de travail avant de prendre en charge la facturation.`,
        ...
        exportAgainModal: {
            ...
            ) => `Les notes de frais suivantes ont déjà été exportées vers ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]} :
