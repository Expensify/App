...
${amount} pour ${merchant} - ${date}`,
    ...
    events: {
        bookEvents: 'Réserver des événements',
        title: 'Événements',
        emptyTitle: 'Aucun événement pour le moment',
        emptySubtitle: 'Les événements que vous pouvez réserver apparaîtront ici.',
        error: 'Nous n’avons pas pu charger les événements.',
        retry: 'Réessayer',
