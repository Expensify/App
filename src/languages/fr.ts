...
Exigez des informations de dépense comme les reçus et les descriptions, définissez des limites et des valeurs par défaut, et automatisez les validations et les paiements – tout au même endroit.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                ruleSummaryTitleContains: (merchantName: string) => `Si le commerçant contient « ${merchantName} »`,
                ruleSummaryTitleExact: (merchantName: string) => \`Si le commerçant est exactement « \${merchantName} »\`,
                matchType: 'Type de correspondance',
                matchTypeContains: 'Contient',
                matchTypeContainsDescription: 'Correspondance des dépenses où le nom du commerçant contient le texte spécifié (insensible à la casse)',
                matchTypeExact: 'Correspond exactement',
                matchTypeExactDescription: 'Correspondance des dépenses où le nom du commerçant correspond exactement au texte spécifié',
