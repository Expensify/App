...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            connectionsSubtitle:
                "[fr] Connect to your HR system to sync employee data, auto-match reimbursements to the right people, and keep your team's expenses accurate without the manual work.",
            ...
            amount: {
                ...
                between: (greaterThan?: string, lessThan?: string) => {
                    if (greaterThan && lessThan) {
                        return `[fr] Between ${greaterThan} and ${lessThan}`;
                    }
                    return '[fr] Between';
                },
