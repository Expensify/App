...
${amount} pour ${merchant} - ${date}`,
        ...
        cardUnlocked: 'Carte déverrouillée !',
        cardUnlockedDescription: 'Il vous sera peut-être demandé d’insérer votre carte dans le lecteur lors de votre prochain achat.',
