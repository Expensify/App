...
${amount} pour ${merchant} - ${date}`,
        ...
        cardUnblocked: 'Carte déverrouillée !',
        cardUnblockedDescription: 'Il vous sera peut-être demandé d’insérer votre carte dans le lecteur lors de votre prochain achat.',
        pinBlocked: 'Votre carte a été bloquée en raison de codes PIN incorrects saisis.',
        unblock: 'Déverrouiller',
        unblockCard: 'Déverrouiller la carte',
    },
    workflowsPage: {
