...
${amount} pour ${merchant} - ${date}`,
    ...
    onboarding: {
        ...
        peopleYouMayKnow: 'Vérifiez si votre équipe est déjà ici',
        workspaceYouMayJoin: (domain: string, email: string) =>
            `Vérifiez votre e-mail pour voir si quelqu’un de ${domain} dispose d’un espace de travail que vous pouvez rejoindre. Saisissez le code magique envoyé à ${email}.`,
