...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        calendarOpened: '[fr] calendar opened',
        send: '[fr] Send',
        na: '[fr] N/A',
...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        revealCardDetail: {
            couldNotReveal: "[fr] We couldn't reveal your card details. Please try again.",
        },
    },
    validateCodeModal: {
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            unlockBankAccount: {
                workspaceTitle: '[fr] Your business bank account has been locked',
                personalTitle: '[fr] Your bank account has been locked',
                workspaceSubtitle: ({policyName}: {policyName: string}) => policyName,
                personalSubtitle: '[fr] Wallet',
            },
        },
        freeTrialSection: {
        ...
        yourSpend: {
            title: '[fr] Your spend',
            awaitingApproval: '[fr] Awaiting approval',
            repaidLast30Days: '[fr] Repaid in the last 30 days',
            recentTransactions: ({lastFour}: {lastFour: string}) => `[fr] Recent transactions • ${lastFour}`,
        },
        seeMore: ({count}: {count: number}) => `[fr] See ${count} more`,
        ...
        gettingStartedSection: {
            ...
            inviteAccountant: '[fr] Invite your accountant',
    ...
    spreadsheet: {
        ...
        importCompanyCardTransactionsPendingMessage: '[fr] New cards and transactions may take some time to appear, please hang tight.',
    ...
    iou: {
        ...
        movedFromReport: (reportName: string) => `[fr] moved an expense from ${reportName}`,
        movedFromReportNoName: '[fr] moved an expense',
        movedTransactionTo: (reportUrl: string, reportName: string) => `[fr] moved this expense to <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionToAnotherReport: '[fr] moved this expense to another report',
        movedTransactionFrom: (reportUrl: string, reportName: string) => `[fr] moved this expense from <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionFromAnotherReport: '[fr] moved this expense from another report',
        ...
        allTransactionsPendingNextStep: "[fr] All transactions are pending. You can't submit this report until they post in a few days.",
        ...
        confirmPaymentReceivedModalTitle: '[fr] Confirm payment received',
        receivedPayment: '[fr] Received payment',
        receivedPaymentConfirmation: "[fr] Please proceed only if you've already received payment outside of Expensify.",
        confirmReceivedPayment: "[fr] Yes, I've received payment",
        ...
        updatedTheRequest: (valueName: string, newValueToDisplay: string, oldValueToDisplay: string) => `[fr] the ${valueName} to ${newValueToDisplay} (previously ${oldValueToDisplay})`,
        ...
        error: {
            ...
            invalidReadings: '[fr] Please enter both start & end readings to continue',
            ...
            unableToSubmitReport: '[fr] Unable to submit report',
            allTransactionsPendingDescription: "[fr] You can't submit this report because all transactions are pending. They may take a few days to post.",
            failedToSaveOdometerDraft: "[fr] Couldn't save your odometer draft. Please try again.",
            ...
            receiptUploadFailedMessage: '[fr] Receipt upload failed. Save the receipt, or delete the expense and lose it.',
            saveReceipt: '[fr] Save receipt',
        ...
        changeApprover: {
            ...
            reassignedApproverMessage: (managerID: number) => `[fr] reassigned the approver to <mention-user accountID="${managerID}"/> via a workflow update`,
            actions: {
    ...
    deviceManagementPage: {
        title: '[fr] Device management',
        description:
            '[fr] Manage all the devices that you have logged into with your Expensify Account. <a href="https://help.expensify.com/articles/new-expensify/settings/Manage-Logged-in-Devices">Learn more</a>.',
        revoke: '[fr] Revoke',
        unknownDevice: '[fr] Unknown Device',
    },
    twoFactorAuth: {
        ...
        `),
        screenshotTip: '[fr] Tip: Screenshot this to save it to your photo library',
    ...
    walletPage: {
        ...
        cardActive: '[fr] Active',
        bankAccountStatus: {
            active: '[fr] Active',
            incomplete: '[fr] Incomplete',
            pending: '[fr] Pending',
            verifying: '[fr] Verifying',
            locked: '[fr] Locked',
            incompleteDescription: '[fr] Finish adding bank account',
            pendingDescription: '[fr] Please confirm test transactions',
            verifyingDescription: "[fr] We're reviewing your documentation",
            lockedDescription: '[fr] This account requires attention',
            finish: '[fr] Finish',
            confirm: '[fr] Confirm',
            unlock: '[fr] Unlock',
        },
        cardFixConnection: '[fr] Please fix this connection',
        cardAskAdminToFix: '[fr] Please ask an admin to fix this connection',
        cardAdminFixConnection: '[fr] Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `[fr] Last synced ${dateStr}`,
        assignedCards: '[fr] Cards',
        assignedCardsDescription: '[fr] Transactions from assigned cards sync automatically.',
...
${amount} for ${merchant} - ${date}`,
        ...
        cardUnblocked: '[fr] Card unblocked!',
        cardUnblockedDescription: '[fr] You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: '[fr] Your card was blocked due to incorrect PIN entries.',
        unblock: '[fr] Unblock',
        unblockCard: '[fr] Unblock card',
    ...
    workflowsPage: {
        ...
        configureViaHR: ({provider}: {provider: string}) => `[fr] Configure via ${provider}.`,
        hrApprovalWorkflowLockedPrompt: ({provider}: {provider: string}) =>
            `[fr] Approvals are managed by your ${provider} integration. To update your approval workflow, head to your ${provider} connection settings.`,
        goToHRSettings: ({provider}: {provider: string}) => `[fr] Go to ${provider} settings`,
    ...
    reportFraudConfirmationPage: {
        ...
        descriptionCardNotReplaced: '[fr] Your card was permanently deactivated. Please contact an admin to issue a new card.',
    ...
    agentsPage: {
        title: '[fr] Agents',
        subtitle: '[fr] Create agents to handle your workflow. Skip the manual work and get hours back in your day.',
        newAgent: '[fr] New agent',
        emptyAgents: {
            title: '[fr] No agents created',
            subtitle: '[fr] Stop manually doing stuff. Instruct an agent instead and save yourself lots of time.',
        },
        error: {
            genericAdd: '[fr] There was a problem adding this agent',
            genericUpdate: '[fr] There was a problem updating this agent',
            updateName: "[fr] There was a problem updating this agent's name",
            updatePrompt: "[fr] There was a problem updating this agent's instructions",
            updateAvatar: "[fr] There was a problem updating this agent's avatar",
        },
    },
    addAgentPage: {
        title: '[fr] New agent',
        agentName: '[fr] Agent name',
        instructions: '[fr] Write custom instructions',
        createAgent: '[fr] Create agent',
        editAvatar: '[fr] Edit avatar',
        defaultAgentName: (displayName: string) => `[fr] ${displayName}'s Agent`,
        defaultPrompt:
            "[fr] Reject expenses that are for gambling, movies, or other obvious non-business reasons.\n\nRemind the user to always include a receipt image that makes the tip clear.\n\nApprove the report if it's very similar to previous reports from the same user.\n\nReject reports with more than $500 in travel expenses.",
    },
    editAgentPage: {
        title: '[fr] Edit agent',
        agentName: '[fr] Agent name',
        instructions: '[fr] Write custom instructions',
        deleteAgent: '[fr] Delete agent',
        deleteAgentTitle: '[fr] Delete agent?',
        deleteAgentMessage: '[fr] Are you sure you want to delete this agent? This action cannot be undone.',
    },
    editAgentAvatarPage: {
        title: '[fr] Edit avatar',
    },
    editAgentNamePage: {
        title: '[fr] Agent name',
    },
    editAgentPromptPage: {
        title: '[fr] Write custom instructions',
        error: {
            emptyPrompt: '[fr] Please enter instructions for your agent.',
        },
    },
    expenseRulesPage: {
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '[fr] <strong>Avoid scams. Do not share your code with anyone.</strong> Our team will never call, text, or email you for this code.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[fr] Here's the list of workspaces you can join.",
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: '[fr] Submit expenses to my employer',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "[fr] Manage my team's expenses",
            [CONST.ONBOARDING_CHOICES.TRACK_BUSINESS]: '[fr] Track expenses for my business',
            [CONST.ONBOARDING_CHOICES.TRACK_PERSONAL]: '[fr] Organize my personal spending',
        ...
        workEmail2FAError: '[fr] This login is an existing account with Two-Factor Authentication (2FA) enabled.',
        mergeBlockScreen: {
            ...
            workAccountClosedSubtitle: '[fr] The work account associated with this email is closed. Please contact your company admin to reactivate it, or sign up with a different email.',
        },
        tasks: {
            testDriveAdminTask: {
    ...
    statusPage: {
        ...
        addVacationDelegate: '[fr] Add vacation delegate',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    addPersonalBankAccount: {
        ...
        updatePersonalInfo: '[fr] Update bank account',
        updatePersonalInfoFailure: '[fr] Unable to update bank account information. Please try again later.',
        updateSuccessTitle: '[fr] Bank account updated!',
        updateSuccessHeader: '[fr] Bank account updated',
        updateSuccessMessage: '[fr] Congrats, your bank account is set up and ready to receive reimbursements.',
    },
    ...
    messages: {
        ...
        userIsAlreadyMember: (login: string, name: string) => `[fr] ${login} is already a member of ${name}`,
        userIsAlreadyAnAdmin: (login: string, name: string) => `[fr] ${login} is already an admin of ${name}`,
    },
    onfidoStep: {
    ...
    workspace: {
        common: {
            ...
            cardAdminAlternateText: '[fr] Manage workspace cards.',
            peopleAdminAlternateText: '[fr] Manage members and approval workflows.',
            paymentsAdminAlternateText: '[fr] Manage workflow payments.',
            reimbursementChoice: {
            ...
            roleName: (role?: string) => {
                switch (role) {
                    ...
                    case CONST.POLICY.ROLE.CARD_ADMIN:
                        return '[fr] Card Admin';
                    case CONST.POLICY.ROLE.PEOPLE_ADMIN:
                        return '[fr] People Admin';
                    case CONST.POLICY.ROLE.PAYMENTS_ADMIN:
                        return '[fr] Payments Admin';
            ...
            travelInvoicing: '[fr] Export travel invoicing expenses as',
            travelInvoicingVendor: '[fr] Travel vendor',
            travelInvoicingPayableAccount: '[fr] Travel payable account',
        },
        createdForClient: {
            title: "[fr] You've created a workspace for your client!",
            description: '[fr] Great news 🎉. Reach out to us if they need any help with the setup.',
        },
        receiptPartners: {
            uber: {
        ...
        qbo: {
            ...
            bankAccountDescription: '[fr] Choose where to send checks from.',
            creditCardAccount: '[fr] Credit card account',
            travelInvoicingDescription: '[fr] Travel expenses will export as credit card charges to the QuickBooks Online account specified below.',
        ...
        xero: {
            ...
            travelInvoicingDescription: '[fr] Travel expenses will export as bank transactions to the Xero account specified below.',
        ...
        sageIntacct: {
            ...
            travelInvoicingDescription: '[fr] Travel expenses will export as credit card charges to the Sage Intacct account specified below.',
            creditCardAccount: '[fr] Credit card account',
        ...
        certinia: {
            title: '[fr] Certinia',
            prerequisites: {
                title: '[fr] Before you connect',
                installBundle: '[fr] For FFA Connections',
                installBundleDescription: ({href, version}: {href: string; version: string}) =>
                    `[fr] Install the Expensify bundle in Salesforce by clicking this link: <a href="${href}">Install FFA Expensify Bundle (Version ${version})</a>`,
                installBundleConfirm: "[fr] I've installed the bundle",
                setupContacts: '[fr] Set up user and contacts',
                setupContactsBullet1:
                    "[fr] Create both a User and a Contact for yourself if these don't already exist in Certinia making sure the email matches your primary email in Expensify.\n\n",
                setupContactsBullet2:
                    "[fr] Create contacts for each employee who will be submitting expense reports and for each report approver. Make sure each contact's email address corresponds with the email address on the employee's Expensify account.\n\n",
                setupContactsBullet3: '[fr] Set permission controls for your user for each contact/resource.\n\n',
                setupContactsConfirm: "[fr] I've set up the user and contacts",
                oauth: '[fr] Log in through Salesforce',
                oauthDescription: "[fr] To finish setup, you'll have to sign in through Salesforce and Certinia.\n\nUse the button below to continue.",
                connectButton: '[fr] Connect to Certinia',
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '[fr] Single entry for each expense',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '[fr] Single, itemized entry for each report',
                },
            },
            invoiceItem: {
...
_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                fileImportDescription: "[fr] A manual option if your bank can't send a feed.",
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                duplicateFeedModal: {
                    title: '[fr] Card feed already connected',
                    prompt: "[fr] You can't add the same card feed to the same workspace twice.",
                },
                csvColumns: {
        ...
        expensifyCard: {
            ...
            exportAsCSV: '[fr] Export as CSV',
            csvColumnType: '[fr] Type',
            csvColumnLimitType: '[fr] Limit type',
            csvColumnLimit: '[fr] Limit',
            findCard: '[fr] Find card',
            newCard: '[fr] New card',
            name: '[fr] Name',
            lastFour: '[fr] Last 4',
            ...
            applyCashbackToBill: '[fr] Apply cash back to my Expensify bill',
            applyCashbackToBillDescription: '[fr] Cash back from the Expensify Card will be used towards payment for your Expensify bill.',
            frequency: {
                daily: '[fr] Daily',
                monthly: '[fr] Monthly',
            },
        ...
        moreFeatures: {
                ...
                travelInvoicing: {
                    ...
                    travelInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[fr] We weren't able to provision some of the members of your workspace for travel invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[fr] Travel Invoicing enabled!',
            ...
            hrWarningModal: {
                disconnectText: ({integration}: {integration: string}) => `[fr] To disable HR, please disconnect ${integration} from this workspace first.`,
            },
        ...
        copyPolicySettings: {
            error: '[fr] An error occurred while copying workspace settings. Please try again.',
            title: '[fr] Copy settings',
            selectWorkspaces: '[fr] Select workspaces',
            description: '[fr] Choose the workspaces you want to copy settings to, then select the settings you’d like to copy.',
            searchPlaceholder: '[fr] Search workspaces',
        },
        emptyWorkspace: {
        ...
        people: {
            ...
            configureHRSync: (providerName: string) => `[fr] Configure ${providerName} sync.`,
            syncWithHR: (providerName: string) => `[fr] Sync with ${providerName}`,
            allMembers: '[fr] All members',
            admins: '[fr] Admins',
            approvers: '[fr] Approvers',
            auditors: '[fr] Auditors',
            emptyRoleFilter: {
                title: '[fr] No members match this filter',
                subtitle: '[fr] Invite a member or change the filter above.',
            },
        ...
        accounting: {
            ...
            updateCredentials: '[fr] Update credentials',
            claimOffer: {
            ...
            syncTravelInvoicingSettlements: '[fr] Sync travel invoicing settlements',
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '[fr] Choose the bank account that your travel invoicing payments will be reconciled against.',
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `[fr] Make sure this account matches your travel invoicing settlement account (ending in ${lastFourPAN}) so Continuous Reconciliation works properly.`,
            },
        },
        hr: {
            title: '[fr] HR',
            ...
            syncNow: '[fr] Sync now',
            disconnect: '[fr] Disconnect',
            disconnectTitle: (providerName: string) => `[fr] Disconnect ${providerName}`,
            disconnectPrompt: (providerName: string) => `[fr] Are you sure you want to disconnect ${providerName}?`,
            alreadyConnectedTitle: '[fr] Cannot connect to multiple HR platforms',
            alreadyConnectedPrompt: '[fr] You must disconnect your current HR platform before connecting another.',
            lastSync: (relativeDate: string) => `[fr] Last synced ${relativeDate}`,
            syncError: (providerName: string) => `[fr] Can't connect to ${providerName}`,
            connectionDescription: (providerName: string) => `[fr] Connect ${providerName} to keep employee approvals in sync with your workspace.`,
            approvalMode: '[fr] Approval mode',
            providerApprovalMode: (providerName: string) => `[fr] ${providerName} approval mode`,
            finalApprover: '[fr] Final approver',
            providerFinalApprover: (providerName: string) => `[fr] ${providerName} final approver`,
            notSet: '[fr] Not set',
            syncing: '[fr] Syncing employees',
            syncingModalTitle: '[fr] Your connection is syncing',
            syncingModalDescription: "[fr] The first connection can take some time. You'll be notified of any errors.",
            approvalModeDescription: (providerName: string) => `[fr] Members and managers are set up to sync with ${providerName}.`,
            approvalModeWarningTitle: '[fr] Change approval mode?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `[fr] Are you sure you would like to change the approval mode for this workspace? Learn more about the different ${providerName}-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
            approvalModeWarningConfirm: '[fr] Change approval mode',
            approvalModes: {
                basic: {label: '[fr] Basic approval', description: '[fr] All users submit to a single person for processing and approval.'},
                manager: {
                    label: '[fr] Manager approval',
                    description: (providerName: string) => `[fr] Employees submit reports to their direct manager configured in ${providerName}.`,
                },
                custom: {label: '[fr] Custom approval', description: "[fr] I'll manually setup approval workflows in Expensify."},
            },
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
                        return '[fr] Synchronizing Gusto Employees';
                    case 'gustoSyncLoadData':
                        return '[fr] Loading data from Gusto';
                    case 'gustoSyncProvisioning':
                        return '[fr] Provisioning employees in policy';
                    case 'zenefitsSyncTitle':
                        return '[fr] Synchronizing TriNet Employees';
                    case 'zenefitsSyncLoadData':
                        return '[fr] Loading data from TriNet';
            ...
            syncResults: {
                title: (provider: string) => `[fr] ${provider} sync complete`,
                successTitle: (provider: string) => `[fr] Successfully synced your ${provider} connection!`,
                added: '[fr] Added',
                removed: '[fr] Removed',
                skipped: '[fr] Skipped',
                employeeCount: () => ({
                    one: '[fr] 1 employee',
                    other: (count: number) => `[fr] ${count} employees`,
                }),
            },
            gusto: {
                title: '[fr] Gusto',
        ...
        distanceRates: {
            ...
            amountPerUnit: (unit: string) => `[fr] Amount per ${unit}`,
            startDate: '[fr] Start date',
            endDate: '[fr] End date',
            errors: {
                rateNameRequired: '[fr] Rate name is required',
                existingRateName: '[fr] A distance rate with this name already exists',
                nameRequired: '[fr] Name is required',
                amountRequired: '[fr] Amount is required',
                startDateMustBeBeforeEndDate: '[fr] Start date must be before end date',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            yourWorkspace: `[fr] Your workspace is set to an unsupported currency. View the <a href="${CONST.ENABLE_GLOBAL_REIMBURSEMENT_HELP_URL}">list of supported currencies</a>.`,
...
Are you sure you want to export them again?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.CERTINIA]: {
                title: '[fr] Certinia',
                description: `[fr] Enjoy automated syncing and reduce manual entries with the Expensify + Certinia integration. Align expense coding dimensions and tax sync with your Certinia setup for clearer financial visibility.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>Our Certinia integration is only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            ...
            approvalSubmit: {
                title: '[fr] Approvals',
                description: '[fr] Centrally configure who all members submit to by enabling approvals.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>Approvals are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            categories: {
                title: '[fr] Categories',
            ...
            companyCardSubmit: {
                title: '[fr] Company cards',
                description: `[fr] Bring your own company card to Expensify to get automatic import, automatic categorization, customizable rule support, and integrated reconciliation.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>Company card import is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            rules: {
                title: '[fr] Rules',
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            travelSubmit: {
                title: '[fr] Expensify Travel',
                description: '[fr] Book discounted flights, hotels, cars, and trains globally from within Expensify, with duty of care reporting and integrated expense management.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>Expensify Travel is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            reports: {
                title: '[fr] Reports',
            ...
            roles: {
                title: '[fr] Roles',
                description: '[fr] Assign different roles to different members to increase or decrease visibility and control as appropriate.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>Roles are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            payments: {
                title: '[fr] Payments',
                description: '[fr] Reimburse employees directly from your business bank account.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>Payments are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            accounting: {
                title: '[fr] Accounting',
                description:
                    '[fr] Sync categories, tags, tax rates, and more from your accounting system to Expensify, as well as export expense reports and card transactions – no typing (or typos) involved!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>Accounting is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            expensifyCard: {
                title: '[fr] Expensify Card',
                description:
                    '[fr] Issue company cards (including virtual cards) directly from your own bank account to get realtime spend control with an unbreakable connection, and up to 2% cashback!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>The Expensify Card is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
                upgradeButton: '[fr] Upgrade and enable',
            },
            invoicing: {
                title: '[fr] Invoicing',
                description: '[fr] Create, send, and track professional invoices, all inside Expensify. Get paid faster with integrated payments and real-time visibility.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[fr] <muted-text>Invoicing is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[fr] per member per month.` : `[fr] per active member per month.`}</muted-text>`,
            },
            pricing: {
                perActiveMember: '[fr] per active member per month.',
                perMember: '[fr] per member per month.',
            },
            note: (subscriptionLink: string) => `[fr] <muted-text><a href="${subscriptionLink}">Learn more</a> about our plans and pricing.</muted-text>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                giftCard: '[fr] Gift card purchases',
                handwrittenReceipt: '[fr] Handwritten receipts',
...
Add more spend rules to protect company cash flow.`,
        ...
        planTypePage: {
            planTypes: {
                ...
                submit2026: {
                    label: '[fr] Submit',
                    description: '[fr] For employees looking to submit expenses to their employer.',
                },
            },
            description: "[fr] Choose a plan that's right for you.",
            subscriptionLink: '[fr] Learn more',
    ...
    workspaceActions: {
        ...
        updatedRequireCompanyCards: ({enabled}: {enabled: boolean}) => `[fr] ${enabled ? '[fr] enabled' : '[fr] disabled'} the company card purchases requirement`,
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `[fr] set itemized receipt required amount to "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) => `[fr] changed itemized receipt required amount to "${newValue}" (previously "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `[fr] removed itemized receipt required amount (previously "${oldValue}")`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            editMultipleDescription: '[fr] Changes will be set for all selected expenses and will override any previously set values.',
            approve: '[fr] Approve',
            pay: '[fr] Pay',
            delete: '[fr] Delete',
            hold: '[fr] Hold',
        ...
        filters: {
            ...
            card: {
                ...
                travelInvoicing: '[fr] Travel invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[fr] Travel invoicing',
            },
            is: '[fr] Is',
            action: {
        ...
        askConcierge: (message: string) => `[fr] Ask Concierge “${message}”`,
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    travelCardLink: '[fr] travel card expenses',
    ...
    chronos: {
        ...
        stopTimer: (duration: string) => `[fr] Stop Timer (${duration})`,
    ...
    accessibilityHints: {
        ...
        openActionsMenu: '[fr] Open actions menu',
        selectAllCategories: '[fr] Select all categories',
        selectAllDistanceRates: '[fr] Select all distance rates',
        selectAllTags: '[fr] Select all tags',
        selectAllTaxes: '[fr] Select all taxes',
        selectAllPerDiemRates: '[fr] Select all per diem rates',
        selectAllMembers: '[fr] Select all members',
        selectAllValues: '[fr] Select all values',
        selectAllRules: '[fr] Select all rules',
    },
    parentReportAction: {
    ...
    gps: {
        ...
        liveActivity: {
            ...
            lockScreenBadgeText: '[fr] Distance',
            lockScreenTrackingText: '[fr] Tracking...',
    ...
    violations: {
        ...
        missingTag: (tagName?: string) => `[fr] Missing ${tagName ?? '[fr] tag'}`,
        ...
        prohibitedExpense: (prohibitedExpenseTypes: string | string[]) => {
            ...
            const getProhibitedExpenseTypeText = (prohibitedExpenseType: string) => {
                switch (prohibitedExpenseType) {
                    ...
                    case 'giftCard':
                        return `[fr] gift card purchases`;
                    case 'handwrittenReceipt':
                        return `[fr] handwritten receipts`;
                    default:
        ...
        smartscanFailed: ({canEdit = true, missingFields = []}: {canEdit?: boolean; missingFields?: string[]}) => {
            if (missingFields.length > 0) {
                const fieldNames: Record<string, string> = {merchant: '[fr] merchant', date: '[fr] date', amount: '[fr] amount'};
                const translated = missingFields.map((f) => fieldNames[f] ?? f);
                let fieldList = '';
                if (translated.length === 1) {
                    fieldList = translated.at(0) ?? '';
                } else if (translated.length === 2) {
                    fieldList = translated.join('[fr]  and ');
                } else {
                    fieldList = `${translated.slice(0, translated.length - 1).join(', ')}, and ${translated.at(-1)}`;
                }
                return `[fr] Receipt scanning failed — missing ${fieldList}.${canEdit ? '[fr]  Enter details manually.' : ''}`;
            }
            return `[fr] Receipt scanning failed.${canEdit ? '[fr]  Enter details manually.' : ''}`;
        },
    ...
    exitSurvey: {
        ...
        goBackJustOnce: '[fr] Go back just once',
    },
    listBoundary: {
    ...
    delegate: {
        ...
        addCopilot: '[fr] Add a copilot to your account',
        membersCanAccessYourAccount: '[fr] These members can access your account:',
        youCanAccessTheseAccounts: '[fr] You can access these accounts:',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            error: {
                ...
                moveMemberNotPolicyAdmin:
                    '[fr] Cannot move member to the domain group. You must be a Policy Admin for the Preferred Policy set on the domain group you are trying to move this user to.',
            },
        ...
        groups: {
            ...
            createGroupError: '[fr] Unable to create this group. Please try again.',
            permissions: '[fr] Group permissions',
            createNewGroupButton: '[fr] New group',
            createGroupSubmitButton: '[fr] Create group',
            expensifyCardPreferredWorkspace: '[fr] Expensify Card preferred workspace',
            expensifyCardPreferredWorkspaceDescription:
                '[fr] All Expensify Card transactions will be created on the Expensify Card Preferred Workspace instead of the Preferred Workspace. Enabling this feature will override the Preferred Workspace setting for Expensify Card transactions only.',
            strictlyEnforceWorkspaceRules: '[fr] Strictly enforce workspace rules',
            strictlyEnforceWorkspaceRulesDescription: '[fr] All workspace rules must be met before submitting a report. No manual exceptions allowed.',
            restrictExpenseWorkspaceCreation: '[fr] Restrict expense workspace creation/removal',
            restrictExpenseWorkspaceCreationDescription:
                '[fr] Prevent members from being able to create an expense workspace or remove themselves from an expense workspace. This is useful for preventing people from using Expensify to submit reports for use outside your domain when combined with strict workspace enforcement.',
            deleteGroup: '[fr] Delete Group',
            deleteGroupDangerConfirmationModal: '[fr] Delete Group',
            deleteGroupDangerConfirmationModalDescription: (defaultGroupName: string) =>
                `[fr] Are you sure? This will reassign all members to the default group (${defaultGroupName}) and can't be undone.`,
            deleteGroupError: '[fr] Unable to delete this group. Please try again.',
            preferredWorkspace: '[fr] Preferred Workspace',
            preferredWorkspaceDescription: (enabled: boolean) => `[fr] All new reports and expenses will be created on ${enabled ? '[fr] selected preferred' : '[fr] this'} workspace.`,
            preferredWorkspaceSelectDescription: '[fr] All new expenses and reports will be created on this workspace.',
            noWorkspacesMessage: '[fr] There are no workspaces on this domain. A workspace is required to enable this restriction.',
            restrictDefaultLoginSelection: '[fr] Restrict default login selection',
            restrictDefaultLoginSelectionDescription: '[fr] Prevent members from changing their login email away from their company domain to avoid policy restrictions.',
            expensifyCardPreferredWorkspaceDisabledMessage: '[fr] To enable this setting, please first enable a preferred workspace and set up Expensify Cards on your domain.',
            findGroup: '[fr] Find group',
        },
    },
};
