...
const translations: TranslationDeepObject<typeof en> = {
  common: {
    ...
    noResultsFoundMatching: (searchString: string) =>
      `Aucun résultat trouvé correspondant à « ${searchString} »`,
    ...
    conjunctionTo: "à",
    genericErrorMessage:
      "Oups... une erreur s’est produite et votre requête n’a pas pu être effectuée. Veuillez réessayer plus tard.",
...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
      ...
      requestModified:
        "Cette demande est en cours de modification par un autre membre",
      characterLimitExceedCounter: (length: number, limit: number) =>
        `Limite de caractères dépassée (${length}/${limit})`,
      dateInvalid: "Veuillez sélectionner une date valide",
      invalidDateShouldBeFuture:
        "Veuillez choisir aujourd’hui ou une date future",
      invalidTimeShouldBeFuture:
        "Veuillez choisir une heure au moins une minute plus tard",
      ...
      invalidTimeRange:
        "Veuillez saisir une heure au format 12 heures (par ex. 2:30 PM)",
      pleaseCompleteForm:
        "Veuillez remplir le formulaire ci-dessus pour continuer",
    ...
    thisFeatureRequiresInternet:
      "Cette fonctionnalité nécessite une connexion Internet active.",
    attachmentWillBeAvailableOnceBackOnline:
      "La pièce jointe sera disponible une fois de retour en ligne.",
    errorOccurredWhileTryingToPlayVideo:
      "Une erreur s’est produite lors de la tentative de lecture de cette vidéo.",
    ...
    zipCodeExampleFormat: ({ zipSampleFormat }: ZipCodeExampleFormatParams) =>
      zipSampleFormat ? `par ex. ${zipSampleFormat}` : "",
    ...
    roleCannotBeChanged: (workflowsLinkPage: string) =>
      `Le rôle ne peut pas être modifié car ce membre est un <a href="${workflowsLinkPage}">payeur</a> dans cet espace de travail.`,
    currency: "Devise",
    ...
    downloadFailedDescription:
      "Votre téléchargement n’a pas pu être terminé. Veuillez réessayer plus tard.",
    ...
    leaveWorkspaceConfirmation:
      "Si vous quittez cet espace de travail, vous ne pourrez plus lui soumettre de dépenses.",
    leaveWorkspaceConfirmationAuditor:
      "Si vous quittez cet espace de travail, vous ne pourrez plus voir ses notes de frais ni ses paramètres.",
    leaveWorkspaceConfirmationAdmin:
      "Si vous quittez cet espace de travail, vous ne pourrez plus gérer ses paramètres.",
  ...
  lockedAccount: {
    ...
    description:
      "Vous n’êtes pas autorisé à effectuer cette action, car ce compte a été verrouillé. Veuillez contacter concierge@expensify.com pour connaître les prochaines étapes.",
  },
  location: {
    useCurrent: "Utiliser la position actuelle",
    notFound:
      "Nous n’avons pas pu trouver votre position. Veuillez réessayer ou saisir une adresse manuellement.",
    permissionDenied:
      "Il semble que vous ayez refusé l’accès à votre position.",
    please: "S'il vous plaît",
  ...
  contact: {
    ...
    importContactsText:
      "Importez les contacts de votre téléphone pour que vos personnes préférées ne soient jamais à plus d’un toucher.",
    importContactsExplanation:
      "vos personnes préférées sont toujours à portée de main.",
    importContactsNativeText:
      "Plus qu’une étape ! Donnez-nous le feu vert pour importer vos contacts.",
  },
  ...
  attachmentPicker: {
    ...
    expensifyDoesNotHaveAccessToCamera:
      "Expensify ne peut pas prendre de photos sans accès à votre appareil photo. Touchez Paramètres pour mettre à jour les autorisations.",
    attachmentError: "Erreur de pièce jointe",
    errorWhileSelectingAttachment:
      "Une erreur s’est produite lors de la sélection d’une pièce jointe. Veuillez réessayer.",
    errorWhileSelectingCorruptedAttachment:
      "Une erreur s’est produite lors de la sélection d’une pièce jointe corrompue. Veuillez essayer un autre fichier.",
    ...
    sizeExceededWithLimit: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `La taille de la pièce jointe dépasse la limite de ${maxUploadSizeInMB} Mo`,
    attachmentTooSmall: "La pièce jointe est trop petite",
    sizeNotMet:
      "La taille de la pièce jointe doit être supérieure à 240 octets",
    wrongFileType: "Type de fichier non valide",
    notAllowedExtension:
      "Ce type de fichier n’est pas autorisé. Veuillez essayer un autre type de fichier.",
    folderNotAllowedMessage:
      "Le téléversement d’un dossier n’est pas autorisé. Veuillez essayer avec un autre fichier.",
    protectedPDFNotSupported:
      "Les PDF protégés par mot de passe ne sont pas pris en charge",
    attachmentImageResized:
      "Cette image a été redimensionnée pour l’aperçu. Téléchargez-la pour la résolution complète.",
    attachmentImageTooLarge:
      "Cette image est trop volumineuse pour être prévisualisée avant le téléversement.",
    imageDimensionsTooLarge:
      "Les dimensions de l'image sont trop grandes pour être traitées. Veuillez utiliser une image plus petite.",
    tooManyFiles: (fileLimit: number) =>
      `Vous pouvez téléverser au maximum ${fileLimit} fichiers à la fois.`,
    sizeExceededWithValue: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Les fichiers dépassent ${maxUploadSizeInMB} Mo. Veuillez réessayer.`,
    ...
    maxFileLimitExceeded:
      "Vous pouvez téléverser jusqu'à 30 reçus à la fois. Les reçus supplémentaires ne seront pas téléversés.",
    unsupportedFileType: (fileType: string) =>
      `Les fichiers ${fileType} ne sont pas pris en charge. Seuls les types de fichiers pris en charge seront téléchargés.`,
    learnMoreAboutSupportedFiles:
      "En savoir plus sur les formats pris en charge.",
    passwordProtected:
      "Les fichiers PDF protégés par mot de passe ne sont pas pris en charge. Seuls les fichiers pris en charge seront téléversés.",
  },
  dropzone: {
  ...
  filePicker: {
    ...
    errorWhileSelectingFile:
      "Une erreur s’est produite lors de la sélection d’un fichier. Veuillez réessayer.",
  },
  connectionComplete: {
    title: "Connexion terminée",
    supportingText:
      "Vous pouvez fermer cette fenêtre et retourner dans l’application Expensify.",
  },
  avatarCropModal: {
    title: "Modifier la photo",
    description:
      "Faites glisser, zoomez et faites pivoter votre image comme vous le souhaitez.",
  },
  composer: {
    noExtensionFoundForMimeType: "Aucune extension trouvée pour ce type MIME",
    problemGettingImageYouPasted:
      "Un problème est survenu lors de la récupération de l’image que vous avez collée",
    commentExceededMaxLength: (formattedMaxLength: string) =>
      `La longueur maximale du commentaire est de ${formattedMaxLength} caractères.`,
    taskTitleExceededMaxLength: (formattedMaxLength: string) =>
      `La longueur maximale du titre de la tâche est de ${formattedMaxLength} caractères.`,
  },
  baseUpdateAppModal: {
  ...
  multifactorAuthentication: {
    reviewTransaction: {
      ...
      requiresYourReview:
        "Une transaction par carte Expensify nécessite votre examen ci-dessous.",
      ...
      areYouSureToDeny:
        "Voulez-vous continuer ? La transaction sera refusée si vous fermez cet écran.",
      ...
      youNeedToTryAgainAtMerchant:
        "Cette transaction n’a pas été vérifiée, nous l’avons donc refusée. Vous devrez réessayer auprès du commerçant.",
      goBackToTheMerchant:
        "Retournez sur le site du commerçant pour continuer la transaction.",
      attemptedTransaction: "Transaction tentée",
      transactionFailed: "Échec de la transaction",
      transactionCouldNotBeCompleted:
        "Votre transaction n’a pas pu être effectuée. Veuillez réessayer chez le commerçant.",
    ...
    biometricsTest: {
      ...
      successfullyAuthenticatedUsing: ({
        ...
        `Vous vous êtes authentifié avec succès en utilisant ${authType}.`,
      troubleshootBiometricsStatus: ({
        registered,
      }: MultifactorAuthenticationTranslationParams) =>
        `Données biométriques (${registered ? "Enregistré" : "Non inscrit"})`,
      yourAttemptWasUnsuccessful:
        "Votre tentative d’authentification a échoué.",
      youCouldNotBeAuthenticated: "Vous n’avez pas pu être authentifié",
      areYouSureToReject:
        "Voulez-vous vraiment continuer ? La tentative d’authentification sera rejetée si vous fermez cet écran.",
    ...
    pleaseEnableInSystemSettings: {
      start:
        "Veuillez activer la vérification par reconnaissance faciale/empreinte digitale ou définir un code d’accès à l’appareil dans vos",
      link: "paramètres système",
      end: ".",
    },
    oops: "Oups, quelque chose s’est mal passé",
    looksLikeYouRanOutOfTime:
      "On dirait que votre temps est écoulé ! Veuillez réessayer chez le commerçant.",
    ...
    verifyYourself: {
      biometrics:
        "Vérifiez votre identité avec votre visage ou votre empreinte digitale",
    },
    enableQuickVerification: {
      biometrics:
        "Activez une vérification rapide et sécurisée à l’aide de votre visage ou de votre empreinte digitale. Aucun mot de passe ni code requis.",
    },
    revoke: {
      ...
      confirmationPrompt:
        "Vous êtes sûr(e) ? Vous aurez besoin d’un code magique pour la prochaine vérification sur n’importe quel appareil.",
  ...
  validateCodeModal: {
    ...
    successfulSignInDescription:
      "Revenez à votre onglet d’origine pour continuer.",
    ...
    expiredCodeDescription:
      "Retournez sur l'appareil d’origine et demandez un nouveau code",
  ...
  customApprovalWorkflow: {
    ...
    description:
      "Votre entreprise utilise un flux d’approbation personnalisé sur cet espace de travail. Veuillez effectuer cette action dans Expensify Classic",
  ...
  emptyList: {
    [CONST.IOU.TYPE.CREATE]: {
      ...
      subtitleText:
        "Vous voulez que votre équipe utilise Expensify, elle aussi ? Soumettez-leur simplement une dépense et nous nous occupons du reste.",
    },
  },
  ...
  welcomeText: {
    ...
    anotherLoginPageIsOpenExplanation:
      "Vous avez ouvert la page de connexion dans un autre onglet. Veuillez vous connecter depuis cet onglet.",
    welcome: "Bienvenue !",
    welcomeWithoutExclamation: "Bienvenue",
    phrase2:
      "L’argent parle. Et maintenant que la messagerie et les paiements sont réunis au même endroit, c’est aussi simple.",
    phrase3:
      "Vos paiements vous parviennent aussi vite que vous faites passer votre message.",
    enterPassword: "Veuillez saisir votre mot de passe",
    welcomeNewFace: (login: string) =>
      `${login}, c’est toujours un plaisir de voir un nouveau visage par ici !`,
    welcomeEnterMagicCode: ({ login }: WelcomeEnterMagicCodeParams) =>
      `Veuillez saisir le code magique envoyé à ${login}. Il devrait arriver dans une minute ou deux.`,
  },
  login: {
    hero: {
  ...
  samlSignIn: {
    welcomeSAMLEnabled:
      "Continuer la connexion avec l’authentification unique :",
    orContinueWithMagicCode:
      "Vous pouvez aussi vous connecter avec un code magique",
    useSingleSignOn: "Utiliser l’authentification unique",
    useMagicCode: "Utiliser le code magique",
    launching: "Lancement en cours...",
    oneMoment:
      "Un instant, nous vous redirigeons vers le portail d’authentification unique de votre entreprise.",
  },
  reportActionCompose: {
    ...
    fileUploadFailed:
      "Le téléversement a échoué. Le fichier n’est pas pris en charge.",
  ...
  reportActionContextMenu: {
    ...
    editAction: ({ action }: EditActionParams) =>
      `Modifier ${action?.actionName === CONST.REPORT.ACTIONS.TYPE.IOU ? "dépense" : "comment"}`,
  ...
  reportActionsView: {
    ...
    beginningOfChatHistory: (users: string) =>
      `Cette discussion est avec ${users}.`,
    ...
    beginningOfChatHistorySelfDM:
      "Ceci est votre espace personnel. Utilisez-le pour vos notes, tâches, brouillons et rappels.",
    ...
    usePlusButton: ({ additionalText }: UsePlusButtonParams) =>
      `Utilisez le bouton + pour ${additionalText} une dépense.`,
    askConcierge:
      "Ceci est votre chat avec Concierge, votre agent IA personnel. Je peux faire presque tout, essayez-moi !",
  ...
  adminOnlyCanPost:
    "Seuls les administrateurs peuvent envoyer des messages dans ce salon.",
  reportAction: {
  ...
  reportArchiveReasons: {
    [CONST.REPORT.ARCHIVE_REASON.DEFAULT]:
      "Ce salon de discussion a été archivé.",
    [CONST.REPORT.ARCHIVE_REASON.ACCOUNT_CLOSED]: ({
      displayName,
    }: ReportArchiveReasonsClosedParams) =>
      `Cette discussion n’est plus active, car ${displayName} a fermé son compte.`,
    ...
    [CONST.REPORT.ARCHIVE_REASON.BOOKING_END_DATE_HAS_PASSED]:
      "Cette réservation est archivée.",
  },
  writeCapabilityPage: {
  ...
  homePage: {
    ...
    timeSensitiveSection: {
      ...
      offer25off: {
        ...
        subtitle: ({ days }: { days: number }) =>
          `${days} ${days === 1 ? "jour" : "jours"} restants`,
      },
      addShippingAddress: {
      ...
      addPaymentCard: {
        title:
          "Ajoutez une carte de paiement pour continuer à utiliser Expensify",
      ...
      reviewCardFraud: {
        ...
        titleWithDetails: ({
          ...
          amount: string;
          merchant: string;
        }) => `Examiner ${amount} de fraude potentielle chez ${merchant}`,
      ...
      fixCompanyCardConnection: {
        title: ({ feedName }: { feedName: string }) =>
          feedName
            ? `Corriger la connexion de la carte d'entreprise ${feedName}`
            : "Corriger la connexion de la carte entreprise",
        defaultSubtitle: "Espace de travail",
        subtitle: ({ policyName }: { policyName: string }) =>
          `${policyName} > Cartes d'entreprise`,
      },
      fixAccountingConnection: {
        title: ({ integrationName }: { integrationName: string }) =>
          `Corriger la connexion ${integrationName}`,
        defaultSubtitle: "Espace de travail",
        subtitle: ({ policyName }: { policyName: string }) =>
          `${policyName} > Comptabilité`,
      },
      fixPersonalCardConnection: {
        title: ({ cardName }: { cardName?: string }) =>
          cardName
            ? `Réparer la connexion de la carte personnelle ${cardName}`
            : "Corriger la connexion de la carte personnelle",
    ...
    discoverSection: {
      ...
      menuItemTitleNonAdmin:
        "Découvrez comment créer des dépenses et soumettre des notes de frais.",
      menuItemTitleAdmin:
        "Découvrez comment inviter des membres, modifier les workflows d’approbation et rapprocher les cartes de société.",
      menuItemDescription: "Découvrez ce qu’Expensify peut faire en 2 min",
    },
    forYouSection: {
      submit: ({ count }: { count: number }) =>
        `Soumettre ${count} ${count === 1 ? "Note de frais" : "notes de frais"}`,
      approve: ({ count }: { count: number }) =>
        `Approuver ${count} ${count === 1 ? "Note de frais" : "notes de frais"}`,
      pay: ({ count }: { count: number }) =>
        `Payer ${count} ${count === 1 ? "Note de frais" : "notes de frais"}`,
      export: ({ count }: { count: number }) =>
        `Exporter ${count} ${count === 1 ? "Note de frais" : "notes de frais"}`,
      begin: "Commencer",
      emptyStateMessages: {
        thumbsUpStarsTitle: "C’est terminé !",
        thumbsUpStarsDescription:
          "Un grand bravo à vous, restez à l’affût de nouvelles tâches.",
        smallRocketTitle: "Tout est à jour",
        smallRocketDescription:
          "Les prochaines tâches à faire apparaîtront ici.",
        cowboyHatTitle: "C’est terminé !",
        cowboyHatDescription:
          "Toutes les tâches sont maîtrisées, gardez un œil ouvert pour la suite.",
        trophy1Title: "Rien à afficher",
        trophy1Description:
          "Vous y êtes arrivé ! Gardez un œil ouvert pour d’autres tâches.",
        palmTreeTitle: "Tout est à jour",
        palmTreeDescription:
          "Il est temps de se détendre, mais restez à l’affût des futures tâches.",
        ...
        targetDescription:
          "Bravo, vous restez dans la bonne direction. Revenez pour plus de tâches !",
        chairTitle: "Rien à afficher",
        chairDescription:
          "Allez vous détendre, nous listerons les prochaines tâches ici.",
        broomTitle: "C’est terminé !",
        broomDescription:
          "Les tâches sont terminées, mais restez à l’affût de nouvelles tâches.",
        houseTitle: "Tout est à jour",
        houseDescription:
          "Voici votre base pour les prochaines tâches à faire.",
        conciergeBotTitle: "Rien à afficher",
        conciergeBotDescription:
          "Bip bop bip bop, revenez pour plus de tâches !",
        ...
        sunglassesDescription:
          "Temps de se détendre, mais restez à l’affût de ce qui arrive !",
  ...
  spreadsheet: {
    ...
    chooseSpreadsheet:
      "<muted-link>Sélectionnez un fichier de feuille de calcul à importer. Formats pris en charge : .csv, .txt, .xls et .xlsx.</muted-link>",
    ...
    fieldNotMapped: (fieldName: string) =>
      `Oups ! Un champ obligatoire (« ${fieldName} ») n’a pas été associé. Veuillez examiner et réessayer.`,
    ...
    importCategoriesSuccessfulDescription: ({
      ...
      if (added) {
        return added === 1
          ? "1 catégorie a été ajoutée."
          : `${added} catégories ont été ajoutées.`;
      }
      return updated === 1
        ? "1 catégorie a été mise à jour."
        : `${updated} catégories ont été mises à jour.`;
    },
    importMembersSuccessfulDescription: ({
      ...
      if (updated) {
        return updated > 1
          ? `${updated} membres ont été mis à jour.`
          : "1 membre a été mis à jour.";
      }
      return added > 1
        ? `${added} membres ont été ajoutés.`
        : "1 membre a été ajouté.";
    },
    importTagsSuccessfulDescription: ({ tags }: { tags: number }) =>
      tags > 1 ? `${tags} tags ont été ajoutés.` : "1 tag a été ajouté.",
    importMultiLevelTagsSuccessfulDescription:
      "Des tags à plusieurs niveaux ont été ajoutés.",
    importPerDiemRatesSuccessfulDescription: ({ rates }: { rates: number }) =>
      rates > 1
        ? `${rates} indemnités journalières ont été ajoutées.`
        : "1 taux de per diem a été ajouté.",
    importTransactionsSuccessfulDescription: ({
      ...
      transactions > 1
        ? `${transactions} transactions ont été importées.`
        : "1 transaction a été importée.",
    importFailedTitle: "Échec de l’importation",
    importFailedDescription:
      "Veuillez vous assurer que tous les champs sont correctement remplis, puis réessayez. Si le problème persiste, veuillez contacter Concierge.",
    importDescription:
      "Choisissez les champs à faire correspondre à partir de votre feuille de calcul en cliquant sur le menu déroulant à côté de chaque colonne importée ci‑dessous.",
    ...
    importSpreadsheetLibraryError:
      "Échec du chargement du module de feuille de calcul. Veuillez vérifier votre connexion Internet et réessayer.",
  ...
  receipt: {
    ...
    alternativeMethodsForwardReceipts: ({ email }: { email: string }) =>
      `<label-text>Transférer les reçus à <a href="mailto:${email}">${email}</a></label-text>`,
    ...
    alternativeMethodsTextReceipts: ({
      ...
      `<label-text>Envoyez des reçus par SMS au ${phoneNumber} (numéros américains uniquement)</label-text>`,
    takePhoto: "Prendre une photo",
    cameraAccess:
      "L’accès à la caméra est requis pour prendre des photos de reçus.",
    ...
    cameraErrorMessage:
      "Une erreur s’est produite lors de la prise de la photo. Veuillez réessayer.",
    locationAccessTitle: "Autoriser l’accès à la position",
    locationAccessMessage:
      "L’accès à la localisation nous aide à garder votre fuseau horaire et votre devise exacts où que vous alliez.",
    ...
    addReceipt: "Ajouter un reçu",
    scanFailed:
      "Le reçu n’a pas pu être scanné, car il lui manque un commerçant, une date ou un montant.",
    crop: "Recadrer",
    addAReceipt: {
  ...
  quickAction: {
    ...
    noLongerHaveReportAccess:
      "Vous n’avez plus accès à votre précédente destination d’action rapide. Choisissez-en une nouvelle ci-dessous.",
  ...
  iou: {
    ...
    splitDateRange: (startDate: string, endDate: string, count: number) =>
      `Du ${startDate} au ${endDate} (${count} jours)`,
    ...
    totalAmountGreaterThanOriginal: (amount: string) =>
      `Le montant total est supérieur de ${amount} à la dépense initiale.`,
    totalAmountLessThanOriginal: (amount: string) =>
      `Le montant total est inférieur de ${amount} à la dépense initiale.`,
    splitExpenseZeroAmount:
      "Veuillez saisir un montant valide avant de continuer.",
    splitExpenseOneMoreSplit:
      "Aucune répartition ajoutée. Ajoutez-en au moins une pour enregistrer.",
    splitExpenseEditTitle: (amount: string, merchant: string) =>
      `Modifier ${amount} pour ${merchant}`,
    removeSplit: "Supprimer la répartition",
    splitExpenseCannotBeEditedModalTitle:
      "Cette dépense ne peut pas être modifiée",
    splitExpenseCannotBeEditedModalDescription:
      "Les dépenses approuvées ou payées ne peuvent pas être modifiées",
    splitExpenseDistanceErrorModalDescription:
      "Veuillez corriger l’erreur de taux de distance, puis réessayer.",
    splitExpensePerDiemRateErrorModalDescription:
      "Veuillez corriger l’erreur de taux de per diem et réessayer.",
    paySomeone: (name?: string) => `Payer ${name ?? "quelqu’un"}`,
    expense: "Dépense",
    ...
    deletedTransaction: (amount: string, merchant: string) =>
      `a supprimé une dépense (${amount} pour ${merchant})`,
    movedFromReport: (reportName: string) =>
      `a déplacé une dépense${reportName ? `de ${reportName}` : ""}`,
    movedTransactionTo: (reportUrl: string, reportName?: string) =>
      `a déplacé cette dépense${reportName ? `vers <a href="${reportUrl}">${reportName}</a>` : ""}`,
    movedTransactionFrom: (reportUrl: string, reportName?: string) =>
      `a déplacé cette dépense${reportName ? `depuis <a href="${reportUrl}">${reportName}</a>` : ""}`,
    unreportedTransaction: (reportUrl: string) =>
      `a déplacé cette dépense vers votre <a href="${reportUrl}">espace personnel</a>`,
    movedAction: (
    ...
    pendingMatchWithCreditCard:
      "Reçu en attente de rapprochement avec la transaction par carte",
    pendingMatch: "Correspondance en attente",
    pendingMatchWithCreditCardDescription:
      "Reçu en attente de rapprochement avec une transaction par carte. Marquez comme paiement en espèces pour annuler.",
    markAsCash: "Marquer comme espèces",
    routePending: "Acheminement en attente...",
    automaticallyEnterExpenseDetails:
      "Concierge saisira automatiquement les détails de la dépense pour vous, ou vous pouvez les ajouter manuellement.",
    receiptScanning: () => ({
      one: "Scan des reçus...",
    ...
    scanMultipleReceiptsDescription:
      "Prenez des photos de tous vos reçus en une seule fois, puis confirmez vous-même les détails ou nous le ferons pour vous.",
    receiptScanInProgress: "Scan du reçu en cours",
    receiptScanInProgressDescription:
      "Scan du reçu en cours. Revenez plus tard ou saisissez les détails maintenant.",
    ...
    receiptStatusText:
      "Vous seul pouvez voir ce reçu pendant son analyse. Revenez plus tard ou saisissez les détails maintenant.",
    receiptScanningFailed:
      "L’analyse du reçu a échoué. Veuillez saisir les détails manuellement.",
    transactionPendingDescription:
      "Transaction en attente. L'inscription peut prendre quelques jours.",
    companyInfo: "Informations sur l’entreprise",
    companyInfoDescription:
      "Nous avons besoin de quelques informations supplémentaires avant que vous puissiez envoyer votre première facture.",
    yourCompanyName: "Nom de votre entreprise",
    yourCompanyWebsite: "Site web de votre entreprise",
    yourCompanyWebsiteNote:
      "Si vous n’avez pas de site web, vous pouvez indiquer à la place le profil LinkedIn ou le profil sur les réseaux sociaux de votre entreprise.",
    invalidDomainError:
      "Vous avez saisi un domaine invalide. Pour continuer, veuillez saisir un domaine valide.",
    publicDomainError:
      "Vous avez saisi un domaine public. Pour continuer, veuillez saisir un domaine privé.",
    expenseCount: () => {
      return {
        one: "1 dépense",
    ...
    settlePersonal: (formattedAmount?: string) =>
      formattedAmount
        ? `Payer ${formattedAmount} en tant que particulier`
        : `Payer avec un compte personnel`,
    settleWallet: (formattedAmount?: string) =>
      formattedAmount
        ? `Payer ${formattedAmount} avec le portefeuille`
    ...
    settleBusiness: (formattedAmount?: string) =>
      formattedAmount
        ? `Payer ${formattedAmount} en tant qu’entreprise`
        : `Payer avec le compte professionnel`,
    payElsewhere: (formattedAmount?: string) =>
      formattedAmount
        ? `Marquer ${formattedAmount} comme payé`
        : `Marquer comme payé`,
    settleInvoicePersonal: (amount?: string, last4Digits?: string) =>
      amount
        ? `a payé ${amount} avec le compte personnel ${last4Digits}`
        : `Payé avec un compte personnel`,
    settleInvoiceBusiness: (amount?: string, last4Digits?: string) =>
      amount
        ? `a payé ${amount} avec le compte professionnel ${last4Digits}`
        : `Payé avec le compte professionnel`,
    payWithPolicy: (policyName: string, formattedAmount?: string) =>
      formattedAmount
        ? `Payer ${formattedAmount} via ${policyName}`
        : `Payer via ${policyName}`,
    businessBankAccount: (amount?: string, last4Digits?: string) =>
      amount
        ? `a payé ${amount} avec le compte bancaire ${last4Digits}`
        : `payé avec le compte bancaire ${last4Digits}`,
    ...
    waitingOnBankAccount: ({
      ...
      `a commencé le paiement, mais attend que ${submitterDisplayName} ajoute un compte bancaire.`,
    ...
    paidElsewhere: ({ payer, comment }: PaidElsewhereParams = {}) =>
      `${payer ? `${payer} ` : ""}marqué comme payé${comment ? `, en disant « ${comment} »` : ""}`,
    paidWithExpensify: (payer?: string) =>
      `${payer ? `${payer} ` : ""}payé avec le portefeuille`,
    ...
    pendingConversionMessage:
      "Le total sera mis à jour quand vous serez de nouveau en ligne",
    changedTheExpense: "a modifié la dépense",
    setTheRequest: (valueName: string, newValueToDisplay: string) =>
      `le ${valueName} sur ${newValueToDisplay}`,
    ...
    removedTheRequest: (valueName: string, oldValueToDisplay: string) =>
      `le ${valueName} (anciennement ${oldValueToDisplay})`,
    updatedTheRequest: ({
      valueName,
      newValueToDisplay,
      oldValueToDisplay,
    }: UpdatedTheRequestParams) =>
      `le ${valueName} sur ${newValueToDisplay} (précédemment ${oldValueToDisplay})`,
    ...
    basedOnMCC: ({ rulesLink }: { rulesLink: string }) =>
      rulesLink
        ? `en fonction des <a href="${rulesLink}">règles de l’espace de travail</a>`
        : "en fonction de la règle de l’espace de travail",
    threadExpenseReportName: (formattedAmount: string, comment?: string) =>
      `${formattedAmount} ${comment ? `pour ${comment}` : "dépense"}`,
    invoiceReportName: ({
      linkedReportID,
    }: OriginalMessage<typeof CONST.REPORT.ACTIONS.TYPE.REPORT_PREVIEW>) =>
      `Note de frais de facture n° ${linkedReportID}`,
    threadPaySomeoneReportName: (formattedAmount: string, comment?: string) =>
      `${formattedAmount} envoyé${comment ? `pour ${comment}` : ""}`,
    ...
    error: {
      invalidCategoryLength:
        "Le nom de la catégorie dépasse 255 caractères. Veuillez le raccourcir ou choisir une autre catégorie.",
      invalidTagLength:
        "Le nom du tag dépasse 255 caractères. Veuillez le raccourcir ou choisir un autre tag.",
      ...
      negativeDistanceNotAllowed:
        "Le relevé de fin doit être supérieur au relevé de début",
      distanceAmountTooLarge:
        "Le montant total est trop élevé. Réduisez la distance ou diminuez le taux.",
      distanceAmountTooLargeReduceDistance:
        "Le montant total est trop élevé. Réduisez la distance.",
      distanceAmountTooLargeReduceRate:
        "Le montant total est trop élevé. Diminuez le taux.",
      odometerReadingTooLarge: (formattedMax: string) =>
        `Les lectures du compteur kilométrique ne peuvent pas dépasser ${formattedMax}.`,
      invalidIntegerAmount:
        "Veuillez saisir un montant entier en dollars avant de continuer",
      invalidTaxAmount: (amount: string) =>
        `Le montant maximal de taxe est de ${amount}`,
      invalidSplit:
        "La somme des répartitions doit être égale au montant total",
      invalidSplitParticipants:
        "Veuillez saisir un montant supérieur à zéro pour au moins deux participants",
      invalidSplitYourself:
        "Veuillez saisir un montant non nul pour votre répartition",
      ...
      genericCreateFailureMessage:
        "Erreur inattendue lors de la soumission de cette dépense. Veuillez réessayer plus tard.",
      genericCreateInvoiceFailureMessage:
        "Erreur inattendue lors de l’envoi de cette facture. Veuillez réessayer plus tard.",
      genericHoldExpenseFailureMessage:
        "Erreur inattendue lors de la mise en attente de cette dépense. Veuillez réessayer ultérieurement.",
      genericUnholdExpenseFailureMessage:
        "Erreur inattendue lors de la levée de la mise en attente de cette dépense. Veuillez réessayer plus tard.",
      receiptDeleteFailureError:
        "Erreur inattendue lors de la suppression de ce reçu. Veuillez réessayer plus tard.",
      ...
      receiptFailureMessageShort:
        "Une erreur s’est produite lors du téléchargement de votre reçu.",
      genericDeleteFailureMessage:
        "Erreur inattendue lors de la suppression de cette dépense. Veuillez réessayer plus tard.",
      genericEditFailureMessage:
        "Erreur inattendue lors de la modification de cette dépense. Veuillez réessayer plus tard.",
      genericSmartscanFailureMessage: "Des champs manquent à la transaction",
      duplicateWaypointsErrorMessage:
        "Veuillez supprimer les points de passage en double",
      atLeastTwoDifferentWaypoints:
        "Veuillez saisir au moins deux adresses différentes",
      splitExpenseMultipleParticipantsErrorMessage:
        "Une dépense ne peut pas être répartie entre un espace de travail et d'autres membres. Veuillez modifier votre sélection.",
      ...
      invalidRate:
        "Taux non valide pour cet espace de travail. Veuillez sélectionner un taux disponible dans l’espace de travail.",
      endDateBeforeStartDate:
        "La date de fin ne peut pas être antérieure à la date de début",
      endDateSameAsStartDate:
        "La date de fin ne peut pas être identique à la date de début",
    ...
    dismissReceiptErrorConfirmation:
      "Attention ! Ignorer cette erreur supprimera complètement votre reçu téléversé. Êtes-vous sûr ?",
    ...
    selectUnreportedExpense:
      "Sélectionnez au moins une dépense à ajouter à la note de frais.",
    emptyStateUnreportedExpenseTitle: "Aucune dépense non déclarée",
    emptyStateUnreportedExpenseSubtitle:
      "Il semble que vous n’ayez aucune dépense non déclarée. Essayez d’en créer une ci-dessous.",
    ...
    explainHoldApprover: () => ({
      ...
      other:
        "Expliquez ce dont vous avez besoin avant d'approuver ces dépenses.",
    }),
    retracted: "Retiré",
    retract: "Retirer",
    reopened: "rouvert",
    ...
    expenseOnHold:
      "Cette dépense a été mise en attente. Veuillez examiner les commentaires pour connaître les prochaines étapes.",
    expensesOnHold:
      "Toutes les dépenses ont été mises en attente. Veuillez examiner les commentaires pour connaître les prochaines étapes.",
    expenseDuplicate:
      "Cette dépense présente des détails similaires à une autre. Veuillez examiner les doublons pour continuer.",
    someDuplicatesArePaid:
      "Certains de ces doublons ont déjà été approuvés ou payés.",
    reviewDuplicates: "Examiner les doublons",
    keepAll: "Tout garder",
    noDuplicatesTitle: "Tout est en ordre !",
    noDuplicatesDescription:
      "Il n'y a aucune transaction en double à vérifier ici.",
    confirmApprove: "Confirmer le montant approuvé",
    confirmApprovalAmount:
      "Approuvez uniquement les dépenses conformes, ou approuvez l’intégralité de la note de frais.",
    confirmApprovalAllHoldAmount: () => ({
      one: "Cette dépense est en attente. Voulez-vous l’approuver quand même ?",
      other:
        "Ces dépenses sont en attente. Voulez-vous tout de même approuver ?",
    }),
    confirmPay: "Confirmer le montant du paiement",
    confirmPayAmount:
      "Payez ce qui n’est pas en attente, ou payez l’intégralité de la note de frais.",
    ...
    whatIsHoldExplain:
      "La mise en attente revient à mettre une « pause » sur une dépense jusqu'à ce que vous soyez prêt à la soumettre.",
    holdIsLeftBehind:
      "Les dépenses retenues sont laissées de côté même si vous soumettez une note de frais entière.",
    unholdWhenReady:
      "Retirez les dépenses de la mise en attente lorsque vous êtes prêt à les soumettre.",
    changePolicyEducational: {
      title: "Vous avez déplacé cette note de frais !",
      description:
        "Vérifiez attentivement ces éléments, qui ont tendance à changer lorsque vous déplacez des notes de frais vers un nouvel espace de travail.",
      reCategorize:
        "<strong>Recatégorisez toutes les dépenses</strong> pour respecter les règles de l’espace de travail.",
      workflows:
        "Cette note de frais peut désormais être soumise à un <strong>circuit d’approbation</strong> différent.",
    },
    ...
    chooseARate:
      "Sélectionnez un taux de remboursement par mile ou kilomètre pour l’espace de travail",
    ...
    bookingPendingDescription:
      "Cette réservation est en attente, car elle n’a pas encore été payée.",
    bookingArchived: "Cette réservation est archivée",
    bookingArchivedDescription:
      "Cette réservation est archivée car la date du voyage est passée. Ajoutez une dépense pour le montant final si nécessaire.",
    ...
    reject: {
      ...
      educationalText:
        "Si vous n’êtes pas prêt à approuver ou à payer une dépense, vous pouvez la mettre en attente ou la rejeter.",
      holdExpenseTitle:
        "Mettre une dépense en attente pour demander plus de détails avant l’approbation ou le paiement.",
      approveExpenseTitle:
        "Approuvez d’autres dépenses pendant que les dépenses en attente restent assignées à vous.",
      heldExpenseLeftBehindTitle:
        "Les dépenses en attente sont laissées de côté lorsque vous approuvez une note de frais entière.",
      rejectExpenseTitle:
        "Rejetez une dépense que vous n’avez pas l’intention d’approuver ou de payer.",
      reasonPageTitle: "Rejeter la dépense",
      reasonPageDescription:
        "Expliquez pourquoi vous n'approuverez pas cette dépense.",
      rejectReason: "Motif de rejet",
      markAsResolved: "Marquer comme résolu",
      rejectedStatus:
        "Cette dépense a été rejetée. Nous attendons que vous corrigiez les problèmes et la marquiez comme résolue pour permettre la soumission.",
      reportActions: {
    ...
    changeApprover: {
      ...
      changedApproverMessage: (managerID: number) =>
        `a changé l'approbateur en <mention-user accountID="${managerID}"/>`,
      actions: {
        addApprover: "Ajouter un approbateur",
        addApproverSubtitle:
          "Ajouter un approbateur supplémentaire au circuit d’approbation existant.",
        bypassApprovers: "Ignorer les approbateurs",
        bypassApproversSubtitle:
          "Vous désigner comme approbateur final et ignorer tous les approbateurs restants.",
      },
      addApprover: {
        subtitle:
          "Choisissez un approbateur supplémentaire pour cette note de frais avant que nous la fassions passer par le reste du flux d’approbation.",
      },
    },
    chooseWorkspace: "Choisir un espace de travail",
    routedDueToDEW: (to: string) =>
      `note de frais transmise à ${to} en raison du flux d’approbation personnalisé`,
    timeTracking: {
      hoursAt: (hours: number, rate: string) =>
        `${hours} ${hours === 1 ? "heure" : "heures"} @ ${rate} / heure`,
      hrs: "h",
      hours: "Heures",
      ratePreview: (rate: string) => `${rate} / heure`,
      amountTooLargeError:
        "Le montant total est trop élevé. Réduisez le nombre d’heures ou diminuez le taux.",
    },
    ...
    rulesModifiedFields: {
      reimbursable: (value: boolean) =>
        value
          ? "a marqué la dépense comme « remboursable »"
          : "a marqué la dépense comme « non remboursable »",
      billable: (value: boolean) =>
        value
          ? "a marqué la dépense comme « facturable »"
          : "a marqué la dépense comme « non refacturable »",
      tax: (value: string, isFirst: boolean) =>
        isFirst
          ? `définir le taux de taxe sur « ${value} »`
          : `taux de taxe à « ${value} »`,
      reportName: (value: string) =>
        `a déplacé cette dépense vers la note de frais « ${value} »`,
      common: (
        key:
        ...
        return isFirst
          ? `définir ${field} sur « ${value} »`
          : `${field} à « ${value} »`;
      },
      formatPersonalRules: (fragments: string, route: string) =>
        `${fragments} via <a href="${route}">règles de dépenses personnelles</a>`,
      formatPolicyRules: (fragments: string, route: string) =>
        `${fragments} via <a href="${route}">règles d’espace de travail</a>`,
    },
    failedToAutoSubmitViaDEW: (reason: string) =>
      `échec de la soumission de la note de frais via <a href="${CONST.SELECT_WORKFLOWS_HELP_URL}">soumissions différées</a>. ${reason}`,
    failedToSubmitViaDEW: (reason: string) =>
      `échec de la soumission de la note de frais. ${reason}`,
    ...
    failedToApproveViaDEW: (reason: string) =>
      `échec de l’approbation. ${reason}`,
    cannotDuplicateDistanceExpense:
      "Vous ne pouvez pas dupliquer des dépenses de distance entre espaces de travail, car les taux peuvent différer d’un espace de travail à l’autre.",
  },
  transactionMerge: {
    listPage: {
    ...
    detailsPage: {
      ...
      selectAllDetailsError:
        "Sélectionnez tous les détails avant de continuer.",
    },
    confirmationPage: {
      header: "Confirmer les détails",
      pageTitle:
        "Confirmez les informations que vous conservez. Les informations que vous ne conservez pas seront supprimées.",
  ...
  loginField: {
    numberHasNotBeenValidated:
      "Le numéro n’a pas été validé. Cliquez sur le bouton pour renvoyer le lien de validation par SMS.",
    emailHasNotBeenValidated:
      "L’e-mail n’a pas été validé. Cliquez sur le bouton pour renvoyer le lien de validation par SMS.",
  },
  avatarWithImagePicker: {
    ...
    deleteWorkspaceError:
      "Désolé, un problème inattendu est survenu lors de la suppression de l’avatar de votre espace de travail",
    sizeExceeded: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `L’image sélectionnée dépasse la taille maximale de téléversement de ${maxUploadSizeInMB} Mo.`,
    ...
    notAllowedExtension: ({ allowedExtensions }: NotAllowedExtensionParams) =>
      `La photo de profil doit être de l’un des types suivants : ${allowedExtensions.join(", ")}.`,
  },
  avatarPage: {
  ...
  profilePage: {
    ...
    invalidFileMessage:
      "Fichier non valide. Veuillez essayer avec une autre image.",
    avatarUploadFailureMessage:
      "Une erreur s’est produite lors du téléchargement de l’avatar. Veuillez réessayer.",
    online: "En ligne",
    offline: "Hors ligne",
    ...
    publicSection: {
      title: "Public",
      subtitle:
        "Ces informations sont affichées sur votre profil public. Tout le monde peut les voir.",
    },
    privateSection: {
      title: "Privé",
      subtitle:
        "Ces informations sont utilisées pour les déplacements et les paiements. Elles n’apparaissent jamais sur votre profil public.",
    },
  },
  securityPage: {
  ...
  shareCodePage: {
    title: "Votre code",
    subtitle:
      "Invitez des membres sur Expensify en partageant votre code QR personnel ou votre lien de parrainage.",
  },
  pronounsPage: {
    pronouns: "Pronoms",
  ...
  contacts: {
    ...
    featureRequiresValidate:
      "Cette fonctionnalité exige que vous validiez votre compte.",
    ...
    enterMagicCode: (contactMethod: string) =>
      `Veuillez saisir le code magique envoyé à ${contactMethod}. Il devrait arriver d'ici une à deux minutes.`,
    ...
    removeAreYouSure:
      "Voulez-vous vraiment supprimer ce moyen de contact ? Cette action est irréversible.",
    failedNewContact: "Échec de l’ajout de ce moyen de contact.",
    genericFailureMessages: {
      requestContactMethodValidateCode:
        "Échec de l’envoi d’un nouveau code magique. Veuillez attendre un peu et réessayer.",
      validateSecondaryLogin:
        "Code magique incorrect ou non valide. Veuillez réessayer ou demander un nouveau code.",
      deleteContactMethod:
        "Échec de la suppression du moyen de contact. Veuillez contacter Concierge pour obtenir de l'aide.",
      setDefaultContactMethod:
        "Échec de la définition d’une nouvelle méthode de contact par défaut. Veuillez contacter Concierge pour obtenir de l’aide.",
      addContactMethod:
        "Échec de l’ajout de ce moyen de contact. Veuillez contacter Concierge pour obtenir de l’aide.",
    ...
    yourDefaultContactMethodRestrictedSwitch:
      "Ceci est votre méthode de contact par défaut actuelle. Votre entreprise a restreint sa suppression ou sa modification.",
  },
  pronouns: {
  ...
  updateRequiredView: {
    ...
    pleaseInstall:
      "Veuillez mettre à jour vers la dernière version de New Expensify",
    pleaseInstallExpensifyClassic:
      "Veuillez installer la dernière version d’Expensify",
    toGetLatestChanges:
      "Sur mobile, téléchargez et installez la dernière version. Sur le web, actualisez votre navigateur.",
  ...
  initialSettingsPage: {
    ...
    aboutPage: {
      description:
        "La nouvelle application Expensify est créée par une communauté de développeurs open source du monde entier. Aidez-nous à construire l’avenir d’Expensify.",
    ...
    troubleshoot: {
      ...
      confirmResetDescription:
        "Tous les brouillons de messages non envoyés seront perdus, mais le reste de vos données est en sécurité.",
      ...
      maskExportOnyxStateData:
        "Masquer les données fragiles des membres lors de l’export de l’état Onyx",
      ...
      usingImportedState:
        "Vous utilisez un état importé. Appuyez ici pour l’effacer.",
      debugMode: "Mode débogage",
      invalidFile: "Fichier invalide",
      invalidFileDescription:
        "Le fichier que vous tentez d’importer n’est pas valide. Veuillez réessayer.",
      ...
      sentryHighlightedSpanOpsPlaceholder:
        "ui.interaction.clic, navigation, ui.chargement",
    },
    security: "Sécurité",
    signOut: "Se déconnecter",
    restoreStashed: "Restaurer la connexion mise de côté",
    signOutConfirmationText:
      "Vous perdrez toutes les modifications hors ligne si vous vous déconnectez.",
    versionLetter: "v",
  ...
  closeAccountPage: {
    ...
    reasonForLeavingPrompt:
      "Nous serions désolés de vous voir partir ! Pourriez-vous nous dire pourquoi, afin que nous puissions nous améliorer ?",
    ...
    closeAccountPermanentlyDeleteData:
      "Voulez-vous vraiment supprimer votre compte ? Cela supprimera définitivement toutes les dépenses en attente.",
    enterDefaultContactToConfirm:
      "Veuillez saisir votre méthode de contact par défaut pour confirmer que vous souhaitez fermer votre compte. Votre méthode de contact par défaut est :",
    ...
    enterYourDefaultContactMethod:
      "Veuillez saisir votre méthode de contact par défaut pour fermer votre compte.",
  },
  mergeAccountsPage: {
    mergeAccount: "Fusionner les comptes",
    accountDetails: {
      accountToMergeInto: (login: string) =>
        `Saisissez le compte que vous souhaitez fusionner avec <strong>${login}</strong>.`,
    ...
    accountValidate: {
      ...
      enterMagicCode: (login: string) =>
        `Pour continuer, veuillez saisir le code magique envoyé à <strong>${login}</strong>.`,
      errors: {
        incorrectMagicCode:
          "Code magique incorrect ou non valide. Veuillez réessayer ou demander un nouveau code.",
    ...
    mergePendingSAML: {
      ...
      limitedSupport:
        "Nous ne prenons pas encore en charge la fusion de comptes sur le nouveau Expensify. Veuillez effectuer cette action sur Expensify Classic à la place.",
      reachOutForHelp:
        "<muted-text><centered-text>N'hésitez pas à <concierge-link>contacter Concierge</concierge-link> si vous avez des questions&nbsp;!</centered-text></muted-text>",
    ...
    mergeFailureTooManyAttempts: {
      ...
      description:
        "Il y a eu trop de tentatives de fusion de comptes. Veuillez réessayer ultérieurement.",
    },
    mergeFailureUnvalidatedAccount: {
      description:
        "Vous ne pouvez pas fusionner avec d'autres comptes, car il n'est pas validé. Veuillez valider le compte et réessayer.",
    },
  ...
  lockAccountPage: {
    ...
    onceLocked:
      "Une fois verrouillé, votre compte sera restreint en attendant une demande de déverrouillage et un contrôle de sécurité",
  ...
  unlockAccountPage: {
    ...
    chatToConciergeToUnlock:
      "Discutez avec Concierge pour résoudre vos problèmes de sécurité et déverrouiller votre compte.",
    chatWithConcierge: "Discuter avec Concierge",
  },
  twoFactorAuth: {
    ...
    explainProcessToRemove:
      "Pour désactiver l’authentification à deux facteurs (2FA), veuillez saisir un code valide depuis votre application d’authentification.",
    explainProcessToRemoveWithRecovery:
      "Pour désactiver l’authentification à deux facteurs (2FA), veuillez saisir un code de récupération valide.",
    disabled: "L’authentification à deux facteurs est maintenant désactivée",
    noAuthenticatorApp:
      "Vous n’aurez plus besoin d’une application d’authentification pour vous connecter à Expensify.",
    ...
    codesLoseAccess: dedent(`
        ...
        `),
    errorStepCodes:
      "Veuillez copier ou télécharger les codes avant de continuer",
    stepVerify: "Vérifier",
    scanCode: "Scannez le code QR à l’aide de votre",
    authenticatorApp: "application d’authentification",
    addKey:
      "Ou ajoutez cette clé secrète à votre application d’authentification :",
    enterCode:
      "Saisissez ensuite le code à six chiffres généré par votre application d’authentification.",
    stepSuccess: "Terminé",
    enabled: "Authentification à deux facteurs activée",
    congrats:
      "Félicitations ! Vous bénéficiez désormais de cette sécurité supplémentaire.",
    copy: "Copier",
    disable: "Désactiver",
    ...
    twoFactorAuthIsRequiredDescription:
      "Pour des raisons de sécurité, Xero exige une authentification à deux facteurs pour connecter l’intégration.",
    twoFactorAuthIsRequiredForAdminsHeader:
      "Authentification à deux facteurs requise",
    twoFactorAuthIsRequiredForAdminsTitle:
      "Veuillez activer l’authentification à deux facteurs",
    twoFactorAuthIsRequiredXero:
      "Votre connexion comptable Xero nécessite une authentification à deux facteurs.",
    ...
    twoFactorAuthRequired:
      "L’authentification à deux facteurs (2FA) est requise pour votre connexion Xero et ne peut pas être désactivée.",
  },
  recoveryCodeForm: {
    error: {
      pleaseFillRecoveryCode: "Veuillez saisir votre code de récupération",
      incorrectRecoveryCode:
        "Code de récupération incorrect. Veuillez réessayer.",
    },
  ...
  twoFactorAuthForm: {
    error: {
      pleaseFillTwoFactorAuth:
        "Veuillez saisir votre code d’authentification à deux facteurs",
      incorrect2fa:
        "Code d’authentification à deux facteurs incorrect. Veuillez réessayer.",
    },
  },
  ...
  privateNotes: {
    title: "Notes privées",
    personalNoteMessage:
      "Conservez des notes sur cette discussion ici. Vous êtes la seule personne qui peut ajouter, modifier ou consulter ces notes.",
    sharedNoteMessage:
      "Conservez des notes sur cette discussion ici. Les employés d’Expensify et les autres membres du domaine team.expensify.com peuvent voir ces notes.",
    composerLabel: "Notes",
    myNote: "Ma note",
    error: {
  ...
  billingCurrency: {
    ...
    paymentCurrencyDescription:
      "Sélectionnez une devise standardisée à laquelle toutes les dépenses personnelles doivent être converties",
  ...
  addDebitCardPage: {
    ...
    error: {
      ...
      securityCode: "Veuillez saisir un code de sécurité valide",
      addressStreet:
        "Veuillez saisir une adresse de facturation valide qui ne soit pas une boîte postale.",
      addressState: "Veuillez sélectionner un État",
      addressCity: "Veuillez saisir une ville",
      genericFailureMessage:
        "Une erreur s’est produite lors de l’ajout de votre carte. Veuillez réessayer.",
  ...
  walletPage: {
    ...
    error: {
      notOwnerOfBankAccount:
        "Une erreur s’est produite lors de la définition de ce compte bancaire comme mode de paiement par défaut",
      invalidBankAccount: "Ce compte bancaire est temporairement suspendu",
      notOwnerOfFund:
        "Une erreur s’est produite lors de la définition de cette carte comme moyen de paiement par défaut",
      setDefaultFailure:
        "Un problème est survenu. Veuillez discuter avec Concierge pour obtenir une aide supplémentaire.",
    },
    addBankAccountFailure:
      "Une erreur inattendue s’est produite lors de l’ajout de votre compte bancaire. Veuillez réessayer.",
    getPaidFaster: "Soyez payé plus rapidement",
    addPaymentMethod:
      "Ajoutez un moyen de paiement pour envoyer et recevoir des paiements directement dans l’application.",
    ...
    sendAndReceiveMoney:
      "Envoyez et recevez de l’argent avec vos amis. Comptes bancaires américains uniquement.",
    enableWallet: "Activer le portefeuille",
    addBankAccountToSendAndReceive:
      "Ajoutez un compte bancaire pour effectuer ou recevoir des paiements.",
    addDebitOrCreditCard: "Ajouter une carte de débit ou de crédit",
    assignedCards: "Cartes assignées",
    assignedCardsDescription:
      "Les transactions de ces cartes se synchronisent automatiquement.",
    expensifyCard: "Carte Expensify",
    walletActivationPending:
      "Nous examinons vos informations. Veuillez revenir vérifier dans quelques minutes !",
    walletActivationFailed:
      "Malheureusement, votre portefeuille ne peut pas être activé pour le moment. Veuillez discuter avec Concierge pour obtenir une assistance supplémentaire.",
    addYourBankAccount: "Ajoutez votre compte bancaire",
    addBankAccountBody:
      "Connectons votre compte bancaire à Expensify afin qu’il soit plus facile que jamais d’envoyer et de recevoir des paiements directement dans l’application.",
    ...
    shareBankAccountTitle:
      "Sélectionnez les administrateurs avec qui partager ce compte bancaire :",
    shareBankAccountSuccess: "Compte bancaire partagé !",
    shareBankAccountSuccessDescription:
      "Les administrateurs sélectionnés recevront un message de confirmation de la part de Concierge.",
    shareBankAccountFailure:
      "Une erreur inattendue s’est produite lors du partage du compte bancaire. Veuillez réessayer.",
    shareBankAccountEmptyTitle: "Aucun administrateur disponible",
    shareBankAccountEmptyDescription:
      "Il n’y a aucun administrateur d’espace de travail avec qui vous pouvez partager ce compte bancaire.",
    ...
    unshareBankAccountWarning: ({ admin }: { admin?: string | null }) =>
      `${admin} perdra l’accès à ce compte bancaire professionnel. Nous terminerons tout de même les paiements en cours.`,
    reachOutForHelp:
      "Elle est utilisée avec la Carte Expensify. <concierge-link>Contactez Concierge</concierge-link> si vous devez arrêter de la partager.",
    unshareErrorModalTitle:
      "Impossible d’annuler le partage du compte bancaire",
    travelCVV: {
      title: "Cryptogramme visuel de la carte de voyage (CVV)",
      subtitle: "À utiliser lors de la réservation de voyages",
      description:
        "Utilisez cette carte pour vos réservations Expensify Travel. Elle apparaîtra comme “Travel Card” lors du paiement.",
    },
    chaseAccountNumberDifferent:
      "Pourquoi mon numéro de compte est-il différent ?",
  },
  cardPage: {
    expensifyCard: "Carte Expensify",
    ...
    fixedLimit: {
      name: "Limite fixe",
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
        `Vous pouvez dépenser jusqu’à ${formattedLimit} avec cette carte, après quoi elle sera désactivée.`,
    },
    monthlyLimit: {
    ...
    suspiciousBannerDescription:
      "Nous avons détecté des transactions suspectes sur votre carte. Touchez ci-dessous pour examiner.",
    cardLocked:
      "Votre carte est temporairement bloquée pendant que notre équipe examine le compte de votre entreprise.",
    markTransactionsAsReimbursable:
      "Marquer les transactions comme remboursables",
    markTransactionsDescription:
      "Lorsqu’elle est activée, les transactions importées depuis cette carte sont marquées comme remboursables par défaut.",
    ...
    cardAddedToWallet: ({ platform }: { platform: "Google" | "Apple" }) =>
      `Ajouté au portefeuille ${platform}`,
    cardDetailsLoadingFailure:
      "Une erreur s’est produite lors du chargement des détails de la carte. Veuillez vérifier votre connexion Internet et réessayer.",
    ...
    missingPrivateDetails: ({
      ...
      `Veuillez <a href="${missingDetailsLink}">ajouter vos informations personnelles</a>, puis réessayer.`,
    unexpectedError:
      "Une erreur s’est produite lors de la récupération des détails de votre carte Expensify. Veuillez réessayer.",
    cardFraudAlert: {
      ...
      deactivatedMessage: ({ cardLastFour }: { cardLastFour: string }) =>
        `a désactivé la carte se terminant par ${cardLastFour}`,
      alertMessage: ({
        cardLastFour,
        amount,
        merchant,
...
${amount} pour ${merchant} - ${date}`,
    ...
    freezeDescription:
      "Une carte gelée ne peut pas être utilisée pour des achats ni des transactions. Vous pouvez la dégeler à tout moment.",
    unfreezeDescription:
    ...
    youFroze: ({ date }: { date: string }) =>
      `Vous avez gelé cette carte le ${date}.`,
    frozenBy: ({ person, date }: { person: string; date: string }) =>
      `${person} a gelé cette carte le ${date}.`,
  },
  workflowsPage: {
    workflowTitle: "Dépense",
    workflowDescription:
      "Configurez un flux de travail depuis le moment où la dépense a lieu, y compris l’approbation et le paiement.",
    submissionFrequency: "Soumissions",
    submissionFrequencyDescription:
      "Choisissez une planification personnalisée pour soumettre des dépenses.",
    submissionFrequencyDateOfMonth: "Jour du mois",
    disableApprovalPromptDescription:
      "La désactivation des approbations effacera tous les flux de travail d’approbation existants.",
    ...
    accessibilityLabel: ({
      ...
      members: string;
      approvers: string;
    }) => `dépenses de ${members}, et l'approbateur est ${approvers}`,
    addApprovalButton: "Ajouter un workflow d’approbation",
    findWorkflow: "Rechercher un flux de travail",
    addApprovalTip:
      "Ce workflow par défaut s’applique à tous les membres, sauf si un workflow plus spécifique existe.",
    approver: "Approbateur",
    addApprovalsDescription:
      "Exiger une approbation supplémentaire avant d’autoriser un paiement.",
    makeOrTrackPaymentsTitle: "Paiements",
    makeOrTrackPaymentsDescription:
      "Ajoutez un payeur autorisé pour les paiements effectués dans Expensify ou suivez les paiements effectués ailleurs.",
    ...
    editor: {
      submissionFrequency:
        "Choisissez la durée pendant laquelle Expensify doit attendre avant de partager les dépenses sans erreur.",
    },
    frequencyDescription:
      "Choisissez à quelle fréquence vous souhaitez que les dépenses soient soumises automatiquement, ou rendez l’envoi manuel",
    frequencies: {
    ...
    approverInMultipleWorkflows:
      "Ce membre appartient déjà à un autre circuit d’approbation. Toute mise à jour effectuée ici sera également répercutée là-bas.",
    ...
    emptyContent: {
      ...
      expensesFromSubtitle:
        "Tous les membres de l’espace de travail appartiennent déjà à un circuit d’approbation existant.",
      approverSubtitle:
        "Tous les approbateurs appartiennent à un workflow existant.",
    },
  },
  workflowsDelayedSubmissionPage: {
    autoReportingFrequencyErrorMessage:
      "La fréquence de soumission n'a pas pu être modifiée. Veuillez réessayer ou contacter l'assistance.",
    monthlyOffsetErrorMessage:
      "La fréquence mensuelle n’a pas pu être modifiée. Veuillez réessayer ou contacter l’assistance.",
  },
  ...
  workflowsEditApprovalsPage: {
    ...
    deletePrompt:
      "Voulez-vous vraiment supprimer ce workflow d’approbation ? Tous les membres suivront ensuite le workflow par défaut.",
  },
  ...
  workflowsApproverPage: {
    genericErrorMessage:
      "L’approbateur n’a pas pu être modifié. Veuillez réessayer ou contacter l’assistance.",
  ...
  workflowsApprovalLimitPage: {
    ...
    enterApproverError:
      "Un approbateur est obligatoire lorsque vous définissez une limite de note de frais",
    enterBothError:
      "Saisissez un montant de note de frais et un approbateur supplémentaire",
  ...
  workflowsPayerPage: {
    ...
    genericErrorMessage:
      "Le payeur autorisé n’a pas pu être modifié. Veuillez réessayer.",
  ...
  reportFraudConfirmationPage: {
    ...
    description:
      "Nous avons définitivement désactivé votre carte actuelle. Lorsque vous retournerez consulter les détails de votre carte, une nouvelle carte virtuelle sera disponible.",
    buttonText: "Compris, merci !",
  },
  activateCardPage: {
    activateCard: "Activer la carte",
    pleaseEnterLastFour:
      "Veuillez saisir les quatre derniers chiffres de votre carte.",
    activatePhysicalCard: "Activer la carte physique",
    error: {
      thatDidNotMatch:
        "Cela ne correspond pas aux 4 derniers chiffres de votre carte. Veuillez réessayer.",
      throttled:
  ...
  getPhysicalCard: {
    ...
    nameMessage:
      "Saisissez votre prénom et votre nom, car ils apparaîtront sur votre carte.",
    legalName: "Nom légal",
    ...
    estimatedDeliveryMessage:
      "Votre carte physique arrivera dans 2 à 3 jours ouvrés.",
    next: "Suivant",
    getPhysicalCard: "Obtenir une carte physique",
  ...
  transferAmountPage: {
    ...
    instantSummary: (rate: string, minAmount: string) =>
      `Frais de ${rate} % (${minAmount} minimum)`,
    ...
    transferDetailBankAccount:
      "Votre argent devrait arriver dans un délai de 1 à 3 jours ouvrables.",
    transferDetailDebitCard: "Votre argent devrait arriver immédiatement.",
    failedTransfer:
      "Votre solde n’est pas entièrement réglé. Veuillez effectuer un virement vers un compte bancaire.",
    notHereSubTitle:
      "Veuillez transférer votre solde depuis la page du portefeuille",
  ...
  expenseRulesPage: {
    ...
    emptyRules: {
      ...
      subtitle:
        "Ajoutez une règle pour automatiser la création de notes de frais.",
    },
    changes: {
      billableUpdate: (value: boolean) =>
        `Mettre à jour la dépense ${value ? "facturable" : "non refacturable"}`,
      categoryUpdate: (value: string) =>
        `Mettre à jour la catégorie sur « ${value} »`,
      commentUpdate: (value: string) =>
        `Mettre à jour la description en « ${value} »`,
      merchantUpdate: (value: string) =>
        `Mettre à jour le commerçant sur « ${value} »`,
      reimbursableUpdate: (value: boolean) =>
        `Mettre à jour la dépense ${value ? "remboursable" : "non remboursable"}`,
      tagUpdate: (value: string) => `Mettre à jour le tag sur « ${value} »`,
      taxUpdate: (value: string) =>
        `Mettre à jour le taux de taxe sur « ${value} »`,
      billable: (value: boolean) =>
        `dépense ${value ? "facturable" : "non refacturable"}`,
      ...
      reimbursable: (value: boolean) =>
        `dépense ${value ? "remboursable" : "non remboursable"}`,
      tag: (value: string) => `taguer vers « ${value} »`,
      tax: (value: string) => `taux d’imposition à « ${value} »`,
      report: (value: string) =>
        `ajouter à une note de frais nommée « ${value} »`,
    },
    ...
    addRule: {
      ...
      merchantHint:
        "Tapez . pour créer une règle qui s’applique à tous les marchands",
      addToReport: "Ajouter à une note de frais nommée",
      createReport: "Créer une note de frais si nécessaire",
      applyToExistingExpenses:
        "Appliquer aux dépenses correspondantes existantes",
      confirmError:
        "Saisissez un commerçant et appliquez au moins une mise à jour",
  ...
  preferencesPage: {
    ...
    testSection: {
      ...
      subtitle:
        "Paramètres pour aider à déboguer et tester l’application sur l’environnement de staging.",
    },
    receiveRelevantFeatureUpdatesAndExpensifyNews:
      "Recevoir des mises à jour de fonctionnalités pertinentes et des actualités Expensify",
    muteAllSounds: "Couper tous les sons d’Expensify",
  },
  priorityModePage: {
    priorityMode: "Mode priorité",
    explainerText:
      "Choisissez de #vous concentrer uniquement sur les discussions non lues et épinglées, ou d’afficher tout avec les discussions les plus récentes et épinglées en haut.",
    priorityModes: {
      default: {
        label: "Le plus récent",
        description:
          "Afficher toutes les discussions triées par les plus récentes",
      },
      gsd: {
        label: "#focus",
        description:
          "Afficher uniquement les non lus triés par ordre alphabétique",
      },
    },
  },
  reportDetailsPage: {
    ...
    errorPDF:
      "Une erreur s’est produite lors de la tentative de génération de votre PDF",
    successPDF:
      "Votre PDF a été généré ! S’il ne s’est pas téléchargé automatiquement, utilisez le bouton ci-dessous.",
  },
  ...
  groupChat: {
    ...
    lastMemberWarning:
      "Comme vous êtes la dernière personne ici, partir rendra cette discussion inaccessible à tous les membres. Êtes-vous sûr de vouloir partir ?",
    defaultReportName: ({ displayName }: ReportArchiveReasonsClosedParams) =>
      `Discussion de groupe de ${displayName}`,
  },
  languagePage: {
    language: "Langue",
    aiGenerated:
      "Les traductions pour cette langue sont générées automatiquement et peuvent contenir des erreurs.",
  },
  themePage: {
    theme: "Thème",
    themes: {
    ...
    chooseThemeBelowOrSync:
      "Choisissez un thème ci-dessous ou synchronisez avec les réglages de votre appareil.",
  },
  termsOfUse: {
  ...
  validateCodeForm: {
    ...
    requiredWhen2FAEnabled:
      "Obligatoire lorsque l’authentification à deux facteurs est activée",
    requestNewCode: ({ timeRemaining }: { timeRemaining: string }) =>
      `Demander un nouveau code dans <a>${timeRemaining}</a>`,
  ...
  passwordForm: {
    ...
    enterYourTwoFactorAuthenticationCodeToContinue:
      "Saisissez votre code d’authentification à deux facteurs pour continuer",
    ...
    error: {
      ...
      twoFactorAuthenticationEnabled:
        "L’authentification à deux facteurs (2FA) est activée sur ce compte. Veuillez vous connecter avec votre e-mail ou votre numéro de téléphone.",
      invalidLoginOrPassword:
        "Identifiant ou mot de passe invalide. Veuillez réessayer ou réinitialiser votre mot de passe.",
      ...
      noAccess:
        "Vous n’avez pas accès à cette application. Veuillez ajouter votre nom d’utilisateur GitHub pour obtenir l’accès.",
      accountLocked:
        "Votre compte a été verrouillé après trop de tentatives infructueuses. Veuillez réessayer dans 1 heure.",
      fallback: "Un problème est survenu. Veuillez réessayer plus tard.",
    },
  },
  loginForm: {
    ...
    error: {
      invalidFormatEmailLogin:
        "L’adresse e-mail saisie est invalide. Veuillez corriger le format et réessayer.",
    },
    cannotGetAccountDetails:
      "Impossible de récupérer les détails du compte. Veuillez essayer de vous reconnecter.",
  ...
  onboarding: {
    ...
    explanationModal: {
      ...
      secondaryDescription:
        "Pour revenir à Expensify Classic, appuyez simplement sur votre photo de profil > Aller à Expensify Classic.",
    },
    getStarted: "Commencer",
    whatsYourName: "Comment vous appelez-vous ?",
    peopleYouMayKnow:
      "Des personnes que vous connaissez probablement sont déjà ici ! Vérifiez votre adresse e-mail pour les rejoindre.",
    workspaceYouMayJoin: ({ domain, email }: WorkspaceYouMayJoin) =>
      `Quelqu’un de ${domain} a déjà créé un espace de travail. Veuillez saisir le code magique envoyé à ${email}.`,
    joinAWorkspace: "Rejoindre un espace de travail",
    listOfWorkspaces:
      "Voici la liste des espaces de travail que vous pouvez rejoindre. Ne vous inquiétez pas, vous pourrez toujours les rejoindre plus tard si vous préférez.",
    workspaceMemberList: ({
      employeeCount,
      policyOwner,
    }: WorkspaceMemberList) =>
      `${employeeCount} membre${employeeCount > 1 ? "s" : ""} • ${policyOwner}`,
    ...
    purpose: {
      ...
      errorContinue:
        "Veuillez appuyer sur Continuer pour procéder à la configuration",
      errorBackButton:
        "Veuillez terminer les questions de configuration pour commencer à utiliser l’application",
      [CONST.ONBOARDING_CHOICES.EMPLOYER]:
        "Me faire rembourser par mon employeur",
      [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]:
        "Gérer les dépenses de mon équipe",
      [CONST.ONBOARDING_CHOICES.PERSONAL_SPEND]:
        "Suivre et budgéter les dépenses",
      [CONST.ONBOARDING_CHOICES.CHAT_SPLIT]:
        "Discutez et partagez les dépenses avec des amis",
    ...
    workEmail: {
      ...
      subtitle:
        "Expensify fonctionne au mieux lorsque vous connectez votre adresse e-mail professionnelle.",
      explanationModal: {
    ...
    workEmailValidation: {
      ...
      magicCodeSent: ({ workEmail }: WorkEmailResendCodeParams) =>
        `Veuillez saisir le code magique envoyé à ${workEmail}. Il devrait arriver d’ici une à deux minutes.`,
    },
    workEmailValidationError: {
      publicEmail:
        "Veuillez saisir une adresse e-mail professionnelle valide provenant d’un domaine privé, par ex. mitch@company.com",
      offline:
        "Nous n’avons pas pu ajouter votre adresse e-mail professionnelle, car vous semblez être hors ligne",
    },
    mergeBlockScreen: {
    ...
    tasks: {
      testDriveAdminTask: {
        ...
        description: ({ testDriveURL }) =>
          `[Découvrez rapidement le produit](${testDriveURL}) pour voir pourquoi Expensify est le moyen le plus rapide de gérer vos dépenses.`,
      },
      testDriveEmployeeTask: {
        title: ({ testDriveURL }) => `Faites un [essai](${testDriveURL})`,
        description: ({ testDriveURL }) =>
          `Essayez-nous en [prenant le volant](${testDriveURL}) et offrez à votre équipe *3&nbsp;mois gratuits d’Expensify&nbsp;!*`,
      },
      ...
      createTestDriveAdminWorkspaceTask: {
        title: ({ workspaceConfirmationLink }) =>
          `[Créer](${workspaceConfirmationLink}) un espace de travail`,
        description:
          "Créez un espace de travail et configurez les paramètres avec l’aide de votre spécialiste de configuration !",
      },
      createWorkspaceTask: {
        title: ({ workspaceSettingsLink }) =>
          `Créer un [espace de travail](${workspaceSettingsLink})`,
      ...
      setupCategoriesTask: {
        title: ({ workspaceCategoriesLink }) =>
          `Configurer les [catégories](${workspaceCategoriesLink})`,
...
${
  integrationName && CONST.connectionsVideoPaths[integrationName]
    ...
    : `[Accéder à la comptabilité](${workspaceAccountingLink}).`
      ...
      connectCorporateCardTask: {
        title: ({ corporateCardLink }) =>
          `Connectez [vos cartes d’entreprise](${corporateCardLink})`,
      ...
      inviteTeamTask: {
        title: ({ workspaceMembersLink }) =>
          `Invitez [votre équipe](${workspaceMembersLink})`,
      ...
      setupCategoriesAndTags: {
        title: ({ workspaceCategoriesLink, workspaceTagsLink }) =>
          `Configurer les [catégories](${workspaceCategoriesLink}) et les [tags](${workspaceTagsLink})`,
      ...
      setupTagsTask: {
        title: ({ workspaceTagsLink }) =>
          `Configurer les [tags](${workspaceTagsLink})`,
        description: ({ workspaceMoreFeaturesLink }) =>
          dedent(`
      ...
      inviteAccountantTask: {
        title: ({ workspaceMembersLink }) =>
          `Invitez votre [comptable](${workspaceMembersLink})`,
        description: ({ workspaceMembersLink }) =>
          dedent(`
      ...
      reviewWorkspaceSettingsTask: {
        title: ({ workspaceSettingsLink }) =>
          `Examinez les [paramètres de votre espace de travail](${workspaceSettingsLink})`,
        description: ({ workspaceSettingsLink }) =>
          dedent(`
    ...
    testDrive: {
      name: ({ testDriveURL }: { testDriveURL?: string }) =>
        testDriveURL ? `Faites un [essai](${testDriveURL})` : "Faites un essai",
    ...
    messages: {
      onboardingEmployerOrSubmitMessage:
        "Se faire rembourser est aussi simple qu’envoyer un message. Passons en revue les bases.",
      ...
      onboardingChatSplitMessage:
        "Partager des notes de frais avec des amis est aussi simple que d’envoyer un message. Voici comment faire.",
      onboardingAdminMessage:
        "Découvrez comment gérer l’espace de travail de votre équipe en tant qu’administrateur et soumettre vos propres dépenses.",
      ...
      onboardingTestDriveReceiverMessage:
        "*Vous bénéficiez de 3 mois gratuits ! Commencez ci-dessous.*",
    },
    workspace: {
      title: "Restez organisé avec un espace de travail",
      subtitle:
        "Débloquez des outils puissants pour simplifier votre gestion des dépenses, le tout à un seul endroit. Avec un espace de travail, vous pouvez :",
      explanationModal: {
      ...
      price:
        "Essayez-le gratuitement pendant 30 jours, puis passez à l’offre supérieure pour seulement <strong>5 $/utilisateur/mois</strong>.",
    ...
    inviteMembers: {
      ...
      subtitle:
        "Ajoutez votre équipe ou invitez votre comptable. Plus on est de fous, plus on rit !",
    },
  },
  featureTraining: {
  ...
  personalDetails: {
    error: {
      ...
      containsReservedWord:
        "Le nom ne peut pas contenir les mots Expensify ou Concierge",
      hasInvalidCharacter:
        "Le nom ne peut pas contenir de virgule ni de point-virgule",
  ...
  privatePersonalDetails: {
    ...
    privateDataMessage:
      "Ces informations sont utilisées pour les déplacements et les paiements. Elles ne s’affichent jamais sur votre profil public.",
    legalName: "Nom légal",
    legalFirstName: "Prénom légal",
    legalLastName: "Nom de famille légal",
    address: "Adresse",
    error: {
      dateShouldBeBefore: (dateString: string) =>
        `La date doit être antérieure au ${dateString}`,
      dateShouldBeAfter: (dateString: string) =>
        `La date doit être postérieure au ${dateString}`,
      hasInvalidCharacter:
        "Le nom peut uniquement contenir des caractères latins",
      incorrectZipFormat: (zipFormat?: string) =>
        `Format de code postal incorrect${zipFormat ? `Format acceptable : ${zipFormat}` : ""}`,
  ...
  unlinkLoginForm: {
    ...
    noLongerHaveAccess: (primaryLogin: string) =>
      `Si vous n'avez plus accès à ${primaryLogin}, veuillez dissocier vos comptes.`,
    unlink: "Dissocier",
  ...
  smsDeliveryFailurePage: {
    ...
    validationSuccess:
      "Votre numéro a été validé ! Cliquez ci-dessous pour envoyer un nouveau code magique de connexion.",
    validationFailed: ({
      timeData,
    }: {
      timeData?: {
      ...
      if (timeData.days) {
        timeParts.push(
          `${timeData.days} ${timeData.days === 1 ? "jour" : "jours"}`,
        );
      }
      if (timeData.hours) {
        timeParts.push(
          `${timeData.hours} ${timeData.hours === 1 ? "heure" : "heures"}`,
        );
      }
      if (timeData.minutes) {
        timeParts.push(
          `${timeData.minutes} ${timeData.minutes === 1 ? "minute" : "minutes"}`,
        );
      }
      let timeText = "";
  ...
  notFound: {
    chatYouLookingForCannotBeFound:
      "La discussion que vous recherchez est introuvable.",
    getMeOutOfHere: "Faites-moi sortir d’ici",
    iouReportNotFound:
      "Les détails de paiement que vous recherchez sont introuvables.",
    notHere: "Hmm... ce n’est pas ici",
    pageNotFound: "Oups, cette page est introuvable",
    noAccess:
      "Cette discussion ou cette dépense a peut-être été supprimée ou vous n’y avez pas accès.\n\nPour toute question, veuillez contacter concierge@expensify.com",
    goBackHome: "Retourner à la page d’accueil",
    commentYouLookingForCannotBeFound:
      "Le commentaire que vous recherchez est introuvable.",
  ...
  errorPage: {
    ...
    subtitle:
      "Votre demande n’a pas pu être effectuée. Veuillez réessayer plus tard.",
    wrongTypeSubtitle:
      "Cette recherche n’est pas valide. Essayez de modifier vos critères de recherche.",
  },
  statusPage: {
    status: "Statut",
    statusExplanation:
      "Ajoutez un emoji pour permettre à vos collègues et amis de savoir facilement ce qui se passe. Vous pouvez aussi ajouter un message si vous le souhaitez !",
    today: "Aujourd’hui",
    ...
    vacationDelegateError:
      "Une erreur s’est produite lors de la mise à jour de votre remplaçant de congés.",
    asVacationDelegate: ({ nameOrEmail }: VacationDelegateParams) =>
      `en tant que délégué de vacances de ${nameOrEmail}`,
  ...
  bankAccount: {
    ...
    thisBankAccount:
      "Ce compte bancaire sera utilisé pour les paiements professionnels dans votre espace de travail",
    ...
    desktopConnection:
      "Remarque : pour vous connecter à Chase, Wells Fargo, Capital One ou Bank of America, veuillez cliquer ici pour terminer cette procédure dans un navigateur.",
    ...
    plaidBodyCopy:
      "Offrez à vos employés un moyen plus simple de payer – et d’être remboursés – pour les dépenses de l’entreprise.",
    checkHelpLine:
      "Votre numéro de routage et votre numéro de compte se trouvent sur un chèque lié à ce compte.",
    bankAccountPurposeTitle:
      "Que voulez-vous faire avec votre compte bancaire?",
    getReimbursed: "Être remboursé",
    getReimbursedDescription: "Par l'employeur ou d'autres",
    makePayments: "Effectuer des paiements",
    makePaymentsDescription:
      "Payer des dépenses ou émettre des Cartes Expensify",
    ...
    hasBeenThrottledError:
      "Une erreur s’est produite lors de l’ajout de votre compte bancaire. Veuillez patienter quelques minutes, puis réessayer.",
    ...
    error: {
      ...
      industryCode:
        "Veuillez saisir un code de classification de secteur valide comportant six chiffres",
      restrictedBusiness:
        "Veuillez confirmer que l’entreprise ne figure pas sur la liste des entreprises restreintes",
      ...
      routingAndAccountNumberCannotBeSame:
        "Le code de routage et le numéro de compte ne peuvent pas être identiques",
      ...
      noDefaultDepositAccountOrDebitCardAvailable:
        "Veuillez ajouter un compte de dépôt par défaut ou une carte de débit",
      validationAmounts:
        "Les montants de validation que vous avez saisis sont incorrects. Veuillez vérifier votre relevé bancaire et réessayer.",
      ...
      sameDepositAndWithdrawalAccount:
        "Les comptes de dépôt et de retrait sont identiques.",
    },
  },
  addPersonalBankAccount: {
    ...
    accountHolderInformationStepHeader:
      "Quelles sont les informations sur le titulaire du compte ?",
    ...
    confirmationStepSubHeader:
      "Vérifiez attentivement les détails ci-dessous et cochez la case des conditions pour confirmer.",
    toGetStarted:
      "Ajoutez un compte bancaire personnel pour recevoir des remboursements, payer des factures ou activer le Portefeuille Expensify.",
  },
  addPersonalBankAccountPage: {
    ...
    successMessage:
      "Félicitations, votre compte bancaire est configuré et prêt à recevoir des remboursements.",
  },
  attachmentView: {
  ...
  messages: {
    ...
    userIsAlreadyMember: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} est déjà membre de ${name}`,
    userIsAlreadyAnAdmin: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} est déjà administrateur de ${name}`,
  },
  onfidoStep: {
    acceptTerms:
      "En poursuivant la demande d’activation de votre Portefeuille Expensify, vous confirmez que vous avez lu, compris et accepté",
    facialScan:
      "Politique et autorisation relatives à la reconnaissance faciale d’Onfido",
    ...
    genericError:
      "Une erreur s’est produite lors du traitement de cette étape. Veuillez réessayer.",
    cameraPermissionsNotGranted: "Activer l’accès à l’appareil photo",
    cameraRequestMessage:
      "Nous avons besoin d’accéder à votre appareil photo pour terminer la vérification de votre compte bancaire. Veuillez l’activer via Réglages > New Expensify.",
    microphonePermissionsNotGranted: "Activer l’accès au microphone",
    microphoneRequestMessage:
      "Nous avons besoin d'accéder à votre microphone pour terminer la vérification du compte bancaire. Veuillez l'activer via Réglages > New Expensify.",
    originalDocumentNeeded:
      "Veuillez téléverser une image originale de votre pièce d'identité plutôt qu'une capture d'écran ou une image numérisée.",
    ...
    selfieIssue:
      "Un problème est survenu avec votre selfie/vidéo. Veuillez téléverser un selfie/vidéo en direct.",
    selfieNotMatching:
      "Votre selfie/vidéo ne correspond pas à votre pièce d’identité. Veuillez téléverser un nouveau selfie/une nouvelle vidéo où votre visage est clairement visible.",
    selfieNotLive:
      "Votre selfie/vidéo ne semble pas être une photo/vidéo en direct. Veuillez téléverser un selfie/une vidéo en direct.",
  },
  additionalDetailsStep: {
    headerTitle: "Détails supplémentaires",
    helpText:
      "Nous devons confirmer les informations suivantes avant que vous puissiez envoyer et recevoir de l’argent depuis votre portefeuille.",
    helpTextIdologyQuestions:
      "Nous devons vous poser encore quelques questions pour terminer la vérification de votre identité.",
    helpLink:
      "En savoir plus sur les raisons pour lesquelles nous en avons besoin.",
    ...
    ssnFull9Error:
      "Veuillez saisir un numéro de sécurité sociale valide à neuf chiffres",
    needSSNFull9:
      "Nous rencontrons des difficultés pour vérifier votre SSN. Veuillez saisir les neuf chiffres complets de votre SSN.",
  ...
  termsStep: {
    ...
    haveReadAndAgreePlain:
      "J’ai lu et j’accepte de recevoir les communications électroniques.",
    ...
    agreeToThePlain:
      "J'accepte la politique de confidentialité et l'accord de portefeuille.",
    ...
    shortTermsForm: {
      expensifyPaymentsAccount: ({ walletProgram }: WalletProgramParams) =>
        `Le portefeuille Expensify est émis par ${walletProgram}.`,
      ...
      inactivityAfterTwelveMonths:
        "Inactivité (après 12 mois sans transaction)",
      ...
      electronicFundsWithdrawalInstant:
        "Retrait de fonds électronique (instantané)",
    ...
    longTermsForm: {
      ...
      sendingFundsDetails:
        "Aucun frais n’est appliqué pour envoyer des fonds à un autre titulaire de compte en utilisant votre solde, votre compte bancaire ou votre carte de débit.",
  ...
  activateStep: {
    ...
    activatedMessage:
      "Félicitations, votre portefeuille est configuré et prêt à effectuer des paiements.",
    checkBackLaterTitle: "Une minute…",
    checkBackLaterMessage:
      "Nous examinons encore vos informations. Veuillez revenir plus tard.",
  ...
  companyStep: {
    ...
    subtitle:
      "Presque terminé ! Pour des raisons de sécurité, nous devons confirmer certaines informations :",
    ...
    confirmCompanyIsNot:
      "Je confirme que cette entreprise ne figure pas sur la",
    ...
    industryClassification:
      "Dans quel secteur d’activité l’entreprise est-elle classée ?",
    industryClassificationCodePlaceholder:
      "Rechercher un code de classification sectorielle",
  },
  requestorStep: {
  ...
  personalInfoStep: {
    ...
    enterTheLast4:
      "Quels sont les quatre derniers chiffres de votre numéro de Sécurité sociale ?",
    dontWorry:
      "Ne vous inquiétez pas, nous ne faisons aucun contrôle de crédit personnel !",
    last4SSN: "4 derniers chiffres du SSN",
    enterYourAddress: "Quelle est votre adresse ?",
    address: "Adresse",
    letsDoubleCheck: "Vérifions une seconde fois que tout est correct.",
    byAddingThisBankAccount:
      "En ajoutant ce compte bancaire, vous confirmez que vous avez lu, compris et accepté",
    ...
    whatsYourSSN:
      "Quels sont les quatre derniers chiffres de votre numéro de Sécurité sociale ?",
    noPersonalChecks:
      "Ne vous inquiétez pas, aucun contrôle de solvabilité personnel ici !",
    whatsYourPhoneNumber: "Quel est votre numéro de téléphone ?",
    weNeedThisToVerify:
      "Nous avons besoin de cela pour vérifier votre portefeuille.",
  },
  businessInfoStep: {
    ...
    enterYourCompanyTaxIdNumber:
      "Quel est le numéro d’identification fiscale de votre entreprise ?",
    taxIDNumber: "Numéro d’identification fiscale",
    taxIDNumberPlaceholder: "9 chiffres",
    enterYourCompanyWebsite: "Quel est le site web de votre entreprise ?",
    companyWebsite: "Site web de l’entreprise",
    enterYourCompanyPhoneNumber:
      "Quel est le numéro de téléphone de votre entreprise ?",
    ...
    pleaseSelectTheStateYourCompanyWasIncorporatedIn:
      "Dans quel État votre société a-t-elle été constituée ?",
    letsDoubleCheck: "Vérifions une seconde fois que tout est correct.",
    companyAddress: "Adresse de l’entreprise",
    listOfRestrictedBusinesses: "liste d’activités commerciales restreintes",
    confirmCompanyIsNot:
    ...
    whatsTheBusinessContactInformation:
      "Quelles sont les coordonnées professionnelles ?",
    ...
    whereWasTheBusinessIncorporated:
      "Où l’entreprise a-t-elle été constituée ?",
    whatTypeOfBusinessIsIt: "Quel type d’entreprise est-ce ?",
    whatsTheBusinessAnnualPayment:
      "Quel est le volume annuel de paiements de l’entreprise ?",
    whatsYourExpectedAverageReimbursements:
      "Quel est votre montant moyen de remboursement prévu ?",
    ...
    selectAverageReimbursement:
      "Sélectionner le montant moyen de remboursement",
  ...
  beneficialOwnerInfoStep: {
    doYouOwn25percent: (companyName: string) =>
      `Possédez-vous 25 % ou plus de ${companyName} ?`,
    doAnyIndividualOwn25percent: (companyName: string) =>
      `Des personnes détiennent-elles 25 % ou plus de ${companyName} ?`,
    areThereMoreIndividualsWhoOwn25percent: (companyName: string) =>
      `Y a-t-il d’autres personnes qui détiennent 25 % ou plus de ${companyName} ?`,
    regulationRequiresUsToVerifyTheIdentity:
      "La réglementation nous oblige à vérifier l’identité de toute personne détenant plus de 25 % de l’entreprise.",
    companyOwner: "Propriétaire d’entreprise",
    enterLegalFirstAndLastName: "Quel est le nom légal du responsable ?",
    legalFirstName: "Prénom légal",
    legalLastName: "Nom de famille légal",
    enterTheDateOfBirthOfTheOwner:
      "Quelle est la date de naissance du responsable ?",
    enterTheLast4:
      "Quels sont les 4 derniers chiffres du numéro de sécurité sociale du responsable ?",
    last4SSN: "4 derniers chiffres du SSN",
    dontWorry:
      "Ne vous inquiétez pas, nous ne faisons aucun contrôle de crédit personnel !",
  ...
  ownershipInfoStep: {
    ...
    doesAnyoneOwn: (companyName: string) =>
      `Des personnes détiennent-elles 25 % ou plus de ${companyName} ?`,
    regulationsRequire:
      "La réglementation nous impose de vérifier l’identité de toute personne physique détenant plus de 25 % de l’entreprise.",
    legalFirstName: "Prénom légal",
    legalLastName: "Nom de famille légal",
    whatsTheOwnersName: "Quel est le nom légal du responsable ?",
    whatsYourName: "Quel est votre nom légal ?",
    whatPercentage:
      "Quel pourcentage de l’entreprise appartient au propriétaire ?",
    ...
    whatsYourAddress: "Quelle est votre adresse ?",
    whatAreTheLast:
      "Quels sont les 4 derniers chiffres du numéro de sécurité sociale du propriétaire ?",
    whatsYourLast:
      "Quels sont les 4 derniers chiffres de votre numéro de Sécurité sociale ?",
    whatsYourNationality: "Quel est votre pays de citoyenneté ?",
    whatsTheOwnersNationality:
      "Quel est le pays de citoyenneté du responsable ?",
    ...
    owners: "Responsables",
    addCertified:
      "Ajoutez un organigramme certifié indiquant les bénéficiaires effectifs",
    ...
    noteEntity:
      "Remarque : le schéma de propriété de l’entité doit être signé par votre comptable, votre conseiller juridique ou être notarié.",
    ...
    acceptedFiles:
      "Formats de fichier acceptés : PDF, PNG, JPEG. La taille totale des fichiers pour chaque section ne peut pas dépasser 5 Mo.",
    ...
    proofOfAddressDescription:
      "Exemples : facture de services publics, contrat de location, etc.",
  ...
  completeVerificationStep: {
    ...
    certifyTrueAndAccurateError:
      "Veuillez certifier que les informations sont vraies et exactes",
    isAuthorizedToUseBankAccount:
      "Je suis autorisé à utiliser ce compte bancaire professionnel pour des dépenses professionnelles",
    isAuthorizedToUseBankAccountError:
      "Vous devez être un responsable habilité, autorisé à utiliser le compte bancaire professionnel",
  ...
  connectBankAccountStep: {
    ...
    maxAttemptsReached:
      "La validation de ce compte bancaire a été désactivée en raison d’un trop grand nombre de tentatives incorrectes.",
    ...
    descriptionCTA:
      "Veuillez saisir le montant de chaque transaction dans les champs ci-dessous. Exemple : 1.51.",
    letsChatText:
      "On y est presque ! Nous avons besoin de votre aide pour vérifier quelques dernières informations par chat. Prêt(e) ?",
    enable2FATitle:
      "Prévenez la fraude, activez l’authentification à deux facteurs (2FA)",
    enable2FAText:
  ...
  countryStep: {
    confirmBusinessBank:
      "Confirmer la devise et le pays du compte bancaire professionnel",
    confirmCurrency: "Confirmer la devise et le pays",
    yourBusiness:
      "La devise de votre compte bancaire professionnel doit correspondre à la devise de votre espace de travail.",
    youCanChange:
      "Vous pouvez modifier la devise de votre espace de travail dans vos",
    findCountry: "Rechercher un pays",
    selectCountry: "Sélectionner un pays",
  },
  bankInfoStep: {
    whatAreYour:
      "Quelles sont les coordonnées de votre compte bancaire professionnel ?",
  ...
  signerInfoStep: {
    ...
    areYouDirector: (companyName: string) =>
      `Êtes-vous un directeur chez ${companyName} ?`,
    regulationRequiresUs:
      "La réglementation nous oblige à vérifier si le signataire a l’autorité nécessaire pour effectuer cette action au nom de l’entreprise.",
    whatsYourName: "Quel est votre nom légal",
    ...
    personalAddress:
      "Justificatif de domicile personnel (p. ex. facture de services publics)",
    letsDoubleCheck: "Vérifions une dernière fois que tout est correct.",
    legalName: "Nom légal",
    proofOf: "Justificatif de domicile personnel",
    enterOneEmail: (companyName: string) =>
      `Saisissez l’e-mail d’un directeur de ${companyName}`,
    regulationRequiresOneMoreDirector:
      "La réglementation exige au moins un autre directeur en tant que signataire.",
    hangTight: "Un instant...",
    enterTwoEmails: (companyName: string) =>
      `Saisissez les adresses e-mail de deux directeurs de ${companyName}`,
    sendReminder: "Envoyer un rappel",
    chooseFile: "Choisir un fichier",
    weAreWaiting:
      "Nous attendons que d’autres vérifient leur identité en tant que dirigeants de l’entreprise.",
    id: "Copie de la pièce d’identité",
    proofOfDirectors: "Justificatif de(s) directeur(s)",
    proofOfDirectorsDescription:
      "Exemples : profil d’entreprise Oncorp ou enregistrement d’entreprise.",
    codiceFiscale: "Code fiscal",
    codiceFiscaleDescription:
      "Code fiscal pour les signataires, utilisateurs autorisés et bénéficiaires effectifs.",
    ...
    PDSandFSGDescription: dedent(`
        ...
        `),
    pleaseUpload:
      "Veuillez téléverser ci-dessous des documents supplémentaires pour nous aider à vérifier votre identité en tant que dirigeant(e) de l’entreprise.",
  ...
  agreementsStep: {
    ...
    regulationRequiresUs:
      "La réglementation nous oblige à vérifier l’identité de toute personne détenant plus de 25 % de l’entreprise.",
    iAmAuthorized:
      "Je suis autorisé à utiliser le compte bancaire professionnel pour les dépenses professionnelles.",
    iCertify:
      "Je certifie que les informations fournies sont exactes et véridiques.",
    ...
    iConsentToThePrivacyNotice:
      'Je consens à l’<a href="https://payments.corpay.com/compliance">avis de confidentialité</a>.',
    iConsentToThePrivacyNoticeAccessibility:
      "Je consens à la notice de confidentialité.",
    error: {
      authorized:
        "Vous devez être un responsable habilité, autorisé à utiliser le compte bancaire professionnel",
  ...
  docusignStep: {
    ...
    pleaseCompleteTheBusinessAccount:
      "Veuillez remplir la Demande de compte professionnel pour la mise en place d’un prélèvement automatique",
    ...
    pleaseUpload:
      "Veuillez téléverser le formulaire DEFT et la page de signature Docusign",
    pleaseUploadTheDirect:
      "Veuillez téléverser les accords de prélèvement automatique et la page de signature DocuSign",
  },
  finishStep: {
    ...
    enable2FA:
      "Activer l’authentification à deux facteurs (2FA) pour prévenir la fraude",
    weTake:
      "Nous accordons une grande importance à votre sécurité. Veuillez configurer l’authentification à deux facteurs (2FA) maintenant pour ajouter une couche de protection supplémentaire à votre compte.",
  ...
  reimbursementAccountLoadingAnimation: {
    ...
    explanationLine:
      "Nous examinons vos informations. Vous pourrez poursuivre les prochaines étapes sous peu.",
  },
  session: {
    offlineMessageRetry:
      "On dirait que vous êtes hors ligne. Veuillez vérifier votre connexion et réessayer.",
  },
  travel: {
    header: "Réserver un voyage",
    title: "Voyagez futé",
    subtitle:
      "Utilisez Expensify Travel pour obtenir les meilleures offres de voyage et gérer toutes vos dépenses professionnelles en un seul endroit.",
    features: {
      saveMoney: "Économisez sur vos réservations",
      alerts:
        "Recevez des alertes en temps réel si vos projets de voyage changent",
    },
    ...
    termsAndConditions: {
      ...
      error:
        "Vous devez accepter les conditions générales d’Expensify Travel pour continuer",
    ...
    flightDetails: {
      ...
      layover: (layover: string) =>
        `<muted-text-label>Vous avez une <strong>escale de ${layover}</strong> avant ce vol</muted-text-label>`,
      takeOff: "Décollage",
      landing: "Accueil",
      seat: "Siège",
    ...
    domainSelector: {
      title: "Domaine",
      subtitle:
        "Choisissez un domaine pour la configuration d’Expensify Travel.",
    ...
    verifyCompany: {
      ...
      conciergeMessage: ({ domain }: { domain: string }) =>
        `L’activation des voyages a échoué pour le domaine : ${domain}. Veuillez vérifier et activer les voyages pour ce domaine.`,
    },
    updates: {
      bookingTicketed: (
        airlineCode: string,
      ...
      flightScheduleChangePending: (airlineCode: string) =>
        `La compagnie aérienne a proposé une modification d’horaire pour le vol ${airlineCode} ; nous attendons une confirmation.`,
      flightScheduleChangeClosed: (airlineCode: string, startDate?: string) =>
        `Changement d’horaire confirmé : le vol ${airlineCode} part désormais à ${startDate}.`,
      flightUpdated: (
        airlineCode: string,
        origin: string,
        destination: string,
      ...
      flightCabinChanged: (airlineCode: string, cabinClass?: string) =>
        `Votre classe de cabine a été mise à jour en ${cabinClass} sur le vol ${airlineCode}.`,
      flightSeatConfirmed: (airlineCode: string) =>
        `Votre attribution de siège sur le vol ${airlineCode} a été confirmée.`,
      flightSeatChanged: (airlineCode: string) =>
        `Votre siège attribué sur le vol ${airlineCode} a été modifié.`,
      flightSeatCancelled: (airlineCode: string) =>
        `Votre siège attribué sur le vol ${airlineCode} a été supprimé.`,
      paymentDeclined:
        "Le paiement de votre réservation de vol a échoué. Veuillez réessayer.",
      bookingCancelledByTraveler: (type: string, id = "") =>
        `Vous avez annulé votre réservation de ${type} ${id}.`,
      bookingCancelledByVendor: (type: string, id = "") =>
        `Le fournisseur a annulé votre réservation de ${type} ${id}.`,
      bookingRebooked: (type: string, id = "") =>
        `Votre réservation de ${type} a été à nouveau effectuée. Nouveau numéro de confirmation : ${id}.`,
      bookingUpdated: (type: string) =>
        `Votre réservation de ${type} a été mise à jour. Examinez les nouveaux détails dans l’itinéraire.`,
      railTicketRefund: (
        origin: string,
        destination: string,
        startDate: string,
      ...
      defaultUpdate: (type: string) =>
        `Votre réservation de ${type} a été mise à jour.`,
    },
  ...
  workspace: {
    common: {
      ...
      customFieldHint:
        "Ajoutez un codage personnalisé qui s’applique à toutes les dépenses de ce membre.",
      reports: "Notes de frais",
      ...
      deleteWithCardsConfirmation:
        "Voulez-vous vraiment supprimer cet espace de travail ? Cela supprimera tous les flux de cartes et les cartes assignées.",
      unavailable: "Espace de travail indisponible",
      memberNotFound:
        "Membre introuvable. Pour inviter un nouveau membre dans l’espace de travail, veuillez utiliser le bouton d’invitation ci-dessus.",
      ...
      mustBeOnlineToViewMembers:
        "Vous devez être en ligne pour voir les membres de cet espace de travail.",
      ...
      descriptionHint:
        "Partager des informations sur cet espace de travail avec tous les membres.",
      welcomeNote:
        "Veuillez utiliser Expensify pour soumettre vos reçus en vue de leur remboursement, merci !",
      subscription: "Abonnement",
      ...
      exportIntegrationSelected: ({
        ...
        `Exporter vers ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      letsDoubleCheck: "Vérifions une seconde fois que tout est correct.",
      ...
      connectTo: ({ connectionName }: ConnectionNameParams) =>
        `Se connecter à ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      ...
      lastSyncDate: (connectionName: string, formattedDate: string) =>
        `${connectionName} - Dernière synchronisation le ${formattedDate}`,
      authenticationError: (connectionName: string) =>
        `Impossible de se connecter à ${connectionName} en raison d’une erreur d’authentification.`,
      learnMore: "En savoir plus",
      memberAlternateText: "Soumettre et approuver des notes de frais.",
      adminAlternateText:
        "Gérer les notes de frais et les paramètres de l’espace de travail.",
    ...
    receiptPartners: {
      uber: {
        subtitle: (organizationName: string) =>
          organizationName
            ? `Connecté à ${organizationName}`
            : "Automatisez les dépenses de voyage et de livraison de repas dans l’ensemble de votre organisation.",
        ...
        takeBusinessRideMessage:
          "Faites un trajet professionnel et vos reçus Uber seront importés dans Expensify. En route !",
        all: "Tout",
        linked: "Lié",
        ...
        status: {
          ...
          [CONST.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS
            .LINKED_PENDING_APPROVAL]: "En attente",
        ...
        centralBillingDescription:
          "Choisissez où importer tous les reçus Uber.",
        invitationFailure:
          "Échec de l’invitation du membre à Uber for Business",
        autoInvite:
          "Inviter de nouveaux membres de l’espace de travail à Uber for Business",
        autoRemove:
          "Désactiver les membres d’espace de travail supprimés d’Uber for Business",
        emptyContent: {
          title: "Aucune invitation en attente",
          subtitle:
            "Hourra ! Nous avons cherché partout et n’avons trouvé aucune invitation en attente.",
        },
      },
    },
    perDiem: {
      ...
      emptyList: {
        ...
        subtitle:
          "Définissez des taux de per diem pour contrôler les dépenses quotidiennes des employés. Importez des taux depuis une feuille de calcul pour commencer.",
      },
      ...
      editCurrencySubtitle: (destination: string) =>
        `La mise à jour de cette devise la modifiera pour tous les sous-taux de per diem de ${destination}.`,
    },
    qbd: {
      exportOutOfPocketExpensesDescription:
        "Définissez comment les dépenses hors poche sont exportées vers QuickBooks Desktop.",
      exportOutOfPocketExpensesCheckToggle:
        "Marquer les chèques comme « imprimer plus tard »",
      exportDescription:
        "Configurez comment les données Expensify sont exportées vers QuickBooks Desktop.",
      date: "Date d’exportation",
      exportInvoices: "Exporter les factures vers",
      exportExpensifyCard:
        "Exporter les transactions de Carte Expensify en tant que",
      account: "Compte",
      accountDescription:
        "Choisissez où comptabiliser les écritures de journal.",
      accountsPayable: "Comptes fournisseurs",
      accountsPayableDescription:
        "Choisissez où créer les factures fournisseur.",
      bankAccount: "Compte bancaire",
      ...
      exportDate: {
        ...
        description:
          "Utiliser cette date lors de l’exportation des notes de frais vers QuickBooks Desktop.",
        values: {
          [CONST.QUICKBOOKS_EXPORT_DATE.LAST_EXPENSE]: {
            label: "Date de la dernière dépense",
            description:
              "Date de la dépense la plus récente sur la note de frais.",
          },
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Date d’exportation",
            description:
              "Date d’export de la note de frais vers QuickBooks Desktop.",
          },
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_SUBMITTED]: {
            label: "Date de soumission",
            description:
              "Date à laquelle la note de frais a été soumise pour approbation.",
          },
        },
      },
      ...
      exportJournalEntryDescription:
        "Nous créerons une écriture comptable détaillée pour chaque note de frais Expensify et la comptabiliserons sur le compte ci-dessous.",
      ...
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}AccountDescription`]:
          "Choisissez d’où envoyer les chèques.",
      ...
      noAccountsFoundDescription:
        "Ajoutez le compte dans QuickBooks Desktop et synchronisez à nouveau la connexion",
      qbdSetup: "Configuration de QuickBooks Desktop",
      requiredSetupDevice: {
        title: "Connexion impossible depuis cet appareil",
        body1:
          "Vous devrez configurer cette connexion depuis l’ordinateur qui héberge votre fichier de société QuickBooks Desktop.",
        body2:
          "Une fois que vous serez connecté, vous pourrez synchroniser et exporter depuis n'importe où.",
      },
      setupPage: {
      ...
      importDescription:
        "Choisissez les configurations de codage à importer de QuickBooks Desktop vers Expensify.",
      classes: "Cours",
      items: "Éléments",
      customers: "Clients/projets",
      exportCompanyCardsDescription:
        "Définissez la façon dont les achats par carte d’entreprise sont exportés vers QuickBooks Desktop.",
      ...
      accountsDescription:
        "Votre plan comptable QuickBooks Desktop sera importé dans Expensify en tant que catégories.",
      accountsSwitchTitle:
        "Choisissez d’importer les nouveaux comptes en tant que catégories activées ou désactivées.",
      ...
      classesDescription:
        "Choisissez comment gérer les classes QuickBooks Desktop dans Expensify.",
      tagsDisplayedAsDescription: "Niveau par poste",
      reportFieldsDisplayedAsDescription: "Niveau de la note de frais",
      customersDescription:
        "Choisissez comment gérer les clients/projets QuickBooks Desktop dans Expensify.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify se synchronisera automatiquement avec QuickBooks Desktop chaque jour.",
        createEntities: "Créer automatiquement les entités",
        createEntitiesDescription:
          "Expensify créera automatiquement des fournisseurs dans QuickBooks Desktop s'ils n'existent pas déjà.",
      },
      itemsDescription:
        "Choisissez comment gérer les éléments QuickBooks Desktop dans Expensify.",
      accountingMethods: {
        ...
        alternateText: {
          [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]:
            "Les dépenses remboursables seront exportées une fois l’approbation finale obtenue",
          [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]:
            "Les dépenses payées de votre poche seront exportées une fois remboursées",
        },
      },
    },
    qbo: {
      ...
      importDescription:
        "Choisissez les configurations de codage à importer de QuickBooks Online vers Expensify.",
      classes: "Cours",
      locations: "Lieux",
      customers: "Clients/projets",
      accountsDescription:
        "Votre plan comptable QuickBooks Online sera importé dans Expensify en tant que catégories.",
      accountsSwitchTitle:
        "Choisissez d’importer les nouveaux comptes en tant que catégories activées ou désactivées.",
      accountsSwitchDescription:
        "Les catégories activées seront disponibles pour que les membres puissent les sélectionner lors de la création de leurs dépenses.",
      classesDescription:
        "Choisissez comment gérer les classes QuickBooks Online dans Expensify.",
      customersDescription:
        "Choisissez comment gérer les clients/projets QuickBooks Online dans Expensify.",
      locationsDescription:
        "Choisissez comment gérer les emplacements QuickBooks Online dans Expensify.",
      taxesDescription:
        "Choisissez comment traiter les taxes QuickBooks Online dans Expensify.",
      ...
      exportDescription:
        "Configurer l’exportation des données Expensify vers QuickBooks Online.",
      date: "Date d’exportation",
      exportInvoices: "Exporter les factures vers",
      exportExpensifyCard:
        "Exporter les transactions de Carte Expensify en tant que",
      exportDate: {
        label: "Date d’exportation",
        description:
          "Utiliser cette date lors de l’export des notes de frais vers QuickBooks Online.",
        values: {
          [CONST.QUICKBOOKS_EXPORT_DATE.LAST_EXPENSE]: {
            label: "Date de la dernière dépense",
            description:
          ...
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Date d’exportation",
            description:
              "Date à laquelle la note de frais a été exportée vers QuickBooks Online.",
          },
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_SUBMITTED]: {
            label: "Date de soumission",
            description:
      ...
      exportInvoicesDescription:
        "Utiliser ce compte lors de l’exportation des factures vers QuickBooks Online.",
      exportCompanyCardsDescription:
        "Définissez comment les achats par carte d’entreprise sont exportés vers QuickBooks Online.",
      vendor: "Fournisseur",
      defaultVendorDescription:
        "Définissez un fournisseur par défaut qui s’appliquera à toutes les transactions par carte de crédit lors de l’exportation.",
      exportOutOfPocketExpensesDescription:
        "Définissez comment les dépenses hors poche sont exportées vers QuickBooks Online.",
      exportCheckDescription:
        "Nous créerons un chèque détaillé pour chaque note de frais Expensify et l’enverrons depuis le compte bancaire ci-dessous.",
      exportJournalEntryDescription:
        "Nous créerons une écriture comptable détaillée pour chaque note de frais Expensify et la comptabiliserons sur le compte ci-dessous.",
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify se synchronisera automatiquement avec QuickBooks Online chaque jour.",
        inviteEmployees: "Inviter des employés",
        inviteEmployeesDescription:
          "Importer les fiches des employés QuickBooks Online et inviter les employés dans cet espace de travail.",
        createEntities: "Créer automatiquement les entités",
        createEntitiesDescription:
        ...
        qboInvoiceCollectionAccount:
          "Compte de recouvrement des factures QuickBooks",
        accountSelectDescription:
          "Choisissez l’endroit depuis lequel payer les factures et nous créerons le paiement dans QuickBooks Online.",
        invoiceAccountSelectorDescription:
          "Choisissez où recevoir les paiements de factures et nous créerons le paiement dans QuickBooks Online.",
      },
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]:
          "Choisissez où exporter les transactions de carte de débit.",
      ...
      exportDestinationAccountsMisconfigurationError: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Choisissez un compte valide pour l’exportation de la facture fournisseur",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Choisissez un compte valide pour l’exportation de l’écriture comptable",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Choisissez un compte valide pour l’exportation de chèques",
      },
      exportDestinationSetupAccountsInfo: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Pour utiliser l’exportation des factures fournisseur, configurez un compte fournisseur dans QuickBooks Online",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Pour utiliser l’export des écritures de journal, configurez un compte de journal dans QuickBooks Online",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Pour utiliser l’exportation de chèques, configurez un compte bancaire dans QuickBooks Online",
      },
      noAccountsFound: "Aucun compte trouvé",
      noAccountsFoundDescription:
        "Ajoutez le compte dans QuickBooks Online et synchronisez à nouveau la connexion.",
      accountingMethods: {
        label: "Quand exporter",
        description: "Choisissez quand exporter les dépenses :",
        values: {
    ...
    xero: {
      ...
      organizationDescription:
        "Choisissez l’organisation Xero depuis laquelle vous souhaitez importer des données.",
      importDescription:
        "Choisissez quelles configurations de codage importer de Xero vers Expensify.",
      accountsDescription:
        "Votre plan comptable Xero sera importé dans Expensify en tant que catégories.",
      accountsSwitchTitle:
        "Choisissez d’importer les nouveaux comptes en tant que catégories activées ou désactivées.",
      accountsSwitchDescription:
        "Les catégories activées seront disponibles pour que les membres puissent les sélectionner lors de la création de leurs dépenses.",
      ...
      trackingCategoriesDescription:
        "Choisissez comment gérer les catégories de suivi Xero dans Expensify.",
      mapTrackingCategoryTo: (categoryName: string) =>
        `Faire correspondre la catégorie Xero ${categoryName} à`,
      mapTrackingCategoryToDescription: (categoryName: string) =>
        `Choisissez où faire correspondre ${categoryName} lors de l’exportation vers Xero.`,
      ...
      taxesDescription:
        "Choisissez comment gérer les taxes Xero dans Expensify.",
      notImported: "Non importé",
      notConfigured: "Non configuré",
      trackingCategoriesOptions: {
        [CONST.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT]:
          "Contact Xero par défaut",
        [CONST.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG]: "Tags",
        [CONST.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD]:
          "Champs de note de frais",
      },
      exportDescription:
        "Configurez la façon dont les données Expensify sont exportées vers Xero.",
      ...
      xeroBankAccountDescription:
        "Choisissez où les dépenses seront enregistrées comme transactions bancaires.",
      exportExpensesDescription:
        "Les notes de frais seront exportées sous forme de facture d’achat avec la date et le statut sélectionnés ci-dessous.",
      purchaseBillDate: "Date de facture d’achat",
      exportInvoices: "Exporter les factures en",
      salesInvoice: "Facture de vente",
      exportInvoicesDescription:
        "Les factures de vente affichent toujours la date à laquelle la facture a été envoyée.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify se synchronisera automatiquement avec Xero tous les jours.",
        purchaseBillStatusTitle: "Statut de la facture d’achat",
        reimbursedReportsDescription:
          "Chaque fois qu’une note de frais est payée via Expensify ACH, le règlement de facture correspondant sera créé dans le compte Xero ci-dessous.",
        ...
        xeroBillPaymentAccountDescription:
          "Choisissez d’où payer les factures et nous créerons le paiement dans Xero.",
        invoiceAccountSelectorDescription:
          "Choisissez où recevoir les paiements de factures et nous créerons le paiement dans Xero.",
      },
      exportDate: {
        label: "Date de facture d’achat",
        description:
          "Utiliser cette date lors de l’exportation des notes de frais vers Xero.",
        values: {
          ...
          [CONST.XERO_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Date d’exportation",
            description:
              "Date à laquelle la note de frais a été exportée vers Xero.",
          },
      ...
      invoiceStatus: {
        ...
        description:
          "Utilisez ce statut lors de l’exportation des factures d’achat vers Xero.",
        values: {
      ...
      noAccountsFound: "Aucun compte trouvé",
      noAccountsFoundDescription:
        "Veuillez ajouter le compte dans Xero et synchroniser à nouveau la connexion",
      accountingMethods: {
        label: "Quand exporter",
        description: "Choisissez quand exporter les dépenses :",
        values: {
    ...
    sageIntacct: {
      ...
      exportDate: {
        label: "Date d’exportation",
        description:
          "Utiliser cette date lors de l’exportation des notes de frais vers Sage Intacct.",
        values: {
          ...
          [CONST.SAGE_INTACCT_EXPORT_DATE.EXPORTED]: {
            label: "Date d’exportation",
            description:
              "Date à laquelle la note de frais a été exportée vers Sage Intacct.",
          },
      ...
      reimbursableExpenses: {
        description:
          "Définissez comment les dépenses payées de votre poche sont exportées vers Sage Intacct.",
        values: {
      ...
      nonReimbursableExpenses: {
        description:
          "Définissez comment les achats par carte d’entreprise sont exportés vers Sage Intacct.",
        values: {
      ...
      exportDescription:
        "Configurez comment les données Expensify sont exportées vers Sage Intacct.",
      ...
      exportPreferredExporterSubNote:
        "Une fois défini, l’exportateur préféré verra les notes de frais à exporter dans son compte.",
      noAccountsFound: "Aucun compte trouvé",
      noAccountsFoundDescription: `Veuillez ajouter le compte dans Sage Intacct et synchroniser à nouveau la connexion`,
      autoSync: "Synchronisation automatique",
      autoSyncDescription:
        "Expensify se synchronisera automatiquement avec Sage Intacct chaque jour.",
      inviteEmployees: "Inviter des employés",
      inviteEmployeesDescription:
    ...
    netsuite: {
      ...
      subsidiarySelectDescription:
        "Choisissez la filiale dans NetSuite à partir de laquelle vous souhaitez importer des données.",
      exportDescription:
        "Configurez comment les données Expensify sont exportées vers NetSuite.",
      exportInvoices: "Exporter les factures vers",
      journalEntriesTaxPostingAccount:
        "Compte de comptabilisation de taxe des écritures de journal",
      journalEntriesProvTaxPostingAccount:
        "Compte de comptabilisation de la taxe provinciale des écritures de journal",
      ...
      nonReimbursableJournalPostingAccount:
        "Compte de saisie des écritures non remboursables",
      reimbursableJournalPostingAccount:
        "Compte de comptabilisation des écritures remboursables",
      journalPostingPreference: {
        ...
        values: {
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            ...
            "Saisie unique et détaillée pour chaque note de frais",
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            .JOURNALS_POSTING_TOTAL_LINE]:
            "Une seule entrée pour chaque dépense",
        },
      },
      invoiceItem: {
        ...
        values: {
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
            ...
            description:
              "Nous créerons un « poste de facture Expensify » pour vous lors de l’export (s’il n’en existe pas déjà un).",
          },
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.SELECT]: {
            label: "Sélectionner un existant",
            description:
              "Nous associerons les factures d’Expensify à l’élément sélectionné ci-dessous.",
          },
        },
      },
      exportDate: {
        label: "Date d’exportation",
        description:
          "Utiliser cette date lors de l’exportation des notes de frais vers NetSuite.",
        values: {
          ...
          [CONST.NETSUITE_EXPORT_DATE.EXPORTED]: {
            label: "Date d’exportation",
            description:
              "Date à laquelle la note de frais a été exportée vers NetSuite.",
          },
        ...
        values: {
          [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
            ...
            reimbursableDescription:
              "Les dépenses payées de votre poche seront exportées sous forme de notes de frais vers NetSuite.",
            nonReimbursableDescription:
              "Les dépenses de carte d’entreprise seront exportées en notes de frais vers NetSuite.",
          },
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify se synchronisera automatiquement avec NetSuite chaque jour.",
        reimbursedReportsDescription:
        ...
        reimbursementsAccountDescription:
          "Choisissez le compte bancaire que vous utiliserez pour les remboursements, et nous créerons le paiement associé dans NetSuite.",
        ...
        exportVendorBillsTo: {
          ...
          values: {
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVED_NONE]: "Préférence NetSuite par défaut",
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVAL_PENDING]: "En attente d’approbation",
        ...
        error: {
          customFormID:
            "Veuillez saisir un ID de formulaire personnalisé numérique valide",
        },
      },
      noAccountsFound: "Aucun compte trouvé",
      noAccountsFoundDescription:
        "Veuillez ajouter le compte dans NetSuite et synchroniser à nouveau la connexion",
      noVendorsFound: "Aucun fournisseur trouvé",
      noVendorsFoundDescription:
        "Veuillez ajouter des fournisseurs dans NetSuite et synchroniser à nouveau la connexion",
      noItemsFound: "Aucun article de facture trouvé",
      noItemsFoundDescription:
        "Veuillez ajouter des éléments de facture dans NetSuite et synchroniser à nouveau la connexion",
      noSubsidiariesFound: "Aucune filiale trouvée",
      noSubsidiariesFoundDescription:
        "Veuillez ajouter une filiale dans NetSuite et synchroniser à nouveau la connexion",
      tokenInput: {
        ...
        formSteps: {
          installBundle: {
            ...
            description:
              "Dans NetSuite, allez dans *Customization > SuiteBundler > Search & Install Bundles* > recherchez « Expensify » > installez le bundle.",
          },
          enableTokenAuthentication: {
            title: "Activer l’authentification basée sur les jetons",
            description:
              "Dans NetSuite, accédez à *Setup > Company > Enable Features > SuiteCloud* > activez *token-based authentication*.",
          },
          enableSoapServices: {
            title: "Activer les services Web SOAP",
            description:
              "Dans NetSuite, allez dans *Setup > Company > Enable Features > SuiteCloud* et activez *SOAP Web Services*.",
          },
          createAccessToken: {
          ...
          enterCredentials: {
            ...
            netSuiteAccountIDDescription:
              "Dans NetSuite, accédez à *Setup > Integration > SOAP Web Services Preferences*.",
          },
        },
      },
      import: {
        ...
        expenseCategoriesDescription:
          "Vos catégories de dépenses NetSuite seront importées dans Expensify en tant que catégories.",
        crossSubsidiaryCustomers: "Clients/projets inter-filiales",
        importFields: {
          departments: {
            title: "Services",
            subtitle:
              "Choisissez comment gérer les *départements* NetSuite dans Expensify.",
          },
          classes: {
            title: "Cours",
          ...
          locations: {
            title: "Lieux",
            subtitle:
              "Choisissez comment gérer les *emplacements* dans Expensify.",
          },
        },
        customersOrJobs: {
          title: "Clients/projets",
          subtitle:
            "Choisissez comment gérer les *clients* et les *projets* NetSuite dans Expensify.",
          importCustomers: "Importer des clients",
          importJobs: "Importer des projets",
          customers: "clients",
          jobs: "projets",
          label: (importFields: string[], importType: string) =>
            `${importFields.join("et")}, ${importType}`,
        },
        ...
        importCustomFields: {
          ...
          label: (importedTypes: string[]) =>
            `Importé en tant que ${importedTypes.join("et")}`,
          requiredFieldError: (fieldName: string) =>
            `Veuillez saisir le ${fieldName}`,
          customSegments: {
            ...
            helpText:
              "sur la configuration de segments/enregistrements personnalisés.",
            emptyTitle:
              "Ajouter un segment personnalisé ou un enregistrement personnalisé",
            fields: {
              segmentName: "Nom",
            ...
            removePrompt:
              "Voulez-vous vraiment supprimer ce segment/enregistrement personnalisé ?",
            addForm: {
              ...
              segmentRecordType:
                "Voulez-vous ajouter un segment personnalisé ou un enregistrement personnalisé ?",
              customSegmentNameTitle:
                "Quel est le nom du segment personnalisé ?",
              customRecordNameTitle:
                "Quel est le nom de l’enregistrement personnalisé ?",
...
_Pour des instructions plus détaillées, [consultez notre site d’aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
              customRecordScriptIDTitle:
                "Quel est l’ID de la colonne de transaction ?",
...
_Pour des instructions plus détaillées, [visitez notre site d’aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})._`,
              customSegmentMappingTitle:
                "Comment ce segment personnalisé doit-il être affiché dans Expensify ?",
              customRecordMappingTitle:
                "Comment cet enregistrement personnalisé doit-il être affiché dans Expensify ?",
            },
            errors: {
              uniqueFieldError: (fieldName: string) =>
                `Un segment/enregistrement personnalisé avec ce ${fieldName?.toLowerCase()} existe déjà`,
            },
          },
          customLists: {
            ...
            removePrompt:
              "Voulez-vous vraiment supprimer cette liste personnalisée ?",
            addForm: {
              listNameTitle: "Choisir une liste personnalisée",
              transactionFieldIDTitle:
                "Quel est l’ID du champ de transaction ?",
...
_Pour des instructions plus détaillées, [visitez notre site d’aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
              mappingTitle:
                "Comment cette liste personnalisée doit-elle être affichée dans Expensify ?",
            },
            errors: {
        ...
        importTypes: {
          ...
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
            ...
            footerContent: (importField: string) =>
              `${startCase(importField)} sera sélectionnable pour chaque dépense individuelle sur la note de frais de l’employé.`,
          },
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
            label: "Champs de note de frais",
            description: "Niveau de la note de frais",
            footerContent: (importField: string) =>
              `La sélection ${startCase(importField)} s’appliquera à toutes les dépenses sur la note de frais d’un employé.`,
          },
        },
      },
    },
    intacct: {
      ...
      downloadExpensifyPackage:
        "Télécharger le package Expensify pour Sage Intacct",
      followSteps:
        "Suivez les étapes de notre tutoriel : Comment se connecter à Sage Intacct",
      ...
      employeeDefaultDescription:
        "Le service par défaut de l’employé sera appliqué à ses dépenses dans Sage Intacct s’il en existe un.",
      displayedAsTagDescription:
        "Le service pourra être sélectionné pour chaque dépense individuelle sur la note de frais d’un employé.",
      displayedAsReportFieldDescription:
        "La sélection de département sera appliquée à toutes les dépenses sur la note de frais d’un employé.",
      toggleImportTitle: (mappingTitle: string) =>
        `Choisissez comment gérer Sage Intacct <strong>${mappingTitle}</strong> dans Expensify.`,
      expenseTypes: "Types de dépenses",
      expenseTypesDescription:
        "Vos types de dépenses Sage Intacct seront importés dans Expensify en tant que catégories.",
      accountTypesDescription:
        "Votre plan comptable Sage Intacct sera importé dans Expensify en tant que catégories.",
      importTaxDescription:
        "Importer le taux de taxe sur les achats depuis Sage Intacct.",
      userDefinedDimensions: "Dimensions définies par l’utilisateur",
      addUserDefinedDimension:
        "Ajouter une dimension définie par l’utilisateur",
    ...
    companyCards: {
      ...
      error: {
        workspaceFeedsCouldNotBeLoadedTitle:
          "Impossible de charger les flux de cartes",
        ...
        feedCouldNotBeLoadedMessage:
          "Une erreur s’est produite lors du chargement de ce flux. Veuillez réessayer ou contacter votre administrateur.",
        tryAgain: "Réessayer",
      },
      addNewCard: {
        other: "Autre",
        ...
        howDoYouWantToConnect:
          "Comment souhaitez-vous vous connecter à votre banque ?",
        ...
        directFeedDetails:
          "L’approche la plus simple. Connectez-vous immédiatement en utilisant vos identifiants principaux. Cette méthode est la plus courante.",
        enableFeed: {
...
3. Une fois le flux activé, cliquez sur Soumettre ci-dessous et nous nous chargerons de l’ajouter.`,
        ...
        amexCorporate:
          "Sélectionnez ceci si le recto de vos cartes indique « Corporate »",
        amexBusiness:
          "Sélectionnez ceci si le recto de vos cartes indique « Business »",
        amexPersonal: "Sélectionnez ceci si vos cartes sont personnelles",
        error: {
          pleaseSelectProvider:
            "Veuillez sélectionner un fournisseur de carte avant de continuer",
          pleaseSelectBankAccount:
            "Veuillez sélectionner un compte bancaire avant de continuer",
          pleaseSelectBank:
            "Veuillez sélectionner une banque avant de continuer",
          pleaseSelectCountry:
            "Veuillez sélectionner un pays avant de continuer",
          pleaseSelectFeedType:
            "Veuillez sélectionner un type de flux avant de continuer",
        },
        exitModal: {
          title: "Quelque chose ne fonctionne pas ?",
          prompt:
            "Nous avons remarqué que vous n’aviez pas fini d’ajouter vos cartes. Si vous avez rencontré un problème, dites-le-nous afin que nous puissions vous aider à tout remettre sur les rails.",
      ...
      startDateDescription:
        "Choisissez votre date de début d’importation. Nous synchroniserons toutes les transactions à partir de cette date.",
      ...
      confirmationDescription:
        "Nous allons commencer à importer les transactions immédiatement.",
      card: "Carte",
      ...
      assignedCard: (assignee: string, link: string) =>
        `a assigné ${assignee} à ${link} ! Les transactions importées apparaîtront dans cette discussion.`,
      ...
      unassignCardFailedError:
        "L’annulation de l’assignation de la carte a échoué.",
      cardAlreadyAssignedError:
        "Cette carte est déjà assignée à un utilisateur dans un autre espace de travail.",
      importTransactions: {
        title: "Importer des transactions depuis un fichier",
        description:
          "Veuillez ajuster les paramètres de votre fichier qui seront appliqués lors de l’importation.",
    ...
    expensifyCard: {
      ...
      getStartedIssuing:
        "Commencez par émettre votre première carte virtuelle ou physique.",
      verificationInProgress: "Vérification en cours...",
      verifyingTheDetails:
        "Nous vérifions quelques détails. Concierge vous informera lorsque les Cartes Expensify seront prêtes à être émises.",
      disclaimer:
      ...
      currentBalanceDescription:
        "Le solde actuel est la somme de toutes les transactions Carte Expensify comptabilisées depuis la dernière date de règlement.",
      balanceWillBeSettledOn: (settlementDate: string) =>
        `Le solde sera réglé le ${settlementDate}`,
      ...
      earnedCashbackDescription:
        "Le solde de remise en argent est basé sur les dépenses mensuelles réglées effectuées avec la Carte Expensify dans votre espace de travail.",
      issueNewCard: "Émettre une nouvelle carte",
      finishSetup: "Terminer la configuration",
      chooseBankAccount: "Choisir un compte bancaire",
      chooseExistingBank:
        "Choisissez un compte bancaire professionnel existant pour régler le solde de votre Carte Expensify ou ajoutez un nouveau compte bancaire",
      accountEndingIn: "Compte se terminant par",
      addNewBankAccount: "Ajouter un nouveau compte bancaire",
      settlementAccount: "Compte de règlement",
      settlementAccountDescription:
        "Choisissez un compte pour payer le solde de votre Carte Expensify.",
      ...
      cardPending: ({ name }: { name: string }) =>
        `La carte est actuellement en attente et sera émise une fois le compte de ${name} validé.`,
      virtual: "Virtuelle",
      physical: "Physique",
      ...
      fixedLimitWarning: (limit: number | string) =>
        `Si vous modifiez le plafond de cette carte à ${limit}, les nouvelles transactions seront refusées.`,
      ...
      issuedCard: (assignee: string) =>
        `a émis une Carte Expensify à ${assignee} ! La carte arrivera dans 2 à 3 jours ouvrés.`,
      ...
      issuedCardVirtual: (assignee: string, link: string) =>
        `a attribué une Carte Expensify virtuelle à ${assignee} ! Le ${link} peut être utilisé immédiatement.`,
      addedShippingDetails: (assignee: string) =>
        `${assignee} a ajouté les informations de livraison. La Carte Expensify arrivera sous 2 à 3 jours ouvrés.`,
      replacedCard: (assignee: string) =>
        `${assignee} a remplacé sa Carte Expensify. La nouvelle carte arrivera sous 2 à 3 jours ouvrés.`,
      replacedVirtualCard: (assignee: string, link: string) =>
        `${assignee} a remplacé sa Carte Expensify virtuelle ! Le ${link} peut être utilisé immédiatement.`,
      card: "carte",
      ...
      verifyingBankAccountDescription:
        "Veuillez patienter pendant que nous confirmons que ce compte peut être utilisé pour émettre des Cartes Expensify.",
      bankAccountVerified: "Compte bancaire vérifié !",
      bankAccountVerifiedDescription:
        "Vous pouvez maintenant émettre des Cartes Expensify aux membres de votre espace de travail.",
      oneMoreStep: "Encore une étape…",
      oneMoreStepDescription:
        "Il semble que nous devions vérifier votre compte bancaire manuellement. Rendez-vous dans Concierge, où vos instructions vous attendent.",
      gotIt: "Compris",
    ...
    categories: {
      ...
      spendCategoriesDescription:
        "Personnalisez la façon dont les dépenses des commerçants sont catégorisées pour les transactions par carte de crédit et les reçus numérisés.",
      ...
      subtitle:
        "Obtenez une meilleure vue d’ensemble de l’endroit où l’argent est dépensé. Utilisez nos catégories par défaut ou ajoutez les vôtres.",
      emptyCategories: {
      ...
      createFailureMessage:
        "Une erreur s’est produite lors de la création de la catégorie, veuillez réessayer.",
      ...
      importedFromAccountingSoftware:
        "Les catégories ci-dessous sont importées depuis votre",
      payrollCode: "Code de paie",
      updatePayrollCodeFailureMessage:
        "Une erreur s’est produite lors de la mise à jour du code de paie, veuillez réessayer",
      glCode: "Code de grand livre",
      updateGLCodeFailureMessage:
        "Une erreur s'est produite lors de la mise à jour du code GL, veuillez réessayer.",
    ...
    moreFeatures: {
      ...
      spendSection: {
        title: "Dépense",
        subtitle:
          "Activez des fonctionnalités qui vous aident à faire grandir votre équipe.",
      },
      manageSection: {
        title: "Gérer",
        subtitle:
          "Ajoutez des contrôles qui aident à maintenir les dépenses dans les limites du budget.",
      },
      earnSection: {
        title: "Gagner",
      ...
      organizeSection: {
        title: "Organiser",
        subtitle:
          "Regroupez et analysez les dépenses, enregistrez chaque taxe payée.",
      },
      integrateSection: {
        title: "Intégrer",
      ...
      perDiem: {
        title: "Indemnité journalière",
        subtitle:
          "Définissez des indemnités journalières pour contrôler les dépenses quotidiennes des employés.",
      },
      travel: {
        title: "Déplacements",
        subtitle:
          "Réservez, gérez et rapprochez tous vos déplacements professionnels.",
        getStarted: {
          title: "Commencez avec Expensify Travel",
          subtitle:
            "Nous avons simplement besoin de quelques informations supplémentaires sur votre entreprise, puis vous serez prêt à décoller.",
          ctaText: "C’est parti",
        },
        reviewingRequest: {
          title: "Faites vos valises, nous avons bien reçu votre demande...",
          subtitle:
            "Nous examinons actuellement votre demande d’activation d’Expensify Travel. Ne vous inquiétez pas, nous vous informerons lorsqu’il sera prêt.",
          ctaText: "Demande envoyée",
        },
        bookOrManageYourTrip: {
          title: "Réservation de voyage",
          subtitle:
            "Félicitations ! Vous êtes prêt à réserver et gérer des voyages dans cet espace de travail.",
        ...
        settings: {
          autoAddTripName: {
            ...
            subtitle:
              "Ajouter automatiquement les noms de voyage aux descriptions des dépenses pour les voyages réservés dans Expensify.",
          },
        },
        travelInvoicing: {
          travelBookingSection: {
            title: "Réservation de voyage",
            subtitle:
              "Félicitations ! Vous êtes prêt à réserver et gérer des voyages sur cet espace de travail.",
            manageTravelLabel: "Gérer les déplacements",
          },
          centralInvoicingSection: {
            title: "Facturation centralisée",
            subtitle:
              "Centralisez toutes les dépenses de voyage dans une facture mensuelle au lieu de payer au moment de l’achat.",
        ...
        personalDetailsDescription:
          "Pour pouvoir réserver un voyage, veuillez saisir votre nom légal tel qu’il apparaît sur votre pièce d’identité délivrée par le gouvernement.",
      },
      expensifyCard: {
        ...
        disableCardPrompt:
          "Vous ne pouvez pas désactiver la Carte Expensify car elle est déjà en cours d’utilisation. Contactez Concierge pour connaître les prochaines étapes.",
        disableCardButton: "Discuter avec Concierge",
        feed: {
          title: "Obtenir la Carte Expensify",
          subTitle:
            "Rationalisez les dépenses de votre entreprise et économisez jusqu’à 50 % sur votre facture Expensify, plus :",
          features: {
      ...
      companyCards: {
        ...
        feed: {
          ...
          subtitle:
            "Liez les cartes que vous avez déjà pour l’importation automatique des transactions, la correspondance des reçus et la réconciliation.",
          features: {
            support: "Connectez des cartes de plus de 10 000 banques",
            assignCards: "Liez les cartes existantes de votre équipe",
            automaticImport:
              "Nous importerons automatiquement les transactions",
          },
        },
        ...
        integrationExport: (integration: string, type?: string) =>
          integration && type
            ? `exportation ${integration} ${type.toLowerCase()}`
            : `Export ${integration}`,
        ...
        unassignCardDescription:
          "Retirer l'assignation de cette carte supprimera toutes les transactions non soumises.",
        removeCard: "Supprimer la carte",
        remove: "Supprimer",
        removeCardDescription:
          "La suppression de cette carte effacera toutes les transactions non soumises.",
        assignCard: "Assigner une carte",
        cardFeedName: "Nom du flux de carte",
        cardFeedNameDescription:
          "Donnez au flux de carte un nom unique afin de pouvoir le distinguer des autres.",
        cardFeedTransaction: "Supprimer les transactions",
        cardFeedTransactionDescription:
          "Choisissez si les titulaires de carte peuvent supprimer des transactions de carte. Les nouvelles transactions suivront ces règles.",
        cardFeedRestrictDeletingTransaction:
          "Restreindre la suppression des transactions",
        cardFeedAllowDeletingTransaction:
          "Autoriser la suppression des transactions",
        removeCardFeed: "Supprimer le flux de cartes",
        removeCardFeedTitle: (feedName: string) =>
          `Supprimer le flux ${feedName}`,
        removeCardFeedDescription:
          "Voulez-vous vraiment supprimer ce flux de cartes ? Cela retirera l'assignation de toutes les cartes.",
        error: {
          feedNameRequired: "Le nom du flux de carte est obligatoire",
          statementCloseDateRequired:
            "Veuillez sélectionner une date de clôture de relevé.",
        },
        ...
        setFeedNameDescription:
          "Donnez au flux de cartes un nom unique afin de pouvoir le distinguer des autres",
        ...
        emptyAddedFeedDescription:
          "Assurez-vous qu’il y a des cartes dans le flux de cartes de votre banque.",
        ...
        giveItNameInstruction:
          "Donnez à la carte un nom qui la distingue des autres.",
        ...
        noAccountsFoundDescription: (connection: string) =>
          `Veuillez ajouter le compte dans ${connection} et synchroniser à nouveau la connexion`,
        ...
        statementCloseDateDescription:
          "Indiquez-nous la date de clôture de votre relevé de carte, et nous créerons un relevé correspondant dans Expensify.",
      },
      workflows: {
        title: "Workflows",
      ...
      connectionsWarningModal: {
        ...
        featureEnabledText:
          "Pour activer ou désactiver cette fonctionnalité, vous devez modifier vos paramètres d’import comptable.",
        disconnectText:
          "Pour désactiver la comptabilité, vous devez déconnecter votre connexion comptable de votre espace de travail.",
        manageSettings: "Gérer les paramètres",
      },
      receiptPartnersWarningModal: {
        featureEnabledTitle: "Dissocier Uber",
        disconnectText:
          "Pour désactiver cette fonctionnalité, veuillez d’abord déconnecter l’intégration Uber for Business.",
      ...
      rules: {
        title: "Règles",
        subtitle:
          "Rendez les reçus obligatoires, signalez les dépenses élevées et plus encore.",
      },
      timeTracking: {
        title: "Heure",
        subtitle:
          "Définissez un taux horaire facturable pour le suivi du temps.",
    ...
    reports: {
      ...
      customNameEmailPhoneExample:
        "E-mail ou téléphone du membre : {report:submit:from}",
      customNameStartDateExample:
        "Date de début de la note de frais : {report:startdate}",
      customNameWorkspaceNameExample:
        "Nom de l'espace de travail : {report:workspacename}",
      customNameReportIDExample: "ID de la note de frais : {report:id}",
      customNameTotalExample: "Total : {report:total}.",
      preventMembersFromChangingCustomNamesTitle:
        "Empêcher les membres de modifier les titres personnalisés des notes de frais",
    },
    reportFields: {
      ...
      deleteConfirmation:
        "Voulez-vous vraiment supprimer ce champ de note de frais ?",
      deleteFieldsConfirmation:
        "Voulez-vous vraiment supprimer ces champs de note de frais ?",
      emptyReportFields: {
        title: "Vous n’avez créé aucun champ de note de frais",
        subtitle:
          "Ajoutez un champ personnalisé (texte, date ou liste déroulante) qui apparaît sur les notes de frais.",
      },
      subtitle:
        "Les champs de note de frais s’appliquent à toutes les dépenses et peuvent être utiles lorsque vous souhaitez demander des informations supplémentaires.",
      disableReportFields: "Désactiver les champs de note de frais",
      disableReportFieldsConfirmation:
        "Êtes-vous sûr(e) ? Les champs de texte et de date seront supprimés, et les listes seront désactivées.",
      importedFromAccountingSoftware:
        "Les champs de note de frais ci-dessous sont importés depuis votre",
      textType: "Texte",
      dateType: "Date",
      dropdownType: "Liste",
      formulaType: "Formule",
      ...
      dropdownAlternateText:
        "Ajoutez une liste d’options parmi lesquelles choisir.",
      formulaAlternateText: "Ajouter un champ de formule.",
      nameInputSubtitle: "Choisissez un nom pour le champ de note de frais.",
      typeInputSubtitle:
        "Choisissez le type de champ de note de frais à utiliser.",
      initialValueInputSubtitle:
        "Saisissez une valeur de départ à afficher dans le champ de la note de frais.",
      listValuesInputSubtitle:
        "Ces valeurs apparaîtront dans la liste déroulante de vos champs de note de frais. Les valeurs activées peuvent être sélectionnées par les membres.",
      listInputSubtitle:
        "Ces valeurs apparaîtront dans la liste des champs de votre note de frais. Les valeurs activées peuvent être sélectionnées par les membres.",
      ...
      emptyReportFieldsValues: {
        ...
        subtitle:
          "Ajoutez des valeurs personnalisées à faire apparaître sur les notes de frais.",
      },
      deleteValuePrompt:
        "Voulez-vous vraiment supprimer cette valeur de liste ?",
      deleteValuesPrompt:
        "Voulez-vous vraiment supprimer ces valeurs de liste ?",
      ...
      existingReportFieldNameError:
        "Un champ de note de frais portant ce nom existe déjà",
      reportFieldNameRequiredError:
        "Veuillez saisir un nom de champ de note de frais",
      reportFieldTypeRequiredError:
        "Veuillez choisir un type de champ de note de frais",
      circularReferenceError:
        "Ce champ ne peut pas faire référence à lui-même. Veuillez le mettre à jour.",
      reportFieldInitialValueRequiredError:
        "Veuillez choisir une valeur initiale pour le champ de note de frais",
      genericFailureMessage:
        "Une erreur s’est produite lors de la mise à jour du champ de note de frais. Veuillez réessayer.",
    },
    tags: {
      tagName: "Nom du tag",
      ...
      subtitle:
        "Les tags ajoutent des moyens plus détaillés de classer les coûts.",
      ...
      emptyTags: {
        ...
        subtitle:
          "Ajoutez un tag pour suivre les projets, les lieux, les services et plus encore.",
      ...
      deleteFailureMessage:
        "Une erreur s’est produite lors de la suppression du tag, veuillez réessayer",
      tagRequiredError: "Le nom du tag est obligatoire",
      existingTagError: "Un tag portant ce nom existe déjà",
      invalidTagNameError:
        "Le nom du tag ne peut pas être 0. Veuillez choisir une autre valeur.",
      genericFailureMessage:
        "Une erreur s’est produite lors de la mise à jour du tag, veuillez réessayer",
      ...
      importTagsSupportingText:
        "Codez vos dépenses avec un seul type de tag ou plusieurs.",
      configureMultiLevelTags:
        "Configurez votre liste de tags pour le multi-niveau.",
      ...
      cannotMakeTagListRequired: {
        ...
        description:
          "Vous pouvez uniquement rendre une liste de tags obligatoire si votre politique comporte plusieurs niveaux de tags configurés.",
      },
      tagCount: () => ({
        one: "1 tag",
    ...
    taxes: {
      subtitle:
        "Ajoutez des noms de taxes, des taux et définissez des valeurs par défaut.",
      ...
      error: {
        ...
        valuePercentageRange:
          "Veuillez saisir un pourcentage valide entre 0 et 100",
        customNameRequired: "Le nom de taxe personnalisé est obligatoire",
        deleteFailureMessage:
          "Une erreur s'est produite lors de la suppression du taux de taxe. Veuillez réessayer ou demander de l'aide à Concierge.",
        updateFailureMessage:
          "Une erreur s’est produite lors de la mise à jour du taux de taxe. Veuillez réessayer ou demander de l’aide à Concierge.",
        createFailureMessage:
          "Une erreur s’est produite lors de la création du taux de taxe. Veuillez réessayer ou demander de l’aide à Concierge.",
        updateTaxClaimableFailureMessage:
          "La partie récupérable doit être inférieure au montant du taux kilométrique",
      },
      deleteTaxConfirmation: "Voulez-vous vraiment supprimer cette taxe ?",
      deleteMultipleTaxConfirmation: (taxAmount: number) =>
        `Voulez-vous vraiment supprimer les taxes ${taxAmount} ?`,
      actions: {
      ...
      importedFromAccountingSoftware:
        "Les taxes ci-dessous sont importées depuis votre",
      taxCode: "Code fiscal",
      updateTaxCodeFailureMessage:
        "Une erreur s’est produite lors de la mise à jour du code de taxe, veuillez réessayer",
    },
    duplicateWorkspace: {
      title: "Nommez votre nouvel espace de travail",
      selectFeatures: "Sélectionnez les fonctionnalités à copier",
      whichFeatures:
        "Quelles fonctionnalités voulez-vous copier dans votre nouvel espace de travail ?",
      ...
      error:
        "Une erreur s’est produite lors de la duplication de votre nouvel espace de travail. Veuillez réessayer.",
    },
    emptyWorkspace: {
      title: "Vous n’avez aucun espace de travail",
      subtitle:
        "Suivez les reçus, remboursez les dépenses, gérez les voyages, envoyez des factures, et plus encore.",
      ...
      description:
        "Les salons sont un excellent endroit pour discuter et travailler avec plusieurs personnes. Pour commencer à collaborer, créez ou rejoignez un espace de travail",
    },
    new: {
      ...
      myGroupWorkspace: ({ workspaceNumber }: { workspaceNumber?: number }) =>
        `Mon espace de travail de groupe${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
      workspaceName: (userName: string, workspaceNumber?: number) =>
        `Espace de travail de ${userName}${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
    },
    people: {
      genericFailureMessage:
        "Une erreur s'est produite lors de la suppression d'un membre de l'espace de travail, veuillez réessayer.",
      ...
      removeMemberPrompt: (memberName: string) =>
        `Voulez-vous vraiment supprimer ${memberName} ?`,
      ...
      error: {
        genericAdd:
          "Un problème est survenu lors de l’ajout de ce membre de l’espace de travail",
        cannotRemove:
          "Vous ne pouvez pas vous supprimer vous-même ni supprimer le responsable de l’espace de travail",
        genericRemove:
          "Un problème est survenu lors de la suppression de ce membre de l’espace de travail",
      },
      addedWithPrimary:
        "Certains membres ont été ajoutés avec leurs identifiants principaux.",
      invitedBySecondaryLogin: (secondaryLogin: string) =>
        `Ajouté par la connexion secondaire ${secondaryLogin}.`,
      workspaceMembersCount: ({ count }: WorkspaceMembersCountParams) =>
        `Nombre total de membres de l'espace de travail : ${count}`,
    ...
    card: {
      ...
      issueNewCard: {
        ...
        smartLimitDescription:
          "Dépenser jusqu’à un certain montant avant de nécessiter une approbation",
        monthly: "Mensuel",
        monthlyDescription: "Dépenser jusqu’à un certain montant par mois",
        fixedAmount: "Montant fixe",
        fixedAmountDescription:
          "Dépenser jusqu’à un certain montant une seule fois",
        setLimit: "Définir une limite",
        cardLimitError: "Veuillez saisir un montant inférieur à 21 474 836 $",
        giveItName: "Donnez-lui un nom",
        giveItNameInstruction:
          "Rendez-le suffisamment unique pour le distinguer des autres cartes. Des cas d’utilisation spécifiques, c’est encore mieux !",
        cardName: "Nom de la carte",
        letsDoubleCheck: "Vérifions une dernière fois que tout est correct.",
        willBeReadyToUse:
          "Cette carte sera prête à être utilisée immédiatement.",
        willBeReadyToShip:
          "Cette carte sera prête à être expédiée immédiatement.",
        cardholder: "Titulaire de la carte",
        ...
        validFromTo: ({
          ...
          startDate: string;
          endDate: string;
        }) => `Valide du ${startDate} au ${endDate}`,
        ...
        combineWithExpiration:
          "Combiner avec les options d’expiration pour un contrôle des dépenses supplémentaire",
        ...
        setExpiryDateDescription:
          "La carte expirera comme indiqué sur la carte",
        amount: "Montant",
      },
      deactivateCardModal: {
        ...
        deactivateConfirmation:
          "La désactivation de cette carte entraînera le refus de toutes les futures transactions et est irréversible.",
      },
    },
    accounting: {
      settings: "paramètres",
      ...
      talkYourOnboardingSpecialist:
        "Discutez avec votre spécialiste de configuration.",
      ...
      goToODToSettings:
        "Accédez à Expensify Classic pour gérer vos paramètres.",
      setup: "Connecter",
      lastSync: (relativeDate: string) =>
        `Dernière synchronisation ${relativeDate}`,
      ...
      connectTitle: ({ connectionName }: ConnectionNameParams) =>
        `Connecter ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName] ?? "intégration comptable"}`,
      ...
      importTypes: {
        ...
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]:
          "Importé en tant que champs de note de frais",
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]:
          "Par défaut employé NetSuite",
      },
      disconnectPrompt: ({
        connectionName,
      }: OptionalParam<ConnectionNameParams> = {}) => {
      ...
      exportCompanyCard:
        "Exporter les dépenses de carte d’entreprise en tant que",
      exportDate: "Date d’exportation",
      defaultVendor: "Fournisseur par défaut",
      autoSync: "Synchronisation automatique",
      autoSyncDescription:
        "Synchronisez automatiquement NetSuite et Expensify, chaque jour. Exportez les notes de frais finalisées en temps réel",
      ...
      chooseReconciliationAccount: {
        chooseBankAccount:
          "Choisissez le compte bancaire avec lequel les paiements de votre Carte Expensify seront rapprochés.",
    ...
    invoices: {
      ...
      bankAccountsSubtitle:
        "Ajoutez un compte bancaire pour effectuer et recevoir des paiements de factures.",
    },
    invite: {
      ...
      genericFailureMessage:
        "Une erreur s’est produite lors de l’invitation du membre à l’espace de travail. Veuillez réessayer.",
    ...
    inviteMessage: {
      confirmDetails: "Confirmer les détails",
      inviteMessagePrompt:
        "Rendez votre invitation encore plus spéciale en ajoutant un message ci-dessous !",
      personalMessagePrompt: "Message",
      genericFailureMessage:
        "Une erreur s’est produite lors de l’invitation du membre à l’espace de travail. Veuillez réessayer.",
      inviteNoMembersError:
        "Veuillez sélectionner au moins un membre à inviter",
      joinRequest: ({
        user,
        workspaceName,
      }: {
        user: string;
        workspaceName: string;
      }) => `${user} a demandé à rejoindre ${workspaceName}`,
    },
    distanceRates: {
      oopsNotSoFast: "Oups ! Pas si vite...",
      workspaceNeeds:
        "Un espace de travail doit avoir au moins un taux de distance activé.",
      distance: "Distance",
      centrallyManage:
        "Gérez les taux de manière centralisée, suivez en miles ou en kilomètres et définissez une catégorie par défaut.",
      rate: "Taux",
      addRate: "Ajouter un taux",
    ...
    editor: {
      ...
      nameInputHelpText:
        "C’est le nom que vous verrez sur votre espace de travail.",
      ...
      currencyInputHelpText:
        "Toutes les dépenses dans cet espace de travail seront converties dans cette devise.",
      ...
      save: "Enregistrer",
      genericFailureMessage:
        "Une erreur s’est produite lors de la mise à jour de l’espace de travail. Veuillez réessayer.",
      avatarUploadFailureMessage:
        "Une erreur s’est produite lors du téléchargement de l’avatar. Veuillez réessayer.",
      addressContext:
        "Une adresse d’espace de travail est requise pour activer Expensify Travel. Veuillez saisir une adresse associée à votre entreprise.",
    ...
    bankAccount: {
      ...
      connectBankAccountNote:
        "Remarque : les comptes bancaires personnels ne peuvent pas être utilisés pour les paiements dans les espaces de travail.",
      oneMoreThing: "Encore une chose !",
      allSet: "Tout est prêt !",
      accountDescriptionWithCards:
        "Ce compte bancaire sera utilisé pour émettre des cartes d’entreprise, rembourser des dépenses, encaisser des factures et payer des notes.",
      ...
      clearProgress:
        "Recommencer effacera les progrès que vous avez réalisés jusqu’ici.",
      areYouSure: "Êtes-vous sûr ?",
      ...
      workspaceCurrencyNotSupported:
        "Devise de l'espace de travail non prise en charge",
      ...
      chooseAnExisting:
        "Choisissez un compte bancaire existant pour payer les dépenses ou ajoutez-en un nouveau.",
    },
    changeOwner: {
      changeOwnerPageTitle: "Transférer le responsable",
      addPaymentCardTitle:
        "Saisissez votre carte de paiement pour transférer la propriété",
      addPaymentCardButtonText:
        "Accepter les conditions et ajouter une carte de paiement",
...
Si vous souhaitez prendre en charge la facturation de l’ensemble de son abonnement, demandez-lui d’abord de vous ajouter comme administrateur à tous ses espaces de travail avant de prendre en charge la facturation.`,
      ...
      failedToClearBalanceText:
        "Nous n’avons pas pu effacer le solde. Veuillez réessayer plus tard.",
      successTitle: "Youpi ! Tout est prêt.",
      successDescription:
        "Vous êtes maintenant le responsable de cet espace de travail.",
...
Voulez-vous vraiment les exporter à nouveau ?`,
    ...
    upgrade: {
      ...
      categories: {
        title: "Catégories",
        description:
          "Les catégories vous permettent de suivre et d’organiser les dépenses. Utilisez nos catégories par défaut ou ajoutez les vôtres.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
...
Rendez obligatoires des informations de dépense comme les reçus et les descriptions, définissez des limites et des valeurs par défaut, et automatisez les approbations et les paiements – le tout en un seul endroit.`,
      ...
      reports: {
        ...
        description:
          "Les notes de frais vous permettent de regrouper les dépenses pour en faciliter le suivi et l’organisation.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      distanceRates: {
        title: "Taux de distance",
        description:
          "Créez et gérez vos propres taux, suivez en miles ou en kilomètres, et définissez des catégories par défaut pour les dépenses de distance.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      auditor: {
        title: "Auditeur",
        description:
          "Les auditeurs obtiennent un accès en lecture seule à toutes les notes de frais pour une visibilité complète et le suivi de la conformité.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      commonFeatures: {
        ...
        benefits: {
          ...
          benefit1:
            "Connexions comptables avancées (NetSuite, Sage Intacct et plus)",
          ...
          selectWorkspace:
            "sélectionnez un espace de travail et modifiez le type de forfait en",
        },
    ...
    downgrade: {
      commonFeatures: {
        ...
        benefits: {
          ...
          confirm:
            "Voulez-vous vraiment rétrograder et supprimer vos configurations ?",
          ...
          selectStep:
            "> sélectionnez chaque espace de travail > modifiez le type d’abonnement en",
        },
      },
      completed: {
        headline: "Votre espace de travail a été rétrogradé",
        description:
          "Vous avez d’autres espaces de travail sur le forfait Control. Pour être facturé au tarif Collect, vous devez rétrograder tous les espaces de travail.",
        gotIt: "Compris, merci",
      },
    },
    payAndDowngrade: {
      ...
      description1: (formattedAmount: string) =>
        `Votre facture finale pour cet abonnement sera de <strong>${formattedAmount}</strong>`,
      ...
      genericFailureMessage:
        "Une erreur s’est produite lors du paiement de votre facture. Veuillez réessayer.",
    },
    restrictedAction: {
      restricted: "Restreint",
      actionsAreCurrentlyRestricted: (workspaceName: string) =>
        `Les actions sur l’espace de travail ${workspaceName} sont actuellement restreintes`,
      ...
      youWillNeedToAddOrUpdatePaymentCard:
        "Vous devez ajouter ou mettre à jour la carte de paiement enregistrée afin de débloquer la nouvelle activité de l’espace de travail.",
      addPaymentCardToUnlock:
        "Ajoutez une carte de paiement pour tout débloquer !",
      addPaymentCardToContinueUsingWorkspace:
        "Ajoutez une carte de paiement pour continuer à utiliser cet espace de travail",
      pleaseReachOutToYourWorkspaceAdmin:
        "Veuillez contacter l’administrateur de votre espace de travail pour toute question.",
    ...
    rules: {
      individualExpenseRules: {
        ...
        receiptRequiredAmountDescription:
          "Exiger des reçus lorsque la dépense dépasse ce montant, sauf si une règle de catégorie le remplace.",
        receiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `Le montant ne peut pas être supérieur au montant requis du reçu détaillé (${amount})`,
        itemizedReceiptRequiredAmount: "Montant nécessitant un reçu détaillé",
        itemizedReceiptRequiredAmountDescription:
          "Exiger des reçus détaillés lorsque la dépense dépasse ce montant, sauf si une règle de catégorie le remplace.",
        itemizedReceiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `Le montant ne peut pas être inférieur au montant requis pour les reçus réguliers (${amount})`,
        maxExpenseAmount: "Montant maximal de la dépense",
        maxExpenseAmountDescription:
          "Signaler les dépenses qui dépassent ce montant, sauf si une règle de catégorie prévaut.",
        maxAge: "Âge maximal",
        maxExpenseAge: "Ancienneté maximale de la dépense",
        maxExpenseAgeDescription:
          "Signaler les dépenses plus anciennes qu’un certain nombre de jours.",
        maxExpenseAgeDays: () => ({
          one: "1 jour",
          other: (count: number) => `${count} jours`,
        }),
        cashExpenseDefault:
          "Paramètres par défaut pour les dépenses en espèces",
        ...
        reimbursableDefaultDescription:
          "Les dépenses sont le plus souvent remboursées aux employés",
        nonReimbursableDefault: "Non remboursable",
        nonReimbursableDefaultDescription:
          "Les dépenses sont occasionnellement remboursées aux employés",
        alwaysReimbursable: "Toujours remboursable",
        alwaysReimbursableDescription:
          "Les dépenses sont toujours remboursées aux employés",
        alwaysNonReimbursable: "Toujours non remboursable",
        alwaysNonReimbursableDescription:
          "Les dépenses ne sont jamais remboursées aux employés",
        ...
        billable: "Facturable",
        billableDescription:
          "Les dépenses sont le plus souvent refacturées aux clients",
        nonBillable: "Non refacturable",
        nonBillableDescription:
          "Les dépenses sont parfois refacturées aux clients",
        eReceipts: "e-reçus",
        ...
        attendeeTrackingHint:
          "Suivez le coût par personne pour chaque dépense.",
        ...
        requireCompanyCard:
          "Exiger l'utilisation de cartes d'entreprise pour tous les achats",
        requireCompanyCardDescription:
          "Signaler toutes les dépenses en espèces, y compris le kilométrage et les indemnités journalières.",
        requireCompanyCardDisabledTooltip:
          "Activez les cartes d’entreprise (dans Plus de fonctionnalités) pour déverrouiller.",
      },
      expenseReportRules: {
        title: "Avancé",
        subtitle:
          "Automatisez la conformité des notes de frais, les approbations et le paiement.",
        preventSelfApprovalsTitle: "Empêcher les auto-approbations",
        preventSelfApprovalsSubtitle:
          "Empêcher les membres de l’espace de travail d’approuver leurs propres notes de frais.",
        autoApproveCompliantReportsTitle:
          "Approuver automatiquement les notes de frais conformes",
        autoApproveCompliantReportsSubtitle:
          "Configurer quelles notes de frais sont éligibles à l’auto-approbation.",
        autoApproveReportsUnderTitle:
          "Approuver automatiquement les notes de frais dont toutes les dépenses sont inférieures à",
        autoApproveReportsUnderDescription:
          "Les notes de frais entièrement conformes dont toutes les dépenses sont en dessous de ce montant seront automatiquement approuvées.",
        randomReportAuditTitle: "Audit aléatoire de notes de frais",
        randomReportAuditDescription:
          "Exiger que certaines notes de frais soient approuvées manuellement, même si elles sont éligibles à l’auto-approbation.",
        autoPayApprovedReportsTitle:
          "Payer automatiquement les notes de frais approuvées",
        autoPayApprovedReportsSubtitle:
          "Configurez quelles notes de frais sont éligibles au paiement automatique.",
        autoPayApprovedReportsLimitError: (currency?: string) =>
          `Veuillez saisir un montant inférieur à ${currency ?? ""}20 000`,
        ...
        autoPayReportsUnderDescription:
          "Les notes de frais entièrement conformes en dessous de ce montant seront payées automatiquement.",
        unlockFeatureEnableWorkflowsSubtitle: (featureName: string) =>
          `Ajoutez ${featureName} pour déverrouiller cette fonctionnalité.`,
      ...
      merchantRules: {
        title: "Commerçant",
        subtitle:
          "Définissez les règles de commerçant pour que les dépenses arrivent correctement codées et nécessitent moins de nettoyage.",
        ...
        previewMatchesEmptyStateSubtitle:
          "Aucune dépense non soumise ne correspond à cette règle.",
        ...
        ruleSummaryTitle: (merchantName: string, isExactMatch: boolean) =>
          `Si le commerçant ${isExactMatch ? "correspond exactement" : "contient"} « ${merchantName} »`,
        ruleSummarySubtitleMerchant: (merchantName: string) =>
          `Renommer le commerçant en « ${merchantName} »`,
        ruleSummarySubtitleUpdateField: (
          fieldName: string,
          fieldValue: string,
        ) => `Mettre à jour ${fieldName} sur « ${fieldValue} »`,
        ruleSummarySubtitleReimbursable: (reimbursable: boolean) =>
          `Marquer comme « ${reimbursable ? "remboursable" : "non remboursable"} »`,
        ruleSummarySubtitleBillable: (billable: boolean) =>
          `Marquer comme « ${billable ? "facturable" : "non refacturable"} »`,
        ...
        duplicateRulePrompt: (merchantName: string) =>
          `Votre règle existante pour « ${merchantName} » aura la priorité sur celle-ci. Enregistrer quand même ?`,
        saveAnyway: "Enregistrer quand même",
        applyToExistingUnsubmittedExpenses:
          "Appliquer aux dépenses non soumises existantes",
      },
      categoryRules: {
        ...
        requiredFieldsDescription: (categoryName: string) =>
          `Cela s’appliquera à toutes les dépenses catégorisées comme <strong>${categoryName}</strong>.`,
        ...
        descriptionHintSubtitle:
          "Astuce de pro : plus c’est court, mieux c’est !",
        ...
        flagAmountsOverDescription: (categoryName: string) =>
          `S’applique à la catégorie « ${categoryName} ».`,
        flagAmountsOverSubtitle:
          "Cela remplace le montant maximal pour toutes les dépenses.",
        expenseLimitTypes: {
          ...
          dailySubtitle:
            "Signaler le montant quotidien total par catégorie pour chaque note de frais.",
        },
        requireReceiptsOver: "Requérir les reçus au-dessus de",
        requireReceiptsOverList: {
          default: (defaultAmount: string) =>
            `${defaultAmount} ${CONST.DOT_SEPARATOR} Par défaut`,
      ...
      customRules: {
        ...
        cardSubtitle:
          "C’est ici que se trouve la politique de dépenses de votre équipe, pour que tout le monde soit d’accord sur ce qui est couvert.",
      },
    },
    planTypePage: {
      planTypes: {
        team: {
          label: "Encaisser",
          description:
            "Pour les équipes qui souhaitent automatiser leurs processus.",
        },
        corporate: {
          label: "Contrôle",
      ...
      description:
        "Choisissez l’offre qui vous convient. Pour une liste détaillée des fonctionnalités et des tarifs, consultez notre",
  ...
  newRoomPage: {
    ...
    restrictedDescription:
      "Les personnes de votre espace de travail peuvent trouver cette salle",
    privateDescription:
      "Les personnes invitées dans cette salle peuvent la trouver",
    ...
    roomNameReservedError: (reservedName: string) =>
      `${reservedName} est un salon par défaut sur tous les espaces de travail. Veuillez choisir un autre nom.`,
    roomNameInvalidError:
      "Les noms de salle peuvent uniquement contenir des lettres minuscules, des chiffres et des tirets",
    ...
    growlMessageOnRenameError:
      "Impossible de renommer la salle de l’espace de travail. Veuillez vérifier votre connexion et réessayer.",
    visibilityOptions: {
  ...
  workspaceActions: {
    ...
    changedCompanyAddress: ({
      ...
      previousAddress
        ? `a modifié l’adresse de l’entreprise en « ${newAddress} » (auparavant « ${previousAddress} »)`
        : `définir l’adresse de l’entreprise sur « ${newAddress} »`,
    addApprovalRule: (
    ...
    deleteCategory: (categoryName: string) =>
      `a supprimé la catégorie « ${categoryName} »`,
    updateCategory: (categoryName: string, oldValue: boolean) =>
      `${oldValue ? "Désactivé" : "Activé"} la catégorie « ${categoryName} »`,
    ...
    setCategoryName: (oldName: string, newName: string) =>
      `a renommé la catégorie « ${oldName} » en « ${newName} »`,
    ...
    updateTagListName: (oldName: string, newName: string) =>
      `a changé le nom de la liste de tags en « ${newName} » (précédemment « ${oldName} »)`,
    addTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `a ajouté le tag « ${tagName} » à la liste « ${tagListName} »`,
    updateTagName: ({
      tagListName,
      newName,
      oldName,
    ...
    deleteTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `a supprimé la balise « ${tagName} » de la liste « ${tagListName} »`,
    deleteMultipleTags: ({ count, tagListName }: UpdatedPolicyTagParams) =>
      `a supprimé les balises « ${count} » de la liste « ${tagListName} »`,
    updateTag: ({
      tagListName,
      newValue,
      tagName,
    ...
    updateCustomUnitTaxEnabled: ({
      ...
      `Suivi fiscal ${newValue ? "activé" : "Désactivé"} sur les taux de distance`,
    addCustomUnitRate: (customUnitName: string, rateName: string) =>
      `a ajouté un nouveau taux ${customUnitName} « ${rateName} »`,
    ...
    deleteCustomUnitRate: ({
      ...
      `a supprimé le taux « ${customUnitName} » « ${rateName} »`,
    addedReportField: ({
      fieldType,
      fieldName,
    }: AddedOrDeletedPolicyReportFieldParams) =>
      `a ajouté le champ de note de frais ${fieldType} « ${fieldName} »`,
    ...
    addedReportFieldOption: (fieldName: string, optionName: string) =>
      `a ajouté l’option « ${optionName} » au champ de note de frais « ${fieldName} »`,
    removedReportFieldOption: (fieldName: string, optionName: string) =>
      `a supprimé l’option « ${optionName} » du champ de note de frais « ${fieldName} »`,
    ...
    deleteReportField: ({
      ...
      fieldType: string;
      fieldName?: string;
    }) => `a supprimé le champ de note de frais ${fieldType} « ${fieldName} »`,
    preventSelfApproval: ({
      oldValue,
      newValue,
    }: UpdatedPolicyPreventSelfApprovalParams) =>
    ...
    updateDefaultTitleEnforced: (value: boolean) =>
      `a activé « Appliquer les titres de note de frais par défaut » ${value ? "activé" : "désactivé"}`,
    ...
    renamedWorkspaceNameAction: (oldName: string, newName: string) =>
      `a mis à jour le nom de cet espace de travail en « ${newName} » (auparavant « ${oldName} »)`,
    ...
    updatedWorkspaceCurrencyAction: (
      ...
      `a mis à jour la devise par défaut en ${newCurrency} (auparavant ${oldCurrency})`,
    ...
    updateApprovalMode: ({ newValue, oldValue }: ChangeFieldParams) =>
      `a mis à jour le mode d’approbation sur « ${newValue} » (auparavant « ${oldValue} »)`,
    ...
    downgradedWorkspace:
      "a rétrogradé cet espace de travail vers l’offre Collect",
    ...
    updatedAttendeeTracking: ({ enabled }: { enabled: boolean }) =>
      `Suivi des participants ${enabled ? "Activé" : "Désactivé"}`,
    updatedAutoPayApprovedReports: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "Activé" : "Désactivé"} notes de frais approuvées en paiement automatique`,
    setAutoPayApprovedReportsLimit: ({ newLimit }: { newLimit: string }) =>
      `définir le seuil d’auto-paiement des notes de frais approuvées sur « ${newLimit} »`,
    ...
    removedAutoPayApprovedReportsLimit:
      "a supprimé le seuil de notes de frais approuvées pour le paiement automatique",
    changedDefaultApprover: ({
      ...
      previousApprover
        ? `a modifié l’approbateur par défaut en ${newApprover} (précédemment ${previousApprover})`
        : `a modifié l’approbateur par défaut en ${newApprover}`,
    ...
    changedInvoiceCompanyName: ({
      ...
      oldValue
        ...
        : `définir le nom de l’entreprise de la facture sur « ${newValue} »`,
    ...
    changedReimburser: ({
      ...
      previousReimburser
        ? `a modifié le payeur autorisé en « ${newReimburser} » (auparavant « ${previousReimburser} »)`
        : `a modifié le payeur autorisé en « ${newReimburser} »`,
    updateReimbursementEnabled: ({
      enabled,
    }: UpdatedPolicyReimbursementEnabledParams) =>
      `Remboursements ${enabled ? "Activé" : "Désactivé"}`,
    updateCustomTaxName: ({
      oldName,
      newName,
    }: UpdatedPolicyCustomTaxNameParams) =>
      `a modifié le nom de taxe personnalisé en « ${newName} » (auparavant « ${oldName} »)`,
    ...
    addTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `a ajouté la taxe « ${taxName} »`,
    deleteTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `a supprimé la taxe « ${taxName} »`,
    updateTax: ({
      oldValue,
      taxName,
      updatedField,
    ...
    setReceiptRequiredAmount: (newValue: string) =>
      `définir le montant de reçu obligatoire sur « ${newValue} »`,
    ...
    removedReceiptRequiredAmount: (oldValue: string) =>
      `a supprimé le montant requis pour le reçu (précédemment « ${oldValue} »)`,
    setMaxExpenseAmount: (newValue: string) =>
      `définir le montant maximal de dépense sur « ${newValue} »`,
    changedMaxExpenseAmount: (oldValue: string, newValue: string) =>
      `montant maximal de dépense modifié en « ${newValue} » (précédemment « ${oldValue} »)`,
    removedMaxExpenseAmount: (oldValue: string) =>
      `montant de dépense maximal supprimé (précédemment « ${oldValue} »)`,
    setMaxExpenseAge: (newValue: string) =>
      `définir l’ancienneté maximale des dépenses à « ${newValue} » jours`,
    changedMaxExpenseAge: (oldValue: string, newValue: string) =>
      `âge maximal de dépense modifié à « ${newValue} » jours (auparavant « ${oldValue} »)`,
    removedMaxExpenseAge: (oldValue: string) =>
      `âge maximal de dépense supprimé (auparavant « ${oldValue} » jours)`,
    updateCategories: ({ count }: UpdatedPolicyCategoriesParams) =>
      `${count} catégories mises à jour`,
    updateTagList: ({ tagListName }: UpdatedPolicyTagListParams) =>
      `a mis à jour les tags dans la liste « ${tagListName} »`,
    ...
    importCustomUnitRates: ({
      ...
      `taux importés pour l’unité personnalisée « ${customUnitName} »`,
    ...
    addBudget: ({
      ...
      const thresholdSuffix =
        typeof notificationThreshold === "number"
          ? `avec un seuil de notification de « ${notificationThreshold}% »`
          : "";
    ...
    updateBudget: ({
      ...
      if (frequencyChanged) {
        changesList.push(
          `a modifié la fréquence du budget en « ${newFrequency} » (auparavant « ${oldFrequency} »)`,
        );
      }
      if (sharedChanged) {
        changesList.push(
          `a modifié le budget total de l'espace de travail en « ${newShared} » (précédemment « ${oldShared} »)`,
        );
      }
      if (individualChanged) {
        changesList.push(
          `a modifié le budget individuel en « ${newIndividual} » (auparavant « ${oldIndividual} »)`,
        );
      }
      if (thresholdChanged) {
        changesList.push(
          `a modifié le seuil de notification à « ${newNotificationThreshold}% » (auparavant « ${oldNotificationThreshold}% »)`,
        );
      }
      if (
        !frequencyChanged &&
    ...
    }) => `a ajouté « ${prohibitedExpense} » aux dépenses interdites`,
    removedProhibitedExpense: ({
      prohibitedExpense,
    }: {
      prohibitedExpense: string;
    }) => `a supprimé « ${prohibitedExpense} » des dépenses interdites`,
    ...
    setAutoJoin: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "activé" : "désactivé"} pré-approbation des demandes de rejoindre l’espace de travail`,
    updatedDefaultTitle: ({
      newDefaultTitle,
      oldDefaultTitle,
    }: UpdatedPolicyDefaultTitleParams) =>
    ...
    updatedAutoHarvesting: ({ enabled }: UpdatedPolicyAutoHarvestingParams) =>
      `Soumission planifiée pour ${enabled ? "activé" : "désactivé"}`,
  ...
  roomMembersPage: {
    ...
    useInviteButton:
      "Pour inviter un nouveau membre dans la discussion, veuillez utiliser le bouton d’invitation ci-dessus.",
    ...
    removeMembersPrompt: ({ memberName }: { memberName: string }) => ({
      ...
      other:
        "Voulez-vous vraiment supprimer les membres sélectionnés de la salle ?",
    }),
    error: {
      genericAdd:
        "Un problème est survenu lors de l’ajout de ce membre de la salle",
    },
  },
  newTaskPage: {
    assignTask: "Assigner la tâche",
    ...
    confirmError:
      "Veuillez saisir un titre et sélectionner une destination de partage",
    descriptionOptional: "Description (facultatif)",
    pleaseEnterTaskName: "Veuillez saisir un titre",
    pleaseEnterTaskDestination:
      "Veuillez sélectionner où vous souhaitez partager cette tâche",
  },
  task: {
    task: "Tâche",
    title: "Titre",
    ...
    assigneeError:
      "Une erreur s’est produite lors de l’assignation de cette tâche. Veuillez essayer un autre assigné.",
    genericCreateTaskFailureMessage:
      "Une erreur s’est produite lors de la création de cette tâche. Veuillez réessayer plus tard.",
    deleteTask: "Supprimer la tâche",
    deleteConfirmation: "Voulez-vous vraiment supprimer cette tâche ?",
  },
  statementPage: {
    title: (year: number | string, monthName: string) =>
      `Relevé de ${monthName} ${year}`,
  },
  ...
  search: {
    ...
    searchResults: {
      ...
      emptyExpenseResults: {
        ...
        subtitle:
          "Créez une dépense ou faites un essai d’Expensify pour en savoir plus.",
        subtitleWithOnlyCreateButton:
          "Utilisez le bouton vert ci-dessous pour créer une dépense.",
      },
      emptyReportResults: {
        title: "Vous n’avez encore créé aucune note de frais",
        subtitle:
          "Créez une note de frais ou faites un essai d’Expensify pour en savoir plus.",
        subtitleWithOnlyCreateButton:
          "Utilisez le bouton vert ci-dessous pour créer une note de frais.",
      },
      emptyInvoiceResults: {
        title: dedent(`
                ...
                `),
        subtitle:
          "Envoyez une facture ou faites un essai d’Expensify pour en savoir plus.",
        subtitleWithOnlyCreateButton:
          "Utilisez le bouton vert ci-dessous pour envoyer une facture.",
      },
      emptyTripResults: {
    ...
    bulkActions: {
      ...
      reject: "Rejeter",
      noOptionsAvailable:
        "Aucune option n’est disponible pour le groupe de dépenses sélectionné.",
    },
    ...
    filters: {
      ...
      limit: "Limite",
      limitDescription:
        "Définissez une limite pour les résultats de votre recherche.",
      currency: "Devise",
      completed: "Terminé",
      amount: {
      ...
      card: {
        ...
        cardFeedNameCSV: ({ cardFeedLabel }: { cardFeedLabel?: string }) =>
          `Toutes les cartes CSV importées${cardFeedLabel ? ` - ${cardFeedLabel}` : ""}`,
      },
    ...
    exportSearchResults: {
      ...
      description:
        "Ouah, ça fait beaucoup d’éléments ! Nous allons les regrouper et Concierge vous enverra un fichier sous peu.",
    },
    exportedTo: "Exporté vers",
    exportAll: {
      selectAllMatchingItems: "Sélectionnez tous les éléments correspondants",
      allMatchingItemsSelected:
        "Tous les éléments correspondants sont sélectionnés",
    },
  ...
  fileDownload: {
    ...
    permissionError: {
      ...
      message:
        "Expensify ne peut pas enregistrer les pièces jointes sans accès au stockage. Touchez Paramètres pour mettre à jour les autorisations.",
    },
  },
  settlement: {
    status: {
    ...
    failedError: ({ link }: { link: string }) =>
      `Nous réessaierons ce règlement lorsque vous <a href="${link}">déverrouillerez votre compte</a>.`,
    withdrawalInfo: ({
      date,
      withdrawalID,
    }: {
      date: string;
      withdrawalID: number;
    }) => `${date} • ID de retrait : ${withdrawalID}`,
  },
  reportLayout: {
    reportLayout: "Mise en page de la note de frais",
    groupByLabel: "Regrouper par :",
    selectGroupByOption:
      "Sélectionnez comment regrouper les dépenses de la note de frais",
    uncategorized: "Non catégorisé",
    noTag: "Aucun tag",
    selectGroup: ({ groupName }: { groupName: string }) =>
      `Sélectionner toutes les dépenses dans ${groupName}`,
    groupBy: {
      category: "Catégorie",
      tag: "Tag",
    },
  ...
  report: {
    newReport: {
      ...
      createReport: "Créer une note de frais",
      chooseWorkspace:
        "Choisissez un espace de travail pour cette note de frais.",
    ...
    genericCreateReportFailureMessage:
      "Erreur inattendue lors de la création de cette discussion. Veuillez réessayer plus tard.",
    genericAddCommentFailureMessage:
      "Erreur inattendue lors de la publication du commentaire. Veuillez réessayer plus tard.",
    genericUpdateReportFieldFailureMessage:
      "Erreur inattendue lors de la mise à jour du champ. Veuillez réessayer plus tard.",
    genericUpdateReportNameEditFailureMessage:
      "Erreur inattendue lors du renommage de la note de frais. Veuillez réessayer plus tard.",
    noActivityYet: "Aucune activité pour le moment",
    connectionSettings: "Paramètres de connexion",
    actions: {
      type: {
        changeField: ({ oldValue, newValue, fieldName }: ChangeFieldParams) =>
          `a modifié ${fieldName} en « ${newValue} » (auparavant « ${oldValue} »)`,
        changeFieldEmpty: ({ newValue, fieldName }: ChangeFieldParams) =>
          `définir ${fieldName} sur « ${newValue} »`,
        ...
        changeType: (oldType: string, newType: string) =>
          `a modifié le type de ${oldType} à ${newType}`,
        ...
        exportedToIntegration: {
          ...
          manual: (label: string) =>
            `a marqué cette note de frais comme exportée manuellement vers ${label}.`,
          ...
          pending: (label: string) =>
            `a commencé à exporter cette note de frais vers ${label}...`,
        },
        integrationsMessage: (
          errorMessage: string,
          label: string,
        ...
        markedReimbursed: (amount: string, currency: string) =>
          `payé ${amount} ${currency} ailleurs`,
        markedReimbursedFromIntegration: ({
          amount,
          currency,
        }: MarkReimbursedFromIntegrationParams) =>
          `a payé ${currency}${amount} via intégration`,
        ...
        addEmployee: (email: string, role: string) =>
          `a ajouté ${email} en tant que ${role === "member" ? "un" : "un"} ${role}`,
        updateRole: ({ email, currentRole, newRole }: UpdateRoleParams) =>
          `a mis à jour le rôle de ${email} en ${newRole} (précédemment ${currentRole})`,
        updatedCustomField1: (
          email: string,
          newValue: string,
        ...
        leftWorkspace: (nameOrEmail: string) =>
          `${nameOrEmail} a quitté l’espace de travail`,
        removeMember: (email: string, role: string) =>
          `a supprimé ${role} ${email}`,
        removedConnection: ({ connectionName }: ConnectionNameParams) =>
          `a supprimé la connexion à ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        addedConnection: ({ connectionName }: ConnectionNameParams) =>
          `connecté à ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        ...
        leftTheChatWithName: (nameOrEmail: string) =>
          `${nameOrEmail ? `${nameOrEmail}: ` : ""} a quitté la discussion`,
      ...
      error: {
        invalidCredentials:
          "Identifiants invalides, veuillez vérifier la configuration de votre connexion.",
      },
    },
  },
  chronos: {
    oooEventSummaryFullDay: (summary: string, dayCount: number, date: string) =>
      `${summary} pour ${dayCount} ${dayCount === 1 ? "jour" : "jours"} jusqu’au ${date}`,
    oooEventSummaryPartialDay: (
      summary: string,
      timePeriod: string,
      date: string,
    ) => `${summary} du ${timePeriod} le ${date}`,
  },
  footer: {
  ...
  threads: {
    ...
    parentNavigationSummary: ({
      ...
      `De ${reportName}${workspaceName ? `dans ${workspaceName}` : ""}`,
  },
  qrCodes: {
    qrCode: "Code QR",
    copy: "Copier l’URL",
  ...
  moderation: {
    flagDescription:
      "Tous les messages signalés seront envoyés à un modérateur pour examen.",
    ...
    inconsiderateDescription:
      "Formulations insultantes ou irrespectueuses, aux intentions douteuses",
    intimidation: "Intimidation",
    intimidationDescription:
      "Poursuivre un programme de manière agressive malgré des objections valables",
    bullying: "Harcèlement",
    bullyingDescription: "Cibler un individu pour obtenir l’obéissance",
    harassment: "Harcèlement",
    harassmentDescription:
      "Comportement raciste, misogyne ou autre comportement largement discriminatoire",
    assault: "Agression",
    assaultDescription:
      "Attaque émotionnelle ciblée spécifiquement avec l’intention de nuire",
    flaggedContent:
      "Ce message a été signalé comme enfreignant nos règles de communauté et son contenu a été masqué.",
    hideMessage: "Masquer le message",
    revealMessage: "Afficher le message",
    levelOneResult:
      "Envoie un avertissement anonyme et le message est signalé pour examen.",
    levelTwoResult:
      "Message masqué dans le canal, avertissement anonyme ajouté et message signalé pour examen.",
    levelThreeResult:
      "Message supprimé du canal, avertissement anonyme ajouté et message signalé pour examen.",
  },
  ...
  teachersUnitePage: {
    ...
    getInTouch:
      "Excellent ! Veuillez partager leurs coordonnées afin que nous puissions les contacter.",
  ...
  distance: {
    ...
    mapPending: {
      ...
      errorSubtitle:
        "Une erreur s’est produite lors du chargement de la carte. Veuillez réessayer.",
    },
    error: {
      selectSuggestedAddress:
        "Veuillez sélectionner une adresse suggérée ou utiliser la position actuelle",
    },
    odometer: {
      ...
      endMessageWeb:
        "Ajoutez une photo du compteur kilométrique prise à la <strong>fin</strong> de votre trajet. Faites glisser un fichier ici ou choisissez-en un à télécharger.",
      ...
      deleteOdometerPhotoConfirmation:
        "Voulez-vous vraiment supprimer cette photo de l’odomètre ?",
      cameraAccessRequired:
        "L'accès à l'appareil photo est requis pour prendre des photos.",
      snapPhotoStart:
        "<muted-text-label>Prenez une photo de votre compteur kilométrique au <strong>début</strong> de votre trajet.</muted-text-label>",
      snapPhotoEnd:
        "<muted-text-label>Prenez une photo de votre compteur kilométrique à la <strong>fin</strong> de votre trajet.</muted-text-label>",
    },
  },
  gps: {
    error: {
      ...
      failedToGetPermissions:
        "Échec de l’obtention des autorisations de localisation requises.",
    },
    ...
    discardDistanceTrackingModal: {
      ...
      prompt:
        "Êtes-vous sûr(e) ? Cela supprimera votre parcours en cours et ne pourra pas être annulé.",
      confirm: "Abandonner le suivi de distance",
    },
    zeroDistanceTripModal: {
      title: "Impossible de créer la dépense",
      prompt:
        "Vous ne pouvez pas créer une dépense avec le même lieu de départ et d’arrivée.",
    },
    locationRequiredModal: {
      title: "Accès à la localisation requis",
      prompt:
        "Veuillez autoriser l’accès à la localisation dans les réglages de votre appareil pour commencer le suivi de distance GPS.",
      allow: "Autoriser",
    },
    androidBackgroundLocationRequiredModal: {
      title: "Accès à la localisation en arrière-plan requis",
      prompt:
        "Veuillez autoriser l’accès à la localisation en arrière-plan dans les réglages de votre appareil (option « Toujours autoriser ») pour lancer le suivi de distance GPS.",
    },
    preciseLocationRequiredModal: {
      title: "Localisation précise requise",
      prompt:
        "Veuillez activer la « localisation précise » dans les réglages de votre appareil pour commencer le suivi de distance GPS.",
    },
    desktop: {
      title: "Suivez la distance sur votre téléphone",
      subtitle:
        "Enregistrez automatiquement les miles ou kilomètres avec le GPS et transformez instantanément les trajets en dépenses.",
    ...
    continueGpsTripModal: {
      ...
      prompt:
        "On dirait que l’application s’est fermée pendant votre dernier trajet GPS. Souhaitez-vous continuer l’enregistrement de ce trajet ?",
    ...
    switchToODWarningTripInProgress: {
      title: "Suivi GPS en cours",
      prompt:
        "Voulez-vous vraiment arrêter le suivi GPS et passer à Expensify Classic ?",
  ...
  reportCardLostOrDamaged: {
    ...
    confirmAddressTitle:
      "Veuillez confirmer l’adresse postale pour votre nouvelle carte.",
    cardDamagedInfo:
      "Votre nouvelle carte arrivera dans 2 à 3 jours ouvrables. Votre carte actuelle continuera de fonctionner jusqu’à l’activation de la nouvelle.",
    cardLostOrStolenInfo:
      "Votre carte actuelle sera définitivement désactivée dès que votre commande sera passée. La plupart des cartes arrivent sous quelques jours ouvrables.",
    address: "Adresse",
    ...
    successDescription:
      "Vous devrez l’activer une fois qu’elle sera arrivée dans quelques jours ouvrables. En attendant, vous pouvez utiliser une carte virtuelle.",
  },
  eReceipt: {
  ...
  referralProgram: {
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
      buttonText:
        "Démarrez une discussion, <success><strong>parrainez un ami</strong></success>.",
    ...
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
      buttonText:
        "Soumettez une dépense, <success><strong>parrainez votre équipe</strong></success>.",
  ...
  violations: {
    ...
    invoiceMarkup: ({ invoiceMarkup }: ViolationsInvoiceMarkupParams) =>
      `Majoration de ${invoiceMarkup} %`,
    maxAge: ({ maxAge }: ViolationsMaxAgeParams) =>
      `Date antérieure de plus de ${maxAge} jours`,
    ...
    overAutoApprovalLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `La dépense dépasse la limite d’auto-approbation de ${formattedLimit}`,
    overCategoryLimit: ({
      formattedLimit,
    }: ViolationsOverCategoryLimitParams) =>
      `Montant dépassant la limite de catégorie de ${formattedLimit}/personne`,
    overLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Montant dépassant la limite de ${formattedLimit}/personne`,
    overTripLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Montant dépassant la limite de ${formattedLimit}/trajet`,
    overLimitAttendee: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Montant dépassant la limite de ${formattedLimit}/personne`,
    perDayLimit: ({ formattedLimit }: ViolationsPerDayLimitParams) =>
      `Montant dépassant la limite quotidienne de catégorie de ${formattedLimit}/personne`,
    receiptNotSmartScanned:
      "Détails du reçu et de la dépense ajoutés manuellement.",
    receiptRequired: ({
      formattedLimit,
      category,
    }: ViolationsReceiptRequiredParams) => {
    ...
    itemizedReceiptRequired: ({
      ...
      `Reçu détaillé requis${formattedLimit ? `au-delà de ${formattedLimit}` : ""}`,
    prohibitedExpense: ({
    ...
    rter: ({
      ...
      if (!isTransactionOlderThan7Days) {
        return isAdmin
          ? `Demandez à ${member} de marquer comme paiement en espèces ou attendez 7 jours et réessayez`
          : "En attente de fusion avec la transaction par carte.";
      }
      return "";
    },
    brokenConnection530Error:
      "Reçu en attente en raison d’une connexion bancaire rompue",
    ...
    memberBrokenConnectionError:
      "Reçu en attente en raison d’une connexion bancaire rompue. Veuillez demander à un administrateur de l’espace de travail de résoudre le problème.",
    markAsCashToIgnore:
      "Marquer comme paiement en espèces pour l’ignorer et demander un paiement.",
    smartscanFailed: ({ canEdit = true }) =>
      `L’analyse du reçu a échoué.${canEdit ? "Saisir les détails manuellement." : ""}`,
  ...
  reportViolations: {
    ...
    reportContainsExpensesWithViolations:
      "La note de frais contient des dépenses avec des violations.",
  },
  violationDismissal: {
    rter: {
  ...
  exitSurvey: {
    ...
    reasonPage: {
      ...
      subtitle:
        "Avant de partir, veuillez nous dire pourquoi vous souhaitez passer à Expensify Classic.",
    },
    reasons: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "J’ai besoin d’une fonctionnalité qui n’est disponible que dans Expensify Classic.",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "Je ne comprends pas comment utiliser le nouveau Expensify.",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Je comprends comment utiliser le nouveau Expensify, mais je préfère Expensify Classic.",
    },
    prompts: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "Quelle fonctionnalité dont vous avez besoin n’est pas disponible dans le nouveau Expensify ?",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "Que cherchez-vous à faire ?",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Pourquoi préférez-vous Expensify Classic ?",
    },
    responsePlaceholder: "Votre réponse",
    thankYou: "Merci pour ce retour !",
    thankYouSubtitle:
      "Vos réponses nous aideront à créer un meilleur produit pour accomplir vos tâches. Merci beaucoup !",
    goToExpensifyClassic: "Passer à Expensify Classic",
    ...
    quickTipSubTitle:
      "Vous pouvez aller directement sur Expensify Classic en visitant expensify.com. Ajoutez-le à vos favoris pour y accéder plus facilement !",
    ...
    benefits: {
      [CONST.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY]:
        "Discuter directement sur les dépenses et les notes de frais",
      [CONST.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE]:
        "Possibilité de tout faire sur mobile",
      [CONST.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE]:
        "Voyages et dépenses à la vitesse d’un chat",
    },
    bookACallTextTop:
      "En passant à Expensify Classic, vous ne profiterez pas de :",
    bookACallTextBottom:
  ...
  listBoundary: {
    errorMessage:
      "Une erreur est survenue lors du chargement de messages supplémentaires",
    tryAgain: "Réessayer",
  },
  systemMessage: {
    mergedWithCashTransaction:
      "a fait correspondre un reçu à cette transaction",
  },
  subscription: {
    authenticatePaymentCard: "Authentifier la carte de paiement",
    mobileReducedFunctionalityMessage:
      "Vous ne pouvez pas modifier votre abonnement dans l’application mobile.",
    badge: {
      freeTrial: (numOfDays: number) =>
        `Essai gratuit : il reste ${numOfDays} ${numOfDays === 1 ? "jour" : "jours"}`,
    },
    billingBanner: {
      ...
      policyOwnerUnderInvoicingOverdue: {
        title: "Vos informations de paiement ne sont plus à jour",
        subtitle:
          "Votre paiement est en retard. Veuillez régler votre facture.",
      },
      ...
      preTrial: {
        ...
        subtitle:
          'Étape suivante, <a href="#">complétez votre liste de configuration</a> pour que votre équipe puisse commencer à déclarer des dépenses.',
      },
      trialStarted: {
        title: (numOfDays: number) =>
          `Essai : il reste ${numOfDays} ${numOfDays === 1 ? "jour" : "jours"} !`,
        subtitle:
          "Ajoutez une carte de paiement pour continuer à utiliser toutes vos fonctionnalités préférées.",
      },
      trialEnded: {
      ...
      earlyDiscount: {
        ...
        onboardingChatTitle: (discountType: number) =>
          `Offre limitée : ${discountType} % de réduction sur votre première année !`,
        subtitle: (
          days: number,
          hours: number,
          minutes: number,
          ...
          `Réclamer dans ${days > 0 ? `${days}j :` : ""}${hours}h : ${minutes}m : ${seconds}s`,
      },
    },
    cardSection: {
      title: "Paiement",
      ...
      cardInfo: (name: string, expiration: string, currency: string) =>
        `Nom : ${name}, Expiration : ${expiration}, Devise : ${currency}`,
      cardNextPayment: (nextPaymentDate: string) =>
        `Votre prochaine date de paiement est le ${nextPaymentDate}.`,
      cardEnding: (cardNumber: string) =>
        `Carte se terminant par ${cardNumber}`,
    ...
    yourPlan: {
      ...
      asLowAs: ({ price }: YourPlanPriceValueParams) =>
        `à partir de ${price} par membre actif/mois`,
      pricePerMemberMonth: ({ price }: YourPlanPriceValueParams) =>
        `${price} par membre/mois`,
      pricePerMemberPerMonth: ({ price }: YourPlanPriceValueParams) =>
        `${price} par membre et par mois`,
      perMemberMonth: "par membre/mois",
      collect: {
        title: "Encaisser",
        description:
          "L’offre pour petites entreprises qui vous offre les dépenses, les voyages et le chat.",
        priceAnnual: ({ lower, upper }: YourPlanPriceParams) =>
          `De ${lower}/membre actif avec la Carte Expensify à ${upper}/membre actif sans la Carte Expensify.`,
      ...
      control: {
        title: "Contrôle",
        description:
          "Gestion des dépenses, des voyages et des discussions pour les grandes entreprises.",
        priceAnnual: ({ lower, upper }: YourPlanPriceParams) =>
          `De ${lower}/membre actif avec la Carte Expensify à ${upper}/membre actif sans la Carte Expensify.`,
        pricePayPerUse: ({ lower, upper }: YourPlanPriceParams) =>
          `De ${lower}/membre actif avec la Carte Expensify à ${upper}/membre actif sans la Carte Expensify.`,
      ...
      saveWithExpensifyDescription:
        "Utilisez notre calculateur d’économies pour voir comment le cash back de la Carte Expensify peut réduire votre facture Expensify.",
    ...
    subscriptionSize: {
      ...
      confirmDetails:
        "Confirmez les détails de votre nouvel abonnement annuel :",
      subscriptionSize: "Taille de l’abonnement",
      activeMembers: (size: number) => `${size} membres actifs/mois`,
      subscriptionRenews: "Renouvellement de l’abonnement",
      youCantDowngrade:
        "Vous ne pouvez pas changer pour une offre inférieure pendant votre abonnement annuel.",
      ...
      error: {
        ...
        sameSize:
          "Veuillez saisir un nombre différent de la taille actuelle de votre abonnement",
      },
    },
    paymentCard: {
      addPaymentCard: "Ajouter une carte de paiement",
      enterPaymentCardDetails:
        "Saisissez les informations de votre carte de paiement",
      security:
        "Expensify est conforme à la norme PCI-DSS, utilise un chiffrement de niveau bancaire et une infrastructure redondante pour protéger vos données.",
    ...
    subscriptionSettings: {
      ...
      saveUpTo: (amountWithCurrency: string) =>
        `Économisez jusqu’à ${amountWithCurrency}/mois par membre actif`,
      ...
      whatsMainReason:
        "Quelle est la principale raison pour laquelle vous désactivez le renouvellement automatique ?",
      renewsOn: (date: string) => `Se renouvelle le ${date}.`,
      pricingConfiguration:
        "Le prix dépend de la configuration. Pour le prix le plus bas, choisissez un abonnement annuel et obtenez la Carte Expensify.",
      ...
      changesBasedOn:
        "Cela varie en fonction de votre utilisation de la Carte Expensify et des options d’abonnement ci-dessous.",
    },
    requestEarlyCancellation: {
      title: "Demander une résiliation anticipée",
      subtitle:
        "Quelle est la principale raison pour laquelle vous demandez une résiliation anticipée ?",
  ...
  feedbackSurvey: {
    ...
    businessClosing:
      "Fermeture, réduction d’effectifs ou acquisition de l’entreprise",
  ...
  delegate: {
    ...
    copilotDelegatedAccessDescription:
      "Autoriser les autres membres à accéder à votre compte.",
    ...
    youCanAccessTheseAccounts:
      "Vous pouvez accéder à ces comptes via le sélecteur de compte :",
    ...
    enterMagicCodeUpdate: (contactMethod: string) =>
      `Veuillez saisir le code magique envoyé à ${contactMethod} pour mettre à jour votre copilote.`,
  ...
  debug: {
    ...
    invalidProperty: ({ propertyName, expectedType }: InvalidPropertyParams) =>
      `Propriété non valide : ${propertyName} - Attendu : ${expectedType}`,
    invalidValue: ({ expectedValues }: InvalidValueParams) =>
      `Valeur non valide - Valeurs attendues : ${expectedValues}`,
    ...
    reasonVisibleInLHN: {
      ...
      hasAddWorkspaceRoomErrors:
        "Présente des erreurs d’ajout de salle d’espace de travail",
    ...
    reasonGBR: {
      ...
      isWaitingForAssigneeToCompleteAction:
        "En attente que l’assigné termine l’action",
      hasChildReportAwaitingAction:
        "Une note de frais enfant est en attente d’action",
      hasMissingInvoiceBankAccount: "A un compte bancaire de facture manquant",
      hasUnresolvedCardFraudAlert:
        "A une alerte de fraude de carte non résolue",
      hasDEWApproveFailed: "L’approbation DEW a échoué",
    },
    reasonRBR: {
      hasErrors:
        "Contient des erreurs dans les données de la note de frais ou des actions de note de frais",
      hasViolations: "Contient des violations",
      hasTransactionThreadViolations:
        "Présente des violations de fil de transaction",
    },
    indicatorStatus: {
      ...
      theresAWorkspaceWithCustomUnitsErrors:
        "Il existe un espace de travail avec des erreurs d’unités personnalisées",
      theresAProblemWithAWorkspaceMember:
        "Il y a un problème avec un membre de l’espace de travail",
      theresAProblemWithAWorkspaceQBOExport:
        "Un problème s’est produit avec un paramètre d’exportation de connexion d’espace de travail.",
      theresAProblemWithAContactMethod:
        "Un problème est survenu avec une méthode de contact",
      aContactMethodRequiresVerification:
        "Une méthode de contact nécessite une vérification",
      theresAProblemWithAPaymentMethod:
        "Un problème est survenu avec un moyen de paiement",
      theresAProblemWithAWorkspace:
        "Il y a un problème avec un espace de travail",
      theresAProblemWithYourReimbursementAccount:
        "Un problème est survenu avec votre compte de remboursement",
      theresABillingProblemWithYourSubscription:
        "Un problème de facturation est survenu avec votre abonnement",
      ...
      theresWasAProblemDuringAWorkspaceConnectionSync:
        "Un problème est survenu lors de la synchronisation de connexion de l’espace de travail",
      theresAProblemWithYourWallet:
        "Il y a un problème avec votre portefeuille",
      theresAProblemWithYourWalletTerms:
        "Il y a un problème avec les conditions de votre portefeuille",
    },
  },
  emptySearchView: {
  ...
  migratedUserWelcomeModal: {
    ...
    subtitle:
      "Il contient tout ce que vous aimez dans notre expérience classique, avec tout un tas d’améliorations pour vous faciliter encore plus la vie :",
    confirmText: "C’est parti !",
    helpText: "Essayer la démo de 2 minutes",
    features: {
      search:
        "Recherche plus puissante sur mobile, sur le web et sur ordinateur",
      concierge:
        "IA Concierge intégrée pour vous aider à automatiser vos dépenses",
  ...
  productTrainingTooltip: {
    ...
    saveSearchTooltip:
      "<tooltip><strong>Renommez vos recherches enregistrées</strong> ici !</tooltip>",
    accountSwitcher:
      "<tooltip>Accédez à vos <strong>comptes Copilot</strong> ici</tooltip>",
    scanTestTooltip: {
      main: "<tooltip><strong>Scannez notre reçu de test</strong> pour voir comment ça marche !</tooltip>",
      manager:
        "<tooltip>Choisissez notre <strong>responsable des tests</strong> pour l’essayer&nbsp;!</tooltip>",
      confirmation:
        "<tooltip>Maintenant, <strong>soumettez votre dépense</strong> et regardez la magie opérer&nbsp;!</tooltip>",
      tryItOut: "Essayer",
    },
    outstandingFilter:
      "<tooltip>Filtrer les dépenses\nqui <strong>doivent être approuvées</strong></tooltip>",
    scanTestDriveTooltip:
      "<tooltip>Envoyez ce reçu pour\n<strong>terminer l’essai !</strong></tooltip>",
    gpsTooltip:
      "<tooltip>Suivi GPS en cours ! Lorsque vous avez terminé, arrêtez le suivi ci-dessous.</tooltip>",
    hasFilterNegation:
      "<tooltip>Recherchez les dépenses sans reçus à l’aide de <strong>-has:receipt</strong>.</tooltip>",
  },
  ...
  scheduledCall: {
    book: {
      ...
      slots: ({ date }: { date: string }) =>
        `<muted-text>Horaires disponibles pour le <strong>${date}</strong></muted-text>`,
    },
    confirmation: {
  ...
  autoSubmitModal: {
    ...
    description:
      "Tous les avertissements et violations ont été effacés, donc :",
    submittedExpensesTitle: "Ces dépenses ont été soumises",
    submittedExpensesDescription:
      "Ces dépenses ont été envoyées à votre approbateur, mais elles peuvent encore être modifiées tant qu’elles ne sont pas approuvées.",
    pendingExpensesTitle: "Les dépenses en attente ont été déplacées",
    pendingExpensesDescription:
      "Toutes les dépenses en attente sur carte ont été déplacées vers une note de frais distincte jusqu’à leur comptabilisation.",
  },
  testDrive: {
    quickAction: {
    ...
    modal: {
      ...
      description:
        "Faites une brève visite du produit pour vous familiariser rapidement.",
      ...
      employee: {
        ...
        error:
          "Ce membre possède un espace de travail, veuillez saisir un nouveau membre pour effectuer le test.",
      },
    },
    banner: {
      currentlyTestDrivingExpensify:
        "Vous êtes actuellement en train de tester Expensify",
      readyForTheRealThing: "Prêt pour de vrai ?",
      getStarted: "Commencer",
    },
    employeeInviteMessage: (
      name: string,
    ) => `# ${name} vous a invité à tester Expensify
...
Voici un *reçu test* pour vous montrer comment ça fonctionne :`,
  ...
  domain: {
    ...
    verifyDomain: {
      ...
      accessYourDNS: ({ domainName }: { domainName: string }) =>
        `Accédez à votre fournisseur DNS et ouvrez les paramètres DNS pour <strong>${domainName}</strong>.`,
      addTXTRecord: "Ajoutez l’enregistrement TXT suivant :",
      saveChanges:
        "Enregistrez les modifications et revenez ici pour vérifier votre domaine.",
      ...
      warning:
        "Après vérification, tous les membres Expensify de votre domaine recevront un e-mail indiquant que leur compte sera géré sous votre domaine.",
      codeFetchError: "Impossible de récupérer le code de vérification",
      genericError:
        "Nous n’avons pas pu vérifier votre domaine. Veuillez réessayer et contacter Concierge si le problème persiste.",
    },
    domainVerified: {
    ...
    samlLogin: {
      ...
      anyMemberWillBeRequired:
        "Tout membre connecté avec une autre méthode devra se réauthentifier en utilisant SAML.",
      ...
      oktaWarningPrompt:
        "Voulez-vous continuer ? Cela désactivera également Okta SCIM.",
      requireWithEmptyMetadataError:
        "Veuillez ajouter ci-dessous les métadonnées du fournisseur d'identité pour activer",
    ...
    samlConfigurationDetails: {
      ...
      fetchError:
        "Impossible de récupérer les détails de la configuration SAML",
    ...
    addDomain: {
      ...
      subtitle:
        "Saisissez le nom du domaine privé auquel vous souhaitez accéder (par ex. expensify.com).",
    ...
    domainAdded: {
      ...
      description:
        "Ensuite, vous devrez vérifier la propriété du domaine et ajuster vos paramètres de sécurité.",
      configure: "Configurer",
    },
    enhancedSecurity: {
      title: "Sécurité renforcée",
      subtitle:
        "Obliger les membres de votre domaine à se connecter via l’authentification unique, restreindre la création d’espaces de travail, et plus encore.",
      enable: "Activer",
    },
    ...
    admins: {
      ...
      setPrimaryContactError:
        "Impossible de définir le contact principal. Veuillez réessayer plus tard.",
      ...
      consolidatedDomainBillingError:
        "La facturation de domaine consolidée n’a pas pu être modifiée. Veuillez réessayer plus tard.",
      addAdmin: "Ajouter un administrateur",
      addAdminError:
        "Impossible d’ajouter ce membre en tant qu’administrateur. Veuillez réessayer.",
      revokeAdminAccess: "Révoquer l’accès administrateur",
      cantRevokeAdminAccess:
        "Impossible de révoquer l'accès administrateur au contact technique",
      error: {
        removeAdmin:
          "Impossible de supprimer cet utilisateur en tant qu’Administrateur. Veuillez réessayer.",
        removeDomain: "Impossible de supprimer ce domaine. Veuillez réessayer.",
        removeDomainNameInvalid:
          "Veuillez saisir votre nom de domaine pour le réinitialiser.",
      },
      resetDomain: "Réinitialiser le domaine",
      resetDomainExplanation: ({ domainName }: { domainName?: string }) =>
        `Veuillez saisir <strong>${domainName}</strong> pour confirmer la réinitialisation du domaine.`,
    ...
    members: {
      ...
      closeAccountInfo: () => ({
        ...
        other:
          "Nous recommandons de fermer les comptes en toute sécurité afin d’éviter de les fermer dans le cas où il y aurait : <bullet-list><bullet-item>Des validations en attente</bullet-item><bullet-item>Des remboursements actifs</bullet-item><bullet-item>Aucune autre méthode de connexion</bullet-item></bullet-list>Sinon, vous pouvez ignorer les précautions de sécurité ci-dessus et forcer la fermeture des comptes sélectionnés.",
      }),
      error: {
        removeMember:
        ...
        vacationDelegate:
          "Impossible de définir cet utilisateur comme délégué de vacances. Veuillez réessayer.",
      },
    ...
    common: {
      ...
      forceTwoFactorAuthError:
        "L’activation forcée de l’authentification à deux facteurs n’a pas pu être modifiée. Veuillez réessayer plus tard.",
  ...
  proactiveAppReview: {
    ...
    description:
      "Faites-le-nous savoir afin que nous puissions rendre votre expérience de gestion de notes de frais encore meilleure.",
    positiveButton: "Oui !",
