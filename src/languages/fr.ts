...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            approvedPartnerTeamTitle: 'Découvrez votre équipe de partenaires Approved!',
            approvedPartnerTeamDescription: 'Une équipe dédiée pour aider votre cabinet à se développer, intégrer des clients plus rapidement et obtenir un support expert.',
            partnerManagerApprovedDescription: 'Maximisez votre partenariat et stimulez les recommandations',
            accountExecutiveDescription: 'Aidez les clients à se configurer avec succès',
            accountManagerApprovedDescription: 'Posez des questions et obtenez du support client',
