    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            biometrics: {
                ...
                test: 'Test',
                softPromptTitle: 'Vérifiez les transactions avec votre visage ou votre empreinte digitale',
                softPromptContent: 'Activez une vérification rapide et sécurisée avec votre visage ou votre empreinte digitale-aucun mot de passe ni code requis.',
                notificationTitle: 'Authentification réussie',
                notificationContent: 'Vous avez été authentifié avec Face ID.',
                biometricsTest: 'Test biométrique',
                errorPageTitle: "Oups, une erreur s'est produite.",
                errorPageContent: "Votre appareil n'a pas pu être enregistré.",
            },
        },
        debugConsole: {
