...
Si vous souhaitez prendre en charge la facturation de l’ensemble de son abonnement, demandez-lui d’abord de vous ajouter comme administrateur à tous ses espaces de travail avant de prendre en charge la facturation.`,
        ...
        exportAgainModal: {
            title: 'Attention !',
            description: (reportName: string, connectionName: ConnectionName) => `Les notes de frais suivantes ont déjà été exportées vers ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}. Voulez-vous vraiment les exporter à nouveau ?
