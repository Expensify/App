...
const translations = {
    common: {
        ...
        seePreview: 'Voir la prévisualisation',
        split: 'Nous avons remarqué que cette dépense a des articles avec plusieurs catégories. Souhaitez-vous diviser cette dépense ?',
        count: 'Compter',
        cancel: 'Annuler',
        dismiss: 'Ignorer',
        yes: 'Oui',
