...
3. Une fois le flux activé, cliquez sur Soumettre ci-dessous et nous nous chargerons de l’ajouter.`,
        ...
        accounting: {
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: 'Choisissez le compte bancaire avec lequel vos paiements de facturation centrale seront rapprochés.',
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `Assurez-vous que ce compte correspond à votre compte de règlement de facturation centrale (se terminant par ${lastFourPAN}) afin que le rapprochement continu fonctionne correctement.`,
            },
            syncTravelInvoicingSettlements: 'Synchroniser les règlements de facturation centrale',
        },
        export: {
