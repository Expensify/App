...
const translations = {
    ...
    termsOfUse: {
        terms: ({termsURL, privacyURL}: TermsOfUseRouteParams) =>
            `<comment><micro-text issmall>En vous connectant, vous acceptez les <a href="${termsURL}" style="color: #5ab0ff;">Conditions d'utilisation</a> et <a href="${privacyURL}" style="color: #5ab0ff;">Confidentialité</a>.</micro-text></comment>`,
        licenses: ({licensesURL}: LicensesParams) =>
            `<comment><micro-text issmall>La transmission d'argent est fournie par ${CONST.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS} (NMLS ID:2017010) conformément à ses <a href="${licensesURL}" style="color: #5ab0ff;">licences</a>.</micro-text></comment>`,
    },
    validateCodeForm: {
