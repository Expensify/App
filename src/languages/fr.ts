...
${amount} pour ${merchant} - ${date}`,
    ...
    activateCardPage: {
        ...
        fillInAllDetails: 'Veuillez renseigner tous les détails ci-dessous',
    },
    getPhysicalCard: {
...
Le forfait Control commence à 9 $ par Membre actif et par mois.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                enterShippingAddress: 'Saisir l’adresse de livraison',
                shippingAddressDescription: 'Indiquez-nous où nous devons envoyer la nouvelle carte.',
                promptCardholder: 'Inviter le titulaire de la carte',
                promptCardholderDescription: 'Le titulaire de la carte sera invité à saisir ou à confirmer son adresse de livraison.',
