...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        setPin: {
            didNotShipCard: "Nous n'avons pas expédié votre carte. Veuillez réessayer.",
        },
    },
    validateCodeModal: {
...
${amount} pour ${merchant} - ${date}`,
        ...
        confirmYourPin: 'Confirmer votre code PIN',
        enterFourDigitPin: 'Saisissez un code PIN à 4 chiffres pour votre carte.',
        reenterPinToConfirm: 'Saisissez à nouveau votre code PIN pour confirmer.',
        pinMustBeFourDigits: 'Le code PIN doit contenir exactement 4 chiffres.',
