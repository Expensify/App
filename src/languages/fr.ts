...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[fr] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[fr] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[fr] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[fr] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[fr] Get clients setup successfully',
            accountManagerApprovedDescription: '[fr] Ask questions and get client support',
            moreResources: '[fr] More resources',
        },
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[fr] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[fr] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[fr] Go to Gusto settings',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            gusto: {
                ...
                disconnect: '[fr] Disconnect',
                lastSync: (relativeDate: string) => `[fr] Last synced ${relativeDate}`,
                syncError: "[fr] Can't connect to Gusto",
                disconnectTitle: '[fr] Disconnect Gusto',
                disconnectPrompt: '[fr] Are you sure you want to disconnect Gusto?',
                ...
                notSet: '[fr] Not set',
                approvalModeDescription: '[fr] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[fr] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[fr] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[fr] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[fr] Basic approval',
                        description: '[fr] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[fr] Manager approval',
                        description: '[fr] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[fr] Custom approval',
                        description: '[fr] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[fr] Gusto sync results',
                    successTitle: '[fr] Successfully synced your Gusto connection!',
                    added: '[fr] Added',
                    removed: '[fr] Removed',
                    skipped: '[fr] Skipped',
                    employeeCount: () => ({
            ...
            zenefits: {
                ...
                disconnect: '[fr] Disconnect',
                lastSync: (relativeDate: string) => `[fr] Last synced ${relativeDate}`,
                syncError: "[fr] Can't connect to TriNet",
                disconnectTitle: '[fr] Disconnect TriNet',
                disconnectPrompt: '[fr] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[fr] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[fr] Approval mode',
                finalApprover: '[fr] Final approver',
                notSet: '[fr] Not set',
                approvalModeDescription: '[fr] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[fr] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[fr] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[fr] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[fr] Basic approval',
                    ...
                    manager: {
                        label: '[fr] Manager approval',
                        description: '[fr] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[fr] Custom approval',
                        description: "[fr] I'll manually setup approval workflows in Expensify.",
    ...
    search: {
        ...
        filters: {
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[fr] Central invoicing',
            },
            is: '[fr] Is',
            action: {
