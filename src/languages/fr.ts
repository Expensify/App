...
${amount} pour ${merchant} - ${date}`,
    ...
    privatePersonalDetails: {
        ...
        commuterExclusionsNote: ({workspaceName}: {workspaceName: string}) => `${workspaceName} utilise cette adresse pour les exclusions de trajet.`,
        error: {
...
3. Une fois le flux activé, cliquez sur Soumettre ci-dessous et nous nous chargerons de l’ajouter.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: 'Soustrayez le trajet de chaque membre entre son domicile et l’adresse de l’espace de travail de chaque réclamation de distance.',
                workspaceAddressRequired: {
                    title: 'Oups, pas si vite...',
                    prompt: 'Cet espace de travail n’a pas encore d’adresse. Ajoutez-en une pour que les exclusions de trajet puissent l’utiliser.',
                    cta: 'Ajouter une adresse',
                },
                errors: {
