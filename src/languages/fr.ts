...
const translations = {
    ...
    iou: {
        ...
        error: {
            ...
            receiptFailureMessage: `<rbr>Une erreur s'est produite lors du téléchargement de votre reçu. Veuillez <a href="retry">réessayer</a> ou <a href="download">enregistrer le reçu</a> à télécharger plus tard.</rbr>`,
