...
Voici un *reçu test* pour vous montrer comment ça fonctionne :`,
    ...
    domain: {
        ...
        members: {
            ...
            forceTwoFactorAuth: 'Forcer l’authentification à deux facteurs',
            forceTwoFactorAuthSAMLEnabledDescription: `<muted-text>Veuillez désactiver <a href="${CONST.SAML_HELP_URL}">SAML</a> pour imposer l’authentification à deux facteurs.</muted-text>`,
