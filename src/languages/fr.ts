...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        unsupportedDevice: {
            ...
            pleaseDownloadMobileApp: `<centered-text><muted-text>Cette action n'est pas prise en charge sur votre appareil. Veuillez télécharger l'application mobile Expensify depuis la <a href="${CONST.APP_DOWNLOAD_LINKS.IOS}">boutique App Store iOS</a> ou <a href="${CONST.APP_DOWNLOAD_LINKS.ANDROID}">Google Play Store</a> et réessayez.</muted-text></centered-text>`,
        },
        biometricsTest: {
