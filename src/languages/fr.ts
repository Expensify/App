...
const translations: TranslationDeepObject<typeof en> = {
    ...
    contacts: {
        ...
        helpText: 'Ajoutez plus de moyens pour envoyer des reçus. Transférez-les à <copy-text text="receipts@expensify.com"/> ou envoyez-les par SMS au 47777 (numéros américains uniquement).',
