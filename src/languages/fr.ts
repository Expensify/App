...
_Pour des instructions plus détaillées, [visitez notre site d’aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        rillet: {
            ...
            exportReimbursable: {label: 'Exporter les dépenses remboursables en tant que', values: {label: 'Factures fournisseurs'}},
            exportDate: {
            ...
            exportCompanyCard: {label: 'Exporter les dépenses de carte d’entreprise en tant que', values: {label: 'Cartes de crédit'}},
