...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    deviceManagementPage: {
        ...
        description: '[fr] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[fr] Revoke',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        people: {
            ...
            configureGustoSync: '[fr] Configure Gusto sync.',
            syncWithGusto: '[fr] Sync with Gusto',
            ...
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    ...
                    case 'mergeHRSyncTitle':
                        return '[fr] Synchronizing HR Employees';
                    case 'jobDone':
                        return '[fr] Waiting for imported data to load';
                    default: {
                        return `[fr] Translation missing for stage: ${stage}`;
...
Add more spend rules to protect company cash flow.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateName: (customUnitName: string, oldValue: string, newValue: string) => `[fr] renamed the ${customUnitName} rate "${oldValue}" to "${newValue}"`,
