...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            accountManager: '[fr] Account Manager',
            accountManagerDescription: "Poser des questions et obtenir l'assistance client",
            partnerManager: '[fr] Partner Manager',
            partnerManagerDescription: 'Optimisez votre partenariat et générez des recommandations',
            guideDescription: 'Votre spécialiste de configuration',
            approvedPartnerTeamTitle: 'Rencontrez votre équipe partenaire Approved!',
            approvedPartnerTeamDescription:
                "Une équipe dédiée, axée sur la croissance de votre cabinet, l'intégration plus rapide de vos clients et une assistance d'experts dès que vous en avez besoin.",
            accountExecutive: '[fr] Account Executive',
