...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        digits: 'chiffres',
        twoFactorCode: 'Code de vérification à deux facteurs',
...
(par ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
            ...
            enterMerchant: 'Saisissez le nom du commerçant',
        ...
        emptyLHN: {
            ...
            subtitleText1: 'Rechercher une discussion en utilisant le',
        ...
        skip: 'Ignorer',
        chatWithAccountManager: (accountManagerDisplayName: string) => `Besoin de quelque chose en particulier ? Discutez avec votre gestionnaire de compte, ${accountManagerDisplayName}.`,
        ...
        leaveWorkspaceConfirmationAdmin: 'Si vous quittez cet espace de travail, vous ne pourrez plus en gérer les paramètres.',
        leaveWorkspaceConfirmationApprover: ({workspaceOwner}: {workspaceOwner: string}) =>
            `Si vous quittez cet espace de travail, vous serez remplacé dans le workflow d’approbation par ${workspaceOwner}, le responsable de l’espace de travail.`,
    ...
    attachmentPicker: {
        ...
        expensifyDoesNotHaveAccessToCamera: 'Expensify ne peut pas prendre de photos sans accéder à votre appareil photo. Touchez Paramètres pour mettre à jour les autorisations.',
        ...
        maxFileLimitExceeded: 'Vous pouvez télécharger jusqu’à 30 reçus à la fois. Les reçus supplémentaires ne seront pas téléchargés.',
    ...
    multifactorAuthentication: {
        ...
        looksLikeYouRanOutOfTime: 'On dirait que le délai est dépassé ! Veuillez réessayer chez le commerçant.',
        ...
        revoke: {
            ...
            explanation:
                'La vérification via reconnaissance faciale/empreinte digitale ou passkey est activée sur un ou plusieurs appareils. La révocation de l’accès exigera un code magique pour la prochaine vérification sur n’importe quel appareil.',
    ...
    welcomeText: {
        ...
        anotherLoginPageIsOpenExplanation: 'Vous avez ouvert la page de connexion dans un autre onglet. Veuillez vous y connecter à partir de cet onglet.',
        welcome: 'Bienvenue !',
    ...
    samlSignIn: {
        welcomeSAMLEnabled: 'Continuer à se connecter avec l’authentification unique :',
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryDomainRoom: (domainRoom: string) =>
            `Cette discussion inclut tous les membres d’Expensify sur le domaine <strong>${domainRoom}</strong>. Utilisez-la pour discuter avec vos collègues, partager des astuces et poser des questions.`,
        ...
        beginningOfChatHistoryAnnounceRoom: (workspaceName: string) =>
            `Cette discussion est avec tout le monde dans <strong>${workspaceName}</strong>. Utilisez-la pour les annonces les plus importantes.`,
        ...
        askConcierge: 'Posez vos questions et obtenez une assistance en temps réel 24 h/24 et 7 j/7.',
    ...
    sidebarScreen: {
        ...
        redirectToExpensifyClassicModal: {
            ...
            description: 'Nous mettons encore au point quelques détails de New Expensify pour l’adapter à votre configuration spécifique. En attendant, rendez-vous sur Expensify Classic.',
        },
    },
    homePage: {
        forYou: 'Pour vous',
        timeSensitiveSection: {
            ...
            cta: 'Demande',
            offer50off: {
                title: 'Profitez de 50 % de réduction sur votre première année !',
            ...
            offer25off: {
                ...
                subtitle: ({days}: {days: number}) => `Il reste ${days} ${days === 1 ? 'jour' : 'jours'}`,
            },
            addShippingAddress: {
        ...
        discoverSection: {
            ...
            menuItemTitleAdmin: 'Découvrez comment inviter des membres, modifier les workflows d’approbation et rapprocher les cartes d’entreprise.',
    ...
    spreadsheet: {
        ...
        dragAndDropMultiLevelTag: `<muted-link>Glissez et déposez votre feuille de calcul ici, ou choisissez un fichier ci-dessous. <a href="${CONST.IMPORT_SPREADSHEET.MULTI_LEVEL_TAGS_ARTICLE_LINK}">En savoir plus</a> sur les formats de fichiers pris en charge.</muted-link>`,
        ...
        fieldNotMapped: (fieldName: string) => `Oups ! Un champ obligatoire (« ${fieldName} ») n’a pas été associé. Veuillez vérifier et réessayer.`,
        ...
        importPerDiemRatesSuccessfulDescription: ({rates}: {rates: number}) => (rates > 1 ? `${rates} taux journaliers ont été ajoutés.` : '1 taux de per diem a été ajouté.'),
        ...
        invalidFileMessage:
            'Le fichier que vous avez téléchargé est soit vide, soit contient des données invalides. Veuillez vous assurer que le fichier est correctement formaté et qu’il contient les informations nécessaires avant de le télécharger à nouveau.',
    ...
    receipt: {
        ...
        alternativeMethodsDownloadApp: ({downloadUrl}: {downloadUrl: string}) =>
            `<label-text><a href="${downloadUrl}">Téléchargez l’appli</a> pour scanner depuis votre téléphone</label-text>`,
        ...
        takePhoto: 'Prendre une photo',
        cameraAccess: "L'accès à l'appareil photo est obligatoire pour prendre des photos de reçus.",
        ...
        locationAccessMessage: 'L’accès à la localisation nous aide à conserver votre fuseau horaire et votre devise précis, où que vous alliez.',
        locationErrorTitle: 'Autoriser l’accès à la position',
        locationErrorMessage: 'L’accès à la localisation nous aide à conserver votre fuseau horaire et votre devise précis, où que vous alliez.',
    ...
    iou: {
        ...
        splitExpenseOneMoreSplit: 'Aucun partage ajouté. Ajoutez-en au moins un pour enregistrer.',
        ...
        pendingMatchWithCreditCardDescription: 'Reçu en attente de rapprochement avec une transaction de carte. Marquez-le comme espèces pour annuler.',
        ...
        duplicateTransaction: (isSubmitted: boolean) =>
            !isSubmitted
                ? 'Des dépenses potentiellement en double ont été identifiées. Examinez les doublons pour activer la soumission.'
        ...
        receiptMissingDetails: 'Détails manquants sur le reçu',
        missingAmount: 'Montant manquant',
        ...
        transactionPendingDescription: 'Transaction en attente. Cela peut prendre quelques jours avant d’être comptabilisée.',
        ...
        settleInvoicePersonal: (amount?: string, last4Digits?: string) => (amount ? `a payé ${amount} avec son compte personnel ${last4Digits}` : `Payé avec un compte personnel`),
        ...
        queuedToApproveViaDEW: 'mis en file d’attente pour approbation via le circuit d’approbation personnalisé',
        trackedAmount: (formattedAmount: string, comment?: string) => `suivi de ${formattedAmount}${comment ? `pour ${comment}` : ''}`,
        splitAmount: ({amount}: SplitAmountParams) => `fractionner ${amount}`,
        ...
        approvedAmount: (amount: number | string) => `montant approuvé ${amount}`,
        ...
        canceledRequest: (amount: string, submitterDisplayName: string) =>
            `a annulé le paiement de ${amount}, car ${submitterDisplayName} n’a pas activé son Portefeuille Expensify sous 30 jours`,
        ...
        basedOnMCC: ({rulesLink}: {rulesLink: string}) =>
            rulesLink ? `sur la base des <a href="${rulesLink}">règles de l’espace de travail</a>` : 'en fonction de la règle de l’espace de travail',
        ...
        error: {
            ...
            invalidSplitYourself: 'Veuillez saisir un montant non nul pour votre partage',
            ...
            receiptFailureMessage:
                '<rbr>Une erreur s’est produite lors du téléchargement de votre reçu. Veuillez <a href="download">enregistrer le reçu</a> et <a href="retry">réessayer</a> ultérieurement.</rbr>',
            ...
            manySplitsProvided: `Le nombre maximal de répartitions autorisé est de ${CONST.IOU.SPLITS_LIMIT}.`,
        ...
        dismissReceiptErrorConfirmation: 'Attention ! Ignorer cette erreur supprimera entièrement votre reçu téléchargé. Voulez-vous continuer ?',
        waitingOnEnabledWallet: ({submitterDisplayName}: WaitingOnBankAccountParams) =>
            `a commencé à régler. Le paiement est en attente jusqu’à ce que ${submitterDisplayName} active son portefeuille.`,
        enableWallet: 'Activer le porte-monnaie',
        hold: 'En attente',
        ...
        unheldExpense: 'a levé la retenue sur cette dépense',
        ...
        confirmApprovalAmount: 'Approuver uniquement les dépenses conformes, ou approuver l’ensemble de la note de frais.',
        ...
        holdEducationalTitle: 'Devez-vous conserver cette dépense ?',
        ...
        bookingArchivedDescription: 'Cette réservation est archivée car la date du voyage est dépassée. Ajoutez une dépense pour le montant final si nécessaire.',
        ...
        reject: {
            ...
            heldExpenseLeftBehindTitle: 'Les dépenses bloquées sont laissées de côté lorsque vous approuvez une note de frais entière.',
            ...
            rejectedStatus: 'Cette dépense a été rejetée. En attente de votre correction des problèmes et du marquage comme résolue pour permettre la soumission.',
            reportActions: {
        ...
        changeApprover: {
            ...
            header: ({workflowSettingLink}: WorkflowSettingsParam) =>
                `Choisissez une option pour modifier l’approbateur de cette note de frais. (Mettez à jour vos <a href="${workflowSettingLink}">paramètres d’espace de travail</a> pour modifier cela définitivement pour toutes les notes de frais.)`,
            ...
            addApprover: {
                subtitle: 'Choisissez un approbateur supplémentaire pour cette note de frais avant que nous la transmettions au reste du flux d’approbation.',
            },
        },
        chooseWorkspace: 'Choisir un espace de travail',
        routedDueToDEW: ({to}: RoutedDueToDEWParams) => `note de frais envoyée à ${to} en raison du workflow d’approbation personnalisé`,
        timeTracking: {
            hoursAt: (hours: number, rate: string) => `${hours} ${hours === 1 ? 'heure' : 'heures'} @ ${rate} / heure`,
            hrs: 'hheures',
            hours: 'Heures',
            ratePreview: (rate: string) => `${rate} / heure`,
            amountTooLargeError: 'Le montant total est trop élevé. Diminuez le nombre d’heures ou réduisez le taux.',
        },
        ...
        policyRulesModifiedFields: (policyRulesModifiedFields: PolicyRulesModifiedFields, policyRulesRoute: string, formatList: (list: string[]) => string) => {
            ...
            const fragments = entries.map(([key, value], i) => {
                ...
                return `${translations.common[key].toLowerCase()} vers « ${updatedValue} »`;
            });
    ...
    nextStep: {
        message: {
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_AUTOMATIC_SUBMIT]: ({actor, actorType, eta, etaType}: NextStepParams) => {
                ...
                switch (actorType) {
                    case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return `En attente que <strong>vos</strong> dépenses se soumettent automatiquement${formattedETA}.`;
                    case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.SUBMITTING_TO_SELF]: (_: NextStepParams) =>
                `Oups ! On dirait que vous soumettez cette note de frais à <strong>vous-même</strong>. L’approbation de vos propres notes de frais est <strong>interdite</strong> par votre espace de travail. Veuillez soumettre cette note de frais à une autre personne ou contacter votre administrateur pour changer la personne à qui vous soumettez.`,
        },
        eta: {
    ...
    contacts: {
        ...
        enterMagicCode: (contactMethod: string) => `Veuillez saisir le code magique envoyé à ${contactMethod}. Il devrait arriver dans une minute ou deux.`,
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            description:
                '<muted-text>Utilisez les outils ci-dessous pour dépanner l’expérience Expensify. Si vous rencontrez des problèmes, veuillez <concierge-link>soumettre un bug</concierge-link>.</muted-text>',
            ...
            destroy: 'Détruire',
            maskExportOnyxStateData: 'Masquer les données sensibles des membres lors de l’export de l’état Onyx',
            ...
            leftHandNavCache: 'Cache de navigation latérale gauche',
    ...
    mergeAccountsPage: {
        ...
        mergeFailureSAMLAccountDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Vous ne pouvez pas fusionner le compte <strong>${email}</strong> vers d’autres comptes, car l’administrateur de votre domaine l’a défini comme votre identifiant principal. Veuillez plutôt fusionner vos autres comptes avec celui-ci.</centered-text></muted-text>`,
        mergeFailure2FA: {
            description: ({email}: MergeFailureDescriptionGenericParams) =>
                `<muted-text><centered-text>Vous ne pouvez pas fusionner les comptes, car l’authentification à deux facteurs (2FA) est activée pour <strong>${email}</strong>. Veuillez désactiver la 2FA pour <strong>${email}</strong>, puis réessayer.</centered-text></muted-text>`,
        ...
        mergeFailureInvoicedAccountDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Vous ne pouvez pas fusionner des comptes dans <strong>${email}</strong> car ce compte possède une relation de facturation facturée.</centered-text></muted-text>`,
    ...
    lockAccountPage: {
        ...
        onceLocked: 'Une fois verrouillé, votre compte sera restreint dans l’attente d’une demande de déverrouillage et d’un examen de sécurité',
    },
    ...
    twoFactorAuth: {
        ...
        keepCodesSafe: 'Conservez précieusement ces codes de récupération !',
        ...
        twoFactorAuthIsRequiredXero: 'Votre connexion comptable Xero requiert une authentification à deux facteurs.',
    ...
    privateNotes: {
        title: 'Notes privées',
        personalNoteMessage: 'Conservez des notes sur cette discussion ici. Vous êtes la seule personne qui peut ajouter, modifier ou afficher ces notes.',
    ...
    billingCurrency: {
        ...
        note: `Remarque : la modification de votre devise de paiement peut avoir une incidence sur le montant que vous paierez pour Expensify. Consultez notre <a href="${CONST.PRICING}">page de tarification</a> pour plus de détails.`,
    },
    addDebitCardPage: {
    ...
    walletPage: {
        ...
        setDefaultSuccess: 'Moyen de paiement par défaut défini !',
        deleteAccount: 'Supprimer le compte',
        deleteConfirmation: 'Voulez-vous vraiment supprimer ce compte ?',
        deleteCard: 'Supprimer la carte',
        deleteCardConfirmation:
            'Toutes les transactions de carte non soumises, y compris celles figurant sur les notes de frais ouvertes, seront supprimées. Voulez-vous vraiment supprimer cette carte ? Vous ne pourrez pas annuler cette action.',
        error: {
        ...
        unshareBankAccountDescription:
            'Toutes les personnes ci-dessous ont accès à ce compte bancaire. Vous pouvez retirer l’accès à tout moment. Nous terminerons tout de même les paiements en cours.',
    ...
    cardPage: {
        ...
        markTransactionsDescription: 'Lorsque cette option est activée, les transactions importées de cette carte sont marquées comme remboursables par défaut.',
...
${amount} pour ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        workflowDescription: "Configurez un flux de travail dès le moment où la dépense a lieu, y compris l'approbation et le paiement.",
        ...
        disableApprovalPromptDescription: 'La désactivation des approbations effacera tous les circuits d’approbation existants.',
        ...
        customApprovalWorkflowEnabled:
            '<muted-text-label>Un processus d’approbation personnalisé est activé sur cet espace de travail. Pour examiner ou modifier ce processus, veuillez contacter votre <account-manager-link>gestionnaire de compte</account-manager-link> ou <concierge-link>Concierge</concierge-link>.</muted-text-label>',
        ...
        editor: {
            submissionFrequency: 'Choisissez le délai pendant lequel Expensify doit attendre avant de partager les dépenses sans erreur.',
        },
        frequencyDescription: 'Choisissez la fréquence à laquelle vous souhaitez que les dépenses soient soumises automatiquement, ou rendez cette action manuelle',
        frequencies: {
        ...
        approverInMultipleWorkflows: "Ce membre appartient déjà à un autre circuit d'approbation. Toute modification effectuée ici sera également répercutée là-bas.",
    ...
    reportFraudConfirmationPage: {
        ...
        description: 'Nous avons définitivement désactivé votre carte actuelle. Lorsque vous reviendrez voir les détails de votre carte, une nouvelle carte virtuelle sera disponible.',
        buttonText: 'C’est noté, merci !',
    },
    activateCardPage: {
        ...
        error: {
            ...
            throttled:
                'Vous avez saisi de façon incorrecte les 4 derniers chiffres de votre carte Expensify trop de fois. Si vous êtes sûr(e) que les numéros sont corrects, veuillez contacter Concierge pour résoudre le problème. Sinon, réessayez plus tard.',
        },
    },
    getPhysicalCard: {
        header: 'Obtenir une carte physique',
        nameMessage: 'Saisissez votre prénom et votre nom, car ils seront affichés sur votre carte.',
        legalName: 'Nom légal',
    ...
    expenseRulesPage: {
        ...
        subtitle: 'Ces règles s’appliqueront à vos dépenses. Si vous soumettez à un espace de travail, alors les règles de cet espace de travail peuvent les remplacer.',
        ...
        addRule: {
            ...
            confirmError: 'Saisissez le commerçant et appliquez au moins une modification',
        ...
        deleteRule: {
            ...
            deleteSinglePrompt: 'Êtes-vous sûr de vouloir supprimer cette règle ?',
    ...
    preferencesPage: {
        ...
        testSection: {
            ...
            subtitle: 'Paramètres pour aider à déboguer et tester l’application en environnement de préproduction.',
        },
        ...
        muteAllSounds: 'Couper tous les sons provenant d’Expensify',
    },
    priorityModePage: {
        priorityMode: 'Mode prioritaire',
        explainerText:
            'Choisissez si vous souhaitez #focus uniquement sur les discussions non lues et épinglées, ou tout afficher avec les discussions les plus récentes et épinglées en haut.',
        priorityModes: {
            default: {
                label: 'Plus récent',
                description: 'Afficher tous les chats triés par le plus récent',
            },
            gsd: {
                label: '#focus',
    ...
    termsOfUse: {
        ...
        license: `<muted-text-xs>La transmission de fonds est fournie par ${CONST.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS} (NMLS ID:2017010) conformément à ses <a href="${CONST.OLD_DOT_PUBLIC_URLS.LICENSES_URL}">licences</a>.</muted-text-xs>`,
    },
    validateCodeForm: {
    ...
    passwordForm: {
        ...
        error: {
            ...
            unableToResetPassword:
                'Nous n’avons pas pu changer votre mot de passe. Cela est probablement dû à un lien de réinitialisation expiré dans un ancien e-mail de réinitialisation de mot de passe. Nous vous avons envoyé un nouveau lien pour réessayer. Vérifiez votre boîte de réception et votre dossier de courrier indésirable ; il devrait arriver dans quelques minutes.',
            noAccess: "Vous n'avez pas accès à cette application. Veuillez ajouter votre nom d'utilisateur GitHub pour y avoir accès.",
    ...
    onboarding: {
        ...
        workEmailValidation: {
            title: 'Vérifier votre adresse e-mail professionnelle',
        ...
        tasks: {
            testDriveAdminTask: {
                ...
                description: ({testDriveURL}) =>
                    `[Faites une visite rapide du produit](${testDriveURL}) pour comprendre pourquoi Expensify est le moyen le plus rapide de gérer vos dépenses.`,
            },
                ...
                description: ({workspaceMoreFeaturesLink}) =>
                    dedent(`
                        *Ajoutez des approbations de dépenses* pour examiner les dépenses de votre équipe et les garder sous contrôle.
                        ...
                        7. Vous serez défini comme approbateur des dépenses. Vous pourrez changer cela pour n’importe quel administrateur une fois que vous aurez invité votre équipe.
            ...
            createWorkspaceTask: {
                ...
                description: ({workspaceSettingsLink}) =>
                    dedent(`
                        ...
                        *Votre nouvel espace de travail est prêt !* [Voir l'espace](${workspaceSettingsLink}).`),
            },
            setupCategoriesTask: {
...
${
    integrationName && CONST.connectionsVideoPaths[integrationName]
        ...
        : `[Accéder à la comptabilité](${workspaceAccountingLink}).`
            ...
            inviteTeamTask: {
                ...
                description: ({workspaceMembersLink}) =>
                    dedent(`
                        *Invitez votre équipe* sur Expensify pour qu’elle puisse commencer à suivre les dépenses dès aujourd’hui.

                        1. Cliquez sur *Espaces de travail*.
                        2. Sélectionnez votre espace de travail.
                        3. Cliquez sur *Membres* > *Inviter un membre*.
                        4. Saisissez les e-mails ou les numéros de téléphone.
            ...
            setupCategoriesAndTags: {
                ...
                description: ({workspaceCategoriesLink, workspaceAccountingLink}) =>
                    dedent(`
                        *Configurez les catégories et les tags* afin que votre équipe puisse coder les dépenses pour faciliter la création de rapports.
            ...
            setupTagsTask: {
                ...
                description: ({workspaceMoreFeaturesLink}) =>
                    dedent(`
                        Utilisez les tags pour ajouter des détails supplémentaires aux dépenses, comme les projets, les clients, les lieux et les services. Si vous avez besoin de plusieurs niveaux de tags, vous pouvez passer à l’offre Control.
            ...
            startChatTask: {
                ...
                description: dedent(`
                    *Démarrez une discussion* avec n'importe qui en utilisant son e-mail ou son numéro de téléphone.
                    ...
                    S'ils n'utilisent pas encore Expensify, ils seront automatiquement invités.

                    Chaque discussion deviendra également un e-mail ou un SMS auquel ils pourront répondre directement.
                `),
            },
            splitExpenseTask: {
                ...
                description: dedent(`
                    *Divisez des dépenses* avec une ou plusieurs personnes.
                    ...
                    N’hésitez pas à ajouter plus de détails si vous le souhaitez, ou envoyez-la simplement. Recevez votre remboursement rapidement !
                `),
            },
            ...
            onboardingManageTeamMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) =>
                isOnboardingFlow
                    ? dedent(`
                        ...
                        👋 Bonjour, je suis votre spécialiste de configuration Expensify. J’ai déjà créé un espace de travail pour vous aider à gérer les reçus et les dépenses de votre équipe. Pour profiter au maximum de votre essai gratuit de 30 jours, il vous suffit de suivre les étapes de configuration restantes ci-dessous !
                    `)
                    : dedent(`
                        # Votre essai gratuit a commencé ! Configurons tout cela.
                        👋 Bonjour, je suis votre spécialiste de configuration Expensify. Maintenant que vous avez créé un espace de travail, profitez au mieux de vos 30 jours d’essai gratuit en suivant les étapes ci-dessous !
                    `),
            onboardingTrackWorkspaceMessage:
                '# Configurons tout ça\n👋 Bonjour, je suis votre spécialiste de configuration Expensify. J’ai déjà créé un espace de travail pour vous aider à gérer vos reçus et dépenses. Pour profiter au maximum de votre essai gratuit de 30 jours, il vous suffit de suivre les dernières étapes de configuration ci-dessous !',
            onboardingChatSplitMessage: 'Partager des notes avec des amis est aussi simple qu’envoyer un message. Voici comment.',
            onboardingAdminMessage: 'Apprenez à gérer l’espace de travail de votre équipe en tant qu’administrateur et à soumettre vos propres dépenses.',
            onboardingLookingAroundMessage:
                'Expensify est surtout connu pour la gestion des dépenses, des voyages et des cartes d’entreprise, mais nous faisons bien plus que cela. Dites-moi ce qui vous intéresse et je vous aiderai à vous lancer.',
        ...
        workspace: {
            ...
            subtitle: 'Débloquez de puissants outils pour simplifier la gestion de vos dépenses, le tout en un seul endroit. Avec un espace de travail, vous pouvez :',
            explanationModal: {
                descriptionOne: 'Suivez et organisez les reçus',
                descriptionTwo: 'Catégorisez et taguez les dépenses',
        ...
        confirmWorkspace: {
            ...
            subtitle:
                'Créez un espace de travail pour suivre les reçus, rembourser les dépenses, gérer les déplacements, créer des notes de frais et bien plus — le tout à la vitesse d’un chat.',
        },
        inviteMembers: {
    ...
    featureTraining: {
        doNotShowAgain: 'Ne plus me montrer cela',
    },
    personalDetails: {
        error: {
    ...
    emailDeliveryFailurePage: {
        ...
        confirmThat: (login: string) =>
            `<strong>Confirmez que ${login} est orthographié correctement et qu’il s’agit d’une adresse e-mail réelle et valide.</strong> Les alias d’e-mail tels que « expenses@domain.com » doivent avoir accès à leur propre boîte de réception pour être des identifiants Expensify valides.`,
    ...
    notFound: {
        ...
        commentYouLookingForCannotBeFound: 'Le commentaire que vous cherchez est introuvable.',
    ...
    statusPage: {
        ...
        setVacationDelegate: `Définissez un remplaçant de vacances pour approuver les notes de frais en votre nom pendant que vous êtes absent du bureau.`,
        ...
        vacationDelegateWarning: ({nameOrEmail}: VacationDelegateParams) =>
            `Vous êtes en train d’assigner ${nameOrEmail} comme remplaçant pendant vos congés. Cette personne n’est pas encore dans tous vos espaces de travail. Si vous choisissez de continuer, un e-mail sera envoyé à tous les administrateurs de vos espaces de travail pour qu’ils l’ajoutent.`,
    },
    ...
    bankAccount: {
        ...
        plaidBodyCopy: 'Offrez à vos employé·es un moyen plus simple de payer — et d’être remboursé·es — pour les dépenses de l’entreprise.',
        checkHelpLine: 'Votre numéro de routage et votre numéro de compte se trouvent sur un chèque associé au compte.',
        ...
        hasCurrencyError: ({workspaceRoute}: WorkspaceRouteParams) =>
            `Oups ! Il semble que la devise de votre espace de travail soit différente du dollar américain (USD). Pour continuer, veuillez aller dans <a href="${workspaceRoute}">les paramètres de votre espace de travail</a> pour la définir sur USD, puis réessayez.`,
    ...
    onfidoStep: {
        ...
        butFirst: `Mais d’abord, les choses ennuyeuses. Lisez le jargon juridique à l’étape suivante puis cliquez sur « Accepter » quand vous êtes prêt.`,
        ...
        selfieIssue: 'Il y a un problème avec votre selfie/vidéo. Veuillez téléverser un selfie/vidéo en direct.',
    ...
    additionalDetailsStep: {
        ...
        ssnFull9Error: 'Veuillez saisir un numéro de SSN à neuf chiffres valide',
    ...
    termsStep: {
        ...
        standard: 'Standard',
        reviewTheFees: 'Jetez un œil à quelques frais.',
        ...
        shortTermsForm: {
            ...
            atmBalanceInquiry: 'Consultation du solde au guichet automatique (dans ou hors réseau)',
            ...
            fdicInsurance: 'Vos fonds sont admissibles à l’assurance FDIC.',
            generalInfo: `Pour obtenir des informations générales sur les comptes prépayés, consultez <a href="${CONST.CFPB_PREPAID_URL}">${CONST.TERMS.CFPB_PREPAID}</a>.`,
            conditionsDetails: `Pour plus de détails et pour connaître les conditions de tous les frais et services, visitez <a href="${CONST.FEES_URL}">${CONST.FEES_URL}</a> ou appelez le +1 833-400-0904.`,
            electronicFundsWithdrawalInstant: 'Retrait de fonds électronique (immédiat)',
        ...
        longTermsForm: {
            ...
            customerServiceDetails: 'Il n’y a aucuns frais de service à la clientèle.',
            ...
            electronicFundsInstantDetails: (percentage: string, amount: string) =>
                ...
                `Les frais s’élèvent à ${percentage}% du montant du transfert (avec des frais minimum de ${amount}).`,
    ...
    companyStep: {
        ...
        industryClassificationCodePlaceholder: 'Rechercher un code de classification de l’industrie',
    },
    requestorStep: {
    ...
    businessInfoStep: {
        ...
        whatsTheBusinessTaxIDEIN: (country: string) => {
            switch (country) {
                ...
                case CONST.COUNTRY.AU:
                    return 'Qu’est-ce que l’Australian Business Number (ABN) ?';
                default:
        ...
        whatsYourExpectedAverageReimbursements: 'Quel est le montant moyen de remboursement que vous prévoyez ?',
        ...
        incorporationCountry: 'Pays d’immatriculation',
        ...
        error: {
            ...
            taxIDEIN: (country: string) => {
                switch (country) {
                    case CONST.COUNTRY.US:
                        return 'Veuillez fournir un numéro d’identification employeur (EIN) valide';
                    case CONST.COUNTRY.CA:
    ...
    beneficialOwnerInfoStep: {
        ...
        regulationRequiresUsToVerifyTheIdentity: 'La réglementation nous impose de vérifier l’identité de toute personne détenant plus de 25 % de l’entreprise.',
        ...
        letsDoubleCheck: 'Vérifions une nouvelle fois que tout est correct.',
        legalName: 'Nom légal',
        address: 'Adresse',
        byAddingThisBankAccount: 'En ajoutant ce compte bancaire, vous confirmez que vous avez lu, compris et accepté',
        owners: 'Responsables',
    ...
    ownershipInfoStep: {
        ...
        whatsYourAddress: 'Quelle est votre adresse ?',
        whatAreTheLast: 'Quels sont les 4 derniers chiffres du numéro de Sécurité sociale du responsable ?',
        ...
        areThereOther: (companyName: string) => `Y a-t-il d’autres personnes qui possèdent 25 % ou plus de ${companyName} ?`,
        owners: 'Responsables',
        addCertified: 'Ajoutez un organigramme certifié qui indique les bénéficiaires effectifs',
        regulationRequiresChart:
            'La réglementation nous impose de recueillir une copie certifiée du schéma de propriété indiquant chaque personne ou entité détenant 25 % ou plus de l’entreprise.',
        ...
        certified: 'Organigramme certifié de propriété des entités',
        ...
        pleaseUpload:
            'Veuillez téléverser ci-dessous des documents supplémentaires pour nous aider à vérifier que vous êtes un propriétaire direct ou indirect de 25 % ou plus de l’entité commerciale.',
        ...
        proofOfBeneficialOwnerDescription:
            'Veuillez fournir une attestation signée et un organigramme émis par un expert-comptable, un notaire ou un avocat attestant de la détention de 25 % ou plus de l’entreprise. Ils doivent être datés de moins de trois mois et inclure le numéro de licence du signataire.',
        ...
        codiceFiscaleDescription:
            'Veuillez télécharger une vidéo d’une visite de site ou d’un appel enregistré avec le signataire. Le signataire doit fournir : nom complet, date de naissance, raison sociale, numéro d’immatriculation, numéro de code fiscal, adresse du siège social, nature de l’activité et objet du compte.',
    },
    completeVerificationStep: {
        ...
        isAuthorizedToUseBankAccountError: 'Vous devez être un dirigeant habilité à opérer sur le compte bancaire de l’entreprise',
    ...
    connectBankAccountStep: {
        ...
        description: `Sous 1 à 2 jours ouvrables, nous enverrons trois (3) petites transactions sur votre compte bancaire à partir d’un nom semblable à « Expensify, Inc. Validation ».`,
        ...
        enable2FAText: 'Nous prenons votre sécurité très au sérieux. Veuillez configurer l’A2F maintenant pour ajouter une couche supplémentaire de protection à votre compte.',
    ...
    signerInfoStep: {
        ...
        regulationRequiresUs: 'La réglementation nous oblige à vérifier si le signataire est habilité à effectuer cette action au nom de l’entreprise.',
        whatsYourName: 'Quel est votre nom légal ?',
        ...
        enterOneEmail: (companyName: string) => `Saisissez l’adresse e-mail d’un directeur de ${companyName}`,
        regulationRequiresOneMoreDirector: 'La réglementation exige au moins un autre administrateur comme signataire.',
        hangTight: 'Patientez un instant...',
        enterTwoEmails: (companyName: string) => `Saisissez les e-mails de deux directeurs de ${companyName}`,
        sendReminder: 'Envoyer un rappel',
        chooseFile: 'Choisir un fichier',
        weAreWaiting: 'Nous attendons que d’autres personnes vérifient leur identité en tant que dirigeants de l’entreprise.',
        ...
        `),
        pleaseUpload: 'Veuillez téléverser ci-dessous des documents supplémentaires afin de nous aider à vérifier votre identité en tant que dirigeant(e) de l’entreprise.',
        enterSignerInfo: 'Saisir les informations du signataire',
        thisStep: 'Cette étape a été terminée',
        isConnecting: ({bankAccountLastFour, currency}: SignerInfoMessageParams) =>
            `se connecte à un compte bancaire professionnel en ${currency} se terminant par ${bankAccountLastFour} sur Expensify pour payer des employés en ${currency}. L’étape suivante nécessite les informations de signature d’un membre de la direction.`,
        error: {
    ...
    agreementsStep: {
        ...
        regulationRequiresUs: 'La réglementation nous impose de vérifier l’identité de toute personne détenant plus de 25 % de l’entreprise.',
        ...
        iConsentToThePrivacyNoticeAccessibility: 'Je consens à la déclaration de confidentialité.',
        error: {
            authorized: 'Vous devez être un dirigeant habilité à opérer sur le compte bancaire de l’entreprise',
    ...
    docusignStep: {
        ...
        pleaseComplete:
            'Veuillez remplir le formulaire d’autorisation ACH en utilisant le lien Docusign ci-dessous, puis téléverser ici la copie signée afin que nous puissions prélever des fonds directement sur votre compte bancaire.',
        pleaseCompleteTheBusinessAccount: 'Veuillez compléter la demande de compte professionnel et l’autorisation de prélèvement automatique',
        pleaseCompleteTheDirect:
            'Veuillez compléter l’accord de prélèvement automatique en utilisant le lien Docusign ci-dessous, puis téléversez ici la copie signée afin que nous puissions prélever des fonds directement sur votre compte bancaire.',
    ...
    finishStep: {
        ...
        thanksFor:
            'Merci pour ces informations. Un agent d’assistance dédié va maintenant examiner vos données. Nous reviendrons vers vous si nous avons besoin d’autres éléments, mais en attendant, n’hésitez pas à nous contacter si vous avez des questions.',
        iHaveA: 'J’ai une question',
        enable2FA: 'Activer l’authentification à deux facteurs (2FA) pour prévenir la fraude',
        weTake: 'Nous prenons votre sécurité très au sérieux. Veuillez configurer l’A2F maintenant pour ajouter une couche supplémentaire de protection à votre compte.',
        secure: 'Sécurisez votre compte',
    },
    reimbursementAccountLoadingAnimation: {
        oneMoment: 'Un instant',
        explanationLine: 'Nous examinons vos informations. Vous pourrez poursuivre les étapes suivantes sous peu.',
    },
    session: {
    ...
    travel: {
        ...
        domainPermissionInfo: {
            ...
            restriction: (domain: string) =>
                `Vous n’avez pas l’autorisation d’activer Expensify Travel pour le domaine <strong>${domain}</strong>. Vous devrez plutôt demander à quelqu’un de ce domaine d’activer Travel.`,
        ...
        verifyCompany: {
            ...
            conciergeMessage: ({domain}: {domain: string}) =>
                `L’activation des voyages a échoué pour le domaine : ${domain}. Veuillez examiner la configuration et activer les voyages pour ce domaine.`,
        },
        updates: {
            ...
            flightScheduleChangeClosed: (airlineCode: string, startDate?: string) => `Changement de programme confirmé : le vol ${airlineCode} part désormais à ${startDate}.`,
            ...
            railTicketRefund: ({origin, destination, startDate}: RailTicketParams) =>
                `Votre billet de train de ${origin} → ${destination} pour le ${startDate} a été remboursé. Un avoir sera traité.`,
            ...
            railTicketUpdate: ({origin, destination, startDate}: RailTicketParams) => `Votre billet de train de ${origin} → ${destination} pour le ${startDate} a été mis à jour.`,
    ...
    workspace: {
        common: {
            ...
            reconcileCards: 'Lettrer les cartes',
            ...
            notAuthorized: `Vous n’avez pas accès à cette page. Si vous essayez de rejoindre cet espace de travail, demandez simplement au responsable de vous ajouter en tant que membre. Autre chose ? Contactez ${CONST.EMAIL.CONCIERGE}.`,
            ...
            goToWorkspaces: 'Accéder aux espaces de travail',
            ...
            youCantDowngradeInvoicing:
                'Vous ne pouvez pas rétrograder votre formule avec un abonnement facturé. Pour discuter ou apporter des modifications à votre abonnement, contactez votre chargé de compte ou Concierge pour obtenir de l’aide.',
            defaultCategory: 'Catégorie par défaut',
            viewTransactions: 'Afficher les opérations',
            policyExpenseChatName: ({displayName}: PolicyExpenseChatNameParams) => `Dépenses de ${displayName}`,
            deepDiveExpensifyCard: `<muted-text-label>Les transactions Expensify Card seront automatiquement exportées vers un « Compte de passif Expensify Card » créé avec <a href="${CONST.DEEP_DIVE_EXPENSIFY_CARD}">notre intégration</a>.</muted-text-label>`,
        },
        receiptPartners: {
            uber: {
                ...
                autoInvite: 'Inviter de nouveaux membres d’espace de travail à Uber for Business',
                autoRemove: 'Désactiver les membres d’espace de travail supprimés dans Uber for Business',
                emptyContent: {
        ...
        perDiem: {
            ...
            emptyList: {
                ...
                subtitle: 'Définissez des taux de per diem pour contrôler les dépenses quotidiennes des employé·e·s. Importez des taux à partir d’une feuille de calcul pour commencer.',
            },
        ...
        qbd: {
            exportOutOfPocketExpensesDescription: 'Définissez comment les dépenses hors de votre poche sont exportées vers QuickBooks Desktop.',
            ...
            exportExpensifyCard: 'Exporter les transactions de carte Expensify en',
            account: 'Compte',
            ...
            creditCardAccount: 'Compte carte de crédit',
            exportDate: {
            ...
            exportVendorBillDescription:
                'Nous créerons une facture fournisseur détaillée pour chaque note de frais Expensify et l’ajouterons au compte ci‑dessous. Si cette période est clôturée, nous l’enregistrerons au 1er jour de la prochaine période ouverte.',
            ...
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}Description`]:
                    'Nous associerons automatiquement le nom du commerçant de la transaction par carte de crédit à tout fournisseur correspondant dans QuickBooks. S’il n’existe aucun fournisseur, nous créerons un fournisseur « Dépenses diverses carte de crédit » pour l’association.',
            ...
            requiredSetupDevice: {
                ...
                body1: 'Vous devrez configurer cette connexion à partir de l’ordinateur qui héberge votre fichier de société QuickBooks Desktop.',
            ...
            accountingMethods: {
                ...
                alternateText: {
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]: 'Les dépenses payées de votre poche seront exportées une fois l’approbation finale obtenue',
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]: 'Les dépenses remboursées par vos soins seront exportées une fois payées',
                },
            },
        },
        qbo: {
            ...
            locationsLineItemsRestrictionDescription:
                'QuickBooks Online ne prend pas en charge les emplacements au niveau de ligne pour les chèques ou les factures fournisseur. Si vous souhaitez avoir des emplacements au niveau de ligne, assurez-vous d’utiliser des écritures de journal et des dépenses par carte de crédit/débit.',
            taxesJournalEntrySwitchNote:
                'QuickBooks Online ne prend pas en charge les taxes sur les écritures de journal. Veuillez modifier votre option d’export en facture fournisseur ou en chèque.',
            ...
            companyCardsLocationEnabledDescription:
                'QuickBooks Online ne prend pas en charge les lieux pour l’exportation des factures fournisseur. Comme les lieux sont activés sur votre espace de travail, cette option d’exportation n’est pas disponible.',
            outOfPocketTaxEnabledDescription:
            ...
            advancedConfig: {
                ...
                inviteEmployeesDescription: 'Importer les fiches employés QuickBooks Online et inviter les employés dans cet espace de travail.',
                createEntities: 'Créer automatiquement des entités',
                ...
                reimbursedReportsDescription:
                    'Chaque fois qu’une note de frais est payée via Expensify ACH, le règlement de facture correspondant sera créé dans le compte QuickBooks Online ci-dessous.',
            ...
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}Description`]:
                    'Nous associerons automatiquement le nom du commerçant figurant sur la transaction par carte de débit à tout fournisseur correspondant dans QuickBooks. S’il n’existe aucun fournisseur, nous créerons un fournisseur « Dépenses par carte de débit » pour l’association.',
            ...
            exportDestinationAccountsMisconfigurationError: {
                ...
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: 'Choisissez un compte valide pour l’exportation d’écriture de journal',
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]: 'Choisissez un compte valide pour l’exportation de chèque',
            },
            exportDestinationSetupAccountsInfo: {
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]: 'Pour utiliser l’exportation de factures fournisseurs, configurez un compte fournisseurs dans QuickBooks Online',
        ...
        xero: {
            ...
            mapTrackingCategoryTo: (categoryName: string) => `Mapper la catégorie Xero ${categoryName} à`,
            mapTrackingCategoryToDescription: (categoryName: string) => `Choisissez où faire correspondre ${categoryName} lors de l’export vers Xero.`,
            customers: 'Refacturer les clients',
            customersDescription:
                'Choisissez si vous souhaitez refacturer les clients dans Expensify. Vos contacts clients Xero peuvent être ajoutés en tant que tags aux Dépenses et seront exportés vers Xero en tant que facture de vente.',
            ...
            exportDeepDiveCompanyCard:
                'Les dépenses exportées seront comptabilisées en tant qu’opérations bancaires sur le compte bancaire Xero ci-dessous, et les dates des opérations correspondront aux dates figurant sur votre relevé bancaire.',
            bankTransactions: 'Transactions bancaires',
            xeroBankAccount: 'Compte bancaire Xero',
            xeroBankAccountDescription: 'Choisissez où les dépenses seront comptabilisées comme transactions bancaires.',
            ...
            advancedConfig: {
                ...
                purchaseBillStatusTitle: "Statut de facture d'achat",
            ...
            invoiceStatus: {
                label: "Statut de facture d'achat",
        ...
        sageIntacct: {
            ...
            reimbursableExpenses: {
                description: 'Définissez comment les dépenses remboursables sont exportées vers Sage Intacct.',
                values: {
            ...
            exportPreferredExporterNote:
                'L’exportateur préféré peut être n’importe quel administrateur d’espace de travail, mais doit aussi être un administrateur de domaine si vous définissez des comptes d’export différents pour chaque carte de société individuelle dans les paramètres de domaine.',
            ...
            inviteEmployeesDescription:
                'Importez les enregistrements d’employés Sage Intacct et invitez des employés dans cet espace de travail. Votre workflow d’approbation sera par défaut une approbation par le responsable et pourra être davantage configuré sur la page Membres.',
            syncReimbursedReports: 'Synchroniser les notes de frais remboursées',
            syncReimbursedReportsDescription:
                'Chaque fois qu’une note de frais est payée via ACH Expensify, le règlement de facture correspondant sera créé dans le compte Sage Intacct ci-dessous.',
        ...
        netsuite: {
            ...
            exportInvoices: 'Exporter les factures vers',
            journalEntriesTaxPostingAccount: 'Compte comptable pour la comptabilisation de la taxe des écritures journalisées',
            ...
            nonReimbursableJournalPostingAccount: 'Compte de saisie comptable non remboursable',
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: 'Entrée unique et détaillée pour chaque note de frais',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: 'Une seule ligne par dépense',
                },
            },
            invoiceItem: {
                ...
                values: {
                    [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
                        ...
                        description: 'Nous créerons une « ligne de facture Expensify » pour vous lors de l’export (si elle n’existe pas déjà).',
                    },
            ...
            exportDate: {
                ...
                values: {
                    ...
                    [CONST.NETSUITE_EXPORT_DATE.EXPORTED]: {
                        label: 'Date d’exportation',
                        description: 'Date d’export de la note de frais vers NetSuite.',
                    },
            ...
            exportDestination: {
                values: {
                    [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
                        ...
                        reimbursableDescription: 'Les dépenses payées de votre poche seront exportées vers NetSuite en tant que notes de frais.',
                        nonReimbursableDescription: 'Les dépenses de carte d’entreprise seront exportées vers NetSuite sous forme de notes de frais.',
                    },
                    [CONST.NETSUITE_EXPORT_DESTINATION.VENDOR_BILL]: {
                        label: 'Factures fournisseur',
                        reimbursableDescription: dedent(`
                            Les dépenses payées de votre poche seront exportées comme des factures à payer au fournisseur NetSuite indiqué ci-dessous.
                        ...
                        nonReimbursableDescription: dedent(`
                            Les dépenses par carte d’entreprise seront exportées en tant que factures à payer au fournisseur NetSuite indiqué ci-dessous.
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        reimbursableDescription: dedent(`
                            Les dépenses payées de votre poche seront exportées en tant qu’écritures comptables vers le compte NetSuite spécifié ci-dessous.

                            Si vous souhaitez définir un fournisseur spécifique pour chaque carte, accédez à *Paramètres > Domaines > Cartes de société*.
                        `),
                        nonReimbursableDescription: dedent(`
                            Les dépenses de carte d’entreprise seront exportées comme écritures comptables vers le compte NetSuite spécifié ci-dessous.
                ...
                expenseReportDestinationConfirmDescription:
                    'Si vous basculez le paramètre d’export de carte société vers les notes de frais, les fournisseurs NetSuite et les comptes de comptabilisation pour les cartes individuelles seront désactivés.\n\nNe vous inquiétez pas, nous conserverons quand même vos sélections précédentes au cas où vous souhaiteriez revenir en arrière plus tard.',
            },
            advancedConfig: {
                ...
                inviteEmployeesDescription:
                    'Importer les enregistrements d’employés NetSuite et inviter les employés dans cet espace de travail. Votre flux d’approbation sera par défaut une approbation par le responsable et pourra être configuré davantage sur la page *Membres*.',
                ...
                exportReportsTo: {
                    ...
                    values: {
                        ...
                        [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED]: "Uniquement l'approbation comptable",
            ...
            noItemsFoundDescription: 'Veuillez ajouter des postes de facture dans NetSuite et synchroniser à nouveau la connexion',
...
_Pour des instructions plus détaillées, [visitez notre site d’aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})._`,
                            customRecordInternalIDFooter: `Vous pouvez trouver les identifiants internes d'enregistrements personnalisés dans NetSuite en suivant ces étapes :

1. Saisissez « Transaction Line Fields » dans la recherche globale.
2. Cliquez sur un enregistrement personnalisé.
3. Recherchez l’identifiant interne sur le côté gauche.
...
_Pour des instructions plus détaillées, [consultez notre site d'aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                            ...
                            customSegmentScriptIDFooter: `Vous pouvez trouver les identifiants de script de segments personnalisés dans NetSuite sous : 

1. *Customization > Lists, Records, & Fields > Custom Segments*.
2. Cliquez sur un segment personnalisé.
3. Cliquez sur l’onglet *Application and Sourcing* près du bas, puis :
    a. Si vous souhaitez afficher le segment personnalisé comme un *tag* (au niveau ligne) dans Expensify, cliquez sur le sous‑onglet *Transaction Columns* et utilisez le *Field ID*.
...
_Pour des instructions plus détaillées, [consultez notre site d’aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})._`,
                    ...
                    customLists: {
                        ...
                        fields: {
                            listName: 'Nom',
                            internalID: 'ID interne',
                            transactionFieldID: 'ID de champ de transaction',
                            mapping: 'Affiché comme',
                        },
                        ...
                        addForm: {
                            ...
                            transactionFieldIDFooter: `Vous pouvez trouver les identifiants de champs de transaction dans NetSuite en suivant ces étapes :

1. Saisissez « Transaction Line Fields » dans la recherche globale.
2. Ouvrez une liste personnalisée.
...
_Pour des instructions plus détaillées, [visitez notre site d’aide](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})._`,
        ...
        intacct: {
            ...
            entity: 'Entité',
            employeeDefault: 'Par défaut d’employé Sage Intacct',
            ...
            displayedAsTagDescription: 'Le département sera sélectionnable pour chaque dépense individuelle sur la note de frais d’un employé.',
            displayedAsReportFieldDescription: 'La sélection de département s’appliquera à toutes les dépenses sur la note de frais d’un employé.',
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                enableFeed: {
                    ...
                    vcf: `1. Consultez [cet article d’aide](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP}) pour des instructions détaillées sur la configuration de vos cartes Visa Commercial.
...
3. *Une fois que vous disposez des informations sur le flux, continuez vers l’écran suivant.*`,
...
3. *Une fois que le flux est activé et que vous disposez de ses informations, passez à l'écran suivant.*`,
                    stripe: `1. Accédez au tableau de bord Stripe, puis à [Paramètres](${CONST.COMPANY_CARDS_STRIPE_HELP}).

2. Sous Intégrations de produits, cliquez sur Activer à côté d'Expensify.

3. Une fois le flux activé, cliquez sur Soumettre ci-dessous et nous commencerons à l'ajouter.`,
                },
                ...
                exitModal: {
                    ...
                    prompt: 'Nous avons remarqué que vous n’avez pas terminé d’ajouter vos cartes. Si vous avez rencontré un problème, dites-le-nous afin que nous puissions vous aider à remettre les choses sur les rails.',
            ...
            whoNeedsCardAssigned: "Qui a besoin qu'une carte soit assignée ?",
            ...
            startDateDescription: 'Choisissez votre date de début d’import. Nous synchroniserons toutes les transactions à partir de cette date.',
            ...
            brokenConnectionError:
                '<rbr>La connexion au flux de carte est rompue. Veuillez <a href="#">vous connecter à votre banque</a> afin que nous puissions rétablir la connexion.</rbr>',
            assignedCard: (assignee: string, link: string) => `${assignee} a été assigné à ${link} ! Les transactions importées apparaîtront dans cette discussion.`,
            ...
            unassignCardFailedError: "Échec du retrait de l'assignation de la carte.",
        ...
        expensifyCard: {
            ...
            issuedCard: (assignee: string) => `a émis une carte Expensify à ${assignee} ! La carte arrivera dans 2 à 3 jours ouvrables.`,
            ...
            issuedCardVirtual: ({assignee, link}: IssueVirtualCardParams) => `a délivré une carte Expensify virtuelle à ${assignee} ! Le ${link} peut être utilisé immédiatement.`,
            addedShippingDetails: (assignee: string) => `${assignee} a ajouté les détails d'expédition. La carte Expensify arrivera dans 2 à 3 jours ouvrables.`,
        ...
        categories: {
            ...
            spendCategoriesDescription: 'Personnalisez la façon dont les dépenses par commerçant sont catégorisées pour les transactions par carte de crédit et les reçus numérisés.',
        ...
        moreFeatures: {
            subtitle:
                'Utilisez les interrupteurs ci-dessous pour activer davantage de fonctionnalités à mesure que vous vous développez. Chaque fonctionnalité apparaîtra dans le menu de navigation pour une personnalisation plus poussée.',
            spendSection: {
                title: 'Dépenser',
                ...
                travelInvoicing: {
                    ...
                    centralInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            currentTravelSpendCta: 'Régler le solde',
            ...
            companyCards: {
                ...
                feed: {
                    title: 'Utiliser vos propres cartes (BYOC)',
                    subtitle: 'Rattachez les cartes que vous avez déjà pour l’import automatique des transactions, la correspondance des reçus et la réconciliation.',
                    features: {
                        support: 'Connectez des cartes de plus de 10 000 banques',
                        assignCards: 'Connectez les cartes existantes de votre équipe',
                ...
                disableCardTitle: 'Désactiver les cartes professionnelles',
                disableCardPrompt:
                ...
                cardFeedTransactionDescription: 'Choisissez si les détenteurs de carte peuvent supprimer les transactions par carte. Les nouvelles transactions suivront ces règles.',
                ...
                setFeedNameDescription: 'Donnez un nom unique au flux de cartes pour pouvoir le distinguer des autres',
                ...
                pendingFeedDescription: `Nous examinons actuellement les détails de votre flux. Une fois que ce sera fait, nous vous contacterons via`,
                pendingBankTitle: 'Vérifiez la fenêtre de votre navigateur',
                pendingBankDescription: (bankName: string) => `Veuillez vous connecter à ${bankName} via la fenêtre de votre navigateur qui vient de s’ouvrir. Si aucune ne s’est ouverte,`,
                ...
                downgradeSubTitle: `Cet espace de travail ne peut pas être rétrogradé, car plusieurs flux de cartes sont connectés (à l’exception des cartes Expensify). Veuillez <a href="#">ne conserver qu’un seul flux de cartes</a> pour continuer.`,
            ...
            workflows: {
                ...
                disableApprovalPrompt:
                    "Les cartes Expensify de cet espace de travail s'appuient actuellement sur l'approbation pour définir leurs Smart Limits. Veuillez modifier les types de limite de toutes les cartes Expensify avec Smart Limits avant de désactiver les approbations.",
            },
            invoices: {
                title: 'Factures',
            ...
            workflowWarningModal: {
                featureEnabledTitle: 'Pas si vite…',
                featureEnabledText:
                    'Les cartes Expensify de cet espace de travail s’appuient sur des workflows d’approbation pour définir leurs Smart Limits.\n\nVeuillez modifier les types de limites de toutes les cartes avec Smart Limits avant de désactiver les workflows.',
                confirmText: 'Accéder aux cartes Expensify',
            },
            rules: {
                title: 'Règles',
        ...
        reportFields: {
            ...
            listValuesInputSubtitle: 'Ces valeurs apparaîtront dans votre liste déroulante de champs de note de frais. Les valeurs activées peuvent être sélectionnées par les membres.',
        ...
        tags: {
            ...
            emptyTags: {
                ...
                subtitle: 'Ajoutez un tag pour suivre les projets, les sites, les services, et plus encore.',
                ...
                subtitleWithAccounting: (accountingPageURL: string) =>
                    `<muted-text><centered-text>Vos tags sont actuellement en cours d'importation depuis une connexion comptable. Rendez-vous dans la section <a href="${accountingPageURL}">comptabilité</a> pour effectuer des modifications.</centered-text></muted-text>`,
            },
            deleteTag: 'Supprimer le tag',
            deleteTags: 'Supprimer des tags',
            ...
            switchSingleToMultiLevelTagWarning: {
                ...
                prompt6: 'sur les niveaux de tags.',
            },
            ...
            importedTagsMessage: (columnCounts: number) =>
                `Nous avons trouvé *${columnCounts} colonnes* dans votre feuille de calcul. Sélectionnez *Nom* à côté de la colonne qui contient les noms de tags. Vous pouvez aussi sélectionner *Activé* à côté de la colonne qui définit le statut des tags.`,
        ...
        emptyWorkspace: {
            ...
            description: 'Les salons sont un excellent moyen de discuter et de travailler avec plusieurs personnes. Pour commencer à collaborer, créez ou rejoignez un espace de travail',
        },
        new: {
        ...
        people: {
            ...
            removeMembersWarningPrompt: ({memberName, ownerName}: RemoveMembersWarningPrompt) =>
                `${memberName} est un approbateur dans cet espace de travail. Lorsque vous ne partagerez plus cet espace de travail avec cette personne, nous la remplacerons dans le circuit d’approbation par le responsable de l’espace de travail, ${ownerName}`,
            removeMembersTitle: () => ({
            ...
            cannotRemoveUserDueToReport: ({memberName}: {memberName: string}) =>
                `${memberName} a une note de frais en cours de traitement sur laquelle agir. Veuillez lui demander d’effectuer l’action requise avant de le retirer de l’espace de travail.`,
        },
        card: {
            getStartedIssuing: 'Commencez en émettant votre première carte virtuelle ou physique.',
            issueCard: 'Émettre une carte',
            issueNewCard: {
                ...
                giveItNameInstruction: 'Rendez-la suffisamment unique pour la distinguer des autres cartes. Des cas d’utilisation précis, c’est encore mieux !',
                cardName: 'Nom de la carte',
                letsDoubleCheck: 'Vérifions une nouvelle fois que tout est correct.',
            ...
            deactivateCardModal: {
                ...
                deactivateCard: 'Désactiver la carte',
                deactivateConfirmation: 'La désactivation de cette carte refusera toutes les transactions futures et est irréversible.',
            },
        },
        accounting: {
            settings: 'paramètres',
            ...
            talkYourAccountManager: 'Discutez avec votre responsable de compte.',
            ...
            errorODIntegration: (oldDotPolicyConnectionsURL: string) =>
                `Une erreur s’est produite avec une connexion qui a été configurée dans Expensify Classic. [Allez sur Expensify Classic pour corriger ce problème.](${oldDotPolicyConnectionsURL})`,
            ...
            claimOffer: {
                ...
                xero: {
                    headline: 'Bénéficiez de Xero gratuitement pendant 6 mois !',
                    description:
                        '<muted-text><centered-text>Nouveau sur Xero ? Les clients d’Expensify bénéficient de 6 mois gratuits. Profitez de cette offre ci-dessous.</centered-text></muted-text>',
                    connectButton: 'Connecter à Xero',
                },
                uber: {
                    headerTitle: 'Uber for Business',
                    headline: 'Obtenez 5 % de réduction sur les trajets Uber',
                    description: `<muted-text><centered-text>Activez Uber for Business via Expensify et économisez 5 % sur tous les trajets professionnels jusqu'en juin. <a href="${CONST.UBER_TERMS_LINK}">Des conditions s'appliquent.</a></centered-text></muted-text>`,
                ...
                syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                    switch (stage) {
                        ...
                        case 'quickbooksOnlineSyncTaxCodes':
                            return 'Importation des codes TVA';
                        ...
                        case 'xeroSyncExpensifyReimbursedReports':
                            return 'Marquer les factures Xero comme payées';
                        ...
                        case 'netSuiteSyncExpensifyReimbursedReports':
                            return 'Marquer les factures et avoirs NetSuite comme payés';
        ...
        distanceRates: {
            ...
            workspaceNeeds: 'Un espace de travail a besoin d’au moins un taux de distance activé.',
            distance: 'Distance',
        ...
        bankAccount: {
            ...
            disconnectYourBankAccount: (bankName: string) =>
                `Dissociez votre compte bancaire <strong>${bankName}</strong>. Toutes les transactions en cours pour ce compte seront quand même exécutées.`,
            ...
            updateCurrencyPrompt:
                'Il semble que votre espace de travail utilise actuellement une devise différente du USD. Veuillez cliquer sur le bouton ci-dessous pour mettre à jour votre devise sur USD maintenant.',
            ...
            chooseAnExisting: 'Choisissez un compte bancaire existant pour payer des dépenses ou ajoutez-en un nouveau.',
        },
        changeOwner: {
            ...
            amountOwedText: 'Ce compte présente un solde impayé d’un mois précédent.\n\nVoulez-vous remettre ce solde à zéro et prendre en charge la facturation de cet espace de travail ?',
...
Voulez-vous régler ce montant (${amount}) afin de reprendre la facturation de cet espace de travail ? Votre carte de paiement sera débitée immédiatement.`,
            ...
            subscriptionText: (usersCount: number, finalCount: number) =>
                `La reprise de cet espace de travail fusionnera son abonnement annuel avec votre abonnement actuel. Cela augmentera la taille de votre abonnement de ${usersCount} membres, portant ainsi votre nouvel abonnement à ${finalCount}. Souhaitez-vous continuer ?`,
...
Voulez-vous vraiment les exporter à nouveau ?`,
        ...
        upgrade: {
            reportFields: {
                title: 'Champs de note de frais',
                description: `Les champs de note de frais vous permettent de spécifier des détails au niveau de l’en-tête, distincts des tags qui se rapportent aux dépenses des postes individuels. Ces détails peuvent inclure des noms de projets spécifiques, des informations sur les déplacements professionnels, des emplacements, et plus encore.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Les champs de note de frais sont uniquement disponibles avec l’abonnement Control, à partir de <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `par membre et par mois.` : `par membre actif et par mois.`}</muted-text>`,
            },
            [CONST.POLICY.CONNECTIONS.NAME.NETSUITE]: {
                title: 'NetSuite',
                description: `Profitez d’une synchronisation automatisée et réduisez les saisies manuelles grâce à l’intégration Expensify + NetSuite. Obtenez des informations financières détaillées et en temps réel avec la prise en charge des segments natifs et personnalisés, y compris la correspondance des projets et des clients.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Notre intégration NetSuite est disponible uniquement avec le forfait Control, à partir de <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `par membre et par mois.` : `par membre actif et par mois.`}</muted-text>`,
            },
            [CONST.POLICY.CONNECTIONS.NAME.SAGE_INTACCT]: {
                title: 'Sage Intacct',
                description: `Profitez de la synchronisation automatisée et réduisez les saisies manuelles grâce à l’intégration Expensify + Sage Intacct. Obtenez des analyses financières détaillées et en temps réel avec des dimensions définies par l’utilisateur, ainsi qu’un codage des dépenses par service, classe, lieu, client et projet (mission).`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            glAndPayrollCodes: {
                title: 'Codes de GL et de paie',
                description: `Ajoutez des codes de GL et de paie à vos catégories pour faciliter l’export des dépenses vers vos systèmes de comptabilité et de paie.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            rules: {
                title: 'Règles',
                description: `Les règles fonctionnent en arrière-plan et maintiennent vos dépenses sous contrôle, pour que vous n’ayez pas à vous soucier des détails.

Exigez des détails de dépense comme les reçus et les descriptions, définissez des limites et des valeurs par défaut, et automatisez les approbations et les paiements – le tout à un seul endroit.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Les règles sont uniquement disponibles avec l’offre Control, à partir de <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `par membre et par mois.` : `par membre actif et par mois.`}</muted-text>`,
            },
            perDiem: {
                title: 'Indemnité journalière',
                description:
                    'Les indemnités journalières sont un excellent moyen de garder vos coûts quotidiens conformes et prévisibles lorsque vos employé(e)s voyagent. Profitez de fonctionnalités comme des taux personnalisés, des catégories par défaut et des détails plus granulaires comme les destinations et les sous-taux.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            travel: {
                title: 'Déplacements',
                description:
                    'Expensify Travel est une nouvelle plateforme de réservation et de gestion des voyages d’affaires qui permet aux membres de réserver des hébergements, des vols, des moyens de transport et plus encore.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Travel est disponible avec l’abonnement Collect, à partir de <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `par membre et par mois.` : `par membre actif et par mois.`}</muted-text>`,
            },
            reports: {
            ...
            multiLevelTags: {
                ...
                description:
                    'Les tags multi-niveaux vous aident à suivre les dépenses avec plus de précision. Assignez plusieurs tags à chaque poste, comme le service, le client ou le centre de coûts, afin de capturer le contexte complet de chaque dépense. Cela permet des rapports plus détaillés, des workflows d’approbation optimisés et des exports comptables plus précis.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            completed: {
                ...
                successMessage: ({policyName, subscriptionLink}: UpgradeSuccessMessageParams) =>
                    `<centered-text>Vous avez réussi à faire passer ${policyName} au plan Control&nbsp;! <a href="${subscriptionLink}">Voir votre abonnement</a> pour plus de détails.</centered-text>`,
                categorizeMessage: `Vous êtes passé avec succès au forfait Collect. Vous pouvez désormais catégoriser vos dépenses !`,
                travelMessage: `Vous êtes passé avec succès au forfait Collect. Vous pouvez maintenant commencer à réserver et gérer vos voyages !`,
            ...
            commonFeatures: {
                ...
                benefits: {
                    startsAtFull: ({learnMoreMethodsRoute, formattedPrice, hasTeam2025Pricing}: LearnMoreRouteParams) =>
                        `<muted-text>Le plan Control commence à <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `par membre et par mois.` : `par membre actif et par mois.`} <a href="${learnMoreMethodsRoute}">En savoir plus</a> sur nos plans et nos prix.</muted-text>`,
                    benefit1: 'Connexions comptables avancées (NetSuite, Sage Intacct et plus)',
                    benefit2: 'Règles de dépenses intelligentes',
                    benefit3: 'Workflows d’approbation multi-niveaux',
        ...
        downgrade: {
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit4: 'Contrôles de sécurité renforcés',
                    headsUp: 'Attention !',
                    multiWorkspaceNote: 'Vous devez rétrograder tous vos espaces de travail avant votre premier paiement mensuel pour commencer un abonnement au tarif Collect. Cliquez',
        ...
        restrictedAction: {
            ...
            youWillNeedToAddOrUpdatePaymentCard: 'Vous devez ajouter ou mettre à jour la carte de paiement enregistrée pour débloquer les nouvelles activités de l’espace de travail.',
        ...
        rules: {
            individualExpenseRules: {
                ...
                subtitle: (categoriesPageLink: string, tagsPageLink: string) =>
                    `<muted-text>Définissez des contrôles de dépenses et des paramètres par défaut pour les dépenses individuelles. Vous pouvez également créer des règles pour les <a href="${categoriesPageLink}">catégories</a> et les <a href="${tagsPageLink}">tags</a>.</muted-text>`,
                receiptRequiredAmount: 'Montant avec reçu obligatoire',
                ...
                itemizedReceiptRequiredAmount: 'Montant requis pour un reçu détaillé',
                ...
                cashExpenseDefault: 'Valeur par défaut pour les dépenses en espèces',
                cashExpenseDefaultDescription:
                    'Choisissez comment les dépenses en espèces doivent être créées. Une dépense est considérée comme une dépense en espèces si elle n’est pas une transaction de carte professionnelle importée. Cela inclut les dépenses créées manuellement, les reçus, les indemnités journalières, les dépenses de distance et de temps.',
                reimbursableDefault: 'Remboursable',
                reimbursableDefaultDescription: 'Les remboursements de dépenses sont le plus souvent versés aux employés',
                ...
                billableDefaultDescription: (tagsPageLink: string) =>
                    `<muted-text>Choisissez si les dépenses en espèces et par carte de crédit doivent être refacturables par défaut. Les dépenses refacturables sont activées ou désactivées dans les <a href="${tagsPageLink}">tags</a>.</muted-text>`,
                billable: 'Facturable',
                ...
                prohibitedDefaultDescription:
                    'Signalez tous les reçus où figurent de l’alcool, des jeux d’argent ou d’autres articles restreints. Les dépenses avec des reçus comportant ces lignes d’articles nécessiteront un examen manuel.',
                ...
                requireCompanyCard: 'Exiger les cartes de société pour tous les achats',
                requireCompanyCardDescription: 'Marquer toutes les dépenses en espèces, y compris le kilométrage et les indemnités journalières.',
            },
            expenseReportRules: {
                title: 'Avancé',
            ...
            merchantRules: {
                title: 'Commerçant',
                subtitle: 'Définissez les règles de marchand pour que les dépenses arrivent correctement codées et nécessitent moins de nettoyage.',
                ...
                ruleSummaryTitle: (merchantName: string, isExactMatch: boolean) => `Si le commerçant ${isExactMatch ? 'correspond exactement à' : 'contient'} « ${merchantName} »`,
            ...
            categoryRules: {
                ...
                expenseLimitTypes: {
                    ...
                    expenseSubtitle:
                        'Signaler les montants de dépenses par catégorie. Cette règle remplace la règle générale de l’espace de travail concernant le montant maximal de dépense.',
                    daily: 'Total de la catégorie',
                    dailySubtitle: 'Signaler le total quotidien par catégorie par note de frais.',
                },
                requireReceiptsOver: 'Exiger les reçus au‑delà de',
            ...
            customRules: {
                ...
                cardSubtitle: 'C’est ici que se trouve la politique de dépenses de votre équipe, pour que tout le monde soit aligné sur ce qui est pris en charge.',
            },
        },
        planTypePage: {
            planTypes: {
            ...
            lockedPlanDescription: ({count, annualSubscriptionEndDate}: WorkspaceLockedPlanTypeParams) => ({
                one: `Vous vous êtes engagé à avoir 1 membre actif sur l’offre Control jusqu’à la fin de votre abonnement annuel, le ${annualSubscriptionEndDate}. Vous pourrez passer à un abonnement à l’usage et rétrograder vers l’offre Collect à partir du ${annualSubscriptionEndDate} en désactivant le renouvellement automatique dans`,
                other: `Vous vous êtes engagé·e pour ${count} membres actifs sur l’offre Control jusqu’à la fin de votre abonnement annuel le ${annualSubscriptionEndDate}. Vous pourrez passer à un abonnement à l’usage et rétrograder vers l’offre Collect à partir du ${annualSubscriptionEndDate} en désactivant le renouvellement automatique dans`,
            }),
    ...
    getAssistancePage: {
        ...
        questionMarkButtonTooltip: 'Obtenir de l’aide de notre équipe',
    ...
    workspaceActions: {
        ...
        updateApprovalRule: ({field, name, newApproverEmail, newApproverName, oldApproverEmail, oldApproverName}: UpdatedPolicyApprovalRuleParams) => {
            ...
            return `a changé l’approbateur pour le/la ${field} « ${name} » en ${formatApprover(newApproverName, newApproverEmail)} (précédemment ${formatApprover(oldApproverName, oldApproverEmail)})`;
        },
        ...
        updateCategoryExpenseLimitType: ({categoryName, oldValue, newValue}: UpdatedPolicyCategoryExpenseLimitTypeParams) => {
            ...
            return `a modifié le type de plafond de la catégorie « ${categoryName} » en ${newValue} (auparavant ${oldValue})`;
        },
        ...
        updateCategoryMaxAmountNoItemizedReceipt: ({categoryName, oldValue, newValue}: UpdatedPolicyCategoryMaxAmountNoReceiptParams) => {
            if (!oldValue) {
                return `a mis à jour la catégorie « ${categoryName} » en remplaçant les reçus détaillés par ${newValue}`;
            }
        ...
        updatedDescriptionHint: ({categoryName, oldValue, newValue}: UpdatedPolicyCategoryDescriptionHintTypeParams) => {
            ...
            return !oldValue
                ...
                : `a modifié l’info-bulle de description de la catégorie « ${categoryName} » en « ${newValue} » (auparavant « ${oldValue} »)`;
        },
        ...
        deleteMultipleTags: ({count, tagListName}: UpdatedPolicyTagParams) => `a retiré « ${count} » tags de la liste « ${tagListName} »`,
        ...
        updateCustomUnitTaxEnabled: ({newValue}: UpdatePolicyCustomUnitTaxEnabledParams) => `${newValue ? 'activé' : 'Désactivé'} suivi de la taxe sur les taux de distance`,
        ...
        preventSelfApproval: ({oldValue, newValue}: UpdatedPolicyPreventSelfApprovalParams) =>
            `mis à jour « Empêcher l’auto-approbation » sur « ${newValue === 'true' ? 'Activé' : 'Désactivé'} » (auparavant « ${oldValue === 'true' ? 'Activé' : 'Désactivé'} »)`,
        ...
        updateDefaultReimbursable: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) =>
            `a mis à jour « Valeur par défaut des dépenses en espèces » en « ${newValue} » (précédemment « ${oldValue} »)`,
        ...
        removedFromApprovalWorkflow: ({submittersNames}: RemovedFromApprovalWorkflowParams) => {
            ...
            return {
                one: `vous a retiré(e) du flux d'approbation et du chat de dépenses de ${joinedNames}. Les notes de frais précédemment soumises resteront disponibles pour approbation dans votre boîte de réception.`,
        ...
        demotedFromWorkspace: (policyName: string, oldRole: string) =>
            `a mis à jour votre rôle dans ${policyName} de ${oldRole} à utilisateur. Vous avez été retiré de tous les chats de dépenses des déclarants, sauf des vôtres.`,
        ...
        updatedWorkspaceFrequencyAction: ({oldFrequency, newFrequency}: UpdatedPolicyFrequencyParams) =>
            `a mis à jour la fréquence de génération automatique de notes de frais sur « ${newFrequency} » (au lieu de « ${oldFrequency} »)`,
        ...
        setAutoPayApprovedReportsLimit: ({newLimit}: {newLimit: string}) => `définir le seuil de paiement automatique des notes de frais approuvées sur « ${newLimit} »`,
        updatedAutoPayApprovedReportsLimit: ({oldLimit, newLimit}: {oldLimit: string; newLimit: string}) =>
            `a modifié le seuil de règlement automatique des notes de frais approuvées à « ${newLimit} » (précédemment « ${oldLimit} »)`,
        ...
        changedSubmitsToApprover: ({
            ...
            if (wasDefaultApprover && previousApprover) {
                ...
                text += '(précédemment approbateur par défaut)';
        ...
        changedSubmitsToDefault: ({
            ...
            let text = approver
                ? `a modifié le processus d’approbation pour ${members} afin qu’ils soumettent leurs notes de frais à l’approbateur par défaut ${approver}`
        ...
        changedForwardsTo: ({approver, forwardsTo, previousForwardsTo}: {approver: string; forwardsTo: string; previousForwardsTo?: string}) =>
            previousForwardsTo
                ? `a modifié le flux d’approbation pour ${approver} afin de transférer les notes de frais approuvées à ${forwardsTo} (précédemment transférées à ${previousForwardsTo})`
                : `a modifié le workflow d’approbation pour ${approver} afin de transférer les notes de frais approuvées à ${forwardsTo} (auparavant, les notes de frais approuvées définitivement)`,
        removedForwardsTo: ({approver, previousForwardsTo}: {approver: string; previousForwardsTo?: string}) =>
            previousForwardsTo
                ...
                : `a modifié le processus d’approbation pour ${approver} afin d’arrêter de transférer les notes de frais approuvées`,
        ...
        changedReimburser: ({newReimburser, previousReimburser}: UpdatedPolicyReimburserParams) =>
            previousReimburser ? `a modifié le payeur autorisé en « ${newReimburser} » (précédemment « ${previousReimburser} »)` : `a modifié le payeur autorisé en « ${newReimburser} »`,
        ...
        setReceiptRequiredAmount: ({newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `définir le montant requis pour le reçu sur « ${newValue} »`,
        ...
        removedMaxExpenseAmount: ({oldValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `a supprimé le montant maximal de la dépense (auparavant « ${oldValue} »)`,
        setMaxExpenseAge: ({newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `définir l’ancienneté maximale d’une dépense sur « ${newValue} » jours`,
        ...
        removedMaxExpenseAge: ({oldValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `a supprimé l’ancienneté maximale des dépenses (précédemment « ${oldValue} » jours)`,
    },
    roomMembersPage: {
    ...
    task: {
        ...
        assigneeError: 'Une erreur s’est produite lors de l’assignation de cette tâche. Veuillez choisir un autre assigné.',
        genericCreateTaskFailureMessage: "Une erreur s'est produite lors de la création de cette tâche. Veuillez réessayer ultérieurement.",
    ...
    search: {
        ...
        groupColumns: 'Grouper les colonnes',
        expenseColumns: 'Colonnes des dépenses',
        statements: 'Relevés',
        ...
        exportSearchResults: {
            ...
            description: 'Ça fait beaucoup d’éléments ! Nous allons tout regrouper et Concierge vous enverra un fichier sous peu.',
        },
    ...
    fileDownload: {
        success: {
            ...
            qrMessage:
                'Vérifiez votre dossier de photos ou de téléchargements pour y trouver une copie de votre code QR. Astuce : ajoutez-le à une présentation pour que votre public puisse le scanner et se connecter directement avec vous.',
        },
        generalError: {
    ...
    reportLayout: {
        ...
        selectGroupByOption: 'Sélectionnez comment regrouper les dépenses de note de frais',
    ...
    report: {
        newReport: {
            ...
            emptyReportConfirmationDontShowAgain: 'Ne plus me montrer cela',
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    reimburseableLink: 'dépenses hors poche',
                ...
                markedReimbursed: ({amount, currency}: MarkedReimbursedParams) => `payé ailleurs en ${currency}${amount}`,
                markedReimbursedFromIntegration: ({amount, currency}: MarkReimbursedFromIntegrationParams) => `a payé ${currency}${amount} via une intégration`,
                ...
                reimbursementDelayed: `a traité le paiement, mais celui-ci est retardé de 1 à 2 jours ouvrés supplémentaires`,
                selectedForRandomAudit: `sélectionné aléatoirement pour examen`,
                selectedForRandomAuditMarkdown: `[sélectionnés aléatoirement](https://help.expensify.com/articles/expensify-classic/reports/Set-a-random-report-audit-schedule) pour examen`,
                ...
                updatedCustomField1: ({email, previousValue, newValue}: UpdatedCustomFieldParams) => {
                    if (!newValue) {
                        return `a supprimé le champ personnalisé 1 de ${email} (auparavant « ${previousValue} »)`;
                    }
    ...
    accessibilityHints: {
        ...
        scrollToNewestMessages: 'Aller aux derniers messages',
    ...
    moderation: {
        ...
        intimidationDescription: 'Poursuivre agressivement un programme malgré des objections valables',
        bullying: 'Harcèlement',
        bullyingDescription: 'Cibler une personne pour obtenir l’obéissance',
        harassment: 'Harcèlement',
        harassmentDescription: 'Comportement raciste, misogyne ou autre comportement largement discriminatoire',
        assault: 'Agression',
        assaultDescription: 'Attaque émotionnelle délibérée visant à nuire',
        ...
        levelTwoResult: 'Message masqué dans le canal, avec avertissement anonyme, et le message est signalé pour examen.',
    ...
    teachersUnitePage: {
        ...
        schoolPrincipalVerifyExpense:
            'Expensify.org partage le coût des fournitures scolaires essentielles afin que les élèves issus de foyers à faible revenu puissent bénéficier de meilleures conditions d’apprentissage. Le directeur de votre établissement sera invité à vérifier vos dépenses.',
        principalFirstName: 'Prénom du représentant principal',
        ...
        schoolMailAsDefault: (contactMethodsRoute: string) =>
            `Avant de continuer, veillez à définir votre adresse e-mail scolaire comme méthode de contact par défaut. Vous pouvez le faire dans Paramètres > Profil > <a href="${contactMethodsRoute}">Méthodes de contact</a>.`,
        error: {
            enterPhoneEmail: 'Saisissez une adresse e-mail ou un numéro de téléphone valide',
            enterEmail: 'Saisir une adresse e-mail',
    ...
    cardTransactions: {
        ...
        outOfPocket: 'Dépenses à payer de votre poche',
    ...
    gps: {
        ...
        stopGpsTrackingModal: {
            ...
            prompt: 'Voulez-vous vraiment continuer ? Cela mettra fin à votre parcours actuel.',
        ...
        locationRequiredModal: {
            ...
            prompt: "Veuillez autoriser l'accès à la localisation dans les paramètres de votre appareil pour démarrer le suivi de distance par GPS.",
            allow: 'Autoriser',
        },
        androidBackgroundLocationRequiredModal: {
            title: 'Accès à la localisation en arrière-plan requis',
            prompt: 'Veuillez autoriser l’accès à la localisation en arrière-plan dans les paramètres de votre appareil (option « Toujours autoriser ») pour démarrer le suivi de distance GPS.',
        },
        ...
        desktop: {
            title: 'Suivez les distances sur votre téléphone',
            subtitle: 'Enregistrez automatiquement vos kilomètres ou miles avec le GPS et transformez instantanément vos trajets en dépenses.',
    ...
    reportCardLostOrDamaged: {
        ...
        cardDamagedInfo: 'Votre nouvelle carte arrivera dans 2 à 3 jours ouvrés. Votre carte actuelle continuera de fonctionner jusqu’à l’activation de la nouvelle.',
    ...
    referralProgram: {
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
            ...
            header: 'Démarrer un chat, parrainer un ami',
            body: 'Vous voulez que vos amis utilisent Expensify, eux aussi ? Commencez simplement une discussion avec eux et nous nous occupons du reste.',
        },
    ...
    violations: {
        ...
        conversionSurcharge: ({surcharge}: ViolationsConversionSurchargeParams) => `Application d'une majoration de conversion de ${surcharge} %`,
        ...
        modifiedAmount: ({type, displayPercentVariance}: ViolationsModifiedAmountParams) => {
            switch (type) {
                ...
                case 'card':
                    return 'Montant supérieur au paiement par carte';
                default:
        ...
        overTripLimit: ({formattedLimit}: ViolationsOverLimitParams) => `Montant dépassant la limite de ${formattedLimit}/déplacement`,
        ...
        receiptRequired: ({formattedLimit, category}: ViolationsReceiptRequiredParams) => {
            if (formattedLimit && category) {
                return `Reçu obligatoire au-delà de la limite de catégorie de ${formattedLimit}`;
            }
            if (formattedLimit) {
        ...
        markAsCashToIgnore: 'Marquer comme paiement en espèces à ignorer et demander le paiement.',
        smartscanFailed: ({canEdit = true}) => `L’analyse du reçu a échoué.${canEdit ? 'Saisir les détails manuellement.' : ''}`,
        receiptGeneratedWithAI: 'Reçu potentiellement généré par l’IA',
        ...
        merchantToKeep: 'Choisir quel commerçant conserver',
    ...
    exitSurvey: {
        ...
        reasonPage: {
            ...
            subtitle: 'Avant de partir, dites‑nous pourquoi vous souhaitez passer à Expensify Classique.',
        },
        reasons: {
        ...
        quickTipSubTitle: 'Vous pouvez accéder directement à Expensify Classic en visitant expensify.com. Ajoutez ce site à vos favoris pour un raccourci facile !',
        ...
        bookACallTextBottom:
            'Nous serions ravis d’organiser un appel avec vous pour comprendre pourquoi. Vous pouvez réserver un appel avec l’un de nos responsables produit seniors pour discuter de vos besoins.',
    ...
    subscription: {
        ...
        billingBanner: {
            ...
            billingDisputePending: {
                ...
                subtitle: (amountOwed: number, cardEnding: string) =>
                    `Vous avez contesté le débit de ${amountOwed} sur la carte se terminant par ${cardEnding}. Votre compte sera verrouillé jusqu’à la résolution du litige avec votre banque.`,
            },
            ...
            cardOnDispute: (amountOwed: string, cardEnding: string) =>
                `Vous avez contesté le débit de ${amountOwed} sur la carte se terminant par ${cardEnding}. Votre compte sera verrouillé jusqu’à la résolution du litige avec votre banque.`,
            preTrial: {
                title: 'Lancer un essai gratuit',
                subtitle: 'Pour continuer, <a href="#">complétez votre liste de configuration</a> afin que votre équipe puisse commencer à déclarer ses dépenses.',
            },
            trialStarted: {
        ...
        yourPlan: {
            ...
            collect: {
                title: 'Encaisser',
                description: 'L’offre pour petites entreprises qui vous offre les dépenses, les voyages et la messagerie.',
                ...
                benefit7: 'Discutez des dépenses, notes de frais et salons',
            ...
            control: {
                ...
                benefit2: 'Workflows d’approbation multi-niveaux',
        ...
        compareModal: {
            ...
            subtitle: `<muted-text>Débloquez les fonctionnalités dont vous avez besoin avec l’offre qui vous convient. <a href="${CONST.PRICING}">Consultez notre page des tarifs</a> pour un aperçu complet des fonctionnalités incluses dans chacune de nos offres.</muted-text>`,
        },
        details: {
            ...
            zeroCommitment: 'Aucun engagement avec le tarif annuel d’abonnement remisé',
        },
        subscriptionSize: {
            title: 'Taille de l’abonnement',
            yourSize: 'La taille de votre abonnement correspond au nombre de places ouvertes pouvant être occupées par n’importe quel membre actif au cours d’un mois donné.',
            eachMonth:
            ...
            youAlreadyCommitted: ({size, date}: SubscriptionCommitmentParams) =>
                `Vous vous êtes déjà engagé à un abonnement annuel pour ${size} membres actifs par mois jusqu’au ${date}. Vous pourrez passer à un abonnement à l’usage le ${date} en désactivant le renouvellement automatique.`,
            error: {
        ...
        subscriptionSettings: {
            ...
            automaticallyIncrease:
                'Augmentez automatiquement vos abonnements annuels pour tenir compte des membres actifs qui dépassent la taille de votre abonnement. Remarque : cela prolongera la date de fin de votre abonnement annuel.',
            ...
            renewsOn: ({date}: SubscriptionSettingsRenewsOnParams) => `Se renouvellera le ${date}.`,
            ...
            learnMore: ({hasAdminsRoom}: SubscriptionSettingsLearnMoreParams) =>
                `<muted-text>En savoir plus sur notre <a href="${CONST.PRICING}">page de tarification</a> ou discutez avec notre équipe dans votre ${hasAdminsRoom ? `<a href="adminsRoom">Salon #admins.</a>` : 'Salon #admins.'}</muted-text>`,
        ...
        requestEarlyCancellation: {
            ...
            subscriptionCanceled: {
                ...
                preventFutureActivity: ({workspacesListRoute}: WorkspacesListRouteParams) =>
                    `Si vous souhaitez empêcher toute activité et tout prélèvement à l’avenir, vous devez <a href="${workspacesListRoute}">supprimer votre/vos espace(s) de travail</a>. Notez que lorsque vous supprimez votre/vos espace(s) de travail, vous serez facturé pour toute activité en cours survenue durant le mois civil en cours.`,
            },
            requestSubmitted: {
                title: 'Demande soumise',
                subtitle:
                    'Merci de nous avoir informés que vous envisagez d’annuler votre abonnement. Nous examinons votre demande et reprendrons rapidement contact avec vous dans votre discussion avec <concierge-link>Concierge</concierge-link>.',
            },
            acknowledgement: `En demandant une résiliation anticipée, je reconnais et j’accepte qu’Expensify n’a aucune obligation d’accéder à une telle demande en vertu des <a href=${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}>Conditions d’utilisation</a> d’Expensify ou de tout autre contrat de services applicable conclu entre Expensify et moi, et qu’Expensify conserve un pouvoir discrétionnaire exclusif quant à l’acceptation de toute telle demande.`,
        },
    },
    feedbackSurvey: {
    ...
    delegate: {
        ...
        roleDescription: ({role}: OptionalParam<DelegateRoleParams> = {}) => {
            switch (role) {
                case CONST.DELEGATE_ROLE.ALL:
                    return 'Autoriser un autre membre à effectuer toutes les actions dans votre compte, en votre nom. Inclut les discussions, les soumissions, les approbations, les paiements, les mises à jour des paramètres, et plus encore.';
                case CONST.DELEGATE_ROLE.SUBMITTER:
                    return 'Autorisez un autre membre à effectuer la plupart des actions sur votre compte en votre nom. Sont exclus les approbations, paiements, rejets et mises en attente.';
                default:
                    return '';
            }
        },
        ...
        notAllowedMessage: (accountOwnerEmail: string) =>
            `En tant que <a href="${CONST.DELEGATE_ROLE_HELP_DOT_ARTICLE_LINK}">copilote</a> de ${accountOwnerEmail}, vous n’êtes pas autorisé à effectuer cette action. Désolé !`,
    ...
    debug: {
        ...
        nothingToPreview: 'Aperçu indisponible',
        ...
        invalidValue: ({expectedValues}: InvalidValueParams) => `Valeur invalide - Valeurs attendues : ${expectedValues}`,
        ...
        reasonVisibleInLHN: {
            ...
            hasIOUViolations: 'Comporte des irrégularités IOU',
            ...
            isSelfDM: 'Est message privé avec soi-même',
        ...
        reasonGBR: {
            ...
            isWaitingForAssigneeToCompleteAction: 'En attente que la personne assignée termine l’action',
        ...
        reasonRBR: {
            ...
            hasViolations: 'Présente des violations',
            hasTransactionThreadViolations: 'Comporte des violations du fil de transaction',
        },
        indicatorStatus: {
            theresAReportAwaitingAction: 'Une note de frais est en attente d’action',
            theresAReportWithErrors: 'Une note de frais contient des erreurs',
            theresAWorkspaceWithCustomUnitsErrors: 'Un espace de travail présente des erreurs d’unités personnalisées',
            theresAProblemWithAWorkspaceMember: 'Problème avec un membre de l’espace de travail',
            theresAProblemWithAWorkspaceQBOExport: 'Un problème est survenu avec le paramètre d’exportation de connexion de l’espace de travail.',
    ...
    migratedUserWelcomeModal: {
        ...
        subtitle: 'Il reprend tout ce que vous aimez dans notre expérience classique, avec tout un tas d’améliorations pour vous faciliter encore plus la vie :',
        confirmText: 'C’est parti !',
        helpText: 'Essayer la démo de 2 minutes',
        features: {
            search: 'Recherche plus puissante sur mobile, web et ordinateur',
            concierge: 'Assistant IA Concierge intégré pour automatiser vos dépenses',
    ...
    autoSubmitModal: {
        ...
        description: 'Tous les avertissements et violations ont été supprimés, donc :',
...
Salut ! Je viens de nous obtenir *3 mois gratuits* pour tester Expensify, la façon la plus rapide de gérer les dépenses.

Voici un *reçu de test* pour vous montrer comment ça marche :`,
    },
    export: {
    ...
    domain: {
        ...
        samlLogin: {
            ...
            subtitle: `<muted-text>Configurer la connexion des membres avec l’<a href="${CONST.SAML_HELP_URL}">authentification unique SAML (SSO).</a></muted-text>`,
        ...
        addDomain: {
            ...
            subtitle: 'Saisissez le nom du domaine privé auquel vous souhaitez accéder (p. ex. expensify.com).',
        ...
        admins: {
            ...
            setPrimaryContactError: 'Impossible de définir le contact principal. Veuillez réessayer ultérieurement.',
            settings: 'Paramètres',
            consolidatedDomainBilling: 'Facturation de domaine consolidée',
            consolidatedDomainBillingDescription: (domainName: string) =>
                `<comment><muted-text-label>Lorsque cette option est activée, le contact principal paiera pour tous les espaces de travail détenus par les membres de <strong>${domainName}</strong> et recevra tous les reçus de facturation.</muted-text-label></comment>`,
            ...
            cantRevokeAdminAccess: 'Impossible de révoquer l’accès administrateur du contact technique',
            error: {
