...
const translations = {
    common: {
        ...
        leaveWorkspaceConfirmationApprover: ({workspaceOwner}: {workspaceOwner: string}) =>
            `Si vous quittez cet espace de travail, vous serez remplacé(e) dans le workflow d’approbation par ${workspaceOwner}, le propriétaire de l’espace de travail.`,
        ...
        cannotLeaveWorkspaceOutstandingReport: 'Veuillez approuver toutes les notes de frais en attente qui vous ont été soumises avant de quitter cet espace de travail.',
    ...
    workspace: {
        ...
        people: {
            ...
            removeMemberPromptApprover: ({approver, workspaceOwner}: {approver: string; workspaceOwner: string}) =>
                `Si vous retirez ${approver} de cet espace de travail, nous le remplacerons dans le workflow d’approbation par ${workspaceOwner}, le propriétaire de l’espace de travail.`,
            removeMemberPromptPendingApproval: ({memberName}: {memberName: string}) =>
                `${memberName} a des notes de frais en attente d’approbation. Veuillez lui demander de les approuver, ou prenez le contrôle de ses rapports avant de retirer ce membre de l’espace de travail.`,
            ...
            removeMemberPromptExporter: ({memberName, workspaceOwner}: {memberName: string; workspaceOwner: string}) =>
                `Si vous retirez ${memberName} de cet espace de travail, nous désignerons ${workspaceOwner}, le propriétaire de l’espace de travail, comme exportateur préféré à sa place.`,
            ...
            cannotRemoveUserDueToReport: ({memberName}: {memberName: string}) =>
                `${memberName} a un rapport en attente de traitement nécessitant une action. Veuillez lui demander d’effectuer l’action requise avant de retirer cette personne de l’espace de travail.`,
        },
        card: {
            getStartedIssuing: 'Commencez en émettant votre première carte virtuelle ou physique.',
            issueCard: 'Émettre une carte',
