...
const translations = {
    ...
    workspace: {
        ...
        upgrade: {
            ...
            reports: {
                title: 'Rapports',
                description: 'Créez des rapports de dépenses organisés pour suivre vos dépenses professionnelles, les soumettre pour approbation et rationaliser votre processus de remboursement.',
