...
const translations = {
    ...
    bankAccount: {
        ...
        hasPhoneLoginError: ({contactMethodsRoute}: ContactMethodsRouteParams) =>
            `Pour connecter un compte bancaire, veuillez <a href="${contactMethodsRoute}">ajoutez un e-mail comme identifiant principal</a> et réessayez. Vous pouvez ajouter votre numéro de téléphone comme connexion secondaire.`,
