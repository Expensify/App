...
Ajoutez davantage de règles de dépenses pour protéger la trésorerie de l’entreprise.`,
                ...
                restrictionTypeHelpAllow:
                    'Les frais sont approuvés s’ils correspondent à n’importe quel commerçant ou à n’importe quelle catégorie, et s’ils ne dépassent pas un montant maximal.',
                restrictionTypeHelpBlock: 'Les frais sont refusés s’ils correspondent à un commerçant ou une catégorie, ou s’ils dépassent un montant maximal.',
                ...
                addMerchantToAllowSpend: 'Ajoutez un commerçant pour autoriser les dépenses',
                matchType: 'Type de correspondance',
                matchTypeContains: 'Contient',
                matchTypeExact: 'Correspond exactement',
                spendCategory: 'Catégorie de dépense',
                maxAmount: 'Montant maximal',
                maxAmountHelp: 'Toute dépense supérieure à ce montant sera refusée, quels que soient le commerçant et les restrictions de catégorie de dépense.',
                currencyMismatchTitle: 'Incompatibilité de devise',
                currencyMismatchPrompt: 'Pour définir un montant maximum, sélectionnez des cartes qui se règlent dans la même devise.',
                reviewSelectedCards: 'Examiner les cartes sélectionnées',
                merchantsMoreCount: ({summary, count}: {summary: string; count: number}) => `${summary}, +${count} de plus`,
                confirmErrorApplyAtLeastOneSpendRuleToOneCard: 'Appliquer au moins une règle de dépense à une carte',
                confirmErrorCardRequired: 'Carte est un champ obligatoire',
                ...
                categoryOptions: {
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.AMAZON_AND_BOOKSTORES]: 'Amazon et librairies',
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.RETAIL]: 'Détail',
                    [CONST.SPEND_RULES.CATEGORIES.SHIPPING_AND_DELIVERY]: 'Expédition et livraison',
                    [CONST.SPEND_RULES.CATEGORIES.SOFTWARE]: 'Logiciel',
                    [CONST.SPEND_RULES.CATEGORIES.TRANSIT_AND_RIDESHARE]: 'Transports en commun et covoiturage',
                    [CONST.SPEND_RULES.CATEGORIES.TRAVEL_AGENCIES]: 'Agences de voyage',
                },
            },
        },
        planTypePage: {
