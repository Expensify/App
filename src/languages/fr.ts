...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    personalCard: {
        ...
        conciergeBrokenConnection30Days: (cardName: string, connectionLink?: string) =>
            connectionLink
                ? `La connexion de votre carte ${cardName} est rompue depuis 30 jours. <a href="${connectionLink}">Connectez-vous à votre banque</a> pour la rétablir ou <a href="${connectionLink}">supprimez la carte</a> si elle n’est plus utilisée. Vous ne perdrez aucune dépense soumise si vous la supprimez.`
                : `La connexion de votre carte ${cardName} est rompue depuis 30 jours. Connectez-vous à votre banque pour la rétablir ou supprimez la carte si elle n’est plus utilisée. Vous ne perdrez aucune dépense soumise si vous la supprimez.`,
        ...
        actions: {
            type: {
                ...
                companyCardConnectionBroken30Days: ({
                    ...
                    `La connexion ${feedName} est interrompue depuis 30 jours. <a href='${workspaceCompanyCardRoute}'>Connectez-vous à votre banque</a> pour la rétablir ou <a href='${workspaceCompanyCardSettingsRoute}'>supprimez la connexion</a> si elle n’est plus utilisée. Vous ne perdrez aucune dépense soumise si vous la supprimez.`,
