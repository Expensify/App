    ...
    iou: {
        ...
        changeApprover: {
            ...
            delegateSubmitNotOnPolicyAsOriginalManager: (originalManager: string, delegate: string) =>
                `Cette note de frais vous a été envoyée au lieu de votre remplaçant de vacances <mention-user>@${delegate}</mention-user>, car cette personne n’est pas membre de la politique de cette note de frais`,
            ...
            delegateSubmitCannotApproveOwnReportAsOriginalManager: (originalManager: string, delegate: string) =>
                `Cette note de frais vous a été envoyée pour approbation, car votre remplaçant de congés, <mention-user>@${delegate}</mention-user>, ne peut pas approuver ses propres notes de frais`,
