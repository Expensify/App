...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            locked: 'Verrouillé',
            incompleteDescription: "Terminer l'ajout du compte bancaire",
            pendingDescription: 'Veuillez confirmer les transactions de test',
            verifyingDescription: 'Nous examinons votre documentation',
            lockedDescription: 'Ce compte nécessite votre attention',
            finish: 'Terminer',
            confirm: 'Confirmer',
            unlock: 'Déverrouiller',
        },
        cardFixConnection: 'Veuillez corriger cette connexion',
        cardAskAdminToFix: 'Veuillez demander à un administrateur de corriger cette connexion',
        cardAdminFixConnection: 'Veuillez corriger cette connexion dans Cartes entreprise',
        lastSynced: (dateStr: string) => `Dernière synchronisation ${dateStr}`,
