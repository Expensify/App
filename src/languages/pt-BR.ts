...
const translations = {
    ...
    contacts: {
        ...
        helpTextBeforeEmail: 'Adicione mais formas de fazer login e enviar recibos para o Expensify.\n\nAdicione um endereço de e-mail para encaminhar recibos para ',
        helpTextAfterEmail: 'ou adicione um número de telefone para enviar recibos por mensagem de texto para 47777 (somente números dos EUA).',
        primary: 'Principal',
