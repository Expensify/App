...
3. Quando o feed estiver ativado, clique em Enviar abaixo e começaremos a adicioná-lo.`,
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `Marcador(es) de fórmula inválido(s): ${placeholders}. Use marcadores compatíveis como {report:id}, {report:name}, {report:created}, etc.`,
