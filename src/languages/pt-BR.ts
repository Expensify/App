...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        calendarOpened: '[pt-BR] calendar opened',
        send: '[pt-BR] Send',
        na: '[pt-BR] N/A',
...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        revealCardDetail: {
            couldNotReveal: "[pt-BR] We couldn't reveal your card details. Please try again.",
        },
    },
    validateCodeModal: {
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            unlockBankAccount: {
                workspaceTitle: '[pt-BR] Your business bank account has been locked',
                personalTitle: '[pt-BR] Your bank account has been locked',
                workspaceSubtitle: ({policyName}: {policyName: string}) => policyName,
                personalSubtitle: '[pt-BR] Wallet',
            },
        },
        freeTrialSection: {
        ...
        yourSpend: {
            title: '[pt-BR] Your spend',
            awaitingApproval: '[pt-BR] Awaiting approval',
            repaidLast30Days: '[pt-BR] Repaid in the last 30 days',
            recentTransactions: ({lastFour}: {lastFour: string}) => `[pt-BR] Recent transactions • ${lastFour}`,
        },
        seeMore: ({count}: {count: number}) => `[pt-BR] See ${count} more`,
        ...
        gettingStartedSection: {
            ...
            inviteAccountant: '[pt-BR] Invite your accountant',
    ...
    spreadsheet: {
        ...
        importCompanyCardTransactionsPendingMessage: '[pt-BR] New cards and transactions may take some time to appear, please hang tight.',
    ...
    iou: {
        ...
        movedFromReport: (reportName: string) => `[pt-BR] moved an expense from ${reportName}`,
        movedFromReportNoName: '[pt-BR] moved an expense',
        movedTransactionTo: (reportUrl: string, reportName: string) => `[pt-BR] moved this expense to <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionToAnotherReport: '[pt-BR] moved this expense to another report',
        movedTransactionFrom: (reportUrl: string, reportName: string) => `[pt-BR] moved this expense from <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionFromAnotherReport: '[pt-BR] moved this expense from another report',
        ...
        allTransactionsPendingNextStep: "[pt-BR] All transactions are pending. You can't submit this report until they post in a few days.",
        ...
        confirmPaymentReceivedModalTitle: '[pt-BR] Confirm payment received',
        receivedPayment: '[pt-BR] Received payment',
        receivedPaymentConfirmation: "[pt-BR] Please proceed only if you've already received payment outside of Expensify.",
        confirmReceivedPayment: "[pt-BR] Yes, I've received payment",
        ...
        updatedTheRequest: (valueName: string, newValueToDisplay: string, oldValueToDisplay: string) => `[pt-BR] the ${valueName} to ${newValueToDisplay} (previously ${oldValueToDisplay})`,
        ...
        error: {
            ...
            invalidReadings: '[pt-BR] Please enter both start & end readings to continue',
            ...
            unableToSubmitReport: '[pt-BR] Unable to submit report',
            allTransactionsPendingDescription: "[pt-BR] You can't submit this report because all transactions are pending. They may take a few days to post.",
            failedToSaveOdometerDraft: "[pt-BR] Couldn't save your odometer draft. Please try again.",
            ...
            receiptUploadFailedMessage: '[pt-BR] Receipt upload failed. Save the receipt, or delete the expense and lose it.',
            saveReceipt: '[pt-BR] Save receipt',
        ...
        changeApprover: {
            ...
            reassignedApproverMessage: (managerID: number) => `[pt-BR] reassigned the approver to <mention-user accountID="${managerID}"/> via a workflow update`,
            actions: {
    ...
    deviceManagementPage: {
        title: '[pt-BR] Device management',
        description:
            '[pt-BR] Manage all the devices that you have logged into with your Expensify Account. <a href="https://help.expensify.com/articles/new-expensify/settings/Manage-Logged-in-Devices">Learn more</a>.',
        revoke: '[pt-BR] Revoke',
        unknownDevice: '[pt-BR] Unknown Device',
    },
    twoFactorAuth: {
        ...
        downloadCodes: '[pt-BR] Download codes',
        ...
        keepCodesSafe: '[pt-BR] Keep these codes safe!',
        ...
        `),
        screenshotTip: '[pt-BR] Tip: Screenshot this to save it to your photo library',
    ...
    walletPage: {
        ...
        cardActive: '[pt-BR] Active',
        bankAccountStatus: {
            active: '[pt-BR] Active',
            incomplete: '[pt-BR] Incomplete',
            pending: '[pt-BR] Pending',
            verifying: '[pt-BR] Verifying',
            locked: '[pt-BR] Locked',
            incompleteDescription: '[pt-BR] Finish adding bank account',
            pendingDescription: '[pt-BR] Please confirm test transactions',
            verifyingDescription: "[pt-BR] We're reviewing your documentation",
            lockedDescription: '[pt-BR] This account requires attention',
            finish: '[pt-BR] Finish',
            confirm: '[pt-BR] Confirm',
            unlock: '[pt-BR] Unlock',
        },
        cardFixConnection: '[pt-BR] Please fix this connection',
        cardAskAdminToFix: '[pt-BR] Please ask an admin to fix this connection',
        cardAdminFixConnection: '[pt-BR] Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `[pt-BR] Last synced ${dateStr}`,
        assignedCards: '[pt-BR] Cards',
        assignedCardsDescription: '[pt-BR] Transactions from assigned cards sync automatically.',
...
${amount} for ${merchant} - ${date}`,
        ...
        cardUnblocked: '[pt-BR] Card unblocked!',
        cardUnblockedDescription: '[pt-BR] You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: '[pt-BR] Your card was blocked due to incorrect PIN entries.',
        unblock: '[pt-BR] Unblock',
        unblockCard: '[pt-BR] Unblock card',
    ...
    workflowsPage: {
        ...
        configureViaHR: ({provider}: {provider: string}) => `[pt-BR] Configure via ${provider}.`,
        hrApprovalWorkflowLockedPrompt: ({provider}: {provider: string}) =>
            `[pt-BR] Approvals are managed by your ${provider} integration. To update your approval workflow, head to your ${provider} connection settings.`,
        goToHRSettings: ({provider}: {provider: string}) => `[pt-BR] Go to ${provider} settings`,
    ...
    reportFraudConfirmationPage: {
        ...
        descriptionCardNotReplaced: '[pt-BR] Your card was permanently deactivated. Please contact an admin to issue a new card.',
    ...
    agentsPage: {
        title: '[pt-BR] Agents',
        subtitle: '[pt-BR] Create agents to handle your workflow. Skip the manual work and get hours back in your day.',
        newAgent: '[pt-BR] New agent',
        emptyAgents: {
            title: '[pt-BR] No agents created',
            subtitle: '[pt-BR] Stop manually doing stuff. Instruct an agent instead and save yourself lots of time.',
        },
        error: {
            genericAdd: '[pt-BR] There was a problem adding this agent',
            genericUpdate: '[pt-BR] There was a problem updating this agent',
            updateName: "[pt-BR] There was a problem updating this agent's name",
            updatePrompt: "[pt-BR] There was a problem updating this agent's instructions",
            updateAvatar: "[pt-BR] There was a problem updating this agent's avatar",
        },
    },
    addAgentPage: {
        title: '[pt-BR] New agent',
        agentName: '[pt-BR] Agent name',
        instructions: '[pt-BR] Write custom instructions',
        createAgent: '[pt-BR] Create agent',
        editAvatar: '[pt-BR] Edit avatar',
        defaultAgentName: (displayName: string) => `[pt-BR] ${displayName}'s Agent`,
        defaultPrompt:
            "[pt-BR] Reject expenses that are for gambling, movies, or other obvious non-business reasons.\n\nRemind the user to always include a receipt image that makes the tip clear.\n\nApprove the report if it's very similar to previous reports from the same user.\n\nReject reports with more than $500 in travel expenses.",
    },
    editAgentPage: {
        title: '[pt-BR] Edit agent',
        agentName: '[pt-BR] Agent name',
        instructions: '[pt-BR] Write custom instructions',
        deleteAgent: '[pt-BR] Delete agent',
        deleteAgentTitle: '[pt-BR] Delete agent?',
        deleteAgentMessage: '[pt-BR] Are you sure you want to delete this agent? This action cannot be undone.',
    },
    editAgentAvatarPage: {
        title: '[pt-BR] Edit avatar',
    },
    editAgentNamePage: {
        title: '[pt-BR] Agent name',
    },
    editAgentPromptPage: {
        title: '[pt-BR] Write custom instructions',
        error: {
            emptyPrompt: '[pt-BR] Please enter instructions for your agent.',
        },
    },
    expenseRulesPage: {
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '[pt-BR] <strong>Avoid scams. Do not share your code with anyone.</strong> Our team will never call, text, or email you for this code.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[pt-BR] Here's the list of workspaces you can join.",
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: '[pt-BR] Submit expenses to my employer',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "[pt-BR] Manage my team's expenses",
            [CONST.ONBOARDING_CHOICES.TRACK_BUSINESS]: '[pt-BR] Track expenses for my business',
            [CONST.ONBOARDING_CHOICES.TRACK_PERSONAL]: '[pt-BR] Organize my personal spending',
        ...
        workEmail2FAError: '[pt-BR] This login is an existing account with Two-Factor Authentication (2FA) enabled.',
        mergeBlockScreen: {
            ...
            workAccountClosedSubtitle:
                '[pt-BR] The work account associated with this email is closed. Please contact your company admin to reactivate it, or sign up with a different email.',
        },
        tasks: {
            testDriveAdminTask: {
    ...
    statusPage: {
        ...
        addVacationDelegate: '[pt-BR] Add vacation delegate',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    addPersonalBankAccount: {
        ...
        updatePersonalInfo: '[pt-BR] Update bank account',
        updatePersonalInfoFailure: '[pt-BR] Unable to update bank account information. Please try again later.',
        updateSuccessTitle: '[pt-BR] Bank account updated!',
        updateSuccessHeader: '[pt-BR] Bank account updated',
        updateSuccessMessage: '[pt-BR] Congrats, your bank account is set up and ready to receive reimbursements.',
    },
    ...
    messages: {
        ...
        userIsAlreadyMember: (login: string, name: string) => `[pt-BR] ${login} is already a member of ${name}`,
        userIsAlreadyAnAdmin: (login: string, name: string) => `[pt-BR] ${login} is already an admin of ${name}`,
    },
    onfidoStep: {
    ...
    workspace: {
        common: {
            ...
            cardAdminAlternateText: '[pt-BR] Manage workspace cards.',
            peopleAdminAlternateText: '[pt-BR] Manage members and approval workflows.',
            paymentsAdminAlternateText: '[pt-BR] Manage workflow payments.',
            reimbursementChoice: {
            ...
            roleName: (role?: string) => {
                switch (role) {
                    ...
                    case CONST.POLICY.ROLE.CARD_ADMIN:
                        return '[pt-BR] Card Admin';
                    case CONST.POLICY.ROLE.PEOPLE_ADMIN:
                        return '[pt-BR] People Admin';
                    case CONST.POLICY.ROLE.PAYMENTS_ADMIN:
                        return '[pt-BR] Payments Admin';
            ...
            travelInvoicing: '[pt-BR] Export travel invoicing expenses as',
            travelInvoicingVendor: '[pt-BR] Travel vendor',
            travelInvoicingPayableAccount: '[pt-BR] Travel payable account',
        },
        createdForClient: {
            title: "[pt-BR] You've created a workspace for your client!",
            description: '[pt-BR] Great news 🎉. Reach out to us if they need any help with the setup.',
        },
        receiptPartners: {
            uber: {
        ...
        qbo: {
            ...
            bankAccountDescription: '[pt-BR] Choose where to send checks from.',
            creditCardAccount: '[pt-BR] Credit card account',
            travelInvoicingDescription: '[pt-BR] Travel expenses will export as credit card charges to the QuickBooks Online account specified below.',
        ...
        xero: {
            ...
            travelInvoicingDescription: '[pt-BR] Travel expenses will export as bank transactions to the Xero account specified below.',
        ...
        sageIntacct: {
            ...
            travelInvoicingDescription: '[pt-BR] Travel expenses will export as credit card charges to the Sage Intacct account specified below.',
            creditCardAccount: '[pt-BR] Credit card account',
        ...
        certinia: {
            title: '[pt-BR] Certinia',
            prerequisites: {
                title: '[pt-BR] Before you connect',
                installBundle: '[pt-BR] For FFA Connections',
                installBundleDescription: ({href, version}: {href: string; version: string}) =>
                    `[pt-BR] Install the Expensify bundle in Salesforce by clicking this link: <a href="${href}">Install FFA Expensify Bundle (Version ${version})</a>`,
                installBundleConfirm: "[pt-BR] I've installed the bundle",
                setupContacts: '[pt-BR] Set up user and contacts',
                setupContactsBullet1:
                    "[pt-BR] Create both a User and a Contact for yourself if these don't already exist in Certinia making sure the email matches your primary email in Expensify.\n\n",
                setupContactsBullet2:
                    "[pt-BR] Create contacts for each employee who will be submitting expense reports and for each report approver. Make sure each contact's email address corresponds with the email address on the employee's Expensify account.\n\n",
                setupContactsBullet3: '[pt-BR] Set permission controls for your user for each contact/resource.\n\n',
                setupContactsConfirm: "[pt-BR] I've set up the user and contacts",
                oauth: '[pt-BR] Log in through Salesforce',
                oauthDescription: "[pt-BR] To finish setup, you'll have to sign in through Salesforce and Certinia.\n\nUse the button below to continue.",
                connectButton: '[pt-BR] Connect to Certinia',
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '[pt-BR] Single entry for each expense',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '[pt-BR] Single, itemized entry for each report',
                },
            },
            invoiceItem: {
...
_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                fileImportDescription: "[pt-BR] A manual option if your bank can't send a feed.",
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                duplicateFeedModal: {
                    title: '[pt-BR] Card feed already connected',
                    prompt: "[pt-BR] You can't add the same card feed to the same workspace twice.",
                },
                csvColumns: {
        ...
        expensifyCard: {
            ...
            exportAsCSV: '[pt-BR] Export as CSV',
            csvColumnType: '[pt-BR] Type',
            csvColumnLimitType: '[pt-BR] Limit type',
            csvColumnLimit: '[pt-BR] Limit',
            findCard: '[pt-BR] Find card',
            ...
            applyCashbackToBill: '[pt-BR] Apply cash back to my Expensify bill',
            applyCashbackToBillDescription: '[pt-BR] Cash back from the Expensify Card will be used towards payment for your Expensify bill.',
            frequency: {
                daily: '[pt-BR] Daily',
                monthly: '[pt-BR] Monthly',
            },
        ...
        moreFeatures: {
                ...
                travelInvoicing: {
                    ...
                    travelInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[pt-BR] We weren't able to provision some of the members of your workspace for travel invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[pt-BR] Travel Invoicing enabled!',
            ...
            hrWarningModal: {
                disconnectText: ({integration}: {integration: string}) => `[pt-BR] To disable HR, please disconnect ${integration} from this workspace first.`,
            },
        ...
        copyPolicySettings: {
            error: '[pt-BR] An error occurred while copying workspace settings. Please try again.',
            title: '[pt-BR] Copy settings',
            selectWorkspaces: '[pt-BR] Select workspaces',
            description: '[pt-BR] Choose the workspaces you want to copy settings to, then select the settings you’d like to copy.',
            searchPlaceholder: '[pt-BR] Search workspaces',
        },
        emptyWorkspace: {
        ...
        people: {
            ...
            configureHRSync: (providerName: string) => `[pt-BR] Configure ${providerName} sync.`,
            syncWithHR: (providerName: string) => `[pt-BR] Sync with ${providerName}`,
            allMembers: '[pt-BR] All members',
            admins: '[pt-BR] Admins',
            approvers: '[pt-BR] Approvers',
            auditors: '[pt-BR] Auditors',
            emptyRoleFilter: {
                title: '[pt-BR] No members match this filter',
                subtitle: '[pt-BR] Invite a member or change the filter above.',
            },
        ...
        accounting: {
            ...
            updateCredentials: '[pt-BR] Update credentials',
            claimOffer: {
            ...
            syncTravelInvoicingSettlements: '[pt-BR] Sync travel invoicing settlements',
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '[pt-BR] Choose the bank account that your travel invoicing payments will be reconciled against.',
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `[pt-BR] Make sure this account matches your travel invoicing settlement account (ending in ${lastFourPAN}) so Continuous Reconciliation works properly.`,
            },
        },
        hr: {
            title: '[pt-BR] HR',
            connections: '[pt-BR] Connections',
            subtitle: '[pt-BR] Connect HR tools and keep employee approvals in sync.',
            connect: '[pt-BR] Connect',
            syncNow: '[pt-BR] Sync now',
            disconnect: '[pt-BR] Disconnect',
            disconnectTitle: (providerName: string) => `[pt-BR] Disconnect ${providerName}`,
            disconnectPrompt: (providerName: string) => `[pt-BR] Are you sure you want to disconnect ${providerName}?`,
            alreadyConnectedTitle: '[pt-BR] Cannot connect to multiple HR platforms',
            alreadyConnectedPrompt: '[pt-BR] You must disconnect your current HR platform before connecting another.',
            lastSync: (relativeDate: string) => `[pt-BR] Last synced ${relativeDate}`,
            syncError: (providerName: string) => `[pt-BR] Can't connect to ${providerName}`,
            connectionDescription: (providerName: string) => `[pt-BR] Connect ${providerName} to keep employee approvals in sync with your workspace.`,
            approvalMode: '[pt-BR] Approval mode',
            providerApprovalMode: (providerName: string) => `[pt-BR] ${providerName} approval mode`,
            finalApprover: '[pt-BR] Final approver',
            providerFinalApprover: (providerName: string) => `[pt-BR] ${providerName} final approver`,
            notSet: '[pt-BR] Not set',
            syncing: '[pt-BR] Syncing employees',
            syncingModalTitle: '[pt-BR] Your connection is syncing',
            syncingModalDescription: "[pt-BR] The first connection can take some time. You'll be notified of any errors.",
            approvalModeDescription: (providerName: string) => `[pt-BR] Members and managers are set up to sync with ${providerName}.`,
            approvalModeWarningTitle: '[pt-BR] Change approval mode?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `[pt-BR] Are you sure you would like to change the approval mode for this workspace? Learn more about the different ${providerName}-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
            approvalModeWarningConfirm: '[pt-BR] Change approval mode',
            approvalModes: {
                basic: {label: '[pt-BR] Basic approval', description: '[pt-BR] All users submit to a single person for processing and approval.'},
                manager: {
                    label: '[pt-BR] Manager approval',
                    description: (providerName: string) => `[pt-BR] Employees submit reports to their direct manager configured in ${providerName}.`,
                },
                custom: {label: '[pt-BR] Custom approval', description: "[pt-BR] I'll manually setup approval workflows in Expensify."},
            },
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
                        return '[pt-BR] Synchronizing Gusto Employees';
                    case 'gustoSyncLoadData':
                        return '[pt-BR] Loading data from Gusto';
                    case 'gustoSyncProvisioning':
                        return '[pt-BR] Provisioning employees in policy';
                    case 'zenefitsSyncTitle':
                        return '[pt-BR] Synchronizing TriNet Employees';
                    case 'zenefitsSyncLoadData':
                        return '[pt-BR] Loading data from TriNet';
            ...
            syncResults: {
                title: (provider: string) => `[pt-BR] ${provider} sync complete`,
                successTitle: (provider: string) => `[pt-BR] Successfully synced your ${provider} connection!`,
                added: '[pt-BR] Added',
                removed: '[pt-BR] Removed',
                skipped: '[pt-BR] Skipped',
                employeeCount: () => ({
                    one: '[pt-BR] 1 employee',
                    other: (count: number) => `[pt-BR] ${count} employees`,
                }),
            },
            gusto: {
                title: '[pt-BR] Gusto',
        ...
        distanceRates: {
            ...
            amountPerUnit: (unit: string) => `[pt-BR] Amount per ${unit}`,
            startDate: '[pt-BR] Start date',
            endDate: '[pt-BR] End date',
            errors: {
                rateNameRequired: '[pt-BR] Rate name is required',
                existingRateName: '[pt-BR] A distance rate with this name already exists',
                nameRequired: '[pt-BR] Name is required',
                amountRequired: '[pt-BR] Amount is required',
                startDateMustBeBeforeEndDate: '[pt-BR] Start date must be before end date',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            yourWorkspace: `[pt-BR] Your workspace is set to an unsupported currency. View the <a href="${CONST.ENABLE_GLOBAL_REIMBURSEMENT_HELP_URL}">list of supported currencies</a>.`,
...
Are you sure you want to export them again?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.CERTINIA]: {
                title: '[pt-BR] Certinia',
                description: `[pt-BR] Enjoy automated syncing and reduce manual entries with the Expensify + Certinia integration. Align expense coding dimensions and tax sync with your Certinia setup for clearer financial visibility.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>Our Certinia integration is only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            ...
            approvalSubmit: {
                title: '[pt-BR] Approvals',
                description: '[pt-BR] Centrally configure who all members submit to by enabling approvals.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>Approvals are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            categories: {
                title: '[pt-BR] Categories',
            ...
            companyCardSubmit: {
                title: '[pt-BR] Company cards',
                description: `[pt-BR] Bring your own company card to Expensify to get automatic import, automatic categorization, customizable rule support, and integrated reconciliation.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>Company card import is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            rules: {
                title: '[pt-BR] Rules',
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            travelSubmit: {
                title: '[pt-BR] Expensify Travel',
                description: '[pt-BR] Book discounted flights, hotels, cars, and trains globally from within Expensify, with duty of care reporting and integrated expense management.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>Expensify Travel is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            reports: {
                title: '[pt-BR] Reports',
            ...
            roles: {
                title: '[pt-BR] Roles',
                description: '[pt-BR] Assign different roles to different members to increase or decrease visibility and control as appropriate.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>Roles are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            payments: {
                title: '[pt-BR] Payments',
                description: '[pt-BR] Reimburse employees directly from your business bank account.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>Payments are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            accounting: {
                title: '[pt-BR] Accounting',
                description:
                    '[pt-BR] Sync categories, tags, tax rates, and more from your accounting system to Expensify, as well as export expense reports and card transactions – no typing (or typos) involved!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>Accounting is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            expensifyCard: {
                title: '[pt-BR] Expensify Card',
                description:
                    '[pt-BR] Issue company cards (including virtual cards) directly from your own bank account to get realtime spend control with an unbreakable connection, and up to 2% cashback!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>The Expensify Card is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
                upgradeButton: '[pt-BR] Upgrade and enable',
            },
            invoicing: {
                title: '[pt-BR] Invoicing',
                description: '[pt-BR] Create, send, and track professional invoices, all inside Expensify. Get paid faster with integrated payments and real-time visibility.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pt-BR] <muted-text>Invoicing is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pt-BR] per member per month.` : `[pt-BR] per active member per month.`}</muted-text>`,
            },
            pricing: {
                perActiveMember: '[pt-BR] per active member per month.',
                perMember: '[pt-BR] per member per month.',
            },
            note: (subscriptionLink: string) => `[pt-BR] <muted-text><a href="${subscriptionLink}">Learn more</a> about our plans and pricing.</muted-text>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                giftCard: '[pt-BR] Gift card purchases',
                handwrittenReceipt: '[pt-BR] Handwritten receipts',
...
Add more spend rules to protect company cash flow.`,
        ...
        planTypePage: {
            planTypes: {
                ...
                submit2026: {
                    label: '[pt-BR] Submit',
                    description: '[pt-BR] For employees looking to submit expenses to their employer.',
                },
            },
            description: "[pt-BR] Choose a plan that's right for you.",
            subscriptionLink: '[pt-BR] Learn more',
    ...
    workspaceActions: {
        ...
        updatedRequireCompanyCards: ({enabled}: {enabled: boolean}) => `[pt-BR] ${enabled ? '[pt-BR] enabled' : '[pt-BR] disabled'} the company card purchases requirement`,
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `[pt-BR] set itemized receipt required amount to "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) => `[pt-BR] changed itemized receipt required amount to "${newValue}" (previously "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `[pt-BR] removed itemized receipt required amount (previously "${oldValue}")`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            editMultipleDescription: '[pt-BR] Changes will be set for all selected expenses and will override any previously set values.',
            approve: '[pt-BR] Approve',
            pay: '[pt-BR] Pay',
            delete: '[pt-BR] Delete',
            hold: '[pt-BR] Hold',
        ...
        filters: {
            ...
            card: {
                ...
                travelInvoicing: '[pt-BR] Travel invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[pt-BR] Travel invoicing',
            },
            is: '[pt-BR] Is',
            action: {
        ...
        askConcierge: (message: string) => `[pt-BR] Ask Concierge “${message}”`,
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    travelCardLink: '[pt-BR] travel card expenses',
    ...
    chronos: {
        ...
        stopTimer: (duration: string) => `[pt-BR] Stop Timer (${duration})`,
    ...
    accessibilityHints: {
        ...
        openActionsMenu: '[pt-BR] Open actions menu',
        selectAllCategories: '[pt-BR] Select all categories',
        selectAllDistanceRates: '[pt-BR] Select all distance rates',
        selectAllTags: '[pt-BR] Select all tags',
        selectAllTaxes: '[pt-BR] Select all taxes',
        selectAllPerDiemRates: '[pt-BR] Select all per diem rates',
        selectAllMembers: '[pt-BR] Select all members',
        selectAllValues: '[pt-BR] Select all values',
        selectAllRules: '[pt-BR] Select all rules',
    },
    parentReportAction: {
    ...
    gps: {
        ...
        liveActivity: {
            ...
            lockScreenBadgeText: '[pt-BR] Distance',
            lockScreenTrackingText: '[pt-BR] Tracking...',
    ...
    violations: {
        ...
        missingTag: (tagName?: string) => `[pt-BR] Missing ${tagName ?? '[pt-BR] tag'}`,
        ...
        prohibitedExpense: (prohibitedExpenseTypes: string | string[]) => {
            ...
            const getProhibitedExpenseTypeText = (prohibitedExpenseType: string) => {
                switch (prohibitedExpenseType) {
                    ...
                    case 'giftCard':
                        return `[pt-BR] gift card purchases`;
                    case 'handwrittenReceipt':
                        return `[pt-BR] handwritten receipts`;
                    default:
        ...
        smartscanFailed: ({canEdit = true, missingFields = []}: {canEdit?: boolean; missingFields?: string[]}) => {
            if (missingFields.length > 0) {
                const fieldNames: Record<string, string> = {merchant: '[pt-BR] merchant', date: '[pt-BR] date', amount: '[pt-BR] amount'};
                const translated = missingFields.map((f) => fieldNames[f] ?? f);
                let fieldList = '';
                if (translated.length === 1) {
                    fieldList = translated.at(0) ?? '';
                } else if (translated.length === 2) {
                    fieldList = translated.join('[pt-BR]  and ');
                } else {
                    fieldList = `${translated.slice(0, translated.length - 1).join(', ')}, and ${translated.at(-1)}`;
                }
                return `[pt-BR] Receipt scanning failed — missing ${fieldList}.${canEdit ? '[pt-BR]  Enter details manually.' : ''}`;
            }
            return `[pt-BR] Receipt scanning failed.${canEdit ? '[pt-BR]  Enter details manually.' : ''}`;
        },
    ...
    exitSurvey: {
        ...
        goBackJustOnce: '[pt-BR] Go back just once',
    },
    listBoundary: {
    ...
    delegate: {
        ...
        addCopilot: '[pt-BR] Add a copilot to your account',
        membersCanAccessYourAccount: '[pt-BR] These members can access your account:',
        youCanAccessTheseAccounts: '[pt-BR] You can access these accounts:',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            error: {
                ...
                moveMemberNotPolicyAdmin:
                    '[pt-BR] Cannot move member to the domain group. You must be a Policy Admin for the Preferred Policy set on the domain group you are trying to move this user to.',
            },
        ...
        groups: {
            ...
            createGroupError: '[pt-BR] Unable to create this group. Please try again.',
            permissions: '[pt-BR] Group permissions',
            createNewGroupButton: '[pt-BR] New group',
            createGroupSubmitButton: '[pt-BR] Create group',
            expensifyCardPreferredWorkspace: '[pt-BR] Expensify Card preferred workspace',
            expensifyCardPreferredWorkspaceDescription:
                '[pt-BR] All Expensify Card transactions will be created on the Expensify Card Preferred Workspace instead of the Preferred Workspace. Enabling this feature will override the Preferred Workspace setting for Expensify Card transactions only.',
            strictlyEnforceWorkspaceRules: '[pt-BR] Strictly enforce workspace rules',
            strictlyEnforceWorkspaceRulesDescription: '[pt-BR] All workspace rules must be met before submitting a report. No manual exceptions allowed.',
            restrictExpenseWorkspaceCreation: '[pt-BR] Restrict expense workspace creation/removal',
            restrictExpenseWorkspaceCreationDescription:
                '[pt-BR] Prevent members from being able to create an expense workspace or remove themselves from an expense workspace. This is useful for preventing people from using Expensify to submit reports for use outside your domain when combined with strict workspace enforcement.',
            deleteGroup: '[pt-BR] Delete Group',
            deleteGroupDangerConfirmationModal: '[pt-BR] Delete Group',
            deleteGroupDangerConfirmationModalDescription: (defaultGroupName: string) =>
                `[pt-BR] Are you sure? This will reassign all members to the default group (${defaultGroupName}) and can't be undone.`,
            deleteGroupError: '[pt-BR] Unable to delete this group. Please try again.',
            preferredWorkspace: '[pt-BR] Preferred Workspace',
            preferredWorkspaceDescription: (enabled: boolean) =>
                `[pt-BR] All new reports and expenses will be created on ${enabled ? '[pt-BR] selected preferred' : '[pt-BR] this'} workspace.`,
            preferredWorkspaceSelectDescription: '[pt-BR] All new expenses and reports will be created on this workspace.',
            noWorkspacesMessage: '[pt-BR] There are no workspaces on this domain. A workspace is required to enable this restriction.',
            restrictDefaultLoginSelection: '[pt-BR] Restrict default login selection',
            restrictDefaultLoginSelectionDescription: '[pt-BR] Prevent members from changing their login email away from their company domain to avoid policy restrictions.',
            expensifyCardPreferredWorkspaceDisabledMessage: '[pt-BR] To enable this setting, please first enable a preferred workspace and set up Expensify Cards on your domain.',
            findGroup: '[pt-BR] Find group',
        },
    },
};
