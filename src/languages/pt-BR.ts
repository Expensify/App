...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
        ...
        campfire: {
            ...
            accountingMethods: {
                ...
                alternateText: {
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]: 'Despesas reembolsáveis serão exportadas quando forem aprovadas em definitivo',
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]: 'Despesas pagas do próprio bolso serão exportadas quando forem pagas',
                },
            },
            syncReimbursedReports: 'Sincronizar relatórios reembolsados',
            syncReimbursedReportsDescription: 'Quando um relatório for pago via ACH, um pagamento de conta será gerado nesta conta.',
            billPaymentAccount: {label: 'Conta para pagamento de contas', description: 'Escolha de onde pagar as contas e nós criaremos o pagamento no Campfire.'},
            syncExpensifyCardSettlements: 'Sincronizar liquidações do Cartão Expensify',
            settlementAccount: {label: 'Conta de liquidação do Cartão Expensify', description: 'Escolha sua conta de liquidação e nós criaremos o pagamento no Campfire.'},
            syncTravelInvoicingSettlements: 'Sincronizar liquidações de faturamento de viagens',
            travelInvoicingSettlementAccount: {
                label: 'Conta de liquidação de faturamento de viagens',
                description: 'Escolha sua conta de liquidação e nós criaremos o pagamento no Campfire.',
            },
            travelInvoicingPayableAccount: {label: 'Conta a pagar de faturamento de viagens'},
        },
        businessCentral: {
