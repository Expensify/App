...
${
    ...
    workspaceActions: {
        ...
        forcedCorporateUpgrade: `Este espaço de trabalho foi atualizado para o plano Control. Clique <a href="${CONST.PLAN_TYPES_AND_PRICING_HELP_URL}">aqui</a> para mais informações.`,
