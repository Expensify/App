...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        perDiem: {
            ...
            requestEmptyList: {
                title: 'Ainda não há taxas de diária',
                subtitle: 'Este espaço de trabalho não tem taxas de diária, peça ao seu administrador para adicionar algumas.',
                adminSubtitle: 'Adicione taxas de diária para organizar seus gastos.',
            },
