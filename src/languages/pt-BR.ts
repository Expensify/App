...
const translations = {
    ...
    receipt: {
        ...
        alternativeMethodsDownloadApp: ({downloadUrl}: {downloadUrl: string}) => `<muted-text-label><a href="${downloadUrl}">Baixe o aplicativo</a> para escanear do seu telefone</muted-text-label>`,
