...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
        ...
        campfire: {
            ...
            exportReimbursable: {label: 'Exportar despesas reembolsáveis como', values: {label: 'Contas de fornecedor'}},
            exportDate: {
                label: 'Data da fatura do fornecedor',
            ...
            exportNonReimbursable: {label: 'Exportar despesas de cartão da empresa como', values: {label: 'Lançamentos contábeis'}},
            defaultCompanyCardVendor: {
                label: 'Fornecedor padrão para todos os cartões da empresa',
                description: 'Escolha um fornecedor Campfire padrão para despesas que não sejam correspondidas automaticamente.',
            },
            companyCardAccount: {label: 'Conta de cartão corporativo', description: 'Escolha para onde exportar as transações do cartão corporativo.'},
            noVendorsFound: 'Nenhum fornecedor encontrado',
