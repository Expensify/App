...
Exija detalhes de despesas como recibos e descrições, defina limites e padrões e automatize aprovações e pagamentos – tudo em um só lugar.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                ruleSummaryTitleContains: (merchantName: string) => `Se o comerciante contiver "${merchantName}"`,
                ruleSummaryTitleExact: (merchantName: string) => `Se o comerciante for exatamente "${merchantName}"`,
                ...
                matchTypeContainsDescription: 'Corresponder despesas onde o nome do comerciante contém o texto especificado (sem diferenciação de maiúsculas)',
                matchTypeExact: 'Corresponde exatamente',
                matchTypeExactDescription: 'Corresponder despesas onde o nome do comerciante corresponde exatamente ao texto especificado',
