...
Exija dados de despesas como recibos e descrições, defina limites e padrões e automatize aprovações e pagamentos – tudo em um só lugar.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                confirmErrorConditionAndDefault: 'Selecione um estabelecimento ou categoria e aplique pelo menos um padrão',
                ...
                categoryRulesApplyGoingForwardTitle: 'Regras de categoria se aplicam daqui para frente',
                categoryRulesApplyGoingForwardPrompt: 'Uma alíquota de imposto padrão se aplica às novas despesas nesta categoria. As despesas que já existem não serão alteradas.',
            },
            categoryRules: {
...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
            ...
            taxesDisabledEmptyState: {title: 'Impostos não estão ativados', subtitle: 'Ative os impostos para documentar e recuperar impostos elegíveis.', cta: 'Ativar impostos'},
        },
        planTypePage: {
            planTypes: {
                team: {
