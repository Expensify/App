...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
        ...
        recruiting: {
            ...
            approvalModeWarningTitle: 'Mudar o modo de aprovação?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `Tem certeza de que gostaria de alterar o modo de aprovação deste espaço de trabalho? Saiba mais sobre os diferentes modos de fluxo de trabalho habilitados por ${providerName} em nosso <a href="${helpSiteURL}">site de ajuda</a>.`,
            approvalModeWarningConfirm: 'Alterar modo de aprovação',
        },
        merge: {
