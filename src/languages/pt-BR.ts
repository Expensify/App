...
(por exemplo, ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        websiteExample: 'ex.: https://www.expensify.com',
        ...
        import: 'Importar',
        offlinePrompt: 'Você não pode executar esta ação no momento.',
        ...
        leaveWorkspaceReimburser:
            'Você não pode sair deste espaço de trabalho como o reembolsador. Defina um novo reembolsador em Espaços de Trabalho > Fazer ou acompanhar pagamentos e tente novamente.',
    ...
    supportalNoAccess: {
        ...
        descriptionWithCommand: ({
            ...
            `Você não está autorizado a realizar esta ação quando o suporte está conectado (comando: ${command ?? ''}). Se você acha que o time de Success deveria poder realizar esta ação, inicie uma conversa no Slack.`,
    },
    lockedAccount: {
    ...
    attachmentPicker: {
        ...
        attachmentImageTooLarge: 'Esta imagem é grande demais para ser visualizada antes do upload.',
        ...
        someFilesCantBeUploaded: 'Alguns arquivos não podem ser carregados',
    ...
    composer: {
        ...
        taskTitleExceededMaxLength: ({formattedMaxLength}: FormattedMaxLengthParams) => `O tamanho máximo do título da tarefa é de ${formattedMaxLength} caracteres.`,
    },
    baseUpdateAppModal: {
        updateApp: 'Atualizar aplicativo',
        updatePrompt: 'Uma nova versão deste app está disponível.\nAtualize agora ou reinicie o app mais tarde para baixar as atualizações mais recentes.',
    },
    deeplinkWrapper: {
        launching: 'Iniciando o Expensify',
        expired: 'Sua sessão expirou.',
        signIn: 'Faça login novamente.',
        redirectedToDesktopApp: 'Redirecionamos você para o aplicativo para desktop.',
    ...
    validateCodeModal: {
        ...
        `),
        requestOneHere: 'solicitação uma aqui.',
    },
    ...
    selectionList: {
        ...
        searchForSomeone: 'Procurar alguém',
    },
    ...
    welcomeText: {
        ...
        phrase2: 'Dinheiro fala mais alto. E agora que chat e pagamentos estão em um só lugar, tudo ficou mais fácil.',
        ...
        welcomeEnterMagicCode: ({login}: WelcomeEnterMagicCodeParams) => `Digite o código mágico enviado para ${login}. Ele deve chegar em um ou dois minutos.`,
    },
    login: {
        hero: {
    ...
    thirdPartySignIn: {
        ...
        redirectToDesktopMessage: 'Vamos redirecionar você para o aplicativo de desktop assim que concluir o login.',
    },
    samlSignIn: {
        ...
        launching: 'Iniciando...',
        oneMoment: 'Aguarde um momento enquanto redirecionamos você para o portal de single sign-on da sua empresa.',
    },
    reportActionCompose: {
    ...
    reportActionContextMenu: {
        ...
        onlyVisible: 'Visível somente para',
    ...
    reportArchiveReasons: {
        ...
        [CONST.REPORT.ARCHIVE_REASON.ACCOUNT_MERGED]: ({displayName, oldDisplayName}: ReportArchiveReasonsMergedParams) =>
            `Esta conversa não está mais ativa porque ${oldDisplayName} unificou a conta com ${displayName}.`,
    ...
    sidebarScreen: {
        ...
        redirectToExpensifyClassicModal: {
            title: 'Em breve',
            description: 'Estamos fazendo alguns ajustes finais no New Expensify para acomodar a sua configuração específica. Enquanto isso, acesse o Expensify Classic.',
        },
    },
    allSettingsScreen: {
    ...
    spreadsheet: {
        ...
        singleFieldMultipleColumns: ({fieldName}: SpreadFieldNameParams) => `Ops! Você mapeou um único campo ("${fieldName}") para várias colunas. Revise e tente novamente.`,
        emptyMappedField: ({fieldName}: SpreadFieldNameParams) => `Ops! O campo ("${fieldName}") contém um ou mais valores vazios. Revise e tente novamente.`,
        importSuccessfulTitle: 'Importação concluída com sucesso',
        ...
        importPerDiemRatesSuccessfulDescription: ({rates}: ImportPerDiemRatesSuccessfulDescriptionParams) =>
            rates > 1 ? `${rates} tarifas de diárias foram adicionadas.` : '1 taxa de diária foi adicionada.',
        importFailedTitle: 'Falha na importação',
        importFailedDescription: 'Certifique-se de que todos os campos estejam preenchidos corretamente e tente novamente. Se o problema persistir, entre em contato com o Concierge.',
        ...
        importMemberConfirmation: () => ({
            ...
            other: (count: number) =>
                `Confirme os detalhes abaixo para os ${count} novos membros do workspace que serão adicionados como parte deste upload. Os membros existentes não receberão nenhuma atualização de função nem mensagens de convite.`,
        }),
    },
    receipt: {
        ...
        alternativeMethodsDownloadApp: ({downloadUrl}: {downloadUrl: string}) => `<label-text><a href="${downloadUrl}">Baixe o app</a> para escanear com o seu celular</label-text>`,
        ...
        deniedCameraAccess: `O acesso à câmera ainda não foi concedido. Siga <a href="${CONST.DENIED_CAMERA_ACCESS_INSTRUCTIONS_URL}">estas instruções</a>.`,
        ...
        allowLocationFromSetting: `O acesso à localização nos ajuda a manter seu fuso horário e sua moeda corretos onde quer que você vá. Permita o acesso à localização nas configurações de permissões do seu dispositivo.`,
        ...
        addReceipt: 'Adicionar recibo',
        scanFailed: 'O recibo não pôde ser escaneado, pois está faltando o estabelecimento, a data ou o valor.',
    },
    quickAction: {
        ...
        header: 'Ação rápida',
        noLongerHaveReportAccess: 'Você não tem mais acesso ao seu destino anterior de ação rápida. Selecione um novo abaixo.',
    ...
    iou: {
        ...
        makeSplitsEven: 'Tornar divisões iguais',
        ...
        pendingMatch: 'Conciliação pendente',
        ...
        receiptScanInProgressDescription: 'Digitalização de recibo em andamento. Volte mais tarde ou insira os detalhes agora.',
        removeFromReport: 'Remover do relatório',
        moveToPersonalSpace: 'Mover despesas para o seu espaço pessoal',
        duplicateTransaction: ({isSubmitted}: DuplicateTransactionParams) =>
            !isSubmitted
                ? 'Despesas potencialmente duplicadas identificadas. Revise as duplicatas para permitir o envio.'
                : 'Despesas potencialmente duplicadas identificadas. Revise as duplicadas para permitir a aprovação.',
        receiptIssuesFound: () => ({
        ...
        receiptStatusText: 'Somente você pode ver este recibo enquanto ele está sendo digitalizado. Volte mais tarde ou insira os detalhes agora.',
        ...
        yourCompanyWebsiteNote: 'Se você não tiver um site, poderá fornecer o LinkedIn da sua empresa ou um perfil de mídia social em seu lugar.',
        ...
        yourSplit: ({amount}: UserSplitParams) => `Seu valor dividido ${amount}`,
        ...
        canceledRequest: ({amount, submitterDisplayName}: CanceledRequestParams) =>
            `cancelou o pagamento de ${amount}, porque ${submitterDisplayName} não ativou a Expensify Wallet em até 30 dias`,
        ...
        setTheRequest: ({valueName, newValueToDisplay}: SetTheRequestParams) => `${valueName} para ${newValueToDisplay}`,
        setTheDistanceMerchant: ({translatedChangedField, newMerchant, newAmountToDisplay}: SetTheDistanceMerchantParams) =>
            `defina o ${translatedChangedField} para ${newMerchant}, o que definiu o valor como ${newAmountToDisplay}`,
        ...
        error: {
            ...
            duplicateWaypointsErrorMessage: 'Remova os pontos de parada duplicados',
            ...
            invalidMerchant: 'Insira um estabelecimento válido',
            ...
            invalidRate: 'Taxa inválida para este workspace. Selecione uma das taxas disponíveis deste workspace.',
        },
        dismissReceiptError: 'Ignorar erro',
        ...
        expenseWasPutOnHold: 'A despesa foi colocada em espera',
        ...
        someDuplicatesArePaid: 'Alguns desses itens duplicados já foram aprovados ou pagos.',
        ...
        whatIsHoldExplain: 'Reter é como apertar “pausar” em uma despesa até que você esteja pronto para enviá-la.',
        holdIsLeftBehind: 'Despesas retidas ficam para trás mesmo se você enviar um relatório inteiro.',
        unholdWhenReady: 'Retire as despesas da retenção quando estiver pronto para enviá-las.',
        ...
        reject: {
            ...
            educationalText: 'Se você não estiver pronto para aprovar ou pagar uma despesa, você pode segurá-la ou recusá-la.',
            ...
            rejectExpenseTitle: 'Recuse uma despesa que você não pretende aprovar ou pagar.',
        ...
        changeApprover: {
            ...
            actions: {
                ...
                addApproverSubtitle: 'Adicione um aprovador adicional ao fluxo de trabalho existente.',
    ...
    transactionMerge: {
        ...
        confirmationPage: {
            ...
            pageTitle: 'Confirme os dados que você deseja manter. Os dados que você não mantiver serão excluídos.',
    ...
    pronouns: {
        ...
        sheHerHersTheyThemTheirs: 'Ela / Dela / Dela / Elu / Delu / Delu',
        merMers: 'Mer / Mers',
        neNirNirs: 'Ne / Nir / Nirs',
        neeNerNers: 'Nee / Ner / Ners',
        perPers: 'Por / Pessoa',
        theyThemTheirs: 'Elu / Delu / Delus',
    ...
    updateRequiredView: {
        ...
        toGetLatestChanges: 'Para celular ou desktop, baixe e instale a versão mais recente. Na web, atualize o seu navegador.',
        newAppNotAvailable: 'O novo aplicativo Expensify não está mais disponível.',
    },
    initialSettingsPage: {
        about: 'Sobre',
        aboutPage: {
            description: 'O novo aplicativo Expensify é desenvolvido por uma comunidade de desenvolvedores open source de todo o mundo. Ajude-nos a construir o futuro da Expensify.',
        ...
        troubleshoot: {
            ...
            confirmResetDescription: 'Todas as mensagens em rascunho que não foram enviadas serão perdidas, mas o resto dos seus dados está seguro.',
            ...
            useStagingServer: 'Usar servidor de testes',
        ...
        debugConsole: {
            ...
            logSizeTooLarge: ({size}: LogSizeParams) => `O tamanho do log excede o limite de ${size} MB. Use “Salvar log” para baixar o arquivo de log em vez disso.`,
            logs: 'Registros',
        ...
        signOutConfirmationText: 'Você perderá quaisquer alterações feitas offline se sair.',
        versionLetter: 'v',
    ...
    mergeAccountsPage: {
        ...
        mergeSuccess: {
            ...
            description: ({from, to}: MergeSuccessDescriptionParams) =>
                `<muted-text><centered-text>Você unificou com sucesso todos os dados de <strong>${from}</strong> em <strong>${to}</strong>. De agora em diante, você pode usar qualquer um dos logins para esta conta.</centered-text></muted-text>`,
        },
        mergePendingSAML: {
        ...
        mergeFailure2FA: {
            description: ({email}: MergeFailureDescriptionGenericParams) =>
                `<muted-text><centered-text>Não é possível mesclar contas porque <strong>${email}</strong> tem a autenticação de dois fatores (2FA) ativada. Desative o 2FA para <strong>${email}</strong> e tente novamente.</centered-text></muted-text>`,
        ...
        mergeFailureUncreatedAccountDescription: ({email, contactMethodLink}: MergeFailureUncreatedAccountDescriptionParams) =>
            `<muted-text><centered-text>Você não pode mesclar contas porque <strong>${email}</strong> não possui uma conta Expensify. Em vez disso, <a href="${contactMethodLink}">adicione-o como um método de contato</a>.</centered-text></muted-text>`,
        ...
        mergeFailureInvoicedAccountDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Você não pode mesclar contas em <strong>${email}</strong> porque essa conta é proprietária de um relacionamento de cobrança faturado.</centered-text></muted-text>`,
    ...
    lockAccountPage: {
        ...
        compromisedDescription:
            'Notou algo estranho na sua conta? Ao reportar, sua conta será bloqueada imediatamente, novas transações com o Cartão Expensify serão impedidas e quaisquer alterações na conta serão prevenidas.',
        domainAdminsDescription: 'Para administradores de domínio: Isso também pausa toda a atividade do Expensify Card e ações de administrador em todo(s) o(s) seu(s) domínio(s).',
        areYouSure: 'Tem certeza de que deseja bloquear sua conta Expensify?',
        onceLocked: 'Depois de bloqueada, sua conta será restringida até que seja feita uma solicitação de desbloqueio e uma revisão de segurança',
    },
    failedToLockAccountPage: {
        failedToLockAccount: 'Falha ao bloquear a conta',
        failedToLockAccountDescription: `Não foi possível bloquear sua conta. Por favor, converse com a Concierge para resolver esse problema.`,
    ...
    passwordPage: {
        ...
        changingYourPasswordPrompt: 'Alterar sua senha atualizará a senha das suas contas Expensify.com e New Expensify.',
    ...
    twoFactorAuth: {
        ...
        copy: 'Copiar',
        disable: 'Desativar',
        enableTwoFactorAuth: 'Habilitar autenticação em duas etapas',
        ...
        twoFactorAuthIsRequiredXero: 'Sua conexão contábil com o Xero exige o uso de autenticação em duas etapas. Para continuar usando o Expensify, ative-a.',
    ...
    twoFactorAuthForm: {
        error: {
            ...
            incorrect2fa: 'Código de autenticação de dois fatores incorreto. Tente novamente.',
        },
    },
    passwordConfirmationScreen: {
        passwordUpdated: 'Senha atualizada!',
        allSet: 'Está tudo pronto. Mantenha sua nova senha em segurança.',
    },
    privateNotes: {
    ...
    billingCurrency: {
        ...
        note: `Observação: Alterar sua moeda de pagamento pode afetar quanto você pagará pelo Expensify. Consulte nossa <a href="${CONST.PRICING}">página de preços</a> para obter todos os detalhes.`,
    },
    addDebitCardPage: {
        ...
        error: {
            ...
            securityCode: 'Insira um código de segurança válido',
            addressStreet: 'Informe um endereço de cobrança válido que não seja uma caixa postal',
    ...
    walletPage: {
        ...
        getPaidBackFaster: 'Receba reembolsos mais rápido',
    ...
    cardPage: {
        ...
        reportFraud: 'Reportar fraude em cartão virtual',
        ...
        enterMagicCode: ({contactMethod}: EnterMagicCodeParams) =>
            `Insira o código mágico enviado para ${contactMethod} para ver os detalhes do seu cartão. Ele deve chegar dentro de um ou dois minutos.`,
        ...
        cardFraudAlert: {
            ...
            clearedMessage: ({cardLastFour}: {cardLastFour: string}) => `limpou a atividade suspeita e reativou o cartão x${cardLastFour}. Tudo pronto para continuar lançando despesas!`,
            ...
            alertMessage: ({
                ...
                merchant: string;
                date: string;
            }) => `atividade suspeita identificada no cartão com final ${cardLastFour}. Você reconhece essa cobrança?
...
${amount} para ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        customApprovalWorkflowEnabled:
            '<muted-text-label>Um fluxo de aprovação personalizado está ativado neste workspace. Para revisar ou alterar esse fluxo de aprovação, entre em contato com seu <account-manager-link>Gerente de Conta</account-manager-link> ou com o <concierge-link>Concierge</concierge-link>.</muted-text-label>',
        ...
        editor: {
            submissionFrequency: 'Escolha por quanto tempo o Expensify deve esperar antes de compartilhar despesas sem erros.',
        },
        ...
        approverInMultipleWorkflows: 'Esse membro já pertence a outro fluxo de aprovação. Qualquer atualização feita aqui será refletida lá também.',
    ...
    workflowsPayerPage: {
        ...
        genericErrorMessage: 'Não foi possível alterar o responsável autorizado pelo pagamento. Tente novamente.',
        admins: 'Administradores',
        payer: 'Pagador',
        paymentAccount: 'Conta de pagamento',
    },
    reportFraudPage: {
        title: 'Reportar fraude em cartão virtual',
        description:
            'Se os dados do seu cartão virtual tiverem sido roubados ou comprometidos, desativaremos permanentemente o seu cartão atual e forneceremos um novo cartão virtual e número.',
        deactivateCard: 'Desativar cartão',
        reportVirtualCardFraud: 'Reportar fraude em cartão virtual',
    },
    reportFraudConfirmationPage: {
        title: 'Fraude no cartão reportada',
        description: 'Desativamos permanentemente o seu cartão atual. Quando você voltar para ver os detalhes do seu cartão, um novo cartão virtual estará disponível.',
    ...
    activateCardPage: {
        ...
        error: {
            ...
            throttled:
                'Você digitou incorretamente os últimos 4 dígitos do seu Expensify Card muitas vezes. Se você tem certeza de que os números estão corretos, entre em contato com o Concierge para resolver. Caso contrário, tente novamente mais tarde.',
        },
    },
    getPhysicalCard: {
    ...
    transferAmountPage: {
        transfer: ({amount}: TransferParams) => `Transferência${amount ? ` ${amount}` : ''}`,
        ...
        notHereSubTitle: 'Por favor, transfira seu saldo na página da carteira',
        goToWallet: 'Ir para Carteira',
    },
    chooseTransferAccountPage: {
        chooseAccount: 'Selecionar conta',
    },
    paymentMethodList: {
    ...
    groupChat: {
        ...
        defaultReportName: ({displayName}: ReportArchiveReasonsClosedParams) => `Bate-papo em grupo de ${displayName}`,
    },
    languagePage: {
        language: 'Idioma',
    ...
    validateCodeForm: {
        ...
        requiredWhen2FAEnabled: 'Obrigatório quando a autenticação em duas etapas (2FA) estiver ativada',
    ...
    passwordForm: {
        ...
        error: {
            ...
            incorrect2fa: 'Código de autenticação de dois fatores incorreto. Tente novamente.',
            twoFactorAuthenticationEnabled: 'Você ativou a autenticação em duas etapas (2FA) nesta conta. Entre usando seu e-mail ou número de telefone.',
            invalidLoginOrPassword: 'Login ou senha inválidos. Tente novamente ou redefina sua senha.',
            unableToResetPassword:
                'Não foi possível alterar sua senha. Isso provavelmente ocorreu devido a um link de redefinição de senha expirado em um e-mail antigo de redefinição de senha. Enviamos um novo link por e-mail para que você possa tentar novamente. Verifique sua Caixa de Entrada e sua pasta de Spam; ele deverá chegar em apenas alguns minutos.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: 'Aqui está a lista de ambientes de trabalho que você pode entrar. Não se preocupe, você sempre poderá entrar neles mais tarde, se preferir.',
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.PERSONAL_SPEND]: 'Controlar e planejar despesas',
        ...
        employees: {
            title: 'Quantos funcionários vocês têm?',
        ...
        tasks: {
            ...
            testDriveEmployeeTask: {
                title: ({testDriveURL}) => `Faça um [test drive](${testDriveURL})`,
                description: ({testDriveURL}) => `Faça um [test drive](${testDriveURL}) e dê à sua equipe *3 meses grátis de Expensify!*`,
            },
            ...
            createTestDriveAdminWorkspaceTask: {
                ...
                description: 'Crie um espaço de trabalho e configure as definições com a ajuda do seu especialista de configuração!',
            },
            createWorkspaceTask: {
            ...
            setupCategoriesTask: {
                ...
                description: ({workspaceCategoriesLink}) =>
                    dedent(`
                        *Configure as categorias* para que sua equipe possa classificar despesas e facilitar os relatórios.

                        1. Clique em *Workspaces*.
                        3. Selecione o seu workspace.
                        4. Clique em *Categories*.
                        5. Desative quaisquer categorias que você não precisar.
                        ...
                        ![Configure as categorias](${CONST.CLOUDFRONT_URL}/videos/walkthrough-categories-v2.mp4)`),
            },
...
${
    integrationName && CONST.connectionsVideoPaths[integrationName]
            ...
            setupTagsTask: {
                ...
                description: ({workspaceMoreFeaturesLink}) =>
                    dedent(`
                        ...
                        5. Ative *Tags*.
                        6. Acesse *Tags* no editor do workspace.
                        7. Clique em *+ Add tag* para criar suas próprias.
            ...
            startChatTask: {
                ...
                description: dedent(`
                    *Inicie um chat* com qualquer pessoa usando o e-mail ou número de telefone dela.
                    ...
                    Todo chat também será enviado como um e-mail ou SMS ao qual ela poderá responder diretamente.
                `),
            },
            splitExpenseTask: {
                ...
                description: dedent(`
                    *Divida despesas* com uma ou mais pessoas.
                    ...
                    Sinta-se à vontade para adicionar mais detalhes, se quiser, ou simplesmente enviar. Vamos fazer você receber seu reembolso!
                `),
            },
            ...
            onboardingManageTeamMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) =>
                isOnboardingFlow
                    ? dedent(`
                        ...
                        👋 Olá, eu sou o seu especialista de configuração da Expensify. Já criei um workspace para ajudar a gerenciar os recibos e despesas da sua equipe. Para aproveitar ao máximo seus 30 dias de avaliação gratuita, basta seguir as etapas de configuração restantes abaixo!
                    `)
                    : dedent(`
                        # Seu teste gratuito começou! Vamos configurar tudo.

                        👋 Olá, sou o seu especialista de configuração do Expensify. Agora que você criou um workspace, aproveite ao máximo seu teste gratuito de 30 dias seguindo as etapas abaixo!
                    `),
            onboardingTrackWorkspaceMessage:
                '# Vamos configurar tudo para você\n👋 Olá, eu sou o seu especialista de configuração do Expensify. Já criei um workspace para ajudar a gerenciar seus recibos e despesas. Para aproveitar ao máximo o seu teste grátis de 30 dias, basta seguir as etapas de configuração restantes abaixo!',
        ...
        confirmWorkspace: {
            ...
            subtitle: 'Crie um workspace para rastrear recibos, reembolsar despesas, gerenciar viagens, criar relatórios e muito mais — tudo na velocidade de um chat.',
        },
        inviteMembers: {
    ...
    emailDeliveryFailurePage: {
        ourEmailProvider: ({login}: OurEmailProviderParams) =>
            `Nosso provedor de email suspendeu temporariamente os emails para ${login} devido a problemas de entrega. Para desbloquear seu login, siga estas etapas:`,
        confirmThat: ({login}: ConfirmThatParams) =>
            `<strong>Confirme que ${login} está escrito corretamente e é um endereço de e-mail real e válido para entrega.</strong> Apelidos de e-mail como "expenses@domain.com" devem ter acesso à própria caixa de entrada de e-mail para ser um login Expensify válido.`,
        ensureYourEmailClient: `<strong>Certifique-se de que seu cliente de e-mail permita e-mails de expensify.com.</strong> Você pode encontrar instruções sobre como concluir esta etapa <a href="${CONST.SET_NOTIFICATION_LINK}">aqui</a>, mas talvez seja necessário pedir ajuda ao seu departamento de TI para configurar as suas configurações de e-mail.`,
    ...
    openAppFailureModal: {
        ...
        subtitle: `Não foi possível carregar todos os seus dados. Já fomos notificados e estamos analisando o problema. Se isso persistir, entre em contato com`,
        refreshAndTryAgain: 'Atualize e tente novamente',
    },
    smsDeliveryFailurePage: {
        smsDeliveryFailureMessage: ({login}: OurEmailProviderParams) =>
            `Não conseguimos entregar mensagens SMS para ${login}, então o acesso foi temporariamente suspenso. Tente validar seu número:`,
    ...
    focusModeUpdateModal: {
        ...
        prompt: ({priorityModePageUrl}: FocusModeUpdateParams) =>
            `Mantenha-se no controle vendo apenas chats não lidos ou que precisam da sua atenção. Não se preocupe, você pode alterar isso a qualquer momento em <a href="${priorityModePageUrl}">configurações</a>.`,
    },
    notFound: {
        chatYouLookingForCannotBeFound: 'O chat que você está procurando não foi encontrado.',
        getMeOutOfHere: 'Tire-me daqui',
        iouReportNotFound: 'Os detalhes de pagamento que você procura não foram encontrados.',
        notHere: 'Hmm... não está aqui',
        pageNotFound: 'Opa, esta página não pode ser encontrada',
        noAccess: 'Este chat ou despesa pode ter sido excluído ou você não tem acesso a ele.\n\nPara quaisquer dúvidas, entre em contato com concierge@expensify.com',
    ...
    statusPage: {
        ...
        vacationDelegateWarning: ({nameOrEmail}: VacationDelegateParams) =>
            `Você está atribuindo ${nameOrEmail} como seu delegado de férias. Essa pessoa ainda não está em todos os seus espaços de trabalho. Se você decidir continuar, um e-mail será enviado a todos os administradores dos seus espaços de trabalho para adicioná-la.`,
    },
    ...
    bankAccount: {
        ...
        hasCurrencyError: ({workspaceRoute}: WorkspaceRouteParams) =>
            `Ops! Parece que a moeda do seu workspace está definida como uma moeda diferente de USD. Para continuar, acesse <a href="${workspaceRoute}">as configurações do seu workspace</a> para defini-la como USD e tente novamente.`,
        ...
        error: {
            ...
            taxID: 'Insira um número válido de identificação fiscal',
            ...
            noDefaultDepositAccountOrDebitCardAvailable: 'Adicione uma conta de depósito padrão ou um cartão de débito',
            validationAmounts: 'Os valores de validação que você inseriu estão incorretos. Verifique seu extrato bancário e tente novamente.',
    ...
    onfidoStep: {
        acceptTerms: 'Ao prosseguir com a solicitação para ativar sua Expensify Wallet, você confirma que leu, compreendeu e aceitou',
        ...
        cameraPermissionsNotGranted: 'Permitir acesso à câmera',
        ...
        originalDocumentNeeded: 'Faça upload de uma imagem original do seu documento de identificação, em vez de uma captura de tela ou imagem digitalizada.',
        documentNeedsBetterQuality:
            'Seu documento de identidade parece estar danificado ou com recursos de segurança ausentes. Faça o upload de uma imagem original de um documento não danificado que esteja totalmente visível.',
    ...
    additionalDetailsStep: {
        ...
        selectAnswer: 'Selecione uma resposta para prosseguir',
        ssnFull9Error: 'Insira um SSN de nove dígitos válido',
        needSSNFull9: 'Não foi possível verificar seu SSN. Insira os nove dígitos completos do seu SSN.',
    ...
    termsStep: {
        ...
        haveReadAndAgreePlain: 'Li e concordo em receber comunicações eletrônicas.',
        ...
        agreeToThe: ({walletAgreementUrl}: WalletAgreementParams) =>
            `Eu concordo com a <a href="${CONST.OLD_DOT_PUBLIC_URLS.PRIVACY_URL}">Política de Privacidade</a> e com o <a href="${walletAgreementUrl}">Acordo da Carteira</a>.`,
        ...
        shortTermsForm: {
            ...
            cashReload: 'Recarregar em dinheiro',
            inNetwork: 'na rede',
            ...
            fdicInsurance: 'Seus fundos são elegíveis para seguro da FDIC.',
            ...
            conditionsDetails: `Para obter detalhes e condições de todas as taxas e serviços, visite <a href="${CONST.FEES_URL}">${CONST.FEES_URL}</a> ou ligue para +1 833-400-0904.`,
        ...
        longTermsForm: {
            ...
            electronicFundsInstantDetails: ({percentage, amount}: ElectronicFundsParams) =>
                'Há uma taxa para transferir fundos da sua Carteira Expensify para o seu cartão de débito vinculado usando a opção de transferência instantânea. Essa transferência normalmente é concluída em alguns minutos.' +
            ...
            fdicInsuranceBancorp: ({amount}: TermsParams) =>
                ...
                `Uma vez lá, seus fundos são segurados até ${amount} pelo FDIC caso o ${CONST.WALLET.PROGRAM_ISSUERS.BANCORP_BANK} venha a falhar, se requisitos específicos de seguro de depósito forem atendidos e seu cartão estiver registrado. Consulte ${CONST.TERMS.FDIC_PREPAID} para mais detalhes.`,
            ...
            generalInformation: `Para obter informações gerais sobre contas pré-pagas, visite ${CONST.TERMS.CFPB_PREPAID}. Se você tiver uma reclamação sobre uma conta pré-paga, ligue para o Bureau de Proteção Financeira ao Consumidor pelo número 1-855-411-2372 ou visite ${CONST.TERMS.CFPB_COMPLAINT}.`,
    ...
    personalInfoStep: {
        ...
        enterTheLast4: 'Quais são os últimos quatro dígitos do seu número do Social Security?',
        ...
        whatsYourSSN: 'Quais são os últimos quatro dígitos do seu número do Social Security?',
    ...
    businessInfoStep: {
        ...
        listOfRestrictedBusinesses: 'lista de negócios restritos',
        confirmCompanyIsNot: 'Confirmo que esta empresa não está na',
        businessInfoTitle: 'Informações da empresa',
        legalBusinessName: 'Nome comercial legal',
    ...
    beneficialOwnerInfoStep: {
        doYouOwn25percent: ({companyName}: CompanyNameParams) => `Você possui 25% ou mais da ${companyName}?`,
        doAnyIndividualOwn25percent: ({companyName}: CompanyNameParams) => `Alguma pessoa física possui 25% ou mais de ${companyName}?`,
        areThereMoreIndividualsWhoOwn25percent: ({companyName}: CompanyNameParams) => `Existem outras pessoas que possuem 25% ou mais de ${companyName}?`,
        regulationRequiresUsToVerifyTheIdentity: 'Regulamentos exigem que verifiquemos a identidade de qualquer pessoa física que detenha mais de 25% do negócio.',
    ...
    ownershipInfoStep: {
        ...
        doesAnyoneOwn: ({companyName}: CompanyNameParams) => `Alguma pessoa física possui 25% ou mais de ${companyName}?`,
        ...
        regulationRequiresChart:
            'A legislação exige que coletemos uma cópia autenticada do organograma societário que mostre todas as pessoas físicas ou jurídicas que possuem 25% ou mais do negócio.',
        ...
        pleaseUpload: 'Faça upload de documentação adicional abaixo para nos ajudar a verificar sua identidade como proprietário direto ou indireto de 25% ou mais da entidade empresarial.',
        ...
        proofOfBeneficialOwnerDescription:
            'Forneça uma declaração assinada e um organograma emitidos por um contador público, tabelião ou advogado, verificando a propriedade de 25% ou mais do negócio. O documento deve estar datado dos últimos três meses e incluir o número da licença do signatário.',
    ...
    completeVerificationStep: {
        ...
        isAuthorizedToUseBankAccount: 'Estou autorizado a usar esta conta bancária empresarial para gastos da empresa',
        isAuthorizedToUseBankAccountError: 'Você deve ser um administrador com autorização para operar a conta bancária da empresa',
    ...
    connectBankAccountStep: {
        ...
        letsChatText: 'Quase pronto! Precisamos da sua ajuda para verificar mais algumas informações pelo chat. Pronto?',
    ...
    countryStep: {
        confirmBusinessBank: 'Confirmar moeda e país da conta bancária empresarial',
        confirmCurrency: 'Confirmar moeda e país',
        yourBusiness: 'A moeda da conta bancária empresarial deve ser a mesma moeda do seu workspace.',
    ...
    signerInfoStep: {
        signerInfo: 'Informações do signatário',
        areYouDirector: ({companyName}: CompanyNameParams) => `Você é diretor(a) na ${companyName}?`,
        regulationRequiresUs: 'Regulamentos exigem que verifiquemos se o signatário tem autoridade para tomar esta ação em nome da empresa.',
        ...
        personalAddress: 'Comprovante de endereço residencial (ex.: conta de serviços públicos)',
        letsDoubleCheck: 'Vamos conferir se está tudo certo.',
        legalName: 'Nome legal',
        proofOf: 'Comprovante de endereço residencial',
        enterOneEmail: ({companyName}: CompanyNameParams) => `Digite o e-mail de um diretor da ${companyName}`,
        ...
        enterTwoEmails: ({companyName}: CompanyNameParams) => `Digite os e-mails de dois diretores em ${companyName}`,
        sendReminder: 'Enviar lembrete',
        chooseFile: 'Escolher arquivo',
        weAreWaiting: 'Estamos aguardando que outras pessoas verifiquem suas identidades como diretoras da empresa.',
        ...
        PDSandFSGDescription: dedent(`
            Nossa parceria com a Corpay utiliza uma conexão de API para aproveitar sua vasta rede de parceiros bancários internacionais a fim de viabilizar Reembolsos Globais no Expensify. De acordo com a regulamentação australiana, estamos fornecendo a você o Financial Services Guide (FSG) e o Product Disclosure Statement (PDS) da Corpay.
        ...
        isConnecting: ({bankAccountLastFour, currency}: SignerInfoMessageParams) =>
            `está conectando uma conta bancária empresarial em ${currency} com final ${bankAccountLastFour} à Expensify para pagar funcionários em ${currency}. A próxima etapa exige as informações de assinatura de um diretor.`,
        error: {
    ...
    agreementsStep: {
        ...
        regulationRequiresUs: 'Regulamentos exigem que verifiquemos a identidade de qualquer pessoa física que detenha mais de 25% do negócio.',
        ...
        error: {
            authorized: 'Você deve ser um administrador com autorização para operar a conta bancária da empresa',
    ...
    docusignStep: {
        ...
        pleaseComplete:
            'Por favor, preencha o formulário de autorização ACH usando o link do Docusign abaixo e, em seguida, faça o upload da cópia assinada aqui para que possamos debitar fundos diretamente da sua conta bancária.',
        pleaseCompleteTheBusinessAccount: 'Conclua o formulário de Débito Direto da Solicitação de Conta Empresarial',
        pleaseCompleteTheDirect:
            'Conclua o Acordo de Débito Direto usando o link do Docusign abaixo e, em seguida, faça o upload da cópia assinada aqui para que possamos debitar fundos diretamente da sua conta bancária.',
        ...
        pleaseUploadTheDirect: 'Faça upload do Acordo de Débito Direto e da página de assinatura Docusign',
    },
    finishStep: {
        letsFinish: 'Vamos terminar no chat!',
        thanksFor:
            'Obrigado pelos detalhes. Um agente de suporte dedicado analisará suas informações agora. Entraremos em contato se precisarmos de mais alguma coisa, mas, enquanto isso, sinta-se à vontade para falar conosco em caso de dúvidas.',
    ...
    travel: {
        ...
        domainPermissionInfo: {
            ...
            restriction: ({domain}: DomainPermissionInfoRestrictionParams) =>
                `Você não tem permissão para ativar o Expensify Travel para o domínio <strong>${domain}</strong>. Em vez disso, você precisará pedir para alguém desse domínio ativar a viagem.`,
        ...
        blockedFeatureModal: {
            ...
            message: `Seu administrador desativou o Expensify Travel. Siga a política de reservas de viagem da sua empresa para fazer os arranjos de viagem.`,
        },
        verifyCompany: {
            title: 'Estamos analisando sua solicitação...',
            message: `Estamos realizando algumas verificações do nosso lado para garantir que sua conta esteja pronta para o Expensify Travel. Entraremos em contato em breve!`,
            confirmText: 'Entendi',
        ...
        updates: {
            ...
            paymentDeclined: 'O pagamento da sua reserva aérea falhou. Tente novamente.',
    ...
    workspace: {
        common: {
            ...
            notAuthorized: `Você não tem acesso a esta página. Se estiver tentando entrar neste workspace, basta pedir ao proprietário do workspace para adicioná-lo como membro. Algo diferente? Entre em contato com ${CONST.EMAIL.CONCIERGE}.`,
            ...
            shareNote: {
                ...
                content: ({adminsRoomLink}: WorkspaceShareNoteParams) =>
                    `Compartilhe este código QR ou copie o link abaixo para facilitar que os membros solicitem acesso ao seu workspace. Todas as solicitações para entrar no workspace aparecerão na sala <a href="${adminsRoomLink}">${CONST.REPORT.WORKSPACE_CHAT_ROOMS.ADMINS}</a> para a sua análise.`,
            },
            ...
            existingConnectionsDescription: ({connectionName}: ConnectionNameParams) =>
                `Como você já conectou ao ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]} antes, pode optar por reutilizar uma conexão existente ou criar uma nova.`,
            ...
            adminAlternateText: 'Admins têm acesso completo de edição a todos os relatórios e configurações do workspace.',
        ...
        receiptPartners: {
            ...
            uber: {
                ...
                sendInvitesDescription: 'Estes membros do workspace ainda não têm uma conta Uber for Business. Desmarque os membros que você não deseja convidar neste momento.',
                ...
                centralBillingAccount: 'Conta central de faturamento',
                centralBillingDescription: 'Escolha para onde importar todos os recibos da Uber.',
                ...
                bannerDescription: 'Conecte o Uber for Business para automatizar as despesas de viagens e entregas de refeição em toda a sua organização.',
                emptyContent: {
                    title: 'Nenhum convite pendente',
                    subtitle: 'Uau! Procuramos em todo lugar e não encontramos nenhum convite pendente.',
                },
            },
        },
        perDiem: {
            subtitle: `<muted-text>Defina as diárias para controlar os gastos diários dos funcionários. <a href="${CONST.DEEP_DIVE_PER_DIEM}">Saiba mais</a>.</muted-text>`,
            amount: 'Valor',
            deleteRates: () => ({
                one: 'Excluir taxa',
                other: 'Excluir tarifas',
            }),
            deletePerDiemRate: 'Excluir tarifa de diária',
            ...
            emptyList: {
                title: 'Diária',
                subtitle: 'Defina as diárias para controlar os gastos diários dos funcionários. Importe as taxas de uma planilha para começar.',
            },
            ...
            editCurrencySubtitle: ({destination}: EditDestinationSubtitleParams) => `Atualizar esta moeda irá alterá-la para todas as subtarifas de diária em ${destination}.`,
        },
        qbd: {
            exportOutOfPocketExpensesDescription: 'Defina como as despesas pagas do próprio bolso serão exportadas para o QuickBooks Desktop.',
            ...
            exportJournalEntryDescription: 'Vamos criar um lançamento contábil itemizado para cada relatório do Expensify e lançá-lo na conta abaixo.',
            exportVendorBillDescription:
                'Criaremos uma conta detalhada de fornecedor para cada relatório do Expensify e a adicionaremos à conta abaixo. Se este período estiver fechado, lançaremos no 1º do próximo período em aberto.',
            outOfPocketTaxEnabledDescription:
                'QuickBooks Desktop não oferece suporte a impostos em exportações de lançamentos contábeis. Como você habilitou impostos no seu workspace, essa opção de exportação está indisponível.',
            ...
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}Description`]:
                    'Vamos corresponder automaticamente o nome do estabelecimento na transação do cartão de crédito com qualquer fornecedor correspondente no QuickBooks. Se não existirem fornecedores, criaremos um fornecedor “Credit Card Misc.” para associação.',
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}Description`]:
                    'Vamos criar uma conta detalhada de fornecedor para cada relatório do Expensify com a data da última despesa e adicioná-la à conta abaixo. Se este período estiver fechado, lançaremos no 1º dia do próximo período em aberto.',
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}Error`]:
                    'As contas de fornecedor não estão disponíveis quando os locais estão ativados. Escolha uma opção de exportação diferente.',
            ...
            requiredSetupDevice: {
                ...
                body1: 'Você precisará configurar essa conexão no computador que hospeda o arquivo da sua empresa no QuickBooks Desktop.',
            ...
            accountingMethods: {
                ...
                alternateText: {
                    ...
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]: 'As despesas reembolsáveis serão exportadas quando forem pagas',
                },
            },
        },
        qbo: {
            ...
            companyCardsLocationEnabledDescription:
                'QuickBooks Online não oferece suporte a locais em exportações de contas de fornecedores. Como você ativou locais no seu workspace, esta opção de exportação não está disponível.',
            outOfPocketTaxEnabledDescription:
            ...
            exportDestinationAccountsMisconfigurationError: {
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]: 'Escolha uma conta válida para exportar contas de fornecedores',
        ...
        xero: {
            ...
            mapTrackingCategoryToDescription: ({categoryName}: CategoryNameParams) => `Escolha para onde mapear ${categoryName} ao exportar para o Xero.`,
            customers: 'Refaturar clientes',
            customersDescription:
                'Escolha se deseja refaturar clientes no Expensify. Seus contatos de clientes do Xero podem ser associados a despesas e serão exportados para o Xero como uma nota fiscal de venda.',
            ...
            advancedConfig: {
                autoSyncDescription: 'O Expensify fará a sincronização automática com o Xero todos os dias.',
                ...
                xeroInvoiceCollectionAccount: 'Conta de recebimento de faturas do Xero',
        ...
        sageIntacct: {
            ...
            exportPreferredExporterSubNote: 'Uma vez definido, o exportador preferido verá os relatórios para exportação na própria conta.',
            noAccountsFound: 'Nenhuma conta encontrada',
            noAccountsFoundDescription: `Adicione a conta no Sage Intacct e sincronize a conexão novamente`,
            autoSync: 'Sincronização automática',
            autoSyncDescription: 'O Expensify irá sincronizar automaticamente com o Sage Intacct todos os dias.',
            inviteEmployees: 'Convidar funcionários',
            inviteEmployeesDescription:
                'Importe registros de funcionários do Sage Intacct e convide funcionários para este espaço de trabalho. Seu fluxo de aprovação terá como padrão a aprovação do gerente e poderá ser configurado mais detalhadamente na página Membros.',
        ...
        netsuite: {
            ...
            nonReimbursableJournalPostingAccount: 'Conta de lançamento em diário não reembolsável',
            reimbursableJournalPostingAccount: 'Conta de lançamento de diário reembolsável',
            journalPostingPreference: {
                label: 'Preferência de lançamento de diários',
                values: {
            ...
            invoiceItem: {
                ...
                values: {
                    [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
                        ...
                        description: 'Criaremos um “item de linha de fatura do Expensify” para você na exportação (se ainda não existir).',
                    },
            ...
            exportDestination: {
                values: {
                    [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
                        ...
                        nonReimbursableDescription: 'Despesas de cartões corporativos serão exportadas como relatórios de despesas para o NetSuite.',
                    },
                    [CONST.NETSUITE_EXPORT_DESTINATION.VENDOR_BILL]: {
                        label: 'Contas de fornecedores',
                        reimbursableDescription: dedent(`
                            As despesas não reembolsadas serão exportadas como contas a pagar ao fornecedor do NetSuite especificado abaixo.
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        reimbursableDescription: dedent(`
                            Despesas pagas do próprio bolso serão exportadas como lançamentos de diário para a conta do NetSuite especificada abaixo.

                            Se você quiser definir um fornecedor específico para cada cartão, vá em *Configurações > Domínios > Cartões Corporativos*.
                        `),
                        nonReimbursableDescription: dedent(`
                            As despesas de cartão corporativo serão exportadas como lançamentos contábeis para a conta do NetSuite especificada abaixo.

                            Se você quiser definir um fornecedor específico para cada cartão, vá em *Settings > Domains > Company Cards*.
                        `),
                    },
                },
            ...
            advancedConfig: {
                ...
                inviteEmployeesDescription:
                    'Importe os registros de funcionários do NetSuite e convide funcionários para este espaço de trabalho. Seu fluxo de aprovação terá como padrão a aprovação do gerente e poderá ser configurado ainda mais na página *Membros*.',
                ...
                customFormIDDescription:
                    'Por padrão, o Expensify criará lançamentos usando o formulário de transação preferencial definido no NetSuite. Alternativamente, você pode definir um formulário de transação específico a ser usado.',
                ...
                exportReportsTo: {
                    ...
                    values: {
                        ...
                        [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED]: 'Somente supervisor aprovado',
                        [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED]: 'Apenas aprovados pela contabilidade',
            ...
            import: {
                ...
                importCustomFields: {
                    ...
                    requiredFieldError: ({fieldName}: RequiredFieldParams) => `Insira o(a) ${fieldName} por favor`,
                    customSegments: {
                        ...
                        emptyTitle: 'Adicionar um segmento personalizado ou um registro personalizado',
                        fields: {
                            segmentName: 'Nome',
                        ...
                        removePrompt: 'Tem certeza de que deseja remover este segmento/registo personalizado?',
                        addForm: {
...
_Para instruções mais detalhadas, [acesse nosso site de ajuda](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
...
3. Localize o ID do campo de transação no lado esquerdo.
...
_Para obter instruções mais detalhadas, [visite nossa central de ajuda](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
                ...
                importTypes: {
                    ...
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
                        ...
                        footerContent: ({importField}: ImportFieldParams) => `${startCase(importField)} ficará selecionável para cada despesa individual no relatório do funcionário.`,
                    },
        ...
        intacct: {
            ...
            employeeDefaultDescription: 'Se existir, o departamento padrão do funcionário será aplicado às suas despesas no Sage Intacct.',
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                whereIsYourBankLocated: 'Onde fica localizado o seu banco?',
                ...
                commercialFeedDetails: 'Requer configuração com o seu banco. Isso geralmente é usado por empresas maiores e costuma ser a melhor opção, se você atender aos requisitos.',
                commercialFeedPlaidDetails: `Requer configuração com seu banco, mas nós vamos orientar você. Isso geralmente é limitado a empresas maiores.`,
                ...
                enableFeed: {
                    ...
                    heading:
                        'Temos uma integração direta com o emissor do seu cartão e podemos importar seus dados de transações para o Expensify de forma rápida e precisa.\n\nPara começar, basta:',
                    ...
                    vcf: `1. Visite [este artigo de ajuda](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP}) para instruções detalhadas sobre como configurar seus Visa Commercial Cards.

2. [Entre em contato com seu banco](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP}) para verificar se ele oferece suporte a um feed comercial para o seu programa e peça para habilitá-lo.

3. *Depois que o feed estiver habilitado e você tiver os detalhes, continue para a próxima tela.*`,
                    gl1025: `1. Acesse [este artigo de ajuda](${CONST.COMPANY_CARDS_AMEX_COMMERCIAL_CARD_HELP}) para descobrir se a American Express pode habilitar um feed comercial para o seu programa.

2. Assim que o feed estiver habilitado, a Amex enviará uma carta de produção.
...
3. *Assim que o feed estiver habilitado e você tiver os detalhes, continue para a próxima tela.*`,
                    stripe: `1. Acesse o Dashboard da Stripe e vá para [Settings](${CONST.COMPANY_CARDS_STRIPE_HELP}).

2. Em Product Integrations, clique em Enable ao lado de Expensify.

3. Quando o feed estiver habilitado, clique em Submit abaixo e nós cuidaremos de adicioná-lo.`,
                },
                ...
                amexBusiness: 'Selecione esta opção se a parte da frente dos seus cartões disser “Business”',
            ...
            somethingMightBeBroken:
                '<muted-text><centered-text>Ou algo pode estar quebrado. De qualquer forma, se você tiver alguma dúvida, apenas <concierge-link>contate o Concierge</concierge-link>.</centered-text></muted-text>',
            ...
            brokenConnectionError:
                '<rbr>A conexão com o feed do cartão está interrompida. Por favor, <a href="#">faça login no seu banco</a> para que possamos restabelecer a conexão.</rbr>',
            assignedCard: ({assignee, link}: AssignedCardParams) => `atribuiu a ${assignee} um(a) ${link}! As transações importadas aparecerão neste chat.`,
            companyCard: 'cartão corporativo',
            chooseCardFeed: 'Escolher feed de cartão',
            ukRegulation:
                'Expensify Limited é um agente da Plaid Financial Ltd., uma instituição de pagamento autorizada e regulamentada pela Financial Conduct Authority sob as Payment Services Regulations 2017 (Número de Referência da Empresa: 804718). A Plaid fornece a você serviços regulados de informações de conta por meio da Expensify Limited como seu agente.',
        },
        expensifyCard: {
            ...
            verifyingTheDetails: 'Estamos verificando alguns detalhes. Concierge avisará você quando os Cartões Expensify estiverem prontos para emissão.',
            disclaimer:
            ...
            remainingLimitDescription:
                'Levamos em conta diversos fatores ao calcular o seu limite restante: o tempo em que você é cliente, as informações relacionadas ao negócio fornecidas durante o cadastro e o dinheiro disponível na conta bancária da sua empresa. O seu limite restante pode variar diariamente.',
            ...
            issuedCardNoShippingDetails: ({assignee}: AssigneeParams) => `emitiu um Expensify Card para ${assignee}! O cartão será enviado assim que os detalhes de envio forem confirmados.`,
            issuedCardVirtual: ({assignee, link}: IssueVirtualCardParams) => `emitiu um Cartão virtual da Expensify para ${assignee}! O ${link} pode ser usado imediatamente.`,
        ...
        categories: {
            ...
            defaultSpendCategories: 'Categorias padrão de gastos',
            ...
            emptyCategories: {
                ...
                subtitleWithAccounting: ({accountingPageURL}: EmptyCategoriesSubtitleWithAccountingParams) =>
                    `<muted-text><centered-text>Suas categorias estão sendo importadas de uma conexão contábil no momento. Vá até <a href="${accountingPageURL}">contabilidade</a> para fazer qualquer alteração.</centered-text></muted-text>`,
            },
        ...
        moreFeatures: {
            subtitle: 'Use os botões de alternância abaixo para ativar mais recursos conforme você cresce. Cada recurso aparecerá no menu de navegação para mais personalizações.',
            spendSection: {
                title: 'Gastos',
            ...
            perDiem: {
                title: 'Diária',
                subtitle: 'Defina as diárias para controlar os gastos diários dos funcionários.',
            },
            expensifyCard: {
            ...
            companyCards: {
                ...
                feed: {
                    ...
                    features: {
                        support: 'Suporte para todos os principais emissores de cartão',
                        assignCards: 'Atribuir cartões a toda a equipe',
                ...
                integrationExport: ({integration, type}: IntegrationExportParams) =>
                    integration && type ? `exportação de ${integration} ${type.toLowerCase()}` : `Exportação do ${integration}`,
                ...
                cardFeedNameDescription: 'Dê um nome exclusivo ao feed de cartão para diferenciá-lo dos demais.',
                cardFeedTransaction: 'Excluir transações',
                cardFeedTransactionDescription: 'Escolha se os portadores do cartão podem excluir transações do cartão. Novas transações seguirão essas regras.',
                ...
                pendingBankDescription: ({bankName}: CompanyCardBankName) => `Conecte-se ao ${bankName} pela janela do navegador que acabou de abrir. Se nenhuma janela tiver sido aberta,`,
                pendingBankLink: 'clique aqui',
            ...
            workflowWarningModal: {
                ...
                confirmText: 'Ir para os Cartões Expensify',
            },
            rules: {
                title: 'Regras',
                subtitle: 'Exija recibos, sinalize gastos elevados e muito mais.',
            },
        },
        reports: {
            ...
            customNameDescription: `Escolha um nome personalizado para relatórios de despesa usando nossas <a href="${CONST.CUSTOM_REPORT_NAME_HELP_URL}">fórmulas avançadas</a>.`,
        ...
        tags: {
            ...
            emptyTags: {
                ...
                subtitleWithAccounting: ({accountingPageURL}: EmptyTagsSubtitleWithAccountingParams) =>
                    `<muted-text><centered-text>Suas tags estão sendo importadas de uma conexão contábil no momento. Vá para <a href="${accountingPageURL}">contabilidade</a> para fazer qualquer alteração.</centered-text></muted-text>`,
            },
            ...
            cannotDeleteOrDisableAllTags: {
                ...
                description: `Pelo menos uma tag deve permanecer ativada porque o seu workspace exige tags.`,
            },
        ...
        duplicateWorkspace: {
            ...
            welcomeNote: 'Por favor, comece a usar meu novo workspace',
        ...
        emptyWorkspace: {
            ...
            subtitle: 'Rastreie recibos, reembolse despesas, gerencie viagens, envie faturas e muito mais.',
            ...
            description: 'As salas são um ótimo lugar para discutir e trabalhar com várias pessoas. Para começar a colaborar, crie ou entre em um workspace',
        },
        new: {
        ...
        people: {
            ...
            removeMembersWarningPrompt: ({memberName, ownerName}: RemoveMembersWarningPrompt) =>
                `${memberName} é um aprovador neste espaço de trabalho. Quando você deixar de compartilhar este espaço de trabalho com ele(a), iremos substituí-lo(a) no fluxo de aprovação pelo(a) proprietário(a) do espaço de trabalho, ${ownerName}`,
            removeMembersTitle: () => ({
                one: 'Remover membro',
            ...
            removeMemberPromptTechContact: ({memberName, workspaceOwner}: {memberName: string; workspaceOwner: string}) =>
                `Se você remover ${memberName} deste workspace, nós os substituiremos como contato técnico por ${workspaceOwner}, o proprietário do workspace.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                giveItNameInstruction: 'Torne-o exclusivo o suficiente para diferenciá-lo de outros cartões. Casos de uso específicos são ainda melhores!',
                cardName: 'Nome do cartão',
                letsDoubleCheck: 'Vamos conferir se está tudo certo.',
        ...
        accounting: {
            ...
            talkYourOnboardingSpecialist: 'Converse com o seu especialista de configuração.',
            ...
            connectPrompt: ({connectionName}: ConnectionNameParams) =>
                `Tem certeza de que deseja conectar ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName] ?? 'esta integração contábil'}? Isso removerá quaisquer conexões de contabilidade existentes.`,
            ...
            exportOutOfPocket: 'Exportar despesas fora do bolso como',
            ...
            saveHoursOnReconciliation:
                'Economize horas em cada período contábil ao permitir que a Expensify reconcilie continuamente, em seu nome, os extratos e liquidações do Expensify Card.',
        ...
        editor: {
            ...
            avatarUploadFailureMessage: 'Ocorreu um erro ao carregar o avatar. Tente novamente.',
            addressContext: 'Um Endereço do Workspace é obrigatório para ativar o Expensify Travel. Insira um endereço associado à sua empresa.',
            policy: 'Política de despesas',
        },
        bankAccount: {
            continueWithSetup: 'Continuar configuração',
            youAreAlmostDone:
                'Você está quase terminando de configurar sua conta bancária, o que permitirá emitir cartões corporativos, reembolsar despesas, receber faturas e pagar contas.',
            ...
            disconnectYourBankAccount: ({bankName}: DisconnectYourBankAccountParams) =>
                `Desconecte sua conta bancária <strong>${bankName}</strong>. Quaisquer transações pendentes para esta conta ainda serão concluídas.`,
            clearProgress: 'Recomeçar apagará o progresso que você fez até agora.',
            areYouSure: 'Tem certeza?',
            workspaceCurrency: 'Moeda do workspace',
            updateCurrencyPrompt: 'Parece que o seu workspace está atualmente definido para uma moeda diferente de USD. Clique no botão abaixo para atualizar sua moeda para USD agora.',
            ...
            yourWorkspace: `Seu workspace está definido para uma moeda não compatível. Veja a <a href="${CONST.CONNECT_A_BUSINESS_BANK_ACCOUNT_HELP_URL}">lista de moedas compatíveis</a>.`,
...
Você quer transferir esse valor (${amount}) para assumir a cobrança deste workspace? Seu cartão de pagamento será cobrado imediatamente.`,
            ...
            subscriptionText: ({usersCount, finalCount}: ChangeOwnerSubscriptionParams) =>
                `Assumir este workspace fará com que a assinatura anual dele seja mesclada com a sua assinatura atual. Isso aumentará o tamanho da sua assinatura em ${usersCount} membros, tornando o novo tamanho da sua assinatura ${finalCount}. Deseja continuar?`,
            duplicateSubscriptionTitle: 'Alerta de assinatura duplicada',
            duplicateSubscriptionButtonText: '- Inglês\n- Espanhol\n- Alemão\n- Francês\n- Italiano\n- Japonês\n- Holandês\n- Polonês\n- Português (BR)\n- Chinês (Simplificado)',
            duplicateSubscriptionText: ({
                email,
                workspaceName,
            }: ChangeOwnerDuplicateSubscriptionParams) => `Parece que você está tentando assumir o faturamento dos workspaces de ${email}, mas, para isso, você precisa ser administrador em todos os workspaces dessa pessoa primeiro.

Clique em "Continuar" se você quiser assumir o faturamento apenas do workspace ${workspaceName}.

Se você quiser assumir o faturamento de toda a assinatura, peça para que essa pessoa adicione você como administrador em todos os workspaces dela antes de assumir o faturamento.`,
            hasFailedSettlementsTitle: 'Não é possível transferir a propriedade',
            hasFailedSettlementsButtonText: 'Entendi',
            hasFailedSettlementsText: ({email}: ChangeOwnerHasFailedSettlementsParams) =>
                `Você não pode assumir a cobrança porque ${email} tem uma quitação em atraso do Expensify Card. Peça para que entrem em contato com concierge@expensify.com para resolver o problema. Depois disso, você poderá assumir a cobrança deste workspace.`,
...
Tem certeza de que deseja exportá-los novamente?`,
        ...
        upgrade: {
            reportFields: {
                title: 'Campos do relatório',
                description: `Os campos de relatório permitem especificar detalhes no nível do cabeçalho, distintos das tags que se aplicam às despesas em itens de linha individuais. Esses detalhes podem incluir nomes específicos de projetos, informações sobre viagens de negócios, localizações e muito mais.`,
            ...
            [CONST.POLICY.CONNECTIONS.NAME.NETSUITE]: {
                title: 'NetSuite',
                description: `Aproveite a sincronização automática e reduza lançamentos manuais com a integração Expensify + NetSuite. Obtenha insights financeiros aprofundados e em tempo real com suporte a segmentos nativos e personalizados, incluindo mapeamento de projetos e clientes.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.POLICY.CONNECTIONS.NAME.SAGE_INTACCT]: {
                title: 'Sage Intacct',
                description: `Aproveite a sincronização automática e reduza lançamentos manuais com a integração Expensify + Sage Intacct. Obtenha insights financeiros profundos e em tempo real com dimensões definidas pelo usuário, além de categorização de despesas por departamento, classe, local, cliente e projeto (trabalho).`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.POLICY.CONNECTIONS.NAME.QBD]: {
                ...
                description: `Aproveite a sincronização automática e reduza os lançamentos manuais com a integração Expensify + QuickBooks Desktop. Alcance a máxima eficiência com uma conexão bidirecional em tempo real e categorização de despesas por classe, item, cliente e projeto.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            categories: {
                title: 'Categorias',
                description: 'Categorias permitem que você monitore e organize seus gastos. Use nossas categorias padrão ou adicione as suas próprias.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            glCodes: {
                title: 'Códigos de contabilidade geral',
            ...
            glAndPayrollCodes: {
                ...
                description: `Adicione códigos de GL e Folha de Pagamento às suas categorias para facilitar a exportação de despesas para seus sistemas contábeis e de folha de pagamento.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
...
Exija detalhes da despesa, como recibos e descrições, defina limites e padrões e automatize aprovações e pagamentos – tudo em um só lugar.`,
            ...
            perDiem: {
                title: 'Diária',
                description:
                    'Per diem é uma ótima forma de manter seus custos diários em conformidade e previsíveis sempre que seus funcionários viajarem. Aproveite recursos como taxas personalizadas, categorias padrão e detalhes mais granulares, como destinos e subtaxas.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Diárias estão disponíveis apenas no plano Control, a partir de <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `por membro por mês.` : `por membro ativo por mês.`}</muted-text>`,
            },
            travel: {
                title: 'Viagem',
                description:
                    'Expensify Travel é uma nova plataforma corporativa de reserva e gestão de viagens que permite aos membros reservarem acomodações, voos, transporte e muito mais.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            multiLevelTags: {
                ...
                description:
                    'Tags em múltiplos níveis ajudam você a rastrear despesas com maior precisão. Atribua várias tags a cada item de linha — como departamento, cliente ou centro de custo — para capturar o contexto completo de cada despesa. Isso permite relatórios mais detalhados, fluxos de aprovação e exportações contábeis.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Tags multinível estão disponíveis apenas no plano Control, a partir de <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `por membro por mês.` : `por membro ativo por mês.`}</muted-text>`,
            },
            distanceRates: {
                title: 'Tarifas de distância',
            ...
            [CONST.UPGRADE_FEATURE_INTRO_MAPPING.multiApprovalLevels.id]: {
                ...
                description:
                    'Vários níveis de aprovação são uma ferramenta de fluxo de trabalho para empresas que exigem mais de uma pessoa para aprovar um relatório antes que ele possa ser reembolsado.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            commonFeatures: {
                title: 'Atualize para o plano Control',
                ...
                benefits: {
                    ...
                    benefit3: 'Fluxos de trabalho de aprovação em vários níveis',
        ...
        downgrade: {
            ...
            completed: {
                ...
                description: 'Você tem outros espaços de trabalho no plano Control. Para serem cobrados na tarifa Collect, é necessário rebaixar todos os espaços de trabalho.',
                gotIt: 'Entendi, obrigado(a)',
            },
        },
        payAndDowngrade: {
            ...
            subscription:
                'Atenção! Esta ação encerrará sua assinatura do Expensify, excluirá este workspace e removerá todos os membros do workspace. Se você quiser manter este workspace e apenas se remover, peça para outro administrador assumir o faturamento primeiro.',
            genericFailureMessage: 'Ocorreu um erro ao pagar sua conta. Tente novamente.',
        },
        restrictedAction: {
            restricted: 'Restrito',
            ...
            youWillNeedToAddOrUpdatePaymentCard: 'Você precisará adicionar ou atualizar o cartão de pagamento em arquivo para desbloquear novas atividades no workspace.',
        ...
        rules: {
            individualExpenseRules: {
                ...
                receiptRequiredAmount: 'Valor que requer recibo',
                ...
                cashExpenseDefaultDescription:
                    'Escolha como as despesas em dinheiro devem ser criadas. Uma despesa é considerada uma despesa em dinheiro se não for uma transação de cartão corporativo importada. Isso inclui despesas criadas manualmente, recibos, diárias, despesas de distância e de tempo.',
                ...
                billableDefault: 'Cobrável padrão',
                ...
                eReceipts: 'eReceipts',
                eReceiptsHint: `eReceipts são criados automaticamente [para a maioria das transações de crédito em USD](${CONST.DEEP_DIVE_ERECEIPTS}).`,
                attendeeTracking: 'Acompanhamento de participantes',
                attendeeTrackingHint: 'Acompanhe o custo por pessoa de cada despesa.',
                prohibitedDefaultDescription:
                    'Marque quaisquer recibos em que apareçam álcool, jogos de azar ou outros itens restritos. Despesas com recibos em que essas linhas de item aparecem exigirão revisão manual.',
            ...
            expenseReportRules: {
                ...
                preventSelfApprovalsTitle: 'Evitar autoaprovações',
                ...
                autoApproveReportsUnderDescription: 'Relatórios de despesas totalmente em conformidade abaixo desse valor serão aprovados automaticamente.',
                randomReportAuditTitle: 'Auditoria aleatória de relatório',
                randomReportAuditDescription: 'Exigir que alguns relatórios sejam aprovados manualmente, mesmo que estejam qualificados para aprovação automática.',
                ...
                autoPayApprovedReportsLimitError: ({currency}: AutoPayApprovedReportsLimitErrorParams = {}) => `Insira um valor menor que ${currency ?? ''}20.000`,
                autoPayApprovedReportsLockedSubtitle: 'Vá até “Mais recursos” e ative “Workflows”, depois adicione “Pagamentos” para desbloquear este recurso.',
                autoPayReportsUnderTitle: 'Relatórios com pagamento automático em andamento',
                ...
                unlockFeatureEnableWorkflowsSubtitle: ({featureName, moreFeaturesLink}: FeatureNameParams) =>
                    `Vá para [mais recursos](${moreFeaturesLink}) e ative os fluxos de trabalho, depois adicione ${featureName} para desbloquear este recurso.`,
            ...
            categoryRules: {
                ...
                flagAmountsOver: 'Assinalar valores acima de',
                ...
                expenseLimitTypes: {
                    ...
                    expenseSubtitle: 'Sinalizar valores de despesa por categoria. Esta regra substitui a regra geral do espaço de trabalho para o valor máximo de despesa.',
                    daily: 'Total da categoria',
                    dailySubtitle: 'Sinalizar o gasto total por categoria em cada relatório de despesas.',
                },
        ...
        planTypePage: {
            ...
            lockedPlanDescription: ({count, annualSubscriptionEndDate}: WorkspaceLockedPlanTypeParams) => ({
                one: `Você se comprometeu com 1 membro ativo no plano Control até o término da sua assinatura anual em ${annualSubscriptionEndDate}. Você poderá mudar para a assinatura pós-paga e fazer o downgrade para o plano Collect a partir de ${annualSubscriptionEndDate}, desativando a renovação automática em`,
    ...
    getAssistancePage: {
        ...
        exploreHelpDocs: 'Explorar a central de ajuda',
    ...
    newRoomPage: {
        ...
        renamedRoomAction: ({oldName, newName, actorName, isExpenseReport}: RenamedRoomActionParams) => {
            ...
            return isExpenseReport ? `${actor}renomeado para "${newName}" (anteriormente "${oldName}")` : `${actor}renomeou esta sala para "${newName}" (antes "${oldName}")`;
        },
    ...
    workspaceApprovalModes: {
        ...
        advanced: 'AVANÇADO',
        dynamicExternal: 'DINÂMICO EXTERNO',
    ...
    workspaceActions: {
        ...
        updateApprovalRule: ({field, name, newApproverEmail, newApproverName, oldApproverEmail, oldApproverName}: UpdatedPolicyApprovalRuleParams) => {
            ...
            return `aprovador alterado para o campo ${field} "${name}" para ${formatApprover(newApproverName, newApproverEmail)} (anteriormente ${formatApprover(oldApproverName, oldApproverEmail)})`;
        },
        ...
        updateCustomUnit: ({customUnitName, newValue, oldValue, updatedField}: UpdatePolicyCustomUnitParams) =>
            `alterou ${customUnitName} ${updatedField} para "${newValue}" (antes "${oldValue}")`,
        updateCustomUnitTaxEnabled: ({newValue}: UpdatePolicyCustomUnitTaxEnabledParams) => `${newValue ? 'habilitado' : 'Desativado'} rastreamento de impostos em taxas por distância`,
        ...
        updatedCustomUnitRate: ({customUnitName, customUnitRateName, newValue, oldValue, updatedField}: UpdatedPolicyCustomUnitRateParams) =>
            `alterou a taxa do(a) ${customUnitName} ${updatedField} "${customUnitRateName}" para "${newValue}" (anteriormente "${oldValue}")`,
        ...
        deleteCustomUnitRate: ({customUnitName, rateName}: AddOrDeletePolicyCustomUnitRateParams) => `removeu a tarifa de "${customUnitName}" "${rateName}"`,
        ...
        updateReportFieldOptionDisabled: ({fieldName, optionName, optionEnabled}: PolicyDisabledReportFieldOptionParams) =>
            `${optionEnabled ? 'habilitado' : 'Desativado'} a opção "${optionName}" para o campo de relatório "${fieldName}"`,
        ...
        updateMaxExpenseAge: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) =>
            `atualizou "Idade máxima da despesa (dias)" para "${newValue}" (antes "${oldValue === 'false' ? CONST.POLICY.DEFAULT_MAX_EXPENSE_AGE : oldValue}")`,
        ...
        updateWorkspaceDescription: ({newDescription, oldDescription}: UpdatedPolicyDescriptionParams) =>
            !oldDescription
                ? `definir a descrição deste espaço de trabalho como "${newDescription}"`
        ...
        updatedWorkspaceFrequencyAction: ({oldFrequency, newFrequency}: UpdatedPolicyFrequencyParams) =>
            `atualizou a frequência de relatórios automáticos para "${newFrequency}" (antes era "${oldFrequency}")`,
        ...
        updatedFeatureEnabled: ({enabled, featureName}: {enabled: boolean; featureName: string}) => {
            switch (featureName) {
                case 'categories':
                    return `${enabled ? 'habilitado' : 'Desativado'} categorias`;
                case 'tags':
                    return `${enabled ? 'habilitado' : 'Desativado'} etiquetas`;
                case 'workflows':
                    return `${enabled ? 'habilitado' : 'Desativado'} fluxos de trabalho`;
                case 'distance rates':
                    return `${enabled ? 'habilitado' : 'Desativado'} tarifas de distância`;
                case 'accounting':
                    return `${enabled ? 'habilitado' : 'Desativado'} contabilidade`;
                case 'Expensify Cards':
                    return `${enabled ? 'habilitado' : 'Desativado'} Cartões Expensify`;
                case 'company cards':
                    return `${enabled ? 'habilitado' : 'Desativado'} cartões corporativos`;
                case 'invoicing':
                    return `Faturamento ${enabled ? 'habilitado' : 'Desativado'}`;
                case 'per diem':
                    return `${enabled ? 'habilitado' : 'Desativado'} por diária`;
                case 'receipt partners':
                    return `${enabled ? 'habilitado' : 'Desativado'} parceiros de recibos`;
                case 'rules':
                    return `${enabled ? 'habilitado' : 'Desativado'} regras`;
                case 'tax tracking':
                    return `${enabled ? 'habilitado' : 'Desativado'} acompanhamento de impostos`;
                default:
                    return `${enabled ? 'habilitado' : 'Desativado'} ${featureName}`;
            }
        },
        updatedAttendeeTracking: ({enabled}: {enabled: boolean}) => `rastreamento de participantes ${enabled ? 'habilitado' : 'Desativado'}`,
        updateReimbursementEnabled: ({enabled}: UpdatedPolicyReimbursementEnabledParams) => `${enabled ? 'habilitado' : 'Desativado'} reembolsos para este workspace`,
        ...
        updateTax: ({oldValue, taxName, updatedField, newValue}: UpdatedPolicyTaxParams) => {
            ...
            switch (updatedField) {
                ...
                case 'enabled': {
                    return `${oldValue ? 'Desativado' : 'habilitado'} o imposto "${taxName}"`;
                }
                default: {
                    return '';
                }
    ...
    roomMembersPage: {
        ...
        notAuthorized: `Você não tem acesso a esta página. Se estiver tentando entrar nesta sala, peça a um membro da sala para adicioná-lo. Algo mais? Entre em contato com ${CONST.EMAIL.CONCIERGE}`,
    ...
    search: {
        ...
        searchResults: {
            ...
            emptySubmitResults: {
                ...
                subtitle: 'Tudo certo. Dê uma volta da vitória!',
        ...
        exportSearchResults: {
            ...
            description: 'Uau, são muitos itens! Nós vamos agrupá-los e o Concierge enviará um arquivo para você em breve.',
        },
        exportAll: {
    ...
    fileDownload: {
        success: {
            ...
            qrMessage:
                'Verifique a pasta de fotos ou downloads para encontrar uma cópia do seu código QR. Dica: Adicione-o a uma apresentação para que seu público possa escanear e se conectar com você diretamente.',
        },
        generalError: {
            title: 'Erro de anexo',
    ...
    desktopApplicationMenu: {
        ...
        copy: 'Copiar',
        paste: 'Colar',
        pasteAndMatchStyle: 'Colar e Ajustar Estilo',
    ...
    checkForUpdatesModal: {
        available: {
            ...
            message: ({isSilentUpdating}: {isSilentUpdating: boolean}) =>
                `A nova versão estará disponível em breve.${!isSilentUpdating ? 'Vamos avisar você quando estivermos prontos para atualizar.' : ''}`,
        ...
        error: {
            ...
            message: 'Não foi possível verificar se há uma atualização. Tente novamente daqui a pouco.',
        },
    },
    settlement: {
        status: {
        ...
        failedError: ({link}: {link: string}) => `Tentaremos novamente este pagamento quando você <a href="${link}">desbloquear sua conta</a>.`,
        ...
        actions: {
            type: {
                ...
                changeReportPolicy: ({fromPolicyName, toPolicyName}: ChangeReportPolicyParams) => {
                    ...
                    return `mudou o workspace para ${toPolicyName}${fromPolicyName ? `(antes ${fromPolicyName})` : ''}`;
                },
                ...
                reimbursementDelayed: `processou o pagamento, mas ele atrasará mais 1–2 dias úteis`,
                selectedForRandomAudit: `selecionado aleatoriamente para revisão`,
                selectedForRandomAuditMarkdown: `[selecionados aleatoriamente](https://help.expensify.com/articles/expensify-classic/reports/Set-a-random-report-audit-schedule) para revisão`,
                ...
                removedConnection: ({connectionName}: ConnectionNameParams) => `conexão removida de ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
    ...
    footer: {
        ...
        spendManagement: 'Gerenciamento de Despesas',
        expenseReports: 'Relatórios de Despesas',
    ...
    moderation: {
        ...
        bullying: 'Bullying',
        bullyingDescription: 'Mirar um indivíduo para obter obediência',
        harassment: 'Assédio',
        ...
        levelTwoResult: 'Mensagem oculta do canal, além de aviso anônimo, e a mensagem foi reportada para revisão.',
        levelThreeResult: 'Mensagem removida do canal com aviso anônimo e mensagem reportada para revisão.',
    },
    ...
    teachersUnitePage: {
        ...
        joinExpensifyOrg:
            'Junte-se ao Expensify.org para eliminar a injustiça ao redor do mundo. A atual campanha “Professores Unidos” apoia educadores em todos os lugares ao dividir os custos de materiais escolares essenciais.',
        ...
        schoolPrincipalVerifyExpense:
            'Expensify.org divide o custo de materiais escolares essenciais para que alunos de famílias de baixa renda possam ter uma experiência de aprendizado melhor. Seu diretor será solicitado a verificar suas despesas.',
        ...
        schoolMailAsDefault: ({contactMethodsRoute}: ContactMethodsRouteParams) =>
            `Antes de prosseguir, certifique-se de definir seu e-mail escolar como método de contato padrão. Você pode fazer isso em Configurações > Perfil > <a href="${contactMethodsRoute}">Métodos de contato</a>.`,
        error: {
    ...
    distance: {
        ...
        deleteWaypointConfirmation: 'Tem certeza de que deseja excluir este ponto de parada?',
        address: 'Endereço',
        waypointDescription: {
            start: 'Iniciar',
            stop: 'Parar',
    ...
    referralProgram: {
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
            buttonText: 'Comece um chat, <success><strong>indique um amigo</strong></success>.',
        ...
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.REFER_FRIEND]: {
            ...
            body: 'Quer que seus amigos também usem o Expensify? Basta conversar, pagar ou dividir uma despesa com eles e nós cuidaremos do resto. Ou então é só compartilhar o seu link de convite!',
        },
    ...
    systemChatFooterMessage: {
        [CONST.INTRO_CHOICES.MANAGE_TEAM]: ({adminReportName, href}: {adminReportName: string; href: string}) =>
            `Converse com o seu especialista de configuração em <a href="${href}">${adminReportName}</a> para obter ajuda`,
    ...
    violations: {
        ...
        fieldRequired: 'Campos de relatório são obrigatórios',
            ...
            switch (type) {
                ...
                default:
                    if (displayPercentVariance) {
                        return `Valor ${displayPercentVariance}% maior do que o recibo escaneado`;
                    }
        ...
        rter: ({brokenBankConnection, isAdmin, isTransactionOlderThan7Days, member, rterType, companyCardPageURL}: ViolationsRterParams) => {
            if (rterType === CONST.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION_530) {
                return 'Não é possível associar o recibo automaticamente devido a conexão bancária interrompida';
            }
            if (brokenBankConnection || rterType === CONST.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? `Conexão bancária interrompida. <a href="${companyCardPageURL}">Reconectar para coincidir com o recibo</a>`
                    : 'Conexão bancária interrompida. Peça a um administrador para reconectar e corresponder o recibo.';
            }
            if (!isTransactionOlderThan7Days) {
                return isAdmin ? `Peça para ${member} marcar como dinheiro em espécie ou aguarde 7 dias e tente novamente` : 'Aguardando conciliação com a transação do cartão.';
            }
            return '';
        },
        brokenConnection530Error: 'Recibo pendente devido à conexão bancária interrompida',
        adminBrokenConnectionError: ({workspaceCompanyCardRoute}: {workspaceCompanyCardRoute: string}) =>
            `<muted-text-label>Recibo pendente devido a uma conexão bancária com problema. Resolva em <a href="${workspaceCompanyCardRoute}">Cartões corporativos</a>.</muted-text-label>`,
    ...
    exitSurvey: {
        ...
        bookACallTextBottom:
            'Ficaríamos empolgados em marcar uma ligação com você para entender o motivo. Você pode agendar uma chamada com um de nossos gerentes de produto sênior para discutir suas necessidades.',
    ...
    subscription: {
        ...
        badge: {
            freeTrial: ({numOfDays}: BadgeFreeTrialParams) => `Avaliação gratuita: ${numOfDays} ${numOfDays === 1 ? 'dia' : 'dias'} restante(s)`,
        },
        billingBanner: {
            ...
            policyOwnerAmountOwedOverdue: {
                ...
                subtitle: ({date, purchaseAmountOwed}: BillingBannerOwnerAmountOwedOverdueParams) =>
                    date && purchaseAmountOwed
                        ? `Não foi possível processar sua cobrança de ${purchaseAmountOwed} em ${date}. Adicione um cartão de pagamento para quitar o valor devido.`
                        : 'Adicione um cartão de pagamento para quitar o valor devido.',
            },
            policyOwnerUnderInvoicing: {
                title: 'Suas informações de pagamento estão desatualizadas',
                subtitle: ({date}: BillingBannerSubtitleWithDateParams) => `Seu pagamento está vencido. Pague sua fatura até ${date} para evitar a interrupção do serviço.`,
            },
            ...
            preTrial: {
                ...
                subtitle: 'Como próximo passo, <a href="#">complete sua lista de verificação de configuração</a> para que sua equipe possa começar a registrar despesas.',
            },
            trialStarted: {
                title: ({numOfDays}: TrialStartedTitleParams) => `Teste: ${numOfDays} ${numOfDays === 1 ? 'dia' : 'dias'} restante(s)!`,
            ...
            earlyDiscount: {
                ...
                subtitle: ({days, hours, minutes, seconds}: EarlyDiscountSubtitleParams) => `Reivindique em ${days > 0 ? `${days}d :` : ''}${hours}h : ${minutes}m : ${seconds}s`,
            },
        },
        cardSection: {
            title: 'Pagamento',
        ...
        yourPlan: {
            ...
            collect: {
                ...
                benefit8: 'Suporte por IA e humano',
            },
            control: {
                title: 'Controle',
                ...
                benefit2: 'Fluxos de trabalho de aprovação em vários níveis',
        ...
        details: {
            ...
            headsUp:
                'Aviso: Se você não definir o tamanho da sua assinatura agora, nós o definiremos automaticamente com base no número de membros ativos do seu primeiro mês. Você então ficará comprometido a pagar por pelo menos esse número de membros pelos próximos 12 meses. Você pode aumentar o tamanho da sua assinatura a qualquer momento, mas não poderá reduzi-lo até que sua assinatura termine.',
        ...
        subscriptionSize: {
            ...
            youAlreadyCommitted: ({size, date}: SubscriptionCommitmentParams) =>
                `Você já contratou uma assinatura anual de ${size} membros ativos por mês até ${date}. Você pode mudar para uma assinatura de pagamento por uso em ${date} desativando a renovação automática.`,
            error: {
        ...
        subscriptionSettings: {
            ...
            pricingConfiguration: 'O preço depende da configuração. Para pagar o menor valor, escolha uma assinatura anual e solicite o Expensify Card.',
            learnMore: {
                part1: 'Saiba mais em nosso',
                pricingPage: 'página de preços',
                part2: 'ou converse com nossa equipe em seu',
                adminsRoom: '#sala de administradores.',
            },
        ...
        requestEarlyCancellation: {
            ...
            subscriptionCanceled: {
                ...
                preventFutureActivity: ({workspacesListRoute}: WorkspacesListRouteParams) =>
                    `Se você quiser evitar atividades e cobranças futuras, você deve <a href="${workspacesListRoute}">excluir seu(s) workspace(s)</a>. Observe que, ao excluir seu(s) workspace(s), será cobrado por qualquer atividade pendente que tenha ocorrido durante o mês calendário atual.`,
            },
            requestSubmitted: {
            ...
            acknowledgement: `Ao solicitar o cancelamento antecipado, reconheço e concordo que a Expensify não tem obrigação de conceder tal solicitação nos termos dos <a href=${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}>Termos de Serviço</a> da Expensify ou de outro contrato de prestação de serviços aplicável entre mim e a Expensify, e que a Expensify mantém total discricionariedade quanto à concessão de qualquer solicitação desse tipo.`,
        },
    },
    feedbackSurvey: {
    ...
    roomChangeLog: {
        updateRoomDescription: 'defina a descrição da sala como:',
    ...
    delegate: {
        ...
        roleDescription: ({role}: OptionalParam<DelegateRoleParams> = {}) => {
            switch (role) {
                case CONST.DELEGATE_ROLE.ALL:
                    return 'Permita que outro membro tome todas as ações na sua conta, em seu nome. Inclui chat, envios, aprovações, pagamentos, atualizações de configurações e muito mais.';
                case CONST.DELEGATE_ROLE.SUBMITTER:
                    return 'Permita que outro membro realize a maioria das ações na sua conta, em seu nome. Exclui aprovações, pagamentos, rejeições e bloqueios.';
                default:
                    return '';
            }
        },
        ...
        enterMagicCode: ({contactMethod}: EnterMagicCodeParams) =>
            `Insira o código mágico enviado para ${contactMethod} para adicionar um copiloto. Ele deve chegar dentro de um ou dois minutos.`,
    ...
    debug: {
        ...
        reasonRBR: {
            ...
            hasTransactionThreadViolations: 'Tem violações de thread de transações',
        },
        indicatorStatus: {
    ...
    migratedUserWelcomeModal: {
        ...
        subtitle: 'Ele tem tudo o que você adora na nossa experiência clássica, com um monte de melhorias para deixar sua vida ainda mais fácil:',
        confirmText: 'Vamos lá!',
        helpText: 'Experimente a demonstração de 2 minutos',
        features: {
            search: 'Pesquisa mais poderosa em dispositivos móveis, web e desktop',
            concierge: 'Concierge AI integrado para ajudar a automatizar suas despesas',
    ...
    productTrainingTooltip: {
        ...
        scanTestTooltip: {
            main: '<tooltip><strong>Digitalize nosso recibo de teste</strong> para ver como funciona!</tooltip>',
    ...
    scheduledCall: {
        ...
        confirmation: {
            ...
            description: 'Verifique se os detalhes abaixo estão corretos para você. Assim que você confirmar a ligação, enviaremos um convite com mais informações.',
    ...
    autoSubmitModal: {
        ...
        submittedExpensesDescription: 'Essas despesas foram enviadas para o seu aprovador, mas ainda podem ser editadas até que sejam aprovadas.',
    ...
    testDrive: {
        ...
        modal: {
            ...
            description: 'Faça um rápido tour pelo produto para ficar por dentro rapidamente.',
            confirmText: 'Iniciar test drive',
            helpText: 'Pular',
            employee: {
                description:
                    '<muted-text>Dê à sua equipe <strong>3 meses grátis de Expensify!</strong> Basta inserir o e-mail do seu chefe abaixo e enviar para ele uma despesa de teste.</muted-text>',
        ...
        banner: {
            ...
            readyForTheRealThing: 'Pronto para a versão real?',
            getStarted: 'Começar',
        },
        employeeInviteMessage: ({name}: EmployeeInviteMessageParams) => `# ${name} convidou você para fazer um test drive no Expensify
Oi! Acabei de conseguir *3 meses grátis* para fazermos um test drive no Expensify, a maneira mais rápida de lidar com despesas.
...
Aqui está um *recibo de teste* para mostrar como funciona:`,
    ...
    domain: {
        ...
        verifyDomain: {
            ...
            genericError: 'Não foi possível verificar seu domínio. Tente novamente e entre em contato com a Concierge se o problema persistir.',
        },
        domainVerified: {
        ...
        saml: 'SAML',
        samlFeatureList: {
            title: 'Login único SAML (SSO)',
            subtitle: ({domainName}: {domainName: string}) =>
                `<muted-text><a href="${CONST.SAML_HELP_URL}">SSO SAML</a> é um recurso de segurança que dá a você mais controle sobre como membros com emails <strong>${domainName}</strong> fazem login no Expensify. Para ativá-lo, você precisará se verificar como um administrador autorizado da empresa.</muted-text>`,
        ...
        samlLogin: {
            title: 'Login SAML',
            subtitle: `<muted-text>Configure o login de membros com <a href="${CONST.SAML_HELP_URL}">SSO (Single Sign-On) via SAML.</a></muted-text>`,
