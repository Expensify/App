...
${amount} para ${merchant} - ${date}`,
    ...
    activateCardPage: {
        ...
        fillInAllDetails: 'Preencha todos os detalhes abaixo',
    },
    getPhysicalCard: {
...
O plano Control começa em US$ 9 por membro ativo por mês.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                shippingAddressDescription: 'Diga para onde devemos enviar o novo cartão.',
                promptCardholder: 'Solicitar ao titular do cartão',
                promptCardholderDescription: 'O titular do cartão será solicitado a inserir ou confirmar seu endereço de entrega.',
