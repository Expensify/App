        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    ...
                    officeBasedTitle: 'Presencial em escritório',
                    officeBasedHelp: 'Membro se desloca até um escritório. Deslocamentos diários comuns não são reembolsáveis.',
                    noRegularWorkplaceTitle: 'Sem local de trabalho fixo',
                    noRegularWorkplaceHelp: 'Membro trabalha remotamente ou não tem um local de trabalho fixo, portanto as regras de deslocamento de casa para o trabalho não se aplicam.',
                    startingPrompt: {
                        title: 'Definir um acordo de trabalho típico',
                        prompt: 'Escolha a modalidade que se aplica à maioria dos membros atuais. Você pode atualizar os membros individualmente ou em lote depois.',
                        officeBasedHelp: 'A maioria dos membros se desloca para um escritório. Deslocamentos comuns são excluídos.',
                        noRegularWorkplaceHelp: 'A maioria das pessoas trabalha remotamente, então as exclusões de deslocamento entre casa e trabalho normalmente não se aplicam.',
                        confirm: 'Aplicar',
                    },
                },
            },
...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            ...
            set: ({arrangement}: {arrangement: string}) => `definir o regime de trabalho padrão como ${arrangement}`,
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `alterou o acordo de trabalho padrão para ${arrangement} (antes ${previousArrangement})`,
        },
        commuterExclusions: {
