        ...
        card: {
            ...
            issueNewCard: {
                ...
                smartLimitDisabledDescription: (workspaceWorkflowsLink: string) =>
                    `<muted-text>Gaste até um determinado valor antes de exigir aprovação. <a href="${workspaceWorkflowsLink}">Ative as aprovações</a> para selecionar esta opção.</muted-text>`,
                monthly: 'Mensal',
