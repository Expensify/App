...
${amount} para ${merchant} - ${date}`,
    ...
    onboarding: {
        ...
        peopleYouMayKnow: 'Veja se sua equipe já está aqui',
        workspaceYouMayJoin: (domain: string, email: string) =>
            `Verifique seu e-mail para ver se alguém de ${domain} tem um workspace ao qual você pode se juntar. Digite o código mágico enviado para ${email}.`,
