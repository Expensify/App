...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
                ...
                maxAmountCurrencyMismatchTitle: 'Incompatibilidade de moeda',
                ...
                merchantTypes: 'Tipos de estabelecimentos',
                allowedMerchants: 'Comerciantes permitidos',
                allowedMerchantTypes: 'Tipos de comerciantes permitidos',
                ...
                currenciesCurrencyMismatchTitle: 'Incompatibilidade de moeda',
                currenciesCurrencyMismatchPrompt: 'Para definir moedas preferenciais, selecione cartões que sejam liquidados na mesma moeda.',
                restrictMerchantsOffSubtitle: 'Cobranças são aprovadas para moedas permitidas que não excedam um valor máximo',
                restrictMerchantsAllowSubtitle:
                    'Os lançamentos são aprovados para moedas permitidas que não ultrapassem um valor máximo e em que o comerciante ou o tipo de comerciante corresponda.',
                restrictMerchantsBlockSubtitle:
                    'As cobranças são aprovadas para moedas permitidas que não excedam um valor máximo ou quando o comerciante ou o tipo de comerciante corresponde.',
            },
            agentRules: {
