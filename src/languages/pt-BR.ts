...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
                ...
                merchantExactlyMatches: 'Estabelecimento coincide exatamente',
                ...
                categoryOptions: {
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.GOVERNMENT_AND_NON_PROFIT]: 'Governo e organizações sem fins lucrativos',
                    [CONST.SPEND_RULES.CATEGORIES.GROCERIES]: 'Compras de supermercado',
                    [CONST.SPEND_RULES.CATEGORIES.GYMS_AND_FITNESS]: 'Academias e condicionamento físico',
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.TRANSIT_AND_RIDESHARE]: 'Transporte público e carro por app',
