    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            biometrics: {
                ...
                test: 'Teste',
                softPromptTitle: 'Verifique transações com seu rosto ou impressão digital',
                softPromptContent: 'Habilite a verificação rápida e segura usando seu rosto ou impressão digital — sem a necessidade de senhas ou códigos.',
                notificationTitle: 'Autenticação bem-sucedida',
                notificationContent: 'Você foi autenticado com sucesso usando o Face ID.',
                biometricsTest: 'Teste de biometria',
                errorPageTitle: 'Ops, algo deu errado',
                errorPageContent: 'Seu dispositivo não pôde ser registrado.',
            },
        },
        debugConsole: {
            saveLog: 'Salvar log',
