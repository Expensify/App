...
${
    ...
    signerInfoStep: {
        ...
        error: {
            ...
            connectToWorkspacePrefix: 'Por favor, conecte esta conta bancária a um',
            connectToWorkspaceLink: 'espaço de trabalho',
            connectToWorkspaceSuffix: 'para convidar um diretor a assinar.',
        },
    },
    agreementsStep: {
        agreements: 'Acordos',
