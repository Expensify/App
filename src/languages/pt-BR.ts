...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            validationFailedFallback: 'Seu banco bloqueou as transações de teste para esta conta. <concierge-link>Fale com a Concierge</concierge-link>',
        },
        fixBankAccount: {
            title: 'Corrigir conta bancária',
            debitBlockedBody:
                'Seu banco bloqueou as transações de teste para esta conta.<br/><br/>Peça para incluírem na lista de permissões os IDs ACH da Expensify:<bullet-list><bullet-item>1270239450</bullet-item><bullet-item>2270239450</bullet-item><bullet-item>4270239450</bullet-item></bullet-list>Depois, reenvie as transações de teste abaixo.',
            insufficientFundsBody: 'As transações de teste falharam por falta de fundos. Quando houver saldo disponível, use o botão abaixo.',
            resendButton: 'Reenviar transações',
            successTitle: 'Transações enviadas!',
            successBody: 'Verifique sua conta bancária nos próximos 1 a 2 dias úteis.',
...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
    ...
    debug: {
        ...
        indicatorStatus: {
            ...
            aBankAccountFailedValidation: 'Uma conta bancária falhou na validação',
        },
    },
    emptySearchView: {
