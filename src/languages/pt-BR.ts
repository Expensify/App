        ...
        recruiting: {
            ...
            filters: {
                ...
                stages: {
                    ...
                    toggleTitle: 'Etapas de importação',
                    allSelected: 'Todas as etapas do trabalho',
                    emptySelectionError: 'Selecione pelo menos uma etapa de trabalho',
                },
                tags: {
                    title: 'Tag',
                    description: 'Escolha as tags de candidatos que você gostaria de sincronizar com este workspace',
                    toggleTitle: 'Importar etiquetas',
                    allSelected: 'Todas as tags',
                    emptySelectionError: 'Selecione pelo menos uma tag',
                },
                offices: {
                    title: 'Escritório',
                    description: 'Escolha os escritórios dos candidatos que você quer sincronizar com este workspace',
                    toggleTitle: 'Importar escritórios (opcional)',
