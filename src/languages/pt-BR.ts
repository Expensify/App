...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            accountManager: '[pt-BR] Account Manager',
            accountManagerDescription: 'Faça perguntas e receba suporte ao cliente',
            partnerManager: '[pt-BR] Partner Manager',
            partnerManagerDescription: 'Maximize sua parceria e gere indicações',
            guideDescription: 'Seu especialista de configuração',
            approvedPartnerTeamTitle: 'Conheça sua equipe parceira do Approved!',
            ...
            accountExecutive: '[pt-BR] Account Executive',
