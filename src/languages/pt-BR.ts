...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            approvedPartnerTeamTitle: 'Conheça sua equipe de parceiros Approved!',
            approvedPartnerTeamDescription: 'Uma equipe dedicada a ajudar sua empresa a crescer, integrar clientes mais rápido e obter suporte especializado.',
            partnerManagerApprovedDescription: 'Maximize sua parceria e impulsione indicações',
            accountExecutiveDescription: 'Ajude clientes a se configurar com sucesso',
            accountManagerApprovedDescription: 'Faça perguntas e obtenha suporte ao cliente',
