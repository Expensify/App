...
${amount} para ${merchant} - ${date}`,
    ...
    privatePersonalDetails: {
        ...
        commuterExclusionsNote: ({workspaceName}: {workspaceName: string}) => `${workspaceName} usa este endereço para exclusões de trajeto.`,
        error: {
...
3. Quando o feed estiver ativado, clique em Enviar abaixo e nós cuidaremos de adicioná-lo.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: 'Subtraia em cada solicitação de distância o trajeto de cada membro entre sua casa e o endereço do espaço de trabalho.',
                workspaceAddressRequired: {
                    title: 'Ops, espere um momento...',
                    prompt: 'Este espaço de trabalho ainda não tem endereço. Adicione um para que as exclusões de trajeto possam usá-lo.',
                    cta: 'Adicionar endereço',
                },
                errors: {
                    distanceMustBePositive: 'A distância deve ser maior que 0.',
