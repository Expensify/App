...
${amount} para ${merchant} - ${date}`,
    ...
    expenseRulesPage: {
        ...
        changes: {
            updateBillable: (value: boolean) => `Atualizar despesa ${value ? 'cobrável' : 'não faturável'}`,
            updateCategory: (value: string) => `Atualizar categoria para "${value}"`,
            updateComment: (value: string) => `Alterar descrição para "${value}"`,
            updateMerchant: (value: string) => `Atualizar comerciante para "${value}"`,
            updateReimbursable: (value: boolean) => `Atualizar despesa ${value ? 'reembolsável' : 'não reembolsável'}`,
            updateTag: (value: string) => `Atualizar etiqueta para "${value}"`,
            updateTax: (value: string) => `Atualizar taxa de imposto para ${value}`,
