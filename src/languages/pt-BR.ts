    ...
    workspaceActions: {
        ...
        expensifyCardRule: {
            ...
            update: {
                ...
                bodyMerchant: ({adjective, value}: {adjective: string; value: string}) => (adjective !== '' ? `${adjective} comerciante '${value}'` : `estabelecimento '${value}'`),
                ...
                bodySpendCategoryChange: ({adjective, oldValue, newValue}: {adjective: string; oldValue: string; newValue: string}) =>
                    adjective !== '' ? `categoria de gasto ${adjective} de '${oldValue}' para '${newValue}'` : `categoria de gastos de '${oldValue}' para '${newValue}'`,
