    ...
    workspace: {
        ...
        qbo: {
            ...
            advancedConfig: {
                ...
                qboFxExpenseAccount: (integrationName = 'QuickBooks Online') => `Conta de taxas de conversão de moeda do ${integrationName}`,
                fxExpenseAccountDescription: (integrationName = 'QuickBooks Online') =>
                    `Quando sua empresa cobrir o custo de conversão de moeda de um pagamento feito no exterior, lançaremos esse custo nesta conta no ${integrationName} como um lançamento contábil.`,
            },
