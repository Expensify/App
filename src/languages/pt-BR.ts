...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. Use o botão ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} para enviar uma fatura.`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `. Basta usar o botão ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE}.`,
