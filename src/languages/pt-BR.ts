...
Exija dados de despesas como recibos e descrições, defina limites e padrões e automatize aprovações e pagamentos – tudo em um só lugar.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                oneConditionPerRuleTitle: 'Apenas uma condição por regra',
                alreadyMatchesMerchantPrompt: 'Esta regra já corresponde a um comerciante. Redefina a regra para corresponder a uma categoria em vez disso.',
                alreadyMatchesCategoryPrompt: 'Essa regra já corresponde a uma categoria. Redefina a regra para corresponder a um comerciante em vez disso.',
                ...
                onlyTaxForCategoryRulesTitle: 'Apenas impostos estão disponíveis para regras de categoria',
                onlyTaxForCategoryRulesPrompt:
                    'Regras de categoria podem definir uma taxa de imposto padrão. Para definir outros padrões, use um comerciante como critério de correspondência.',
                clearIncompatibleDefaultsTitle: 'Limpar os outros padrões?',
                clearIncompatibleDefaultsPrompt: 'Esses campos não são compatíveis com a categoria. Quer limpar todos os campos?',
...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
            ...
            newRule: {
                ...
                requireFields: 'Definir requisitos do campo',
