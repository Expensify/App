...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                fireworksTitle: '[pt-BR] All caught up',
                fireworksDescription: '[pt-BR] Upcoming to-dos will appear here.',
            },
        },
    ...
    iou: {
        ...
        error: {
            ...
            nonReimbursablePayment: '[pt-BR] Cannot pay via Expensify',
            nonReimbursablePaymentDescription: (isMultiple?: boolean) =>
                isMultiple
                    ? "[pt-BR] One or more selected reports don't have reimbursable expenses. Double check the expenses, or manually mark as paid."
                    : "[pt-BR] The report doesn't have reimbursable expenses. Double check the expenses, or manually mark as paid.",
        },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        emptyWorkspace: {
            title: '[pt-BR] You have no workspaces',
            subtitle: '[pt-BR] Track receipts, reimburse expenses, manage travel, send invoices, and more.',
