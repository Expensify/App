...
3. Quando o feed estiver ativado, clique em Enviar abaixo e nós cuidaremos de adicioná-lo.`,
        ...
        accounting: {
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: 'Escolha a conta bancária na qual os pagamentos de faturamento central serão conciliados.',
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `Certifique-se de que esta conta corresponda à sua conta de liquidação de faturamento central (terminada em ${lastFourPAN}) para que a Conciliação Contínua funcione corretamente.`,
            },
            syncTravelInvoicingSettlements: 'Sincronizar liquidações de faturamento central',
        },
        export: {
