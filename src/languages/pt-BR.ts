...
O plano Control começa em US$ 9 por membro ativo por mês.`,
        ...
        accounting: {
            ...
            syncTravelInvoicingSettlementsNoAccountTooltip: 'Defina uma conta para suas exportações para desbloquear.',
            syncTravelInvoicingSettlementsNoAutoSyncTooltip: 'Ative a sincronização automática para desbloquear.',
        },
        export: {
