...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
    ...
    workspaceActions: {
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `definiu o valor obrigatório do recibo detalhado como "${newValue}"`,
        ...
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `removeu o valor obrigatório do recibo detalhado (antes era "${oldValue}")`,
