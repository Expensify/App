...
_Para instruções mais detalhadas, [visite nossa central de ajuda](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        rillet: {
            ...
            exportReimbursable: {label: 'Exportar despesas reembolsáveis como', values: {label: 'Faturas de fornecedores'}},
            exportDate: {
            ...
            exportCompanyCard: {label: 'Exportar despesas de cartão corporativo como', values: {label: 'Cartões de crédito'}},
