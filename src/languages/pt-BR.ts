...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            connectionsSubtitle:
                "[pt-BR] Connect to your HR system to sync employee data, auto-match reimbursements to the right people, and keep your team's expenses accurate without the manual work.",
...
Add more spend rules to protect company cash flow.`,
    ...
    search: {
        ...
        applyFilters: '[pt-BR] Apply filters',
            ...
            amount: {
                ...
                between: (greaterThan?: string, lessThan?: string) => {
                    if (greaterThan && lessThan) {
                        return `[pt-BR] Between ${greaterThan} and ${lessThan}`;
                    }
                    return '[pt-BR] Between';
                },
