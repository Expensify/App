...
const translations: TranslationDeepObject<typeof en> = {
    ...
    contacts: {
        ...
        helpText: 'Adicione mais maneiras de enviar recibos. Encaminhe-os para <copy-text text="receipts@expensify.com"/> ou envie uma mensagem para 47777 (apenas números dos EUA).',
