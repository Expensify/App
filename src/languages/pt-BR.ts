...
const translations = {
    ...
    initialSettingsPage: {
        ...
        versionLetter: 'v',
        readTheTermsAndPrivacy: `<muted-micro-text>Leia o <a href="${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}">Termos de Serviço</a> e <a href="${CONST.OLD_DOT_PUBLIC_URLS.PRIVACY_URL}">Privacidade</a>.</muted-micro-text>`,
        help: 'Ajuda',
