...
O plano Control começa em US$ 9 por membro ativo por mês.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    title: 'Tipo de trabalho padrão',
                    officeBasedTitle: 'Trabalho no escritório',
                    officeBasedHelp: 'O membro se desloca até um escritório. Os trajetos habituais são excluídos do reembolso.',
                    noRegularWorkplaceTitle: 'Sem local de trabalho fixo',
                    noRegularWorkplaceHelp: 'O membro trabalha remotamente ou não tem local de trabalho fixo, então as regras de trajeto casa-trabalho não se aplicam.',
                    startingPrompt: {
                        title: 'Defina um tipo de trabalho padrão',
                        prompt: 'Escolha o tipo de trabalho que se aplica à maioria dos membros atuais. Você pode atualizar os membros individualmente ou em massa depois.',
                        officeBasedHelp: 'A maioria dos membros se desloca até um escritório. Os trajetos habituais são excluídos.',
                        noRegularWorkplaceHelp: 'A maioria dos membros trabalha remotamente, então as exclusões de trajeto casa-trabalho normalmente não se aplicam.',
                        confirm: 'Aplicar',
                    },
                },
            },
...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            officeBased: 'trabalho no escritório',
            noRegularWorkplace: 'sem local de trabalho fixo',
            set: ({arrangement}: {arrangement: string}) => `definiu o tipo de trabalho padrão como “${arrangement}”`,
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `alterou o tipo de trabalho padrão para “${arrangement}” (anteriormente “${previousArrangement}”)`,
        },
        commuterExclusions: {
