...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        keepSelected: '[pt-BR] Keep selected',
    ...
    deviceManagementPage: {
        ...
        description: '[pt-BR] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[pt-BR] Revoke',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        people: {
            ...
            configureGustoSync: '[pt-BR] Configure Gusto sync.',
            syncWithGusto: '[pt-BR] Sync with Gusto',
            ...
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    ...
                    case 'mergeHRSyncTitle':
                        return '[pt-BR] Synchronizing HR Employees';
                    case 'jobDone':
                        return '[pt-BR] Waiting for imported data to load';
                    default: {
                        return `[pt-BR] Translation missing for stage: ${stage}`;
...
Add more spend rules to protect company cash flow.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateName: (customUnitName: string, oldValue: string, newValue: string) => `[pt-BR] renamed the ${customUnitName} rate "${oldValue}" to "${newValue}"`,
