...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        movedUnreportedTransaction: (reportUrl: string) => `moveu esta despesa do seu <a href="${reportUrl}">espaço pessoal</a>`,
        ...
        movedFromPersonalSpace: (reportName?: string, workspaceName?: string) => `despesa movida do espaço pessoal para ${workspaceName ?? `conversar com ${reportName}`}`,
    ...
    mergeAccountsPage: {
        ...
        accountDetails: {
            accountToMergeInto: (login: string) => `Insira a conta que você deseja mesclar em <strong>${login}</strong>.`,
...
3. Quando o feed estiver ativado, clique em Enviar abaixo e começaremos a adicioná-lo.`,
        ...
        expensifyCard: {
            ...
            issuedCardVirtual: (assignee: string, link: string) => `emitiu para ${assignee} um Cartão virtual Expensify! O ${link} pode ser usado imediatamente.`,
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                integrationExport: (integration: string, type?: string) => (integration && type ? `exportação de ${integration} ${type.toLowerCase()}` : `Exportação de ${integration}`),
                integrationExportTitleXero: (integration: string) => `Escolha a conta do ${integration} para a qual as transações devem ser exportadas.`,
        ...
        new: {
            ...
            workspaceName: (userName: string, workspaceNumber?: number) => `Workspace de ${userName}${workspaceNumber ? ` ${workspaceNumber}` : ''}`,
        },
        people: {
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                leftWorkspace: (nameOrEmail: string) => `${nameOrEmail} saiu do workspace`,
