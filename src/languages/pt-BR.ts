    ...
    workspace: {
        ...
        qbo: {
            ...
            advancedConfig: {
                ...
                qboFxExpenseAccount: (integrationName = 'QuickBooks Online') => `Conta de tarifa de conversão de moeda do ${integrationName}`,
                fxExpenseAccountDescription: (integrationName = 'QuickBooks Online') =>
                    `Quando sua empresa cobrir o custo de conversão de moeda em um pagamento feito no exterior, nós registraremos esse custo nesta conta em ${integrationName} como um lançamento contábil.`,
            },
