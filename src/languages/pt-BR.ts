    ...
    workspaceActions: {
        ...
        commuterExclusions: {
            changedToFixedDistance: ({previousMethod}: {previousMethod: string}) =>
                `alterou "excluir deslocamentos diários" para uma distância fixa por solicitação (anteriormente ${previousMethod})`,
            changedToHomeAndOffice: ({previousMethod}: {previousMethod: string}) => `alterou "excluir deslocamentos" para calcular por casa e escritório (anteriormente ${previousMethod})`,
            previousMethod: {disabled: 'não excluir deslocamentos para o trabalho', fixedDistance: 'distância fixa por solicitação', homeAndOffice: 'casa e escritório'},
