...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[pt-BR] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[pt-BR] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[pt-BR] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[pt-BR] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[pt-BR] Get clients setup successfully',
            accountManagerApprovedDescription: '[pt-BR] Ask questions and get client support',
            moreResources: '[pt-BR] More resources',
        },
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[pt-BR] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[pt-BR] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[pt-BR] Go to Gusto settings',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            gusto: {
                ...
                disconnect: '[pt-BR] Disconnect',
                lastSync: (relativeDate: string) => `[pt-BR] Last synced ${relativeDate}`,
                syncError: "[pt-BR] Can't connect to Gusto",
                disconnectTitle: '[pt-BR] Disconnect Gusto',
                disconnectPrompt: '[pt-BR] Are you sure you want to disconnect Gusto?',
                ...
                approvalModeDescription: '[pt-BR] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[pt-BR] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[pt-BR] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[pt-BR] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[pt-BR] Basic approval',
                        description: '[pt-BR] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[pt-BR] Manager approval',
                        description: '[pt-BR] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[pt-BR] Custom approval',
                        description: '[pt-BR] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[pt-BR] Gusto sync results',
                    successTitle: '[pt-BR] Successfully synced your Gusto connection!',
                    added: '[pt-BR] Added',
                    removed: '[pt-BR] Removed',
            ...
            zenefits: {
                ...
                disconnect: '[pt-BR] Disconnect',
                lastSync: (relativeDate: string) => `[pt-BR] Last synced ${relativeDate}`,
                syncError: "[pt-BR] Can't connect to TriNet",
                disconnectTitle: '[pt-BR] Disconnect TriNet',
                disconnectPrompt: '[pt-BR] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[pt-BR] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[pt-BR] Approval mode',
                finalApprover: '[pt-BR] Final approver',
                notSet: '[pt-BR] Not set',
                approvalModeDescription: '[pt-BR] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[pt-BR] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[pt-BR] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[pt-BR] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[pt-BR] Basic approval',
                    ...
                    manager: {
                        label: '[pt-BR] Manager approval',
                        description: '[pt-BR] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[pt-BR] Custom approval',
                        description: "[pt-BR] I'll manually setup approval workflows in Expensify.",
    ...
    search: {
        ...
        filters: {
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[pt-BR] Central invoicing',
            },
            is: '[pt-BR] Is',
            action: {
