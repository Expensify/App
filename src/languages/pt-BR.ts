...
Exija dados de despesas como recibos e descrições, defina limites e padrões e automatize aprovações e pagamentos – tudo em um só lugar.`,
    ...
    workspaceActions: {
        ...
        assignedCompanyCard: (email: string, cardLastFour: string) => `atribuiu o cartão empresarial ${email} com final ${cardLastFour}`,
        unassignedCompanyCard: (email: string, cardLastFour: string) => `cartão corporativo ${email} não atribuído com final ${cardLastFour}`,
