...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        biometricsTest: {
            ...
            troubleshootBiometricsStatus: (registered?: boolean) => `Biometria (${registered ? 'Registrado' : 'Não registrado'})`,
    ...
    nextStep: {
        message: {
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.NO_FURTHER_ACTION]: () => `Nenhuma ação adicional necessária!`,
