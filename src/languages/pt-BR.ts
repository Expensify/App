...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        setPin: {
            didNotShipCard: 'Não enviamos seu cartão. Por favor, tente novamente.',
        },
    },
    validateCodeModal: {
...
${amount} para ${merchant} - ${date}`,
        ...
        enterFourDigitPin: 'Digite um PIN de 4 dígitos para o seu cartão.',
        reenterPinToConfirm: 'Digite novamente o PIN para confirmar.',
        pinMustBeFourDigits: 'O PIN deve ter exatamente 4 dígitos.',
        invalidPin: 'Por favor, escolha um PIN mais seguro.',
        pinMismatch: 'Os PINs não coincidem. Por favor, tente novamente.',
