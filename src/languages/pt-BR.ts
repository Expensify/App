...
Adicione mais regras de gasto para proteger o fluxo de caixa da empresa.`,
        ...
        hr: {
            ...
            alreadyConnectedTitle: 'Não é possível conectar múltiplas plataformas de RH',
            alreadyConnectedPrompt: 'Você deve desconectar sua plataforma de RH atual antes de conectar outra.',
            lastSync: (relativeDate: string) => `Última sincronização ${relativeDate}`,
