...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            locked: 'Bloqueado',
            incompleteDescription: 'Conclua a adição da conta bancária',
            pendingDescription: 'Confirme as transações de teste',
            verifyingDescription: 'Estamos analisando sua documentação',
            lockedDescription: 'Esta conta requer atenção',
            finish: 'Concluir',
            confirm: 'Confirmar',
            unlock: 'Desbloquear',
        },
        cardFixConnection: 'Corrija esta conexão',
        cardAskAdminToFix: 'Peça a um administrador para corrigir esta conexão',
        cardAdminFixConnection: 'Corrija esta conexão em Cartões corporativos',
        lastSynced: (dateStr: string) => `Última sincronização ${dateStr}`,
