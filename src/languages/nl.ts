...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        setPin: {
            didNotShipCard: 'We hebben je kaart niet verzonden. Probeer het opnieuw.',
        },
    },
    validateCodeModal: {
...
${amount} voor ${merchant} - ${date}`,
        ...
        enterFourDigitPin: 'Voer een 4-cijferige pincode in voor je kaart.',
        reenterPinToConfirm: 'Voer je pincode opnieuw in ter bevestiging.',
        pinMustBeFourDigits: 'De pincode moet exact 4 cijfers bevatten.',
        invalidPin: 'Kies een veiligere pincode.',
        pinMismatch: 'Pincodes komen niet overeen. Probeer het opnieuw.',
        revealPin: 'Pincode tonen',
