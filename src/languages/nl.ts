...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            locked: 'Vergrendeld',
            incompleteDescription: 'Maak het toevoegen van de bankrekening af',
            pendingDescription: 'Bevestig de testtransacties',
            verifyingDescription: 'We controleren uw documentatie',
            lockedDescription: 'Dit account vereist aandacht',
            finish: 'Voltooien',
            confirm: 'Bevestigen',
            unlock: 'Ontgrendelen',
        },
        cardFixConnection: 'Herstel deze verbinding',
        cardAskAdminToFix: 'Vraag een beheerder om deze verbinding te herstellen',
        cardAdminFixConnection: 'Herstel deze verbinding bij Bedrijfskaarten',
        lastSynced: (dateStr: string) => `Laatst gesynchroniseerd ${dateStr}`,
