...
Hier is een *testbon* om je te laten zien hoe het werkt:`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            ctaFix: 'Oplossen',
            fixCompanyCardConnection: {title: ({feedName}: {feedName: string}) => (feedName ? `Verbinding voor ${feedName}-bedrijfskaart herstellen` : 'Verbinding voor bedrijfskaart herstellen'), subtitle: 'Werkruimte > Bedrijfskaarten'},
