...
const translations: TranslationDeepObject<typeof en> = {
    ...
    contacts: {
        ...
        helpText: 'Voeg meer manieren toe om bonnen te verzenden. Stuur ze naar <copy-text text="receipts@expensify.com"/> of stuur ze naar 47777 (alleen Amerikaanse nummers).',
