...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        calendarOpened: '[nl] calendar opened',
        send: '[nl] Send',
        na: '[nl] N/A',
...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        plusMore: ({count}: {count: number}) => `[nl] +${count} more`,
    ...
    multifactorAuthentication: {
        ...
        revealCardDetail: {
            couldNotReveal: "[nl] We couldn't reveal your card details. Please try again.",
        },
    },
    validateCodeModal: {
    ...
    readOnlyConversation: '[nl] This conversation is read-only.',
    reportAction: {
        asCopilot: '[nl] as copilot for',
        assistedBy: (agentName: string) => `[nl] assisted by ${agentName}`,
        humanSupportAgent: '[nl] a human support agent',
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            unlockBankAccount: {
                workspaceTitle: '[nl] Your business bank account has been locked',
                personalTitle: '[nl] Your bank account has been locked',
                workspaceSubtitle: ({policyName}: {policyName: string}) => policyName,
                personalSubtitle: '[nl] Wallet',
            },
        },
        freeTrialSection: {
        ...
        yourSpend: {
            title: '[nl] Your spend',
            awaitingApproval: '[nl] Awaiting approval',
            repaidLast30Days: '[nl] Repaid in the last 30 days',
            recentTransactions: ({lastFour}: {lastFour: string}) => `[nl] Recent transactions • ${lastFour}`,
        },
        seeMore: ({count}: {count: number}) => `[nl] See ${count} more`,
        ...
        gettingStartedSection: {
            ...
            connectAccountingDefault: '[nl] Connect to accounting',
            customizeCategories: '[nl] Customize accounting categories',
            inviteAccountant: '[nl] Invite your accountant',
    ...
    spreadsheet: {
        ...
        importCompanyCardTransactionsPendingMessage: '[nl] New cards and transactions may take some time to appear, please hang tight.',
    ...
    iou: {
        ...
        movedFromReport: (reportName: string) => `[nl] moved an expense from ${reportName}`,
        movedFromReportNoName: '[nl] moved an expense',
        movedTransactionTo: (reportUrl: string, reportName: string) => `[nl] moved this expense to <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionToAnotherReport: '[nl] moved this expense to another report',
        movedTransactionFrom: (reportUrl: string, reportName: string) => `[nl] moved this expense from <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionFromAnotherReport: '[nl] moved this expense from another report',
        ...
        allTransactionsPendingNextStep: "[nl] All transactions are pending. You can't submit this report until they post in a few days.",
        ...
        confirmPaymentReceivedModalTitle: '[nl] Confirm payment received',
        receivedPayment: '[nl] Received payment',
        receivedPaymentConfirmation: "[nl] Please proceed only if you've already received payment outside of Expensify.",
        confirmReceivedPayment: "[nl] Yes, I've received payment",
        ...
        reimbursedThisReport: '[nl] reimbursed this report',
        paidThisBill: '[nl] paid this bill',
        reimbursedOnBehalfOf: (actor: string) => `[nl] on behalf of ${actor}`,
        reimbursedFromBankAccount: (debitBankAccount: string) => `[nl] from the bank account ending in ${debitBankAccount}`,
        reimbursedSubmitterAddedBankAccount: (submitter: string) => `[nl] ${submitter} added a bank account, taking report off hold. Reimbursement is initiated`,
        reimbursedWithFastACH: ({
            ...
            isCurrentUser
                ? `[nl] . Money is on its way to your${creditBankAccount ? `[nl]  bank account ending in ${creditBankAccount}` : '[nl]  account'}. Reimbursement estimated to complete on ${expectedDate}.`
                : `[nl] . Money is on its way to ${submitterLogin}'s${creditBankAccount ? `[nl]  bank account ending in ${creditBankAccount}` : '[nl]  account'}. Reimbursement estimated to complete on ${expectedDate}.`,
        reimbursedWithCheck: '[nl]  via check.',
        reimbursedWithStripeConnect: ({
            ...
            const paymentMethod = isCard ? '[nl] card' : '[nl] bank account';
            return isCurrentUser
                ? `[nl] . Money is on its way to your${creditBankAccount ? `[nl]  bank account ending in ${creditBankAccount}` : '[nl]  account'} (paid via ${paymentMethod}). This could take up to 10 business days.`
                : `[nl] . Money is on its way to ${submitterLogin}'s${creditBankAccount ? `[nl]  bank account ending in ${creditBankAccount}` : '[nl]  account'} (paid via ${paymentMethod}). This could take up to 10 business days.`;
        },
        reimbursedWithACH: ({creditBankAccount, expectedDate}: {creditBankAccount?: string; expectedDate?: string}) =>
            `[nl]  with direct deposit (ACH)${creditBankAccount ? `[nl]  to the bank account ending in ${creditBankAccount}. ` : '. '}${expectedDate ? `[nl] The reimbursement is estimated to complete by ${expectedDate}.` : '[nl] This generally takes 4-5 business days.'}`,
        ...
        updatedTheRequest: (valueName: string, newValueToDisplay: string, oldValueToDisplay: string) => `[nl] the ${valueName} to ${newValueToDisplay} (previously ${oldValueToDisplay})`,
        ...
        error: {
            ...
            invalidReadings: '[nl] Please enter both start & end readings to continue',
            ...
            unableToSubmitReport: '[nl] Unable to submit report',
            allTransactionsPendingDescription: "[nl] You can't submit this report because all transactions are pending. They may take a few days to post.",
            failedToSaveOdometerDraft: "[nl] Couldn't save your odometer draft. Please try again.",
            ...
            receiptUploadFailedMessage: '[nl] Receipt upload failed. Save the receipt, or delete the expense and lose it.',
            saveReceipt: '[nl] Save receipt',
        ...
        addExistingExpense: '[nl] Add existing expense',
        selectExistingExpense: '[nl] Select at least one expense to add to the report.',
        emptyStateExistingExpenseTitle: '[nl] No existing expenses',
        emptyStateExistingExpenseSubtitle: '[nl] Looks like you don’t have any existing expenses. Try creating one below.',
        addExistingExpenseConfirm: '[nl] Add to report',
        ...
        changeApprover: {
            ...
            reassignedApproverMessage: (managerID: number) => `[nl] reassigned the approver to <mention-user accountID="${managerID}"/> via a workflow update`,
            actions: {
        ...
        bulkDuplicateLimit: `[nl] You can duplicate up to ${CONST.SEARCH.BULK_DUPLICATE_LIMIT} expenses at a time. Please select fewer expenses and try again.`,
        taxDisabledAlert: {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            showBranchNameInTitle: '[nl] Show branch name in browser title',
        ...
        help: '[nl] Help',
        helpPage: {
            title: '[nl] Got questions?',
            description: "[nl] We're here to help, around the clock.",
            helpSite: '[nl] Help site',
            conciergeChat: '[nl] Concierge',
            conciergeChatDescription: '[nl] Your personal AI agent',
            accountManagerDescription: '[nl] Your account manager',
            partnerManagerDescription: '[nl] Your partner manager',
            guideDescription: '[nl] Your setup specialist',
        },
    ...
    deviceManagementPage: {
        title: '[nl] Device management',
        description:
            '[nl] Manage all the devices that you have logged into with your Expensify Account. <a href="https://help.expensify.com/articles/new-expensify/settings/Manage-Logged-in-Devices">Learn more</a>.',
        revoke: '[nl] Revoke',
        unknownDevice: '[nl] Unknown Device',
    },
    twoFactorAuth: {
        ...
        `),
        screenshotTip: '[nl] Tip: Screenshot this to save it to your photo library',
    ...
    walletPage: {
        ...
        cardActive: '[nl] Active',
        bankAccountStatus: {
            active: '[nl] Active',
            incomplete: '[nl] Incomplete',
            pending: '[nl] Pending',
            verifying: '[nl] Verifying',
            locked: '[nl] Locked',
            incompleteDescription: '[nl] Finish adding bank account',
            pendingDescription: '[nl] Please confirm test transactions',
            verifyingDescription: "[nl] We're reviewing your documentation",
            lockedDescription: '[nl] This account requires attention',
            finish: '[nl] Finish',
            confirm: '[nl] Confirm',
            unlock: '[nl] Unlock',
        },
        cardFixConnection: '[nl] Please fix this connection',
        cardAskAdminToFix: '[nl] Please ask an admin to fix this connection',
        cardAdminFixConnection: '[nl] Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `[nl] Last synced ${dateStr}`,
        assignedCards: '[nl] Cards',
        assignedCardsDescription: '[nl] Transactions from assigned cards sync automatically.',
    ...
    cardPage: {
        ...
        spendRules: '[nl] Spend rules',
        editSpendRules: '[nl] Edit spend rules',
        reviewTransaction: '[nl] Review transaction',
...
${amount} for ${merchant} - ${date}`,
        ...
        cardUnblocked: '[nl] Card unblocked!',
        cardUnblockedDescription: '[nl] You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: '[nl] Your card was blocked due to incorrect PIN entries.',
        unblock: '[nl] Unblock',
        unblockCard: '[nl] Unblock card',
    ...
    workflowsPage: {
        ...
        configureViaHR: ({provider}: {provider: string}) => `[nl] Configure via ${provider}.`,
        hrApprovalWorkflowLockedPrompt: ({provider}: {provider: string}) =>
            `[nl] Approvals are managed by your ${provider} integration. To update your approval workflow, head to your ${provider} connection settings.`,
        goToHRSettings: ({provider}: {provider: string}) => `[nl] Go to ${provider} settings`,
    ...
    workflowsExpensesFromPage: {
        ...
        memberAlreadyInWorkflowTitle: '[nl] Member already in a workflow',
        memberAlreadyInWorkflowPrompt: ({memberName, approverName}: {memberName: string; approverName: string}) =>
            `[nl] ${memberName} is already in an approval workflow that submits to ${approverName}. Adding them here will move them to this workflow.`,
    },
    ...
    reportFraudConfirmationPage: {
        ...
        descriptionCardNotReplaced: '[nl] Your card was permanently deactivated. Please contact an admin to issue a new card.',
    ...
    agentsPage: {
        title: '[nl] Agents',
        subtitle: '[nl] Create agents to handle your workflow. Skip the manual work and get hours back in your day.',
        newAgent: '[nl] New agent',
        emptyAgents: {
            title: '[nl] No agents created',
            subtitle: '[nl] Stop manually doing stuff. Instruct an agent instead and save yourself lots of time.',
        },
        error: {
            genericAdd: '[nl] There was a problem adding this agent',
            genericUpdate: '[nl] There was a problem updating this agent',
            updateName: "[nl] There was a problem updating this agent's name",
            updatePrompt: "[nl] There was a problem updating this agent's instructions",
            updateAvatar: "[nl] There was a problem updating this agent's avatar",
        },
    },
    addAgentPage: {
        title: '[nl] New agent',
        agentName: '[nl] Agent name',
        instructions: '[nl] Write custom instructions',
        createAgent: '[nl] Create agent',
        editAvatar: '[nl] Edit avatar',
        defaultAgentName: (displayName: string) => `[nl] ${displayName}'s Agent`,
        defaultPrompt:
            "[nl] Reject expenses that are for gambling, movies, or other obvious non-business reasons.\n\nRemind the user to always include a receipt image that makes the tip clear.\n\nApprove the report if it's very similar to previous reports from the same user.\n\nReject reports with more than $500 in travel expenses.",
    },
    editAgentPage: {
        title: '[nl] Edit agent',
        agentName: '[nl] Agent name',
        instructions: '[nl] Write custom instructions',
        deleteAgent: '[nl] Delete agent',
        deleteAgentTitle: '[nl] Delete agent?',
        deleteAgentMessage: '[nl] Are you sure you want to delete this agent? This action cannot be undone.',
    },
    editAgentAvatarPage: {
        title: '[nl] Edit avatar',
    },
    editAgentNamePage: {
        title: '[nl] Agent name',
    },
    editAgentPromptPage: {
        title: '[nl] Write custom instructions',
        error: {
            emptyPrompt: '[nl] Please enter instructions for your agent.',
        },
    },
    expenseRulesPage: {
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '[nl] <strong>Avoid scams. Do not share your code with anyone.</strong> Our team will never call, text, or email you for this code.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[nl] Here's the list of workspaces you can join.",
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: '[nl] Submit expenses to my employer',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "[nl] Manage my team's expenses",
            [CONST.ONBOARDING_CHOICES.TRACK_BUSINESS]: '[nl] Track expenses for my business',
            [CONST.ONBOARDING_CHOICES.TRACK_PERSONAL]: '[nl] Organize my personal spending',
            [CONST.ONBOARDING_CHOICES.LOOKING_AROUND]: '[nl] Something else',
        },
        employees: {
            title: '[nl] How many employees do you have?',
            [CONST.ONBOARDING_COMPANY_SIZE.MICRO_SMALL]: '[nl] 1-4 employees',
            [CONST.ONBOARDING_COMPANY_SIZE.MICRO_MEDIUM]: '[nl] 5-10 employees',
        ...
        workEmail2FAError: '[nl] This login is an existing account with Two-Factor Authentication (2FA) enabled.',
        mergeBlockScreen: {
            ...
            workAccountClosedSubtitle: '[nl] The work account associated with this email is closed. Please contact your company admin to reactivate it, or sign up with a different email.',
        },
        tasks: {
            testDriveAdminTask: {
        ...
        messages: {
            ...
            onboardingManageTeamMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) =>
                isOnboardingFlow
                    ...
                    `),
            onboardingTrackWorkspaceMessage: '[nl] To make the most of your 30-day free trial, follow the remaining steps below:',
    ...
    statusPage: {
        ...
        addVacationDelegate: '[nl] Add vacation delegate',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    addPersonalBankAccount: {
        ...
        updatePersonalInfo: '[nl] Update bank account',
        updatePersonalInfoFailure: '[nl] Unable to update bank account information. Please try again later.',
        updateSuccessTitle: '[nl] Bank account updated!',
        updateSuccessHeader: '[nl] Bank account updated',
        updateSuccessMessage: '[nl] Congrats, your bank account is set up and ready to receive reimbursements.',
    },
    ...
    messages: {
        ...
        userIsAlreadyMember: (login: string, name: string) => `[nl] ${login} is already a member of ${name}`,
        userIsAlreadyAnAdmin: (login: string, name: string) => `[nl] ${login} is already an admin of ${name}`,
    },
    onfidoStep: {
    ...
    workspace: {
        common: {
            ...
            cardAdminAlternateText: '[nl] Manage workspace cards.',
            peopleAdminAlternateText: '[nl] Manage members and approval workflows.',
            paymentsAdminAlternateText: '[nl] Manage workflow payments.',
            reimbursementChoice: {
            ...
            roleName: (role?: string) => {
                switch (role) {
                    ...
                    case CONST.POLICY.ROLE.CARD_ADMIN:
                        return '[nl] Card Admin';
                    case CONST.POLICY.ROLE.PEOPLE_ADMIN:
                        return '[nl] People Admin';
                    case CONST.POLICY.ROLE.PAYMENTS_ADMIN:
                        return '[nl] Payments Admin';
            ...
            travelInvoicing: '[nl] Export travel invoicing expenses as',
            travelInvoicingVendor: '[nl] Travel vendor',
            travelInvoicingPayableAccount: '[nl] Travel payable account',
        },
        createdForClient: {
            title: "[nl] You've created a workspace for your client!",
            description: '[nl] Great news 🎉. Reach out to us if they need any help with the setup.',
        },
        receiptPartners: {
            uber: {
        ...
        qbo: {
            ...
            bankAccountDescription: '[nl] Choose where to send checks from.',
            creditCardAccount: '[nl] Credit card account',
            travelInvoicingDescription: '[nl] Travel expenses will export as credit card charges to the QuickBooks Online account specified below.',
        ...
        xero: {
            ...
            travelInvoicingDescription: '[nl] Travel expenses will export as bank transactions to the Xero account specified below.',
        ...
        sageIntacct: {
            ...
            travelInvoicingDescription: '[nl] Travel expenses will export as credit card charges to the Sage Intacct account specified below.',
            creditCardAccount: '[nl] Credit card account',
        ...
        certinia: {
            title: '[nl] Certinia',
            prerequisites: {
                title: '[nl] Before you connect',
                installBundle: '[nl] For FFA Connections',
                installBundleDescription: ({href, version}: {href: string; version: string}) =>
                    `[nl] Install the Expensify bundle in Salesforce by clicking this link: <a href="${href}">Install FFA Expensify Bundle (Version ${version})</a>`,
                installBundleConfirm: "[nl] I've installed the bundle",
                setupContacts: '[nl] Set up user and contacts',
                setupContactsBullet1:
                    "[nl] Create both a User and a Contact for yourself if these don't already exist in Certinia making sure the email matches your primary email in Expensify.\n\n",
                setupContactsBullet2:
                    "[nl] Create contacts for each employee who will be submitting expense reports and for each report approver. Make sure each contact's email address corresponds with the email address on the employee's Expensify account.\n\n",
                setupContactsBullet3: '[nl] Set permission controls for your user for each contact/resource.\n\n',
                setupContactsConfirm: "[nl] I've set up the user and contacts",
                oauth: '[nl] Log in through Salesforce',
                oauthDescription: "[nl] To finish setup, you'll have to sign in through Salesforce and Certinia.\n\nUse the button below to continue.",
                connectButton: '[nl] Connect to Certinia',
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '[nl] Single entry for each expense',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '[nl] Single, itemized entry for each report',
                },
            },
            invoiceItem: {
                ...
                values: {
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        nonReimbursableDescription: dedent(`
                            ...
                            If you'd like to set a specific vendor for each card, go to *Settings > Domains > Company Cards*.
                        `),
                        travelDescription: '[nl] Travel expenses will export as journal entries to the NetSuite account specified below.',
                    },
                },
...
_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                fileImportDescription: "[nl] A manual option if your bank can't send a feed.",
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                duplicateFeedModal: {
                    title: '[nl] Card feed already connected',
                    prompt: "[nl] You can't add the same card feed to the same workspace twice.",
                },
                csvColumns: {
        ...
        expensifyCard: {
            ...
            exportAsCSV: '[nl] Export as CSV',
            csvColumnType: '[nl] Type',
            csvColumnLimitType: '[nl] Limit type',
            csvColumnLimit: '[nl] Limit',
            findCard: '[nl] Find card',
            newCard: '[nl] New card',
            name: '[nl] Name',
            lastFour: '[nl] Last 4',
            ...
            applyCashbackToBill: '[nl] Apply cash back to my Expensify bill',
            applyCashbackToBillDescription: '[nl] Cash back from the Expensify Card will be used towards payment for your Expensify bill.',
            frequency: {
                daily: '[nl] Daily',
                monthly: '[nl] Monthly',
            },
        ...
        moreFeatures: {
                ...
                travelInvoicing: {
                    ...
                    travelInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            monthlySpendLimitLabel: '[nl] Monthly spend limit per member',
                            monthlySpendLimitDescription: '[nl] The maximum amount each member can spend on travel per month.',
                            reduceLimitTitle: '[nl] Reduce travel spend limit?',
                            reduceLimitWarning:
                                '[nl] If you reduce the limit, members who have already spent more than this amount will be unable to make new travel bookings until next month.',
                            provisioningError:
                                "[nl] We weren't able to provision some of the members of your workspace for travel invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[nl] Travel Invoicing enabled!',
            ...
            hrWarningModal: {
                disconnectText: ({integration}: {integration: string}) => `[nl] To disable HR, please disconnect ${integration} from this workspace first.`,
            },
        ...
        copyPolicySettings: {
            error: '[nl] An error occurred while copying workspace settings. Please try again.',
            title: '[nl] Copy settings',
            selectWorkspaces: '[nl] Select workspaces',
            description: '[nl] Choose the workspaces you want to copy settings to, then select the settings you’d like to copy.',
            searchPlaceholder: '[nl] Search workspaces',
        },
        emptyWorkspace: {
            title: '[nl] No workspaces yet',
            subtitle: '[nl] Create a workspace to manage your expenses, reimbursements, and company cards.',
        ...
        people: {
            ...
            configureHRSync: (providerName: string) => `[nl] Configure ${providerName} sync.`,
            syncWithHR: (providerName: string) => `[nl] Sync with ${providerName}`,
            allMembers: '[nl] All members',
            admins: '[nl] Admins',
            approvers: '[nl] Approvers',
            auditors: '[nl] Auditors',
            emptyRoleFilter: {
                title: '[nl] No members match this filter',
                subtitle: '[nl] Invite a member or change the filter above.',
            },
        ...
        accounting: {
            ...
            updateCredentials: '[nl] Update credentials',
            claimOffer: {
            ...
            syncTravelInvoicingSettlements: '[nl] Sync travel invoicing settlements',
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '[nl] Choose the bank account that your travel invoicing payments will be reconciled against.',
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `[nl] Make sure this account matches your travel invoicing settlement account (ending in ${lastFourPAN}) so Continuous Reconciliation works properly.`,
            },
        },
        hr: {
            title: '[nl] HR',
            connections: '[nl] Connections',
            subtitle: '[nl] Connect HR tools and keep employee approvals in sync.',
            connect: '[nl] Connect',
            syncNow: '[nl] Sync now',
            disconnect: '[nl] Disconnect',
            disconnectTitle: (providerName: string) => `[nl] Disconnect ${providerName}`,
            disconnectPrompt: (providerName: string) => `[nl] Are you sure you want to disconnect ${providerName}?`,
            alreadyConnectedTitle: '[nl] Cannot connect to multiple HR platforms',
            alreadyConnectedPrompt: '[nl] You must disconnect your current HR platform before connecting another.',
            lastSync: (relativeDate: string) => `[nl] Last synced ${relativeDate}`,
            syncError: (providerName: string) => `[nl] Can't connect to ${providerName}`,
            connectionDescription: (providerName: string) => `[nl] Connect ${providerName} to keep employee approvals in sync with your workspace.`,
            approvalMode: '[nl] Approval mode',
            providerApprovalMode: (providerName: string) => `[nl] ${providerName} approval mode`,
            finalApprover: '[nl] Final approver',
            providerFinalApprover: (providerName: string) => `[nl] ${providerName} final approver`,
            notSet: '[nl] Not set',
            syncing: '[nl] Syncing employees',
            syncingModalTitle: '[nl] Your connection is syncing',
            syncingModalDescription: "[nl] The first connection can take some time. You'll be notified of any errors.",
            approvalModeDescription: (providerName: string) => `[nl] Members and managers are set up to sync with ${providerName}.`,
            approvalModeWarningTitle: '[nl] Change approval mode?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `[nl] Are you sure you would like to change the approval mode for this workspace? Learn more about the different ${providerName}-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
            approvalModeWarningConfirm: '[nl] Change approval mode',
            approvalModes: {
                basic: {label: '[nl] Basic approval', description: '[nl] All users submit to a single person for processing and approval.'},
                manager: {
                    label: '[nl] Manager approval',
                    description: (providerName: string) => `[nl] Employees submit reports to their direct manager configured in ${providerName}.`,
                },
                custom: {label: '[nl] Custom approval', description: "[nl] I'll manually setup approval workflows in Expensify."},
            },
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
                        return '[nl] Synchronizing Gusto Employees';
                    case 'gustoSyncLoadData':
                        return '[nl] Loading data from Gusto';
                    case 'gustoSyncProvisioning':
                        return '[nl] Provisioning employees in policy';
                    case 'zenefitsSyncTitle':
                        return '[nl] Synchronizing TriNet Employees';
                    case 'zenefitsSyncLoadData':
                        return '[nl] Loading data from TriNet';
            ...
            syncResults: {
                title: (provider: string) => `[nl] ${provider} sync complete`,
                successTitle: (provider: string) => `[nl] Successfully synced your ${provider} connection!`,
                added: '[nl] Added',
                removed: '[nl] Removed',
                skipped: '[nl] Skipped',
                employeeCount: () => ({
                    one: '[nl] 1 employee',
                    other: (count: number) => `[nl] ${count} employees`,
                }),
            },
            gusto: {
                title: '[nl] Gusto',
        ...
        distanceRates: {
            ...
            amountPerUnit: (unit: string) => `[nl] Amount per ${unit}`,
            startDate: '[nl] Start date',
            endDate: '[nl] End date',
            errors: {
                rateNameRequired: '[nl] Rate name is required',
                existingRateName: '[nl] A distance rate with this name already exists',
                nameRequired: '[nl] Name is required',
                amountRequired: '[nl] Amount is required',
                startDateMustBeBeforeEndDate: '[nl] Start date must be before end date',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            yourWorkspace: `[nl] Your workspace is set to an unsupported currency. View the <a href="${CONST.ENABLE_GLOBAL_REIMBURSEMENT_HELP_URL}">list of supported currencies</a>.`,
...
Are you sure you want to export them again?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.CERTINIA]: {
                title: '[nl] Certinia',
                description: `[nl] Enjoy automated syncing and reduce manual entries with the Expensify + Certinia integration. Align expense coding dimensions and tax sync with your Certinia setup for clearer financial visibility.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>Our Certinia integration is only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            ...
            approvalSubmit: {
                title: '[nl] Approvals',
                description: '[nl] Centrally configure who all members submit to by enabling approvals.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>Approvals are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            categories: {
                title: '[nl] Categories',
            ...
            companyCardSubmit: {
                title: '[nl] Company cards',
                description: `[nl] Bring your own company card to Expensify to get automatic import, automatic categorization, customizable rule support, and integrated reconciliation.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>Company card import is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            rules: {
                title: '[nl] Rules',
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            hr: {
                title: '[nl] HR integrations',
                description:
                    '[nl] Connect your HR provider to automatically sync employees and manage approval workflows. Keep your team roster and reporting structure up to date without manual work.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>HR integrations are only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            travel: {
                title: '[nl] Travel',
            ...
            travelSubmit: {
                title: '[nl] Expensify Travel',
                description: '[nl] Book discounted flights, hotels, cars, and trains globally from within Expensify, with duty of care reporting and integrated expense management.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>Expensify Travel is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            reports: {
                title: '[nl] Reports',
            ...
            roles: {
                title: '[nl] Roles',
                description: '[nl] Assign different roles to different members to increase or decrease visibility and control as appropriate.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>Roles are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            payments: {
                title: '[nl] Payments',
                description: '[nl] Reimburse employees directly from your business bank account.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>Payments are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            accounting: {
                title: '[nl] Accounting',
                description:
                    '[nl] Sync categories, tags, tax rates, and more from your accounting system to Expensify, as well as export expense reports and card transactions – no typing (or typos) involved!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>Accounting is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            expensifyCard: {
                title: '[nl] Expensify Card',
                description:
                    '[nl] Issue company cards (including virtual cards) directly from your own bank account to get realtime spend control with an unbreakable connection, and up to 2% cashback!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>The Expensify Card is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
                upgradeButton: '[nl] Upgrade and enable',
            },
            invoicing: {
                title: '[nl] Invoicing',
                description: '[nl] Create, send, and track professional invoices, all inside Expensify. Get paid faster with integrated payments and real-time visibility.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[nl] <muted-text>Invoicing is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[nl] per member per month.` : `[nl] per active member per month.`}</muted-text>`,
            },
            pricing: {
                perActiveMember: '[nl] per active member per month.',
                perMember: '[nl] per member per month.',
            },
            note: (subscriptionLink: string) => `[nl] <muted-text><a href="${subscriptionLink}">Learn more</a> about our plans and pricing.</muted-text>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                giftCard: '[nl] Gift card purchases',
                handwrittenReceipt: '[nl] Handwritten receipts',
            ...
            customRules: {
                ...
                policyDocument: '[nl] Policy document',
                policyText: '[nl] Policy text',
            },
            spendRules: {
                title: '[nl] Spend',
...
Add more spend rules to protect company cash flow.`,
                ...
                summaryMoreCount: ({summary, count}: {summary: string; count: number}) => (count > 0 ? `[nl] ${summary}, +${count} more` : summary),
                summaryMerchants: ({
                    merchants,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[nl] Blocked' : '[nl] Allowed'} ${shownCount > 1 ? '[nl] merchants' : '[nl] merchant'}: ${merchants}${hiddenCount > 0 ? `[nl] , +${hiddenCount} more` : ''}`,
                summaryCategories: ({
                    categories,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[nl] Blocked' : '[nl] Allowed'} ${shownCount > 1 ? '[nl] categories' : '[nl] category'}: ${categories}${hiddenCount > 0 ? `[nl] , +${hiddenCount} more` : ''}`,
                ...
                noAvailableCards: '[nl] All cards already have a rule',
                noAvailableCardsSubtitle: '[nl] Edit an existing card rule to make changes',
                noCardsIssuedTitle: '[nl] No Expensify Cards issued',
                noCardsIssuedSubtitle: '[nl] Issue Expensify Cards to create spend rules',
                max: '[nl] Max',
                categoryOptions: {
        ...
        planTypePage: {
            planTypes: {
                ...
                submit2026: {
                    label: '[nl] Submit',
                    description: '[nl] For employees looking to submit expenses to their employer.',
                },
            },
            description: "[nl] Choose a plan that's right for you.",
            subscriptionLink: '[nl] Learn more',
    ...
    workspaceActions: {
        ...
        deleteCustomUnitRate: (customUnitName: string, rateName: string) => `[nl] removed the "${customUnitName}" rate "${rateName}"`,
        ...
        updatedManualApprovalThreshold: (oldLimit: string, newLimit: string) => `[nl] changed the manual approval limit for all expenses to ${newLimit} (previously ${oldLimit})`,
        ...
        updatedRequireCompanyCards: ({enabled}: {enabled: boolean}) => `[nl] ${enabled ? '[nl] enabled' : '[nl] disabled'} the company card purchases requirement`,
        ...
        updateCustomTaxName: (oldName: string, newName: string) => `[nl] changed the custom tax name to "${newName}" (previously "${oldName}")`,
        updateCurrencyDefaultTax: (oldName: string, newName: string) => `[nl] changed the workspace currency default tax rate to "${newName}" (previously "${oldName}")`,
        updateForeignCurrencyDefaultTax: (oldName: string, newName: string) => `[nl] changed the foreign currency default tax rate to "${newName}" (previously "${oldName}")`,
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `[nl] set itemized receipt required amount to "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) => `[nl] changed itemized receipt required amount to "${newValue}" (previously "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `[nl] removed itemized receipt required amount (previously "${oldValue}")`,
    ...
    search: {
        tabs: {
            ...
            expenses: '[nl] Expenses',
            submit: '[nl] Drafts',
            approve: '[nl] Needs approval',
            pay: '[nl] Ready to pay',
            accounting: '[nl] Accounting',
            export: '[nl] Awaiting export',
            unapprovedCash: '[nl] Cash accruals',
            unapprovedCard: '[nl] Card accruals',
            statements: '[nl] Card statements',
            reconciliation: '[nl] Bank reconciliation',
        ...
        bulkActions: {
            ...
            editMultipleDescription: '[nl] Changes will be set for all selected expenses and will override any previously set values.',
            approve: '[nl] Approve',
            pay: '[nl] Pay',
            delete: '[nl] Delete',
            hold: '[nl] Hold',
            ...
            duplicateReport: ({count}: {count: number}) => `[nl] Duplicate ${count === 1 ? '[nl] report' : '[nl] reports'}`,
            undelete: '[nl] Undelete',
        ...
        filters: {
            ...
            sortOrder: {
                [CONST.SEARCH.SORT_ORDER.ASC]: '[nl] Ascending',
                [CONST.SEARCH.SORT_ORDER.DESC]: '[nl] Descending',
            },
            groupBy: {
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[nl] Travel invoicing',
            },
            is: '[nl] Is',
            action: {
        ...
        askConcierge: (message: string) => `[nl] Ask Concierge “${message}”`,
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    travelCardLink: '[nl] travel card expenses',
                ...
                integrationSyncFailedRecurrence: ({count}: {count: number}) => `[nl] (Repeated ${count} times.)`,
    ...
    chronos: {
        ...
        stopTimer: (duration: string) => `[nl] Stop Timer (${duration})`,
        scheduleOOO: '[nl] Schedule OOO',
        scheduleOOOTitle: '[nl] Schedule Out of Office',
        date: '[nl] Date',
        time: '[nl] Time (use 24-hour format)',
        durationAmount: '[nl] Duration',
        durationUnit: '[nl] Unit',
        reason: '[nl] Reason',
        workingPercentage: '[nl] Working percentage',
        dateRequired: '[nl] Date is required.',
        invalidTimeFormat: '[nl] Please enter a valid 24-hour time (e.g., 14:30).',
        enterANumber: '[nl] Please enter a number.',
        hour: '[nl] hours',
        day: '[nl] days',
        week: '[nl] weeks',
        month: '[nl] months',
    ...
    accessibilityHints: {
        ...
        openActionsMenu: '[nl] Open actions menu',
        selectAllCategories: '[nl] Select all categories',
        selectAllDistanceRates: '[nl] Select all distance rates',
        selectAllTags: '[nl] Select all tags',
        selectAllTaxes: '[nl] Select all taxes',
        selectAllPerDiemRates: '[nl] Select all per diem rates',
        selectAllMembers: '[nl] Select all members',
        selectAllValues: '[nl] Select all values',
        selectAllRules: '[nl] Select all rules',
    },
    parentReportAction: {
    ...
    gps: {
        ...
        liveActivity: {
            ...
            lockScreenBadgeText: '[nl] Distance',
            lockScreenTrackingText: '[nl] Tracking...',
    ...
    violations: {
        ...
        missingTag: (tagName?: string) => `[nl] Missing ${tagName ?? '[nl] tag'}`,
        ...
        prohibitedExpense: (prohibitedExpenseTypes: string | string[]) => {
            ...
            const getProhibitedExpenseTypeText = (prohibitedExpenseType: string) => {
                switch (prohibitedExpenseType) {
                    ...
                    case 'giftCard':
                        return `[nl] gift card purchases`;
                    case 'handwrittenReceipt':
                        return `[nl] handwritten receipts`;
                    default:
        ...
        smartscanFailed: ({canEdit = true, missingFields = []}: {canEdit?: boolean; missingFields?: string[]}) => {
            if (missingFields.length > 0) {
                const fieldNames: Record<string, string> = {merchant: '[nl] merchant', date: '[nl] date', amount: '[nl] amount'};
                const translated = missingFields.map((f) => fieldNames[f] ?? f);
                let fieldList = '';
                if (translated.length === 1) {
                    fieldList = translated.at(0) ?? '';
                } else if (translated.length === 2) {
                    fieldList = translated.join('[nl]  and ');
                } else {
                    fieldList = `${translated.slice(0, translated.length - 1).join(', ')}, and ${translated.at(-1)}`;
                }
                return `[nl] Receipt scanning failed — missing ${fieldList}.${canEdit ? '[nl]  Enter details manually.' : ''}`;
            }
            return `[nl] Receipt scanning failed.${canEdit ? '[nl]  Enter details manually.' : ''}`;
        },
    ...
    exitSurvey: {
        ...
        goBackJustOnce: '[nl] Go back just once',
    },
    listBoundary: {
    ...
    subscription: {
        ...
        details: {
            ...
            creditBalance: '[nl] Credit balance',
        ...
        cancelSubscription: {
            title: '[nl] Cancel subscription',
            subtitle: '[nl] What’s the main reason you’re canceling your subscription?',
    ...
    delegate: {
        ...
        addCopilot: '[nl] Add a copilot to your account',
        membersCanAccessYourAccount: '[nl] These members can access your account:',
        youCanAccessTheseAccounts: '[nl] You can access these accounts:',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            moveToGroup: '[nl] Move to group',
            domainGroup: '[nl] Domain group',
            chooseWhereToMove: ({count}: {count: number}) => `[nl] Choose where to move ${count} ${count === 1 ? '[nl] member' : '[nl] members'}.`,
            chooseWhereToMoveName: ({name}: {name: string}) => `[nl] Choose where to move ${name}.`,
            error: {
                addMember: '[nl] Unable to add this member. Please try again.',
                removeMember: '[nl] Unable to remove this user. Please try again.',
                moveMember: '[nl] Unable to move this member. Please try again.',
                vacationDelegate: '[nl] Unable to set this user as a vacation delegate. Please try again.',
                moveMemberNotPolicyAdmin:
                    '[nl] Cannot move member to the domain group. You must be a Policy Admin for the Preferred Policy set on the domain group you are trying to move this user to.',
            },
        ...
        common: {
            ...
            error: "[nl] Couldn't save this change. Please try again.",
        },
        groups: {
            title: '[nl] Groups',
            memberCount: () => {
            ...
            defaultGroup: '[nl] Default group for new members',
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `[nl] Are you sure you want to make ${newName} the default group? New members will be invited to this group instead of the previous default group (${currentName}). `,
            makeDefault: '[nl] Make default',
            neverMind: '[nl] Never mind',
            createGroupError: '[nl] Unable to create this group. Please try again.',
            permissions: '[nl] Group permissions',
            createNewGroupButton: '[nl] New group',
            createGroupSubmitButton: '[nl] Create group',
            expensifyCardPreferredWorkspace: '[nl] Expensify Card preferred workspace',
            expensifyCardPreferredWorkspaceDescription:
                '[nl] All Expensify Card transactions will be created on the Expensify Card Preferred Workspace instead of the Preferred Workspace. Enabling this feature will override the Preferred Workspace setting for Expensify Card transactions only.',
            strictlyEnforceWorkspaceRules: '[nl] Strictly enforce workspace rules',
            strictlyEnforceWorkspaceRulesDescription: '[nl] All workspace rules must be met before submitting a report. No manual exceptions allowed.',
            restrictExpenseWorkspaceCreation: '[nl] Restrict expense workspace creation/removal',
            restrictExpenseWorkspaceCreationDescription:
                '[nl] Prevent members from being able to create an expense workspace or remove themselves from an expense workspace. This is useful for preventing people from using Expensify to submit reports for use outside your domain when combined with strict workspace enforcement.',
            deleteGroup: '[nl] Delete Group',
            deleteGroupDangerConfirmationModal: '[nl] Delete Group',
            deleteGroupDangerConfirmationModalDescription: (defaultGroupName: string) =>
                `[nl] Are you sure? This will reassign all members to the default group (${defaultGroupName}) and can't be undone.`,
            deleteGroupError: '[nl] Unable to delete this group. Please try again.',
            preferredWorkspace: '[nl] Preferred Workspace',
            preferredWorkspaceDescription: (enabled: boolean) => `[nl] All new reports and expenses will be created on ${enabled ? '[nl] selected preferred' : '[nl] this'} workspace.`,
            preferredWorkspaceSelectDescription: '[nl] All new expenses and reports will be created on this workspace.',
            noWorkspacesMessage: '[nl] There are no workspaces on this domain. A workspace is required to enable this restriction.',
            restrictDefaultLoginSelection: '[nl] Restrict default login selection',
            restrictDefaultLoginSelectionDescription: '[nl] Prevent members from changing their login email away from their company domain to avoid policy restrictions.',
            expensifyCardPreferredWorkspaceDisabledMessage: '[nl] To enable this setting, please first enable a preferred workspace and set up Expensify Cards on your domain.',
            findGroup: '[nl] Find group',
        },
    },
};
