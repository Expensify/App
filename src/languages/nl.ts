        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    ...
                    officeBasedTitle: 'Op kantoor',
                    officeBasedHelp: 'Het lid reist naar een kantoor. Gebruikelijke woon-werkritten worden uitgesloten van vergoeding.',
                    noRegularWorkplaceTitle: 'Geen vaste werkplek',
                    noRegularWorkplaceHelp: 'Het lid werkt op afstand of heeft geen vaste werkplek, dus regels voor woon-werkverkeer gelden niet.',
                    startingPrompt: {
                        title: 'Stel een gebruikelijke werkafspraak in',
                        prompt: 'Kies de werkafspraak die voor de meeste huidige leden geldt. Je kunt leden later afzonderlijk of in bulk bijwerken.',
                        officeBasedHelp: 'De meeste leden reizen naar een kantoor. Gebruikelijke woon-werkritten worden uitgesloten.',
                        noRegularWorkplaceHelp: 'De meeste leden werken op afstand, dus uitsluitingen voor woon-werkverkeer gelden meestal niet.',
                        confirm: 'Toepassen',
                    },
                },
            },
...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            ...
            set: ({arrangement}: {arrangement: string}) => `heeft de standaard werkafspraak ingesteld op ‘${arrangement}’`,
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `heeft de standaard werkafspraak gewijzigd in ‘${arrangement}’ (voorheen ‘${previousArrangement}’)`,
        },
        commuterExclusions: {
