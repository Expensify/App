...
3. Zodra de feed is ingeschakeld, klik hieronder op Verzenden en wij gaan ermee aan de slag om deze toe te voegen.`,
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `Ongeldige formule-plaatshouder(s): ${placeholders}. Gebruik ondersteunde plaatshouders zoals {report:id}, {report:name}, {report:created}, enz.`,
