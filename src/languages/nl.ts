...
Vereis onkostendetails zoals bonnen en beschrijvingen, stel limieten en standaardwaarden in, en automatiseer goedkeuringen en betalingen – allemaal op één plek.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                oneConditionPerRuleTitle: 'Slechts één voorwaarde per regel',
                alreadyMatchesMerchantPrompt: 'Deze regel komt al overeen met een handelaar. Reset de regel zodat deze in plaats daarvan overeenkomt met een categorie.',
                alreadyMatchesCategoryPrompt: 'Deze regel komt al overeen met een categorie. Stel de regel opnieuw in om in plaats daarvan op een leverancier te matchen.',
                ...
                onlyTaxForCategoryRulesTitle: 'Alleen belasting is beschikbaar voor categoriewaarden',
                onlyTaxForCategoryRulesPrompt:
                    'Categoriregels kunnen een standaardbelastingtarief instellen. Om andere standaarden in te stellen, kun je in plaats daarvan op een leverancier matchen.',
                clearIncompatibleDefaultsTitle: 'Andere standaardinstellingen wissen?',
                clearIncompatibleDefaultsPrompt: 'Deze velden zijn niet compatibel met de categorie. Wil je alle velden wissen?',
                clearFields: 'Velden wissen',
...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
            ...
            newRule: {
                ...
                createAgentRuleDescription: 'Maak flexibele regels die worden uitgevoerd wanneer jij dat wilt.',
            },
