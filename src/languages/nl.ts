...
${amount} voor ${merchant} - ${date}`,
    ...
    onboarding: {
        ...
        peopleYouMayKnow: 'Kijk of je team hier al is',
        workspaceYouMayJoin: (domain: string, email: string) =>
            `Verifieer je e-mailadres om te controleren of iemand van ${domain} een workspace heeft waar je je bij kunt aansluiten. Voer de magische code in die naar ${email} is gestuurd.`,
