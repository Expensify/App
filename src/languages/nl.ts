...
Het Control-abonnement begint bij $9 per actieve deelnemer per maand.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    title: 'Standaard werkregeling',
                    officeBasedTitle: 'Op kantoor gebaseerd',
                    officeBasedHelp: 'Lid reist regelmatig naar een kantoor. Gewone woon-werkverkeerreizen komen niet in aanmerking voor vergoeding.',
                    noRegularWorkplaceTitle: 'Geen vaste werkplek',
                    noRegularWorkplaceHelp: 'Lid werkt op afstand of heeft geen vaste werkplek, waardoor de woon-werkverkeersregels niet van toepassing zijn.',
                    startingPrompt: {
                        title: 'Stel een typische werkregeling in',
                        prompt: 'Kies de regeling die van toepassing is op de meeste huidige leden. Je kunt leden later afzonderlijk of in bulk bijwerken.',
                        officeBasedHelp: 'De meeste leden pendelen naar een kantoor. Gewone woon-werkverplaatsingen zijn uitgesloten.',
                        noRegularWorkplaceHelp: 'De meeste medewerkers werken op afstand, dus woon-werkuitzonderingen zijn meestal niet van toepassing.',
                        confirm: 'Toepassen',
                    },
                },
            },
    ...
    workspaceActions: {
        ...
        workArrangement: {
            ...
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `heeft de standaard werksituatie gewijzigd naar ${arrangement} (voorheen ${previousArrangement})`,
        },
        commuterExclusions: {
