...
3. Zodra de feed is ingeschakeld, klik je hieronder op Verzenden en gaan wij aan de slag om deze toe te voegen.`,
        ...
        reportFields: {
            ...
            unsupportedFormulaValueError: ({value}: UnsupportedFormulaValueErrorParams) => `Niet-ondersteunde formule-token(s): ${value}. Gebruik ondersteunde tokens zoals {report:id}.`,
