...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[nl] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[nl] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[nl] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[nl] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[nl] Get clients setup successfully',
            accountManagerApprovedDescription: '[nl] Ask questions and get client support',
            moreResources: '[nl] More resources',
        },
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[nl] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[nl] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[nl] Go to Gusto settings',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    workspace: {
        common: {
            ...
            travelInvoicing: '[nl] Export Expensify Travel Payable To',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                travelInvoicing: {
                    ...
                    centralInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[nl] We weren't able to provision some of the members of your workspace for central invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
        ...
        hr: {
            ...
            settingsTitle: '[nl] Gusto settings',
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
            ...
            gusto: {
                ...
                disconnect: '[nl] Disconnect',
                lastSync: (relativeDate: string) => `[nl] Last synced ${relativeDate}`,
                syncError: "[nl] Can't connect to Gusto",
                disconnectTitle: '[nl] Disconnect Gusto',
                disconnectPrompt: '[nl] Are you sure you want to disconnect Gusto?',
                connectionDescription: '[nl] Connect Gusto to keep employee approvals in sync with your workspace.',
                approvalMode: '[nl] Approval mode',
                finalApprover: '[nl] Final approver',
                notSet: '[nl] Not set',
                approvalModeDescription: '[nl] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[nl] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[nl] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[nl] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[nl] Basic approval',
                        description: '[nl] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[nl] Manager approval',
                        description: '[nl] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[nl] Custom approval',
                        description: '[nl] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[nl] Gusto sync results',
                    successTitle: '[nl] Successfully synced your Gusto connection!',
                    added: '[nl] Added',
                    removed: '[nl] Removed',
                    skipped: '[nl] Skipped',
                    employeeCount: () => ({
            ...
            zenefits: {
                ...
                disconnect: '[nl] Disconnect',
                lastSync: (relativeDate: string) => `[nl] Last synced ${relativeDate}`,
                syncError: "[nl] Can't connect to TriNet",
                disconnectTitle: '[nl] Disconnect TriNet',
                disconnectPrompt: '[nl] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[nl] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[nl] Approval mode',
                finalApprover: '[nl] Final approver',
                notSet: '[nl] Not set',
                approvalModeDescription: '[nl] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[nl] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[nl] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[nl] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[nl] Basic approval',
                    ...
                    manager: {
                        label: '[nl] Manager approval',
                        description: '[nl] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[nl] Custom approval',
                        description: "[nl] I'll manually setup approval workflows in Expensify.",
    ...
    search: {
        ...
        filters: {
            ...
            card: {
                ...
                centralInvoicing: '[nl] Central invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[nl] Central invoicing',
            },
            is: '[nl] Is',
            action: {
