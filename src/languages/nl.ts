...
${amount} voor ${merchant} - ${date}`,
    ...
    expenseRulesPage: {
        ...
        changes: {
            updateBillable: (value: boolean) => `Uitgave ${value ? 'factureerbaar' : 'niet-declarabel'} bijwerken`,
            updateCategory: (value: string) => `Categorie bijwerken naar "${value}"`,
            updateComment: (value: string) => `Beschrijving wijzigen in "${value}"`,
            updateMerchant: (value: string) => `Handelaar bijwerken naar "${value}"`,
            updateReimbursable: (value: boolean) => `Uitgave ${value ? 'terugbetaalbaar' : 'niet-vergoedbaar'} bijwerken`,
            updateTag: (value: string) => `Tag bijwerken naar "${value}"`,
            updateTax: (value: string) => `Belastingtarief bijwerken naar ${value}`,
