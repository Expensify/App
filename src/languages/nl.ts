...
${amount} voor ${merchant} - ${date}`,
    ...
    activateCardPage: {
        ...
        fillInAllDetails: 'Vul alle gegevens hieronder in',
    },
    getPhysicalCard: {
...
Het Control-abonnement begint bij $9 per actieve deelnemer per maand.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                enterShippingAddress: 'Voer verzendadres in',
                shippingAddressDescription: 'Vertel ons waar we de nieuwe kaart naartoe moeten sturen.',
                promptCardholder: 'Kaarthouder vragen',
                promptCardholderDescription: 'De kaarthouder wordt gevraagd om het bezorgadres in te voeren of te bevestigen.',
