...
Het Control-abonnement begint bij $9 per actieve deelnemer per maand.`,
        ...
        accounting: {
            ...
            syncTravelInvoicingSettlements: 'Geconsolideerde Travel Billing-afrekeningen synchroniseren',
            syncTravelInvoicingSettlementsNoAccountTooltip: 'Stel een rekening in voor je exports om te ontgrendelen.',
            syncTravelInvoicingSettlementsNoAutoSyncTooltip: 'Schakel automatisch synchroniseren in om te ontgrendelen.',
        },
        export: {
