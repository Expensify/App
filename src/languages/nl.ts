...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            accountManager: '[nl] Account Manager',
            accountManagerDescription: 'Stel vragen en krijg ondersteuning voor klanten',
            partnerManager: '[nl] Partner Manager',
            partnerManagerDescription: 'Haal het maximale uit je samenwerking en stimuleer verwijzingen',
            ...
            approvedPartnerTeamDescription:
                'Een toegewijd team dat zich richt op het laten groeien van je kantoor, het sneller onboarden van klanten en het bieden van deskundige ondersteuning wanneer je die nodig hebt.',
            accountExecutive: '[nl] Account Executive',
