...
${
    ...
    workspaceActions: {
        ...
        forcedCorporateUpgrade: `Deze werkruimte is geüpgraded naar het Control-abonnement. Klik <a href="${CONST.PLAN_TYPES_AND_PRICING_HELP_URL}">hier</a> voor meer informatie.`,
