...
Voeg meer bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
                ...
                restrictionTypeHelpAllow: 'Kosten worden goedgekeurd als ze overeenkomen met een leverancier of categorie en een maximumbedrag niet overschrijden.',
                restrictionTypeHelpBlock: 'Transacties worden geweigerd als ze overeenkomen met een geblokkeerde handelaar of categorie, of een maximumbedrag overschrijden.',
                addMerchant: 'Winkel toevoegen',
                merchantContains: 'Handelaar bevat',
                merchantExactlyMatches: 'Leverancier komt exact overeen',
                ...
                addMerchantToAllowSpend: 'Voeg een verkoper toe om uitgaven toe te staan',
                matchType: 'Overeenkomsttype',
                matchTypeContains: 'Bevat',
                matchTypeExact: 'Komt exact overeen',
                spendCategory: 'Uitgavencategorie',
                maxAmount: 'Maximumbedrag',
                maxAmountHelp: 'Elke betaling boven dit bedrag wordt geweigerd, ongeacht beperkingen op handelaar en uitgavencategorie.',
                currencyMismatchTitle: 'Valuta komt niet overeen',
                currencyMismatchPrompt: 'Om een maximumbedrag in te stellen, selecteer kaarten die in dezelfde valuta worden vereffend.',
                ...
                confirmErrorApplyAtLeastOneSpendRule: 'Pas minimaal één bestedingsregel toe',
                categories: 'Categorieën',
                ...
                categoryOptions: {
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.DINING]: 'Dineren',
                    [CONST.SPEND_RULES.CATEGORIES.FUEL_AND_GAS]: 'Brandstof en gas',
                    [CONST.SPEND_RULES.CATEGORIES.GOVERNMENT_AND_NON_PROFIT]: 'Overheid en non-profitorganisaties',
