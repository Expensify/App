...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
                ...
                maxAmountCurrencyMismatchPrompt: 'Om een maximumbedrag in te stellen, selecteer kaarten die in dezelfde valuta worden vereffend.',
                ...
                restrictMerchants: 'Winkels beperken',
                ...
                settlementCurrencyPermittedSubtitle: 'De kaartafrekeningsvaluta is altijd toegestaan',
                currenciesCurrencyMismatchTitle: 'Valutaverschil',
                currenciesCurrencyMismatchPrompt: 'Om voorkeursvaluta in te stellen, selecteer kaarten die in dezelfde valuta worden afgerekend.',
                restrictMerchantsOffSubtitle: 'Lasten worden goedgekeurd voor toegestane valuta die een maximumbedrag niet overschrijden',
                restrictMerchantsAllowSubtitle:
                    'Kosten worden goedgekeurd voor toegestane valuta die een maximumbedrag niet overschrijden, en waarbij de handelaar of het handelaarstype overeenkomt.',
                restrictMerchantsBlockSubtitle:
                    'Kosten worden goedgekeurd voor toegestane valuta die een maximumbedrag niet overschrijden, of wanneer de handelaar of het type handelaar overeenkomt.',
            },
            agentRules: {
                title: 'Agentregels',
