...
Vraag verplichte uitgavedetails zoals bonnetjes en beschrijvingen, stel limieten en standaardwaarden in en automatiseer goedkeuringen en betalingen – allemaal op één plek.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                ruleSummaryTitleContains: (merchantName: string) => `Als handelaar "${merchantName}" bevat`,
                ruleSummaryTitleExact: (merchantName: string) => `Als handelaar precies "${merchantName}" is`,
                ruleSummarySubtitleMerchant: (merchantName: string) => `Naam handelaar wijzigen in "${merchantName}"`,
                matchType: 'Type overeenkomst',
                matchTypeContains: 'Bevat',
                matchTypeContainsDescription: 'Overeenkomst met uitgaven waarbij de naam van de handelaar de opgegeven tekst bevat (hoofdletterongevoelig)',
                matchTypeExact: 'Komt exact overeen',
                matchTypeExactDescription: 'Overeenkomst met uitgaven waarbij de naam van de handelaar exact overeenkomt met de opgegeven tekst',
