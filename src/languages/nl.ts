...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        createExpenses: ({expensesNumber}: CreateExpensesParams) => `Maak ${expensesNumber} onkosten`,
...
3. Zodra de feed is ingeschakeld, klik hieronder op Verzenden en wij gaan ermee aan de slag om deze toe te voegen.`,
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                pendingBankDescription: ({bankName}: CompanyCardBankName) => `Maak verbinding met ${bankName} via het browservenster dat zojuist is geopend. Als er geen werd geopend,`,
...
Vraag verplichte uitgavedetails zoals bonnetjes en beschrijvingen, stel limieten en standaardwaarden in en automatiseer goedkeuringen en betalingen – allemaal op één plek.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateEnabled: ({customUnitName, customUnitRateName, oldValue, newValue}: UpdatedPolicyCustomUnitRateEnabledParams) => {
            return `heeft de in-/uitschakelstatus van het ${customUnitName}-tarief "${customUnitRateName}" gewijzigd naar "${newValue}" (voorheen "${oldValue}")`;
        },
