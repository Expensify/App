        ...
        recruiting: {
            ...
            filters: {
                ...
                stages: {
                    ...
                    toggleTitle: 'Importtaakfasen',
                    allSelected: 'Alle functiestadia',
                    emptySelectionError: 'Selecteer minimaal één functieniveau',
                },
                tags: {
                    title: 'Label',
                    description: 'Kies de tags van kandidaten die je wilt synchroniseren met deze workspace',
                    toggleTitle: 'Tags importeren',
                    allSelected: 'Alle tags',
                    emptySelectionError: 'Selecteer ten minste één tag',
                },
                offices: {
                    title: 'Kantoor',
                    description: 'Kies de kantoren van kandidaten die je met deze workspace wilt synchroniseren',
                    toggleTitle: 'Kantoren importeren (optioneel)',
