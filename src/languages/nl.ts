...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
        ...
        campfire: {
            ...
            exportReimbursable: {label: 'Declareerbare uitgaven exporteren als', values: {label: 'Leveranciersrekeningen'}},
            exportDate: {
                label: 'Factuurdatum leverancier',
                description: 'Gebruik deze datum bij het exporteren van rapporten naar Campfire.',
                values: {label: 'Datum van indiening', description: 'Datum waarop het rapport ter goedkeuring is ingediend.'},
            },
            exportNonReimbursable: {label: 'Exporteer bedrijfskaartuitgaven als', values: {label: 'Boekingen'}},
            defaultCompanyCardVendor: {
            ...
            companyCardAccount: {label: 'Bedrijfskaartaccount', description: 'Kies waar je bedrijfspastransacties wilt exporteren.'},
            noVendorsFound: 'Geen leveranciers gevonden',
            noVendorsFoundDescription: 'Voeg leveranciers toe in Campfire en synchroniseer de verbinding opnieuw',
            noAccountsFound: 'Geen accounts gevonden',
            noAccountsFoundDescription: 'Voeg alsjeblieft accounts toe in Campfire en synchroniseer de verbinding opnieuw',
        },
        businessCentral: {
