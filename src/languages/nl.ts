...
${amount} voor ${merchant} - ${date}`,
        ...
        cardUnblocked: 'Kaart ontgrendeld!',
        cardUnblockedDescription: 'Je wordt mogelijk gevraagd om je kaart bij je volgende aankoop in de lezer te steken.',
        pinBlocked: 'Je kaart is vergrendeld vanwege onjuiste pincode-invoer.',
        unblock: 'Ontgrendelen',
        unblockCard: 'Kaart ontgrendelen',
    },
    workflowsPage: {
