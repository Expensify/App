...
${amount} voor ${merchant} - ${date}`,
        ...
        reenterPinToConfirm: 'Voer je pincode opnieuw in om te bevestigen.',
    ...
    domain: {
        ...
        members: {
            ...
            cannotSetVacationDelegateForMember: (email: string) =>
                `Je kunt geen vakantievertegenwoordiger instellen voor ${email}, omdat die persoon nu al vertegenwoordiger is voor de volgende leden:`,
        },
