...
${amount} voor ${merchant} - ${date}`,
    ...
    privatePersonalDetails: {
        ...
        commuterExclusionsNote: ({workspaceName}: {workspaceName: string}) => `${workspaceName} gebruikt dit adres voor woon-werkuitsluitingen.`,
        error: {
...
3. Zodra de feed is ingeschakeld, klik je hieronder op Verzenden en gaan wij aan de slag om deze toe te voegen.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: 'Trek van elke afstandsclaim het woon-werkverkeer van elk lid tussen huis en het werkruimteadres af.',
                workspaceAddressRequired: {
                    title: 'Oeps, niet zo snel...',
                    prompt: 'Deze werkruimte heeft nog geen adres. Voeg er een toe zodat woon-werkuitsluitingen het kunnen gebruiken.',
                    cta: 'Adres toevoegen',
                },
                errors: {
