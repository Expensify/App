    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            biometrics: {
                ...
                test: 'Test',
                softPromptTitle: 'Verifieer transacties met uw gezicht of vingerafdruk',
                softPromptContent: 'Schakel snelle en veilige verificatie in met uw gezicht of vingerafdruk - geen wachtwoorden of codes vereist.',
                notificationTitle: 'Authenticatie geslaagd',
                notificationContent: 'U hebt succesvol geauthenticeerd met Face ID.',
                biometricsTest: 'Biometrietest',
                errorPageTitle: 'Oeps, er is iets misgegaan',
                errorPageContent: 'Uw apparaat kon niet worden geregistreerd.',
            },
        },
        debugConsole: {
            saveLog: 'Log opslaan',
