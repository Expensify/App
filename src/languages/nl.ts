...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            insufficientFunds: 'Testtransacties mislukt door onvoldoende saldo',
        ...
        fixBankAccount: {
            ...
            insufficientFundsBody: 'Testtransacties zijn mislukt vanwege onvoldoende saldo. Zodra er voldoende saldo is, gebruik je de knop hieronder.',
...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
    ...
    debug: {
        ...
        indicatorStatus: {
            ...
            aBankAccountFailedValidation: 'Een bankrekening is niet door de verificatie gekomen',
        },
    },
    emptySearchView: {
