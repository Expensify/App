...
${amount} voor ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        perDiem: {
            ...
            requestEmptyList: {
                title: 'Nog geen daggeldtarieven',
                subtitle: 'Deze werkruimte heeft geen daggeldtarieven, vraag je beheerder om er een paar toe te voegen.',
                adminSubtitle: 'Voeg daggeldtarieven toe om je uitgaven te organiseren.',
            },
