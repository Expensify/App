...
Hier is een *proefbon* om je te laten zien hoe het werkt:`,
    ...
    domain: {
        ...
        members: {
            ...
            forceTwoFactorAuth: 'Tweefactorauthenticatie afdwingen',
            forceTwoFactorAuthSAMLEnabledDescription: `<muted-text>Schakel <a href="${CONST.SAML_HELP_URL}">SAML</a> uit om tweefactorauthenticatie te forceren.</muted-text>`,
            forceTwoFactorAuthDescription: `<muted-text>Tweeledige verificatie vereisen voor alle leden van dit domein. Domeinleden krijgen een prompt om Tweeledige verificatie in te stellen voor hun account wanneer zij zich aanmelden.</muted-text>`,
            forceTwoFactorAuthError: 'Verplichte tweeledige verificatie kon niet worden gewijzigd. Probeer het later opnieuw.',
        },
