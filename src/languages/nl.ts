        ...
        accounting: {
            ...
            chooseReconciliationAccount: {
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `Zorg ervoor dat deze rekening overeenkomt met je centrale afrekenrekening voor facturatie (die eindigt op ${lastFourPAN}), zodat Continue Afstemming goed werkt.`,
            },
            syncCentralInvoicingSettlements: 'Centrale factureringsafrekeningen synchroniseren',
        },
        export: {
