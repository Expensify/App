...
Hier is een *proefbon* om je te laten zien hoe het werkt:`,
    ...
    domain: {
        ...
        groups: {
            ...
            RestrictExpenseWorkspaceCreation: 'Beperking van aanmaken/verwijderen van onkostenwerkruimten',
            RestrictExpenseWorkspaceCreationDescription: 'Voorkomt dat leden een onkostenwerkruimte aanmaken of zichzelf uit een onkostenwerkruimte verwijderen.',
            RestrictDefaultLoginSelection: 'Standaard inlogselectie beperken',
            RestrictDefaultLoginSelectionDescription: 'Voorkomt dat leden hun inlog-e-mail wijzigen van hun bedrijfsdomein.',
            StrictlyEnforceWorkspaceRules: 'Werkruimteregels strikt handhaven',
            StrictlyEnforceWorkspaceRulesDescription: 'Alle werkruimteregels moeten worden nageleefd voordat een rapport wordt ingediend. Geen handmatige uitzonderingen toegestaan.',
            preferredWorkspace: 'Voorkeurswerkruimte',
            preferredWorkspaceDescription: (enabled: boolean) => `Alle nieuwe rapporten en onkosten worden aangemaakt in ${enabled ? 'de geselecteerde voorkeurs' : 'deze'} werkruimte.`,
