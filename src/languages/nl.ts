...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
    ...
    /**
     * Parameter-free labels for submitted transaction violations shown in Search table columns.
     * Prefer these over `violations.*` when violation data/context is unavailable.
     */
