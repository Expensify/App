...
const translations = {
    ...
    iou: {
        ...
        holdExpense: () => ({
            one: 'Uitgave aanhouden',
            other: 'Onkosten pauzeren',
        }),
        ...
        explainHold: {one: 'Leg uit waarom je deze uitgave tegenhoudt.', other: 'Leg uit waarom je deze uitgaven tegenhoudt.'},
