...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            approvedPartnerTeamDescription: 'Een toegewijd team dat je kantoor helpt groeien, klanten sneller aan boord brengt en deskundige ondersteuning biedt.',
            partnerManagerApprovedDescription: 'Maximaliseer je partnerschap en stimuleer verwijzingen',
            accountExecutiveDescription: 'Help klanten succesvol aan de slag te gaan',
            accountManagerApprovedDescription: 'Stel vragen en ontvang klantenondersteuning',
            moreResources: 'Meer hulpbronnen',
        },
    },
    closeAccountPage: {
