...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        addCardTermsOfService: 'Servicevoorwaarden van Expensify',
        ...
        ssnFull9: 'Alle 9 cijfers van het SSN',
        ...
        acceptTermsOfService: `Ik ga akkoord met de <a href="${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}">Expensify Algemene Voorwaarden</a>`,
        remove: 'Verwijderen',
        admin: 'Beheerder',
        owner: 'Eigenaar',
...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
            ...
            requestModified: 'Dit verzoek wordt op dit moment bewerkt door een ander lid',
            ...
            invalidDateShouldBeFuture: 'Kies vandaag of een toekomstige datum alstublieft',
            invalidTimeShouldBeFuture: 'Kies een tijd die minstens één minuut later ligt',
            invalidCharacter: 'Ongeldig teken',
            enterMerchant: 'Voer een naam van een leverancier in',
            enterAmount: 'Voer een bedrag in',
            missingMerchantName: 'Ontbrekende handelsnaam',
        ...
        leaveWorkspaceConfirmation: 'Als je deze workspace verlaat, kun je geen declaraties meer indienen voor deze workspace.',
        ...
        leaveWorkspaceReimburser:
            'Je kunt deze workspace niet verlaten als vergoedende persoon. Stel eerst een nieuwe vergoedende persoon in via Workspaces > Betalingen uitvoeren of volgen en probeer het dan opnieuw.',
        ...
        nonReimbursableTotal: 'Totaal niet-vergoedbaar',
    },
    supportalNoAccess: {
        title: 'Niet zo snel',
    ...
    location: {
        ...
        please: 'Alsjeblieft',
        allowPermission: 'sta locatietoegang in bij instellingen',
        tryAgain: 'en probeer het opnieuw.',
    },
    contact: {
        importContacts: 'Contacten importeren',
        importContactsTitle: 'Importeer je contacten',
        importContactsText: 'Importeer contacten van je telefoon zodat je favoriete mensen altijd maar één tik verwijderd zijn.',
    ...
    attachmentPicker: {
        ...
        attachmentImageResized: 'Deze afbeelding is verkleind voor de preview. Download om de volledige resolutie te zien.',
        ...
        maxFileLimitExceeded: 'Je kunt tot 30 bonnetjes tegelijk uploaden. Eventuele extra’s worden niet geüpload.',
    ...
    multifactorAuthentication: {
        biometricsTest: {
            ...
            yourAttemptWasUnsuccessful: 'Je aanmeldpoging is mislukt.',
            youCouldNotBeAuthenticated: 'Je kon niet worden geauthenticeerd',
        ...
        pleaseEnableInSystemSettings: {
            start: 'Schakel gezichts-/vingerafdrukverificatie in of stel een toesteltoegangscode in op je',
        ...
        enableQuickVerification: {
            biometrics: 'Schakel snelle, veilige verificatie in met uw gezicht of vingerafdruk. Geen wachtwoorden of codes nodig.',
        },
    },
    validateCodeModal: {
    ...
    selectionList: {
        nameEmailOrPhoneNumber: 'Naam, e-mailadres of telefoonnummer',
    ...
    emptyList: {
        [CONST.IOU.TYPE.CREATE]: {
            ...
            subtitleText: 'Wil je dat je team Expensify ook gebruikt? Dien gewoon een declaratie bij hen in en wij zorgen voor de rest.',
        },
    },
    ...
    welcomeText: {
        ...
        anotherLoginPageIsOpen: 'Er is nog een aanmeldpagina geopend.',
    ...
    samlSignIn: {
        ...
        launching: 'Starten...',
        oneMoment: 'Een ogenblik terwijl we je doorverwijzen naar het single sign-onportaal van je bedrijf.',
    },
    reportActionCompose: {
        dropToUpload: 'Sleep hier om te uploaden',
        sendAttachment: 'Bijlage verzenden',
        addAttachment: 'Bijlage toevoegen',
        writeSomething: 'Typ iets...',
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryPolicyExpenseChat: (workspaceName: string, submitterDisplayName: string) =>
            `Hier zal <strong>${submitterDisplayName}</strong> onkosten indienen bij <strong>${workspaceName}</strong>. Gebruik gewoon de +-knop.`,
    ...
    reportAction: {
        ...
        harvestCreatedExpenseReport: (reportUrl: string, reportName: string) =>
            `heeft dit rapport aangemaakt om alle uitgaven van <a href="${reportUrl}">${reportName}</a> te bewaren die niet konden worden ingediend met de door jou gekozen frequentie`,
    ...
    youHaveBeenBanned: 'Opmerking: je bent verbannen van chatten in dit kanaal.',
    ...
    reportArchiveReasons: {
        ...
        [CONST.REPORT.ARCHIVE_REASON.ACCOUNT_MERGED]: ({displayName, oldDisplayName}: ReportArchiveReasonsMergedParams) =>
            `Deze chat is niet meer actief omdat ${oldDisplayName} zijn of haar account heeft samengevoegd met ${displayName}.`,
    ...
    sidebarScreen: {
        ...
        redirectToExpensifyClassicModal: {
            ...
            description: 'We zijn New Expensify nog op een paar punten aan het verfijnen om het op jouw specifieke instellingen af te stemmen. Ga in de tussentijd naar Expensify Classic.',
        },
    },
    allSettingsScreen: {
    ...
    spreadsheet: {
        ...
        importMembersSuccessfulDescription: ({added, updated}: {added: number; updated: number}) => {
            ...
            if (updated) {
                return updated > 1 ? `${updated} leden zijn bijgewerkt.` : '1 deelnemer is bijgewerkt.';
            }
        ...
        importMultiLevelTagsSuccessfulDescription: 'Labels met meerdere niveaus zijn toegevoegd.',
        ...
        importDescription: 'Kies welke velden je vanuit je spreadsheet wilt koppelen door op het dropdownmenu naast elke geïmporteerde kolom hieronder te klikken.',
        sizeNotMet: 'Bestandsgrootte moet groter zijn dan 0 bytes',
        invalidFileMessage:
            'Het bestand dat je hebt geüpload is leeg of bevat ongeldige gegevens. Zorg ervoor dat het bestand juist is opgemaakt en alle vereiste informatie bevat voordat je het opnieuw uploadt.',
    ...
    receipt: {
        ...
        desktopSubtitleSingle: `of sleep hierheen slepen`,
        ...
        alternativeMethodsTextReceipts: ({phoneNumber}: {phoneNumber: string}) => `<label-text>SMS-bonnen sturen naar ${phoneNumber} (alleen VS-nummers)</label-text>`,
        takePhoto: 'Maak een foto',
        cameraAccess: 'Cameratoegang is vereist om foto’s van bonnetjes te maken.',
        deniedCameraAccess: `De cameratoegang is nog steeds niet verleend, volg alsjeblieft <a href="${CONST.DENIED_CAMERA_ACCESS_INSTRUCTIONS_URL}">deze instructies</a>.`,
        ...
        locationAccessMessage: 'Locatietoegang helpt ons je tijdzone en valuta overal waar je heen gaat nauwkeurig te houden.',
        locationErrorTitle: 'Locatietoegang toestaan',
        locationErrorMessage: 'Locatietoegang helpt ons je tijdzone en valuta overal waar je heen gaat nauwkeurig te houden.',
    ...
    iou: {
        ...
        splitByPercentage: 'Verdelen naar percentage',
        ...
        splitExpenseOneMoreSplit: 'Geen verdelingen toegevoegd. Voeg er minstens één toe om op te slaan.',
        ...
        splitExpenseCannotBeEditedModalDescription: 'Goedgekeurde of betaalde declaraties kunnen niet worden bewerkt',
        paySomeone: ({name}: PaySomeoneParams = {}) => `Betaal ${name ?? 'iemand'}`,
        expense: 'Declaratie',
        ...
        chooseRecipient: 'Ontvang(st)er kiezen',
        createExpenseWithAmount: ({amount}: {amount: string}) => `Maak onkosten van ${amount}`,
        ...
        pendingMatchWithCreditCardDescription: 'Bon in afwachting van koppeling aan kaarttransactie. Markeer als contant om te annuleren.',
        ...
        receiptScanInProgressDescription: 'Bonnetjescan wordt uitgevoerd. Kom later terug of voer de gegevens nu in.',
        ...
        receiptStatusText: 'Alleen jij kunt deze bon zien terwijl hij wordt gescand. Kom later terug of voer nu de details in.',
        receiptScanningFailed: 'Bon scannen mislukt. Voer de gegevens handmatig in.',
        transactionPendingDescription: 'Transactie in behandeling. Het kan enkele dagen duren voordat deze is geboekt.',
        ...
        publicDomainError: 'U hebt een openbaar domein ingevoerd. Voer om verder te gaan een privédomein in.',
        expenseCount: () => {
            return {
                one: '1 uitgave',
        ...
        submitted: ({memo}: SubmittedWithMemoParams) => `ingediend${memo ? `, met de opmerking: ${memo}` : ''}`,
        automaticallySubmitted: `ingediend via <a href="${CONST.SELECT_WORKFLOWS_HELP_URL}">indiening uitstellen</a>`,
        queuedToSubmitViaDEW: 'in de wachtrij gezet om in te dienen via aangepaste goedkeuringsworkflow',
        ...
        setTheRequest: ({valueName, newValueToDisplay}: SetTheRequestParams) => `de ${valueName} in ${newValueToDisplay}`,
        ...
        basedOnMCC: ({rulesLink}: {rulesLink: string}) => (rulesLink ? `op basis van de <a href="${rulesLink}">werkruimteregels</a>` : 'op basis van werkruimte-regel'),
        ...
        error: {
            invalidCategoryLength: 'De categorienaam overschrijdt 255 tekens. Kort deze in of kies een andere categorie.',
            invalidTagLength: 'De tagnaam is langer dan 255 tekens. Maak hem korter of kies een andere tag.',
            ...
            invalidIntegerAmount: 'Voer een heel dollarbedrag in voordat u verdergaat',
            invalidTaxAmount: ({amount}: RequestAmountParams) => `Maximale belastingbedrag is ${amount}`,
            invalidSplit: 'De som van alle splitsingen moet gelijk zijn aan het totaalbedrag',
            ...
            genericUnholdExpenseFailureMessage: 'Onverwachte fout bij het verwijderen van deze uitgave uit de wachtrij. Probeer het later opnieuw.',
            ...
            duplicateWaypointsErrorMessage: 'Verwijder dubbele routepunten',
            atLeastTwoDifferentWaypoints: 'Voer minimaal twee verschillende adressen in',
            splitExpenseMultipleParticipantsErrorMessage: 'Een uitgave kan niet worden opgesplitst tussen een workspace en andere leden. Werk je selectie bij.',
            ...
            dateRangeExceedsMaxDays: `Het datumbereik mag maximaal ${CONST.IOU.SPLITS_LIMIT} dagen zijn.`,
        },
        ...
        unholdExpense: 'Vrijkomen uitgave',
        ...
        addUnreportedExpense: 'Niet-gedeclareerde uitgave toevoegen',
        ...
        emptyStateUnreportedExpenseSubtitle: 'Het lijkt erop dat je geen niet-rapporteerde uitgaven hebt. Probeer er hieronder een aan te maken.',
        addUnreportedExpenseConfirm: 'Toevoegen aan rapport',
        newReport: 'Nieuw rapport',
        explainHold: () => ({
            one: 'Leg uit waarom je deze uitgave aanhoudt.',
            other: 'Leg uit waarom je deze onkosten vasthoudt.',
        }),
        ...
        expenseOnHold: 'Deze uitgave is in de wacht gezet. Bekijk de opmerkingen voor de vervolgstappen.',
        expensesOnHold: 'Alle uitgaven zijn in de wacht gezet. Controleer de opmerkingen voor de volgende stappen.',
        ...
        confirmApprovalAllHoldAmount: () => ({
            ...
            other: 'Deze uitgaven staan in de wacht. Wil je ze toch goedkeuren?',
        }),
        ...
        confirmPayAllHoldAmount: () => ({
            ...
            other: 'Deze onkosten staan in de wacht. Wil je toch betalen?',
        }),
        ...
        unholdWhenReady: 'Haal de blokkering van onkosten wanneer je klaar bent om ze in te dienen.',
        changePolicyEducational: {
            title: 'Je hebt dit rapport verplaatst!',
            description: 'Controleer deze items extra goed; ze veranderen vaak wanneer je rapporten naar een nieuwe workspace verplaatst.',
            reCategorize: '<strong>Categoriseer onkosten opnieuw</strong> om te voldoen aan de werkruimteregels.',
        ...
        unapproveWithIntegrationWarning: ({accountingIntegration}: UnapproveWithIntegrationWarningParams) =>
            `Dit rapport is al geëxporteerd naar ${accountingIntegration}. Wijzigingen kunnen tot gegevensafwijkingen leiden. Weet je zeker dat je de goedkeuring van dit rapport wilt intrekken?`,
        reimbursable: 'declarabel',
        ...
        dates: 'Data',
        rates: 'Tarieven',
        submitsTo: ({name}: SubmitsToParams) => `Indienen bij ${name}`,
        reject: {
            ...
            heldExpenseLeftBehindTitle: 'Geblokkeerde onkosten blijven achter wanneer je een volledig rapport goedkeurt.',
            ...
            rejectedStatus: 'Deze uitgave is afgewezen. We wachten totdat jij de problemen oplost en als opgelost markeert, zodat je deze opnieuw kunt indienen.',
            reportActions: {
                rejectedExpense: 'heeft deze uitgave afgewezen',
                markedAsResolved: 'heeft de reden voor afwijzing als opgelost gemarkeerd',
            },
        },
        moveExpenses: () => ({one: 'Declaratie verplaatsen', other: 'Declaraties verplaatsen'}),
        moveExpensesError: 'Je kunt per diem-kosten niet naar rapporten in andere werkruimten verplaatsen, omdat de per diem-tarieven per werkruimte kunnen verschillen.',
        changeApprover: {
            title: 'Fiatteur wijzigen',
            header: ({workflowSettingLink}: WorkflowSettingsParam) =>
                `Kies een optie om de goedkeurder voor dit rapport te wijzigen. (Werk je <a href="${workflowSettingLink}">werkruimte-instellingen</a> bij om dit permanent voor alle rapporten te veranderen.)`,
            ...
            actions: {
                ...
                bypassApprovers: 'Approvers overslaan',
        ...
        correctDistanceRateError: 'Los het foutieve kilometerbedrag op en probeer het opnieuw.',
    },
    transactionMerge: {
        listPage: {
    ...
    loginField: {
        numberHasNotBeenValidated: 'Het nummer is nog niet gevalideerd. Klik op de knop om de validatielink opnieuw via sms te verzenden.',
        emailHasNotBeenValidated: 'Het e-mailadres is niet gevalideerd. Klik op de knop om de verificatielink opnieuw via sms te verzenden.',
    },
    ...
    nextStep: {
        message: {
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_SUBMIT]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return `Wacht tot <strong>jij</strong> onkosten indient.`;
                    case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_SUBMITTER_ACCOUNT]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return `Wacht tot <strong>jij</strong> een bankrekening toevoegt.`;
                    case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_APPROVE]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return `Wachten tot <strong>jij</strong> de onkosten goedkeurt.`;
                    case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return `Wachten tot <strong>${actor}</strong> de declaraties goedkeurt.`;
                    case CONST.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_PAY]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    ...
                    case CONST.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return `Wachten tot een beheerder de uitgaven betaalt.`;
                }
            },
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.SUBMITTING_TO_SELF]: (_: NextStepParams) =>
                `Oeps! Het lijkt erop dat je deze bij <strong>jezelf</strong> indient. Het goedkeuren van je eigen rapporten is <strong>verboden</strong> door je workspace. Dien dit rapport in bij iemand anders of neem contact op met je beheerder om de persoon te wijzigen bij wie je indient.`,
        },
        eta: {
    ...
    contacts: {
        ...
        enterMagicCode: (contactMethod: string) => `Voer de magische code in die naar ${contactMethod} is verzonden. Deze zou binnen één à twee minuten moeten aankomen.`,
        setAsDefault: 'Instellen als standaard',
        yourDefaultContactMethod:
            'Dit is je huidige standaardcontactmethode. Voordat je die kunt verwijderen, moet je een andere contactmethode kiezen en op ‘Als standaard instellen’ klikken.',
    ...
    updateRequiredView: {
        ...
        pleaseInstall: 'Werk New Expensify bij naar de meest recente versie',
        ...
        newAppNotAvailable: 'De New Expensify-app is niet langer beschikbaar.',
    },
    initialSettingsPage: {
        about: 'OverInfo',
        aboutPage: {
            description: 'De nieuwe Expensify-app is gebouwd door een community van open-sourcontwikkelaars van over de hele wereld. Help ons de toekomst van Expensify op te bouwen.',
            appDownloadLinks: 'Links om de app te downloaden',
            viewKeyboardShortcuts: 'Toetsenbord­shortcuts weergeven',
        ...
        troubleshoot: {
            ...
            profileTrace: 'Profielsleutel',
            results: 'Resultaten',
            releaseOptions: 'Vrijgaveopties',
            ...
            simulateFailingNetworkRequests: 'MISLUKTE netwerkverzoeken simuleren',
            ...
            softKillTheApp: 'Sluit de app tijdelijk af',
            kill: 'Doden',
        ...
        debugConsole: {
            saveLog: 'Log opslaan',
            shareLog: 'Log delen',
            enterCommand: 'Opdracht invoeren',
            execute: 'Uitvoeren',
            noLogsAvailable: 'Geen logboeken beschikbaar',
            logSizeTooLarge: ({size}: LogSizeParams) =>
                `Logbestandsgrootte overschrijdt de limiet van ${size} MB. Gebruik alstublieft "Log opslaan" om het logbestand in plaats daarvan te downloaden.`,
            logs: 'Logboeken',
    ...
    closeAccountPage: {
        ...
        closeAccountPermanentlyDeleteData: 'Weet je zeker dat je je account wilt verwijderen? Hierdoor worden alle openstaande uitgaven permanent verwijderd.',
        enterDefaultContactToConfirm: 'Voer je standaard contactmethode in om te bevestigen dat je je account wilt sluiten. Je standaard contactmethode is:',
    ...
    mergeAccountsPage: {
        ...
        accountValidate: {
            ...
            lossOfUnsubmittedData: ({login}: MergeAccountIntoParams) =>
                `Het samenvoegen van je accounts kan niet worden teruggedraaid en zorgt ervoor dat niet-ingediende uitgaven voor <strong>${login}</strong> verloren gaan.`,
        ...
        mergeSuccess: {
            ...
            description: ({from, to}: MergeSuccessDescriptionParams) =>
                `<muted-text><centered-text>Je hebt alle gegevens van <strong>${from}</strong> succesvol samengevoegd in <strong>${to}</strong>. Vanaf nu kun je voor deze account een van beide logins gebruiken.</centered-text></muted-text>`,
        },
        mergePendingSAML: {
            weAreWorkingOnIt: 'We werken eraan',
        ...
        mergeFailureSAMLDomainControlDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Je kunt <strong>${email}</strong> niet samenvoegen omdat deze wordt beheerd door <strong>${email.split('@').at(1) ?? ''}</strong>. Neem voor hulp <concierge-link>contact op met Concierge</concierge-link>.</centered-text></muted-text>`,
        ...
        mergeFailure2FA: {
            description: ({email}: MergeFailureDescriptionGenericParams) =>
                `<muted-text><centered-text>Je kunt accounts niet samenvoegen omdat voor <strong>${email}</strong> tweestapsverificatie (2FA) is ingeschakeld. Schakel 2FA voor <strong>${email}</strong> uit en probeer het opnieuw.</centered-text></muted-text>`,
            learnMore: 'Meer informatie over accounts samenvoegen.',
        },
        mergeFailureAccountLockedDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Je kunt <strong>${email}</strong> niet samenvoegen omdat deze is vergrendeld. Neem voor hulp contact op met <concierge-link>Concierge</concierge-link>.</centered-text></muted-text>`,
    ...
    lockAccountPage: {
        ...
        compromisedDescription:
            'Val je iets geks op aan je account? Dit melden zal je account direct vergrendelen, nieuwe Expensify Card-transacties blokkeren en alle wijzigingen aan je account voorkomen.',
        domainAdminsDescription: 'Voor domeinbeheerders: dit pauzeert ook alle Expensify Card-activiteiten en beheerdersacties in al je domeinen.',
        areYouSure: 'Weet je zeker dat je je Expensify-account wilt vergrendelen?',
        onceLocked: 'Zodra je account is vergrendeld, wordt deze beperkt in afwachting van een ontgrendelingsverzoek en een beveiligingscontrole',
    },
    failedToLockAccountPage: {
        failedToLockAccount: 'Account vergrendelen mislukt',
        failedToLockAccountDescription: `We konden je account niet vergrendelen. Chat met Concierge om dit probleem op te lossen.`,
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthEnabled: 'Verificatie in twee stappen ingeschakeld',
        whatIsTwoFactorAuth:
            'Twofactor-authenticatie (2FA) helpt je account veilig te houden. Bij het inloggen moet je een code invoeren die is gegenereerd door je voorkeurs-authenticatie-app.',
        disableTwoFactorAuth: 'Tweeledige verificatie uitschakelen',
        explainProcessToRemove: 'Om tweeledige verificatie (2FA) uit te schakelen, voer een geldige code in uit je authenticator-app.',
        explainProcessToRemoveWithRecovery: 'Om tweestapsverificatie (2FA) uit te schakelen, voer een geldige herstelsleutel in.',
        ...
        enterCode: 'Voer vervolgens de zescijferige code in die door je authenticator-app is gegenereerd.',
        stepSuccess: 'Voltooid',
        enabled: 'Verificatie in twee stappen ingeschakeld',
        congrats: 'Gefeliciteerd! Je hebt nu die extra beveiliging.',
        copy: 'Kopiëren',
        disable: 'Uitschakelen',
        enableTwoFactorAuth: 'Tweestapsverificatie inschakelen',
        pleaseEnableTwoFactorAuth: 'Schakel alsjeblieft tweeledige verificatie in.',
        ...
        twoFactorAuthIsRequiredForAdminsHeader: 'Tweestapsverificatie vereist',
    ...
    twoFactorAuthForm: {
        error: {
            pleaseFillTwoFactorAuth: 'Voer uw twee-factor-authenticatiecode in',
    ...
    privateNotes: {
        title: 'Privénotities',
        personalNoteMessage: 'Maak hier aantekeningen over deze chat. Jij bent de enige die deze aantekeningen kan toevoegen, bewerken of bekijken.',
        sharedNoteMessage: 'Noteer hier opmerkingen over deze chat. Expensify-medewerkers en andere leden met een team.expensify.com-domein kunnen deze opmerkingen bekijken.',
    ...
    walletPage: {
        ...
        setDefaultConfirmation: 'Stel in als standaardbetaalmethode',
        ...
        error: {
            ...
            setDefaultFailure: 'Er is iets misgegaan. Neem contact op met Concierge voor verdere ondersteuning.',
        },
        ...
        addPaymentMethod: 'Voeg een betaalmethode toe om betalingen rechtstreeks in de app te versturen en te ontvangen.',
        ...
        assignedCardsDescription: 'Dit zijn kaarten die zijn toegewezen door een werkruimtebeheerder om de uitgaven van het bedrijf te beheren.',
        ...
        addBankAccountBody: 'Laten we je bankrekening koppelen aan Expensify, zodat het nog makkelijker wordt om rechtstreeks in de app betalingen te versturen en te ontvangen.',
        ...
        unshareBankAccount: 'Delen bankrekening ongedaan maken',
        ...
        unshareBankAccountWarning: ({admin}: {admin?: string | null}) =>
            `${admin} verliest de toegang tot deze zakelijke bankrekening. We ronden nog steeds alle betalingen af die in behandeling zijn.`,
        reachOutForHelp: 'Het wordt gebruikt met de Expensify Card. <concierge-link>Neem contact op met Concierge</concierge-link> als je het moet ontkoppelen.',
        unshareErrorModalTitle: 'Kan bankrekening niet stopzetten met delen',
    },
    cardPage: {
        expensifyCard: 'Expensify Card',
        ...
        fixedLimit: {
            name: 'Vast limiet',
            title: ({formattedLimit}: ViolationsOverLimitParams) => `Je kunt tot ${formattedLimit} op deze kaart uitgeven, daarna wordt deze gedeactiveerd.`,
        },
        monthlyLimit: {
            name: 'Maandelijkse limiet',
            title: ({formattedLimit}: ViolationsOverLimitParams) =>
                `Je kunt per maand tot ${formattedLimit} uitgeven met deze kaart. De limiet wordt op de 1e dag van elke kalendermaand opnieuw ingesteld.`,
        },
        ...
        suspiciousBannerDescription: 'We hebben verdachte transacties op je kaart ontdekt. Tik hieronder om ze te controleren.',
        ...
        cardFraudAlert: {
            ...
            clearedMessage: ({cardLastFour}: {cardLastFour: string}) =>
                `heeft de verdachte activiteit gewist en kaart x${cardLastFour} opnieuw geactiveerd. Alles is klaar om weer uitgaven te declareren!`,
            ...
            alertMessage: ({
                ...
                merchant: string;
                date: string;
            }) => `heeft verdachte activiteit vastgesteld op de kaart die eindigt op ${cardLastFour}. Herkent u deze afschrijving?
...
${amount} voor ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        customApprovalWorkflowEnabled:
            '<muted-text-label>In deze werkruimte is een aangepast goedkeuringsproces ingeschakeld. Neem contact op met je <account-manager-link>Accountmanager</account-manager-link> of <concierge-link>Concierge</concierge-link> om dit proces te bekijken of te wijzigen.</muted-text-label>',
        customApprovalWorkflowEnabledConciergeOnly:
            '<muted-text-label>Er is een aangepast goedkeuringsproces ingeschakeld voor deze werkruimte. Neem contact op met <concierge-link>Concierge</concierge-link> om dit proces te bekijken of te wijzigen.</muted-text-label>',
        editor: {
        ...
        emptyContent: {
            ...
            approverSubtitle: 'Alle fiatteurs behoren tot een bestaand werkproces.',
        },
    },
    workflowsDelayedSubmissionPage: {
        ...
        monthlyOffsetErrorMessage: 'Maandfrequentie kon niet worden gewijzigd. Probeer het opnieuw of neem contact op met support.',
    },
    ...
    workflowsEditApprovalsPage: {
        title: 'Autorisatieworkflow bewerken',
    ...
    workflowsApproverPage: {
        ...
        description: 'Deze persoon keurt de uitgaven goed.',
    },
    workflowsApprovalLimitPage: {
        ...
        description: ({approverName}: {approverName: string}) =>
            approverName
                ? `Voeg een extra fiatteur toe wanneer <strong>${approverName}</strong> de fiatteur is en het rapport het onderstaande bedrag overschrijdt:`
    ...
    getPhysicalCard: {
        ...
        nameMessage: 'Voer je voor- en achternaam in, omdat deze op je kaart wordt getoond.',
    ...
    transferAmountPage: {
        ...
        failedTransfer: 'Uw saldo is nog niet volledig vereffend. Maak alstublieft een overschrijving naar een bankrekening.',
    ...
    paymentMethodList: {
        ...
        addFirstPaymentMethod: 'Voeg een betaalmethode toe om betalingen rechtstreeks in de app te versturen en te ontvangen.',
        defaultPaymentMethod: 'Standaard',
        bankAccountLastFour: (lastFour: string) => `Bankrekening • ${lastFour}`,
    },
    expenseRulesPage: {
        title: 'Onkostregels',
        subtitle: 'Deze regels zijn van toepassing op je declaraties. Als je deze indient bij een werkruimte, kunnen de regels van die werkruimte ze overschrijven.',
        emptyRules: {
            title: 'Je hebt nog geen regels aangemaakt',
            subtitle: 'Voeg een regel toe om onkostendeclaraties te automatiseren.',
        },
        changes: {
            billable: (value: boolean) => `Declaratie ${value ? 'factureerbaar' : 'niet-declarabel'} bijwerken`,
            category: (value: string) => `Categorie bijgewerkt naar "${value}"`,
            comment: (value: string) => `Beschrijving wijzigen in "${value}"`,
            merchant: (value: string) => `Handelaar bijwerken naar ‘${value}’`,
            reimbursable: (value: boolean) => `Uitgave ${value ? 'declarabel' : 'niet-vergoedbaar'} bijwerken`,
        ...
        addRule: {
            ...
            applyUpdates: 'Breng deze updates vervolgens toe:',
            merchantHint: 'Typ * om een regel te maken die op alle leveranciers van toepassing is',
    ...
    priorityModePage: {
        ...
        explainerText: 'Kies of je je wilt #focussen op alleen ongelezen en vastgezette chats, of alles wilt tonen met de meest recente en vastgezette chats bovenaan.',
        priorityModes: {
            default: {
                label: 'Meest recent',
    ...
    reportDescriptionPage: {
        ...
        explainerText: 'Stel een aangepaste beschrijving in voor de ruimte.',
    },
    groupChat: {
    ...
    termsOfUse: {
        ...
        license: `<muted-text-xs>Geldtransmissie wordt verzorgd door ${CONST.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS} (NMLS ID:2017010) op grond van diens <a href="${CONST.OLD_DOT_PUBLIC_URLS.LICENSES_URL}">licenties</a>.</muted-text-xs>`,
    },
    validateCodeForm: {
    ...
    passwordForm: {
        ...
        enterYourTwoFactorAuthenticationCodeToContinue: 'Voer uw tweeledige verificatiecode in om door te gaan',
    ...
    loginForm: {
        ...
        cannotGetAccountDetails: 'Kan accountgegevens niet ophalen. Probeer opnieuw in te loggen.',
    ...
    onboarding: {
        ...
        explanationModal: {
            ...
            description:
                'Eén app om je zakelijke en persoonlijke uitgaven af te handelen, zo snel als chat. Probeer het uit en laat ons weten wat je ervan vindt. Er komt nog veel meer aan!',
        ...
        workspaceYouMayJoin: ({domain, email}: WorkspaceYouMayJoin) => `Iemand van ${domain} heeft al een werkruimte gemaakt. Voer de magische code in die naar ${email} is gestuurd.`,
        joinAWorkspace: 'Lid worden van een workspace',
        listOfWorkspaces: 'Hier is de lijst met werkruimten waaraan je kunt deelnemen. Maak je geen zorgen, je kunt je er altijd later nog bij aansluiten als je dat liever hebt.',
        ...
        purpose: {
            ...
            errorContinue: 'Druk op Doorgaan om de configuratie te voltooien',
            errorBackButton: 'Beantwoord de instelvragen om de app te kunnen gebruiken',
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: 'Laat mij terugbetalen door mijn werkgever',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: 'Beheer de uitgaven van mijn team',
            [CONST.ONBOARDING_CHOICES.PERSONAL_SPEND]: 'Kosten bijhouden en budgetteren',
        ...
        accounting: {
            title: 'Gebruik je boekhoudsoftware?',
            none: 'Geen',
        },
        interestedFeatures: {
        ...
        tasks: {
            testDriveAdminTask: {
                ...
                description: ({testDriveURL}) => `[Maak een korte producttour](${testDriveURL}) om te zien waarom Expensify de snelste manier is om je uitgaven te doen.`,
            },
            ...
            addExpenseApprovalsTask: {
                ...
                description: ({workspaceMoreFeaturesLink}) =>
                    dedent(`
                        *Voeg onkostengoedkeuringen toe* om de uitgaven van je team te controleren en binnen de perken te houden.
            ...
            createTestDriveAdminWorkspaceTask: {
                ...
                description: 'Maak een workspace aan en stel de instellingen in met hulp van je implementatiespecialist!',
            },
            createWorkspaceTask: {
                title: ({workspaceSettingsLink}) => `Maak een [werkruimte](${workspaceSettingsLink})`,
                description: ({workspaceSettingsLink}) =>
                    dedent(`
                        *Maak een workspace* om uitgaven bij te houden, bonnetjes te scannen, chatberichten te sturen en meer.
                ...
                description: ({workspaceCategoriesLink}) =>
                    dedent(`
                        *Stel categorieën in* zodat je team uitgaven kan coderen voor eenvoudige rapportage.
                        ...
                        [Breng me naar de categorie-instellingen van mijn workspace](${workspaceCategoriesLink}).
            ...
            combinedTrackSubmitExpenseTask: {
                ...
                description: dedent(`
                    *Dien een uitgave in* door een bedrag in te voeren of een bon te scannen.
                    ...
                    4. Voeg het e-mailadres of telefoonnummer van je/uw leidinggevende toe.
                    5. Klik op *Maken*.
            ...
            trackExpenseTask: {
                ...
                description: dedent(`
                    *Volg een uitgave* in elke valuta, of je nu een bon hebt of niet.
                    ...
                    En klaar ben je! Ja, zo simpel is het.
                `),
            },
            addAccountingIntegrationTask: {
                title: ({integrationName, workspaceAccountingLink}) =>
                    `Verbinden${integrationName === CONST.ONBOARDING_ACCOUNTING_MAPPING.other ? '' : 'naar'} [${integrationName === CONST.ONBOARDING_ACCOUNTING_MAPPING.other ? 'je / jouw' : ''} ${integrationName}](${workspaceAccountingLink})`,
                description: ({integrationName, workspaceAccountingLink}) =>
                    dedent(`
                        Verbind ${integrationName === CONST.ONBOARDING_ACCOUNTING_MAPPING.other ? 'je / jouw' : 'naar'} ${integrationName} voor automatische kosten­codering en synchronisatie, zodat de maandafsluiting moeiteloos verloopt.
...
${
    integrationName && CONST.connectionsVideoPaths[integrationName]
                ...
                description: ({workspaceMembersLink}) =>
                    dedent(`
                        *Nodig je team uit* voor Expensify zodat ze vandaag nog kunnen beginnen met het bijhouden van uitgaven.
                        ...
                        [Breng me naar werkruimteleden](${workspaceMembersLink}).
            ...
            setupTagsTask: {
                ...
                description: ({workspaceMoreFeaturesLink}) =>
                    dedent(`
                        ...
                        6. Klik op *+ Tag toevoegen* om je eigen tags te maken.
            ...
            splitExpenseTask: {
                ...
                description: dedent(`
                    *Deel uitgaven* met één of meer personen.
                    ...
                    Voeg gerust extra details toe als je wilt, of verstuur het gewoon direct. Zo ben je zo weer terugbetaald!
                `),
            },
        ...
        testDrive: {
            name: ({testDriveURL}: {testDriveURL?: string}) => (testDriveURL ? `Maak een [testrit](${testDriveURL})` : 'Maak een testrit'),
        ...
        messages: {
            onboardingEmployerOrSubmitMessage: 'Geld terugkrijgen is net zo eenvoudig als een bericht sturen. Laten we de basis doornemen.',
            ...
            onboardingManageTeamMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) =>
                isOnboardingFlow
                    ? dedent(`
                        ...
                        👋 Hoi, ik ben je Expensify-inrichtingsspecialist. Ik heb al een workspace gemaakt om de bonnetjes en uitgaven van je team te beheren. Volg de resterende configuratiestappen hieronder om het meeste uit je gratis proefperiode van 30 dagen te halen!
                    `)
                    : dedent(`
                        # Je gratis proefperiode is gestart! Laten we aan de slag gaan.
                        👋 Hoi, ik ben je Expensify-inrichtingsspecialist. Nu je een workspace hebt aangemaakt, haal je alles uit je gratis proefperiode van 30 dagen door de onderstaande stappen te volgen!
                    `),
            onboardingTrackWorkspaceMessage:
                '# Laten we je instellen\n👋 Hoi, ik ben je Expensify-instellingsspecialist. Ik heb al een werkruimte aangemaakt om je bonnetjes en uitgaven te beheren. Volg de resterende configuratiestappen hieronder om het meeste uit je proefperiode van 30 dagen te halen!',
            onboardingChatSplitMessage: 'Rekeningen splitsen met vrienden is net zo eenvoudig als het sturen van een bericht. Zo werkt het.',
            onboardingAdminMessage: 'Leer hoe je als beheerder de werkruimte van je team beheert en je eigen uitgaven indient.',
            onboardingLookingAroundMessage:
                'Expensify staat vooral bekend om het beheren van onkosten, reizen en zakelijke kaarten, maar we doen veel meer dan dat. Laat me weten waar je in geïnteresseerd bent, dan help ik je op weg.',
        ...
        workspace: {
            ...
            subtitle: 'Ontgrendel krachtige tools om je onkostenbeheer te vereenvoudigen, allemaal op één plek. Met een werkruimte kun je:',
            explanationModal: {
                descriptionOne: 'Bonnen volgen en ordenen',
                descriptionTwo: 'Kosten categoriseren en taggen',
        ...
        confirmWorkspace: {
            ...
            subtitle: 'Maak een werkruimte om bonnetjes bij te houden, uitgaven te vergoeden, reizen te beheren, rapporten te maken en meer — allemaal op chatsnelheid.',
        },
        inviteMembers: {
    ...
    unlinkLoginForm: {
        toValidateLogin: ({primaryLogin, secondaryLogin}: ToValidateLoginParams) =>
            `Om ${secondaryLogin} te verifiëren, stuur de magische code dan opnieuw vanuit de Accountinstellingen van ${primaryLogin}.`,
        noLongerHaveAccess: ({primaryLogin}: NoLongerHaveAccessParams) => `Als je geen toegang meer hebt tot ${primaryLogin}, koppel je accounts dan los.`,
    ...
    emailDeliveryFailurePage: {
        ourEmailProvider: ({login}: OurEmailProviderParams) =>
            `Onze e-mailprovider heeft e-mails naar ${login} tijdelijk geblokkeerd vanwege afleveringsproblemen. Volg deze stappen om je login te deblokkeren:`,
        ...
        ensureYourEmailClient: `<strong>Zorg ervoor dat je e-mailclient e-mails van expensify.com toestaat.</strong> Je vindt instructies over hoe je deze stap voltooit <a href="${CONST.SET_NOTIFICATION_LINK}">hier</a>, maar mogelijk heb je je IT-afdeling nodig om je e-mailinstellingen te configureren.`,
    ...
    openAppFailureModal: {
        ...
        subtitle: `We hebben niet alle gegevens kunnen laden. We zijn hiervan op de hoogte gebracht en onderzoeken het probleem. Als dit aanhoudt, neem dan contact op met`,
        refreshAndTryAgain: 'Vernieuw en probeer het opnieuw',
    },
    smsDeliveryFailurePage: {
        smsDeliveryFailureMessage: ({login}: OurEmailProviderParams) =>
            `We kunnen geen sms-berichten bezorgen naar ${login}, daarom is deze tijdelijk geblokkeerd. Probeer je nummer opnieuw te valideren:`,
        ...
        validationFailed: ({
            ...
            return `Even geduld! Je moet ${timeText} wachten voordat je opnieuw kunt proberen je nummer te verifiëren.`;
        },
    },
    welcomeSignUpForm: {
        join: 'Meedoen',
    ...
    notFound: {
        ...
        iouReportNotFound: 'De gezochte betalingsgegevens kunnen niet worden gevonden.',
        ...
        contactConcierge: 'Neem bij vragen contact op met concierge@expensify.com',
    },
    errorPage: {
    ...
    statusPage: {
        ...
        vacationDelegate: 'Vervangende goedkeurder',
        setVacationDelegate: `Stel een vervanger in om rapporten namens jou goed te keuren terwijl je afwezig bent.`,
        vacationDelegateError: 'Er is een fout opgetreden bij het bijwerken van je vervanger voor vakanties.',
        asVacationDelegate: ({nameOrEmail}: VacationDelegateParams) => `als vakantievertegenwoordiger van ${nameOrEmail}`,
        toAsVacationDelegate: ({submittedToName, vacationDelegateName}: SubmittedToVacationDelegateParams) => `aan ${submittedToName} als vakantiemandaat voor ${vacationDelegateName}`,
        vacationDelegateWarning: ({nameOrEmail}: VacationDelegateParams) =>
            `Je wijst ${nameOrEmail} aan als je vervangende medewerker tijdens je vakantie. Diegene zit nog niet in al je werkruimtes. Als je doorgaat, wordt er een e-mail naar al je werkruimtebeheerders gestuurd om diegene toe te voegen.`,
    },
    ...
    bankAccount: {
        ...
        thisBankAccount: 'Deze bankrekening wordt gebruikt voor zakelijke betalingen in jouw workspace',
        ...
        plaidBodyCopy: 'Geef je medewerkers een eenvoudigere manier om bedrijfskosten te betalen – en terugbetaald te krijgen.',
        checkHelpLine: 'Je vindt je routingnummer en rekeningnummer op een cheque voor de rekening.',
        hasPhoneLoginError: (contactMethodRoute: string) =>
            `Om een bankrekening te koppelen, <a href="${contactMethodRoute}">voeg eerst een e-mailadres toe als je primaire login</a> en probeer het opnieuw. Je kunt je telefoonnummer als secundaire login toevoegen.`,
        ...
        error: {
            ...
            noDefaultDepositAccountOrDebitCardAvailable: 'Voeg een standaardstortingsrekening of debetkaart toe',
            ...
            sameDepositAndWithdrawalAccount: 'De stortings- en opnameaccounts zijn hetzelfde.',
        },
    },
    ...
    attachmentView: {
        unknownFilename: 'Naam bestand onbekend',
    ...
    onfidoStep: {
        acceptTerms: 'Door verder te gaan met het verzoek om uw Expensify Wallet te activeren, bevestigt u dat u het volgende hebt gelezen, begrijpt en accepteert',
        facialScan: 'Onfido’s beleid en vrijgave voor gezichts­scan',
        onfidoLinks: (onfidoTitle: string) =>
            `<muted-text-micro>${onfidoTitle} <a href='${CONST.ONFIDO_FACIAL_SCAN_POLICY_URL}'>Onfido’s beleid en vrijgave voor gezichtsherkenning</a>, <a href='${CONST.ONFIDO_PRIVACY_POLICY_URL}'>Privacybeleid</a> en <a href='${CONST.ONFIDO_TERMS_OF_SERVICE_URL}'>Servicevoorwaarden</a>.</muted-text-micro>`,
        ...
        imageNeedsBetterQuality:
            'Er is een probleem met de afbeeldingskwaliteit van je identiteitsbewijs. Upload alsjeblieft een nieuwe afbeelding waarop je volledige identiteitsbewijs duidelijk zichtbaar is.',
    ...
    additionalDetailsStep: {
        ...
        helpTextIdologyQuestions: 'We moeten je nog maar een paar vragen stellen om het verifiëren van je identiteit af te ronden.',
        ...
        needSSNFull9: 'We hebben moeite met het verifiëren van uw sofinummer. Voer alstublieft alle negen cijfers van uw sofinummer in.',
    ...
    termsStep: {
        ...
        haveReadAndAgreePlain: 'Ik heb dit gelezen en ga ermee akkoord om elektronische bekendmakingen te ontvangen.',
        ...
        noOverdraftOrCredit: 'Geen mogelijkheid tot roodstand/credit.',
        electronicFundsWithdrawal: 'Elektronische fondsenafschrijving',
        standard: 'Standaard',
        reviewTheFees: 'Bekijk enkele tarieven.',
        ...
        shortTermsForm: {
            ...
            cashReload: 'Opwaarderen met contant geld',
        ...
        longTermsForm: {
            ...
            sendingFundsDetails: 'Er zijn geen kosten verbonden aan het versturen van geld naar een andere rekeninghouder met je saldo, bankrekening of betaalpas.',
            electronicFundsStandardDetails:
                'Er zijn geen kosten verbonden aan het overmaken van geld van je Expensify Wallet naar je bankrekening met de standaardoptie. Deze overboeking is meestal binnen 1–3 werkdagen voltooid.',
            electronicFundsInstantDetails: (percentage: string, amount: string) =>
                'Er zijn kosten verbonden aan het overboeken van geld van je Expensify Wallet naar je gekoppelde debetkaart met de optie voor directe overboeking. Deze overboeking wordt meestal binnen enkele minuten afgerond.' +
                `De vergoeding is ${percentage}% van het overboekingsbedrag (met een minimumvergoeding van ${amount}).`,
            fdicInsuranceBancorp: ({amount}: TermsParams) =>
                `Uw geld komt in aanmerking voor FDIC-verzekering. Uw geld wordt aangehouden bij of overgemaakt naar ${CONST.WALLET.PROGRAM_ISSUERS.BANCORP_BANK}, een instelling die is verzekerd door de FDIC.` +
                `Zodra ze daar zijn, zijn je tegoeden tot ${amount} verzekerd door de FDIC in het geval ${CONST.WALLET.PROGRAM_ISSUERS.BANCORP_BANK} failliet gaat, mits aan specifieke voorwaarden voor depositoverzekering is voldaan en je kaart is geregistreerd. Zie ${CONST.TERMS.FDIC_PREPAID} voor meer informatie.`,
            contactExpensifyPayments: `Neem contact op met ${CONST.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS} door te bellen naar +1 833-400-0904, per e-mail via ${CONST.EMAIL.CONCIERGE} of meld je aan op ${CONST.NEW_EXPENSIFY_URL}.`,
    ...
    companyStep: {
        ...
        subtitle: 'Bijna klaar! Voor de veiligheid moeten we nog enkele gegevens bevestigen:',
    ...
    personalInfoStep: {
        ...
        dontWorry: 'Maak je geen zorgen, we doen geen enkele persoonlijke kredietcheck!',
        last4SSN: 'Laatste 4 van SSN',
        enterYourAddress: 'Wat is je adres?',
        address: 'Adres',
        letsDoubleCheck: 'Laten we nog eens controleren of alles er goed uitziet.',
        byAddingThisBankAccount: 'Door deze bankrekening toe te voegen, bevestig je dat je hebt gelezen, begrijpt en aanvaardt',
        ...
        noPersonalChecks: 'Geen zorgen, hier worden geen persoonlijke kredietchecks gedaan!',
    ...
    businessInfoStep: {
        ...
        whatsThisNumber: 'Welk nummer is dit?',
        ...
        findIncorporationType: 'Type oprichting zoeken',
        findBusinessCategory: 'Bedrijfscategorie zoeken',
        ...
        error: {
            ...
            taxIDEIN: (country: string) => {
                switch (country) {
                    ...
                    case CONST.COUNTRY.AU:
                        return 'Voer een geldig Australian Business Number (ABN) in';
                    default:
    ...
    beneficialOwnerInfoStep: {
        doYouOwn25percent: (companyName: string) => `Bent u eigenaar van 25% of meer van ${companyName}?`,
        doAnyIndividualOwn25percent: (companyName: string) => `Bezitten een of meer personen 25% of meer van ${companyName}?`,
        areThereMoreIndividualsWhoOwn25percent: (companyName: string) => `Zijn er nog andere personen die 25% of meer van ${companyName} bezitten?`,
    ...
    ownershipInfoStep: {
        ...
        doYouOwn: (companyName: string) => `Bent u eigenaar van 25% of meer van ${companyName}?`,
        doesAnyoneOwn: (companyName: string) => `Bezitten een of meer personen 25% of meer van ${companyName}?`,
        regulationsRequire: 'Volgens de regelgeving moeten wij de identiteit verifiëren van iedere persoon die meer dan 25% van het bedrijf bezit.',
        legalFirstName: 'Wettelijke voornaam',
        legalLastName: 'Wettelijke achternaam',
        ...
        whatsYourNationality: 'Wat is uw land van staatsburgerschap?',
        ...
        owners: 'Eigenaren',
        addCertified: 'Voeg een gecertificeerd organisatieschema toe dat de uiteindelijke belanghebbenden toont',
        ...
        noteEntity: 'Let op: het eigendomsdiagram van de entiteit moet ondertekend zijn door uw accountant, juridisch adviseur of notarieel worden bekrachtigd.',
        ...
        pleaseUpload: 'Upload hieronder extra documentatie om ons te helpen uw identiteit te verifiëren als directe of indirecte eigenaar van 25% of meer van de zakelijke entiteit.',
        ...
        proofOfBeneficialOwnerDescription:
            'Gelieve een ondertekende verklaring en organogram van een openbaar accountant, notaris of advocaat te verstrekken waarin het eigendom van 25% of meer van het bedrijf wordt bevestigd. Deze moet gedateerd zijn binnen de laatste drie maanden en het licentienummer van de ondertekenaar bevatten.',
        ...
        codiceFiscale: 'Codice fiscale/Belasting-ID',
        codiceFiscaleDescription:
            'Upload een video van een locatiebezoek of een opgenomen gesprek met de tekeningsbevoegde. De tekeningsbevoegde moet het volgende verstrekken: volledige naam, geboortedatum, bedrijfsnaam, registratienummer, fiscaal nummer, statutaire adres, aard van de bedrijfsactiviteiten en doel van de rekening.',
    },
    completeVerificationStep: {
        ...
        isAuthorizedToUseBankAccountError: 'Je moet een bevoegde leidinggevende zijn met machtiging om de zakelijke bankrekening te beheren',
    ...
    connectBankAccountStep: {
        ...
        descriptionCTA: 'Voer elk transactiebedrag in de velden hieronder in. Voorbeeld: 1.51.',
    ...
    signerInfoStep: {
        ...
        regulationRequiresUs: 'Vanwege regelgeving moeten we controleren of de ondertekenaar bevoegd is om deze actie namens het bedrijf uit te voeren.',
        ...
        PDSandFSG: 'PDS- en FSG-openbaarmakingsdocumenten',
        PDSandFSGDescription: dedent(`
            Onze samenwerking met Corpay maakt gebruik van een API-verbinding om te profiteren van hun uitgebreide netwerk van internationale bankpartners, waarmee Global Reimbursements in Expensify mogelijk worden gemaakt. In overeenstemming met de Australische regelgeving verstrekken wij je hierbij Corpay’s Financial Services Guide (FSG) en Product Disclosure Statement (PDS).
        ...
        `),
        pleaseUpload: 'Upload hieronder extra documenten om ons te helpen uw identiteit als directeur van het bedrijf te verifiëren.',
    ...
    agreementsStep: {
        ...
        error: {
            authorized: 'Je moet een bevoegde leidinggevende zijn met machtiging om de zakelijke bankrekening te beheren',
    ...
    docusignStep: {
        ...
        pleaseComplete:
            'Vul het ACH-incassoformulier in via de Docusign-link hieronder en upload daarna hier de ondertekende versie, zodat wij rechtstreeks geld van uw bankrekening kunnen afschrijven.',
        pleaseCompleteTheBusinessAccount: 'Rond de aanvraag voor een zakelijke rekening met automatische incasso af',
        pleaseCompleteTheDirect:
            'Rond de automatische-incassoregeling af via de Docusign-link hieronder en upload daarna de ondertekende kopie hier, zodat we rechtstreeks geld van je bankrekening kunnen afschrijven.',
        ...
        pleaseUploadTheDirect: 'Upload de machtiging voor automatische incasso en de DocuSign-handtekeningpagina',
    },
    finishStep: {
        letsFinish: 'Laten we in de chat afronden!',
        thanksFor:
            'Bedankt voor deze details. Een toegewijde supportmedewerker zal je informatie nu beoordelen. We nemen weer contact met je op als we nog iets van je nodig hebben, maar neem intussen gerust contact met ons op als je vragen hebt.',
    ...
    travel: {
        ...
        features: {
            ...
            alerts: 'Ontvang realtime meldingen als je reisplannen wijzigen',
        },
        ...
        hotelDetails: {
            ...
            cancellationPolicies: {
                ...
                partiallyRefundable: 'Gedeeltelijk restituabel',
            },
        },
        car: 'Auto',
        carDetails: {
        ...
        phoneError: ({phoneErrorMethodsRoute}: PhoneErrorRouteParams) =>
            `<rbr>Voeg alsjeblieft een werkmail toe als je primaire login via <a href="${phoneErrorMethodsRoute}">een werkmail als primaire login toevoegen</a> om reizen te boeken.</rbr>`,
        domainSelector: {
            title: 'Domein',
        ...
        domainPermissionInfo: {
            ...
            accountantInvitation: `Als je accountant bent, overweeg dan om deel te nemen aan het programma <a href="${CONST.OLD_DOT_PUBLIC_URLS.EXPENSIFY_APPROVED_PROGRAM_URL}">ExpensifyApproved! accountants</a> om reizen voor dit domein in te schakelen.`,
        },
        publicDomainError: {
            title: 'Aan de slag met Expensify Travel',
            message: `Je moet je werk-e-mailadres gebruiken (bijv. naam@bedrijf.com) met Expensify Travel, niet je persoonlijke e-mailadres (bijv. naam@gmail.com).`,
        },
        blockedFeatureModal: {
            title: 'Expensify Travel is uitgeschakeld',
            message: `Je beheerder heeft Expensify Travel uitgeschakeld. Volg het boekingsbeleid van je bedrijf voor het regelen van reizen.`,
        },
        verifyCompany: {
            ...
            conciergeMessage: ({domain}: {domain: string}) => `Reismogelijkheden inschakelen is mislukt voor domein: ${domain}. Controleer dit domein en schakel reizen in.`,
        },
        updates: {
            ...
            ticketVoided: (airlineCode: string, origin: string, destination: string, startDate: string) =>
                `Je ticket voor vlucht ${airlineCode} (${origin} → ${destination}) op ${startDate} is ongeldig gemaakt.`,
            ...
            paymentDeclined: 'Betaling voor je vluchtboeking is mislukt. Probeer het alsjeblieft opnieuw.',
            ...
            bookingUpdated: ({type}: TravelTypeParams) => `Je ${type}-boeking is bijgewerkt. Bekijk de nieuwe gegevens in de reisroute.`,
            railTicketRefund: ({origin, destination, startDate}: RailTicketParams) =>
                `Je treinticket voor ${origin} → ${destination} op ${startDate} is terugbetaald. Er wordt een tegoed verwerkt.`,
    ...
    workspace: {
        common: {
            ...
            defaultNote: `Ontvangstbewijzen die naar ${CONST.EMAIL.RECEIPTS} worden gestuurd, verschijnen in deze werkruimte.`,
            ...
            notAuthorized: `Je hebt geen toegang tot deze pagina. Als je probeert lid te worden van deze werkruimte, vraag dan de eigenaar van de werkruimte om je als lid toe te voegen. Iets anders aan de hand? Neem contact op met ${CONST.EMAIL.CONCIERGE}.`,
            ...
            workspaceName: 'Naam van workspace',
            ...
            welcomeNote: 'Gebruik Expensify om je bonnen in te dienen voor terugbetaling, bedankt!',
            subscription: 'Abonnement',
            ...
            letsDoubleCheck: 'Laten we nog eens controleren of alles er goed uitziet.',
            lineItemLevel: 'Niveau van regelniveau',
            ...
            shareNote: {
                ...
                content: ({adminsRoomLink}: WorkspaceShareNoteParams) =>
                    `Deel deze QR-code of kopieer de onderstaande link om het leden gemakkelijk te maken toegang tot je workspace aan te vragen. Alle verzoeken om lid te worden van de workspace verschijnen in de <a href="${adminsRoomLink}">${CONST.REPORT.WORKSPACE_CHAT_ROOMS.ADMINS}</a>-ruimte voor je beoordeling.`,
            },
            ...
            adminAlternateText: 'Rapporten en werkruimtesettings beheren.',
            ...
            deepDiveExpensifyCard: `<muted-text-label>Expensify Card-transacties worden automatisch geëxporteerd naar een "Expensify Card Liability Account" dat wordt aangemaakt via <a href="${CONST.DEEP_DIVE_EXPENSIFY_CARD}">onze integratie</a>.</muted-text-label>`,
        },
        receiptPartners: {
            uber: {
                subtitle: ({organizationName}: ReceiptPartnersUberSubtitleParams) =>
                    organizationName ? `Verbonden met ${organizationName}` : 'Automatiseer reis- en maaltijdbezorgkosten in uw hele organisatie.',
                ...
                takeBusinessRideMessage: 'Maak een zakelijke rit en je Uber-bonnen worden in Expensify geïmporteerd. Scheuren maar!',
                all: 'Alles',
                linked: 'Gekoppeld',
                outstanding: 'Openstaand',
                status: {
                ...
                autoRemove: 'Gedeactiveerde verwijderde werkruimteleden in Uber for Business',
                emptyContent: {
        ...
        perDiem: {
            ...
            findPerDiemRate: 'Dagvergoeding zoeken',
            areYouSureDelete: () => ({
            ...
            editDestinationSubtitle: (destination: string) => `Als u deze bestemming bijwerkt, wordt deze gewijzigd voor alle ${destination} per diem-subtarieven.`,
            editCurrencySubtitle: (destination: string) => `Het bijwerken van deze valuta zal deze wijzigen voor alle ${destination} daggeldsubtarieven.`,
        },
        qbd: {
            ...
            bankAccountDescription: 'Kies vanaf waar je cheques wilt versturen.',
            ...
            exportVendorBillDescription:
                'We maken een gespecificeerde leveranciersfactuur voor elk Expensify-rapport en voegen die toe aan de onderstaande rekening. Als deze periode is afgesloten, boeken we op de 1e van de volgende open periode.',
            ...
            accounts: {
                ...
                [CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: 'Dagboekboeking',
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}Description`]:
                    'We koppelen automatisch de naam van de handelaar op de creditcardtransactie aan eventuele overeenkomende leveranciers in QuickBooks. Als er geen leveranciers bestaan, maken we een leverancier ‘Credit Card Misc.’ aan voor de koppeling.',
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}AccountDescription`]: 'Kies vanaf waar je cheques wilt versturen.',
            ...
            setupPage: {
                ...
                body: 'Voltooi de installatie door de volgende link te openen op de computer waarop QuickBooks Desktop draait.',
                setupErrorTitle: 'Er is iets misgegaan',
                setupErrorBody: ({conciergeLink}: QBDSetupErrorBodyParams) =>
                    `<muted-text><centered-text>De verbinding met QuickBooks Desktop werkt op dit moment niet. Probeer het later opnieuw of <a href="${conciergeLink}">neem contact op met Concierge</a> als het probleem zich blijft voordoen.</centered-text></muted-text>`,
            },
            ...
            defaultVendorDescription: 'Stel een standaardleverancier in die bij het exporteren op alle creditcardtransacties wordt toegepast.',
            ...
            accountsSwitchDescription: 'Ingeschakelde categorieën zijn beschikbaar voor leden om te selecteren wanneer ze hun uitgaven aanmaken.',
            ...
            accountingMethods: {
                ...
                alternateText: {
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]: 'Declarabele onkosten worden geëxporteerd zodra ze definitief zijn goedgekeurd',
        ...
        qbo: {
            ...
            taxesJournalEntrySwitchNote: 'QuickBooks Online ondersteunt geen belastingen op journaalposten. Wijzig uw exportoptie in leveranciersfactuur of cheque.',
            exportDescription: 'Stel in hoe Expensify-gegevens worden geëxporteerd naar QuickBooks Online.',
            date: 'Exportdatum',
            exportInvoices: 'Facturen exporteren naar',
            exportExpensifyCard: 'Exporteer Expensify Card-transacties als',
            exportDate: {
            ...
            outOfPocketTaxEnabledDescription:
                'QuickBooks Online ondersteunt geen belastingen op exports van journaalposten. Omdat je belastingen hebt ingeschakeld in je workspace, is deze exportoptie niet beschikbaar.',
            outOfPocketTaxEnabledError: 'Boekingen zijn niet beschikbaar wanneer belastingen zijn ingeschakeld. Kies een andere exportoptie.',
            advancedConfig: {
                autoSyncDescription: 'Expensify wordt elke dag automatisch met QuickBooks Online gesynchroniseerd.',
                ...
                createEntitiesDescription:
                    'Expensify maakt automatisch leveranciers aan in QuickBooks Online als ze daar nog niet bestaan, en maakt automatisch klanten aan bij het exporteren van facturen.',
                ...
                qboInvoiceCollectionAccount: 'QuickBooks-incasso-rekening voor facturen',
            ...
            accounts: {
                [CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD]: 'Betaalkaart',
                ...
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: 'Dagboekboeking',
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]: 'Controleren',
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}Description`]:
                    'We koppelen automatisch de naam van de handelaar op de debitcardtransactie aan alle bijbehorende leveranciers in QuickBooks. Als er geen leveranciers bestaan, maken we een leverancier ‘Debit Card Misc.’ aan voor de koppeling.',
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}Description`]:
                    'We koppelen automatisch de naam van de handelaar op de creditcardtransactie aan eventuele overeenkomende leveranciers in QuickBooks. Als er geen leveranciers bestaan, maken we een leverancier ‘Credit Card Misc.’ aan voor de koppeling.',
                [`${CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}Description`]:
                    'We maken een gespecificeerde leveranciersfactuur voor elk Expensify-rapport met de datum van de laatste uitgave en voegen deze toe aan de onderstaande rekening. Als deze periode is afgesloten, boeken we op de 1e van de eerstvolgende open periode.',
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]: 'Kies waar u debitcardtransacties wilt exporteren.',
            ...
            exportDestinationAccountsMisconfigurationError: {
                ...
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: 'Kies een geldig rekeningnummer voor export van journaalposten',
            ...
            exportDestinationSetupAccountsInfo: {
                ...
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: 'Om journaalpostexport te gebruiken, maak een journaalrekening aan in QuickBooks Online',
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]: 'Stel een bankrekening in in QuickBooks Online om cheques te kunnen exporteren',
            },
            noAccountsFound: 'Geen accounts gevonden',
        ...
        xero: {
            ...
            customersDescription:
                'Kies of je klanten in Expensify opnieuw wilt factureren. Je Xero‑klantcontacten kunnen worden getagd aan uitgaven en worden naar Xero geëxporteerd als een verkoopfactuur.',
            ...
            purchaseBillDate: 'Factuurdatum aankoop',
        ...
        sageIntacct: {
            ...
            exportPreferredExporterSubNote: 'Zodra dit is ingesteld, ziet de voorkeurs­exporteur in zijn/haar account rapporten die klaar zijn voor export.',
            noAccountsFound: 'Geen accounts gevonden',
            noAccountsFoundDescription: `Voeg de rekening toe in Sage Intacct en synchroniseer de koppeling opnieuw`,
            ...
            syncReimbursedReportsDescription:
                'Telkens wanneer een rapport wordt betaald via Expensify ACH, wordt de bijbehorende factuurbetaling aangemaakt in de onderstaande Sage Intacct-account.',
        ...
        netsuite: {
            ...
            exportInvoices: 'Facturen exporteren naar',
            journalEntriesTaxPostingAccount: 'Boekingen grootboekrekening voor belastingboeking',
            ...
            nonReimbursableJournalPostingAccount: 'Niet-vergoedbare boekingsrekening',
            reimbursableJournalPostingAccount: 'Boekingsrekening voor terugbetaalbare posten',
            journalPostingPreference: {
                label: 'Voorkeur voor boeken van journaalposten',
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: 'Eén gespecificeerde post per rapport',
            ...
            exportDestination: {
                values: {
                    [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
                        label: 'Declaraties',
                        reimbursableDescription: 'Zakelijke uitgaven uit eigen zak worden als onkostendeclaraties naar NetSuite geëxporteerd.',
                        nonReimbursableDescription: 'Bedrijfspaskosten worden geëxporteerd als onkostendeclaraties naar NetSuite.',
                    },
                    [CONST.NETSUITE_EXPORT_DESTINATION.VENDOR_BILL]: {
                        label: 'Leveranciersfacturen',
                        reimbursableDescription: dedent(`
                            Eigen uitgaven worden geëxporteerd als rekeningen die betaalbaar zijn aan de hieronder opgegeven NetSuite-leverancier.

                            Als je voor elke kaart een specifieke leverancier wilt instellen, ga dan naar *Instellingen > Domeinen > Bedrijfskaarten*.
                        `),
                        nonReimbursableDescription: dedent(`
                            Bedrijfspaskosten worden geëxporteerd als facturen die betaalbaar zijn aan de hieronder opgegeven NetSuite-leverancier.
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        label: 'Boekingen',
                        reimbursableDescription: dedent(`
                            Uit eigen zak betaalde onkosten worden als journaalposten geëxporteerd naar de hieronder opgegeven NetSuite-rekening.
            ...
            advancedConfig: {
                ...
                approvalAccountDescription:
                    'Kies de rekening waarop transacties in NetSuite worden goedgekeurd. Als je terugbetaalde rapporten synchroniseert, is dit ook de rekening waarop betalingsopdrachten voor facturen worden aangemaakt.',
                defaultApprovalAccount: 'NetSuite-standaard',
                inviteEmployees: 'Werknemers uitnodigen en goedkeuringen instellen',
                inviteEmployeesDescription:
                    'Import NetSuite-medewerkerrecords en nodig medewerkers uit voor deze werkruimte. Uw goedkeuringsworkflow wordt standaard ingesteld op goedkeuring door de manager en kan verder worden geconfigureerd op de pagina *Leden*.',
                ...
                customFormIDDescription:
                    'Standaard maakt Expensify boekingen aan met behulp van het voorkeurstransactieformulier dat is ingesteld in NetSuite. Als alternatief kun je een specifiek transactieformulier aanwijzen dat moet worden gebruikt.',
                customFormIDReimbursable: 'Zakelijke uitgave uit eigen zak',
                customFormIDNonReimbursable: 'Bedrijfspas-uitgave',
                exportReportsTo: {
                    ...
                    values: {
                        [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE]: 'Standaardvoorkeur NetSuite',
                ...
                exportVendorBillsTo: {
                    ...
                    values: {
                        [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED_NONE]: 'Standaardvoorkeur NetSuite',
                        [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVAL_PENDING]: 'Wacht op goedkeuring',
                        [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED]: 'Goedgekeurd voor boeking',
                    },
                },
                exportJournalsTo: {
                    label: 'Niveau voor journaalpostgoedkeuring',
                    description:
                        'Zodra een journaalpost in Expensify is goedgekeurd en naar NetSuite is geëxporteerd, kun je in NetSuite vóór de boeking een extra goedkeuringsniveau instellen.',
                    values: {
                        [CONST.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED_NONE]: 'Standaardvoorkeur NetSuite',
                        [CONST.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVAL_PENDING]: 'Wacht op goedkeuring',
            ...
            tokenInput: {
                ...
                formSteps: {
                    installBundle: {
                        ...
                        description: 'Ga in NetSuite naar *Customization > SuiteBundler > Search & Install Bundles* > zoek op "Expensify" > installeer de bundle.',
                    },
                    ...
                    createAccessToken: {
                        ...
                        description:
                            'Ga in NetSuite naar *Setup > Users/Roles > Access Tokens* > maak een toegangstoken aan voor de app "Expensify" en de rol "Expensify Integration" of "Administrator".\n\n*Belangrijk:* Zorg ervoor dat je de *Token ID* en *Token Secret* van deze stap opslaat. Je hebt deze nodig voor de volgende stap.',
                    },
                    enterCredentials: {
                ...
                importCustomFields: {
                    ...
                    customSegments: {
                        ...
                        addForm: {
                            ...
                            customSegmentNameFooter: `Je vindt aangepaste segmentnamen in NetSuite op de pagina *Customizations > Links, Records & Fields > Custom Segments*.

_Voor meer gedetailleerde instructies, [bezoek onze helpsite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                            customRecordNameFooter: `Je kunt aangepaste recordnamen in NetSuite vinden door in de globale zoekopdracht “Transaction Column Field” in te voeren.
...
3. Zoek de interne ID aan de linkerzijde.
...
_Voor meer gedetailleerde instructies, [bezoek onze helppagina](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                            ...
                            customSegmentScriptIDFooter: `Je vindt script-ID’s van aangepaste segmenten in NetSuite onder:
...
_Voor meer gedetailleerde instructies, [bezoek onze help-pagina](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                    ...
                    customLists: {
                        ...
                        fields: {
                            listName: 'Naam',
                            internalID: 'Interne ID',
                            transactionFieldID: 'Veld-ID transactie',
                            mapping: 'Weergegeven als',
                        },
                        ...
                        addForm: {
                            ...
                            transactionFieldIDTitle: 'Wat is de veld-ID van de transactie?',
                            transactionFieldIDFooter: `Je kunt transactieveld-ID’s in NetSuite vinden door het volgende te doen:
...
_Voor meer gedetailleerde instructies, [bezoek onze helpsite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
                            mappingTitle: 'Hoe moet deze aangepaste lijst in Expensify worden weergegeven?',
                        },
                        errors: {
                ...
                importTypes: {
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]: {
                        ...
                        footerContent: (importField: string) =>
                            `Als u ${importField} gebruikt in NetSuite, passen we bij het exporteren naar Expense Report of Journal Entry de standaardinstelling toe die is vastgelegd op de medewerkerskaart.`,
                    },
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
                        label: 'Tags',
                        description: 'Niveau van regelniveau',
                        footerContent: (importField: string) => `${startCase(importField)} zal selecteerbaar zijn voor elke afzonderlijke uitgave op het rapport van een werknemer.`,
                    },
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
                        label: 'Rapportvelden',
                        description: 'Rapportniveau',
                        footerContent: (importField: string) => `De selectie ${startCase(importField)} wordt toegepast op alle uitgaven in het rapport van een medewerker.`,
                    },
                },
            },
        },
        intacct: {
            ...
            employeeDefaultDescription: 'De standaardafdeling van de medewerker wordt toegepast op diens uitgaven in Sage Intacct, als die bestaat.',
            displayedAsTagDescription: 'Afdeling kan worden geselecteerd voor elke afzonderlijke uitgave op het rapport van een medewerker.',
            displayedAsReportFieldDescription: 'De selectie van de afdeling wordt toegepast op alle uitgaven in het rapport van een medewerker.',
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                commercialFeedDetails: 'Vereist instellingen met uw bank. Dit wordt meestal gebruikt door grotere bedrijven en is vaak de beste optie als u in aanmerking komt.',
                commercialFeedPlaidDetails: `Vereist een koppeling met je bank, maar wij begeleiden je daarbij. Dit is meestal alleen beschikbaar voor grotere bedrijven.`,
                ...
                enableFeed: {
                    ...
                    heading:
                        'We hebben een directe koppeling met uw kaartuitgever en kunnen uw transactiegegevens snel en nauwkeurig in Expensify importeren.\n\nOm te beginnen hoeft u alleen:',
                    visa: 'We hebben wereldwijde integraties met Visa, al verschilt de beschikbaarheid per bank en kaartprogramma.\n\nOm te beginnen hoef je alleen maar:',
...
2. [Neem contact op met je bank](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP}) om te controleren of ze een commerciële feed voor je programma ondersteunen, en vraag hen deze in te schakelen.

3. *Zodra de feed is ingeschakeld en je de details hebt, ga verder naar het volgende scherm.*`,
                    gl1025: `1. Bezoek [dit hulpartikel](${CONST.COMPANY_CARDS_AMEX_COMMERCIAL_CARD_HELP}) om te weten te komen of American Express een commerciële feed kan inschakelen voor je programma.
...
2. [Neem contact op met je bank](${CONST.COMPANY_CARDS_MASTERCARD_COMMERCIAL_CARDS}) om te verifiëren dat ze een commerciële feed voor je programma ondersteunen en vraag hen deze in te schakelen.
...
3. Zodra de feed is ingeschakeld, klik hieronder op Verzenden en wij gaan ermee aan de slag om deze toe te voegen.`,
            ...
            card: 'Kaart',
            cardName: 'Kaartnaam',
            brokenConnectionError: '<rbr>De kaartfeedverbinding is verbroken. <a href="#">Log in bij uw bank</a> zodat we de verbinding opnieuw kunnen tot stand brengen.</rbr>',
        ...
        expensifyCard: {
            ...
            disclaimer:
                'De Expensify Visa® Commercial Card wordt uitgegeven door The Bancorp Bank, N.A., lid van de FDIC, op grond van een licentie van Visa U.S.A. Inc., en kan niet worden gebruikt bij alle handelaren die Visa-kaarten accepteren. Apple® en het Apple-logo® zijn handelsmerken van Apple Inc., geregistreerd in de VS en andere landen. App Store is een dienstmerk van Apple Inc. Google Play en het Google Play-logo zijn handelsmerken van Google LLC.',
            euUkDisclaimer:
                'Kaarten die worden verstrekt aan inwoners van de EER worden uitgegeven door Transact Payments Malta Limited en kaarten die worden verstrekt aan inwoners van het VK worden uitgegeven door Transact Payments Limited krachtens een licentie van Visa Europe Limited. Transact Payments Malta Limited is naar behoren gemachtigd en gereguleerd door de Malta Financial Services Authority als financiële instelling onder de Financial Institution Act 1994. Registratienummer C 91879. Transact Payments Limited is gemachtigd en gereguleerd door de Gibraltar Financial Service Commission.',
            ...
            remainingLimitDescription:
                'We houden rekening met een aantal factoren bij het berekenen van je resterende limiet: je klantduur, de zakelijke informatie die je tijdens het aanmeldproces hebt verstrekt en het beschikbare saldo op je zakelijke bankrekening. Je resterende limiet kan dagelijks fluctueren.',
            earnedCashback: 'Cashback',
            earnedCashbackDescription: 'De cashbacksaldo is gebaseerd op de afgerekende maandelijkse uitgaven met de Expensify Card in je workspace.',
            ...
            settlementAccountInfo: ({reconciliationAccountSettingsLink, accountNumber}: SettlementAccountInfoParams) =>
                `Zorg ervoor dat deze rekening overeenkomt met uw <a href="${reconciliationAccountSettingsLink}">afstemmingsrekening</a> (${accountNumber}), zodat Continue Afstemming goed werkt.`,
            settlementFrequency: 'Afwikkelingsfrequentie',
            ...
            addedShippingDetails: (assignee: string) => `${assignee} heeft verzendgegevens toegevoegd. Expensify Card wordt binnen 2-3 werkdagen geleverd.`,
            ...
            oneMoreStepDescription: 'Het lijkt erop dat we je bankrekening handmatig moeten verifiëren. Ga naar Concierge, daar staan de instructies voor je klaar.',
            gotIt: 'Begrepen',
        ...
        categories: {
            ...
            importedFromAccountingSoftware: 'De onderstaande categorieën zijn geïmporteerd vanuit jouw',
            payrollCode: 'Loonscode',
        ...
        moreFeatures: {
            ...
            spendSection: {
                title: 'Uitgaven',
                subtitle: 'Schakel functionaliteit in die helpt je team op te schalen.',
            },
            manageSection: {
                title: 'Beheren',
                subtitle: 'Voeg controles toe die helpen om uitgaven binnen budget te houden.',
            },
            earnSection: {
                title: 'Verdien',
                subtitle: 'Stroomlijn je inkomsten en laat je sneller uitbetalen.',
            },
            organizeSection: {
                title: 'Organiseren',
            ...
            travel: {
                title: 'Reizen',
                subtitle: 'Boek, beheer en reconcilieer al uw zakelijke reizen.',
                getStarted: {
                    title: 'Aan de slag met Expensify Travel',
                ...
                travelInvoicing: {
                    ...
                    centralInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            currentTravelLimitLabel: 'Huidige reiskredietlimiet',
                            settlementAccountLabel: 'Afwikkelingsrekening',
                            settlementFrequencyLabel: 'Afwikkelingsfrequentie',
                        },
                    },
                },
            },
            expensifyCard: {
                ...
                feed: {
                    ...
                    subTitle: 'Stroomlijn je zakelijke onkosten en bespaar tot 50% op je Expensify-factuur, plus:',
                    features: {
                        cashBack: 'Cashback op elke aankoop in de VS',
                        unlimited: 'Onbeperkte virtuele kaarten',
                        spend: 'Bestedingsregels en aangepaste limieten',
                    },
            ...
            companyCards: {
                ...
                unassignCardDescription: 'Het loskoppelen van deze kaart verwijdert alle transacties op conceptrapporten uit de rekening van de kaarthouder.',
                assignCard: 'Kaart toewijzen',
                ...
                error: {
                    feedNameRequired: 'Naam van kaartfeed is verplicht',
                ...
                pendingFeedDescription: `We beoordelen op dit moment je feedgegevens. Zodra dat is afgerond, nemen we contact met je op via`,
                ...
                downgradeSubTitle: `Deze workspace kan niet worden gedegradeerd omdat er meerdere kaartfeeds zijn gekoppeld (met uitzondering van Expensify Cards). <a href="#">Houd slechts één kaartfeed aan</a> om verder te gaan.`,
                noAccountsFoundDescription: (connection: string) => `Voeg de rekening toe in ${connection} en synchroniseer de verbinding opnieuw`,
                ...
                statementCloseDateTitle: 'Datum afschriftafsluiting',
                statementCloseDateDescription: 'Laat ons weten wanneer je creditcardafschrift sluit, dan maken we een bijpassend afschrift in Expensify.',
            },
            workflows: {
                title: 'Workflows',
                subtitle: 'Configureer hoe uitgaven worden goedgekeurd en betaald.',
                disableApprovalPrompt:
                    'Expensify Cards van deze workspace zijn momenteel afhankelijk van goedkeuringen om hun Smart Limits te bepalen. Pas de limiettypen van alle Expensify Cards met Smart Limits aan voordat je goedkeuringen uitschakelt.',
            },
            invoices: {
                title: 'Facturen',
                subtitle: 'Verzend en ontvang facturen.',
            },
            categories: {
                title: 'Categorieën',
                subtitle: 'Volg en beheer uitgaven.',
            },
            tags: {
                title: 'Tags',
            ...
            connections: {
                title: 'Boekhouding',
                subtitle: 'Synchroniseer uw grootboekrekeningschema en meer.',
            },
            receiptPartners: {
                title: 'Bonnetjespartners',
                subtitle: 'Import bonnen automatisch.',
            },
            connectionsWarningModal: {
                featureEnabledTitle: 'Niet zo snel...',
                featureEnabledText: 'Om deze functie in of uit te schakelen, moet je je boekhoudimportinstellingen aanpassen.',
            ...
            receiptPartnersWarningModal: {
                featureEnabledTitle: 'Koppeling met Uber verbreken',
                disconnectText: 'Om deze functie uit te schakelen, koppel eerst de koppeling met Uber for Business los.',
        ...
        reports: {
            ...
            customNameTitle: 'Standaardtitel rapport',
            ...
            customNameEmailPhoneExample: 'E-mailadres of telefoonnummer van het lid: {report:submit:from}',
        ...
        reportFields: {
            ...
            formulaAlternateText: 'Voeg een formulierformuleveld toe.',
        ...
        tags: {
            ...
            enableTags: 'Labels inschakelen',
            requireTag: 'Tag verplicht',
            requireTags: 'Labels vereisen',
            notRequireTags: 'Niet verplichten',
            disableTag: 'Tag uitschakelen',
            disableTags: 'Labels uitschakelen',
            addTag: 'Tag toevoegen',
            editTag: 'Label bewerken',
            editTags: 'Tags bewerken',
            findTag: 'Tag zoeken',
            subtitle: 'Tags voegen een meer gedetailleerde manier toe om kosten te classificeren.',
            ...
            emptyTags: {
                ...
                subtitleHTML: `<muted-text><centered-text>Voeg tags toe om projecten, locaties, afdelingen en meer bij te houden. <a href="${CONST.IMPORT_TAGS_EXPENSIFY_URL}">Meer informatie</a> over de opmaak van tagbestanden voor import.</centered-text></muted-text>`,
                subtitleWithAccounting: (accountingPageURL: string) =>
                    `<muted-text><centered-text>Uw labels worden momenteel geïmporteerd via een boekhoudkoppeling. Ga naar <a href="${accountingPageURL}">Boekhouding</a> om wijzigingen aan te brengen.</centered-text></muted-text>`,
            },
            ...
            deleteFailureMessage: 'Er is een fout opgetreden bij het verwijderen van het label, probeer het opnieuw.',
            ...
            importedFromAccountingSoftware: 'De onderstaande labels zijn geïmporteerd uit je',
            glCode: 'Grootboekcode',
            updateGLCodeFailureMessage: 'Er is een fout opgetreden bij het bijwerken van de GL-code, probeer het opnieuw.',
            tagRules: 'Tagregels',
            ...
            configureMultiLevelTags: 'Stel je lijst met labels in voor taggen op meerdere niveaus.',
            ...
            importMultiLevelTags: {
                ...
                independentTags: 'Dit zijn onafhankelijke labels',
                glAdjacentColumn: 'Er staat een GL-code in de aangrenzende kolom',
            },
            tagLevel: {
                singleLevel: 'Enkelvoudig niveau van tags',
                multiLevel: 'Labels met meerdere niveaus',
            },
            ...
            cannotDeleteOrDisableAllTags: {
                ...
                description: `Er moet minimaal één tag ingeschakeld blijven, omdat je workspace tags vereist.`,
            },
            cannotMakeAllTagsOptional: {
                title: 'Kan niet alle tags optioneel maken',
                description: `Er moet minstens één tag vereist blijven, omdat de instellingen van je workspace tags vereisen.`,
            },
            cannotMakeTagListRequired: {
                title: 'Taglijst kan niet verplicht worden gemaakt',
        ...
        taxes: {
            ...
            workspaceDefault: 'Standaardvaluta werkruimte',
            ...
            error: {
                ...
                updateTaxClaimableFailureMessage: 'Het terugvorderbare deel moet lager zijn dan het bedrag van het kilometertarief',
            },
        ...
        emptyWorkspace: {
            ...
            subtitle: 'Houd bonnetjes bij, vergoed uitgaven, beheer reizen, verstuur facturen en meer.',
        ...
        people: {
            ...
            selectAll: 'Alles selecteren',
            error: {
                genericAdd: 'Er is een probleem opgetreden bij het toevoegen van dit workspace-lid',
                cannotRemove: 'Je kunt jezelf of de workspace-eigenaar niet verwijderen',
                genericRemove: 'Er is een probleem opgetreden bij het verwijderen van dat werkruimte­lid',
            },
            ...
            workspaceMembersCount: ({count}: WorkspaceMembersCountParams) => `Totaal aantal werkruimtegrleden: ${count}`,
            importMembers: 'Leden importeren',
            removeMemberPromptApprover: ({approver, workspaceOwner}: {approver: string; workspaceOwner: string}) =>
                `Als je ${approver} uit deze workspace verwijdert, vervangen we deze persoon in de goedkeuringsworkflow door ${workspaceOwner}, de eigenaar van de workspace.`,
            removeMemberPromptPendingApproval: ({memberName}: {memberName: string}) =>
                `${memberName} heeft openstaande onkostendeclaraties om goed te keuren. Vraag hen deze goed te keuren of neem hun declaraties over voordat je hen uit de workspace verwijdert.`,
            removeMemberPromptReimburser: ({memberName}: {memberName: string}) =>
                `Je kunt ${memberName} niet uit deze werkruimte verwijderen. Stel eerst een nieuwe vergoedingsverwerker in via Workflows > Betalingen uitvoeren of volgen en probeer het dan opnieuw.`,
            removeMemberPromptExporter: ({memberName, workspaceOwner}: {memberName: string; workspaceOwner: string}) =>
                `Als je ${memberName} uit deze werkruimte verwijdert, vervangen we hen als voorkeurs­exporteur door ${workspaceOwner}, de eigenaar van de werkruimte.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                physicalCardDescription: 'Ideaal voor de frequente uitgever',
                ...
                smartLimitDescription: 'Geef tot een bepaald bedrag uit voordat goedkeuring vereist is',
                monthly: 'Maandelijks',
                ...
                giveItNameInstruction: 'Maak het uniek genoeg om het van andere kaarten te kunnen onderscheiden. Specifieke gebruikssituaties zijn nog beter!',
                cardName: 'Kaartnaam',
                letsDoubleCheck: 'Laten we voor de zekerheid controleren of alles er goed uitziet.',
                willBeReadyToUse: 'Deze kaart is onmiddellijk klaar voor gebruik.',
                willBeReadyToShip: 'Deze kaart is direct klaar om verzonden te worden.',
                cardholder: 'Kaarthouder',
                cardType: 'Kaarttype',
                limit: 'Limiet',
        ...
        accounting: {
            settings: 'instellingen',
            title: 'Verbindingen',
            subtitle: 'Verbind met je boekhoudsysteem om transacties te coderen met je rekeningschema, betalingen automatisch te matchen en je financiën synchroon te houden.',
            ...
            talkYourOnboardingSpecialist: 'Chat met je setupspecificus.',
            ...
            connectPrompt: ({connectionName}: ConnectionNameParams) =>
                `Weet je zeker dat je ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName] ?? 'deze boekhoudkundige integratie'} wilt verbinden? Dit verwijdert alle bestaande boekhoudkundige koppelingen.`,
            enterCredentials: 'Voer je inloggegevens in',
            claimOffer: {
                badgeText: 'Aanbieding beschikbaar!',
                xero: {
                    headline: 'Krijg Xero 6 maanden gratis!',
                    description: '<muted-text><centered-text>Nieuw bij Xero? Expensify-klanten krijgen 6 maanden gratis. Claim je aanbieding hieronder.</centered-text></muted-text>',
                ...
                syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                    switch (stage) {
                        ...
                        case 'netSuiteSyncTags':
                            return 'Gegevens importeren als Expensify-labels';
            ...
            exportOutOfPocket: 'Exporteer uit eigen zak betaalde onkosten als',
            ...
            reconciliationAccount: 'Rekening voor aflettering',
            continuousReconciliation: 'Doorlopende afstemming',
            saveHoursOnReconciliation:
                'Bespaar uren op de afstemming aan het einde van elke boekhoudperiode door Expensify continu de Expensify Card‑afschriften en afwikkelingen voor je te laten afstemmen.',
            enableContinuousReconciliation: (accountingAdvancedSettingsLink: string, connectionName: string) =>
                `<muted-text-label>Om Continue-afstemming in te schakelen, schakel je <a href="${accountingAdvancedSettingsLink}">automatisch synchroniseren</a> in voor ${connectionName}.</muted-text-label>`,
            chooseReconciliationAccount: {
                ...
                settlementAccountReconciliation: ({settlementAccountUrl, lastFourPAN}: SettlementAccountReconciliationParams) =>
                    `Zorg ervoor dat deze rekening overeenkomt met je <a href="${settlementAccountUrl}">Expensify Card-vereffeningsrekening</a> (eindigend op ${lastFourPAN}), zodat Continue Afstemmen goed werkt.`,
            },
        },
        export: {
            notReadyHeading: 'Niet klaar om te exporteren',
            notReadyDescription:
                'Concept- of in afwachting zijnde onkostendeclaraties kunnen niet worden geëxporteerd naar het boekhoudsysteem. Keur deze onkosten goed of betaal ze voordat je ze exporteert.',
        },
        invoices: {
            sendInvoice: 'Factuur verzenden',
            sendFrom: 'Verzenden vanuit',
        ...
        distanceRates: {
            ...
            taxFeatureNotEnabledMessage:
                '<muted-text>Belastingen moeten in de werkruimte zijn ingeschakeld om deze functie te gebruiken. Ga naar <a href="#">Meer functies</a> om dat te wijzigen.</muted-text>',
            ...
            errors: {
                rateNameRequired: 'Naam van tarief is vereist',
                existingRateName: 'Een afstandstarief met deze naam bestaat al',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            disconnectYourBankAccount: (bankName: string) =>
                `Koppel je bankrekening bij <strong>${bankName}</strong> los. Eventuele openstaande transacties voor deze rekening worden nog steeds uitgevoerd.`,
            clearProgress: 'Opnieuw beginnen wist de voortgang die je tot nu toe hebt gemaakt.',
            areYouSure: 'Weet je het zeker?',
            workspaceCurrency: 'Werkruimtevaluta',
            updateCurrencyPrompt:
                'Het lijkt erop dat de valuta van je werkruimte momenteel is ingesteld op een andere valuta dan USD. Klik hieronder op de knop om je valuta nu bij te werken naar USD.',
        ...
        changeOwner: {
            ...
            addPaymentCardPciCompliant: 'Compatibel met PCI-DSS',
...
Wil je dit bedrag (${amount}) overnemen om de facturering voor deze workspace over te nemen? Je betaalkaart wordt direct belast.`,
            ...
            subscriptionText: (usersCount: number, finalCount: number) =>
                `Door deze workspace over te nemen, wordt het jaarlijkse abonnement ervan samengevoegd met je huidige abonnement. Hierdoor wordt je abonnementsomvang vergroot met ${usersCount} leden en wordt je nieuwe abonnementsomvang ${finalCount}. Wil je doorgaan?`,
            duplicateSubscriptionTitle: 'Melding dubbele abonnementen',
            duplicateSubscriptionButtonText: 'Doorgaan',
            duplicateSubscriptionText: (
                email: string,
                workspaceName: string,
            ) => `Het lijkt erop dat je de facturering voor de werkruimtes van ${email} wilt overnemen. Om dit te doen, moet je eerst beheerder zijn van al hun werkruimtes.
...
Als je de facturering voor hun volledige abonnement wilt overnemen, vraag hen dan om je eerst als beheerder toe te voegen aan al hun werkruimtes voordat je de facturering overneemt.`,
            ...
            failedToClearBalanceTitle: 'Saldo leegmaken mislukt',
            failedToClearBalanceButtonText: 'OK',
            failedToClearBalanceText: 'We konden het saldo niet wegwerken. Probeer het later opnieuw.',
            successTitle: 'Joepie! Helemaal klaar.',
...
Weet je zeker dat je ze opnieuw wilt exporteren?`,
        ...
        upgrade: {
            reportFields: {
                title: 'Rapportvelden',
                description: `Rapportvelden laten je kopgegevens op rapportniveau opgeven, anders dan tags die betrekking hebben op de onkosten van afzonderlijke regelitems. Deze gegevens kunnen specifieke projectnamen, informatie over zakenreizen, locaties en meer omvatten.`,
            ...
            [CONST.POLICY.CONNECTIONS.NAME.NETSUITE]: {
                title: 'NetSuite',
                description: `Profiteer van geautomatiseerde synchronisatie en verminder handmatige invoer met de Expensify + NetSuite-integratie. Krijg diepgaande realtime financiële inzichten met ondersteuning voor native en aangepaste segmenten, inclusief project- en klantkoppeling.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.POLICY.CONNECTIONS.NAME.SAGE_INTACCT]: {
                title: 'Sage Intacct',
                description: `Profiteer van automatische synchronisatie en verminder handmatige invoer met de Expensify + Sage Intacct-integratie. Krijg diepgaande financiële inzichten in real time met door de gebruiker gedefinieerde dimensies, evenals onkostencodering per afdeling, klasse, locatie, klant en project (taak).`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.POLICY.CONNECTIONS.NAME.QBD]: {
                ...
                description: `Profiteer van automatische synchronisatie en verminder handmatige invoer met de Expensify + QuickBooks Desktop-integratie. Bereik maximale efficiëntie met een realtime, tweerichtingsverbinding en het coderen van uitgaven per klasse, artikel, klant en project.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.UPGRADE_FEATURE_INTRO_MAPPING.approvals.id]: {
                ...
                description: `Als je extra goedkeuringslagen wilt toevoegen – of er gewoon zeker van wilt zijn dat de grootste uitgaven een extra controle krijgen – dan ben je bij ons aan het juiste adres. Geavanceerde goedkeuringen helpen je om op elk niveau de juiste controles in te bouwen, zodat je de uitgaven van je team onder controle houdt.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            categories: {
                title: 'Categorieën',
                description: 'Categorieën helpen je om uitgaven bij te houden en te organiseren. Gebruik onze standaardcategorieën of voeg je eigen categorieën toe.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            glCodes: {
                ...
                description: `Voeg GL-codes toe aan je categorieën en labels voor eenvoudige export van onkostendeclaraties naar je boekhoud- en salarisadministratiesystemen.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            glAndPayrollCodes: {
                ...
                description: `Voeg grootboek- en loonadministratiecodes toe aan je categorieën voor eenvoudige export van uitgaven naar je boekhoud- en loonadministratiesystemen.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            taxCodes: {
                ...
                description: `Voeg belastingcodes toe aan je belastingen voor een eenvoudige export van uitgaven naar je boekhoud- en salarissystemen.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            companyCards: {
                ...
                description: `Moet je meer kaartfeeds toevoegen? Ontgrendel onbeperkt bedrijfskaarten om transacties van alle grote kaartuitgevers te synchroniseren.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            rules: {
                title: 'Regels',
                description: `Regels worden op de achtergrond uitgevoerd en houden je uitgaven onder controle, zodat jij je geen zorgen hoeft te maken over de kleinigheden.

Vraag om uitgavendetails zoals bonnen en beschrijvingen, stel limieten en standaardwaarden in en automatiseer goedkeuringen en betalingen – allemaal op één plek.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            reports: {
                title: 'Rapporten',
                description: 'Met rapporten kunt u uitgaven groeperen voor eenvoudiger opvolging en organisatie.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            multiLevelTags: {
                title: 'Labels met meerdere niveaus',
                description:
                    'Met tags op meerdere niveaus kun je uitgaven nauwkeuriger bijhouden. Wijs meerdere tags toe aan elke postregel—zoals afdeling, klant of kostenplaats—om de volledige context van elke uitgave vast te leggen. Dit maakt gedetailleerdere rapportages, goedkeuringsworkflows en accounting‑exports mogelijk.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Tags op meerdere niveaus zijn alleen beschikbaar in het Control-abonnement, vanaf <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `per lid per maand.` : `per actieve gebruiker per maand.`}</muted-text>`,
            },
            distanceRates: {
                title: 'Kilometertarieven',
                ...
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Vergoeding per afstandseenheid is beschikbaar in het Collect-abonnement, vanaf <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `per lid per maand.` : `per actieve gebruiker per maand.`}</muted-text>`,
            },
            auditor: {
                title: 'Auditor',
            ...
            commonFeatures: {
                ...
                benefits: {
                    ...
                    benefit3: 'Workflows voor goedkeuring op meerdere niveaus',
                    benefit4: 'Geavanceerde beveiligingsinstellingen',
                ...
                upgradeWorkspaceWarningForRestrictedPolicyCreationPrompt: 'Uw bedrijf heeft het maken van werkruimtes beperkt. Neem contact op met een beheerder voor hulp.',
            },
        },
        downgrade: {
            commonFeatures: {
        ...
        payAndDowngrade: {
            ...
            subscription:
                'Let op! Deze actie beëindigt je Expensify-abonnement, verwijdert deze werkruimte en verwijdert alle werkruimteleden. Als je deze werkruimte wilt behouden en alleen jezelf wilt verwijderen, laat dan eerst een andere beheerder de facturering overnemen.',
        ...
        restrictedAction: {
            ...
            workspaceOwnerWillNeedToAddOrUpdatePaymentCard: ({workspaceOwnerName}: WorkspaceOwnerWillNeedToAddOrUpdatePaymentCardParams) =>
                `Werkruimte-eigenaar ${workspaceOwnerName} moet de betalingskaart in het dossier toevoegen of bijwerken om nieuwe werkruimte-activiteit te ontgrendelen.`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                cashExpenseDefaultDescription:
                    'Kies hoe contante uitgaven moeten worden aangemaakt. Een uitgave wordt beschouwd als een contante uitgave als het geen geïmporteerde zakelijke kaarttransactie is. Dit omvat handmatig aangemaakte uitgaven, bonnen, dagvergoedingen, afstands- en tijdsgebonden uitgaven.',
                ...
                eReceipts: 'eBonnet',
                eReceiptsHint: `eReceipts worden automatisch aangemaakt [voor de meeste creditcardtransacties in USD](${CONST.DEEP_DIVE_ERECEIPTS}).`,
                attendeeTracking: 'Aanwezigen bijhouden',
                attendeeTrackingHint: 'Volg de kostprijs per persoon voor elke uitgave.',
                prohibitedDefaultDescription:
                    'Markeer alle bonnetjes waarop alcohol, gokken of andere verboden artikelen voorkomen. Declaraties met bonnetjes waarop deze posten voorkomen, moeten handmatig worden gecontroleerd.',
                prohibitedExpenses: 'Verboden uitgaven',
                alcohol: 'Alcohol',
                hotelIncidentals: 'Bijkomende hotelkosten',
                gambling: 'Gokken',
                tobacco: 'Tabak',
                adultEntertainment: 'Volwassenenentertainment',
                requireCompanyCard: 'Bedrijfspassen verplicht stellen voor alle aankopen',
            ...
            categoryRules: {
                ...
                descriptionHintDescription: (categoryName: string) =>
                    `Herinner medewerkers eraan om extra informatie te geven voor uitgaven in “${categoryName}”. Deze hint verschijnt in het beschrijvingsveld van onkostendeclaraties.`,
                ...
                expenseLimitTypes: {
                    ...
                    dailySubtitle: 'Markeer totale dagelijkse categorie-uitgaven per onkostennota.',
                },
            ...
            customRules: {
                ...
                cardSubtitle: 'Hier staat het onkostbeleid van je team, zodat iedereen precies weet wat er wel en niet wordt vergoed.',
            },
        },
        planTypePage: {
            planTypes: {
            ...
            lockedPlanDescription: ({count, annualSubscriptionEndDate}: WorkspaceLockedPlanTypeParams) => ({
                one: `Je hebt je vastgelegd op 1 actief lid in het Control-abonnement tot je jaarlijkse abonnement afloopt op ${annualSubscriptionEndDate}. Je kunt overschakelen naar een betalen-per-gebruik-abonnement en downgraden naar het Collect-abonnement vanaf ${annualSubscriptionEndDate} door automatisch verlengen uit te schakelen in`,
                other: `Je hebt je vastgelegd op ${count} actieve leden in het Control-abonnement tot je jaarlijkse abonnement afloopt op ${annualSubscriptionEndDate}. Je kunt vanaf ${annualSubscriptionEndDate} overschakelen naar een gebruiksafhankelijk abonnement en downgraden naar het Collect-abonnement door automatisch verlengen uit te schakelen in`,
            }),
    ...
    getAssistancePage: {
        ...
        scheduleACall: 'Bel een gesprek in',
    ...
    emojiPicker: {
        ...
        headers: {
            ...
            smileysAndEmotion: 'Smileys en emotie',
    ...
    newRoomPage: {
        ...
        privateDescription: 'Uitgenodigde personen voor deze ruimte kunnen deze terugvinden',
    ...
    workspaceActions: {
        ...
        deleteApprovalRule: (approverEmail: string, approverName: string, field: string, name: string) =>
            `${approverName} (${approverEmail}) verwijderd als goedkeurder voor het veld ${field} "${name}"`,
        ...
        updateCategoryMaxExpenseAmount: ({categoryName, oldAmount, newAmount}: UpdatedPolicyCategoryMaxExpenseAmountParams) => {
            ...
            if (oldAmount && !newAmount) {
                return `heeft het maximumbedrag van ${oldAmount} verwijderd uit de categorie "${categoryName}"`;
            }
        ...
        updatedDescriptionHint: ({categoryName, oldValue, newValue}: UpdatedPolicyCategoryDescriptionHintTypeParams) => {
            ...
            return !oldValue
                ? `heeft de beschrijvingstip "${newValue}" toegevoegd aan de categorie "${categoryName}"`
        ...
        updateTag: ({tagListName, newValue, tagName, updatedField, oldValue}: UpdatedPolicyTagFieldParams) => {
            ...
            return `heeft de tag "${tagName}" in de lijst "${tagListName}" bijgewerkt door een ${updatedField} van "${newValue}" toe te voegen`;
        },
        ...
        updateMonthlyOffset: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => {
            ...
            return `heeft de indieningsdatum van het maandrapport bijgewerkt naar ‘${newValue}’ (voorheen ‘${oldValue}’)`;
        },
        updateDefaultBillable: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) =>
            `heeft ‘Onkosten opnieuw doorbelasten aan klanten’ bijgewerkt naar ‘${newValue}’ (voorheen ‘${oldValue}’)`,
        ...
        changedCustomReportNameFormula: ({newValue, oldValue}: UpdatedPolicyFieldWithNewAndOldValueParams) =>
            `heeft de aangepaste rapportnaamformule gewijzigd in „${newValue}” (voorheen „${oldValue}”)`,
        ...
        removedFromApprovalWorkflow: ({submittersNames}: RemovedFromApprovalWorkflowParams) => {
            ...
            return {
                one: `heeft je verwijderd uit de goedkeuringsworkflow en uit de onkostenchats van ${joinedNames}. Eerder ingediende rapporten blijven beschikbaar voor goedkeuring in je inbox.`,
        ...
        demotedFromWorkspace: (policyName: string, oldRole: string) =>
            `heeft je rol in ${policyName} bijgewerkt van ${oldRole} naar gebruiker. Je bent verwijderd uit alle declaratiechats van indieners, behalve uit je eigen.`,
        ...
        updatedWorkspaceFrequencyAction: ({oldFrequency, newFrequency}: UpdatedPolicyFrequencyParams) =>
            `heeft de frequentie voor automatisch rapporteren bijgewerkt naar ‘${newFrequency}’ (voorheen ‘${oldFrequency}’)`,
        ...
        changedSubmitsToApprover: ({
            ...
            if (wasDefaultApprover && previousApprover) {
                ...
                text += '(vroegere standaardgoedkeurder)';
        ...
        changedSubmitsToDefault: ({
            ...
            let text = approver
                ...
                : `heeft de goedkeuringsworkflow voor ${members} gewijzigd zodat rapporten naar de standaardgoedkeurder worden gestuurd`;
            if (wasDefaultApprover && previousApprover) {
                text += `(voorheen standaardgoedkeurder ${previousApprover})`;
            } else if (wasDefaultApprover) {
                text += '(vroegere standaardgoedkeurder)';
        ...
        changedInvoiceCompanyWebsite: ({newValue, oldValue}: {newValue: string; oldValue?: string}) =>
            oldValue ? `heeft de bedrijfswebsite op de factuur gewijzigd in ‘${newValue}’ (voorheen ‘${oldValue}’)` : `stel de bedrijfswebsite op de factuur in op ‘${newValue}’`,
        changedReimburser: ({newReimburser, previousReimburser}: UpdatedPolicyReimburserParams) =>
            previousReimburser
                ? `heeft de gemachtigde betaler gewijzigd in ‘${newReimburser}’ (voorheen ‘${previousReimburser}’)`
                : `heeft de bevoegde betaler gewijzigd in ‘${newReimburser}’`,
        ...
        removedReceiptRequiredAmount: ({oldValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `verwijderde vereist bonbedrag (voorheen "${oldValue}")`,
        setMaxExpenseAmount: ({newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `stel maximumbedrag per uitgave in op "${newValue}"`,
        ...
        removedMaxExpenseAmount: ({oldValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `maximale onkostendrempel verwijderd (voorheen "${oldValue}")`,
        setMaxExpenseAge: ({newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `stel maximale onkost-leeftijd in op "${newValue}" dagen`,
    ...
    roomMembersPage: {
        ...
        roomArchived: `Het lijkt erop dat deze ruimte is gearchiveerd. Neem bij vragen contact op met ${CONST.EMAIL.CONCIERGE}.`,
        removeMembersPrompt: ({memberName}: {memberName: string}) => ({
    ...
    newTaskPage: {
        ...
        confirmError: 'Voer een titel in en selecteer een gedeelde bestemming',
    ...
    search: {
        ...
        searchResults: {
            ...
            emptyReportResults: {
                ...
                subtitle: 'Maak een rapport of maak een testrit met Expensify om meer te leren.',
            ...
            emptyPayResults: {
                ...
                subtitle: 'Gefeliciteerd! Je hebt de finishlijn gehaald.',
            },
            emptyExportResults: {
        ...
        unapprovedCash: 'Niet-goedgekeurde contante uitgave',
        ...
        exportSearchResults: {
            title: 'Export maken',
            description: 'Wow, dat zijn veel items! We bundelen ze voor je, en Concierge stuurt je binnenkort een bestand.',
        },
    ...
    reportLayout: {
        ...
        selectGroupByOption: 'Kies hoe je rapportuitgaven groepeert',
    ...
    report: {
        newReport: {
            ...
            emptyReportConfirmationPrompt: ({workspaceName}: {workspaceName: string}) =>
                `Weet je zeker dat je nog een ander rapport wilt maken in ${workspaceName}? Je kunt je lege rapporten openen in`,
        ...
        actions: {
            type: {
                ...
                changeReportPolicy: (toPolicyName: string, fromPolicyName?: string) => {
                    if (!toPolicyName) {
                        return `heeft de werkruimte ${fromPolicyName ? `(vroeger ${fromPolicyName})` : ''} gewijzigd`;
                    }
                    return `heeft de werkruimte gewijzigd in ${toPolicyName}${fromPolicyName ? `(vroeger ${fromPolicyName})` : ''}`;
                },
                ...
                exportedToIntegration: {
                    ...
                    reimburseableLink: 'privé-uitgaven',
                    nonReimbursableLink: 'bedrijfskaartuitgaven',
                    pending: (label: string) => `is dit rapport naar ${label} gaan exporteren...`,
                },
                ...
                addEmployee: (email: string, role: string) => `${email} is toegevoegd als ${role === 'member' ? 'a' : 'een'} ${role}`,
                ...
                updatedCustomField1: ({email, previousValue, newValue}: UpdatedCustomFieldParams) => {
                    if (!newValue) {
                        return `heeft aangepast veld 1 van ${email} verwijderd (voorheen ‘${previousValue}’)`;
                    }
    ...
    moderation: {
        ...
        levelThreeResult: 'Bericht uit kanaal verwijderd, anonieme waarschuwing verzonden en bericht ter beoordeling gemeld.',
    },
    ...
    teachersUnitePage: {
        teachersUnite: 'Leraren verenigt',
        joinExpensifyOrg:
            'Doe mee met Expensify.org om onrecht overal ter wereld uit te bannen. De huidige campagne “Teachers Unite” steunt onderwijzers overal door de kosten van essentiële schoolbenodigdheden te delen.',
        iKnowATeacher: 'Ik ken een leraar',
        iAmATeacher: 'Ik ben een leraar',
        getInTouch: 'Geweldig! Deel alsjeblieft hun gegevens zodat we contact met hen kunnen opnemen.',
    ...
    distance: {
        ...
        mapPending: {
            title: 'In afwachting van koppeling',
    ...
    gps: {
        ...
        disclaimer: 'Gebruik GPS om een uitgave van je rit te maken. Tik hieronder op Start om het bijhouden te beginnen.',
        error: {
            failedToStart: 'Starten van locatiebepaling mislukt.',
            failedToGetPermissions: 'Verkrijgen van vereiste locatierechten is mislukt.',
        },
        ...
        stopGpsTrackingModal: {
            ...
            prompt: 'Weet je het zeker? Hiermee beëindig je je huidige traject.',
            cancel: 'Tracking hervatten',
            confirm: 'GPS-tracking stoppen',
        },
        discardDistanceTrackingModal: {
            title: 'Afstandstracering negeren',
            prompt: 'Weet je het zeker? Hiermee wordt je huidige voortgang verwijderd en dit kan niet ongedaan worden gemaakt.',
        ...
        preciseLocationRequiredModal: {
            title: 'Exacte locatie vereist',
            prompt: 'Schakel alsjeblieft ‘precieze locatie’ in in de instellingen van je apparaat om GPS-afstandsregistratie te starten.',
        },
        desktop: {
            title: 'Volg afstand op je telefoon',
            subtitle: 'Registreer automatisch mijlen of kilometers met GPS en zet ritten direct om in uitgaven.',
    ...
    reportCardLostOrDamaged: {
        ...
        successDescription: 'Je moet het activeren zodra het over een paar werkdagen is aangekomen. In de tussentijd kun je een virtuele kaart gebruiken.',
    },
    eReceipt: {
    ...
    referralProgram: {
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
            ...
            body: 'Wil je dat je vrienden Expensify ook gebruiken? Begin gewoon een chat met hen en wij regelen de rest.',
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
            ...
            body: 'Wil je dat je team Expensify ook gebruikt? Dien gewoon een declaratie bij hen in en wij zorgen voor de rest.',
        },
    ...
    systemChatFooterMessage: {
        [CONST.INTRO_CHOICES.MANAGE_TEAM]: ({adminReportName, href}: {adminReportName: string; href: string}) =>
            `Chat met je installatie-expert in <a href="${href}">${adminReportName}</a> voor hulp`,
    ...
    violations: {
        ...
        conversionSurcharge: ({surcharge}: ViolationsConversionSurchargeParams) => `${surcharge}% opslag voor conversie toegepast`,
        ...
        invoiceMarkup: ({invoiceMarkup}: ViolationsInvoiceMarkupParams) => `Met ${invoiceMarkup}% opslag berekend`,
        ...
        overCategoryLimit: ({formattedLimit}: ViolationsOverCategoryLimitParams) => `Bedrag boven de categoriegrens van ${formattedLimit} per persoon`,
        ...
        perDayLimit: ({formattedLimit}: ViolationsPerDayLimitParams) => `Bedrag boven de categorielimiet van ${formattedLimit}/persoon per dag`,
        ...
        rter: ({brokenBankConnection, isAdmin, isTransactionOlderThan7Days, member, rterType, companyCardPageURL}: ViolationsRterParams) => {
            if (rterType === CONST.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION_530) {
                return 'Kan bon niet automatisch aan bon koppelen vanwege verbroken bankverbinding';
            }
            if (brokenBankConnection || rterType === CONST.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? `Bankkoppeling verbroken. <a href="${companyCardPageURL}">Opnieuw verbinden om bon te koppelen</a>`
                    : 'Bankverbinding verbroken. Vraag een beheerder om opnieuw te verbinden om de bon te laten overeenkomen.';
            }
        ...
        brokenConnection530Error: 'Bon in behandeling door verbroken bankverbinding',
        ...
        memberBrokenConnectionError: 'Bon blijft in behandeling vanwege een verbroken bankverbinding. Vraag een workspacebeheerder om dit op te lossen.',
        markAsCashToIgnore: 'Markeren als contant om te negeren en betaling aan te vragen.',
        smartscanFailed: ({canEdit = true}) => `Scannen van bon is mislukt.${canEdit ? 'Voer de gegevens handmatig in.' : ''}`,
        receiptGeneratedWithAI: 'Potentiële door AI gegenereerde bon',
    ...
    exitSurvey: {
        ...
        quickTip: 'Snelle tip...',
        quickTipSubTitle: 'Je kunt rechtstreeks naar Expensify Classic gaan door expensify.com te bezoeken. Maak er een bladwijzer van voor een snelle snelkoppeling!',
        ...
        benefits: {
            ...
            [CONST.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE]: 'Reizen en declareren in het tempo van chat',
        },
    ...
    subscription: {
        ...
        billingBanner: {
            policyOwnerAmountOwed: {
                title: 'Uw betaalgegevens zijn verouderd',
                subtitle: (date: string) => `Werk je betaalkaart vóór ${date} bij om al je favoriete functies te blijven gebruiken.`,
            },
            ...
            policyOwnerUnderInvoicing: {
                title: 'Uw betaalgegevens zijn verouderd',
                subtitle: (date: string) => `Uw betaling is achterstallig. Betaal uw factuur uiterlijk op ${date} om onderbreking van de dienstverlening te voorkomen.`,
            },
            ...
            billingDisputePending: {
                ...
                subtitle: (amountOwed: number, cardEnding: string) =>
                    `Je hebt de afschrijving van ${amountOwed} op de kaart die eindigt op ${cardEnding} betwist. Je account wordt vergrendeld totdat het geschil met je bank is opgelost.`,
            },
            cardAuthenticationRequired: {
                title: 'Je betaalkaart is niet volledig geverifieerd.',
            ...
            cardExpired: {
                title: 'Je kaart kon niet worden belast',
                subtitle: (amountOwed: number) => `Uw betaalpas is verlopen. Voeg een nieuwe betaalpas toe om uw openstaande saldo van ${amountOwed} te vereffenen.`,
            },
            cardExpireSoon: {
            ...
            preTrial: {
                ...
                subtitle: 'Voltooi als volgende stap <a href="#">je configuratiechecklist</a>, zodat je team kan beginnen met declareren.',
            },
            trialStarted: {
        ...
        cardSection: {
            ...
            cardInfo: (name: string, expiration: string, currency: string) => `Naam: ${name}, Verloopt op: ${expiration}, Valuta: ${currency}`,
            ...
            requestRefundModal: {
                full: 'Een terugbetaling krijgen is eenvoudig: downgrade je account vóór je volgende factureringsdatum en je ontvangt een terugbetaling. <br /> <br /> Let op: je account downgraden betekent dat je werkruimte(n) wordt/verwijderd. Deze actie kan niet ongedaan worden gemaakt, maar je kunt altijd een nieuwe werkruimte aanmaken als je van gedachten verandert.',
        ...
        yourPlan: {
            ...
            collect: {
                ...
                priceAnnual: ({lower, upper}: YourPlanPriceParams) => `Vanaf ${lower}/actief lid met de Expensify Card, ${upper}/actief lid zonder de Expensify Card.`,
                pricePayPerUse: ({lower, upper}: YourPlanPriceParams) => `Vanaf ${lower}/actief lid met de Expensify Card, ${upper}/actief lid zonder de Expensify Card.`,
                benefit1: 'Bonnetjes scannen',
                benefit2: 'Vergoedingen',
                benefit3: 'Beheer zakelijke kaarten',
            ...
            control: {
                ...
                benefit2: 'Workflows voor goedkeuring op meerdere niveaus',
        ...
        compareModal: {
            ...
            subtitle: `<muted-text>Ontgrendel de functies die je nodig hebt met het pakket dat bij je past. <a href="${CONST.PRICING}">Bekijk onze prijspagina</a> voor een volledig overzicht van de functies van elk pakket.</muted-text>`,
        },
        details: {
            ...
            headsUp:
                'Let op: als je je abonnementsomvang nu niet instelt, stellen we deze automatisch in op het aantal actieve leden in je eerste maand. Je bent dan verplicht om voor minstens dit aantal leden de komende 12 maanden te betalen. Je kunt je abonnementsomvang op elk moment verhogen, maar je kunt deze niet verlagen totdat je abonnement is afgelopen.',
        ...
        subscriptionSize: {
            ...
            eachMonth:
                'Elke maand dekt je abonnement tot het hierboven ingestelde aantal actieve leden. Telkens wanneer je de grootte van je abonnement verhoogt, start je een nieuw 12‑maandenabonnement met die nieuwe grootte.',
        ...
        subscriptionSettings: {
            ...
            summary: ({subscriptionType, subscriptionSize, autoRenew, autoIncrease}: SubscriptionSettingsSummaryParams) =>
                `Abonnementstype: ${subscriptionType}, Abonnementsomvang: ${subscriptionSize}, Automatisch verlengen: ${autoRenew}, Aantal jaarlijkse seats automatisch verhogen: ${autoIncrease}`,
            none: 'geen',
            on: 'aan',
            off: 'uit',
            annual: 'Jaarlijks',
            ...
            automaticallyIncrease:
                'Verhoog automatisch je jaarlijkse aantal seats om ruimte te maken voor actieve leden die je abonnementsomvang overschrijden. Let op: hierdoor wordt de einddatum van je jaarlijkse abonnement verlengd.',
            ...
            changesBasedOn: 'Dit verandert op basis van je Expensify Card-gebruik en de onderstaande abonnementsopties.',
        },
        requestEarlyCancellation: {
            title: 'Vroegtijdige annulering aanvragen',
            subtitle: 'Wat is de belangrijkste reden dat je om voortijdige opzegging vraagt?',
            subscriptionCanceled: {
                title: 'Abonnement opgezegd',
                subtitle: 'Je jaarabonnement is opgezegd.',
                info: 'Als je je werkruimte(s) op basis van betalen per gebruik wilt blijven gebruiken, ben je helemaal klaar.',
                preventFutureActivity: ({workspacesListRoute}: WorkspacesListRouteParams) =>
                    `Als je toekomstige activiteit en kosten wilt voorkomen, moet je je <a href="${workspacesListRoute}">werkruimte(s) verwijderen</a>. Let op: wanneer je je werkruimte(s) verwijdert, worden alle openstaande kosten in rekening gebracht die in de huidige kalendermaand zijn gemaakt.`,
            },
            requestSubmitted: {
                title: 'Verzoek ingediend',
                subtitle:
                    'Bedankt dat je hebt laten weten dat je je abonnement wilt opzeggen. We beoordelen je verzoek en nemen binnenkort contact met je op via je chat met <concierge-link>Concierge</concierge-link>.',
            },
            acknowledgement: `Door om vervroegde beëindiging te verzoeken, erken en ga ik ermee akkoord dat Expensify volgens de Expensify <a href=${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}>Servicevoorwaarden</a> of een andere toepasselijke dienstverleningsovereenkomst tussen mij en Expensify niet verplicht is om een dergelijk verzoek te honoreren en dat Expensify als enige naar eigen goeddunken beslist over de toewijzing van een dergelijk verzoek.`,
        },
    },
    feedbackSurvey: {
    ...
    delegate: {
        ...
        copilotDelegatedAccessDescription: 'Andere leden toegang geven tot je account.',
        ...
        accessLevelDescription: 'Kies hieronder een toegangsniveau. Zowel Volledige als Beperkte toegang staan copilots toe om alle gesprekken en uitgaven te bekijken.',
        roleDescription: ({role}: OptionalParam<DelegateRoleParams> = {}) => {
            switch (role) {
                ...
                case CONST.DELEGATE_ROLE.SUBMITTER:
                    return 'Sta een ander lid toe om namens jou de meeste handelingen in je account uit te voeren. Exclusief goedkeuringen, betalingen, afwijzingen en blokkeringen.';
                default:
                    return '';
            }
        },
    ...
    debug: {
        ...
        reasonVisibleInLHN: {
            ...
            hasAddWorkspaceRoomErrors: 'Heeft fouten bij het toevoegen van een werkruimtekamer',
        ...
        reasonGBR: {
            hasJoinRequest: 'Heeft join-verzoek (beheerruimte)',
            isUnreadWithMention: 'Is ongelezen met vermelding',
            isWaitingForAssigneeToCompleteAction: 'Wacht tot de toegewezene de actie voltooide',
        ...
        reasonRBR: {
            ...
            hasTransactionThreadViolations: 'Heeft schendingen van transactiedraden',
        },
        indicatorStatus: {
            ...
            theresAProblemWithAWorkspaceMember: 'Er is een probleem met een werkruimtedeelnemer',
            ...
            aContactMethodRequiresVerification: 'Een contactmethode moet worden geverifieerd',
    ...
    emptySearchView: {
        takeATestDrive: 'Maak een testrit',
    },
    migratedUserWelcomeModal: {
        title: 'Welkom bij New Expensify!',
        subtitle: 'Het bevat alles wat je zo waardeert aan onze klassieke ervaring, plus een heleboel upgrades om je leven nog makkelijker te maken:',
        confirmText: 'Laten we gaan!',
        helpText: 'Probeer demo van 2 minuten',
        features: {
            search: 'Krachtigere zoekfunctie op mobiel, web en desktop',
            concierge: 'Ingebouwde Concierge-AI om je onkostendeclaraties te automatiseren',
    ...
    scheduledCall: {
        book: {
            title: 'Bel een gesprek in',
            description: 'Kies een tijdstip dat voor jou uitkomt.',
        ...
        confirmation: {
            ...
            setupSpecialist: 'Je implementatiespecialist',
            meetingLength: 'Vergaderingsduur',
            dateTime: 'Datum en tijd',
            minutes: '30 minuten',
        },
        callScheduled: 'Oproep ingepland',
    },
    autoSubmitModal: {
        ...
        pendingExpensesTitle: 'Openstaande uitgaven zijn verplaatst',
        pendingExpensesDescription: 'Alle openstaande kaartuitgaven zijn verplaatst naar een apart rapport totdat ze zijn geboekt.',
    },
    testDrive: {
        quickAction: {
...
Hoi! Ik heb zojuist voor ons *3 maanden gratis* geregeld om Expensify uit te proberen, de snelste manier om onkosten te verwerken.
    ...
    domain: {
        ...
        verifyDomain: {
            ...
            beforeProceeding: ({domainName}: {domainName: string}) =>
                `Controleer voordat je doorgaat of <strong>${domainName}</strong> van jou is door de DNS-instellingen ervan bij te werken.`,
        ...
        samlFeatureList: {
            ...
            subtitle: ({domainName}: {domainName: string}) =>
                `<muted-text><a href="${CONST.SAML_HELP_URL}">SAML SSO</a> is een beveiligingsfunctie die je meer controle geeft over hoe leden met e-mailadressen van <strong>${domainName}</strong> inloggen bij Expensify. Om dit in te schakelen, moet je jezelf verifiëren als een geautoriseerde bedrijfsbeheerder.</muted-text>`,
        ...
        samlLogin: {
            ...
            anyMemberWillBeRequired: 'Alle leden die zijn aangemeld met een andere methode, moeten zich opnieuw verifiëren via SAML.',
            enableError: 'Kan SAML-instelling voor inschakelen niet bijwerken',
        ...
        accessRestricted: {
            ...
            subtitle: (domainName: string) => `Verifieer dat je een bevoegde bedrijfsbeheerder bent voor <strong>${domainName}</strong> als je controle nodig hebt over:`,
        ...
        admins: {
            ...
            error: {
                removeAdmin: 'Kan deze gebruiker niet als Admin verwijderen. Probeer het opnieuw.',
            ...
            resetDomainInfo: `Deze actie is <strong>definitief</strong> en de volgende gegevens worden verwijderd: <br/> <ul><li>Bedrijfspasverbindingen en alle niet-ingediende uitgaven van die passen</li> <li>SAML- en groepsinstellingen</li> </ul> Alle accounts, werkruimtes, rapporten, uitgaven en andere gegevens blijven behouden. <br/><br/>Opmerking: je kunt dit domein uit je domeinlijst verwijderen door het bijbehorende e-mailadres te verwijderen uit je <a href="#">contactmethoden</a>.`,
        },
        members: {
            title: 'Leden',
            findMember: 'Lid zoeken',
