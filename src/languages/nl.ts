...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
    ...
    violations: {
        ...
        cannotMergeDuplicates:
            'Je kunt uitgaven alleen samenvoegen in rapporten die open zijn of in afwachting van de eerste goedkeuring. Mogelijk moet je het rapport intrekken, de uitgaven samenvoegen en het daarna opnieuw indienen.',
    },
    reportViolations: {
