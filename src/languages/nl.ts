...
Voeg meer bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
    ...
    workspaceActions: {
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `vereist bedrag voor gespecificeerde bon ingesteld op "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) =>
            `heeft het vereiste bedrag voor gespecificeerde bon gewijzigd naar "${newValue}" (voorheen "${oldValue}")`,
