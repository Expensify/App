...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    deviceManagementPage: {
        ...
        description: '[nl] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[nl] Revoke',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        people: {
            ...
            configureGustoSync: '[nl] Configure Gusto sync.',
            syncWithGusto: '[nl] Sync with Gusto',
            ...
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    ...
                    case 'mergeHRSyncTitle':
                        return '[nl] Synchronizing HR Employees';
                    case 'jobDone':
                        return '[nl] Waiting for imported data to load';
                    default: {
                        return `[nl] Translation missing for stage: ${stage}`;
...
Add more spend rules to protect company cash flow.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateName: (customUnitName: string, oldValue: string, newValue: string) => `[nl] renamed the ${customUnitName} rate "${oldValue}" to "${newValue}"`,
