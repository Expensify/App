...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        cardConnectionStatus: {
            ...
            fixInCompanyCards: 'Please fix this connection in Company Cards',
            askAdminToFix: 'Please ask an admin to fix this connection',
        },
        lastSynced: ({relativeDate}: {relativeDate: string}) => `Last synced ${relativeDate}`,
