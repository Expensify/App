    ...
    iou: {
        ...
        changeApprover: {
            ...
            delegateSubmitNotOnPolicyAsOriginalManager: (_originalManager: string, delegate: string) =>
                `Dit rapport is naar jou gestuurd in plaats van naar je vervangend manager <mention-user>@${delegate}</mention-user>, omdat die geen lid is van het beleid van dit rapport`,
            ...
            delegateSubmitCannotApproveOwnReportAsOriginalManager: (_originalManager: string, delegate: string) =>
                `Dit rapport is ter goedkeuring naar jou verzonden, omdat je vervanger voor vakantie, <mention-user>@${delegate}</mention-user>, zijn of haar eigen rapporten niet kan goedkeuren`,
