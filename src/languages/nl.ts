...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
        ...
        campfire: {
            ...
            autoSyncDescription: 'Synchroniseer Campfire en Expensify automatisch, elke dag. Rapporten worden in realtime gesynchroniseerd.',
            accountingMethods: {
                label: 'Exportmethode',
                description: 'Kies wanneer je onkosten wilt exporteren.',
                values: {
            ...
            syncReimbursedReports: 'Verrekende rapporten synchroniseren',
            syncReimbursedReportsDescription: 'Wanneer een rapport via ACH wordt betaald, wordt er in deze rekening een betalingsopdracht gegenereerd.',
            billPaymentAccount: {label: 'Betaalrekening', description: 'Kies vanwaar je rekeningen wilt betalen en wij maken de betaling aan in Campfire.'},
            syncExpensifyCardSettlements: 'Expensify Kaart-afrekeningen synchroniseren',
            settlementAccount: {label: 'Expensify Kaart-verrekeningsrekening', description: 'Kies je afwikkelingsrekening en we maken de betaling aan in Campfire.'},
            syncTravelInvoicingSettlements: 'Reisfacturatie-afrekeningen synchroniseren',
            travelInvoicingSettlementAccount: {label: 'Rekening voor afwikkeling van reisfacturatie', description: 'Kies je afwikkelingsrekening en we maken de betaling aan in Campfire.'},
            travelInvoicingPayableAccount: {label: 'Te betalen rekening voor reisinvoerendekking'},
        },
        businessCentral: {
