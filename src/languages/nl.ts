...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. Gebruik de ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} knop om een factuur te verzenden.`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `. Gebruik gewoon de ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} knop.`,
