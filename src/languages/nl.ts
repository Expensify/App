...
er bestedingsregels toe om de kasstroom van het bedrijf te beschermen.`,
        ...
        recruiting: {
            ...
            filters: {
                ...
                offices: {title: 'Kantoor', optionalTitle: 'Kantoor (optioneel)', description: 'Kies de kantoorlocaties van kandidaten die je met deze workspace wilt synchroniseren'},
            },
        },
        merge: {
