...
var translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryDomainRoomPartOne: function (_a) {
            ...
            return "Deze chat is met alle Expensify-leden op het ".concat(domainRoom, " domein.");
        },
        ...
        beginningOfChatHistoryAnnounceRoomPartOne: function (_a) {
            var workspaceName = _a.workspaceName;
            return "Deze chat is met iedereen in ".concat(workspaceName, ".");
        },
    ...
    iou: {
        ...
        deletedTransaction: function (_a) {
            var amount = _a.amount, merchant = _a.merchant;
            return "verwijderde een uitgave in dit rapport, ".concat(merchant, " - ").concat(amount);
        },
        ...
        settlePersonal: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Betaal ".concat(formattedAmount, " als individu") : "Betaal als individu");
        },
        ...
        settleBusiness: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Betaal ".concat(formattedAmount, " als een bedrijf") : "Betalen als een bedrijf");
        },
        payElsewhere: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Betaal ".concat(formattedAmount, " ergens anders") : "Elders betalen");
        },
        ...
        waitingOnBankAccount: function (_a) {
            ...
            return "is begonnen met afrekenen. Betaling wordt vastgehouden totdat ".concat(submitterDisplayName, " een bankrekening toevoegt.");
        },
        ...
        paidElsewhere: function (_a) {
            ...
            return "".concat(payer ? "".concat(payer, " ") : '', " elders betaald");
        },
        paidWithExpensify: function (_a) {
            var _b = _a === void 0 ? {} : _a, payer = _b.payer;
            return "".concat(payer ? "".concat(payer, " ") : '', "betaald met Expensify");
        },
    ...
    termsOfUse: {
        ...
        phrase3: 'en',
        phrase4: 'Privacy',
        phrase5: "Geldtransmissie wordt geleverd door ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " (NMLS ID:2017010) volgens zijn"),
        phrase6: 'licenties',
    },
    validateCodeForm: {
    ...
    workspace: {
        common: {
            ...
            shareNote: {
                ...
                content: {
                    firstPart: 'Deel deze QR-code of kopieer de onderstaande link om het voor leden gemakkelijk te maken toegang tot je werkruimte aan te vragen. Alle verzoeken om lid te worden van de werkruimte verschijnen in de',
        ...
        qbd: {
            ...
            accounts: (_f = {},
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Creditcard',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Leveranciersfactuur',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Journaalboeking',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Controleren',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK, "Description")] = 'We maken een gespecificeerde cheque voor elk Expensify-rapport en sturen deze vanaf de onderstaande bankrekening.',
                ...
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = 'We maken een gespecificeerde leveranciersfactuur voor elk Expensify-rapport met de datum van de laatste uitgave en voegen deze toe aan het onderstaande account. Als deze periode is afgesloten, boeken we naar de 1e van de volgende open periode.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Kies waar u creditcardtransacties wilt exporteren.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Kies een leverancier om toe te passen op alle creditcardtransacties.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "AccountDescription")] = 'Kies waar u cheques vandaan wilt verzenden.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'Leveranciersfacturen zijn niet beschikbaar wanneer locaties zijn ingeschakeld. Kies alstublieft een andere exportoptie.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'Cheques zijn niet beschikbaar wanneer locaties zijn ingeschakeld. Kies een andere exportoptie.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'Journaalposten zijn niet beschikbaar wanneer belastingen zijn ingeschakeld. Kies een andere exportoptie.',
                _f),
        ...
        qbo: {
            ...
            accounts: (_h = {},
                _h[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD] = 'Debetkaart',
                _h[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Creditcard',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Leveranciersfactuur',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Journaalboeking',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Controleren',
                ...
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = "We zullen automatisch de naam van de handelaar op de creditcardtransactie koppelen aan eventuele overeenkomstige leveranciers in QuickBooks. Als er geen leveranciers bestaan, maken we een 'Credit Card Misc.' leverancier voor associatie aan.",
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = 'We maken een gespecificeerde leveranciersfactuur voor elk Expensify-rapport met de datum van de laatste uitgave en voegen deze toe aan het onderstaande account. Als deze periode is afgesloten, boeken we naar de 1e van de volgende open periode.',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "AccountDescription")] = 'Kies waar u debetkaarttransacties wilt exporteren.',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Kies waar u creditcardtransacties wilt exporteren.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Kies een leverancier om toe te passen op alle creditcardtransacties.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'Leveranciersfacturen zijn niet beschikbaar wanneer locaties zijn ingeschakeld. Kies alstublieft een andere exportoptie.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'Cheques zijn niet beschikbaar wanneer locaties zijn ingeschakeld. Kies een andere exportoptie.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'Journaalposten zijn niet beschikbaar wanneer belastingen zijn ingeschakeld. Kies een andere exportoptie.',
                _h),
            exportDestinationAccountsMisconfigurationError: (_j = {},
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Kies een geldig account voor de export van leveranciersfacturen',
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Kies een geldig account voor journaalpostexport',
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Kies een geldig account voor het exporteren van cheques',
                _j),
            exportDestinationSetupAccountsInfo: (_k = {},
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Om de export van leveranciersfacturen te gebruiken, stel een crediteurenrekening in QuickBooks Online in.',
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Om journal entry export te gebruiken, stel een journaalrekening in QuickBooks Online in.',
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Om cheque-export te gebruiken, stel een bankrekening in QuickBooks Online in.',
                _k),
            noAccountsFound: 'Geen accounts gevonden',
            ...
            accountingMethods: {
                ...
                values: (_l = {},
                    ...
                    _l[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Contant',
                    _l),
                alternateText: (_m = {},
                    _m[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze definitief zijn goedgekeurd.',
                    _m[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Uit eigen zak gemaakte uitgaven worden geëxporteerd wanneer ze zijn betaald.',
                    _m),
            },
        },
        workspaceList: {
        ...
        xero: {
            ...
            trackingCategoriesOptions: (_o = {},
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT] = 'Xero contact standaardinstelling',
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG] = 'Tags',
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD] = 'Rapportvelden',
                _o),
            ...
            invoiceStatus: {
                ...
                values: (_q = {},
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.DRAFT] = 'Conceptversie',
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_APPROVAL] = 'In afwachting van goedkeuring',
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_PAYMENT] = 'In afwachting van betaling',
                    _q),
            },
            noAccountsFound: 'Geen accounts gevonden',
        ...
        sageIntacct: {
            ...
            reimbursableExpenses: {
                ...
                values: (_s = {},
                    _s[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.EXPENSE_REPORT] = 'Onkostendeclaraties',
                    _s[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Leveranciersfacturen',
                    _s),
            },
            nonReimbursableExpenses: {
                description: 'Stel in hoe aankopen met bedrijfskaarten worden geëxporteerd naar Sage Intacct.',
                values: (_t = {},
                    _t[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.CREDIT_CARD_CHARGE] = 'Kredietkaarten',
                    _t[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Leveranciersfacturen',
                    _t),
            },
            creditCardAccount: 'Creditcardrekening',
        ...
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: (_u = {},
                    _u[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE] = 'Enkele, gespecificeerde invoer voor elk rapport',
                    _u[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE] = 'Enkele invoer voor elke uitgave',
                    _u),
            },
            invoiceItem: {
                label: 'Factuuritem',
            ...
            advancedConfig: {
                ...
                exportReportsTo: {
                    ...
                    values: (_y = {},
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE] = 'NetSuite standaardvoorkeur',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED] = 'Alleen door supervisor goedgekeurd',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED] = 'Alleen boekhouding goedgekeurd',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH] = 'Supervisor en boekhouding goedgekeurd',
                        _y),
                },
                accountingMethods: {
                    label: 'Wanneer exporteren',
                ...
                exportVendorBillsTo: {
                    ...
                    values: (_1 = {},
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED_NONE] = 'NetSuite standaardvoorkeur',
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVAL_PENDING] = 'In afwachting van goedkeuring',
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED] = 'Goedgekeurd voor plaatsing',
                        _1),
                },
                exportJournalsTo: {
                    ...
                    values: (_2 = {},
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED_NONE] = 'NetSuite standaardvoorkeur',
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVAL_PENDING] = 'In afwachting van goedkeuring',
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED] = 'Goedgekeurd voor plaatsing',
                        _2),
                },
                error: {
        ...
        companyCards: {
            ...
            statementCloseDate: (_4 = {},
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_DAY_OF_MONTH] = 'Laatste dag van de maand',
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_BUSINESS_DAY_OF_MONTH] = 'Laatste werkdag van de maand',
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH] = 'Aangepaste dag van de maand',
                _4),
        ...
        accounting: {
            ...
            importTypes: (_5 = {},
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.IMPORTED] = 'Geïmporteerd',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG] = 'Geïmporteerd als tags',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.DEFAULT] = 'Geïmporteerd',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NOT_IMPORTED] = 'Niet geïmporteerd',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NONE] = 'Niet geïmporteerd',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD] = 'Geïmporteerd als rapportvelden',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT] = 'NetSuite medewerker standaardwaarde',
                _5),
        ...
        upgrade: (_6 = {
            ...
            _6.upgradeToUnlock = 'Ontgrendel deze functie',
            _6.completed = {
                headline: "Je hebt je werkruimte ge\u00FCpgraded!",
                successMessage: function (_a) {
                    var policyName = _a.policyName;
                    return "Je hebt ".concat(policyName, " met succes ge\u00FCpgraded naar het Control-plan!");
                },
        ...
        rules: {
            ...
            expenseReportRules: {
                ...
                unlockFeatureEnableWorkflowsSubtitle: function (_a) {
                    ...
                    return "en workflows inschakelen, voeg vervolgens ".concat(featureName, " toe om deze functie te ontgrendelen.");
                },
                enableFeatureSubtitle: function (_a) {
                    var featureName = _a.featureName;
                    return "en schakel ".concat(featureName, " in om deze functie te ontgrendelen.");
                },
            },
            categoryRules: {
    ...
    search: {
        ...
        filters: {
            date: {
                ...
                presets: (_7 = {},
                    _7[CONST_1.default.SEARCH.DATE_PRESETS.NEVER] = 'Nooit',
                    _7[CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH] = 'Laatste maand',
                    _7),
            },
            status: 'Status',
            keyword: 'Trefwoord',
        ...
        actions: {
            type: {
                ...
                changeReportPolicy: function (_a) {
                    ...
                    return "veranderde de werkruimte naar ".concat(toPolicyName).concat(fromPolicyName ? "(vroeger ".concat(fromPolicyName, ")") : '');
                },
                ...
                delegateSubmit: function (_a) {
                    ...
                    return "heeft dit rapport naar ".concat(delegateUser, " gestuurd omdat ").concat(originalManager, " op vakantie is.");
                },
                exportedToCSV: "ge\u00EBxporteerd naar CSV",
                exportedToIntegration: {
                    automatic: function (_a) {
                        var label = _a.label;
                        return "ge\u00EBxporteerd naar ".concat(label);
                    },
    ...
    referralProgram: (_8 = {},
        ...
        _8.copyReferralLink = 'Kopieer uitnodigingslink',
        _8),
    ...
    violations: {
        ...
        autoReportedRejectedExpense: function (_a) {
            ...
            return "".concat(rejectedBy, " heeft deze uitgave afgewezen met de opmerking \"").concat(rejectReason, "\"");
        },
        ...
        receiptNotSmartScanned: 'Uitgavendetails en bon handmatig toegevoegd. Controleer de details. <a href="https://help.expensify.com/articles/expensify-classic/reports/Automatic-Receipt-Audit">Meer informatie</a> over automatische controle van alle bonnen.',
    ...
    exitSurvey: {
        ...
        reasons: (_11 = {},
            _11[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Ik heb een functie nodig die alleen beschikbaar is in Expensify Classic.',
            _11[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Ik begrijp niet hoe ik New Expensify moet gebruiken.',
            _11[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Ik begrijp hoe ik New Expensify moet gebruiken, maar ik geef de voorkeur aan Expensify Classic.',
            _11),
        prompts: (_12 = {},
            _12[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Welke functie heeft u nodig die niet beschikbaar is in New Expensify?',
            _12[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'Wat probeer je te doen?',
            _12[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Waarom geef je de voorkeur aan Expensify Classic?',
            _12),
        ...
        benefits: (_13 = {},
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY] = 'Direct chatten over onkosten en rapporten',
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE] = 'Mogelijkheid om alles op mobiel te doen',
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE] = 'Reizen en uitgaven met de snelheid van chatten',
            _13),
        ...
        billingBanner: {
            ...
            cardAuthenticationRequired: {
                ...
                subtitle: function (_a) {
                    ...
                    return "Uw betaalkaart is niet volledig geverifieerd. Voltooi het verificatieproces om uw betaalkaart met eindcijfers ".concat(cardEnding, " te activeren.");
                },
            },
            insufficientFunds: {
                title: 'Uw kaart kon niet worden belast.',
    ...
    delegate: {
        ...
        notAllowedMessageEnd: function (_a) {
            ...
            return "voor ".concat(accountOwnerEmail, ", je hebt geen toestemming om deze actie uit te voeren. Sorry!");
        },
