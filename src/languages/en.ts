...
export default {
    ...
    workspace: {
        ...
        qbo: {
            ...
            accounts: {
                [CONST.QUICKBOOKS_EXPORT_ACCOUNT_TYPE.DEBIT_CARD]: 'Debit card',
                [CONST.QUICKBOOKS_EXPORT_ACCOUNT_TYPE.CREDIT_CARD]: 'Credit card',
                ...
                [`${CONST.QUICKBOOKS_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]: 'Debit card transactions will export to the bank account below.”',
                [`${CONST.QUICKBOOKS_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}AccountDescription`]: 'Credit card transactions will export to the bank account below.',
