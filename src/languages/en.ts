...
const translations = {
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            verifying: 'Verifying',
            locked: 'Locked',
            incompleteDescription: 'Finish adding bank account',
            pendingDescription: 'Please confirm test transactions',
            verifyingDescription: "We're reviewing your documentation",
            lockedDescription: 'This account requires attention',
            finish: 'Finish',
            confirm: 'Confirm',
            unlock: 'Unlock',
        },
        cardFixConnection: 'Please fix this connection',
        cardAskAdminToFix: 'Please ask an admin to fix this connection',
        cardAdminFixConnection: 'Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `Last synced ${dateStr}`,
        assignedCards: 'Cards',
