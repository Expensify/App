...
export default {
    ...
    violations: {
        allTagLevelsRequired: 'All tag levels required',
        autoReportedRejectedExpense: 'Auto-reported rejected expense',
        billableExpense: 'Billable option no longer exists',
        cashExpenseWithNoReceipt: ({amount}: CashExpenseWithNoReceiptParams) => `Receipt required for amounts over ${amount}`,
        categoryOutOfPolicy: 'Category no longer exists',
        conversionSurcharge: ({percentGreater}: ConversionSurchargeParams) => `Amount ${percentGreater}% greater than scanned receipt`,
        customUnitOutOfPolicy: 'Custom unit out of policy',
        duplicatedTransaction: 'Duplicated transaction detected',
        fieldRequired: 'Description required for selected category',
        futureDate: 'Future date not allowed',
        invoiceMarkup: 'Invoice markup',
        maxAge: ({dayOverdue}: MaxAgeParams) => `Date older than workspace limit of ${dayOverdue} days`,
        missingCategory: 'Missing category',
        missingComment: 'Missing comment',
        missingTag: ({tagName}: MissingTagParams) => `Missing ${tagName}`,
        ...
        overCategoryLimit: 'Amount over limit for selected category',
        overLimit: ({amount}: OverLimitParams) => `Amount over workspace limit of ${amount}`,
        overLimitAttendee: 'Over limit attendee',
        perDayLimit: ({category}: PerDayLimitParams) => `Amount over daily limit for selected ${category}`,
        receiptNotSmartScanned: 'Receipt not verified via Receipt Audit. Please double check the details.',
        receiptRequired: 'Receipt required for selected category',
        rter: 'RTER',
        smartscanFailed: 'Smartscan failed',
        someTagLevelsRequired: 'Some tag levels required',
        tagOutOfPolicy: ({tagName}: MissingTagParams) => `${tagName} no longer exists`,
        taxAmountChanged: 'Tax amount was modified',
        taxOutOfPolicy: ({taxName}: TaxOutOfPolicyParams) => `${taxName} no longer exists`,
