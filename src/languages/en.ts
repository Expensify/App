...
const translations = {
  common: {
    ...
    noResultsFoundMatching: (searchString: string) =>
      `No results found matching "${searchString}"`,
    ...
    attachmentWillBeAvailableOnceBackOnline:
      "Attachment will become available once back online.",
    ...
    zipCodeExampleFormat: ({ zipSampleFormat }: ZipCodeExampleFormatParams) =>
      zipSampleFormat ? `e.g. ${zipSampleFormat}` : "",
    ...
    roleCannotBeChanged: (workflowsLinkPage: string) =>
      `Role can't be changed because this member is a <a href="${workflowsLinkPage}">payer</a> on this workspace.`,
    currency: "Currency",
    ...
    downloadFailedDescription:
      "Your download couldn't be completed. Please try again later.",
    ...
    chatWithAccountManager: (accountManagerDisplayName: string) =>
      `Need something specific? Chat with your account manager, ${accountManagerDisplayName}.`,
    chatNow: "Chat now",
  ...
  lockedAccount: {
    ...
    description:
      "You're not allowed to complete this action as this account has been locked. Please reach out to concierge@expensify.com for next steps",
  },
  location: {
  ...
  contact: {
    ...
    importContactsNativeText:
      "Just one more step! Give us the green light to import your contacts.",
  },
  ...
  attachmentPicker: {
    ...
    sizeExceededWithLimit: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Attachment size is larger than ${maxUploadSizeInMB} MB limit`,
    attachmentTooSmall: "Attachment is too small",
    sizeNotMet: "Attachment size must be greater than 240 bytes",
    wrongFileType: "Invalid file type",
    notAllowedExtension:
      "This file type is not allowed. Please try a different file type.",
    folderNotAllowedMessage:
      "Uploading a folder is not allowed. Please try a different file.",
    protectedPDFNotSupported: "Password-protected PDF is not supported",
    attachmentImageResized:
      "This image has been resized for previewing. Download for full resolution.",
    attachmentImageTooLarge:
      "This image is too large to preview before uploading.",
    imageDimensionsTooLarge:
      "Image dimensions are too large to process. Please use a smaller image.",
    ...
    sizeExceededWithValue: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Files exceeds ${maxUploadSizeInMB} MB. Please try again.`,
    someFilesCantBeUploaded: "Some files can't be uploaded",
    sizeLimitExceeded: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Files must be under ${maxUploadSizeInMB} MB. Any larger files won't be uploaded.`,
    maxFileLimitExceeded:
      "You can upload up to 30 receipts at a time. Any extras won't be uploaded.",
    unsupportedFileType: (fileType: string) =>
      `${fileType} files aren't supported. Only supported file types will be uploaded.`,
    learnMoreAboutSupportedFiles: "Learn more about supported formats.",
    passwordProtected:
      "Password-protected PDFs aren't supported. Only supported files will be uploaded.",
  },
  dropzone: {
  ...
  connectionComplete: {
    ...
    supportingText:
      "You can close this window and head back to the Expensify app.",
  },
  avatarCropModal: {
    title: "Edit photo",
  ...
  composer: {
    ...
    commentExceededMaxLength: (formattedMaxLength: string) =>
      `The maximum comment length is ${formattedMaxLength} characters.`,
    taskTitleExceededMaxLength: (formattedMaxLength: string) =>
      `The maximum task title length is ${formattedMaxLength} characters.`,
  },
  baseUpdateAppModal: {
  ...
  multifactorAuthentication: {
    reviewTransaction: {
      ...
      areYouSureToDeny:
        "Are you sure? The transaction will be denied if you close this screen.",
      ...
      youNeedToTryAgainAtMerchant:
        "This transaction was not verified, so we denied it. You'll need to try again at the merchant.",
      goBackToTheMerchant:
        "Return to the merchant site to continue the transaction.",
      transactionFailed: "Transaction failed",
      transactionCouldNotBeCompleted:
        "Your transaction could not be completed. Please try again at the merchant.",
    ...
    biometricsTest: {
      ...
      successfullyAuthenticatedUsing: ({
        ...
        `You’ve successfully authenticated using ${authType}.`,
      ...
      areYouSureToReject:
        "Are you sure? The authentication attempt will be rejected if you close this screen.",
    ...
    pleaseEnableInSystemSettings: {
      start:
        "Please enable face/fingerprint verification or set a device passcode in your ",
    ...
    looksLikeYouRanOutOfTime:
      "Looks like you ran out of time! Please try again at the merchant.",
    ...
    enableQuickVerification: {
      biometrics:
        "Enable quick, secure verification using your face or fingerprint. No passwords or codes required.",
    },
    revoke: {
      revoke: "Revoke",
      title: "Face/fingerprint & passkeys",
      explanation:
        "Face/fingerprint or passkey verification are enabled on one or more devices. Revoking access will require a magic code for the next verification on any device.",
      confirmationPrompt:
        "Are you sure? You'll need a magic code for the next verification on any device.",
      cta: "Revoke access",
      noDevices:
        "You don't have any devices registered for face/fingerprint or passkey verification. If you register any, you will be able to revoke that access here.",
      dismiss: "Got it",
  ...
  validateCodeModal: {
    ...
    expiredCodeDescription:
      "Go back to the original device and request a new code",
  ...
  customApprovalWorkflow: {
    ...
    description:
      "Your company has a custom approval workflow on this workspace. Please take this action in Expensify Classic",
  ...
  emptyList: {
    [CONST.IOU.TYPE.CREATE]: {
      ...
      subtitleText:
        "Want your team to use Expensify, too? Just submit an expense to them and we'll take care of the rest.",
    },
  },
  ...
  samlSignIn: {
    ...
    launching: "Launching...",
    oneMoment:
      "One moment while we redirect you to your company's single sign-on portal.",
  },
  reportActionCompose: {
  ...
  reportActionsView: {
    ...
    askConcierge:
      "This is your chat with Concierge, your personal AI agent. I can do almost anything, try me!",
  ...
  reportArchiveReasons: {
    ...
    [CONST.REPORT.ARCHIVE_REASON.ACCOUNT_CLOSED]: ({
      ...
      `This chat is no longer active because ${displayName} closed their account.`,
  ...
  homePage: {
    ...
    timeSensitiveSection: {
      ...
      fixCompanyCardConnection: {
        title: ({ feedName }: { feedName: string }) =>
          feedName
            ? `Fix ${feedName} company card connection`
            : "Fix company card connection",
      ...
      fixPersonalCardConnection: {
        title: ({ cardName }: { cardName?: string }) =>
          cardName
            ? `Fix ${cardName} personal card connection`
            : "Fix personal card connection",
        subtitle: "Wallet",
      },
      fixAccountingConnection: {
        title: ({ integrationName }: { integrationName: string }) =>
          `Fix ${integrationName} connection`,
        defaultSubtitle: "Workspace",
        subtitle: ({ policyName }: { policyName: string }) => policyName,
      },
      addShippingAddress: {
      ...
      reviewCardFraud: {
        ...
        titleWithDetails: ({
          ...
          amount: string;
          merchant: string;
        }) => `Review ${amount} in potential fraud at ${merchant}`,
    ...
    discoverSection: {
      ...
      menuItemTitleAdmin:
        "Learn how to invite members, edit approval workflows, and reconcile company cards.",
      menuItemDescription: "See what Expensify can do in 2 min",
    },
    forYouSection: {
      submit: ({ count }: { count: number }) =>
        `Submit ${count} ${count === 1 ? "report" : "reports"}`,
      approve: ({ count }: { count: number }) =>
        `Approve ${count} ${count === 1 ? "report" : "reports"}`,
      pay: ({ count }: { count: number }) =>
        `Pay ${count} ${count === 1 ? "report" : "reports"}`,
      export: ({ count }: { count: number }) =>
        `Export ${count} ${count === 1 ? "report" : "reports"}`,
      begin: "Begin",
      emptyStateMessages: {
        thumbsUpStarsTitle: "You're done!",
        thumbsUpStarsDescription:
          "Thumbs up to you, stay tuned for more tasks.",
        ...
        cowboyHatDescription:
          "All tasks are wrangled, keep an eye out for more.",
        ...
        conciergeBotDescription:
          "Beep boop beep boop, check back for more tasks!",
        ...
        sunglassesDescription:
          "Time to chill, though stay tuned for what's next!",
  ...
  spreadsheet: {
    ...
    dragAndDrop:
      "<muted-link>Drag and drop your spreadsheet here, or choose a file below. Supported formats: .csv, .txt, .xls, and .xlsx.</muted-link>",
    ...
    chooseSpreadsheet:
      "<muted-link>Select a spreadsheet file to import. Supported formats: .csv, .txt, .xls, and .xlsx.</muted-link>",
    ...
    fieldNotMapped: (fieldName: string) =>
      `Oops! A required field ("${fieldName}") hasn't been mapped. Please review and try again.`,
    singleFieldMultipleColumns: (fieldName: string) =>
      `Oops! You've mapped a single field ("${fieldName}") to multiple columns. Please review and try again.`,
    emptyMappedField: (fieldName: string) =>
      `Oops! The field ("${fieldName}") contains one or more empty values. Please review and try again.`,
    ...
    importCategoriesSuccessfulDescription: ({
      ...
      if (added) {
        return added === 1
          ? "1 category has been added."
          : `${added} categories have been added.`;
      }

      return updated === 1
        ? "1 category has been updated."
        : `${updated} categories have been updated.`;
    },
    importMembersSuccessfulDescription: ({
      ...
      if (updated) {
        return updated > 1
          ? `${updated} members have been updated.`
          : "1 member has been updated.";
      }

      return added > 1
        ? `${added} members have been added.`
        : "1 member has been added.";
    },
    importTagsSuccessfulDescription: ({ tags }: { tags: number }) =>
      tags > 1 ? `${tags} tags have been added.` : "1 tag has been added.",
    importMultiLevelTagsSuccessfulDescription:
      "Multi-level tags have been added.",
    importPerDiemRatesSuccessfulDescription: ({ rates }: { rates: number }) =>
      rates > 1
        ? `${rates} per diem rates have been added.`
        : "1 per diem rate has been added.",
    importTransactionsSuccessfulDescription: ({
      ...
      transactions > 1
        ? `${transactions} transactions have been imported.`
        : "1 transaction has been imported.",
    importFailedTitle: "Import failed",
    importFailedDescription:
      "Please ensure all fields are filled out correctly and try again. If the problem persists, please reach out to Concierge.",
    importDescription:
      "Choose which fields to map from your spreadsheet by clicking the dropdown next to each imported column below.",
    ...
    importSpreadsheetLibraryError:
      "Failed to load spreadsheet module. Please check your internet connection and try again.",
  ...
  receipt: {
    ...
    alternativeMethodsDownloadApp: ({ downloadUrl }: { downloadUrl: string }) =>
      `<label-text><a href="${downloadUrl}">Download the app</a> to scan from your phone</label-text>`,
    alternativeMethodsForwardReceipts: ({ email }: { email: string }) =>
      `<label-text>Forward receipts to <a href="mailto:${email}">${email}</a></label-text>`,
    ...
    alternativeMethodsTextReceipts: ({
      ...
      `<label-text>Text receipts to ${phoneNumber} (US numbers only)</label-text>`,
    ...
    locationAccessMessage:
      "Location access helps us keep your timezone and currency accurate wherever you go.",
    ...
    addReceipt: "Add receipt",
    scanFailed:
      "The receipt couldn't be scanned, as it's missing a merchant, date, or amount.",
    crop: "Crop",
    addAReceipt: {
  ...
  quickAction: {
    ...
    noLongerHaveReportAccess:
      "You no longer have access to your previous quick action destination. Pick a new one below.",
  ...
  iou: {
    ...
    taxRate: "Tax rate",
    approve: ({ formattedAmount }: { formattedAmount?: string } = {}) =>
    ...
    splitDateRange: (startDate: string, endDate: string, count: number) =>
      `${startDate} to ${endDate} (${count} days)`,
    splitExpenseSubtitle: (amount: string, merchant: string) =>
      `${amount} from ${merchant}`,
    ...
    totalAmountGreaterThanOriginal: (amount: string) =>
      `Total amount is ${amount} greater than the original expense.`,
    totalAmountLessThanOriginal: (amount: string) =>
      `Total amount is ${amount} less than the original expense.`,
    ...
    splitExpenseDistanceErrorModalDescription:
      "Please fix the distance rate error and try again.",
    splitExpensePerDiemRateErrorModalDescription:
      "Please fix the per diem rate error and try again.",
    expense: "Expense",
    ...
    removeExpenseConfirmation:
      "Are you sure you want to remove this receipt? This action cannot be undone.",
    ...
    cancelPaymentConfirmation:
      "Are you sure that you want to cancel this payment?",
    ...
    deletedTransaction: (amount: string, merchant: string) =>
      `deleted an expense (${amount} for ${merchant})`,
    movedFromReport: (reportName: string) =>
      `moved an expense${reportName ? ` from ${reportName}` : ""}`,
    movedTransactionTo: (reportUrl: string, reportName?: string) =>
      `moved this expense${reportName ? ` to <a href="${reportUrl}">${reportName}</a>` : ""}`,
    movedTransactionFrom: (reportUrl: string, reportName?: string) =>
      `moved this expense${reportName ? ` from <a href="${reportUrl}">${reportName}</a>` : ""}`,
    unreportedTransaction: (reportUrl: string) =>
      `moved this expense to your <a href="${reportUrl}">personal space</a>`,
    movedAction: (
    ...
    pendingMatchWithCreditCardDescription:
      "Receipt pending match with card transaction. Mark as cash to cancel.",
    markAsCash: "Mark as cash",
    routePending: "Route pending...",
    automaticallyEnterExpenseDetails:
      "Concierge will automatically enter the expense details for you, or you can add them manually.",
    receiptScanning: () => ({
    ...
    scanMultipleReceiptsDescription:
      "Snap photos of all your receipts at once, then confirm details yourself or we'll do it for you.",
    ...
    receiptStatusText:
      "Only you can see this receipt when it's scanning. Check back later or enter the details now.",
    ...
    companyInfoDescription:
      "We need a few more details before you can send your first invoice.",
    yourCompanyName: "Your company name",
    yourCompanyWebsite: "Your company website",
    yourCompanyWebsiteNote:
      "If you don't have a website, you can provide your company's LinkedIn or social media profile instead.",
    invalidDomainError:
      "You have entered an invalid domain. To continue, please enter a valid domain.",
    publicDomainError:
      "You have entered a public domain. To continue, please enter a private domain.",
    expenseCount: () => {
      return {
        one: "1 expense",
    ...
    businessBankAccount: (amount?: string, last4Digits?: string) =>
      amount
        ? `paid ${amount} with bank account ${last4Digits}`
        : `paid with bank account ${last4Digits}`,
    ...
    expenseAmount: (formattedAmount: string, comment?: string) =>
      `${formattedAmount}${comment ? ` for ${comment}` : ""}`,
    ...
    failedToAutoSubmitViaDEW: (reason: string) =>
      `failed to submit the report via <a href="${CONST.SELECT_WORKFLOWS_HELP_URL}">delay submissions</a>. ${reason}`,
    failedToSubmitViaDEW: (reason: string) =>
      `failed to submit the report. ${reason}`,
    failedToAutoApproveViaDEW: (reason: string) =>
      `failed to approve via <a href="${CONST.CONFIGURE_EXPENSE_REPORT_RULES_HELP_URL}">workspace rules</a>. ${reason}`,
    ...
    payerSettledWithMissingBankAccount: (amount: number | string) =>
      `paid ${amount}. Add a bank account to receive your payment.`,
    ...
    waitingOnBankAccount: ({
      ...
      `started payment, but is waiting for ${submitterDisplayName} to add a bank account.`,
    ...
    paidElsewhere: ({ payer, comment }: PaidElsewhereParams = {}) =>
      `${payer ? `${payer} ` : ""}marked as paid${comment ? `, saying "${comment}"` : ""}`,
    paidWithExpensify: (payer?: string) =>
      `${payer ? `${payer} ` : ""}paid with wallet`,
    ...
    setTheRequest: (valueName: string, newValueToDisplay: string) =>
      `the ${valueName} to ${newValueToDisplay}`,
    ...
    removedTheRequest: (valueName: string, oldValueToDisplay: string) =>
      `the ${valueName} (previously ${oldValueToDisplay})`,
    updatedTheRequest: ({
      valueName,
      newValueToDisplay,
      oldValueToDisplay,
    }: UpdatedTheRequestParams) =>
      `the ${valueName} to ${newValueToDisplay} (previously ${oldValueToDisplay})`,
    ...
    basedOnMCC: ({ rulesLink }: { rulesLink: string }) =>
      rulesLink
        ? `based on <a href="${rulesLink}">workspace rules</a>`
        : "based on workspace rule",
    threadExpenseReportName: (formattedAmount: string, comment?: string) =>
      `${formattedAmount} ${comment ? `for ${comment}` : "expense"}`,
    invoiceReportName: ({
      linkedReportID,
    }: OriginalMessage<typeof CONST.REPORT.ACTIONS.TYPE.REPORT_PREVIEW>) =>
      `Invoice Report #${linkedReportID}`,
    threadPaySomeoneReportName: (formattedAmount: string, comment?: string) =>
      `${formattedAmount} sent${comment ? ` for ${comment}` : ""}`,
    movedFromPersonalSpace: ({
      reportName,
      workspaceName,
    }: MovedFromPersonalSpaceParams) =>
      `moved expense from personal space to ${workspaceName ?? `chat with ${reportName}`}`,
    movedToPersonalSpace: "moved expense to personal space",
    error: {
      invalidCategoryLength:
        "The category name exceeds 255 characters. Please shorten it or choose a different category.",
      invalidTagLength:
        "The tag name exceeds 255 characters. Please shorten it or choose a different tag.",
      ...
      distanceAmountTooLargeReduceDistance:
        "The total amount is too large. Reduce the distance.",
      distanceAmountTooLargeReduceRate:
        "The total amount is too large. Lower the rate.",
      odometerReadingTooLarge: (formattedMax: string) =>
        `Odometer readings cannot exceed ${formattedMax}.`,
      ...
      invalidSplitParticipants:
        "Please enter an amount greater than zero for at least two participants",
      ...
      genericCreateInvoiceFailureMessage:
        "Unexpected error sending this invoice. Please try again later.",
      genericHoldExpenseFailureMessage:
        "Unexpected error holding this expense. Please try again later.",
      genericUnholdExpenseFailureMessage:
        "Unexpected error taking this expense off hold. Please try again later.",
      receiptDeleteFailureError:
        "Unexpected error deleting this receipt. Please try again later.",
      receiptFailureMessage:
        '<rbr>There was an error uploading your receipt. Please <a href="download">save the receipt</a> and <a href="retry">try again</a> later.</rbr>',
      ...
      genericEditFailureMessage:
        "Unexpected error editing this expense. Please try again later.",
      ...
      splitExpenseMultipleParticipantsErrorMessage:
        "An expense cannot be split between a workspace and other members. Please update your selection.",
      ...
      endDateSameAsStartDate:
        "The end date can't be the same as the start date",
    ...
    dismissReceiptErrorConfirmation:
      "Heads up! Dismissing this error will remove your uploaded receipt entirely. Are you sure?",
    ...
    selectUnreportedExpense:
      "Select at least one expense to add to the report.",
    emptyStateUnreportedExpenseTitle: "No unreported expenses",
    emptyStateUnreportedExpenseSubtitle:
      "Looks like you don’t have any unreported expenses. Try creating one below.",
    ...
    expenseOnHold:
      "This expense was put on hold. Please review the comments for next steps.",
    expensesOnHold:
      "All expenses were put on hold. Please review the comments for next steps.",
    expenseDuplicate:
      "This expense has similar details to another one. Please review the duplicates to continue.",
    someDuplicatesArePaid:
      "Some of these duplicates have been approved or paid already.",
    reviewDuplicates: "Review duplicates",
    keepAll: "Keep all",
    noDuplicatesTitle: "All set!",
    noDuplicatesDescription:
      "There are no duplicate transactions for review here.",
    confirmApprove: "Confirm approval amount",
    confirmApprovalAmount:
      "Approve only compliant expenses, or approve the entire report.",
    ...
    whatIsHoldExplain:
      "Hold is like hitting “pause” on an expense until you're ready to submit it.",
    holdIsLeftBehind:
      "Held expenses are left behind even if you submit an entire report.",
    unholdWhenReady: "Unhold expenses when you're ready to submit them.",
    changePolicyEducational: {
      title: "You moved this report!",
      description:
        "Double-check these items, which tend to change when moving reports to a new workspace.",
      reCategorize:
        "<strong>Re-categorize any expenses</strong> to comply with workspace rules.",
      workflows:
        "This report may now be subject to a different <strong>approval workflow.</strong>",
    },
    ...
    bookingPendingDescription:
      "This booking is pending because it hasn't been paid yet.",
    bookingArchived: "This booking is archived",
    bookingArchivedDescription:
      "This booking is archived because the trip date has passed. Add an expense for the final amount if needed.",
    attendees: "Attendees",
    ...
    reject: {
      ...
      educationalText:
        "If you're not ready to approve or pay an expense, you can hold or reject it.",
      holdExpenseTitle:
        "Hold an expense to ask for more details before approval or payment.",
      approveExpenseTitle:
        "Approve other expenses while held expenses stay assigned to you.",
      heldExpenseLeftBehindTitle:
        "Held expenses are left behind when you approve an entire report.",
      rejectExpenseTitle:
        "Reject an expense that you don't intend to approve or pay.",
      reasonPageTitle: "Reject expense",
      reasonPageDescription: "Explain why you will not approve this expense.",
      rejectReason: "Rejection reason",
      markAsResolved: "Mark as resolved",
      rejectedStatus:
        "This expense was rejected. Waiting on you to fix the issues and mark as resolved to enable submission.",
      reportActions: {
    ...
    moveExpensesError:
      "You can't move per diem expenses to reports on other workspaces, because the per diem rates may differ between workspaces.",
    changeApprover: {
      ...
      changedApproverMessage: (managerID: number) =>
        `changed the approver to <mention-user accountID="${managerID}"/>`,
      actions: {
        addApprover: "Add approver",
        addApproverSubtitle:
          "Add an additional approver to the existing workflow.",
        bypassApprovers: "Bypass approvers",
        bypassApproversSubtitle:
          "Assign yourself as final approver and skip any remaining approvers.",
      },
      addApprover: {
        subtitle:
          "Choose an additional approver for this report before we route through the rest of the approval workflow.",
      },
    },
    chooseWorkspace: "Choose a workspace",
    routedDueToDEW: (to: string) =>
      `report routed to ${to} due to custom approval workflow`,
    timeTracking: {
      hoursAt: (hours: number, rate: string) =>
        `${hours} ${hours === 1 ? "hour" : "hours"} @ ${rate} / hour`,
      hrs: "hrs",
      hours: "Hours",
    ...
    rulesModifiedFields: {
      reimbursable: (value: boolean) =>
        value
          ? 'marked the expense as "reimbursable"'
          : 'marked the expense as "non-reimbursable"',
      billable: (value: boolean) =>
        value
          ? 'marked the expense as "billable"'
          : 'marked the expense as "non-billable"',
      tax: (value: string, isFirst: boolean) =>
        isFirst ? `set the tax rate to "${value}"` : `tax rate to "${value}"`,
      ...
      formatPersonalRules: (fragments: string, route: string) =>
        `${fragments} via <a href="${route}">personal expense rules</a>`,
      formatPolicyRules: (fragments: string, route: string) =>
        `${fragments} via <a href="${route}">workspace rules</a>`,
    },
    duplicateNonDefaultWorkspacePerDiemError:
      "You can't duplicate per diem expenses across workspaces because the rates may differ between workspaces.",
    cannotDuplicateDistanceExpense:
      "You can't duplicate distance expenses across workspaces because the rates may differ between workspaces.",
  },
  transactionMerge: {
    listPage: {
    ...
    confirmationPage: {
      ...
      pageTitle:
        "Confirm the details you're keeping. The details you don't keep will be deleted.",
  ...
  loginField: {
    numberHasNotBeenValidated:
      "The number hasn't been validated. Click the button to resend the validation link via text.",
    emailHasNotBeenValidated:
      "The email hasn't been validated. Click the button to resend the validation link via text.",
  },
  ...
  nextStep: {
    ...
    eta: {
      ...
      [CONST.NEXT_STEP.ETA_KEY.SEMI_MONTHLY]:
  ...
  contacts: {
    ...
    enterMagicCode: (contactMethod: string) =>
      `Please enter the magic code sent to ${contactMethod}. It should arrive within a minute or two.`,
    ...
    yourDefaultContactMethodRestrictedSwitch:
      "This is your current default contact method. Your company has restricted removing or changing it.",
    removeContactMethod: "Remove contact method",
    removeAreYouSure:
      "Are you sure you want to remove this contact method? This action can't be undone.",
    ...
    genericFailureMessages: {
      ...
      deleteContactMethod:
        "Failed to delete contact method. Please reach out to Concierge for help.",
      setDefaultContactMethod:
        "Failed to set a new default contact method. Please reach out to Concierge for help.",
      addContactMethod:
        "Failed to add this contact method. Please reach out to Concierge for help.",
  ...
  updateRequiredView: {
    ...
    pleaseInstallExpensifyClassic:
      "Please install the latest version of Expensify",
    toGetLatestChanges:
      "For mobile, download and install the latest version. For web, refresh your browser.",
  ...
  initialSettingsPage: {
    ...
    troubleshoot: {
      ...
      confirmResetDescription:
        "All unsent draft messages will be lost, but the rest of your data is safe.",
      ...
      maskExportOnyxStateData:
        "Mask fragile member data while exporting Onyx state",
      exportOnyxState: "Export Onyx state",
      importOnyxState: "Import Onyx state",
      testCrash: "Test crash",
      resetToOriginalState: "Reset to original state",
      usingImportedState:
        "You are using imported state. Press here to clear it.",
      debugMode: "Debug mode",
      invalidFile: "Invalid file",
      invalidFileDescription:
        "The file you are trying to import is not valid. Please try again.",
  ...
  closeAccountPage: {
    ...
    enterDefaultContactToConfirm:
      "Please enter your default contact method to confirm you wish to close your account. Your default contact method is:",
  ...
  mergeAccountsPage: {
    ...
    accountDetails: {
      accountToMergeInto: (login: string) =>
        `Enter the account you want to merge into <strong>${login}</strong>.`,
    ...
    accountValidate: {
      ...
      enterMagicCode: (login: string) =>
        `To continue, please enter the magic code sent to <strong>${login}</strong>.`,
      errors: {
        incorrectMagicCode:
          "Incorrect or invalid magic code. Please try again or request a new code.",
    ...
    mergePendingSAML: {
      ...
      reachOutForHelp:
        "<muted-text><centered-text>Feel free to <concierge-link>reach out to Concierge</concierge-link> if you have any questions!</centered-text></muted-text>",
    ...
    mergeFailureUnvalidatedAccount: {
      description:
        "You can't merge into other accounts because it's not validated. Please validate the account and try again.",
    },
  ...
  lockAccountPage: {
    ...
    unlockDescription:
      "We’ll review the account to verify it’s safe to unlock and reach out via Concierge with any questions.",
    ...
    domainAdminsDescription:
      "For domain admins: This also pauses all Expensify Card activity and admin actions across your domain(s).",
    areYouSure: "Are you sure you want to lock your Expensify account?",
    onceLocked:
      "Once locked, your account will be restricted pending an unlock request and a security review",
  },
  ...
  unlockAccountPage: {
    ...
    chatToConciergeToUnlock:
      "Chat with Concierge to resolve security concerns and unlock your account.",
    chatWithConcierge: "Chat with Concierge",
  },
  twoFactorAuth: {
    ...
    explainProcessToRemove:
      "To disable two-factor authentication (2FA), please enter a valid code from your authentication app.",
    explainProcessToRemoveWithRecovery:
      "To disable two-factor authentication (2FA), please enter a valid recovery code.",
    disabled: "Two-factor authentication is now disabled",
    noAuthenticatorApp:
      "You’ll no longer require an authenticator app to log into Expensify.",
    ...
    enterCode:
      "Then enter the six-digit code generated from your authenticator app.",
    ...
    twoFactorAuthIsRequiredDescription:
      "For security purposes, Xero requires two-factor authentication to connect the integration.",
    ...
    twoFactorAuthIsRequiredXero:
      "Your Xero accounting connection requires two-factor authentication.",
    ...
    twoFactorAuthRequired:
      "Two-factor authentication (2FA) is required for your Xero connection and cannot be disabled.",
  },
  recoveryCodeForm: {
    error: {
  ...
  privateNotes: {
    ...
    sharedNoteMessage:
      "Keep notes about this chat here. Expensify employees and other members on the team.expensify.com domain can view these notes.",
    composerLabel: "Notes",
    myNote: "My note",
    error: {
  ...
  billingCurrency: {
    ...
    paymentCurrencyDescription:
      "Select a standardized currency that all personal expenses should be converted to",
  ...
  walletPage: {
    ...
    error: {
      notOwnerOfBankAccount:
        "An error occurred while setting this bank account as your default payment method",
      invalidBankAccount: "This bank account is temporarily suspended",
      notOwnerOfFund:
        "An error occurred while setting this card as your default payment method",
      setDefaultFailure:
    ...
    assignedCardsDescription:
      "Transactions from these cards sync automatically.",
    expensifyCard: "Expensify Card",
    walletActivationPending:
      "We're reviewing your information. Please check back in a few minutes!",
    walletActivationFailed:
      "Unfortunately, your wallet can't be enabled at this time. Please chat with Concierge for further assistance.",
    addYourBankAccount: "Add your bank account",
    addBankAccountBody:
      "Let's connect your bank account to Expensify so it’s easier than ever to send and receive payments directly in the app.",
    ...
    shareBankAccountSuccessDescription:
      "The selected admins will receive a confirmation message from Concierge.",
    shareBankAccountFailure:
      "An unexpected error occurred while trying to share bank account. Please try again.",
    shareBankAccountEmptyTitle: "No admins available",
    shareBankAccountEmptyDescription:
      "There are no workspace admins you can share this bank account with.",
    shareBankAccountNoAdminsSelected:
      "Please select an admin before continuing",
    unshareBankAccount: "Unshare bank account",
    unshareBankAccountDescription:
      "Everyone below has access to this bank account. You can remove access at any point. We’ll still complete any payments in process.",
    unshareBankAccountWarning: ({ admin }: { admin?: string | null }) =>
      `${admin} will lose access to this business bank account. We’ll still complete any payments in process.`,
    reachOutForHelp:
      "It’s being used with the Expensify Card. <concierge-link>Reach out to Concierge</concierge-link> if you need to unshare it.",
    unshareErrorModalTitle: `Can't unshare bank account`,
    travelCVV: {
      title: "Travel CVV",
      subtitle: "Use this when booking travel",
      description:
        "Use this card for your Expensify Travel bookings. It'll show as “Travel Card” at checkout.",
    },
  ...
  cardPage: {
    ...
    smartLimit: {
      ...
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
        `You can spend up to ${formattedLimit} on this card, and the limit will reset as your submitted expenses are approved.`,
    },
    fixedLimit: {
      name: "Fixed limit",
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
        `You can spend up to ${formattedLimit} on this card, and then it will deactivate.`,
    },
    monthlyLimit: {
      name: "Monthly limit",
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
    ...
    suspiciousBannerDescription:
      "We noticed suspicious transactions on your card. Tap below to review.",
    cardLocked:
    ...
    markTransactionsDescription:
      "When enabled, transactions imported from this card are marked as reimbursable by default.",
    ...
    enterMagicCode: (contactMethod: string) =>
      `Please enter the magic code sent to ${contactMethod} to view your card details. It should arrive within a minute or two.`,
    missingPrivateDetails: ({
      missingDetailsLink,
    }: {
      missingDetailsLink: string;
    }) =>
      `Please <a href="${missingDetailsLink}">add your personal details</a>, then try again.`,
    unexpectedError:
      "There was an error trying to get your Expensify card details. Please try again.",
    cardFraudAlert: {
      confirmButtonText: "Yes, I do",
      reportFraudButtonText: "No, it wasn't me",
      clearedMessage: ({ cardLastFour }: { cardLastFour: string }) =>
        `cleared the suspicious activity and reactivated card x${cardLastFour}. All set to keep expensing!`,
      deactivatedMessage: ({ cardLastFour }: { cardLastFour: string }) =>
        `deactivated the card ending in ${cardLastFour}`,
      alertMessage: ({
        cardLastFour,
        amount,
        merchant,
    ...
    freezeDescription:
      "A frozen card cannot be used for purchases and transactions. You can unfreeze it at any time.",
    unfreezeDescription:
      "Unfreezing this card will start allowing purchases and transactions again. Only proceed if you're sure the card is safe to use.",
    frozen: "Frozen",
    youFroze: ({ date }: { date: string }) => `You froze this card on ${date}.`,
    frozenBy: ({ person, date }: { person: string; date: string }) =>
      `${person} froze this card on ${date}.`,
  },
  workflowsPage: {
    workflowTitle: "Spend",
    workflowDescription:
      "Configure a workflow from the moment spend occurs, including approval and payment.",
    ...
    disableApprovalPromptDescription:
      "Disabling approvals will erase all existing approval workflows.",
    ...
    accessibilityLabel: ({
      ...
      members: string;
      approvers: string;
    }) => `expenses from ${members}, and the approver is ${approvers}`,
    ...
    editor: {
      submissionFrequency:
        "Choose how long Expensify should wait before sharing error-free spend.",
    },
    frequencyDescription:
      "Choose how often you’d like expenses to submit automatically, or make it manual",
    frequencies: {
      instant: "Instantly",
      weekly: "Weekly",
      monthly: "Monthly",
    ...
    emptyContent: {
      ...
      expensesFromSubtitle:
        "All workspace members already belong to an existing approval workflow.",
      approverSubtitle: "All approvers belong to an existing workflow.",
    },
  },
  workflowsDelayedSubmissionPage: {
    autoReportingFrequencyErrorMessage:
      "Submission frequency couldn't be changed. Please try again or contact support.",
    monthlyOffsetErrorMessage:
      "Monthly frequency couldn't be changed. Please try again or contact support.",
  },
  ...
  workflowsEditApprovalsPage: {
    ...
    deletePrompt:
      "Are you sure you want to delete this approval workflow? All members will subsequently follow the default workflow.",
  },
  ...
  workflowsApproverPage: {
    genericErrorMessage:
      "The approver couldn't be changed. Please try again or contact support.",
    title: "Set approver",
  ...
  workflowsPayerPage: {
    ...
    genericErrorMessage:
      "The authorized payer could not be changed. Please try again.",
    admins: "Admins",
    payer: "Payer",
  ...
  reportFraudPage: {
    ...
    description:
      "If your virtual card details have been stolen or compromised, we’ll permanently deactivate your existing card and provide you with a new virtual card and number.",
  ...
  activateCardPage: {
    ...
    error: {
      thatDidNotMatch:
        "That didn't match the last 4 digits on your card. Please try again.",
      throttled:
  ...
  getPhysicalCard: {
    ...
    nameMessage:
      "Enter your first and last name, as this will be shown on your card.",
    ...
    estimatedDeliveryMessage:
      "Your physical card will arrive in 2-3 business days.",
    next: "Next",
    getPhysicalCard: "Get physical card",
    shipCard: "Ship card",
  },
  ...
  expenseRulesPage: {
    ...
    changes: {
      billableUpdate: (value: boolean) =>
        `Update expense ${value ? "billable" : "non-billable"}`,
  ...
  priorityModePage: {
    ...
    explainerText:
      "Choose whether to #focus on unread and pinned chats only, or show everything with the most recent and pinned chats at the top.",
    priorityModes: {
      default: {
        label: "Most recent",
  ...
  groupChat: {
    ...
    lastMemberWarning:
      "Since you're the last person here, leaving will make this chat inaccessible to all members. Are you sure you want to leave?",
    defaultReportName: ({ displayName }: ReportArchiveReasonsClosedParams) =>
      `${displayName}'s group chat`,
  },
  languagePage: {
    language: "Language",
    aiGenerated:
      "The translations for this language are generated automatically and may contain errors.",
  },
  themePage: {
    theme: "Theme",
    themes: {
  ...
  validateCodeForm: {
    ...
    requestNewCode: ({ timeRemaining }: { timeRemaining: string }) =>
      `Request a new code in <a>${timeRemaining}</a>`,
  ...
  onboarding: {
    ...
    welcomeSignOffTitleManageTeam:
      "Once you finish the tasks above, we can explore more functionality like approval workflows and rules!",
    welcomeSignOffTitle: "It's great to meet you!",
    explanationModal: {
      title: "Welcome to Expensify",
      description:
        "One app to handle your business and personal spend at the speed of chat. Try it out and let us know what you think. Much more to come!",
      secondaryDescription:
        "To switch back to Expensify Classic, just tap your profile picture > Go to Expensify Classic.",
    },
    getStarted: "Get started",
    whatsYourName: "What's your name?",
    peopleYouMayKnow:
      "People you may know are already here! Verify your email to join them.",
    workspaceYouMayJoin: ({ domain, email }: WorkspaceYouMayJoin) =>
      `Someone from ${domain} has already created a workspace. Please enter the magic code sent to ${email}.`,
    joinAWorkspace: "Join a workspace",
    listOfWorkspaces:
      "Here's the list of workspaces you can join. Don't worry, you can always join them later if you prefer.",
    workspaceMemberList: ({
      employeeCount,
      policyOwner,
    }: WorkspaceMemberList) =>
      `${employeeCount} member${employeeCount > 1 ? "s" : ""} • ${policyOwner}`,
    ...
    purpose: {
      ...
      errorBackButton:
        "Please finish the setup questions to start using the app",
    ...
    workEmailValidation: {
      ...
      magicCodeSent: ({ workEmail }: WorkEmailResendCodeParams) =>
        `Please enter the magic code sent to ${workEmail}. It should arrive in a minute or two.`,
    },
    workEmailValidationError: {
      publicEmail:
        "Please enter a valid work email from a private domain e.g. mitch@company.com",
      offline: "We couldn’t add your work email as you appear to be offline",
    },
    mergeBlockScreen: {
      title: "Couldn’t add work email",
      subtitle: ({ workEmail }: WorkEmailMergingBlockedParams) =>
        `We couldn’t add ${workEmail}. Please try again later in Settings or chat with Concierge for guidance.`,
    },
    tasks: {
      testDriveAdminTask: {
        title: ({ testDriveURL }) => `Take a [test drive](${testDriveURL})`,
        description: ({ testDriveURL }) =>
          `[Take a quick product tour](${testDriveURL}) to see why Expensify is the fastest way to do your expenses.`,
      },
      testDriveEmployeeTask: {
        title: ({ testDriveURL }) => `Take a [test drive](${testDriveURL})`,
        description: ({ testDriveURL }) =>
          `Take us for a [test drive](${testDriveURL}) and get your team *3 free months of Expensify!*`,
      },
      ...
      createTestDriveAdminWorkspaceTask: {
        title: ({ workspaceConfirmationLink }) =>
          `[Create](${workspaceConfirmationLink}) a workspace`,
        description:
          "Create a workspace and configure the settings with the help of your setup specialist!",
      },
      createWorkspaceTask: {
        title: ({ workspaceSettingsLink }) =>
          `Create a [workspace](${workspaceSettingsLink})`,
      ...
      setupCategoriesTask: {
        title: ({ workspaceCategoriesLink }) =>
          `Set up [categories](${workspaceCategoriesLink})`,
      ...
      connectCorporateCardTask: {
        title: ({ corporateCardLink }) =>
          `Connect [your corporate cards](${corporateCardLink})`,
      ...
      inviteTeamTask: {
        title: ({ workspaceMembersLink }) =>
          `Invite [your team](${workspaceMembersLink})`,
      ...
      setupCategoriesAndTags: {
        title: ({ workspaceCategoriesLink, workspaceTagsLink }) =>
          `Set up [categories](${workspaceCategoriesLink}) and [tags](${workspaceTagsLink})`,
      ...
      inviteAccountantTask: {
        title: ({ workspaceMembersLink }) =>
          `Invite your [accountant](${workspaceMembersLink})`,
        description: ({ workspaceMembersLink }) =>
          dedent(`
      ...
      reviewWorkspaceSettingsTask: {
        title: ({ workspaceSettingsLink }) =>
          `Review your [workspace settings](${workspaceSettingsLink})`,
        description: ({ workspaceSettingsLink }) =>
          dedent(`
    ...
    testDrive: {
      name: ({ testDriveURL }: { testDriveURL?: string }) =>
        testDriveURL
          ? `Take a [test drive](${testDriveURL})`
          : "Take a test drive",
    ...
    messages: {
      onboardingEmployerOrSubmitMessage:
        "Getting paid back is as easy as sending a message. Let’s go over the basics.",
      ...
      onboardingChatSplitMessage:
        "Splitting bills with friends is as easy as sending a message. Here’s how.",
      onboardingAdminMessage:
        "Learn how to manage your team's workspace as an admin and submit your own expenses.",
      ...
      onboardingTestDriveReceiverMessage:
        "*You've got 3 months free! Get started below.*",
    },
    workspace: {
      title: "Stay organized with a workspace",
      subtitle:
        "Unlock powerful tools to simplify your expense management, all in one place. With a workspace, you can:",
      explanationModal: {
      ...
      price:
        "Try it free for 30 days, then upgrade for just <strong>$5/user/month</strong>.",
      createWorkspace: "Create workspace",
    },
    confirmWorkspace: {
      title: "Confirm workspace",
      subtitle:
        "Create a workspace to track receipts, reimburse expenses, manage travel, create reports, and more — all at the speed of chat.",
    },
    inviteMembers: {
      title: "Invite members",
      subtitle:
        "Add your team or invite your accountant. The more, the merrier!",
    },
  },
  featureTraining: {
  ...
  personalDetails: {
    error: {
      ...
      containsReservedWord:
        "Name cannot contain the words Expensify or Concierge",
  ...
  privatePersonalDetails: {
    ...
    error: {
      ...
      incorrectZipFormat: (zipFormat?: string) =>
        `Incorrect zip code format${zipFormat ? ` Acceptable format: ${zipFormat}` : ""}`,
  ...
  unlinkLoginForm: {
    ...
    noLongerHaveAccess: (primaryLogin: string) =>
      `If you no longer have access to ${primaryLogin}, please unlink your accounts.`,
    unlink: "Unlink",
    linkSent: "Link sent!",
  ...
  smsDeliveryFailurePage: {
    ...
    validationSuccess:
      "Your number has been validated! Click below to send a new magic sign-in code.",
    validationFailed: ({
      timeData,
    }: {
      timeData?: { days?: number; hours?: number; minutes?: number } | null;
    }) => {
      if (!timeData) {
      ...
      if (timeData.days) {
        timeParts.push(
          `${timeData.days} ${timeData.days === 1 ? "day" : "days"}`,
        );
      }

      if (timeData.hours) {
        timeParts.push(
          `${timeData.hours} ${timeData.hours === 1 ? "hour" : "hours"}`,
        );
      }
  ...
  notFound: {
    ...
    noAccess:
      "This chat or expense may have been deleted or you do not have access to it.\n\nFor any questions please contact concierge@expensify.com",
    goBackHome: "Go back to home page",
    commentYouLookingForCannotBeFound:
      "The comment you are looking for cannot be found.",
  ...
  errorPage: {
    ...
    wrongTypeSubtitle:
      "That search isn't valid. Try adjusting your search criteria.",
  },
  statusPage: {
    status: "Status",
    statusExplanation:
      "Add an emoji to give your colleagues and friends an easy way to know what's going on. You can optionally add a message too!",
    today: "Today",
    ...
    vacationDelegateError:
      "There was an error updating your vacation delegate.",
    asVacationDelegate: ({ nameOrEmail }: VacationDelegateParams) =>
      `as ${nameOrEmail}'s vacation delegate`,
    toAsVacationDelegate: (
      submittedToName: string,
      vacationDelegateName: string,
    ) =>
      `to ${submittedToName} as vacation delegate for ${vacationDelegateName}`,
  ...
  bankAccount: {
    ...
    thisBankAccount:
      "This bank account will be used for business payments on your workspace",
    ...
    toGetStarted:
      "Add a bank account to reimburse expenses, issue Expensify Cards, collect invoice payments, and pay bills all from one place.",
    plaidBodyCopy:
    ...
    hasBeenThrottledError:
      "An error occurred while adding your bank account. Please wait a few minutes and try again.",
    ...
    error: {
      ...
      industryCode:
        "Please enter a valid industry classification code with six digits",
      restrictedBusiness:
        "Please confirm the business isn't on the list of restricted businesses",
      routingNumber: "Please enter a valid routing number",
      accountNumber: "Please enter a valid account number",
      routingAndAccountNumberCannotBeSame:
        "Routing and account numbers can't match",
      companyType: "Please select a valid company type",
      tooManyAttempts:
        "Due to a high number of login attempts, this option has been disabled for 24 hours. Please try again later or enter details manually instead.",
      ...
      noDefaultDepositAccountOrDebitCardAvailable:
        "Please add a default deposit account or debit card",
      validationAmounts:
      ...
      sameDepositAndWithdrawalAccount:
        "The deposit and withdrawal accounts are the same.",
    },
  },
  addPersonalBankAccount: {
    ...
    confirmationStepSubHeader:
      "Double check the details below, and check the terms box to confirm.",
    toGetStarted:
      "Add a personal bank account to receive reimbursements, pay invoices, or enable the Expensify Wallet.",
  },
  ...
  messages: {
    ...
    userIsAlreadyAnAdmin: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} is already an admin of ${name}`,
  },
  onfidoStep: {
    acceptTerms:
    ...
    genericError:
      "An error occurred while processing this step. Please try again.",
    ...
    selfieIssue:
      "There's an issue with your selfie/video. Please upload a live selfie/video.",
    selfieNotMatching:
  ...
  additionalDetailsStep: {
    ...
    needSSNFull9:
      "We're having trouble verifying your SSN. Please enter the full nine digits of your SSN.",
  ...
  termsStep: {
    ...
    haveReadAndAgreePlain:
      "I have read and agree to receive electronic disclosures.",
    ...
    shortTermsForm: {
      expensifyPaymentsAccount: ({ walletProgram }: WalletProgramParams) =>
        `The Expensify Wallet is issued by ${walletProgram}.`,
    ...
    longTermsForm: {
      ...
      sendingFundsDetails:
        "There's no fee to send funds to another account holder using your balance, bank account, or debit card.",
  ...
  personalInfoStep: {
    ...
    byAddingThisBankAccount:
      "By adding this bank account, you confirm that you've read, understand, and accept",
  ...
  businessInfoStep: {
    ...
    selectYourCompanyIncorporationDate:
      "What's your company’s incorporation date?",
    incorporationDate: "Incorporation date",
    incorporationDatePlaceholder: "Start date (yyyy-mm-dd)",
    incorporationState: "Incorporation state",
    pleaseSelectTheStateYourCompanyWasIncorporatedIn:
      "Which state was your company incorporated in?",
    letsDoubleCheck: "Let's double check that everything looks right.",
    companyAddress: "Company address",
    listOfRestrictedBusinesses: "list of restricted businesses",
    confirmCompanyIsNot: "I confirm that this company is not on the",
    ...
    whatsTheBusinessContactInformation:
      "What's the business contact information?",
    ...
    whatsTheBusinessAnnualPayment:
      "What's the business's annual payment volume?",
    whatsYourExpectedAverageReimbursements:
      "What's your expected average reimbursement amount?",
  ...
  beneficialOwnerInfoStep: {
    ...
    doAnyIndividualOwn25percent: (companyName: string) =>
      `Do any individuals own 25% or more of ${companyName}?`,
    areThereMoreIndividualsWhoOwn25percent: (companyName: string) =>
      `Are there more individuals who own 25% or more of ${companyName}?`,
    regulationRequiresUsToVerifyTheIdentity:
      "Regulation requires us to verify the identity of any individual who owns more than 25% of the business.",
    ...
    enterTheLast4:
      "What are the last 4 digits of the owner’s Social Security Number?",
    last4SSN: "Last 4 of SSN",
    dontWorry: "Don't worry, we don't do any personal credit checks!",
  ...
  ownershipInfoStep: {
    ...
    doesAnyoneOwn: (companyName: string) =>
      `Do any individuals own 25% or more of ${companyName}?`,
    regulationsRequire:
      "Regulations require us to verify the identity of any individual who owns more than 25% of the business.",
    legalFirstName: "Legal first name",
    legalLastName: "Legal last name",
    ...
    areThereOther: (companyName: string) =>
      `Are there other individuals who own 25% or more of ${companyName}?`,
    owners: "Owners",
    addCertified: "Add a certified org chart that shows the beneficial owners",
    regulationRequiresChart:
      "Regulation requires us to collect a certified copy of the ownership chart that shows every individual or entity who owns 25% or more of the business.",
    uploadEntity: "Upload entity ownership chart",
    noteEntity:
      "Note: Entity ownership chart must be signed by your accountant, legal counsel, or notarized.",
    ...
    pleaseUpload:
      "Please upload additional documentation below to help us verify your identity as a direct or indirect owner of 25% or more of the business entity.",
    acceptedFiles:
      "Accepted file formats: PDF, PNG, JPEG. Total file size for each section cannot exceed 5 MB.",
  ...
  completeVerificationStep: {
    ...
    certifyTrueAndAccurateError:
      "Please certify that the information is true and accurate",
    isAuthorizedToUseBankAccount:
      "I am authorized to use this business bank account for business spend",
  ...
  connectBankAccountStep: {
    ...
    enable2FAText:
      "We take your security seriously. Please set up 2FA now to add an extra layer of protection to your account.",
  ...
  countryStep: {
    ...
    yourBusiness:
      "Your business bank account currency must match your workspace currency.",
  ...
  signerInfoStep: {
    ...
    areYouDirector: (companyName: string) =>
      `Are you a director at ${companyName}?`,
    regulationRequiresUs:
      "Regulation requires us to verify if the signer has the authority to take this action on behalf of the business.",
    whatsYourName: "What's your legal name",
    ...
    enterOneEmail: (companyName: string) =>
      `Enter the email of a director at ${companyName}`,
    regulationRequiresOneMoreDirector:
      "Regulation requires at least one more director as a signer.",
    hangTight: "Hang tight...",
    enterTwoEmails: (companyName: string) =>
      `Enter the emails of two directors at ${companyName}`,
    sendReminder: "Send a reminder",
    chooseFile: "Choose file",
    weAreWaiting:
      "We're waiting for others to verify their identities as directors of the business.",
    id: "Copy of ID",
    proofOfDirectors: "Proof of director(s)",
    proofOfDirectorsDescription:
      "Examples: Oncorp Corporate Profile or Business Registration.",
    codiceFiscale: "Codice Fiscale",
    codiceFiscaleDescription:
      "Codice Fiscale for Signatories, Authorized Users and Beneficial Owners.",
    ...
    PDSandFSGDescription: dedent(`
        ...
        `),
    pleaseUpload:
      "Please upload additional documentation below to help us verify your identity as a director of the business.",
  ...
  agreementsStep: {
    ...
    regulationRequiresUs:
      "Regulation requires us to verify the identity of any individual who owns more than 25% of the business.",
    iAmAuthorized:
      "I am authorized to use the business bank account for business spend.",
    ...
    iConsentToThePrivacyNotice:
      'I consent to the <a href="https://payments.corpay.com/compliance">privacy notice</a>.',
  ...
  docusignStep: {
    ...
    pleaseCompleteTheBusinessAccount:
      "Please complete the Business Account Application Direct Debit Arrangement",
    ...
    pleaseUploadTheDirect:
      "Please upload the Direct Debit Arrangements and Docusign signature page",
  },
  finishStep: {
  ...
  reimbursementAccountLoadingAnimation: {
    ...
    explanationLine:
      "We’re taking a look at your information. You'll be able to continue with next steps shortly.",
  },
  session: {
    offlineMessageRetry:
  ...
  travel: {
    ...
    termsAndConditions: {
      ...
      error:
        "You must agree to the Expensify Travel terms & conditions to continue",
    ...
    flightDetails: {
      ...
      layover: (layover: string) =>
        `<muted-text-label>You have a <strong>${layover} layover</strong> before this flight</muted-text-label>`,
      takeOff: "Take-off",
      landing: "Landing",
      seat: "Seat",
      class: "Cabin Class",
    ...
    phoneError: (phoneErrorMethodsRoute: string) =>
      `<rbr>Please <a href="${phoneErrorMethodsRoute}">add a work email as your primary login</a> to book travel.</rbr>`,
    domainSelector: {
      title: "Domain",
    ...
    verifyCompany: {
      ...
      conciergeMessage: ({ domain }: { domain: string }) =>
        `Travel enablement failed for domain: ${domain}. Please review and enable travel for this domain.`,
    },
    updates: {
      bookingTicketed: (
        airlineCode: string,
      ...
      flightScheduleChangePending: (airlineCode: string) =>
        `The airline has proposed a schedule change for flight ${airlineCode}; we are awaiting confirmation.`,
      flightScheduleChangeClosed: (airlineCode: string, startDate?: string) =>
        `Schedule change confirmed: flight ${airlineCode} now departs at ${startDate}.`,
      flightUpdated: (
        airlineCode: string,
        origin: string,
        destination: string,
      ...
      flightCabinChanged: (airlineCode: string, cabinClass?: string) =>
        `Your cabin class has been updated to ${cabinClass} on flight ${airlineCode}.`,
      flightSeatConfirmed: (airlineCode: string) =>
        `Your seat assignment on flight ${airlineCode} has been confirmed.`,
      flightSeatChanged: (airlineCode: string) =>
        `Your seat assignment on flight ${airlineCode} has been changed.`,
      flightSeatCancelled: (airlineCode: string) =>
        `Your seat assignment on flight ${airlineCode} was removed.`,
      paymentDeclined: "Payment for your air booking failed. Please try again.",
      bookingCancelledByTraveler: (type: string, id = "") =>
        `You cancelled your ${type} reservation ${id}.`,
      bookingCancelledByVendor: (type: string, id = "") =>
        `The vendor cancelled your ${type} reservation ${id}.`,
      bookingRebooked: (type: string, id = "") =>
        `Your ${type} reservation was re-booked. New confirmation #:${id}.`,
      bookingUpdated: (type: string) =>
        `Your ${type} booking was updated. Review the new details in the itinerary.`,
      railTicketRefund: (
        origin: string,
        destination: string,
        startDate: string,
      ...
      railTicketExchange: (
        ...
        `Your rail ticket for ${origin} → ${destination} on ${startDate} has been exchanged.`,
      railTicketUpdate: (
        origin: string,
        destination: string,
        startDate: string,
      ) =>
        `Your rail ticket for ${origin} → ${destination} on ${startDate} has been updated.`,
  ...
  proactiveAppReview: {
    ...
    description:
      "Let us know so we can help make your expensing experience even better.",
    positiveButton: "Yeah!",
  ...
  workspace: {
    common: {
      ...
      customFieldHint:
        "Add custom coding that applies to all spend from this member.",
      reports: "Reports",
      ...
      deleteWithCardsConfirmation:
        "Are you sure you want to delete this workspace? This will remove all card feeds and assigned cards.",
      ...
      mustBeOnlineToViewMembers:
        "You need to be online in order to view members of this workspace.",
      moreFeatures: "More features",
      requested: "Requested",
      distanceRates: "Distance rates",
      defaultDescription: "One place for all your receipts and expenses.",
      descriptionHint:
        "Share information about this workspace with all members.",
      welcomeNote:
        "Please use Expensify to submit your receipts for reimbursement, thanks!",
      subscription: "Subscription",
      ...
      exportIntegrationSelected: ({
        ...
        `Export to ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      letsDoubleCheck: "Let's double check that everything looks right.",
      ...
      connectTo: ({ connectionName }: ConnectionNameParams) =>
        `Connect to ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      ...
      lastSyncDate: (connectionName: string, formattedDate: string) =>
        `${connectionName} - Last synced ${formattedDate}`,
      authenticationError: (connectionName: string) =>
        `Can’t connect to ${connectionName} due to an authentication error.`,
      learnMore: "Learn more",
      ...
      uber: {
        subtitle: (organizationName: string) =>
          organizationName
            ...
            : "Automate travel and meal delivery expenses across your organization.",
        sendInvites: "Send invites",
        sendInvitesDescription:
          "These workspace members don't have an Uber for Business account yet. Unselect any members you do not wish to invite at this time.",
        ...
        takeBusinessRideMessage:
          "Take a business ride and your Uber receipts will import into Expensify. Scoot!",
        all: "All",
        linked: "Linked",
        outstanding: "Outstanding",
        status: {
          ...
          [CONST.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS
            .LINKED_PENDING_APPROVAL]: "Pending",
        ...
        emptyContent: {
          ...
          subtitle:
            "Huzzah! We looked high and low and couldn’t find any outstanding invites.",
        },
      },
    },
    perDiem: {
      ...
      emptyList: {
        title: "Per diem",
        subtitle:
          "Set per diem rates to control daily employee spend. Import rates from a spreadsheet to get started.",
      },
      ...
      editDestinationSubtitle: (destination: string) =>
        `Updating this destination will change it for all ${destination} per diem subrates.`,
      editCurrencySubtitle: (destination: string) =>
        `Updating this currency will change it for all ${destination} per diem subrates.`,
    },
    qbd: {
      exportOutOfPocketExpensesDescription:
        "Set how out-of-pocket expenses export to QuickBooks Desktop.",
      exportOutOfPocketExpensesCheckToggle: "Mark checks as “print later”",
      exportDescription:
        "Configure how Expensify data exports to QuickBooks Desktop.",
      date: "Export date",
      ...
      exportDate: {
        label: "Export date",
        description:
          "Use this date when exporting reports to QuickBooks Desktop.",
        values: {
      ...
      exportJournalEntryDescription:
        "We'll create an itemized journal entry for each Expensify report and post it to the account below.",
      ...
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}AccountDescription`]:
          "Choose where to export credit card transactions.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}AccountDescription`]:
          "Choose a vendor to apply to all credit card transactions.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}AccountDescription`]:
          "Choose where to send checks from.",

        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}Error`]:
          "Vendor bills are unavailable when locations are enabled. Please choose a different export option.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}Error`]:
          "Checks are unavailable when locations are enabled. Please choose a different export option.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY}Error`]:
          "Journal entries are unavailable when taxes are enabled. Please choose a different export option.",
      },
      noAccountsFound: "No accounts found",
      noAccountsFoundDescription:
        "Add the account in QuickBooks Desktop and sync the connection again",
      qbdSetup: "QuickBooks Desktop setup",
      requiredSetupDevice: {
        title: "Can't connect from this device",
        body1:
          "You'll need to setup this connection from the computer that hosts your QuickBooks Desktop company file.",
        body2:
          "Once you're connected, you'll be able to sync and export from anywhere.",
      },
      setupPage: {
      ...
      importDescription:
        "Choose which coding configurations to import from QuickBooks Desktop to Expensify.",
      classes: "Classes",
      items: "Items",
      customers: "Customers/projects",
      exportCompanyCardsDescription:
        "Set how company card purchases export to QuickBooks Desktop.",
      defaultVendorDescription:
        "Set a default vendor that will apply to all credit card transactions upon export.",
      accountsDescription:
        "Your QuickBooks Desktop chart of accounts will import into Expensify as categories.",
      accountsSwitchTitle:
        "Choose to import new accounts as enabled or disabled categories.",
      accountsSwitchDescription:
        "Enabled categories will be available for members to select when creating their expenses.",
      classesDescription:
        "Choose how to handle QuickBooks Desktop classes in Expensify.",
      tagsDisplayedAsDescription: "Line item level",
      reportFieldsDisplayedAsDescription: "Report level",
      customersDescription:
        "Choose how to handle QuickBooks Desktop customers/projects in Expensify.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify will automatically sync with QuickBooks Desktop every day.",
        createEntities: "Auto-create entities",
        createEntitiesDescription:
          "Expensify will automatically create vendors in QuickBooks Desktop if they don't exist already.",
      },
      itemsDescription:
        "Choose how to handle QuickBooks Desktop items in Expensify.",
      accountingMethods: {
    ...
    qbo: {
      ...
      importDescription:
        "Choose which coding configurations to import from QuickBooks Online to Expensify.",
      classes: "Classes",
      locations: "Locations",
      customers: "Customers/projects",
      accountsDescription:
        "Your QuickBooks Online chart of accounts will import into Expensify as categories.",
      accountsSwitchTitle:
        "Choose to import new accounts as enabled or disabled categories.",
      accountsSwitchDescription:
        "Enabled categories will be available for members to select when creating their expenses.",
      classesDescription:
        "Choose how to handle QuickBooks Online classes in Expensify.",
      customersDescription:
        "Choose how to handle QuickBooks Online customers/projects in Expensify.",
      locationsDescription:
        "Choose how to handle QuickBooks Online locations in Expensify.",
      taxesDescription:
        "Choose how to handle QuickBooks Online taxes in Expensify.",
      ...
      exportDescription:
        "Configure how Expensify data exports to QuickBooks Online.",
      date: "Export date",
      exportInvoices: "Export invoices to",
      exportExpensifyCard: "Export Expensify Card transactions as",
      exportDate: {
        label: "Export date",
        description:
          "Use this date when exporting reports to QuickBooks Online.",
        values: {
          [CONST.QUICKBOOKS_EXPORT_DATE.LAST_EXPENSE]: {
            label: "Date of last expense",
            description: "Date of the most recent expense on the report.",
      ...
      exportInvoicesDescription:
        "Use this account when exporting invoices to QuickBooks Online.",
      exportCompanyCardsDescription:
        "Set how company card purchases export to QuickBooks Online.",
      vendor: "Vendor",
      defaultVendorDescription:
        "Set a default vendor that will apply to all credit card transactions upon export.",
      exportOutOfPocketExpensesDescription:
        "Set how out-of-pocket expenses export to QuickBooks Online.",
      exportCheckDescription:
        "We'll create an itemized check for each Expensify report and send it from the bank account below.",
      exportJournalEntryDescription:
        "We'll create an itemized journal entry for each Expensify report and post it to the account below.",
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify will automatically sync with QuickBooks Online every day.",
        inviteEmployees: "Invite employees",
        inviteEmployeesDescription:
          "Import QuickBooks Online employee records and invite employees to this workspace.",
        createEntities: "Auto-create entities",
        createEntitiesDescription:
          "Expensify will automatically create vendors in QuickBooks Online if they don't exist already, and auto-create customers when exporting invoices.",
        reimbursedReportsDescription:
          "Any time a report is paid using Expensify ACH, the corresponding bill payment will be created in the QuickBooks Online account below.",
        ...
        accountSelectDescription:
          "Choose where to pay bills from and we'll create the payment in QuickBooks Online.",
        invoiceAccountSelectorDescription:
          "Choose where to receive invoice payments and we'll create the payment in QuickBooks Online.",
      },
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]:
          "Choose where to export debit card transactions.",
      ...
      exportDestinationAccountsMisconfigurationError: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Choose a valid account for vendor bill export",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Choose a valid account for journal entry export",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Choose a valid account for check export",
      },
      exportDestinationSetupAccountsInfo: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "To use vendor bill export, set up an accounts payable account in QuickBooks Online",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "To use journal entry export, set up a journal account in QuickBooks Online",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "To use check export, set up a bank account in QuickBooks Online",
      },
      noAccountsFound: "No accounts found",
      noAccountsFoundDescription:
        "Add the account in QuickBooks Online and sync the connection again.",
      accountingMethods: {
        label: "When to Export",
        description: "Choose when to export the expenses:",
        values: {
    ...
    xero: {
      ...
      organizationDescription:
        "Choose the Xero organization that you'd like to import data from.",
      importDescription:
        "Choose which coding configurations to import from Xero to Expensify.",
      accountsDescription:
        "Your Xero chart of accounts will import into Expensify as categories.",
      accountsSwitchTitle:
        "Choose to import new accounts as enabled or disabled categories.",
      accountsSwitchDescription:
        "Enabled categories will be available for members to select when creating their expenses.",
      ...
      trackingCategoriesDescription:
        "Choose how to handle Xero tracking categories in Expensify.",
      mapTrackingCategoryTo: (categoryName: string) =>
        `Map Xero ${categoryName} to`,
      mapTrackingCategoryToDescription: (categoryName: string) =>
        `Choose where to map ${categoryName} when exporting to Xero.`,
      customers: "Re-bill customers",
      customersDescription:
        "Choose whether to re-bill customers in Expensify. Your Xero customer contacts can be tagged to expenses, and will export to Xero as a sales invoice.",
      ...
      exportDeepDiveCompanyCard:
        "Exported expenses will post as bank transactions to the Xero bank account below, and transaction dates will match the dates on your bank statement.",
      bankTransactions: "Bank transactions",
      xeroBankAccount: "Xero bank account",
      xeroBankAccountDescription:
        "Choose where expenses will post as bank transactions.",
      exportExpensesDescription:
        "Reports will export as a purchase bill with the date and status selected below.",
      purchaseBillDate: "Purchase bill date",
      exportInvoices: "Export invoices as",
      salesInvoice: "Sales invoice",
      exportInvoicesDescription:
        "Sales invoices always display the date on which the invoice was sent.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify will automatically sync with Xero every day.",
        purchaseBillStatusTitle: "Purchase bill status",
        reimbursedReportsDescription:
          "Any time a report is paid using Expensify ACH, the corresponding bill payment will be created in the Xero account below.",
        ...
        xeroBillPaymentAccountDescription:
          "Choose where to pay bills from and we'll create the payment in Xero.",
        invoiceAccountSelectorDescription:
          "Choose where to receive invoice payments and we'll create the payment in Xero.",
      },
      exportDate: {
      ...
      noAccountsFound: "No accounts found",
      noAccountsFoundDescription:
        "Please add the account in Xero and sync the connection again",
      accountingMethods: {
        label: "When to Export",
        description: "Choose when to export the expenses:",
        values: {
    ...
    sageIntacct: {
      ...
      exportDescription:
        "Configure how Expensify data exports to Sage Intacct.",
      ...
      exportPreferredExporterSubNote:
        "Once set, the preferred exporter will see reports for export in their account.",
      noAccountsFound: "No accounts found",
      noAccountsFoundDescription: `Please add the account in Sage Intacct and sync the connection again`,
      autoSync: "Auto-sync",
      autoSyncDescription:
        "Expensify will automatically sync with Sage Intacct every day.",
      inviteEmployees: "Invite employees",
      inviteEmployeesDescription:
      ...
      syncReimbursedReportsDescription:
        "Any time a report is paid using Expensify ACH, the corresponding bill payment will be created in the Sage Intacct account below.",
    ...
    netsuite: {
      ...
      subsidiarySelectDescription:
        "Choose the subsidiary in NetSuite that you'd like to import data from.",
      ...
      journalEntriesProvTaxPostingAccount:
        "Journal entries provincial tax posting account",
      ...
      nonReimbursableJournalPostingAccount:
        "Non-reimbursable journal posting account",
      ...
      journalPostingPreference: {
        ...
        values: {
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            ...
            "Single, itemized entry for each report",
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            .JOURNALS_POSTING_TOTAL_LINE]: "Single entry for each expense",
        },
      },
      invoiceItem: {
        label: "Invoice item",
        values: {
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
            ...
            description:
              'We\'ll create an "Expensify invoice line item" for you upon export (if one doesn’t exist already).',
          },
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.SELECT]: {
            label: "Select existing",
            description:
              "We'll tie invoices from Expensify to the item selected below.",
          },
        },
      },
      exportDate: {
        ...
        values: {
          [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
            ...
            reimbursableDescription:
              "Out-of-pocket expenses will export as expense reports to NetSuite.",
            nonReimbursableDescription:
              "Company card expenses will export as expense reports to NetSuite.",
          },
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify will automatically sync with NetSuite every day.",
        reimbursedReportsDescription:
          "Any time a report is paid using Expensify ACH, the corresponding bill payment will be created in the NetSuite account below.",
        reimbursementsAccount: "Reimbursements account",
        reimbursementsAccountDescription:
          "Choose the bank account you'll use for reimbursements, and we'll create the associated payment in NetSuite.",
        collectionsAccount: "Collections account",
        collectionsAccountDescription:
          "Once an invoice is marked as paid in Expensify and exported to NetSuite, it’ll appear against the account below.",
        ...
        exportReportsTo: {
          ...
          description:
            "Once an expense report is approved in Expensify and exported to NetSuite, you can set an additional level of approval in NetSuite prior to posting.",
          values: {
            [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE]:
              "NetSuite default preference",
            [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED]:
              "Only supervisor approved",
            [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED]:
              "Only accounting approved",
            [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH]:
              "Supervisor and accounting approved",
          },
        },
        accountingMethods: {
          label: "When to Export",
        ...
        exportVendorBillsTo: {
          ...
          description:
            "Once a vendor bill is approved in Expensify and exported to NetSuite, you can set an additional level of approval in NetSuite prior to posting.",
          values: {
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVED_NONE]: "NetSuite default preference",
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVAL_PENDING]: "Pending approval",
        ...
        exportJournalsTo: {
          ...
          description:
            "Once a journal entry is approved in Expensify and exported to NetSuite, you can set an additional level of approval in NetSuite prior to posting.",
          values: {
      ...
      noAccountsFound: "No accounts found",
      noAccountsFoundDescription:
        "Please add the account in NetSuite and sync the connection again",
      noVendorsFound: "No vendors found",
      noVendorsFoundDescription:
        "Please add vendors in NetSuite and sync the connection again",
      noItemsFound: "No invoice items found",
      noItemsFoundDescription:
        "Please add invoice items in NetSuite and sync the connection again",
      noSubsidiariesFound: "No subsidiaries found",
      noSubsidiariesFoundDescription:
        "Please add a subsidiary in NetSuite and sync the connection again",
      tokenInput: {
        ...
        formSteps: {
          installBundle: {
            ...
            description:
              'In NetSuite, go to *Customization > SuiteBundler > Search & Install Bundles* > search for "Expensify" > install the bundle.',
          },
          enableTokenAuthentication: {
            title: "Enable token-based authentication",
            description:
              "In NetSuite, go to *Setup > Company > Enable Features > SuiteCloud* > enable *token-based authentication*.",
          },
          enableSoapServices: {
            title: "Enable SOAP web services",
            description:
              "In NetSuite, go to *Setup > Company > Enable Features > SuiteCloud* > enable *SOAP Web Services*.",
          },
          createAccessToken: {
          ...
          enterCredentials: {
            ...
            netSuiteAccountIDDescription:
              "In NetSuite, go to *Setup > Integration > SOAP Web Services Preferences*.",
          },
        },
      },
      import: {
        ...
        expenseCategoriesDescription:
          "Your NetSuite expense categories will import into Expensify as categories.",
        crossSubsidiaryCustomers: "Cross-subsidiary customers/projects",
        importFields: {
          departments: {
            title: "Departments",
            subtitle:
              "Choose how to handle the NetSuite *departments* in Expensify.",
          },
          classes: {
            title: "Classes",
        ...
        importCustomFields: {
          ...
          customSegments: {
            ...
            removePrompt:
              "Are you sure you want to remove this custom segment/record?",
            addForm: {
              ...
              segmentRecordType:
                "Do you want to add a custom segment or a custom record?",
              ...
              customSegmentMappingTitle:
                "How should this custom segment be displayed in Expensify?",
              customRecordMappingTitle:
                "How should this custom record be displayed in Expensify?",
            },
            errors: {
              uniqueFieldError: (fieldName: string) =>
                `A custom segment/record with this ${fieldName?.toLowerCase()} already exists`,
            },
          },
          customLists: {
            title: "Custom lists",
            ...
            addForm: {
              ...
              mappingTitle:
                "How should this custom list be displayed in Expensify?",
            },
            errors: {
        ...
        importTypes: {
          ...
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
            ...
            footerContent: (importField: string) =>
              `${startCase(importField)} will be selectable for each individual expense on an employee's report.`,
          },
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
            label: "Report fields",
            description: "Report level",
            footerContent: (importField: string) =>
              `${startCase(importField)} selection will apply to all expense on an employee's report.`,
          },
        },
      },
    },
    intacct: {
      ...
      downloadExpensifyPackage:
        "Download the Expensify package for Sage Intacct",
      followSteps:
        "Follow the steps in our How-to: Connect to Sage Intacct instructions",
      ...
      displayedAsTagDescription:
        "Department will be selectable for each individual expense on an employee's report.",
      displayedAsReportFieldDescription:
        "Department selection will apply to all expenses on an employee's report.",
      toggleImportTitle: (mappingTitle: string) =>
        `Choose how to handle Sage Intacct <strong>${mappingTitle}</strong> in Expensify.`,
      expenseTypes: "Expense types",
      expenseTypesDescription:
        "Your Sage Intacct expense types will import into Expensify as categories.",
      accountTypesDescription:
        "Your Sage Intacct chart of accounts will import into Expensify as categories.",
      ...
      removeDimensionPrompt:
        "Are you sure you want to remove this user-defined dimension?",
    ...
    companyCards: {
      ...
      error: {
        ...
        workspaceFeedsCouldNotBeLoadedMessage:
          "An error occurred while loading workspace card feeds. Please try again or contact your administrator.",
        feedCouldNotBeLoadedTitle: "Couldn't load this feed",
        feedCouldNotBeLoadedMessage:
          "An error occurred while loading this feed. Please try again or contact your administrator.",
        tryAgain: "Try again",
      },
      addNewCard: {
        other: "Other",
        ...
        commercialFeedDetails:
          "Requires setup with your bank. This is typically used by larger companies and is often the best option if you qualify.",
        ...
        directFeedDetails:
          "The simplest approach. Connect right away using your master credentials. This method is most common.",
        enableFeed: {
          title: (provider: string) => `Enable your ${provider} feed`,
          heading:
            "We have a direct integration with your card issuer and can import your transaction data into Expensify quickly and accurately.\n\nTo get started, simply:",
          visa: "We have global integrations with Visa, though eligibility varies by bank and card program.\n\nTo get started, simply:",
          mastercard:
            "We have global integrations with Mastercard, though eligibility varies by bank and card program.\n\nTo get started, simply:",
        ...
        error: {
          pleaseSelectProvider:
            "Please select a card provider before continuing",
          pleaseSelectBankAccount:
            "Please select a bank account before continuing",
        ...
        exitModal: {
          ...
          prompt:
            "We noticed you didn't finish adding your cards. If you found an issue, let us know so we can help get things back on track.",
      ...
      startDateDescription:
        "Choose your import start date. We'll sync all transactions from this date onwards.",
      editStartDateDescription:
        "Choose a new transaction start date. We'll sync all transactions from that date onwards, excluding those we already imported.",
      fromTheBeginning: "From the beginning",
      customStartDate: "Custom start date",
      customCloseDate: "Custom close date",
      letsDoubleCheck: "Let's double check that everything looks right.",
      confirmationDescription:
        "We'll begin importing transactions immediately.",
      card: "Card",
      cardName: "Card name",
      brokenConnectionError:
        '<rbr>Card feed connection is broken. Please <a href="#">log into your bank</a> so we can establish the connection again.</rbr>',
      assignedCard: (assignee: string, link: string) =>
        `assigned ${assignee} a ${link}! Imported transactions will appear in this chat.`,
      ...
      cardAlreadyAssignedError:
        "This card is already assigned to a user in another workspace.",
      importTransactions: {
        title: "Import transactions from file",
        description:
          "Please adjust the settings for your file that will be applied on import.",
    ...
    expensifyCard: {
      ...
      verifyingTheDetails:
        "We're verifying a few details. Concierge will let you know when Expensify Cards are ready to issue.",
      disclaimer:
      ...
      currentBalanceDescription:
        "Current balance is the sum of all posted Expensify Card transactions that have occurred since the last settlement date.",
      balanceWillBeSettledOn: (settlementDate: string) =>
        `Balance will be settled on ${settlementDate}`,
      ...
      earnedCashbackDescription:
        "Cash back balance is based on settled monthly Expensify Card spend across your workspace.",
      issueNewCard: "Issue new card",
      finishSetup: "Finish setup",
      chooseBankAccount: "Choose bank account",
      chooseExistingBank:
        "Choose an existing business bank account to pay your Expensify Card balance, or add a new bank account",
      accountEndingIn: "Account ending in",
      addNewBankAccount: "Add a new bank account",
      settlementAccount: "Settlement account",
      settlementAccountDescription:
        "Choose an account to pay your Expensify Card balance.",
      ...
      settlementFrequencyDescription:
        "Choose how often you’ll pay your Expensify Card balance.",
      settlementFrequencyInfo:
        "If you’d like to switch to monthly settlement, you’ll need to connect your bank account via Plaid and have a positive 90-day balance history.",
      frequency: {
        daily: "Daily",
        monthly: "Monthly",
      },
      ...
      cardPending: ({ name }: { name: string }) =>
        `Card is currently pending and will be issued once ${name}'s account is validated.`,
      virtual: "Virtual",
      physical: "Physical",
      ...
      monthlyLimitWarning: (limit: number | string) =>
        `If you change this card’s limit to ${limit}, new transactions will be declined until next month.`,
      fixedLimitWarning: (limit: number | string) =>
        `If you change this card’s limit to ${limit}, new transactions will be declined.`,
      ...
      issuedCardNoShippingDetails: (assignee: string) =>
        `issued ${assignee} an Expensify Card! The card will be shipped once shipping details are confirmed.`,
      issuedCardVirtual: (assignee: string, link: string) =>
        `issued ${assignee} a virtual Expensify Card! The ${link} can be used right away.`,
      addedShippingDetails: (assignee: string) =>
        `${assignee} added shipping details. Expensify Card will arrive in 2-3 business days.`,
      replacedCard: (assignee: string) =>
        `${assignee} replaced their Expensify Card. The new card will arrive in 2-3 business days.`,
      replacedVirtualCard: (assignee: string, link: string) =>
        `${assignee} replaced their virtual Expensify Card! The ${link} can be used right away.`,
      card: "card",
      ...
      verifyingBankAccountDescription:
        "Please wait while we confirm that this account can be used to issue Expensify Cards.",
      bankAccountVerified: "Bank account verified!",
      bankAccountVerifiedDescription:
        "You can now issue Expensify Cards to your workspace members.",
      oneMoreStep: "One more step...",
      oneMoreStepDescription:
        "Looks like we need to manually verify your bank account. Please head on over to Concierge where your instructions are waiting for you.",
      gotIt: "Got it",
    ...
    categories: {
      ...
      spendCategoriesDescription:
        "Customize how merchant spend is categorized for credit card transactions and scanned receipts.",
      ...
      importedFromAccountingSoftware:
        "The categories below are imported from your",
      payrollCode: "Payroll code",
      updatePayrollCodeFailureMessage:
        "An error occurred while updating the payroll code, please try again",
      glCode: "GL code",
      updateGLCodeFailureMessage:
        "An error occurred while updating the GL code, please try again",
    ...
    moreFeatures: {
      ...
      travel: {
        ...
        getStarted: {
          title: "Get started with Expensify Travel",
          subtitle:
            "We just need a few more pieces of info about your business, then you'll be ready for takeoff.",
          ctaText: "Let's go",
        },
        reviewingRequest: {
          title: "Pack your bags, we've got your request...",
          subtitle:
            "We're currently reviewing your request to enable Expensify Travel. Don't worry, we'll let you know when it's ready.",
          ctaText: "Request sent",
        },
        bookOrManageYourTrip: {
          title: "Travel booking",
          subtitle:
            "Congrats! You're all set to book and manage travel on this workspace.",
        ...
        settings: {
          autoAddTripName: {
            ...
            subtitle:
              "Automatically add trip names to expense descriptions for travel booked in Expensify.",
          },
        },
        travelInvoicing: {
          ...
          centralInvoicingSection: {
            ...
            subtitle:
              "Centralize all travel spend in a monthly invoice instead of paying at time of purchase.",
            learnHow: "Learn how.",
            subsections: {
              ...
              settlementFrequencyDescription:
                "How often Expensify will pull from your business bank account to settle recent Expensify Travel transactions.",
            },
          },
          disableModal: {
        ...
        personalDetailsDescription:
          "In order to book travel, please enter your legal name as it appears on your government-issued ID.",
      },
      expensifyCard: {
        ...
        disableCardPrompt:
          "You can’t disable the Expensify Card because it’s already in use. Reach out to Concierge for next steps.",
        disableCardButton: "Chat with Concierge",
        feed: {
          title: "Get the Expensify Card",
          subTitle:
            "Streamline your business expenses and save up to 50% on your Expensify bill, plus:",
          features: {
      ...
      companyCards: {
        ...
        disableCardPrompt:
          "You can’t disable company cards because this feature is in use. Reach out to the Concierge for next steps.",
        disableCardButton: "Chat with Concierge",
        cardDetails: "Card details",
        cardNumber: "Card number",
        ...
        integrationExportTitleXero: (integration: string) =>
          `Choose the ${integration} account where transactions should be exported.`,
        ...
        unassignCardDescription:
          "Unassigning this card will delete all unsubmitted transactions.",
        assignCard: "Assign card",
        removeCard: "Remove card",
        remove: "Remove",
        removeCardDescription:
          "Removing this card will delete all unsubmitted transactions.",
        cardFeedName: "Card feed name",
        cardFeedNameDescription:
          "Give the card feed a unique name so you can tell it apart from the others.",
        ...
        emptyAddedFeedDescription:
          "Make sure there are cards in your bank's card feed.",
        ...
        pendingBankDescription: (bankName: string) =>
          `Please connect to ${bankName} via your browser window that just opened. If one didn’t open, `,
        pendingBankLink: "please click here",
        giveItNameInstruction:
          "Give the card a name that sets it apart from others.",
        updating: "Updating...",
        neverUpdated: "Never",
        noAccountsFound: "No accounts found",
        ...
        noAccountsFoundDescription: (connection: string) =>
          `Please add the account in ${connection} and sync the connection again`,
        ...
        statementCloseDateDescription:
          "Let us know when your card statement closes, and we’ll create a matching statement in Expensify.",
      },
      workflows: {
        title: "Workflows",
      ...
      connectionsWarningModal: {
        ...
        featureEnabledText:
          "To enable or disable this feature, you'll need to change your accounting import settings.",
        disconnectText:
          "To disable accounting, you'll need to disconnect your accounting connection from your workspace.",
        manageSettings: "Manage settings",
      },
      receiptPartnersWarningModal: {
        featureEnabledTitle: "Disconnect Uber",
        disconnectText:
          "To disable this feature, please disconnect the Uber for Business integration first.",
    ...
    reports: {
      ...
      customNameEmailPhoneExample:
        "Member’s email or phone: {report:submit:from}",
    ...
    reportFields: {
      ...
      deleteFieldsConfirmation:
        "Are you sure you want to delete these report fields?",
      emptyReportFields: {
        title: "You haven't created any report fields",
        subtitle:
          "Add a custom field (text, date, or dropdown) that appears on reports.",
      },
      subtitle:
      ...
      disableReportFieldsConfirmation:
        "Are you sure? Text and date fields will be deleted, and lists will be disabled.",
      importedFromAccountingSoftware:
        "The report fields below are imported from your",
      textType: "Text",
      dateType: "Date",
      dropdownType: "List",
      formulaType: "Formula",
      ...
      initialValueInputSubtitle:
        "Enter a starting value to show in the report field.",
      listValuesInputSubtitle:
        "These values will appear in your report field dropdown. Enabled values can be selected by members.",
      listInputSubtitle:
        "These values will appear in your report field list. Enabled values can be selected by members.",
      ...
      circularReferenceError:
        "This field can't refer to itself. Please update.",
      reportFieldInitialValueRequiredError:
        "Please choose a report field initial value",
      genericFailureMessage:
        "An error occurred while updating the report field. Please try again.",
    },
    tags: {
      tagName: "Tag name",
      ...
      emptyTags: {
        ...
        subtitle:
          "Add a tag to track projects, locations, departments, and more.",
      ...
      deleteTagsConfirmation:
        "Are you sure that you want to delete these tags?",
      deleteFailureMessage:
      ...
      cannotMakeTagListRequired: {
        ...
        description:
          "You can only make a tag list required if your policy has multiple tag levels configured.",
      },
      tagCount: () => ({
        one: "1 Tag",
    ...
    taxes: {
      ...
      error: {
        ...
        deleteFailureMessage:
          "An error occurred while deleting the tax rate. Please try again or ask Concierge for help.",
        updateFailureMessage:
          "An error occurred while updating the tax rate. Please try again or ask Concierge for help.",
        createFailureMessage:
          "An error occurred while creating the tax rate. Please try again or ask Concierge for help.",
        updateTaxClaimableFailureMessage:
          "The reclaimable portion must be less than the distance rate amount",
      },
      deleteTaxConfirmation: "Are you sure you want to delete this tax?",
      deleteMultipleTaxConfirmation: (taxAmount: number) =>
        `Are you sure you want to delete ${taxAmount} taxes?`,
      actions: {
        delete: "Delete rate",
      ...
      updateTaxCodeFailureMessage:
        "An error occurred while updating the tax code, please try again",
    },
    duplicateWorkspace: {
      title: "Name your new workspace",
      selectFeatures: "Select features to copy",
      whichFeatures:
        "Which features do you want to copy over to your new workspace?",
      ...
      error:
        "An error occurred while duplicating your new workspace. Please try again.",
    },
    emptyWorkspace: {
      ...
      description:
        "Rooms are a great place to discuss and work with multiple people. To begin collaborating, create or join a workspace",
    },
    new: {
      ...
      myGroupWorkspace: ({ workspaceNumber }: { workspaceNumber?: number }) =>
        `My Group Workspace${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
      workspaceName: (userName: string, workspaceNumber?: number) =>
        `${userName}'s Workspace${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
    },
    people: {
      genericFailureMessage:
        "An error occurred removing a member from the workspace, please try again",
      ...
      invitedBySecondaryLogin: (secondaryLogin: string) =>
        `Added by secondary login ${secondaryLogin}.`,
    ...
    card: {
      ...
      issueNewCard: {
        ...
        smartLimitDescription:
          "Spend up to a certain amount before requiring approval",
        monthly: "Monthly",
        ...
        disabledApprovalForSmartLimitError:
          "Please enable approvals in <strong>Workflows > Add approvals</strong> before setting up smart limits",
        ...
        combineWithExpiration:
          "Combine with expiration options for additional spend control",
      ...
      deactivateCardModal: {
        ...
        deactivateConfirmation:
          "Deactivating this card will decline all future transactions and can’t be undone.",
      },
    },
    accounting: {
      settings: "settings",
      title: "Connections",
      subtitle:
        "Connect to your accounting system to code transactions with your chart of accounts, auto-match payments, and keep your finances in sync.",
      ...
      connectTitle: ({ connectionName }: ConnectionNameParams) =>
        `Connect ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName] ?? "accounting integration"}`,
      ...
      claimOffer: {
        ...
        xero: {
          ...
          description:
            "<muted-text><centered-text>New to Xero? Expensify customers get 6 months free. Claim your offer below.</centered-text></muted-text>",
      ...
      chooseReconciliationAccount: {
        chooseBankAccount:
          "Choose the bank account that your Expensify Card payments will be reconciled against.",
    ...
    export: {
      ...
      notReadyDescription:
        "Draft or pending expense reports cannot be exported to the accounting system. Please approve or pay these expenses before exporting them.",
    },
    invoices: {
      ...
      invoiceBalanceSubtitle:
        "This is your current balance from collecting invoice payments. It'll transfer to your bank account automatically if you've added one.",
      bankAccountsSubtitle:
        "Add a bank account to make and receive invoice payments.",
    },
    invite: {
      ...
      genericFailureMessage:
        "An error occurred while inviting the member to the workspace. Please try again.",
    ...
    inviteMessage: {
      confirmDetails: "Confirm details",
      inviteMessagePrompt:
        "Make your invitation extra special by adding a message below!",
      ...
      joinRequest: ({
        ...
        user: string;
        workspaceName: string;
      }) => `${user} requested to join ${workspaceName}`,
    },
    distanceRates: {
      ...
      distance: "Distance",
      centrallyManage:
        "Centrally manage rates, track in miles or kilometers, and set a default category.",
      rate: "Rate",
      addRate: "Add rate",
      findRate: "Find rate",
      trackTax: "Track tax",
    ...
    editor: {
      ...
      save: "Save",
      genericFailureMessage:
        "An error occurred while updating the workspace. Please try again.",
      avatarUploadFailureMessage:
        "An error occurred uploading the avatar. Please try again.",
      addressContext:
    ...
    bankAccount: {
      ...
      youAreAlmostDone:
        "You're almost done setting up your bank account, which will let you issue corporate cards, reimburse expenses, collect invoices, and pay bills.",
      ...
      accountDescriptionWithCards:
        "This bank account will be used to issue corporate cards, reimburse expenses, collect invoices, and pay bills.",
      ...
      clearProgress:
        "Starting over will clear the progress you've made so far.",
      areYouSure: "Are you sure?",
      workspaceCurrency: "Workspace currency",
      updateCurrencyPrompt:
        "It looks like your workspace is currently set to a different currency than USD. Please click the button below to update your currency to USD now.",
      ...
      chooseAnExisting:
        "Choose an existing bank account to pay expenses or add a new one.",
    },
    changeOwner: {
      ...
      failedToClearBalanceText:
        "We were unable to clear the balance. Please try again later.",
    ...
    upgrade: {
      ...
      categories: {
        title: "Categories",
        description:
          "Categories allow you to track and organize spend. Use our default categories or add your own.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      travel: {
        title: "Travel",
        description:
          "Expensify Travel is a new corporate travel booking and management platform that allows members to book accommodations, flights, transportation, and more.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      reports: {
        title: "Reports",
        description:
          "Reports allow you to group expenses for easier tracking and organization.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      distanceRates: {
        title: "Distance rates",
        description:
          "Create and manage your own rates, track in miles or kilometers, and set default categories for distance expenses.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      auditor: {
        title: "Auditor",
        description:
          "Auditors get read-only access to all reports for full visibility and compliance monitoring.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      [CONST.UPGRADE_FEATURE_INTRO_MAPPING.multiApprovalLevels.id]: {
        ...
        description:
          "Multiple approval levels is a workflow tool for companies that require more than one person to approve a report before it can be reimbursed.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      commonFeatures: {
        ...
        upgradeWorkspaceWarningForRestrictedPolicyCreationPrompt:
          "Your company has restricted workspace creation. Please reach out to an admin for help.",
      },
    },
    downgrade: {
      commonFeatures: {
        ...
        benefits: {
          ...
          confirm:
            "Are you sure you want to downgrade and remove your configurations?",
          warning: "This cannot be undone.",
          benefit1:
            "Accounting connections (except QuickBooks Online and Xero)",
          benefit2: "Smart expense rules",
          benefit3: "Multi-level approval workflows",
          benefit4: "Enhanced security controls",
          headsUp: "Heads up!",
          multiWorkspaceNote:
            "You’ll need to downgrade all your workspaces before your first monthly payment to begin a subscription at the Collect rate. Click",
      ...
      completed: {
        ...
        description:
          "You have other workspaces on the Control plan. To be billed at the Collect rate, you must downgrade all workspaces.",
        gotIt: "Got it, thanks",
      },
    },
    payAndDowngrade: {
      ...
      description1: (formattedAmount: string) =>
        `Your final bill for this subscription will be <strong>${formattedAmount}</strong>`,
      ...
      genericFailureMessage:
        "An error occurred while paying your bill. Please try again.",
    },
    restrictedAction: {
      ...
      youWillNeedToAddOrUpdatePaymentCard:
        "You'll need to add or update the payment card on file to unlock new workspace activity.",
      addPaymentCardToUnlock: "Add a payment card to unlock!",
      addPaymentCardToContinueUsingWorkspace:
        "Add a payment card to continue using this workspace",
      pleaseReachOutToYourWorkspaceAdmin:
        "Please reach out to your workspace admin for any questions.",
    ...
    rules: {
      individualExpenseRules: {
        ...
        receiptRequiredAmountDescription:
          "Require receipts when spend exceeds this amount, unless overridden by a category rule.",
        receiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `Amount can't be greater than the itemized receipt required amount (${amount})`,
        itemizedReceiptRequiredAmount: "Itemized receipt required amount",
        itemizedReceiptRequiredAmountDescription:
          "Require itemized receipts when spend exceeds this amount, unless overridden by a category rule.",
        itemizedReceiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `Amount can't be lower than the amount required for regular receipts (${amount})`,
        maxExpenseAmount: "Max expense amount",
        maxExpenseAmountDescription:
          "Flag spend that exceeds this amount, unless overridden by a category rule.",
        maxAge: "Max age",
        maxExpenseAge: "Max expense age",
        maxExpenseAgeDescription:
          "Flag spend older than a specific number of days.",
        maxExpenseAgeDays: () => ({
          one: "1 day",
        ...
        nonBillableDescription:
          "Expenses are occasionally re-billed to clients",
        eReceipts: "eReceipts",
        ...
        requireCompanyCardDescription:
          "Flag all cash spend, including mileage and per-diem expenses.",
        requireCompanyCardDisabledTooltip:
          "Enable Company cards (under More features) to unlock.",
      },
      expenseReportRules: {
        title: "Advanced",
        ...
        preventSelfApprovalsSubtitle:
          "Prevent workspace members from approving their own expense reports.",
        autoApproveCompliantReportsTitle: "Auto-approve compliant reports",
        autoApproveCompliantReportsSubtitle:
          "Configure which expense reports are eligible for auto-approval.",
        autoApproveReportsUnderTitle:
          "Auto-approve reports with all expenses under",
        autoApproveReportsUnderDescription:
          "Fully compliant expense reports where all expenses are under this amount will be automatically approved.",
        randomReportAuditTitle: "Random report audit",
        randomReportAuditDescription:
          "Require that some reports be manually approved, even if eligible for auto-approval.",
        autoPayApprovedReportsTitle: "Auto-pay approved reports",
        autoPayApprovedReportsSubtitle:
          "Configure which expense reports are eligible for auto-pay.",
        autoPayApprovedReportsLimitError: (currency?: string) =>
          `Please enter an amount less than ${currency ?? ""}20,000`,
        autoPayApprovedReportsLockedSubtitle:
          "Go to more features and enable workflows, then add payments to unlock this feature.",
        autoPayReportsUnderTitle: "Auto-pay reports under",
        autoPayReportsUnderDescription:
          "Fully compliant expense reports under this amount will be automatically paid.",
        unlockFeatureEnableWorkflowsSubtitle: (featureName: string) =>
          `Add ${featureName} to unlock this feature.`,
        enableFeatureSubtitle: (
          featureName: string,
          moreFeaturesLink?: string,
        ) =>
          `Go to [more features](${moreFeaturesLink}) and enable ${featureName} to unlock this feature.`,
      },
      merchantRules: {
        title: "Merchant",
        subtitle:
          "Set the merchant rules so expenses arrive correctly coded and require less cleanup.",
        ...
        previewMatchesEmptyStateSubtitle:
          "No unsubmitted expenses match this rule.",
        ...
        ruleSummaryTitle: (merchantName: string, isExactMatch: boolean) =>
          `If merchant ${isExactMatch ? "exactly matches" : "contains"} "${merchantName}"`,
        ruleSummarySubtitleMerchant: (merchantName: string) =>
          `Rename merchant to "${merchantName}"`,
        ruleSummarySubtitleUpdateField: (
          fieldName: string,
          fieldValue: string,
        ) => `Update ${fieldName} to "${fieldValue}"`,
        ruleSummarySubtitleReimbursable: (reimbursable: boolean) =>
          `Mark as  "${reimbursable ? "reimbursable" : "non-reimbursable"}"`,
        ruleSummarySubtitleBillable: (billable: boolean) =>
          `Mark as "${billable ? "billable" : "non-billable"}"`,
        ...
        duplicateRulePrompt: (merchantName: string) =>
          `Your existing rule for "${merchantName}" will take priority over this one. Save anyway?`,
        saveAnyway: "Save anyway",
        applyToExistingUnsubmittedExpenses:
          "Apply to existing unsubmitted expenses",
      },
      categoryRules: {
        ...
        requiredFieldsDescription: (categoryName: string) =>
          `This will apply to all expenses categorized as <strong>${categoryName}</strong>.`,
        ...
        flagAmountsOverDescription: (categoryName: string) =>
          `Applies to the category “${categoryName}”.`,
        flagAmountsOverSubtitle:
          "This overrides the max amount for all expenses.",
        expenseLimitTypes: {
          expense: "Individual expense",
          expenseSubtitle:
            "Flag expense amounts by category. This rule overrides the general workspace rule for max expense amount.",
        ...
        requireReceiptsOverList: {
          default: (defaultAmount: string) =>
            `${defaultAmount} ${CONST.DOT_SEPARATOR} Default`,
      ...
      customRules: {
        ...
        cardSubtitle:
          "Here's where your team's expense policy lives, so everyone's on the same page about what's covered.",
      },
    },
    planTypePage: {
      planTypes: {
      ...
      description:
        "Choose a plan that's right for you. For a detailed list of features and pricing, check out our",
  ...
  newRoomPage: {
    ...
    roomNameReservedError: (reservedName: string) =>
      `${reservedName} is a default room on all workspaces. Please choose another name.`,
    ...
    renamedRoomAction: (
      ...
      return isExpenseReport
        ? `${actor}renamed to "${newName}" (previously "${oldName}")`
        : `${actor}renamed this room to "${newName}" (previously "${oldName}")`;
    },
    roomRenamedTo: (newName: string) => `Room renamed to ${newName}`,
    social: "social",
    selectAWorkspace: "Select a workspace",
    growlMessageOnRenameError:
      "Unable to rename workspace room. Please check your connection and try again.",
    visibilityOptions: {
  ...
  workspaceActions: {
    ...
    changedCompanyAddress: ({
      ...
      previousAddress
        ? `changed the company address to "${newAddress}" (previously "${previousAddress}")`
        : `set the company address to "${newAddress}"`,
    addApprovalRule: (
      ...
      `added ${approverName} (${approverEmail}) as an approver for the ${field} "${name}"`,
    deleteApprovalRule: (
      approverEmail: string,
      approverName: string,
      field: string,
    ...
    addCategory: (categoryName: string) =>
      `added the category "${categoryName}"`,
    deleteCategory: (categoryName: string) =>
      `removed the category "${categoryName}"`,
    updateCategory: (categoryName: string, oldValue: boolean) =>
      `${oldValue ? "disabled" : "enabled"} the category "${categoryName}"`,
    ...
    setCategoryName: (oldName: string, newName: string) =>
      `renamed the category "${oldName}" to "${newName}"`,
    ...
    updateTagListName: (oldName: string, newName: string) =>
      `changed the tag list name to "${newName}" (previously "${oldName}")`,
    updateTagList: ({ tagListName }: UpdatedPolicyTagListParams) =>
      `updated tags on the list "${tagListName}"`,
    updateTagListRequired: ({
      tagListsName,
      isRequired,
    }: UpdatedPolicyTagListRequiredParams) =>
      `changed tag list "${tagListsName}" to ${isRequired ? "required" : "not required"}`,
    ...
    addTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `added the tag "${tagName}" to the list "${tagListName}"`,
    updateTagName: ({
      tagListName,
      newName,
      oldName,
    }: UpdatedPolicyTagNameParams) =>
      `updated the tag list "${tagListName}" by changing the tag "${oldName}" to "${newName}"`,
    updateTagEnabled: ({
      tagListName,
      tagName,
      enabled,
    }: UpdatedPolicyTagParams) =>
      `${enabled ? "enabled" : "disabled"} the tag "${tagName}" on the list "${tagListName}"`,
    deleteTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `removed the tag "${tagName}" from the list "${tagListName}"`,
    deleteMultipleTags: ({ count, tagListName }: UpdatedPolicyTagParams) =>
      `removed "${count}" tags from the list "${tagListName}"`,
    updateTag: ({
      tagListName,
      newValue,
      tagName,
    ...
    updateCustomUnitTaxEnabled: ({
      ...
      `${newValue ? "enabled" : "disabled"} tax tracking on distance rates`,
    ...
    importCustomUnitRates: ({
      ...
      `imported rates for custom unit "${customUnitName}"`,
    addCustomUnitRate: (customUnitName: string, rateName: string) =>
      `added a new ${customUnitName} rate "${rateName}"`,
    deleteCustomUnitRate: ({
      customUnitName,
      rateName,
    }: AddOrDeletePolicyCustomUnitRateParams) =>
      `removed the "${customUnitName}" rate "${rateName}"`,
    ...
    addedReportField: ({
      ...
      `added ${fieldType} Report Field "${fieldName}"`,
    ...
    updateReportFieldDefaultValue: ({
      ...
      `set the default value of report field "${fieldName}" to "${defaultValue}"`,
    addedReportFieldOption: (fieldName: string, optionName: string) =>
      `added the option "${optionName}" to the report field "${fieldName}"`,
    removedReportFieldOption: (fieldName: string, optionName: string) =>
      `removed the option "${optionName}" from the report field "${fieldName}"`,
    ...
    deleteReportField: ({
      ...
      fieldType: string;
      fieldName?: string;
    }) => `removed ${fieldType} Report Field "${fieldName}"`,
    preventSelfApproval: ({
      oldValue,
      newValue,
    }: UpdatedPolicyPreventSelfApprovalParams) =>
    ...
    updateDefaultBillable: (oldValue: string, newValue: string) =>
      `updated "Re-bill expenses to clients" to "${newValue}" (previously "${oldValue}")`,
    updateDefaultReimbursable: (oldValue: string, newValue: string) =>
      `updated "Cash expense default" to "${newValue}" (previously "${oldValue}")`,
    updateDefaultTitleEnforced: (value: boolean) =>
      `turned "Enforce default report titles" ${value ? "on" : "off"}`,
    ...
    renamedWorkspaceNameAction: (oldName: string, newName: string) =>
      `updated the name of this workspace to "${newName}" (previously "${oldName}")`,
    ...
    updatedWorkspaceCurrencyAction: (
      ...
      `updated the default currency to ${newCurrency} (previously ${oldCurrency})`,
    ...
    updateApprovalMode: ({ newValue, oldValue }: ChangeFieldParams) =>
      `updated the approval mode to "${newValue}" (previously "${oldValue}")`,
    ...
    addBudget: ({
      ...
      const thresholdSuffix =
        typeof notificationThreshold === "number"
          ? ` with notification threshold of "${notificationThreshold}%"`
          : "";
    ...
    updateBudget: ({
      ...
      if (frequencyChanged) {
        changesList.push(
          `changed budget frequency to "${newFrequency}" (previously "${oldFrequency}")`,
        );
      }

      if (sharedChanged) {
        changesList.push(
          `changed total workspace budget to "${newShared}" (previously "${oldShared}")`,
        );
      }

      if (individualChanged) {
        changesList.push(
          `changed individual budget to "${newIndividual}" (previously "${oldIndividual}")`,
        );
      }

      if (thresholdChanged) {
        changesList.push(
          `changed notification threshold to "${newNotificationThreshold}%" (previously "${oldNotificationThreshold}%")`,
        );
      }
    ...
    }) => `added "${prohibitedExpense}" to prohibited expenses`,
    removedProhibitedExpense: ({
      prohibitedExpense,
    }: {
      prohibitedExpense: string;
    }) => `removed "${prohibitedExpense}" from prohibited expenses`,
    ...
    setAutoJoin: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "enabled" : "disabled"} pre-approval of workspace join requests`,
    updatedDefaultTitle: ({
      newDefaultTitle,
      oldDefaultTitle,
    }: UpdatedPolicyDefaultTitleParams) =>
    ...
    updatedOwnership: ({
      ...
      `took over ownership of ${policyName} from ${oldOwnerName} (${oldOwnerEmail})`,
    updatedAutoHarvesting: ({ enabled }: UpdatedPolicyAutoHarvestingParams) =>
      `${enabled ? "enabled" : "disabled"} scheduled submit`,
    ...
    updatedAttendeeTracking: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "enabled" : "disabled"} attendee tracking`,
    updatedAutoPayApprovedReports: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "enabled" : "disabled"} auto-pay approved reports`,
    setAutoPayApprovedReportsLimit: ({ newLimit }: { newLimit: string }) =>
      `set the auto-pay approved reports threshold to "${newLimit}"`,
    ...
    removedAutoPayApprovedReportsLimit:
      "removed the auto-pay approved reports threshold",
    changedDefaultApprover: ({
      ...
      previousApprover
        ? `changed the default approver to ${newApprover} (previously ${previousApprover})`
        : `changed the default approver to ${newApprover}`,
    ...
    changedInvoiceCompanyName: ({
      ...
      oldValue
        ? `changed the invoice company name to "${newValue}" (previously "${oldValue}")`
        : `set the invoice company name to "${newValue}"`,
    changedInvoiceCompanyWebsite: ({
      ...
      oldValue
        ? `changed the invoice company website to "${newValue}" (previously "${oldValue}")`
        : `set the invoice company website to "${newValue}"`,
    changedReimburser: ({
      newReimburser,
      previousReimburser,
    }: UpdatedPolicyReimburserParams) =>
      previousReimburser
        ? `changed the authorized payer to "${newReimburser}" (previously "${previousReimburser}")`
        : `changed the authorized payer to "${newReimburser}"`,
    updateReimbursementEnabled: ({
      enabled,
    }: UpdatedPolicyReimbursementEnabledParams) =>
      `${enabled ? "enabled" : "disabled"} reimbursements`,
    updateCustomTaxName: ({
      oldName,
      newName,
    }: UpdatedPolicyCustomTaxNameParams) =>
      `changed the custom tax name to "${newName}" (previously "${oldName}")`,
    updateCurrencyDefaultTax: ({
      oldName,
      newName,
    }: UpdatedPolicyCurrencyDefaultTaxParams) =>
      `changed the workspace currency default tax rate to "${newName}" (previously "${oldName}")`,
    ...
    addTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `added the tax "${taxName}"`,
    deleteTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `removed the tax "${taxName}"`,
    updateTax: ({
      oldValue,
      taxName,
      updatedField,
    ...
    setReceiptRequiredAmount: (newValue: string) =>
      `set receipt required amount to "${newValue}"`,
    changedReceiptRequiredAmount: (oldValue: string, newValue: string) =>
      `changed receipt required amount to "${newValue}" (previously "${oldValue}")`,
    removedReceiptRequiredAmount: (oldValue: string) =>
      `removed receipt required amount (previously "${oldValue}")`,
    setMaxExpenseAmount: (newValue: string) =>
      `set max expense amount to "${newValue}"`,
    changedMaxExpenseAmount: (oldValue: string, newValue: string) =>
      `changed max expense amount to "${newValue}" (previously "${oldValue}")`,
    removedMaxExpenseAmount: (oldValue: string) =>
      `removed max expense amount (previously "${oldValue}")`,
    setMaxExpenseAge: (newValue: string) =>
      `set max expense age to "${newValue}" days`,
    changedMaxExpenseAge: (oldValue: string, newValue: string) =>
      `changed max expense age to "${newValue}" days (previously "${oldValue}")`,
    removedMaxExpenseAge: (oldValue: string) =>
      `removed max expense age (previously "${oldValue}" days)`,
  },
  roomMembersPage: {
    memberNotFound: "Member not found.",
    useInviteButton:
      "To invite a new member to the chat, please use the invite button above.",
    ...
    removeMembersPrompt: ({ memberName }: { memberName: string }) => ({
      ...
      other:
        "Are you sure you want to remove the selected members from the room?",
    }),
    error: {
  ...
  newTaskPage: {
    ...
    pleaseEnterTaskDestination:
      "Please select where you want to share this task",
  },
  task: {
    task: "Task",
    title: "Title",
    ...
    assigneeError:
      "An error occurred while assigning this task. Please try another assignee.",
    genericCreateTaskFailureMessage:
      "There was an error creating this task. Please try again later.",
  ...
  search: {
    ...
    searchResults: {
      ...
      emptyExpenseResults: {
        ...
        subtitleWithOnlyCreateButton:
          "Use the green button below to create an expense.",
      },
      emptyReportResults: {
        ...
        subtitleWithOnlyCreateButton:
          "Use the green button below to create a report.",
      },
      emptyInvoiceResults: {
        title: dedent(`
                ...
                `),
        subtitle:
          "Send an invoice or take a test drive of Expensify to learn more.",
        subtitleWithOnlyCreateButton:
          "Use the green button below to send an invoice.",
      },
      emptyTripResults: {
    ...
    bulkActions: {
      ...
      reject: "Reject",
      noOptionsAvailable:
        "No options available for the selected group of expenses.",
    },
    ...
    filters: {
      ...
      card: {
        ...
        cardFeedNameCSV: ({ cardFeedLabel }: { cardFeedLabel?: string }) =>
          `All CSV Imported Cards${cardFeedLabel ? ` - ${cardFeedLabel}` : ""}`,
      },
    ...
    exportSearchResults: {
      title: "Create export",
      description:
        "Whoa, that's a lot of items! We'll bundle them up, and Concierge will send you a file shortly.",
    },
  ...
  fileDownload: {
    success: {
      ...
      qrMessage:
        "Check your photos or downloads folder for a copy of your QR code. Protip: Add it to a presentation for your audience to scan and connect with you directly.",
    },
    generalError: {
  ...
  settlement: {
    ...
    failedError: ({ link }: { link: string }) =>
      `We'll retry this settlement when you <a href="${link}">unlock your account</a>.`,
    withdrawalInfo: ({
      date,
      withdrawalID,
    }: {
      date: string;
      withdrawalID: number;
    }) => `${date} • Withdrawal ID: ${withdrawalID}`,
  },
  reportLayout: {
    ...
    selectGroup: ({ groupName }: { groupName: string }) =>
      `Select all expenses in ${groupName}`,
    groupBy: {
      category: "Category",
      tag: "Tag",
    },
  ...
  report: {
    ...
    genericCreateReportFailureMessage:
      "Unexpected error creating this chat. Please try again later.",
    genericAddCommentFailureMessage:
      "Unexpected error posting the comment. Please try again later.",
    genericUpdateReportFieldFailureMessage:
      "Unexpected error updating the field. Please try again later.",
    genericUpdateReportNameEditFailureMessage:
      "Unexpected error renaming the report. Please try again later.",
    noActivityYet: "No activity yet",
    connectionSettings: "Connection Settings",
    actions: {
      type: {
        changeField: ({ oldValue, newValue, fieldName }: ChangeFieldParams) =>
          `changed ${fieldName} to "${newValue}" (previously "${oldValue}")`,
        ...
        changeType: (oldType: string, newType: string) =>
          `changed type from ${oldType} to ${newType}`,
        ...
        exportedToIntegration: {
          ...
          manual: (label: string) =>
            `marked this report as manually exported to ${label}.`,
          ...
          pending: (label: string) =>
            `started exporting this report to ${label}...`,
        },
        integrationsMessage: (
          errorMessage: string,
          label: string,
        ...
        markedReimbursed: (amount: string, currency: string) =>
          `paid ${currency}${amount} elsewhere`,
        markedReimbursedFromIntegration: ({
          amount,
          currency,
        }: MarkReimbursedFromIntegrationParams) =>
          `paid ${currency}${amount} via integration`,
        ...
        addEmployee: (email: string, role: string) =>
          `added ${email} as ${role === "member" ? "a" : "an"} ${role}`,
        updateRole: ({ email, currentRole, newRole }: UpdateRoleParams) =>
          `updated the role of ${email} to ${newRole} (previously ${currentRole})`,
        updatedCustomField1: (
          email: string,
          newValue: string,
          ...
          return !previousValue
            ? `added "${newValue}" to ${email}’s custom field 1`
            : `changed ${email}’s custom field 1 to "${newValue}" (previously "${previousValue}")`;
        },
        updatedCustomField2: (
          email: string,
          newValue: string,
          ...
          return !previousValue
            ? `added "${newValue}" to ${email}’s custom field 2`
            : `changed ${email}’s custom field 2 to "${newValue}" (previously "${previousValue}")`;
        },
        leftWorkspace: (nameOrEmail: string) =>
          `${nameOrEmail} left the workspace`,
        removeMember: (email: string, role: string) =>
          `removed ${role} ${email}`,
        removedConnection: ({ connectionName }: ConnectionNameParams) =>
          `removed connection to ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        addedConnection: ({ connectionName }: ConnectionNameParams) =>
          `connected to ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        leftTheChat: "left the chat",
        leftTheChatWithName: (nameOrEmail: string) =>
          `${nameOrEmail ? `${nameOrEmail}: ` : ""}left the chat`,
      ...
      error: {
        invalidCredentials:
          "Invalid credentials, please check the configuration of your connection.",
      },
    },
  },
  chronos: {
    oooEventSummaryFullDay: (summary: string, dayCount: number, date: string) =>
      `${summary} for ${dayCount} ${dayCount === 1 ? "day" : "days"} until ${date}`,
  ...
  moderation: {
    flagDescription:
      "All flagged messages will be sent to a moderator for review.",
    ...
    inconsiderateDescription:
      "Insulting or disrespectful phrasing, with questionable intentions",
    intimidation: "Intimidation",
    intimidationDescription:
      "Aggressively pursuing an agenda over valid objections",
    bullying: "Bullying",
    bullyingDescription: "Targeting an individual to obtain obedience",
    harassment: "Harassment",
    harassmentDescription:
      "Racist, misogynistic, or other broadly discriminatory behavior",
    assault: "Assault",
    assaultDescription:
      "Specifically targeted emotional attack with the intention of harm",
    flaggedContent:
      "This message has been flagged as violating our community rules and the content has been hidden.",
    hideMessage: "Hide message",
    revealMessage: "Reveal message",
    levelOneResult:
      "Sends anonymous warning and message is reported for review.",
    levelTwoResult:
      "Message hidden from channel, plus anonymous warning and message is reported for review.",
    levelThreeResult:
      "Message removed from channel plus anonymous warning and message is reported for review.",
  },
  ...
  teachersUnitePage: {
    ...
    getInTouch:
      "Excellent! Please share their information so we can get in touch with them.",
  ...
  distance: {
    ...
    odometer: {
      ...
      deleteOdometerPhotoConfirmation:
        "Are you sure you want to delete this odometer photo?",
      startMessageWeb:
        "Add a photo of your odometer from the <strong>start</strong> of your trip. Drag a file here or choose one to upload.",
      endMessageWeb:
        "Add a photo of your odometer from the <strong>end</strong> of your trip. Drag a file here or choose one to upload.",
      cameraAccessRequired: "Camera access is required to take pictures.",
      snapPhotoStart:
        "<muted-text-label>Snap a photo of your odometer at the <strong>start</strong> of your trip.</muted-text-label>",
      snapPhotoEnd:
        "<muted-text-label>Snap a photo of your odometer at the <strong>end</strong> of your trip.</muted-text-label>",
    },
  },
  gps: {
    error: {
    ...
    discardDistanceTrackingModal: {
      ...
      prompt:
        "Are you sure? This will discard your current journey and can't be undone.",
      confirm: "Discard distance tracking",
    },
    zeroDistanceTripModal: {
      title: "Can't create expense",
      prompt:
        "You can't create an expense with the same start and stop location.",
    },
    locationRequiredModal: {
      title: "Location access required",
      prompt:
        "Please allow location access in your device settings to start GPS distance tracking.",
      allow: "Allow",
    },
    androidBackgroundLocationRequiredModal: {
      title: "Background location access required",
      prompt:
        'Please allow background location access in your device settings ("Allow all the time" option) to start GPS distance tracking.',
    },
    preciseLocationRequiredModal: {
      title: "Precise location required",
      prompt:
        'Please enable "precise location" in your device settings to start GPS distance tracking.',
    },
    desktop: {
      title: "Track distance on your phone",
      subtitle:
        "Log miles or kilometers automatically with GPS and turn trips into expenses instantly.",
    ...
    continueGpsTripModal: {
      ...
      prompt:
        "Looks like the app closed during your last GPS trip. Would you like to continue recording from that trip?",
    ...
    switchToODWarningTripInProgress: {
      title: "GPS tracking in progress",
      prompt:
        "Are you sure you want to stop GPS tracking and switch to Expensify Classic?",
  ...
  reportCardLostOrDamaged: {
    ...
    confirmAddressTitle:
      "Please confirm the mailing address for your new card.",
    cardDamagedInfo:
      "Your new card will arrive in 2-3 business days. Your current card will continue to work until you activate your new one.",
    cardLostOrStolenInfo:
      "Your current card will be permanently deactivated as soon as your order is placed. Most cards arrive in a few business days.",
    address: "Address",
    ...
    successDescription:
      "You'll need to activate it once it arrives in a few business days. In the meantime, you can use a virtual card.",
  },
  eReceipt: {
  ...
  referralProgram: {
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
      buttonText:
        "Start a chat, <success><strong>refer a friend</strong></success>.",
    ...
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
      buttonText:
        "Submit an expense, <success><strong>refer your team</strong></success>.",
  ...
  violations: {
    ...
    invoiceMarkup: ({ invoiceMarkup }: ViolationsInvoiceMarkupParams) =>
      `Marked up by ${invoiceMarkup}%`,
    maxAge: ({ maxAge }: ViolationsMaxAgeParams) =>
      `Date older than ${maxAge} days`,
    ...
    overAutoApprovalLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Expense exceeds auto-approval limit of ${formattedLimit}`,
    overCategoryLimit: ({
      formattedLimit,
    }: ViolationsOverCategoryLimitParams) =>
      `Amount over ${formattedLimit}/person category limit`,
    overLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Amount over ${formattedLimit}/person limit`,
    overTripLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Amount over ${formattedLimit}/trip limit`,
    overLimitAttendee: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Amount over ${formattedLimit}/person limit`,
    perDayLimit: ({ formattedLimit }: ViolationsPerDayLimitParams) =>
      `Amount over daily ${formattedLimit}/person category limit`,
    ...
    itemizedReceiptRequired: ({
      ...
      `Itemized receipt required${formattedLimit ? ` over ${formattedLimit}` : ""}`,
    prohibitedExpense: ({
    ...
    rter: ({
      ...
      if (!isTransactionOlderThan7Days) {
        return isAdmin
          ...
          : "Awaiting merge with card transaction.";
      }
    ...
    memberBrokenConnectionError:
      "Receipt pending due to broken bank connection. Please ask a workspace admin to resolve.",
    markAsCashToIgnore: "Mark as cash to ignore and request payment.",
    smartscanFailed: ({ canEdit = true }) =>
      `Receipt scanning failed.${canEdit ? " Enter details manually." : ""}`,
  ...
  reportViolations: {
    ...
    reportContainsExpensesWithViolations:
      "Report contains expenses with violations.",
  },
  violationDismissal: {
    rter: {
  ...
  exitSurvey: {
    ...
    reasonPage: {
      ...
      subtitle:
        "Before you go, please tell us why you’d like to switch to Expensify Classic.",
    },
    reasons: {
      ...
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "I don't understand how to use New Expensify.",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "I understand how to use New Expensify, but I prefer Expensify Classic.",
    },
    prompts: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
      ...
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Why do you prefer Expensify Classic?",
    },
    ...
    bookACallTextBottom:
      "We’d be excited to get on a call with you to understand why. You can book a call with one of our senior product managers to discuss your needs.",
  ...
  subscription: {
    ...
    mobileReducedFunctionalityMessage:
      "You can’t make changes to your subscription in the mobile app.",
    badge: {
      freeTrial: (numOfDays: number) =>
        `Free trial: ${numOfDays} ${numOfDays === 1 ? "day" : "days"} left`,
    },
    billingBanner: {
      policyOwnerAmountOwed: {
        title: "Your payment info is outdated",
        subtitle: (date: string) =>
          `Update your payment card by ${date} to continue using all of your favorite features.`,
      },
      ...
      policyOwnerUnderInvoicing: {
        title: "Your payment info is outdated",
        subtitle: (date: string) =>
          `Your payment is past due. Please pay your invoice by ${date} to avoid service interruption.`,
      },
      ...
      cardExpired: {
        title: "Your card couldn’t be charged",
        subtitle: (amountOwed: number) =>
          `Your payment card expired. Please add a new payment card to clear your ${amountOwed} outstanding balance.`,
      },
      cardExpireSoon: {
      ...
      retryBillingError: {
        title: "Your card couldn’t be charged",
        subtitle:
          "Before retrying, please call your bank directly to authorize Expensify charges and remove any holds. Otherwise, try adding a different payment card.",
      },
      ...
      preTrial: {
        ...
        subtitle:
          'As a next step, <a href="#">complete your setup checklist</a> so your team can start expensing.',
      },
      trialStarted: {
        title: (numOfDays: number) =>
          `Trial: ${numOfDays} ${numOfDays === 1 ? "day" : "days"} left!`,
        subtitle:
          "Add a payment card to continue using all of your favorite features.",
      },
      trialEnded: {
      ...
      earlyDiscount: {
        ...
        onboardingChatTitle: (discountType: number) =>
          `Limited-time offer: ${discountType}% off your first year!`,
        subtitle: (
          days: number,
          hours: number,
          minutes: number,
          ...
          `Claim within ${days > 0 ? `${days}d : ` : ""}${hours}h : ${minutes}m : ${seconds}s`,
      },
    },
    cardSection: {
      title: "Payment",
      ...
      cardInfo: (name: string, expiration: string, currency: string) =>
        `Name: ${name}, Expiration: ${expiration}, Currency: ${currency}`,
      cardNextPayment: (nextPaymentDate: string) =>
        `Your next payment date is ${nextPaymentDate}.`,
    ...
    yourPlan: {
      ...
      asLowAs: ({ price }: YourPlanPriceValueParams) =>
        `as low as ${price} per active member/month`,
      ...
      collect: {
        title: "Collect",
        description:
          "The small business plan that gives you expense, travel, and chat.",
        priceAnnual: ({ lower, upper }: YourPlanPriceParams) =>
          `From ${lower}/active member with the Expensify Card, ${upper}/active member without the Expensify Card.`,
      ...
      saveWithExpensifyDescription:
        "Use our savings calculator to see how cash back from the Expensify Card can reduce your Expensify bill.",
    ...
    details: {
      ...
      zeroCommitment:
        "Zero commitment at the discounted annual subscription rate",
    },
    subscriptionSize: {
      title: "Subscription size",
      yourSize:
        "Your subscription size is the number of open seats that can be filled by any active member in a given month.",
      eachMonth:
      ...
      error: {
        ...
        sameSize:
          "Please enter a number different than your current subscription size",
      },
    },
    paymentCard: {
      addPaymentCard: "Add payment card",
      ...
      security:
        "Expensify is PCI-DSS compliant, uses bank-level encryption, and utilizes redundant infrastructure to protect your data.",
    ...
    subscriptionSettings: {
      ...
      saveUpTo: (amountWithCurrency: string) =>
        `Save up to ${amountWithCurrency}/month per active member`,
      ...
      pricingConfiguration:
        "Pricing depends on configuration. For the lowest price, choose an annual subscription and get the Expensify Card.",
      ...
      changesBasedOn:
        "This changes based on your Expensify Card usage and the subscription options below.",
    },
  ...
  delegate: {
    ...
    youCanAccessTheseAccounts:
      "You can access these accounts via the account switcher:",
    ...
    accessLevelDescription:
      "Choose an access level below. Both Full and Limited access allow copilots to view all conversations and expenses.",
    ...
    enterMagicCode: (contactMethod: string) =>
      `Please enter the magic code sent to ${contactMethod} to add a copilot. It should arrive within a minute or two.`,
    enterMagicCodeUpdate: (contactMethod: string) =>
      `Please enter the magic code sent to ${contactMethod} to update your copilot.`,
  ...
  debug: {
    ...
    invalidProperty: ({ propertyName, expectedType }: InvalidPropertyParams) =>
      `Invalid property: ${propertyName} - Expected: ${expectedType}`,
    invalidValue: ({ expectedValues }: InvalidValueParams) =>
      `Invalid value - Expected: ${expectedValues}`,
    ...
    reasonGBR: {
      ...
      isWaitingForAssigneeToCompleteAction:
        "Is waiting for assignee to complete action",
  ...
  migratedUserWelcomeModal: {
    ...
    subtitle:
      "It's got everything you love from our classic experience with a whole bunch of upgrades to make your life even easier:",
  ...
  productTrainingTooltip: {
    ...
    saveSearchTooltip:
      "<tooltip><strong>Rename your saved searches</strong> here!</tooltip>",
    accountSwitcher:
      "<tooltip>Access your <strong>Copilot accounts</strong> here</tooltip>",
    scanTestTooltip: {
      main: "<tooltip><strong>Scan our test receipt</strong> to see how it works!</tooltip>",
      manager:
        "<tooltip>Choose our <strong>test manager</strong> to try it out!</tooltip>",
      confirmation:
        "<tooltip>Now, <strong>submit your expense</strong> and watch the\nmagic happen!</tooltip>",
      tryItOut: "Try it out",
    },
    outstandingFilter:
      "<tooltip>Filter for expenses\nthat <strong>need approval</strong></tooltip>",
    scanTestDriveTooltip:
      "<tooltip>Send this receipt to\n<strong>complete the test drive!</strong></tooltip>",
    gpsTooltip:
      "<tooltip>GPS tracking in progress! When you're done, stop tracking below.</tooltip>",
    hasFilterNegation:
      "<tooltip>Search for expenses without receipts using <strong>-has:receipt</strong>.</tooltip>",
  },
  ...
  scheduledCall: {
    book: {
      ...
      slots: ({ date }: { date: string }) =>
        `<muted-text>Available times for <strong>${date}</strong></muted-text>`,
    },
    confirmation: {
      title: "Confirm call",
      description:
        "Make sure the details below look good to you. Once you confirm the call, we'll send an invite with more info.",
  ...
  autoSubmitModal: {
    ...
    submittedExpensesDescription:
      "These expenses have been sent to your approver but can still be edited until they are approved.",
    pendingExpensesTitle: "Pending expenses have been moved",
    pendingExpensesDescription:
      "Any pending card expenses have been moved to a separate report until they post.",
  },
  testDrive: {
    quickAction: {
    ...
    modal: {
      ...
      employee: {
        ...
        error:
          "That member owns a workspace, please input a new member to test.",
      },
    },
    banner: {
  ...
  domain: {
    ...
    verifyDomain: {
      ...
      beforeProceeding: ({ domainName }: { domainName: string }) =>
        `Before proceeding, verify that you own <strong>${domainName}</strong> by updating its DNS settings.`,
      accessYourDNS: ({ domainName }: { domainName: string }) =>
        `Access your DNS provider and open DNS settings for <strong>${domainName}</strong>.`,
      ...
      warning:
        "After verification, all Expensify members on your domain will receive an email that their account will be managed under your domain.",
      codeFetchError: "Couldn’t fetch verification code",
      genericError:
        "We couldn't verify your domain. Please try again and reach out to Concierge if the problem persists.",
    },
    domainVerified: {
    ...
    samlLogin: {
      ...
      anyMemberWillBeRequired:
        "Any member signed in with a different method will be required to re-authenticate using SAML.",
      ...
      requireWithEmptyMetadataError:
        "Please add Identity Provider metadata below to enable",
    ...
    accessRestricted: {
      ...
      subtitle: (domainName: string) =>
        `Please verify yourself as an authorized company administrator for <strong>${domainName}</strong> if you need control over:`,
    ...
    addDomain: {
      title: "Add domain",
      subtitle:
        "Enter the name of the private domain you want to access (e.g. expensify.com).",
    ...
    domainAdded: {
      title: "Domain added",
      description:
        "Next, you'll need to verify ownership of the domain and adjust your security settings.",
      configure: "Configure",
    },
    enhancedSecurity: {
    ...
    admins: {
      ...
      setPrimaryContactError:
        "Unable to set primary contact. Please try again later.",
      ...
      consolidatedDomainBillingError:
        "Consolidated domain billing couldn't be changed. Please try again later.",
      addAdmin: "Add admin",
      ...
      cantRevokeAdminAccess:
        "Can't revoke admin access from the technical contact",
      error: {
        removeAdmin:
          "Unable to remove this user as an Admin. Please try again.",
      ...
      resetDomainExplanation: ({ domainName }: { domainName?: string }) =>
        `Please type <strong>${domainName}</strong> to confirm the domain reset.`,
    ...
    members: {
      ...
      closeAccountInfo: () => ({
        ...
        other:
          "We recommend closing the accounts safely to skip closing it in case there are: <bullet-list><bullet-item>Pending approvals</bullet-item><bullet-item>Active reimbursements</bullet-item><bullet-item>No alternative login methods</bullet-item></bullet-list>Otherwise, you can ignore the safety precautions above and force close the selected accounts.",
      }),
      closeAccount: () => ({
        one: "Close account",
      ...
      error: {
        ...
        vacationDelegate:
          "Unable to set this user as a vacation delegate. Please try again.",
      },
      cannotSetVacationDelegateForMember: (email: string) =>
        `You can't set a vacation delegate for ${email} because they're currently the delegate for the following members:`,
    ...
    common: {
      ...
      forceTwoFactorAuthError:
        "Force two-factor authentication couldn't be changed. Please try again later.",
