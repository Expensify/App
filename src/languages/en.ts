...
const translations = {
    ...
    expenseRulesPage: {
        ...
        changes: {
            updateBillable: (value: boolean) => `Update expense ${value ? 'billable' : 'non-billable'}`,
            updateCategory: (value: string) => `Update category to "${value}"`,
            updateComment: (value: string) => `Update description to "${value}"`,
            updateMerchant: (value: string) => `Update merchant to "${value}"`,
            updateReimbursable: (value: boolean) => `Update expense ${value ? 'reimbursable' : 'non-reimbursable'}`,
            updateTag: (value: string) => `Update tag to "${value}"`,
            updateTax: (value: string) => `Update tax rate to "${value}"`,
