...
const translations = {
    ...
    reportAction: {
        ...
        createdReportForUnapprovedTransactions: (reportUrl: string, reportName: string) => `created this report for any held expenses from <a href="${reportUrl}">${reportName}</a>`,
    },
    mentionSuggestions: {
