    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            simulate3DSPendingTransaction: {
                ...
                card: 'Card',
                selectedCardAccessibilityLabel: 'Selected card',
                noActiveExpensifyCard: 'No active Expensify card',
                cardEndingIn: (lastFour: string) => `Card ending in ${lastFour}`,
                runScriptedQAFlows: 'Run scripted QA flows',
                ...
                outcome: 'Outcome',
                outcomeApproveOrDeny: 'Approve/Deny (normal)',
                outcomeMarqetaError: 'Marqeta error on result',
                outcomeAlreadyApproved: 'Already approved error',
                outcomeAlreadyDenied: 'Already denied error',
                merchantPlaceholder: 'Enter merchant name',
                merchantAccessibilityLabel: 'Merchant name',
                amountAndCurrency: 'Amount & currency',
                amountAccessibilityLabel: 'Amount input field',
                delayBeforeDelivery: 'Delay before delivery (sec)',
                delayAccessibilityLabel: 'Delay in seconds before delivering challenge',
                expiresAfter: 'Expires after (min)',
                ...
                createdTimePlaceholder: 'Leave empty for current time',
                createdTimeAccessibilityLabel: 'Created time override',
                createdTimeDescription: 'Format: ISO 8601 UTC (e.g. 2024-01-15T10:30:00.000Z). Leave empty for most cases — only set this to backdate the transaction.',
            },
        },
        security: 'Security',
        signOut: 'Sign out',
