...
const translations = {
    ...
    cardPage: {
        ...
        cardUnlockedDescription: 'You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: 'Your card was locked due to incorrect PIN entries.',
        unlock: 'Unlock',
