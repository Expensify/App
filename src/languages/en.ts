...
const translations = {
    ...
    onboarding: {
        ...
        messages: {
            ...
            onboardingManageTeamMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) => isOnboardingFlow ? 
            ...
            onboardingTrackWorkspaceMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) => isOnboardingFlow ?
