...
const translations = {
    ...
    receipt: {
        ...
        deniedCameraAccess: `<centered-text>Camera access still hasn't been granted, please follow <a href="${CONST.DENIED_CAMERA_ACCESS_INSTRUCTIONS_URL}">these instructions</a>.</centered-text>`,
