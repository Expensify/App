...
const translations = {
    ...
    iou: {
        ...
        error: {
            ...
            receiptFailureMessage: '<rbr>There was an error uploading your receipt. Please <a href="retry">try again</a> or <a href="download">save the receipt</a> to upload later.</rbr>',
