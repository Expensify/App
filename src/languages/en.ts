...
const translations = {
    ...
    privatePersonalDetails: {
        ...
        enterPinCode: 'Set the PIN for your card.',
        verifyPinCode: 'Enter your PIN again to confirm.',
        ...
        error: {
            ...
            invalidPinCode: 'PIN can only include arabic numerals and has to be exactly 4 digits long',
            mismatchOfPinCodes: 'The PIN you entered does not match the one from first input. Please make sure the PINs match.',
        },
    },
