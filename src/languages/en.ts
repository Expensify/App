    ...
    workspace: {
        ...
        rules: {
            ...
            merchantRules: {
                ...
                clearIncompatibleDefaultsTitle: 'Clear the other defaults?',
                clearIncompatibleDefaultsPrompt: "These fields aren't compatible with category. Want to clear all fields?",
