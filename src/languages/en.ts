...
const translations = {
    ...
    workflowsPayerPage: {
        ...
        shareBankAccount: {
            ...
            errorDescription: ({admin, chatLink}: {admin: string; chatLink: string}) =>
                `${admin} doesn’t have access to this bank account, so you can’t make them the payer. <a href="${chatLink}">Chat with ${admin}</a> if the bank account should be shared.`,
        },
    },
    reportFraudPage: {
