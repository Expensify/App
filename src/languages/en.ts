...
export default {
    ...
    iou: {
        ...
        nextStep: 'Next Steps',
        finished: 'Finished',
        requestAmount: ({amount}: RequestAmountParams) => `request ${amount}`, // TODO: Need to update this
        requestedAmount: ({formattedAmount, comment}: RequestedAmountMessageParams) => `expense of ${formattedAmount}${comment ? ` for ${comment}` : ''}`,
