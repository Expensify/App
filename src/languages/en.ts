...
const translations = {
    ...
    workspace: {
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `Invalid formula placeholder(s): ${placeholders}. Please use supported placeholders like {report:id}, {report:name}, {report:created}, etc.`,
