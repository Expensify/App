...
const translations = {
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthIsRequiredForAdminsDescription: 'Your Xero accounting connection requires two-factor authentication.\nTo continue using Expensify, please enable it.',
