...
const translations = {
    ...
    onboarding: {
        ...
        peopleYouMayKnow: 'See if your team is already here',
        workspaceYouMayJoin: (domain: string, email: string) => `Verify your email to check if anyone from ${domain} has a workspace you can join. Enter the magic code sent to ${email}.`,
