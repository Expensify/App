...
const translations = {
    ...
    multifactorAuthentication: {
        ...
        biometricsTest: {
            ...
            troubleshootBiometricsStatus: (registered?: boolean) => `Biometrics (${registered ? 'Registered' : 'Not registered'})`,
    ...
    nextStep: {
        message: {
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.NO_FURTHER_ACTION]: () => `No further action required!`,
