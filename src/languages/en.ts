...
const translations = {
    ...
    iou: {
        ...
        dynamicExternalWorkflowCannotSubmit: "This report can't be submitted. Please review the comments to resolve.",
        ...
        error: {
            ...
            genericDEWSubmitFailureMessage: 'Dynamic External Workflow submission failed',
