...
const translations = {
    ...
    domain: {
        ...
        admins: {
            ...
            consolidatedDomainBillingDescription: (domainName: string) => `When enabled, the primary contact will pay for all workspaces owned by <strong>${domainName}</strong> members and receive all billing receipts.`,
