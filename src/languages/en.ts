    ...
    workspace: {
        ...
        changeOwner: {
            ...
            addPaymentCardReadAndAcceptText: ({termsURL, privacyURL}: AddPaymentCardReadAndAcceptRouteParams) =>
                `<comment><muted-text-label>Read and accept <a href="${termsURL}" style="text-decoration-line: none;">terms</a> & <a href="${privacyURL}" style="text-decoration-line: none;">privacy</a> policy to add your card</muted-text-label></comment>`,
