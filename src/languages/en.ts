...
export default {
    ...
    loungeAccessPage: {
        ...
        noCheckInsLeftFirstPart: 'No more check-ins remaining this month',
        noCheckInsLeftSecondPart: ({nextCheckIn}: NoCheckInsLeftParams) => `, but you’ll be eligible to check in again ${nextCheckIn}.`,
