...
const translations = {
    ...
    contacts: {
        ...
        helpText: ({email}: {email: string}) =>
            `Add more ways to log in and send receipts to Expensify.<br/><br/>Add an email address to forward receipts to <copy-text text="${email}">${email}</copy-text> or add a phone number to text receipts to 47777 (US numbers only).`,
