...
export default {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryUserRoomPartThree: ' It was created by ',
        beginningOfChatHistoryUserRoomPartFour: '.',
        ...
        beginningOfChatHistoryPartTwo: ' Ask questions and get 24/7 realtime support.',
        ...
        usePlusButton: ({additionalText, type}: UsePlusButtonParams) => `\n${additionalText ? `Use the + button to ${additionalText} an ${type ?? 'expense'}.` : 'Just use the + button.'}`,
        iouTypes: {
            pay: 'pay',
            split: 'split',
            submit: 'submit',
