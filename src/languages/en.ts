    ...
    workspace: {
        ...
        rules: {
            ...
            merchantRules: {
                ...
                ruleSummaryTitleContains: (merchantName: string) => `If merchant contains "${merchantName}"`,
                ruleSummaryTitleExact: (merchantName: string) => `If merchant is exactly "${merchantName}"`,
