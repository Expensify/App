...
const translations = {
    ...
    iou: {
        ...
        whatIsHoldTitle: "What's hold?",
        whatIsHoldExplain: 'Hold is the equivalent of pausing an expense right where it's at in the approval chain.',
        holdIsTemporaryTitle: 'Why is it used?',
        holdIsTemporaryExplain: "Hold is typically used to clear up confusion about an expense or clarify an important detail before approval or payment.",
        deleteHoldTitle: "What happens next?",
        deleteHoldExplain: "A held expense gets left behind upon report approval. It's added to future reports and falls off until the hold is removed.",
        set: 'set',
        changed: 'changed',
        removed: 'removed',
