...
export default {
    ...
    login: {
        hero: {
            header: 'Track, submit, and split expenses, and chat with friends.',
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: ' starts here! 🎉 This is the place to chat, submit expense and settle up.',
    ...
    iou: {
        ...
        expensedAmount: ({formattedAmount, comment}: RequestedAmountMessageParams) => `expensed ${formattedAmount}${comment ? ` for ${comment}` : ''}`,
        ...
        error: {
            ...
            genericCreateFailureMessage: 'Unexpected error creating the expense, please try again later',
            ...
            genericDeleteFailureMessage: 'Unexpected error deleting the expense, please try again later',
            genericEditFailureMessage: 'Unexpected error editing the expense, please try again later',
            ...
            splitExpenseMultipleParticipantsErrorMessage: 'Split expense is only allowed between a single workspace or individual users. Please update your selection.',
    ...
    closeAccountPage: {
        ...
        closeAccountPermanentlyDeleteData:
            'This will permanently delete all of your unsubmitted expense data and will cancel and decline any outstanding submitted expenses. Are you sure you want to delete the account?',
    ...
    referralProgram: {
        ...
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.MONEY_REQUEST]: {
            ...
            buttonText2: `get $${CONST.REFERRAL_PROGRAM.REVENUE}.`,
            header: `Submit expense, get $${CONST.REFERRAL_PROGRAM.REVENUE}`,
            body: `It pays to get paid! Submit expense from a new Expensify account and get $${CONST.REFERRAL_PROGRAM.REVENUE} when they become a customer.`,
        },
