...
const translations = {
    ...
    contacts: {
        ...
        helpText: ({email}: {email: string}) =>
            `Add more ways to log in and send receipts. Use an email address to forward receipts to <a href="mailto:${email}">${email}</a> or a phone number to text them to 47777 (US numbers only).`,
