    ...
    workspace: {
        ...
        rules: {
            ...
            merchantRules: {
                ...
                subtitle: 'Automatically update expense fields based on merchant name.',
                emptyTitle: 'No merchant rules',
                emptySubtitle: 'Create rules to automatically fill in expense details like category, tag, and more when a merchant name matches.',
                addRule: 'Add rule',
                merchantToMatch: 'Merchant to match',
                setCategory: 'Set category',
                setTag: 'Set tag',
                setDescription: 'Set description',
                setReimbursable: 'Set reimbursable',
                setBillable: 'Set billable',
                setTax: 'Set tax',
                renameMerchant: 'Rename merchant to',
                ruleAppliesWhen: ({merchantName}: {merchantName: string}) => `When merchant contains "${merchantName}"`,
                ruleAppliesWhenExact: ({merchantName}: {merchantName: string}) => `When merchant is "${merchantName}"`,
            },
            categoryRules: {
