                ...
                importCustomFields: {
                    ...
                    customSegments: {
                        ...
                        addForm: {
                            ...
                            segmentNameTitle: "What's the custom segment name?",
                            recordNameTitle: "What's the custom record name?",
                            segmentNameFooter: `You can find custom segment names in NetSuire under *Customizations > Links, Records & Fields > Custom Segments* page.\n\n_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                            recordNameFooter: `You can find custom record names in NetSuire by entering the "Transaction Column Field" in global search. For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                            internalIDTitle: "What's the internal ID?",
                            segmentInternalIDFooter: `First, make sure you've enabled internal IDs in NetSuire under *Home > Set Preferences > Show Internal ID.*\n\n You can find custom segment internal IDs in NetSuite under:\n\n1. *Customization > Lists, Records, & Fields > Custom Segments*. 2. Click into a custom segment. 3. Click the hyperlink next to *Custom Record Type*. 4. Find the internal ID in the table at the bottom.\n\n_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
                            recordInternalIDFooter: `You can find custom record internal IDs in NetSuite by following these steps:\n\n 1. Enter "Transaction Line Fields" in gloabl search. 2. Click into a customr record. 3. Find the internal ID on the left-hand side. For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                            segmentScriptIDTitle: "What's the script ID?",
                            segmentScriptIDFooter: `You can find custom segment script IDs in NetSuite under: \n\n1. *Customization > Lists, Records, & Fields > Custom Segments*. 2. Click into a custom segment. 3. Click the *Application and Sourcing* tab near the bottom, then:\n  a. If you want to display the custom segment as a *tag* (at the line-item level) in Expensify, click the *Transaction Columns* sub-tab and use the *Field ID*. b. If you want to display the custome segment as a *report field* (at the report level) in Expensify, click the *Transactions* sub-tab and use the *Field ID*.\n\n_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
                            recordtScriptIDTitle: "What's the transaction column ID?",
                            recordtScriptIDFooter: `You can find custom record script IDs in NetSuite under:\n\n 1. Enter "Transaction Line Fields" in global search. 2. Click into a custom record. 3. Find the script ID on the left-hand side.\n\nFor more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
