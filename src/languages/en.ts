...
import type {
    ...
    IntacctMappingTitleParams, // IntegrationExportParams,
    // IntegrationSyncFailedParams,
    InvalidPropertyParams,
    InvalidValueParams, // IssueVirtualCardParams,
    ...
    MissingPropertyParams, // MovedActionParams,
    // MovedFromPersonalSpaceParams,
    // MovedFromReportParams,
    // MovedTransactionParams,
    // NeedCategoryForExportToIntegrationParams,
    // NewWorkspaceNameParams,
    NextStepParams, // NoLongerHaveAccessParams,
...
const translations = {
    ...
    iou: {
        ...
        movedUnreportedTransaction: (reportUrl: string) => `moved this expense from your <a href="${reportUrl}">personal space</a>`,
