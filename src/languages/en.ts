...
const translations = {
    ...
    violations: {
        ...
        receiptNotSmartScanned: 'Receipt not smart scanned because the expense was created manually. Please verify the details. <a href="https://help.expensify.com/articles/expensify-classic/reports/Automatic-Receipt-Audit">Learn more</a> about how to enable automatic auditing for all receipts.',
