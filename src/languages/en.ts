...
const translations = {
    ...
    biometrics: {
        ...
        statusMessage: {
            ...
            failedMessage: (authorization?: boolean, because?: string) => `Your ${authorization ? 'authorization' : 'authentication'} ${because ? `failed: ${because}` : 'was unsuccessful'}`,
            successTitle: (authorization?: boolean) => `${authorization ? 'Authorization' : 'Authentication'} successful`,
            failedTitle: (authorization?: boolean) => `${authorization ? 'Authorization' : 'Authentication'} failed`,
        },
        /** Title indicating biometrics registration status */
        title: (registered: boolean = true) => `Biometrics (${registered ? 'Registered' : 'Not registered'})`,
        reason: {
