...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. Use the ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} button to send an invoice.`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `. Just use the ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} button.`,
