...
Oto *paragon testowy*, żeby pokazać Ci, jak to działa:`,
    ...
    domain: {
        ...
        members: {
            ...
            forceTwoFactorAuthSAMLEnabledDescription: `<muted-text>Wyłącz proszę <a href="${CONST.SAML_HELP_URL}">SAML</a>, aby wymusić uwierzytelnianie dwuskładnikowe.</muted-text>`,
            forceTwoFactorAuthDescription: `<muted-text>Wymagaj uwierzytelniania dwuskładnikowego dla wszystkich członków tej domeny. Członkowie domeny zostaną poproszeni o skonfigurowanie uwierzytelniania dwuskładnikowego na swoim koncie podczas logowania.</muted-text>`,
            forceTwoFactorAuthError: 'Wymuszenie uwierzytelniania dwuskładnikowego nie mogło zostać zmienione. Spróbuj ponownie później.',
        },
