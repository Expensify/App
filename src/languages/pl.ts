...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            approvedPartnerTeamDescription: 'Dedykowany zespół pomagający Twojej firmie się rozwijać, szybciej wdrażać klientów i uzyskiwać wsparcie ekspertów.',
            partnerManagerApprovedDescription: 'Maksymalizuj partnerstwo i zwiększaj polecenia',
            accountExecutiveDescription: 'Pomóż klientom w pomyślnej konfiguracji',
            accountManagerApprovedDescription: 'Zadawaj pytania i uzyskuj wsparcie dla klientów',
