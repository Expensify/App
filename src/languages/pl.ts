...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    lockAccountPage: {
        ...
        lostCardOrCharges:
            '<a href="https://help.expensify.com/articles/expensify-classic/expensify-card/Dispute-Transaction">Zgubiona karta lub nieznane obciążenia</a>: Anuluj swoją kartę i skontaktuj się z Concierge, aby zakwestionować nieznane transakcje.',
        unauthorizedAccess:
            '<a href="https://help.expensify.com/articles/expensify-classic/settings/Report-Suspicious-Activity">Nieautoryzowany dostęp do konta</a>: Zablokuj swoje konto poniżej. Blokuje to nowe transakcje Kartą Expensify, zamówienia kart i zmiany na koncie. Jeśli jesteś administratorem domeny, wstrzymuje to również całą aktywność kart i działania administracyjne w całej domenie.',
        securityTeamFollowUp: 'Nasz zespół ds. bezpieczeństwa skontaktuje się po zablokowaniu z adresu <a href="mailto:risk@expensify.com">risk@expensify.com</a>.',
