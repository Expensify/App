...
Wymagaj szczegółów wydatków, takich jak paragony i opisy, ustawiaj limity i wartości domyślne oraz automatyzuj akceptacje i płatności – wszystko w jednym miejscu.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                turnOnTaxesFirstPrompt: 'Reguły kategorii ustawiają domyślną stawkę podatku. Włącz podatki w ustawieniach swojego obszaru roboczego, aby z nich korzystać.',
                categoryRulesApplyGoingForwardTitle: 'Reguły kategorii będą stosowane od teraz',
                categoryRulesApplyGoingForwardPrompt: 'Domyślna stawka podatku ma zastosowanie do nowych wydatków w tej kategorii. Istniejące już wydatki nie zostaną zmienione.',
            },
            categoryRules: {
...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
            ...
            newRule: {
                ...
                createAgentRuleDescription: 'Twórz elastyczne reguły, które uruchamiają się wtedy, kiedy ich potrzebujesz.',
            },
            ...
            expenseDefaultType: {
                ...
                subtitle: 'Z czym ta reguła powinna się dopasowywać?',
                merchant: 'Sprzedawca',
            ...
            taxesDisabledEmptyState: {title: 'Podatek nie jest włączony', subtitle: 'Włącz podatki, aby udokumentować i odzyskać uprawnione kwoty podatku.', cta: 'Włącz podatki'},
        },
        planTypePage: {
            planTypes: {
                team: {
