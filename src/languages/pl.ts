...
Wymagaj szczegółów wydatków, takich jak paragony i opisy, ustawiaj limity i wartości domyślne oraz automatyzuj akceptacje i płatności – wszystko w jednym miejscu.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                oneConditionPerRuleTitle: 'Tylko jeden warunek na regułę',
                alreadyMatchesMerchantPrompt: 'Ta reguła jest już dopasowana do sprzedawcy. Zresetuj ją, żeby zamiast tego dopasowywała kategorię.',
                alreadyMatchesCategoryPrompt: 'Ta reguła już dopasowuje według kategorii. Zresetuj ją, żeby dopasowywała według sprzedawcy.',
                ...
                onlyTaxForCategoryRulesTitle: 'Dla reguł kategorii dostępny jest tylko podatek',
                onlyTaxForCategoryRulesPrompt: 'Reguły kategorii mogą ustawiać domyślną stawkę podatku. Żeby ustawić inne wartości domyślne, dopasuj zamiast tego sprzedawcę.',
                clearIncompatibleDefaultsTitle: 'Wyczyścić pozostałe domyślne ustawienia?',
                clearIncompatibleDefaultsPrompt: 'Te pola są niezgodne z kategorią. Wyczyścić wszystkie pola?',
...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
            ...
            newRule: {
                ...
                createAgentRuleDescription: 'Twórz elastyczne reguły, które uruchamiają się, kiedy tego potrzebujesz.',
            },
