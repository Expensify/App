...
Plan Control zaczyna się od 9 USD za aktywnego członka miesięcznie.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    title: 'Domyślny model pracy',
                    officeBasedTitle: 'Praca w biurze',
                    officeBasedHelp: 'Członek dojeżdża do biura. Standardowe dojazdy są wyłączone ze zwrotu kosztów.',
                    noRegularWorkplaceTitle: 'Brak stałego miejsca pracy',
                    noRegularWorkplaceHelp: 'Członek pracuje zdalnie lub nie ma stałego miejsca pracy, więc zasady dojazdu z domu do pracy nie mają zastosowania.',
                    startingPrompt: {
                        title: 'Ustaw typowy model pracy',
                        prompt: 'Wybierz model pracy, który dotyczy większości obecnych członków. Później możesz zaktualizować członków pojedynczo lub zbiorczo.',
                        officeBasedHelp: 'Większość członków dojeżdża do biura. Standardowe dojazdy są wyłączone.',
                        noRegularWorkplaceHelp: 'Większość członków pracuje zdalnie, więc wyłączenia dojazdów zwykle nie mają zastosowania.',
                        confirm: 'Zastosuj',
                    },
                },
            },
...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            ...
            set: ({arrangement}: {arrangement: string}) => `ustawił(a) domyślny model pracy na „${arrangement}”`,
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `zmienił(a) domyślny model pracy na „${arrangement}” (poprzednio „${previousArrangement}”)`,
        },
        commuterExclusions: {
