...
Oto *paragon testowy*, który pokazuje, jak to działa:`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            ctaFix: 'Napraw',
            fixCompanyCardConnection: {title: ({feedName}: {feedName: string}) => (feedName ? `Napraw połączenie firmowej karty ${feedName}` : 'Napraw połączenie firmowej karty'), subtitle: 'Workspace > Karty firmowe'},
