...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            locked: 'Zablokowane',
            incompleteDescription: 'Dokończ dodawanie konta bankowego',
            pendingDescription: 'Potwierdź transakcje testowe',
            verifyingDescription: 'Sprawdzamy Twoją dokumentację',
            lockedDescription: 'To konto wymaga uwagi',
            finish: 'Zakończ',
            confirm: 'Potwierdź',
            unlock: 'Odblokuj',
        },
        cardFixConnection: 'Napraw to połączenie',
        cardAskAdminToFix: 'Poproś administratora o naprawienie tego połączenia',
        cardAdminFixConnection: 'Napraw to połączenie w Kartach firmowych',
        lastSynced: (dateStr: string) => `Ostatnia synchronizacja ${dateStr}`,
        assignedCards: 'Karty',
