...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[pl] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[pl] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[pl] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[pl] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[pl] Get clients setup successfully',
            accountManagerApprovedDescription: '[pl] Ask questions and get client support',
            moreResources: '[pl] More resources',
        },
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[pl] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[pl] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[pl] Go to Gusto settings',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            settingsTitle: '[pl] Gusto settings',
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
            ...
            gusto: {
                ...
                disconnect: '[pl] Disconnect',
                lastSync: (relativeDate: string) => `[pl] Last synced ${relativeDate}`,
                syncError: "[pl] Can't connect to Gusto",
                disconnectTitle: '[pl] Disconnect Gusto',
                disconnectPrompt: '[pl] Are you sure you want to disconnect Gusto?',
                connectionDescription: '[pl] Connect Gusto to keep employee approvals in sync with your workspace.',
                approvalMode: '[pl] Approval mode',
                finalApprover: '[pl] Final approver',
                notSet: '[pl] Not set',
                approvalModeDescription: '[pl] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[pl] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[pl] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[pl] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[pl] Basic approval',
                        description: '[pl] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[pl] Manager approval',
                        description: '[pl] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[pl] Custom approval',
                        description: '[pl] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[pl] Gusto sync results',
                    successTitle: '[pl] Successfully synced your Gusto connection!',
                    added: '[pl] Added',
                    removed: '[pl] Removed',
                    skipped: '[pl] Skipped',
                    employeeCount: () => ({
            ...
            zenefits: {
                ...
                disconnect: '[pl] Disconnect',
                lastSync: (relativeDate: string) => `[pl] Last synced ${relativeDate}`,
                syncError: "[pl] Can't connect to TriNet",
                disconnectTitle: '[pl] Disconnect TriNet',
                disconnectPrompt: '[pl] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[pl] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[pl] Approval mode',
                finalApprover: '[pl] Final approver',
                notSet: '[pl] Not set',
                approvalModeDescription: '[pl] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[pl] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[pl] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[pl] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[pl] Basic approval',
                    ...
                    manager: {
                        label: '[pl] Manager approval',
                        description: '[pl] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[pl] Custom approval',
                        description: "[pl] I'll manually setup approval workflows in Expensify.",
    ...
    search: {
        ...
        filters: {
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[pl] Central invoicing',
            },
            is: '[pl] Is',
            action: {
