...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
        ...
        campfire: {
            ...
            autoSyncDescription: 'Automatycznie synchronizuj Campfire i Expensify każdego dnia. Raporty synchronizują się w czasie rzeczywistym.',
            accountingMethods: {
                label: 'Metoda eksportu',
                description: 'Wybierz, kiedy eksportować wydatki.',
                values: {
            ...
            syncReimbursedReports: 'Synchronizuj rozliczone raporty',
            syncReimbursedReportsDescription: 'Gdy raport zostanie opłacony przez ACH, w tym koncie zostanie utworzona płatność rachunku.',
            billPaymentAccount: {label: 'Konto do opłacania rachunków', description: 'Wybierz, z jakiego źródła chcesz opłacać rachunki, a my utworzymy płatność w Campfire.'},
            syncExpensifyCardSettlements: 'Synchronizuj rozliczenia Karty Expensify',
            ...
            travelInvoicingPayableAccount: {label: 'Konto zobowiązań za faktury podróżne'},
        },
        businessCentral: {
