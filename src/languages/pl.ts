...
Wymagaj szczegółów wydatków, takich jak paragony i opisy, ustawiaj limity i wartości domyślne oraz automatyzuj akceptacje i płatności – wszystko w jednym miejscu.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                ruleSummaryTitleContains: (merchantName: string) => `Jeśli sprzedawca zawiera „${merchantName}”`,
                ruleSummaryTitleExact: (merchantName: string) => \`Jeśli sprzedawca jest dokładnie „\${merchantName}"\`,
                matchType: 'Typ dopasowania',
                matchTypeContains: 'Zawiera',
                matchTypeContainsDescription: 'Dopasuj wydatki, gdy nazwa sprzedawcy zawiera określony tekst (bez uwzględniania wielkości liter)',
                matchTypeExact: 'Dopasowuje dokładnie',
                matchTypeExactDescription: 'Dopasuj wydatki, gdy nazwa sprzedawcy dokładnie odpowiada określonemu tekstowi',
