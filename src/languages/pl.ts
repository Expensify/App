...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
        ...
        recruiting: {
            ...
            filters: {
                description: (providerName: string) => `Wybierz, którzy członkowie mają być zaimportowani z ${providerName}. Możesz wybierać spośród etapów rekrutacji, tagów i biur.`,
                skipImport: 'Nie importuj',
                chooseAtLeastOneItem: 'Wybierz co najmniej jeden element do zaimportowania',
                stages: {title: 'Etap rekrutacji', description: 'Wybierz etap rekrutacji kandydatów, których chcesz zsynchronizować z tym miejscem pracy'},
                tags: {title: 'Tag', description: 'Wybierz tagi kandydatów, które chcesz zsynchronizować z tym miejscem pracy'},
                offices: {title: 'Biuro', optionalTitle: 'Biuro (opcjonalnie)', description: 'Wybierz biura kandydatów, które chcesz zsynchronizować z tym miejscem pracy'},
            },
