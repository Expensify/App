...
const translations = {
    ...
    bankAccount: {
        ...
        hasPhoneLoginError: ({contactMethodsRoute}: ContactMethodsRouteParams) =>
            `Aby połączyć konto bankowe, proszę <a href="${contactMethodsRoute}">dodaj e-mail jako swoje główne dane logowania</a> i spróbuj ponownie. Możesz dodać swój numer telefonu jako dodatkowy login.`,
