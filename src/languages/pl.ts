...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
    ...
    violations: {
        ...
        cannotMergeDuplicates:
            'Możesz łączyć wydatki tylko w raportach, które są otwarte lub oczekują na pierwsze zatwierdzenie. Być może będziesz musiał wycofać raport, połączyć wydatki, a następnie wysłać go ponownie.',
    },
    reportViolations: {
