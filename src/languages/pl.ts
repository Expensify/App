...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: 'Artykuły, samouczki i więcej',
            conciergeChat: 'Concierge',
            conciergeChatDescription: 'Twój osobisty asystent AI',
            accountManager: 'Account Manager',
            yourAccountManager: 'Twój opiekun konta',
            accountManagerDescription: 'Zadawaj pytania i uzyskaj pomoc dla klientów',
            partnerManager: 'Partner Manager',
            partnerManagerDescription: 'Zmaksymalizuj swoje partnerstwo i zwiększ liczbę poleceń',
            guideDescription: 'Twój specjalista ds. konfiguracji',
            approvedPartnerTeamTitle: 'Poznaj swój zespół partnerów Approved!',
            approvedPartnerTeamDescription: 'Dedykowany zespół, który pomaga twojej firmie rosnąć, szybciej wdrażać klientów i otrzymywać eksperckie wsparcie zawsze, gdy go potrzebujesz.',
            accountExecutive: 'Account Executive',
            accountExecutiveDescription: 'Pomyślnie skonfiguruj klientów',
