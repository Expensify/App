...
${amount} dla ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        perDiem: {
            ...
            requestEmptyList: {
                title: 'Brak stawek diet',
                subtitle: 'Ta przestrzeń robocza nie ma żadnych stawek diet, poproś administratora o ich dodanie.',
                adminSubtitle: 'Dodaj stawki diet, aby uporządkować swoje wydatki.',
            },
