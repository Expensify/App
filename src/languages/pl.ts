...
3. Gdy kanał zostanie włączony, kliknij poniżej Submit, a my zajmiemy się jego dodaniem.`,
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `Nieprawidłowy/e symbol/e zastępcze formuły: ${placeholders}. Użyj obsługiwanych symboli zastępczych, takich jak {report:id}, {report:name}, {report:created} itp.`,
