...
${amount} dla ${merchant} - ${date}`,
    ...
    activateCardPage: {
        ...
        fillInAllDetails: 'Uzupełnij wszystkie poniższe dane',
    },
    getPhysicalCard: {
...
Plan Control zaczyna się od 9 USD za aktywnego członka miesięcznie.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                enterShippingAddress: 'Wpisz adres dostawy',
                shippingAddressDescription: 'Powiedz nam, dokąd mamy wysłać nową kartę.',
                promptCardholder: 'Poproś posiadacza karty',
                promptCardholderDescription: 'Posiadacz karty zostanie poproszony o podanie lub potwierdzenie adresu wysyłki.',
