...
const translations: TranslationDeepObject<typeof en> = {
    ...
    contacts: {
        ...
        helpText: 'Dodaj więcej sposobów na przesyłanie paragonów. Prześlij je do <copy-text text="receipts@expensify.com"/> lub wyślij SMS na numer 47777 (tylko numery w USA).',
