...
${
    ...
    workspaceActions: {
        ...
        forcedCorporateUpgrade: `Ten obszar roboczy został uaktualniony do planu Control. Kliknij <a href="${CONST.PLAN_TYPES_AND_PRICING_HELP_URL}">tutaj</a>, aby uzyskać więcej informacji.`,
