...
const translations: TranslationDeepObject<typeof en> = {
  common: {
    ...
    noResultsFoundMatching: (searchString: string) =>
      `Nie znaleziono wyników pasujących do „${searchString}”`,
    ...
    conjunctionTo: "do",
    genericErrorMessage:
      "Ups... coś poszło nie tak i Twoje żądanie nie mogło zostać zrealizowane. Spróbuj ponownie później.",
    percentage: "Procent",
    converted: "Przekonwertowano",
    error: {
      invalidAmount: "Nieprawidłowa kwota",
      acceptTerms:
        "Aby kontynuować, musisz zaakceptować Warunki świadczenia usług",
...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
      ...
      characterLimitExceedCounter: (length: number, limit: number) =>
        `Przekroczono limit znaków (${length}/${limit})`,
      ...
      invalidTimeShouldBeFuture:
        "Wybierz godzinę co najmniej o minutę późniejszą",
      ...
      invalidTimeRange:
        "Wprowadź godzinę w 12‑godzinnym formacie (np. 2:30 PM)",
    ...
    thisFeatureRequiresInternet:
      "Ta funkcja wymaga aktywnego połączenia z internetem.",
    attachmentWillBeAvailableOnceBackOnline:
      "Załącznik będzie dostępny po ponownym połączeniu z internetem.",
    errorOccurredWhileTryingToPlayVideo:
      "Wystąpił błąd podczas próby odtworzenia tego wideo.",
    ...
    zipCodeExampleFormat: ({ zipSampleFormat }: ZipCodeExampleFormatParams) =>
      zipSampleFormat ? `np. ${zipSampleFormat}` : "",
    description: "Opis",
    title: "Tytuł",
    ...
    roleCannotBeChanged: (workflowsLinkPage: string) =>
      `Nie można zmienić roli, ponieważ ten członek jest <a href="${workflowsLinkPage}">płatnikiem</a> w tym obszarze roboczym.`,
    currency: "Waluta",
    ...
    downloadFailedDescription:
      "Nie można było dokończyć pobierania. Spróbuj ponownie później.",
    ...
    leaveWorkspaceConfirmation:
      "Jeśli opuścisz ten obszar roboczy, nie będziesz mógł przesyłać do niego wydatków.",
    leaveWorkspaceConfirmationAuditor:
      "Jeśli opuścisz tę przestrzeń roboczą, nie będziesz mieć dostępu do jej raportów ani ustawień.",
    leaveWorkspaceConfirmationAdmin:
      "Jeśli opuścisz tę przestrzeń roboczą, nie będziesz mógł zarządzać jej ustawieniami.",
    ...
    unstableInternetConnection:
      "Niestabilne połączenie internetowe. Sprawdź swoją sieć i spróbuj ponownie.",
  ...
  lockedAccount: {
    ...
    description:
      "Nie możesz wykonać tej akcji, ponieważ to konto zostało zablokowane. Skontaktuj się z concierge@expensify.com, aby poznać kolejne kroki",
  },
  location: {
    useCurrent: "Użyj bieżącej lokalizacji",
    notFound:
      "Nie udało się ustalić Twojej lokalizacji. Spróbuj ponownie lub wprowadź adres ręcznie.",
    permissionDenied:
      "Wygląda na to, że odmówiłeś(-aś) dostępu do swojej lokalizacji.",
    please: "Proszę",
  ...
  contact: {
    ...
    importContactsText:
      "Zaimportuj kontakty z telefonu, aby Twoje ulubione osoby były zawsze na wyciągnięcie ręki.",
    importContactsExplanation:
      "dzięki czemu twoi ulubieni znajomi są zawsze na wyciągnięcie ręki.",
    importContactsNativeText:
      "Jeszcze tylko jeden krok! Daj nam zielone światło na zaimportowanie Twoich kontaktów.",
  },
  ...
  attachmentPicker: {
    ...
    expensifyDoesNotHaveAccessToCamera:
      "Expensify nie może robić zdjęć bez dostępu do aparatu. Stuknij „Ustawienia”, aby zaktualizować uprawnienia.",
    attachmentError: "Błąd załącznika",
    errorWhileSelectingAttachment:
      "Wystąpił błąd podczas wybierania załącznika. Spróbuj ponownie.",
    errorWhileSelectingCorruptedAttachment:
      "Wystąpił błąd podczas wybierania uszkodzonego załącznika. Spróbuj użyć innego pliku.",
    ...
    sizeExceededWithLimit: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Rozmiar załącznika przekracza limit ${maxUploadSizeInMB} MB`,
    ...
    notAllowedExtension:
      "Ten typ pliku jest niedozwolony. Spróbuj użyć innego typu pliku.",
    folderNotAllowedMessage:
      "Przesyłanie folderu nie jest dozwolone. Spróbuj użyć innego pliku.",
    protectedPDFNotSupported: "Plik PDF chroniony hasłem nie jest obsługiwany",
    attachmentImageResized:
      "Ten obraz został przeskalowany na potrzeby podglądu. Pobierz go, aby zobaczyć w pełnej rozdzielczości.",
    attachmentImageTooLarge:
      "Ten obraz jest zbyt duży, aby wyświetlić podgląd przed przesłaniem.",
    imageDimensionsTooLarge:
      "Wymiary obrazu są zbyt duże do przetworzenia. Użyj mniejszego obrazu.",
    tooManyFiles: (fileLimit: number) =>
      `Możesz jednorazowo przesłać maksymalnie ${fileLimit} plików.`,
    sizeExceededWithValue: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Plik przekracza ${maxUploadSizeInMB} MB. Spróbuj ponownie.`,
    someFilesCantBeUploaded: "Niektórych plików nie można przesłać",
    sizeLimitExceeded: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Pliki muszą mieć mniej niż ${maxUploadSizeInMB} MB. Większe pliki nie zostaną przesłane.`,
    maxFileLimitExceeded:
      "Możesz jednocześnie przesłać maksymalnie 30 paragonów. Dodatkowe paragony nie zostaną przesłane.",
    unsupportedFileType: (fileType: string) =>
      `Pliki typu ${fileType} nie są obsługiwane. Zostaną przesłane tylko obsługiwane typy plików.`,
    learnMoreAboutSupportedFiles:
      "Dowiedz się więcej o obsługiwanych formatach.",
    passwordProtected:
      "Pliki PDF zabezpieczone hasłem nie są obsługiwane. Zostaną przesłane tylko obsługiwane pliki.",
  },
  dropzone: {
  ...
  filePicker: {
    ...
    errorWhileSelectingFile:
      "Wystąpił błąd podczas wybierania pliku. Spróbuj ponownie.",
  },
  connectionComplete: {
  ...
  multifactorAuthentication: {
    reviewTransaction: {
      ...
      requiresYourReview:
        "Transakcja kartą Expensify wymaga Twojej weryfikacji poniżej.",
      ...
      areYouSureToDeny:
        "Na pewno? Transakcja zostanie odrzucona, jeśli zamkniesz ten ekran.",
      ...
      youNeedToTryAgainAtMerchant:
        "Ta transakcja nie została zweryfikowana, więc ją odrzuciliśmy. Musisz spróbować ponownie u sprzedawcy.",
      goBackToTheMerchant:
        "Wróć do strony sprzedawcy, aby kontynuować transakcję.",
      attemptedTransaction: "Próbowana transakcja",
      transactionFailed: "Transakcja nie powiodła się",
      transactionCouldNotBeCompleted:
        "Twoja transakcja nie mogła zostać zrealizowana. Spróbuj ponownie u sprzedawcy.",
      transactionCouldNotBeCompletedReachOut:
        "Nie można było sfinalizować Twojej transakcji. Jeśli nie próbowałeś(-aś) wykonać tej transakcji, <concierge-link>skontaktuj się z Concierge</concierge-link>, aby zgłosić potencjalne oszustwo.",
      reviewFailed: "Recenzja nie powiodła się",
      alreadyReviewedSubtitle:
        "Ta transakcja została już przez Ciebie sprawdzona. Sprawdź swoją <transaction-history-link>historię transakcji</transaction-history-link> lub skontaktuj się z <concierge-link>Concierge</concierge-link>, aby zgłosić wszelkie problemy.",
    },
    biometricsTest: {
      ...
      successfullyAuthenticatedUsing: ({
        ...
        `Pomyślnie uwierzytelniono przy użyciu ${authType}.`,
      troubleshootBiometricsStatus: ({
        registered,
      }: MultifactorAuthenticationTranslationParams) =>
        `Dane biometryczne (${registered ? "Zarejestrowano" : "Nie zarejestrowano"})`,
      yourAttemptWasUnsuccessful:
        "Twoja próba uwierzytelnienia nie powiodła się.",
      youCouldNotBeAuthenticated: "Nie udało się uwierzytelnić użytkownika",
      areYouSureToReject:
        "Na pewno? Próba uwierzytelnienia zostanie odrzucona, jeśli zamkniesz ten ekran.",
    ...
    pleaseEnableInSystemSettings: {
      start:
        "Włącz weryfikację twarzą/odciskiem palca lub ustaw kod blokady urządzenia w swoim",
      link: "ustawienia systemowe",
      end: ".",
    },
    oops: "Ups, coś poszło nie tak",
    looksLikeYouRanOutOfTime:
      "Wygląda na to, że skończył ci się czas! Spróbuj ponownie u sprzedawcy.",
    ...
    enableQuickVerification: {
      biometrics:
        "Włącz szybką i bezpieczną weryfikację za pomocą twarzy lub odcisku palca. Bez haseł i kodów.",
    },
    revoke: {
      ...
      confirmationPrompt:
        "Na pewno? Do kolejnej weryfikacji na dowolnym urządzeniu będziesz potrzebować magicznego kodu.",
      cta: "Cofnij dostęp",
      noDevices:
  ...
  validateCodeModal: {
    ...
    successfulSignInDescription:
      "Wróć do swojej pierwotnej karty, aby kontynuować.",
    ...
    expiredCodeDescription:
      "Wróć do oryginalnego urządzenia i poproś o nowy kod",
  ...
  customApprovalWorkflow: {
    ...
    description:
      "Twoja firma ma niestandardowy proces zatwierdzania w tym obszarze roboczym. Wykonaj tę akcję w Expensify Classic",
  ...
  emptyList: {
    [CONST.IOU.TYPE.CREATE]: {
      ...
      subtitleText:
        "Chcesz, aby Twój zespół też korzystał z Expensify? Po prostu prześlij im wydatek, a my zajmiemy się resztą.",
    },
  },
  ...
  welcomeText: {
    ...
    anotherLoginPageIsOpenExplanation:
      "Otworzyłeś stronę logowania w osobnej karcie. Zaloguj się z tamtej karty.",
    welcome: "Witamy!",
    welcomeWithoutExclamation: "Witamy",
    phrase2:
      "Pieniądze mają głos. A teraz, gdy czat i płatności są w jednym miejscu, jest to także proste.",
    phrase3:
      "Twoje płatności docierają do Ciebie tak szybko, jak szybko potrafisz przekazać swoją myśl.",
    enterPassword: "Wprowadź swoje hasło",
    welcomeNewFace: (login: string) =>
      `${login}, zawsze miło zobaczyć tu nową twarz!`,
    welcomeEnterMagicCode: ({ login }: WelcomeEnterMagicCodeParams) =>
      `Wprowadź magiczny kod wysłany na ${login}. Powinien dotrzeć w ciągu minuty lub dwóch.`,
  },
  login: {
    hero: {
  ...
  samlSignIn: {
    welcomeSAMLEnabled:
      "Kontynuuj logowanie za pomocą logowania jednokrotnego (SSO):",
    ...
    oneMoment:
      "Chwileczkę, przekierowujemy Cię do firmowego portalu logowania jednokrotnego (SSO).",
  },
  reportActionCompose: {
    ...
    fileUploadFailed:
      "Przesyłanie nie powiodło się. Plik nie jest obsługiwany.",
    localTime: (user: string, time: string) => `Jest ${time} dla ${user}`,
    edited: "(edytowano)",
    emoji: "Emoji",
    collapse: "Zwiń",
    expand: "Rozwiń",
  ...
  reportActionContextMenu: {
    ...
    editAction: ({ action }: EditActionParams) =>
      `Edytuj ${action?.actionName === CONST.REPORT.ACTIONS.TYPE.IOU ? "wydatek" : "komentarz"}`,
  ...
  reportActionsView: {
    ...
    beginningOfChatHistoryAnnounceRoom: (workspaceName: string) =>
      `Ten czat jest z wszystkimi w <strong>${workspaceName}</strong>. Używaj go do najważniejszych ogłoszeń.`,
    ...
    beginningOfChatHistorySelfDM:
      "To Twoja osobista przestrzeń. Używaj jej na notatki, zadania, szkice i przypomnienia.",
    ...
    usePlusButton: ({ additionalText }: UsePlusButtonParams) =>
      `Użyj przycisku +, aby ${additionalText} wydatek.`,
    askConcierge:
      "To Twój czat z Concierge, Twoim osobistym agentem AI. Mogę zrobić prawie wszystko, wypróbuj mnie!",
  ...
  adminOnlyCanPost:
    "Tylko administratorzy mogą wysyłać wiadomości w tym pokoju.",
  reportAction: {
  ...
  youHaveBeenBanned:
    "Uwaga: Zostałeś zablokowany przed czatowaniem na tym kanale.",
  ...
  reportArchiveReasons: {
    ...
    [CONST.REPORT.ARCHIVE_REASON.BOOKING_END_DATE_HAS_PASSED]:
      "Ta rezerwacja jest zarchiwizowana.",
  },
  writeCapabilityPage: {
  ...
  sidebarScreen: {
    ...
    redirectToExpensifyClassicModal: {
      ...
      description:
        "Dopasowujemy jeszcze kilka elementów Nowego Expensify do Twojej specyficznej konfiguracji. Tymczasem przejdź do klasycznej wersji Expensify.",
    },
  },
  homePage: {
    forYou: "Dla ciebie",
    timeSensitiveSection: {
      ...
      reviewCardFraud: {
        ...
        titleWithDetails: ({
          ...
          `Przejrzyj ${amount} potencjalnie oszukańczych transakcji u ${merchant}`,
      ...
      fixCompanyCardConnection: {
        title: ({ feedName }: { feedName: string }) =>
          feedName
            ? `Napraw połączenie karty firmowej ${feedName}`
            : "Napraw połączenie karty firmowej",
        defaultSubtitle: "Obszar roboczy",
        subtitle: ({ policyName }: { policyName: string }) =>
          `${policyName} > Karty firmowe`,
      },
      fixAccountingConnection: {
        title: ({ integrationName }: { integrationName: string }) =>
          `Napraw połączenie ${integrationName}`,
        defaultSubtitle: "Obszar roboczy",
        subtitle: ({ policyName }: { policyName: string }) =>
          `${policyName} > Księgowość`,
      },
      fixPersonalCardConnection: {
        title: ({ cardName }: { cardName?: string }) =>
          cardName
            ? `Napraw połączenie z prywatną kartą ${cardName}`
            : "Napraw połączenie karty prywatnej",
        subtitle: "Portfel",
      },
    },
    ...
    discoverSection: {
      ...
      menuItemTitleNonAdmin:
        "Dowiedz się, jak tworzyć wydatki i wysyłać raporty.",
      menuItemTitleAdmin:
        "Dowiedz się, jak zapraszać członków, edytować procesy zatwierdzania i uzgadniać karty firmowe.",
      menuItemDescription: "Zobacz, co Expensify potrafi w 2 minuty",
    },
    forYouSection: {
      submit: ({ count }: { count: number }) =>
        `Prześlij ${count} ${count === 1 ? "raport" : "raporty"}`,
      approve: ({ count }: { count: number }) =>
        `Zatwierdź ${count} ${count === 1 ? "raport" : "raporty"}`,
      pay: ({ count }: { count: number }) =>
        `Zapłać ${count} ${count === 1 ? "raport" : "raporty"}`,
      export: ({ count }: { count: number }) =>
        `Eksportuj ${count} ${count === 1 ? "raport" : "raporty"}`,
      begin: "Rozpocznij",
      emptyStateMessages: {
        thumbsUpStarsTitle: "Gotowe!",
        thumbsUpStarsDescription: "Brawo dla ciebie, wypatruj kolejnych zadań.",
        smallRocketTitle: "Wszystko nadrobione",
        smallRocketDescription: "Nadchodzące zadania pojawią się tutaj.",
        cowboyHatTitle: "Gotowe!",
        cowboyHatDescription:
          "Wszystkie zadania ogarnięte, wypatruj kolejnych.",
        trophy1Title: "Nic do wyświetlenia",
        trophy1Description:
          "Udało ci się! Wypatruj kolejnych zadań do wykonania.",
        palmTreeTitle: "Wszystko nadrobione",
        palmTreeDescription: "Czas na relaks, ale wypatruj przyszłych zadań.",
        fishbowlBlueTitle: "Gotowe!",
        fishbowlBlueDescription: "Przyszłe zadania pojawią się tutaj.",
        targetTitle: "Wszystko nadrobione",
        targetDescription:
          "Świetnie trzymasz się celu. Wróć po kolejne zadania!",
        chairTitle: "Nic do wyświetlenia",
        chairDescription:
          "Idź odpocząć, nadchodzące zadania wyświetlimy tutaj.",
        broomTitle: "Gotowe!",
        broomDescription:
          "Zadania są ogarnięte, ale wypatruj kolejnych rzeczy do zrobienia.",
        ...
        flashTitle: "Gotowe!",
        flashDescription:
          "Twoje przyszłe zadania błyskawicznie pojawią się tutaj.",
        sunglassesTitle: "Nic do wyświetlenia",
        sunglassesDescription:
          "Czas się zrelaksować, ale wypatruj tego, co nadchodzi!",
  ...
  spreadsheet: {
    ...
    dragAndDrop:
      "<muted-link>Przeciągnij i upuść tutaj swój arkusz kalkulacyjny lub wybierz plik poniżej. Obsługiwane formaty: .csv, .txt, .xls i .xlsx.</muted-link>",
    ...
    chooseSpreadsheet:
      "<muted-link>Wybierz plik arkusza kalkulacyjnego do zaimportowania. Obsługiwane formaty: .csv, .txt, .xls i .xlsx.</muted-link>",
    ...
    fieldNotMapped: (fieldName: string) =>
      `Ups! Wymagane pole („${fieldName}”) nie zostało zmapowane. Sprawdź i spróbuj ponownie.`,
    singleFieldMultipleColumns: (fieldName: string) =>
      `Ups! Przypisałeś jedno pole („${fieldName}”) do wielu kolumn. Sprawdź ustawienia i spróbuj ponownie.`,
    emptyMappedField: (fieldName: string) =>
      `Ups! Pole („${fieldName}”) zawiera jedną lub więcej pustych wartości. Sprawdź je i spróbuj ponownie.`,
    ...
    importCategoriesSuccessfulDescription: ({
      ...
      if (added) {
        return added === 1
          ? "Dodano 1 kategorię."
          : `Dodano ${added} kategorie.`;
      }

      return updated === 1
        ? "Zaktualizowano 1 kategorię."
        : `Zaktualizowano ${updated} kategorie.`;
    },
    ...
    importPerDiemRatesSuccessfulDescription: ({ rates }: { rates: number }) =>
      rates > 1 ? `Dodano stawki diety: ${rates}.` : "Dodano 1 stawkę diety.",
    importTransactionsSuccessfulDescription: ({
      ...
      transactions > 1
        ? `Zaimportowano ${transactions} transakcje.`
        : "Zaimportowano 1 transakcję.",
    importFailedTitle: "Import nieudany",
    importFailedDescription:
      "Upewnij się, że wszystkie pola zostały poprawnie wypełnione i spróbuj ponownie. Jeśli problem będzie się powtarzał, skontaktuj się z Concierge.",
    importDescription:
      "Wybierz, które pola zmapować z arkusza kalkulacyjnego, klikając menu rozwijane obok każdej zaimportowanej kolumny poniżej.",
    ...
    importSpreadsheetLibraryError:
      "Nie udało się załadować modułu arkusza kalkulacyjnego. Sprawdź połączenie z internetem i spróbuj ponownie.",
  ...
  receipt: {
    ...
    alternativeMethodsDownloadApp: ({ downloadUrl }: { downloadUrl: string }) =>
      `<label-text><a href="${downloadUrl}">Pobierz aplikację</a>, aby skanować z telefonu</label-text>`,
    alternativeMethodsForwardReceipts: ({ email }: { email: string }) =>
      `<label-text>Przekaż paragony na adres <a href="mailto:${email}">${email}</a></label-text>`,
    ...
    alternativeMethodsTextReceipts: ({
      ...
      `<label-text>Wyślij paragony SMS-em na ${phoneNumber} (tylko numery w USA)</label-text>`,
    takePhoto: "Zrób zdjęcie",
    cameraAccess:
      "Dostęp do aparatu jest wymagany, aby robić zdjęcia paragonów.",
    ...
    cameraErrorMessage:
      "Wystąpił błąd podczas robienia zdjęcia. Spróbuj ponownie.",
    locationAccessTitle: "Zezwól na dostęp do lokalizacji",
    locationAccessMessage:
      "Dostęp do lokalizacji pomaga nam utrzymać poprawną strefę czasową i walutę, gdziekolwiek jesteś.",
    ...
    addReceipt: "Dodaj paragon",
    scanFailed:
      "Nie można było zeskanować paragonu, ponieważ brakuje na nim sprzedawcy, daty lub kwoty.",
    crop: "Przytnij",
    addAReceipt: {
  ...
  quickAction: {
    ...
    noLongerHaveReportAccess:
      "Nie masz już dostępu do swojego poprzedniego szybkiego działania. Wybierz poniżej nowe.",
  ...
  iou: {
    ...
    splitDateRange: (startDate: string, endDate: string, count: number) =>
      `${startDate} do ${endDate} (${count} dni)`,
    ...
    totalAmountGreaterThanOriginal: (amount: string) =>
      `Kwota łączna jest o ${amount} wyższa niż pierwotny wydatek.`,
    totalAmountLessThanOriginal: (amount: string) =>
      `Kwota całkowita jest o ${amount} mniejsza niż pierwotny wydatek.`,
    splitExpenseZeroAmount: "Wprowadź prawidłową kwotę przed kontynuowaniem.",
    splitExpenseOneMoreSplit:
      "Nie dodano podziałów. Dodaj co najmniej jeden, aby zapisać.",
    splitExpenseEditTitle: (amount: string, merchant: string) =>
      `Edytuj ${amount} dla ${merchant}`,
    removeSplit: "Usuń podział",
    splitExpenseCannotBeEditedModalTitle:
      "Ten wydatek nie może zostać edytowany",
    splitExpenseCannotBeEditedModalDescription:
      "Zatwierdzonych ani opłaconych wydatków nie można edytować",
    splitExpenseDistanceErrorModalDescription:
      "Napraw błąd stawki za dystans i spróbuj ponownie.",
    splitExpensePerDiemRateErrorModalDescription:
      "Napraw błąd stawki diety i spróbuj ponownie.",
    paySomeone: (name?: string) => `Zapłać ${name ?? "ktoś"}`,
    expense: "Wydatek",
    ...
    deletedTransaction: (amount: string, merchant: string) =>
      `usunął(-ę) wydatek (${amount} dla ${merchant})`,
    movedFromReport: (reportName: string) =>
      `przeniesiono wydatek${reportName ? `z ${reportName}` : ""}`,
    movedTransactionTo: (reportUrl: string, reportName?: string) =>
      `przeniósł ten wydatek${reportName ? `do <a href="${reportUrl}">${reportName}</a>` : ""}`,
    movedTransactionFrom: (reportUrl: string, reportName?: string) =>
      `przeniósł(-ę) ten wydatek${reportName ? `z <a href="${reportUrl}">${reportName}</a>` : ""}`,
    unreportedTransaction: (reportUrl: string) =>
      `przeniósł ten wydatek do Twojej <a href="${reportUrl}">przestrzeni osobistej</a>`,
    movedAction: (
    ...
    pendingMatchWithCreditCard:
      "Oczekuje na dopasowanie paragonu do transakcji kartą",
    pendingMatch: "Oczekujące dopasowanie",
    pendingMatchWithCreditCardDescription:
      "Oczekuje na dopasowanie paragonu do transakcji kartą. Oznacz jako gotówkę, aby anulować.",
    markAsCash: "Oznacz jako gotówkę",
    routePending: "Trasa w toku…",
    automaticallyEnterExpenseDetails:
      "Concierge automatycznie wprowadzi szczegóły wydatku za Ciebie lub możesz dodać je ręcznie.",
    receiptScanning: () => ({
    ...
    scanMultipleReceiptsDescription:
      "Zrób zdjęcia wszystkich paragonów naraz, a potem samodzielnie potwierdź szczegóły albo pozwól, żebyśmy zrobili to za Ciebie.",
    receiptScanInProgress: "Trwa skanowanie paragonu",
    receiptScanInProgressDescription:
      "Trwa skanowanie paragonu. Sprawdź później lub wprowadź dane teraz.",
    ...
    receiptStatusText:
      "Tylko ty widzisz ten paragon podczas skanowania. Sprawdź ponownie później lub wprowadź szczegóły teraz.",
    receiptScanningFailed:
      "Skanowanie paragonu nie powiodło się. Wprowadź dane ręcznie.",
    transactionPendingDescription:
      "Transakcja w toku. Zaksięgowanie może potrwać kilka dni.",
    companyInfo: "Informacje o firmie",
    companyInfoDescription:
      "Potrzebujemy jeszcze kilku informacji, zanim będziesz mógł wysłać swoją pierwszą fakturę.",
    yourCompanyName: "Nazwa Twojej firmy",
    yourCompanyWebsite: "Strona internetowa Twojej firmy",
    yourCompanyWebsiteNote:
      "Jeśli nie masz strony internetowej, możesz zamiast niej podać profil swojej firmy na LinkedIn lub w mediach społecznościowych.",
    invalidDomainError:
      "Wprowadzone domena jest nieprawidłowa. Aby kontynuować, wprowadź prawidłową domenę.",
    publicDomainError:
      "Wprowadziłeś domenę publiczną. Aby kontynuować, wprowadź domenę prywatną.",
    expenseCount: () => {
      return {
        one: "1 wydatek",
    ...
    settlePersonal: (formattedAmount?: string) =>
      formattedAmount
        ? `Zapłać ${formattedAmount} jako osoba prywatna`
        : `Zapłać z konta osobistego`,
    settleWallet: (formattedAmount?: string) =>
      formattedAmount
        ? `Zapłać ${formattedAmount} z portfela`
        : `Zapłać portfelem`,
    settlePayment: (formattedAmount: string) => `Zapłać ${formattedAmount}`,
    settleBusiness: (formattedAmount?: string) =>
      formattedAmount
        ? `Zapłać ${formattedAmount} jako firma`
        : `Zapłać z konta firmowego`,
    payElsewhere: (formattedAmount?: string) =>
      formattedAmount
        ? `Oznacz ${formattedAmount} jako zapłaconą`
        : `Oznacz jako zapłacone`,
    settleInvoicePersonal: (amount?: string, last4Digits?: string) =>
      amount
        ? `zapłacono ${amount} z konta osobistego ${last4Digits}`
        : `Zapłacono z konta osobistego`,
    settleInvoiceBusiness: (amount?: string, last4Digits?: string) =>
      amount
        ? `zapłacono ${amount} z firmowego konta ${last4Digits}`
        : `Zapłacono z konta firmowego`,
    payWithPolicy: (policyName: string, formattedAmount?: string) =>
      formattedAmount
        ? `Zapłać ${formattedAmount} przez ${policyName}`
        : `Zapłać przez ${policyName}`,
    businessBankAccount: (amount?: string, last4Digits?: string) =>
      amount
        ? `zapłacono ${amount} z konta bankowego ${last4Digits}`
        : `zapłacono z konta bankowego ${last4Digits}`,
    ...
    waitingOnBankAccount: ({
      ...
      `rozpoczęto płatność, ale oczekuje na to, aż ${submitterDisplayName} doda konto bankowe.`,
    ...
    paidElsewhere: ({ payer, comment }: PaidElsewhereParams = {}) =>
      `${payer ? `${payer} ` : ""}oznaczone jako opłacone${comment ? `, mówiąc „${comment}”` : ""}`,
    paidWithExpensify: (payer?: string) =>
      `${payer ? `${payer} ` : ""}zapłacono z portfela`,
    ...
    removedTheRequest: (valueName: string, oldValueToDisplay: string) =>
      `${valueName} (wcześniej ${oldValueToDisplay})`,
    updatedTheRequest: ({
      valueName,
      newValueToDisplay,
      oldValueToDisplay,
    }: UpdatedTheRequestParams) =>
      `${valueName} na ${newValueToDisplay} (wcześniej ${oldValueToDisplay})`,
    ...
    basedOnMCC: ({ rulesLink }: { rulesLink: string }) =>
      rulesLink
        ? `na podstawie <a href="${rulesLink}">zasad przestrzeni roboczej</a>`
        : "na podstawie reguły przestrzeni roboczej",
    threadExpenseReportName: (formattedAmount: string, comment?: string) =>
      `${formattedAmount} ${comment ? `dla ${comment}` : "wydatek"}`,
    invoiceReportName: ({
      linkedReportID,
    }: OriginalMessage<typeof CONST.REPORT.ACTIONS.TYPE.REPORT_PREVIEW>) =>
      `Raport faktury nr ${linkedReportID}`,
    threadPaySomeoneReportName: (formattedAmount: string, comment?: string) =>
      `Wysłano ${formattedAmount}${comment ? `za ${comment}` : ""}`,
    movedFromPersonalSpace: ({
      workspaceName,
      reportName,
    }: MovedFromPersonalSpaceParams) =>
      `przeniesiono wydatek z przestrzeni osobistej do ${workspaceName ?? `czat z ${reportName}`}`,
    movedToPersonalSpace: "przeniesiono wydatek do przestrzeni prywatnej",
    error: {
      invalidCategoryLength:
        "Nazwa kategorii przekracza 255 znaków. Skróć ją lub wybierz inną kategorię.",
      invalidTagLength:
        "Nazwa taga przekracza 255 znaków. Skróć ją lub wybierz inny tag.",
      ...
      negativeDistanceNotAllowed:
        "Końcowy odczyt musi być większy niż początkowy odczyt",
      distanceAmountTooLarge:
        "Łączna kwota jest zbyt wysoka. Zmniejsz dystans lub obniż stawkę.",
      distanceAmountTooLargeReduceDistance:
        "Łączna kwota jest zbyt wysoka. Zmniejsz dystans.",
      distanceAmountTooLargeReduceRate:
        "Łączna kwota jest zbyt wysoka. Obniż stawkę.",
      odometerReadingTooLarge: (formattedMax: string) =>
        `Odczyty licznika nie mogą przekraczać ${formattedMax}.`,
      invalidIntegerAmount:
        "Przed kontynuowaniem wprowadź kwotę w pełnych dolarach",
      invalidTaxAmount: (amount: string) =>
        `Maksymalna kwota podatku to ${amount}`,
      invalidSplit: "Suma podziałów musi być równa całkowitej kwocie",
      invalidSplitParticipants:
        "Wprowadź kwotę większą od zera dla co najmniej dwóch uczestników",
      ...
      genericCreateFailureMessage:
        "Niespodziewany błąd podczas przesyłania tego wydatku. Spróbuj ponownie później.",
      genericCreateInvoiceFailureMessage:
        "Nieoczekiwany błąd podczas wysyłania tej faktury. Spróbuj ponownie później.",
      genericHoldExpenseFailureMessage:
        "Nieoczekiwany błąd podczas wstrzymywania tego wydatku. Spróbuj ponownie później.",
      genericUnholdExpenseFailureMessage:
        "Nieoczekiwany błąd podczas zdejmowania tego wydatku z wstrzymania. Spróbuj ponownie później.",
      receiptDeleteFailureError:
        "Nieoczekiwany błąd podczas usuwania tego paragonu. Spróbuj ponownie później.",
      receiptFailureMessage:
        '<rbr>Wystąpił błąd podczas przesyłania paragonu. Prosimy <a href="download">zapisać paragon</a> i <a href="retry">spróbować ponownie</a> później.</rbr>',
      receiptFailureMessageShort: "Wystąpił błąd podczas przesyłania paragonu.",
      genericDeleteFailureMessage:
        "Nieoczekiwany błąd podczas usuwania tego wydatku. Spróbuj ponownie później.",
      genericEditFailureMessage:
        "Nieoczekiwany błąd podczas edycji tego wydatku. Spróbuj ponownie później.",
      ...
      splitExpenseMultipleParticipantsErrorMessage:
        "Wydatek nie może być podzielony między przestrzeń roboczą a innych członków. Zaktualizuj swój wybór.",
      ...
      invalidRate:
        "Stawka nie jest dostępna dla tego przestrzeni roboczej. Wybierz proszę jedną z dostępnych stawek w tej przestrzeni roboczej.",
      endDateBeforeStartDate:
        "Data zakończenia nie może być wcześniejsza niż data rozpoczęcia",
      endDateSameAsStartDate:
        "Data zakończenia nie może być taka sama jak data rozpoczęcia",
    ...
    dismissReceiptErrorConfirmation:
      "Uwaga! Zamknięcie tego błędu spowoduje całkowite usunięcie przesłanego paragonu. Czy na pewno chcesz kontynuować?",
    ...
    selectUnreportedExpense:
      "Wybierz co najmniej jeden wydatek, aby dodać go do raportu.",
    emptyStateUnreportedExpenseTitle: "Brak nierozliczonych wydatków",
    emptyStateUnreportedExpenseSubtitle:
      "Wygląda na to, że nie masz żadnych nierozliczonych wydatków. Spróbuj utworzyć jeden poniżej.",
    ...
    expenseOnHold:
      "Ten wydatek został wstrzymany. Sprawdź komentarze, aby poznać kolejne kroki.",
    expensesOnHold:
      "Wszystkie wydatki zostały wstrzymane. Sprawdź komentarze, aby poznać kolejne kroki.",
    expenseDuplicate:
      "Ten wydatek ma szczegóły podobne do innego. Sprawdź duplikaty, aby kontynuować.",
    someDuplicatesArePaid:
      "Niektóre z tych duplikatów zostały już zatwierdzone lub opłacone.",
    reviewDuplicates: "Przejrzyj duplikaty",
    keepAll: "Zachowaj wszystko",
    noDuplicatesTitle: "Wszystko gotowe!",
    noDuplicatesDescription:
      "Nie ma tutaj zduplikowanych transakcji do sprawdzenia.",
    confirmApprove: "Potwierdź kwotę zatwierdzenia",
    confirmApprovalAmount:
      "Zatwierdź tylko zgodne wydatki lub zatwierdź cały raport.",
    ...
    confirmPayAmount:
      "Zapłać to, co nie jest wstrzymane, lub zapłać cały raport.",
    ...
    whatIsHoldExplain:
      "Wstrzymanie działa jak naciśnięcie „pauzy” na wydatku, dopóki nie będziesz gotowy, aby go przesłać.",
    holdIsLeftBehind:
      "Wstrzymane wydatki pozostają nieprzetworzone, nawet jeśli prześlesz cały raport.",
    unholdWhenReady:
      "Zdejmij wstrzymanie z wydatków, gdy będziesz gotowy(-a) je przesłać.",
    changePolicyEducational: {
      title: "Przeniesiono ten raport!",
      description:
        "Sprawdź dokładnie te elementy, które zwykle się zmieniają podczas przenoszenia raportów do nowej przestrzeni roboczej.",
      reCategorize:
        "<strong>Przeklasyfikuj wszystkie wydatki</strong>, aby były zgodne z zasadami przestrzeni roboczej.",
      workflows:
        "Ten raport może teraz podlegać innemu <strong>procesowi zatwierdzania.</strong>",
    },
    ...
    chooseARate:
      "Wybierz stawkę zwrotu kosztów za milę lub kilometr dla przestrzeni roboczej",
    ...
    bookingPendingDescription:
      "Ta rezerwacja jest oczekująca, ponieważ nie została jeszcze opłacona.",
    bookingArchived: "Ta rezerwacja jest zarchiwizowana",
    bookingArchivedDescription:
      "Ta rezerwacja została zarchiwizowana, ponieważ data podróży już minęła. W razie potrzeby dodaj wydatek na ostateczną kwotę.",
    ...
    deleteSubrateConfirmation:
      "Czy na pewno chcesz usunąć tę stawkę podrzędną?",
    quantity: "Ilość",
    ...
    dates: "Daty",
    rates: "Stawki",
    submitsTo: (name: string) => `Przesyła do ${name}`,
    reject: {
      educationalTitle: "Zatrzymać czy odrzucić?",
      educationalText:
        "Jeśli nie jesteś gotowy, aby zatwierdzić lub opłacić wydatek, możesz go wstrzymać lub odrzucić.",
      holdExpenseTitle:
        "Wstrzymaj wydatek, aby poprosić o więcej szczegółów przed jego zatwierdzeniem lub wypłatą.",
      approveExpenseTitle:
        "Zatwierdzaj inne wydatki, podczas gdy wstrzymane wydatki pozostają przypisane do Ciebie.",
      heldExpenseLeftBehindTitle:
        "Wstrzymane wydatki są pomijane, gdy zatwierdzasz cały raport.",
      rejectExpenseTitle:
        "Odrzuć wydatek, którego nie zamierzasz zatwierdzić ani opłacić.",
      reasonPageTitle: "Odrzuć wydatek",
      reasonPageDescription:
        "Wyjaśnij, dlaczego nie zatwierdzisz tego wydatku.",
      rejectReason: "Powód odrzucenia",
      markAsResolved: "Oznacz jako rozwiązane",
      rejectedStatus:
        "Ten wydatek został odrzucony. Czekamy, aż naprawisz problemy i oznaczysz go jako rozwiązany, aby umożliwić przesłanie.",
      reportActions: {
    ...
    moveExpensesError:
      "Nie możesz przenosić diet do raportów w innych przestrzeniach roboczych, ponieważ stawki diet mogą się różnić między przestrzeniami roboczymi.",
    changeApprover: {
      ...
      changedApproverMessage: (managerID: number) =>
        `zmienił(a) akceptującego na <mention-user accountID="${managerID}"/>`,
      actions: {
        addApprover: "Dodaj zatwierdzającego",
        addApproverSubtitle:
          "Dodaj dodatkową osobę zatwierdzającą do istniejącego przepływu zatwierdzania.",
        bypassApprovers: "Pomiń zatwierdzających",
        bypassApproversSubtitle:
          "Przypisz siebie jako ostatecznego akceptującego i pomiń wszystkich pozostałych akceptujących.",
      },
      addApprover: {
        subtitle:
          "Wybierz dodatkowego akceptującego ten raport, zanim przekażemy go dalej w procesie akceptacji.",
      },
    },
    chooseWorkspace: "Wybierz przestrzeń roboczą",
    routedDueToDEW: (to: string) =>
      `raport skierowano do ${to} z powodu niestandardowego przepływu zatwierdzania`,
    timeTracking: {
      hoursAt: (hours: number, rate: string) =>
        `${hours} ${hours === 1 ? "godzina" : "godziny"} @ ${rate} / godzinę`,
      hrs: "godz.",
      hours: "Godziny",
      ratePreview: (rate: string) => `${rate} / godzinę`,
      amountTooLargeError:
        "Łączna kwota jest zbyt wysoka. Zmniejsz liczbę godzin lub obniż stawkę.",
    },
    ...
    rulesModifiedFields: {
      reimbursable: (value: boolean) =>
        value
          ? "oznaczył(a) wydatek jako „podlegający zwrotowi”"
          : "oznaczył(a) wydatek jako „niepodlegający zwrotowi kosztów”",
      billable: (value: boolean) =>
        value
          ? "oznaczył(-a) wydatek jako „fakturowany”"
          : "oznaczono wydatek jako „niefakturowalny”",
      tax: (value: string, isFirst: boolean) =>
        isFirst
          ? `ustaw stawkę podatku na „${value}”`
          : `stawka podatku na „${value}”`,
      reportName: (value: string) =>
        `przeniósł ten wydatek do raportu „${value}”`,
      common: (
        key:
        ...
        return isFirst
          ? `ustaw ${field} na „${value}”`
          : `${field} na „${value}”`;
      },
      formatPersonalRules: (fragments: string, route: string) =>
        `${fragments} przez <a href="${route}">zasady wydatków prywatnych</a>`,
      formatPolicyRules: (fragments: string, route: string) =>
        `${fragments} przez <a href="${route}">zasady workspace’u</a>`,
    },
    failedToAutoSubmitViaDEW: (reason: string) =>
      `nie udało się przesłać raportu przez <a href="${CONST.SELECT_WORKFLOWS_HELP_URL}">opóźnianie wysyłki</a>. ${reason}`,
    failedToSubmitViaDEW: (reason: string) =>
      `nie udało się wysłać raportu. ${reason}`,
    ...
    failedToApproveViaDEW: (reason: string) =>
      `nie udało się zaakceptować. ${reason}`,
    cannotDuplicateDistanceExpense:
      "Nie możesz duplikować wydatków za przejazdy między przestrzeniami roboczymi, ponieważ stawki mogą się różnić między poszczególnymi przestrzeniami.",
  },
  transactionMerge: {
    listPage: {
    ...
    detailsPage: {
      ...
      selectAllDetailsError:
        "Zaznacz wszystkie szczegóły przed kontynuowaniem.",
    },
    confirmationPage: {
      header: "Potwierdź szczegóły",
      pageTitle:
        "Potwierdź szczegóły, które zachowujesz. Szczegóły, których nie zachowasz, zostaną usunięte.",
  ...
  loginField: {
    numberHasNotBeenValidated:
      "Numer nie został zweryfikowany. Kliknij przycisk, aby ponownie wysłać link weryfikacyjny w wiadomości tekstowej.",
    emailHasNotBeenValidated:
      "Adres e-mail nie został zweryfikowany. Kliknij przycisk, aby ponownie wysłać link weryfikacyjny w wiadomości tekstowej.",
  },
  avatarWithImagePicker: {
    ...
    deleteWorkspaceError:
      "Przepraszamy, wystąpił nieoczekiwany problem podczas usuwania awatara Twojego przestrzeni roboczej",
    sizeExceeded: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Wybrany obraz przekracza maksymalny rozmiar przesyłania ${maxUploadSizeInMB} MB.`,
  ...
  nextStep: {
    message: {
      ...
      [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_SUBMIT]: ({
        ...
        switch (actorType) {
          case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
            return `Oczekiwanie, aż <strong>ty</strong> zgłosisz wydatki.`;
          case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
      ...
      [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_APPROVE]: ({
        ...
        switch (actorType) {
          case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
            return `Oczekiwanie na <strong>Twoje</strong> zatwierdzenie wydatków.`;
          case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
      ...
      [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_EXPORT]: ({
        ...
        switch (actorType) {
          case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
            return `Oczekujemy, aż <strong>ty</strong> wyeksportujesz ten raport.`;
          case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
      ...
      [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_PAY]: ({
        ...
        switch (actorType) {
          case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
            return `Czekamy, aż <strong>Ty</strong> opłacisz wydatki.`;
          case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
      ...
      [CONST.NEXT_STEP.MESSAGE_KEY.SUBMITTING_TO_SELF]: (_: NextStepParams) =>
        `Ups! Wygląda na to, że wysyłasz zgłoszenie <strong>do siebie</strong>. Zatwierdzanie własnych raportów jest <strong>zabronione</strong> w Twojej przestrzeni roboczej. Wyślij ten raport do kogoś innego lub skontaktuj się z administratorem, aby zmienić osobę, do której wysyłasz zgłoszenia.`,
    },
    eta: {
      ...
      [CONST.NEXT_STEP.ETA_KEY.LAST_BUSINESS_DAY_OF_MONTH]:
        "w ostatnim dniu roboczym miesiąca",
  ...
  profilePage: {
    ...
    publicSection: {
      title: "Public",
      subtitle:
        "Te dane są wyświetlane w Twoim publicznym profilu. Każdy może je zobaczyć.",
    },
    privateSection: {
      title: "Prywatne",
      subtitle:
        "Te dane są używane do podróży i płatności. Nigdy nie są wyświetlane w Twoim publicznym profilu.",
    },
  },
  securityPage: {
  ...
  shareCodePage: {
    title: "Twój kod",
    subtitle:
      "Zaproś członków do Expensify, udostępniając swój osobisty kod QR lub link polecający.",
  },
  pronounsPage: {
    pronouns: "Zaimki",
  ...
  contacts: {
    ...
    enterMagicCode: (contactMethod: string) =>
      `Wpisz magiczny kod wysłany na ${contactMethod}. Powinien dotrzeć w ciągu minuty lub dwóch.`,
    ...
    removeAreYouSure:
      "Czy na pewno chcesz usunąć tę metodę kontaktu? Tej akcji nie można cofnąć.",
    failedNewContact: "Nie udało się dodać tej metody kontaktu.",
    genericFailureMessages: {
      requestContactMethodValidateCode:
        "Nie udało się wysłać nowego magicznego kodu. Poczekaj chwilę i spróbuj ponownie.",
      validateSecondaryLogin:
        "Nieprawidłowy lub niepoprawny kod magiczny. Spróbuj ponownie lub poproś o nowy kod.",
      deleteContactMethod:
        "Nie udało się usunąć metody kontaktu. Skontaktuj się z Concierge, aby uzyskać pomoc.",
      setDefaultContactMethod:
        "Nie udało się ustawić nowej domyślnej metody kontaktu. Skontaktuj się z Concierge, aby uzyskać pomoc.",
      addContactMethod:
        "Nie udało się dodać tej metody kontaktu. Skontaktuj się z Concierge, aby uzyskać pomoc.",
    ...
    yourDefaultContactMethodRestrictedSwitch:
      "To jest Twoja domyślna metoda kontaktu. Twoja firma zablokowała możliwość usuwania lub zmiany tej metody.",
  },
  pronouns: {
    coCos: "Co / Coś",
  ...
  updateRequiredView: {
    ...
    toGetLatestChanges:
      "Na urządzeniu mobilnym pobierz i zainstaluj najnowszą wersję. W przeglądarce odśwież stronę.",
  ...
  initialSettingsPage: {
    ...
    troubleshoot: {
      ...
      confirmResetDescription:
        "Wszystkie niewysłane szkice wiadomości zostaną utracone, ale reszta Twoich danych jest bezpieczna.",
      ...
      maskExportOnyxStateData:
        "Maskuj wrażliwe dane członków podczas eksportu stanu Onyx",
      ...
      usingImportedState:
        "Używasz zaimportowanego stanu. Naciśnij tutaj, aby go wyczyścić.",
      debugMode: "Tryb debugowania",
      invalidFile: "Nieprawidłowy plik",
      invalidFileDescription:
        "Plik, który próbujesz zaimportować, jest nieprawidłowy. Spróbuj ponownie.",
      ...
      sentryHighlightedSpanOpsPlaceholder:
        "kliknięcie interfejsu, nawigacja, ładowanie interfejsu",
    },
    security: "Bezpieczeństwo",
    signOut: "Wyloguj się",
    restoreStashed: "Przywróć zapisane logowanie",
    signOutConfirmationText:
      "Utracisz wszystkie zmiany w trybie offline, jeśli się wylogujesz.",
    versionLetter: "v",
  ...
  closeAccountPage: {
    ...
    reasonForLeavingPrompt:
      "Byłoby nam bardzo przykro, gdybyś odszedł! Czy mógłbyś nam powiedzieć, dlaczego, abyśmy mogli się poprawić?",
    ...
    closeAccountPermanentlyDeleteData:
      "Na pewno chcesz usunąć swoje konto? Spowoduje to trwałe usunięcie wszystkich nierozliczonych wydatków.",
    enterDefaultContactToConfirm:
      "Wpisz swoją domyślną metodę kontaktu, aby potwierdzić, że chcesz zamknąć konto. Twoja domyślna metoda kontaktu to:",
    ...
    enterYourDefaultContactMethod:
      "Aby zamknąć konto, wprowadź domyślną metodę kontaktu.",
  },
  mergeAccountsPage: {
    mergeAccount: "Połącz konta",
    accountDetails: {
      accountToMergeInto: (login: string) =>
        `Wpisz konto, które chcesz połączyć z kontem <strong>${login}</strong>.`,
    ...
    accountValidate: {
      ...
      enterMagicCode: (login: string) =>
        `Aby kontynuować, wprowadź magiczny kod wysłany na adres <strong>${login}</strong>.`,
      errors: {
        incorrectMagicCode:
          "Nieprawidłowy lub niepoprawny kod magiczny. Spróbuj ponownie lub poproś o nowy kod.",
    ...
    mergePendingSAML: {
      ...
      limitedSupport:
        "Nie obsługujemy jeszcze łączenia kont w Nowym Expensify. Wykonaj tę akcję w Expensify Classic.",
      reachOutForHelp:
        "<muted-text><centered-text>Jeśli masz jakieś pytania, śmiało <concierge-link>skontaktuj się z Concierge</concierge-link>!</centered-text></muted-text>",
    ...
    mergeFailureTooManyAttempts: {
      ...
      description:
        "Wykonano zbyt wiele prób połączenia kont. Spróbuj ponownie później.",
    },
    mergeFailureUnvalidatedAccount: {
      description:
        "Nie możesz scalić z innymi kontami, ponieważ to konto nie jest zweryfikowane. Zweryfikuj konto i spróbuj ponownie.",
    },
  ...
  lockAccountPage: {
    ...
    domainAdminsDescription:
      "Dla administratorów domen: to również wstrzymuje całą aktywność Kart Expensify i działania administracyjne w twoich domenach.",
    areYouSure: "Czy na pewno chcesz zablokować swoje konto Expensify?",
    onceLocked:
      "Po zablokowaniu Twoje konto będzie ograniczone do czasu złożenia prośby o odblokowanie i przeprowadzenia kontroli bezpieczeństwa",
    unlockTitle: "Otrzymaliśmy Twoją prośbę",
    unlockDescription:
      "Przejrzymy konto, aby potwierdzić, że bezpiecznie je odblokować, i skontaktujemy się przez Concierge w razie pytań.",
  },
  ...
  unlockAccountPage: {
    ...
    chatToConciergeToUnlock:
      "Porozmawiaj z Concierge, aby rozwiązać problemy z bezpieczeństwem i odblokować swoje konto.",
    chatWithConcierge: "Czat z Concierge",
  },
  twoFactorAuth: {
    ...
    explainProcessToRemove:
      "Aby wyłączyć uwierzytelnianie dwuskładnikowe (2FA), wprowadź prawidłowy kod z aplikacji uwierzytelniającej.",
    explainProcessToRemoveWithRecovery:
      "Aby wyłączyć uwierzytelnianie dwuskładnikowe (2FA), wprowadź prawidłowy kod odzyskiwania.",
    disabled: "Uwierzytelnianie dwuskładnikowe jest teraz wyłączone",
    noAuthenticatorApp:
      "Nie będziesz już potrzebować aplikacji uwierzytelniającej, aby logować się do Expensify.",
    ...
    enterCode:
      "Następnie wprowadź sześciocyfrowy kod wygenerowany przez aplikację uwierzytelniającą.",
    ...
    twoFactorAuthIsRequiredDescription:
      "Ze względów bezpieczeństwa Xero wymaga uwierzytelniania dwuskładnikowego, aby połączyć integrację.",
    twoFactorAuthIsRequiredForAdminsHeader:
      "Wymagane uwierzytelnianie dwuskładnikowe",
    twoFactorAuthIsRequiredForAdminsTitle:
      "Włącz uwierzytelnianie dwuskładnikowe",
    twoFactorAuthIsRequiredXero:
      "Twoje połączenie księgowe z Xero wymaga uwierzytelniania dwuskładnikowego.",
    twoFactorAuthIsRequiredCompany:
      "Twoetapowe uwierzytelnianie jest wymagane przez Twoją firmę.",
    twoFactorAuthCannotDisable: "Nie można wyłączyć 2FA",
    twoFactorAuthRequired:
      "Dla połączenia z Xero wymagana jest weryfikacja dwuetapowa (2FA) i nie można jej wyłączyć.",
  },
  recoveryCodeForm: {
    error: {
      pleaseFillRecoveryCode: "Wprowadź swój kod odzyskiwania",
      incorrectRecoveryCode:
        "Nieprawidłowy kod odzyskiwania. Spróbuj ponownie.",
    },
  ...
  twoFactorAuthForm: {
    error: {
      pleaseFillTwoFactorAuth:
        "Wprowadź swój kod uwierzytelniania dwuskładnikowego",
      incorrect2fa:
        "Nieprawidłowy kod uwierzytelniania dwuskładnikowego. Spróbuj ponownie.",
    },
  },
  ...
  privateNotes: {
    ...
    personalNoteMessage:
      "Zapisuj notatki o tej rozmowie tutaj. Tylko Ty możesz je dodawać, edytować lub przeglądać.",
    sharedNoteMessage:
      "Zapisuj tutaj notatki dotyczące tej rozmowy. Pracownicy Expensify oraz inni członkowie w domenie team.expensify.com mogą je zobaczyć.",
  ...
  billingCurrency: {
    ...
    paymentCurrencyDescription:
      "Wybierz standardową walutę, na którą mają być przeliczane wszystkie wydatki osobiste",
  ...
  addDebitCardPage: {
    ...
    error: {
      ...
      securityCode: "Wprowadź prawidłowy kod zabezpieczający",
      addressStreet:
        "Wprowadź prawidłowy adres rozliczeniowy, który nie jest skrytką pocztową",
      addressState: "Wybierz stan",
      addressCity: "Wpisz miasto",
      genericFailureMessage:
        "Wystąpił błąd podczas dodawania Twojej karty. Spróbuj ponownie.",
  ...
  walletPage: {
    ...
    error: {
      notOwnerOfBankAccount:
        "Wystąpił błąd podczas ustawiania tego konta bankowego jako domyślnej metody płatności",
      invalidBankAccount: "To konto bankowe jest tymczasowo zawieszone",
      notOwnerOfFund:
        "Wystąpił błąd podczas ustawiania tej karty jako domyślnej metody płatności",
      setDefaultFailure:
        "Coś poszło nie tak. Porozmawiaj z Concierge, aby uzyskać dalszą pomoc.",
    },
    addBankAccountFailure:
      "Wystąpił nieoczekiwany błąd podczas próby dodania Twojego konta bankowego. Spróbuj ponownie.",
    getPaidFaster: "Szybciej otrzymuj płatności",
    addPaymentMethod:
      "Dodaj metodę płatności, aby wysyłać i odbierać płatności bezpośrednio w aplikacji.",
    ...
    sendAndReceiveMoney:
      "Wysyłaj i odbieraj pieniądze ze znajomymi. Tylko konta bankowe w USA.",
    enableWallet: "Włącz portfel",
    addBankAccountToSendAndReceive:
      "Dodaj konto bankowe, aby wysyłać lub odbierać płatności.",
    addDebitOrCreditCard: "Dodaj kartę debetową lub kredytową",
    assignedCards: "Przypisane karty",
    assignedCardsDescription:
      "Transakcje z tych kart synchronizują się automatycznie.",
    expensifyCard: "Karta Expensify",
    walletActivationPending:
      "Sprawdzamy Twoje informacje. Sprawdź ponownie za kilka minut!",
    walletActivationFailed:
      "Niestety w tej chwili nie można włączyć Twojego portfela. Skontaktuj się z Concierge, aby uzyskać dalszą pomoc.",
    addYourBankAccount: "Dodaj swoje konto bankowe",
    addBankAccountBody:
      "Połącz swoje konto bankowe z Expensify, aby jeszcze łatwiej wysyłać i otrzymywać płatności bezpośrednio w aplikacji.",
    ...
    shareBankAccountTitle:
      "Wybierz administratorów, z którymi chcesz udostępnić to konto bankowe:",
    shareBankAccountSuccess: "Udostępniono konto bankowe!",
    shareBankAccountSuccessDescription:
      "Wybrani administratorzy otrzymają wiadomość z potwierdzeniem od Concierge.",
    shareBankAccountFailure:
      "Wystąpił nieoczekiwany błąd podczas próby udostępnienia konta bankowego. Spróbuj ponownie.",
    shareBankAccountEmptyTitle: "Brak dostępnych administratorów",
    shareBankAccountEmptyDescription:
      "Nie ma żadnych administratorów przestrzeni roboczej, z którymi możesz udostępnić to konto bankowe.",
    shareBankAccountNoAdminsSelected:
      "Wybierz administratora przed kontynuowaniem",
    unshareBankAccount: "Przestań udostępniać konto bankowe",
    unshareBankAccountDescription:
      "Wszyscy poniżej mają dostęp do tego konta bankowego. Możesz w każdej chwili odebrać im dostęp. Nadal zrealizujemy wszystkie płatności będące w toku.",
    unshareBankAccountWarning: ({ admin }: { admin?: string | null }) =>
      `${admin} straci dostęp do tego firmowego konta bankowego. Nadal zrealizujemy wszystkie płatności w toku.`,
    reachOutForHelp:
      "Jest używany z Kartą Expensify. <concierge-link>Skontaktuj się z Concierge</concierge-link>, jeśli musisz przestać się nim dzielić.",
    unshareErrorModalTitle: "Nie można cofnąć udostępniania konta bankowego",
    travelCVV: {
      title: "CVV podróży",
      subtitle: "Użyj tego podczas rezerwacji podróży",
      description:
        "Użyj tej karty do rezerwacji w Expensify Travel. Podczas płatności będzie wyświetlana jako “Travel Card”.",
    },
  ...
  cardPage: {
    ...
    smartLimit: {
      ...
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
        `Możesz wydać do ${formattedLimit} tą kartą, a limit będzie się odnawiał w miarę zatwierdzania zgłoszonych wydatków.`,
    },
    fixedLimit: {
      name: "Stały limit",
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
        `Możesz wydać do ${formattedLimit} na tej karcie, a następnie zostanie ona dezaktywowana.`,
    },
    monthlyLimit: {
    ...
    suspiciousBannerDescription:
      "Wykryliśmy podejrzane transakcje na Twojej karcie. Stuknij poniżej, aby je sprawdzić.",
    cardLocked:
      "Twoja karta jest tymczasowo zablokowana, podczas gdy nasz zespół sprawdza konto Twojej firmy.",
    markTransactionsAsReimbursable:
      "Oznacz transakcje jako podlegające zwrotowi",
    markTransactionsDescription:
      "Po włączeniu transakcje zaimportowane z tej karty są domyślnie oznaczane jako podlegające zwrotowi.",
    ...
    cardAddedToWallet: ({ platform }: { platform: "Google" | "Apple" }) =>
      `Dodano do portfela ${platform}`,
    cardDetailsLoadingFailure:
      "Wystąpił błąd podczas wczytywania szczegółów karty. Sprawdź swoje połączenie internetowe i spróbuj ponownie.",
    validateCardTitle: "Upewnijmy się, że to Ty",
    enterMagicCode: (contactMethod: string) =>
      `Wprowadź magiczny kod wysłany na ${contactMethod}, aby wyświetlić szczegóły karty. Powinien dotrzeć w ciągu minuty lub dwóch.`,
    missingPrivateDetails: ({
      missingDetailsLink,
    }: {
      missingDetailsLink: string;
    }) =>
      `Dodaj proszę <a href="${missingDetailsLink}">swoje dane osobowe</a>, a następnie spróbuj ponownie.`,
    unexpectedError:
      "Wystąpił błąd podczas pobierania szczegółów Twojej karty Expensify. Spróbuj ponownie.",
    cardFraudAlert: {
      confirmButtonText: "Tak, robię",
      reportFraudButtonText: "Nie, to nie byłem ja",
      clearedMessage: ({ cardLastFour }: { cardLastFour: string }) =>
        `usunął podejrzaną aktywność i ponownie aktywował kartę x${cardLastFour}. Możesz dalej rozliczać wydatki!`,
      deactivatedMessage: ({ cardLastFour }: { cardLastFour: string }) =>
        `dezaktywowano kartę kończącą się na ${cardLastFour}`,
      alertMessage: ({
        cardLastFour,
        amount,
        merchant,
...
${amount} dla ${merchant} - ${date}`,
    ...
    freezeDescription:
      "Zamrożonej karty nie można używać do zakupów i transakcji. Możesz ją odmrozić w dowolnym momencie.",
    unfreezeDescription:
      "Odmrożenie tej karty ponownie umożliwi zakupy i transakcje. Kontynuuj tylko wtedy, gdy masz pewność, że korzystanie z karty jest bezpieczne.",
    frozen: "Zamrożona",
    youFroze: ({ date }: { date: string }) => `Zamroziłeś tę kartę ${date}.`,
    frozenBy: ({ person, date }: { person: string; date: string }) =>
      `${person} zamroził(a) tę kartę ${date}.`,
  },
  workflowsPage: {
    workflowTitle: "Wydatki",
    workflowDescription:
      "Skonfiguruj workflow od momentu poniesienia wydatku, łącznie z akceptacją i płatnością.",
    submissionFrequency: "Zgłoszenia",
    submissionFrequencyDescription:
      "Wybierz niestandardowy harmonogram składania wydatków.",
    submissionFrequencyDateOfMonth: "Dzień miesiąca",
    disableApprovalPromptDescription:
      "Wyłączenie zatwierdzania usunie wszystkie istniejące procesy zatwierdzania.",
    ...
    accessibilityLabel: ({
      ...
      members: string;
      approvers: string;
    }) => `wydatki od ${members}, a zatwierdzającym jest ${approvers}`,
    addApprovalButton: "Dodaj proces akceptacji",
    findWorkflow: "Znajdź przepływ pracy",
    addApprovalTip:
      "Domyślny proces pracy ma zastosowanie do wszystkich członków, chyba że istnieje bardziej szczegółowy proces pracy.",
    approver: "Osoba zatwierdzająca",
    addApprovalsDescription:
      "Wymagaj dodatkowej akceptacji przed autoryzacją płatności.",
    makeOrTrackPaymentsTitle: "Płatności",
    makeOrTrackPaymentsDescription:
      "Dodaj upoważnionego płatnika dla płatności dokonywanych w Expensify lub śledź płatności wykonywane gdzie indziej.",
    ...
    editor: {
      submissionFrequency:
        "Wybierz, jak długo Expensify ma czekać, zanim udostępni wydatki bez błędów.",
    },
    frequencyDescription:
      "Wybierz, jak często wydatki mają być wysyłane automatycznie, lub ustaw wysyłanie ręczne",
    frequencies: {
      instant: "Natychmiast",
      weekly: "Co tydzień",
      monthly: "Miesięcznie",
    ...
    approverInMultipleWorkflows:
      "Ten członek należy już do innego procesu zatwierdzania. Wszelkie zmiany wprowadzone tutaj będą widoczne także tam.",
    ...
    emptyContent: {
      ...
      expensesFromSubtitle:
        "Wszyscy członkowie tego obszaru roboczego już należą do istniejącego obiegu zatwierdzania.",
      approverSubtitle:
        "Wszyscy zatwierdzający należą do istniejącego przepływu pracy.",
    },
  },
  workflowsDelayedSubmissionPage: {
    autoReportingFrequencyErrorMessage:
      "Nie udało się zmienić częstotliwości wysyłania. Spróbuj ponownie lub skontaktuj się z pomocą techniczną.",
    monthlyOffsetErrorMessage:
      "Nie można było zmienić miesięcznej częstotliwości. Spróbuj ponownie lub skontaktuj się z pomocą techniczną.",
  },
  ...
  workflowsEditApprovalsPage: {
    ...
    deletePrompt:
      "Czy na pewno chcesz usunąć ten proces zatwierdzania? Wszyscy członkowie będą następnie korzystać z domyślnego procesu.",
  },
  ...
  workflowsApproverPage: {
    genericErrorMessage:
      "Nie udało się zmienić osoby zatwierdzającej. Spróbuj ponownie lub skontaktuj się z pomocą techniczną.",
  ...
  workflowsApprovalLimitPage: {
    ...
    enterApproverError:
      "Zatwierdzający jest wymagany, gdy ustawisz limit raportu",
    ...
    forwardLimitDescription: ({
      ...
      approverName: string;
    }) => `Raporty powyżej ${approvalLimit} przekazuj do ${approverName}`,
  },
  workflowsPayerPage: {
    title: "Upoważniony płatnik",
    genericErrorMessage:
      "Nie można było zmienić upoważnionej osoby płacącej. Spróbuj ponownie.",
  ...
  reportFraudPage: {
    ...
    description:
      "Jeśli dane Twojej wirtualnej karty zostały skradzione lub przejęte, trwale dezaktywujemy Twoją obecną kartę i zapewnimy Ci nową wirtualną kartę z nowym numerem.",
  ...
  reportFraudConfirmationPage: {
    ...
    description:
      "Trwale dezaktywowaliśmy Twoją dotychczasową kartę. Gdy wrócisz do szczegółów karty, będzie tam dostępna nowa wirtualna karta.",
  ...
  activateCardPage: {
    ...
    error: {
      thatDidNotMatch:
        "To nie zgadza się z ostatnimi 4 cyframi Twojej karty. Spróbuj ponownie.",
      throttled:
  ...
  getPhysicalCard: {
    ...
    nameMessage:
      "Wpisz swoje imię i nazwisko, ponieważ zostaną one wyświetlone na Twojej karcie.",
    ...
    estimatedDeliveryMessage:
      "Twoja fizyczna karta dotrze w ciągu 2–3 dni roboczych.",
    next: "Dalej",
    getPhysicalCard: "Zamów kartę fizyczną",
    shipCard: "Wyślij kartę",
  },
  transferAmountPage: {
    transfer: (amount: string) => `Przelew${amount ? ` ${amount}` : ""}`,
    instant: "Natychmiastowa (karta debetowa)",
    instantSummary: (rate: string, minAmount: string) =>
      `Opłata ${rate}% (minimum ${minAmount})`,
    ...
    transferDetailBankAccount:
      "Twoje pieniądze powinny dotrzeć w ciągu najbliższych 1–3 dni roboczych.",
    transferDetailDebitCard: "Twoje pieniądze powinny dotrzeć natychmiast.",
    failedTransfer:
      "Twoje saldo nie jest w pełni rozliczone. Przelej środki na konto bankowe.",
  ...
  expenseRulesPage: {
    ...
    changes: {
      billableUpdate: (value: boolean) =>
        `Zaktualizuj wydatek ${value ? "rozliczalny" : "niepodlegające fakturowaniu"}`,
    ...
    addRule: {
      ...
      merchantHint:
        "Wpisz . , aby utworzyć regułę, która będzie miała zastosowanie do wszystkich sprzedawców",
  ...
  preferencesPage: {
    ...
    testSection: {
      ...
      subtitle:
        "Ustawienia pomocne przy debugowaniu i testowaniu aplikacji na środowisku staging.",
    },
    receiveRelevantFeatureUpdatesAndExpensifyNews:
      "Otrzymuj istotne aktualizacje funkcji i wiadomości od Expensify",
    muteAllSounds: "Wycisz wszystkie dźwięki z Expensify",
  },
  priorityModePage: {
    priorityMode: "Tryb priorytetowy",
    explainerText:
      "Wybierz, czy #skupić się tylko na nieprzeczytanych i przypiętych czatach, czy wyświetlać wszystko, z najnowszymi i przypiętymi czatami na górze.",
    priorityModes: {
      default: {
        label: "Najnowsze",
  ...
  reportDetailsPage: {
    ...
    successPDF:
      "Twój plik PDF został wygenerowany! Jeśli nie pobrał się automatycznie, użyj przycisku poniżej.",
  },
  ...
  groupChat: {
    ...
    lastMemberWarning:
      "Ponieważ jesteś ostatnią osobą w tym czacie, wyjście spowoduje, że stanie się on niedostępny dla wszystkich członków. Czy na pewno chcesz opuścić czat?",
    defaultReportName: ({ displayName }: ReportArchiveReasonsClosedParams) =>
      `Czat grupowy ${displayName}`,
  },
  languagePage: {
    language: "Język",
    aiGenerated:
      "Tłumaczenia dla tego języka są generowane automatycznie i mogą zawierać błędy.",
  },
  themePage: {
    theme: "Motyw",
    themes: {
    ...
    chooseThemeBelowOrSync:
      "Wybierz motyw poniżej lub zsynchronizuj z ustawieniami urządzenia.",
  },
  termsOfUse: {
  ...
  validateCodeForm: {
    ...
    requestNewCode: ({ timeRemaining }: { timeRemaining: string }) =>
      `Poproś o nowy kod za <a>${timeRemaining}</a>`,
  ...
  passwordForm: {
    ...
    enterYourTwoFactorAuthenticationCodeToContinue:
      "Wprowadź swój kod uwierzytelniania dwuskładnikowego, aby kontynuować",
    ...
    error: {
      ...
      twoFactorAuthenticationEnabled:
        "Masz włączone uwierzytelnianie dwuskładnikowe (2FA) na tym koncie. Zaloguj się, używając adresu e-mail lub numeru telefonu.",
      invalidLoginOrPassword:
        "Nieprawidłowy login lub hasło. Spróbuj ponownie lub zresetuj swoje hasło.",
      ...
      noAccess:
        "Nie masz dostępu do tej aplikacji. Dodaj swoją nazwę użytkownika GitHub, aby uzyskać dostęp.",
      accountLocked:
        "Twoje konto zostało zablokowane po zbyt wielu nieudanych próbach logowania. Spróbuj ponownie za 1 godzinę.",
      fallback: "Coś poszło nie tak. Spróbuj ponownie później.",
    },
  },
  loginForm: {
    ...
    error: {
      invalidFormatEmailLogin:
        "Wprowadzony adres e-mail jest nieprawidłowy. Popraw jego format i spróbuj ponownie.",
    },
    cannotGetAccountDetails:
      "Nie można pobrać szczegółów konta. Spróbuj zalogować się ponownie.",
  ...
  onboarding: {
    ...
    welcomeSignOffTitleManageTeam:
      "Gdy ukończysz powyższe zadania, będziemy mogli poznać więcej funkcji, takich jak przepływy akceptacji i reguły!",
    welcomeSignOffTitle: "Miło cię poznać!",
    explanationModal: {
      title: "Witamy w Expensify",
      description:
        "Jedna aplikacja do obsługi firmowych i prywatnych wydatków w tempie czatu. Wypróbuj ją i daj nam znać, co o niej myślisz. To dopiero początek!",
      secondaryDescription:
        "Aby wrócić do Expensify Classic, po prostu stuknij swoje zdjęcie profilowe > Przejdź do Expensify Classic.",
    },
    getStarted: "Rozpocznij",
    whatsYourName: "Jak masz na imię?",
    peopleYouMayKnow:
      "Osoby, które możesz znać, są już tutaj! Zweryfikuj swój e-mail, aby do nich dołączyć.",
    workspaceYouMayJoin: ({ domain, email }: WorkspaceYouMayJoin) =>
      `Ktoś z domeny ${domain} utworzył już przestrzeń roboczą. Wprowadź magiczny kod wysłany na adres ${email}.`,
    ...
    workspaceMemberList: ({
      ...
      `${employeeCount} członek${employeeCount > 1 ? "s" : ""} • ${policyOwner}`,
    ...
    workEmail: {
      ...
      subtitle:
        "Expensify działa najlepiej, gdy podłączysz swój służbowy adres e‑mail.",
      explanationModal: {
        descriptionOne:
          "Przekaż na adres receipts@expensify.com do zeskanowania",
        descriptionTwo:
          "Dołącz do swoich współpracowników, którzy już korzystają z Expensify",
    ...
    workEmailValidation: {
      ...
      magicCodeSent: ({ workEmail }: WorkEmailResendCodeParams) =>
        `Wprowadź magiczny kod wysłany na adres ${workEmail}. Powinien dotrzeć w ciągu minuty lub dwóch.`,
    },
    workEmailValidationError: {
      publicEmail:
        "Wpisz poprawny służbowy adres e‑mail z prywatnej domeny, np. mitch@company.com",
      offline:
        "Nie mogliśmy dodać Twojego służbowego adresu e‑mail, ponieważ wydajesz się być offline",
    },
    mergeBlockScreen: {
    ...
    tasks: {
      testDriveAdminTask: {
        ...
        description: ({ testDriveURL }) =>
          `[Weź krótką wycieczkę po produkcie](${testDriveURL}), aby zobaczyć, dlaczego Expensify jest najszybszym sposobem rozliczania wydatków.`,
      },
      testDriveEmployeeTask: {
        title: ({ testDriveURL }) => `Zrób [jazdę próbną](${testDriveURL})`,
        description: ({ testDriveURL }) =>
          `Wypróbuj nas w ramach [jazdy próbnej](${testDriveURL}) i zapewnij swojemu zespołowi *3 miesiące Expensify za darmo!*`,
      },
      ...
      createTestDriveAdminWorkspaceTask: {
        title: ({ workspaceConfirmationLink }) =>
          `[Utwórz](${workspaceConfirmationLink}) przestrzeń roboczą`,
        description:
          "Utwórz przestrzeń roboczą i skonfiguruj ustawienia z pomocą swojego specjalisty ds. konfiguracji!",
      },
      createWorkspaceTask: {
        title: ({ workspaceSettingsLink }) =>
          `Utwórz [workspace](${workspaceSettingsLink})`,
      ...
      setupCategoriesTask: {
        title: ({ workspaceCategoriesLink }) =>
          `Skonfiguruj [kategorie](${workspaceCategoriesLink})`,
...
${
  integrationName && CONST.connectionsVideoPaths[integrationName]
    ...
    : `[Przejdź do księgowości](${workspaceAccountingLink}).`
      ...
      connectCorporateCardTask: {
        title: ({ corporateCardLink }) =>
          `Połącz [swoje karty firmowe](${corporateCardLink})`,
      ...
      inviteTeamTask: {
        title: ({ workspaceMembersLink }) =>
          `Zaproś [swój zespół](${workspaceMembersLink})`,
      ...
      setupCategoriesAndTags: {
        title: ({ workspaceCategoriesLink, workspaceTagsLink }) =>
          `Skonfiguruj [kategorie](${workspaceCategoriesLink}) i [tagi](${workspaceTagsLink})`,
      ...
      setupTagsTask: {
        title: ({ workspaceTagsLink }) =>
          `Skonfiguruj [tagi](${workspaceTagsLink})`,
        description: ({ workspaceMoreFeaturesLink }) =>
          dedent(`
      ...
      inviteAccountantTask: {
        title: ({ workspaceMembersLink }) =>
          `Zaproś swojego [księgowego](${workspaceMembersLink})`,
        description: ({ workspaceMembersLink }) =>
          dedent(`
      ...
      reviewWorkspaceSettingsTask: {
        title: ({ workspaceSettingsLink }) =>
          `Sprawdź swoje [ustawienia przestrzeni roboczej](${workspaceSettingsLink})`,
        description: ({ workspaceSettingsLink }) =>
          dedent(`
    ...
    testDrive: {
      name: ({ testDriveURL }: { testDriveURL?: string }) =>
        testDriveURL
          ? `Zrób [jazdę próbną](${testDriveURL})`
    ...
    messages: {
      onboardingEmployerOrSubmitMessage:
        "Otrzymanie zwrotu jest tak proste jak wysłanie wiadomości. Omówmy podstawy.",
      onboardingPersonalSpendMessage:
        "Oto jak w kilku kliknięciach śledzić swoje wydatki.",
      ...
      onboardingChatSplitMessage:
        "Dziel się rachunkami ze znajomymi tak łatwo, jak wysyłasz wiadomość. Oto jak to działa.",
      onboardingAdminMessage:
        "Dowiedz się, jak zarządzać przestrzenią roboczą swojego zespołu jako administrator i rozliczać własne wydatki.",
      ...
      onboardingTestDriveReceiverMessage:
        "*Masz 3 miesiące za darmo! Zacznij poniżej.*",
    },
    workspace: {
      title: "Zachowaj porządek dzięki przestrzeni roboczej",
      subtitle:
        "Odblokuj zaawansowane narzędzia, które uproszczą zarządzanie wydatkami — wszystko w jednym miejscu. Dzięki przestrzeni roboczej możesz:",
      explanationModal: {
      ...
      price:
        "Wypróbuj za darmo przez 30 dni, a potem przejdź na wyższy plan za jedyne <strong>5 USD/użytkownika/miesiąc</strong>.",
      createWorkspace: "Utwórz przestrzeń roboczą",
    },
    confirmWorkspace: {
      title: "Potwierdź przestrzeń roboczą",
      subtitle:
        "Utwórz przestrzeń roboczą, aby śledzić paragony, rozliczać wydatki, zarządzać podróżami, tworzyć raporty i więcej — wszystko z szybkością czatu.",
    },
    inviteMembers: {
      title: "Zaproś członków",
      subtitle:
        "Dodaj swój zespół lub zaproś księgowego. Im więcej, tym weselej!",
    },
  },
  featureTraining: {
  ...
  personalDetails: {
    error: {
      ...
      containsReservedWord:
        "Nazwa nie może zawierać słów Expensify ani Concierge",
  ...
  privatePersonalDetails: {
    ...
    error: {
      dateShouldBeBefore: (dateString: string) =>
        `Data powinna być wcześniejsza niż ${dateString}`,
      dateShouldBeAfter: (dateString: string) =>
        `Data powinna być po ${dateString}`,
      hasInvalidCharacter: "Nazwa może zawierać tylko znaki łacińskie",
      incorrectZipFormat: (zipFormat?: string) =>
        `Nieprawidłowy format kodu pocztowego${zipFormat ? `Akceptowalny format: ${zipFormat}` : ""}`,
  ...
  unlinkLoginForm: {
    toValidateLogin: (primaryLogin: string, secondaryLogin: string) =>
      `Aby zweryfikować ${secondaryLogin}, wyślij ponownie magiczny kod z Ustawień konta ${primaryLogin}.`,
    noLongerHaveAccess: (primaryLogin: string) =>
      `Jeśli nie masz już dostępu do ${primaryLogin}, odłącz swoje konta.`,
    unlink: "Odłącz",
    linkSent: "Link wysłany!",
    successfullyUnlinkedLogin:
      "Dodatkowe logowanie zostało pomyślnie odłączone!",
  },
  ...
  smsDeliveryFailurePage: {
    ...
    validationSuccess:
      "Twój numer został zweryfikowany! Kliknij poniżej, aby wysłać nowy magiczny kod logowania.",
    validationFailed: ({
      timeData,
    }: {
      timeData?: {
      ...
      if (timeData.days) {
        timeParts.push(
          `${timeData.days} ${timeData.days === 1 ? "dzień" : "dni"}`,
        );
      }
      if (timeData.hours) {
        timeParts.push(
          `${timeData.hours} ${timeData.hours === 1 ? "godzina" : "godziny"}`,
        );
      }
      if (timeData.minutes) {
        timeParts.push(
          `${timeData.minutes} ${timeData.minutes === 1 ? "minuta" : "minuty"}`,
        );
      }
      let timeText = "";
  ...
  errorPage: {
    title: ({ isBreakLine }: { isBreakLine: boolean }) =>
      `Ups... ${isBreakLine ? "\n" : ""}Coś poszło nie tak`,
    subtitle:
      "Nie można było ukończyć Twojego żądania. Spróbuj ponownie później.",
    wrongTypeSubtitle:
      "To wyszukiwanie jest nieprawidłowe. Spróbuj dostosować kryteria wyszukiwania.",
  },
  statusPage: {
    status: "Status",
    statusExplanation:
      "Dodaj emotikon, aby ułatwić współpracownikom i znajomym zorientowanie się, co się dzieje. Opcjonalnie możesz dodać też wiadomość!",
    today: "Dzisiaj",
    ...
    vacationDelegateError:
      "Wystąpił błąd podczas aktualizowania Twojego zastępcy urlopowego.",
    asVacationDelegate: ({ nameOrEmail }: VacationDelegateParams) =>
      `jako osoba zastępująca ${nameOrEmail} podczas urlopu`,
    toAsVacationDelegate: (
      submittedToName: string,
      vacationDelegateName: string,
    ) =>
      `do ${submittedToName} jako zastępca urlopowy dla ${vacationDelegateName}`,
  ...
  bankAccount: {
    ...
    thisBankAccount:
      "To konto bankowe będzie używane do płatności firmowych w Twoim obszarze roboczym",
    ...
    toGetStarted:
      "Dodaj konto bankowe, żeby zwracać wydatki, wydawać Karty Expensify, przyjmować płatności faktur i opłacać rachunki — wszystko w jednym miejscu.",
    plaidBodyCopy:
      "Daj pracownikom łatwiejszy sposób płacenia – i otrzymywania zwrotów – za wydatki firmowe.",
    checkHelpLine:
      "Numer rozliczeniowy i numer rachunku znajdziesz na czeku powiązanym z tym kontem.",
    ...
    makePaymentsDescription: "Opłacaj wydatki lub wydawaj Karty Expensify",
    ...
    hasBeenThrottledError:
      "Wystąpił błąd podczas dodawania Twojego konta bankowego. Poczekaj kilka minut i spróbuj ponownie.",
    ...
    error: {
      ...
      industryCode:
        "Wprowadź prawidłowy sześciocyfrowy kod klasyfikacji branży",
      restrictedBusiness:
        "Potwierdź, że firma nie znajduje się na liście działalności objętych ograniczeniami",
      ...
      routingAndAccountNumberCannotBeSame:
        "Numer rozliczeniowy i numer konta nie mogą być takie same",
      ...
      noDefaultDepositAccountOrDebitCardAvailable:
        "Dodaj domyślne konto depozytowe lub kartę debetową",
      validationAmounts:
        "Wprowadzone kwoty weryfikacyjne są nieprawidłowe. Sprawdź wyciąg bankowy i spróbuj ponownie.",
  ...
  addPersonalBankAccount: {
    ...
    confirmationStepSubHeader:
      "Sprawdź poniższe szczegóły i zaznacz pole z warunkami, aby potwierdzić.",
    toGetStarted:
      "Dodaj osobiste konto bankowe, aby otrzymywać zwroty wydatków, opłacać faktury lub włączyć Portfel Expensify.",
  },
  addPersonalBankAccountPage: {
    ...
    successMessage:
      "Gratulacje, Twoje konto bankowe zostało skonfigurowane i jest gotowe do otrzymywania zwrotów.",
  },
  attachmentView: {
  ...
  messages: {
    ...
    userIsAlreadyMember: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} jest już członkiem ${name}`,
    userIsAlreadyAnAdmin: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} jest już administratorem ${name}`,
  },
  onfidoStep: {
    acceptTerms:
      "Kontynuując wniosek o aktywację portfela Expensify, potwierdzasz, że zapoznałeś(-aś) się, rozumiesz i akceptujesz",
    ...
    genericError:
      "Wystąpił błąd podczas przetwarzania tego kroku. Spróbuj ponownie.",
    cameraPermissionsNotGranted: "Włącz dostęp do aparatu",
    cameraRequestMessage:
      "Potrzebujemy dostępu do aparatu, aby zakończyć weryfikację konta bankowego. Proszę włączyć go w Ustawienia > New Expensify.",
    microphonePermissionsNotGranted: "Włącz dostęp do mikrofonu",
    microphoneRequestMessage:
      "Potrzebujemy dostępu do Twojego mikrofonu, aby dokończyć weryfikację konta bankowego. Włącz go w Ustawienia > New Expensify.",
    originalDocumentNeeded:
      "Prześlij oryginalne zdjęcie swojego dokumentu tożsamości zamiast zrzutu ekranu lub zeskanowanego obrazu.",
    ...
    imageNeedsBetterQuality:
      "Wystąpił problem z jakością zdjęcia Twojego dokumentu tożsamości. Prześlij nowe zdjęcie, na którym cały dokument będzie wyraźnie widoczny.",
    selfieIssue:
      "Wystąpił problem z Twoim selfie/wideo. Prześlij proszę aktualne selfie/wideo.",
    selfieNotMatching:
      "Twoje selfie/wideo nie pasuje do Twojego dokumentu tożsamości. Prześlij nowe selfie/wideo, na którym Twoja twarz jest wyraźnie widoczna.",
    selfieNotLive:
      "Twoje selfie/wideo nie wygląda na wykonane na żywo. Prześlij proszę selfie/wideo zrobione na żywo.",
  },
  additionalDetailsStep: {
    headerTitle: "Dodatkowe szczegóły",
    helpText:
      "Musimy potwierdzić następujące informacje, zanim będziesz mógł wysyłać i otrzymywać pieniądze ze swojego portfela.",
    helpTextIdologyQuestions:
      "Musimy zadać Ci jeszcze kilka pytań, aby dokończyć weryfikację Twojej tożsamości.",
    ...
    needSSNFull9:
      "Mamy problem ze zweryfikowaniem Twojego numeru SSN. Wprowadź pełne dziewięć cyfr swojego numeru SSN.",
  ...
  termsStep: {
    ...
    haveReadAndAgreePlain:
      "Przeczytałem(-am) i zgadzam się na otrzymywanie ujawnień w formie elektronicznej.",
    ...
    shortTermsForm: {
      expensifyPaymentsAccount: ({ walletProgram }: WalletProgramParams) =>
        `Portfel Expensify jest wydawany przez ${walletProgram}.`,
      ...
      atmBalanceInquiry:
        "Sprawdzenie salda w bankomacie (w sieci lub poza siecią)",
      customerService:
        "Obsługa klienta (zautomatyzowana lub z konsultantem na żywo)",
      inactivityAfterTwelveMonths:
        "Nieaktywność (po 12 miesiącach bez transakcji)",
      ...
      electronicFundsWithdrawalInstant:
        "Elektroniczne wycofanie środków (natychmiastowe)",
    ...
    longTermsForm: {
      ...
      sendingFundsDetails:
        "Nie ma opłat za wysyłanie środków do innego posiadacza konta przy użyciu salda, konta bankowego lub karty debetowej.",
  ...
  activateStep: {
    ...
    activatedMessage:
      "Gratulacje, Twój portfel jest skonfigurowany i gotowy do wykonywania płatności.",
    checkBackLaterTitle: "Chwileczkę…",
    checkBackLaterMessage:
      "Wciąż sprawdzamy Twoje informacje. Sprawdź ponownie później.",
  ...
  companyStep: {
    ...
    subtitle:
      "Prawie gotowe! Ze względów bezpieczeństwa musimy potwierdzić kilka informacji:",
    ...
    industryClassificationCodePlaceholder:
      "Wyszukaj kod klasyfikacji branżowej",
  },
  requestorStep: {
  ...
  personalInfoStep: {
    ...
    enterTheLast4:
      "Jakie są ostatnie cztery cyfry Twojego numeru Social Security?",
    dontWorry:
      "Spokojnie, nie przeprowadzamy żadnych osobistych kontroli kredytowych!",
    last4SSN: "Ostatnie 4 cyfry numeru SSN",
    enterYourAddress: "Jaki jest twój adres?",
    address: "Adres",
    letsDoubleCheck: "Sprawdźmy jeszcze raz, czy wszystko wygląda poprawnie.",
    byAddingThisBankAccount:
      "Dodając to konto bankowe, potwierdzasz, że przeczytałeś(-aś), rozumiesz i akceptujesz",
    whatsYourLegalName:
      "Jak brzmi twoje imię i nazwisko zgodnie z dokumentami?",
    whatsYourDOB: "Jaka jest twoja data urodzenia?",
    whatsYourAddress: "Jaki jest Twój adres?",
    whatsYourSSN:
      "Jakie są ostatnie cztery cyfry Twojego numeru Social Security?",
    noPersonalChecks:
      "Spokojnie, tu nie sprawdzamy Twojej historii kredytowej!",
  ...
  businessInfoStep: {
    ...
    enterYourCompanyTaxIdNumber:
      "Jaki jest numer identyfikacji podatkowej Twojej firmy?",
    taxIDNumber: "Numer identyfikacji podatkowej",
    taxIDNumberPlaceholder: "9 cyfr",
    ...
    selectYourCompanyIncorporationDate:
      "Jaka jest data rejestracji Twojej firmy?",
    incorporationDate: "Data rejestracji firmy",
    incorporationDatePlaceholder: "Data początkowa (rrrr-mm-dd)",
    incorporationState: "Stan rejestracji firmy",
    pleaseSelectTheStateYourCompanyWasIncorporatedIn:
      "W którym stanie została zarejestrowana Twoja firma?",
    letsDoubleCheck: "Sprawdźmy jeszcze raz, czy wszystko wygląda poprawnie.",
    companyAddress: "Adres firmy",
    listOfRestrictedBusinesses: "lista działalności objętych ograniczeniami",
    confirmCompanyIsNot: "Potwierdzam, że ta firma nie znajduje się na",
    ...
    whatsYourExpectedAverageReimbursements:
      "Jaka jest oczekiwana średnia kwota zwrotu?",
  ...
  beneficialOwnerInfoStep: {
    doYouOwn25percent: (companyName: string) =>
      `Czy posiadasz 25% lub więcej udziałów w ${companyName}?`,
    doAnyIndividualOwn25percent: (companyName: string) =>
      `Czy którakolwiek osoba posiada 25% lub więcej udziałów w ${companyName}?`,
    areThereMoreIndividualsWhoOwn25percent: (companyName: string) =>
      `Czy są jeszcze inne osoby, które posiadają 25% lub więcej udziałów w ${companyName}?`,
    regulationRequiresUsToVerifyTheIdentity:
      "Przepisy wymagają od nas weryfikacji tożsamości każdej osoby, która posiada ponad 25% udziałów w firmie.",
    companyOwner: "Właściciel firmy",
    enterLegalFirstAndLastName:
      "Jakie jest oficjalne imię i nazwisko właściciela?",
    legalFirstName: "Imię (zgodnie z dokumentem tożsamości)",
    legalLastName: "Nazwisko zgodne z dokumentami",
    enterTheDateOfBirthOfTheOwner: "Jaka jest data urodzenia właściciela?",
    enterTheLast4:
      "Jakie są ostatnie 4 cyfry numeru Social Security właściciela?",
    last4SSN: "Ostatnie 4 cyfry numeru SSN",
    dontWorry:
      "Spokojnie, nie przeprowadzamy żadnych osobistych kontroli kredytowych!",
  ...
  ownershipInfoStep: {
    ...
    doesAnyoneOwn: (companyName: string) =>
      `Czy którakolwiek osoba posiada 25% lub więcej udziałów w ${companyName}?`,
    regulationsRequire:
      "Przepisy wymagają od nas zweryfikowania tożsamości każdej osoby, która posiada więcej niż 25% udziałów w firmie.",
    legalFirstName: "Imię (zgodnie z dokumentem tożsamości)",
    legalLastName: "Nazwisko zgodne z dokumentami",
    ...
    areThereOther: (companyName: string) =>
      `Czy są inne osoby, które posiadają 25% lub więcej udziałów w ${companyName}?`,
    owners: "Właściciele",
    addCertified:
      "Dodaj potwierdzone drzewo organizacyjne pokazujące beneficjentów rzeczywistych",
    ...
    noteEntity:
      "Uwaga: wykres struktury własnościowej jednostki musi być podpisany przez Twojego księgowego, doradcę prawnego lub poświadczony notarialnie.",
    ...
    acceptedFiles:
      "Akceptowane formaty plików: PDF, PNG, JPEG. Łączny rozmiar plików w każdej sekcji nie może przekroczyć 5 MB.",
  ...
  completeVerificationStep: {
    ...
    certifyTrueAndAccurate:
      "Oświadczam, że podane informacje są prawdziwe i dokładne",
    certifyTrueAndAccurateError:
      "Potwierdź, że informacje są prawdziwe i dokładne",
    isAuthorizedToUseBankAccount:
      "Jestem upoważniony(-a) do korzystania z tego firmowego konta bankowego na wydatki służbowe",
    isAuthorizedToUseBankAccountError:
      "Musisz być osobą zasiadającą we władzach firmy z upoważnieniem do obsługi firmowego rachunku bankowego",
  ...
  connectBankAccountStep: {
    ...
    maxAttemptsReached:
      "Weryfikacja tego konta bankowego została wyłączona z powodu zbyt wielu nieprawidłowych prób.",
    ...
    descriptionCTA:
      "Wprowadź kwotę każdej transakcji w polach poniżej. Przykład: 1,51.",
    letsChatText:
      "Już prawie gotowe! Musimy z Twoją pomocą zweryfikować jeszcze kilka ostatnich informacji na czacie. Gotowy/a?",
    enable2FATitle:
      "Zabezpiecz się przed oszustwami, włącz uwierzytelnianie dwuskładnikowe (2FA)",
    enable2FAText:
      "Poważnie podchodzimy do kwestii bezpieczeństwa. Skonfiguruj teraz uwierzytelnianie dwuskładnikowe (2FA), aby dodać dodatkową warstwę ochrony swojego konta.",
  ...
  countryStep: {
    ...
    yourBusiness:
      "Waluta firmowego konta bankowego musi być taka sama jak waluta Twojej przestrzeni roboczej.",
  ...
  signerInfoStep: {
    ...
    areYouDirector: (companyName: string) =>
      `Czy jesteś dyrektorem w firmie ${companyName}?`,
    regulationRequiresUs:
      "Przepisy wymagają od nas potwierdzenia, czy podpisujący ma uprawnienia do podjęcia tej czynności w imieniu firmy.",
    ...
    enterOneEmail: (companyName: string) =>
      `Wpisz adres e-mail dyrektora w firmie ${companyName}`,
    regulationRequiresOneMoreDirector:
      "Przepisy wymagają co najmniej jednego dodatkowego dyrektora jako sygnatariusza.",
    hangTight: "Chwileczkę…",
    enterTwoEmails: (companyName: string) =>
      `Wpisz adresy e-mail dwóch dyrektorów w firmie ${companyName}`,
    sendReminder: "Wyślij przypomnienie",
    chooseFile: "Wybierz plik",
    weAreWaiting:
      "Czekamy, aż pozostałe osoby potwierdzą swoją tożsamość jako dyrektorzy firmy.",
    id: "Kopia dowodu tożsamości",
    proofOfDirectors: "Potwierdzenie powołania dyrektora/dyrektorów",
    proofOfDirectorsDescription:
      "Przykłady: profil korporacyjny Oncorp lub rejestracja firmy.",
    codiceFiscale: "Kod fiskalny",
    codiceFiscaleDescription:
      "Codice Fiscale dla sygnatariuszy, użytkowników upoważnionych i beneficjentów rzeczywistych.",
    ...
    PDSandFSGDescription: dedent(`
        ...
        `),
    pleaseUpload:
      "Prześlij poniżej dodatkową dokumentację, abyśmy mogli zweryfikować Twoją tożsamość jako dyrektora firmy.",
  ...
  agreementsStep: {
    ...
    regulationRequiresUs:
      "Przepisy wymagają od nas weryfikacji tożsamości każdej osoby, która posiada ponad 25% udziałów w firmie.",
    iAmAuthorized:
      "Mam upoważnienie do korzystania z firmowego rachunku bankowego na wydatki służbowe.",
    ...
    iConsentToThePrivacyNotice:
      'Wyrażam zgodę na <a href="https://payments.corpay.com/compliance">informację o ochronie prywatności</a>.',
    iConsentToThePrivacyNoticeAccessibility:
      "Wyrażam zgodę na informację o prywatności.",
    error: {
      authorized:
        "Musisz być osobą zasiadającą we władzach firmy z upoważnieniem do obsługi firmowego rachunku bankowego",
  ...
  docusignStep: {
    ...
    pleaseCompleteTheBusinessAccount:
      "Proszę wypełnić wniosek o konto firmowe – ustalenie polecenia zapłaty",
    ...
    pleaseUploadTheDirect:
      "Prześlij proszę Uzgodnienia Dotyczące Polecenia Zapłaty oraz stronę z podpisem DocuSign",
  },
  finishStep: {
    ...
    iHaveA: "Mam pytanie",
    enable2FA:
      "Włącz uwierzytelnianie dwuskładnikowe (2FA), aby zapobiec oszustwom",
    weTake:
      "Poważnie podchodzimy do kwestii bezpieczeństwa. Skonfiguruj teraz uwierzytelnianie dwuskładnikowe (2FA), aby dodać dodatkową warstwę ochrony swojego konta.",
  ...
  reimbursementAccountLoadingAnimation: {
    ...
    explanationLine:
      "Sprawdzamy Twoje informacje. Wkrótce będziesz mógł/mogła przejść do kolejnych kroków.",
  },
  session: {
    offlineMessageRetry:
      "Wygląda na to, że jesteś offline. Sprawdź swoje połączenie i spróbuj ponownie.",
  },
  travel: {
    header: "Zarezerwuj podróż",
    title: "Podróżuj mądrze",
    subtitle:
      "Użyj Expensify Travel, aby otrzymać najlepsze oferty podróży i zarządzać wszystkimi wydatkami służbowymi w jednym miejscu.",
    features: {
      saveMoney: "Oszczędzaj na swoich rezerwacjach",
      alerts:
        "Otrzymuj alerty w czasie rzeczywistym, gdy Twoje plany podróży się zmienią",
    },
    ...
    flightDetails: {
      ...
      layover: (layover: string) =>
        `<muted-text-label>Masz <strong>${layover} międzylądowanie</strong> przed tym lotem</muted-text-label>`,
      takeOff: "StartStart",
    ...
    verifyCompany: {
      ...
      conciergeMessage: ({ domain }: { domain: string }) =>
        `Włączenie podróży nie powiodło się dla domeny: ${domain}. Sprawdź i włącz podróże dla tej domeny.`,
    },
    updates: {
      bookingTicketed: (
        airlineCode: string,
      ...
      flightScheduleChangePending: (airlineCode: string) =>
        `Linie lotnicze zaproponowały zmianę rozkładu dla lotu ${airlineCode}; oczekujemy na potwierdzenie.`,
      flightScheduleChangeClosed: (airlineCode: string, startDate?: string) =>
        `Zmiana planu potwierdzona: lot ${airlineCode} odlatyje teraz o ${startDate}.`,
      flightUpdated: (
        airlineCode: string,
        origin: string,
        destination: string,
      ...
      flightCabinChanged: (airlineCode: string, cabinClass?: string) =>
        `Twoja klasa kabiny została zaktualizowana na ${cabinClass} w locie ${airlineCode}.`,
      flightSeatConfirmed: (airlineCode: string) =>
        `Twój przydział miejsca na locie ${airlineCode} został potwierdzony.`,
      flightSeatChanged: (airlineCode: string) =>
        `Twoje miejsce na locie ${airlineCode} zostało zmienione.`,
      flightSeatCancelled: (airlineCode: string) =>
        `Twoja przydzielona miejscówka na locie ${airlineCode} została usunięta.`,
      paymentDeclined:
        "Płatność za rezerwację lotu nie powiodła się. Spróbuj ponownie.",
      bookingCancelledByTraveler: (type: string, id = "") =>
        `Anulowano Twoją rezerwację ${type} ${id}.`,
      bookingCancelledByVendor: (type: string, id = "") =>
        `Dostawca anulował Twoją rezerwację typu ${type} ${id}.`,
      bookingRebooked: (type: string, id = "") =>
        `Twoja rezerwacja (${type}) została ponownie zarezerwowana. Nowy numer potwierdzenia: ${id}.`,
      bookingUpdated: (type: string) =>
        `Twoja rezerwacja (${type}) została zaktualizowana. Sprawdź nowe szczegóły w planie podróży.`,
      railTicketRefund: (
        origin: string,
        destination: string,
        startDate: string,
      ...
      railTicketExchange: (
        ...
        `Twój bilet kolejowy z ${origin} → ${destination} na ${startDate} został wymieniony.`,
      railTicketUpdate: (
        origin: string,
        destination: string,
        startDate: string,
      ) =>
        `Twój bilet kolejowy z ${origin} → ${destination} na ${startDate} został zaktualizowany.`,
      defaultUpdate: (type: string) =>
        `Twoja rezerwacja (${type}) została zaktualizowana.`,
    },
    flightTo: "Lot do",
    trainTo: "Pociąg do",
  ...
  workspace: {
    common: {
      ...
      customFieldHint:
        "Dodaj niestandardowe kodowanie, które będzie stosowane do wszystkich wydatków tego członka.",
      reports: "Raporty",
      ...
      deleteWithCardsConfirmation:
        "Na pewno chcesz usunąć tę przestrzeń roboczą? Spowoduje to usunięcie wszystkich źródeł kart i przypisanych kart.",
      unavailable: "Niedostępne miejsce pracy",
      memberNotFound:
        "Nie znaleziono członka. Aby zaprosić nową osobę do przestrzeni roboczej, użyj przycisku zaproszenia powyżej.",
      ...
      clientID: "ID klienta",
      clientIDInputHint: "Wprowadź unikalny identyfikator klienta",
      mustBeOnlineToViewMembers:
        "Musisz być online, aby wyświetlić członków tego workspace.",
      moreFeatures: "Więcej funkcji",
      requested: "Zamówiono",
      distanceRates: "Stawki za dystans",
      defaultDescription:
        "Jedno miejsce na wszystkie Twoje paragony i wydatki.",
      descriptionHint:
        "Udostępnij informacje o tym obszarze roboczym wszystkim członkom.",
      welcomeNote:
        "Prosimy o przesyłanie paragonów do zwrotu kosztów za pomocą Expensify, dziękujemy!",
      subscription: "Subskrypcja",
      ...
      exportIntegrationSelected: ({
        ...
        `Eksportuj do ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      letsDoubleCheck: "Sprawdźmy jeszcze raz, czy wszystko wygląda poprawnie.",
      lineItemLevel: "Poziom pozycji liniowej",
      reportLevel: "Poziom raportu",
      topLevel: "Najwyższy poziom",
      appliedOnExport:
        "Nie zaimportowano do Expensify, zastosowane przy eksporcie",
      shareNote: {
      ...
      connectTo: ({ connectionName }: ConnectionNameParams) =>
        `Połącz z ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      ...
      lastSyncDate: (connectionName: string, formattedDate: string) =>
        `${connectionName} – Ostatnia synchronizacja ${formattedDate}`,
      authenticationError: (connectionName: string) =>
        `Nie można połączyć z ${connectionName} z powodu błędu uwierzytelniania.`,
      learnMore: "Dowiedz się więcej",
      memberAlternateText: "Przesyłaj i zatwierdzaj raporty.",
      adminAlternateText:
        "Zarządzaj raportami i ustawieniami przestrzeni roboczej.",
      ...
      reimbursementChoice: {
        [CONST.POLICY.REIMBURSEMENT_CHOICES.REIMBURSEMENT_YES]: "Bezpośredni",
        [CONST.POLICY.REIMBURSEMENT_CHOICES.REIMBURSEMENT_NO]: "Brak",
        [CONST.POLICY.REIMBURSEMENT_CHOICES.REIMBURSEMENT_MANUAL]: "Pośredni",
      },
    ...
    receiptPartners: {
      uber: {
        subtitle: (organizationName: string) =>
          organizationName
            ? `Połączono z ${organizationName}`
            : "Automatyzuj wydatki na podróże i dostawy posiłków w całej swojej organizacji.",
        sendInvites: "Wyślij zaproszenia",
        sendInvitesDescription:
          "Ci członkowie przestrzeni roboczej nie mają jeszcze konta Uber for Business. Odznacz wszystkich członków, których nie chcesz teraz zapraszać.",
        ...
        takeBusinessRideMessage:
          "Wybierz przejazd służbowy, a Twoje paragony Ubera zostaną zaimportowane do Expensify. Ruszaj!",
        all: "Wszystko",
        linked: "Powiązane",
        ...
        status: {
          ...
          [CONST.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS
            .LINKED_PENDING_APPROVAL]: "Oczekujące",
        ...
        centralBillingDescription:
          "Wybierz miejsce importu wszystkich paragonów z Uber.",
        invitationFailure:
          "Nie udało się zaprosić członka do Uber for Business",
        autoInvite:
          "Zaproś nowych członków przestrzeni roboczej do Uber for Business",
        autoRemove:
          "Dezaktywuj usuniętych członków miejsca pracy w Uber for Business",
        emptyContent: {
          title: "Brak oczekujących zaproszeń",
          subtitle:
            "Hurra! Szukaliśmy wszędzie i nie znaleźliśmy żadnych zaległych zaproszeń.",
        },
      },
    },
    perDiem: {
      ...
      emptyList: {
        title: "Dieta",
        subtitle:
          "Ustaw stawki dzienne (ryczałty), aby kontrolować dziennie wydatki pracowników. Zaimportuj stawki z arkusza kalkulacyjnego, aby rozpocząć.",
      },
      ...
      editDestinationSubtitle: (destination: string) =>
        `Zaktualizowanie tego miejsca docelowego zmieni je dla wszystkich podstawek diet ${destination}.`,
      editCurrencySubtitle: (destination: string) =>
        `Zaktualizowanie tej waluty spowoduje jej zmianę dla wszystkich podrzędnych stawek diet w ${destination}.`,
    },
    qbd: {
      exportOutOfPocketExpensesDescription:
        "Ustaw sposób eksportu wydatków z własnej kieszeni do QuickBooks Desktop.",
      exportOutOfPocketExpensesCheckToggle:
        "Oznacz czeki jako „do wydrukowania później”",
      exportDescription:
        "Skonfiguruj sposób eksportu danych z Expensify do QuickBooks Desktop.",
      date: "Data eksportu",
      ...
      accountsPayableDescription:
        "Wybierz, gdzie tworzyć rachunki od dostawców.",
      bankAccount: "Konto bankowe",
      ...
      exportDate: {
        label: "Data eksportu",
        description:
          "Użyj tej daty podczas eksportowania raportów do QuickBooks Desktop.",
        values: {
      ...
      exportJournalEntryDescription:
        "Utworzymy szczegółowy zapis księgowy dla każdego raportu Expensify i zaksięgujemy go na koncie poniżej.",
      ...
      outOfPocketTaxEnabledError:
        "Zapisy w dzienniku są niedostępne, gdy podatki są włączone. Wybierz inną opcję eksportu.",
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}AccountDescription`]:
          "Wybierz miejsce eksportu transakcji z karty kredytowej.",
        ...
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}AccountDescription`]:
          "Wybierz, skąd wysyłać czeki.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}Error`]:
          "Rachunki dostawców są niedostępne, gdy lokalizacje są włączone. Wybierz inną opcję eksportu.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}Error`]:
          "Czeki są niedostępne, gdy lokalizacje są włączone. Wybierz inną opcję eksportu.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY}Error`]:
          "Zapisy w dzienniku są niedostępne, gdy podatki są włączone. Wybierz inną opcję eksportu.",
      },
      noAccountsFound: "Nie znaleziono kont",
      noAccountsFoundDescription:
        "Dodaj konto w QuickBooks Desktop i zsynchronizuj połączenie ponownie",
      qbdSetup: "Konfiguracja QuickBooks Desktop",
      requiredSetupDevice: {
        title: "Nie można połączyć z tego urządzenia",
        body1:
          "Musisz skonfigurować to połączenie z komputera, na którym znajduje się plik firmy QuickBooks Desktop.",
        body2:
          "Po połączeniu będziesz mógł synchronizować i eksportować z dowolnego miejsca.",
      },
      setupPage: {
      ...
      importDescription:
        "Wybierz, które konfiguracje kodowania zaimportować z QuickBooks Desktop do Expensify.",
      classes: "Zajęcia",
      items: "Pozycje",
      customers: "Klienci/projekty",
      exportCompanyCardsDescription:
        "Ustaw sposób eksportu zakupów z kart firmowych do QuickBooks Desktop.",
      defaultVendorDescription:
        "Ustaw domyślnego dostawcę, który zostanie zastosowany do wszystkich transakcji kartą kredytową podczas eksportu.",
      accountsDescription:
        "Plan kont w QuickBooks Desktop zostanie zaimportowany do Expensify jako kategorie.",
      accountsSwitchTitle:
        "Wybierz, czy importować nowe konta jako włączone czy wyłączone kategorie.",
      accountsSwitchDescription:
        "Włączone kategorie będą dostępne do wyboru dla członków podczas tworzenia ich wydatków.",
      classesDescription:
        "Wybierz sposób obsługi klas QuickBooks Desktop w Expensify.",
      tagsDisplayedAsDescription: "Poziom pozycji liniowej",
      reportFieldsDisplayedAsDescription: "Poziom raportu",
      customersDescription:
        "Wybierz, jak obsługiwać klientów/projekty QuickBooks Desktop w Expensify.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify będzie automatycznie synchronizować się z QuickBooks Desktop każdego dnia.",
        createEntities: "Automatycznie twórz jednostki",
        createEntitiesDescription:
          "Expensify automatycznie utworzy dostawców w QuickBooks Desktop, jeśli jeszcze nie istnieją.",
      },
      itemsDescription:
        "Wybierz, jak obsługiwać elementy QuickBooks Desktop w Expensify.",
      accountingMethods: {
        ...
        alternateText: {
          [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]:
            "Wydatki z własnej kieszeni zostaną wyeksportowane po ostatecznym zatwierdzeniu",
          [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]:
            "Wydatki z własnej kieszeni zostaną wyeksportowane po opłaceniu",
        },
      },
    },
    qbo: {
      ...
      importDescription:
        "Wybierz, które konfiguracje kodowania zaimportować z QuickBooks Online do Expensify.",
      classes: "Zajęcia",
      locations: "Lokalizacje",
      customers: "Klienci/projekty",
      accountsDescription:
        "Plan kont w QuickBooks Online zostanie zaimportowany do Expensify jako kategorie.",
      accountsSwitchTitle:
        "Wybierz, czy importować nowe konta jako włączone czy wyłączone kategorie.",
      accountsSwitchDescription:
        "Włączone kategorie będą dostępne do wyboru dla członków podczas tworzenia ich wydatków.",
      classesDescription:
        "Wybierz sposób obsługi klas QuickBooks Online w Expensify.",
      customersDescription:
        "Wybierz sposób obsługi klientów/projektów z QuickBooks Online w Expensify.",
      locationsDescription:
        "Wybierz sposób obsługi lokalizacji QuickBooks Online w Expensify.",
      taxesDescription:
        "Wybierz sposób obsługi podatków QuickBooks Online w Expensify.",
      ...
      taxesJournalEntrySwitchNote:
        "QuickBooks Online nie obsługuje podatków w zapisach w dzienniku. Zmień opcję eksportu na rachunek od dostawcy lub czek.",
      exportDescription:
        "Skonfiguruj sposób eksportu danych z Expensify do QuickBooks Online.",
      date: "Data eksportu",
      exportInvoices: "Eksportuj faktury do",
      exportExpensifyCard: "Eksportuj transakcje Karty Expensify jako",
      exportDate: {
        label: "Data eksportu",
        description:
          "Użyj tej daty podczas eksportowania raportów do QuickBooks Online.",
        values: {
          [CONST.QUICKBOOKS_EXPORT_DATE.LAST_EXPENSE]: {
            label: "Data ostatniego wydatku",
            description: "Data najnowszego wydatku w raporcie.",
      ...
      exportInvoicesDescription:
        "Użyj tego konta podczas eksportowania faktur do QuickBooks Online.",
      exportCompanyCardsDescription:
        "Ustaw, w jaki sposób zakupy kartą firmową są eksportowane do QuickBooks Online.",
      vendor: "Dostawca",
      defaultVendorDescription:
        "Ustaw domyślnego dostawcę, który zostanie zastosowany do wszystkich transakcji kartą kredytową podczas eksportu.",
      exportOutOfPocketExpensesDescription:
        "Ustaw sposób eksportu wydatków z własnej kieszeni do QuickBooks Online.",
      exportCheckDescription:
        "Utworzymy wyszczególniony czek dla każdego raportu Expensify i wyślemy go z poniższego konta bankowego.",
      exportJournalEntryDescription:
        "Utworzymy szczegółowy zapis księgowy dla każdego raportu Expensify i zaksięgujemy go na koncie poniżej.",
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify będzie automatycznie synchronizować się z QuickBooks Online każdego dnia.",
        inviteEmployees: "Zaproś pracowników",
        inviteEmployeesDescription:
          "Zaimportuj rekordy pracowników z QuickBooks Online i zaproś pracowników do tego obszaru roboczego.",
        createEntities: "Automatycznie twórz jednostki",
        createEntitiesDescription:
        ...
        qboInvoiceCollectionAccount:
          "konto rozliczeń należności z faktur QuickBooks",
        accountSelectDescription:
          "Wybierz, z jakiego konta opłacać rachunki, a my utworzymy płatność w QuickBooks Online.",
        invoiceAccountSelectorDescription:
          "Wybierz, gdzie otrzymywać płatności za faktury, a my utworzymy płatność w QuickBooks Online.",
      },
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]:
          "Wybierz miejsce eksportu transakcji kartą debetową.",
      ...
      exportDestinationAccountsMisconfigurationError: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Wybierz prawidłowe konto do eksportu rachunków od dostawców",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Wybierz prawidłowe konto do eksportu zapisu księgowego",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Wybierz prawidłowe konto do eksportu czeku",
      },
      exportDestinationSetupAccountsInfo: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Aby korzystać z eksportu rachunków dostawców, skonfiguruj konto zobowiązań w QuickBooks Online",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Aby korzystać z eksportu zapisów w dzienniku, skonfiguruj konto dziennika w QuickBooks Online",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Aby korzystać z eksportu czeków, skonfiguruj konto bankowe w QuickBooks Online",
      },
      noAccountsFound: "Nie znaleziono kont",
      noAccountsFoundDescription:
        "Dodaj konto w QuickBooks Online i zsynchronizuj połączenie ponownie.",
      accountingMethods: {
        label: "Kiedy eksportować",
        description: "Wybierz, kiedy eksportować wydatki:",
        values: {
    ...
    xero: {
      ...
      organizationDescription:
        "Wybierz organizację Xero, z której chcesz zaimportować dane.",
      importDescription:
        "Wybierz, które konfiguracje kodowania zaimportować z Xero do Expensify.",
      accountsDescription:
        "Twój plan kont w Xero zostanie zaimportowany do Expensify jako kategorie.",
      accountsSwitchTitle:
        "Wybierz, czy importować nowe konta jako włączone czy wyłączone kategorie.",
      accountsSwitchDescription:
        "Włączone kategorie będą dostępne do wyboru dla członków podczas tworzenia ich wydatków.",
      ...
      trackingCategoriesDescription:
        "Wybierz sposób obsługi kategorii śledzenia Xero w Expensify.",
      mapTrackingCategoryTo: (categoryName: string) =>
        `Mapuj Xero ${categoryName} do`,
      mapTrackingCategoryToDescription: (categoryName: string) =>
        `Wybierz, dokąd mapować ${categoryName} podczas eksportu do Xero.`,
      ...
      xeroBankAccountDescription:
        "Wybierz, gdzie wydatki będą księgowane jako transakcje bankowe.",
      exportExpensesDescription:
        "Raporty zostaną wyeksportowane jako rachunek zakupu z datą i statusem wybranymi poniżej.",
      purchaseBillDate: "Data rachunku zakupu",
      exportInvoices: "Eksportuj faktury jako",
      salesInvoice: "Faktura sprzedaży",
      exportInvoicesDescription:
        "Faktury sprzedażowe zawsze wyświetlają datę wysłania faktury.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify będzie automatycznie synchronizować się z Xero każdego dnia.",
        ...
        xeroBillPaymentAccountDescription:
          "Wybierz, z jakiego konta opłacać rachunki, a my utworzymy płatność w Xero.",
        invoiceAccountSelectorDescription:
          "Wybierz, gdzie chcesz otrzymywać płatności za faktury, a my utworzymy płatność w Xero.",
      },
      exportDate: {
      ...
      invoiceStatus: {
        ...
        description:
          "Użyj tego statusu podczas eksportowania rachunków zakupów do Xero.",
        values: {
      ...
      noAccountsFound: "Nie znaleziono kont",
      noAccountsFoundDescription:
        "Dodaj proszę konto w Xero i zsynchronizuj połączenie ponownie",
      accountingMethods: {
        label: "Kiedy eksportować",
        description: "Wybierz, kiedy eksportować wydatki:",
        values: {
    ...
    sageIntacct: {
      ...
      exportDate: {
        label: "Data eksportu",
        description:
          "Użyj tej daty podczas eksportowania raportów do Sage Intacct.",
        values: {
      ...
      reimbursableExpenses: {
        description:
          "Ustaw sposób eksportu wydatków z własnej kieszeni do Sage Intacct.",
        values: {
      ...
      nonReimbursableExpenses: {
        description:
          "Ustaw sposób eksportu zakupów kartą firmową do Sage Intacct.",
        values: {
      ...
      exportDescription:
        "Skonfiguruj sposób eksportu danych z Expensify do Sage Intacct.",
      ...
      exportPreferredExporterSubNote:
        "Po ustawieniu preferowany eksporter zobaczy w swoim koncie raporty do eksportu.",
      noAccountsFound: "Nie znaleziono kont",
      ...
      autoSyncDescription:
        "Expensify będzie automatycznie synchronizować się z Sage Intacct każdego dnia.",
      inviteEmployees: "Zaproś pracowników",
      inviteEmployeesDescription:
    ...
    netsuite: {
      ...
      subsidiarySelectDescription:
        "Wybierz jednostkę zależną w NetSuite, z której chcesz zaimportować dane.",
      exportDescription:
        "Skonfiguruj sposób eksportu danych z Expensify do NetSuite.",
      exportInvoices: "Eksportuj faktury do",
      journalEntriesTaxPostingAccount: "Konto podatkowe zapisów w dzienniku",
      journalEntriesProvTaxPostingAccount:
        "Konto księgowania prowincjonalnego podatku w dzienniku",
      ...
      nonReimbursableJournalPostingAccount:
        "Konto księgowania nierozliczanych wydatków",
      ...
      journalPostingPreference: {
        ...
        values: {
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            ...
            "Pojedynczy, wyszczególniony wpis dla każdego raportu",
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            .JOURNALS_POSTING_TOTAL_LINE]:
            "Pojedynczy wpis dla każdego wydatku",
        },
      },
      invoiceItem: {
        ...
        values: {
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
            ...
            description:
              "Utworzymy dla Ciebie „pozycję faktury Expensify” podczas eksportu (jeśli jeszcze nie istnieje).",
          },
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.SELECT]: {
            label: "Wybierz istniejące",
            description:
              "Połączymy faktury z Expensify z pozycją wybraną poniżej.",
          },
        },
      },
      exportDate: {
        label: "Data eksportu",
        description:
          "Użyj tej daty podczas eksportowania raportów do NetSuite.",
        values: {
        ...
        values: {
          [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
            ...
            reimbursableDescription:
              "Wydatki z własnej kieszeni zostaną wyeksportowane do NetSuite jako raporty wydatków.",
            nonReimbursableDescription:
              "Wydatki z firmowych kart zostaną wyeksportowane do NetSuite jako raporty wydatków.",
          },
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify będzie automatycznie synchronizować się z NetSuite każdego dnia.",
        reimbursedReportsDescription:
        ...
        reimbursementsAccountDescription:
          "Wybierz konto bankowe, którego użyjesz do zwrotów, a my utworzymy powiązaną płatność w NetSuite.",
        collectionsAccount: "Konto przejęte przez windykację",
        collectionsAccountDescription:
          "Gdy faktura zostanie oznaczona jako opłacona w Expensify i wyeksportowana do NetSuite, pojawi się na poniższym koncie.",
        ...
        exportVendorBillsTo: {
          ...
          values: {
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVED_NONE]: "Domyślne ustawienie NetSuite",
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVAL_PENDING]: "Oczekuje na zatwierdzenie",
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED]:
              "Zatwierdzono do zaksięgowania",
          },
        },
        exportJournalsTo: {
        ...
        error: {
          customFormID:
            "Wprowadź prawidłowy numeryczny identyfikator niestandardowego formularza",
        },
      },
      noAccountsFound: "Nie znaleziono kont",
      noAccountsFoundDescription:
        "Dodaj konto w NetSuite i ponownie zsynchronizuj połączenie",
      noVendorsFound: "Nie znaleziono dostawców",
      noVendorsFoundDescription:
        "Dodaj proszę dostawców w NetSuite i zsynchronizuj połączenie ponownie",
      noItemsFound: "Nie znaleziono pozycji faktury",
      noItemsFoundDescription:
        "Dodaj pozycje faktury w NetSuite i zsynchronizuj połączenie ponownie",
      noSubsidiariesFound: "Nie znaleziono spółek zależnych",
      noSubsidiariesFoundDescription:
        "Dodaj proszę jednostkę zależną w NetSuite i ponownie zsynchronizuj połączenie",
      tokenInput: {
        ...
        formSteps: {
          installBundle: {
            ...
            description:
              "W NetSuite przejdź do *Customization > SuiteBundler > Search & Install Bundles* > wyszukaj „Expensify” > zainstaluj pakiet.",
          },
          enableTokenAuthentication: {
            title: "Włącz uwierzytelnianie oparte na tokenach",
            description:
              "W NetSuite przejdź do *Setup > Company > Enable Features > SuiteCloud* i włącz *token-based authentication*.",
          },
          enableSoapServices: {
            title: "Włącz usługi sieciowe SOAP",
            description:
              "W NetSuite przejdź do *Setup > Company > Enable Features > SuiteCloud* i włącz *SOAP Web Services*.",
          },
          createAccessToken: {
          ...
          enterCredentials: {
            ...
            netSuiteAccountIDDescription:
              "W NetSuite przejdź do *Setup > Integration > SOAP Web Services Preferences*.",
          },
        },
      },
      import: {
        ...
        expenseCategoriesDescription:
          "Twoje kategorie wydatków z NetSuite zostaną zaimportowane do Expensify jako kategorie.",
        ...
        importCustomFields: {
          ...
          label: (importedTypes: string[]) =>
            `Zaimportowano jako ${importedTypes.join("i")}`,
          requiredFieldError: (fieldName: string) =>
            `Wpisz proszę ${fieldName}`,
          customSegments: {
            ...
            helpText:
              "dotyczące konfigurowania niestandardowych segmentów/rekordów.",
            emptyTitle:
              "Dodaj niestandardowy segment lub niestandardowy rekord",
            fields: {
              segmentName: "Nazwa",
            ...
            removePrompt:
              "Czy na pewno chcesz usunąć ten niestandardowy segment/rekord?",
            addForm: {
              ...
              segmentRecordType:
                "Czy chcesz dodać niestandardowy segment czy niestandardowy rekord?",
              customSegmentNameTitle: "Jaka jest nazwa własnego segmentu?",
              customRecordNameTitle:
                "Jaka jest nazwa niestandardowego rekordu?",
...
_Aby uzyskać bardziej szczegółowe instrukcje, [odwiedź naszą stronę pomocy](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
              customSegmentInternalIDTitle:
                "Jaki jest identyfikator wewnętrzny?",
...
_Bardziej szczegółowe instrukcje znajdziesz, [odwiedzając naszą stronę pomocy](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
              customRecordScriptIDTitle:
                "Jaki jest identyfikator kolumny transakcji?",
...
_Aby uzyskać bardziej szczegółowe instrukcje, [odwiedź naszą stronę pomocy](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
              customSegmentMappingTitle:
                "Jak ten niestandardowy segment powinien być wyświetlany w Expensify?",
              customRecordMappingTitle:
                "Jak powinien być wyświetlany ten niestandardowy rekord w Expensify?",
            },
            errors: {
              uniqueFieldError: (fieldName: string) =>
                `Niestandardowy segment/rekord z tym ${fieldName?.toLowerCase()} już istnieje`,
            },
          },
          customLists: {
            ...
            addForm: {
              ...
              transactionFieldIDTitle:
                "Jaki jest identyfikator pola transakcji?",
...
_Aby uzyskać bardziej szczegółowe instrukcje, [odwiedź naszą stronę pomocy](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
              mappingTitle:
                "Jak ta lista niestandardowa powinna być wyświetlana w Expensify?",
            },
            errors: {
        ...
        importTypes: {
          ...
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
            ...
            footerContent: (importField: string) =>
              `${startCase(importField)} będzie można wybrać dla każdego pojedynczego wydatku w raporcie pracownika.`,
          },
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
            label: "Pola raportu",
            description: "Poziom raportu",
            footerContent: (importField: string) =>
              `Zaznaczenie ${startCase(importField)} zostanie zastosowane do wszystkich wydatków w raporcie pracownika.`,
          },
        },
      },
    },
    intacct: {
      ...
      followSteps:
        "Postępuj zgodnie z krokami w naszej instrukcji „Jak połączyć się z Sage Intacct”",
      ...
      employeeDefaultDescription:
        "Domyślny dział pracownika zostanie zastosowany do jego wydatków w Sage Intacct, jeśli istnieje.",
      displayedAsTagDescription:
        "Dział będzie można wybrać osobno dla każdego wydatku w raporcie pracownika.",
      displayedAsReportFieldDescription:
        "Wybór działu zostanie zastosowany do wszystkich wydatków w raporcie pracownika.",
      toggleImportTitle: (mappingTitle: string) =>
        `Wybierz, jak obsługiwać Sage Intacct <strong>${mappingTitle}</strong> w Expensify.`,
      expenseTypes: "Typy wydatków",
      expenseTypesDescription:
        "Typy wydatków z Sage Intacct zostaną zaimportowane do Expensify jako kategorie.",
      accountTypesDescription:
        "Twój plan kont Sage Intacct zostanie zaimportowany do Expensify jako kategorie.",
      importTaxDescription:
        "Importuj stawkę podatku od zakupów z Sage Intacct.",
      ...
      removeDimensionPrompt:
        "Czy na pewno chcesz usunąć ten zdefiniowany przez użytkownika wymiar?",
      ...
      detailedInstructionsRestOfSentence:
        "przy dodawaniu wymiarów zdefiniowanych przez użytkownika.",
      userDimensionsAdded: () => ({
        one: "Dodano 1 UDD",
    ...
    companyCards: {
      ...
      error: {
        ...
        workspaceFeedsCouldNotBeLoadedMessage:
          "Wystąpił błąd podczas ładowania kanałów kart w przestrzeni roboczej. Spróbuj ponownie lub skontaktuj się ze swoim administratorem.",
        feedCouldNotBeLoadedTitle: "Nie udało się wczytać tego kanału",
        feedCouldNotBeLoadedMessage:
          "Wystąpił błąd podczas ładowania tego kanału. Spróbuj ponownie lub skontaktuj się z administratorem.",
        tryAgain: "Spróbuj ponownie",
      },
      addNewCard: {
        other: "Inne",
        ...
        howDoYouWantToConnect:
          "W jaki sposób chcesz połączyć się ze swoim bankiem?",
        ...
        commercialFeedDetails:
          "Wymaga konfiguracji z Twoim bankiem. Zwykle jest używana przez większe firmy i często jest najlepszą opcją, jeśli się kwalifikujesz.",
        ...
        directFeedDetails:
          "Najprostsze podejście. Połącz się od razu, używając swoich głównych danych logowania. Ta metoda jest najczęściej stosowana.",
        enableFeed: {
          ...
          mastercard:
            "Mamy globalne integracje z Mastercard, choć kwalifikowalność zależy od banku i programu kart.\n\nAby rozpocząć, po prostu:",
...
3. Gdy kanał zostanie włączony, kliknij poniżej Wyślij i zajmiemy się jego dodaniem.`,
        ...
        amexCorporate:
          "Wybierz tę opcję, jeśli na przedniej stronie Twoich kart widnieje napis „Corporate”",
        amexBusiness:
          "Zaznacz to, jeśli na przodzie Twoich kart widnieje napis „Business”",
        ...
        exitModal: {
          ...
          prompt:
            "Zauważyliśmy, że nie dokończono dodawania kart. Jeśli napotkano jakiś problem, daj nam znać, abyśmy mogli pomóc wszystko przywrócić na właściwe tory.",
      ...
      startDateDescription:
        "Wybierz datę rozpoczęcia importu. Zsynchronizujemy wszystkie transakcje od tego dnia.",
      editStartDateDescription:
        "Wybierz nową datę początkową transakcji. Zsynchronizujemy wszystkie transakcje od tej daty wzwyż, z wyłączeniem tych, które już zaimportowaliśmy.",
      ...
      confirmationDescription:
        "Natychmiast rozpoczniemy importowanie transakcji.",
      card: "Karta",
      cardName: "Nazwa karty",
      brokenConnectionError:
        '<rbr>Połączenie z kartą jest przerwane. Proszę <a href="#">zalogować się do swojego banku</a>, abyśmy mogli ponownie nawiązać połączenie.</rbr>',
      assignedCard: (assignee: string, link: string) =>
        `przypisał(-a) ${assignee} ${link}! Zaimportowane transakcje pojawią się na tym czacie.`,
      ...
      cardAlreadyAssignedError:
        "Ta karta jest już przypisana do użytkownika w innej przestrzeni roboczej.",
      importTransactions: {
        title: "Importuj transakcje z pliku",
        description:
          "Dostosuj ustawienia dla swojego pliku, które zostaną zastosowane podczas importu.",
    ...
    expensifyCard: {
      ...
      getStartedIssuing:
        "Zacznij od wydania swojej pierwszej wirtualnej lub fizycznej karty.",
      verificationInProgress: "Weryfikacja w toku...",
      verifyingTheDetails:
        "Weryfikujemy kilka szczegółów. Concierge da ci znać, kiedy Karty Expensify będą gotowe do wydania.",
      disclaimer:
      ...
      balanceWillBeSettledOn: (settlementDate: string) =>
        `Saldo zostanie rozliczone w dniu ${settlementDate}`,
      ...
      earnedCashbackDescription:
        "Saldo zwrotu gotówki jest oparte na rozliczonych miesięcznych wydatkach Kartą Expensify w twoim zespole.",
      issueNewCard: "Wydaj nową kartę",
      finishSetup: "Zakończ konfigurację",
      chooseBankAccount: "Wybierz konto bankowe",
      chooseExistingBank:
        "Wybierz istniejące firmowe konto bankowe, żeby spłacić saldo Karty Expensify, albo dodaj nowe konto bankowe",
      accountEndingIn: "Konto kończące się na",
      addNewBankAccount: "Dodaj nowe konto bankowe",
      settlementAccount: "Konto rozliczeniowe",
      settlementAccountDescription:
        "Wybierz konto, z którego spłacisz saldo swojej Karty Expensify.",
      ...
      settlementFrequencyDescription:
        "Wybierz, jak często będziesz spłacać saldo swojej Karty Expensify.",
      settlementFrequencyInfo:
        "Jeśli chcesz przejść na miesięczne rozliczenie, musisz podłączyć swoje konto bankowe przez Plaid i mieć dodatnią historię salda z ostatnich 90 dni.",
      frequency: {
        daily: "Codziennie",
        monthly: "Miesięcznie",
      },
      ...
      cardPending: ({ name }: { name: string }) =>
        `Karta jest obecnie w oczekiwaniu i zostanie wydana po zweryfikowaniu konta ${name}.`,
      virtual: "Wirtualna",
      physical: "Fizyczny",
      ...
      smartLimitWarning: (limit: number | string) =>
        `Jeśli zmienisz limit tej karty na ${limit}, nowe transakcje będą odrzucane, dopóki nie zaakceptujesz na niej kolejnych wydatków.`,
      monthlyLimitWarning: (limit: number | string) =>
        `Jeśli zmienisz limit tej karty na ${limit}, nowe transakcje będą odrzucane aż do następnego miesiąca.`,
      fixedLimitWarning: (limit: number | string) =>
        `Jeśli zmienisz limit tej karty na ${limit}, nowe transakcje zostaną odrzucone.`,
      ...
      issuedCard: (assignee: string) =>
        `przydzielono osobie ${assignee} Kartę Expensify! Karta dotrze w ciągu 2–3 dni roboczych.`,
      issuedCardNoShippingDetails: (assignee: string) =>
        `wydano dla ${assignee} Kartę Expensify! Karta zostanie wysłana, gdy dane do wysyłki zostaną potwierdzone.`,
      issuedCardVirtual: (assignee: string, link: string) =>
        `przyznał(-a) ${assignee} wirtualną Kartę Expensify! Z ${link} można korzystać od razu.`,
      addedShippingDetails: (assignee: string) =>
        `${assignee} dodał dane wysyłki. Karta Expensify dotrze w ciągu 2–3 dni roboczych.`,
      replacedCard: (assignee: string) =>
        `${assignee} wymienił(a) swoją Kartę Expensify. Nowa karta dotrze w ciągu 2–3 dni roboczych.`,
      replacedVirtualCard: (assignee: string, link: string) =>
        `${assignee} wymienił(-a) swoją wirtualną Kartę Expensify! ${link} można używać od razu.`,
      card: "karta",
      ...
      verifyingBankAccountDescription:
        "Poczekaj, aż potwierdzimy, że to konto może zostać użyte do wydawania Kart Expensify.",
      bankAccountVerified: "Konto bankowe zostało zweryfikowane!",
      bankAccountVerifiedDescription:
        "Możesz teraz wydawać Karty Expensify członkom swojego przestrzeni roboczej.",
      oneMoreStep: "Jeszcze jeden krok…",
      oneMoreStepDescription:
        "Wygląda na to, że musimy ręcznie zweryfikować Twoje konto bankowe. Przejdź do Concierge, gdzie czekają na Ciebie dalsze instrukcje.",
      gotIt: "Rozumiem",
    ...
    categories: {
      ...
      spendCategoriesDescription:
        "Dostosuj sposób kategoryzowania wydatków u sprzedawców dla transakcji kartą kredytową i zeskanowanych paragonów.",
      deleteFailureMessage:
        "Wystąpił błąd podczas usuwania kategorii, spróbuj ponownie",
      ...
      subtitle:
        "Uzyskaj lepszy wgląd w to, gdzie wydawane są pieniądze. Użyj naszych domyślnych kategorii lub dodaj własne.",
      emptyCategories: {
      ...
      updateFailureMessage:
        "Wystąpił błąd podczas aktualizowania kategorii, spróbuj ponownie",
      createFailureMessage:
        "Wystąpił błąd podczas tworzenia kategorii, spróbuj ponownie",
      ...
      importedFromAccountingSoftware:
        "Poniższe kategorie są importowane z Twojego",
      payrollCode: "Kod płacowy",
      updatePayrollCodeFailureMessage:
        "Wystąpił błąd podczas aktualizowania kodu listy płac, spróbuj ponownie",
      glCode: "Kod księgi głównej",
      updateGLCodeFailureMessage:
        "Wystąpił błąd podczas aktualizowania kodu GL, spróbuj ponownie",
    ...
    moreFeatures: {
      subtitle:
        "Użyj poniższych przełączników, aby włączać kolejne funkcje w miarę rozwoju. Każda funkcja pojawi się w menu nawigacji, gdzie będzie można ją dalej dostosować.",
      spendSection: {
        title: "Wydatki",
      ...
      perDiem: {
        title: "Dieta",
        subtitle:
          "Ustaw stawki diet, aby kontrolować dzienne wydatki pracowników.",
      },
      travel: {
        title: "Podróże",
        ...
        getStarted: {
          title: "Pierwsze kroki z Expensify Travel",
          subtitle:
            "Potrzebujemy jeszcze tylko kilku informacji o Twojej firmie, a potem będziesz gotowy do startu.",
          ctaText: "Zaczynajmy",
        },
        reviewingRequest: {
          title: "Spakuj walizki, mamy już Twoje zgłoszenie...",
          subtitle:
            "Obecnie rozpatrujemy Twoją prośbę o włączenie Expensify Travel. Nie martw się, damy Ci znać, gdy będzie gotowe.",
          ctaText: "Żądanie wysłane",
        },
        bookOrManageYourTrip: {
          title: "Rezerwacja podróży",
          subtitle:
            "Gratulacje! Możesz już rezerwować i zarządzać podróżami w tym obszarze roboczym.",
        ...
        settings: {
          autoAddTripName: {
            ...
            subtitle:
              "Automatycznie dodawaj nazwy podróży do opisów wydatków za podróże zarezerwowane w Expensify.",
          },
        },
        travelInvoicing: {
          travelBookingSection: {
            title: "Rezerwacja podróży",
            subtitle:
              "Gratulacje! Wszystko gotowe, aby rezerwować i zarządzać podróżami w tym obszarze roboczym.",
            manageTravelLabel: "Zarządzaj podróżami",
          },
          centralInvoicingSection: {
            title: "Centralne fakturowanie",
            subtitle:
              "Skonsoliduj wszystkie wydatki na podróże w jednym miesięcznym rachunku zamiast płacić w momencie zakupu.",
            ...
            subsections: {
              ...
              settlementFrequencyDescription:
                "Jak często Expensify będzie pobierać środki z firmowego konta bankowego, aby rozliczyć ostatnie transakcje Expensify Travel.",
            },
          },
          disableModal: {
        ...
        personalDetailsDescription:
          "Aby zarezerwować podróż, wpisz swoje imię i nazwisko dokładnie tak, jak widnieje w Twoim dokumencie tożsamości wydanym przez organ państwowy.",
      },
      expensifyCard: {
        ...
        disableCardPrompt:
          "Nie możesz wyłączyć Karty Expensify, ponieważ jest już używana. Skontaktuj się z Concierge, żeby poznać kolejne kroki.",
        disableCardButton: "Czat z Concierge",
        feed: {
          title: "Zamów Kartę Expensify",
          subTitle:
            "Usprawnij rozliczanie wydatków firmowych i zaoszczędź do 50% na rachunku Expensify, a dodatkowo:",
          features: {
      ...
      companyCards: {
        ...
        feed: {
          ...
          subtitle:
            "Połącz karty, które już masz, aby automatycznie importować transakcje, dopasowywać paragony i uzgadniać operacje.",
          features: {
        ...
        disableCardPrompt:
          "Nie możesz wyłączyć kart firmowych, ponieważ ta funkcja jest w użyciu. Skontaktuj się z Concierge, aby poznać kolejne kroki.",
        disableCardButton: "Czat z Concierge",
        cardDetails: "Dane karty",
        cardNumber: "Numer karty",
        ...
        integrationExport: (integration: string, type?: string) =>
          integration && type
            ? `eksport ${integration} ${type.toLowerCase()}`
            : `Eksport z ${integration}`,
        integrationExportTitleXero: (integration: string) =>
          `Wybierz konto ${integration}, do którego mają być eksportowane transakcje.`,
        ...
        unassignCardDescription:
          "Cofnięcie przypisania tej karty spowoduje usunięcie wszystkich niewysłanych transakcji.",
        removeCard: "Usuń kartę",
        remove: "Usuń",
        removeCardDescription:
          "Usunięcie tej karty spowoduje usunięcie wszystkich niewysłanych transakcji.",
        assignCard: "Przypisz kartę",
        cardFeedName: "Nazwa źródła karty",
        cardFeedNameDescription:
          "Nadaj kanałowi karty unikalną nazwę, aby odróżnić go od pozostałych.",
        cardFeedTransaction: "Usuń transakcje",
        cardFeedTransactionDescription:
          "Wybierz, czy posiadacze kart mogą usuwać transakcje kartowe. Nowe transakcje będą podlegały tym zasadom.",
        ...
        removeCardFeedDescription:
          "Na pewno chcesz usunąć ten kanał kart? Spowoduje to odłączenie wszystkich kart.",
        error: {
        ...
        emptyAddedFeedDescription:
          "Upewnij się, że w strumieniu kart Twojego banku znajdują się karty.",
        ...
        pendingBankDescription: (bankName: string) =>
          `Połącz się z ${bankName} w oknie przeglądarki, które właśnie się otworzyło. Jeśli żadne się nie otworzyło,`,
        pendingBankLink: "kliknij tutaj",
        giveItNameInstruction:
          "Nadaj karcie nazwę, która odróżni ją od innych.",
        updating: "Aktualizowanie...",
        neverUpdated: "Nigdy",
        noAccountsFound: "Nie znaleziono kont",
        defaultCard: "Domyślna karta",
        downgradeTitle: `Nie można obniżyć planu przestrzeni roboczej`,
        downgradeSubTitle: `Tego przestrzeni roboczej nie można zdegradować, ponieważ jest podłączonych wiele źródeł kart (z wyłączeniem Kart Expensify). Aby kontynuować, proszę <a href="#">pozostaw tylko jedno źródło karty</a>.`,
        noAccountsFoundDescription: (connection: string) =>
          `Dodaj konto w ${connection} i zsynchronizuj to połączenie ponownie`,
        expensifyCardBannerTitle: "Zamów Kartę Expensify",
        ...
        statementCloseDateDescription:
          "Daj nam znać, kiedy kończy się okres rozliczeniowy Twojej karty, a utworzymy w Expensify pasujące zestawienie.",
      },
      workflows: {
        title: "Przepływy pracy",
        subtitle: "Skonfiguruj sposób zatwierdzania i opłacania wydatków.",
        disableApprovalPrompt:
          "Karty Expensify z tego obszaru roboczego obecnie polegają na zatwierdzaniu przy ustalaniu swoich Inteligentnych Limitów. Zmień typy limitów wszystkich Kart Expensify z Inteligentnymi Limitami, zanim wyłączysz zatwierdzanie.",
      },
      invoices: {
        title: "Faktury",
      ...
      connectionsWarningModal: {
        ...
        featureEnabledText:
          "Aby włączyć lub wyłączyć tę funkcję, musisz zmienić ustawienia importu księgowego.",
        disconnectText:
          "Aby wyłączyć księgowość, musisz odłączyć połączenie księgowe od swojego obszaru roboczego.",
        manageSettings: "Zarządzaj ustawieniami",
      },
      receiptPartnersWarningModal: {
        featureEnabledTitle: "Odłącz Uber",
        disconnectText:
          "Aby wyłączyć tę funkcję, najpierw odłącz integrację Uber for Business.",
      ...
      workflowWarningModal: {
        featureEnabledTitle: "Nie tak szybko...",
        featureEnabledText:
          "Karty Expensify w tym obszarze roboczym opierają się na przepływach akceptacji, aby określić swoje Smart Limits.\n\nZmień typy limitów wszystkich kart z włączonymi Smart Limits, zanim wyłączysz przepływy akceptacji.",
    ...
    reports: {
      ...
      customNameEmailPhoneExample:
        "Adres e-mail lub telefon członka: {report:submit:from}",
      customNameStartDateExample: "Data początkowa raportu: {report:startdate}",
      customNameWorkspaceNameExample:
        "Nazwa przestrzeni roboczej: {report:workspacename}",
      ...
      preventMembersFromChangingCustomNamesTitle:
        "Zabroń członkom zmiany niestandardowych tytułów raportów",
    },
    reportFields: {
      addField: "Dodaj pole",
      delete: "Usuń pole",
      ...
      emptyReportFields: {
        ...
        subtitle:
          "Dodaj niestandardowe pole (tekstowe, daty lub z listą wyboru), które będzie widoczne w raportach.",
      },
      subtitle:
        "Pola raportu mają zastosowanie do wszystkich wydatków i mogą być pomocne, gdy chcesz poprosić o dodatkowe informacje.",
      disableReportFields: "Wyłącz pola raportu",
      disableReportFieldsConfirmation:
        "Na pewno? Pola tekstowe i daty zostaną usunięte, a listy wyłączone.",
      importedFromAccountingSoftware:
        "Pola raportu poniżej są importowane z Twojego",
      textType: "Tekst",
      dateType: "Data",
      dropdownType: "Lista",
      formulaType: "Formuła",
      ...
      initialValueInputSubtitle:
        "Wprowadź wartość początkową, która ma zostać wyświetlona w polu raportu.",
      listValuesInputSubtitle:
        "Te wartości pojawią się na liście rozwijanej pola raportu. Włączeni członkowie mogą je wybierać.",
      listInputSubtitle:
        "Te wartości pojawią się na liście pól raportu. Włączone wartości mogą być wybierane przez członków.",
      ...
      circularReferenceError:
        "To pole nie może odnosić się do siebie. Zaktualizuj je.",
      reportFieldInitialValueRequiredError:
        "Wybierz początkową wartość pola raportu",
      genericFailureMessage:
        "Wystąpił błąd podczas aktualizowania pola raportu. Spróbuj ponownie.",
    },
    tags: {
      tagName: "Nazwa tagu",
      ...
      emptyTags: {
        ...
        subtitle:
          "Dodaj tag, aby śledzić projekty, lokalizacje, działy i inne.",
      ...
      deleteFailureMessage:
        "Wystąpił błąd podczas usuwania tagu, spróbuj ponownie",
      tagRequiredError: "Nazwa tagu jest wymagana",
      existingTagError: "Tag o tej nazwie już istnieje",
      invalidTagNameError:
        "Nazwa tagu nie może wynosić 0. Wybierz inną wartość.",
      genericFailureMessage:
        "Wystąpił błąd podczas aktualizowania taga, spróbuj ponownie",
      ...
      importTagsSupportingText:
        "Oznaczaj wydatki jednym typem taga lub wieloma.",
      configureMultiLevelTags:
        "Skonfiguruj swoją listę tagów do tagowania wielopoziomowego.",
      ...
      switchSingleToMultiLevelTagWarning: {
        ...
        prompt1:
          "Zmiana poziomów tagów spowoduje usunięcie wszystkich obecnych tagów.",
      ...
      cannotMakeTagListRequired: {
        ...
        description:
          "Możesz ustawić listę tagów jako wymaganą tylko wtedy, gdy w Twojej polityce skonfigurowano wiele poziomów tagów.",
      },
      tagCount: () => ({
        one: "1 dzień",
    ...
    taxes: {
      ...
      error: {
        ...
        valuePercentageRange:
          "Wprowadź prawidłowy procent w przedziale od 0 do 100",
        customNameRequired: "Niestandardowa nazwa podatku jest wymagana",
        deleteFailureMessage:
          "Wystąpił błąd podczas usuwania stawki podatku. Spróbuj ponownie lub poproś Concierge o pomoc.",
        updateFailureMessage:
          "Wystąpił błąd podczas aktualizowania stawki podatku. Spróbuj ponownie lub poproś Concierge o pomoc.",
        createFailureMessage:
          "Wystąpił błąd podczas tworzenia stawki podatku. Spróbuj ponownie lub poproś Concierge o pomoc.",
        updateTaxClaimableFailureMessage:
          "Część podlegająca zwrotowi musi być mniejsza niż kwota stawki za przejazd",
      },
      deleteTaxConfirmation: "Czy na pewno chcesz usunąć ten podatek?",
      deleteMultipleTaxConfirmation: (taxAmount: number) =>
        `Czy na pewno chcesz usunąć podatek ${taxAmount}?`,
      actions: {
        delete: "Usuń stawkę",
      ...
      importedFromAccountingSoftware:
        "Poniższe podatki są importowane z Twojego",
      taxCode: "Kod podatkowy",
      updateTaxCodeFailureMessage:
        "Wystąpił błąd podczas aktualizowania kodu podatkowego, spróbuj ponownie",
    },
    duplicateWorkspace: {
      title: "Nadaj nazwę swojemu nowemu workspace’owi",
      selectFeatures: "Wybierz funkcje do skopiowania",
      whichFeatures:
        "Które funkcje chcesz skopiować do swojego nowego obszaru roboczego?",
      ...
      error:
        "Wystąpił błąd podczas duplikowania Twojego nowego obszaru roboczego. Spróbuj ponownie.",
    },
    emptyWorkspace: {
      title: "Nie masz żadnych przestrzeni roboczych",
      subtitle:
        "Śledź paragony, rozliczaj wydatki, zarządzaj podróżami, wysyłaj faktury i wiele więcej.",
      ...
      description:
        "Pokoje to świetne miejsce do dyskusji i współpracy z wieloma osobami. Aby rozpocząć współpracę, utwórz lub dołącz do przestrzeni roboczej",
    },
    new: {
      ...
      myGroupWorkspace: ({ workspaceNumber }: { workspaceNumber?: number }) =>
        `Moja grupa robocza${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
      workspaceName: (userName: string, workspaceNumber?: number) =>
        `Workspace użytkownika ${userName}${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
    },
    people: {
      genericFailureMessage:
        "Wystąpił błąd podczas usuwania członka z przestrzeni roboczej, spróbuj ponownie",
      ...
      removeMemberPrompt: (memberName: string) =>
        `Czy na pewno chcesz usunąć ${memberName}?`,
      ...
      error: {
        genericAdd:
          "Wystąpił problem z dodaniem tego członka przestrzeni roboczej",
        cannotRemove:
          "Nie możesz usunąć siebie ani właściciela przestrzeni roboczej",
        genericRemove:
          "Wystąpił problem z usunięciem tego członka przestrzeni roboczej",
      },
      addedWithPrimary:
        "Niektóre osoby zostały dodane za pomocą swoich głównych loginów.",
      invitedBySecondaryLogin: (secondaryLogin: string) =>
        `Dodane przez dodatkowy login ${secondaryLogin}.`,
      workspaceMembersCount: ({ count }: WorkspaceMembersCountParams) =>
        `Łączna liczba członków przestrzeni roboczej: ${count}`,
    ...
    card: {
      ...
      issueNewCard: {
        ...
        smartLimitDescription:
          "Wydawaj do określonej kwoty przed wymaganiem zatwierdzenia",
        monthly: "Miesięcznie",
        ...
        giveItNameInstruction:
          "Uczyń ją na tyle unikalną, by dało się ją odróżnić od innych kart. Jeszcze lepsze są konkretne przypadki użycia!",
        cardName: "Nazwa karty",
        letsDoubleCheck:
          "Sprawdźmy jeszcze raz, czy wszystko wygląda poprawnie.",
        ...
        disabledApprovalForSmartLimitError:
          "Przed skonfigurowaniem inteligentnych limitów włącz zatwierdzanie w <strong>Przepływy pracy > Dodaj zatwierdzenia</strong>",
        singleUse: "Jednorazowe użycie",
        singleUseDescription: "Wygasa po jednej transakcji",
        validFrom: "Ważne od",
        startDate: "Data rozpoczęcia",
        endDate: "Data zakończenia",
        noExpirationHint: "Karta bez daty ważności nie wygaśnie",
        validFromTo: ({
          startDate,
          endDate,
        }: {
        ...
        combineWithExpiration:
          "Połącz z opcjami wygaśnięcia dla dodatkowej kontroli wydatków",
        ...
        setExpiryDateDescription:
          "Karta wygaśnie zgodnie z informacją na karcie",
        amount: "Kwota",
      },
      deactivateCardModal: {
        ...
        deactivateConfirmation:
          "Dezaktywacja tej karty spowoduje odrzucenie wszystkich przyszłych transakcji i nie będzie można jej cofnąć.",
      },
    },
    accounting: {
      settings: "ustawienia",
      title: "Połączenia",
      subtitle:
        "Połącz się ze swoim systemem księgowym, aby kategoryzować transakcje za pomocą planu kont, automatycznie dopasowywać płatności i utrzymywać finanse w synchronizacji.",
      ...
      talkYourOnboardingSpecialist:
        "Porozmawiaj ze swoim specjalistą ds. konfiguracji.",
      ...
      goToODToSettings:
        "Przejdź do Expensify Classic, aby zarządzać swoimi ustawieniami.",
      setup: "Połącz",
      lastSync: (relativeDate: string) =>
        `Ostatnia synchronizacja ${relativeDate}`,
      ...
      connectTitle: ({ connectionName }: ConnectionNameParams) =>
        `Połącz ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName] ?? "integracja z księgowością"}`,
      ...
      importTypes: {
        ...
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]:
          "Zaimportowano jako pola raportu",
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]:
          "Domyślny pracownik NetSuite",
      },
      disconnectPrompt: ({
        connectionName,
      }: OptionalParam<ConnectionNameParams> = {}) => {
      ...
      claimOffer: {
        ...
        xero: {
          ...
          description:
            "<muted-text><centered-text>Nowy w Xero? Klienci Expensify otrzymują 6 miesięcy za darmo. Odbierz swoją ofertę poniżej.</centered-text></muted-text>",
      ...
      autoSync: "Automatyczna synchronizacja",
      autoSyncDescription:
        "Synchronizuj NetSuite i Expensify automatycznie, każdego dnia. Eksportuj sfinalizowany raport w czasie rzeczywistym",
      ...
      saveHoursOnReconciliation:
        "Oszczędzaj godziny przy każdej sesji uzgadniania, pozwalając Expensify na ciągłe uzgadnianie wyciągów i rozliczeń Karty Expensify w Twoim imieniu.",
      ...
      chooseReconciliationAccount: {
        chooseBankAccount:
          "Wybierz konto bankowe, do którego będą uzgadniane płatności kartą Karta Expensify.",
    ...
    export: {
      ...
      notReadyDescription:
        "Szkiców ani oczekujących raportów wydatków nie można wyeksportować do systemu księgowego. Zatwierdź lub opłać te wydatki przed ich eksportem.",
    },
    invoices: {
      sendInvoice: "Wyślij fakturę",
      sendFrom: "Wyślij z",
      invoicingDetails: "Szczegóły faktury",
      invoicingDetailsDescription:
        "Te informacje pojawią się na Twoich fakturach.",
      ...
      invoiceBalanceSubtitle:
        "To jest Twój aktualny stan środków z zebranych płatności za faktury. Zostanie on automatycznie przelany na Twoje konto bankowe, jeśli je dodałeś(-aś).",
      bankAccountsSubtitle:
        "Dodaj konto bankowe, aby wysyłać i otrzymywać płatności za faktury.",
    },
    invite: {
      ...
      genericFailureMessage:
        "Wystąpił błąd podczas zapraszania członka do przestrzeni roboczej. Spróbuj ponownie.",
    ...
    inviteMessage: {
      confirmDetails: "Potwierdź szczegóły",
      inviteMessagePrompt:
        "Uczyń swoje zaproszenie jeszcze bardziej wyjątkowym, dodając poniżej wiadomość!",
      personalMessagePrompt: "Wiadomość",
      genericFailureMessage:
        "Wystąpił błąd podczas zapraszania członka do przestrzeni roboczej. Spróbuj ponownie.",
      inviteNoMembersError:
        "Wybierz co najmniej jednego członka do zaproszenia",
      joinRequest: ({
        user,
        workspaceName,
      }: {
        user: string;
        workspaceName: string;
      }) => `${user} poprosił(a) o dołączenie do ${workspaceName}`,
    },
    distanceRates: {
      oopsNotSoFast: "Ups! Nie tak szybko...",
      workspaceNeeds:
        "Miejsce pracy musi mieć włączoną co najmniej jedną stawkę za dystans.",
      distance: "Dystans",
      centrallyManage:
        "Centralnie zarządzaj stawkami, śledź w milach lub kilometrach i ustaw domyślną kategorię.",
      rate: "Oceń",
      addRate: "Dodaj stawkę",
    ...
    editor: {
      ...
      nameInputHelpText:
        "To jest nazwa, którą zobaczysz w swoim obszarze roboczym.",
      ...
      currencyInputHelpText:
        "Wszystkie wydatki w tym obszarze roboczym zostaną przeliczone na tę walutę.",
      currencyInputDisabledText: (currency: string) =>
        `Domyślnej waluty nie można zmienić, ponieważ to miejsce pracy jest połączone z kontem bankowym w ${currency}.`,
      save: "Zapisz",
      genericFailureMessage:
        "Wystąpił błąd podczas aktualizowania przestrzeni roboczej. Spróbuj ponownie.",
      avatarUploadFailureMessage:
        "Wystąpił błąd podczas przesyłania awatara. Spróbuj ponownie.",
      addressContext:
        "Adres miejsca pracy jest wymagany, aby włączyć Expensify Travel. Wprowadź adres powiązany z Twoją firmą.",
      policy: "Polityka wydatków",
    },
    bankAccount: {
      continueWithSetup: "Kontynuuj konfigurację",
      youAreAlmostDone:
        "Prawie zakończyłeś konfigurację konta bankowego, które pozwoli Ci wydawać firmowe karty, zwracać wydatki, pobierać faktury i opłacać rachunki.",
      streamlinePayments: "Usprawnij płatności",
      connectBankAccountNote:
        "Uwaga: kont osobistych nie można używać do płatności w przestrzeniach roboczych.",
      oneMoreThing: "Jeszcze jedna rzecz!",
      allSet: "Wszystko gotowe!",
      accountDescriptionWithCards:
        "To konto bankowe będzie używane do wydawania kart firmowych, zwrotu wydatków, pobierania faktur i opłacania rachunków.",
      ...
      updateCurrencyPrompt:
        "Wygląda na to, że Twoje środowisko pracy jest obecnie ustawione na inną walutę niż USD. Kliknij przycisk poniżej, aby teraz zmienić walutę na USD.",
      updateToUSD: "Zaktualizuj na USD",
      updateWorkspaceCurrency: "Zaktualizuj walutę przestrzeni roboczej",
      workspaceCurrencyNotSupported:
        "Waluta przestrzeni roboczej nie jest obsługiwana",
      ...
      chooseAnExisting:
        "Wybierz istniejące konto bankowe do opłacania wydatków lub dodaj nowe.",
    },
    changeOwner: {
      changeOwnerPageTitle: "Przenieś właściciela",
      addPaymentCardTitle:
        "Wprowadź swoją kartę płatniczą, aby przenieść własność",
      ...
      amountOwedText:
        "Na tym koncie pozostało nieuregulowane saldo z poprzedniego miesiąca.\n\nCzy chcesz wyczyścić saldo i przejąć rozliczanie tego obszaru roboczego?",
      ownerOwesAmountTitle: "Zaległe saldo",
      ownerOwesAmountButtonText: "Przenieś saldo",
      ownerOwesAmountText: (
        email: string,
        amount: string,
      ) => `Konto będące właścicielem tego przestrzeni roboczej (${email}) ma zaległe saldo z poprzedniego miesiąca.
...
Jeśli chcesz przejąć rozliczenia za całą ich subskrypcję, poproś ich najpierw o dodanie Cię jako administratora do wszystkich ich przestrzeni roboczych, a dopiero potem przejmij rozliczenia.`,
      ...
      hasFailedSettlementsText: (email: string) =>
        `Nie możesz przejąć rozliczeń, ponieważ ${email} ma zaległe rozliczenie Karty Expensify. Poproś tę osobę o kontakt z concierge@expensify.com w celu rozwiązania problemu. Następnie będziesz mógł przejąć rozliczenia dla tego obszaru roboczego.`,
      failedToClearBalanceTitle: "Nie udało się wyczyścić salda",
      failedToClearBalanceButtonText: "OK",
      failedToClearBalanceText:
        "Nie udało się wyczyścić salda. Spróbuj ponownie później.",
...
Czy na pewno chcesz wyeksportować je ponownie?`,
    ...
    upgrade: {
      ...
      categories: {
        title: "Kategorie",
        description:
          "Kategorie pozwalają śledzić i porządkować wydatki. Skorzystaj z naszych domyślnych kategorii lub dodaj własne.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
...
Wymagaj szczegółów wydatków, takich jak paragony i opisy, ustawiaj limity i wartości domyślne oraz automatyzuj akceptacje i płatności – wszystko w jednym miejscu.`,
      ...
      reports: {
        title: "Raporty",
        description:
          "Raporty pozwalają grupować wydatki, aby ułatwić ich śledzenie i organizację.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      distanceRates: {
        title: "Stawki za dystans",
        description:
          "Twórz i zarządzaj własnymi stawkami, śledź przejechany dystans w milach lub kilometrach i ustawiaj domyślne kategorie dla wydatków za przejazdy.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      auditor: {
        title: "Audytor",
        description:
          "Biegli rewidentci otrzymują dostęp tylko do odczytu do wszystkich raportów, aby zapewnić pełną widoczność i monitorowanie zgodności.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      commonFeatures: {
        ...
        benefits: {
          ...
          benefit1:
            "Zaawansowane połączenia księgowe (NetSuite, Sage Intacct i inne)",
    ...
    downgrade: {
      commonFeatures: {
        ...
        benefits: {
          ...
          confirm:
            "Czy na pewno chcesz obniżyć plan i usunąć swoje konfiguracje?",
          warning: "Tej operacji nie można cofnąć.",
          benefit1:
            "Połączenia księgowe (z wyjątkiem QuickBooks Online i Xero)",
          benefit2: "Inteligentne reguły wydatków",
          benefit3: "Wielopoziomowe przepływy zatwierdzania",
          benefit4: "Zaawansowane mechanizmy zabezpieczeń",
          headsUp: "Uwaga!",
      ...
      completed: {
        ...
        description:
          "Masz inne przestrzenie robocze w planie Control. Aby być rozliczanym według stawki Collect, musisz obniżyć plan wszystkich przestrzeni roboczych.",
        gotIt: "Jasne, dzięki",
      },
    },
    payAndDowngrade: {
      ...
      description1: (formattedAmount: string) =>
        `Twój końcowy rachunek za tę subskrypcję wyniesie <strong>${formattedAmount}</strong>`,
      description2: (date: string) =>
        `Zobacz swoje podsumowanie poniżej dla ${date}:`,
      subscription:
      ...
      genericFailureMessage:
        "Wystąpił błąd podczas opłacania Twojego rachunku. Spróbuj ponownie.",
    },
    restrictedAction: {
      restricted: "Ograniczone",
      actionsAreCurrentlyRestricted: (workspaceName: string) =>
        `Działania w przestrzeni roboczej ${workspaceName} są obecnie ograniczone`,
      ...
      youWillNeedToAddOrUpdatePaymentCard:
        "Aby odblokować nowe działania w przestrzeni roboczej, musisz dodać lub zaktualizować zapisaną kartę płatniczą.",
      addPaymentCardToUnlock: "Dodaj kartę płatniczą, aby odblokować!",
      addPaymentCardToContinueUsingWorkspace:
        "Dodaj kartę płatniczą, aby dalej korzystać z tego workspace’u",
      pleaseReachOutToYourWorkspaceAdmin:
        "W razie pytań skontaktuj się z administratorem swojego obszaru roboczego.",
    ...
    rules: {
      individualExpenseRules: {
        ...
        receiptRequiredAmountDescription:
          "Wymagaj paragonów, gdy wydatek przekracza tę kwotę, chyba że zastąpi to reguła kategorii.",
        receiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `Kwota nie może być większa niż wymagana kwota z wyszczególnionego paragonu (${amount})`,
        itemizedReceiptRequiredAmount:
          "Wymagana kwota z wyszczególnionego paragonu",
        itemizedReceiptRequiredAmountDescription:
          "Wymagaj zindywidualizowanych paragonów, gdy wydatki przekraczają tę kwotę, chyba że zastąpi to reguła kategorii.",
        itemizedReceiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `Kwota nie może być niższa niż kwota wymagana dla zwykłych paragonów (${amount})`,
        maxExpenseAmount: "Maksymalna kwota wydatku",
        maxExpenseAmountDescription:
          "Oznacz wydatki przekraczające tę kwotę, chyba że zastąpi to reguła kategorii.",
        maxAge: "Maksymalny wiek",
        maxExpenseAge: "Maksymalny wiek wydatku",
        maxExpenseAgeDescription:
          "Oznaczaj wydatki starsze niż określona liczba dni.",
        maxExpenseAgeDays: () => ({
          one: "1 dzień",
        ...
        reimbursableDefaultDescription:
          "Wydatki są najczęściej zwracane pracownikom",
        nonReimbursableDefault: "Nierefundowane",
        nonReimbursableDefaultDescription:
          "Koszty są sporadycznie zwracane pracownikom",
        ...
        alwaysNonReimbursableDescription:
          "Wydatki nigdy nie są zwracane pracownikom",
        ...
        nonBillableDescription:
          "Wydatki są okazjonalnie refakturowane klientom",
        eReceipts: "eParagony",
        ...
        requireCompanyCardDescription:
          "Oznacz wszystkie wydatki gotówkowe, w tym koszty za przejechane kilometry i ryczałty dzienne.",
        requireCompanyCardDisabledTooltip:
          "Włącz karty firmowe (w sekcji Więcej funkcji), aby odblokować.",
      },
      expenseReportRules: {
        title: "Zaawansowane",
        subtitle:
          "Zautomatyzuj zgodność raportów wydatków, ich zatwierdzanie i płatności.",
        preventSelfApprovalsTitle: "Zabroń samoakceptacji",
        preventSelfApprovalsSubtitle:
          "Uniemożliwij członkom przestrzeni roboczej zatwierdzanie własnych raportów wydatków.",
        autoApproveCompliantReportsTitle:
          "Automatycznie zatwierdzaj zgodne raporty",
        autoApproveCompliantReportsSubtitle:
          "Skonfiguruj, które raporty wydatków kwalifikują się do automatycznego zatwierdzania.",
        autoApproveReportsUnderTitle:
          "Automatycznie zatwierdzaj raporty, gdy wszystkie wydatki są poniżej",
        autoApproveReportsUnderDescription:
          "W pełni zgodne raporty wydatków, w których wszystkie wydatki są poniżej tej kwoty, zostaną zatwierdzone automatycznie.",
        randomReportAuditTitle: "Losowa kontrola raportów",
        randomReportAuditDescription:
          "Wymagaj ręcznego zatwierdzania niektórych raportów, nawet jeśli kwalifikują się do automatycznego zatwierdzenia.",
        autoPayApprovedReportsTitle:
          "Automatycznie opłacaj zatwierdzone raporty",
        autoPayApprovedReportsSubtitle:
          "Skonfiguruj, które raporty wydatków kwalifikują się do automatycznej płatności.",
        autoPayApprovedReportsLimitError: (currency?: string) =>
          `Wprowadź kwotę mniejszą niż ${currency ?? ""}20 000`,
        autoPayApprovedReportsLockedSubtitle:
          "Przejdź do „Więcej funkcji” i włącz Workflows, a następnie dodaj płatności, aby odblokować tę funkcję.",
        autoPayReportsUnderTitle: "Automatycznie opłacaj raporty w ramach",
        autoPayReportsUnderDescription:
          "W pełni zgodne raporty wydatków poniżej tej kwoty zostaną opłacone automatycznie.",
        unlockFeatureEnableWorkflowsSubtitle: (featureName: string) =>
          `Dodaj ${featureName}, aby odblokować tę funkcję.`,
      ...
      merchantRules: {
        title: "Sprzedawca",
        subtitle:
          "Skonfiguruj reguły dla sprzedawców, aby wydatki trafiały z prawidłowym kodowaniem i wymagały mniej poprawek.",
        ...
        previewMatchesEmptyStateSubtitle:
          "Żadne niewysłane wydatki nie pasują do tej reguły.",
        ...
        ruleSummaryTitle: (merchantName: string, isExactMatch: boolean) =>
          `Jeśli sprzedawca ${isExactMatch ? "dokładnie pasuje" : "zawiera"} „${merchantName}”`,
        ruleSummarySubtitleMerchant: (merchantName: string) =>
          `Zmień nazwę sprzedawcy na „${merchantName}”`,
        ruleSummarySubtitleUpdateField: (
          fieldName: string,
          fieldValue: string,
        ) => `Zaktualizuj ${fieldName} na „${fieldValue}”`,
        ruleSummarySubtitleReimbursable: (reimbursable: boolean) =>
          `Oznacz jako „${reimbursable ? "podlegające zwrotowi" : "bez zwrotu kosztów"}”`,
        ruleSummarySubtitleBillable: (billable: boolean) =>
          `Oznacz jako „${billable ? "rozliczalny" : "niepodlegające fakturowaniu"}”`,
        ...
        duplicateRulePrompt: (merchantName: string) =>
          `Twoja istniejąca reguła dla „${merchantName}” będzie mieć pierwszeństwo przed tą. Zapisać mimo to?`,
        saveAnyway: "Zapisz mimo to",
        applyToExistingUnsubmittedExpenses:
          "Zastosuj do istniejących niewysłanych wydatków",
      },
      categoryRules: {
        ...
        requiredFieldsDescription: (categoryName: string) =>
          `Zostanie to zastosowane do wszystkich wydatków zaklasyfikowanych jako <strong>${categoryName}</strong>.`,
        ...
        flagAmountsOverDescription: (categoryName: string) =>
          `Dotyczy kategorii „${categoryName}”.`,
        flagAmountsOverSubtitle:
          "To zastępuje maksymalną kwotę dla wszystkich wydatków.",
        expenseLimitTypes: {
          expense: "Pojedynczy wydatek",
          expenseSubtitle:
            "Oznaczaj kwoty wydatków według kategorii. Ta reguła zastępuje ogólną regułę maksymalnej kwoty wydatku dla przestrzeni roboczej.",
          daily: "Suma kategorii",
          dailySubtitle:
            "Oznaczaj łączną dzienną kwotę wydatków według kategorii dla każdego raportu wydatków.",
        },
        requireReceiptsOver: "Wymagaj paragonów powyżej",
        requireReceiptsOverList: {
          default: (defaultAmount: string) =>
            `${defaultAmount} ${CONST.DOT_SEPARATOR} Domyślne`,
          never: "Nigdy nie wymagaj paragonów",
          always: "Zawsze wymagaj paragonów",
        },
        requireItemizedReceiptsOver:
          "Wymagaj wyszczegółowionych paragonów powyżej",
      ...
      customRules: {
        ...
        cardSubtitle:
          "To tutaj znajduje się polityka wydatków Twojego zespołu, aby wszyscy mieli jasność co do tego, co jest objęte.",
      },
    },
    planTypePage: {
      planTypes: {
      ...
      description:
        "Wybierz plan odpowiedni dla siebie. Szczegółową listę funkcji i cen znajdziesz w naszej",
  ...
  newRoomPage: {
    ...
    restrictedDescription:
      "Osoby w Twojej przestrzeni roboczej mogą znaleźć ten pokój",
    ...
    roomNameReservedError: (reservedName: string) =>
      `${reservedName} to domyślny pokój we wszystkich przestrzeniach roboczych. Wybierz inną nazwę.`,
    roomNameInvalidError:
      "Nazwy pokojów mogą zawierać tylko małe litery, cyfry i łączniki",
    ...
    renamedRoomAction: (
      ...
      return isExpenseReport
        ? `${actor}zmieniono nazwę na „${newName}” (wcześniej „${oldName}”)`
        : `${actor} zmienił(a) nazwę tego pokoju na „${newName}” (wcześniej „${oldName}”)`;
    },
    roomRenamedTo: (newName: string) => `Pokój zmieniono na ${newName}`,
    social: "społeczny",
    selectAWorkspace: "Wybierz przestrzeń roboczą",
    growlMessageOnRenameError:
      "Nie można zmienić nazwy pokoju w przestrzeni roboczej. Sprawdź połączenie i spróbuj ponownie.",
    visibilityOptions: {
  ...
  workspaceActions: {
    ...
    changedCompanyAddress: ({
      ...
      previousAddress
        ? `zmieniono adres firmy na „${newAddress}” (poprzednio „${previousAddress}”)`
        : `ustaw adres firmy na „${newAddress}”`,
    addApprovalRule: (
    ...
    addCategory: (categoryName: string) => `dodano kategorię „${categoryName}”`,
    deleteCategory: (categoryName: string) =>
      `usunięto kategorię „${categoryName}”`,
    updateCategory: (categoryName: string, oldValue: boolean) =>
      `${oldValue ? "wyłączone" : "włączone"} kategorię „${categoryName}”`,
    ...
    setCategoryName: (oldName: string, newName: string) =>
      `zmieniono nazwę kategorii „${oldName}” na „${newName}”`,
    ...
    updateTagListName: (oldName: string, newName: string) =>
      `zmienił nazwę listy tagów na „${newName}” (poprzednio „${oldName}”)`,
    addTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `dodano znacznik „${tagName}” do listy „${tagListName}”`,
    updateTagName: ({
      tagListName,
      newName,
      oldName,
    }: UpdatedPolicyTagNameParams) =>
      `zaktualizowano listę znaczników „${tagListName}”, zmieniając znacznik „${oldName}” na „${newName}”`,
    updateTagEnabled: ({
      tagListName,
      tagName,
      enabled,
    }: UpdatedPolicyTagParams) =>
      `${enabled ? "włączone" : "Wyłączone"} tag "${tagName}" na liście "${tagListName}"`,
    deleteTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `usunięto tag „${tagName}” z listy „${tagListName}”`,
    deleteMultipleTags: ({ count, tagListName }: UpdatedPolicyTagParams) =>
      `usunięto tagi „${count}” z listy „${tagListName}”`,
    updateTag: ({
      tagListName,
      newValue,
      tagName,
    ...
    updateCustomUnitTaxEnabled: ({
      ...
      `${newValue ? "włączone" : "wyłączone"} śledzenie podatku dla stawek za dystans`,
    addCustomUnitRate: (customUnitName: string, rateName: string) =>
      `dodano nową stawkę ${customUnitName} „${rateName}”`,
    ...
    deleteCustomUnitRate: ({
      ...
      `usunięto stawkę „${rateName}” jednostki „${customUnitName}”`,
    addedReportField: ({
      fieldType,
      fieldName,
    }: AddedOrDeletedPolicyReportFieldParams) =>
      `dodano pole raportu ${fieldType} „${fieldName}”`,
    ...
    addedReportFieldOption: (fieldName: string, optionName: string) =>
      `dodano opcję „${optionName}” do pola raportu „${fieldName}”`,
    removedReportFieldOption: (fieldName: string, optionName: string) =>
      `usunął opcję „${optionName}” z pola raportu „${fieldName}”`,
    ...
    deleteReportField: ({
      ...
      fieldType: string;
      fieldName?: string;
    }) => `usunięto pole raportu ${fieldType} „${fieldName}”`,
    preventSelfApproval: ({
      oldValue,
      newValue,
    }: UpdatedPolicyPreventSelfApprovalParams) =>
    ...
    updateDefaultTitleEnforced: (value: boolean) =>
      `włączył(-a) „Wymuszanie domyślnych tytułów raportów” ${value ? "włączone" : "wyłączone"}`,
    ...
    renamedWorkspaceNameAction: (oldName: string, newName: string) =>
      `zaktualizowano nazwę tego obszaru roboczego na „${newName}” (wcześniej „${oldName}”)`,
    updateWorkspaceDescription: (
      ...
      !oldDescription
        ...
        : `zaktualizowano opis tego workspace’u na „${newDescription}” (wcześniej „${oldDescription}”)`,
    ...
    updateApprovalMode: ({ newValue, oldValue }: ChangeFieldParams) =>
      `zaktualizowano tryb zatwierdzania na „${newValue}” (wcześniej „${oldValue}”)`,
    ...
    updatedFeatureEnabled: ({
      ...
      switch (featureName) {
        ...
        case "rules":
          return `${enabled ? "włączone" : "wyłączone"} zasad`;
        case "tax tracking":
    ...
    updatedAttendeeTracking: ({ enabled }: { enabled: boolean }) =>
      `Śledzenie uczestników ${enabled ? "włączone" : "wyłączone"}`,
    updatedAutoPayApprovedReports: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "włączone" : "wyłączone"} automatycznie opłaconych zatwierdzonych raportów`,
    setAutoPayApprovedReportsLimit: ({ newLimit }: { newLimit: string }) =>
      `ustaw próg automatycznych płatności zatwierdzonych raportów na „${newLimit}”`,
    ...
    removedAutoPayApprovedReportsLimit:
      "usunął próg automatycznego opłacania zatwierdzonych raportów",
    changedDefaultApprover: ({
      ...
      previousApprover
        ? `zmienił(a) domyślnego zatwierdzającego na ${newApprover} (wcześniej ${previousApprover})`
        : `zmieniono domyślnego akceptującego na ${newApprover}`,
    ...
    changedInvoiceCompanyName: ({
      ...
      oldValue
        ? `zmieniono nazwę firmy na fakturze na „${newValue}” (poprzednio „${oldValue}”)`
        : `ustaw nazwę firmy na fakturze na „${newValue}”`,
    changedInvoiceCompanyWebsite: ({
      ...
      oldValue
        ? `zmienił(a) firmową stronę internetową faktury na „${newValue}” (poprzednio „${oldValue}”)`
        : `ustawiono firmową stronę internetową na fakturze na „${newValue}”`,
    changedReimburser: ({
      newReimburser,
      previousReimburser,
    }: UpdatedPolicyReimburserParams) =>
    ...
    updateReimbursementEnabled: ({
      ...
      `${enabled ? "włączone" : "wyłączone"} zwrotów kosztów`,
    updateCustomTaxName: ({
      oldName,
      newName,
    }: UpdatedPolicyCustomTaxNameParams) =>
      `zmieniono niestandardową nazwę podatku na „${newName}" (poprzednio „${oldName}")`,
    ...
    addTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `dodano podatek „${taxName}”`,
    deleteTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `usunął(-ę) podatek „${taxName}”`,
    updateTax: ({
      oldValue,
      taxName,
      updatedField,
    ...
    setReceiptRequiredAmount: (newValue: string) =>
      `ustaw wymaganą kwotę paragonu na „${newValue}”`,
    changedReceiptRequiredAmount: (oldValue: string, newValue: string) =>
      `zmienił(a) wymaganą kwotę paragonu na „${newValue}” (wcześniej „${oldValue}”)`,
    removedReceiptRequiredAmount: (oldValue: string) =>
      `usunięto wymagany limit paragonu (wcześniej „${oldValue}”)`,
    setMaxExpenseAmount: (newValue: string) =>
      `ustaw maksymalną kwotę wydatku na „${newValue}”`,
    changedMaxExpenseAmount: (oldValue: string, newValue: string) =>
      `zmieniono maksymalną kwotę wydatku na „${newValue}” (wcześniej „${oldValue}”)`,
    removedMaxExpenseAmount: (oldValue: string) =>
      `usunięto maksymalną kwotę wydatku (wcześniej „${oldValue}”)`,
    setMaxExpenseAge: (newValue: string) =>
      `ustaw maksymalny wiek wydatku na „${newValue}” dni`,
    changedMaxExpenseAge: (oldValue: string, newValue: string) =>
      `zmieniono maksymalny wiek wydatku na „${newValue}” dni (wcześniej „${oldValue}”)`,
    removedMaxExpenseAge: (oldValue: string) =>
      `usunięto maksymalny wiek wydatku (wcześniej „${oldValue}” dni)`,
    updateCategories: ({ count }: UpdatedPolicyCategoriesParams) =>
      `zaktualizowano ${count} kategorie`,
    updateTagList: ({ tagListName }: UpdatedPolicyTagListParams) =>
      `zaktualizowano tagi na liście „${tagListName}”`,
    updateTagListRequired: ({
      tagListsName,
      isRequired,
    }: UpdatedPolicyTagListRequiredParams) =>
      `zmieniono listę tagów „${tagListsName}” na ${isRequired ? "wymagane" : "niewymagane"}`,
    importTags: "zaimportowano tagi z arkusza kalkulacyjnego",
    deletedAllTags: "usunął(-ę) wszystkie tagi",
    updateCustomUnitDefaultCategory: ({
      customUnitName,
      newValue,
      oldValue,
    }: UpdatePolicyCustomUnitDefaultCategoryParams) =>
      `zmienił(a) domyślną kategorię jednostki ${customUnitName} na „${newValue}” ${oldValue ? `(uprzednio „${oldValue}”)` : ""}`,
    importCustomUnitRates: ({
      customUnitName,
    }: ImportPolicyCustomUnitRatesParams) =>
      `zaimportowano stawki dla niestandardowej jednostki „${customUnitName}”`,
    updateCustomUnitSubRate: ({
      ...
      `zmieniono stawkę „${customUnitName}” stawka „${customUnitRateName}” stawka podrzędna „${customUnitSubRateName}” ${updatedField} na „${newValue}” (wcześniej „${oldValue}”)`,
    removedCustomUnitSubRate: ({
      customUnitName,
      customUnitRateName,
      removedSubRateName,
    }: RemovedPolicyCustomUnitSubRateParams) =>
      `usunięto stawkę „${customUnitName}” o nazwie „${customUnitRateName}” i podstawkę „${removedSubRateName}”`,
    addBudget: ({
      frequency,
      entityName,
      entityType,
      ...
      const thresholdSuffix =
        typeof notificationThreshold === "number"
          ? `z progiem powiadomień wynoszącym „${notificationThreshold}%”`
          : "";
      if (typeof shared !== "undefined" && typeof individual !== "undefined") {
        return `dodano ${frequency} indywidualny budżet „${individual}” oraz ${frequency} współdzielony budżet „${shared}”${thresholdSuffix} do ${entityType} „${entityName}”`;
      }
      if (typeof individual !== "undefined") {
        return `dodano ${frequency} indywidualny budżet „${individual}”${thresholdSuffix} do ${entityType} „${entityName}”`;
      }
      return `dodano ${frequency} współdzielony budżet „${shared}”${thresholdSuffix} do ${entityType} „${entityName}”`;
    },
    updateBudget: ({
      entityType,
      entityName,
      ...
      if (frequencyChanged) {
        changesList.push(
          `zmieniono częstotliwość budżetu na „${newFrequency}” (wcześniej „${oldFrequency}”)`,
        );
      }
      if (sharedChanged) {
        changesList.push(
          `zmieniono łączny budżet przestrzeni roboczej na „${newShared}” (wcześniej „${oldShared}”)`,
        );
      }
      if (individualChanged) {
        changesList.push(
          `zmieniono indywidualny budżet na „${newIndividual}” (wcześniej „${oldIndividual}”)`,
        );
      }
      if (thresholdChanged) {
        changesList.push(
          `zmieniono próg powiadomień na „${newNotificationThreshold}%” (wcześniej „${oldNotificationThreshold}%”)`,
        );
      }
      if (
        !frequencyChanged &&
        ...
        return `zaktualizowano budżet dla ${entityType} „${entityName}”`;
      }
      if (changesList.length === 1) {
        if (frequencyChanged) {
          return `zmieniono częstotliwość budżetu dla ${entityType} „${entityName}” na „${newFrequency}” (wcześniej „${oldFrequency}”)`;
        }
        if (sharedChanged) {
          return `zmieniono łączny budżet przestrzeni roboczej dla ${entityType} „${entityName}” na „${newShared}” (wcześniej „${oldShared}”)`;
        }
        if (individualChanged) {
          return `zmieniono indywidualny budżet dla ${entityType} „${entityName}” na „${newIndividual}” (wcześniej „${oldIndividual}”)`;
        }
        return `zmieniono próg powiadomień dla ${entityType} „${entityName}” na „${newNotificationThreshold}%” (wcześniej „${oldNotificationThreshold}%”)`;
      }
      return `zaktualizowano budżet dla ${entityType} „${entityName}”: ${changesList.join("; ")}`;
    },
    deleteBudget: ({
      entityType,
      entityName,
      ...
      if (shared && individual) {
        return `usunięto ${frequency} współdzielony budżet „${shared}” oraz indywidualny budżet „${individual}”${thresholdSuffix} z ${entityType} „${entityName}”`;
      }
      if (shared) {
        return `usunięto ${frequency} współdzielony budżet „${shared}”${thresholdSuffix} z ${entityType} „${entityName}”`;
      }
      if (individual) {
        return `usunięto ${frequency} indywidualny budżet „${individual}”${thresholdSuffix} z ${entityType} „${entityName}”`;
      }
      return `usunięto budżet z ${entityType} „${entityName}”`;
    },
    updatedTimeEnabled: ({ enabled }: UpdatedPolicyTimeEnabledParams) => {
      return `${enabled ? "włączone" : "wyłączone"} śledzenie czasu`;
    },
    updatedTimeRate: ({ newRate, oldRate }: UpdatedPolicyTimeRateParams) => {
      return `zmieniono stawkę godzinową na „${newRate}” (wcześniej „${oldRate}”)`;
    },
    addedProhibitedExpense: ({
      prohibitedExpense,
    }: {
      prohibitedExpense: string;
    }) => `dodano „${prohibitedExpense}” do zabronionych wydatków`,
    removedProhibitedExpense: ({
      prohibitedExpense,
    }: {
      prohibitedExpense: string;
    }) => `usunięto „${prohibitedExpense}” z wydatków zabronionych`,
    ...
    setAutoJoin: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "włączone" : "wyłączone"} wstępna akceptacja próśb o dołączenie do przestrzeni workspace`,
    updatedDefaultTitle: ({
      newDefaultTitle,
      oldDefaultTitle,
    }: UpdatedPolicyDefaultTitleParams) =>
    ...
    updatedOwnership: ({
      ...
      `przejął(a) własność ${policyName} od ${oldOwnerName} (${oldOwnerEmail})`,
    updatedAutoHarvesting: ({ enabled }: UpdatedPolicyAutoHarvestingParams) =>
      `Zaplanowane przesłanie ${enabled ? "włączone" : "wyłączone"}`,
  ...
  roomMembersPage: {
    ...
    useInviteButton:
      "Aby zaprosić nowego członka do czatu, użyj przycisku zapraszania powyżej.",
  ...
  task: {
    ...
    action: "Zakończ",
    messages: {
      created: (title: string) => `zadanie dla ${title}`,
    ...
    assigneeError:
      "Wystąpił błąd podczas przypisywania tego zadania. Spróbuj wybrać inną osobę odpowiedzialną.",
    genericCreateTaskFailureMessage:
      "Wystąpił błąd podczas tworzenia tego zadania. Spróbuj ponownie później.",
    deleteTask: "Usuń zadanie",
    deleteConfirmation: "Czy na pewno chcesz usunąć to zadanie?",
  },
  statementPage: {
    title: (year: number | string, monthName: string) =>
      `Wyciąg za ${monthName} ${year}`,
  },
  ...
  search: {
    ...
    searchResults: {
      ...
      emptyExpenseResults: {
        ...
        subtitle:
          "Utwórz wydatek lub wypróbuj Expensify, aby dowiedzieć się więcej.",
        subtitleWithOnlyCreateButton:
          "Użyj zielonego przycisku poniżej, aby utworzyć wydatek.",
      },
      emptyReportResults: {
        title: "Nie utworzyłeś jeszcze żadnych raportów",
        subtitle:
          "Utwórz raport lub wypróbuj Expensify, aby dowiedzieć się więcej.",
        subtitleWithOnlyCreateButton:
          "Użyj zielonego przycisku poniżej, aby utworzyć raport.",
      },
      emptyInvoiceResults: {
        title: dedent(`
                ...
                `),
        subtitle:
          "Wyślij fakturę lub wypróbuj Expensify, aby dowiedzieć się więcej.",
        subtitleWithOnlyCreateButton:
          "Użyj zielonego przycisku poniżej, aby wysłać fakturę.",
      },
      emptyTripResults: {
    ...
    filters: {
      ...
      card: {
        ...
        cardFeedNameCSV: ({ cardFeedLabel }: { cardFeedLabel?: string }) =>
          `Wszystkie zaimportowane karty CSV${cardFeedLabel ? ` - ${cardFeedLabel}` : ""}`,
      },
    ...
    exportSearchResults: {
      ...
      description:
        "Wow, ale dużo pozycji! Spakujemy je, a Concierge wkrótce wyśle Ci plik.",
    },
  ...
  fileDownload: {
    ...
    permissionError: {
      ...
      message:
        "Expensify nie może zapisywać załączników bez dostępu do pamięci. Stuknij „Ustawienia”, aby zaktualizować uprawnienia.",
    },
  },
  settlement: {
    status: {
    ...
    failedError: ({ link }: { link: string }) =>
      `Spróbujemy ponownie rozliczyć tę płatność, gdy <a href="${link}">odblokujesz swoje konto</a>.`,
    withdrawalInfo: ({
      date,
      withdrawalID,
    }: {
  ...
  reportLayout: {
    ...
    selectGroup: ({ groupName }: { groupName: string }) =>
      `Zaznacz wszystkie wydatki w ${groupName}`,
    groupBy: {
      category: "Kategoria",
      tag: "Tag",
    },
  ...
  report: {
    newReport: {
      ...
      emptyReportConfirmationPrompt: ({
        ...
        `Czy na pewno chcesz utworzyć kolejny raport w ${workspaceName}? Puste raporty znajdziesz w`,
    ...
    genericCreateReportFailureMessage:
      "Nieoczekiwany błąd podczas tworzenia tego czatu. Spróbuj ponownie później.",
    genericAddCommentFailureMessage:
      "Nieoczekiwany błąd podczas wysyłania komentarza. Spróbuj ponownie później.",
    genericUpdateReportFieldFailureMessage:
      "Nieoczekiwany błąd podczas aktualizowania pola. Spróbuj ponownie później.",
    genericUpdateReportNameEditFailureMessage:
      "Nieoczekiwany błąd podczas zmiany nazwy raportu. Spróbuj ponownie później.",
    ...
    actions: {
      type: {
        changeField: ({ oldValue, newValue, fieldName }: ChangeFieldParams) =>
          `zmieniono ${fieldName} na „${newValue}” (wcześniej „${oldValue}”)`,
        changeFieldEmpty: ({ newValue, fieldName }: ChangeFieldParams) =>
          `ustaw ${fieldName} na „${newValue}”`,
        ...
        changeType: (oldType: string, newType: string) =>
          `zmieniono typ z ${oldType} na ${newType}`,
        ...
        exportedToIntegration: {
          ...
          pending: (label: string) =>
            `rozpoczęto eksport tego raportu do ${label}...`,
        },
        integrationsMessage: (
          errorMessage: string,
          label: string,
        ...
        markedReimbursed: (amount: string, currency: string) =>
          `zapłacono ${currency}${amount} gdzie indziej`,
        markedReimbursedFromIntegration: ({
          amount,
          currency,
        }: MarkReimbursedFromIntegrationParams) =>
          `zapłacono ${currency}${amount} przez integrację`,
        ...
        addEmployee: (email: string, role: string) =>
          `dodano ${email} jako ${role === "member" ? "a" : "włączony"} ${role}`,
        updateRole: ({ email, currentRole, newRole }: UpdateRoleParams) =>
          `zaktualizowano rolę użytkownika ${email} na ${newRole} (wcześniej ${currentRole})`,
        updatedCustomField1: (
          email: string,
          newValue: string,
        ...
        leftWorkspace: (nameOrEmail: string) =>
          `${nameOrEmail} opuścił(-a) przestrzeń roboczą`,
        removeMember: (email: string, role: string) =>
          `usunięto ${role} ${email}`,
        removedConnection: ({ connectionName }: ConnectionNameParams) =>
          `usunięto połączenie z ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        addedConnection: ({ connectionName }: ConnectionNameParams) =>
          `połączono z ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        ...
        leftTheChatWithName: (nameOrEmail: string) =>
          `${nameOrEmail ? `${nameOrEmail}: ` : ""} opuścił czat`,
        actionableCard3DSTransactionApproval: (
          ...
          const amountAndMerchantText = [amount, merchant]
            .filter((s) => !!s?.length)
            .join(" ");
          return `Otwórz aplikację mobilną Expensify, aby przejrzeć transakcję${amountAndMerchantText ? ` ${amountAndMerchantText}` : ""}`;
        },
      },
      error: {
        invalidCredentials:
          "Nieprawidłowe dane logowania, sprawdź konfigurację swojego połączenia.",
      },
    },
  },
  chronos: {
    oooEventSummaryFullDay: (summary: string, dayCount: number, date: string) =>
      `${summary} za ${dayCount} ${dayCount === 1 ? "dzień" : "dni"} do ${date}`,
    oooEventSummaryPartialDay: (
      summary: string,
      timePeriod: string,
      date: string,
    ) => `${summary} z ${timePeriod} z dnia ${date}`,
  },
  footer: {
    features: "Funkcje",
  ...
  threads: {
    ...
    parentNavigationSummary: ({
      ...
      `Z raportu ${reportName}${workspaceName ? `w ${workspaceName}` : ""}`,
  },
  qrCodes: {
    qrCode: "Kod QR",
    copy: "Skopiuj URL",
  ...
  moderation: {
    flagDescription:
      "Wszystkie oznaczone wiadomości zostaną wysłane do moderatora do weryfikacji.",
    ...
    inconsiderateDescription:
      "Obrażające lub lekceważące sformułowanie, o wątpliwych intencjach",
    intimidation: "Zastraszanie",
    intimidationDescription:
      "Agresywne forsowanie własnej agendy mimo uzasadnionych zastrzeżeń",
    bullying: "Nękanie",
    bullyingDescription:
      "Obieranie za cel jednostki w celu uzyskania posłuszeństwa",
    harassment: "Nękanie",
    harassmentDescription:
      "Rasistowskie, mizoginistyczne lub inne szeroko dyskryminujące zachowania",
    assault: "Napaść",
    assaultDescription:
      "Celowo wymierzony atak emocjonalny z zamiarem wyrządzenia krzywdy",
    flaggedContent:
      "Ta wiadomość została oznaczona jako naruszająca nasze zasady społeczności, a jej treść została ukryta.",
    hideMessage: "Ukryj wiadomość",
    revealMessage: "Pokaż wiadomość",
    levelOneResult:
      "Wysyła anonimowe ostrzeżenie, a wiadomość zostaje zgłoszona do weryfikacji.",
    levelTwoResult:
      "Wiadomość ukryta na kanale, wraz z anonimowym ostrzeżeniem, a wiadomość została zgłoszona do sprawdzenia.",
    levelThreeResult:
      "Wiadomość usunięta z kanału, wysłano anonimowe ostrzeżenie, a wiadomość została zgłoszona do weryfikacji.",
  },
  ...
  teachersUnitePage: {
    ...
    getInTouch:
      "Świetnie! Udostępnij ich dane kontaktowe, abyśmy mogli się z nimi skontaktować.",
  ...
  distance: {
    ...
    error: {
      selectSuggestedAddress:
        "Wybierz sugerowany adres lub użyj bieżącej lokalizacji",
    },
    odometer: {
      ...
      startMessageWeb:
        "Dodaj zdjęcie licznika kilometrów z <strong>początku</strong> swojej podróży. Przeciągnij tutaj plik lub wybierz go, aby przesłać.",
      endMessageWeb:
        "Dodaj zdjęcie licznika przebiegu z <strong>końca</strong> swojej podróży. Przeciągnij tutaj plik lub wybierz jeden, aby go przesłać.",
      startTitle: "Zdjęcie licznika na początku",
      ...
      deleteOdometerPhotoConfirmation:
        "Na pewno chcesz usunąć to zdjęcie licznika?",
      cameraAccessRequired:
        "Aby robić zdjęcia, wymagany jest dostęp do aparatu.",
      snapPhotoStart:
        "<muted-text-label>Zrób zdjęcie licznika kilometrów na <strong>początku</strong> podróży.</muted-text-label>",
      snapPhotoEnd:
        "<muted-text-label>Zrób zdjęcie licznika kilometrów na <strong>koniec</strong> swojej podróży.</muted-text-label>",
    },
  },
  gps: {
    error: {
      failedToStart: "Nie udało się uruchomić śledzenia lokalizacji.",
      failedToGetPermissions:
        "Nie udało się uzyskać wymaganych uprawnień lokalizacji.",
    },
    ...
    discardDistanceTrackingModal: {
      ...
      prompt:
        "Na pewno? Spowoduje to porzucenie Twojej bieżącej ścieżki i nie będzie można tego cofnąć.",
      confirm: "Odrzuć śledzenie dystansu",
    },
    zeroDistanceTripModal: {
      title: "Nie można utworzyć wydatku",
      prompt:
        "Nie możesz utworzyć wydatku z takim samym miejscem początkowym i końcowym.",
    },
    locationRequiredModal: {
      title: "Wymagany dostęp do lokalizacji",
      prompt:
        "Zezwól na dostęp do lokalizacji w ustawieniach urządzenia, aby rozpocząć śledzenie dystansu GPS.",
      allow: "Zezwól",
    },
    androidBackgroundLocationRequiredModal: {
      title: "Wymagany dostęp do lokalizacji w tle",
      prompt:
        "Zezwól na dostęp do lokalizacji w tle w ustawieniach urządzenia (opcja „Zawsze zezwalaj”), aby uruchomić śledzenie dystansu GPS.",
    },
    preciseLocationRequiredModal: {
      title: "Wymagana dokładna lokalizacja",
      prompt:
        "Włącz proszę „dokładną lokalizację” w ustawieniach urządzenia, aby rozpocząć śledzenie dystansu GPS.",
    },
    desktop: {
      title: "Śledź dystans na swoim telefonie",
      subtitle:
        "Automatycznie rejestruj mile lub kilometry za pomocą GPS i natychmiast zamieniaj przejazdy w wydatki.",
    ...
    continueGpsTripModal: {
      ...
      prompt:
        "Wygląda na to, że aplikacja została zamknięta podczas Twojej ostatniej trasy GPS. Czy chcesz kontynuować nagrywanie z tamtej trasy?",
    ...
    switchToODWarningTripInProgress: {
      title: "Trwa śledzenie GPS",
      prompt:
        "Czy na pewno chcesz zatrzymać śledzenie GPS i przełączyć się na Expensify Classic?",
  ...
  reportCardLostOrDamaged: {
    ...
    confirmAddressTitle:
      "Potwierdź adres korespondencyjny dla swojej nowej karty.",
    cardDamagedInfo:
      "Twoja nowa karta dotrze w ciągu 2–3 dni roboczych. Twoja obecna karta będzie działać do momentu aktywacji nowej.",
    ...
    successDescription:
      "Będziesz musieć aktywować ją, gdy dotrze za kilka dni roboczych. W międzyczasie możesz korzystać z wirtualnej karty.",
  },
  eReceipt: {
  ...
  referralProgram: {
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
      buttonText:
        "Rozpocznij czat, <success><strong>poleć znajomego</strong></success>.",
    ...
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
      buttonText:
        "Złóż raport wydatków, <success><strong>poleć swój zespół</strong></success>.",
  ...
  violations: {
    ...
    invoiceMarkup: ({ invoiceMarkup }: ViolationsInvoiceMarkupParams) =>
      `Podwyższono o ${invoiceMarkup}%`,
    maxAge: ({ maxAge }: ViolationsMaxAgeParams) =>
      `Data starsza niż ${maxAge} dni`,
    ...
    overAutoApprovalLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Wydatek przekracza automatyczny limit zatwierdzania w wysokości ${formattedLimit}`,
    overCategoryLimit: ({
      formattedLimit,
    }: ViolationsOverCategoryLimitParams) =>
      `Kwota przekracza limit kategorii w wysokości ${formattedLimit}/osobę`,
    overLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Kwota powyżej limitu ${formattedLimit}/osobę`,
    overTripLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Kwota powyżej limitu ${formattedLimit}/podróż`,
    overLimitAttendee: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Kwota powyżej limitu ${formattedLimit}/osobę`,
    perDayLimit: ({ formattedLimit }: ViolationsPerDayLimitParams) =>
      `Kwota przekraczająca dzienny limit kategorii ${formattedLimit}/osobę`,
    ...
    itemizedReceiptRequired: ({
      ...
      `Wymagany paragon z wyszczególnieniem pozycji${formattedLimit ? `powyżej ${formattedLimit}` : ""}`,
    prohibitedExpense: ({
    ...
    rter: ({
      ...
      if (!isTransactionOlderThan7Days) {
        return isAdmin
          ? `Poproś ${member}, aby oznaczył to jako gotówkę, albo poczekaj 7 dni i spróbuj ponownie`
          : "Oczekiwanie na połączenie z transakcją kartową.";
      }
      return "";
    },
    brokenConnection530Error:
      "Paragon oczekuje z powodu przerwanego połączenia z bankiem",
    ...
    memberBrokenConnectionError:
      "Paragon oczekuje z powodu zerwanego połączenia z bankiem. Poproś administratora przestrzeni roboczej o rozwiązanie problemu.",
    markAsCashToIgnore:
      "Oznacz jako gotówkę, aby zignorować i poprosić o płatność.",
    smartscanFailed: ({ canEdit = true }) =>
      `Skanowanie paragonu nie powiodło się.${canEdit ? "Wpisz szczegóły ręcznie." : ""}`,
    ...
    isTransactionReimbursable:
      "Wybierz, czy transakcja jest podlegająca zwrotowi",
  ...
  reportViolations: {
    ...
    reportContainsExpensesWithViolations:
      "Raport zawiera wydatki z naruszeniami.",
  },
  violationDismissal: {
    rter: {
  ...
  exitSurvey: {
    ...
    reasonPage: {
      ...
      subtitle:
        "Zanim odejdziesz, powiedz nam proszę, dlaczego chcesz przełączyć się na Expensify Classic.",
    },
    reasons: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "Potrzebuję funkcji, która jest dostępna tylko w Expensify Classic.",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "Nie rozumiem, jak korzystać z New Expensify.",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Rozumiem, jak korzystać z Nowego Expensify, ale wolę klasyczną wersję Expensify.",
    },
    prompts: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "Jakiej funkcji potrzebujesz, której nie ma w New Expensify?",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]: "Co próbujesz zrobić?",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Dlaczego wolisz Expensify Classic?",
    },
    responsePlaceholder: "Twoja odpowiedź",
    thankYou: "Dziękujemy za opinię!",
    thankYouSubtitle:
      "Twoje odpowiedzi pomogą nam stworzyć lepszy produkt do załatwiania spraw. Bardzo dziękujemy!",
    goToExpensifyClassic: "Przełącz na Expensify Classic",
    ...
    quickTipSubTitle:
      "Możesz przejść bezpośrednio do Expensify Classic, odwiedzając expensify.com. Dodaj ją do zakładek, aby mieć łatwy skrót!",
    ...
    benefits: {
      [CONST.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY]:
        "Bezpośrednie czatowanie na wydatkach i raportach",
      [CONST.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE]:
        "Możliwość robienia wszystkiego na urządzeniu mobilnym",
      [CONST.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE]:
        "Podróże i wydatki z prędkością czatu",
    },
  ...
  subscription: {
    ...
    mobileReducedFunctionalityMessage:
      "Nie możesz wprowadzać zmian w swoim abonamencie w aplikacji mobilnej.",
    badge: {
      freeTrial: (numOfDays: number) =>
        `Darmowy okres próbny: pozostało ${numOfDays} ${numOfDays === 1 ? "dzień" : "dni"}`,
    },
    billingBanner: {
      ...
      policyOwnerUnderInvoicing: {
        title: "Twoje dane płatnicze są nieaktualne",
        subtitle: (date: string) =>
          `Twoja płatność jest przeterminowana. Prosimy opłacić fakturę do ${date}, aby uniknąć przerwy w świadczeniu usługi.`,
      },
      ...
      cardAuthenticationRequired: {
        ...
        subtitle: (cardEnding: string) =>
          `Aby aktywować swoją kartę płatniczą kończącą się na ${cardEnding}, dokończ proces uwierzytelniania.`,
      },
      insufficientFunds: {
        title: "Nie można było obciążyć Twojej karty",
      ...
      preTrial: {
        ...
        subtitle:
          'Jako następny krok <a href="#">wypełnij swoją listę kontrolną konfiguracji</a>, aby Twój zespół mógł zacząć rozliczać wydatki.',
      },
      trialStarted: {
        title: (numOfDays: number) =>
          `Okres próbny: pozostało ${numOfDays} ${numOfDays === 1 ? "dzień" : "dni"}!`,
        subtitle:
          "Dodaj kartę płatniczą, aby nadal korzystać ze wszystkich swoich ulubionych funkcji.",
      },
      trialEnded: {
      ...
      earlyDiscount: {
        ...
        subscriptionPageTitle: (discountType: number) =>
          `<strong>${discountType}% zniżki na pierwszy rok!</strong> Dodaj kartę płatniczą i rozpocznij roczną subskrypcję.`,
        onboardingChatTitle: (discountType: number) =>
          `Oferta ograniczona czasowo: ${discountType}% zniżki na pierwszy rok!`,
        subtitle: (
          days: number,
          hours: number,
          minutes: number,
          ...
          `Odbierz w ciągu ${days > 0 ? `${days}d :` : ""}${hours}h : ${minutes}m : ${seconds}s`,
      },
    },
    cardSection: {
      title: "Płatność",
      ...
      cardInfo: (name: string, expiration: string, currency: string) =>
        `Nazwa: ${name}, Data ważności: ${expiration}, Waluta: ${currency}`,
      cardNextPayment: (nextPaymentDate: string) =>
        `Data Twojej następnej płatności to ${nextPaymentDate}.`,
    ...
    yourPlan: {
      ...
      asLowAs: ({ price }: YourPlanPriceValueParams) =>
        `już od ${price} za aktywnego członka/miesiąc`,
      pricePerMemberMonth: ({ price }: YourPlanPriceValueParams) =>
        `${price} za członka/miesiąc`,
      pricePerMemberPerMonth: ({ price }: YourPlanPriceValueParams) =>
        `${price} za członka miesięcznie`,
      perMemberMonth: "za użytkownika/miesiąc",
      collect: {
        title: "Zbierz",
        description:
          "Plan dla małych firm, który zapewnia wydatki, podróże i czat.",
        priceAnnual: ({ lower, upper }: YourPlanPriceParams) =>
          `Od ${lower}/aktywnego członka z Kartą Expensify do ${upper}/aktywnego członka bez Karty Expensify.`,
      ...
      saveWithExpensifyDescription:
        "Skorzystaj z naszego kalkulatora oszczędności, żeby zobaczyć, jak zwrot gotówki z Karty Expensify może obniżyć twój rachunek w Expensify.",
    ...
    details: {
      ...
      zeroCommitment:
        "Zero zobowiązań przy obniżonej rocznej stawce subskrypcji",
    },
    subscriptionSize: {
      title: "Rozmiar subskrypcji",
      yourSize:
        "Rozmiar Twojej subskrypcji to liczba wolnych miejsc, które w danym miesiącu mogą zostać zajęte przez dowolnych aktywnych członków.",
      eachMonth:
      ...
      subscriptionSize: "Rozmiar subskrypcji",
      activeMembers: (size: number) => `${size} aktywnych członków/miesiąc`,
      subscriptionRenews: "Odnowienie subskrypcji",
      youCantDowngrade:
        "Nie możesz przejść na niższy plan w trakcie rocznej subskrypcji.",
    ...
    paymentCard: {
      ...
      security:
        "Expensify jest zgodny z PCI-DSS, używa szyfrowania na poziomie bankowym i wykorzystuje redundantną infrastrukturę, aby chronić Twoje dane.",
    ...
    expensifyCode: {
      ...
      enterCode:
        "Wprowadź kod Expensify, aby zastosować go do swojej subskrypcji.",
      apply: "Zastosuj",
      error: {
    ...
    subscriptionSettings: {
      ...
      saveUpTo: (amountWithCurrency: string) =>
        `Oszczędzaj do ${amountWithCurrency}/miesiąc na aktywnego członka`,
      ...
      whatsMainReason:
        "Jaki jest główny powód wyłączenia automatycznego odnawiania?",
      renewsOn: (date: string) => `Odnawia się ${date}.`,
      pricingConfiguration:
        "Cena zależy od konfiguracji. Żeby zapłacić jak najmniej, wybierz roczną subskrypcję i zamów Kartę Expensify.",
      ...
      changesBasedOn:
        "To się zmienia w zależności od korzystania z Karty Expensify i poniższych opcji subskrypcji.",
    },
    requestEarlyCancellation: {
      title: "Poproś o wcześniejsze anulowanie",
      subtitle:
        "Jaki jest główny powód, dla którego prosisz o wcześniejsze anulowanie?",
  ...
  delegate: {
    ...
    accessLevelDescription:
      "Wybierz poziom dostępu poniżej. Zarówno Pełny, jak i Ograniczony dostęp pozwalają współprowadzącym przeglądać wszystkie konwersacje i wydatki.",
    ...
    removeCopilotConfirmation:
      "Czy na pewno chcesz usunąć tego pilota współpracującego?",
    changeAccessLevel: "Zmień poziom dostępu",
    makeSureItIsYou: "Upewnijmy się, że to Ty",
    enterMagicCode: (contactMethod: string) =>
      `Wprowadź magiczny kod wysłany na ${contactMethod}, aby dodać pilota. Kod powinien dotrzeć w ciągu minuty lub dwóch.`,
    enterMagicCodeUpdate: (contactMethod: string) =>
      `Wprowadź magiczny kod wysłany na ${contactMethod}, aby zaktualizować swojego copilota.`,
  ...
  debug: {
    ...
    missingProperty: ({ propertyName }: MissingPropertyParams) =>
      `Brak pola ${propertyName}`,
    invalidProperty: ({ propertyName, expectedType }: InvalidPropertyParams) =>
      `Nieprawidłowa właściwość: ${propertyName} – Oczekiwano: ${expectedType}`,
    invalidValue: ({ expectedValues }: InvalidValueParams) =>
      `Nieprawidłowa wartość – oczekiwano: ${expectedValues}`,
    ...
    reasonVisibleInLHN: {
      ...
      hasAddWorkspaceRoomErrors:
        "Zawiera błędy dodawania pokoju przestrzeni roboczej",
    ...
    reasonGBR: {
      ...
      isWaitingForAssigneeToCompleteAction:
        "Oczekuje, aż osoba przypisana wykona działanie",
      hasChildReportAwaitingAction:
        "Posiada raport podrzędny oczekujący na działanie",
      hasMissingInvoiceBankAccount: "Brakujący rachunek bankowy faktury",
      hasUnresolvedCardFraudAlert:
        "Ma nierozwiązaną blokadę oszustwa na karcie",
    ...
    indicatorStatus: {
      ...
      theresAWorkspaceWithCustomUnitsErrors:
        "Istnieje przestrzeń robocza z błędami niestandardowych jednostek",
      theresAProblemWithAWorkspaceMember:
        "Wystąpił problem z członkiem przestrzeni roboczej",
      theresAProblemWithAWorkspaceQBOExport:
        "Wystąpił problem z ustawieniem eksportu połączenia przestrzeni roboczej.",
      ...
      theresAProblemWithYourReimbursementAccount:
        "Wystąpił problem z Twoim kontem zwrotów",
      theresABillingProblemWithYourSubscription:
        "Wystąpił problem z rozliczeniem Twojej subskrypcji",
      yourSubscriptionHasBeenSuccessfullyRenewed:
        "Twoja subskrypcja została pomyślnie odnowiona",
      theresWasAProblemDuringAWorkspaceConnectionSync:
        "Wystąpił problem podczas synchronizacji połączenia przestrzeni roboczej",
      theresAProblemWithYourWallet: "Wystąpił problem z Twoim portfelem",
      theresAProblemWithYourWalletTerms:
        "Wystąpił problem z warunkami Twojego portfela",
    },
  },
  emptySearchView: {
  ...
  migratedUserWelcomeModal: {
    ...
    subtitle:
      "Zawiera wszystko, co lubisz w naszym klasycznym doświadczeniu, plus całą masę ulepszeń, które jeszcze bardziej ułatwią Ci życie:",
    confirmText: "Ruszajmy!",
    helpText: "Wypróbuj 2‑minutowe demo",
    features: {
      search:
        "Potężniejsze wyszukiwanie w aplikacji mobilnej, w przeglądarce i na komputerze",
      concierge:
        "Wbudowana Concierge AI, która pomaga zautomatyzować Twoje wydatki",
  ...
  productTrainingTooltip: {
    ...
    saveSearchTooltip:
      "<tooltip><strong>Zmień nazwę zapisanych wyszukiwań</strong> tutaj!</tooltip>",
    accountSwitcher:
      "<tooltip>Uzyskaj tutaj dostęp do <strong>kont Copilot</strong></tooltip>",
    scanTestTooltip: {
      main: "<tooltip><strong>Zeskanuj nasz przykładowy paragon</strong>, aby zobaczyć, jak to działa!</tooltip>",
      manager:
        "<tooltip>Wybierz naszego <strong>menedżera testów</strong>, aby go wypróbować!</tooltip>",
      confirmation:
        "<tooltip>Teraz <strong>wyślij swój wydatek</strong> i zobacz, jak dzieje się magia!</tooltip>",
      tryItOut: "Wypróbuj to",
    },
    outstandingFilter:
      "<tooltip>Filtruj wydatki,\nktóre <strong>wymagają zatwierdzenia</strong></tooltip>",
    scanTestDriveTooltip:
      "<tooltip>Wyślij ten paragon, aby\n<strong>zakończyć jazdę próbną!</strong></tooltip>",
    gpsTooltip:
      "<tooltip>Śledzenie GPS w toku! Gdy skończysz, zatrzymaj śledzenie poniżej.</tooltip>",
    hasFilterNegation:
      "<tooltip>Wyszukaj wydatki bez paragonów za pomocą <strong>-has:receipt</strong>.</tooltip>",
  },
  ...
  scheduledCall: {
    book: {
      ...
      slots: ({ date }: { date: string }) =>
        `<muted-text>Dostępne godziny na <strong>${date}</strong></muted-text>`,
    },
    confirmation: {
      title: "Potwierdź połączenie",
      description:
        "Upewnij się, że poniższe szczegóły wyglądają dla Ciebie w porządku. Po potwierdzeniu rozmowy wyślemy zaproszenie z dodatkowymi informacjami.",
  ...
  autoSubmitModal: {
    ...
    submittedExpensesDescription:
      "Te wydatki zostały wysłane do osoby zatwierdzającej, ale nadal można je edytować, dopóki nie zostaną zatwierdzone.",
    pendingExpensesTitle: "Nierozliczone wydatki zostały przeniesione",
    pendingExpensesDescription:
      "Wszystkie oczekujące wydatki z karty zostały przeniesione do osobnego raportu, dopóki nie zostaną zaksięgowane.",
  },
  testDrive: {
    quickAction: {
    ...
    modal: {
      ...
      description:
        "Zrób krótkie wprowadzenie do produktu, aby szybko się wdrożyć.",
      ...
      employee: {
        ...
        error:
          "Ten członek jest właścicielem przestrzeni roboczej, wprowadź nowego członka do przetestowania.",
      },
    },
    banner: {
    ...
    employeeInviteMessage: (
      name: string,
    ) => `# ${name} zaprosił(a) Cię do wypróbowania Expensify
...
Oto *paragon testowy*, żeby pokazać Ci, jak to działa:`,
  ...
  domain: {
    ...
    verifyDomain: {
      ...
      accessYourDNS: ({ domainName }: { domainName: string }) =>
        `Przejdź do swojego dostawcy DNS i otwórz ustawienia DNS dla <strong>${domainName}</strong>.`,
      ...
      warning:
        "Po weryfikacji wszyscy członkowie Expensify w Twojej domenie otrzymają e-mail z informacją, że ich konto będzie zarządzane w ramach Twojej domeny.",
      codeFetchError: "Nie udało się pobrać kodu weryfikacyjnego",
      genericError:
        "Nie udało się zweryfikować Twojej domeny. Spróbuj ponownie i skontaktuj się z Concierge, jeśli problem będzie się powtarzał.",
    },
    domainVerified: {
    ...
    samlLogin: {
      ...
      anyMemberWillBeRequired:
        "Każda osoba należąca do zespołu, która jest zalogowana inną metodą, będzie musiała ponownie się uwierzytelnić za pomocą SAML.",
      ...
      requireWithEmptyMetadataError:
        "Dodaj poniżej metadane dostawcy tożsamości, aby włączyć",
    ...
    accessRestricted: {
      ...
      subtitle: (domainName: string) =>
        `Zwierzyń się proszę jako upoważniony administrator firmy dla <strong>${domainName}</strong>, jeśli potrzebujesz kontroli nad:`,
    ...
    addDomain: {
      title: "Dodaj domenę",
      subtitle:
        "Wprowadź nazwę prywatnej domeny, do której chcesz uzyskać dostęp (np. expensify.com).",
    ...
    domainAdded: {
      title: "Dodano domenę",
      description:
        "Następnie musisz potwierdzić własność domeny i dostosować ustawienia zabezpieczeń.",
      configure: "Skonfiguruj",
    },
    enhancedSecurity: {
      title: "Zwiększone bezpieczeństwo",
      subtitle:
        "Wymagaj od członków swojej domeny logowania za pomocą logowania jednokrotnego (SSO), ograniczaj tworzenie przestrzeni roboczych i nie tylko.",
      enable: "Włącz",
    },
    ...
    admins: {
      ...
      setPrimaryContactError:
        "Nie można ustawić głównego kontaktu. Spróbuj ponownie później.",
      ...
      consolidatedDomainBillingError:
        "Nie można było zmienić zbiorczego rozliczania domeny. Spróbuj ponownie później.",
      addAdmin: "Dodaj administratora",
      addAdminError:
        "Nie można dodać tego członka jako administratora. Spróbuj ponownie.",
      revokeAdminAccess: "Wycofaj dostęp administratora",
      cantRevokeAdminAccess:
        "Nie można odebrać dostępu administratora osobie kontaktowej ds. technicznych",
      error: {
        removeAdmin:
          "Nie można usunąć tego użytkownika jako administratora. Spróbuj ponownie.",
      ...
      resetDomainExplanation: ({ domainName }: { domainName?: string }) =>
        `Wpisz proszę <strong>${domainName}</strong>, aby potwierdzić reset domeny.`,
    ...
    members: {
      ...
      closeAccountInfo: () => ({
        one: "Zalecamy bezpieczne zamknięcie konta, aby pominąć jego zamykanie w przypadku, gdy występują: <bullet-list><bullet-item>Oczekujące zatwierdzenia</bullet-item><bullet-item>Aktywne zwroty kosztów</bullet-item><bullet-item>Brak alternatywnych metod logowania</bullet-item></bullet-list>W przeciwnym razie możesz zignorować powyższe środki ostrożności i wymusić zamknięcie wybranego konta.",
        other:
          "Zalecamy bezpieczne zamknięcie kont, aby pominąć ich zamykanie w przypadku, gdy występują: <bullet-list><bullet-item>Oczekujące zatwierdzenia</bullet-item><bullet-item>Aktywne zwroty kosztów</bullet-item><bullet-item>Brak alternatywnych metod logowania</bullet-item></bullet-list>W przeciwnym razie możesz zignorować powyższe środki ostrożności i wymusić zamknięcie wybranych kont.",
      }),
      error: {
        removeMember: "Nie można usunąć tego użytkownika. Spróbuj ponownie.",
        addMember: "Nie można dodać tego członka. Spróbuj ponownie.",
        vacationDelegate:
          "Nie można ustawić tego użytkownika jako zastępującego na czas nieobecności. Spróbuj ponownie.",
      },
      cannotSetVacationDelegateForMember: (email: string) =>
        `Nie możesz ustawić zastępstwa urlopowego dla ${email}, ponieważ jest on/ona obecnie zastępcą dla następujących członków:`,
    ...
    common: {
      ...
      forceTwoFactorAuthError:
        "Nie udało się zmienić wymuszania uwierzytelniania dwuskładnikowego. Spróbuj ponownie później.",
  ...
  proactiveAppReview: {
    ...
    description:
      "Daj nam znać, abyśmy mogli pomóc uczynić Twoje rozliczanie wydatków jeszcze lepszym.",
    positiveButton: "Tak!",
