    ...
    iou: {
        homeAddressRequired: {
            ...
            prompt: ({workspaceName}: {workspaceName: string}) =>
                workspaceName
                    ? `Zanim zaczniesz śledzić przejechany dystans, dodaj swój adres domowy do prywatnego profilu. ${workspaceName} używa tego adresu do odliczeń za dojazdy do pracy.`
                    : 'Zanim zaczniesz śledzić dystans, musisz dodać swój adres domowy do prywatnego profilu. To miejsce pracy używa tego adresu do odliczeń za dojazdy.',
...
${amount} dla ${merchant} - ${date}`,
    ...
    privatePersonalDetails: {
        ...
        commuterExclusionsHint: ({workspaceName}: {workspaceName: string}) => `${workspaceName} używa tego adresu do wykluczeń dojazdów.`,
        error: {
...
Plan Control zaczyna się od 9 USD za aktywnego członka miesięcznie.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                summaryHomeAndOffice: 'Używaj lokalizacji domu i biura',
                ...
                errors: {distanceMustBePositive: 'Dystans musi być dodatnią liczbą całkowitą.', invalidAddress: 'Wpisz poprawny adres', distanceTooLarge: 'Odległość jest zbyt duża.'},
            },
            distance: 'Dystans',
