...
Oto *paragon testowy*, żeby pokazać Ci, jak to działa:`,
    ...
    domain: {
        ...
        members: {
            ...
            cannotSetVacationDelegateForMember: (email: string) => `Nie możesz ustawić zastępcy urlopowego dla ${email}, ponieważ jest on obecnie zastępcą dla następujących członków:`,
        },
