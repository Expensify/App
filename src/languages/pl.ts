...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                fireworksTitle: '[pl] All caught up',
                fireworksDescription: '[pl] Upcoming to-dos will appear here.',
            },
        },
    ...
    iou: {
        ...
        error: {
            ...
            nonReimbursablePayment: '[pl] Cannot pay via Expensify',
            nonReimbursablePaymentDescription: (isMultiple?: boolean) =>
                isMultiple
                    ? "[pl] One or more selected reports don't have reimbursable expenses. Double check the expenses, or manually mark as paid."
                    : "[pl] The report doesn't have reimbursable expenses. Double check the expenses, or manually mark as paid.",
        },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        emptyWorkspace: {
            title: '[pl] You have no workspaces',
            subtitle: '[pl] Track receipts, reimburse expenses, manage travel, send invoices, and more.',
