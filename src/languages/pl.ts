...
${amount} dla ${merchant} - ${date}`,
    ...
    expenseRulesPage: {
        ...
        changes: {
            updateBillable: (value: boolean) => `Zaktualizuj wydatek ${value ? 'Fakturowalne' : 'niefakturowalne'}`,
            updateCategory: (value: string) => `Zaktualizuj kategorię na „${value}”`,
            updateComment: (value: string) => `Zmień opis na „${value}”`,
            updateMerchant: (value: string) => `Zaktualizuj sprzedawcę na „${value}”`,
            updateReimbursable: (value: boolean) => `Zaktualizuj wydatek ${value ? 'podlegający zwrotowi' : 'niepodlegający zwrotowi'}`,
            updateTag: (value: string) => `Zaktualizuj znacznik na „${value}”`,
            updateTax: (value: string) => `Zaktualizuj stawkę podatku na ${value}`,
