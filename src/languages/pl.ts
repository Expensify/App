...
${amount} dla ${merchant} - ${date}`,
    ...
    privatePersonalDetails: {
        ...
        commuterExclusionsNote: ({workspaceName}: {workspaceName: string}) => `${workspaceName} używa tego adresu do wykluczeń dojazdów.`,
        error: {
...
3. Gdy kanał zostanie włączony, kliknij poniżej Wyślij i zajmiemy się jego dodaniem.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: 'Odejmij od każdego roszczenia o dystans dojazd każdego członka między jego domem a adresem przestrzeni roboczej.',
                workspaceAddressRequired: {
                    title: 'Hej, nie tak szybko...',
                    prompt: 'Ta przestrzeń robocza nie ma jeszcze adresu. Dodaj go, aby wykluczenia dojazdów mogły z niego korzystać.',
                    cta: 'Dodaj adres',
                },
                errors: {
