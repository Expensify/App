        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    ...
                    officeBasedTitle: 'Pracujący w biurze',
                    officeBasedHelp: 'Członek dojeżdża do biura. Zwykłe dojazdy nie podlegają zwrotowi kosztów.',
                    noRegularWorkplaceTitle: 'Brak stałego miejsca pracy',
                    noRegularWorkplaceHelp: 'Członek pracuje zdalnie lub nie ma stałego miejsca pracy, więc zasady dotyczące dojazdów z domu do pracy nie mają zastosowania.',
                    startingPrompt: {
