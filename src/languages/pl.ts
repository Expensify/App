...
const translations = {
    ...
    cardPage: {
        ...
        missingPrivateDetails: ({profileSettingsLink}: {profileSettingsLink: string}) => `Dodaj swoje dane osobowe w <a href="${profileSettingsLink}">Konto > Profil > Prywatne</a>, a następnie spróbuj ponownie.`,
