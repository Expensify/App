...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        error: {
            ...
            reportsNotSubmittedTitle: 'Prześlij raporty',
            reportsNotMarkedAsDoneTitle: 'Oznacz raporty jako wykonane',
            reportsNotSubmittedDescription: 'Nie udało się przesłać tych raportów. Sprawdź, czy żadne wydatki nie są wstrzymane ani w toku, a następnie spróbuj ponownie.',
            reportsNotMarkedAsDoneDescription: 'Nie udało się oznaczyć tych raportów jako wykonanych. Sprawdź, czy żadne wydatki nie są wstrzymane ani w toku, a następnie spróbuj ponownie.',
