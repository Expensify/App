...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. Użyj przycisku ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE}, aby wysłać fakturę.`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `. Po prostu użyj przycisku ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE}.`,
