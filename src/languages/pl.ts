...
${amount} dla ${merchant} - ${date}`,
        ...
        cardUnblockedDescription: 'Przy następnej płatności możesz zostać poproszony o włożenie karty do terminala.',
        pinBlocked: 'Twoja karta została zablokowana z powodu błędnego wprowadzenia PIN-u.',
        unblock: 'Odblokuj',
