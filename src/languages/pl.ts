...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        setPin: {
            didNotShipCard: 'Nie wysłaliśmy Twojej karty. Spróbuj ponownie.',
        },
    },
    validateCodeModal: {
...
${amount} dla ${merchant} - ${date}`,
        ...
        reenterPinToConfirm: 'Wprowadź ponownie PIN, aby potwierdzić.',
        pinMustBeFourDigits: 'PIN musi mieć dokładnie 4 cyfry.',
        invalidPin: 'Wybierz bezpieczniejszy PIN.',
        pinMismatch: 'Kody PIN nie pasują do siebie. Spróbuj ponownie.',
        revealPin: 'Pokaż PIN',
        hidePin: 'Ukryj PIN',
        pin: 'PIN',
