...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        movedFromPersonalSpace: (workspaceName?: string, reportName?: string) => `przeniesiono wydatek z przestrzeni osobistej do ${workspaceName ?? `czat z ${reportName}`}`,
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                updateRole: (email: string, newRole: string, currentRole: string) => `zaktualizowano rolę użytkownika ${email} na ${newRole} (wcześniej ${currentRole})`,
