...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
        ...
        recruiting: {
            ...
            approvalModeWarningTitle: 'Zmienić tryb zatwierdzania?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `Czy na pewno chcesz zmienić tryb zatwierdzania dla tego workspace? Dowiedz się więcej o różnych trybach workflow obsługiwanych przez ${providerName} na naszej <a href="${helpSiteURL}">stronie pomocy</a>.`,
            approvalModeWarningConfirm: 'Zmień tryb zatwierdzania',
        },
        merge: {
