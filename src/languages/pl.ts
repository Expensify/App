...
_Aby uzyskać bardziej szczegółowe instrukcje, [odwiedź naszą stronę pomocy](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addWorkEmailDescription: 'Dodaj swój służbowy e-mail i ustaw go jako główną metodę kontaktu, aby korzystać z istniejących kanałów z innych przestrzeni roboczych.',
            error: {
