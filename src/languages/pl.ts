...
const translations = {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            kill: 'Zabić',
            biometrics: {
                biometricsRegistered: 'Biometria (zarejestrowana)',
                biometricsNotRegistered: 'Biometria (niezarejestrowana)',
                test: 'Test',
                softPromptTitle: 'Weryfikuj transakcje za pomocą twarzy lub odcisku palca',
                softPromptContent: 'Włącz szybką i bezpieczną weryfikację za pomocą twarzy lub odcisku palca — bez haseł ani kodów.',
                notificationTitle: 'Uwierzytelnianie zakończone pomyślnie',
                notificationContent: 'Uwierzytelniono pomyślnie za pomocą Face ID',
                biometricsTest: 'Test biometryczny',
                errorPageTitle: 'Ups, coś poszło nie tak',
                errorPageContent: 'Nie można zarejestrować urządzenia.',
            },
        },
        debugConsole: {
            saveLog: 'Zapisz log',
