        ...
        recruiting: {
            ...
            filters: {
                ...
                stages: {
                    ...
                    toggleTitle: 'Etapy zadania importu',
                    allSelected: 'Wszystkie etapy pracy',
                    emptySelectionError: 'Wybierz co najmniej jeden etap pracy',
                },
                tags: {
                    title: 'Tag',
                    description: 'Wybierz tagi kandydatów, które chcesz zsynchronizować z tym obszarem roboczym',
                    toggleTitle: 'Importuj tagi',
                    allSelected: 'Wszystkie tagi',
                    emptySelectionError: 'Wybierz co najmniej jeden znacznik',
                },
                offices: {
                    title: 'Biuro',
                    description: 'Wybierz biura kandydatów, które chcesz zsynchronizować z tym miejscem pracy',
                    toggleTitle: 'Importuj biura (opcjonalnie)',
                    allSelected: 'Wszystkie biura',
                },
            },
