...
const translations = {
    ...
    contacts: {
        ...
        helpTextBeforeEmail: 'Dodaj więcej sposobów logowania się i wysyłania paragonów do Expensify.\n\nDodaj adres e-mail, aby przesyłać paragony do ',
        helpTextAfterEmail: 'lub dodaj numer telefonu, aby wysyłać paragony SMS-em na 47777 (tylko numery z USA).',
        primary: 'Podstawowy',
        secondary: 'Dodatkowy',
