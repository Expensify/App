...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        gettingStartedSection: {
            ...
            linkPersonalCardSubText: 'Automatycznie importuj wydatki',
    ...
    personalCard: {
        ...
        conciergeBrokenConnection30Days: (cardName: string, connectionLink?: string) =>
            connectionLink
                ? `Połączenie Twojej karty ${cardName} jest przerwane od 30 dni. <a href="${connectionLink}">Zaloguj się do swojego banku</a>, aby je naprawić, lub <a href="${connectionLink}">usuń kartę</a>, jeśli nie jest już używana. Nie stracisz żadnych przesłanych wydatków, jeśli ją usuniesz.`
                : `Połączenie Twojej karty ${cardName} jest przerwane od 30 dni. Zaloguj się do swojego banku, aby je naprawić, lub usuń kartę, jeśli nie jest już używana. Nie stracisz żadnych przesłanych wydatków, jeśli ją usuniesz.`,
...
${amount} dla ${merchant} - ${date}`,
    ...
    workspace: {
        common: {
            ...
            exportIntegrationSelected: (connectionName: ConnectionName) => `Eksportuj do ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
            letsDoubleCheck: 'Sprawdźmy jeszcze raz, czy wszystko wygląda poprawnie.',
...
Jeśli chcesz przejąć rozliczenia za całą ich subskrypcję, poproś ich najpierw o dodanie Cię jako administratora do wszystkich ich przestrzeni roboczych, a dopiero potem przejmij rozliczenia.`,
        ...
        exportAgainModal: {
            ...
            ) => `Następujące raporty zostały już wyeksportowane do ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}. Na pewno chcesz wyeksportować je ponownie?
...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
            ...
            requireFieldsRule: {
                ...
                doTheFollowing: 'Wykonaj następujące:',
    ...
    search: {
        ...
        tabs: {
            ...
            violationsBySubmitter: 'Naruszenia przez osobę składającą wniosek',
        },
    },
    genericErrorPage: {
        ...
        actions: {
            type: {
                ...
                companyCardConnectionBroken30Days: ({
                    ...
                    `Połączenie ${feedName} jest przerwane od 30 dni. <a href='${workspaceCompanyCardRoute}'>Zaloguj się do swojego banku</a>, aby je naprawić, lub <a href='${workspaceCompanyCardSettingsRoute}'>usuń połączenie</a>, jeśli nie jest już używane. Nie stracisz żadnych przesłanych wydatków, jeśli je usuniesz.`,
    ...
    violations: {
        ...
        shortName: {
            ...
            billableExpense: 'Element fakturowany już nieaktualny',
            ...
            conversionSurcharge: 'Zastosowano dopłatę za przewalutowanie',
            customUnitOutOfPolicy: 'Stawka nie jest prawidłowa dla tego workspace’a',
            customUnitRateOutOfDateRange: 'Stawka poza obowiązującymi datami',
            duplicatedTransaction: 'Potencjalny duplikat',
            fieldRequired: 'Pole raportu jest wymagane',
            futureDate: 'Data z przyszłości jest niedozwolona',
            hold: 'Wydatek wstrzymany',
            inactiveVendor: 'Dostawca już nie jest ważny',
            increasedDistance: 'Dystans przekracza trasę',
            invoiceMarkup: 'Faktura oznaczona',
            itemizedReceiptRequired: 'Wymagany paragon z wyszczególnieniem pozycji',
            maxAge: 'Wydatek zbyt stary',
            missingAttendees: 'Wymagani uczestnicy',
            missingCategory: 'Brak kategorii',
            missingComment: 'Opis wymagany',
            missingTag: 'Brakujący tag',
            modifiedAmount: 'Kwota zmieniona',
            modifiedDate: 'Data modyfikacji',
            noRoute: 'Brak poprawnej trasy',
            nonExpensiworksExpense: 'Wydatek spoza Expensiworks',
            overAutoApprovalLimit: 'Powyżej limitu automatycznej akceptacji',
            overCategoryLimit: 'Poza limitem kategorii',
            overLimit: 'Poza limitem',
            overTripLimit: 'Przekroczono limit podróży',
            perDayLimit: 'Przekroczono dzienny limit',
            ...
            someTagLevelsRequired: 'Tag jest wymagany',
            tagOutOfPolicy: 'Tag jest już nieważny',
            overLimitAttendee: 'Przekroczono limit osób',
            customRules: 'Naruszenie niestandardowej reguły',
            taxAmountChanged: 'Kwota podatku zmodyfikowana',
            taxOutOfPolicy: 'Stawka podatku nie jest już ważna',
            taxRateChanged: 'Zmieniono stawkę podatku',
            taxRequired: 'Brak stawki podatku',
        },
    },
    reportViolations: {
