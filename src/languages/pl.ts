...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        fixBankAccount: {
            ...
            insufficientFundsBody: 'Transakcje testowe nie powiodły się z powodu braku środków. Gdy środki będą dostępne, użyj przycisku poniżej.',
...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
    ...
    debug: {
        ...
        indicatorStatus: {
            ...
            aBankAccountFailedValidation: 'Konto bankowe nie przeszło weryfikacji',
        },
    },
    emptySearchView: {
