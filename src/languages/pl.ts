...
Oto *paragon testowy*, żeby pokazać Ci, jak to działa:`,
    ...
    domain: {
        ...
        groups: {
            ...
            RestrictExpenseWorkspaceCreation: 'Ogranicz tworzenie/usuwanie obszarów roboczych wydatków',
            RestrictExpenseWorkspaceCreationDescription: 'Uniemożliwia członkom tworzenie obszaru roboczego wydatków lub usuwanie się z obszaru roboczego wydatków.',
            RestrictDefaultLoginSelection: 'Ogranicz wybór domyślnego loginu',
            RestrictDefaultLoginSelectionDescription: 'Uniemożliwia członkom zmianę adresu e-mail logowania z domeny firmowej.',
            StrictlyEnforceWorkspaceRules: 'Ściśle egzekwuj reguły obszaru roboczego',
            StrictlyEnforceWorkspaceRulesDescription: 'Wszystkie reguły obszaru roboczego muszą być spełnione przed przesłaniem raportu. Nie dozwolone są wyjątki ręczne.',
            ...
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `Czy na pewno chcesz ustawić ${newName} jako grupę domyślną? Nowi członkowie zostaną zaproszeni do tej grupy zamiast poprzedniej grupy domyślnej (${currentName}). `,
