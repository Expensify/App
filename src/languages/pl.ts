...
${amount} dla ${merchant} - ${date}`,
    ...
    onboarding: {
        ...
        peopleYouMayKnow: 'Sprawdź, czy twój zespół już tu jest',
        workspaceYouMayJoin: (domain: string, email: string) =>
            `Zweryfikuj swój e‑mail, żeby sprawdzić, czy ktoś z ${domain} ma workspace, do którego możesz dołączyć. Wpisz magiczny kod wysłany na adres ${email}.`,
