...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    deviceManagementPage: {
        ...
        description: '[pl] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[pl] Revoke',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        people: {
            ...
            configureGustoSync: '[pl] Configure Gusto sync.',
            syncWithGusto: '[pl] Sync with Gusto',
            ...
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    ...
                    case 'mergeHRSyncTitle':
                        return '[pl] Synchronizing HR Employees';
                    case 'jobDone':
                        return '[pl] Waiting for imported data to load';
                    default: {
                        return `[pl] Translation missing for stage: ${stage}`;
...
Add more spend rules to protect company cash flow.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateName: (customUnitName: string, oldValue: string, newValue: string) => `[pl] renamed the ${customUnitName} rate "${oldValue}" to "${newValue}"`,
