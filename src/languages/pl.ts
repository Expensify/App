...
Dodaj więcej zasad wydatków, żeby chronić płynność finansową firmy.`,
        ...
        campfire: {
            ...
            exportDescription: 'Skonfiguruj sposób eksportowania danych Expensify do Campfire.',
            exportReimbursable: {label: 'Eksportuj wydatki podlegające zwrotowi jako', values: {label: 'Rachunki od dostawców'}},
            exportDate: {
            ...
            exportNonReimbursable: {label: 'Wyeksportuj wydatki z firmowej karty jako', values: {label: 'Zapisy w dzienniku'}},
            defaultCompanyCardVendor: {
                label: 'Domyślny dostawca dla wszystkich firmowych kart',
                description: 'Wybierz domyślnego dostawcę Campfire dla wydatków, które nie dopasują się automatycznie.',
            },
            companyCardAccount: {label: 'Konto karty firmowej', description: 'Wybierz, dokąd eksportować transakcje z firmowych kart.'},
            noVendorsFound: 'Nie znaleziono dostawców',
            noVendorsFoundDescription: 'Dodaj proszę dostawców w Campfire i zsynchronizuj połączenie ponownie',
            noAccountsFound: 'Nie znaleziono kont',
            noAccountsFoundDescription: 'Dodaj konta w Campfire i ponownie zsynchronizuj połączenie',
        },
        businessCentral: {
