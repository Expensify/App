...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        calendarOpened: '[pl] calendar opened',
        send: '[pl] Send',
        na: '[pl] N/A',
...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        plusMore: ({count}: {count: number}) => `[pl] +${count} more`,
    ...
    multifactorAuthentication: {
        ...
        revealCardDetail: {
            couldNotReveal: "[pl] We couldn't reveal your card details. Please try again.",
        },
    },
    validateCodeModal: {
    ...
    readOnlyConversation: '[pl] This conversation is read-only.',
    reportAction: {
        asCopilot: '[pl] as copilot for',
        assistedBy: (agentName: string) => `[pl] assisted by ${agentName}`,
        humanSupportAgent: '[pl] a human support agent',
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            unlockBankAccount: {
                workspaceTitle: '[pl] Your business bank account has been locked',
                personalTitle: '[pl] Your bank account has been locked',
                workspaceSubtitle: ({policyName}: {policyName: string}) => policyName,
                personalSubtitle: '[pl] Wallet',
            },
        },
        freeTrialSection: {
        ...
        yourSpend: {
            title: '[pl] Your spend',
            awaitingApproval: '[pl] Awaiting approval',
            repaidLast30Days: '[pl] Repaid in the last 30 days',
            recentTransactions: ({lastFour}: {lastFour: string}) => `[pl] Recent transactions • ${lastFour}`,
        },
        seeMore: ({count}: {count: number}) => `[pl] See ${count} more`,
        ...
        gettingStartedSection: {
            ...
            inviteAccountant: '[pl] Invite your accountant',
    ...
    spreadsheet: {
        ...
        importCompanyCardTransactionsPendingMessage: '[pl] New cards and transactions may take some time to appear, please hang tight.',
    ...
    iou: {
        ...
        movedFromReport: (reportName: string) => `[pl] moved an expense from ${reportName}`,
        movedFromReportNoName: '[pl] moved an expense',
        movedTransactionTo: (reportUrl: string, reportName: string) => `[pl] moved this expense to <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionToAnotherReport: '[pl] moved this expense to another report',
        movedTransactionFrom: (reportUrl: string, reportName: string) => `[pl] moved this expense from <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionFromAnotherReport: '[pl] moved this expense from another report',
        ...
        allTransactionsPendingNextStep: "[pl] All transactions are pending. You can't submit this report until they post in a few days.",
        ...
        confirmPaymentReceivedModalTitle: '[pl] Confirm payment received',
        receivedPayment: '[pl] Received payment',
        receivedPaymentConfirmation: "[pl] Please proceed only if you've already received payment outside of Expensify.",
        confirmReceivedPayment: "[pl] Yes, I've received payment",
        ...
        updatedTheRequest: (valueName: string, newValueToDisplay: string, oldValueToDisplay: string) => `[pl] the ${valueName} to ${newValueToDisplay} (previously ${oldValueToDisplay})`,
        ...
        error: {
            ...
            invalidReadings: '[pl] Please enter both start & end readings to continue',
            ...
            unableToSubmitReport: '[pl] Unable to submit report',
            allTransactionsPendingDescription: "[pl] You can't submit this report because all transactions are pending. They may take a few days to post.",
            failedToSaveOdometerDraft: "[pl] Couldn't save your odometer draft. Please try again.",
            ...
            receiptUploadFailedMessage: '[pl] Receipt upload failed. Save the receipt, or delete the expense and lose it.',
            saveReceipt: '[pl] Save receipt',
        ...
        addExistingExpense: '[pl] Add existing expense',
        selectExistingExpense: '[pl] Select at least one expense to add to the report.',
        emptyStateExistingExpenseTitle: '[pl] No existing expenses',
        emptyStateExistingExpenseSubtitle: '[pl] Looks like you don’t have any existing expenses. Try creating one below.',
        addExistingExpenseConfirm: '[pl] Add to report',
        ...
        changeApprover: {
            ...
            reassignedApproverMessage: (managerID: number) => `[pl] reassigned the approver to <mention-user accountID="${managerID}"/> via a workflow update`,
            actions: {
        ...
        bulkDuplicateLimit: `[pl] You can duplicate up to ${CONST.SEARCH.BULK_DUPLICATE_LIMIT} expenses at a time. Please select fewer expenses and try again.`,
        taxDisabledAlert: {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            showBranchNameInTitle: '[pl] Show branch name in browser title',
        ...
        help: '[pl] Help',
        helpPage: {
            title: '[pl] Got questions?',
            description: "[pl] We're here to help, around the clock.",
    ...
    deviceManagementPage: {
        title: '[pl] Device management',
        description:
            '[pl] Manage all the devices that you have logged into with your Expensify Account. <a href="https://help.expensify.com/articles/new-expensify/settings/Manage-Logged-in-Devices">Learn more</a>.',
        revoke: '[pl] Revoke',
        unknownDevice: '[pl] Unknown Device',
    },
    twoFactorAuth: {
        ...
        `),
        screenshotTip: '[pl] Tip: Screenshot this to save it to your photo library',
    ...
    walletPage: {
        ...
        cardActive: '[pl] Active',
        bankAccountStatus: {
            active: '[pl] Active',
            incomplete: '[pl] Incomplete',
            pending: '[pl] Pending',
            verifying: '[pl] Verifying',
            locked: '[pl] Locked',
            incompleteDescription: '[pl] Finish adding bank account',
            pendingDescription: '[pl] Please confirm test transactions',
            verifyingDescription: "[pl] We're reviewing your documentation",
            lockedDescription: '[pl] This account requires attention',
            finish: '[pl] Finish',
            confirm: '[pl] Confirm',
            unlock: '[pl] Unlock',
        },
        cardFixConnection: '[pl] Please fix this connection',
        cardAskAdminToFix: '[pl] Please ask an admin to fix this connection',
        cardAdminFixConnection: '[pl] Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `[pl] Last synced ${dateStr}`,
        assignedCards: '[pl] Cards',
        assignedCardsDescription: '[pl] Transactions from assigned cards sync automatically.',
    ...
    cardPage: {
        ...
        spendRules: '[pl] Spend rules',
        editSpendRules: '[pl] Edit spend rules',
        reviewTransaction: '[pl] Review transaction',
...
${amount} for ${merchant} - ${date}`,
        ...
        cardUnblocked: '[pl] Card unblocked!',
        cardUnblockedDescription: '[pl] You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: '[pl] Your card was blocked due to incorrect PIN entries.',
        unblock: '[pl] Unblock',
        unblockCard: '[pl] Unblock card',
    ...
    workflowsPage: {
        ...
        configureViaHR: ({provider}: {provider: string}) => `[pl] Configure via ${provider}.`,
        hrApprovalWorkflowLockedPrompt: ({provider}: {provider: string}) =>
            `[pl] Approvals are managed by your ${provider} integration. To update your approval workflow, head to your ${provider} connection settings.`,
        goToHRSettings: ({provider}: {provider: string}) => `[pl] Go to ${provider} settings`,
    ...
    workflowsExpensesFromPage: {
        ...
        memberAlreadyInWorkflowTitle: '[pl] Member already in a workflow',
        memberAlreadyInWorkflowPrompt: ({memberName, approverName}: {memberName: string; approverName: string}) =>
            `[pl] ${memberName} is already in an approval workflow that submits to ${approverName}. Adding them here will move them to this workflow.`,
    },
    ...
    reportFraudConfirmationPage: {
        ...
        descriptionCardNotReplaced: '[pl] Your card was permanently deactivated. Please contact an admin to issue a new card.',
    ...
    agentsPage: {
        title: '[pl] Agents',
        subtitle: '[pl] Create agents to handle your workflow. Skip the manual work and get hours back in your day.',
        newAgent: '[pl] New agent',
        emptyAgents: {
            title: '[pl] No agents created',
            subtitle: '[pl] Stop manually doing stuff. Instruct an agent instead and save yourself lots of time.',
        },
        error: {
            genericAdd: '[pl] There was a problem adding this agent',
            genericUpdate: '[pl] There was a problem updating this agent',
            updateName: "[pl] There was a problem updating this agent's name",
            updatePrompt: "[pl] There was a problem updating this agent's instructions",
            updateAvatar: "[pl] There was a problem updating this agent's avatar",
        },
    },
    addAgentPage: {
        title: '[pl] New agent',
        agentName: '[pl] Agent name',
        instructions: '[pl] Write custom instructions',
        createAgent: '[pl] Create agent',
        editAvatar: '[pl] Edit avatar',
        defaultAgentName: (displayName: string) => `[pl] ${displayName}'s Agent`,
        defaultPrompt:
            "[pl] Reject expenses that are for gambling, movies, or other obvious non-business reasons.\n\nRemind the user to always include a receipt image that makes the tip clear.\n\nApprove the report if it's very similar to previous reports from the same user.\n\nReject reports with more than $500 in travel expenses.",
    },
    editAgentPage: {
        title: '[pl] Edit agent',
        agentName: '[pl] Agent name',
        instructions: '[pl] Write custom instructions',
        deleteAgent: '[pl] Delete agent',
        deleteAgentTitle: '[pl] Delete agent?',
        deleteAgentMessage: '[pl] Are you sure you want to delete this agent? This action cannot be undone.',
    },
    editAgentAvatarPage: {
        title: '[pl] Edit avatar',
    },
    editAgentNamePage: {
        title: '[pl] Agent name',
    },
    editAgentPromptPage: {
        title: '[pl] Write custom instructions',
        error: {
            emptyPrompt: '[pl] Please enter instructions for your agent.',
        },
    },
    expenseRulesPage: {
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '[pl] <strong>Avoid scams. Do not share your code with anyone.</strong> Our team will never call, text, or email you for this code.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[pl] Here's the list of workspaces you can join.",
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: '[pl] Submit expenses to my employer',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "[pl] Manage my team's expenses",
            [CONST.ONBOARDING_CHOICES.TRACK_BUSINESS]: '[pl] Track expenses for my business',
            [CONST.ONBOARDING_CHOICES.TRACK_PERSONAL]: '[pl] Organize my personal spending',
        ...
        workEmail2FAError: '[pl] This login is an existing account with Two-Factor Authentication (2FA) enabled.',
        mergeBlockScreen: {
            ...
            workAccountClosedSubtitle: '[pl] The work account associated with this email is closed. Please contact your company admin to reactivate it, or sign up with a different email.',
        },
        tasks: {
            testDriveAdminTask: {
    ...
    statusPage: {
        ...
        addVacationDelegate: '[pl] Add vacation delegate',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    addPersonalBankAccount: {
        ...
        updatePersonalInfo: '[pl] Update bank account',
        updatePersonalInfoFailure: '[pl] Unable to update bank account information. Please try again later.',
        updateSuccessTitle: '[pl] Bank account updated!',
        updateSuccessHeader: '[pl] Bank account updated',
        updateSuccessMessage: '[pl] Congrats, your bank account is set up and ready to receive reimbursements.',
    },
    ...
    messages: {
        ...
        userIsAlreadyMember: (login: string, name: string) => `[pl] ${login} is already a member of ${name}`,
        userIsAlreadyAnAdmin: (login: string, name: string) => `[pl] ${login} is already an admin of ${name}`,
    },
    onfidoStep: {
    ...
    workspace: {
        common: {
            ...
            cardAdminAlternateText: '[pl] Manage workspace cards.',
            peopleAdminAlternateText: '[pl] Manage members and approval workflows.',
            paymentsAdminAlternateText: '[pl] Manage workflow payments.',
            reimbursementChoice: {
            ...
            roleName: (role?: string) => {
                switch (role) {
                    ...
                    case CONST.POLICY.ROLE.CARD_ADMIN:
                        return '[pl] Card Admin';
                    case CONST.POLICY.ROLE.PEOPLE_ADMIN:
                        return '[pl] People Admin';
                    case CONST.POLICY.ROLE.PAYMENTS_ADMIN:
                        return '[pl] Payments Admin';
            ...
            travelInvoicing: '[pl] Export travel invoicing expenses as',
            travelInvoicingVendor: '[pl] Travel vendor',
            travelInvoicingPayableAccount: '[pl] Travel payable account',
        },
        createdForClient: {
            title: "[pl] You've created a workspace for your client!",
            description: '[pl] Great news 🎉. Reach out to us if they need any help with the setup.',
        },
        receiptPartners: {
            uber: {
        ...
        qbo: {
            ...
            bankAccountDescription: '[pl] Choose where to send checks from.',
            creditCardAccount: '[pl] Credit card account',
            travelInvoicingDescription: '[pl] Travel expenses will export as credit card charges to the QuickBooks Online account specified below.',
        ...
        xero: {
            ...
            travelInvoicingDescription: '[pl] Travel expenses will export as bank transactions to the Xero account specified below.',
        ...
        sageIntacct: {
            ...
            travelInvoicingDescription: '[pl] Travel expenses will export as credit card charges to the Sage Intacct account specified below.',
            creditCardAccount: '[pl] Credit card account',
        ...
        certinia: {
            title: '[pl] Certinia',
            prerequisites: {
                title: '[pl] Before you connect',
                installBundle: '[pl] For FFA Connections',
                installBundleDescription: ({href, version}: {href: string; version: string}) =>
                    `[pl] Install the Expensify bundle in Salesforce by clicking this link: <a href="${href}">Install FFA Expensify Bundle (Version ${version})</a>`,
                installBundleConfirm: "[pl] I've installed the bundle",
                setupContacts: '[pl] Set up user and contacts',
                setupContactsBullet1:
                    "[pl] Create both a User and a Contact for yourself if these don't already exist in Certinia making sure the email matches your primary email in Expensify.\n\n",
                setupContactsBullet2:
                    "[pl] Create contacts for each employee who will be submitting expense reports and for each report approver. Make sure each contact's email address corresponds with the email address on the employee's Expensify account.\n\n",
                setupContactsBullet3: '[pl] Set permission controls for your user for each contact/resource.\n\n',
                setupContactsConfirm: "[pl] I've set up the user and contacts",
                oauth: '[pl] Log in through Salesforce',
                oauthDescription: "[pl] To finish setup, you'll have to sign in through Salesforce and Certinia.\n\nUse the button below to continue.",
                connectButton: '[pl] Connect to Certinia',
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '[pl] Single entry for each expense',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '[pl] Single, itemized entry for each report',
                },
            },
            invoiceItem: {
                ...
                values: {
                    ...
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        ...
                        nonReimbursableDescription: dedent(`
                            ...
                            If you'd like to set a specific vendor for each card, go to *Settings > Domains > Company Cards*.
                        `),
                        travelDescription: '[pl] Travel expenses will export as journal entries to the NetSuite account specified below.',
                    },
                },
...
_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                fileImportDescription: "[pl] A manual option if your bank can't send a feed.",
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                duplicateFeedModal: {
                    title: '[pl] Card feed already connected',
                    prompt: "[pl] You can't add the same card feed to the same workspace twice.",
                },
                csvColumns: {
        ...
        expensifyCard: {
            ...
            exportAsCSV: '[pl] Export as CSV',
            csvColumnType: '[pl] Type',
            csvColumnLimitType: '[pl] Limit type',
            csvColumnLimit: '[pl] Limit',
            findCard: '[pl] Find card',
            newCard: '[pl] New card',
            name: '[pl] Name',
            lastFour: '[pl] Last 4',
            ...
            applyCashbackToBill: '[pl] Apply cash back to my Expensify bill',
            applyCashbackToBillDescription: '[pl] Cash back from the Expensify Card will be used towards payment for your Expensify bill.',
            frequency: {
                daily: '[pl] Daily',
                monthly: '[pl] Monthly',
            },
        ...
        moreFeatures: {
                ...
                travelInvoicing: {
                    ...
                    travelInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[pl] We weren't able to provision some of the members of your workspace for travel invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[pl] Travel Invoicing enabled!',
            ...
            hrWarningModal: {
                disconnectText: ({integration}: {integration: string}) => `[pl] To disable HR, please disconnect ${integration} from this workspace first.`,
            },
        ...
        copyPolicySettings: {
            error: '[pl] An error occurred while copying workspace settings. Please try again.',
            title: '[pl] Copy settings',
            selectWorkspaces: '[pl] Select workspaces',
            description: '[pl] Choose the workspaces you want to copy settings to, then select the settings you’d like to copy.',
            searchPlaceholder: '[pl] Search workspaces',
        },
        emptyWorkspace: {
        ...
        people: {
            ...
            configureHRSync: (providerName: string) => `[pl] Configure ${providerName} sync.`,
            syncWithHR: (providerName: string) => `[pl] Sync with ${providerName}`,
            allMembers: '[pl] All members',
            admins: '[pl] Admins',
            approvers: '[pl] Approvers',
            auditors: '[pl] Auditors',
            emptyRoleFilter: {
                title: '[pl] No members match this filter',
                subtitle: '[pl] Invite a member or change the filter above.',
            },
        ...
        accounting: {
            ...
            updateCredentials: '[pl] Update credentials',
            claimOffer: {
            ...
            syncTravelInvoicingSettlements: '[pl] Sync travel invoicing settlements',
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '[pl] Choose the bank account that your travel invoicing payments will be reconciled against.',
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `[pl] Make sure this account matches your travel invoicing settlement account (ending in ${lastFourPAN}) so Continuous Reconciliation works properly.`,
            },
        },
        hr: {
            title: '[pl] HR',
            connections: '[pl] Connections',
            subtitle: '[pl] Connect HR tools and keep employee approvals in sync.',
            connect: '[pl] Connect',
            syncNow: '[pl] Sync now',
            disconnect: '[pl] Disconnect',
            disconnectTitle: (providerName: string) => `[pl] Disconnect ${providerName}`,
            disconnectPrompt: (providerName: string) => `[pl] Are you sure you want to disconnect ${providerName}?`,
            alreadyConnectedTitle: '[pl] Cannot connect to multiple HR platforms',
            alreadyConnectedPrompt: '[pl] You must disconnect your current HR platform before connecting another.',
            lastSync: (relativeDate: string) => `[pl] Last synced ${relativeDate}`,
            syncError: (providerName: string) => `[pl] Can't connect to ${providerName}`,
            connectionDescription: (providerName: string) => `[pl] Connect ${providerName} to keep employee approvals in sync with your workspace.`,
            approvalMode: '[pl] Approval mode',
            providerApprovalMode: (providerName: string) => `[pl] ${providerName} approval mode`,
            finalApprover: '[pl] Final approver',
            providerFinalApprover: (providerName: string) => `[pl] ${providerName} final approver`,
            notSet: '[pl] Not set',
            syncing: '[pl] Syncing employees',
            syncingModalTitle: '[pl] Your connection is syncing',
            syncingModalDescription: "[pl] The first connection can take some time. You'll be notified of any errors.",
            approvalModeDescription: (providerName: string) => `[pl] Members and managers are set up to sync with ${providerName}.`,
            approvalModeWarningTitle: '[pl] Change approval mode?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `[pl] Are you sure you would like to change the approval mode for this workspace? Learn more about the different ${providerName}-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
            approvalModeWarningConfirm: '[pl] Change approval mode',
            approvalModes: {
                basic: {label: '[pl] Basic approval', description: '[pl] All users submit to a single person for processing and approval.'},
                manager: {
                    label: '[pl] Manager approval',
                    description: (providerName: string) => `[pl] Employees submit reports to their direct manager configured in ${providerName}.`,
                },
                custom: {label: '[pl] Custom approval', description: "[pl] I'll manually setup approval workflows in Expensify."},
            },
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
                        return '[pl] Synchronizing Gusto Employees';
                    case 'gustoSyncLoadData':
                        return '[pl] Loading data from Gusto';
                    case 'gustoSyncProvisioning':
                        return '[pl] Provisioning employees in policy';
                    case 'zenefitsSyncTitle':
                        return '[pl] Synchronizing TriNet Employees';
                    case 'zenefitsSyncLoadData':
                        return '[pl] Loading data from TriNet';
            ...
            syncResults: {
                title: (provider: string) => `[pl] ${provider} sync complete`,
                successTitle: (provider: string) => `[pl] Successfully synced your ${provider} connection!`,
                added: '[pl] Added',
                removed: '[pl] Removed',
                skipped: '[pl] Skipped',
                employeeCount: () => ({
                    one: '[pl] 1 employee',
                    other: (count: number) => `[pl] ${count} employees`,
                }),
            },
            gusto: {
                title: '[pl] Gusto',
        ...
        distanceRates: {
            ...
            amountPerUnit: (unit: string) => `[pl] Amount per ${unit}`,
            startDate: '[pl] Start date',
            endDate: '[pl] End date',
            errors: {
                rateNameRequired: '[pl] Rate name is required',
                existingRateName: '[pl] A distance rate with this name already exists',
                nameRequired: '[pl] Name is required',
                amountRequired: '[pl] Amount is required',
                startDateMustBeBeforeEndDate: '[pl] Start date must be before end date',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            yourWorkspace: `[pl] Your workspace is set to an unsupported currency. View the <a href="${CONST.ENABLE_GLOBAL_REIMBURSEMENT_HELP_URL}">list of supported currencies</a>.`,
...
Are you sure you want to export them again?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.CERTINIA]: {
                title: '[pl] Certinia',
                description: `[pl] Enjoy automated syncing and reduce manual entries with the Expensify + Certinia integration. Align expense coding dimensions and tax sync with your Certinia setup for clearer financial visibility.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>Our Certinia integration is only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            ...
            approvalSubmit: {
                title: '[pl] Approvals',
                description: '[pl] Centrally configure who all members submit to by enabling approvals.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>Approvals are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            categories: {
                title: '[pl] Categories',
            ...
            companyCardSubmit: {
                title: '[pl] Company cards',
                description: `[pl] Bring your own company card to Expensify to get automatic import, automatic categorization, customizable rule support, and integrated reconciliation.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>Company card import is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            rules: {
                title: '[pl] Rules',
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            hr: {
                title: '[pl] HR integrations',
                description:
                    '[pl] Connect your HR provider to automatically sync employees and manage approval workflows. Keep your team roster and reporting structure up to date without manual work.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>HR integrations are only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            travel: {
                title: '[pl] Travel',
            ...
            travelSubmit: {
                title: '[pl] Expensify Travel',
                description: '[pl] Book discounted flights, hotels, cars, and trains globally from within Expensify, with duty of care reporting and integrated expense management.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>Expensify Travel is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            reports: {
                title: '[pl] Reports',
            ...
            roles: {
                title: '[pl] Roles',
                description: '[pl] Assign different roles to different members to increase or decrease visibility and control as appropriate.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>Roles are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            payments: {
                title: '[pl] Payments',
                description: '[pl] Reimburse employees directly from your business bank account.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>Payments are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            accounting: {
                title: '[pl] Accounting',
                description:
                    '[pl] Sync categories, tags, tax rates, and more from your accounting system to Expensify, as well as export expense reports and card transactions – no typing (or typos) involved!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>Accounting is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            expensifyCard: {
                title: '[pl] Expensify Card',
                description:
                    '[pl] Issue company cards (including virtual cards) directly from your own bank account to get realtime spend control with an unbreakable connection, and up to 2% cashback!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>The Expensify Card is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
                upgradeButton: '[pl] Upgrade and enable',
            },
            invoicing: {
                title: '[pl] Invoicing',
                description: '[pl] Create, send, and track professional invoices, all inside Expensify. Get paid faster with integrated payments and real-time visibility.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[pl] <muted-text>Invoicing is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[pl] per member per month.` : `[pl] per active member per month.`}</muted-text>`,
            },
            pricing: {
                perActiveMember: '[pl] per active member per month.',
                perMember: '[pl] per member per month.',
            },
            note: (subscriptionLink: string) => `[pl] <muted-text><a href="${subscriptionLink}">Learn more</a> about our plans and pricing.</muted-text>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                giftCard: '[pl] Gift card purchases',
                handwrittenReceipt: '[pl] Handwritten receipts',
            ...
            customRules: {
                ...
                policyDocument: '[pl] Policy document',
                policyText: '[pl] Policy text',
            },
            spendRules: {
                title: '[pl] Spend',
...
Add more spend rules to protect company cash flow.`,
                ...
                summaryMoreCount: ({summary, count}: {summary: string; count: number}) => (count > 0 ? `[pl] ${summary}, +${count} more` : summary),
                summaryMerchants: ({
                    merchants,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[pl] Blocked' : '[pl] Allowed'} ${shownCount > 1 ? '[pl] merchants' : '[pl] merchant'}: ${merchants}${hiddenCount > 0 ? `[pl] , +${hiddenCount} more` : ''}`,
                summaryCategories: ({
                    categories,
                    hiddenCount,
                    shownCount,
                    ...
                    `${action === CONST.SPEND_RULES.ACTION.BLOCK ? '[pl] Blocked' : '[pl] Allowed'} ${shownCount > 1 ? '[pl] categories' : '[pl] category'}: ${categories}${hiddenCount > 0 ? `[pl] , +${hiddenCount} more` : ''}`,
        ...
        planTypePage: {
            planTypes: {
                ...
                submit2026: {
                    label: '[pl] Submit',
                    description: '[pl] For employees looking to submit expenses to their employer.',
                },
            },
            description: "[pl] Choose a plan that's right for you.",
            subscriptionLink: '[pl] Learn more',
    ...
    workspaceActions: {
        ...
        deleteCustomUnitRate: (customUnitName: string, rateName: string) => `[pl] removed the "${customUnitName}" rate "${rateName}"`,
        ...
        updatedManualApprovalThreshold: (oldLimit: string, newLimit: string) => `[pl] changed the manual approval limit for all expenses to ${newLimit} (previously ${oldLimit})`,
        ...
        updatedRequireCompanyCards: ({enabled}: {enabled: boolean}) => `[pl] ${enabled ? '[pl] enabled' : '[pl] disabled'} the company card purchases requirement`,
        ...
        updateCustomTaxName: (oldName: string, newName: string) => `[pl] changed the custom tax name to "${newName}" (previously "${oldName}")`,
        updateCurrencyDefaultTax: (oldName: string, newName: string) => `[pl] changed the workspace currency default tax rate to "${newName}" (previously "${oldName}")`,
        updateForeignCurrencyDefaultTax: (oldName: string, newName: string) => `[pl] changed the foreign currency default tax rate to "${newName}" (previously "${oldName}")`,
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `[pl] set itemized receipt required amount to "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) => `[pl] changed itemized receipt required amount to "${newValue}" (previously "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `[pl] removed itemized receipt required amount (previously "${oldValue}")`,
    ...
    search: {
        tabs: {
            ...
            expenses: '[pl] Expenses',
            submit: '[pl] Drafts',
            approve: '[pl] Needs approval',
            pay: '[pl] Ready to pay',
            accounting: '[pl] Accounting',
            export: '[pl] Awaiting export',
            unapprovedCash: '[pl] Cash accruals',
            unapprovedCard: '[pl] Card accruals',
            statements: '[pl] Card statements',
            reconciliation: '[pl] Bank reconciliation',
        ...
        bulkActions: {
            ...
            editMultipleDescription: '[pl] Changes will be set for all selected expenses and will override any previously set values.',
            approve: '[pl] Approve',
            pay: '[pl] Pay',
            delete: '[pl] Delete',
            hold: '[pl] Hold',
            ...
            duplicateReport: ({count}: {count: number}) => `[pl] Duplicate ${count === 1 ? '[pl] report' : '[pl] reports'}`,
        ...
        filters: {
            ...
            card: {
                ...
                travelInvoicing: '[pl] Travel invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[pl] Travel invoicing',
            },
            is: '[pl] Is',
            action: {
        ...
        askConcierge: (message: string) => `[pl] Ask Concierge “${message}”`,
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    travelCardLink: '[pl] travel card expenses',
                ...
                integrationSyncFailedRecurrence: ({count}: {count: number}) => `[pl] (Repeated ${count} times.)`,
    ...
    chronos: {
        ...
        stopTimer: (duration: string) => `[pl] Stop Timer (${duration})`,
    ...
    accessibilityHints: {
        ...
        openActionsMenu: '[pl] Open actions menu',
        selectAllCategories: '[pl] Select all categories',
        selectAllDistanceRates: '[pl] Select all distance rates',
        selectAllTags: '[pl] Select all tags',
        selectAllTaxes: '[pl] Select all taxes',
        selectAllPerDiemRates: '[pl] Select all per diem rates',
        selectAllMembers: '[pl] Select all members',
        selectAllValues: '[pl] Select all values',
        selectAllRules: '[pl] Select all rules',
    },
    parentReportAction: {
    ...
    gps: {
        ...
        liveActivity: {
            ...
            lockScreenBadgeText: '[pl] Distance',
            lockScreenTrackingText: '[pl] Tracking...',
    ...
    violations: {
        ...
        missingTag: (tagName?: string) => `[pl] Missing ${tagName ?? '[pl] tag'}`,
        ...
        prohibitedExpense: (prohibitedExpenseTypes: string | string[]) => {
            ...
            const getProhibitedExpenseTypeText = (prohibitedExpenseType: string) => {
                switch (prohibitedExpenseType) {
                    ...
                    case 'giftCard':
                        return `[pl] gift card purchases`;
                    case 'handwrittenReceipt':
                        return `[pl] handwritten receipts`;
                    default:
        ...
        smartscanFailed: ({canEdit = true, missingFields = []}: {canEdit?: boolean; missingFields?: string[]}) => {
            if (missingFields.length > 0) {
                const fieldNames: Record<string, string> = {merchant: '[pl] merchant', date: '[pl] date', amount: '[pl] amount'};
                const translated = missingFields.map((f) => fieldNames[f] ?? f);
                let fieldList = '';
                if (translated.length === 1) {
                    fieldList = translated.at(0) ?? '';
                } else if (translated.length === 2) {
                    fieldList = translated.join('[pl]  and ');
                } else {
                    fieldList = `${translated.slice(0, translated.length - 1).join(', ')}, and ${translated.at(-1)}`;
                }
                return `[pl] Receipt scanning failed — missing ${fieldList}.${canEdit ? '[pl]  Enter details manually.' : ''}`;
            }
            return `[pl] Receipt scanning failed.${canEdit ? '[pl]  Enter details manually.' : ''}`;
        },
    ...
    exitSurvey: {
        ...
        goBackJustOnce: '[pl] Go back just once',
    },
    listBoundary: {
    ...
    subscription: {
        ...
        details: {
            ...
            creditBalance: '[pl] Credit balance',
        ...
        cancelSubscription: {
            title: '[pl] Cancel subscription',
            subtitle: '[pl] What’s the main reason you’re canceling your subscription?',
    ...
    delegate: {
        ...
        addCopilot: '[pl] Add a copilot to your account',
        membersCanAccessYourAccount: '[pl] These members can access your account:',
        youCanAccessTheseAccounts: '[pl] You can access these accounts:',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            error: {
                ...
                moveMemberNotPolicyAdmin:
                    '[pl] Cannot move member to the domain group. You must be a Policy Admin for the Preferred Policy set on the domain group you are trying to move this user to.',
            },
        ...
        common: {
            ...
            error: "[pl] Couldn't save this change. Please try again.",
        },
        groups: {
            title: '[pl] Groups',
            memberCount: () => {
            ...
            defaultGroup: '[pl] Default group for new members',
            defaultGroupPrompt: (currentName: string, newName: string) =>
                `[pl] Are you sure you want to make ${newName} the default group? New members will be invited to this group instead of the previous default group (${currentName}). `,
            makeDefault: '[pl] Make default',
            neverMind: '[pl] Never mind',
            createGroupError: '[pl] Unable to create this group. Please try again.',
            permissions: '[pl] Group permissions',
            createNewGroupButton: '[pl] New group',
            createGroupSubmitButton: '[pl] Create group',
            expensifyCardPreferredWorkspace: '[pl] Expensify Card preferred workspace',
            expensifyCardPreferredWorkspaceDescription:
                '[pl] All Expensify Card transactions will be created on the Expensify Card Preferred Workspace instead of the Preferred Workspace. Enabling this feature will override the Preferred Workspace setting for Expensify Card transactions only.',
            strictlyEnforceWorkspaceRules: '[pl] Strictly enforce workspace rules',
            strictlyEnforceWorkspaceRulesDescription: '[pl] All workspace rules must be met before submitting a report. No manual exceptions allowed.',
            restrictExpenseWorkspaceCreation: '[pl] Restrict expense workspace creation/removal',
            restrictExpenseWorkspaceCreationDescription:
                '[pl] Prevent members from being able to create an expense workspace or remove themselves from an expense workspace. This is useful for preventing people from using Expensify to submit reports for use outside your domain when combined with strict workspace enforcement.',
            deleteGroup: '[pl] Delete Group',
            deleteGroupDangerConfirmationModal: '[pl] Delete Group',
            deleteGroupDangerConfirmationModalDescription: (defaultGroupName: string) =>
                `[pl] Are you sure? This will reassign all members to the default group (${defaultGroupName}) and can't be undone.`,
            deleteGroupError: '[pl] Unable to delete this group. Please try again.',
            preferredWorkspace: '[pl] Preferred Workspace',
            preferredWorkspaceDescription: (enabled: boolean) => `[pl] All new reports and expenses will be created on ${enabled ? '[pl] selected preferred' : '[pl] this'} workspace.`,
            preferredWorkspaceSelectDescription: '[pl] All new expenses and reports will be created on this workspace.',
            noWorkspacesMessage: '[pl] There are no workspaces on this domain. A workspace is required to enable this restriction.',
            restrictDefaultLoginSelection: '[pl] Restrict default login selection',
            restrictDefaultLoginSelectionDescription: '[pl] Prevent members from changing their login email away from their company domain to avoid policy restrictions.',
            expensifyCardPreferredWorkspaceDisabledMessage: '[pl] To enable this setting, please first enable a preferred workspace and set up Expensify Cards on your domain.',
            findGroup: '[pl] Find group',
        },
    },
};
