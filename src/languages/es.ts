...
${amount} para ${merchant} - ${date}`,
    ...
    domain: {
        ...
        verifyDomain: {
            ...
            saveChanges: 'Guarda los cambios y regresa aquí para verificar tu dominio.',
            youMayNeedToConsult: `Es posible que necesites consultar con el departamento de TI de tu organización para completar la verificación. <a href="${CONST.DOMAIN_VERIFICATION_HELP_URL}">Más información</a>.`,
            warning:
