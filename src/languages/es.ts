...
${amount} para ${merchant} - ${date}`,
    ...
    privatePersonalDetails: {
        ...
        commuterExclusionsNote: ({workspaceName}: {workspaceName: string}) => `${workspaceName} usa esta dirección para las exclusiones de desplazamientos.`,
        error: {
    ...
    workspace: {
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: 'Resta el trayecto entre la casa de cada miembro y la dirección del espacio de trabajo en cada reclamación de distancia.',
                distanceLabel: 'Distancia',
                workspaceAddressRequired: {
                    title: 'Espera un momento...',
                    prompt: 'Este espacio de trabajo aún no tiene dirección. Añade una para que las exclusiones de desplazamientos puedan usarla.',
                    cta: 'Añadir dirección',
                },
                errors: {
