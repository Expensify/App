    ...
    workspace: {
        ...
        rules: {
            ...
            spendRules: {
                ...
                merchantsMoreCount: ({summary, count}: {summary: string; count: number}) => `${summary}, +${count} más`,
                ...
                categoryOptions: {
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.GOVERNMENT_AND_NON_PROFIT]: 'Gobierno y organizaciones sin ánimo de lucro',
