        ...
        requestEarlyCancellation: {
            ...
            subscriptionCanceled: {
                ...
                preventFutureActivity:
                    'Si quieres evitar actividad y cargos futuros, debes <a>eliminar tu(s) espacio(s) de trabajo.</a> Ten en cuenta que cuando elimines tu(s) espacio(s) de trabajo, se te cobrará cualquier actividad pendienteque se haya incurrido durante el mes en curso.',
            },
            requestSubmitted: {
