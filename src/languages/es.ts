...
const translations: TranslationDeepObject<typeof en> = {
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            accountManager: '[es] Account Manager',
            accountManagerDescription: 'Haz preguntas y recibe soporte al cliente',
            partnerManager: '[es] Partner Manager',
            partnerManagerDescription: 'Maximiza tu colaboración y genera recomendaciones',
            guideDescription: 'Tu especialista asignado',
            approvedPartnerTeamTitle: 'Conoce a tu equipo de socios de Approved!',
            approvedPartnerTeamDescription: 'Un equipo dedicado centrado en ayudar a que tu firma crezca, incorpore clientes más rápido y reciba soporte experto siempre que lo necesites.',
            accountExecutive: '[es] Account Executive',
