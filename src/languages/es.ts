...
const translations: TranslationDeepObject<typeof en> = {
  ...
  multifactorAuthentication: {
    ...
    biometricsTest: {
      ...
      successfullyAuthenticatedUsing: ({ authType }) =>
        `Te has autenticado exitosamente con ${authType}.`,
      troubleshootBiometricsStatus: ({ registered }) =>
        `Biometría (${registered ? "Registrada" : "No registrada"})`,
  ...
  spreadsheet: {
    ...
    importCategoriesSuccessfulDescription: ({
      ...
      if (added) {
        return added === 1
          ? "Se añadió 1 categoría."
          : `Se añadieron ${added} categorías.`;
      }
      return updated === 1
        ? "Se actualizó 1 categoría."
        : `Se actualizaron ${updated} categorías.`;
    },
  ...
  iou: {
    ...
    routedDueToDEW: (to) =>
      `informe enviado a ${to} debido a un flujo de aprobación personalizado`,
    timeTracking: {
