...
const translations = {
    ...
    contacts: {
        ...
        helpTextBeforeEmail: 'Añade más formas de iniciar sesión y enviar recibos a Expensify.\n\nAñade una dirección de correo electrónico para reenviar recibos a ',
        helpTextAfterEmail: 'o añade un número de teléfono para enviar recibos por mensaje de texto al 47777 (solo números de EE. UU.).',
        primary: 'Principal',
