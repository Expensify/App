...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        dualEntry: {
            ...
            enableNewAccountsTitle: 'Habilitar cuentas recién importadas',
            enableNewAccountsDescription: 'Las nuevas cuentas de DualEntry estarán disponibles como categorías.',
            dimensionsImport: 'Elige qué dimensiones de DualEntry quieres importar como etiquetas',
            importDescription: 'Elige qué configuraciones de codificación quieres importar desde DualEntry.',
        },
        type: {
            free: 'Gratis',
            control: 'Controlar',
