...
export default {
    ...
    beneficialOwnerInfoStep: {
        ...
        regulationRequiresUsToVerifyTheIdentity: 'La regulación nos exige verificar la identidad de cualquier persona que posea más del 25% de la empresa.',
        companyOwner: 'Dueño de la empresa',
        enterLegalFirstAndLastName: 'Ingresa el nombre y apellido legal del dueño.',
        legalFirstName: 'Nombre legal',
        legalLastName: 'Apellido legal',
        enterTheDateOfBirthOfTheOwner: 'Ingresa la fecha de nacimiento del dueño.',
        enterTheLast4: 'Ingresa los últimos 4 dígitos del NSS del dueño.',
        last4SSN: 'Últimos 4 dígitos del Número de Seguro Social',
        dontWorry: 'No te preocupes, ¡no realizamos verificaciones de crédito personales!',
        enterTheOwnersAddress: 'Ingresa la dirección del dueño.',
        letsDoubleCheck: 'Vamos a verificar que todo esté correcto.',
        legalName: 'Nombre legal',
        address: 'Dirección',
        byAddingThisBankAccount: 'Al agregar esta cuenta bancaria, confirmas que has leído, comprendido y aceptado',
        owners: 'Dueños',
    },
    validationStep: {
