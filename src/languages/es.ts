...
const translations: TranslationDeepObject<typeof en> = {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            simulate3DSPendingTransaction: {
                title: 'Simular transacción 3DS pendiente',
                selectCard: 'Selecciona una tarjeta',
                card: 'Tarjeta',
                selectedCardAccessibilityLabel: 'Tarjeta seleccionada',
                noActiveExpensifyCard: 'No hay ninguna Tarjeta Expensify activa',
                cardEndingIn: (lastFour: string) => `Tarjeta terminada en ${lastFour}`,
                runScriptedQAFlows: 'Ejecutar flujos de QA predefinidos',
                runScriptedQAFlowsDescription:
                    'Pulsa para poner en cola 6 transacciones con 30 s de diferencia: Aprobación, Denegación, Expiración (expira después de 1 minuto), Error de Marqeta, Ya aprobada, Ya denegada.',
                outcome: 'Resultado',
                outcomeApproveOrDeny: 'Aprobar/Denegar (normal)',
                outcomeMarqetaError: 'Error de Marqeta en el resultado',
                outcomeAlreadyApproved: 'Error de ya aprobada',
                outcomeAlreadyDenied: 'Error de ya denegada',
                merchantPlaceholder: 'Introduce el nombre del comercio',
                merchantAccessibilityLabel: 'Nombre del comercio',
                amountAndCurrency: 'Importe y moneda',
                amountAccessibilityLabel: 'Campo de importe',
                delayBeforeDelivery: 'Retraso antes de la entrega (seg)',
                delayAccessibilityLabel: 'Retraso en segundos antes de enviar el desafío',
                expiresAfter: 'Expira después de (min)',
                ...
                createdTimePlaceholder: 'Dejar vacío para la hora actual',
                createdTimeAccessibilityLabel: 'Anulación de hora de creación',
                createdTimeDescription: 'Formato: ISO 8601 UTC (p. ej. 2024-01-15T10:30:00.000Z). Dejar vacío en la mayoría de los casos; solo establecer para antedatar la transacción.',
            },
        },
        security: 'Seguridad',
