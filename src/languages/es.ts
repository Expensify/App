...
${amount} para ${merchant} - ${date}`,
    ...
    signerInfoStep: {
        ...
        bothSignersMustBeOnIllionReport: 'Ambos firmantes deben figurar como directores en el informe de illion de la empresa. No pueden ser dos personas cualesquiera del negocio.',
        signerMustBeOnIllionReport: 'El director que agregues como firmante debe figurar en el informe de illion de la empresa.',
    ...
    agreementsStep: {
        ...
        bankStatementDescription: 'Proporciona un extracto bancario reciente, con fecha de los últimos tres meses, de la cuenta bancaria de empresa que estás conectando.',
        agreements: 'Acuerdos',
        ...
        iConsentToThePrivacyNotice: 'Doy mi consentimiento para el <a href="https://www.corpay.com/privacy-policy">aviso de privacidad</a>.',
