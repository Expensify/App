    ...
    workspace: {
        ...
        qbd: {
            ...
            accounts: {
                ...
                [CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD]: 'Cuenta de tarjeta de crédito',
                [`Non${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.VENDOR_BILL}`]: 'Cuentas por pagar',
