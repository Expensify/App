...
const translations = {
    ...
    signerInfoStep: {
        ...
        uploadID: 'Subir documento de identidad y comprobante de domicilio',
        id: 'Identificación (licencia de conducir o pasaporte)',
        personalAddress: 'Comprobante de domicilio personal (por ejemplo, factura de servicios públicos)',
        letsDoubleCheck: 'Vamos a comprobar que todo está bien.',
        legalName: 'Nombre legal',
        proofOf: 'Comprobante de domicilio personal',
        enterOneEmail: 'Ingrese el correo electrónico del director o alto funcionario en',
        regulationRequiresOneMoreDirector: 'El reglamento exige que haya otro director o funcionario superior como firmante.',
        hangTight: 'Aguanta fuerte...',
        enterTwoEmails: 'Ingrese los correos electrónicos de dos directores o altos funcionarios en',
