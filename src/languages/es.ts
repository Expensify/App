...
${amount} para ${merchant} - ${date}`,
        ...
        invalidCardLimit: 'El límite de tu tarjeta es $0. Pide al administrador de tu espacio de trabajo que establezca un límite de gasto distinto de cero e inténtalo de nuevo.',
