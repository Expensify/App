...
export default {
    ...
    focusModeUpdateModal: {
        ...
        prompt: 'Los mensajes leídos se ocultarán, a menos que tengan un punto verde, lo que significa que está esperándote. Puedes cambiar esto en la configuración de tu cuenta ',
    },
    notFound: {
