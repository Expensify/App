...
export default {
    ...
    workspace: {
        ...
        reportFields: {
            ...
            dateType: 'Fecha',
            dropdownType: 'Lista',
            textAlternateText: 'Add a textbox to freely write something in',
            dateAlternateText: 'Add a calendar to pick a date',
            dropdownAlternateText: 'Add a list of options to select from',
            ...
            listValuesInputSubtitle: 'These values will appear in your report field dropdown. Enabled values are selectable by members.',
