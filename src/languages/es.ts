...
const translations = {
    ...
    twoFactorAuth: {
        ...
        twoFactorAuthIsRequiredForAdminsDescription: 'Tu conexión de contabilidad con Xero requiere autenticación de dos factores. Para seguir usando Expensify, por favor habilítalo.',
