        ...
        card: {
            ...
            issueNewCard: {
                ...
                smartLimitDisabledDescription: (workspaceWorkflowsLink: string) =>
                    `<muted-text>Gasta hasta un determinado importe antes de requerir aprobación. <a href="${workspaceWorkflowsLink}">Habilita las aprobaciones</a> para seleccionar esta opción.</muted-text>`,
                monthly: 'Mensual',
