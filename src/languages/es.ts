    ...
    workspace: {
        ...
        rules: {
            ...
            spendRules: {
                ...
                maxAmountCurrencyMismatchTitle: 'Conflicto de divisas',
                maxAmountCurrencyMismatchPrompt: 'Para establecer un importe máximo, selecciona tarjetas que se liquiden en la misma divisa.',
                ...
                currenciesCurrencyMismatchTitle: 'Conflicto de divisas',
                currenciesCurrencyMismatchPrompt: 'Para establecer las divisas preferidas, selecciona tarjetas que se liquiden en la misma divisa.',
            },
            aiRules: {
                title: 'Reglas de IA',
