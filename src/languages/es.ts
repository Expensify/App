...
El plan Controlar empieza en 9 $ por miembro activo al mes.`,
        ...
        exportAgainModal: {
            title: '¡Cuidado!',
            description: ({reportName, connectionName, connectionNameFriendly}) =>
                `Los siguientes informes ya se han exportado a ${connectionNameFriendly ?? CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}. ¿Estás seguro de que deseas exportarlos de nuevo?\n\n${reportName}`,
