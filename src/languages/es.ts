    ...
    workspace: {
        ...
        rules: {
            ...
            spendRules: {
                ...
                maxAmountCurrencyMismatchTitle: 'Desajuste de divisa',
                maxAmountCurrencyMismatchPrompt: 'Para establecer un importe máximo, selecciona tarjetas que liquiden en la misma moneda.',
                ...
                currenciesCurrencyMismatchTitle: 'Desajuste de divisa',
                currenciesCurrencyMismatchPrompt: 'Para establecer las divisas preferidas, selecciona las tarjetas que liquiden en la misma moneda.',
                restrictMerchantsOffSubtitle: 'Los cargos se aprueban para monedas permitidas que no superen un importe máximo',
                restrictMerchantsAllowSubtitle: 'Los cargos se aprueban para las divisas permitidas que no superen un importe máximo y cuando el comercio o el tipo de comercio coinciden.',
                restrictMerchantsBlockSubtitle: 'Los cargos se aprueban para las divisas permitidas que no superan un importe máximo, o cuando el comercio o el tipo de comercio coinciden.',
            },
            agentRules: {
