...
export default {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryDomainRoomPartOne: 'Este chat es con todos los miembros de Expensify en el dominio ',
        beginningOfChatHistoryDomainRoomPartTwo: '. Úsalo para chatear con compañeros de trabajo, compartir consejos y hacer preguntas.',
        beginningOfChatHistoryAdminRoomPartOne: 'Este chat es con los administradores del espacio de trabajo ',
        beginningOfChatHistoryAdminRoomPartTwo: '. Úsalo para hablar sobre la configuración del espacio de trabajo y más.',
        beginningOfChatHistoryAnnounceRoomPartOne: 'Este chat es con todos en el espacio de trabajo ',
        beginningOfChatHistoryAnnounceRoomPartTwo: '. Úsalo para los anuncios más importantes.',
        beginningOfChatHistoryUserRoomPartOne: 'Este chat es para todo lo relacionado con ',
        beginningOfChatHistoryUserRoomPartTwo: '. Fue creado por ',
        beginningOfChatHistoryUserRoomPartThree: '.',
        beginningOfChatHistoryInvoiceRoomPartOne: 'Este chat es para facturas entre ',
        beginningOfChatHistoryInvoiceRoomPartTwo: ' y ',
        beginningOfChatHistoryInvoiceRoomPartThree: '.',
        beginningOfChatHistoryPartOne: 'Este chat es con ',
        beginningOfChatHistoryPartTwo: '.',
        beginningOfChatHistoryPartThree: ' Haz preguntas y obtén soporte en tiempo real las 24/7.',
        ...
        usePlusButton: ({additionalText, type}: UsePlusButtonParams) => `\n${additionalText ? `Usa el botón + para ${additionalText} ${type === CONST.REPORT.TYPE.INVOICE ? 'una factura' : 'un gasto'}.` : 'Solo usa el botón +.'}`,
        iouTypes: {
            pay: 'pagar',
            split: 'dividir',
            submit: 'presentar',
