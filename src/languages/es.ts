...
const translations = {
    common: {
        ...
        cannotLeaveWorkspaceOutstandingReport: 'Por favor, apruebe cualquier informe de gastos pendiente que se le haya enviado antes de abandonar este espacio de trabajo.',
