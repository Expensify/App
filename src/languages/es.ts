    ...
    report: {
        ...
        actions: {
            type: {
                ...
                delegateSubmit: ({delegateUser, awayUser}: DelegateSubmitParams) => `sent this report to ${delegateUser} since ${awayUser} is on vacation`,
                ...
                markedReimbursedFromIntegration: ({amount, currency}: MarkedReimbursedParams) => `paid ${currency}${amount} via integration`,
                ...
                unshare: ({user}: ShareParams) => `removed user ${user}`,
