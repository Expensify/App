        ...
        recruiting: {
            ...
            filters: {
                ...
                stages: {
                    ...
                    toggleTitle: 'Importar fases del trabajo',
                    allSelected: 'Todos los estados del trabajo',
                    emptySelectionError: 'Selecciona al menos una etapa del trabajo',
                },
                tags: {
                    title: 'Etiqueta',
                    description: 'Elige las etiquetas de candidatos que te gustaría sincronizar con este espacio de trabajo',
                    toggleTitle: 'Importar etiquetas',
                    allSelected: 'Todas las etiquetas',
                    emptySelectionError: 'Por favor, selecciona al menos una etiqueta',
                },
                offices: {
                    title: 'Oficina',
                    description: 'Elige las oficinas de los candidatos que te gustaría sincronizar con este espacio de trabajo',
                    toggleTitle: 'Importar oficinas (opcional)',
