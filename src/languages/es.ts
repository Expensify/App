...
export default {
    ...
    referralProgram: {
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
            ...
            body: `Inicia un chat con una cuenta nueva de Expensify y obtendrás $${CONST.REFERRAL_PROGRAM.REVENUE} una vez que empiezan una suscripción anual con dos o más miembros activos y realizar los dos primeros pagos de su factura Expensify. Sí, es así de fácil.`,
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.MONEY_REQUEST]: {
            ...
            body: `Pide dinero a una cuenta nueva de Expensify y obtendrás $${CONST.REFERRAL_PROGRAM.REVENUE} una vez que empiezan una suscripción anual con dos o más miembros activos y realizar los dos primeros pagos de su factura Expensify. Sí, es así de fácil.`,
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SEND_MONEY]: {
            ...
            body: `Envía dinero a una cuenta nueva de Expensify y obtendrás $${CONST.REFERRAL_PROGRAM.REVENUE} una vez que empiezan una suscripción anual con dos o más miembros activos y realizar los dos primeros pagos de su factura Expensify. Sí, es así de fácil.`,
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.REFERRAL_FRIEND]: {
            ...
            body: `Envía tu enlace de invitación de Expensify a un amigo. Cuando comiencen una suscripción anual, obtendrás $${CONST.REFERRAL_PROGRAM.REVENUE}. Sí, es así de fácil.`,
        },
