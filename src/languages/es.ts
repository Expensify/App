...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. Usa el botón ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} para enviar una factura.`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `. Solo usa el botón ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE}.`,
