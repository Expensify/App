...
export default {
    ...
    iou: {
        ...
        hold: 'En espera',
        holdRequest: 'Solicitud de retención',
        unholdRequest: 'Solicitud de cancelación de retención',
        explainHold: 'Explique por qué mantiene esta solicitud.',
        reason: 'Razón',
        holdReasonRequired: 'Se requiere una razón al sostener.',
        requestOnHold: 'Esta solicitud quedó en suspenso. Revise los comentarios para los próximos pasos.',
        confirmApprove: 'Confirmar qué aprobar',
