...
${amount} para ${merchant} - ${date}`,
        ...
        cardUnlockedDescription: 'Es posible que se te pida insertar tu tarjeta en el lector la próxima vez que realices una compra.',
        pinBlocked: 'Tu tarjeta fue bloqueada debido a entradas de PIN incorrectas.',
        unlock: 'Desbloquear',
