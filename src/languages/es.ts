...
${reportName}`,
    ...
    domain: {
        ...
        groups: {
            ...
            expensifyCardPreferredWorkspace: 'Espacio de trabajo preferido para tarjetas',
            expensifyCardPreferredWorkspaceDescription:
                'Todas las transacciones de Expensify Card y de tarjetas de empresa se crearán en el espacio de trabajo preferido para tarjetas en lugar del espacio de trabajo preferido. Al habilitar esta función, la configuración de espacio de trabajo preferido se aplicará solo a las transacciones con tarjeta.',
            ...
            expensifyCardPreferredWorkspaceDisabledMessage:
                'Para habilitar esta configuración, primero habilita un espacio de trabajo preferido y configura una Expensify Card o un feed de tarjetas de empresa en tu dominio.',
