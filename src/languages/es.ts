    ...
    workspace: {
        ...
        rules: {
            ...
            merchantRules: {
                ...
                ruleSummaryTitleContains: (merchantName: string) => `Si el comerciante contiene "${merchantName}"`,
                ruleSummaryTitleExact: (merchantName: string) => `Si el comerciante es exactamente "${merchantName}"`,
                ...
                matchTypeContainsDescription: 'Coincide con gastos donde el nombre del comerciante contiene el texto especificado (sin distinción de mayúsculas)',
                matchTypeExact: 'Coincide exactamente',
                matchTypeExactDescription: 'Coincide con gastos donde el nombre del comerciante coincide exactamente con el texto especificado',
