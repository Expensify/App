    ...
    workspace: {
        ...
        accounting: {
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: 'Elige la cuenta bancaria con la que se reconciliarán los pagos de tu facturación central.',
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `Asegúrate de que esta cuenta coincida con tu cuenta de liquidación de facturación central (que termina en ${lastFourPAN}) para que la conciliación continua funcione correctamente.`,
            },
            syncTravelInvoicingSettlements: 'Sincronizar liquidaciones de facturación central',
        },
        card: {
            issueCard: 'Emitir tarjeta',
            getStartedIssuing: 'Empieza emitiendo tu primera tarjeta virtual o física.',
