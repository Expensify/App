        ...
        messages: {
            ...
            onboardingTrackWorkspaceMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) =>
                isOnboardingFlow
                    ...
                    : '# Vamos a configurarte\n👋 ¡Estoy aquí para ayudarte! Para empezar, he personalizado la configuración de tu espacio de trabajo para propietarios únicos y negocios similares. Puedes ajustar tu espacio de trabajo haciendo clic en el enlace de abajo.\n\nAquí tienes cómo **organizar tus gastos** en unos pocos clics:',
