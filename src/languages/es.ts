...
${reportName}`,
        ...
        campfire: {
            ...
            exportDate: {
                label: 'Fecha de la factura del proveedor',
            ...
            exportNonReimbursable: {label: 'Exportar gastos de tarjetas de la empresa como', values: {label: 'Asientos contables'}},
            defaultCompanyCardVendor: {
            ...
            noAccountsFound: 'No se han encontrado cuentas',
            noAccountsFoundDescription: 'Por favor, añade cuentas en Campfire y sincroniza la conexión de nuevo',
        },
        businessCentral: {
