...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        hr: {
            ...
            alreadyConnectedTitle: 'No se pueden conectar múltiples plataformas de HR',
            alreadyConnectedPrompt: 'Debes desconectar tu plataforma de HR actual antes de conectar otra.',
