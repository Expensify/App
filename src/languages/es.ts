...
const translations: TranslationDeepObject<typeof en> = {
  common: {
    ...
    noResultsFoundMatching: (searchString: string) =>
      `No se encontraron resultados que coincidan con "${searchString}"`,
    ...
    conjunctionTo: "a",
    genericErrorMessage:
      "Ups... algo no ha ido bien y la acción no se ha podido completar. Por favor, inténtalo más tarde.",
    ...
    error: {
      ...
      characterLimitExceedCounter: (length, limit) =>
        `Se superó el límite de caracteres (${length}/${limit})`,
      dateInvalid: "Por favor, selecciona una fecha válida",
      invalidDateShouldBeFuture:
        "Por favor, elige una fecha igual o posterior a hoy",
      invalidTimeShouldBeFuture:
        "Por favor, elige una hora al menos un minuto en el futuro",
      ...
      invalidTimeRange:
        "Por favor, introduce una hora entre 1 y 12 (por ejemplo, 2:30 PM)",
      pleaseCompleteForm:
        "Por favor complete el formulario de arriba para continuar",
      ...
      login:
        "Se produjo un error al iniciar sesión. Por favor intente nuevamente.",
    },
    comma: "la coma",
    ...
    pleaseEnterEmailOrPhoneNumber:
      "Por favor, escribe un correo electrónico o número de teléfono",
    ...
    thisFeatureRequiresInternet:
      "Esta función requiere una conexión a Internet activa.",
    ...
    errorOccurredWhileTryingToPlayVideo:
      "Se produjo un error al intentar reproducir este video.",
    areYouSure: "¿Estás seguro?",
    verify: "Verifique",
    yesContinue: "Sí, continuar",
    websiteExample: "p. ej. https://www.expensify.com",
    zipCodeExampleFormat: ({ zipSampleFormat }) =>
      zipSampleFormat ? `p. ej. ${zipSampleFormat}` : "",
    ...
    roleCannotBeChanged: (workflowsLinkPage: string) =>
      `El rol no se puede cambiar porque este miembro es un <a href="${workflowsLinkPage}">pagador</a> en este espacio de trabajo.`,
    currency: "Divisa",
    ...
    downloadFailedDescription:
      "No se pudo completar la descarga. Por favor, inténtalo más tarde.",
    ...
    chatWithAccountManager: (accountManagerDisplayName) =>
      `¿Necesitas algo específico? Habla con tu gerente de cuenta, ${accountManagerDisplayName}.`,
    ...
    leaveWorkspaceConfirmation:
      "Si sales de este espacio de trabajo, no podrás enviar gastos en él.",
    leaveWorkspaceConfirmationAuditor:
      "Si sales de este espacio de trabajo, no podrás ver sus informes y configuraciones.",
    leaveWorkspaceConfirmationAdmin:
      "Si sales de este espacio de trabajo, no podrás gestionar su configuración.",
    ...
    unstableInternetConnection:
      "Conexión a internet inestable. Por favor, revisa tu red e inténtalo de nuevo.",
  ...
  lockedAccount: {
    ...
    description:
      "No puedes completar esta acción porque esta cuenta ha sido bloqueada. Para obtener más información, escribe a concierge@expensify.com.",
  },
  connectionComplete: {
    title: "Conexión completa",
    supportingText:
      "Ya puedes cerrar esta página y volver a la App de Expensify.",
  },
  location: {
    useCurrent: "Usar ubicación actual",
    notFound:
      "No pudimos encontrar tu ubicación. Inténtalo de nuevo o introduce una dirección manualmente.",
  ...
  contact: {
    ...
    importContactsText:
      "Importa contactos desde tu teléfono para que tus personas favoritas siempre estén a un toque de distancia.",
    importContactsExplanation:
      "para que tus personas favoritas estén siempre a un toque de distancia.",
    importContactsNativeText:
      "¡Solo un paso más! Danos luz verde para importar tus contactos.",
  },
  ...
  attachmentPicker: {
    ...
    expensifyDoesNotHaveAccessToCamera:
      "Expensify no puede tomar fotos sin acceso a la cámara. Haz click en configuración para actualizar los permisos.",
    attachmentError: "Error al adjuntar archivo",
    errorWhileSelectingAttachment:
      "Se ha producido un error al seleccionar un archivo adjunto. Por favor, inténtalo de nuevo.",
    errorWhileSelectingCorruptedAttachment:
      "Se ha producido un error al seleccionar un archivo adjunto corrupto. Por favor, inténtalo con otro archivo.",
    ...
    sizeExceededWithLimit: ({ maxUploadSizeInMB }) =>
      `El archivo adjunto supera el límite de ${maxUploadSizeInMB} MB.`,
    ...
    folderNotAllowedMessage:
      "Subir una carpeta no está permitido. Prueba con otro archivo.",
    protectedPDFNotSupported: "Los PDFs con contraseña no son compatibles",
    attachmentImageResized:
      "Se ha cambiado el tamaño de esta imagen para obtener una vista previa. Descargar para resolución completa.",
    attachmentImageTooLarge:
      "Esta imagen es demasiado grande para obtener una vista previa antes de subirla.",
    imageDimensionsTooLarge:
      "Las dimensiones de la imagen son demasiado grandes para procesar. Por favor, usa una imagen más pequeña.",
    tooManyFiles: (fileLimit: number) =>
      `Solamente puedes suber ${fileLimit} archivos a la vez.`,
    sizeExceededWithValue: ({ maxUploadSizeInMB }) =>
      `El archivo supera los ${maxUploadSizeInMB} MB. Por favor, vuelve a intentarlo.`,
    someFilesCantBeUploaded: "Algunos archivos no se pueden subir",
    sizeLimitExceeded: ({ maxUploadSizeInMB }) =>
      `Los archivos deben ser menores a ${maxUploadSizeInMB} MB. Los archivos más grandes no se subirán.`,
    maxFileLimitExceeded:
      "Puedes subir hasta 30 recibos a la vez. Los extras no se subirán.",
    ...
    learnMoreAboutSupportedFiles:
      "Obtén más información sobre los formatos compatibles.",
    passwordProtected:
      "Los PDFs con contraseña no son compatibles. Solo se subirán los archivos compatibles",
  },
  dropzone: {
  ...
  filePicker: {
    ...
    errorWhileSelectingFile:
      "An error occurred while selecting an file. Please try again.",
  },
  avatarCropModal: {
    title: "Editar foto",
    description:
  ...
  composer: {
    ...
    commentExceededMaxLength: (formattedMaxLength) =>
      `El comentario debe tener máximo ${formattedMaxLength} caracteres.`,
    taskTitleExceededMaxLength: (formattedMaxLength) =>
      `La longitud máxima del título de una tarea es de ${formattedMaxLength} caracteres.`,
  },
  baseUpdateAppModal: {
  ...
  multifactorAuthentication: {
    reviewTransaction: {
      ...
      requiresYourReview:
        "Una transacción con la tarjeta Expensify requiere tu revisión a continuación.",
      ...
      areYouSureToDeny:
        "¿Estás seguro? La transacción será rechazada si cierras esta pantalla.",
      youCanTryAgainAtMerchantOrReachOut:
        "Puedes intentarlo de nuevo en el comercio. Si no realizaste esta transacción, comunícate con Concierge para reportar un posible fraude.",
      youNeedToTryAgainAtMerchant:
        "Esta transacción no fue verificada, por lo que la hemos rechazado. Necesitarás intentarlo de nuevo en el comercio.",
      goBackToTheMerchant:
        "Regresa al sitio del comercio para continuar la transacción.",
      transactionFailed: "Transacción fallida",
      transactionCouldNotBeCompleted:
        "Su transacción no pudo ser completada. Por favor, inténtelo de nuevo en el comercio.",
    ...
    biometricsTest: {
      ...
      successfullyAuthenticatedUsing: ({
        ...
        `Te has autenticado exitosamente con ${authType}.`,
      troubleshootBiometricsStatus: ({
        status,
      }: MultifactorAuthenticationTranslationParams) => `Biometría (${status})`,
      ...
      statusRegisteredOtherDevice: () => ({
        one: "Otro dispositivo registrado",
        other: "Otros dispositivos registrados",
      }),
      yourAttemptWasUnsuccessful: "Tu intento de autenticación fue fallido.",
      youCouldNotBeAuthenticated: "No se pudo autenticar",
      areYouSureToReject:
        "¿Estás seguro? El intento de autenticación será rechazado si cierras esta pantalla.",
    ...
    pleaseEnableInSystemSettings: {
      start:
        "Por favor, activa la verificación de rostro/huella digital o establece un código de acceso en tus ",
      link: "ajustes del sistema",
      end: ".",
    },
    oops: "Ups, algo salió mal",
    looksLikeYouRanOutOfTime:
      "¡Parece que se te acabó el tiempo! Por favor, inténtalo de nuevo en el comercio.",
    ...
    enableQuickVerification: {
      biometrics:
        "Activa la verificación rápida y segura usando tu rostro o huella dactilar. No se requieren contraseñas ni códigos.",
    },
    revoke: {
      revoke: "Revocar",
      ...
      confirmationPrompt:
        "¿Estás seguro? Necesitarás un código mágico para la próxima verificación en ese dispositivo.",
      confirmationPromptThisDevice:
        "¿Estás seguro? Necesitarás un código mágico para la próxima verificación en este dispositivo.",
      confirmationPromptMultiple:
        "¿Estás seguro? Necesitarás un código mágico para la próxima verificación en esos dispositivos.",
      confirmationPromptAll:
        "¿Estás seguro? Necesitarás un código mágico para la próxima verificación en cualquier dispositivo.",
      cta: "Revocar acceso",
      ctaAll: "Revocar todo",
      noDevices:
      ...
      otherDevices: ({
        ...
        const displayCount =
          ...
          otherDeviceCount >= 1 &&
          otherDeviceCount <= 9
            ? numberWords.at(otherDeviceCount - 1)
            : `${otherDeviceCount}`;
  ...
  customApprovalWorkflow: {
    ...
    description:
      "Tu empresa tiene un flujo de aprobación personalizado en este espacio de trabajo. Por favor, realiza esta acción en Expensify Classic",
  ...
  emptyList: {
    [CONST.IOU.TYPE.CREATE]: {
      ...
      subtitleText:
        "¿Quieres que tu equipo también use Expensify? Simplemente envíale un gasto y nosotros nos encargaremos del resto.",
    },
  },
  ...
  welcomeText: {
    ...
    anotherLoginPageIsOpenExplanation:
      "Ha abierto la página de inicio de sesión en una pestaña separada. Inicie sesión desde esa pestaña específica.",
    welcome: "¡Bienvenido!",
    ...
    welcomeNewFace: (login) =>
      `${login}, siempre es genial ver una cara nueva por aquí!`,
    welcomeEnterMagicCode: ({ login }) =>
      `Por favor, introduce el código mágico enviado a ${login}. Debería llegar en un par de minutos.`,
  },
  login: {
    hero: {
  ...
  samlSignIn: {
    welcomeSAMLEnabled:
      "Continua iniciando sesión con el inicio de sesión único:",
    orContinueWithMagicCode:
      "También puedes iniciar sesión con un código mágico",
    useSingleSignOn: "Usar el inicio de sesión único",
    useMagicCode: "Usar código mágico",
    launching: "Cargando...",
    oneMoment:
      "Un momento mientras te redirigimos al portal de inicio de sesión único de tu empresa.",
  },
  reportActionCompose: {
  ...
  reportActionContextMenu: {
    ...
    editAction: ({ action }) =>
      `Editar ${action?.actionName === CONST.REPORT.ACTIONS.TYPE.IOU ? "gasto" : "comentario"}`,
    deleteAction: ({ action }) => {
      let type = "comentario";
  ...
  reportActionsView: {
    ...
    beginningOfChatHistorySelfDM:
      "Este es tu espacio personal. Úsalo para notas, tareas, borradores y recordatorios.",
    beginningOfChatHistorySystemDM:
      "¡Bienvenido! Vamos a configurar tu cuenta.",
    chatWithAccountManager: "Chatea con tu gestor de cuenta aquí",
    askMeAnything: "¡Pregúntame lo que quieras!",
    sayHello: "¡Saluda!",
    yourSpace: "Tu espacio",
    welcomeToRoom: ({ roomName }) => `¡Bienvenido a ${roomName}!`,
    usePlusButton: ({ additionalText }) =>
      ` Usa el botón + para ${additionalText} un gasto`,
    askConcierge:
      "Este es tu chat con Concierge, tu agente personal de IA. Puedo hacer casi cualquier cosa, ¡pruébame!",
  ...
  adminOnlyCanPost:
    "Solo los administradores pueden enviar mensajes en esta sala.",
  reportAction: {
  ...
  reportArchiveReasons: {
    ...
    [CONST.REPORT.ARCHIVE_REASON.ACCOUNT_CLOSED]: ({ displayName }) =>
      `Este chat está desactivado porque ${displayName} ha cerrado tu cuenta.`,
  ...
  sidebarScreen: {
    ...
    redirectToExpensifyClassicModal: {
      title: "Próximamente",
      description:
        "Estamos ajustando algunos detalles de New Expensify para adaptarla a tu configuración específica. Mientras tanto, dirígete a Expensify Classic.",
    },
  },
  homePage: {
    forYou: "Para ti",
    timeSensitiveSection: {
      ...
      fixCompanyCardConnection: {
        title: ({ feedName }: { feedName: string }) =>
          feedName
            ? `Reconectar la tarjeta corporativa de ${feedName}`
            : "Reconectar la tarjeta corporativa",
      ...
      fixPersonalCardConnection: {
        title: ({ cardName }: { cardName?: string }) =>
          cardName
            ? `Arreglar la conexión de la tarjeta personal de ${cardName}`
            : "Arreglar la conexión de la tarjeta personal",
        subtitle: "Monedero",
      },
      fixAccountingConnection: {
        title: ({ integrationName }: { integrationName: string }) =>
          `Reconectar con ${integrationName}`,
        defaultSubtitle: "Espacio de trabajo",
        subtitle: ({ policyName }: { policyName: string }) => policyName,
      },
      addShippingAddress: {
        ...
        subtitle:
          "Proporciona una dirección para recibir tu Tarjeta Expensify.",
        cta: "Añade dirección",
      },
      addPaymentCard: {
      ...
      reviewCardFraud: {
        ...
        titleWithDetails: ({
          ...
          amount: string;
          merchant: string;
        }) => `Revisa ${amount} en posible fraude en ${merchant}`,
    ...
    discoverSection: {
      ...
      menuItemTitleAdmin:
        "Aprende a invitar a miembros, editar flujos de aprobación y conciliar tarjetas corporativas.",
      menuItemDescription: "Descubre lo que Expensify puede hacer en 2 minutos",
    },
    forYouSection: {
      submit: ({ count }: { count: number }) =>
        `Enviar ${count} ${count === 1 ? "informe" : "informes"}`,
      approve: ({ count }: { count: number }) =>
        `Aprobar ${count} ${count === 1 ? "informe" : "informes"}`,
      pay: ({ count }: { count: number }) =>
        `Pagar ${count} ${count === 1 ? "informe" : "informes"}`,
      export: ({ count }: { count: number }) =>
        `Exportar ${count} ${count === 1 ? "informe" : "informes"}`,
      begin: "Comenzar",
      emptyStateMessages: {
        thumbsUpStarsTitle: "¡Has terminado!",
        thumbsUpStarsDescription:
          "Pulgar arriba, mantente atento a más tareas.",
        ...
        conciergeBotDescription:
          "¡Bip bup bip bup, vuelve a revisar para más tareas!",
        ...
        sunglassesDescription:
          "¡Hora de relajarse, pero mantente atento a lo que viene!",
    ...
    upcomingTravelSection: {
      ...
      hotelIn: ({ destination }: { destination: string }) =>
        `Hotel en ${destination}`,
      carRentalIn: ({ destination }: { destination: string }) =>
        `Alquiler de coche en ${destination}`,
  ...
  spreadsheet: {
    ...
    dragAndDrop:
      "<muted-link>Arrastra y suelta un archivo de hoja de cálculo aquí</muted-link>",
    ...
    chooseSpreadsheet:
      "<muted-link>Elige un archivo de hoja de cálculo para importar. Los formatos soportados son .csv, .txt, .xls y .xlsx.</muted-link>",
    ...
    fieldNotMapped: (fieldName) =>
      `¡Vaya! Un campo obligatorio ("${fieldName}") no ha sido mapeado. Por favor, revisa e inténtalo de nuevo.`,
    singleFieldMultipleColumns: (fieldName) =>
      `¡Vaya! Has mapeado un solo campo ("${fieldName}") a varias columnas. Por favor, revisa e inténtalo de nuevo.`,
    emptyMappedField: (fieldName) =>
      `¡Vaya! El campo ("${fieldName}") contiene uno o más valores vacíos. Por favor, revísalo e inténtalo de nuevo.`,
    importFailedTitle: "Fallo en la importación",
    importFailedDescription:
      "Por favor, asegúrate de que todos los campos estén llenos correctamente e inténtalo de nuevo. Si el problema persiste, por favor contacta a Concierge.",
    importCategoriesSuccessfulDescription: ({ categories }) =>
      categories > 1
        ? `Se han agregado ${categories} categorías.`
        : "Se ha agregado 1 categoría.",
    importMembersSuccessfulDescription: ({ added, updated }) => {
      ...
      if (updated) {
        return updated > 1
          ? `${updated} miembros han sido actualizados.`
          : "1 miembro ha sido actualizado.";
      }

      return added > 1
        ? `Se han agregado ${added} miembros`
        : "Se ha agregado 1 miembro.";
    },
    importTagsSuccessfulDescription: ({ tags }) =>
      tags > 1
        ? `Se han agregado ${tags} etiquetas.`
        : "Se ha agregado 1 etiqueta.",
    importMultiLevelTagsSuccessfulDescription:
      "Etiquetas de nivel múltiple han sido agregadas.",
    importPerDiemRatesSuccessfulDescription: ({ rates }) =>
      rates > 1
        ? `Se han añadido ${rates} tasas de per diem.`
        : "Se ha añadido 1 tasa de per diem.",
    importTransactionsSuccessfulDescription: ({ transactions }) =>
      transactions > 1
        ? `Se han importado ${transactions} transacciones.`
        : "Se ha importado 1 transacción.",
    importSuccessfulTitle: "Importar categorías",
    importDescription:
      "Elige qué campos mapear desde tu hoja de cálculo haciendo clic en el menú desplegable junto a cada columna importada a continuación.",
    ...
    importSpreadsheetLibraryError:
      "Error al cargar el módulo de hojas de cálculo. Por favor, verifica tu conexión a internet e inténtalo de nuevo.",
  ...
  receipt: {
    ...
    alternativeMethodsDownloadApp: ({ downloadUrl }) =>
      `<label-text><a href="${downloadUrl}">Descarga la aplicación</a> para escanear desde tu teléfono</label-text>`,
    alternativeMethodsForwardReceipts: ({ email }) =>
      `<label-text>Reenvía recibos a <a href="mailto:${email}">${email}</a></label-text>`,
    ...
    alternativeMethodsTextReceipts: ({ phoneNumber }) =>
      `<label-text>Envía recibos por SMS a ${phoneNumber} (solo números de EE.UU.)</label-text>`,
    takePhoto: "Haz una foto",
    cameraAccess:
      "Se requiere acceso a la cámara para hacer fotos de los recibos.",
    ...
    locationAccessMessage:
      "El acceso a la ubicación nos ayuda a mantener tu zona horaria y moneda precisas dondequiera que vayas.",
    ...
    addReceipt: "Añadir recibo",
    scanFailed:
      "El recibo no pudo ser escaneado, ya que falta el comerciante, la fecha o el monto.",
    crop: "Recortar",
    addAReceipt: {
  ...
  quickAction: {
    ...
    noLongerHaveReportAccess:
      "Ya no tienes acceso al destino previo de esta acción rápida. Escoge uno nuevo a continuación.",
  ...
  iou: {
    ...
    splitDateRange: (startDate, endDate, count) =>
      `${startDate} al ${endDate} (${count} días)`,
    ...
    totalAmountGreaterThanOriginal: (amount) =>
      `El importe total es ${amount} mayor que el gasto original.`,
    totalAmountLessThanOriginal: (amount) =>
      `El importe total es ${amount} menor que el gasto original.`,
    splitExpenseZeroAmount:
      "Por favor, introduce un importe válido antes de continuar.",
    splitExpenseOneMoreSplit:
      "No se han añadido divisiones. Añade al menos una para guardar.",
    splitExpenseEditTitle: (amount, merchant) =>
      `Editar ${amount} para ${merchant}`,
    ...
    splitExpenseCannotBeEditedModalDescription:
      "Los gastos aprobados o pagados no se pueden editar",
    splitExpenseDistanceErrorModalDescription:
      "Corrige el error de la tarifa de distancia e inténtalo de nuevo.",
    splitExpensePerDiemRateErrorModalDescription:
      "Por favor, corrige el error de la tasa de viáticos y vuelve a intentarlo.",
    ...
    removeExpenseConfirmation:
      "¿Estás seguro de que quieres eliminar este recibo? Esta acción no se puede deshacer.",
    paySomeone: (name) => `Pagar a ${name ?? "alguien"}`,
    ...
    pendingMatchWithCreditCard:
      "Recibo pendiente de adjuntar con la transacción de la tarjeta",
    pendingMatchWithCreditCardDescription:
      "Recibo pendiente de adjuntar con la transacción de la tarjeta. Márcalo como efectivo para cancelar.",
    markAsCash: "Marcar como efectivo",
    routePending: "Ruta pendiente...",
    findExpense: "Buscar gasto",
    deletedTransaction: (amount, merchant) =>
      `eliminó un gasto (${amount} para ${merchant})`,
    movedFromReport: (reportName) =>
      `movió un gasto${reportName ? ` desde ${reportName}` : ""}`,
    movedTransactionTo: (reportUrl, reportName) =>
      `movió este gasto${reportName ? ` a <a href="${reportUrl}">${reportName}</a>` : ""}`,
    movedTransactionFrom: (reportUrl, reportName) =>
      `movió este gasto${reportName ? ` desde <a href="${reportUrl}">${reportName}</a>` : ""}`,
    unreportedTransaction: (reportUrl) =>
      `movió este gasto a tu <a href="${reportUrl}">espacio personal</a>`,
    movedAction: (
      shouldHideMovedReportUrl,
      movedReportUrl,
      newParentReportUrl,
      toPolicyName,
    ) => {
    ...
    automaticallyEnterExpenseDetails:
      "Concierge introducirá automáticamente los detalles del gasto por ti, o puedes añadirlos manualmente.",
    receiptScanning: () => ({
    ...
    scanMultipleReceiptsDescription:
      "Haz fotos de todos tus recibos a la vez y confirma los detalles tú mismo o nosotros lo haremos por ti.",
    receiptScanInProgress: "Escaneado de recibo en proceso",
    receiptScanInProgressDescription:
      "Escaneado de recibo en proceso. Vuelve a comprobarlo más tarde o introduce los detalles ahora.",
    ...
    receiptStatusText:
      "Solo tú puedes ver este recibo cuando se está escaneando. Vuelve más tarde o introduce los detalles ahora.",
    receiptScanningFailed:
      "El escaneo de recibo ha fallado. Introduce los detalles manualmente.",
    transactionPendingDescription:
      "Transacción pendiente. Puede tardar unos días en contabilizarse.",
    companyInfo: "Información de la empresa",
    companyInfoDescription:
      "Necesitamos algunos detalles más antes de que pueda enviar su primera factura.",
    ...
    invalidDomainError:
      "Ha introducido un dominio no válido. Para continuar, introduzca un dominio válido.",
    publicDomainError:
      "Ha introducido un dominio público. Para continuar, introduzca un dominio privado.",
    expenseCount: () => {
      return {
        one: "1 gasto",
    ...
    business: "Empresa",
    settlePersonal: (formattedAmount) =>
      formattedAmount
        ? `Pago ${formattedAmount} como individuo`
        : `Pago con cuenta personal`,
    settleWallet: (formattedAmount) =>
      formattedAmount
        ? `Pagar ${formattedAmount} con billetera`
        : `con billetera`,
    settlePayment: (formattedAmount) => `Pagar ${formattedAmount}`,
    settleBusiness: (formattedAmount) =>
      formattedAmount
        ? `Pagar ${formattedAmount} como negocio`
        : `Pago con cuenta empresarial`,
    payElsewhere: (formattedAmount) =>
      formattedAmount
        ? `Marcar ${formattedAmount} como pagado`
        : `Marcar como pagado`,
    settleInvoicePersonal: (amount, last4Digits) =>
      amount
        ? `pagado ${amount} con cuenta personal ${last4Digits}`
        : `Pagado con cuenta personal`,
    settleInvoiceBusiness: (amount, last4Digits) =>
      amount
        ? `pagado ${amount} con cuenta de empresa ${last4Digits}`
        : `Pagado con cuenta de empresa`,
    payWithPolicy: (policyName, formattedAmount) =>
      formattedAmount
        ? `Pay ${formattedAmount} via ${policyName}`
        : `Pay via ${policyName}`,
    businessBankAccount: (amount, last4Digits) =>
      amount
        ? `pagó ${amount} con la cuenta bancaria ${last4Digits}.`
        : `pagó con la cuenta bancaria ${last4Digits}`,
    ...
    expenseAmount: (formattedAmount, comment) =>
      `${formattedAmount}${comment ? ` para ${comment}` : ""}`,
    ...
    queuedToSubmitViaDEW:
      "en cola para enviar a través del flujo de aprobación personalizado",
    failedToAutoSubmitViaDEW: (reason: string) =>
      `no ha podido enviar este informe mediante <a href="${CONST.SELECT_WORKFLOWS_HELP_URL}">retrasar envíos</a>. ${reason}`,
    failedToSubmitViaDEW: (reason: string) =>
      `no ha podido enviar este informe. ${reason}`,
    ...
    failedToApproveViaDEW: (reason: string) =>
      `no ha podido aprobar. ${reason}`,
    queuedToApproveViaDEW:
      "en cola para aprobar a través del flujo de aprobación personalizado",
    trackedAmount: (formattedAmount, comment) =>
      `realizó un seguimiento de ${formattedAmount}${comment ? ` para ${comment}` : ""}`,
    splitAmount: (amount) => `dividir ${amount}`,
    didSplitAmount: (formattedAmount, comment) =>
      `dividió ${formattedAmount}${comment ? ` para ${comment}` : ""}`,
    yourSplit: ({ amount }) => `Tu parte ${amount}`,
    payerOwesAmount: (amount, payer, comment) =>
      `${payer} debe ${amount}${comment ? ` para ${comment}` : ""}`,
    payerOwes: (payer) => `${payer} debe: `,
    payerPaidAmount: (amount, payer) =>
      `${payer ? `${payer} ` : ""}pagó ${amount}`,
    ...
    payerSettledWithMissingBankAccount: (amount) =>
      `pagó ${amount}. Agrega una cuenta bancaria para recibir tu pago.`,
    ...
    waitingOnBankAccount: ({ submitterDisplayName }) =>
      `inició el pago, pero está esperando a que ${submitterDisplayName} añada una cuenta bancaria.`,
    adminCanceledRequest: "canceló el pago",
    canceledRequest: (amount, submitterDisplayName) =>
      `canceló el pago  ${amount}, porque ${submitterDisplayName} no habilitó tu Billetera Expensify en un plazo de 30 días.`,
    settledAfterAddedBankAccount: (submitterDisplayName, amount) =>
    ...
    paidElsewhere: ({ payer, comment }: PaidElsewhereParams = {}) =>
      `${payer ? `${payer} ` : ""}marcó como pagado${comment ? `, diciendo "${comment}"` : ""}`,
    paidWithExpensify: (payer) =>
      `${payer ? `${payer} ` : ""}pagó con la billetera`,
    ...
    basedOnMCC: ({ rulesLink }: { rulesLink: string }) =>
      rulesLink
        ? `basado en <a href="${rulesLink}">reglas del espacio de trabajo</a>`
        : "basado en regla del espacio de trabajo",
    threadExpenseReportName: (formattedAmount, comment) =>
      `${comment ? `${formattedAmount} para ${comment}` : `Gasto de ${formattedAmount}`}`,
    invoiceReportName: ({ linkedReportID }) =>
      `Informe de facturación #${linkedReportID}`,
    threadPaySomeoneReportName: (formattedAmount, comment) =>
      `${formattedAmount} enviado${comment ? ` para ${comment}` : ""}`,
    movedFromPersonalSpace: ({ workspaceName, reportName }) =>
      `movió el gasto desde su espacio personal a ${workspaceName ?? `un chat con ${reportName}`}`,
    movedToPersonalSpace: "movió el gasto a su espacio personal",
    error: {
      invalidCategoryLength:
        "La longitud de la categoría escogida excede el máximo permitido (255). Por favor, escoge otra categoría o acorta la categoría primero.",
      invalidTagLength:
        "La longitud de la etiqueta escogida excede el máximo permitido (255). Por favor, escoge otra etiqueta o acorta la etiqueta primero.",
      invalidAmount: "Por favor, ingresa un importe válido antes de continuar",
      invalidDistance:
        "Por favor, ingresa una distancia válida antes de continuar",
      invalidReadings: "Por favor ingrese ambas lecturas de inicio y fin",
      negativeDistanceNotAllowed:
        "La lectura final debe ser mayor que la lectura inicial",
      distanceAmountTooLarge:
        "El importe total es demasiado alto. Reduce la distancia o disminuye la tarifa.",
      distanceAmountTooLargeReduceDistance:
        "El importe total es demasiado alto. Reduce la distancia.",
      distanceAmountTooLargeReduceRate:
        "El importe total es demasiado alto. Disminuye la tarifa.",
      odometerReadingTooLarge: (formattedMax: string) =>
        `Las lecturas del odómetro no pueden superar ${formattedMax}.`,
      invalidIntegerAmount:
        "Por favor, introduce una cantidad entera en dólares antes de continuar",
      invalidTaxAmount: (amount) =>
        `El importe máximo del impuesto es ${amount}`,
      invalidSplit: "La suma de las partes debe ser igual al importe total",
      invalidSplitParticipants:
        "Introduce un importe superior a cero para al menos dos participantes",
      ...
      genericHoldExpenseFailureMessage:
        "Error inesperado al retener el gasto. Por favor, inténtalo de nuevo más tarde.",
      genericUnholdExpenseFailureMessage:
        "Error inesperado al desbloquear el gasto. Por favor, inténtalo de nuevo más tarde.",
      genericCreateFailureMessage:
        "Error inesperado al enviar este gasto. Por favor, inténtalo más tarde.",
      genericCreateInvoiceFailureMessage:
        "Error inesperado al enviar la factura. Por favor, inténtalo de nuevo más tarde.",
      receiptDeleteFailureError:
        "Error inesperado al borrar este recibo. Por favor, vuelve a intentarlo más tarde.",
      receiptFailureMessage:
        '<rbr>Hubo un error al cargar tu recibo. Por favor, <a href="download">guarda el recibo</a> e <a href="retry">inténtalo de nuevo</a> más tarde.</rbr>',
      receiptFailureMessageShort: "Hubo un error al cargar tu recibo.",
      genericDeleteFailureMessage:
        "Error inesperado al eliminar este gasto. Por favor, inténtalo más tarde.",
      genericEditFailureMessage:
        "Error inesperado al editar este gasto. Por favor, inténtalo más tarde.",
      genericSmartscanFailureMessage: "La transacción tiene campos vacíos",
      duplicateWaypointsErrorMessage:
        "Por favor, elimina los puntos de ruta duplicados",
      ...
      splitExpenseMultipleParticipantsErrorMessage:
        "Solo puedes dividir un gasto entre un único espacio de trabajo o con miembros individuales. Por favor, actualiza tu selección.",
      ...
      invalidRate:
        "Tasa no válida para este espacio de trabajo. Por favor, selecciona una tasa disponible en el espacio de trabajo.",
    ...
    dismissReceiptErrorConfirmation:
      "¡Atención! Descartar este error eliminará completamente tu recibo cargado. ¿Estás seguro?",
    waitingOnEnabledWallet: ({ submitterDisplayName }) =>
      `inició el pago, pero no se procesará hasta que ${submitterDisplayName} active su billetera`,
    ...
    selectUnreportedExpense:
      "Selecciona al menos un gasto para agregar al informe.",
    emptyStateUnreportedExpenseTitle: "No hay gastos no reportados",
    emptyStateUnreportedExpenseSubtitle:
      "Parece que no tienes gastos no reportados. Puedes crear uno a continuación.",
    ...
    expenseOnHold:
      "Este gasto está retenido. Revisa los comentarios para saber como proceder.",
    expensesOnHold:
      "Todos los gastos están retenidos. Revisa los comentarios para saber como proceder.",
    expenseDuplicate:
      "Este gasto tiene detalles similares a otro. Por favor, revisa los duplicados para continuar.",
    someDuplicatesArePaid:
      "Algunos de estos duplicados ya han sido aprobados o pagados.",
    reviewDuplicates: "Revisar duplicados",
    keepAll: "Mantener todos",
    noDuplicatesTitle: "¡Todo listo!",
    noDuplicatesDescription:
      "No hay transacciones duplicadas para revisar aquí.",
    confirmApprove: "Confirmar importe a aprobar",
    confirmApprovalAmount:
      "Aprueba sólo los gastos conformes, o aprueba todo el informe.",
    confirmApprovalAllHoldAmount: () => ({
      one: "Este gasto está retenido. ¿Quieres aprobarlo de todos modos?",
      other:
        "Estos gastos están retenidos. ¿Quieres aprobarlos de todos modos?",
    }),
    confirmPay: "Confirmar importe de pago",
    confirmPayAmount:
      "Paga lo que no está retenido, o paga el informe completo.",
    ...
    whatIsHoldExplain:
      'Retener es como presionar "pausa" en un gasto hasta que estés listo para enviarlo.',
    holdIsLeftBehind:
      "Los gastos retenidos se quedan fuera incluso si envías un informe completo.",
    unholdWhenReady: "Desbloquea los gastos cuando estés listo para enviarlos.",
    changePolicyEducational: {
      title: "¡Has movido este informe!",
      description:
        "Revisa cuidadosamente estos elementos, que tienden a cambiar al trasladar informes a un nuevo espacio de trabajo.",
      reCategorize:
        "<strong>Vuelve a categorizar los gastos</strong> para cumplir con las reglas del espacio de trabajo.",
      workflows:
        "Este informe ahora puede estar sujeto a un <strong>flujo de aprobación</strong> diferente.",
    },
    ...
    chooseARate:
      "Selecciona una tasa de reembolso por milla o kilómetro para el espacio de trabajo",
    ...
    bookingPendingDescription:
      "Esta reserva está pendiente porque aún no se ha pagado.",
    bookingArchived: "Esta reserva está archivada",
    bookingArchivedDescription:
      "Esta reserva está archivada porque la fecha del viaje ha pasado. Agregue un gasto por el monto final si es necesario.",
    ...
    deleteSubrateConfirmation:
      "¿Estás seguro de que deseas eliminar esta subtasa?",
    quantity: "Cantidad",
    ...
    reject: {
      ...
      educationalText:
        "Si no estás listo para aprobar o pagar un gasto, puedes retenerlo o rechazarlo.",
      holdExpenseTitle:
        "Retén un gasto para pedir más detalles antes de aprobarlo o pagarlo.",
      approveExpenseTitle:
        "Aprueba otros gastos mientras los gastos retenidos permanecen asignados a ti.",
      heldExpenseLeftBehindTitle:
        "Los gastos retenidos se dejan atrás cuando apruebas un informe completo.",
      rejectExpenseTitle:
        "Rechaza un gasto que no tengos intención de aprobar o pagar.",
      ...
      rejectedStatus:
        "Este gasto fue rechazado. Estamos esperando que soluciones los problemas y lo marques como resuelto para poder enviarlo.",
      reportActions: {
    ...
    moveExpensesError:
      "No puedes mover gastos per diem a informes de otros espacios de trabajo, porque las tarifas de dietas pueden diferir entre espacios de trabajo.",
    changeApprover: {
      ...
      changedApproverMessage: (managerID) =>
        `cambió el aprobador a <mention-user accountID="${managerID}"/>`,
      actions: {
        addApprover: "Añadir aprobador",
        addApproverSubtitle:
          "Añade un aprobador adicional al flujo de trabajo existente.",
        bypassApprovers: "Omitir aprobadores",
        bypassApproversSubtitle:
          "Asígnate como aprobador final y omite a los aprobadores restantes.",
      },
      addApprover: {
        subtitle:
          "Elige un aprobador adicional para este informe antes de que lo enviemos por el resto del flujo de aprobación.",
      },
    },
    chooseWorkspace: "Elige un espacio de trabajo",
    routedDueToDEW: (to: string, reason?: string) =>
      `informe enviado a ${to}${reason ? ` porque ${reason}` : ""}`,
    timeTracking: {
      hoursAt: (hours: number, rate: string) =>
        `${hours} ${hours === 1 ? "hora" : "horas"} a ${rate} / hora`,
      hrs: "h",
      hours: "Horas",
      ratePreview: (rate: string) => `${rate} / hora`,
      amountTooLargeError:
        "El importe total es demasiado alto. Reduce las horas o disminuye la tasa.",
    },
    ...
    rulesModifiedFields: {
      reimbursable: (value: boolean) =>
        value
          ? 'marcó el gasto como "reembolsable"'
          : 'marcó el gasto como "no reembolsable"',
      billable: (value: boolean) =>
        value
          ? 'marcó el gasto como "facturable"'
          : 'marcó el gasto como "no facturable"',
      tax: (value: string, isFirst: boolean) =>
        isFirst
          ? `estableció la tasa de impuesto a "${value}"`
          : `tasa de impuesto a "${value}"`,
      ...
      common: (
        ...
        return isFirst
          ? `estableció el ${field} a "${value}"`
          : `${field} a "${value}"`;
      },
      formatPersonalRules: (fragments: string, route: string) =>
        `${fragments} vía <a href="${route}">reglas de gastos personales</a>`,
      formatPolicyRules: (fragments: string, route: string) =>
        `${fragments} vía <a href="${route}">reglas del espacio de trabajo</a>`,
    },
    duplicateNonDefaultWorkspacePerDiemError:
      "No puedes duplicar gastos de viáticos entre espacios de trabajo porque las tarifas pueden variar entre ellos.",
    cannotDuplicateDistanceExpense:
      "No puedes duplicar gastos de distancia entre espacios de trabajo porque las tasas pueden diferir entre espacios de trabajo.",
  },
  transactionMerge: {
    listPage: {
      ...
      selectTransactionToMerge: ({ reportName }) =>
    ...
    detailsPage: {
      ...
      selectAllDetailsError:
        "Selecciona todos los detalles antes de continuar.",
    },
    confirmationPage: {
      header: "Confirma los detalles",
      pageTitle:
        "Confirma los detalles que conservarás. Los detalles que no conserves serán eliminados.",
  ...
  loginField: {
    ...
    emailHasNotBeenValidated:
      "El correo electrónico no está validado todavía. Haz click en el botón para reenviar el enlace de confirmación via correo electrónico.",
  },
  avatarWithImagePicker: {
    ...
    deleteWorkspaceError:
      "Lo sentimos, hubo un problema eliminando el avatar de tu espacio de trabajo",
  ...
  nextStep: {
    message: {
      ...
      [CONST.NEXT_STEP.MESSAGE_KEY.NO_FURTHER_ACTION]: (_) =>
  ...
  profilePage: {
    ...
    publicSection: {
      title: "Público",
      subtitle:
        "Estos detalles se muestran en tu perfil público, a disposición de los demás.",
    },
    privateSection: {
      title: "Privado",
      subtitle:
        "Estos detalles se utilizan para viajes y pagos. Nunca se mostrarán en tu perfil público.",
    },
  },
  securityPage: {
  ...
  contacts: {
    ...
    enterMagicCode: (contactMethod) =>
      `Por favor, introduce el código mágico enviado a ${contactMethod}. Debería llegar en un par de minutos.`,
    ...
    yourDefaultContactMethodRestrictedSwitch:
      "Este es tu método de contacto predeterminado actual. Tu empresa ha restringido su eliminación o modificación.",
    removeContactMethod: "Eliminar método de contacto",
    removeAreYouSure:
      "¿Estás seguro de que quieres eliminar este método de contacto? Esta acción no se puede deshacer.",
    failedNewContact:
      "Se ha producido un error al añadir este método de contacto.",
    genericFailureMessages: {
      requestContactMethodValidateCode:
        "No se ha podido enviar un nuevo código mágico. Espera un rato y vuelve a intentarlo.",
      validateSecondaryLogin:
        "Código mágico incorrecto o no válido. Inténtalo de nuevo o solicita otro código.",
      deleteContactMethod:
        "No se ha podido eliminar este método de contacto. Por favor, contacta con Concierge para obtener ayuda.",
      setDefaultContactMethod:
        "No se pudo establecer un nuevo método de contacto predeterminado. Por favor contacta con Concierge para obtener ayuda.",
      addContactMethod:
        "Se ha producido un error al añadir este método de contacto. Por favor, contacta con Concierge para obtener ayuda.",
      enteredMethodIsAlreadySubmitted:
        "El método de contacto ingresado ya existe",
  ...
  updateRequiredView: {
    ...
    pleaseInstallExpensifyClassic:
      "Por favor, instala la última versión de Expensify",
    toGetLatestChanges:
      "Para móvil, descarga e instala la última versión. Para la web, actualiza tu navegador.",
  ...
  initialSettingsPage: {
    ...
    aboutPage: {
      description:
        "New Expensify está creada por una comunidad de desarrolladores de código abierto de todo el mundo. Ayúdanos a construir el futuro de Expensify.",
    ...
    troubleshoot: {
      ...
      confirmResetDescription:
        "Todos los borradores no enviados se perderán, pero el resto de tus datos estarán a salvo.",
      ...
      maskExportOnyxStateData:
        "Enmascare los datos frágiles del miembro mientras exporta el estado Onyx",
      ...
      usingImportedState:
        "Estás utilizando el estado importado. Pulsa aquí para borrarlo.",
      debugMode: "Modo depuración",
      invalidFile: "Archivo inválido",
      invalidFileDescription:
        "El archivo que ests intentando importar no es válido. Por favor, inténtalo de nuevo.",
      ...
      sentryDebugDescription:
        "Registrar las solicitudes de Sentry en la consola",
      sentryHighlightedSpanOps: "Nombres de spans resaltados",
      sentryHighlightedSpanOpsPlaceholder:
        "ui.interaction.click, navigation, ui.load",
    },
    security: "Seguridad",
  ...
  closeAccountPage: {
    ...
    closeAccountPermanentlyDeleteData:
      "¿Estás seguro de que quieres eliminar tu cuenta? Esta acción eliminará permanentemente toda la información de cualquier gasto pendiente.",
    ...
    enterYourDefaultContactMethod:
      "Por favor, introduce tu método de contacto predeterminado para cerrar tu cuenta.",
  },
  mergeAccountsPage: {
    mergeAccount: "Fusionar cuentas",
    accountDetails: {
      accountToMergeInto: (login) =>
        `Introduce la cuenta en la que deseas fusionar <strong>${login}</strong>.`,
      notReversibleConsent: "Entiendo que esto no es reversible",
    },
    accountValidate: {
      confirmMerge: "¿Estás seguro de que deseas fusionar cuentas?",
      lossOfUnsubmittedData: (login) =>
        `Fusionar tus cuentas es irreversible y resultará en la pérdida de cualquier gasto no enviado de <strong>${login}</strong>.`,
      enterMagicCode: (login) =>
        `Para continuar, por favor introduce el código mágico enviado a <strong>${login}</strong>.`,
      errors: {
        incorrectMagicCode:
          "Código mágico incorrecto o no válido. Inténtalo de nuevo o solicita otro código.",
    ...
    mergePendingSAML: {
      ...
      limitedSupport:
        "Todavía no es posible fusionar cuentas en New Expensify. Por favor, realiza esta acción en Expensify Classic en su lugar",
      reachOutForHelp:
        "<muted-text><centered-text>¡No dudes en <concierge-link>comunicarte con Concierge</concierge-link> si tienes alguna pregunta!</centered-text></muted-text>",
    ...
    mergeFailureTooManyAttempts: {
      ...
      description:
        "Hubo demasiados intentos de fusionar cuentas. Por favor, inténtalo de nuevo más tarde.",
    },
    mergeFailureUnvalidatedAccount: {
      description:
        "No puedes fusionarte con otras cuentas porque no está validada. Por favor, valida la cuenta e inténtalo de nuevo.",
    },
  ...
  lockAccountPage: {
    ...
    domainAdminsDescription:
      "Para administradores de dominio: Esto también detiene toda la actividad de la Tarjeta Expensify y las acciones administrativas en tus dominios.",
    areYouSure: "¿Estás seguro de que deseas bloquear tu cuenta de Expensify?",
    onceLocked:
      "Una vez bloqueada, tu cuenta estará restringida hasta que se solicite el desbloqueo y se realice una revisión de seguridad.",
  },
  failedToLockAccountPage: {
    failedToLockAccount: "No se pudo bloquear la cuenta",
    failedToLockAccountDescription:
      "No pudimos bloquear tu cuenta. Por favor, chatea con Concierge para resolver este problema.",
  ...
  unlockAccountPage: {
    ...
    chatToConciergeToUnlock:
      "Chatea con Concierge para resolver los problemas de seguridad y desbloquear tu cuenta.",
    chatWithConcierge: "Chatear con Concierge",
  },
  twoFactorAuth: {
    ...
    explainProcessToRemove:
      "Para deshabilitar la autenticación de dos factores (2FA), por favor introduce un código válido de tu aplicación de autenticación.",
    explainProcessToRemoveWithRecovery:
      "Para deshabilitar la autenticación en dos pasos (2FA), por favor introduce un código de recuperación válido.",
    disabled: "La autenticación de dos factores está ahora deshabilitada",
    noAuthenticatorApp:
      "Ya no necesitarás una aplicación de autenticación para iniciar sesión en Expensify.",
    ...
    enterCode:
      "Luego introduce el código de seis dígitos generado por tu aplicación de autenticación.",
    ...
    twoFactorAuthIsRequiredDescription:
      "Por razones de seguridad, Xero requiere la autenticación de dos factores para conectar la integración.",
    twoFactorAuthIsRequiredForAdminsHeader:
      "Autenticación de dos factores requerida",
    twoFactorAuthIsRequiredForAdminsTitle:
      "Por favor, habilita la autenticación de dos factores",
    ...
    twoFactorAuthIsRequiredCompany:
      "Tu empresa requiere el uso de autenticación de dos factores. Por favor, habilítala para seguir usando Expensify.",
    twoFactorAuthCannotDisable:
      "No se puede desactivar la autenticación de dos factores (2FA)",
    twoFactorAuthRequired:
      "La autenticación de dos factores (2FA) es obligatoria para tu conexión a Xero y no se puede desactivar.",
  },
  recoveryCodeForm: {
    error: {
      pleaseFillRecoveryCode: "Por favor, introduce tu código de recuperación",
      incorrectRecoveryCode:
        "Código de recuperación incorrecto. Por favor, inténtalo de nuevo.",
    },
  ...
  twoFactorAuthForm: {
    error: {
      ...
      incorrect2fa:
        "Código de autenticación de dos factores incorrecto. Por favor, inténtalo de nuevo.",
    },
  },
  ...
  privateNotes: {
    ...
    personalNoteMessage:
      "Guarda notas sobre este chat aquí. Usted es la única persona que puede añadir, editar o ver estas notas.",
    sharedNoteMessage:
      "Guarda notas sobre este chat aquí. Los empleados de Expensify y otros miembros del dominio team.expensify.com pueden ver estas notas.",
    composerLabel: "Notas",
    myNote: "Mi nota",
    error: {
  ...
  billingCurrency: {
    ...
    paymentCurrencyDescription:
      "Selecciona una moneda estándar a la que se deben convertir todos los gastos personales",
  ...
  addDebitCardPage: {
    ...
    error: {
      ...
      debitCardNumber:
        "Por favor, introduce un número de tarjeta de débito válido",
      expirationDate: "Por favor, selecciona una fecha de vencimiento válida",
      securityCode: "Por favor, introduce un código de seguridad válido",
      addressStreet:
        "Por favor, introduce una dirección de facturación válida que no sea un apartado postal",
  ...
  addPaymentCardPage: {
    ...
    error: {
      ...
      addressZipCode: "Por favor, introduce un código postal válido",
      paymentCardNumber:
        "Por favor, introduce un número de tarjeta de pago válido",
      expirationDate: "Por favor, selecciona una fecha de vencimiento válida",
      securityCode: "Por favor, introduce un código de seguridad válido",
      addressStreet:
        "Por favor, introduce una dirección de facturación válida que no sea un apartado postal",
  ...
  personalCard: {
    ...
    lookingForCompanyCardsDescription:
      "Añade tus propias tarjetas de más de 10.000 bancos de todo el mundo.",
    personalCardAdded: "¡Tarjeta personal añadida!",
    personalCardAddedDescription:
      "¡Felicidades! Empezaremos a importar transacciones desde tu tarjeta",
    ...
    bankConnectionDescription:
      "Intenta añadir tus tarjetas de nuevo. De lo contrario, puedes",
    ...
    upgradeDescription:
      "¿Necesitas añadir más tarjetas? Crea un espacio de trabajo para añadir tarjetas personales o asignar tarjetas de empresa a todo el equipo.",
  ...
  walletPage: {
    ...
    error: {
      notOwnerOfBankAccount:
        "Se ha producido un error al establecer esta cuenta bancaria como método de pago predeterminado",
      invalidBankAccount: "Esta cuenta bancaria está temporalmente suspendida",
      notOwnerOfFund:
        "Se ha producido un error al establecer esta tarjeta de crédito como método de pago predeterminado",
      setDefaultFailure: "No se ha podido configurar el método de pago",
    },
    addBankAccountFailure:
      "Ocurrió un error inesperado al intentar añadir la cuenta bancaria. Inténtalo de nuevo.",
    getPaidFaster: "Cobra más rápido",
    addPaymentMethod:
      "Añade un método de pago para enviar y recibir pagos directamente en la aplicación.",
    ...
    assignedCardsDescription:
      "Las transacciones de estas tarjetas se sincronizan automáticamente.",
    expensifyCard: "Tarjeta Expensify",
    walletActivationPending:
      "Estamos revisando tu información. Por favor, vuelve en unos minutos.",
    walletActivationFailed:
      "Lamentablemente, no podemos activar tu billetera en este momento. Chatea con Concierge para obtener más ayuda.",
    addYourBankAccount: "Añadir tu cuenta bancaria",
    addBankAccountBody:
      "Conectemos tu cuenta bancaria a Expensify para que sea más fácil que nunca enviar y recibir pagos directamente en la aplicación.",
    ...
    shareBankAccountTitle:
      "Seleccionar los administradores con quienes compartir esta cuenta bancaria:",
    shareBankAccountSuccess: "¡Cuenta bancaria compartida!",
    shareBankAccountSuccessDescription:
      "Los administradores seleccionados recibirán un mensaje de confirmación de Concierge.",
    shareBankAccountFailure:
      "Se produjo un error inesperado al intentar compartir la cuenta bancaria. Inténtelo de nuevo.",
    shareBankAccountEmptyTitle: "No hay administradores disponibles",
    shareBankAccountEmptyDescription:
      "No hay administradores del espacio de trabajo con los que puedas compartir esta cuenta bancaria",
    shareBankAccountNoAdminsSelected:
      "Seleccione un administrador antes de continuar",
    ...
    unshareBankAccountWarning: ({ admin }: { admin?: string | null }) =>
      `${admin} perderá el acceso a esta cuenta bancaria comercial. Seguiremos completando los pagos en proceso.`,
    reachOutForHelp:
      "Se está usando con la tarjeta Expensify. <concierge-link>Contacte con Concierge</concierge-link> si necesita dejar de compartirla.",
    unshareErrorModalTitle: "No se puede dejar de compartir la cuenta bancaria",
    travelCVV: {
      title: "CVV de viaje",
      subtitle: "Úsalo al reservar viajes",
      description:
        "Usa esta tarjeta para tus reservas de Expensify Travel. Aparecerá como “Travel Card” al pagar.",
    },
    chaseAccountNumberDifferent:
      "¿Por qué es diferente el número de mi cuenta?",
  },
  cardPage: {
    expensifyCard: "Tarjeta Expensify",
    ...
    smartLimit: {
      ...
      title: ({ formattedLimit }) =>
        `Puedes gastar hasta ${formattedLimit} en esta tarjeta al mes. El límite se restablecerá el primer día del mes.`,
    },
    fixedLimit: {
      name: "Límite fijo",
      title: ({ formattedLimit }) =>
        `Puedes gastar hasta ${formattedLimit} en esta tarjeta, luego se desactivará.`,
    },
    monthlyLimit: {
      name: "Límite mensual",
      title: ({ formattedLimit }) =>
        `Puedes gastar hasta ${formattedLimit} en esta tarjeta y el límite se restablecerá a medida que se aprueben tus gastos.`,
    },
    ...
    suspiciousBannerDescription:
      "Hemos detectado una transacción sospechosa en la tarjeta. Haz click abajo para revisarla.",
    cardLocked:
      "La tarjeta está temporalmente bloqueada mientras nuestro equipo revisa la cuenta de tu empresa.",
    markTransactionsAsReimbursable: "Marcar transacciones como reembolsables",
    markTransactionsDescription:
      "Cuando está habilitado, las transacciones importadas de esta tarjeta se marcan como reembolsables por defecto.",
    ...
    missingPrivateDetails: ({
      ...
      `Por favor, <a href="${missingDetailsLink}">agrega tus datos personales</a> y vuelve a intentarlo.`,
    unexpectedError:
      "Se produjo un error al intentar obtener los detalles de tu tarjeta Expensify. Vuelve a intentarlo.",
    cardFraudAlert: {
      confirmButtonText: "Sí, lo hago",
      reportFraudButtonText: "No, no fui yo",
      clearedMessage: ({ cardLastFour }) =>
      ...
      deactivatedMessage: ({ cardLastFour }) =>
        `la tarjeta terminada en ${cardLastFour} ha sido desactivada`,
      alertMessage: ({
        cardLastFour,
        amount,
        merchant,
...
${amount} para ${merchant} - ${date}`,
    ...
    freezeDescription:
      "Una tarjeta congelada no se puede usar para compras ni transacciones. Puedes descongelarla en cualquier momento.",
    unfreezeDescription:
      "Al descongelar esta tarjeta se volverán a permitir compras y transacciones. Continúa solo si estás seguro de que la tarjeta es segura para usar.",
    frozen: "Congelada",
    youFroze: ({ date }: { date: string }) =>
      `Congelaste esta tarjeta el ${date}.`,
    frozenBy: ({ person, date }: { person: string; date: string }) =>
      `${person} congeló esta tarjeta el ${date}.`,
  },
  workflowsPage: {
    workflowTitle: "Gasto",
    workflowDescription:
      "Configure un flujo de trabajo desde el momento en que se produce el gasto, incluida la aprobación y el pago",
    ...
    disableApprovalPromptDescription:
      "Deshabilitar las aprobaciones borrará todos los flujos de trabajo de aprobación existentes.",
    ...
    accessibilityLabel: ({
      ...
      members: string;
      approvers: string;
    }) => `gastos de ${members}, y el aprobador es ${approvers}`,
    ...
    editor: {
      submissionFrequency:
        "Elige cuánto tiempo Expensify debe esperar antes de compartir los gastos sin errores.",
    },
    frequencyDescription:
      "Elige la frecuencia de presentación automática de gastos, o preséntalos manualmente",
    frequencies: {
      instant: "Al instante",
      weekly: "Semanal",
      monthly: "Mensual",
    ...
    approverInMultipleWorkflows:
      "Este miembro ya pertenece a otro flujo de aprobación. Cualquier actualización aquí se reflejará allí también.",
    ...
    emptyContent: {
      ...
      expensesFromSubtitle:
        "Todos los miembros del espacio de trabajo ya pertenecen a un flujo de aprobación existente.",
      approverSubtitle:
        "Todos los aprobadores pertenecen a un flujo de trabajo existente.",
    },
  },
  workflowsDelayedSubmissionPage: {
    autoReportingFrequencyErrorMessage:
      "La frecuencia de envío no pudo ser cambiada. Por favor, inténtelo de nuevo o contacte al soporte.",
    monthlyOffsetErrorMessage:
      "La frecuencia mensual no pudo ser cambiada. Por favor, inténtelo de nuevo o contacte al soporte.",
  },
  ...
  workflowsEditApprovalsPage: {
    ...
    deletePrompt:
      "¿Estás seguro de que quieres eliminar este flujo de trabajo de aprobación? Todos los miembros pasarán a usar el flujo de trabajo predeterminado.",
  },
  ...
  workflowsApproverPage: {
    genericErrorMessage:
      "El aprobador no pudo ser cambiado. Por favor, inténtelo de nuevo o contacte al soporte.",
  ...
  workflowsApprovalLimitPage: {
    ...
    enterApproverError:
      "Se requiere un aprobador cuando estableces un límite de informe",
    ...
    forwardLimitDescription: ({
      ...
      `Los informes superiores a ${approvalLimit} se envían a ${approverName}`,
  },
  workflowsPayerPage: {
    title: "Pagador autorizado",
    genericErrorMessage:
      "El pagador autorizado no se pudo cambiar. Por favor, inténtalo mas tarde.",
  ...
  reportFraudConfirmationPage: {
    ...
    description:
      "Hemos desactivado permanentemente tu tarjeta existente. Cuando vuelvas a ver los detalles de tu tarjeta, tendrás una nueva tarjeta virtual disponible.",
  ...
  activateCardPage: {
    ...
    error: {
      thatDidNotMatch:
        "Los 4 últimos dígitos de tu tarjeta no coinciden. Por favor, inténtalo de nuevo.",
      throttled:
  ...
  getPhysicalCard: {
    ...
    estimatedDeliveryMessage:
      "Tu tarjeta física llegará en 2-3 días laborales.",
    next: "Siguiente",
    getPhysicalCard: "Obtener tarjeta física",
  ...
  transferAmountPage: {
    ...
    notHereSubTitle:
      "Por favor, transfiere el saldo desde la página de billetera",
  ...
  expenseRulesPage: {
    ...
    changes: {
      billableUpdate: (value: boolean) =>
        `Actualiza el gasto a ${value ? "facturable" : "no facturable"}`,
      ...
      reimbursable: (value: boolean) =>
        `el gasto a ${value ? "reembolsable" : "no reembolsable"}`,
    ...
    addRule: {
      ...
      merchantHint:
        "Escribe . para crear una regla que se aplique a todos los comercios",
    ...
    deleteRule: {
      ...
      deleteMultiplePrompt:
        "¿Estás seguro de que quieres eliminar estas reglas?",
    },
  },
  preferencesPage: {
    appSection: {
  ...
  reportDetailsPage: {
    ...
    successPDF:
      "¡Tu PDF ha sido generado! Si no se descargó automáticamente, usa el botón de abajo.",
  },
  reportDescriptionPage: {
    roomDescription: "Descripción de la sala de chat",
    roomDescriptionOptional: "Descripción de la sala de chat (opcional)",
    explainerText:
      "Establece una descripción personalizada para la sala de chat.",
  },
  groupChat: {
    lastMemberTitle: "¡Atención!",
    lastMemberWarning:
      "Ya que eres la última persona aquí, si te vas, este chat quedará inaccesible para todos los miembros. ¿Estás seguro de que quieres salir del chat?",
    defaultReportName: ({ displayName }) => `Chat de grupo de ${displayName}`,
  },
  languagePage: {
    language: "Idioma",
    aiGenerated:
      "Las traducciones para este idioma se generan automáticamente y pueden contener errores.",
  },
  themePage: {
    theme: "Tema",
    themes: {
    ...
    chooseThemeBelowOrSync:
      "Elige un tema a continuación o sincronízalo con los ajustes de tu dispositivo.",
  },
  termsOfUse: {
  ...
  validateCodeForm: {
    ...
    requestNewCode: ({ timeRemaining }) =>
      `Pedir un código nuevo en <a>${timeRemaining}</a>`,
  ...
  passwordForm: {
    ...
    enterYourTwoFactorAuthenticationCodeToContinue:
      "Introduce el código de autenticación de dos factores para continuar",
    ...
    error: {
      ...
      twoFactorAuthenticationEnabled:
        "Tienes autenticación de 2 factores activada en esta cuenta. Por favor, conéctate usando tu correo electrónico o número de teléfono.",
      invalidLoginOrPassword:
        "Usuario o clave incorrectos. Por favor, inténtalo de nuevo o restablece la contraseña.",
      ...
      noAccess:
        "No tienes acceso a esta aplicación. Por favor, añade tu usuario de GitHub para acceder.",
      accountLocked:
        "Tu cuenta ha sido bloqueada tras varios intentos fallidos. Por favor, inténtalo de nuevo dentro de una hora.",
      fallback: "Ha ocurrido un error. Por favor, inténtalo mas tarde.",
    },
  },
  loginForm: {
  ...
  onboarding: {
    ...
    welcomeSignOffTitleManageTeam:
      "Una vez que termines las tareas anteriores, podemos explorar más funcionalidades como flujos de aprobación y reglas.",
    explanationModal: {
      title: "Bienvenido a Expensify",
      description:
        "Una aplicación para gestionar en un chat todos los gastos de tu empresa y personales. Inténtalo y dinos qué te parece. ¡Hay mucho más por venir!",
      secondaryDescription:
        "Para volver a Expensify Classic, simplemente haz click en tu foto de perfil > Ir a Expensify Classic.",
    },
    getStarted: "Comenzar",
    whatsYourName: "¿Cómo te llamas?",
    peopleYouMayKnow:
      "Las personas que tal vez conozcas ya están aquí. Verifica tu correo electrónico para unirte a ellos.",
    workspaceMemberList: ({ employeeCount, policyOwner }) =>
      `${employeeCount} miembro${employeeCount > 1 ? "s" : ""} • ${policyOwner}`,
    workspaceYouMayJoin: ({ domain, email }) =>
      `Alguien de ${domain} ya ha creado un espacio de trabajo. Por favor, introduce el código mágico enviado a ${email}.`,
    joinAWorkspace: "Unirse a un espacio de trabajo",
    listOfWorkspaces:
      "Aquí está la lista de espacios de trabajo a los que puedes unirte. No te preocupes, siempre puedes unirte a ellos más tarde si lo prefieres.",
    whereYouWork: "¿Dónde trabajas?",
    errorSelection: "Selecciona una opción para continuar",
    purpose: {
      title: "¿Qué quieres hacer hoy?",
      errorContinue:
        "Por favor, haz click en continuar para configurar tu cuenta",
      errorBackButton:
        "Por favor, finaliza las preguntas de configuración para empezar a utilizar la aplicación",
      [CONST.ONBOARDING_CHOICES.EMPLOYER]: "Cobrar de mi empresa",
      [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]:
        "Gestionar los gastos de mi equipo",
      [CONST.ONBOARDING_CHOICES.PERSONAL_SPEND]:
        "Controlar y presupuestar gastos",
      [CONST.ONBOARDING_CHOICES.CHAT_SPLIT]:
        "Chatea y divide gastos con tus amigos",
    ...
    workEmail: {
      ...
      subtitle:
        "Expensify funciona mejor cuando conectas tu correo electrónico de trabajo.",
      explanationModal: {
        descriptionOne: "Reenvía a receipts@expensify.com para escanear",
        descriptionTwo:
          "Únete a tus compañeros de trabajo que ya están usando Expensify",
    ...
    workEmailValidation: {
      ...
      magicCodeSent: ({ workEmail }) =>
        `Por favor, introduce el código mágico enviado a ${workEmail}. Debería llegar en uno o dos minutos.`,
    },
    workEmailValidationError: {
      publicEmail:
        "Por favor, introduce un correo electrónico laboral válido de un dominio privado, por ejemplo: mitch@company.com",
      sameAsSignupEmail:
        "Por favor, introduce un correo electrónico diferente al que utilizaste para registrarte",
      offline:
        "No pudimos añadir tu correo electrónico laboral porque parece que estás sin conexión.",
    },
    mergeBlockScreen: {
    ...
    tasks: {
      testDriveAdminTask: {
        ...
        description: ({ testDriveURL }) =>
          `[Haz un recorrido rápido por el producto](${testDriveURL}) para ver por qué Expensify es la forma más rápida de gestionar tus gastos.`,
      },
      testDriveEmployeeTask: {
        title: ({ testDriveURL }) => `Haz una [prueba](${testDriveURL})`,
        description: ({ testDriveURL }) =>
          `Haz una [prueba](${testDriveURL}) y consigue *3 meses gratis de Expensify para tu equipo!*`,
      },
      ...
      createTestDriveAdminWorkspaceTask: {
        title: ({ workspaceConfirmationLink }) =>
          `[Crea](${workspaceConfirmationLink}) un espacio de trabajo`,
        description:
          "Crea un espacio de trabajo y configura los ajustes con la ayuda de tu especialista asignado.",
      },
      createWorkspaceTask: {
        title: ({ workspaceSettingsLink }) =>
          `Crea un [espacio de trabajo](${workspaceSettingsLink})`,
      ...
      setupCategoriesTask: {
        title: ({ workspaceCategoriesLink }) =>
          `Configura [categorías](${workspaceCategoriesLink})`,
      ...
      connectCorporateCardTask: {
        title: ({ corporateCardLink }) =>
          `Conecta [tu tarjeta corporativa](${corporateCardLink})`,
      ...
      inviteTeamTask: {
        title: ({ workspaceMembersLink }) =>
          `Invita a [tu equipo](${workspaceMembersLink})`,
      ...
      setupCategoriesAndTags: {
        title: ({ workspaceCategoriesLink, workspaceTagsLink }) =>
          `Configura [categorías](${workspaceCategoriesLink}) y [etiquetas](${workspaceTagsLink})`,
      ...
      setupTagsTask: {
        title: ({ workspaceTagsLink }) =>
          `Configura [etiquetas](${workspaceTagsLink})`,
        description: ({ workspaceMoreFeaturesLink }) =>
          dedent(`
      ...
      inviteAccountantTask: {
        title: ({ workspaceMembersLink }) =>
          `Invita a tu [contador](${workspaceMembersLink})`,
        description: ({ workspaceMembersLink }) =>
          dedent(`
      ...
      reviewWorkspaceSettingsTask: {
        title: ({ workspaceSettingsLink }) =>
          `Revisa tu [configuración del espacio de trabajo](${workspaceSettingsLink})`,
        description: ({ workspaceSettingsLink }) =>
          dedent(`
    ...
    testDrive: {
      name: ({ testDriveURL }) =>
        testDriveURL ? `Haz una [prueba](${testDriveURL})` : "Haz una prueba",
    ...
    messages: {
      onboardingEmployerOrSubmitMessage:
        "Que te reembolsen es tan fácil como enviar un mensaje. Repasemos lo básico.",
      onboardingPersonalSpendMessage:
        "Aquí tienes cómo organizar tus gastos en unos pocos clics.",
      ...
      onboardingChatSplitMessage:
        "Dividir cuentas con amigos es tan fácil como enviar un mensaje. Así se hace.",
      onboardingAdminMessage:
        "Aprende a gestionar el espacio de tu equipo como administrador y enviar tus propios gastos.",
      onboardingTestDriveReceiverMessage:
        "*¡Tienes 3 meses gratis! Empieza abajo.*",
    },
    workspace: {
      title: "Mantente organizado con un espacio de trabajo",
      subtitle:
        "Desbloquea herramientas potentes para simplificar la gestión de tus gastos, todo en un solo lugar. Con un espacio de trabajo, puedes:",
      explanationModal: {
      ...
      price:
        "Pruébalo gratis durante 30 días y luego mejora por solo <strong>$5/usuario/mes</strong>.",
      createWorkspace: "Crear espacio de trabajo",
    },
    confirmWorkspace: {
      title: "Confirmar espacio de trabajo",
      subtitle:
        "Crea un espacio de trabajo para organizar recibos, reembolsar gastos, gestionar viajes, crear informes y más, todo a la velocidad del chat.",
    },
    inviteMembers: {
      title: "Invita a miembros",
      subtitle:
        "Añade a tu equipo o invita a tu contador. ¡Cuantos más, mejor!",
    },
  },
  featureTraining: {
  ...
  privatePersonalDetails: {
    ...
    error: {
      ...
      incorrectZipFormat: (zipFormat) =>
        `Formato de código postal incorrecto.${zipFormat ? ` Formato aceptable: ${zipFormat}` : ""}`,
  ...
  unlinkLoginForm: {
    toValidateLogin: (primaryLogin, secondaryLogin) =>
      `Para validar ${secondaryLogin}, reenvía el código mágico desde la Configuración de la cuenta de ${primaryLogin}.`,
    noLongerHaveAccess: (primaryLogin) =>
      `Si ya no tienes acceso a ${primaryLogin} por favor, desvincula las cuentas.`,
    unlink: "Desvincular",
    linkSent: "¡Enlace enviado!",
    successfullyUnlinkedLogin:
      "¡Nombre de usuario secundario desvinculado correctamente!",
  },
  ...
  smsDeliveryFailurePage: {
    smsDeliveryFailureMessage: (login) =>
    ...
    validationSuccess:
      "¡Tu número ha sido validado! Haz clic abajo para enviar un nuevo código mágico de inicio de sesión.",
    validationFailed: ({ timeData }) => {
      ...
      if (timeData.days) {
        timeParts.push(
          `${timeData.days} ${timeData.days === 1 ? "día" : "días"}`,
        );
      }

      if (timeData.hours) {
        timeParts.push(
          `${timeData.hours} ${timeData.hours === 1 ? "hora" : "horas"}`,
        );
      }

      if (timeData.minutes) {
        timeParts.push(
          `${timeData.minutes} ${timeData.minutes === 1 ? "minuto" : "minutos"}`,
        );
      }
  ...
  notFound: {
    ...
    noAccess:
      "Es posible que este chat o gasto haya sido eliminado o que no tengas acceso a él. \n\nPara cualquier consulta, contáctanos a través de concierge@expensify.com",
    goBackHome: "Volver a la página principal",
    commentYouLookingForCannotBeFound:
      "No se puede encontrar el comentario que estás buscando. Vuelve al chat",
    contactConcierge:
      "Para cualquier consulta, contáctanos a través de concierge@expensify.com",
  ...
  errorPage: {
    ...
    wrongTypeSubtitle:
      "Esa búsqueda no es válida. Intenta ajustar tus criterios de búsqueda.",
  },
  statusPage: {
    status: "Estado",
    statusExplanation:
      "Añade un emoji para que tus colegas y amigos puedan saber fácilmente qué está pasando. ¡También puedes añadir un mensaje opcionalmente!",
    today: "Hoy",
    ...
    setVacationDelegate:
      "Configura un delegado de vacaciones para aprobar informes en tu nombre mientras estás fuera de la oficina.",
    ...
    vacationDelegateError:
      "Hubo un error al actualizar tu delegado de vacaciones.",
    asVacationDelegate: ({ nameOrEmail: managerName }) =>
      `como delegado de vacaciones de ${managerName}`,
    toAsVacationDelegate: (submittedToName, vacationDelegateName) =>
      `a ${submittedToName} como delegado de vacaciones de ${vacationDelegateName}`,
  ...
  bankAccount: {
    ...
    thisBankAccount:
      "Esta cuenta bancaria se utilizará para pagos comerciales en tu espacio de trabajo",
    ...
    desktopConnection:
      "Para conectarse con Chase, Wells Fargo, Capital One o Bank of America, haz clic aquí para completar este proceso en un navegador.",
    yourDataIsSecure: "Tus datos están seguros",
    toGetStarted:
      "Conecta una cuenta bancaria para reembolsar gastos, emitir Tarjetas Expensify, y cobrar y pagar facturas todo desde un mismo lugar.",
    plaidBodyCopy:
      "Ofrezca a sus empleados una forma más sencilla de pagar - y recuperar - los gastos de la empresa.",
    checkHelpLine:
      "Tus números de ruta y de cuenta se pueden encontrar en un cheque de la cuenta bancaria.",
    ...
    error: {
      ...
      addressStreet:
        "Por favor, introduce una dirección válida que no sea un apartado postal",
      addressState: "Por favor, selecciona un estado",
      ...
      industryCode:
        "Por favor, introduce un código de clasificación de industria válido",
      restrictedBusiness:
        "Por favor, confirma que la empresa no está en la lista de negocios restringidos",
      ...
      routingAndAccountNumberCannotBeSame:
        "Los números de ruta y de cuenta no pueden ser iguales",
      ...
      ssnLast4:
        "Por favor, introduce los últimos 4 dígitos del número de seguridad social",
      ...
      noDefaultDepositAccountOrDebitCardAvailable:
        "Por favor, añade una cuenta bancaria para depósitos o una tarjeta de débito",
      validationAmounts:
        "Los importes de validación que introduciste son incorrectos. Por favor, comprueba tu cuenta bancaria e inténtalo de nuevo.",
      ...
      sameDepositAndWithdrawalAccount:
        "Las cuentas de depósito y retiro son las mismas.",
    },
  },
  addPersonalBankAccount: {
    ...
    accountHolderInformationStepHeader:
      "¿Cuáles son los detalles del titular de la cuenta?",
    ...
    confirmationStepSubHeader:
      "Verifica dos veces los detalles a continuación y marca la casilla de términos para confirmar.",
    toGetStarted:
      "Agrega una cuenta bancaria personal para recibir reembolsos, pagar facturas o habilitar la Cartera de Expensify.",
  },
  ...
  messages: {
    ...
    userIsAlreadyMember: ({ login, name }) =>
      `${login} ya es miembro de ${name}`,
    userIsAlreadyAnAdmin: ({ login, name }) =>
      `${login} ya es administrador de ${name}`,
  },
  onfidoStep: {
    acceptTerms:
      "Al continuar con la solicitud para activar tu Billetera Expensify, confirma que ha leído, comprende y acepta ",
    ...
    butFirst:
      'Pero primero, lo aburrido. Lee la jerga legal en el siguiente paso y haz clic en "Aceptar" cuando estés listo.',
    genericError:
      "Se ha producido un error al procesar este paso. Inténtalo de nuevo.",
    cameraPermissionsNotGranted: "Permiso para acceder a la cámara",
    cameraRequestMessage:
      "Necesitamos acceso a tu cámara para completar la verificación de tu cuenta de banco. Por favor habilita los permisos en Configuración > New Expensify.",
    microphonePermissionsNotGranted: "Permiso para acceder al micrófono",
    microphoneRequestMessage:
      "Necesitamos acceso a tu micrófono para completar la verificación de tu cuenta de banco. Por favor habilita los permisos en Configuración > New Expensify.",
  ...
  additionalDetailsStep: {
    ...
    helpTextIdologyQuestions:
      "Tenemos que preguntarte unas preguntas más para terminar de verificar tu identidad",
    ...
    ssnFull9Error:
      "Por favor, introduce los 9 dígitos de un número de seguridad social válido",
    needSSNFull9:
      "Estamos teniendo problemas para verificar tu número de seguridad social. Introduce los 9 dígitos del número de seguridad social.",
  ...
  termsStep: {
    ...
    haveReadAndAgreePlain:
      "He leído y acepto recibir divulgaciones electrónicas.",
    haveReadAndAgree: `He leído y acepto recibir <a href="${CONST.ELECTRONIC_DISCLOSURES_URL}">divulgaciones electrónicas</a>.`,
    agreeToThePlain:
      "Estoy de acuerdo con el Privacidad y Acuerdo de la billetera.",
    ...
    shortTermsForm: {
      expensifyPaymentsAccount: ({ walletProgram }) =>
        `La Billetera Expensify es emitida por ${walletProgram}.`,
      ...
      inactivityAfterTwelveMonths:
        "Inactividad (después de 12 meses sin transacciones)",
      ...
      electronicFundsWithdrawalInstant:
        "Retiro electrónico de fondos (instantáneo)",
    ...
    longTermsForm: {
      ...
      sendingFundsDetails:
        "No se aplica ningún cargo por enviar fondos a otro titular de cuenta utilizando tu saldo cuenta bancaria o tarjeta de débito",
  ...
  activateStep: {
    ...
    checkBackLaterMessage:
      "Todavía estamos revisando tu información. Por favor, vuelve más tarde.",
  ...
  companyStep: {
    ...
    industryClassificationCodePlaceholder:
      "Buscar código de clasificación industrial",
  },
  requestorStep: {
  ...
  personalInfoStep: {
    ...
    enterTheLast4:
      "¿Cuáles son los últimos 4 dígitos de tu número de la seguridad social?",
    dontWorry:
      "No te preocupes, no hacemos verificaciones de crédito personales.",
    ...
    byAddingThisBankAccount:
      "Añadiendo esta cuenta bancaria, confirmas que has leído, entendido y aceptado",
  ...
  businessInfoStep: {
    ...
    companyWebsite: "Página web de la empresa",
    enterYourCompanyPhoneNumber:
      "¿Cuál es el número de teléfono de tu empresa?",
    ...
    selectYourCompanyIncorporationDate:
      "¿Cuál es la fecha de constitución de la empresa?",
    ...
    pleaseSelectTheStateYourCompanyWasIncorporatedIn:
      "¿Cuál es el estado en el que se constituyó la empresa?",
    letsDoubleCheck: "Verifiquemos que todo esté correcto",
    ...
    whatsTheBusinessContactInformation:
      "¿Cuál es la información de contacto de la empresa?",
    ...
    whatsTheBusinessAnnualPayment:
      "¿Cuál es el volumen anual de pagos de la empresa?",
    whatsYourExpectedAverageReimbursements:
      "¿Cuál es el monto promedio esperado de reembolso?",
    ...
    annualPaymentVolumeInCurrency: (currencyCode) =>
      `Volumen anual de pagos en ${currencyCode}`,
    averageReimbursementAmount: "Monto promedio de reembolso",
    averageReimbursementAmountInCurrency: (currencyCode) =>
      `Monto promedio de reembolso en ${currencyCode}`,
  ...
  beneficialOwnerInfoStep: {
    doYouOwn25percent: (companyName) =>
      `¿Posee el 25% o más de ${companyName}?`,
    doAnyIndividualOwn25percent: (companyName) =>
      `¿Alguien posee el 25% o más de ${companyName}?`,
    areThereMoreIndividualsWhoOwn25percent: (companyName) =>
      `¿Hay más personas que posean el 25% o más de ${companyName}?`,
    regulationRequiresUsToVerifyTheIdentity:
      "La ley nos exige verificar la identidad de cualquier persona que posea más del 25% de la empresa.",
    ...
    enterTheLast4:
      "¿Cuáles son los últimos 4 dígitos del número de la seguridad social del dueño?",
    last4SSN: "Últimos 4 dígitos del número de la seguridad social",
    dontWorry:
      "No te preocupes, ¡no realizamos verificaciones de crédito personales!",
    enterTheOwnersAddress: "¿Cuál es la dirección del dueño?",
    letsDoubleCheck: "Vamos a verificar que todo esté correcto.",
    legalName: "Nombre legal",
    address: "Dirección",
    byAddingThisBankAccount:
      "Al añadir esta cuenta bancaria, confirmas que has leído, comprendido y aceptado",
    owners: "Dueños",
  },
  ownershipInfoStep: {
    ...
    doesAnyoneOwn: (companyName) =>
      `¿Alguien posee el 25% o más de ${companyName}?`,
    regulationsRequire:
      "Las regulaciones requieren que verifiquemos la identidad de cualquier persona que posea más del 25% del negocio.",
    legalFirstName: "Nombre legal",
    ...
    whatAreTheLast:
      "¿Cuáles son los últimos 4 dígitos del número de seguro social del propietario?",
    whatsYourLast:
      "¿Cuáles son los últimos 4 dígitos de su número de seguro social?",
    whatsYourNationality: "¿Cuál es tu país de ciudadanía?",
    whatsTheOwnersNationality:
      "¿Cuál es el país de ciudadanía del propietario?",
    countryOfCitizenship: "País de ciudadanía",
    dontWorry:
      "No se preocupe, ¡no realizamos ninguna verificación de crédito personal!",
    last4: "Últimos 4 del SSN",
    whyDoWeAsk: "¿Por qué solicitamos esto?",
    letsDoubleCheck: "Verifiquemos que todo esté correcto.",
    legalName: "Nombre legal",
    ownershipPercentage: "Porcentaje de propiedad",
    areThereOther: (companyName) =>
      `¿Hay otras personas que posean el 25% o más de ${companyName}?`,
    owners: "Propietarios",
    addCertified:
      "Agregue un organigrama certificado que muestre los propietarios beneficiarios",
    regulationRequiresChart:
      "La regulación nos exige recopilar una copia certificada del organigrama que muestre a cada persona o entidad que posea el 25% o más del negocio.",
    uploadEntity: "Subir organigrama de propiedad de la entidad",
    noteEntity:
      "Nota: El organigrama de propiedad de la entidad debe estar firmado por su contador, asesor legal o notariado.",
    ...
    acceptedFiles:
      "Formatos de archivo aceptados: PDF, PNG, JPEG. El tamaño total del archivo para cada sección no puede superar los 5 MB.",
    ...
    proofOfAddressDescription:
      "Ejemplos: Factura de servicios, contrato de alquiler, etc.",
  ...
  completeVerificationStep: {
    ...
    certifyTrueAndAccurate:
      "Certifico que la información dada es verdadera y precisa",
    certifyTrueAndAccurateError:
      "Por favor, certifica que la información es verdadera y exacta",
    isAuthorizedToUseBankAccount:
      "Estoy autorizado para usar la cuenta bancaria de mi empresa para gastos de empresa",
    isAuthorizedToUseBankAccountError:
      "Debes ser el responsable oficial con autorización para operar la cuenta bancaria de la empresa",
  ...
  connectBankAccountStep: {
    ...
    maxAttemptsReached:
      "La validación de esta cuenta bancaria se ha desactivado debido a demasiados intentos incorrectos.",
    description:
      'Enviaremos tres (3) pequeñas transacciones a tu cuenta bancaria a nombre de "Expensify, Inc. Validation" dentro de los próximos 1-2 días laborables.',
    descriptionCTA:
      "Introduce el importe de cada transacción en los campos siguientes. Ejemplo: 1.51.",
    letsChatText:
      "¡Ya casi estamos! Necesitamos tu ayuda para verificar unos últimos datos a través del chat. ¿Estás listo?",
    enable2FATitle: "¡Evita fraudes, activa la autenticación de dos factores!",
    enable2FAText:
      "Tu seguridad es importante para nosotros. Por favor, configura ahora la autenticación de dos factores para añadir una capa adicional de protección a tu cuenta.",
    secureYourAccount: "Asegura tu cuenta",
  },
  countryStep: {
    confirmBusinessBank:
      "Confirmar moneda y país de la cuenta bancaria comercial",
    confirmCurrency: "Confirmar moneda y país",
    yourBusiness:
      "La moneda de su cuenta bancaria comercial debe coincidir con la moneda de su espacio de trabajo.",
  ...
  signerInfoStep: {
    ...
    regulationRequiresUs:
      "La regulación requiere que verifiquemos si el firmante tiene la autoridad para realizar esta acción en nombre de la empresa.",
    ...
    personalAddress:
      "Prueba de domicilio personal (por ejemplo, factura de servicios públicos)",
    letsDoubleCheck: "Vamos a verificar que todo esté correcto.",
    legalName: "Nombre legal",
    proofOf: "Comprobante de domicilio personal",
    enterOneEmail: (companyName) =>
      `Introduce el correo electrónico del director en ${companyName}`,
    regulationRequiresOneMoreDirector:
      "El reglamento exige que haya otro director como firmante.",
    hangTight: "Espera un momento...",
    enterTwoEmails: (companyName) =>
      `Introduce los correos electrónicos de dos directores en ${companyName}`,
    sendReminder: "Enviar un recordatorio",
    chooseFile: "Seleccionar archivo",
    weAreWaiting:
      "Estamos esperando que otros verifiquen sus identidades como directores de la empresa.",
    id: "Copia de identificación",
    proofOfDirectors: "Prueba de director(es)",
    proofOfDirectorsDescription:
      "Ejemplos: Perfil Corporativo de Oncorp o Registro Comercial.",
    codiceFiscale: "Codice Fiscale",
    codiceFiscaleDescription:
      "Codice Fiscale para firmantes, usuarios autorizados y beneficiarios finales.",
    ...
    pleaseUpload:
      "Sube documentación adicional a continuación para ayudarnos a verificar tu identidad como director de la empresa.",
  ...
  agreementsStep: {
    ...
    regulationRequiresUs:
      "La normativa requiere que verifiquemos la identidad de cualquier individuo que posea más del 25% del negocio.",
    iAmAuthorized:
      "Estoy autorizado para usar la cuenta bancaria para gastos del negocio.",
    iCertify:
      "Certifico que la información proporcionada es verdadera y correcta.",
    ...
    iConsentToThePrivacyNotice:
      'Doy mi consentimiento para el <a href="https://payments.corpay.com/compliance">aviso de privacidad</a>.',
    iConsentToThePrivacyNoticeAccessibility:
      "Doy mi consentimiento para el aviso de privacidad.",
    error: {
      authorized:
        "Debe ser un funcionario controlador con autorización para operar la cuenta bancaria comercial",
  ...
  docusignStep: {
    ...
    pleaseCompleteTheBusinessAccount:
      "Por favor, complete la Solicitud de Cuenta Comercial y el Acuerdo de Débito Directo.",
    ...
    pleaseUpload:
      "Por favor, cargue el formulario DEFT y la página de firma de Docusign.",
    pleaseUploadTheDirect:
      "Por favor, cargue los Acuerdos de Débito Directo y la página de firma de Docusign.",
  },
  finishStep: {
    ...
    enable2FA:
      "Habilite la autenticación de dos factores (2FA) para prevenir fraudes",
    weTake:
      "Nos tomamos su seguridad en serio. Por favor, configure 2FA ahora para agregar una capa adicional de protección a su cuenta.",
  ...
  session: {
    offlineMessageRetry:
      "Parece que estás desconectado. Por favor, comprueba tu conexión e inténtalo de nuevo.",
  },
  travel: {
    header: "Reservar viajes",
    title: "Viaja de forma inteligente",
    subtitle:
      "Utiliza Expensify Travel para obtener las mejores ofertas de viaje y gestionar todos los gastos de tu negocio en un solo lugar.",
    features: {
    ...
    flightDetails: {
      passenger: "Pasajero",
      layover: (layover) =>
        `<muted-text-label>Tienes una <strong>escala de ${layover}</strong> antes de este vuelo</muted-text-label>`,
      takeOff: "Despegue",
      landing: "Aterrizaje",
      seat: "Asiento",
    ...
    phoneError: (phoneErrorMethodsRoute) =>
    ...
    publicDomainError: {
      ...
      message:
        "Tendrás que usar tu correo electrónico laboral (por ejemplo, nombre@empresa.com) con Expensify Travel, no tu correo personal (por ejemplo, nombre@gmail.com).",
    },
    blockedFeatureModal: {
      title: "Expensify Travel ha sido deshabilitado",
      message:
        "Tu administrador ha desactivado Expensify Travel. Por favor, sigue la política de reservas de tu empresa para organizar tus viajes.",
    },
    verifyCompany: {
      ...
      conciergeMessage: ({ domain }) =>
        `Hubo un error habilitando viajes para el dominio: ${domain}. Por favor, revisa y habilita los viajes para este dominio.`,
    },
    updates: {
      bookingTicketed: (
        airlineCode,
      ...
      ticketVoided: (airlineCode, origin, destination, startDate) =>
      ...
      flightCancelled: (airlineCode, origin, destination, startDate) =>
        `Tu vuelo ${airlineCode} (${origin} → ${destination}) del ${startDate} ha sido cancelado por la aerolínea.`,
      flightScheduleChangePending: (airlineCode) =>
        `La aerolínea ha propuesto un cambio de horario para el vuelo ${airlineCode}; estamos esperando la confirmación.`,
      flightScheduleChangeClosed: (airlineCode, startDate) =>
        `Cambio de horario confirmado: el vuelo ${airlineCode} ahora sale a las ${startDate}.`,
      flightUpdated: (airlineCode, origin, destination, startDate) =>
        `Tu vuelo ${airlineCode} (${origin} → ${destination}) del ${startDate} ha sido actualizado.`,
      flightCabinChanged: (airlineCode, cabinClass) =>
        `Tu clase de cabina ha sido actualizada a ${cabinClass} en el vuelo ${airlineCode}.`,
      flightSeatConfirmed: (airlineCode) =>
        `Tu asignación de asiento en el vuelo ${airlineCode} ha sido confirmada.`,
      flightSeatChanged: (airlineCode) =>
        `Tu asignación de asiento en el vuelo ${airlineCode} ha sido modificada.`,
      flightSeatCancelled: (airlineCode) =>
        `Tu asignación de asiento en el vuelo ${airlineCode} fue eliminada.`,
      paymentDeclined:
        "El pago de tu reserva aérea ha fallado. Por favor, inténtalo de nuevo.",
      bookingCancelledByTraveler: (type, id = "") =>
        `Cancelaste tu reserva de ${type} ${id}.`,
      bookingCancelledByVendor: (type, id = "") =>
        `El proveedor canceló tu reserva de ${type} ${id}.`,
      bookingRebooked: (type, id = "") =>
        `Tu reserva de ${type} fue reprogramada. Nuevo número de confirmación: ${id}.`,
      bookingUpdated: (type) =>
        `Tu reserva de ${type} fue actualizada. Revisa los nuevos detalles en el itinerario.`,
      railTicketRefund: (origin, destination, startDate) =>
        `Tu billete de tren de ${origin} a ${destination} para el ${startDate} ha sido reembolsado. Se procesará un crédito.`,
      railTicketExchange: (origin, destination, startDate) =>
        `Tu billete de tren de ${origin} a ${destination} para el ${startDate} ha sido cambiado.`,
      railTicketUpdate: (origin, destination, startDate) =>
  ...
  proactiveAppReview: {
    ...
    description:
      "Dínoslo para que podamos ayudarte a mejorar tu experiencia de gestión de gastos.",
    positiveButton: "¡Sí!",
  ...
  workspace: {
    common: {
      ...
      customFieldHint:
        "Añade una codificación personalizada que se aplique a todos los gastos de este miembro.",
      reports: "Informes",
      ...
      deleteWithCardsConfirmation:
        "¿Estás seguro de que quieres eliminar este espacio de trabajo? Se eliminarán todos los datos de las tarjetas y las tarjetas asignadas.",
      ...
      memberNotFound:
        "Miembro no encontrado. Para invitar a un nuevo miembro al espacio de trabajo, por favor, utiliza el botón invitar que está arriba.",
      ...
      mustBeOnlineToViewMembers:
        "Debes estar en línea para poder ver los miembros de este espacio de trabajo.",
      ...
      descriptionHint:
        "Comparte información sobre este espacio de trabajo con todos los miembros.",
      ...
      exportIntegrationSelected: ({ connectionName }) =>
        `Exportar a  ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      letsDoubleCheck: "Verifiquemos que todo esté correcto",
      reportField: "Campo del informe",
      lineItemLevel: "Nivel de partida",
      reportLevel: "Nivel de informe",
      appliedOnExport:
        "No se importa en Expensify, se aplica en la exportación",
      shareNote: {
      ...
      connectTo: ({ connectionName }) =>
        `Conéctate a ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      ...
      lastSyncDate: (connectionName, formattedDate) =>
        `${connectionName} - Última sincronización ${formattedDate}`,
      topLevel: "Nivel superior",
      authenticationError: (connectionName) =>
        `No se puede conectar a ${connectionName} debido a un error de autenticación.`,
      learnMore: "Más información",
      memberAlternateText: "Presentar y aprobar informes.",
      adminAlternateText:
        "Gestionar informes y configuración del área de trabajo.",
    ...
    receiptPartners: {
      uber: {
        subtitle: (organizationName) =>
          organizationName
            ? `Conectado a ${organizationName}`
            : "Automatice los gastos de viajes y entrega de comidas en toda su organización.",
        sendInvites: "Invitar miembros",
        sendInvitesDescription:
          "Estos miembros del workspace aún no tienen una cuenta de Uber for Business. Deselecciona cualquier miembro que no desees invitar en este momento.",
        ...
        takeBusinessRideMessage:
          "Toma un viaje de negocios y tus recibos de Uber se importarán a Expensify. ¡Vámonos!",
        all: "Todos",
        linked: "Vinculado",
        outstanding: "Pendiente",
        status: {
          ...
          [CONST.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS
            .LINKED_PENDING_APPROVAL]: "Pendiente",
        ...
        centralBillingDescription:
          "Elija dónde importar todos los recibos de Uber.",
        invitationFailure: "Error al invitar miembro a Uber for Business",
        autoInvite:
          "Invitar a nuevos miembros del espacio de trabajo a Uber para Empresas",
        autoRemove:
          "Desactivar miembros del espacio de trabajo eliminados de Uber para Empresas",
        emptyContent: {
          title: "No hay invitaciones pendientes",
          subtitle:
            "¡Hurra! Buscamos por todas partes y no encontramos ninguna invitación pendiente.",
        },
      },
    },
    perDiem: {
      ...
      emptyList: {
        title: "Per diem",
        subtitle:
          "Establece dietas per diem para controlar el gasto diario de los empleados. Importa las tarifas desde una hoja de cálculo para comenzar.",
      },
      ...
      editDestinationSubtitle: (destination) =>
        `Actualizar este destino lo modificará para todas las subtasas per diem de ${destination}.`,
      editCurrencySubtitle: (destination) =>
        `Actualizar esta moneda la modificará para todas las subtasas per diem de ${destination}.`,
    },
    qbd: {
      exportOutOfPocketExpensesDescription:
        "Establezca cómo se exportan los gastos de bolsillo a QuickBooks Desktop.",
      exportOutOfPocketExpensesCheckToggle:
        "Marcar los cheques como “imprimir más tarde”",
      exportDescription:
        "Configura cómo se exportan los datos de Expensify a QuickBooks Desktop.",
      date: "Fecha de exportación",
      exportInvoices: "Exportar facturas a",
      exportExpensifyCard:
        "Exportar las transacciones de la tarjeta Expensify como",
      account: "Cuenta",
      accountDescription: "Elige dónde contabilizar los asientos contables.",
      accountsPayable: "Cuentas por pagar",
      accountsPayableDescription:
        "Elige dónde crear las facturas de proveedores.",
      bankAccount: "Cuenta bancaria",
      ...
      exportDate: {
        ...
        description:
          "Usa esta fecha al exportar informes a QuickBooks Desktop.",
        values: {
          ...
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Fecha de exportación",
            description:
              "Fecha de exportación del informe a QuickBooks Desktop.",
          },
      ...
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}AccountDescription`]:
          "Elige desde dónde enviar los cheques.",
      ...
      noAccountsFoundDescription:
        "Añade la cuenta en QuickBooks Desktop y sincroniza de nuevo la conexión",
      qbdSetup: "Configuración de QuickBooks Desktop",
      requiredSetupDevice: {
        title: "No se puede conectar desde este dispositivo",
        body1:
          "Deberás configurar esta conexión desde la computadora que hospeda tu archivo de empresa de QuickBooks Desktop.",
        body2:
          "Una vez que estés conectado, podrás sincronizar y exportar desde cualquier lugar.",
      },
      setupPage: {
      ...
      importDescription:
        "Elige que configuraciónes de codificación son importadas desde QuickBooks Desktop a Expensify.",
      classes: "Clases",
      items: "Artículos",
      customers: "Clientes/proyectos",
      exportCompanyCardsDescription:
        "Establece cómo se exportan las compras con tarjeta de empresa a QuickBooks Desktop.",
      defaultVendorDescription:
        "Establece un proveedor predeterminado que se aplicará a todas las transacciones con tarjeta de crédito al momento de exportarlas.",
      accountsDescription:
        "Tu plan de cuentas de QuickBooks Desktop se importará a Expensify como categorías.",
      accountsSwitchTitle:
        "Elige importar cuentas nuevas como categorías activadas o desactivadas.",
      accountsSwitchDescription:
        "Las categorías activas estarán disponibles para ser escogidas cuando se crea un gasto.",
      classesDescription:
        "Elige cómo gestionar las clases de QuickBooks Desktop en Expensify.",
      tagsDisplayedAsDescription: "Nivel de partida",
      reportFieldsDisplayedAsDescription: "Nivel de informe",
      customersDescription:
        "Elige cómo gestionar los clientes/proyectos de QuickBooks Desktop en Expensify.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify se sincronizará automáticamente con QuickBooks Desktop todos los días.",
        createEntities: "Crear entidades automáticamente",
        createEntitiesDescription:
          "Expensify creará automáticamente proveedores en QuickBooks Desktop si aún no existen.",
      },
      itemsDescription:
        "Elige cómo gestionar los elementos de QuickBooks Desktop en Expensify.",
      accountingMethods: {
    ...
    qbo: {
      ...
      importDescription:
        "Elige que configuraciónes de codificación son importadas desde QuickBooks Online a Expensify.",
      classes: "Clases",
      locations: "Lugares",
      customers: "Clientes/proyectos",
      accountsDescription:
        "Tu plan de cuentas de QuickBooks Online se importará a Expensify como categorías.",
      accountsSwitchTitle:
        "Elige importar cuentas nuevas como categorías activadas o desactivadas.",
      accountsSwitchDescription:
        "Las categorías activas estarán disponibles para ser escogidas cuando se crea un gasto.",
      classesDescription:
        "Elige cómo gestionar las clases de QuickBooks Online en Expensify.",
      customersDescription:
        "Elige cómo gestionar los clientes/proyectos de QuickBooks Online en Expensify.",
      locationsDescription:
        "Elige cómo gestionar los lugares de QuickBooks Online en Expensify.",
      ...
      taxesDescription:
        "Elige cómo gestionar los impuestos de QuickBooks Online en Expensify.",
      ...
      exportInvoices: "Exportar facturas a",
      exportDescription:
        "Configura cómo se exportan los datos de Expensify a QuickBooks Online.",
      date: "Fecha de exportación",
      exportExpensifyCard:
        "Exportar las transacciones de las tarjetas Expensify como",
      exportDate: {
        label: "Fecha de exportación",
        ...
        values: {
          ...
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Fecha de exportación",
            description:
              "Fecha de exportación del informe a QuickBooks Online.",
          },
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_SUBMITTED]: {
            label: "Fecha de envío",
            description:
              "Fecha en la que el informe se envió para tu aprobación.",
          },
        },
      },
      ...
      exportInvoicesDescription:
        "Usa esta cuenta al exportar facturas a QuickBooks Online.",
      exportCompanyCardsDescription:
        "Establece cómo se exportan las compras con tarjeta de empresa a QuickBooks Online.",
      account: "Cuenta",
      accountDescription: "Elige dónde contabilizar los asientos contables.",
      vendor: "Proveedor",
      defaultVendorDescription:
      ...
      exportOutOfPocketExpensesDescription:
        "Establezca cómo se exportan los gastos de bolsillo a QuickBooks Online.",
      exportCheckDescription:
        "Crearemos un cheque desglosado para cada informe de Expensify y lo enviaremos desde la cuenta bancaria a continuación.",
      exportJournalEntryDescription:
        "Crearemos una entrada contable desglosada para cada informe de Expensify y lo contabilizaremos en la cuenta a continuación.",
      ...
      outOfPocketTaxEnabledError:
        "La anotacion en el diario no está disponible cuando los impuestos están activados. Por favor, selecciona otra opción de exportación diferente.",

      advancedConfig: {
        autoSyncDescription:
          "Expensify se sincronizará automáticamente con QuickBooks Online todos los días.",
        inviteEmployees: "Invitar empleados",
        inviteEmployeesDescription:
          "Importe los registros de los empleados de QuickBooks Online e invítelos a este espacio de trabajo.",
        createEntities: "Crear entidades automáticamente",
        createEntitiesDescription:
          "Expensify creará automáticamente proveedores en QuickBooks Online si aún no existen, y creará automáticamente clientes al exportar facturas.",
        ...
        accountSelectDescription:
          "Elige desde dónde pagar las facturas y crearemos el pago en QuickBooks Online.",
        invoiceAccountSelectorDescription:
          "Elige dónde recibir los pagos de facturas y crearemos el pago en QuickBooks Online.",
      },
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]:
          "Elige dónde exportar las transacciones con tarjeta de débito.",
      ...
      exportDestinationAccountsMisconfigurationError: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Elige una cuenta válida para la exportación de facturas de proveedor",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Elige una cuenta válida para la exportación de asientos contables",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Elige una cuenta válida para la exportación de cheques",
      },
      exportDestinationSetupAccountsInfo: {
        ...
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Para usar la exportación de cheques, configura una cuenta bancaria en QuickBooks Online",
      },
      noAccountsFound: "No se ha encontrado ninguna cuenta",
      noAccountsFoundDescription:
        "Añade la cuenta en QuickBooks Online y sincroniza de nuevo la conexión.",
      accountingMethods: {
        label: "Cuándo Exportar",
        description: "Elige cuándo exportar los gastos:",
        values: {
    ...
    xero: {
      ...
      organizationDescription:
        "Seleccione la organización en Xero desde la que está importando los datos.",
      importDescription:
        "Elija qué configuraciones de codificación se importan de Xero a Expensify.",
      accountsDescription:
        "Tu plan de cuentas de Xero se importará a Expensify como categorías.",
      accountsSwitchTitle:
        "Elige importar cuentas nuevas como categorías activadas o desactivadas.",
      accountsSwitchDescription:
        "Las categorías activas estarán disponibles para ser escogidas cuando se crea un gasto.",
      ...
      trackingCategoriesDescription:
        "Elige cómo gestionar categorías de seguimiento de Xero en Expensify.",
      mapTrackingCategoryTo: (categoryName) =>
        `Asignar ${categoryName} de Xero a`,
      mapTrackingCategoryToDescription: (categoryName) =>
        `Elige dónde mapear ${categoryName} al exportar a Xero.`,
      ...
      exportExpensesDescription:
        "Los informes se exportarán como una factura de compra utilizando la fecha y el estado que seleccione a continuación",
      purchaseBillDate: "Fecha de la factura de compra",
      exportInvoices: "Exportar facturas como",
      salesInvoice: "Factura de venta",
      exportInvoicesDescription:
        "Las facturas de venta siempre muestran la fecha en la que se envió la factura.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify se sincronizará automáticamente con Xero todos los días.",
        ...
        xeroBillPaymentAccountDescription:
          "Elige desde dónde pagar las facturas y crearemos el pago en Xero.",
        invoiceAccountSelectorDescription:
          "Elige dónde recibir los pagos de facturas y crearemos el pago en Xero.",
      },
      exportDate: {
        ...
        values: {
          ...
          [CONST.XERO_EXPORT_DATE.REPORT_SUBMITTED]: {
            label: "Fecha de envío",
            description:
              "Fecha en la que el informe se envió para su aprobación.",
          },
        },
      },
      invoiceStatus: {
      ...
      noAccountsFound: "No se ha encontrado ninguna cuenta",
      noAccountsFoundDescription:
        "Añade la cuenta en Xero y sincroniza de nuevo la conexión",
      accountingMethods: {
        label: "Cuándo Exportar",
        description: "Elige cuándo exportar los gastos:",
        values: {
    ...
    sageIntacct: {
      ...
      exportDate: {
        label: "Fecha de exportación",
        description:
          "Utilice esta fecha cuando exporte informes a Sage Intacct.",
        values: {
          ...
          [CONST.SAGE_INTACCT_EXPORT_DATE.EXPORTED]: {
            label: "Fecha de exportación",
            description:
              "Fecha en la que se exportó el informe a Sage Intacct.",
          },
          [CONST.SAGE_INTACCT_EXPORT_DATE.SUBMITTED]: {
            label: "Fecha de envío",
            description:
              "Fecha de presentación del informe para su aprobación.",
          },
        },
      },
      reimbursableExpenses: {
        description:
          "Establece cómo se exportan los gastos por cuenta propia a Sage Intacct.",
        values: {
      ...
      exportDescription:
        "Configure cómo se exportan los datos de Expensify a Sage Intacct.",
      ...
      exportPreferredExporterSubNote:
        "Una vez configurado, el exportador preferido verá los informes para exportar en su cuenta.",
      noAccountsFound: "No se ha encontrado ninguna cuenta",
      noAccountsFoundDescription:
        "Añade la cuenta en Sage Intacct y sincroniza de nuevo la conexión",
      autoSync: "Sincronización automática",
      autoSyncDescription:
        "Sincronice Sage Intacct y Expensify automáticamente, todos los días.",
    ...
    netsuite: {
      ...
      exportDescription:
        "Configura cómo se exportan los datos de Expensify a NetSuite.",
      exportInvoices: "Exportar facturas a",
      journalEntriesTaxPostingAccount:
        "Cuenta de registro de impuestos de asientos contables",
      journalEntriesProvTaxPostingAccount:
        "Cuenta de registro de impuestos provinciales de asientos contables",
      ...
      nonReimbursableJournalPostingAccount:
        "Cuenta de registro de diario no reembolsable",
      reimbursableJournalPostingAccount:
        "Cuenta de registro de diario reembolsable",
      journalPostingPreference: {
        ...
        values: {
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            ...
            "Entrada única y detallada para cada informe",
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            .JOURNALS_POSTING_TOTAL_LINE]:
            "Entrada única para cada gasto individual",
        },
      },
      invoiceItem: {
        ...
        values: {
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
            ...
            description:
              "Crearemos un 'Artículo de línea de factura de Expensify' para ti al exportar (si aún no existe).",
          },
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.SELECT]: {
            label: "Seleccionar existente",
            description:
              "Asociaremos las facturas de Expensify al artículo seleccionado a continuación.",
          },
        },
      },
      exportDate: {
        ...
        values: {
          [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
            ...
            reimbursableDescription:
              "Los gastos reembolsables se exportarán como informes de gastos a NetSuite.",
            nonReimbursableDescription:
              "Los gastos no reembolsables se exportarán como informes de gastos a NetSuite.",
          },
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify se sincronizará automáticamente con NetSuite todos los días.",
        reimbursedReportsDescription:
        ...
        reimbursementsAccountDescription:
          "Elija la cuenta bancaria que utilizará para los reembolsos y crearemos el pago asociado en NetSuite.",
        collectionsAccount: "Cuenta de cobros",
        collectionsAccountDescription:
          "Una vez que una factura se marca como pagada en Expensify y se exporta a NetSuite, aparecerá contra la cuenta de abajo.",
        ...
        exportVendorBillsTo: {
          ...
          values: {
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              ...
              "Preferencia predeterminada de NetSuite",
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVAL_PENDING]: "Aprobación pendiente",
        ...
        exportJournalsTo: {
          ...
          description:
            "Una vez aprobado un asiento en Expensify y exportado a NetSuite, puede establecer un nivel adicional de aprobación en NetSuite antes de contabilizarlo.",
          values: {
        ...
        error: {
          customFormID:
            "Introduzca un ID numérico válido para el formulario personalizado",
        },
      },
      noAccountsFound: "No se han encontrado cuentas",
      noAccountsFoundDescription:
        "Añade la cuenta en NetSuite y sincroniza la conexión de nuevo",
      noVendorsFound: "No se han encontrado proveedores",
      noVendorsFoundDescription:
        "Añade proveedores en NetSuite y sincroniza la conexión de nuevo",
      noItemsFound: "No se han encontrado artículos de factura",
      noItemsFoundDescription:
        "Añade artículos de factura en NetSuite y sincroniza la conexión de nuevo",
      noSubsidiariesFound: "No se ha encontrado subsidiarias",
      noSubsidiariesFoundDescription:
        "Añade la subsidiaria en NetSuite y sincroniza de nuevo la conexión",
      tokenInput: {
        ...
        formSteps: {
          installBundle: {
            ...
            description:
              'En NetSuite, ir a *Personalización > SuiteBundler > Buscar e Instalar Paquetes* > busca "Expensify" > instala el paquete.',
          },
          enableTokenAuthentication: {
            title: "Habilitar la autenticación basada en token",
            description:
              "En NetSuite, ir a *Configuración > Empresa > Habilitar Funciones > SuiteCloud* > activar *autenticación basada en token*.",
          },
          enableSoapServices: {
            title: "Habilitar servicios web SOAP",
            description:
              "En NetSuite, ir a *Configuración > Empresa > Habilitar funciones > SuiteCloud* > habilitar *Servicios Web SOAP*.",
          },
          createAccessToken: {
          ...
          enterCredentials: {
            ...
            netSuiteAccountIDDescription:
              "En NetSuite, ir a *Configuración > Integración > Preferencias de Servicios Web SOAP*.",
          },
        },
      },
      import: {
        ...
        expenseCategoriesDescription:
          "Las categorías de gastos de NetSuite se importan a Expensify como categorías.",
        crossSubsidiaryCustomers: "Clientes/proyectos entre subsidiaria",
        importFields: {
          departments: {
            title: "Departamentos",
            subtitle:
              "Elige cómo manejar los *departamentos* de NetSuite en Expensify.",
          },
          classes: {
            title: "Clases",
        ...
        customersOrJobs: {
          ...
          subtitle:
            "Elija cómo manejar los *clientes* y *proyectos* de NetSuite en Expensify.",
          importCustomers: "Importar clientes",
          importJobs: "Importar proyectos",
          customers: "clientes",
          jobs: "proyectos",
          label: (importFields, importType) =>
            `${importFields.join(" y ")}, ${importType}`,
        },
        importTaxDescription: "Importar grupos de impuestos desde NetSuite.",
        importCustomFields: {
          chooseOptionBelow: "Elija una de las opciones siguientes:",
          label: (importedTypes) =>
            `Importados como ${importedTypes.join(" y ")}`,
          requiredFieldError: (fieldName) =>
            `Por favor, introduzca el ${fieldName}`,
          customSegments: {
            ...
            helpText:
              " sobre la configuración de segmentos/registros personalizado.",
            emptyTitle:
              "Añadir un segmento personalizado o un registro personalizado",
            fields: {
              segmentName: "Name",
            ...
            removePrompt:
              "¿Está seguro de que desea eliminar este segmento/registro personalizado?",
            addForm: {
              ...
              segmentRecordType:
                "¿Desea añadir un segmento personalizado o un registro personalizado?",
              customSegmentNameTitle:
                "¿Cuál es el nombre del segmento personalizado?",
              customRecordNameTitle:
                "¿Cuál es el nombre del registro personalizado?",
              ...
              customSegmentInternalIDTitle:
                "¿Cuál es la identificación interna?",
              ...
              customRecordScriptIDTitle:
                "¿Cuál es el ID de columna de la transacción?",
              ...
              customSegmentMappingTitle:
                "¿Cómo debería mostrarse este segmento personalizado en Expensify?",
              customRecordMappingTitle:
                "¿Cómo debería mostrarse este registro de segmento personalizado en Expensify?",
            },
            errors: {
              uniqueFieldError: (fieldName) =>
                `Ya existe un segmento/registro personalizado con este ${fieldName?.toLowerCase()}`,
            },
          },
          customLists: {
            ...
            removePrompt:
              "¿Está seguro de que desea eliminar esta lista personalizado?",
            addForm: {
              listNameTitle: "Elija una lista personalizada",
              transactionFieldIDTitle:
                "¿Cuál es el ID del campo de transacción?",
              ...
              mappingTitle:
                "¿Cómo debería mostrarse esta lista personalizada en Expensify?",
            },
            errors: {
        ...
        importTypes: {
          ...
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
            ...
            footerContent: (importField) =>
              `Se podrán seleccionar ${importField} para cada gasto individual en el informe de un empleado.`,
          },
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
            label: "Campos de informe",
            description: "Nivel de informe",
            footerContent: (importField) =>
              `La selección de ${importField} se aplicará a todos los gastos en el informe de un empleado.`,
          },
        },
      },
    },
    intacct: {
      ...
      downloadExpensifyPackage:
        "Descargar el paquete Expensify para Sage Intacct",
      followSteps:
        "Siga los pasos de nuestras instrucciones Cómo: Instrucciones para conectarse a Sage Intacct",
      ...
      employeeDefaultDescription:
        "El departamento por defecto del empleado se aplicará a sus gastos en Sage Intacct si existe.",
      displayedAsTagDescription:
        "Se podrá seleccionar el departamento para cada gasto individual en el informe de un empleado.",
      displayedAsReportFieldDescription:
        "La selección de departamento se aplicará a todos los gastos que figuren en el informe de un empleado.",
      toggleImportTitle: (mappingTitle) =>
        `Elija cómo gestionar Sage Intacct <strong>${mappingTitle}</strong> en Expensify.`,
      expenseTypes: "Tipos de gastos",
      expenseTypesDescription:
        "Los tipos de gastos de Sage Intacct se importan a Expensify como categorías.",
      accountTypesDescription:
        "Su plan de cuentas de Sage Intacct se importará a Expensify como categorías.",
      importTaxDescription:
        "Importar el tipo impositivo de compra desde Sage Intacct.",
      ...
      removeDimensionPrompt:
        "Está seguro de que desea eliminar esta dimensión definida por el usuario?",
      ...
      detailedInstructionsRestOfSentence:
        " para añadir dimensiones definidas por el usuario.",
      userDimensionsAdded: () => ({
        one: "1 UDD añadido",
    ...
    companyCards: {
      ...
      error: {
        workspaceFeedsCouldNotBeLoadedTitle:
          "Error al cargar las fuentes de tarjetas del espacio de trabajo",
        ...
        feedCouldNotBeLoadedMessage:
          "Ocurrió un error al cargar esta fuente de tarjetas. Por favor, inténtelo de nuevo o contacte a su administrador.",
      ...
      addNewCard: {
        ...
        commercialFeedDetails:
          "Requiere configuración con tu banco. Esto suele ser utilizado por empresas más grandes y a menudo es la mejor opción si calificas.",
        commercialFeedPlaidDetails:
          "Requiere configurarlo con tu banco, pero te guiaremos. Esto suele estar limitado a empresas más grandes.",
        directFeedDetails:
          "El enfoque más simple. Conéctate de inmediato usando tus credenciales maestras. Este método es el más común.",
        enableFeed: {
          ...
          mastercard:
            "Contamos con integraciones globales con Mastercard, aunque la elegibilidad varía según el banco y el programa de la tarjeta.\n\nPara empezar, simplemente:",
        ...
        amexCorporate:
          "Seleccione esto si el frente de sus tarjetas dice “Corporativa”",
        amexBusiness:
          "Seleccione esta opción si el frente de sus tarjetas dice “Negocios”",
        amexPersonal: "Selecciona esta opción si tus tarjetas son personales",
        error: {
          pleaseSelectProvider:
            "Seleccione un proveedor de tarjetas antes de continuar",
          pleaseSelectBankAccount:
            "Seleccione una cuenta bancaria antes de continuar",
          pleaseSelectBank: "Seleccione una bancaria antes de continuar",
          pleaseSelectCountry: "Seleccione un país antes de continuar",
          pleaseSelectFeedType:
            "Seleccione un tipo de pienso antes de continuar",
        },
        exitModal: {
          title: "¿Algo no funciona?",
          prompt:
            "Notamos que no terminaste de añadir tus tarjetas. Si encontraste un problema, háznoslo saber para que podamos ayudarte a solucionarlo.",
      ...
      startDateDescription:
        "Importaremos todas las transacciones desde esta fecha en adelante. Si no se especifica una fecha, iremos tan atrás como lo permita tu banco.",
      ...
      confirmationDescription:
        "Comenzaremos a importar transacciones inmediatamente.",
      card: "Tarjeta",
      ...
      assignedCard: (assignee, link) =>
        `ha asignado a ${assignee} una ${link}! Las transacciones importadas aparecerán en este chat.`,
      ...
      cardAlreadyAssignedError:
        "Esta tarjeta ya está asignada a un usuario en otro espacio de trabajo.",
      importTransactions: {
        title: "Importar transacciones desde archivo",
        description:
          "Por favor, ajusta la configuración de archivo que se aplicará al importar.",
    ...
    expensifyCard: {
      ...
      getStartedIssuing:
        "Empieza emitiendo tu primera tarjeta virtual o física.",
      verificationInProgress: "Verificación en curso...",
      verifyingTheDetails:
        "Estamos verificando algunos detalles. Concierge te avisará cuando las tarjetas de Expensify estén listas para emitirse.",
      disclaimer:
      ...
      balanceWillBeSettledOn: (settlementDate) =>
        `El saldo se liquidará el ${settlementDate}.`,
      ...
      earnedCashbackDescription:
        "El saldo de devolución se basa en el gasto mensual realizado con la tarjeta Expensify en tu espacio de trabajo.",
      issueNewCard: "Emitir nueva tarjeta",
      finishSetup: "Terminar configuración",
      chooseBankAccount: "Elegir cuenta bancaria",
      chooseExistingBank:
        "Elige una cuenta bancaria comercial existente para pagar el saldo de su Tarjeta Expensify o añade una nueva cuenta bancaria.",
      ...
      settlementAccountDescription:
        "Elige una cuenta para pagar el saldo de tu Tarjeta Expensify.",
      ...
      settlementFrequencyDescription:
        "Elige con qué frecuencia pagarás el saldo de tu Tarjeta Expensify",
      ...
      cardPending: ({ name }: { name: string }) =>
        `La tarjeta está pendiente y se emitirá una vez que la cuenta de ${name} haya sido validada.`,
      virtual: "Virtual",
      physical: "Física",
      deactivate: "Desactivar tarjeta",
      changeCardLimit: "Modificar el límite de la tarjeta",
      changeLimit: "Modificar límite",
      smartLimitWarning: (limit) =>
      ...
      monthlyLimitWarning: (limit) =>
        `Si cambias el límite de esta tarjeta a ${limit}, las nuevas transacciones serán rechazadas hasta el próximo mes.`,
      fixedLimitWarning: (limit) =>
        `Si cambias el límite de esta tarjeta a ${limit}, se rechazarán las nuevas transacciones.`,
      ...
      issuedCard: (assignee) =>
        `emitió a ${assignee} una Tarjeta Expensify. La tarjeta llegará en 2-3 días laborables.`,
      issuedCardNoShippingDetails: (assignee) =>
        `emitió a ${assignee} una Tarjeta Expensify. La tarjeta se enviará una vez que se confirmen los detalles de envío.`,
      issuedCardVirtual: (assignee, link) =>
        `emitió a ${assignee} una ${link} virtual. La tarjeta puede utilizarse inmediatamente.`,
      addedShippingDetails: (assignee) =>
        `${assignee} agregó los detalles de envío. La Tarjeta Expensify llegará en 2-3 días hábiles.`,
      replacedCard: (assignee) =>
        `${assignee} reemplazó su Tarjeta Expensify. La nueva tarjeta llegará en 2-3 días hábiles.`,
      replacedVirtualCard: (assignee, link) =>
        `${assignee} reemplazó su Tarjeta Expensify virtual! La ${link} puede utilizarse inmediatamente.`,
      card: "tarjeta",
      ...
      verifyingBankAccountDescription:
        "Por favor, espere mientras confirmamos que esta cuenta se puede utilizar para emitir tarjetas Expensify.",
      bankAccountVerified: "¡Cuenta bancaria verificada!",
      bankAccountVerifiedDescription:
        "Ahora puedes emitir tarjetas de Expensify para los miembros de tu espacio de trabajo.",
      oneMoreStep: "Un paso más",
      oneMoreStepDescription:
        "Parece que tenemos que verificar manualmente tu cuenta bancaria. Dirígete a Concierge, donde te esperan las instrucciones.",
      gotIt: "Entendido",
    ...
    categories: {
      ...
      spendCategoriesDescription:
        "Personaliza cómo se categorizan los gastos de los comerciantes para las transacciones con tarjeta de crédito y los recibos escaneados.",
      deleteFailureMessage:
        "Se ha producido un error al intentar eliminar la categoría. Por favor, inténtalo más tarde.",
      categoryName: "Nombre de la categoría",
      requiresCategory: "Los miembros deben clasificar todos los gastos",
      needCategoryForExportToIntegration: (connectionName) =>
      ...
      createFailureMessage:
        "Se ha producido un error al intentar crear la categoría. Por favor, inténtalo más tarde.",
      ...
      updatePayrollCodeFailureMessage:
        "Se produjo un error al actualizar el código de nómina, por favor intente nuevamente",
      glCode: "Código de Libro Mayor",
      updateGLCodeFailureMessage:
        "Se produjo un error al actualizar el código de Libro Mayor. Inténtelo nuevamente.",
    ...
    moreFeatures: {
      ...
      spendSection: {
        title: "Gasto",
        subtitle:
          "Habilita otras funcionalidades que ayudan a aumentar tu equipo.",
      },
      manageSection: {
        title: "Gestionar",
        subtitle:
          "Añade controles que ayudan a mantener los gastos dentro del presupuesto.",
      },
      earnSection: {
        title: "Gane",
      ...
      perDiem: {
        title: "Per diem",
        subtitle:
          "Establece las tasas per diem para controlar los gastos diarios de los empleados.",
      },
      travel: {
        title: "Viajes",
        ...
        getStarted: {
          title: "Comienza con Expensify Travel",
          subtitle:
            "Solo necesitamos algunos datos más sobre tu empresa y estarás listo para despegar.",
          ctaText: "Vamos allá",
        },
        reviewingRequest: {
          title: "Prepara las maletas, tenemos tu solicitud...",
          subtitle:
            "Estamos revisando tu solicitud para habilitar Expensify Travel. No te preocupes, te avisaremos cuando esté listo.",
          ctaText: "Solicitud enviada",
        },
        bookOrManageYourTrip: {
          title: "Reserva de viajes",
          subtitle:
            "¡Felicidades! Ya puedes reservar y gestionar viajes en este espacio de trabajo.",
        ...
        settings: {
          autoAddTripName: {
            ...
            subtitle:
              "Añade automáticamente los nombres de viajes a las descripciones de los gastos reservados en Expensify.",
          },
        },
        travelInvoicing: {
          travelBookingSection: {
            title: "Reserva de viajes",
            subtitle:
              "¡Felicidades! Todo está listo para reservar y gestionar viajes en este espacio de trabajo.",
            manageTravelLabel: "Gestionar viajes",
          },
          centralInvoicingSection: {
            title: "Facturación centralizada",
            subtitle:
              "Centraliza todos los gastos de viaje en una factura mensual en lugar de pagar en el momento de la compra.",
            learnHow: "Aprende cómo.",
            subsections: {
              currentTravelSpendLabel: "Gasto actual en viajes",
              currentTravelSpendPaymentQueued: (amount: string) =>
                `El pago de ${amount} está en cola y se procesará pronto.`,
          ...
          selectDateRangeError:
            "Por favor, selecciona un rango de fechas para exportar",
          invalidDateRangeError:
            "La fecha de inicio debe ser anterior a la fecha de fin",
          enabled: "¡Facturación centralizada habilitada!",
          enabledDescription:
            "Todos los gastos de viaje en este espacio de trabajo ahora se centralizarán en una factura mensual.",
        },
        personalDetailsDescription:
          "Para poder reservar el viaje, por favor ingrese su nombre legal tal como aparece en su identificación oficial emitida por el gobierno.",
      },
      expensifyCard: {
        ...
        disableCardPrompt:
          "No puedes deshabilitar la Tarjeta Expensify porque ya está en uso. Por favor, contacta con Concierge para conocer los pasos a seguir.",
        disableCardButton: "Chatear con Concierge",
        feed: {
          title: "Consigue la Tarjeta Expensify",
          subTitle:
            "Simplifica los gastos de tu empresa y ahorra hasta un 50 % en tu factura de Expensify, además:",
          features: {
      ...
      companyCards: {
        ...
        feed: {
          ...
          subtitle:
            "Vincula las tarjetas que ya tienes para la importación automática de transacciones, coincidencia de recibos y conciliación.",
          features: {
        ...
        bankConnectionDescription:
          "Intente agregar sus tarjetas de nuevo. De lo contrario, puede",
        disableCardTitle: "Deshabilitar tarjetas de empresa",
        disableCardPrompt:
          "No puedes deshabilitar las tarjetas de empresa porque esta función está en uso. Por favor, contacta a Concierge para los próximos pasos.",
        disableCardButton: "Chatear con Concierge",
        cardDetails: "Datos de la tarjeta",
        cardNumber: "Número de la tarjeta",
        ...
        integrationExport: (integration, type) =>
          integration && type
            ? `Exportación a ${integration} ${type.toLowerCase()}`
            : `Exportación a ${integration}`,
        integrationExportTitleXero: (integration) =>
          `Seleccione la cuenta ${integration} donde se deben exportar las transacciones.`,
        ...
        unassignCardDescription:
          "Desasignar esta tarjeta eliminará todas las transacciones no enviadas.",
        removeCard: "Eliminar tarjeta",
        remove: "Eliminar",
        removeCardDescription:
          "Eliminar esta tarjeta eliminará todas las transacciones no enviadas.",
        assignCard: "Asignar tarjeta",
        cardFeedName: "Nombre del feed de tarjeta",
        cardFeedNameDescription:
          "Dale al feed de tarjeta un nombre único para que puedas distinguirlo de los demás.",
        cardFeedTransaction: "Eliminar transacciones",
        cardFeedTransactionDescription:
          "Elige si los titulares de tarjetas pueden eliminar transacciones de tarjetas. Las nuevas transacciones seguirán estas reglas.",
        cardFeedRestrictDeletingTransaction:
          "Restringir eliminación de transacciones",
        cardFeedAllowDeletingTransaction:
          "Permitir eliminación de transacciones",
        ...
        removeCardFeedDescription:
          "¿Estás seguro de que deseas eliminar esta fuente de tarjetas? Esto anulará la asignación de todas las tarjetas.",
        error: {
          feedNameRequired: "Se requiere el nombre de la fuente de la tarjeta",
          statementCloseDateRequired:
            "Por favor, selecciona una fecha de cierre del estado de cuenta.",
        },
        ...
        emptyAddedFeedDescription:
          "Comienza asignando tu primera tarjeta a un miembro.",
        ...
        pendingBankDescription: (bankName) =>
          `Conéctese a ${bankName} a través de la ventana del navegador que acaba de abrir. Si no se abrió, `,
        pendingBankLink: "por favor haga clic aquí",
        giveItNameInstruction:
          "Nombra la tarjeta para distingirla de las demás.",
        ...
        noAccountsFoundDescription: (connection) =>
          `Añade la cuenta en ${connection} y sincroniza la conexión de nuevo`,
        ...
        statementCloseDateDescription:
          "Indícanos cuándo cierra el estado de cuenta de tu tarjeta y crearemos uno correspondiente en Expensify.",
      },
      workflows: {
      ...
      connectionsWarningModal: {
        ...
        disconnectText:
          "Para desactivar la contabilidad, desconecta tu conexión contable del espacio de trabajo.",
        manageSettings: "Gestionar la configuración",
      },
      receiptPartnersWarningModal: {
        featureEnabledTitle: "Desconectar Uber",
        disconnectText:
          "Para desactivar esta función, desconecta primero la integración de Uber for Business.",
      ...
      rules: {
        title: "Reglas",
        subtitle:
          "Solicita recibos, resalta gastos de alto importe y mucho más.",
      },
      timeTracking: {
        title: "Tiempo",
        subtitle:
          "Establecer una tarifa por hora facturable para el seguimiento de tiempo.",
    ...
    reports: {
      ...
      customNameEmailPhoneExample:
        "Correo electrónico o teléfono del miembro: {report:submit:from}",
      customNameStartDateExample:
        "Fecha de inicio del informe: {report:startdate}",
      customNameWorkspaceNameExample:
        "Nombre del espacio de trabajo: {report:workspacename}",
    ...
    reportFields: {
      ...
      deleteConfirmation:
        "¿Está seguro de que desea eliminar este campo del informe?",
      deleteFieldsConfirmation:
        "¿Está seguro de que desea eliminar estos campos del informe?",
      emptyReportFields: {
        title: "No has creado ningún campo de informe",
        subtitle:
          "Añade un campo personalizado (texto, fecha o desplegable) que aparezca en los informes.",
      },
      subtitle:
      ...
      disableReportFieldsConfirmation:
        "Estás seguro? Se eliminarán los campos de texto y fecha y se desactivarán las listas.",
      ...
      initialValueInputSubtitle:
        "Ingresa un valor inicial para mostrar en el campo del informe.",
      listValuesInputSubtitle:
        "Estos valores aparecerán en el desplegable del campo de tu informe. Los miembros pueden seleccionar los valores habilitados.",
      listInputSubtitle:
        "Estos valores aparecerán en la lista de campos de tu informe. Los miembros pueden seleccionar los valores habilitados.",
      ...
      emptyReportFieldsValues: {
        ...
        subtitle:
          "Añade valores personalizados para que aparezcan en los informes.",
      },
      deleteValuePrompt:
        "¿Estás seguro de que quieres eliminar este valor de la lista?",
      deleteValuesPrompt:
        "¿Estás seguro de que quieres eliminar estos valores de la lista?",
      ...
      existingReportFieldNameError:
        "Ya existe un campo de informe con este nombre",
      ...
      circularReferenceError:
        "Este campo no puede hacer referencia a sí mismo. Por favor, actualizar.",
      reportFieldInitialValueRequiredError:
        "Elige un valor inicial de campo de informe",
      genericFailureMessage:
        "Se ha producido un error al actualizar el campo de informe. Por favor, inténtalo de nuevo.",
    },
    tags: {
      ...
      subtitle:
        "Las etiquetas añaden formas más detalladas de clasificar los costos.",
      ...
      emptyTags: {
        ...
        subtitle:
          "Añade una etiqueta para realizar el seguimiento de proyectos, ubicaciones, departamentos y otros.",
      ...
      deleteTagsConfirmation:
        "¿Estás seguro de que quieres eliminar estas etiquetas?",
      deleteFailureMessage:
        "Se ha producido un error al intentar eliminar la etiqueta. Por favor, inténtalo más tarde.",
      tagRequiredError: "Lo nombre de la etiqueta es obligatorio",
      existingTagError: "Ya existe una etiqueta con este nombre",
      invalidTagNameError:
        "El nombre de la etiqueta no puede ser 0. Por favor, elige un valor diferente.",
      genericFailureMessage:
        "Se ha producido un error al actualizar la etiqueta. Por favor, inténtelo nuevamente.",
      importedFromAccountingSoftware: "Las etiquetas se gestionan en tu",
      employeesSeeTagsAs: "Los empleados ven las etiquetas como",
      glCode: "Código de Libro Mayor",
      updateGLCodeFailureMessage:
        "Se produjo un error al actualizar el código de Libro Mayor. Por favor, inténtelo nuevamente.",
      ...
      switchSingleToMultiLevelTagWarning: {
        ...
        prompt1:
          "Cambiar el nivel de etiquetas eliminará todas las etiquetas actuales.",
      ...
      cannotMakeTagListRequired: {
        ...
        description:
          "Solo puedes hacer que una lista de etiquetas sea obligatoria si tu política tiene varios niveles de etiquetas configurados.",
      },
      tagCount: () => ({
        one: "1 etiqueta",
    ...
    taxes: {
      subtitle:
        "Añade nombres, tasas y establezca valores por defecto para los impuestos.",
      addRate: "Añadir tasa",
      ...
      error: {
        ...
        valuePercentageRange:
          "Por favor, introduce un porcentaje entre 0 y 100",
        deleteFailureMessage:
          "Se ha producido un error al intentar eliminar la tasa de impuesto. Por favor, inténtalo más tarde.",
        updateFailureMessage:
          "Se ha producido un error al intentar modificar la tasa de impuesto. Por favor, inténtalo más tarde.",
        createFailureMessage:
          "Se ha producido un error al intentar crear la tasa de impuesto. Por favor, inténtalo más tarde.",
        updateTaxClaimableFailureMessage:
          "La porción recuperable debe ser menor al monto del importe por distancia",
      },
      deleteTaxConfirmation:
        "¿Estás seguro de que quieres eliminar este impuesto?",
      deleteMultipleTaxConfirmation: (taxAmount) =>
        `¿Estás seguro de que quieres eliminar ${taxAmount} impuestos?`,
      actions: {
      ...
      updateTaxCodeFailureMessage:
        "Se produjo un error al actualizar el código tributario, inténtelo nuevamente",
    },
    duplicateWorkspace: {
      title: "Nombra tu nuevo espacio de trabajo",
      selectFeatures: "Selecciona las funciones a copiar",
      whichFeatures:
        "¿Qué funciones deseas copiar a tu nuevo espacio de trabajo?",
      confirmDuplicate: "\n\n¿Quieres continuar?",
      ...
      welcomeNote:
        "Por favor, comience a utilizar mi nuevo espacio de trabajo.",
      ...
      error:
        "Se produjo un error al duplicar tu nuevo espacio de trabajo. Inténtalo de nuevo.",
    },
    emptyWorkspace: {
      title: "No tienes espacios de trabajo",
      subtitle:
        "Organiza recibos, reembolsa gastos, gestiona viajes, envía facturas y mucho más.",
      ...
      description:
        "Las salas son un gran lugar para discutir y trabajar con varias personas. Para comenzar a colaborar, cree o únase a un espacio de trabajo",
    },
    new: {
      newWorkspace: "Nuevo espacio de trabajo",
      getTheExpensifyCardAndMore: "Consigue la Tarjeta Expensify y más",
      confirmWorkspace: "Confirmar espacio de trabajo",
      myGroupWorkspace: ({ workspaceNumber }) =>
        `Mi Espacio de Trabajo en Grupo${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
      workspaceName: (userName, workspaceNumber) =>
        `Espacio de trabajo${workspaceNumber ? ` ${workspaceNumber}` : ""} de ${userName}`,
    },
    people: {
      genericFailureMessage:
        "Se ha producido un error al intentar eliminar a un miembro del espacio de trabajo. Por favor, inténtalo más tarde.",
      ...
      error: {
        genericAdd:
          "Ha ocurrido un problema al añadir el miembro al espacio de trabajo",
        cannotRemove:
      ...
      addedWithPrimary:
        "Se agregaron algunos miembros con sus nombres de usuario principales.",
      invitedBySecondaryLogin: (secondaryLogin) =>
        `Agregado por nombre de usuario secundario ${secondaryLogin}.`,
      workspaceMembersCount: ({ count }) =>
        `Total de miembros del espacio de trabajo: ${count}`,
    ...
    accounting: {
      ...
      title: "Conexiones",
      subtitle:
        "Conecta a tu sistema de contabilidad para codificar transacciones con tu plan de cuentas, auto-cotejar pagos, y mantener tus finanzas sincronizadas.",
      ...
      goToODToSettings:
        "Ve a Expensify Classic para gestionar tus configuraciones.",
      setup: "Configurar",
      ...
      connectTitle: ({ connectionName }) =>
        `Conectar ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName] ?? "accounting integration"}`,
      ...
      importTypes: {
        ...
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]:
          "Importado como campos de informe",
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]:
          "Predeterminado del empleado NetSuite",
      },
      ...
      exportPreferredExporterSubNote:
        "Una vez configurado, el exportador preferido verá los informes para exportar en tu cuenta.",
      ...
      chooseReconciliationAccount: {
        chooseBankAccount:
          "Elige la cuenta bancaria con la que se conciliarán los pagos de tu Tarjeta Expensify.",
    ...
    card: {
      ...
      issueNewCard: {
        ...
        smartLimitDescription:
          "Gasta hasta una determinada cantidad antes de requerir aprobación",
        monthly: "Mensual",
        ...
        willBeReadyToShip:
          "Esta tarjeta estará lista para enviarse de inmediato.",
        cardholder: "Titular de la tarjeta",
        cardType: "Tipo de tarjeta",
        limit: "Limite",
        limitType: "Tipo de limite",
        disabledApprovalForSmartLimitError:
          "Por favor, habilita las aprobaciones en <strong>Flujos de trabajo > Aprobaciones</strong> antes de configurar los límites inteligentes",
        ...
        validFromTo: ({
          ...
          startDate: string;
          endDate: string;
        }) => `Válido desde ${startDate} hasta ${endDate}`,
        ...
        combineWithExpiration:
          "Combina con opciones de vencimiento para un control de gasto adicional",
        ...
        setExpiryDateDescription:
          "La tarjeta expirará según se indica en la tarjeta",
        amount: "Monto",
      },
      deactivateCardModal: {
        ...
        deactivateConfirmation:
          "Al desactivar esta tarjeta, se rechazarán todas las transacciones futuras y no se podrá deshacer.",
      },
    },
    ...
    invoices: {
      ...
      invoiceBalanceSubtitle:
        "Este es tu saldo actual de la recaudación de pagos de facturas. Se transferirá automáticamente a tu cuenta bancaria si has agregado una.",
      bankAccountsSubtitle:
        "Agrega una cuenta bancaria para hacer y recibir pagos de facturas.",
    },
    invite: {
    ...
    inviteMessage: {
      confirmDetails: "Confirma los detalles",
      inviteMessagePrompt:
        "¡Añadir un mensaje para hacer tu invitación destacar!",
      personalMessagePrompt: "Mensaje",
      inviteNoMembersError:
        "Por favor, selecciona al menos un miembro a invitar.",
      genericFailureMessage:
      ...
      joinRequest: ({ user, workspaceName }) =>
        `${user} solicitó unirse al espacio de trabajo ${workspaceName}`,
    },
    distanceRates: {
      oopsNotSoFast: "Ups! No tan rápido...",
      workspaceNeeds:
        "Un espacio de trabajo necesita al menos una tasa de distancia activa.",
      distance: "Distancia",
      centrallyManage:
        "Gestiona centralizadamente las tasas, elige si contabilizar en millas o kilómetros, y define una categoría por defecto",
      rate: "Tasa",
    ...
    editor: {
      ...
      currencyInputDisabledText: (currency) =>
      ...
      save: "Guardar",
      genericFailureMessage:
        "Se ha producido un error al guardar el espacio de trabajo. Por favor, inténtalo de nuevo.",
      avatarUploadFailureMessage:
        "No se pudo subir el avatar. Por favor, inténtalo de nuevo.",
      addressContext:
    ...
    bankAccount: {
      ...
      youAreAlmostDone:
        "Casi has acabado de configurar tu cuenta bancaria, que te permitirá emitir tarjetas corporativas, reembolsar gastos y cobrar pagar facturas.",
      streamlinePayments: "Optimiza pagos",
      connectBankAccountNote:
        "Nota: No se pueden usar cuentas bancarias personales para realizar pagos en los espacios de trabajo.",
      oneMoreThing: "¡Una cosa más!",
      allSet: "¡Todo listo!",
      accountDescriptionWithCards:
        "Esta cuenta bancaria se utilizará para emitir tarjetas corporativas, reembolsar gastos y cobrar y pagar facturas.",
      ...
      disconnectYourBankAccount: (bankName) =>
      ...
      workspaceCurrencyNotSupported:
        "Moneda del espacio de trabajo no soportada",
      ...
      chooseAnExisting:
        "Elige una cuenta bancaria existente para pagar gastos o añade una nueva.",
    },
    changeOwner: {
      changeOwnerPageTitle: "Transferir la propiedad",
      addPaymentCardTitle:
        "Ingrese tu tarjeta de pago para transferir la propiedad",
      ...
      failedToClearBalanceText:
        "No hemos podido liquidar el saldo, por favor, inténtalo más tarde.",
      successTitle: "¡Guau! Todo listo.",
      successDescription:
        "Ahora eres el propietario de este espacio de trabajo.",
    ...
    planTypePage: {
      ...
      description:
        "Elige el plan adecuado para ti. Para ver una lista detallada de funciones y precios, consulta nuestra",
    ...
    upgrade: {
      ...
      categories: {
        title: "Categorías",
        description:
          "Las categorías te permiten rastrear y organizar gastos. Usa nuestras categorías predeterminadas o añade las tuyas propias.",
        onlyAvailableOnPlan: ({ formattedPrice, hasTeam2025Pricing }) =>
      ...
      reports: {
        title: "Informes",
        description:
          "Los informes te permiten agrupar gastos para un seguimiento y organización más fáciles.",
        onlyAvailableOnPlan: ({ formattedPrice, hasTeam2025Pricing }) =>
      ...
      distanceRates: {
        title: "Tasas de distancia",
        description:
          "Crea y gestiona tus propias tasas, realiza el seguimiento en millas o kilómetros y establece categorías predeterminadas para los gastos de distancia.",
        onlyAvailableOnPlan: ({ formattedPrice, hasTeam2025Pricing }) =>
      ...
      auditor: {
        title: "Auditor",
        description:
          "Los auditores tienen acceso de lectura a todos los informes para una visibilidad completa y la supervisión del cumplimiento.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      completed: {
        ...
        travelMessage:
          "Has actualizado con éxito al plan Recopilar. ¡Ahora puedes comenzar a reservar y gestionar viajes!",
        ...
        distanceRateMessage:
          "Has actualizado correctamente al plan Recopilar. ¡Ahora puedes cambiar la tasa de distancia!",
      ...
      commonFeatures: {
        ...
        benefits: {
          ...
          benefit1:
            "Conexiones avanzadas de contabilidad (NetSuite, Sage Intacct y más)",
          ...
          selectWorkspace:
            "selecciona un espacio de trabajo y cambia el tipo de plan a",
        },
    ...
    downgrade: {
      commonFeatures: {
        ...
        benefits: {
          ...
          confirm:
            "¿Estás seguro de que deseas desmejorar y eliminar tus configuraciones?",
          warning: "Esto no se puede deshacer.",
          benefit1:
            "Conexiones de contabilidad (excepto QuickBooks Online y Xero)",
          benefit2: "Reglas inteligentes de gastos",
          benefit3: "Flujos de aprobación de varios niveles",
          benefit4: "Controles de seguridad mejorados",
          headsUp: "¡Atención!",
          ...
          selectStep:
            "> selecciona cada espacio de trabajo > cambia el tipo de plan a",
        },
      },
      completed: {
        headline: "Tu espacio de trabajo ha sido bajado de categoría",
        description:
          "Tienes otros espacios de trabajo en el plan Controlar. Para facturarte con la tasa del plan Recopilar, debes bajar de categoría todos los espacios de trabajo.",
        gotIt: "Entendido, gracias.",
      },
    },
    payAndDowngrade: {
      ...
      description1: (formattedAmount) =>
        `Tu factura final por esta suscripción será <strong>${formattedAmount}</strong>`,
      description2: (date) =>
        `Consulta el desglose a continuación para ${date}:`,
      subscription:
      ...
      genericFailureMessage:
        "Ocurrió un error al pagar tu factura. Por favor, inténtalo de nuevo.",
    },
    restrictedAction: {
      restricted: "Restringido",
      actionsAreCurrentlyRestricted: (workspaceName) =>
        `Las acciones en el espacio de trabajo ${workspaceName} están actualmente restringidas`,
      ...
      youWillNeedToAddOrUpdatePaymentCard:
        "Debes añadir o actualizar la tarjeta de pago registrada para desbloquear nueva actividad en el espacio de trabajo.",
      addPaymentCardToUnlock: "Añade una tarjeta para desbloquearlo!",
      addPaymentCardToContinueUsingWorkspace:
        "Añade una tarjeta de pago para seguir utilizando este espacio de trabajo",
      pleaseReachOutToYourWorkspaceAdmin:
        "Si tienes alguna pregunta, ponte en contacto con el administrador de su espacio de trabajo.",
    ...
    rules: {
      individualExpenseRules: {
        ...
        receiptRequiredAmountDescription:
          "Exige recibos cuando los gastos superen este importe, a menos que lo anule una regla de categoría.",
        receiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `La cantidad no puede ser mayor que la cantidad requerida para recibos detallados (${amount})`,
        itemizedReceiptRequiredAmount:
          "Cantidad requerida para recibos detallados",
        itemizedReceiptRequiredAmountDescription:
          "Exige recibos detallados cuando los gastos superen este importe, a menos que lo anule una regla de categoría.",
        itemizedReceiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `La cantidad no puede ser menor que la cantidad requerida para recibos regulares (${amount})`,
        maxExpenseAmount: "Importe máximo del gasto",
        maxExpenseAmountDescription:
          "Marca los gastos que superen este importe, a menos que una regla de categoría lo anule.",
        maxAge: "Antigüedad máxima",
        maxExpenseAge: "Antigüedad máxima de los gastos",
        maxExpenseAgeDescription:
          "Marca los gastos de más de un número determinado de días.",
        maxExpenseAgeDays: () => ({
          one: "1 día",
        ...
        billable: "Facturable",
        billableDescription:
          "Los gastos se vuelven a facturar a los clientes en la mayoría de los casos",
        nonBillable: "No facturable",
        nonBillableDescription:
          "Los gastos se vuelven a facturar a los clientes en ocasiones",
        ...
        attendeeTrackingHint:
          "Haz un seguimiento del coste por persona para cada gasto.",
        ...
        requireCompanyCard:
          "Requerir que todas las compras se hagan con la tarjeta de empresa",
        requireCompanyCardDescription:
          "Marca todo gasto en efectivo, incluyendo kilometraje y gastos per diem.",
        requireCompanyCardDisabledTooltip:
          "Habilita las tarjetas de empresa (bajo Más características) para desbloquearlo.",
      },
      expenseReportRules: {
        title: "Avanzado",
        subtitle:
          "Automatiza el cumplimiento, la aprobación y el pago de los informes de gastos.",
        preventSelfApprovalsTitle: "Evitar autoaprobaciones",
        preventSelfApprovalsSubtitle:
          "Evita que los miembros del espacio de trabajo aprueben sus propios informes de gastos.",
        autoApproveCompliantReportsTitle:
          "Aprobación automática de informes conformes",
        autoApproveCompliantReportsSubtitle:
          "Configura qué informes de gastos pueden aprobarse de forma automática.",
        autoApproveReportsUnderTitle:
          "Aprobar automáticamente informes con todos los gastos por debajo de",
        autoApproveReportsUnderDescription:
          "Los informes de gastos totalmente conformes en los que todos los gastos estén por debajo de esta cantidad se aprobarán automáticamente.",
        randomReportAuditTitle: "Auditoría aleatoria de informes",
        randomReportAuditDescription:
          "Requiere que algunos informes sean aprobados manualmente, incluso si son elegibles para la aprobación automática.",
        autoPayApprovedReportsTitle: "Pago automático de informes aprobados",
        autoPayApprovedReportsSubtitle:
          "Configura qué informes de gastos pueden pagarse de forma automática.",
        autoPayApprovedReportsLimitError: (currency) =>
          `Por favor, introduce un monto menor a ${currency ?? ""}20,000`,
        autoPayApprovedReportsLockedSubtitle:
          "Ve a más funciones y habilita flujos de trabajo, luego agrega pagos para desbloquear esta función.",
        autoPayReportsUnderTitle:
          "Pagar automáticamente informes por debajo de",
        autoPayReportsUnderDescription:
          "Los informes de gastos totalmente conformes por debajo de esta cantidad se pagarán automáticamente.",
        unlockFeatureEnableWorkflowsSubtitle: (featureName) =>
          `Añade ${featureName} para desbloquear esta función.`,
        enableFeatureSubtitle: (featureName, moreFeaturesLink) =>
          `Ir a [más características](${moreFeaturesLink}) y habilita ${featureName} para desbloquear esta función.`,
      },
      merchantRules: {
        title: "Comerciante",
        subtitle:
          "Configura las reglas de comerciante para que los gastos lleguen correctamente codificados y requieran menos limpieza.",
        ...
        previewMatchesEmptyStateSubtitle:
          "No hay gastos no enviados que coincidan con esta regla.",
        ...
        ruleSummaryTitle: (merchantName: string, isExactMatch: boolean) =>
          `Si el comerciante ${isExactMatch ? "coincide exactamente con" : "contiene"} "${merchantName}"`,
        ruleSummarySubtitleMerchant: (merchantName: string) =>
          `Renombrar comerciante a "${merchantName}"`,
        ruleSummarySubtitleUpdateField: (
          fieldName: string,
          fieldValue: string,
        ) => `Actualizar ${fieldName} a "${fieldValue}"`,
        ruleSummarySubtitleReimbursable: (reimbursable: boolean) =>
          `Marcar como "${reimbursable ? "reembolsable" : "no reembolsable"}"`,
        ruleSummarySubtitleBillable: (billable: boolean) =>
          `Marcar como "${billable ? "facturable" : "no facturable"}"`,
        ...
        duplicateRulePrompt: (merchantName: string) =>
          `La regla existente para "${merchantName}" tendrá prioridad sobre esta. ¿Desea guardarla de todos modos?`,
        saveAnyway: "Guardar de todos modos",
        applyToExistingUnsubmittedExpenses:
          "Aplicar a gastos existentes no enviados",
      },
      categoryRules: {
        ...
        requiredFieldsDescription: (categoryName) =>
          `Esto se aplicará a todos los gastos categorizados como <strong>${categoryName}</strong>.`,
        ...
        flagAmountsOverDescription: (categoryName) =>
          `Aplica a la categoría “${categoryName}”.`,
        flagAmountsOverSubtitle:
          "Esto anula el importe máximo para todos los gastos.",
        expenseLimitTypes: {
          expense: "Gasto individual",
          expenseSubtitle:
            "Señala importes de gastos por categoría. Esta regla anula la regla general del espacio de trabajo para el importe máximo de gastos.",
          daily: "Total por categoría",
          dailySubtitle:
            "Marcar el gasto total por día por categoría en cada informe de gastos.",
        },
        requireReceiptsOver: "Requerir recibos para importes superiores a",
        requireReceiptsOverList: {
          default: (defaultAmount) =>
            `${defaultAmount} ${CONST.DOT_SEPARATOR} Predeterminado`,
          never: "Nunca requerir recibos",
          always: "Requerir recibos siempre",
        },
        requireItemizedReceiptsOver:
          "Requerir recibos detallados para importes superiores a",
      ...
      customRules: {
        ...
        cardSubtitle:
          "Aquí es donde se definen las reglas de tu equipo, para que todos sepan lo que esta cubierto.",
      },
    },
  },
  getAssistancePage: {
  ...
  newRoomPage: {
    ...
    roomNameReservedError: (reservedName) =>
    ...
    renamedRoomAction: (oldName, newName, isExpenseReport, actorName) => {
      ...
      return isExpenseReport
        ? `${actor}cambió el nombre a "${newName}" (previamente "${oldName}")`
        : `${actor}cambió el nombre de la sala a "${newName}" (previamente "${oldName}")`;
    },
  ...
  workspaceActions: {
    ...
    changedCompanyAddress: ({
      ...
      previousAddress
        ? `cambió la dirección de la empresa a "${newAddress}" (anteriormente "${previousAddress}")`
        : `estableció la dirección de la empresa en "${newAddress}"`,
    addApprovalRule: (approverEmail, approverName, field, name) =>
      `añadió a ${approverName} (${approverEmail}) como aprobador para la ${field} "${name}"`,
    deleteApprovalRule: (approverEmail, approverName, field, name) =>
    ...
    updateCategory: (categoryName, oldValue) =>
      `${oldValue ? "deshabilitó" : "habilitó"} la categoría "${categoryName}"`,
    ...
    setCategoryName: (oldName, newName) =>
      `renombró la categoría "${oldName}" a "${newName}"`,
    updateCategories: ({ count }) => `actualizó ${count} categorías`,
    updateTagListName: (oldName, newName) =>
      `cambió el nombre de la lista de etiquetas a "${newName}" (previamente "${oldName}")`,
    updateTagList: ({ tagListName }) =>
      `actualizó las etiquetas de la lista "${tagListName}"`,
    updateTagListRequired: ({ tagListsName, isRequired }) =>
      `cambió la lista de etiquetas "${tagListsName}" a ${isRequired ? "requerida" : "no requerida"}`,
    importTags: "importó etiquetas desde una hoja de cálculo",
    deletedAllTags: "eliminó todas las etiquetas",
    addTag: ({ tagListName, tagName }) =>
      `añadió la etiqueta "${tagName}" a la lista "${tagListName}"`,
    updateTagName: ({ tagListName, newName, oldName }) =>
      `actualizó la lista de etiquetas "${tagListName}" cambiando la etiqueta "${oldName}" a "${newName}"`,
    updateTagEnabled: ({
      tagListName,
      tagName,
      enabled,
    }: UpdatedPolicyTagParams) =>
      `${enabled ? "habilitó" : "deshabilitó"} la etiqueta "${tagName}" en la lista "${tagListName}"`,
    deleteTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `eliminó la etiqueta "${tagName}" de la lista "${tagListName}"`,
    deleteMultipleTags: ({ count, tagListName }) =>
      `eliminó "${count}" etiquetas de la lista "${tagListName}"`,
    ...
    updateCustomUnit: ({ customUnitName, newValue, oldValue, updatedField }) =>
      `cambió el ${customUnitName} ${updatedField} a "${newValue}" (previamente "${oldValue}")`,
    updateCustomUnitTaxEnabled: ({ newValue }) =>
      `${newValue ? "habilitó" : "deshabilitó"} el seguimiento de impuestos en tasas de distancia`,
    ...
    importCustomUnitRates: ({ customUnitName }) =>
      `importó tasas para la unidad personalizada "${customUnitName}"`,
    addCustomUnitRate: (customUnitName, rateName) =>
      `añadió una nueva tasa de "${rateName}" para "${customUnitName}"`,
    deleteCustomUnitRate: ({ customUnitName, rateName }) =>
      `eliminó la tasa "${rateName}" de "${customUnitName}"`,
    ...
    addedReportField: ({ fieldType, fieldName }) =>
      `añadió el campo de informe ${fieldType} "${fieldName}"`,
    ...
    updateReportFieldDefaultValue: ({ defaultValue, fieldName }) =>
      `estableció el valor predeterminado del campo de informe "${fieldName}" en "${defaultValue}"`,
    addedReportFieldOption: (fieldName, optionName) =>
      `añadió la opción "${optionName}" al campo de informe "${fieldName}"`,
    removedReportFieldOption: (fieldName, optionName) =>
      `eliminó la opción "${optionName}" del campo de informe "${fieldName}"`,
    ...
    deleteReportField: ({
      ...
      fieldType: string;
      fieldName?: string;
    }) => `eliminó el campo de informe ${fieldType} "${fieldName}"`,
    ...
    setReceiptRequiredAmount: (newValue) =>
      `estableció el importe requerido del recibo en "${newValue}"`,
    changedReceiptRequiredAmount: (oldValue, newValue) =>
      `cambió el importe requerido del recibo a "${newValue}" (antes "${oldValue}")`,
    removedReceiptRequiredAmount: (oldValue) =>
      `eliminó el importe requerido del recibo (antes "${oldValue}")`,

    setMaxExpenseAmount: (newValue) =>
      `estableció el importe máximo del gasto en "${newValue}"`,
    changedMaxExpenseAmount: (oldValue, newValue) =>
      `cambió el importe máximo del gasto a "${newValue}" (antes "${oldValue}")`,
    removedMaxExpenseAmount: (oldValue) =>
      `eliminó el importe máximo del gasto (antes "${oldValue}")`,

    setMaxExpenseAge: (newValue) =>
      `estableció la antigüedad máxima del gasto en "${newValue}" días`,
    changedMaxExpenseAge: (oldValue, newValue) =>
      `cambió la antigüedad máxima del gasto a "${newValue}" días (antes "${oldValue}")`,
    removedMaxExpenseAge: (oldValue) =>
      `eliminó la antigüedad máxima del gasto (anteriormente "${oldValue}" días)`,
    updateDefaultBillable: (oldValue, newValue) =>
      `actualizó "Volver a facturar gastos a clientes" a "${newValue}" (previamente "${oldValue}")`,
    updateDefaultReimbursable: (oldValue, newValue) =>
    ...
    updateDefaultTitleEnforced: (value) =>
      `cambió "Requerir título predeterminado de informe" a ${value ? "activado" : "desactivado"}`,
    changedCustomReportNameFormula: (oldValue, newValue) =>
      `cambió la fórmula personalizado del nombre del informe a "${newValue}" (anteriormente "${oldValue}")`,
    ...
    renamedWorkspaceNameAction: (oldName, newName) =>
      `actualizó el nombre de este espacio de trabajo a "${newName}" (previamente "${oldName}")`,
    ...
    demotedFromWorkspace: (policyName, oldRole) =>
      `cambió tu rol en ${policyName} de ${oldRole} a miembro. Te eliminamos de todos los chats de gastos, excepto el suyo.`,
    updatedWorkspaceCurrencyAction: (oldCurrency, newCurrency) =>
      `actualizó la moneda predeterminada a ${newCurrency} (previamente ${oldCurrency})`,
    updatedWorkspaceFrequencyAction: (oldFrequency, newFrequency) =>
      `actualizó la frecuencia de generación automática de informes a "${newFrequency}" (previamente "${oldFrequency}")`,
    updateApprovalMode: ({ newValue, oldValue }) =>
      `actualizó el modo de aprobación a "${newValue}" (previamente "${oldValue}")`,
    ...
    downgradedWorkspace:
      "bajó de categoría este espacio de trabajo al plan Recopilar",
    ...
    changedReimburser: ({ newReimburser, previousReimburser }) =>
      previousReimburser
        ? `cambió el pagador autorizado a "${newReimburser}" (previamente "${previousReimburser}")`
        : `cambió el pagador autorizado a "${newReimburser}"`,
    updateReimbursementEnabled: ({ enabled }) =>
      `${enabled ? "habilitó" : "deshabilitó"} los reembolsos`,
    updatedManualApprovalThreshold: ({ oldLimit, newLimit }) =>
    ...
    addBudget: ({
      ...
      const thresholdSuffix =
        typeof notificationThreshold === "number"
          ? ` con umbral de notificación de "${notificationThreshold}%"`
          : "";
    ...
    updateBudget: ({
      ...
      if (frequencyChanged) {
        changesList.push(
          `cambió la frecuencia del presupuesto a "${newFrequency}" (antes "${oldFrequency}")`,
        );
      }

      if (sharedChanged) {
        changesList.push(
          `cambió el presupuesto compartido total del espacio de trabajo a "${newShared}" (antes "${oldShared}")`,
        );
      }

      if (individualChanged) {
        changesList.push(
          `cambió el presupuesto individual a "${newIndividual}" (antes "${oldIndividual}")`,
        );
      }

      if (thresholdChanged) {
        changesList.push(
          `cambió el umbral de notificación a "${newNotificationThreshold}%" (antes "${oldNotificationThreshold}%")`,
        );
      }
    ...
    updatedTimeEnabled: ({ enabled }) =>
      `${enabled ? "habilitó" : "deshabilitó"} el seguimiento de tiempo`,
    updatedTimeRate: ({ newRate, oldRate }) =>
      `cambió la tarifa por hora a "${newRate}" (anteriormente "${oldRate}")`,
    addedProhibitedExpense: ({ prohibitedExpense }) =>
      `añadió "${prohibitedExpense}" a los gastos prohibidos`,
    removedProhibitedExpense: ({ prohibitedExpense }) =>
      `eliminó "${prohibitedExpense}" de los gastos prohibidos`,
    ...
    setAutoJoin: ({ enabled }) =>
      `${enabled ? "habilitó" : "deshabilitó"} la aprobación previa de solicitudes para unirse al espacio de trabajo`,
    updatedDefaultTitle: ({ newDefaultTitle, oldDefaultTitle }) =>
      `cambió la fórmula personalizada del nombre del informe a "${newDefaultTitle}" (previamente "${oldDefaultTitle}")`,
    updatedOwnership: ({ oldOwnerEmail, oldOwnerName, policyName }) =>
      `asumió la propiedad del espacio de trabajo ${policyName} de ${oldOwnerName} (${oldOwnerEmail})`,
    updatedAutoHarvesting: ({ enabled }) =>
      `${enabled ? "habilitó" : "deshabilitó"} el envío programado`,
    ...
    updatedAttendeeTracking: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "habilitó" : "deshabilitó"} el seguimiento de asistentes`,
    updatedAutoPayApprovedReports: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "habilitó" : "deshabilitó"} el autopago de informes aprobados`,
    setAutoPayApprovedReportsLimit: ({ newLimit }: { newLimit: string }) =>
      `estableció el umbral de autopago de informes aprobados en "${newLimit}"`,
    ...
    removedAutoPayApprovedReportsLimit:
      "eliminó el umbral de autopago de informes aprobados",
    changedDefaultApprover: ({
      ...
      previousApprover
        ? `cambió el aprobador predeterminado a ${newApprover} (anteriormente ${previousApprover})`
        : `cambió el aprobador predeterminado a ${newApprover}`,
    ...
    updateCustomTaxName: ({ oldName, newName }) =>
      `cambió el nombre del impuesto personalizado a "${newName}" (antes "${oldName}")`,
    updateCurrencyDefaultTax: ({ oldName, newName }) =>
      `cambió la tasa impositiva predeterminada de la moneda del espacio de trabajo a "${newName}" (anteriormente "${oldName}")`,
    updateForeignCurrencyDefaultTax: ({ oldName, newName }) =>
      `cambió la tasa impositiva predeterminada de la moneda extranjera a "${newName}" (anteriormente "${oldName}")`,
    changedInvoiceCompanyName: ({
      ...
      oldValue
        ? `cambió el nombre de la empresa de la factura a "${newValue}" (previamente "${oldValue}")`
        : `estableció el nombre de la empresa de la factura como "${newValue}"`,
  ...
  roomMembersPage: {
    ...
    useInviteButton:
      "Para invitar a un nuevo miembro al chat, por favor, utiliza el botón invitar que está más arriba.",
    ...
    removeMembersPrompt: ({ memberName }) => ({
      ...
      other:
        "¿Estás seguro de que quieres eliminar a los miembros seleccionados de la sala de chat?",
    }),
    error: {
  ...
  newTaskPage: {
    ...
    confirmError:
      "Por favor, introduce un título y selecciona un destino de tarea",
    descriptionOptional: "Descripción (opcional)",
    pleaseEnterTaskName: "Por favor, introduce un título",
    pleaseEnterTaskDestination:
      "Por favor, selecciona dónde deseas compartir esta tarea",
  },
  task: {
    task: "Tarea",
    title: "Título",
    ...
    genericCreateTaskFailureMessage:
      "Error inesperado al crear la tarea. Por favor, inténtalo más tarde.",
  ...
  search: {
    ...
    searchResults: {
      ...
      emptyExpenseResults: {
        ...
        subtitle:
          "Crea un gasto o haz una prueba por Expensify para aprender más.",
        subtitleWithOnlyCreateButton:
          "Usa el botón verde de abajo para crear un gasto.",
      },
      emptyReportResults: {
        title: "Aún no has creado ningún informe",
        subtitle:
          "Crea un informe o haz una prueba de Expensify para aprender más.",
        subtitleWithOnlyCreateButton:
          "Usa el botón verde de abajo para crear un informe.",
      },
      emptyInvoiceResults: {
        title: "Aún no has creado \nninguna factura",
        subtitle:
          "Envía una factura o haz una prueba por Expensify para aprender más.",
        subtitleWithOnlyCreateButton:
          "Usa el botón verde de abajo para enviar una factura.",
      },
      emptyTripResults: {
    ...
    bulkActions: {
      ...
      reject: "Rechazar",
      noOptionsAvailable:
        "No hay opciones disponibles para el grupo de gastos seleccionado.",
    },
    ...
    filters: {
      ...
      limit: "Límite",
      limitDescription:
        "Establece un límite para los resultados de tu búsqueda.",
      currency: "Divisa",
      ...
      card: {
        ...
        cardFeedName: ({ cardFeedBankName, cardFeedLabel }) =>
          `Todo ${cardFeedBankName}${cardFeedLabel ? ` - ${cardFeedLabel}` : ""}`,
        cardFeedNameCSV: ({ cardFeedLabel }) =>
          `Todas las Tarjetas Importadas desde CSV${cardFeedLabel ? ` - ${cardFeedLabel}` : ""}`,
      },
      amount: {
        lessThan: (amount) => `Menos de ${amount ?? ""}`,
        greaterThan: (amount) => `Más que ${amount ?? ""}`,
        between: (greaterThan, lessThan) =>
          `Entre ${greaterThan} y ${lessThan}`,
    ...
    exportSearchResults: {
      ...
      description:
        "¡Wow, esos son muchos elementos! Los agruparemos y Concierge te enviará un archivo en breve.",
    },
    exportedTo: "Exported to",
    exportAll: {
      selectAllMatchingItems: "Seleccionar todos los elementos coincidentes",
      allMatchingItemsSelected:
        "Todos los elementos coincidentes seleccionados",
    },
  },
  genericErrorPage: {
  ...
  settlement: {
    ...
    failedError: ({ link }: { link: string }) =>
      `Reintentaremos esta liquidación cuando <a href="${link}">desbloquees tu cuenta</a>.`,
    withdrawalInfo: ({
      date,
      withdrawalID,
    }: {
      date: string;
      withdrawalID: number;
    }) => `${date} • ID de retiro: ${withdrawalID}`,
  },
  reportLayout: {
    ...
    selectGroup: ({ groupName }: { groupName: string }) =>
      `Seleccionar todos los gastos en ${groupName}`,
    groupBy: {
      category: "Categoría",
      tag: "Etiqueta",
    },
  ...
  report: {
    ...
    genericCreateReportFailureMessage:
      "Error inesperado al crear el chat. Por favor, inténtalo más tarde.",
    genericAddCommentFailureMessage:
      "Error inesperado al añadir el comentario. Por favor, inténtalo más tarde.",
    genericUpdateReportFieldFailureMessage:
      "Error inesperado al actualizar el campo. Por favor, inténtalo más tarde.",
    genericUpdateReportNameEditFailureMessage:
      "Error inesperado al cambiar el nombre del informe. Por favor, intentarlo más tarde.",
    noActivityYet: "Sin actividad todavía",
    connectionSettings: "Configuración de conexión",
    actions: {
      type: {
        changeField: ({ oldValue, newValue, fieldName }) =>
          `cambió ${fieldName} a "${newValue}" (previamente "${oldValue}")`,
        changeFieldEmpty: ({ newValue, fieldName }) =>
          `estableció ${fieldName} a ${newValue}`,
        ...
        changeType: (oldType, newType) =>
          `cambió type de ${oldType} a ${newType}`,
        ...
        exportedToIntegration: {
          ...
          manual: (label) =>
            `marcó este informe como exportado manualmente a ${label}.`,
        ...
        markedReimbursed: (amount, currency) =>
          `pagó ${currency}${amount} en otro lugar`,
        markedReimbursedFromIntegration: ({ amount, currency }) =>
          `pagó ${currency}${amount} mediante integración`,
        ...
        updateRole: ({ email, currentRole, newRole }) =>
          `actualizó el rol ${email} a ${newRole} (previamente ${currentRole})`,
        ...
        leftWorkspace: (nameOrEmail) =>
          `${nameOrEmail} salió del espacio de trabajo`,
        removeMember: (email, role) => `eliminado ${role} ${email}`,
        removedConnection: ({ connectionName }) =>
          `eliminó la conexión a ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        addedConnection: ({ connectionName }) =>
          `se conectó a ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        leftTheChat: "salió del chat",
        leftTheChatWithName: (nameOrEmail) =>
          `${nameOrEmail ? `${nameOrEmail}: ` : ""}salió del chat`,
      ...
      error: {
        invalidCredentials:
          "Credenciales no válidas, por favor verifica la configuración de tu conexión.",
      },
    },
  },
  chronos: {
    oooEventSummaryFullDay: (summary, dayCount, date) =>
      `${summary} por ${dayCount} ${dayCount === 1 ? "día" : "días"} hasta el ${date}`,
  ...
  threads: {
    ...
    from: "De",
    in: "en",
    parentNavigationSummary: ({ reportName, workspaceName }) =>
      `De ${reportName}${workspaceName ? ` en ${workspaceName}` : ""}`,
  },
  qrCodes: {
    qrCode: "Código QR",
    copy: "Copiar URL",
  ...
  moderation: {
    flagDescription:
      "Todos los mensajes marcados se enviarán a un moderador para tu revisión.",
    ...
    inconsiderateDescription:
      "Frase insultante o irrespetuosa, con intenciones cuestionables",
    intimidation: "Intimidación",
    intimidationDescription:
      "Persigue agresivamente una agenda sobre objeciones válidas",
    bullying: "Bullying",
    bullyingDescription: "Se dirige a un individuo para obtener obediencia",
    harassment: "Acoso",
    harassmentDescription:
      "Comportamiento racista, misógino u otro comportamiento discriminatorio",
    assault: "Agresion",
    assaultDescription:
      "Ataque emocional específicamente dirigido con la intención de hacer daño",
    flaggedContent:
      "Este mensaje ha sido marcado por violar las reglas de nuestra comunidad y el contenido se ha ocultado.",
    hideMessage: "Ocultar mensaje",
    revealMessage: "Revelar mensaje",
    levelOneResult:
      "Envía una advertencia anónima y el mensaje es reportado para revisión.",
    levelTwoResult:
      "Mensaje ocultado en el canal, más advertencia anónima y mensaje reportado para revisión.",
    levelThreeResult:
      "Mensaje eliminado del canal, más advertencia anónima y mensaje reportado para revisión.",
  },
  teachersUnitePage: {
    teachersUnite: "Profesores Unidos",
    joinExpensifyOrg:
      "Únete a Expensify.org para eliminar la injusticia en todo el mundo y ayuda a los profesores a dividir sus gastos para las aulas más necesitadas.",
    iKnowATeacher: "Yo conozco a un profesor",
    iAmATeacher: "Soy profesor",
    getInTouch:
      "¡Excelente! Por favor, comparte tu información para que podamos ponernos en contacto con ellos.",
    ...
    error: {
      ...
      tryDifferentEmail:
        "Por favor intenta con un correo electrónico diferente",
    },
  },
  cardTransactions: {
  ...
  distance: {
    ...
    mapPending: {
      ...
      errorSubtitle:
        "No se pudo cargar el mapa. Por favor, inténtalo de nuevo.",
    },
    error: {
      selectSuggestedAddress:
        "Por favor, selecciona una dirección sugerida o usa la ubicación actual",
    },
    odometer: {
      ...
      deleteOdometerPhotoConfirmation:
        "¿Estás seguro de que deseas eliminar esta foto del odómetro?",
      startMessageWeb:
        "Añade una foto de tu odómetro al <strong>inicio</strong> de tu viaje. Arrastra un archivo aquí o elige uno para subirlo.",
      endMessageWeb:
        "Añade una foto de tu odómetro al <strong>final</strong> de tu viaje. Arrastra un archivo aquí o elige uno para subirlo.",
      cameraAccessRequired: "Se requiere acceso a la cámara para tomar fotos.",
      snapPhotoStart:
        "<muted-text-label>Haz una foto de tu odómetro al <strong>inicio</strong> de tu viaje.</muted-text-label>",
      snapPhotoEnd:
        "<muted-text-label>Haz una foto de tu odómetro al <strong>final</strong> de tu viaje.</muted-text-label>",
    },
  },
  reportCardLostOrDamaged: {
    ...
    confirmAddressTitle:
      "Por favor, confirma la dirección postal de tu nueva tarjeta.",
    cardDamagedInfo:
      "La nueva tarjeta te llegará en 2-3 días laborables. La tarjeta actual seguirá funcionando hasta que actives la nueva.",
    cardLostOrStolenInfo:
      "La tarjeta actual se desactivará permanentemente en cuanto realices el pedido. La mayoría de las tarjetas llegan en pocos días laborables.",
    address: "Dirección",
    ...
    successDescription:
      "Tendrás que activarla cuando llegue en unos días hábiles. Mientras tanto, puedes usar una tarjeta virtual.",
  },
  eReceipt: {
  ...
  referralProgram: {
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
      buttonText:
        "Inicia un chat y <success><strong>recomienda a un amigo</strong></success>",
    ...
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
      buttonText:
        "Presenta un gasto y <success><strong>recomienda a tu equipo</strong></success>",
  ...
  systemChatFooterMessage: {
    [CONST.INTRO_CHOICES.MANAGE_TEAM]: ({ adminReportName, href }) =>
  ...
  violations: {
    ...
    cashExpenseWithNoReceipt: ({ formattedLimit } = {}) =>
      `Recibo obligatorio para cantidades mayores de ${formattedLimit}`,
    ...
    overAutoApprovalLimit: ({ formattedLimit }) =>
      `Importe supera el límite de aprobación automática${formattedLimit ? ` de ${formattedLimit}` : ""}`,
    overCategoryLimit: ({ formattedLimit }) =>
      `Importe supera el límite para la categoría${formattedLimit ? ` de ${formattedLimit}/persona` : ""}`,
    overLimit: ({ formattedLimit }) =>
      `Importe supera el límite${formattedLimit ? ` de ${formattedLimit}/persona` : ""}`,
    overTripLimit: ({ formattedLimit }) =>
      `Importe supera el límite${formattedLimit ? ` de ${formattedLimit}/viaje` : ""}`,
    overLimitAttendee: ({ formattedLimit }) =>
      `Importe supera el límite${formattedLimit ? ` de ${formattedLimit}/persona` : ""}`,
    perDayLimit: ({ formattedLimit }) =>
      `Importe supera el límite diario de la categoría${formattedLimit ? ` de ${formattedLimit}/persona` : ""}`,
    receiptNotSmartScanned:
      "Detalles del recibo y del gasto añadidos manualmente.",
    ...
    itemizedReceiptRequired: ({ formattedLimit }) =>
      `Recibo detallado requerido${formattedLimit ? ` para importes sobre ${formattedLimit}` : ""}`,
    ...
    brokenConnection530Error:
      "Recibo pendiente debido a una conexión bancaria rota",
    ...
    memberBrokenConnectionError:
      "Recibo pendiente debido a una conexión bancaria rota. Por favor, pide a un administrador del espacio de trabajo que lo resuelva.",
    markAsCashToIgnore:
      "Márcalo como efectivo para ignorar y solicitar el pago.",
    smartscanFailed: ({ canEdit = true }) =>
      `No se pudo escanear el recibo.${canEdit ? " Introduce los datos manualmente." : ""}`,
    receiptGeneratedWithAI: "Posible recibo generado por IA",
    someTagLevelsRequired: ({ tagName } = {}) => `Falta ${tagName ?? "Tag"}`,
    tagOutOfPolicy: ({ tagName } = {}) =>
      `La etiqueta ${tagName ? `${tagName} ` : ""}ya no es válida`,
    taxAmountChanged: "El importe del impuesto fue modificado",
    taxOutOfPolicy: ({ taxName } = {}) =>
      `${taxName ?? "El impuesto"} ya no es válido`,
    ...
    confirmDuplicatesInfo:
      "Los duplicados que no conserves se mantendrán para que el remitente los elimine.",
  ...
  reportViolations: {
    [CONST.REPORT_VIOLATIONS.FIELD_REQUIRED]: (fieldName) =>
      `${fieldName} es obligatorio`,
    reportContainsExpensesWithViolations:
      "El informe contiene gastos con violaciones.",
  },
  violationDismissal: {
    rter: {
  ...
  exitSurvey: {
    ...
    reasonPage: {
      ...
      subtitle:
        "Antes de irte, por favor dinos por qué te gustaría cambiarte a Expensify Classic.",
    },
    reasons: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "Necesito una función que sólo está disponible en Expensify Classic.",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "No entiendo cómo usar New Expensify.",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Entiendo cómo usar New Expensify, pero prefiero Expensify Classic.",
    },
    prompts: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "¿Qué función necesitas que no esté disponible en New Expensify?",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "¿Qué estás tratando de hacer?",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "¿Por qué prefieres Expensify Classic?",
    },
    ...
    quickTipSubTitle:
      "Puedes ir directamente a Expensify Classic visitando expensify.com. Márcalo como favorito para tener un acceso directo fácil.",
    ...
    benefits: {
      [CONST.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY]:
        "Chat directo sobre gastos e informes",
      [CONST.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE]:
        "Posibilidad de hacerlo todo desde el móvil",
      [CONST.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE]:
        "Viajes y gastos a la velocidad del chat",
    },
    bookACallTextTop: "Al cambiar a Expensify Classic, se perderá:",
    bookACallTextBottom:
      "Nos encantaría hablar con usted para entender por qué. Puede concertar una llamada con uno de nuestros jefes de producto para hablar de sus necesidades.",
  ...
  subscription: {
    ...
    mobileReducedFunctionalityMessage:
      "No puedes hacer cambios en tu suscripción en la aplicación móvil.",
    badge: {
      freeTrial: (numOfDays) =>
        `Prueba gratuita: ${numOfDays === 1 ? `queda 1 día` : `quedan ${numOfDays} días`}`,
    },
    billingBanner: {
      policyOwnerAmountOwed: {
        title: "Tu información de pago está desactualizada",
        subtitle: (date) =>
          `Actualiza tu tarjeta de pago antes del ${date} para continuar utilizando todas tus herramientas favoritas`,
      },
      ...
      policyOwnerUnderInvoicing: {
        title: "Tu información de pago está desactualizada",
        subtitle: (date) =>
          `Tu pago está vencido. Por favor, paga tu factura antes del ${date} para evitar la interrupción del servicio.`,
      },
      ...
      preTrial: {
        ...
        subtitle:
          'El próximo paso es <a href="#">completar la configuración</a> para que tu equipo pueda empezar a enviar gastos.',
      },
      trialStarted: {
        title: (numOfDays) =>
          `Prueba gratuita: ¡${numOfDays === 1 ? `queda 1 día` : `${numOfDays} días`}!`,
        subtitle:
          "Añade una tarjeta de pago para seguir utilizando tus funciones favoritas.",
      },
      trialEnded: {
      ...
      earlyDiscount: {
        ...
        onboardingChatTitle: (discountType) =>
          `Oferta por tiempo limitado: ¡${discountType}% de descuento en tu primer año!`,
        subtitle: (days, hours, minutes, seconds) =>
          `Solicítala en ${days > 0 ? `${days}d : ` : ""}${hours}h : ${minutes}m : ${seconds}s`,
      },
    },
    cardSection: {
      title: "Pago",
      ...
      cardInfo: (name, expiration, currency) =>
        `Nombre: ${name}, Expiración: ${expiration}, Moneda: ${currency}`,
      cardNextPayment: (nextPaymentDate) =>
        `Tu próxima fecha de pago es ${nextPaymentDate}.`,
    ...
    yourPlan: {
      ...
      collect: {
        title: "Recopilar",
        description:
          "El plan para pequeñas empresas que te ofrece gestión de gastos, viajes y chat.",
        priceAnnual: ({ lower, upper }) =>
          `Desde ${lower}/miembro activo con la Tarjeta Expensify, ${upper}/miembro activo sin la Tarjeta Expensify.`,
        pricePayPerUse: ({ lower, upper }) =>
          `Desde ${lower}/miembro activo con la Tarjeta Expensify, ${upper}/miembro activo sin la Tarjeta Expensify.`,
      ...
      saveWithExpensifyDescription:
        "Utiliza nuestra calculadora de ahorro para ver cómo el reembolso en efectivo de la Tarjeta Expensify puede reducir tu factura de Expensify",
    ...
    details: {
      ...
      zeroCommitment:
        "Compromiso cero con la tarifa de suscripción anual reducida",
    },
    subscriptionSize: {
      title: "Tamaño de suscripción",
      yourSize:
        "El tamaño de tu suscripción es el número de plazas abiertas que puede ocupar cualquier miembro activo en un mes determinado.",
      eachMonth:
      ...
      youCantDowngrade:
        "No puedes bajar de categoría durante tu suscripción anual.",
      ...
      error: {
        ...
        sameSize:
          "Por favor, introduce un número diferente al de tu subscripción actual",
      },
    },
    paymentCard: {
      ...
      security:
        "Expensify es PCI-DSS obediente, utiliza cifrado a nivel bancario, y emplea infraestructura redundante para proteger tus datos.",
    ...
    expensifyCode: {
      ...
      enterCode:
        "Introduce un código Expensify para aplicarlo a tu suscripción.",
      apply: "Aplicar",
      error: {
    ...
    subscriptionSettings: {
      ...
      saveUpTo: (amountWithCurrency) =>
        `Ahorre hasta ${amountWithCurrency} al mes por miembro activo`,
      ...
      pricingConfiguration:
        "El precio depende de la configuración. Para obtener el precio más bajo, elige una suscripción anual y obtén la Tarjeta Expensify.",
      ...
      changesBasedOn:
        "Esto varía según el uso de tu Tarjeta Expensify y las opciones de suscripción que elijas a continuación.",
    },
    requestEarlyCancellation: {
      title: "Solicitar cancelación anticipada",
      subtitle:
        "¿Cuál es la razón principal por la que solicitas la cancelación anticipada?",
  ...
  delegate: {
    ...
    copilotDelegatedAccessDescription:
      "Permitir que otros miembros accedan a tu cuenta.",
    ...
    youCanAccessTheseAccounts:
      "Puedes acceder a estas cuentas a través del conmutador de cuentas:",
    role: ({ role } = {}) => {
      switch (role) {
    ...
    accessLevelDescription:
      "Elige un nivel de acceso a continuación. Tanto el acceso Completo como el Limitado permiten a los copilotos ver todas las conversaciones y gastos.",
    ...
    removeCopilotConfirmation:
      "¿Estás seguro de que quieres eliminar este copiloto?",
    ...
    enterMagicCodeUpdate: (contactMethod) =>
    ...
    noAccessMessage:
      "Como copiloto, no tienes acceso a esta página. ¡Lo sentimos!",
  ...
  debug: {
    ...
    invalidProperty: ({ propertyName, expectedType }) =>
      `Propiedad inválida: ${propertyName} - Esperado: ${expectedType}`,
    invalidValue: ({ expectedValues }) =>
    ...
    reasonVisibleInLHN: {
      ...
      hasAddWorkspaceRoomErrors:
        "Tiene errores al agregar sala de espacio de trabajo",
    ...
    reasonGBR: {
      ...
      isWaitingForAssigneeToCompleteAction:
        "Esperando a que el asignado complete la acción",
      ...
      hasUnresolvedCardFraudAlert:
        "Tiene una alerta de fraude de tarjeta sin resolver",
    ...
    reasonRBR: {
      ...
      hasTransactionThreadViolations:
        "Tiene violaciones de hilo de transacciones",
    },
    indicatorStatus: {
      ...
      theresAWorkspaceWithCustomUnitsErrors:
        "Hay un espacio de trabajo con errores en las unidades personalizadas",
      theresAProblemWithAWorkspaceMember:
        "Hay un problema con un miembro del espacio de trabajo",
      theresAProblemWithAWorkspaceQBOExport:
        "Hubo un problema con la configuración de exportación de la conexión del espacio de trabajo.",
      theresAProblemWithAContactMethod:
        "Hay un problema con un método de contacto",
      ...
      theresAProblemWithYourReimbursementAccount:
        "Hay un problema con tu cuenta de reembolso",
      theresABillingProblemWithYourSubscription:
        "Hay un problema de facturación con tu suscripción",
      yourSubscriptionHasBeenSuccessfullyRenewed:
        "Tu suscripción se ha renovado con éxito",
      theresWasAProblemDuringAWorkspaceConnectionSync:
        "Hubo un problema durante la sincronización de la conexión del espacio de trabajo",
      theresAProblemWithYourWallet: "Hay un problema con tu billetera",
      theresAProblemWithYourWalletTerms:
        "Hay un problema con los términos de tu billetera",
    },
  },
  emptySearchView: {
  ...
  migratedUserWelcomeModal: {
    ...
    subtitle:
      "Tiene todo lo que te encanta de nuestra experiencia clásica con un montón de mejoras para hacerte la vida aún más fácil:",
    confirmText: "¡Vamos!",
    helpText: "Prueba la demo de 2 minutos",
    features: {
      search: "Búsqueda más potente en móviles, web y ordenadores",
      concierge:
        "Concierge AI integrada para ayudarte a automatizar tus gastos",
  ...
  productTrainingTooltip: {
    ...
    saveSearchTooltip:
      "<tooltip><strong>Renombra tus búsquedas guardadas</strong> aquí</tooltip>",
    accountSwitcher:
      "<tooltip>Accede a tus <strong>cuentas copiloto</strong> aquí</tooltip>",
    scanTestTooltip: {
      main: "<tooltip>¡<strong>Escanea nuestro recibo de prueba</strong> para ver cómo funciona!</tooltip>",
      manager:
        "<tooltip>¡Elige a <strong>nuestro gerente</strong> de prueba para probarlo!</tooltip>",
      confirmation:
        "<tooltip>Ahora, <strong>envía tu gasto y</strong>\n¡observa cómo ocurre la magia!</tooltip>",
      tryItOut: "Prueba esto",
    },
    outstandingFilter:
      "<tooltip>Filtra los gastos\nque <strong>necesitan aprobación</strong></tooltip>",
    scanTestDriveTooltip:
      "<tooltip>¡Envía este recibo para\n<strong>completar la prueba</strong>!</tooltip>",
    gpsTooltip:
      "<tooltip>¡Seguimiento por GPS en curso! Cuando termines, detén el seguimiento a continuación.</tooltip>",
    hasFilterNegation:
      "<tooltip>Busca gastos sin recibos usando <strong>-has:receipt</strong>.</tooltip>",
  },
  ...
  scheduledCall: {
    book: {
      ...
      slots: ({ date }) =>
        `<muted-text>Horarios disponibles para el <strong>${date}</strong></muted-text>`,
    },
    confirmation: {
      title: "Confirmar llamada",
      description:
        "Asegúrate de que los detalles a continuación sean correctos. Una vez que confirmes la llamada, enviaremos una invitación con más información.",
  ...
  autoSubmitModal: {
    ...
    description:
      "Se han solucionado todas las advertencias e infracciones, así que:",
    submittedExpensesTitle: "Estos gastos han sido enviados",
    submittedExpensesDescription:
      "Estos gastos se han enviado a tu aprobador pero aún se pueden editar hasta que sean aprobados.",
    pendingExpensesTitle: "Los gastos pendientes se han movido",
    pendingExpensesDescription:
      "Todo gasto de tarjeta pendiente se ha movido a un informe separado hasta que sea contabilizado.",
  },
  testDrive: {
    quickAction: {
    ...
    modal: {
      ...
      description:
        "Haz un recorrido rápido por el producto para ponerte al día rápidamente.",
      ...
      employee: {
        ...
        error:
          "Ese miembro es propietario de un espacio de trabajo, por favor introduce un nuevo miembro para probar.",
      },
    },
    banner: {
  ...
  domain: {
    ...
    verifyDomain: {
      ...
      accessYourDNS: ({ domainName }: { domainName: string }) =>
        `Accede a tu proveedor de DNS y abre la configuración DNS de <strong>${domainName}</strong>.`,
      addTXTRecord: "Añade el siguiente registro TXT:",
      saveChanges:
        "Guarda los cambios y vuelve aquí para verificar tu dominio.",
      ...
      genericError:
        "No pudimos verificar tu dominio. Por favor, inténtalo de nuevo y contacta con Concierge si el problema persiste.",
    },
    domainVerified: {
    ...
    samlLogin: {
      ...
      anyMemberWillBeRequired:
        "Cualquier miembro que haya iniciado sesión con un método diferente deberá volver a autenticarse usando SAML.",
      enableError:
        "No se pudo actualizar la configuración de habilitación de SAML",
      requireError:
        "No se pudo actualizar la configuración de requerimiento de SAML",
      ...
      requireWithEmptyMetadataError:
        "Por favor, añade los metadatos del Proveedor de Identidad a continuación para habilitar",
    ...
    samlConfigurationDetails: {
      ...
      fetchError:
        "No se pudieron obtener los detalles de configuración de SAML",
      setMetadataGenericError:
        "No se pudieron establecer los metadatos de SAML",
    },
    accessRestricted: {
    ...
    addDomain: {
      ...
      subtitle:
        "Introduce el nombre del dominio privado al que deseas acceder (por ejemplo, expensify.com).",
    ...
    domainAdded: {
      ...
      description:
        "A continuación, deberás verificar la propiedad del dominio y ajustar tu configuración de seguridad.",
      configure: "Configurar",
    },
    enhancedSecurity: {
      title: "Seguridad mejorada",
      subtitle:
        "Solicita que los miembros de tu dominio inicien sesión mediante inicio de sesión único, restringe la creación de espacios de trabajo y más.",
      enable: "Habilitar",
    },
    ...
    admins: {
      ...
      setPrimaryContactError:
        "No se pudo establecer el contacto principal. Por favor, inténtalo de nuevo más tarde.",
      ...
      consolidatedDomainBillingError:
        "No se pudo cambiar la facturación consolidada del dominio. Por favor, inténtalo de nuevo más tarde.",
      addAdmin: "Añadir administrador",
      addAdminError:
        "No se pudo añadir a este miembro como administrador. Por favor, inténtalo de nuevo.",
      revokeAdminAccess: "Revocar acceso de administrador",
      cantRevokeAdminAccess:
        "No se puede revocar el acceso de administrador del contacto técnico",
      error: {
        removeAdmin:
          "No se pudo eliminar a este usuario como administrador. Por favor, inténtalo de nuevo.",
        removeDomain:
          "No se pudo eliminar este dominio. Por favor inténtalo de nuevo.",
        removeDomainNameInvalid:
          "Introduce el nombre de tu dominio para restablecerlo.",
      },
      resetDomain: "Restablecer dominio",
      resetDomainExplanation: ({ domainName }: { domainName?: string }) =>
        `Por favor escribe <strong>${domainName}</strong> para confirmar el restablecimiento del dominio.`,
    ...
    members: {
      ...
      closeAccountInfo: () => ({
        ...
        other:
          "Recomendamos cerrar las cuentas de forma segura para omitir el cierre si hay: <bullet-list><bullet-item>Aprobaciones pendientes</bullet-item><bullet-item>Reembolsos en curso</bullet-item><bullet-item>No hay otro método de inicio de sesión</bullet-item></bullet-list>De lo contrario, puedes ignorar las precauciones de seguridad anteriores y forzar el cierre de las cuentas seleccionadas.",
      }),
      error: {
        removeMember:
          "No se pudo eliminar a este usuario. Por favor, inténtalo de nuevo.",
        addMember:
          "No se pudo añadir este miembro. Por favor, inténtalo de nuevo.",
        vacationDelegate:
          "No se pudo establecer a este usuario como delegado de vacaciones. Por favor, inténtalo de nuevo.",
      },
    ...
    common: {
      ...
      forceTwoFactorAuthError:
        "No se pudo cambiar la autenticación de dos factores forzada. Por favor, inténtalo de nuevo más tarde.",
  ...
  gps: {
    error: {
      ...
      failedToGetPermissions:
        "No se pudieron obtener los permisos de ubicación necesarios.",
    },
    ...
    discardDistanceTrackingModal: {
      ...
      prompt:
        "¿Estás seguro? Esto descartará tu trayecto actual y no se puede deshacer.",
      confirm: "Descartar seguimiento de distancia",
    },
    zeroDistanceTripModal: {
      title: "No se puede crear el gasto",
      prompt:
        "No puedes crear un gasto con la misma ubicación de inicio y fin.",
    },
    locationRequiredModal: {
      title: "Se requiere acceso a la ubicación",
      prompt:
        "Por favor, permite el acceso a la ubicación en la configuración de tu dispositivo para iniciar el seguimiento de distancia por GPS.",
      allow: "Permitir",
    },
    androidBackgroundLocationRequiredModal: {
      title: "Se requiere acceso a la ubicación en segundo plano",
      prompt:
        'Por favor, permite el acceso a la ubicación en segundo plano en la configuración de tu dispositivo (opción "Permitir solo con la app en uso") para iniciar el seguimiento de distancia por GPS.',
    },
    preciseLocationRequiredModal: {
      title: "Se requiere ubicación precisa",
      prompt:
        'Por favor, habilita la "ubicación precisa" en la configuración de tu dispositivo para iniciar el seguimiento de distancia por GPS.',
    },
    desktop: {
      title: "Registra la distancia en tu teléfono",
      subtitle:
        "Registra millas o kilómetros automáticamente con GPS y convierte los viajes en gastos al instante.",
    ...
    continueGpsTripModal: {
      ...
      prompt:
        "Parece que la app se cerró durante tu último viaje por GPS. ¿Te gustaría continuar grabando ese viaje?",
    ...
    switchToODWarningTripInProgress: {
      title: "Seguimiento por GPS en curso",
      prompt:
        "¿Seguro que quieres detener el seguimiento por GPS y cambiar a Expensify Classic?",
    ...
    locationServicesRequiredModal: {
      ...
      prompt:
        "Por favor, permite el acceso a la ubicación en los ajustes de tu dispositivo para iniciar el seguimiento de distancia por GPS.",
    },
