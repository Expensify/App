    ...
    workspace: {
        ...
        card: {
            ...
            issueNewCard: {
                ...
                addExpirationDate: 'Agregar fecha de vencimiento',
                addExpirationDateDescription: 'Si no se establece una fecha específica, la tarjeta vencerá según la fecha de vencimiento existente en la tarjeta',
                amount: 'Importe',
