...
export default {
    ...
    termsStep: {
        ...
        shortTermsForm: {
            ...
            instant: '(instantáneo)',
            electronicFundsInstantFeeMin: '(mínimo US$0,25)',
        },
        longTermsForm: {
            ...
            fdicInsuranceBancorp:
                ...
                `están asegurados hasta US$250.000 por la FDIC en caso de que ${CONST.WALLET.PROGRAM_ISSUERS.BANCORP_BANK} quiebre. Ver`,
