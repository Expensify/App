...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        companyCards: {
            ...
            editStartDateDescription: "Elige una nueva fecha de inicio de transacciones. Sincronizaremos todas las transacciones a partir de esa fecha, excepto las que ya hayamos importado.",
