...
${amount} para ${merchant} - ${date}`,
    ...
    autoSubmitModal: {
        ...
        submittedExpensesTitle: 'Se han enviado los gastos conformes',
        submittedExpensesDescription: 'Los gastos conformes han sido enviados a tu aprobador, pero aún pueden editarse hasta que sean aprobados.',
