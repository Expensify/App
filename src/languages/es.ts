...
const translations: TranslationDeepObject<typeof en> = {
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            locked: 'Bloqueada',
            incompleteDescription: 'Termina de agregar la cuenta bancaria',
            pendingDescription: 'Por favor, confirma las transacciones de prueba',
            verifyingDescription: 'Estamos revisando tu documentación',
            lockedDescription: 'Esta cuenta requiere atención',
            finish: 'Terminar',
            confirm: 'Confirmar',
            unlock: 'Desbloquear',
        },
        cardFixConnection: 'Por favor, arregla esta conexión',
        cardAskAdminToFix: 'Por favor, pide a un administrador que arregle esta conexión',
        cardAdminFixConnection: 'Por favor, arregla esta conexión en Tarjetas corporativas',
        lastSynced: (dateStr: string) => `Última sincronización ${dateStr}`,
