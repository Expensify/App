...
${amount} para ${merchant} - ${date}`,
        ...
        pinUnblockedDescription: 'Termina de desbloquear tu tarjeta insertándola en el lector cuando hagas tu próxima compra.',
        pinBlocked: 'Tu tarjeta fue bloqueada debido a entradas de PIN incorrectas. Cambia tu PIN para desbloquear tu tarjeta.',
