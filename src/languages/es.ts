...
const translations = {
    ...
    iou: {
        ...
        error: {
            ...
            tryAgainMessage: 'intenta de nuevo ',
            saveFileMessage: ' guarda el archivo',
            uploadLaterMessage: ' para subirlo más tarde.',
        ...
        dismissReceiptErrorConfirmation: '¡Atención! Descartar este error eliminará tu archivo cargado por completo. ¿Estás seguro?',
