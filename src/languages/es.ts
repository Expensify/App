...
const translations = {
    ...
    workspace: {
        ...
        expensifyCard: {
            ...
            issuedCardVirtual: ({assignee, link}: IssueVirtualCardParams) => `emitió a ${assignee} una Tarjeta Expensify virtual. La ${link} puede utilizarse inmediatamente.`,
            ...
            replacedCard: ({assignee}: AssigneeParams) => `${assignee} reemplazó su Tarjeta Expensify. La nueva tarjeta llegará en 2-3 días hábiles.`,
            replacedVirtualCard: ({assignee, link}: IssueVirtualCardParams) => `${assignee} reemplazó su Tarjeta Expensify virtual! La ${link} puede utilizarse inmediatamente.`,
            card: 'tarjeta',
