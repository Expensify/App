...
const translations: TranslationDeepObject<typeof en> = {
    ...
    contacts: {
        ...
        helpText: ({email}: {email: string}) =>
            `Agrega más formas de iniciar sesión y enviar recibos a Expensify.<br/><br/>Agrega una dirección de correo electrónico para reenviar recibos a <copy-text text="${email}">${email}</copy-text> o agrega un número de teléfono para enviar recibos por mensaje de texto al 47777 (solo números de EE. UU.).`,
