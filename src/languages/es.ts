...
const translations = {
    ...
    iou: {
        ...
        movedTransactionTo: ({reportUrl, reportName}: MovedTransactionParams) => `movió este gasto${reportName ? ` de <a href="${reportUrl}">${reportName}</a>` : ''}`,
        movedTransactionFrom: ({reportUrl, reportName}: MovedTransactionParams) => `movió este gasto${reportName ? ` from <a href="${reportUrl}">${reportName}</a>` : ''}`,
