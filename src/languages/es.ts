...
${amount} para ${merchant} - ${date}`,
    ...
    workspaceActions: {
        ...
        updatedOwnership: ({oldOwnerEmail, oldOwnerName, policyName}) => `asumió la propiedad del espacio de trabajo de <strong>${policyName}</strong> de ${oldOwnerName} (${oldOwnerEmail})`,
