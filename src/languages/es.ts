...
export default {
    ...
    task: {
        ...
        messages: {
            ...
            updatedField: ({fieldName, newValueToDisplay}: UpdatedTaskFieldParams) => `cambió ${fieldName === 'título' ? 'el' : 'la'} ${fieldName} a "${newValueToDisplay}"`,
            removedField: ({fieldName}: RemovedTaskFieldParams) => `eliminó la ${fieldName}`,
            updatedAssignee: ({assignee}: UpdatedTaskAssigneeParams) => `asignó a ${assignee}`,
        },
