...
${reportName}`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                confirmErrorCategoryTax: 'Selecciona una tasa de impuestos',
                confirmErrorCondition: 'Selecciona un comercio o una categoría',
                confirmErrorConditionAndDefault: 'Selecciona un comercio o una categoría y aplica al menos un valor predeterminado',
                turnOnTaxesFirstTitle: 'Activa primero los impuestos',
                turnOnTaxesFirstPrompt:
                    'Las reglas de categoría establecen una tasa de impuesto predeterminada. Activa los impuestos en la configuración de tu espacio de trabajo para poder usarlos.',
