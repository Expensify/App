...
export default {
    ...
    loungeAccessPage: {
        checkIn: 'Registrarse',
        youAreCheckedIn: '¡Estás registrado!',
        addressLabel: 'Dirección',
        address: '88 Kearny Street, Floor 16, San Francisco, CA',
        nextCheckInLabel: 'Próximo check-in',
        nextCheckInBeforeNumberCheckIn: ({checkInsRemaining}: RemainingCheckInsParams) =>
            `Eres elegible para realizar el check-in en la sala vip y te queda${checkInsRemaining === 1 ? '' : 'n'}`,
        ...
        noCheckInsLeftFirstPart: 'No quedan más check-ins este mes',
        noCheckInsLeftSecondPart: ({nextCheckIn}: NoCheckInsLeftParams) => `, pero podrás volver a realizar el check-in el ${nextCheckIn}.`,
        loungeAccess: 'Acceso a la sala vip',
        headline: '¿Qué es la sala vip Expensify?',
        description:
