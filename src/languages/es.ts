...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        rillet: {
            ...
            howToFindAPIKey:
                '<strong>Encontrar tu clave de API.</strong><ol><li>Inicia sesión en Rillet</li><li>Ve a [organization name] -> Configuración de la organización -> Acceso a la API</li><li>Crea una clave de API</li><li>Copia la clave de API a continuación</li></ol>',
            subsidiary: 'Filial',
