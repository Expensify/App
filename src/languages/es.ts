...
${amount} para ${merchant} - ${date}`,
    ...
    workflowsExpensesFromPage: {
        ...
        moveEveryoneToNewWorkflowTitle: 'Mover a todos a un nuevo flujo de trabajo',
        moveEveryoneToNewWorkflowPrompt:
            'Estás a punto de mover a todos a un nuevo flujo de trabajo de aprobación. Esto eliminará todos los flujos de trabajo de aprobación existentes y moverá a todos al nuevo. Esta acción no se puede deshacer.',
    },
