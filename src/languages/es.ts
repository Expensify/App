...
const translations = {
    ...
    walletPage: {
        ...
        enableWallet: 'Habilitar billetera',
        addBankAccountToSendAndReceive: 'Añadir una cuenta bancaria te permite recibir reembolsos por los gastos que envíes a un espacio de trabajo.',
    ...
    report: {
        ...
        actions: {
            type: {
                ...
                addEmployee: ({email, role}: AddEmployeeParams) => `añadió a ${email} como ${role === 'user' ? 'miembro' : 'administrador'}`,
