...
const translations = {
    ...
    bankAccount: {
        ...
        hasPhoneLoginError:
            'Para añadir una cuenta bancaria verificada, <a>asegúrate de que tu nombre de usuario principal sea un correo electrónico válido</a> y vuelve a intentarlo. Puedes añadir tu número de teléfono como nombre de usuario secundario.',
