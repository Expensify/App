...
const translations = {
    ...
    docusignStep: {
        ...
        pleaseComplete:
            'Por favor, complete el formulario de autorización ACH con el enlace de Docusign a continuación y luego cargue esa copia firmada aquí para que podamos retirar fondos directamente de su cuenta bancaria.',
        pleaseCompleteTheBusinessAccount: 'Por favor, complete la Solicitud de Cuenta Comercial para el Acuerdo de Débito Directo.',
        pleaseCompleteTheDirect:
            'Por favor, complete el Acuerdo de Débito Directo usando el enlace de Docusign a continuación y luego cargue esa copia firmada aquí para que podamos retirar fondos directamente de su cuenta bancaria.',
