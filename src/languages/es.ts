...
export default {
    ...
    report: {
        ...
        actions: {
            type: {
                changeField: ({value, oldValue, fieldName}: ChangeFieldParams) => `cambió ${fieldName} de ${oldValue} a ${value}`,
                changePolicy: ({value, oldValue}: ModifyExpenseParams) => `cambió policy de ${oldValue} a ${value}`,
                changeType: ({value, oldValue}: ModifyExpenseParams) => `cambió type de ${oldValue} a ${value}`,
                delegateSubmit: ({delegateUser, awayUser}: DelegateSubmitParams) => `envié este informe a ${delegateUser} ya que ${awayUser} está de vacaciones`,
                exportedToCSV: `exportó este informe a CSV`,
                exportedToIntegration: `exportó este informe a Integration`,
                exportedToQuickBooks: `exportó este informe a QuickBooks`,
                ...
                markedReimbursedFromIntegration: ({amount, currency}: MarkedReimbursedParams) => `pagó ${currency}${amount} mediante integración`,
                ...
                share: ({user}: ShareParams) => `usuario invitado ${user}`,
                unshare: ({user}: ShareParams) => `usuario eliminado ${user}`,
