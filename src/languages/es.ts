...
export default {
    common: {
        ...
        error: {
            ...
            invalidDateShouldBeFuture: 'Por favor elija una fecha igual o posterior a hoy',
            invalidTimeShouldBeFuture: 'Por favor elija una hora al menos un minuto en el futuro',
