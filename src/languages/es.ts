...
export default {
    ...
    report: {
        ...
        actions: {
            type: {
                changeField: ({value, oldValue, fieldName}: ChangeFieldParams) => `changed ${fieldName} from ${oldValue} to ${value}`,
                changePolicy: ({value, oldValue}: ModifyExpenseParams) => `changed policy from ${oldValue} to ${value}`,
                changeType: ({value, oldValue}: ModifyExpenseParams) => `changed type from ${oldValue} to ${value}`,
                delegateSubmit: ({delegateUser, targetUser}: DelegateSubmitParams) => `sent this report to ${delegateUser} since ${targetUser} is on vacation`,
                ...
                exportedToIntegration: `exported this report to Integration`,
                exportedToQuickBooks: `exported this report to QuickBooks`,
                forwarded: ({amount}: ForwardedParams) => `approved ${amount}`,
                ...
                markedReimbursed: ({amount}: MarkedReimbursedParams) => `paid ${amount} elsewhere`,
                markedReimbursedFromIntegration: ({amount}: MarkedReimbursedParams) => `paid ${amount} via integration`,
                ...
                reimbursementDelayed: ({delayReason}: ReimbursementDelayedParams) => `delayed payment up to two business day due to ${delayReason}`,
                ...
                share: ({user}: ShareParams) => `invited user ${user}`,
                unshare: ({user}: ShareParams) => `invited user ${user}`,
                stripePaid: ({amount}: StripePaidParams) => `paid ${amount}`,
