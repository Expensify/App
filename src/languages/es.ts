...
${amount} para ${merchant} - ${date}`,
    ...
    activateCardPage: {
        ...
        fillInAllDetails: 'Por favor, completa todos los datos a continuación',
    },
    getPhysicalCard: {
...
El plan Controlar empieza en 9 $ por miembro activo al mes.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                enterShippingAddress: 'Introduce la dirección de envío',
                shippingAddressDescription: 'Dinos a dónde debemos enviar la nueva tarjeta.',
                promptCardholder: 'Solicitar al titular de la tarjeta',
                promptCardholderDescription: 'Se le pedirá a la persona titular de la tarjeta que introduzca o confirme su dirección de envío.',
