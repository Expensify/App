...
export default {
    ...
    violations: {
        ...
        none: 'Ninguno',
        taxCodeToKeep: 'Elige qué tasa de impuesto quieras conservar',
        tagToKeep: 'Elige la etiqueta que quieras conservar',
        isTransactionReimbursable: 'Elige si la transacción es reembolsable',
        merchantToKeep: 'Elige qué comerciante quieras conservar',
        descriptionToKeep: 'Elige la descripción que quieras conservar',
        categoryToKeep: 'Elige la categoría que quieras conservar',
