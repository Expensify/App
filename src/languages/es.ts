...
${amount} para ${merchant} - ${date}`,
    ...
    onboarding: {
        ...
        personalTrackGoal: {
            title: '¿Qué te interesa rastrear?',
            [CONST.ONBOARDING_PERSONAL_TRACK_GOALS.INVESTMENT_TRACKING]: 'Seguimiento de inversiones',
            [CONST.ONBOARDING_PERSONAL_TRACK_GOALS.HOUSEHOLD_TRACKING]: 'Seguimiento del hogar',
            [CONST.ONBOARDING_PERSONAL_TRACK_GOALS.SIDEPROJECT_TRACKING]: 'Seguimiento de proyectos secundarios',
            [CONST.ONBOARDING_PERSONAL_TRACK_GOALS.SOMETHING_ELSE]: 'Algo más',
            somethingElsePlaceholder: 'Cuéntanos qué quieres rastrear',
        },
        employees: {
