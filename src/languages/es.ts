...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    sidebarScreen: {
        ...
        fabNewChatExplained: '[es] Open actions menu',
    ...
    homePage: {
        ...
        assignedCards: '[es] Your Expensify Cards',
        assignedCardsRemaining: ({amount}: {amount: string}) => `[es] ${amount} remaining`,
    ...
    iou: {
        ...
        transactionPendingDescription: '[es] Transaction pending. It may take a few days to post.',
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[es] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[es] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[es] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[es] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[es] Get clients setup successfully',
            accountManagerApprovedDescription: '[es] Ask questions and get client support',
            moreResources: '[es] More resources',
        },
    ...
    deviceManagementPage: {
        ...
        description: '[es] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[es] Revoke',
    ...
    twoFactorAuth: {
        ...
        keepCodesSafe: '[es] Keep these recovery codes safe!',
    ...
    walletPage: {
        ...
        assignedCards: '[es] Assigned cards',
        assignedCardsDescription: '[es] Transactions from these cards sync automatically.',
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[es] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[es] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[es] Go to Gusto settings',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[es] Here's the list of workspaces you can join. Don't worry, you can always join them later if you prefer.",
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    workspace: {
        common: {
            ...
            travelInvoicing: '[es] Export Expensify Travel Payable To',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                travelInvoicing: {
                    ...
                    centralInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[es] We weren't able to provision some of the members of your workspace for central invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[es] Central Invoicing enabled!',
        ...
        people: {
            ...
            configureGustoSync: '[es] Configure Gusto sync.',
            syncWithGusto: '[es] Sync with Gusto',
        ...
        hr: {
            ...
            settingsTitle: '[es] Gusto settings',
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
            ...
            gusto: {
                ...
                disconnect: '[es] Disconnect',
                lastSync: (relativeDate: string) => `[es] Last synced ${relativeDate}`,
                syncError: "[es] Can't connect to Gusto",
                disconnectTitle: '[es] Disconnect Gusto',
                disconnectPrompt: '[es] Are you sure you want to disconnect Gusto?',
                connectionDescription: '[es] Connect Gusto to keep employee approvals in sync with your workspace.',
                approvalMode: '[es] Approval mode',
                finalApprover: '[es] Final approver',
                notSet: '[es] Not set',
                approvalModeDescription: '[es] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[es] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[es] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[es] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[es] Basic approval',
                        description: '[es] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[es] Manager approval',
                        description: '[es] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[es] Custom approval',
                        description: '[es] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[es] Gusto sync results',
                    successTitle: '[es] Successfully synced your Gusto connection!',
                    added: '[es] Added',
                    removed: '[es] Removed',
                    skipped: '[es] Skipped',
                    employeeCount: () => ({
            ...
            zenefits: {
                ...
                disconnect: '[es] Disconnect',
                lastSync: (relativeDate: string) => `[es] Last synced ${relativeDate}`,
                syncError: "[es] Can't connect to TriNet",
                disconnectTitle: '[es] Disconnect TriNet',
                disconnectPrompt: '[es] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[es] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[es] Approval mode',
                finalApprover: '[es] Final approver',
                notSet: '[es] Not set',
                approvalModeDescription: '[es] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[es] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[es] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[es] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[es] Basic approval',
                    ...
                    manager: {
                        label: '[es] Manager approval',
                        description: '[es] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[es] Custom approval',
                        description: "[es] I'll manually setup approval workflows in Expensify.",
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            note: (subscriptionLink: string) => `[es] <muted-text>Upgrade to access this feature, or <a href="${subscriptionLink}">learn more</a> about our plans and pricing.</muted-text>`,
...
Add more spend rules to protect company cash flow.`,
        ...
        planTypePage: {
            ...
            description: "[es] Choose a plan that's right for you. For a detailed list of features and pricing, check out our",
            subscriptionLink: '[es] plan types and pricing help page',
    ...
    search: {
        ...
        filters: {
            ...
            card: {
                ...
                centralInvoicing: '[es] Central invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[es] Central invoicing',
            },
            is: '[es] Is',
            action: {
    ...
    violations: {
        ...
        smartscanFailed: ({canEdit = true}) => `[es] Receipt scanning failed.${canEdit ? '[es]  Enter details manually.' : ''}`,
