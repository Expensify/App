...
${amount} para ${merchant} - ${date}`,
    ...
    workspaceActions: {
        ...
        forcedCorporateUpgrade: 'Este espacio de trabajo ha sido actualizado al plan Control. Haz clic <a href="%baseURL/articles/new-expensify/billing-and-subscriptions/Billing-Overview">aquí</a> para obtener más información.',
