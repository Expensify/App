...
const translations = {
    ...
    spreadsheet: {
        ...
        importMembersSuccessfulDescription: ({members}: ImportMembersSuccessfulDescriptionParams) => (members > 1 ? `Se han agregado ${members} miembros.` : 'Se ha agregado 1 miembro.'),
