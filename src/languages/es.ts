        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    ...
                    officeBasedHelp: 'La persona se desplaza habitualmente a una oficina. Los trayectos ordinarios no se reembolsan.',
                    noRegularWorkplaceTitle: 'Sin lugar de trabajo fijo',
                    noRegularWorkplaceHelp:
                        'El miembro trabaja en remoto o no tiene un lugar de trabajo fijo, por lo que no se aplican las normas sobre desplazamiento desde casa al trabajo.',
                    startingPrompt: {
                        title: 'Establece una modalidad de trabajo habitual',
                        prompt: 'Elige la modalidad que se aplique a la mayoría de los miembros actuales. Podrás actualizar los miembros individualmente o en bloque más adelante.',
                        officeBasedHelp: 'La mayoría de los miembros se desplazan a una oficina. Los desplazamientos habituales están excluidos.',
                        noRegularWorkplaceHelp: 'La mayoría de los miembros trabajan en remoto, así que las exclusiones por desplazamiento de casa al trabajo normalmente no se aplican.',
                        confirm: 'Aplicar',
                    },
                },
            },
...
${reportName}`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            ...
            set: ({arrangement}: {arrangement: string}) => `establece la modalidad de trabajo predeterminada en ${arrangement}`,
