...
const translations = {
    ...
    cardPage: {
        ...
        missingPrivateDetails: ({profileSettingsLink}: {profileSettingsLink: string}) => `Agrega tus datos personales en <a href="${profileSettingsLink}">Cuenta > Perfil > Privado</a> y vuelve a intentarlo.`,
