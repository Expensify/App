...
const translations = {
    ...
    newRoomPage: {
        ...
        renamedRoomAction: ({oldName, newName, isExpenseReport}: RenamedRoomActionParams) =>
            isExpenseReport ? `cambió el nombre a "${newName}" (previamente "${oldName}")` : `cambió el nombre de la sala a "${newName}" (previamente "${oldName}")`,
