...
El plan Controlar empieza en 9 $ por miembro activo al mes.`,
        ...
        accounting: {
            ...
            syncTravelInvoicingSettlements: 'Sincronizar liquidaciones de facturación de viajes consolidadas',
            syncTravelInvoicingSettlementsNoAccountTooltip: 'Establece una cuenta para tus exportaciones para desbloquearlo.',
            syncTravelInvoicingSettlementsNoAutoSyncTooltip: 'Habilita la autosincronización para desbloquearlo.',
        },
        card: {
            issueCard: 'Emitir tarjeta',
