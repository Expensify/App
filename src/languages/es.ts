...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        failedToAutoSubmitViaDEW: (reason: string) => `No se ha podido enviar este informe mediante <a href="${CONST.SELECT_WORKFLOWS_HELP_URL}">retrasar envíos</a> porque ${reason}`,
        failedToSubmitViaDEW: (reason: string) => `No se ha podido enviar este informe porque ${reason}`,
