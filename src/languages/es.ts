...
export default {
    ...
    welcomeText: {
        ...
        welcomeNewFace: ({login}: SignUpNewFaceCodeParams) => `${login}, siempre es genial ver una cara nueva por aquí! Por favor, continúa haciendo click en el botón de unirse abajo.`,
