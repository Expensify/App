...
${amount} para ${merchant} - ${date}`,
    ...
    workspaceActions: {
        ...
        forcedCorporateUpgrade: `Este espacio de trabajo ha sido actualizado al plan Control. Haz clic <a href="${CONST.PLAN_TYPES_AND_PRICING_HELP_URL}">aquí</a> para obtener más información.`,
