...
const translations: TranslationDeepObject<typeof en> = {
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            confirm: 'Confirmar',
            unlock: 'Desbloquear',
            finishAdding: 'Termina de añadir la cuenta bancaria',
            confirmTestTransactions: 'Por favor, confirma las transacciones de prueba',
            reviewingDocumentation: 'Estamos revisando tu documentación',
            requiresAttention: 'Esta cuenta requiere atención',
        },
        cardConnectionStatus: {
            active: 'Activa',
            inactive: 'Inactiva',
            fix: 'Arreglar',
            fixConnection: 'Por favor, arregla esta conexión',
            fixInCompanyCards: 'Por favor, arregla esta conexión en Tarjetas de empresa',
            askAdminToFix: 'Por favor, pide a un administrador que arregle esta conexión',
        },
        lastSynced: ({relativeDate}: {relativeDate: string}) => `Última sincronización ${relativeDate}`,
