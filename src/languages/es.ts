...
${amount} para ${merchant} - ${date}`,
    ...
    violations: {
        ...
        customUnitRateOutOfDateRange: ({startDate, endDate}) => `La tasa solo es válida del ${startDate} al ${endDate}`,
        customUnitRateOutOfDateRangeStartOnly: ({startDate}) => `La tasa solo es válida a partir del ${startDate}`,
        customUnitRateOutOfDateRangeEndOnly: ({endDate}) => `La tasa solo es válida hasta el ${endDate}`,
