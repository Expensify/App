...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        rules: {
            ...
            merchantRules: {
                title: 'Reglas de comerciante',
                subtitle: 'Actualiza automáticamente los campos de gasto según el nombre del comerciante.',
                emptyTitle: 'Sin reglas de comerciante',
                emptySubtitle: 'Crea reglas para completar automáticamente los detalles del gasto como categoría, etiqueta y más cuando el nombre del comerciante coincida.',
                addRule: 'Añadir regla',
                merchantToMatch: 'Comerciante a coincidir',
                setCategory: 'Establecer categoría',
                setTag: 'Establecer etiqueta',
                setDescription: 'Establecer descripción',
                setReimbursable: 'Establecer reembolsable',
                setBillable: 'Establecer facturable',
                setTax: 'Establecer impuesto',
                renameMerchant: 'Renombrar comerciante a',
                ruleAppliesWhen: ({merchantName}) => `Cuando el comerciante contiene "${merchantName}"`,
                ruleAppliesWhenExact: ({merchantName}) => `Cuando el comerciante es "${merchantName}"`,
            },
            categoryRules: {
