...
export default {
    ...
    iou: {
        ...
        error: {
            ...
            splitBillMultipleParticipantsIncludingWorkspace: 'Solo puedes dividir una cuenta entre un único espacio de trabajo o con usuarios individuales. Por favor actualiza tu selección.',
        },
