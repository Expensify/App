...
import type {PaidElsewhereParams, RoutedDueToDEWParams, SplitDateRangeParams, ViolationsRterParams} from './params';
...
${amount} para ${merchant} - ${date}`,
    ...
    travel: {
        ...
        features: {
            ...
            easyPayments: 'Pagos fáciles para tus miembros',
            travelSpendLimits: 'Establece límites de gasto en viajes',
            invoicedMonthlyWeekly: 'Recibe facturas mensual o semanalmente',
        },
