...
const translations = {
    ...
    bankAccount: {
        ...
        hasCurrencyError: ({workspaceInitialRoute}: WorkspaceInitialRouteParams) =>
            `¡Ups! Parece que la moneda de tu espacio de trabajo no está configurada en USD. Para continuar, ve a <a href="${workspaceInitialRoute}">la configuración del área de trabajo</a>, configúrala en USD e inténtalo nuevamente.`,
        error: {
