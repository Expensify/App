...
export default {
    ...
    violations: {
        allTagLevelsRequired: 'Se requieren todos los niveles de etiquetas',
        autoReportedRejectedExpense: 'Gasto rechazado informado automáticamente',
        billableExpense: 'La opción facturable ya no existe',
        cashExpenseWithNoReceipt: ({amount}: CashExpenseWithNoReceiptParams) => `Se requiere recibo para montos superiores a ${amount}`,
        categoryOutOfPolicy: 'La categoría ya no existe',
        conversionSurcharge: ({percentGreater}: ConversionSurchargeParams) => `Cantidad ${percentGreater}% mayor que el recibo escaneado`,
        customUnitOutOfPolicy: 'Unidad personalizada fuera de la política',
        duplicatedTransaction: 'Transacción duplicada detectada',
        fieldRequired: 'Descripción requerida para la categoría seleccionada',
        futureDate: 'No se permite fecha futura',
        invoiceMarkup: 'Recargo de factura',
        maxAge: ({dayOverdue}: MaxAgeParams) => `Fecha más antigua que el límite del espacio de trabajo de ${dayOverdue} días`,
        missingCategory: 'Falta categoría',
        missingComment: 'Falta comentario',
        missingTag: ({tagName}: MissingTagParams) => `Falta ${tagName}`,
        modifiedAmount: 'Cantidad mayor que el recibo escaneado',
        modifiedDate: 'La fecha difiere del recibo escaneado',
        nonExpensiworksExpense: 'Gasto no Expensiworks',
        overAutoApprovalLimit: 'Sobre el límite de aprobación automática',
        overCategoryLimit: 'Cantidad sobre el límite para la categoría seleccionada',
        overLimit: ({amount}: OverLimitParams) => `Cantidad sobre el límite del espacio de trabajo de ${amount}`,
        overLimitAttendee: 'Asistente sobre el límite',
        perDayLimit: ({category}: PerDayLimitParams) => `Cantidad sobre el límite diario para la ${category} seleccionada`,
        receiptNotSmartScanned: 'Recibo no verificado a través de Auditoría de Recibos. Por favor, verifique los detalles.',
        receiptRequired: 'Se requiere recibo para la categoría seleccionada',
        rter: 'RTER',
        smartscanFailed: 'Falló Smartscan',
        someTagLevelsRequired: 'Se requieren algunos niveles de etiquetas',
        tagOutOfPolicy: ({tagName}: MissingTagParams) => `${tagName} ya no existe`,
        taxAmountChanged: 'El monto del impuesto fue modificado',
        taxOutOfPolicy: ({taxName}: TaxOutOfPolicyParams) => `${taxName} ya no existe`,
