...
export default {
    ...
    reportCardLostOrDamaged: {
        ...
        reasonTitle: '¿Por qué necesita una tarjeta nueva?',
        cardDamaged: 'Mi tarjeta estaba dañada',
        cardLostOrStolen: 'He perdido o me han robado la tarjeta',
        confirmAddressTitle: 'Confirme que la dirección que aparece a continuación es a la que desea que le enviemos su nueva tarjeta.',
        currentCardInfo: 'Su tarjeta actual se desactivará permanentemente en cuanto se realice el pedido. La mayoría de las tarjetas llegan en pocos días laborables.',
        address: 'Dirección',
