    ...
    iou: {
        ...
        reimbursedWithStripeConnect: ({
            ...
            return isCurrentUser
                ? `. El dinero está en camino a tu${creditBankAccount ? ` cuenta bancaria terminada en ${creditBankAccount}` : ' cuenta'} (pagado mediante ${paymentMethod}). Esto generalmente toma de 4 a 5 días hábiles.`
                : `. El dinero está en camino a la cuenta bancaria de ${submitterLogin}${creditBankAccount ? ` terminada en ${creditBankAccount}` : ''} (pagado mediante ${paymentMethod}). Esto generalmente toma de 4 a 5 días hábiles.`;
        },
