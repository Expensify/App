...
export default {
    ...
    violations: {
        ...
        receiptRequired: ({category, formattedLimit}: ViolationsReceiptRequiredParams) =>
            `Recibo obligatorio${!category && !formattedLimit ? '' : ` para importes sobre${category ? ` el limite de la categoría de` : ''} ${formattedLimit}`}`,
