...
${amount} para ${merchant} - ${date}`,
    ...
    onboarding: {
        ...
        personalTrackGoal: {
            title: '¿Qué quieres rastrear?',
            [CONST.ONBOARDING_PERSONAL_TRACK_GOALS.INVESTMENT_TRACKING]: 'Costos de una propiedad de inversión',
            ...
            somethingElsePlaceholder: '¿Qué estás rastreando?',
        },
        employees: {
