...
${reportName}`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                oneConditionPerRuleTitle: 'Solo una condición por regla',
                alreadyMatchesMerchantPrompt: 'Esta regla ya coincide con un comercio. Restablece la regla para que coincida con una categoría en su lugar.',
                alreadyMatchesCategoryPrompt: 'Esta regla ya coincide con una categoría. Restablece la regla para que coincida con un comercio en su lugar.',
                ...
                onlyTaxForCategoryRulesTitle: 'Solo el impuesto está disponible para las reglas de categoría',
                onlyTaxForCategoryRulesPrompt:
                    'Las reglas de categoría pueden establecer una tasa de impuesto predeterminada. Para establecer otros valores predeterminados, en su lugar haz la coincidencia con un comerciante.',
                clearIncompatibleDefaultsTitle: '¿Borrar las otras opciones predeterminadas?',
                clearIncompatibleDefaultsPrompt: 'Estos campos no son compatibles con la categoría. ¿Quieres borrar todos los campos?',
