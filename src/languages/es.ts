...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        submitReportPolicyViolationsTitle: '¿Enviar informe?',
        submitReportPolicyViolationsDescription: 'Este informe tiene infracciones de política. ¿Estás seguro de que deseas enviarlo sin realizar cambios?',
        ...
        sevenDayHoldSubmitDescription: 'Gasto a la espera de una posible coincidencia con una transacción de tarjeta',
        rejectedExpenseSubmitDescription: 'Gasto rechazado no marcado como resuelto',
