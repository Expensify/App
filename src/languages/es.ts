...
const translations = {
    ...
    workspaceActions: {
        ...
        updateDefaultReimbursable: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `actualizó "Los gastos en efectivo son" a "${newValue}" (previamente "${oldValue}")`,
