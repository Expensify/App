...
${amount} para ${merchant} - ${date}`,
    ...
    signerInfoStep: {
        ...
        error: {
            ...
            connectToWorkspacePrefix: 'Por favor, conecta esta cuenta bancaria a un',
            connectToWorkspaceLink: 'espacio de trabajo',
            connectToWorkspaceSuffix: 'para invitar a un director a firmar.',
        },
    },
    agreementsStep: {
        agreements: 'Acuerdos',
