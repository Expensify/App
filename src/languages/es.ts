...
export default {
    ...
    loungeAccessPage: {
        checkIn: 'Registrarse',
        youAreCheckedIn: 'TRANSLATION NEEDED',
        ...
        nextCheckInNumberCountPlural: 'TRANSLATIONS NEEDED',
        nextCheckInAfterNumber: 'TRANSLATION NEEDED',
        noCheckInsLeftFirstPart: 'TRANSLATION NEEDED',
        noCheckInsLeftSecondPart: ({nextCheckIn}: NoCheckInsLeftParams) => `SECOND PART ${nextCheckIn}.`,
