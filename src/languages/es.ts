...
export default {
    ...
    workspace: {
        ...
        companyCards: {
            ...
            whoNeedsCardAssigned: '¿A quién le gustaría asignar una tarjeta?',
            chooseCard: 'Elige una tarjeta',
            chooseCardFor: ({assignee, feed}: AssignCardParams) => `Elige una tarjeta ${assignee} del feed de tarjetas ${feed}.`,
            noActiveCards: 'No hay tarjetas activas en este feed',
            somethingMightBeBroken: 'O algo podría estar roto. De cualquier manera, si tienes alguna pregunta, contacta a Concierge.',
