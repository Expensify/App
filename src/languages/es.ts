...
const translations: TranslationDeepObject<typeof en> = {
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            approvedPartnerTeamTitle: 'Conoce a tu equipo de socios Approved!',
            approvedPartnerTeamDescription: 'Un equipo dedicado a ayudar a tu firma a crecer, incorporar clientes más rápido y obtener soporte experto cuando lo necesites.',
            partnerManagerApprovedDescription: 'Maximiza tu asociación e impulsa referencias',
            accountExecutiveDescription: 'Ayuda a configurar clientes exitosamente',
            accountManagerApprovedDescription: 'Haz preguntas y obtén soporte para clientes',
