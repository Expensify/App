...
const translations: TranslationDeepObject<typeof en> = {
    ...
    iou: {
        ...
        addUnreportedExpense: 'Añadir gasto existente',
        selectUnreportedExpense: 'Selecciona al menos un gasto para agregar al informe.',
        emptyStateUnreportedExpenseTitle: 'No hay gastos existentes',
        emptyStateUnreportedExpenseSubtitle: 'Parece que no tienes gastos existentes. Puedes crear uno a continuación.',
