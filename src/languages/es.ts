...
${amount} para ${merchant} - ${date}`,
    ...
    workspace: {
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `Marcador(es) de fórmula no válido(s): ${placeholders}. Utiliza marcadores compatibles como {report:id}, {report:name}, {report:created}, etc.`,
