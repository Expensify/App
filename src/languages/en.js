...
export default {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryAdminRoomPartOne: () => 'Use ',
        beginningOfChatHistoryAdminRoomPartTwo: ({workspaceName}) => ` to hear about important announcements related to ${workspaceName}`,
