...
export default {
    ...
    bankAccount: {
        ...
        desktopConnection: 'Note: if you are connecting to Chase, Wells Fargo, Capital One or Bank of America on the Desktop app, please click here to use a browser tab instead.',
