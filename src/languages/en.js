...
var translations = {
    common: {
        ...
        noResultsFoundMatching: function (_a) {
            ...
            return "No results found matching \"".concat(searchString, "\"");
        },
        ...
        error: {
            ...
            phoneNumber: "Please enter a valid phone number, with the country code (e.g. ".concat(CONST_1.default.EXAMPLE_PHONE_NUMBER, ")"),
    ...
    reportActionContextMenu: {
        ...
        deleteAction: function (_a) {
            var action = _a.action;
            return "Delete ".concat((action === null || action === void 0 ? void 0 : action.actionName) === CONST_1.default.REPORT.ACTIONS.TYPE.IOU ? 'expense' : 'comment');
        },
        deleteConfirmation: function (_a) {
            var action = _a.action;
            return "Are you sure you want to delete this ".concat((action === null || action === void 0 ? void 0 : action.actionName) === CONST_1.default.REPORT.ACTIONS.TYPE.IOU ? 'expense' : 'comment', "?");
        },
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryDomainRoomPartOne: function (_a) {
            ...
            return "This chat is with all Expensify members on the ".concat(domainRoom, " domain.");
        },
        ...
        beginningOfChatHistoryAnnounceRoomPartOne: function (_a) {
            var workspaceName = _a.workspaceName;
            return "This chat is with everyone in ".concat(workspaceName, ".");
        },
    ...
    iou: {
        ...
        deletedTransaction: function (_a) {
            var amount = _a.amount, merchant = _a.merchant;
            return "deleted an expense on this report, ".concat(merchant, " - ").concat(amount);
        },
        ...
        settlePersonal: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pay ".concat(formattedAmount, " as an individual") : "Pay as an individual");
        },
        ...
        settleBusiness: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pay ".concat(formattedAmount, " as a business") : "Pay as a business");
        },
        payElsewhere: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pay ".concat(formattedAmount, " elsewhere") : "Pay elsewhere");
        },
        nextStep: 'Next steps',
        finished: 'Finished',
        flip: 'Flip',
        ...
        waitingOnBankAccount: function (_a) {
            ...
            return "started settling up. Payment is on hold until ".concat(submitterDisplayName, " adds a bank account.");
        },
        adminCanceledRequest: function (_a) {
            var manager = _a.manager;
            return "".concat(manager ? "".concat(manager, ": ") : '', "canceled the payment");
        },
        ...
        paidElsewhere: function (_a) {
            ...
            return "".concat(payer ? "".concat(payer, " ") : '', "paid elsewhere");
        },
        paidWithExpensify: function (_a) {
            var _b = _a === void 0 ? {} : _a, payer = _b.payer;
            return "".concat(payer ? "".concat(payer, " ") : '', "paid with Expensify");
        },
    ...
    termsOfUse: {
        ...
        phrase3: 'and',
        phrase4: 'Privacy',
        phrase5: "Money transmission is provided by ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " (NMLS ID:2017010) pursuant to its"),
        phrase6: 'licenses',
    },
    validateCodeForm: {
    ...
    onboarding: {
        ...
        purpose: (_c = {
            ...
            _c[CONST_1.default.ONBOARDING_CHOICES.EMPLOYER] = 'Get paid back by my employer',
            _c[CONST_1.default.ONBOARDING_CHOICES.MANAGE_TEAM] = "Manage my team's expenses",
            _c[CONST_1.default.ONBOARDING_CHOICES.PERSONAL_SPEND] = 'Track and budget expenses',
            _c[CONST_1.default.ONBOARDING_CHOICES.CHAT_SPLIT] = 'Chat and split expenses with friends',
            _c[CONST_1.default.ONBOARDING_CHOICES.LOOKING_AROUND] = 'Something else',
            _c),
        employees: (_d = {
                title: 'How many employees do you have?'
            },
            _d[CONST_1.default.ONBOARDING_COMPANY_SIZE.MICRO] = '1-10 employees',
            _d[CONST_1.default.ONBOARDING_COMPANY_SIZE.SMALL] = '11-50 employees',
            _d[CONST_1.default.ONBOARDING_COMPANY_SIZE.MEDIUM_SMALL] = '51-100 employees',
            _d[CONST_1.default.ONBOARDING_COMPANY_SIZE.MEDIUM] = '101-1,000 employees',
            _d[CONST_1.default.ONBOARDING_COMPANY_SIZE.LARGE] = 'More than 1,000 employees',
            _d),
        accounting: {
        ...
        tasks: {
            ...
            setupCategoriesAndTags: {
                title: function (_a) {
                    ...
                    return "Set up [categories](".concat(workspaceCategoriesLink, ") and [tags](").concat(workspaceMoreFeaturesLink, ")");
                },
                description: function (_a) {
            ...
            setupTagsTask: {
                title: function (_a) {
                    ...
                    return "Set up [tags](".concat(workspaceMoreFeaturesLink, ")");
                },
                description: function (_a) {
                    var workspaceMoreFeaturesLink = _a.workspaceMoreFeaturesLink;
            ...
            reviewWorkspaceSettingsTask: {
                ...
                description: function (_a) {
                    ...
                    return "Here's how to review and update your workspace settings:\n" +
                        ...
                        "[Go to your workspace](".concat(workspaceSettingsLink, "). We'll track them in the #admins room.");
                },
            },
            createReportTask: {
        ...
        messages: {
            ...
            onboardingMangeTeamMessage: function (_a) {
                ...
                return "Here is a task list I\u2019d recommend for a company of your size".concat(onboardingCompanySize ? " with ".concat(onboardingCompanySize, " submitters") : ':');
            },
    ...
    emailDeliveryFailurePage: {
        ...
        confirmThat: function (_a) {
            var login = _a.login;
            return "Confirm that ".concat(login, " is spelled correctly and is a real, deliverable email address. ");
        },
    ...
    termsStep: {
        ...
        longTermsForm: {
            ...
            contactExpensifyPayments: "Contact ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " by calling +1 833-400-0904, by email at"),
    ...
    ownershipInfoStep: {
        ...
        doesAnyoneOwn: function (_a) {
            var companyName = _a.companyName;
            return "Does any individuals own 25% or more of ".concat(companyName, "?");
        },
    ...
    signerInfoStep: {
        ...
        areYouDirector: function (_a) {
            var companyName = _a.companyName;
            return "Are you a director or senior officer at ".concat(companyName, "?");
        },
        ...
        enterOneEmail: function (_a) {
            var companyName = _a.companyName;
            return "Enter the email of director or senior officer at ".concat(companyName);
        },
        ...
        enterTwoEmails: function (_a) {
            var companyName = _a.companyName;
            return "Enter the emails of two directors or senior officers at ".concat(companyName);
        },
    ...
    workspace: {
        common: {
            ...
            shareNote: {
                ...
                content: {
                    firstPart: 'Share this QR code or copy the link below to make it easy for members to request access to your workspace. All requests to join the workspace will show up in the',
        ...
        perDiem: {
            ...
            errors: {
                existingRateError: function (_a) {
                    var rate = _a.rate;
                    return "A rate with value ".concat(rate, " already exists");
                },
            },
        ...
        qbd: {
            ...
            accounts: (_f = {},
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Credit card',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Vendor bill',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Journal entry',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Check',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK, "Description")] = "We'll create an itemized check for each Expensify report and send it from the bank account below.",
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = "We'll automatically match the merchant name on the credit card transaction to any corresponding vendors in QuickBooks. If no vendors exist, we'll create a 'Credit Card Misc.' vendor for association.",
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = "We'll create an itemized vendor bill for each Expensify report with the date of the last expense, and add it to the account below. If this period is closed, we'll post to the 1st of the next open period.",
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Choose where to export credit card transactions.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Choose a vendor to apply to all credit card transactions.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "AccountDescription")] = 'Choose where to send checks from.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'Vendor bills are unavailable when locations are enabled. Please choose a different export option.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'Checks are unavailable when locations are enabled. Please choose a different export option.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'Journal entries are unavailable when taxes are enabled. Please choose a different export option.',
                _f),
        ...
        qbo: {
            ...
            accounts: (_h = {},
                _h[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD] = 'Debit card',
                _h[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = 'Credit card',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Vendor bill',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Journal entry',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Check',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "Description")] = "We'll automatically match the merchant name on the debit card transaction to any corresponding vendors in QuickBooks. If no vendors exist, we'll create a 'Debit Card Misc.' vendor for association.",
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = "We'll automatically match the merchant name on the credit card transaction to any corresponding vendors in QuickBooks. If no vendors exist, we'll create a 'Credit Card Misc.' vendor for association.",
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = "We'll create an itemized vendor bill for each Expensify report with the date of the last expense, and add it to the account below. If this period is closed, we'll post to the 1st of the next open period.",
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "AccountDescription")] = 'Choose where to export debit card transactions.',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Choose where to export credit card transactions.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Choose a vendor to apply to all credit card transactions.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'Vendor bills are unavailable when locations are enabled. Please choose a different export option.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'Checks are unavailable when locations are enabled. Please choose a different export option.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'Journal entries are unavailable when taxes are enabled. Please choose a different export option.',
                _h),
            exportDestinationAccountsMisconfigurationError: (_j = {},
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'Choose a valid account for vendor bill export',
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'Choose a valid account for journal entry export',
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'Choose a valid account for check export',
                _j),
            exportDestinationSetupAccountsInfo: (_k = {},
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = 'To use vendor bill export, set up an accounts payable account in QuickBooks Online',
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = 'To use journal entry export, set up a journal account in QuickBooks Online',
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = 'To use check export, set up a bank account in QuickBooks Online',
                _k),
            noAccountsFound: 'No accounts found',
            ...
            accountingMethods: {
                ...
                values: (_l = {},
                    ...
                    _l[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Cash',
                    _l),
                alternateText: (_m = {},
                    _m[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Out-of-pocket expenses will export when final approved',
                    _m[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Out-of-pocket expenses will export when paid',
                    _m),
            },
        },
        workspaceList: {
        ...
        xero: {
            ...
            trackingCategoriesOptions: (_o = {},
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT] = 'Xero contact default',
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG] = 'Tags',
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD] = 'Report fields',
                _o),
            ...
            invoiceStatus: {
                ...
                values: (_q = {},
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.DRAFT] = 'Draft',
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_APPROVAL] = 'Awaiting approval',
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_PAYMENT] = 'Awaiting payment',
                    _q),
            },
            noAccountsFound: 'No accounts found',
        ...
        sageIntacct: {
            ...
            reimbursableExpenses: {
                ...
                values: (_s = {},
                    _s[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.EXPENSE_REPORT] = 'Expense reports',
                    _s[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Vendor bills',
                    _s),
            },
            nonReimbursableExpenses: {
                description: 'Set how company card purchases export to Sage Intacct.',
                values: (_t = {},
                    _t[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.CREDIT_CARD_CHARGE] = 'Credit cards',
                    _t[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = 'Vendor bills',
                    _t),
            },
            creditCardAccount: 'Credit card account',
        ...
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: (_u = {},
                    _u[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE] = 'Single, itemized entry for each report',
                    _u[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE] = 'Single entry for each expense',
                    _u),
            },
            invoiceItem: {
                label: 'Invoice item',
            ...
            advancedConfig: {
                ...
                exportReportsTo: {
                    ...
                    values: (_y = {},
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE] = 'NetSuite default preference',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED] = 'Only supervisor approved',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED] = 'Only accounting approved',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH] = 'Supervisor and accounting approved',
                        _y),
                },
                accountingMethods: {
                    label: 'When to Export',
                    ...
                    values: (_z = {},
                        ...
                        _z[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Cash',
                        _z),
                    alternateText: (_0 = {},
                        _0[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = 'Out-of-pocket expenses will export when final approved',
                        _0[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = 'Out-of-pocket expenses will export when paid',
                        _0),
                },
                exportVendorBillsTo: {
                    ...
                    values: (_1 = {},
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED_NONE] = 'NetSuite default preference',
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVAL_PENDING] = 'Pending approval',
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED] = 'Approved for posting',
                        _1),
                },
                exportJournalsTo: {
                    ...
                    values: (_2 = {},
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED_NONE] = 'NetSuite default preference',
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVAL_PENDING] = 'Pending approval',
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED] = 'Approved for posting',
                        _2),
                },
                error: {
        ...
        companyCards: {
            ...
            statementCloseDate: (_4 = {},
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_DAY_OF_MONTH] = 'Last day of the month',
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_BUSINESS_DAY_OF_MONTH] = 'Last business day of the month',
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH] = 'Custom day of month',
                _4),
            ...
            chooseCardFor: function (_a) {
                ...
                return "Choose a card for ".concat(assignee, " from the ").concat(feed, " cards feed.");
            },
        ...
        expensifyCard: {
            ...
            issuedCardNoShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "issued ".concat(assignee, " an Expensify Card! The card will be shipped once shipping details are added.");
            },
        ...
        accounting: {
            ...
            importTypes: (_5 = {},
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.IMPORTED] = 'Imported',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG] = 'Imported as tags',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.DEFAULT] = 'Imported',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NOT_IMPORTED] = 'Not imported',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NONE] = 'Not imported',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD] = 'Imported as report fields',
            ...
            chooseReconciliationAccount: {
                ...
                reconciliationWorks: function (_a) {
                    ...
                    return "(ending in ".concat(lastFourPAN, ") so Continuous Reconciliation works properly.");
                },
            },
        },
        export: {
        ...
        upgrade: (_6 = {
            ...
            _6.upgradeToUnlock = 'Unlock this feature',
            _6.completed = {
                headline: "You've upgraded your workspace!",
                successMessage: function (_a) {
                    var policyName = _a.policyName;
                    return "You've successfully upgraded ".concat(policyName, " to the Control plan!");
                },
        ...
        rules: {
            ...
            expenseReportRules: {
                ...
                unlockFeatureEnableWorkflowsSubtitle: function (_a) {
                    ...
                    return "and enable workflows, then add ".concat(featureName, " to unlock this feature.");
                },
                enableFeatureSubtitle: function (_a) {
                    var featureName = _a.featureName;
                    return "and enable ".concat(featureName, " to unlock this feature.");
                },
            },
            categoryRules: {
    ...
    search: {
        ...
        filters: {
            date: {
                ...
                presets: (_7 = {},
                    _7[CONST_1.default.SEARCH.DATE_PRESETS.NEVER] = 'Never',
                    _7[CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH] = 'Last month',
                    _7),
            },
            status: 'Status',
            keyword: 'Keyword',
        ...
        actions: {
            type: {
                changeField: function (_a) {
                    ...
                    return "changed ".concat(fieldName, " from ").concat(oldValue, " to ").concat(newValue);
                },
                changeFieldEmpty: function (_a) {
                    var newValue = _a.newValue, fieldName = _a.fieldName;
                    return "changed ".concat(fieldName, " to ").concat(newValue);
                },
                ...
                delegateSubmit: function (_a) {
                    ...
                    return "sent this report to ".concat(delegateUser, " since ").concat(originalManager, " is on vacation");
                },
                exportedToCSV: "exported to CSV",
                exportedToIntegration: {
                    automatic: function (_a) {
                        var label = _a.label;
                        return "exported to ".concat(label);
                    },
    ...
    referralProgram: (_8 = {},
        ...
        _8.copyReferralLink = 'Copy invite link',
        _8),
    ...
    violations: {
        ...
        autoReportedRejectedExpense: function (_a) {
            ...
            return "".concat(rejectedBy, " rejected this expense with the comment \"").concat(rejectReason, "\"");
        },
        ...
        receiptNotSmartScanned: 'Expense details and receipt added manually. Please verify the details. <a href="https://help.expensify.com/articles/expensify-classic/reports/Automatic-Receipt-Audit">Learn more</a> about automatic auditing for all receipts.',
        ...
        prohibitedExpense: function (_a) {
            ...
            switch (prohibitedExpenseType) {
                ...
                case 'gambling':
                    return "".concat(preMessage, " gambling");
                case 'tobacco':
                    return "".concat(preMessage, " tobacco");
                case 'adultEntertainment':
                    return "".concat(preMessage, " adult entertainment");
                case 'hotelIncidentals':
                    return "".concat(preMessage, " hotel incidentals");
                default:
        ...
        rter: function (_a) {
            ...
            if (brokenBankConnection || rterType === CONST_1.default.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? "Can't auto-match receipt due to broken bank connection which ".concat(email, " needs to fix")
    ...
    exitSurvey: {
        ...
        reasons: (_11 = {},
            _11[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = "I need a feature that's only available in Expensify Classic.",
            _11[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = "I don't understand how to use New Expensify.",
            _11[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'I understand how to use New Expensify, but I prefer Expensify Classic.',
            _11),
        prompts: (_12 = {},
            _12[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = "What feature do you need that isn't available in New Expensify?",
            _12[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'What are you trying to do?',
            _12[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Why do you prefer Expensify Classic?',
            _12),
        ...
        benefits: (_13 = {},
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY] = 'Chatting directly on expenses and reports',
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE] = 'Ability to do everything on mobile',
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE] = 'Travel and expense at the speed of chat',
            _13),
        ...
        billingBanner: {
            ...
            cardAuthenticationRequired: {
                ...
                subtitle: function (_a) {
                    ...
                    return "Your payment card hasn\u2019t been fully authenticated. Please complete the authentication process to activate your payment card ending in ".concat(cardEnding, ".");
                },
            },
            insufficientFunds: {
                title: 'Your card couldn’t be charged',
    ...
    delegate: {
        ...
        notAllowedMessageEnd: function (_a) {
            ...
            return " for ".concat(accountOwnerEmail, ", you don't have permission to take this action. Sorry!");
        },
