...
領収書や説明などの経費詳細を必須にし、上限やデフォルトを設定し、承認や支払いを自動化——すべてを1か所で行えます。`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                confirmErrorConditionAndDefault: '店舗またはカテゴリを選択し、少なくとも1つのデフォルトを適用してください',
                turnOnTaxesFirstTitle: '先に税金を有効にしてください',
                turnOnTaxesFirstPrompt: 'カテゴリルールはデフォルトの税率を設定します。利用するには、ワークスペース設定で税金を有効にしてください。',
                categoryRulesApplyGoingForwardTitle: 'カテゴリルールは今後に適用されます',
                categoryRulesApplyGoingForwardPrompt: 'このカテゴリーの新しい経費には、デフォルトの税率が適用されます。既に存在する経費は変更されません。',
            },
            categoryRules: {
                title: 'カテゴリルール',
                approver: '承認者',
...
会社のキャッシュフローを守るために、支出ルールをさらに追加しましょう。`,
            ...
            newRule: {
                ...
                createAgentRuleDescription: '必要なときに実行できる柔軟なルールを作成できます。',
            },
            ...
            expenseDefaultType: {
                title: '経費のデフォルトを適用',
                subtitle: 'このルールは何にマッチさせますか？',
                merchant: '加盟店',
                merchantDescription: '特定の店舗の経費フィールドを更新する',
                category: 'カテゴリ',
                categoryDescription: '特定のカテゴリにデフォルトの税率を設定する',
            },
            taxesDisabledEmptyState: {title: '税金は有効になっていません', subtitle: '対象となる税金を記録して還付を受けられるように、税金を有効にします。', cta: '税金を有効にする'},
        },
        planTypePage: {
            planTypes: {
                team: {
