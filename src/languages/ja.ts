...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[ja] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[ja] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[ja] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[ja] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[ja] Get clients setup successfully',
            accountManagerApprovedDescription: '[ja] Ask questions and get client support',
            moreResources: '[ja] More resources',
        },
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[ja] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[ja] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[ja] Go to Gusto settings',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            gusto: {
                ...
                disconnect: '[ja] Disconnect',
                lastSync: (relativeDate: string) => `[ja] Last synced ${relativeDate}`,
                syncError: "[ja] Can't connect to Gusto",
                disconnectTitle: '[ja] Disconnect Gusto',
                disconnectPrompt: '[ja] Are you sure you want to disconnect Gusto?',
                ...
                notSet: '[ja] Not set',
                approvalModeDescription: '[ja] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[ja] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[ja] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[ja] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[ja] Basic approval',
                        description: '[ja] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[ja] Manager approval',
                        description: '[ja] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[ja] Custom approval',
                        description: '[ja] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[ja] Gusto sync results',
                    successTitle: '[ja] Successfully synced your Gusto connection!',
                    added: '[ja] Added',
                    removed: '[ja] Removed',
                    skipped: '[ja] Skipped',
                    employeeCount: () => ({
            ...
            zenefits: {
                ...
                disconnect: '[ja] Disconnect',
                lastSync: (relativeDate: string) => `[ja] Last synced ${relativeDate}`,
                syncError: "[ja] Can't connect to TriNet",
                disconnectTitle: '[ja] Disconnect TriNet',
                disconnectPrompt: '[ja] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[ja] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[ja] Approval mode',
                finalApprover: '[ja] Final approver',
                notSet: '[ja] Not set',
                approvalModeDescription: '[ja] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[ja] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[ja] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[ja] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[ja] Basic approval',
                    ...
                    manager: {
                        label: '[ja] Manager approval',
                        description: '[ja] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[ja] Custom approval',
                        description: "[ja] I'll manually setup approval workflows in Expensify.",
    ...
    search: {
        ...
        filters: {
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[ja] Central invoicing',
            },
            is: '[ja] Is',
            action: {
