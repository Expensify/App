        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    ...
                    officeBasedHelp: 'メンバーはオフィスに通勤します。通常の通勤は精算の対象外になります。',
                    noRegularWorkplaceTitle: '決まった勤務地なし',
                    noRegularWorkplaceHelp: 'メンバーはリモート勤務、または決まった勤務地がないため、通勤のルールは適用されません。',
                    startingPrompt: {
                        title: '標準の勤務形態を設定',
                        prompt: '現在のメンバーの大半に当てはまる勤務形態を選択してください。あとから個別または一括で変更できます。',
                        officeBasedHelp: 'ほとんどのメンバーがオフィスに通勤します。通常の通勤は対象外になります。',
                        noRegularWorkplaceHelp: 'ほとんどのメンバーがリモート勤務のため、通勤の除外は通常適用されません。',
                        confirm: '適用',
                    },
                },
            },
...
会社のキャッシュフローを守るために、支出ルールをさらに追加しましょう。`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            officeBased: 'オフィス勤務',
            noRegularWorkplace: '決まった勤務地なし',
            set: ({arrangement}: {arrangement: string}) => `デフォルトの勤務形態を「${arrangement}」に設定しました`,
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `デフォルトの勤務形態を「${arrangement}」に変更しました（以前は「${previousArrangement}」）`,
        },
        commuterExclusions: {
