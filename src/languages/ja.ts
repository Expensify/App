...
3. フィードが有効になったら、下の「Submit」をクリックしてください。追加作業を進めます。`,
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `無効な数式プレースホルダー: ${placeholders}。{report:id}、{report:name}、{report:created} などのサポートされているプレースホルダーを使用してください。`,
