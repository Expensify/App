...
会社のキャッシュフローを守るために、支出ルールをさらに追加しましょう。`,
        ...
        campfire: {
            ...
            exportReimbursable: {label: '立替経費のエクスポート形式', values: {label: '仕入先請求書'}},
            exportDate: {
                label: '取引先請求書の日付',
                description: 'レポートを Campfire にエクスポートするときは、この日付を使用します。',
                values: {label: '提出日', description: 'レポートが承認申請のために提出された日付です。'},
            },
            exportNonReimbursable: {label: '会社カード経費のエクスポート形式', values: {label: '仕訳伝票'}},
            defaultCompanyCardVendor: {label: 'すべての会社カードのデフォルト仕入先', description: '自動で一致しない経費に使用する、デフォルトの Campfire ベンダーを選択してください。'},
            companyCardAccount: {label: '会社カード口座', description: '会社カードの取引をどこにエクスポートするか選択してください。'},
            noVendorsFound: '取引先が見つかりませんでした',
            noVendorsFoundDescription: 'Campfire に取引先を追加して、もう一度接続を同期してください',
            noAccountsFound: 'アカウントが見つかりません',
            noAccountsFoundDescription: 'Campfire でアカウントを追加して、もう一度接続を同期してください',
        },
        businessCentral: {
