...
会社のキャッシュフローを守るために、支出ルールをさらに追加しましょう。`,
                ...
                maxAmountCurrencyMismatchPrompt: '上限金額を設定するには、同じ通貨で精算されるカードを選択してください。',
                ...
                merchantTypes: '加盟店タイプ',
                allowedMerchants: '許可された加盟店',
                allowedMerchantTypes: '許可された加盟店の種類',
                blockedMerchants: 'ブロック済み加盟店',
                blockedMerchantTypes: 'ブロックされた加盟店タイプ',
                currencies: '通貨',
                permittedCurrencies: '許可された通貨',
                allCurrencies: 'すべての通貨',
                permittedCurrenciesSubtitle: 'すべての通貨または特定の通貨を許可するか選択します',
                settlementCurrencyPermittedSubtitle: 'カードの決済通貨は常に許可されています',
                currenciesCurrencyMismatchTitle: '通貨の不一致',
                currenciesCurrencyMismatchPrompt: '優先通貨を設定するには、同じ通貨で清算されるカードを選択してください。',
                restrictMerchantsOffSubtitle: '許可された通貨で、上限金額を超えない利用分のみ承認されます',
                restrictMerchantsAllowSubtitle: '取引は、許可された通貨で最大金額を超えず、加盟店または加盟店の種類が一致する場合に承認されます。',
                restrictMerchantsBlockSubtitle: '許可された通貨で、上限金額を超えない請求、または加盟店または加盟店の種類が一致する請求が承認されます。',
            },
            agentRules: {
                title: 'エージェント ルール',
