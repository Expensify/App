...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    iou: {
        ...
        error: {
            ...
            reportsNotSubmittedTitle: 'レポートを送信',
            reportsNotMarkedAsDoneTitle: 'レポートを完了にする',
            reportsNotSubmittedDescription: 'これらのレポートは送信できませんでした。すべての経費が保留中または処理待ちでないことを確認して、もう一度お試しください。',
            reportsNotMarkedAsDoneDescription: 'これらのレポートは完了にできませんでした。すべての経費が保留中または処理待ちでないことを確認して、もう一度お試しください。',
