...
const translations = {
    ...
    cardPage: {
        ...
        missingPrivateDetails: ({profileSettingsLink}: {profileSettingsLink: string}) =>
            `<a href="${profileSettingsLink}">アカウント > プロフィール > プライベート</a>で個人情報を追加してから、もう一度お試しください。`,
...
${date} - ${merchant}に${amount}`,
    ...
    onboarding: {
        ...
        workspace: {
            ...
            price: '30日間は無料でお試し、その後は<strong>$5/月</strong>でアップグレード。',
    ...
    workspace: {
        ...
        expensifyCard: {
            ...
            issuedCardNoShippingDetails: ({assignee}: AssigneeParams) => `${assignee} にExpensify Cardを発行しました！配送情報が追加され次第、カードを発送します。`,
