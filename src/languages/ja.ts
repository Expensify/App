...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            accountManager: '[ja] Account Manager',
            accountManagerDescription: '質問してクライアントサポートを受ける',
            partnerManager: '[ja] Partner Manager',
            partnerManagerDescription: 'パートナーシップを最大化して紹介数を伸ばしましょう',
            guideDescription: 'お客様のセットアップ担当者',
            approvedPartnerTeamTitle: '承認されたパートナーチームをご紹介します',
            approvedPartnerTeamDescription: '御社の成長支援、クライアントのスムーズなオンボーディング、そして必要なときにいつでも受けられる専門的なサポートに特化した専任チームです。',
            accountExecutive: '[ja] Account Executive',
            accountExecutiveDescription: 'クライアントの導入を成功させましょう',
