...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            approvedPartnerTeamTitle: 'Approved!パートナーチームのご紹介',
            approvedPartnerTeamDescription: '貴社の成長を支援し、クライアントの迅速なオンボーディングと専門的なサポートを提供する専任チームです。',
            partnerManagerApprovedDescription: 'パートナーシップを最大化し、紹介を促進',
            accountExecutiveDescription: 'クライアントの設定を成功に導く',
            accountManagerApprovedDescription: '質問をしてクライアントサポートを受ける',
