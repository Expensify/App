...
${date} の ${merchant} への ${amount}`,
        ...
        enterFourDigitPin: 'カード用の4桁の暗証番号を入力してください。',
        reenterPinToConfirm: '確認のため、PIN を再入力してください。',
...
使い方がわかるように、こちらが*テスト用レシート*です。`,
    ...
    domain: {
        ...
        members: {
            ...
            cannotSetVacationDelegateForMember: (email: string) => `${email} さんは現在、次のメンバーの代理承認者になっているため、休暇代理を設定することはできません。`,
        },
        common: {settings: '設定'},
