...
3. フィードが有効になったら、下の「送信」をクリックしてください。追加作業を進めます。`,
        ...
        copyPolicySettings: {
            ...
            description: '設定をコピーしたいワークスペースを選択し、次にコピーしたい設定を選んでください。',
            searchPlaceholder: 'ワークスペースを検索',
            selectFeatures: 'コピーする機能を選択',
            whichFeatures: '既存のワークスペースで上書きする設定を選択してください。',
            accountingDisabledTooltip: '元のワークスペースと対象のワークスペースは同じ会計アカウントに接続されていないため、これらの設定は安全にコピーできません。',
            workflowsWithoutMembersTitle: 'メンバーを含めずにワークフローをコピーしますか？',
            workflowsWithoutMembersPrompt:
                'メンバーのいないワークフローをコピーしようとしています。申請と支払いの設定はコピーされますが、ワークスペースのメンバーは変更されません。続行しますか？',
        },
        emptyWorkspace: {
            title: 'ワークスペースがありません',
