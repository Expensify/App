...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    multifactorAuthentication: {
        ...
        setPin: {
            didNotShipCard: 'カードを発送できませんでした。もう一度お試しください。',
        },
    },
    validateCodeModal: {
...
${date} の ${merchant} への ${amount}`,
        ...
        enterFourDigitPin: 'カードの4桁のPINを入力してください。',
        reenterPinToConfirm: '確認のためPINを再入力してください。',
        pinMustBeFourDigits: 'PINは4桁でなければなりません。',
        invalidPin: 'より安全なPINを選択してください。',
