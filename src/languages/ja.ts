        ...
        rules: {
            ...
            categoryRules: {
                ...
                expenseLimitTypes: {
                    expense: '個別経費',
                    expenseSubtitle:
                        'カテゴリごとに経費金額にフラグを付けます。このルールは、経費金額の上限に関するワークスペース全体の一般ルールを上書きします。複数日の予約は、1泊あたりの平均額を使用して評価されます。',
                    daily: 'カテゴリ合計',
...
会社のキャッシュフローを守るために、支出ルールをさらに追加しましょう。`,
    ...
    violations: {
        ...
        overCategoryLimitPerNight: (formattedLimit: string) => `1泊あたりの料金が1人あたりのカテゴリ上限 ${formattedLimit} を超えています`,
        overLimitPerNight: (formattedLimit: string) => `1泊あたりの料金が1人あたりの上限額 ${formattedLimit} を超えています`,
    },
    reportViolations: {
