...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    iou: {
        ...
        error: {
            ...
            reportsNotSubmittedDescription: 'これらのレポートは送信できませんでした。経費が保留中または処理待ちでないことを確認して、もう一度お試しください。',
            reportsNotMarkedAsDoneDescription: 'これらのレポートは完了にできませんでした。経費が保留中または処理待ちでないことを確認して、もう一度お試しください。',
