...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            unlock: 'ロック解除',
            debitBlocked: 'この口座へのテスト取引が銀行によってブロックされました',
            insufficientFunds: '残高不足のためテスト取引に失敗しました',
            validationFailedFallback: 'この口座へのテスト取引は銀行によりブロックされました。<concierge-link>Concierge に連絡する</concierge-link>',
        },
        fixBankAccount: {
            title: '銀行口座を修正',
            debitBlockedBody:
                'お使いの銀行が、この口座へのテスト取引をブロックしました。<br/><br/>銀行に依頼して、Expensify の ACH ID をホワイトリストに登録してもらってください。<bullet-list><bullet-item>1270239450</bullet-item><bullet-item>2270239450</bullet-item><bullet-item>4270239450</bullet-item></bullet-list>その後、下記のテスト取引を再送してください。',
            insufficientFundsBody: 'テスト取引は残高不足のため失敗しました。資金が利用可能になりましたら、下のボタンをご利用ください。',
            resendButton: '取引を再送信',
...
会社のキャッシュフローを守るために、支出ルールをさらに追加しましょう。`,
    ...
    debug: {
        ...
        indicatorStatus: {
            ...
            aBankAccountFailedValidation: '銀行口座の認証に失敗しました',
        },
    },
    emptySearchView: {
