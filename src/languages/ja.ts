...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    multifactorAuthentication: {
        unsupportedDevice: {
            ...
            pleaseDownloadMobileApp: `<centered-text><muted-text>現在、お使いのデバイスではこのアクションはサポートされていません。Expensifyのモバイルアプリを<a href="${CONST.APP_DOWNLOAD_LINKS.IOS}">iOSアップストア</a>または<a href="${CONST.APP_DOWNLOAD_LINKS.ANDROID}">Googleプレイストア</a>からダウンロードして、再度お試しください。</muted-text></centered-text>`,
        },
        biometricsTest: {
