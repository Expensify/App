...
領収書や説明などの経費詳細を必須にし、上限やデフォルトを設定し、承認や支払いを自動化——すべてを1か所で行えます。`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                confirmErrorCondition: '店舗またはカテゴリを選択してください',
                confirmErrorConditionAndDefault: '取引先またはカテゴリを選択し、少なくとも 1 つのデフォルトを適用してください',
                oneConditionPerRuleTitle: 'ルールごとに条件は1つだけです',
                alreadyMatchesMerchantPrompt: 'このルールはすでに店舗で一致するように設定されています。カテゴリで一致するようにルールをリセットしてください。',
                alreadyMatchesCategoryPrompt: 'このルールはすでにカテゴリで一致するように設定されています。マーチャントで一致するようにルールをリセットしてください。',
                turnOnTaxesFirstTitle: '先に税金を有効にしてください',
                turnOnTaxesFirstPrompt: 'カテゴリルールでは、デフォルトの税率を設定できます。利用するには、ワークスペース設定で税金を有効にしてください。',
                onlyTaxForCategoryRulesTitle: 'カテゴリルールでは税金のみ利用できます',
                onlyTaxForCategoryRulesPrompt: 'カテゴリルールでは、デフォルトの税率を設定できます。その他のデフォルトを設定するには、代わりに加盟店でマッチさせてください。',
                clearIncompatibleDefaultsTitle: '他のデフォルト設定をクリアしますか？',
                clearIncompatibleDefaultsPrompt: 'これらのフィールドはカテゴリと互換性がありません。すべてのフィールドをクリアしますか？',
                clearFields: 'フィールドをクリア',
                categoryRulesApplyGoingForwardTitle: 'カテゴリルールは今後に適用されます',
                categoryRulesApplyGoingForwardPrompt: 'このカテゴリの新しい経費には、デフォルトの税率が適用されます。既に存在する経費は変更されません。',
            },
            categoryRules: {
                title: 'カテゴリルール',
                approver: '承認者',
...
会社のキャッシュフローを守るために、支出ルールをさらに追加しましょう。`,
            ...
            newRule: {
                ...
                createAgentRule: 'エージェントルールを説明',
                createAgentRuleDescription: '必要なときに実行できる柔軟なルールを作成します。',
            },
