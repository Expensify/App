...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            confirmDigitalWalletAddition: {
                title: ({walletName}: {walletName: string}) => `への カード追加 ${walletName} の承認が必要です`,
    ...
    addCardToDigitalWallet: {
        ...
        confirmHeading: 'リクエストを確認',
        confirmDescription: ({walletName, lastFourDigits}: {walletName: string; lastFourDigits: string}) => `Expensify カード（下4桁 ${lastFourDigits}）を ${walletName} に追加しますか？`,
        deny: '拒否',
        confirm: '確認',
        verifyTitle: 'ご本人確認をお願いします',
        enterSecurityCode: (contactMethod: string) => `このリクエストを確認するため、${contactMethod} に送信されたセキュリティコードを入力してください。1〜2分で届きます。`,
        successHeading: '完了！',
        successDescription: ({walletName}: {walletName: string}) => `カードは ${walletName} で利用できるようになりました。`,
        deniedHeading: 'リクエストを拒否しました',
        deniedDescription: ({walletName}: {walletName: string}) => `カードは ${walletName} に追加されませんでした。`,
    },
    cardPage: {
        expensifyCard: 'Expensify カード',
