...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        calendarOpened: '[ja] calendar opened',
        send: '[ja] Send',
        na: '[ja] N/A',
...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        revealCardDetail: {
            couldNotReveal: "[ja] We couldn't reveal your card details. Please try again.",
        },
    },
    validateCodeModal: {
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            unlockBankAccount: {
                workspaceTitle: '[ja] Your business bank account has been locked',
                personalTitle: '[ja] Your bank account has been locked',
                workspaceSubtitle: ({policyName}: {policyName: string}) => policyName,
                personalSubtitle: '[ja] Wallet',
            },
        },
        freeTrialSection: {
        ...
        yourSpend: {
            title: '[ja] Your spend',
            awaitingApproval: '[ja] Awaiting approval',
            repaidLast30Days: '[ja] Repaid in the last 30 days',
            recentTransactions: ({lastFour}: {lastFour: string}) => `[ja] Recent transactions • ${lastFour}`,
        },
        seeMore: ({count}: {count: number}) => `[ja] See ${count} more`,
        ...
        gettingStartedSection: {
            ...
            inviteAccountant: '[ja] Invite your accountant',
    ...
    spreadsheet: {
        ...
        importCompanyCardTransactionsPendingMessage: '[ja] New cards and transactions may take some time to appear, please hang tight.',
    ...
    iou: {
        ...
        movedFromReport: (reportName: string) => `[ja] moved an expense from ${reportName}`,
        movedFromReportNoName: '[ja] moved an expense',
        movedTransactionTo: (reportUrl: string, reportName: string) => `[ja] moved this expense to <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionToAnotherReport: '[ja] moved this expense to another report',
        movedTransactionFrom: (reportUrl: string, reportName: string) => `[ja] moved this expense from <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionFromAnotherReport: '[ja] moved this expense from another report',
        ...
        allTransactionsPendingNextStep: "[ja] All transactions are pending. You can't submit this report until they post in a few days.",
        ...
        confirmPaymentReceivedModalTitle: '[ja] Confirm payment received',
        receivedPayment: '[ja] Received payment',
        receivedPaymentConfirmation: "[ja] Please proceed only if you've already received payment outside of Expensify.",
        confirmReceivedPayment: "[ja] Yes, I've received payment",
        ...
        updatedTheRequest: (valueName: string, newValueToDisplay: string, oldValueToDisplay: string) => `[ja] the ${valueName} to ${newValueToDisplay} (previously ${oldValueToDisplay})`,
        ...
        error: {
            ...
            invalidReadings: '[ja] Please enter both start & end readings to continue',
            ...
            unableToSubmitReport: '[ja] Unable to submit report',
            allTransactionsPendingDescription: "[ja] You can't submit this report because all transactions are pending. They may take a few days to post.",
            failedToSaveOdometerDraft: "[ja] Couldn't save your odometer draft. Please try again.",
            ...
            receiptUploadFailedMessage: '[ja] Receipt upload failed. Save the receipt, or delete the expense and lose it.',
            saveReceipt: '[ja] Save receipt',
        ...
        changeApprover: {
            ...
            reassignedApproverMessage: (managerID: number) => `[ja] reassigned the approver to <mention-user accountID="${managerID}"/> via a workflow update`,
            actions: {
    ...
    deviceManagementPage: {
        title: '[ja] Device management',
        description:
            '[ja] Manage all the devices that you have logged into with your Expensify Account. <a href="https://help.expensify.com/articles/new-expensify/settings/Manage-Logged-in-Devices">Learn more</a>.',
        revoke: '[ja] Revoke',
        unknownDevice: '[ja] Unknown Device',
    },
    twoFactorAuth: {
        ...
        `),
        screenshotTip: '[ja] Tip: Screenshot this to save it to your photo library',
    ...
    walletPage: {
        ...
        cardActive: '[ja] Active',
        bankAccountStatus: {
            active: '[ja] Active',
            incomplete: '[ja] Incomplete',
            pending: '[ja] Pending',
            verifying: '[ja] Verifying',
            locked: '[ja] Locked',
            incompleteDescription: '[ja] Finish adding bank account',
            pendingDescription: '[ja] Please confirm test transactions',
            verifyingDescription: "[ja] We're reviewing your documentation",
            lockedDescription: '[ja] This account requires attention',
            finish: '[ja] Finish',
            confirm: '[ja] Confirm',
            unlock: '[ja] Unlock',
        },
        cardFixConnection: '[ja] Please fix this connection',
        cardAskAdminToFix: '[ja] Please ask an admin to fix this connection',
        cardAdminFixConnection: '[ja] Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `[ja] Last synced ${dateStr}`,
        assignedCards: '[ja] Cards',
        assignedCardsDescription: '[ja] Transactions from assigned cards sync automatically.',
...
${amount} for ${merchant} - ${date}`,
        ...
        cardUnblocked: '[ja] Card unblocked!',
        cardUnblockedDescription: '[ja] You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: '[ja] Your card was blocked due to incorrect PIN entries.',
        unblock: '[ja] Unblock',
        unblockCard: '[ja] Unblock card',
    ...
    workflowsPage: {
        ...
        configureViaHR: ({provider}: {provider: string}) => `[ja] Configure via ${provider}.`,
        hrApprovalWorkflowLockedPrompt: ({provider}: {provider: string}) =>
            `[ja] Approvals are managed by your ${provider} integration. To update your approval workflow, head to your ${provider} connection settings.`,
        goToHRSettings: ({provider}: {provider: string}) => `[ja] Go to ${provider} settings`,
    ...
    reportFraudConfirmationPage: {
        ...
        descriptionCardNotReplaced: '[ja] Your card was permanently deactivated. Please contact an admin to issue a new card.',
    ...
    agentsPage: {
        title: '[ja] Agents',
        subtitle: '[ja] Create agents to handle your workflow. Skip the manual work and get hours back in your day.',
        newAgent: '[ja] New agent',
        emptyAgents: {
            title: '[ja] No agents created',
            subtitle: '[ja] Stop manually doing stuff. Instruct an agent instead and save yourself lots of time.',
        },
        error: {
            genericAdd: '[ja] There was a problem adding this agent',
            genericUpdate: '[ja] There was a problem updating this agent',
            updateName: "[ja] There was a problem updating this agent's name",
            updatePrompt: "[ja] There was a problem updating this agent's instructions",
            updateAvatar: "[ja] There was a problem updating this agent's avatar",
        },
    },
    addAgentPage: {
        title: '[ja] New agent',
        agentName: '[ja] Agent name',
        instructions: '[ja] Write custom instructions',
        createAgent: '[ja] Create agent',
        editAvatar: '[ja] Edit avatar',
        defaultAgentName: (displayName: string) => `[ja] ${displayName}'s Agent`,
        defaultPrompt:
            "[ja] Reject expenses that are for gambling, movies, or other obvious non-business reasons.\n\nRemind the user to always include a receipt image that makes the tip clear.\n\nApprove the report if it's very similar to previous reports from the same user.\n\nReject reports with more than $500 in travel expenses.",
    },
    editAgentPage: {
        title: '[ja] Edit agent',
        agentName: '[ja] Agent name',
        instructions: '[ja] Write custom instructions',
        deleteAgent: '[ja] Delete agent',
        deleteAgentTitle: '[ja] Delete agent?',
        deleteAgentMessage: '[ja] Are you sure you want to delete this agent? This action cannot be undone.',
    },
    editAgentAvatarPage: {
        title: '[ja] Edit avatar',
    },
    editAgentNamePage: {
        title: '[ja] Agent name',
    },
    editAgentPromptPage: {
        title: '[ja] Write custom instructions',
        error: {
            emptyPrompt: '[ja] Please enter instructions for your agent.',
        },
    },
    expenseRulesPage: {
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '[ja] <strong>Avoid scams. Do not share your code with anyone.</strong> Our team will never call, text, or email you for this code.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[ja] Here's the list of workspaces you can join.",
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: '[ja] Submit expenses to my employer',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "[ja] Manage my team's expenses",
            [CONST.ONBOARDING_CHOICES.TRACK_BUSINESS]: '[ja] Track expenses for my business',
            [CONST.ONBOARDING_CHOICES.TRACK_PERSONAL]: '[ja] Organize my personal spending',
        ...
        workEmail2FAError: '[ja] This login is an existing account with Two-Factor Authentication (2FA) enabled.',
        mergeBlockScreen: {
            ...
            workAccountClosedSubtitle: '[ja] The work account associated with this email is closed. Please contact your company admin to reactivate it, or sign up with a different email.',
        },
        tasks: {
            testDriveAdminTask: {
    ...
    statusPage: {
        ...
        addVacationDelegate: '[ja] Add vacation delegate',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    addPersonalBankAccount: {
        ...
        updatePersonalInfo: '[ja] Update bank account',
        updatePersonalInfoFailure: '[ja] Unable to update bank account information. Please try again later.',
        updateSuccessTitle: '[ja] Bank account updated!',
        updateSuccessHeader: '[ja] Bank account updated',
        updateSuccessMessage: '[ja] Congrats, your bank account is set up and ready to receive reimbursements.',
    },
    ...
    messages: {
        ...
        userIsAlreadyMember: (login: string, name: string) => `[ja] ${login} is already a member of ${name}`,
        userIsAlreadyAnAdmin: (login: string, name: string) => `[ja] ${login} is already an admin of ${name}`,
    },
    onfidoStep: {
    ...
    workspace: {
        common: {
            ...
            cardAdminAlternateText: '[ja] Manage workspace cards.',
            peopleAdminAlternateText: '[ja] Manage members and approval workflows.',
            paymentsAdminAlternateText: '[ja] Manage workflow payments.',
            reimbursementChoice: {
            ...
            roleName: (role?: string) => {
                switch (role) {
                    ...
                    case CONST.POLICY.ROLE.CARD_ADMIN:
                        return '[ja] Card Admin';
                    case CONST.POLICY.ROLE.PEOPLE_ADMIN:
                        return '[ja] People Admin';
                    case CONST.POLICY.ROLE.PAYMENTS_ADMIN:
                        return '[ja] Payments Admin';
            ...
            travelInvoicing: '[ja] Export travel invoicing expenses as',
            travelInvoicingVendor: '[ja] Travel vendor',
            travelInvoicingPayableAccount: '[ja] Travel payable account',
        },
        createdForClient: {
            title: "[ja] You've created a workspace for your client!",
            description: '[ja] Great news 🎉. Reach out to us if they need any help with the setup.',
        },
        receiptPartners: {
            uber: {
        ...
        qbo: {
            ...
            bankAccountDescription: '[ja] Choose where to send checks from.',
            creditCardAccount: '[ja] Credit card account',
            travelInvoicingDescription: '[ja] Travel expenses will export as credit card charges to the QuickBooks Online account specified below.',
        ...
        xero: {
            ...
            travelInvoicingDescription: '[ja] Travel expenses will export as bank transactions to the Xero account specified below.',
        ...
        sageIntacct: {
            ...
            travelInvoicingDescription: '[ja] Travel expenses will export as credit card charges to the Sage Intacct account specified below.',
            creditCardAccount: '[ja] Credit card account',
        ...
        certinia: {
            title: '[ja] Certinia',
            prerequisites: {
                title: '[ja] Before you connect',
                installBundle: '[ja] For FFA Connections',
                installBundleDescription: ({href, version}: {href: string; version: string}) =>
                    `[ja] Install the Expensify bundle in Salesforce by clicking this link: <a href="${href}">Install FFA Expensify Bundle (Version ${version})</a>`,
                installBundleConfirm: "[ja] I've installed the bundle",
                setupContacts: '[ja] Set up user and contacts',
                setupContactsBullet1:
                    "[ja] Create both a User and a Contact for yourself if these don't already exist in Certinia making sure the email matches your primary email in Expensify.\n\n",
                setupContactsBullet2:
                    "[ja] Create contacts for each employee who will be submitting expense reports and for each report approver. Make sure each contact's email address corresponds with the email address on the employee's Expensify account.\n\n",
                setupContactsBullet3: '[ja] Set permission controls for your user for each contact/resource.\n\n',
                setupContactsConfirm: "[ja] I've set up the user and contacts",
                oauth: '[ja] Log in through Salesforce',
                oauthDescription: "[ja] To finish setup, you'll have to sign in through Salesforce and Certinia.\n\nUse the button below to continue.",
                connectButton: '[ja] Connect to Certinia',
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '[ja] Single entry for each expense',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '[ja] Single, itemized entry for each report',
                },
            },
            invoiceItem: {
...
_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                fileImportDescription: "[ja] A manual option if your bank can't send a feed.",
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                duplicateFeedModal: {
                    title: '[ja] Card feed already connected',
                    prompt: "[ja] You can't add the same card feed to the same workspace twice.",
                },
                csvColumns: {
        ...
        expensifyCard: {
            ...
            exportAsCSV: '[ja] Export as CSV',
            csvColumnType: '[ja] Type',
            csvColumnLimitType: '[ja] Limit type',
            csvColumnLimit: '[ja] Limit',
            findCard: '[ja] Find card',
            newCard: '[ja] New card',
            name: '[ja] Name',
            lastFour: '[ja] Last 4',
            ...
            applyCashbackToBill: '[ja] Apply cash back to my Expensify bill',
            applyCashbackToBillDescription: '[ja] Cash back from the Expensify Card will be used towards payment for your Expensify bill.',
            frequency: {
                daily: '[ja] Daily',
                monthly: '[ja] Monthly',
            },
        ...
        moreFeatures: {
                ...
                travelInvoicing: {
                    ...
                    travelInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[ja] We weren't able to provision some of the members of your workspace for travel invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[ja] Travel Invoicing enabled!',
            ...
            hrWarningModal: {
                disconnectText: ({integration}: {integration: string}) => `[ja] To disable HR, please disconnect ${integration} from this workspace first.`,
            },
        ...
        copyPolicySettings: {
            error: '[ja] An error occurred while copying workspace settings. Please try again.',
            title: '[ja] Copy settings',
            selectWorkspaces: '[ja] Select workspaces',
            description: '[ja] Choose the workspaces you want to copy settings to, then select the settings you’d like to copy.',
            searchPlaceholder: '[ja] Search workspaces',
        },
        emptyWorkspace: {
        ...
        people: {
            ...
            configureHRSync: (providerName: string) => `[ja] Configure ${providerName} sync.`,
            syncWithHR: (providerName: string) => `[ja] Sync with ${providerName}`,
            allMembers: '[ja] All members',
            admins: '[ja] Admins',
            approvers: '[ja] Approvers',
            auditors: '[ja] Auditors',
            emptyRoleFilter: {
                title: '[ja] No members match this filter',
                subtitle: '[ja] Invite a member or change the filter above.',
            },
        ...
        accounting: {
            ...
            updateCredentials: '[ja] Update credentials',
            claimOffer: {
            ...
            syncTravelInvoicingSettlements: '[ja] Sync travel invoicing settlements',
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '[ja] Choose the bank account that your travel invoicing payments will be reconciled against.',
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `[ja] Make sure this account matches your travel invoicing settlement account (ending in ${lastFourPAN}) so Continuous Reconciliation works properly.`,
            },
        },
        hr: {
            title: '[ja] HR',
            connections: '[ja] Connections',
            subtitle: '[ja] Connect HR tools and keep employee approvals in sync.',
            connect: '[ja] Connect',
            syncNow: '[ja] Sync now',
            disconnect: '[ja] Disconnect',
            disconnectTitle: (providerName: string) => `[ja] Disconnect ${providerName}`,
            disconnectPrompt: (providerName: string) => `[ja] Are you sure you want to disconnect ${providerName}?`,
            alreadyConnectedTitle: '[ja] Cannot connect to multiple HR platforms',
            alreadyConnectedPrompt: '[ja] You must disconnect your current HR platform before connecting another.',
            lastSync: (relativeDate: string) => `[ja] Last synced ${relativeDate}`,
            syncError: (providerName: string) => `[ja] Can't connect to ${providerName}`,
            connectionDescription: (providerName: string) => `[ja] Connect ${providerName} to keep employee approvals in sync with your workspace.`,
            approvalMode: '[ja] Approval mode',
            providerApprovalMode: (providerName: string) => `[ja] ${providerName} approval mode`,
            finalApprover: '[ja] Final approver',
            providerFinalApprover: (providerName: string) => `[ja] ${providerName} final approver`,
            notSet: '[ja] Not set',
            syncing: '[ja] Syncing employees',
            syncingModalTitle: '[ja] Your connection is syncing',
            syncingModalDescription: "[ja] The first connection can take some time. You'll be notified of any errors.",
            approvalModeDescription: (providerName: string) => `[ja] Members and managers are set up to sync with ${providerName}.`,
            approvalModeWarningTitle: '[ja] Change approval mode?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `[ja] Are you sure you would like to change the approval mode for this workspace? Learn more about the different ${providerName}-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
            approvalModeWarningConfirm: '[ja] Change approval mode',
            approvalModes: {
                basic: {label: '[ja] Basic approval', description: '[ja] All users submit to a single person for processing and approval.'},
                manager: {
                    label: '[ja] Manager approval',
                    description: (providerName: string) => `[ja] Employees submit reports to their direct manager configured in ${providerName}.`,
                },
                custom: {label: '[ja] Custom approval', description: "[ja] I'll manually setup approval workflows in Expensify."},
            },
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
                        return '[ja] Synchronizing Gusto Employees';
                    case 'gustoSyncLoadData':
                        return '[ja] Loading data from Gusto';
                    case 'gustoSyncProvisioning':
                        return '[ja] Provisioning employees in policy';
                    case 'zenefitsSyncTitle':
                        return '[ja] Synchronizing TriNet Employees';
                    case 'zenefitsSyncLoadData':
                        return '[ja] Loading data from TriNet';
            ...
            syncResults: {
                title: (provider: string) => `[ja] ${provider} sync complete`,
                successTitle: (provider: string) => `[ja] Successfully synced your ${provider} connection!`,
                added: '[ja] Added',
                removed: '[ja] Removed',
                skipped: '[ja] Skipped',
                employeeCount: () => ({
                    one: '[ja] 1 employee',
                    other: (count: number) => `[ja] ${count} employees`,
                }),
            },
            gusto: {
                title: '[ja] Gusto',
        ...
        distanceRates: {
            ...
            amountPerUnit: (unit: string) => `[ja] Amount per ${unit}`,
            startDate: '[ja] Start date',
            endDate: '[ja] End date',
            errors: {
                rateNameRequired: '[ja] Rate name is required',
                existingRateName: '[ja] A distance rate with this name already exists',
                nameRequired: '[ja] Name is required',
                amountRequired: '[ja] Amount is required',
                startDateMustBeBeforeEndDate: '[ja] Start date must be before end date',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            yourWorkspace: `[ja] Your workspace is set to an unsupported currency. View the <a href="${CONST.ENABLE_GLOBAL_REIMBURSEMENT_HELP_URL}">list of supported currencies</a>.`,
...
Are you sure you want to export them again?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.CERTINIA]: {
                title: '[ja] Certinia',
                description: `[ja] Enjoy automated syncing and reduce manual entries with the Expensify + Certinia integration. Align expense coding dimensions and tax sync with your Certinia setup for clearer financial visibility.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>Our Certinia integration is only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            ...
            approvalSubmit: {
                title: '[ja] Approvals',
                description: '[ja] Centrally configure who all members submit to by enabling approvals.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>Approvals are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            categories: {
                title: '[ja] Categories',
            ...
            companyCardSubmit: {
                title: '[ja] Company cards',
                description: `[ja] Bring your own company card to Expensify to get automatic import, automatic categorization, customizable rule support, and integrated reconciliation.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>Company card import is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            rules: {
                title: '[ja] Rules',
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            travelSubmit: {
                title: '[ja] Expensify Travel',
                description: '[ja] Book discounted flights, hotels, cars, and trains globally from within Expensify, with duty of care reporting and integrated expense management.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>Expensify Travel is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            reports: {
                title: '[ja] Reports',
            ...
            roles: {
                title: '[ja] Roles',
                description: '[ja] Assign different roles to different members to increase or decrease visibility and control as appropriate.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>Roles are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            payments: {
                title: '[ja] Payments',
                description: '[ja] Reimburse employees directly from your business bank account.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>Payments are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            accounting: {
                title: '[ja] Accounting',
                description:
                    '[ja] Sync categories, tags, tax rates, and more from your accounting system to Expensify, as well as export expense reports and card transactions – no typing (or typos) involved!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>Accounting is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            expensifyCard: {
                title: '[ja] Expensify Card',
                description:
                    '[ja] Issue company cards (including virtual cards) directly from your own bank account to get realtime spend control with an unbreakable connection, and up to 2% cashback!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>The Expensify Card is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
                upgradeButton: '[ja] Upgrade and enable',
            },
            invoicing: {
                title: '[ja] Invoicing',
                description: '[ja] Create, send, and track professional invoices, all inside Expensify. Get paid faster with integrated payments and real-time visibility.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[ja] <muted-text>Invoicing is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[ja] per member per month.` : `[ja] per active member per month.`}</muted-text>`,
            },
            pricing: {
                perActiveMember: '[ja] per active member per month.',
                perMember: '[ja] per member per month.',
            },
            note: (subscriptionLink: string) => `[ja] <muted-text><a href="${subscriptionLink}">Learn more</a> about our plans and pricing.</muted-text>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                giftCard: '[ja] Gift card purchases',
                handwrittenReceipt: '[ja] Handwritten receipts',
...
Add more spend rules to protect company cash flow.`,
        ...
        planTypePage: {
            planTypes: {
                ...
                submit2026: {
                    label: '[ja] Submit',
                    description: '[ja] For employees looking to submit expenses to their employer.',
                },
            },
            description: "[ja] Choose a plan that's right for you.",
            subscriptionLink: '[ja] Learn more',
    ...
    workspaceActions: {
        ...
        updatedRequireCompanyCards: ({enabled}: {enabled: boolean}) => `[ja] ${enabled ? '[ja] enabled' : '[ja] disabled'} the company card purchases requirement`,
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `[ja] set itemized receipt required amount to "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) => `[ja] changed itemized receipt required amount to "${newValue}" (previously "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `[ja] removed itemized receipt required amount (previously "${oldValue}")`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            editMultipleDescription: '[ja] Changes will be set for all selected expenses and will override any previously set values.',
            approve: '[ja] Approve',
            pay: '[ja] Pay',
            delete: '[ja] Delete',
            hold: '[ja] Hold',
        ...
        filters: {
            ...
            card: {
                ...
                travelInvoicing: '[ja] Travel invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[ja] Travel invoicing',
            },
            is: '[ja] Is',
            action: {
        ...
        askConcierge: (message: string) => `[ja] Ask Concierge “${message}”`,
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    travelCardLink: '[ja] travel card expenses',
    ...
    chronos: {
        ...
        stopTimer: (duration: string) => `[ja] Stop Timer (${duration})`,
    ...
    accessibilityHints: {
        ...
        openActionsMenu: '[ja] Open actions menu',
        selectAllCategories: '[ja] Select all categories',
        selectAllDistanceRates: '[ja] Select all distance rates',
        selectAllTags: '[ja] Select all tags',
        selectAllTaxes: '[ja] Select all taxes',
        selectAllPerDiemRates: '[ja] Select all per diem rates',
        selectAllMembers: '[ja] Select all members',
        selectAllValues: '[ja] Select all values',
        selectAllRules: '[ja] Select all rules',
    },
    parentReportAction: {
    ...
    gps: {
        ...
        liveActivity: {
            ...
            lockScreenBadgeText: '[ja] Distance',
            lockScreenTrackingText: '[ja] Tracking...',
    ...
    violations: {
        ...
        missingTag: (tagName?: string) => `[ja] Missing ${tagName ?? '[ja] tag'}`,
        ...
        prohibitedExpense: (prohibitedExpenseTypes: string | string[]) => {
            ...
            const getProhibitedExpenseTypeText = (prohibitedExpenseType: string) => {
                switch (prohibitedExpenseType) {
                    ...
                    case 'giftCard':
                        return `[ja] gift card purchases`;
                    case 'handwrittenReceipt':
                        return `[ja] handwritten receipts`;
                    default:
        ...
        smartscanFailed: ({canEdit = true, missingFields = []}: {canEdit?: boolean; missingFields?: string[]}) => {
            if (missingFields.length > 0) {
                const fieldNames: Record<string, string> = {merchant: '[ja] merchant', date: '[ja] date', amount: '[ja] amount'};
                const translated = missingFields.map((f) => fieldNames[f] ?? f);
                let fieldList = '';
                if (translated.length === 1) {
                    fieldList = translated.at(0) ?? '';
                } else if (translated.length === 2) {
                    fieldList = translated.join('[ja]  and ');
                } else {
                    fieldList = `${translated.slice(0, translated.length - 1).join(', ')}, and ${translated.at(-1)}`;
                }
                return `[ja] Receipt scanning failed — missing ${fieldList}.${canEdit ? '[ja]  Enter details manually.' : ''}`;
            }
            return `[ja] Receipt scanning failed.${canEdit ? '[ja]  Enter details manually.' : ''}`;
        },
    ...
    exitSurvey: {
        ...
        goBackJustOnce: '[ja] Go back just once',
    },
    listBoundary: {
    ...
    delegate: {
        ...
        addCopilot: '[ja] Add a copilot to your account',
        membersCanAccessYourAccount: '[ja] These members can access your account:',
        youCanAccessTheseAccounts: '[ja] You can access these accounts:',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            error: {
                ...
                moveMemberNotPolicyAdmin:
                    '[ja] Cannot move member to the domain group. You must be a Policy Admin for the Preferred Policy set on the domain group you are trying to move this user to.',
            },
        ...
        groups: {
            ...
            createGroupError: '[ja] Unable to create this group. Please try again.',
            permissions: '[ja] Group permissions',
            createNewGroupButton: '[ja] New group',
            createGroupSubmitButton: '[ja] Create group',
            expensifyCardPreferredWorkspace: '[ja] Expensify Card preferred workspace',
            expensifyCardPreferredWorkspaceDescription:
                '[ja] All Expensify Card transactions will be created on the Expensify Card Preferred Workspace instead of the Preferred Workspace. Enabling this feature will override the Preferred Workspace setting for Expensify Card transactions only.',
            strictlyEnforceWorkspaceRules: '[ja] Strictly enforce workspace rules',
            strictlyEnforceWorkspaceRulesDescription: '[ja] All workspace rules must be met before submitting a report. No manual exceptions allowed.',
            restrictExpenseWorkspaceCreation: '[ja] Restrict expense workspace creation/removal',
            restrictExpenseWorkspaceCreationDescription:
                '[ja] Prevent members from being able to create an expense workspace or remove themselves from an expense workspace. This is useful for preventing people from using Expensify to submit reports for use outside your domain when combined with strict workspace enforcement.',
            deleteGroup: '[ja] Delete Group',
            deleteGroupDangerConfirmationModal: '[ja] Delete Group',
            deleteGroupDangerConfirmationModalDescription: (defaultGroupName: string) =>
                `[ja] Are you sure? This will reassign all members to the default group (${defaultGroupName}) and can't be undone.`,
            deleteGroupError: '[ja] Unable to delete this group. Please try again.',
            preferredWorkspace: '[ja] Preferred Workspace',
            preferredWorkspaceDescription: (enabled: boolean) => `[ja] All new reports and expenses will be created on ${enabled ? '[ja] selected preferred' : '[ja] this'} workspace.`,
            preferredWorkspaceSelectDescription: '[ja] All new expenses and reports will be created on this workspace.',
            noWorkspacesMessage: '[ja] There are no workspaces on this domain. A workspace is required to enable this restriction.',
            restrictDefaultLoginSelection: '[ja] Restrict default login selection',
            restrictDefaultLoginSelectionDescription: '[ja] Prevent members from changing their login email away from their company domain to avoid policy restrictions.',
            expensifyCardPreferredWorkspaceDisabledMessage: '[ja] To enable this setting, please first enable a preferred workspace and set up Expensify Cards on your domain.',
            findGroup: '[ja] Find group',
        },
    },
};
