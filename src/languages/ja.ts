...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    deviceManagementPage: {
        ...
        description: '[ja] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[ja] Revoke',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        people: {
            ...
            configureGustoSync: '[ja] Configure Gusto sync.',
            syncWithGusto: '[ja] Sync with Gusto',
            ...
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    ...
                    case 'mergeHRSyncTitle':
                        return '[ja] Synchronizing HR Employees';
                    case 'jobDone':
                        return '[ja] Waiting for imported data to load';
                    default: {
                        return `[ja] Translation missing for stage: ${stage}`;
...
Add more spend rules to protect company cash flow.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateName: (customUnitName: string, oldValue: string, newValue: string) => `[ja] renamed the ${customUnitName} rate "${oldValue}" to "${newValue}"`,
