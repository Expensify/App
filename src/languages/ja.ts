...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. 請使用 ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} ボタンを押して請求書を送信してください。`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} ボタンを使用するだけです。`,
