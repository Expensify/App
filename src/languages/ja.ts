...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            verifying: '確認中',
            locked: 'ロック済み',
            incompleteDescription: '銀行口座の追加を完了してください',
            pendingDescription: 'テスト取引を確認してください',
            verifyingDescription: '書類を確認しています',
            lockedDescription: 'このアカウントには対応が必要です',
            finish: '完了',
            confirm: '確認',
            unlock: 'ロック解除',
        },
        cardFixConnection: 'この接続を修正してください',
        cardAskAdminToFix: '管理者にこの接続の修正を依頼してください',
        cardAdminFixConnection: '法人カードでこの接続を修正してください',
        lastSynced: (dateStr: string) => `最終同期 ${dateStr}`,
        assignedCards: 'カード',
