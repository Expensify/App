        ...
        recruiting: {
            ...
            filters: {
                ...
                stages: {
                    ...
                    toggleTitle: 'インポートジョブのステージ',
                    allSelected: 'すべての求人ステージ',
                    emptySelectionError: '少なくとも1つの求人ステージを選択してください',
                },
                tags: {
                    title: 'タグ',
                    description: 'このワークスペースと同期したい候補者のタグを選択してください',
                    toggleTitle: 'タグをインポート',
                    allSelected: 'すべてのタグ',
                    emptySelectionError: '少なくとも 1 つタグを選択してください',
                },
                offices: {
                    title: 'オフィス',
                    description: 'このワークスペースと同期したい候補者のオフィスを選択してください',
                    toggleTitle: 'オフィスをインポート（任意）',
                    allSelected: 'すべてのオフィス',
                },
            },
