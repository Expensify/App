        ...
        campfire: {
            ...
            accountingMethods: {
                ...
                alternateText: {
                    ...
                    [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]: '自己負担経費は精算時にエクスポートされます',
                },
            },
            syncReimbursedReports: '精算済みレポートを同期',
            syncReimbursedReportsDescription: 'レポートがACHで支払われた場合、この口座に支払伝票が作成されます。',
            billPaymentAccount: {label: '請求書支払い口座', description: '請求書の支払元を選択すると、Campfire 内に支払いを作成します。'},
            syncExpensifyCardSettlements: 'Expensify カードの決済を同期する',
            settlementAccount: {label: 'Expensify カードの決済口座', description: '精算用の口座を選択すると、Campfire に支払いを作成します。'},
            syncTravelInvoicingSettlements: '出張請求の精算を同期',
            travelInvoicingSettlementAccount: {label: '旅費請求決済口座', description: '精算用の口座を選択すると、Campfire に支払いを作成します。'},
            travelInvoicingPayableAccount: {label: '旅行請求書の買掛金勘定'},
        },
        businessCentral: {
