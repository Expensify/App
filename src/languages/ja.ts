        ...
        hr: {
            ...
            mergeHR: {
                groups: {
                    ...
                    staleSelectionError: (providerName: string) => `選択されたグループの一部は、${providerName} 内に既に存在しないため、これらのグループの従業員との同期が停止しました。`,
                    updateSelectionLink: 'グループを更新します。',
                    noGroupsFound: 'グループが見つかりません',
                    noGroupsFoundDescription:
                        '現在選択できるグループはありません。グループを選択せずに保存して全従業員を同期するか、新しいグループが作成されてからもう一度接続を同期してください。',
                },
            },
        },
        recruiting: {
