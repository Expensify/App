...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    multifactorAuthentication: {
        ...
        revoke: {
            ...
            title: '顔／指紋 & パスキー',
            explanation:
                '1 つ以上のデバイスで、顔／指紋認証またはパスキー認証が有効になっています。アクセスを取り消すと、今後いずれのデバイスでも、次回の認証時にマジックコードが必要になります',
            confirmationPrompt: '本当に続行しますか？今後、どのデバイスでも次回の認証にはマジックコードが必要になります',
            cta: 'アクセスを取り消す',
            noDevices: '顔認証・指紋認証またはパスキー認証に登録されているデバイスがありません。  \nデバイスを登録すると、そのアクセス権をここで取り消すことができるようになります。',
            dismiss: '了解',
