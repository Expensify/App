...
export default {
    ...
    attachmentView: {
        ...
        pdfPasswordRequired: 'Este PDF está protegido por contraseña. Por favor, introduzca la contraseña para continuar.',
        incorrectPDFPassword: 'Contraseña incorrecta. Por favor inténtalo de nuevo.',
    },
    pronouns: {
        heHimHis: 'Él',
        sheHerHers: 'Ella',
