...
export default {
    ...
    validateCodeForm: {
        ...
        enterAuthenticatorCode: 'Por favor, ingresa tu código de autenticador',
    ...
    passwordForm: {
        ...
        error: {
            ...
            unableToResetPassword: 'No se pudo cambiar tu clave. Probablemente porque el enlace para reestablecer la contrasenña ha expirado. Te hemos enviado un nuevo enlace. Comprueba tu bandeja de entrada y carpeta de Spam',
