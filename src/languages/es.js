...
export default {
    ...
    workspace: {
        ...
        invite: {
            ...
            welcomeNote: ({workspaceName}) => `¡Has sido invitado a ${workspaceName}! Descargue la aplicación móvil Expensify usando use.expensify.com/download para comenzar a rastrear sus gastos.`,
        },
        editor: {
