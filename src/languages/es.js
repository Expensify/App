...
export default {
    ...
    allCountries: {
        AC: {countryName: 'Isla Ascensión'},
        AD: {countryName: 'Andorra'},
        AE: {countryName: 'Emiratos Árabes Unidos'},
        AF: {countryName: 'Afganistán'},
        AG: {countryName: 'Antigua y Barbuda'},
        AI: {countryName: 'Anguila'},
        AL: {countryName: 'Albania'},
        AM: {countryName: 'Armenia'},
        AO: {countryName: 'Angola'},
        AQ: {countryName: 'Antártida'},
        AR: {countryName: 'Argentina'},
        AS: {countryName: 'Samoa Americana'},
        AT: {countryName: 'Austria'},
        AU: {countryName: 'Australia'},
        AW: {countryName: 'Aruba'},
        AX: {countryName: 'Islas de Åland'},
        AZ: {countryName: 'Azerbaiyán'},
        BA: {countryName: 'Bosnia y Herzegovina'},
        BB: {countryName: 'Barbados'},
        BD: {countryName: 'Bangladesh'},
        BE: {countryName: 'Bélgica'},
        BF: {countryName: 'Burkina Faso'},
        BG: {countryName: 'Bulgaria'},
        BH: {countryName: 'Bahrein'},
        BI: {countryName: 'Burundi'},
        BJ: {countryName: 'Benin'},
        BL: {countryName: 'San Bartolomé'},
        BM: {countryName: 'Islas Bermudas'},
        BN: {countryName: 'Brunéi'},
        BO: {countryName: 'Bolivia'},
        BQ: {countryName: 'Bonaire, San Eustaquio y Saba'},
        BR: {countryName: 'Brazil'},
        BS: {countryName: 'Bahamas'},
        BT: {countryName: 'Bhután'},
        BW: {countryName: 'Botsuana'},
        BY: {countryName: 'Bielorrusia'},
        BZ: {countryName: 'Belice'},
        CA: {countryName: 'Canadá'},
        CC: {countryName: 'Islas Cocos (Keeling)'},
        CD: {countryName: 'República Democrática del Congo'},
        CF: {countryName: 'República Centroafricana'},
        CG: {countryName: 'República del Congo'},
        CH: {countryName: 'Suiza'},
        CI: {countryName: 'Costa de Marfil'},
        CK: {countryName: 'Islas Cook'},
        CL: {countryName: 'Chile'},
        CM: {countryName: 'Camerún'},
        CN: {countryName: 'China'},
        CO: {countryName: 'Colombia'},
        CR: {countryName: 'Costa Rica'},
        CU: {countryName: 'Cuba'},
        CV: {countryName: 'Cabo Verde'},
        CW: {countryName: 'Curazao'},
        CX: {countryName: 'Isla de Navidad'},
        CY: {countryName: 'Chipre'},
        CZ: {countryName: 'República Checa'},
        DE: {countryName: 'Alemania'},
        DJ: {countryName: 'Yibuti'},
        DK: {countryName: 'Dinamarca'},
        DM: {countryName: 'Dominica'},
        DO: {countryName: 'República Dominicana'},
        DZ: {countryName: 'Argelia'},
        EC: {countryName: 'Ecuador'},
        EE: {countryName: 'Estonia'},
        EG: {countryName: 'Egipto'},
        EH: {countryName: 'Sahara Occidental'},
        ER: {countryName: 'Eritrea'},
        ES: {countryName: 'España'},
        ET: {countryName: 'Etiopía'},
        FI: {countryName: 'Finlandia'},
        FJ: {countryName: 'Fiyi'},
        FK: {countryName: 'Islas Malvinas'},
        FM: {countryName: 'Micronesia'},
        FO: {countryName: 'Islas Feroe'},
        FR: {countryName: 'Francia'},
        GA: {countryName: 'Gabón'},
        GB: {countryName: 'Reino Unido'},
        GD: {countryName: 'Granada'},
        GE: {countryName: 'Georgia'},
        GF: {countryName: 'Guayana Francesa'},
        GG: {countryName: 'Guernsey'},
        GH: {countryName: 'Ghana'},
        GI: {countryName: 'Gibraltar'},
        GL: {countryName: 'Groenlandia'},
        GM: {countryName: 'Gambia'},
        GN: {countryName: 'Guinea'},
        GP: {countryName: 'Guadeloupe'},
        GQ: {countryName: 'Guinea Ecuatorial'},
        GR: {countryName: 'Greece'},
        GS: {countryName: 'Islas Georgias del Sur y Sandwich del Sur'},
        GT: {countryName: 'Guatemala'},
        GU: {countryName: 'Guam'},
        GW: {countryName: 'Guinea-Bissau'},
        GY: {countryName: 'Guyana'},
        HK: {countryName: 'Hong Kong'},
        HN: {countryName: 'Honduras'},
        HR: {countryName: 'Croacia'},
        HT: {countryName: 'Haiti'},
        HU: {countryName: 'Hungría'},
        ID: {countryName: 'Indonesia'},
        IE: {countryName: 'Irlanda'},
        IL: {countryName: 'Israel'},
        IM: {countryName: 'Isla de Man'},
        IN: {countryName: 'India'},
        IO: {countryName: 'Territorio Británico del Océano Índico'},
        IQ: {countryName: 'Irak'},
        IR: {countryName: 'Irán'},
        IS: {countryName: 'Islandia'},
        IT: {countryName: 'Italia'},
        JE: {countryName: 'Jersey'},
        JM: {countryName: 'Jamaica'},
        JO: {countryName: 'Jordania'},
        JP: {countryName: 'Japón'},
        KE: {countryName: 'Kenia'},
        KG: {countryName: 'Kirguistán'},
        KH: {countryName: 'Camboya'},
        KI: {countryName: 'Kiribati'},
        KM: {countryName: 'Comoras'},
        KN: {countryName: 'San Cristóbal y Nieves'},
        KP: {countryName: 'Corea del Norte'},
        KR: {countryName: 'Corea del Sur'},
        KW: {countryName: 'Kuwait'},
        KY: {countryName: 'Islas Caimán'},
        KZ: {countryName: 'Kazajistán'},
        LA: {countryName: 'Laos'},
        LB: {countryName: 'Líbano'},
        LC: {countryName: 'Santa Lucía'},
        LI: {countryName: 'Liechtenstein'},
        LK: {countryName: 'Sri Lanka'},
        LR: {countryName: 'Liberia'},
        LS: {countryName: 'Lesoto'},
        LT: {countryName: 'Lituania'},
        LU: {countryName: 'Luxemburgo'},
        LV: {countryName: 'Letonia'},
        LY: {countryName: 'Libia'},
        MA: {countryName: 'Marruecos'},
        MC: {countryName: 'Mónaco'},
        MD: {countryName: 'Moldavia'},
        ME: {countryName: 'Montenegro'},
        MF: {countryName: 'San Martín (Francia)'},
        MG: {countryName: 'Madagascar'},
        MH: {countryName: 'Islas Marshall'},
        MK: {countryName: 'Macedônia'},
        ML: {countryName: 'Mali'},
        MM: {countryName: 'Birmania'},
        MN: {countryName: 'Mongolia'},
        MO: {countryName: 'Macao'},
        MP: {countryName: 'Islas Marianas del Norte'},
        MQ: {countryName: 'Martinica'},
        MR: {countryName: 'Mauritania'},
        MS: {countryName: 'Montserrat'},
        MT: {countryName: 'Malta'},
        MU: {countryName: 'Mauritius'},
        MV: {countryName: 'Islas Maldivas'},
        MW: {countryName: 'Malawi'},
        MX: {countryName: 'México'},
        MY: {countryName: 'Malasia'},
        MZ: {countryName: 'Mozambique'},
        NA: {countryName: 'Namibia'},
        NC: {countryName: 'Nueva Caledonia'},
        NE: {countryName: 'Niger'},
        NF: {countryName: 'Isla Norfolk'},
        NG: {countryName: 'Nigeria'},
        NI: {countryName: 'Nicaragua'},
        NL: {countryName: 'Países Bajos'},
        NO: {countryName: 'Noruega'},
        NP: {countryName: 'Nepal'},
        NR: {countryName: 'Nauru'},
        NU: {countryName: 'Niue'},
        NZ: {countryName: 'Nueva Zealand'},
        OM: {countryName: 'Omán'},
        PA: {countryName: 'Panamá'},
        PE: {countryName: 'Perú'},
        PF: {countryName: 'Polinesia Francesa'},
        PG: {countryName: 'Papúa Nueva Guinea'},
        PH: {countryName: 'Filipinas'},
        PK: {countryName: 'Pakistán'},
        PL: {countryName: 'Polonia'},
        PM: {countryName: 'San Pedro y Miquelón'},
        PN: {countryName: 'Islas Pitcairn'},
        PR: {countryName: 'Puerto Rico'},
        PS: {countryName: 'Palestina'},
        PT: {countryName: 'Portugal'},
        PW: {countryName: 'Palau'},
        PY: {countryName: 'Paraguay'},
        QA: {countryName: 'Qatar'},
        RE: {countryName: 'Reunión'},
        RO: {countryName: 'Rumanía'},
        RS: {countryName: 'Serbia'},
        RU: {countryName: 'Rusia'},
        RW: {countryName: 'Ruanda'},
        SA: {countryName: 'Arabia Saudita'},
        SB: {countryName: 'Islas Salomón'},
        SC: {countryName: 'Seychelles'},
        SD: {countryName: 'Sudán'},
        SE: {countryName: 'Suecia'},
        SG: {countryName: 'Singapur'},
        SH: {countryName: 'Santa Elena'},
        SI: {countryName: 'Eslovenia'},
        SJ: {countryName: 'Svalbard y Jan Mayen'},
        SK: {countryName: 'Eslovaquia'},
        SL: {countryName: 'Sierra Leona'},
        SM: {countryName: 'San Marino'},
        SN: {countryName: 'Senegal'},
        SO: {countryName: 'Somalia'},
        SR: {countryName: 'Surinám'},
        SS: {countryName: 'República de Sudán del Sur'},
        ST: {countryName: 'Santo Tomé y Príncipe'},
        SV: {countryName: 'El Salvador'},
        SX: {countryName: 'Sint Maarten'},
        SY: {countryName: 'Siria'},
        SZ: {countryName: 'Swazilandia'},
        TA: {countryName: 'Tristán de Acuña'},
        TC: {countryName: 'Islas Turcas y Caicos'},
        TD: {countryName: 'Chad'},
        TF: {countryName: 'Territorios Australes y Antárticas Franceses'},
        TG: {countryName: 'Togo'},
        TH: {countryName: 'Tailandia'},
        TJ: {countryName: 'Tayikistán'},
        TK: {countryName: 'Tokelau'},
        TL: {countryName: 'Timor Oriental'},
        TM: {countryName: 'Turkmenistán'},
        TN: {countryName: 'Tunez'},
        TO: {countryName: 'Tonga'},
        TR: {countryName: 'Turquía'},
        TT: {countryName: 'Trinidad y Tobago'},
        TV: {countryName: 'Tuvalu'},
        TW: {countryName: 'Taiwán'},
        TZ: {countryName: 'Tanzania'},
        UA: {countryName: 'Ucrania'},
        UG: {countryName: 'Uganda'},
        UM: {countryName: 'Islas Ultramarinas Menores de Estados Unidos'},
        US: {countryName: 'Estados Unidos de América'},
        UY: {countryName: 'Uruguay'},
        UZ: {countryName: 'Uzbekistan'},
        VA: {countryName: 'Ciudad del Vaticano'},
        VC: {countryName: 'San Vicente y las Granadinas'},
        VE: {countryName: 'Venezuela'},
        VG: {countryName: 'Islas Vírgenes Británicas'},
        VI: {countryName: 'Islas Vírgenes de los Estados Unidos'},
        VN: {countryName: 'Vietnam'},
        VU: {countryName: 'Vanuatu'},
        WF: {countryName: 'Wallis y Futuna'},
        WS: {countryName: 'Samoa'},
        XK: {countryName: 'Kosovo'},
        YE: {countryName: 'Yemen'},
        YT: {countryName: 'Mayotte'},
        ZA: {countryName: 'Sudáfrica'},
        ZM: {countryName: 'Zambia'},
        ZW: {countryName: 'Zimbabue'},
    },
    accessibilityHints: {
