...
var translations = {
    common: {
        ...
        noResultsFoundMatching: function (_a) {
            ...
            return "No se encontraron resultados que coincidan con \"".concat(searchString, "\"");
        },
        ...
        error: {
            ...
            phoneNumber: "Introduce un tel\u00E9fono v\u00E1lido, incluyendo el c\u00F3digo del pa\u00EDs (p. ej. ".concat(CONST_1.default.EXAMPLE_PHONE_NUMBER, ")"),
    ...
    reportActionContextMenu: {
        ...
        deleteAction: function (_a) {
            var action = _a.action;
            return "Eliminar ".concat((action === null || action === void 0 ? void 0 : action.actionName) === CONST_1.default.REPORT.ACTIONS.TYPE.IOU ? 'gasto' : 'comentario');
        },
        deleteConfirmation: function (_a) {
            var action = _a.action;
            return "\u00BFEst\u00E1s seguro de que quieres eliminar este ".concat((action === null || action === void 0 ? void 0 : action.actionName) === CONST_1.default.REPORT.ACTIONS.TYPE.IOU ? 'gasto' : 'comentario', "?");
        },
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryDomainRoomPartOne: function (_a) {
            ...
            return "Este chat es con todos los miembros de Expensify en el dominio ".concat(domainRoom, ".");
        },
        ...
        beginningOfChatHistoryAnnounceRoomPartOne: function (_a) {
            var workspaceName = _a.workspaceName;
            return "Este chat es con todos en ".concat(workspaceName, ".");
        },
    ...
    iou: {
        ...
        deletedTransaction: function (_a) {
            var amount = _a.amount, merchant = _a.merchant;
            return "elimin\u00F3 un gasto de este informe, ".concat(merchant, " - ").concat(amount);
        },
        ...
        settlePersonal: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pago ".concat(formattedAmount, " como individuo") : "Pago individual");
        },
        ...
        settleBusiness: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pagar ".concat(formattedAmount, " como negocio") : "Pagar como empresa");
        },
        payElsewhere: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "Pagar ".concat(formattedAmount, " de otra forma") : "Pagar de otra forma");
        },
        ...
        submitAmount: function (_a) {
            var amount = _a.amount;
            return "Solicitar ".concat(amount);
        },
        ...
        waitingOnBankAccount: function (_a) {
            ...
            return "inici\u00F3 el pago, pero no se procesar\u00E1 hasta que ".concat(submitterDisplayName, " a\u00F1ada una cuenta bancaria");
        },
        adminCanceledRequest: function (_a) {
            var manager = _a.manager;
            return "".concat(manager ? "".concat(manager, ": ") : '', "cancel\u00F3 el pago");
        },
        ...
        paidElsewhere: function (_a) {
            ...
            return "".concat(payer ? "".concat(payer, " ") : '', "pag\u00F3 de otra forma");
        },
        paidWithExpensify: function (_a) {
            var _b = _a === void 0 ? {} : _a, payer = _b.payer;
            return "".concat(payer ? "".concat(payer, " ") : '', "pag\u00F3 con Expensify");
        },
    ...
    termsOfUse: {
        ...
        phrase3: 'y',
        phrase4: 'Privacidad',
        phrase5: "El env\u00EDo de dinero es brindado por ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " (NMLS ID:2017010) de conformidad con sus"),
        phrase6: 'licencias',
    },
    validateCodeForm: {
    ...
    onboarding: {
        ...
        tasks: {
            ...
            setupCategoriesAndTags: {
                title: function (_a) {
                    ...
                    return "Configura [categor\u00EDas](".concat(workspaceCategoriesLink, ") y [etiquetas](").concat(workspaceMoreFeaturesLink, ")");
                },
                description: function (_a) {
            ...
            setupTagsTask: {
                title: function (_a) {
                    ...
                    return "Configura [etiquetas](".concat(workspaceMoreFeaturesLink, ")");
                },
                description: function (_a) {
                    var workspaceMoreFeaturesLink = _a.workspaceMoreFeaturesLink;
            ...
            reviewWorkspaceSettingsTask: {
                ...
                description: function (_a) {
                    var workspaceSettingsLink = _a.workspaceSettingsLink;
                    return 'Así es como puedes revisar y actualizar la configuración de tu espacio de trabajo:\n' +
                        '1. Haz clic en la pestaña de configuración.\n' +
                        '2. Haz clic en *Espacios de trabajo* > [Tu espacio de trabajo].\n' +
                        "[Ir a tu espacio de trabajo](".concat(workspaceSettingsLink, "). Lo rastrearemos en la sala #admins.");
                },
            },
            createReportTask: {
        ...
        messages: {
            ...
            onboardingMangeTeamMessage: function (_a) {
                ...
                return "Aqu\u00ED tienes una lista de tareas recomendadas para una empresa de tu tama\u00F1o".concat(onboardingCompanySize ? " con ".concat(onboardingCompanySize, " remitentes") : ':');
            },
    ...
    emailDeliveryFailurePage: {
        ...
        confirmThat: function (_a) {
            var login = _a.login;
            return "Confirma que ".concat(login, " est\u00E1 escrito correctamente y que es una direcci\u00F3n de correo electr\u00F3nico real que puede recibir correos. ");
        },
        ...
        longTermsForm: {
            ...
            electronicFundsInstantDetails: function (_a) {
                ...
                return 'Hay una tarifa para transferir fondos desde tu Billetera Expensify a ' +
                    ...
                    "generalmente se completa dentro de varios minutos. La tarifa es el ".concat(percentage, "% del importe de la ") +
                    "transferencia (con una tarifa m\u00EDnima de ".concat(amount, "). ");
            },
            fdicInsuranceBancorp: function (_a) {
                var amount = _a.amount;
                return 'Tus fondos pueden acogerse al seguro de la FDIC. Tus fondos se mantendrán o serán ' +
                    "transferidos a ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, ", una instituci\u00F3n asegurada por la FDIC. Una vez all\u00ED, tus fondos ") +
                    "est\u00E1n asegurados hasta ".concat(amount, " por la FDIC en caso de que ").concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.BANCORP_BANK, " quiebre, si se cumplen ") +
            ...
            contactExpensifyPayments: "Comun\u00EDcate con ".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, " llamando al + 1833-400-0904, o por correo electr\u00F3nico a"),
    ...
    signerInfoStep: {
        ...
        areYouDirector: function (_a) {
            var companyName = _a.companyName;
            return "\u00BFEs usted director o alto funcionario de ".concat(companyName, "?");
        },
        ...
        enterOneEmail: function (_a) {
            var companyName = _a.companyName;
            return "Introduce el correo electr\u00F3nico del director o alto funcionario en ".concat(companyName);
        },
        ...
        enterTwoEmails: function (_a) {
            var companyName = _a.companyName;
            return "Introduce los correos electr\u00F3nicos de dos directores o altos funcionarios en ".concat(companyName);
        },
    ...
    workspace: {
        ...
        perDiem: {
            ...
            errors: {
                existingRateError: function (_a) {
                    var rate = _a.rate;
                    return "Ya existe una tasa con el valor ".concat(rate);
                },
            },
        ...
        qbd: {
            ...
            accounts: (_f = {},
                ...
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK, "Description")] = 'Crearemos un cheque desglosado para cada informe de Expensify y lo enviaremos desde la cuenta bancaria a continuación.',
                ...
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = 'Crearemos una factura de proveedor desglosada para cada informe de Expensify con la fecha del último gasto, y la añadiremos a la cuenta a continuación. Si este periodo está cerrado, lo contabilizaremos el 1º del siguiente periodo abierto.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Elige dónde exportar las transacciones con tarjeta de crédito.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Selecciona el proveedor que se aplicará a todas las transacciones con tarjeta de crédito.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "AccountDescription")] = 'Elige desde dónde enviar los cheques.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'Las facturas de proveedores no están disponibles cuando las ubicaciones están habilitadas. Por favor, selecciona otra opción de exportación.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'Los cheques no están disponibles cuando las ubicaciones están habilitadas. Por favor, selecciona otra opción de exportación.',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'Los asientos contables no están disponibles cuando los impuestos están habilitados. Por favor, selecciona otra opción de exportación.',
                _f),
        ...
        qbo: {
            ...
            accounts: (_h = {},
                ...
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = "Automáticamente relacionaremos el nombre del comerciante de la transacción con tarjeta de crédito con cualquier proveedor correspondiente en QuickBooks. Si no existen proveedores, crearemos un proveedor asociado 'Credit Card Misc.'.",
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = 'Crearemos una factura de proveedor desglosada para cada informe de Expensify con la fecha del último gasto, y la añadiremos a la cuenta a continuación. Si este periodo está cerrado, lo contabilizaremos en el día 1 del siguiente periodo abierto.',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "AccountDescription")] = 'Elige dónde exportar las transacciones con tarjeta de débito.',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = 'Elige dónde exportar las transacciones con tarjeta de crédito.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = 'Selecciona el proveedor que se aplicará a todas las transacciones con tarjeta de crédito.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = 'Las facturas de proveedores no están disponibles cuando las ubicaciones están habilitadas. Por favor, selecciona otra opción de exportación diferente.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = 'La verificación no está disponible cuando las ubicaciones están habilitadas. Por favor, selecciona otra opción de exportación diferente.',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = 'El asiento de diario no está disponible cuando los impuestos están habilitados. Por favor, selecciona otra opción de exportación diferente.',
                _h),
        ...
        companyCards: {
            ...
            statementCloseDate: (_4 = {},
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_DAY_OF_MONTH] = 'Último día del mes',
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_BUSINESS_DAY_OF_MONTH] = 'Último día hábil del mes',
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH] = 'Día personalizado del mes',
                _4),
            ...
            chooseCardFor: function (_a) {
                ...
                return "Elige una tarjeta para ".concat(assignee, " del feed de tarjetas ").concat(feed, ".");
            },
        ...
        expensifyCard: {
            ...
            issuedCardNoShippingDetails: function (_a) {
                var assignee = _a.assignee;
                return "emiti\u00F3 a ".concat(assignee, " una Tarjeta Expensify. La tarjeta se enviar\u00E1 una vez que se agreguen los detalles de env\u00EDo.");
            },
        ...
        accounting: {
            ...
            importTypes: (_5 = {},
                ...
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG] = 'Importado como etiquetas',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.DEFAULT] = 'Importado',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NOT_IMPORTED] = 'No importado',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NONE] = 'No importado',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD] = 'Importado como campos de informe',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT] = 'Predeterminado del empleado NetSuite',
                _5),
            ...
            chooseReconciliationAccount: {
                ...
                reconciliationWorks: function (_a) {
                    ...
                    return "(que termina en ".concat(lastFourPAN, ") para que la conciliaci\u00F3n continua funcione correctamente.");
                },
            },
        },
        card: {
        ...
        upgrade: (_6 = {
            ...
            _6.upgradeToUnlock = 'Desbloquear esta función',
            _6.completed = {
                ...
                successMessage: function (_a) {
                    var policyName = _a.policyName;
                    return "Has actualizado con \u00E9xito ".concat(policyName, " al plan Controlar.");
                },
        ...
        rules: {
            ...
            expenseReportRules: {
                ...
                unlockFeatureEnableWorkflowsSubtitle: function (_a) {
                    ...
                    return "y habilita flujos de trabajo, luego agrega ".concat(featureName, " para desbloquear esta funci\u00F3n.");
                },
                enableFeatureSubtitle: function (_a) {
                    var featureName = _a.featureName;
                    return "y habilita ".concat(featureName, " para desbloquear esta funci\u00F3n.");
                },
            },
            categoryRules: {
        ...
        filters: {
            date: {
                ...
                presets: (_7 = {},
                    ...
                    _7[CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH] = 'El mes pasado',
                    _7),
            },
            status: 'Estado',
        ...
        actions: {
            type: {
                changeField: function (_a) {
                    ...
                    return "cambi\u00F3 ".concat(fieldName, " de ").concat(oldValue, " a ").concat(newValue);
                },
                changeFieldEmpty: function (_a) {
                    var newValue = _a.newValue, fieldName = _a.fieldName;
                    return "cambi\u00F3 ".concat(fieldName, " a ").concat(newValue);
                },
                ...
                delegateSubmit: function (_a) {
                    ...
                    return "envi\u00E9 este informe a ".concat(delegateUser, " ya que ").concat(originalManager, " est\u00E1 de vacaciones");
                },
                exportedToCSV: "exportado a CSV",
                exportedToIntegration: {
                    automatic: function (_a) {
                        var label = _a.label;
                        return "exportado a ".concat(label);
                    },
    ...
    referralProgram: (_8 = {},
        ...
        _8.copyReferralLink = 'Copiar enlace de invitación',
        _8),
    ...
    violations: {
        ...
        autoReportedRejectedExpense: function (_a) {
            ...
            return "".concat(rejectedBy, " rechaz\u00F3 la solicitud y coment\u00F3 \"").concat(rejectReason, "\"");
        },
        ...
        prohibitedExpense: function (_a) {
            ...
            switch (prohibitedExpenseType) {
                ...
                case 'gambling':
                    return "".concat(preMessage, " juegos de apuestas");
                case 'tobacco':
                    return "".concat(preMessage, " tabaco");
                case 'adultEntertainment':
                    return "".concat(preMessage, " entretenimiento para adultos");
                case 'hotelIncidentals':
                    return "".concat(preMessage, " gastos adicionales de hotel");
                default:
        ...
        rter: function (_a) {
            ...
            if (brokenBankConnection || rterType === CONST_1.default.RTER_VIOLATION_TYPES.BROKEN_CARD_CONNECTION) {
                return isAdmin
                    ? "No se puede adjuntar recibo debido a un problema con la conexi\u00F3n a tu banco que ".concat(email, " necesita arreglar")
    ...
    exitSurvey: {
        ...
        reasons: (_11 = {},
            _11[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = 'Necesito una función que sólo está disponible en Expensify Classic.',
            _11[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = 'No entiendo cómo usar New Expensify.',
            _11[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = 'Entiendo cómo usar New Expensify, pero prefiero Expensify Classic.',
            _11),
        prompts: (_12 = {},
            _12[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = '¿Qué función necesitas que no esté disponible en New Expensify?',
            _12[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = '¿Qué estás tratando de hacer?',
            _12[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = '¿Por qué prefieres Expensify Classic?',
            _12),
        ...
        benefits: (_13 = {},
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY] = 'Chat directo sobre gastos e informes',
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE] = 'Posibilidad de hacerlo todo desde el móvil',
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE] = 'Viajes y gastos a la velocidad del chat',
            _13),
        ...
        billingBanner: {
            ...
            cardAuthenticationRequired: {
                ...
                subtitle: function (_a) {
                    ...
                    return "Tu tarjeta de pago no ha sido autenticada completamente. Por favor, completa el proceso de autenticaci\u00F3n para activar tu tarjeta de pago que termina en ".concat(cardEnding, ".");
                },
            },
            insufficientFunds: {
                title: 'No se ha podido realizar el cobro a tu tarjeta',
    ...
    delegate: {
        ...
        notAllowedMessageEnd: function (_a) {
            ...
            return " de ".concat(accountOwnerEmail, ", no tienes permiso para realizar esta acci\u00F3n. \u00A1Lo siento!");
        },
