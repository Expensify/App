...
export default {
    ...
    workspace: {
        ...
        people: {
            ...
            genericFailureMessage: '[Translate] An error occurred removing an user from the workspace, please try again.',
            onlyAdminCanRemove: '[Translate] Can’t remove people from the workspace if you are not an admin.',
            cannotRemovePolicyOwner: '[Translate] Can’t remove the admin of this workspace.',
            removeMembersPrompt: '[Translate] Are you sure you want to remove the selected people from your workspace?',
            removeMembersTitle: '[Translate] Remove Members',
        },
        card: {
