...
export default {
    ...
    iou: {
        ...
        paidElsewhereWithAmount: ({payer, amount}) => `${payer ? `${payer} ` : ''}pagó ${amount} de otra forma`,
        paidUsingPaypalWithAmount: ({payer, amount}) => `${payer ? `${payer} ` : ''}pagó ${amount} con PayPal.me`,
        paidUsingExpensifyWithAmount: ({payer, amount}) => `${payer ? `${payer} ` : ''}pagó ${amount} con Expensify`,
