...
export default {
    ...
    contacts: {
        ...
        enterMagicCode: ({contactMethod}) => `Por favor, introduzca el código mágico enviado a ${contactMethod}`,
        yourDefaultContactMethod: 'Este es su método de contacto predeterminado actual. No podrá eliminar este método de contacto hasta que establezca un método alternativo por defecto seleccionando otro método de contacto y pulsando "Establecer como predeterminado".',
        removeContactMethod: 'Eliminar método de contacto',
        removeAreYouSure: '¿Está seguro de que desea eliminar este método de contacto? Esta acción no se puede deshacer.',
        resendMagicCode: 'Reenviar código mágico',
        genericFailureMessages: {
            requestContactMethodValidateCode: 'No se ha podido enviar un nuevo código mágico. Espere un poco y vuelva a intentarlo.',
            validateSecondaryLogin: 'No se ha podido validar el método de contacto con el código mágico indicado. Solicita un nuevo código e inténtalo de nuevo.',
            deleteContactMethod: 'No se ha podido eliminar el método de contacto. Chatea con el conserje para obtener más ayuda.',
        },
    },
    pronouns: {
        coCos: 'Co / Cos',
