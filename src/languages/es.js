...
export default {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryAdminOnlyPostingRoomPartOne: 'Usar ',
        beginningOfChatHistoryAdminOnlyPostingRoomPartTwo: ({workspaceName}) => ` para enterarse de anuncios importantes relacionados con ${workspaceName}`,
