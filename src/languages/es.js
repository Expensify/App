...
export default {
    ...
    bankAccount: {
        ...
        hasCurrencyError: '¡Ups! Parece que la moneda de tu espacio de trabajo está configurada en una moneda diferente al USD. Para continuar, por favor configúrala en USD e inténtalo nuevamente.',
        error: {
