    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            biometrics: {
                ...
                test: 'Test',
                softPromptTitle: 'Transaktionen mit Gesicht oder Fingerabdruck verifizieren',
                softPromptContent: 'Schnelle und sichere Verifizierung mit Gesicht oder Fingerabdruck-ganz ohne Passwörter oder Codes.',
                notificationTitle: 'Authentifizierung erfolgreich',
                notificationContent: 'Sie haben sich erfolgreich mit Face ID authentifiziert.',
                biometricsTest: 'Biometrietest',
                errorPageTitle: 'Hoppla, da ist ein Fehler aufgetreten',
                errorPageContent: 'Ihr Gerät konnte nicht registriert werden.',
            },
        },
        debugConsole: {
