...
3. Sobald der Feed aktiviert ist, klicken Sie unten auf „Senden“ und wir kümmern uns um die Einrichtung.`,
        ...
        reportFields: {
            ...
            unsupportedFormulaValueError: ({value}: UnsupportedFormulaValueErrorParams) => `Nicht unterstützte Formel-Token(s): ${value}. Verwende unterstützte Token wie {report:id}.`,
