...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        bankAccountStatus: {
            ...
            locked: 'Gesperrt',
            incompleteDescription: 'Bankkonto-Einrichtung abschließen',
            pendingDescription: 'Bitte bestätigen Sie die Testtransaktionen',
            verifyingDescription: 'Wir überprüfen Ihre Dokumentation',
            lockedDescription: 'Dieses Konto erfordert Aufmerksamkeit',
            finish: 'Abschließen',
            confirm: 'Bestätigen',
            unlock: 'Entsperren',
        },
        cardFixConnection: 'Bitte beheben Sie diese Verbindung',
        cardAskAdminToFix: 'Bitte bitten Sie einen Administrator, diese Verbindung zu beheben',
        cardAdminFixConnection: 'Bitte beheben Sie diese Verbindung unter Firmenkarten',
        lastSynced: (dateStr: string) => `Zuletzt synchronisiert ${dateStr}`,
