...
3. Sobald der Feed aktiviert ist, klicken Sie unten auf „Submit“ und wir kümmern uns darum, ihn hinzuzufügen.`,
        ...
        reportFields: {
            ...
            invalidFormulaError: ({placeholders}: InvalidFormulaErrorParams) => `Ungültige(r) Formelplatzhalter: ${placeholders}. Bitte verwenden Sie unterstützte Platzhalter wie {report:id}, {report:name}, {report:created} usw.`,
