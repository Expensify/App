...
${amount} für ${merchant} – ${date}`,
    ...
    loginForm: {
        ...
        error: {
            ...
            agentSignInBlocked:
                'Bei Agentenkonten ist eine direkte Anmeldung nicht möglich. Um einen Agenten zu verwenden, melde dich mit deinem eigenen Konto an und greife über Copilot darauf zu.',
        },
