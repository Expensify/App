...
Hier ist ein *Testbeleg*, um dir zu zeigen, wie es funktioniert:`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            ctaFix: 'Beheben',
            fixCompanyCardConnection: {title: ({feedName}: {feedName: string}) => (feedName ? `${feedName}-Firmenkartenverbindung reparieren` : 'Firmenkartenverbindung reparieren'), subtitle: 'Workspace > Firmenkarten'},
