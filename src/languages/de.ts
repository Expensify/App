...
3. Sobald der Feed aktiviert ist, klicken Sie unten auf „Submit“ und wir kümmern uns darum, ihn hinzuzufügen.`,
        ...
        moreFeatures: {
            ...
            timeTracking: {title: 'Zeit', subtitle: 'Legen Sie einen stündlichen abrechenbaren Satz fest, damit Mitarbeiter für ihre aufgewendete Zeit bezahlt werden.'},
        },
        reports: {
...
Fordere Spesendetails wie Belege und Beschreibungen an, lege Limits und Standardwerte fest und automatisiere Genehmigungen und Zahlungen – alles an einem Ort.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                merchantHint: 'Einen Händlernamen mit groß-/kleinschreibungsunabhängiger „enthält“-Übereinstimmung abgleichen',
                saveRule: 'Regel speichern',
