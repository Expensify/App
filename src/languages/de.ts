...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            accountManager: '[de] Account Manager',
            accountManagerDescription: 'Fragen stellen und Support erhalten',
            partnerManager: '[de] Partner Manager',
            partnerManagerDescription: 'Maximieren Sie Ihre Partnerschaft und fördern Sie Weiterempfehlungen',
            guideDescription: 'Ihre Einrichtungsfachkraft',
            approvedPartnerTeamTitle: 'Lernen Sie Ihr Approved!-Partnerteam kennen',
            approvedPartnerTeamDescription:
                'Ein engagiertes Team, das sich darauf konzentriert, Ihrem Unternehmen beim Wachstum zu helfen, Mandanten schneller zu integrieren und Ihnen jederzeit fachkundige Unterstützung zu bieten.',
            accountExecutive: '[de] Account Executive',
            accountExecutiveDescription: 'Kundeneinrichtung erfolgreich abschließen',
