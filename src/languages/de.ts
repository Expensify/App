...
${amount} für ${merchant} – ${date}`,
    ...
    workspace: {
        ...
        perDiem: {
            ...
            requestEmptyList: {
                title: 'Noch keine Tagespauschalen',
                subtitle: 'Dieser Arbeitsbereich hat keine Tagespauschalen. Bitten Sie Ihren Administrator, welche hinzuzufügen.',
                adminSubtitle: 'Fügen Sie Tagespauschalen hinzu, um Ihre Ausgaben zu organisieren.',
            },
