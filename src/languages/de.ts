...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        error: {
            ...
            allExpensesOnHoldDescription: 'Sie können diesen Bericht nicht einreichen, weil alle Ausgaben angehalten wurden. Heben Sie das Zurückhalten auf, um ihn einzureichen.',
