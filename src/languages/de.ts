...
3. Sobald der Feed aktiviert ist, klicken Sie unten auf „Senden“ und wir kümmern uns um die Einrichtung.`,
        ...
        accounting: {
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: 'Wählen Sie das Bankkonto aus, mit dem Ihre Zahlungen aus der zentralen Rechnungsstellung abgeglichen werden.',
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `Stellen Sie sicher, dass dieses Konto mit Ihrem Abrechnungskonto für zentrale Rechnungsstellung (endet auf ${lastFourPAN}) übereinstimmt, damit die kontinuierliche Abstimmung ordnungsgemäß funktioniert.`,
            },
            syncTravelInvoicingSettlements: 'Abgleiche der zentralen Rechnungsstellung synchronisieren',
        },
        export: {
