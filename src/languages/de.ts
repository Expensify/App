...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        setPin: {
            didNotShipCard: 'Wir haben Ihre Karte nicht versendet. Bitte versuchen Sie es erneut.',
        },
    },
    validateCodeModal: {
...
${amount} für ${merchant} – ${date}`,
        ...
        setYourPin: 'PIN festlegen',
        confirmYourPin: 'PIN bestätigen',
        enterFourDigitPin: 'Gib eine 4-stellige PIN für deine Karte ein.',
        reenterPinToConfirm: 'Gib deine PIN zur Bestätigung erneut ein.',
        pinMustBeFourDigits: 'Die PIN muss genau 4 Ziffern haben.',
        invalidPin: 'Bitte wähle eine sicherere PIN.',
