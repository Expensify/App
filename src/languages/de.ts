    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            betaOverridesDescription:
                'Überschreibungen gelten nur für dieses Gerät und wirken sich nur auf Frontend-Prüfungen aus. Durch das Umschalten einer Beta wird sie auf diesen Wert festgelegt und bleibt es, bis du sie zurücksetzt. „Alle Überschreibungen zurücksetzen“ löscht alle und setzt jede Beta auf den Wert zurück, den dein Konto im Backend hat. Einige Funktionen werden zusätzlich vom Backend gesteuert, sodass das erzwungene Aktivieren einer Beta, die dein Konto nicht hat, auf Anfrageebene trotzdem fehlschlagen kann.',
