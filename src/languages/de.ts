...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    attachmentPicker: {
        ...
        sizeExceededWithValue: (maxUploadSizeInMB) => `Dateien überschreiten ${maxUploadSizeInMB} MB. Bitte versuche es erneut.`,
        someFilesCantBeUploaded: 'Einige Dateien können nicht hochgeladen werden',
        sizeLimitExceeded: (maxUploadSizeInMB) => `Dateien dürfen nicht größer als ${maxUploadSizeInMB} MB sein. Größere Dateien werden nicht hochgeladen.`,
    ...
    cardPage: {
        ...
        monthlyLimit: {
            ...
            title: (formattedLimit) => `Sie können mit dieser Karte bis zu ${formattedLimit} pro Monat ausgeben. Das Limit wird am 1. Tag eines jeden Kalendermonats zurückgesetzt.`,
        },
...
${amount} für ${merchant} – ${date}`,
    ...
    onboarding: {
        ...
        workEmailValidation: {
            ...
            magicCodeSent: (workEmail) => `Bitte gib den magischen Code ein, der an ${workEmail} gesendet wurde. Er sollte in ein bis zwei Minuten ankommen.`,
        },
...
${
    ...
    statusPage: {
        ...
        asVacationDelegate: (nameOrEmail) => `als Urlaubsvertretung von ${nameOrEmail}`,
    ...
    termsStep: {
        ...
        shortTermsForm: {
            expensifyPaymentsAccount: (walletProgram) => `Die Expensify-Wallet wird von ${walletProgram} herausgegeben.`,
...
3. Sobald der Feed aktiviert ist, klicken Sie unten auf „Senden“ und wir kümmern uns um die Einrichtung.`,
        ...
        people: {
            ...
            workspaceMembersCount: (count) => `Gesamtzahl der Workspace-Mitglieder: ${count}`,
...
Fordern Sie Spesendetails wie Belege und Beschreibungen an, legen Sie Limits und Standardwerte fest und automatisieren Sie Genehmigungen und Zahlungen – alles an einem Ort.`,
    ...
    workspaceActions: {
        ...
        updateReimbursementEnabled: (enabled) => `${enabled ? 'aktiviert' : 'deaktiviert'} Rückerstattungen`,
        ...
        updateCategories: (count) => `${count} Kategorien aktualisiert`,
        updateTagList: (tagListName) => `Tags in der Liste „${tagListName}“ aktualisiert`,
        ...
        importCustomUnitRates: (customUnitName) => `importierte Preise für benutzerdefinierte Einheit „${customUnitName}“`,
        ...
        updatedAutoHarvesting: (enabled) => `${enabled ? 'aktiviert' : 'deaktiviert'} geplante Einreichung`,
    ...
    violations: {
        ...
        conversionSurcharge: (surcharge) => `${surcharge}% Umrechnungszuschlag angewendet`,
        ...
        invoiceMarkup: (invoiceMarkup) => `Um ${invoiceMarkup}% erhöht`,
        maxAge: (maxAge) => `Datum ist älter als ${maxAge} Tage`,
        ...
        overAutoApprovalLimit: (formattedLimit) => `Ausgabe überschreitet das Auto-Genehmigungslimit von ${formattedLimit}`,
        overCategoryLimit: (formattedLimit) => `Betrag über dem Kategorie-Limit von ${formattedLimit}/Person`,
        overLimit: (formattedLimit) => `Betrag über dem Limit von ${formattedLimit}/Person`,
        overTripLimit: (formattedLimit) => `Betrag über dem Limit von ${formattedLimit}/Reise`,
        overLimitAttendee: (formattedLimit) => `Betrag über dem Limit von ${formattedLimit}/Person`,
        perDayLimit: (formattedLimit) => `Betrag über dem täglichen Kategorienlimit von ${formattedLimit}/Person`,
    ...
    subscription: {
        ...
        yourPlan: {
            ...
            asLowAs: (price) => `schon ab ${price} pro aktivem Mitglied/Monat`,
            pricePerMemberMonth: (price) => `${price} pro Mitglied/Monat`,
            pricePerMemberPerMonth: (price) => `${price} pro Mitglied und Monat`,
