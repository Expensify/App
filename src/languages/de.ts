...
${amount} für ${merchant} – ${date}`,
        ...
        enterFourDigitPin: 'Geben Sie eine 4-stellige PIN für Ihre Karte ein.',
        reenterPinToConfirm: 'Geben Sie Ihre PIN zur Bestätigung erneut ein.',
    ...
    domain: {
        ...
        members: {
            ...
            cannotSetVacationDelegateForMember: (email: string) =>
                `Sie können für ${email} keine Urlaubsvertretung festlegen, da diese Person derzeit die Vertretung für die folgenden Mitglieder ist:`,
        },
