...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        ssnFull9: 'Vollständige 9-stellige Sozialversicherungsnummer',
        ...
        acceptTermsAndConditions: `Ich akzeptiere die <a href="${CONST.OLD_DOT_PUBLIC_URLS.ACH_TERMS_URL}">Geschäftsbedingungen</a>`,
...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
        ...
        personalBankAccount: 'Privates Bankkonto',
        ...
        import: 'Importieren',
        offlinePrompt: 'Du kannst diese Aktion jetzt nicht ausführen.',
        ...
        skip: 'Überspringen',
        chatWithAccountManager: (accountManagerDisplayName: string) => `Sie benötigen etwas Bestimmtes? Chatten Sie mit Ihrer/Ihrem Kundenbetreuer*in, ${accountManagerDisplayName}.`,
        ...
        rateOutOfPolicy: 'Satz nicht richtlinienkonform',
        ...
        leaveWorkspaceConfirmationTechContact: ({workspaceOwner}: {workspaceOwner: string}) =>
            `Wenn du diesen Workspace verlässt, wirst du als technischer Kontakt durch ${workspaceOwner}, den/die Workspace-Inhaber:in, ersetzt.`,
        leaveWorkspaceReimburser:
            'Du kannst diesen Workspace als Erstattungsverantwortliche*r nicht verlassen. Bitte lege unter „Workspaces > Zahlungen senden oder nachverfolgen“ eine*n neue*n Erstattungsverantwortliche*n fest und versuche es dann erneut.',
        ...
        reimbursableTotal: 'Erstattungsfähige Gesamtsumme',
    ...
    lockedAccount: {
        ...
        description: 'Sie dürfen diese Aktion nicht ausführen, da dieses Konto gesperrt wurde. Bitte wenden Sie sich an concierge@expensify.com, um das weitere Vorgehen zu klären.',
    },
    location: {
        useCurrent: 'Aktuellen Standort verwenden',
        notFound: 'Wir konnten deinen Standort nicht finden. Bitte versuche es erneut oder gib die Adresse manuell ein.',
    ...
    contact: {
        ...
        importContactsText: 'Importiere Kontakte von deinem Telefon, damit deine Lieblingsmenschen immer nur einen Tipp entfernt sind.',
        importContactsExplanation: 'sodass deine Lieblingsmenschen immer nur einen Tipp entfernt sind.',
    ...
    attachmentPicker: {
        ...
        errorWhileSelectingCorruptedAttachment: 'Beim Auswählen eines beschädigten Anhangs ist ein Fehler aufgetreten. Bitte versuche eine andere Datei.',
        ...
        sizeNotMet: 'Die Anlagengröße muss größer als 240 Byte sein',
        ...
        attachmentImageResized: 'Dieses Bild wurde für die Vorschau verkleinert. Lade es in voller Auflösung herunter.',
        ...
        maxFileLimitExceeded: 'Sie können bis zu 30 Belege auf einmal hochladen. Weitere werden nicht hochgeladen.',
    ...
    avatarCropModal: {
        ...
        description: 'Bild nach Belieben ziehen, zoomen und drehen.',
    },
    composer: {
    ...
    multifactorAuthentication: {
        ...
        pleaseEnableInSystemSettings: {
            start: 'Bitte aktivieren Sie die Gesichts-/Fingerabdruckverifizierung oder legen Sie einen Gerätecode auf Ihrem',
            link: 'Systemeinstellungen',
            end: '.',
        },
        oops: 'Ups, etwas ist schiefgelaufen',
        looksLikeYouRanOutOfTime: 'Anscheinend ist Ihre Zeit abgelaufen! Bitte versuchen Sie es noch einmal beim Händler.',
    ...
    validateCodeModal: {
        ...
        `),
        doNotShare: dedent(`
            Gib deinen Code nicht an jemand anderen weiter.  
            Expensify wird dich niemals danach fragen!
        `),
        or: 'oder',
        signInHere: 'melde dich einfach hier an',
        expiredCodeTitle: 'Magic-Code abgelaufen',
        expiredCodeDescription: 'Zum ursprünglichen Gerät zurückkehren und einen neuen Code anfordern',
        successfulNewCodeRequest: 'Code angefordert. Bitte prüfe dein Gerät.',
        ...
        `),
        requestOneHere: 'Fordere hier eins an.',
    },
    ...
    login: {
        hero: {
            header: 'Reisen und Spesen in Chatgeschwindigkeit',
            body: 'Willkommen bei der nächsten Generation von Expensify, in der Ihre Reisen und Ausgaben dank kontextbezogenem Chat in Echtzeit schneller vorankommen.',
        },
    },
    samlSignIn: {
        welcomeSAMLEnabled: 'Fahre mit der Anmeldung per Single Sign-On fort:',
    ...
    reportActionContextMenu: {
        ...
        deleteConfirmation: ({action}: DeleteConfirmationParams) => {
            ...
            return `Möchten Sie diesen ${type} wirklich löschen?`;
        },
        onlyVisible: 'Nur sichtbar für',
        replyInThread: 'Im Thread antworten',
        joinThread: 'Unterhaltung beitreten',
        leaveThread: 'Thread verlassen',
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryAdminRoom: (workspaceName: string) =>
            `Dieser Chat ist mit der Admin‑Person von <strong>${workspaceName}</strong>. Verwende ihn, um über die Einrichtung des Arbeitsbereichs und mehr zu sprechen.`,
        ...
        beginningOfChatHistoryPolicyExpenseChat: (workspaceName: string, submitterDisplayName: string) =>
            `Hier wird <strong>${submitterDisplayName}</strong> Spesen bei <strong>${workspaceName}</strong> einreichen. Verwende dazu einfach die +‑Taste.`,
        beginningOfChatHistorySelfDM: 'Dies ist dein persönlicher Bereich. Nutze ihn für Notizen, Aufgaben, Entwürfe und Erinnerungen.',
        beginningOfChatHistorySystemDM: 'Willkommen! Lass uns mit der Einrichtung beginnen.',
        ...
        usePlusButton: ({additionalText}: UsePlusButtonParams) => `Verwenden Sie die +‑Schaltfläche, um eine Ausgabe zu ${additionalText}.`,
        askConcierge: 'Stelle Fragen und erhalte rund um die Uhr Unterstützung in Echtzeit.',
    ...
    reportAction: {
        ...
        createdReportForUnapprovedTransactions: ({reportUrl, reportName}: CreatedReportForUnapprovedTransactionsParams) =>
            `hat diesen Bericht für alle zurückgestellten Ausgaben aus <a href="${reportUrl}">${reportName}</a> erstellt`,
    },
    mentionSuggestions: {
    ...
    youHaveBeenBanned: 'Hinweis: Du wurdest vom Chatten in diesem Kanal gesperrt.',
    ...
    sidebarScreen: {
        ...
        redirectToExpensifyClassicModal: {
            ...
            description: 'Wir feilen noch an ein paar Details von New Expensify, damit alles zu deinem Setup passt. In der Zwischenzeit kannst du Expensify Classic verwenden.',
        },
    },
    allSettingsScreen: {
    ...
    spreadsheet: {
        ...
        import: 'Tabellendatei importieren',
        ...
        fieldNotMapped: (fieldName: string) => `Ups! Ein Pflichtfeld („${fieldName}“) wurde nicht zugeordnet. Bitte überprüfen und erneut versuchen.`,
        ...
        importPerDiemRatesSuccessfulDescription: ({rates}: {rates: number}) => (rates > 1 ? `${rates} Tagegeldsätze wurden hinzugefügt.` : '1 Tagessatz wurde hinzugefügt.'),
        ...
        importDescription: 'Wählen Sie aus, welche Felder aus Ihrer Tabelle zugeordnet werden sollen, indem Sie unten neben jeder importierten Spalte das Dropdown-Menü anklicken.',
        ...
        importMemberConfirmation: () => ({
            one: `Bitte bestätige die untenstehenden Details für ein neues Workspace-Mitglied, das im Rahmen dieses Uploads hinzugefügt wird. Bestehende Mitglieder erhalten keine Rollenaktualisierungen oder Einladungsnachrichten.`,
            other: (count: number) =>
                `Bitte bestätige die folgenden Details für die ${count} neuen Arbeitsbereichsmitglieder, die im Rahmen dieses Uploads hinzugefügt werden. Bestehende Mitglieder erhalten keine Rollenaktualisierungen oder Einladungsnachrichten.`,
        }),
    },
    receipt: {
        ...
        alternativeMethodsTextReceipts: ({phoneNumber}: {phoneNumber: string}) => `<label-text>Belege als Textnachricht an ${phoneNumber} senden (nur US-Nummern)</label-text>`,
        takePhoto: 'Foto aufnehmen',
        cameraAccess: 'Für das Fotografieren von Belegen ist Kamera-Zugriff erforderlich.',
    ...
    quickAction: {
        ...
        noLongerHaveReportAccess: 'Du hast keinen Zugriff mehr auf dein bisheriges Schnellaktionsziel. Wähle unten ein neues aus.',
    ...
    iou: {
        ...
        removeExpenseConfirmation: 'Möchten Sie diese Quittung wirklich entfernen? Diese Aktion kann nicht rückgängig gemacht werden.',
        ...
        routePending: 'Route wird verarbeitet ...',
        receiptScanning: () => ({
            one: 'Beleg wird gescannt ...',
            other: 'Belege werden gescannt …',
        }),
        scanMultipleReceipts: 'Mehrere Belege scannen',
        scanMultipleReceiptsDescription: 'Fotografiere alle deine Belege auf einmal und bestätige die Details anschließend selbst – oder wir übernehmen das für dich.',
        ...
        receiptScanningFailed: 'Belegerfassung fehlgeschlagen. Bitte die Angaben manuell eingeben.',
        transactionPendingDescription: 'Transaktion ausstehend. Die Buchung kann einige Tage dauern.',
        companyInfo: 'Unternehmensinformationen',
        companyInfoDescription: 'Wir benötigen noch ein paar Details, bevor Sie Ihre erste Rechnung senden können.',
        ...
        deleteConfirmation: () => ({
            one: 'Bist du sicher, dass du diese Ausgabe löschen möchtest?',
        ...
        settlePersonal: ({formattedAmount}: SettleExpensifyCardParams) => (formattedAmount ? `${formattedAmount} privat bezahlen` : `Mit Privatkonto bezahlen`),
        ...
        submitted: ({memo}: SubmittedWithMemoParams) => `eingereicht${memo ? `, mit dem Kommentar ${memo}` : ''}`,
        ...
        trackedAmount: (formattedAmount: string, comment?: string) => `Verfolgen von ${formattedAmount}${comment ? `für ${comment}` : ''}`,
        ...
        adminCanceledRequest: 'die Zahlung storniert',
        canceledRequest: (amount: string, submitterDisplayName: string) =>
            `hat die Zahlung über ${amount} storniert, weil ${submitterDisplayName} ihr Expensify Wallet nicht innerhalb von 30 Tagen aktiviert hat`,
        ...
        pendingConversionMessage: 'Die Summe wird aktualisiert, sobald du wieder online bist',
        ...
        removedTheRequest: ({valueName, oldValueToDisplay}: RemovedTheRequestParams) => `der/die/das ${valueName} (früher ${oldValueToDisplay})`,
        updatedTheRequest: ({valueName, newValueToDisplay, oldValueToDisplay}: UpdatedTheRequestParams) => `die(n) ${valueName} auf ${newValueToDisplay} (zuvor ${oldValueToDisplay})`,
        ...
        error: {
            ...
            invalidIntegerAmount: 'Bitte gib einen ganzen Dollarbetrag ein, bevor du fortfährst',
            ...
            noParticipantSelected: 'Bitte wähle eine teilnehmende Person aus',
            ...
            genericUnholdExpenseFailureMessage: 'Unerwarteter Fehler beim Aufheben der Sperre dieser Ausgabe. Bitte versuche es später noch einmal.',
            ...
            invalidQuantity: 'Bitte gib eine gültige Anzahl ein',
            ...
            manySplitsProvided: `Die maximal zulässige Anzahl von Aufteilungen beträgt ${CONST.IOU.SPLITS_LIMIT}.`,
            dateRangeExceedsMaxDays: `Der Datumsbereich darf ${CONST.IOU.SPLITS_LIMIT} Tage nicht überschreiten.`,
        },
        dismissReceiptError: 'Fehler schließen',
        ...
        waitingOnEnabledWallet: ({submitterDisplayName}: WaitingOnBankAccountParams) =>
            `hat mit dem Ausgleich begonnen. Die Zahlung ist ausgesetzt, bis ${submitterDisplayName} ihr Wallet aktiviert.`,
        ...
        unholdExpense: 'Sperre der Ausgabe aufheben',
        ...
        emptyStateUnreportedExpenseSubtitle: 'Es scheint, dass du keine nicht eingereichten Ausgaben hast. Versuch, unten eine zu erstellen.',
        ...
        explainHold: () => ({
            ...
            other: 'Erklären Sie, warum Sie diese Spesen zurückhalten.',
        }),
        ...
        reopenExportedReportConfirmation: ({connectionName}: {connectionName: string}) =>
            `Dieser Bericht wurde bereits nach ${connectionName} exportiert. Änderungen können zu Datenabweichungen führen. Möchtest du diesen Bericht wirklich wieder öffnen?`,
        reason: 'Grund',
        holdReasonRequired: 'Beim Zurückhalten ist eine Begründung erforderlich.',
        expenseWasPutOnHold: 'Spesen wurden zurückgestellt',
        ...
        confirmApprove: 'Freigabebetrag bestätigen',
        ...
        whatIsHoldExplain: 'Anhalten ist wie „Pause“ bei einer Ausgabe zu drücken, bis du bereit bist, sie einzureichen.',
        holdIsLeftBehind: 'Zurückgehaltene Ausgaben werden nicht eingereicht, selbst wenn du einen gesamten Bericht einreichst.',
        unholdWhenReady: 'Spesen freigeben, wenn du sie einreichen möchtest.',
        ...
        changed: 'geändert',
        removed: 'entfernt',
        transactionPending: 'Buchung ausstehend.',
        chooseARate: 'Wähle einen Erstattungsbetrag pro Meile oder Kilometer für den Arbeitsbereich aus',
        unapprove: 'Nicht genehmigen',
        unapproveReport: 'Genehmigung aufheben',
        headsUp: 'Achtung!',
        unapproveWithIntegrationWarning: ({accountingIntegration}: UnapproveWithIntegrationWarningParams) =>
            `Dieser Bericht wurde bereits nach ${accountingIntegration} exportiert. Änderungen können zu Datenabweichungen führen. Bist du sicher, dass du die Freigabe für diesen Bericht aufheben möchtest?`,
        reimbursable: 'erstattungsfähig',
        ...
        whoIsYourAccountant: 'Wer ist Ihre Steuerberaterin oder Ihr Steuerberater?',
        ...
        reject: {
            ...
            heldExpenseLeftBehindTitle: 'Zurückgestellte Ausgaben bleiben bestehen, wenn du einen gesamten Bericht genehmigst.',
        ...
        moveExpensesError:
            'Sie können Per-Diem-Spesen nicht zu Berichten in anderen Arbeitsbereichen verschieben, da sich die Per-Diem-Sätze zwischen den Arbeitsbereichen unterscheiden können.',
        changeApprover: {
            ...
            changedApproverMessage: (managerID: number) => `die genehmigende Person in <mention-user accountID="${managerID}"/> geändert`,
            actions: {
                addApprover: 'Genehmigende Person hinzufügen',
                ...
                bypassApproversSubtitle: 'Sich selbst als letzte:n Genehmiger:in zuweisen und verbleibende Genehmiger:innen überspringen.',
            },
            addApprover: {
                subtitle: 'Wählen Sie eine zusätzliche genehmigende Person für diesen Bericht aus, bevor wir ihn durch den restlichen Genehmigungsworkflow leiten.',
            },
        },
        chooseWorkspace: 'Wähle einen Workspace',
        routedDueToDEW: ({to}: RoutedDueToDEWParams) => `Bericht wurde aufgrund des benutzerdefinierten Genehmigungsworkflows an ${to} weitergeleitet`,
        timeTracking: {
        ...
        correctDistanceRateError: 'Behebe den Fehler beim Kilometersatz und versuche es erneut.',
    },
    transactionMerge: {
        listPage: {
            ...
            selectTransactionToMerge: ({reportName}: {reportName: string}) =>
                `Wähle eine <a href="${CONST.HELP_DOC_LINKS.MERGE_EXPENSES}">berechtigte Ausgabe</a> aus, um sie mit <strong>${reportName}</strong> zu zusammenzuführen.`,
        },
        receiptPage: {
    ...
    loginField: {
        numberHasNotBeenValidated: 'Die Nummer wurde nicht verifiziert. Klicke auf die Schaltfläche, um den Bestätigungslink per SMS erneut zu senden.',
        emailHasNotBeenValidated: 'Die E-Mail-Adresse wurde nicht verifiziert. Klicke auf die Schaltfläche, um den Bestätigungslink per SMS erneut zu senden.',
    },
    avatarWithImagePicker: {
        ...
        notAllowedExtension: ({allowedExtensions}: NotAllowedExtensionParams) => `Das Profilbild muss einen der folgenden Typen haben: ${allowedExtensions.join(', ')}.`,
    },
    avatarPage: {
        ...
        message: {
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_ADD_TRANSACTIONS]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    ...
                    case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return `Warte darauf, dass <strong>${actor}</strong> Ausgaben hinzufügt.`;
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_SUBMIT]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    ...
                    case CONST.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return `Warte darauf, dass ein Admin Ausgaben einreicht.`;
                }
            },
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_FOR_AUTOMATIC_SUBMIT]: ({actor, actorType, eta, etaType}: NextStepParams) => {
                ...
                switch (actorType) {
                    ...
                    case CONST.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return `Warten darauf, dass die Auslagen eines Admins automatisch eingereicht werden${formattedETA}.`;
                }
            },
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_FIX_ISSUES]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    ...
                    case CONST.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
                        return `Warten auf eine Administrator*in, um die Probleme zu beheben.`;
                }
            },
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_APPROVE]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return `Warten auf <strong>dich</strong>, um Spesen zu genehmigen.`;
                    case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.WAITING_TO_PAY]: ({actor, actorType}: NextStepParams) => {
                ...
                switch (actorType) {
                    case CONST.NEXT_STEP.ACTOR_TYPE.CURRENT_USER:
                        return `Warten auf <strong>dich</strong>, um Spesen zu bezahlen.`;
                    case CONST.NEXT_STEP.ACTOR_TYPE.OTHER_USER:
                        return `Warten auf die Erstattung der Ausgaben durch <strong>${actor}</strong>.`;
                    case CONST.NEXT_STEP.ACTOR_TYPE.UNSPECIFIED_ADMIN:
            ...
            [CONST.NEXT_STEP.MESSAGE_KEY.SUBMITTING_TO_SELF]: (_: NextStepParams) =>
                `Ups! Sie scheinen diesen Bericht bei <strong>sich selbst</strong> einzureichen. Das Genehmigen eigener Berichte ist in Ihrem Arbeitsbereich <strong>verboten</strong>. Bitte reichen Sie diesen Bericht bei jemand anderem ein oder wenden Sie sich an Ihre Admin, um die Person zu ändern, an die Sie Berichte einreichen.`,
        },
        eta: {
    ...
    pronounsPage: {
        ...
        placeholderText: 'Suche, um Optionen anzuzeigen',
    },
    contacts: {
        ...
        genericFailureMessages: {
            requestContactMethodValidateCode: 'Der neue Magic-Code konnte nicht gesendet werden. Bitte warte einen Moment und versuche es erneut.',
            ...
            setDefaultContactMethod: 'Standard-Kontaktmethode konnte nicht aktualisiert werden. Bitte wende dich für Hilfe an Concierge.',
        ...
        goBackContactMethods: 'Zu den Kontaktmethoden zurückkehren',
    },
    // cspell:disable
    pronouns: {
        coCos: 'Co / Cos',
        ...
        zeHirHirs: 'Ze / Hir',
        callMeByMyName: 'Sprich mich mit meinem Namen an',
    },
    // cspell:enable
    displayNamePage: {
    ...
    initialSettingsPage: {
        ...
        troubleshoot: {
            ...
            debugConsole: 'Debugkonsole',
            description:
                '<muted-text>Verwenden Sie die folgenden Tools, um Probleme mit der Expensify Nutzung zu beheben. Wenn Sie auf Probleme stoßen, <concierge-link>melden Sie bitte einen Fehler</concierge-link>.</muted-text>',
            confirmResetDescription: 'Alle ungesendeten Entwurfsnachrichten gehen verloren, aber alle anderen Daten sind sicher.',
            ...
            destroy: 'Löschen',
            maskExportOnyxStateData: 'Empfindliche Mitgliederdaten beim Export des Onyx-Status maskieren',
            ...
            sentryHighlightedSpanOpsPlaceholder: 'ui.interaction.klick, Navigation, ui.laden',
        },
        debugConsole: {
    ...
    closeAccountPage: {
        ...
        enterDefaultContactToConfirm: 'Bitte gib deine bevorzugte Kontaktmethode ein, um zu bestätigen, dass du dein Konto schließen möchtest. Deine bevorzugte Kontaktmethode ist:',
    ...
    mergeAccountsPage: {
        ...
        accountValidate: {
            ...
            lossOfUnsubmittedData: ({login}: MergeAccountIntoParams) =>
                `Das Zusammenführen Ihrer Konten kann nicht rückgängig gemacht werden und führt zum Verlust aller nicht eingereichten Ausgaben für <strong>${login}</strong>.`,
        ...
        mergePendingSAML: {
            ...
            limitedSupport: 'Das Zusammenführen von Konten wird in New Expensify noch nicht unterstützt. Bitte führe diese Aktion stattdessen in Expensify Classic aus.',
        ...
        mergeFailureSAMLAccountDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Sie können <strong>${email}</strong> nicht mit anderen Konten zusammenführen, weil Ihre Domain-Administration es als Ihre primäre Anmeldung festgelegt hat. Bitte führen Sie stattdessen andere Konten damit zusammen.</centered-text></muted-text>`,
        mergeFailure2FA: {
        ...
        mergeFailureAccountLockedDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Du kannst <strong>${email}</strong> nicht zusammenführen, weil es gesperrt ist. Bitte <concierge-link>wende dich für Unterstützung an Concierge</concierge-link>.</centered-text></muted-text>`,
        ...
        mergeFailureInvoicedAccountDescription: ({email}: MergeFailureDescriptionGenericParams) =>
            `<muted-text><centered-text>Konten können nicht in das Konto <strong>${email}</strong> zusammengeführt werden, da dieses Konto eine fakturierte Rechnungsbeziehung besitzt.</centered-text></muted-text>`,
    ...
    lockAccountPage: {
        ...
        compromisedDescription:
            'Ihnen kommt etwas an Ihrem Konto seltsam vor? Wenn Sie dies melden, wird Ihr Konto sofort gesperrt, neue Expensify Card-Transaktionen werden blockiert und alle Kontoänderungen verhindert.',
        domainAdminsDescription: 'Für Domain-Admins: Dadurch werden auch alle Expensify Card-Aktivitäten und Admin-Aktionen in deiner/deinen Domain(s) angehalten.',
        areYouSure: 'Möchtest du dein Expensify-Konto wirklich sperren?',
        onceLocked: 'Sobald Ihr Konto gesperrt ist, wird es eingeschränkt, bis eine Entsperranfrage gestellt und eine Sicherheitsprüfung durchgeführt wurde',
    },
    ...
    twoFactorAuth: {
        ...
        whatIsTwoFactorAuth:
            'Die Zwei-Faktor-Authentifizierung (2FA) hilft dabei, Ihr Konto zu schützen. Beim Anmelden müssen Sie einen Code eingeben, der von Ihrer bevorzugten Authentifizierungs-App generiert wird.',
        ...
        congrats: 'Glückwunsch! Du hast jetzt diese zusätzliche Sicherheit.',
        copy: 'Kopieren',
        disable: 'Deaktivieren',
        ...
        twoFactorAuthIsRequiredForAdminsTitle: 'Bitte Zwei-Faktor-Authentifizierung aktivieren',
    ...
    recoveryCodeForm: {
        ...
        use2fa: 'Verwende den Zwei-Faktor-Authentifizierungscode',
    },
    twoFactorAuthForm: {
        error: {
    ...
    billingCurrency: {
        ...
        paymentCurrencyDescription: 'Wähle eine standardisierte Währung aus, in die alle privaten Ausgaben umgerechnet werden sollen',
        note: `Hinweis: Wenn Sie Ihre Zahlungswährung ändern, kann sich dies darauf auswirken, wie viel Sie für Expensify bezahlen. Weitere Einzelheiten finden Sie auf unserer <a href="${CONST.PRICING}">Preisseite</a>.`,
    },
    addDebitCardPage: {
    ...
    walletPage: {
        ...
        getPaidBackFaster: 'Schneller Geld zurückbekommen',
        secureAccessToYourMoney: 'Sicherer Zugriff auf Ihr Geld',
        receiveMoney: 'Geld in deiner Landeswährung empfangen',
        ...
        assignedCardsDescription: 'Dies sind Karten, die von einer Arbeitsbereichs-Adminperson zugewiesen werden, um die Unternehmensausgaben zu verwalten.',
        expensifyCard: 'Expensify Card',
        walletActivationPending: 'Wir überprüfen Ihre Angaben. Bitte schauen Sie in ein paar Minuten noch einmal vorbei!',
        walletActivationFailed: 'Leider kann Ihr Wallet derzeit nicht aktiviert werden. Bitte chatten Sie mit Concierge, um weitere Unterstützung zu erhalten.',
        addYourBankAccount: 'Füge dein Bankkonto hinzu',
        addBankAccountBody: 'Verbinde dein Bankkonto mit Expensify, damit du so einfach wie nie zuvor Zahlungen direkt in der App senden und empfangen kannst.',
        ...
        shareBankAccountNoAdminsSelected: 'Bitte wähle zuerst eine:n Admin aus, bevor du fortfährst',
        unshareBankAccount: 'Bankkonto-Freigabe aufheben',
        unshareBankAccountDescription:
            'Alle unten aufgeführten Personen haben Zugriff auf dieses Bankkonto. Du kannst den Zugriff jederzeit entziehen. Wir führen trotzdem alle laufenden Zahlungen aus.',
        unshareBankAccountWarning: ({admin}: {admin?: string | null}) =>
            `${admin} wird den Zugriff auf dieses Geschäftskonto verlieren. Wir werden alle laufenden Zahlungen trotzdem abschließen.`,
    ...
    cardPage: {
        ...
        suspiciousBannerDescription: 'Wir haben verdächtige Transaktionen auf Ihrer Karte festgestellt. Tippen Sie unten, um diese zu überprüfen.',
        ...
        validateCardTitle: 'Bestätigen Sie Ihre Identität',
...
${amount} für ${merchant} – ${date}`,
    ...
    workflowsPage: {
        ...
        workflowDescription: 'Konfiguriere einen Workflow ab dem Zeitpunkt der Ausgabe, einschließlich Genehmigung und Bezahlung.',
        ...
        disableApprovalPromptDescription: 'Wenn du Genehmigungen deaktivierst, werden alle bestehenden Genehmigungs-Workflows gelöscht.',
        ...
        makeOrTrackPaymentsDescription: 'Fügen Sie eine autorisierte zahlende Person für Zahlungen in Expensify hinzu oder verfolgen Sie Zahlungen, die anderswo getätigt wurden.',
        customApprovalWorkflowEnabled:
            '<muted-text-label>Für diesen Workspace ist ein benutzerdefinierter Genehmigungs-Workflow aktiviert. Um diesen Workflow zu überprüfen oder zu ändern, wende dich bitte an deine(n) <account-manager-link>Account Manager</account-manager-link> oder an <concierge-link>Concierge</concierge-link>.</muted-text-label>',
        customApprovalWorkflowEnabledConciergeOnly:
            '<muted-text-label>In diesem Workspace ist ein benutzerdefinierter Genehmigungs-Workflow aktiviert. Um diesen Workflow zu überprüfen oder zu ändern, wende dich bitte an <concierge-link>Concierge</concierge-link>.</muted-text-label>',
        editor: {
        ...
        approverInMultipleWorkflows: 'Dieses Mitglied gehört bereits zu einem anderen Genehmigungs-Workflow. Alle Aktualisierungen hier werden sich auch dort auswirken.',
        approverCircularReference: (name1: string, name2: string) =>
            `<strong>${name1}</strong> genehmigt bereits Berichte für <strong>${name2}</strong>. Bitte wähle eine andere genehmigende Person, um einen zirkulären Workflow zu vermeiden.`,
        emptyContent: {
    ...
    workflowsApproverPage: {
        genericErrorMessage: 'Die zu approvierende Person konnte nicht geändert werden. Bitte versuche es erneut oder kontaktiere den Support.',
    ...
    workflowsApprovalLimitPage: {
        ...
        description: ({approverName}: {approverName: string}) =>
            approverName
                ? `Weitere:n Genehmiger:in hinzufügen, wenn <strong>${approverName}</strong> Genehmiger:in ist und der Bericht den untenstehenden Betrag überschreitet:`
        ...
        additionalApproverLabel: 'Zusätzliche Genehmigende',
        skip: 'Überspringen',
        next: 'Weiter',
        ...
        enterBothError: 'Gib einen Berichtsbetrag und eine zusätzliche genehmigende Person ein',
    ...
    workflowsPayerPage: {
        ...
        genericErrorMessage: 'Der autorisierte Zahlungspflichtige konnte nicht geändert werden. Bitte versuche es erneut.',
        admins: 'Admins',
        payer: 'Zahler',
    ...
    reportFraudPage: {
        ...
        description:
            'Wenn Ihre virtuellen Kartendaten gestohlen oder kompromittiert wurden, deaktivieren wir Ihre bestehende Karte dauerhaft und stellen Ihnen eine neue virtuelle Karte mit neuer Kartennummer zur Verfügung.',
    ...
    reportFraudConfirmationPage: {
        ...
        description: 'Wir haben Ihre bestehende Karte dauerhaft deaktiviert. Wenn Sie zurückgehen, um Ihre Kartendetails anzusehen, steht Ihnen eine neue virtuelle Karte zur Verfügung.',
    ...
    getPhysicalCard: {
        ...
        legalLastName: 'Amtlicher Nachname',
    ...
    transferAmountPage: {
        ...
        transferDetailDebitCard: 'Dein Geld sollte sofort eintreffen.',
    ...
    expenseRulesPage: {
        ...
        subtitle: 'Diese Regeln gelten für deine Ausgaben. Wenn du bei einem Workspace einreichst, können dessen Regeln diese außer Kraft setzen.',
        emptyRules: {
            title: 'Sie haben noch keine Regeln erstellt',
            subtitle: 'Füge eine Regel hinzu, um Spesenberichte zu automatisieren.',
        },
        changes: {
            billable: (value: boolean) => `Ausgabe ${value ? 'abrechenbar' : 'nicht abrechenbar'} aktualisieren`,
    ...
    preferencesPage: {
        ...
        receiveRelevantFeatureUpdatesAndExpensifyNews: 'Erhalte relevante Funktionsaktualisierungen und Expensify-News',
        muteAllSounds: 'Alle Expensify-Sounds stummschalten',
    },
    priorityModePage: {
        priorityMode: 'Prioritätsmodus',
        explainerText:
            'Wähle, ob nur ungelesene und angeheftete Chats hervorgehoben werden sollen, oder ob alle Chats angezeigt werden, wobei die neuesten und angehefteten Chats oben stehen.',
        priorityModes: {
            default: {
                label: 'Aktuellste',
                description: 'Alle Chats nach dem Neuesten sortiert anzeigen',
            },
            gsd: {
                label: '#Fokus',
    ...
    reportDetailsPage: {
        ...
        successPDF: 'Dein PDF wurde erstellt! Wenn der Download nicht automatisch gestartet wurde, verwende die Schaltfläche unten.',
    },
    ...
    termsOfUse: {
        terms: `<muted-text-xs>Mit Ihrer Anmeldung stimmen Sie den <a href="${CONST.OLD_DOT_PUBLIC_URLS.TERMS_URL}">Nutzungsbedingungen</a> und der <a href="${CONST.OLD_DOT_PUBLIC_URLS.PRIVACY_URL}">Datenschutzerklärung</a> zu.</muted-text-xs>`,
    ...
    passwordForm: {
        ...
        error: {
            ...
            incorrectLoginOrPassword: 'Benutzername oder Passwort ist falsch. Bitte versuche es erneut.',
            incorrect2fa: 'Falscher Zwei-Faktor-Authentifizierungscode. Bitte versuche es erneut.',
            twoFactorAuthenticationEnabled: 'Für dieses Konto ist die Zwei-Faktor-Authentifizierung aktiviert. Bitte melde dich mit deiner E‑Mail-Adresse oder deiner Telefonnummer an.',
            invalidLoginOrPassword: 'Ungültiger Benutzername oder Passwort. Bitte versuchen Sie es erneut oder setzen Sie Ihr Passwort zurück.',
    ...
    onboarding: {
        ...
        explanationModal: {
            ...
            description: 'Eine App, um geschäftliche und private Ausgaben mit der Geschwindigkeit eines Chats zu verwalten. Probier sie aus und sag uns, was du denkst. Viel mehr folgt!',
        ...
        purpose: {
            ...
            errorBackButton: 'Beantworte bitte die Einrichtungsfragen, um die App verwenden zu können',
            ...
            [CONST.ONBOARDING_CHOICES.CHAT_SPLIT]: 'Chatten und Ausgaben mit Freund:innen teilen',
        ...
        workEmailValidationError: {
            ...
            offline: 'Wir konnten Ihre geschäftliche E-Mail-Adresse nicht hinzufügen, da Sie offenbar offline sind',
        },
        mergeBlockScreen: {
        ...
        tasks: {
            testDriveAdminTask: {
                title: ({testDriveURL}) => `Mach eine[n Probefahrt](${testDriveURL})`,
            ...
            testDriveEmployeeTask: {
                title: ({testDriveURL}) => `Mach eine[n Probefahrt](${testDriveURL})`,
                description: ({testDriveURL}) => `Mach mit uns eine [Probefahrt](${testDriveURL}) und sichere deinem Team *3 kostenlose Monate Expensify!*`,
            },
            addExpenseApprovalsTask: {
                ...
                description: ({workspaceMoreFeaturesLink}) =>
                    dedent(`
                        ...
                        7. Du wirst als Ausgabengenehmiger:in festgelegt. Du kannst das auf beliebige Admins ändern, sobald du dein Team eingeladen hast.

                        [Zu Weitere Funktionen](${workspaceMoreFeaturesLink}).`),
            },
            ...
            setupCategoriesTask: {
                ...
                description: ({workspaceCategoriesLink}) =>
                    dedent(`
                        *Richten Sie Kategorien ein*, damit Ihr Team Ausgaben für eine einfache Berichterstattung kodieren kann.
            ...
            trackExpenseTask: {
                ...
                description: dedent(`
                    *Erfasse eine Ausgabe* in jeder Währung – mit oder ohne Beleg.
...
${
    integrationName && CONST.connectionsVideoPaths[integrationName]
        ...
        : `[Zum Bereich Buchhaltung](${workspaceAccountingLink}).`
            ...
            connectCorporateCardTask: {
                title: ({corporateCardLink}) => `[Firmenkarten verbinden](${corporateCardLink})`,
            ...
            inviteTeamTask: {
                ...
                description: ({workspaceMembersLink}) =>
                    dedent(`
                        *Lade dein Team* zu Expensify ein, damit es noch heute mit der Ausgabenverfolgung starten kann.
                        ...
                        [Zu den Arbeitsbereichsmitgliedern](${workspaceMembersLink}).
            ...
            setupTagsTask: {
                title: ({workspaceTagsLink}) => `[Richtlinien](${workspaceTagsLink}) einrichten`,
                description: ({workspaceMoreFeaturesLink}) =>
                    dedent(`
                        Verwenden Sie Tags, um zusätzliche Ausgabendetails wie Projekte, Kund:innen, Standorte und Abteilungen hinzuzufügen. Wenn Sie mehrere Ebenen von Tags benötigen, können Sie auf den Control‑Tarif upgraden.
                        ...
                        6. Klicken Sie auf *+ Tag hinzufügen*, um Ihre eigenen zu erstellen.
            ...
            inviteAccountantTask: {
                ...
                description: ({workspaceMembersLink}) =>
                    dedent(`
                        *Laden Sie Ihre Steuerberatung ein*, mit Ihnen in Ihrem Workspace zusammenzuarbeiten und Ihre Geschäftsausgaben zu verwalten.

                        1. Klicken Sie auf *Workspaces*.
                        2. Wählen Sie Ihren Workspace aus.
                        3. Klicken Sie auf *Mitglieder*.
                        4. Klicken Sie auf *Mitglied einladen*.
                        5. Geben Sie die E-Mail-Adresse Ihrer Steuerberatung ein.

                        [Jetzt Ihre Steuerberatung einladen](${workspaceMembersLink}).`),
            },
            startChatTask: {
                title: 'Chat starten',
                description: dedent(`
                    *Starte einen Chat* mit beliebigen Personen über deren E‑Mail-Adresse oder Telefonnummer.
            ...
            splitExpenseTask: {
                ...
                description: dedent(`
                    *Ausgaben teilen* mit einer oder mehreren Personen.
                    ...
                    Füge bei Bedarf weitere Details hinzu oder schick sie einfach ab. So bekommst du dein Geld zurück!
                `),
            },
            reviewWorkspaceSettingsTask: {
                title: ({workspaceSettingsLink}) => `Überprüfe deine [Arbeitsbereichseinstellungen](${workspaceSettingsLink})`,
                description: ({workspaceSettingsLink}) =>
                    dedent(`
        ...
        testDrive: {
            name: ({testDriveURL}: {testDriveURL?: string}) => (testDriveURL ? `Mach eine[n Probefahrt](${testDriveURL})` : 'Mach eine Probefahrt'),
            embeddedDemoIframeTitle: 'Probefahrt',
            employeeFakeReceipt: {
                description: 'Mein Kassenbeleg für die Probefahrt!',
            },
        },
        messages: {
            ...
            onboardingManageTeamMessage: ({isOnboardingFlow = false}: {isOnboardingFlow?: boolean}) =>
                isOnboardingFlow
                    ? dedent(`
                        ...
                        👋 Hallo, ich bin deine Expensify-Einrichtungsspezialist:in. Ich habe bereits einen Arbeitsbereich erstellt, um die Belege und Ausgaben deines Teams zu verwalten. Um das Beste aus deiner 30-tägigen kostenlosen Testversion herauszuholen, folge einfach den restlichen Einrichtungsschritten unten!
                    `)
                    : dedent(`
                        # Deine kostenlose Testphase hat begonnen! Lass uns alles einrichten.
                        👋 Hey, ich bin deine Expensify-Einrichtungsspezialist*in. Jetzt, wo du einen Workspace erstellt hast, nutze deine 30-tägige kostenlose Testphase optimal, indem du die folgenden Schritte befolgst!
                    `),
            onboardingTrackWorkspaceMessage:
                '# Lass uns dein Konto einrichten\n👋 Hallo, ich bin deine Expensify-Einrichtungsexpertin. Ich habe bereits einen Workspace erstellt, damit du deine Belege und Ausgaben verwalten kannst. Um das Beste aus deiner 30-tägigen kostenlosen Testphase herauszuholen, folge einfach den verbleibenden Einrichtungsschritten unten!',
            onboardingChatSplitMessage: 'Rechnungen mit Freund:innen zu teilen ist so einfach wie das Senden einer Nachricht. So geht’s.',
            onboardingAdminMessage: 'Erfahren Sie, wie Sie als Administrator:in den Workspace Ihres Teams verwalten und Ihre eigenen Ausgaben einreichen.',
            onboardingLookingAroundMessage:
                'Expensify ist vor allem für Ausgaben, Reisen und die Verwaltung von Firmenkarten bekannt, aber wir können noch viel mehr. Sag mir einfach, was dich interessiert, und ich helfe dir beim Einstieg.',
            onboardingTestDriveReceiverMessage: '*Du hast 3 Monate kostenlos! Leg unten los.*',
        },
        workspace: {
            title: 'Bleib mit einem Workspace organisiert',
            subtitle: 'Schalte leistungsstarke Tools frei, um dein Spesenmanagement zu vereinfachen – alles an einem Ort. Mit einem Workspace kannst du:',
            explanationModal: {
        ...
        confirmWorkspace: {
            ...
            subtitle:
                'Erstelle einen Workspace, um Belege zu erfassen, Ausgaben zu erstatten, Reisen zu verwalten, Berichte zu erstellen und mehr – alles mit der Geschwindigkeit eines Chats.',
        },
        inviteMembers: {
            title: 'Mitglieder einladen',
            subtitle: 'Füge dein Team hinzu oder lade deine Steuerberaterin bzw. deinen Steuerberater ein. Je mehr, desto besser!',
        },
    },
    featureTraining: {
    ...
    privatePersonalDetails: {
        ...
        enterPhoneNumber: 'Wie ist deine Telefonnummer?',
    ...
    unlinkLoginForm: {
        toValidateLogin: ({primaryLogin, secondaryLogin}: ToValidateLoginParams) =>
            `Um ${secondaryLogin} zu bestätigen, sende bitte den magischen Code erneut aus den Kontoeinstellungen von ${primaryLogin}.`,
        ...
        successfullyUnlinkedLogin: 'Sekundärer Login wurde erfolgreich getrennt!',
    },
    ...
    smsDeliveryFailurePage: {
        smsDeliveryFailureMessage: ({login}: OurEmailProviderParams) =>
            `Wir konnten keine SMS-Nachrichten an ${login} zustellen, daher wurde diese Nummer vorübergehend deaktiviert. Bitte versuche, deine Nummer zu bestätigen:`,
    ...
    errorPage: {
        ...
        wrongTypeSubtitle: 'Diese Suche ist ungültig. Bitte passe deine Suchkriterien an.',
    },
    statusPage: {
        status: 'Status',
        statusExplanation: 'Füge ein Emoji hinzu, damit deine Kolleg:innen und Freund:innen leicht sehen, was los ist. Optional kannst du auch eine Nachricht hinzufügen!',
        today: 'Heute',
    ...
    bankAccount: {
        ...
        thisBankAccount: 'Dieses Bankkonto wird für Geschäftszahlungen in deinem Workspace verwendet werden',
        ...
        toGetStarted: 'Füge ein Bankkonto hinzu, um Ausgaben zu erstatten, Expensify Cards auszugeben, Rechnungszahlungen zu empfangen und Rechnungen zentral von einem Ort aus zu bezahlen.',
        plaidBodyCopy: 'Gib deinen Mitarbeitenden eine einfachere Möglichkeit, Firmenausgaben zu bezahlen – und das Geld dafür zurückzubekommen.',
        checkHelpLine: 'Ihre Bankleitzahl und Ihre Kontonummer finden Sie auf einem Scheck für dieses Konto.',
        hasPhoneLoginError: (contactMethodRoute: string) =>
            `Um ein Bankkonto zu verknüpfen, bitte <a href="${contactMethodRoute}">füge eine E‑Mail als deinen primären Login hinzu</a> und versuche es erneut. Du kannst deine Telefonnummer als sekundären Login hinzufügen.`,
        ...
        error: {
            youNeedToSelectAnOption: 'Bitte wähle eine Option, um fortzufahren',
            ...
            industryCode: 'Bitte gib einen gültigen Branchencode mit sechs Ziffern ein',
    ...
    addPersonalBankAccount: {
        ...
        confirmationStepSubHeader: 'Überprüfe die Details unten noch einmal und markiere das Kontrollkästchen für die Bedingungen, um zu bestätigen.',
        toGetStarted: 'Füge ein privates Bankkonto hinzu, um Rückerstattungen zu erhalten, Rechnungen zu bezahlen oder die Expensify Wallet zu aktivieren.',
    },
    ...
    onfidoStep: {
        acceptTerms: 'Wenn Sie mit der Anfrage zur Aktivierung Ihrer Expensify Wallet fortfahren, bestätigen Sie, dass Sie Folgendes gelesen, verstanden und akzeptiert haben:',
        ...
        letsVerifyIdentity: 'Bestätigen wir Ihre Identität',
        ...
        microphoneRequestMessage:
            'Wir benötigen Zugriff auf Ihr Mikrofon, um die Verifizierung Ihres Bankkontos abzuschließen. Bitte aktivieren Sie dies über Einstellungen > New Expensify.',
        originalDocumentNeeded: 'Bitte laden Sie ein Originalfoto Ihres Ausweises hoch, keine Bildschirmfotos oder eingescannten Bilder.',
    ...
    additionalDetailsStep: {
        ...
        helpTextIdologyQuestions: 'Wir müssen Ihnen nur noch ein paar weitere Fragen stellen, um Ihre Identität abschließend zu bestätigen.',
        helpLink: 'Erfahre mehr darüber, warum wir das benötigen.',
        legalFirstNameLabel: 'Amtlicher Vorname',
        legalMiddleNameLabel: 'Amtlicher zweiter Vorname',
        legalLastNameLabel: 'Amtlicher Nachname',
    ...
    termsStep: {
        ...
        shortTermsForm: {
            ...
            weChargeOneFee: 'Wir berechnen 1 weitere Art von Gebühr. Diese ist:',
            ...
            electronicFundsWithdrawalInstant: 'Elektronische Kontobelastung (sofort)',
        ...
        longTermsForm: {
            ...
            sendingFundsTitle: 'Geld an eine*n anderen Kontoinhaber*in senden',
            ...
            electronicFundsInstantDetails: (percentage: string, amount: string) =>
                'Für die Überweisung von Guthaben aus deinem Expensify Wallet auf die verknüpfte Debitkarte mit der Option „Sofortüberweisung“ fällt eine Gebühr an. Diese Überweisung wird in der Regel innerhalb weniger Minuten abgeschlossen.' +
                `Die Gebühr beträgt ${percentage}% des Überweisungsbetrags (mit einer Mindestgebühr von ${amount}).`,
            fdicInsuranceBancorp: ({amount}: TermsParams) =>
                `Ihre Gelder sind für eine FDIC-Versicherung berechtigt. Ihre Gelder werden bei oder an ${CONST.WALLET.PROGRAM_ISSUERS.BANCORP_BANK}, einem von der FDIC versicherten Institut, gehalten oder übertragen.` +
                `Sobald sie dort sind, sind Ihre Gelder im Falle eines Ausfalls von ${CONST.WALLET.PROGRAM_ISSUERS.BANCORP_BANK} durch die FDIC bis zu ${amount} versichert, sofern bestimmte Einlagensicherungsanforderungen erfüllt sind und Ihre Karte registriert ist. Weitere Details finden Sie in ${CONST.TERMS.FDIC_PREPAID}.`,
    ...
    companyStep: {
        ...
        industryClassification: 'Unter welcher Branche wird das Unternehmen geführt?',
        industryClassificationCodePlaceholder: 'Nach Brancheklassifizierungscode suchen',
    },
    requestorStep: {
    ...
    businessInfoStep: {
        ...
        listOfRestrictedBusinesses: 'Liste eingeschränkter Unternehmen',
        confirmCompanyIsNot: 'Ich bestätige, dass dieses Unternehmen nicht auf der',
        businessInfoTitle: 'Geschäftliche Informationen',
        legalBusinessName: 'Offizieller Firmenname',
        ...
        whatsTheBusinessTaxIDEIN: (country: string) => {
            switch (country) {
                ...
                case CONST.COUNTRY.CA:
                    return 'Was ist die Betriebsnummer (BN)?';
                case CONST.COUNTRY.GB:
        ...
        selectIncorporationType: 'Wähle die Rechtsform aus',
        ...
        findAverageReimbursement: 'Durchschnittliche Erstattungsbetrag ermitteln',
    ...
    beneficialOwnerInfoStep: {
        ...
        doAnyIndividualOwn25percent: (companyName: string) => `Halten Einzelpersonen 25 % oder mehr von ${companyName}?`,
        ...
        enterLegalFirstAndLastName: 'Wie lautet der gesetzliche Name der Inhaberperson?',
        legalFirstName: 'Amtlicher Vorname',
        legalLastName: 'Amtlicher Nachname',
        enterTheDateOfBirthOfTheOwner: 'Wie ist das Geburtsdatum des Inhabers?',
    ...
    ownershipInfoStep: {
        ownerInfo: 'Eigentümerinfo',
        businessOwner: 'Unternehmensinhaber',
        signerInfo: 'Unterzeichner-Infos',
        doYouOwn: (companyName: string) => `Besitzen Sie 25 % oder mehr von ${companyName}?`,
        doesAnyoneOwn: (companyName: string) => `Halten Einzelpersonen 25 % oder mehr von ${companyName}?`,
        ...
        legalFirstName: 'Amtlicher Vorname',
        legalLastName: 'Amtlicher Nachname',
        whatsTheOwnersName: 'Wie lautet der gesetzliche Name der Inhaberperson?',
        ...
        ownership: 'Eigentum',
        whatsTheOwnersDOB: 'Wie ist das Geburtsdatum des Inhabers?',
        whatsYourDOB: 'Was ist dein Geburtsdatum?',
        whatsTheOwnersAddress: 'Wie lautet die Adresse des Eigentümers?',
        whatsYourAddress: 'Wie lautet deine Adresse?',
        whatAreTheLast: 'Wie lauten die letzten 4 Ziffern der Sozialversicherungsnummer des Kontoinhabers?',
        ...
        regulationRequiresChart:
            'Vorschriften verpflichten uns, eine beglaubigte Kopie des Beteiligungsdiagramms einzuholen, das alle Personen oder juristischen Einheiten ausweist, die 25 % oder mehr des Unternehmens besitzen.',
        uploadEntity: 'Organigramm der Eigentumsverhältnisse hochladen',
        noteEntity:
            'Hinweis: Das Diagramm zur Eigentümerstruktur der Gesellschaft muss von Ihrer Steuerberaterin/Ihrem Steuerberater, Ihrer Rechtsberaterin/Ihrem Rechtsberater unterzeichnet oder notariell beglaubigt werden.',
        certified: 'Bestätigtes Beteiligungsdiagramm',
        ...
        pleaseUpload:
            'Bitte laden Sie unten zusätzliche Unterlagen hoch, damit wir Ihre Identität als direkte(n) oder indirekte(n) Eigentümer(in) von 25 % oder mehr der Geschäftseinheit überprüfen können.',
        ...
        proofOfBeneficialOwnerDescription:
            'Bitte legen Sie eine unterzeichnete Bescheinigung und ein Organigramm eines Wirtschaftsprüfers, Notars oder Rechtsanwalts vor, die den Besitz von 25 % oder mehr des Unternehmens bestätigen. Diese müssen innerhalb der letzten drei Monate datiert sein und die Zulassungsnummer der unterzeichnenden Person enthalten.',
    ...
    completeVerificationStep: {
        ...
        isAuthorizedToUseBankAccountError: 'Sie müssen ein vertretungsberechtigtes geschäftsführendes Organ mit Vollmacht zur Führung des Geschäftskontos sein',
        termsAndConditions: 'Allgemeine Geschäftsbedingungen',
    },
    connectBankAccountStep: {
        validateYourBankAccount: 'Bestätige dein Bankkonto',
        validateButtonText: 'Bestätigen',
    ...
    countryStep: {
        ...
        youCanChange: 'Du kannst die Währung deines Arbeitsbereichs in deinen Einstellungen ändern',
        findCountry: 'Land finden',
        selectCountry: 'Land auswählen',
    },
    bankInfoStep: {
    ...
    signerInfoStep: {
        ...
        regulationRequiresOneMoreDirector: 'Die Vorschriften verlangen mindestens eine weitere:n Direktor:in als Unterzeichner:in.',
        ...
        chooseFile: 'Datei auswählen',
        weAreWaiting: 'Wir warten darauf, dass andere ihre Identität als Geschäftsführer des Unternehmens verifizieren.',
        id: 'Kopie des Ausweises',
        proofOfDirectors: 'Nachweis der Geschäftsführer',
        ...
        PDSandFSGDescription: dedent(`
            Unsere Partnerschaft mit Corpay nutzt eine API-Verbindung, um deren umfangreiches Netzwerk internationaler Bankpartner zu verwenden und so globale Erstattungen in Expensify zu ermöglichen. Gemäß den australischen Vorschriften stellen wir Ihnen den Financial Services Guide (FSG) und das Product Disclosure Statement (PDS) von Corpay zur Verfügung.
        ...
        isConnecting: ({bankAccountLastFour, currency}: SignerInfoMessageParams) =>
            `verbindet ein ${currency}-Geschäftsbankkonto mit der Endung ${bankAccountLastFour} mit Expensify, um Mitarbeitende in ${currency} zu bezahlen. Der nächste Schritt erfordert Zeichnungsberechtigungsinformationen von einer Geschäftsführungsperson.`,
        error: {
    ...
    agreementsStep: {
        ...
        iAmAuthorized: 'Ich bin berechtigt, das Geschäftskonto für geschäftliche Ausgaben zu verwenden.',
        ...
        iConsentToThePrivacyNoticeAccessibility: 'Ich willige in die Datenschutzrichtlinie ein.',
        error: {
            authorized: 'Sie müssen ein vertretungsberechtigtes geschäftsführendes Organ mit Vollmacht zur Führung des Geschäftskontos sein',
    ...
    docusignStep: {
        ...
        pleaseComplete:
            'Bitte füllen Sie das ACH-Autorisierungsformular über den untenstehenden Docusign-Link aus und laden Sie die unterzeichnete Kopie anschließend hier hoch, damit wir Gelder direkt von Ihrem Bankkonto einziehen können.',
        pleaseCompleteTheBusinessAccount: 'Bitte füllen Sie den Antrag auf ein Geschäftskonto für das Lastschriftverfahren aus',
        pleaseCompleteTheDirect:
            'Bitte füllen Sie die Lastschriftvereinbarung über den untenstehenden DocuSign-Link aus und laden Sie die unterzeichnete Kopie anschließend hier hoch, damit wir Beträge direkt von Ihrem Bankkonto einziehen können.',
    ...
    finishStep: {
        ...
        thanksFor:
            'Danke für diese Angaben. Eine*eigens zugewiesene*r Support-Mitarbeitende*r wird Ihre Informationen nun prüfen. Wir melden uns erneut, falls wir noch etwas von Ihnen benötigen. In der Zwischenzeit können Sie sich bei Fragen jederzeit gerne an uns wenden.',
    ...
    reimbursementAccountLoadingAnimation: {
        ...
        explanationLine: 'Wir prüfen gerade deine Angaben. Du kannst in Kürze mit den nächsten Schritten fortfahren.',
    },
    session: {
    ...
    travel: {
        ...
        flightDetails: {
            passenger: 'Passagier',
            layover: (layover: string) => `<muted-text-label>Du hast einen <strong>${layover} Zwischenstopp</strong> vor diesem Flug</muted-text-label>`,
            takeOff: 'Start',
            landing: 'Landung',
            seat: 'Sitz',
            class: 'Kabinenklasse',
        ...
        phoneError: ({phoneErrorMethodsRoute}: PhoneErrorRouteParams) =>
            `<rbr>Bitte <a href="${phoneErrorMethodsRoute}">füge eine geschäftliche E-Mail-Adresse als primären Login hinzu</a>, um Reisen zu buchen.</rbr>`,
        domainSelector: {
            title: 'Domain',
        ...
        domainPermissionInfo: {
            ...
            accountantInvitation: `Wenn Sie Buchhalter:in sind, treten Sie dem <a href="${CONST.OLD_DOT_PUBLIC_URLS.EXPENSIFY_APPROVED_PROGRAM_URL}">ExpensifyApproved!-Buchhalterprogramm</a> bei, um Reisen für diese Domain zu aktivieren.`,
        },
        publicDomainError: {
            title: 'Loslegen mit Expensify Travel',
            message: `Du musst bei Expensify Travel deine geschäftliche E-Mail-Adresse (z. B. name@company.com) verwenden, nicht deine private E-Mail-Adresse (z. B. name@gmail.com).`,
        },
        blockedFeatureModal: {
            title: 'Expensify Travel wurde deaktiviert',
            message: `Ihre*e Admin* hat Expensify Travel deaktiviert. Bitte halten Sie sich für Ihre Reisebuchungen an die Reiserichtlinie Ihres Unternehmens.`,
        },
        verifyCompany: {
            title: 'Wir prüfen Ihre Anfrage …',
            message: `Wir führen ein paar Überprüfungen durch, um sicherzustellen, dass Ihr Konto für Expensify Travel bereit ist. Wir melden uns in Kürze bei Ihnen!`,
            confirmText: 'Verstanden',
            conciergeMessage: ({domain}: {domain: string}) =>
                `Aktivierung von Reisen ist für die Domain ${domain} fehlgeschlagen. Bitte überprüfen Sie diese Domain und aktivieren Sie Reisen dafür.`,
        },
        updates: {
            ...
            flightScheduleChangePending: (airlineCode: string) => `Die Fluggesellschaft hat eine Flugplanänderung für Flug ${airlineCode} vorgeschlagen; wir warten auf eine Bestätigung.`,
            ...
            flightCabinChanged: (airlineCode: string, cabinClass?: string) => `Ihre Reiseklasse wurde auf dem Flug ${airlineCode} auf ${cabinClass} aktualisiert.`,
            ...
            railTicketRefund: ({origin, destination, startDate}: RailTicketParams) =>
                `Dein Zugticket von ${origin} nach ${destination} am ${startDate} wurde erstattet. Eine Gutschrift wird veranlasst.`,
    ...
    workspace: {
        common: {
            ...
            defaultNote: `An Belege, die an ${CONST.EMAIL.RECEIPTS} gesendet werden, erscheinen in diesem Workspace.`,
            ...
            memberNotFound: 'Mitglied nicht gefunden. Um ein neues Mitglied in den Arbeitsbereich einzuladen, verwende bitte die Einladen-Schaltfläche oben.',
            notAuthorized: `Du hast keinen Zugriff auf diese Seite. Wenn du versuchst, diesem Workspace beizutreten, bitte einfach die Workspace-Inhaber*in, dich als Mitglied hinzuzufügen. Etwas anderes? Wende dich an ${CONST.EMAIL.CONCIERGE}.`,
            goToWorkspace: 'Zum Workspace',
            duplicateWorkspace: 'Arbeitsbereich duplizieren',
            duplicateWorkspacePrefix: 'Duplizieren',
            goToWorkspaces: 'Zu den Arbeitsbereichen',
            clearFilter: 'Filter zurücksetzen',
            workspaceName: 'Workspace-Name',
            workspaceOwner: 'Eigentümer',
            workspaceType: 'Arbeitsbereichstyp',
            workspaceAvatar: 'Workspace-Avatar',
            mustBeOnlineToViewMembers: 'Du musst online sein, um die Mitglieder dieses Workspace anzusehen.',
            moreFeatures: 'Mehr Funktionen',
            requested: 'Angefordert',
            distanceRates: 'Entfernungssätze',
            defaultDescription: 'Ein Ort für alle deine Belege und Ausgaben.',
            ...
            shareNote: {
                header: 'Gib deinen Arbeitsbereich für andere Mitglieder frei',
                content: ({adminsRoomLink}: WorkspaceShareNoteParams) =>
                    `Teile diesen QR-Code oder kopiere den Link unten, damit Mitglieder ganz einfach Zugriff auf deinen Arbeitsbereich anfragen können. Alle Anfragen zum Beitritt zum Arbeitsbereich erscheinen zur Überprüfung im Raum <a href="${adminsRoomLink}">${CONST.REPORT.WORKSPACE_CHAT_ROOMS.ADMINS}</a>.`,
            },
            ...
            youCantDowngradeInvoicing:
                'Sie können Ihren Tarif bei einem fakturierten Abonnement nicht herabstufen. Um Ihre Abonnementdetails zu besprechen oder zu ändern, wenden Sie sich an Ihre*n Account Manager*in oder an Concierge, um Hilfe zu erhalten.',
            ...
            deepDiveExpensifyCard: `<muted-text-label>Expensify Card-Transaktionen werden automatisch in ein „Expensify Card-Verbindlichkeitskonto“ exportiert, das mit <a href="${CONST.DEEP_DIVE_EXPENSIFY_CARD}">unserer Integration</a> erstellt wird.</muted-text-label>`,
        },
        receiptPartners: {
            uber: {
                subtitle: ({organizationName}: ReceiptPartnersUberSubtitleParams) =>
                    organizationName ? `Verbunden mit ${organizationName}` : 'Automatisieren Sie Reise- und Essenslieferungsspesen in Ihrem gesamten Unternehmen.',
                ...
                emptyContent: {
                    ...
                    subtitle: 'Juchhu! Wir haben alles abgesucht und keine offenen Einladungen gefunden.',
                },
            },
        },
        perDiem: {
            subtitle: `<muted-text>Tagessätze festlegen, um die täglichen Ausgaben der Mitarbeitenden zu steuern. <a href="${CONST.DEEP_DIVE_PER_DIEM}">Mehr erfahren</a>.</muted-text>`,
            amount: 'Betrag',
            deleteRates: () => ({
                one: 'Satz löschen',
                other: 'Sätze löschen',
            ...
            emptyList: {
                ...
                subtitle: 'Tagespauschalen festlegen, um die täglichen Ausgaben von Mitarbeitenden zu steuern. Importiere zum Start die Sätze aus einer Tabellenkalkulation.',
            },
            importPerDiemRates: 'Tagespauschalen importieren',
            editPerDiemRate: 'Tagessatz bearbeiten',
            editPerDiemRates: 'Tagessätze bearbeiten',
            editDestinationSubtitle: (destination: string) => `Die Aktualisierung dieses Ziels ändert es für alle Tagegeld-Teilbeträge von ${destination}.`,
            editCurrencySubtitle: (destination: string) => `Wenn du diese Währung aktualisierst, wird sie für alle ${destination}-Tagegeld-Teilbeträge geändert.`,
        },
        qbd: {
            ...
            exportVendorBillDescription:
                'Wir erstellen für jeden Expensify-Bericht eine aufgeschlüsselte Lieferantenrechnung und fügen sie dem untenstehenden Konto hinzu. Wenn dieser Zeitraum geschlossen ist, buchen wir auf den 1. Tag des nächsten offenen Zeitraums.',
            outOfPocketTaxEnabledDescription:
                'QuickBooks Desktop unterstützt keine Steuern beim Export von Buchungsjournaleinträgen. Da in deinem Workspace Steuern aktiviert sind, ist diese Exportoption nicht verfügbar.',
            ...
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}Description`]:
                    'Wir gleichen den Händlernamen der Kreditkartentransaktion automatisch mit den entsprechenden Lieferanten in QuickBooks ab. Wenn keine Lieferanten vorhanden sind, erstellen wir einen „Credit Card Misc.“-Lieferanten zur Verknüpfung.',
                [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}Description`]:
                    'Wir erstellen für jeden Expensify-Bericht eine detaillierte Kreditorenrechnung mit dem Datum der letzten Ausgabe und fügen sie dem untenstehenden Konto hinzu. Falls dieser Zeitraum abgeschlossen ist, buchen wir auf den 1. des nächsten offenen Zeitraums.',
                [`${CONST.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}AccountDescription`]: 'Wähle aus, wohin Kreditkartentransaktionen exportiert werden sollen.',
            ...
            requiredSetupDevice: {
                title: 'Von diesem Gerät keine Verbindung möglich',
            ...
            importDescription: 'Wähle aus, welche Codierungskonfigurationen aus QuickBooks Desktop nach Expensify importiert werden sollen.',
            classes: 'Klassen',
            items: 'Posten',
            ...
            customersDescription: 'Wähle aus, wie QuickBooks Desktop-Kunden/Projekte in Expensify behandelt werden sollen.',
            advancedConfig: {
            ...
            itemsDescription: 'Wähle aus, wie QuickBooks Desktop-Posten in Expensify behandelt werden sollen.',
            accountingMethods: {
        ...
        qbo: {
            ...
            accountsSwitchTitle: 'Wählen Sie, ob neue Konten als aktivierte oder deaktivierte Kategorien importiert werden sollen.',
            accountsSwitchDescription: 'Aktivierte Kategorien stehen Mitgliedern zur Auswahl, wenn sie ihre Ausgaben erstellen.',
            classesDescription: 'Wähle aus, wie QuickBooks Online-Klassen in Expensify gehandhabt werden sollen.',
            ...
            locationsLineItemsRestrictionDescription:
                'QuickBooks Online unterstützt keine Standorte auf Zeilenebene für Schecks oder Kreditorenrechnungen. Wenn du Standorte auf Zeilenebene verwenden möchtest, stelle sicher, dass du Buchungssätze und Kredit-/Debitkartenausgaben verwendest.',
            taxesJournalEntrySwitchNote: 'QuickBooks Online unterstützt keine Steuern in Journalbuchungen. Bitte ändere deine Exportoption auf Lieferantenrechnung oder Scheck.',
            ...
            exportCompanyCardsDescription: 'Legen Sie fest, wie Käufe mit Firmenkarten nach QuickBooks Online exportiert werden.',
            vendor: 'Lieferant',
            defaultVendorDescription: 'Legen Sie einen Standardanbieter fest, der beim Export auf alle Kreditkartentransaktionen angewendet wird.',
            ...
            companyCardsLocationEnabledDescription:
                'QuickBooks Online unterstützt keine Standorte beim Export von Eingangsrechnungen. Da Sie Standorte in Ihrem Workspace aktiviert haben, ist diese Exportoption nicht verfügbar.',
            outOfPocketTaxEnabledDescription:
                'QuickBooks Online unterstützt keine Steuern bei Exporten von Buchungsjournalen. Da in Ihrem Arbeitsbereich Steuern aktiviert sind, ist diese Exportoption nicht verfügbar.',
            outOfPocketTaxEnabledError: 'Buchungssätze sind nicht verfügbar, wenn Steuern aktiviert sind. Bitte wähle eine andere Exportoption.',
            advancedConfig: {
                ...
                createEntitiesDescription:
                    'Expensify legt in QuickBooks Online automatisch Lieferanten an, wenn sie noch nicht vorhanden sind, und erstellt beim Export von Rechnungen automatisch Kunden.',
                ...
                qboInvoiceCollectionAccount: 'QuickBooks-Konto für Rechnungseinzüge',
                ...
                invoiceAccountSelectorDescription: 'Wählen Sie, wohin Rechnungzahlungen empfangen werden sollen, und wir erstellen die Zahlung in QuickBooks Online.',
            },
            accounts: {
                ...
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}Description`]:
                    'Wir ordnen den Händlernamen der Debitkartentransaktion automatisch den entsprechenden Lieferanten in QuickBooks zu. Falls keine Lieferanten vorhanden sind, erstellen wir einen Lieferanten „Debit Card Misc.“ für die Zuordnung.',
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}Description`]:
                    'Wir gleichen den Händlernamen der Kreditkartentransaktion automatisch mit den entsprechenden Lieferanten in QuickBooks ab. Wenn keine Lieferanten vorhanden sind, erstellen wir einen „Credit Card Misc.“-Lieferanten zur Verknüpfung.',
                [`${CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL}Description`]:
                    'Wir erstellen für jeden Expensify-Bericht eine detaillierte Kreditorenrechnung mit dem Datum der letzten Ausgabe und fügen sie dem untenstehenden Konto hinzu. Falls dieser Zeitraum abgeschlossen ist, buchen wir auf den 1. des nächsten offenen Zeitraums.',
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]: 'Wähle aus, wohin die Debitkartentransaktionen exportiert werden sollen.',
                [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD}AccountDescription`]: 'Wähle aus, wohin Kreditkartentransaktionen exportiert werden sollen.',
            ...
            exportDestinationAccountsMisconfigurationError: {
                ...
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: 'Wähle ein gültiges Konto für den Export der Buchungsjournale aus',
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]: 'Wähle ein gültiges Konto für den Scheckexport aus',
            },
            exportDestinationSetupAccountsInfo: {
                ...
                [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]: 'Um den Export von Journalbuchungen zu verwenden, richte ein Journalbuchungskonto in QuickBooks Online ein',
        ...
        xero: {
            ...
            customersDescription:
                'Wähle, ob Kund:innen in Expensify weiterverrechnet werden sollen. Deine Xero-Kundenkontakte können Ausgaben zugewiesen werden und werden als Verkaufsrechnung nach Xero exportiert.',
            ...
            advancedConfig: {
                ...
                xeroBillPaymentAccountDescription: 'Wählen Sie aus, von wo Rechnungen bezahlt werden sollen, und wir erstellen die Zahlung in Xero.',
        ...
        sageIntacct: {
            ...
            defaultVendorDescription: (isReimbursable: boolean) =>
                `Legen Sie einen Standardlieferanten fest, der auf ${isReimbursable ? '' : 'nicht-'}erstattungsfähige Ausgaben angewendet wird, die in Sage Intacct keinen passenden Lieferanten haben.`,
            exportDescription: 'Konfigurieren Sie, wie Expensify-Daten nach Sage Intacct exportiert werden.',
            exportPreferredExporterNote:
                'Der bevorzugte Exporteur kann jede Workspace-Adminperson sein, muss aber auch Domain-Admin sein, wenn du in den Domaineinstellungen unterschiedliche Exportkonten für einzelne Firmenkarten festlegst.',
            exportPreferredExporterSubNote: 'Sobald festgelegt, sieht der bevorzugte Exporteur in seinem Konto die Berichte zum Export.',
            noAccountsFound: 'Keine Konten gefunden',
            ...
            inviteEmployeesDescription:
                'Importiere Sage-Intacct-Mitarbeiterdatensätze und lade Mitarbeitende in diesen Workspace ein. Dein Genehmigungsworkflow wird standardmäßig auf Managergenehmigung gesetzt und kann auf der Seite „Mitglieder“ weiter konfiguriert werden.',
        ...
        netsuite: {
            ...
            subsidiarySelectDescription: 'Wähle die Tochtergesellschaft in NetSuite aus, von der du Daten importieren möchtest.',
            exportDescription: 'Konfiguriere, wie Expensify-Daten nach NetSuite exportiert werden.',
            exportInvoices: 'Rechnungen exportieren nach',
            journalEntriesTaxPostingAccount: 'Steuerbuchungskonto für Buchungsjournale',
            journalEntriesProvTaxPostingAccount: 'Journalbuchungen: Buchungskonto für Provinzsteuer',
            ...
            invoiceItem: {
                ...
                values: {
                    [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
                        ...
                        description: 'Wir erstellen bei der Exportierung eine „Expensify-Rechnungsposition“ für dich (falls noch keine vorhanden ist).',
                    },
            ...
            exportDestination: {
                values: {
                    [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
                        ...
                        reimbursableDescription: 'Auslagen aus eigener Tasche werden als Spesenabrechnungen nach NetSuite exportiert.',
                        nonReimbursableDescription: 'Spesen von Firmenkarten werden als Spesenberichte nach NetSuite exportiert.',
                    },
                    [CONST.NETSUITE_EXPORT_DESTINATION.VENDOR_BILL]: {
                        ...
                        nonReimbursableDescription: dedent(`
                            Ausgaben der Firmenkarten werden als Rechnungen exportiert, die an den unten angegebenen NetSuite-Lieferanten zahlbar sind.

                            Wenn du für jede Karte einen eigenen Lieferanten festlegen möchtest, gehe zu *Einstellungen > Domains > Firmenkarten*.
                        `),
                    },
                    [CONST.NETSUITE_EXPORT_DESTINATION.JOURNAL_ENTRY]: {
                        label: 'Buchungsjournale',
                        reimbursableDescription: dedent(`
                            Auslagen aus eigener Tasche werden als Buchungszeilen in das unten angegebene NetSuite-Konto exportiert.

                            Wenn du für jede Karte einen bestimmten Lieferanten festlegen möchtest, gehe zu *Einstellungen > Domains > Firmenkarten*.
                        `),
                        nonReimbursableDescription: dedent(`
                            Firmkarten-Ausgaben werden als Buchungszeilen in das unten angegebene NetSuite-Konto exportiert.

                            Wenn du für jede Karte einen bestimmten Kreditor festlegen möchtest, gehe zu *Einstellungen > Domänen > Firmenkarten*.
                        `),
                    },
                },
            ...
            advancedConfig: {
                ...
                reimbursementsAccountDescription: 'Wähle das Bankkonto, das du für Erstattungen verwenden möchtest, und wir erstellen die zugehörige Zahlung in NetSuite.',
                ...
                exportReportsTo: {
                    ...
                    values: {
                        ...
                        [CONST.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH]: 'Vorgesetzte*r und Buchhaltung haben genehmigt',
                    },
                },
                accountingMethods: {
                    label: 'Zeitpunkt des Exports',
                ...
                exportVendorBillsTo: {
                    ...
                    description:
                        'Sobald eine Kreditorenrechnung in Expensify genehmigt und nach NetSuite exportiert wurde, können Sie in NetSuite vor der Verbuchung eine zusätzliche Genehmigungsstufe festlegen.',
                    values: {
                ...
                exportJournalsTo: {
                    label: 'Buchungsfreigabeebene',
                    description:
                        'Sobald ein Buchungssatz in Expensify genehmigt und nach NetSuite exportiert wurde, können Sie in NetSuite vor der Verbuchung eine zusätzliche Genehmigungsstufe festlegen.',
                    values: {
            ...
            tokenInput: {
                ...
                formSteps: {
                    ...
                    enableTokenAuthentication: {
                        ...
                        description: 'Wechsle in NetSuite zu *Setup > Company > Enable Features > SuiteCloud* und aktiviere *token-based authentication*.',
                    },
                    enableSoapServices: {
                    ...
                    enterCredentials: {
                        ...
                        netSuiteAccountIDDescription: 'Wechsle in NetSuite zu *Setup > Integration > SOAP Web Services Preferences*.',
                    },
                },
            },
            import: {
                ...
                importFields: {
                    ...
                    locations: {
                        title: 'Standorte',
                        subtitle: 'Wähle, wie *Standorte* in Expensify behandelt werden sollen.',
                    },
                },
                customersOrJobs: {
                ...
                importCustomFields: {
                    ...
                    customSegments: {
                        ...
                        removePrompt: 'Sind Sie sicher, dass Sie dieses benutzerdefinierte Segment/den benutzerdefinierten Eintrag entfernen möchten?',
                        addForm: {
                            customSegmentName: 'benutzerdefinierter Segmentname',
                            customRecordName: 'Benutzerdefinierter Satzname',
                            ...
                            recordTitle: 'Benutzerdefinierter Eintrag',
...
_Für ausführlichere Anweisungen [besuchen Sie unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                            ...
                            customSegmentInternalIDFooter: `Stelle zuerst sicher, dass du die internen IDs in NetSuite unter *Home > Set Preferences > Show Internal ID* aktiviert hast.
...
_Für detailliertere Anweisungen [besuche unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
                            customRecordInternalIDFooter: `Sie finden die internen IDs benutzerdefinierter Datensätze in NetSuite, indem Sie folgende Schritte ausführen:
...
_Für detailliertere Anweisungen [besuchen Sie unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})._`,
                            ...
                            customSegmentScriptIDFooter: `Benutzerdefinierte Segment-Skript-IDs finden Sie in NetSuite unter:
...
3. Suche die Skript-ID auf der linken Seite.
...
_Für detailliertere Anweisungen [besuche unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})_.`,
                    ...
                    customLists: {
                        ...
                        addForm: {
                            ...
                            transactionFieldIDFooter: `Sie finden Transaktionsfeld-IDs in NetSuite, indem Sie folgende Schritte ausführen:
...
_Für detailliertere Anweisungen [besuchen Sie unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})._`,
                ...
                importTypes: {
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]: {
                        ...
                        footerContent: (importField: string) =>
                            `Wenn Sie ${importField} in NetSuite verwenden, wenden wir beim Export in den Spesenbericht oder den Buchungssatz den im Mitarbeiterdatensatz festgelegten Standardwert an.`,
                    },
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
                        label: 'Stichwörter',
                        description: 'Positionsebene',
                        footerContent: (importField: string) => `${startCase(importField)} kann für jede einzelne Ausgabe in dem Bericht eines Mitarbeiters ausgewählt werden.`,
                    },
                    [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
                        label: 'Berichtsfelder',
                        description: 'Berichtsebene',
                        footerContent: (importField: string) => `${startCase(importField)}-Auswahl wird auf alle Ausgaben im Bericht eines Mitarbeiters angewendet.`,
                    },
                },
            },
        },
        intacct: {
            ...
            prerequisitesTitle: 'Bevor Sie die Verbindung herstellen …',
            downloadExpensifyPackage: 'Lade das Expensify-Paket für Sage Intacct herunter',
            followSteps: 'Befolge die Schritte in unserer Anleitung „How-to: Mit Sage Intacct verbinden“',
            enterCredentials: 'Gib deine Sage Intacct-Anmeldedaten ein',
            entity: 'Entität',
            employeeDefault: 'Standardwert für Sage Intacct-Mitarbeiter',
            employeeDefaultDescription: 'Die Standardabteilung der Mitarbeitenden wird auf ihre Spesen in Sage Intacct angewendet, sofern eine vorhanden ist.',
            displayedAsTagDescription: 'Die Abteilung kann für jede einzelne Ausgabe im Bericht eines Mitarbeitenden ausgewählt werden.',
            displayedAsReportFieldDescription: 'Die Abteilungsauswahl gilt für alle Ausgaben im Bericht einer:s Mitarbeitenden.',
            toggleImportTitle: ({mappingTitle}: ToggleImportTitleParams) => `Wähle aus, wie Sage Intacct-<strong>${mappingTitle}</strong> in Expensify behandelt werden sollen.`,
            ...
            importTaxDescription: 'Steuersatz für Einkaufssteuer aus Sage Intacct importieren.',
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                whoIsYourBankAccount: 'Wie heißt Ihre Bank?',
                ...
                enableFeed: {
                    title: (provider: string) => `${provider}-Feed aktivieren`,
                    heading:
                    ...
                    visa: 'Wir haben globale Integrationen mit Visa, allerdings hängt die Verfügbarkeit von deiner Bank und deinem Kartenprogramm ab.\n\nUm loszulegen, musst du nur Folgendes tun:',
                    mastercard:
                        'Wir haben globale Integrationen mit Mastercard, allerdings unterscheidet sich die Verfügbarkeit je nach Bank und Kartenprogramm.\n\nUm loszulegen, gehe einfach wie folgt vor:',
                    vcf: `1. Lies dir [diesen Hilfeartikel](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP}) durch, um detaillierte Anweisungen zur Einrichtung deiner Visa Commercial Cards zu erhalten.

2. [Kontaktiere deine Bank](${CONST.COMPANY_CARDS_VISA_COMMERCIAL_CARD_HELP}), um zu prüfen, ob sie einen Commercial-Feed für dein Programm unterstützt, und bitte sie, diesen zu aktivieren.

3. *Sobald der Feed aktiviert ist und du seine Details hast, fahre mit dem nächsten Bildschirm fort.*`,
                    gl1025: `1. Öffne [diesen Hilfeartikel](${CONST.COMPANY_CARDS_AMEX_COMMERCIAL_CARD_HELP}), um herauszufinden, ob American Express für dein Programm einen Commercial-Feed aktivieren kann.
...
2. [Kontaktiere deine Bank](${CONST.COMPANY_CARDS_MASTERCARD_COMMERCIAL_CARDS}), um zu überprüfen, ob sie einen Commercial-Feed für dein Programm unterstützt, und bitte sie, diesen zu aktivieren.
...
3. Sobald der Feed aktiviert ist, klicken Sie unten auf „Senden“ und wir kümmern uns um das Hinzufügen.`,
                ...
                enterNameOfBank: 'Banknamen eingeben',
                feedDetails: {
                    vcf: {
                    ...
                    gl1025: {
                        ...
                        fileNameLabel: 'Dateiname der Übertragung',
                ...
                error: {
                    pleaseSelectProvider: 'Bitte wähle einen Kartenanbieter aus, bevor du fortfährst',
                    pleaseSelectBankAccount: 'Bitte wähle ein Bankkonto aus, bevor du fortfährst',
                    pleaseSelectBank: 'Bitte wähle vor dem Fortfahren ein Bankkonto aus',
                ...
                exitModal: {
                    ...
                    prompt: 'Wir haben festgestellt, dass du das Hinzufügen deiner Karten nicht abgeschlossen hast. Wenn du auf ein Problem gestoßen bist, sag uns Bescheid, damit wir dir helfen können, wieder alles ins Lot zu bringen.',
            ...
            chooseTheCardholder: 'Wähle die Karteninhaberin oder den Karteninhaber',
            ...
            assignedCard: (assignee: string, link: string) => `hat ${assignee} ein(e) ${link} zugewiesen! Importierte Transaktionen werden in diesem Chat angezeigt.`,
            companyCard: 'Firmenkarte',
            chooseCardFeed: 'Karten-Feed auswählen',
            ukRegulation:
                'Expensify Limited ist ein Vertreter von Plaid Financial Ltd., einem von der Financial Conduct Authority nach den Payment Services Regulations 2017 zugelassenen Zahlungsinstitut (Firmennummer: 804718). Plaid stellt Ihnen über Expensify Limited als seinen Vertreter regulierte Kontoinformationsdienste zur Verfügung.',
            assignCardFailedError: 'Kartenzuweisung fehlgeschlagen.',
            cardAlreadyAssignedError: 'Diese Karte ist bereits einem Mitglied in einem anderen Workspace zugeordnet.',
        },
        expensifyCard: {
            ...
            disclaimer:
                'Die Expensify Visa® Commercial Card wird von The Bancorp Bank, N.A., Mitglied der FDIC, gemäß einer Lizenz von Visa U.S.A. Inc. ausgegeben und kann nicht bei allen Händlern verwendet werden, die Visa-Karten akzeptieren. Apple® und das Apple-Logo® sind Marken von Apple Inc., eingetragen in den USA und anderen Ländern. App Store ist eine Dienstleistungsmarke von Apple Inc. Google Play und das Google Play-Logo sind Marken von Google LLC.',
            euUkDisclaimer:
                'Von Transact Payments Malta Limited ausgegebene Karten werden an Einwohner des EWR ausgegeben und von Transact Payments Limited ausgegebene Karten werden an Einwohner des Vereinigten Königreichs gemäß einer Lizenz von Visa Europe Limited ausgegeben. Transact Payments Malta Limited ist ordnungsgemäß von der Malta Financial Services Authority als Finanzinstitut nach dem Financial Institution Act 1994 zugelassen und reguliert. Registrierungsnummer C 91879. Transact Payments Limited ist von der Gibraltar Financial Service Commission zugelassen und wird von dieser reguliert.',
            ...
            requestLimitIncrease: 'Erhöhung des Anfrage-Limits beantragen',
            remainingLimitDescription:
                'Wir berücksichtigen mehrere Faktoren bei der Berechnung deines verbleibenden Limits: deine Dauer als Kund*in, die geschäftsbezogenen Informationen, die du bei der Registrierung angegeben hast, sowie das verfügbare Guthaben auf deinem Geschäftskonto. Dein verbleibendes Limit kann täglich schwanken.',
            ...
            chooseExistingBank: 'Wähle ein bestehendes Geschäftskonto aus, um dein Expensify Card‑Guthaben zu begleichen, oder füge ein neues Bankkonto hinzu',
            ...
            settlementFrequencyInfo:
                'Wenn du zur monatlichen Abrechnung wechseln möchtest, musst du dein Bankkonto über Plaid verknüpfen und eine positive Kontohistorie der letzten 90 Tage haben.',
            frequency: {
                daily: 'Täglich',
                monthly: 'Monatlich',
            },
            ...
            issuedCard: (assignee: string) => `hat ${assignee} eine Expensify Card ausgestellt! Die Karte trifft in 2–3 Werktagen ein.`,
            ...
            addedShippingDetails: (assignee: string) => `${assignee} hat Versanddetails hinzugefügt. Die Expensify Card wird in 2–3 Werktagen eintreffen.`,
            replacedCard: (assignee: string) => `${assignee} hat seine Expensify Card ersetzt. Die neue Karte wird in 2–3 Werktagen ankommen.`,
            replacedVirtualCard: ({assignee, link}: IssueVirtualCardParams) => `${assignee} hat ihre virtuelle Expensify Card ersetzt! Der ${link} kann sofort verwendet werden.`,
            card: 'Karte',
            ...
            oneMoreStepDescription: 'Es scheint, dass wir Ihr Bankkonto manuell verifizieren müssen. Bitte gehen Sie zu Concierge, dort warten Ihre Anweisungen auf Sie.',
            gotIt: 'Verstanden',
        ...
        categories: {
            ...
            deleteCategoryPrompt: 'Möchtest du diese Kategorie wirklich löschen?',
            ...
            spendCategoriesDescription: 'Legen Sie fest, wie Händlerausgaben für Kreditkartentransaktionen und gescannte Belege kategorisiert werden.',
            ...
            emptyCategories: {
                ...
                subtitleWithAccounting: (accountingPageURL: string) =>
                    `<muted-text><centered-text>Deine Kategorien werden derzeit aus einer Buchhaltungsanbindung importiert. Gehe zu <a href="${accountingPageURL}">Buchhaltung</a>, um Änderungen vorzunehmen.</centered-text></muted-text>`,
            },
            ...
            importedFromAccountingSoftware: 'Die Kategorien unten werden importiert aus Ihrer/Ihrem',
        ...
        moreFeatures: {
            subtitle: 'Verwende die Schalter unten, um mit deinem Wachstum weitere Funktionen zu aktivieren. Jede Funktion erscheint im Navigationsmenü für eine weitergehende Anpassung.',
            spendSection: {
                title: 'Ausgaben',
            ...
            manageSection: {
                title: 'Verwalten',
                subtitle: 'Füge Kontrollmöglichkeiten hinzu, die helfen, Ausgaben im Budget zu halten.',
            },
            earnSection: {
                title: 'Verdienen',
            ...
            perDiem: {
                title: 'Tagespauschale',
                subtitle: 'Legen Sie Pauschal­sätze fest, um tägliche Mitarbeiterausgaben zu steuern.',
            },
            travel: {
                title: 'Reisen',
                ...
                reviewingRequest: {
                    ...
                    subtitle: 'Wir prüfen derzeit deine Anfrage zur Aktivierung von Expensify Travel. Keine Sorge, wir geben dir Bescheid, sobald alles bereit ist.',
                ...
                travelInvoicing: {
                    ...
                    centralInvoicingSection: {
                        ...
                        subtitle: 'Zentralisiere alle Reisekosten in einer Monatsrechnung, statt sie zum Zeitpunkt des Kaufs zu bezahlen.',
                        ...
                        subsections: {
                            ...
                            settlementFrequencyLabel: 'Abrechnungsfrequenz',
                        },
                    },
                },
            },
            expensifyCard: {
                ...
                subtitle: 'Verschaffen Sie sich Einblicke und Kontrolle über Ausgaben.',
                disableCardTitle: 'Expensify Card deaktivieren',
                disableCardPrompt: 'Sie können die Expensify Card nicht deaktivieren, weil sie bereits verwendet wird. Wenden Sie sich an Concierge, um die nächsten Schritte zu erfahren.',
                disableCardButton: 'Mit Concierge chatten',
                feed: {
                    title: 'Expensify Card bestellen',
                    subTitle: 'Optimieren Sie Ihre Geschäftsausgaben und sparen Sie bis zu 50 % auf Ihrer Expensify-Rechnung, zusätzlich:',
                    features: {
                        cashBack: 'Cashback auf jeden Kauf in den USA',
            ...
            companyCards: {
                ...
                feed: {
                    ...
                    subtitle: 'Verknüpfe die Karten, die du bereits hast, für den automatischen Transaktionsimport, das Belegabgleichen und die Abstimmung.',
                    features: {
                ...
                integrationExportTitleXero: ({integration}: IntegrationExportParams) => `Wähle das ${integration}-Konto, in das die Transaktionen exportiert werden sollen.`,
                ...
                unassignCardDescription:
                    'Wenn diese Karte nicht mehr zugewiesen ist, werden alle Transaktionen auf Entwurfsberichten aus dem Konto der Karteninhaberin bzw. des Karteninhabers entfernt.',
                assignCard: 'Karte zuweisen',
                ...
                cardFeedTransactionDescription: 'Wähle, ob Karteninhaber Kartentransaktionen löschen können. Neue Transaktionen folgen diesen Regeln.',
                ...
                emptyAddedFeedDescription: 'Stellen Sie sicher, dass sich Karten im Kartenfeed Ihrer Bank befinden.',
                ...
                pendingBankDescription: (bankName: string) => `Bitte stelle über das soeben geöffnete Browserfenster eine Verbindung zu ${bankName} her. Falls sich keines geöffnet hat,`,
                ...
                downgradeSubTitle: `Dieser Workspace kann nicht herabgestuft werden, da mehrere Kartenfeeds verbunden sind (ausgenommen Expensify Cards). Bitte <a href="#">nur einen Kartenfeed behalten</a>, um fortzufahren.`,
                ...
                expensifyCardBannerSubtitle:
                    'Genieße Cashback auf jeden Kauf in den USA, bis zu 50 % Rabatt auf deine Expensify-Rechnung, unbegrenzt viele virtuelle Karten und vieles mehr.',
                expensifyCardBannerLearnMoreButton: 'Mehr erfahren',
                statementCloseDateTitle: 'Abrechnungsstichtag',
                statementCloseDateDescription: 'Teile uns mit, wann dein Kreditkartenkontoauszug schließt, und wir erstellen einen passenden Auszug in Expensify.',
            },
            workflows: {
                title: 'Workflows',
                subtitle: 'Konfiguriere, wie Ausgaben genehmigt und bezahlt werden.',
                disableApprovalPrompt:
                    'Expensify Cards in diesem Workspace verwenden derzeit Genehmigungen, um ihre Smart Limits festzulegen. Bitte ändern Sie die Limitarten aller Expensify Cards mit Smart Limits, bevor Sie Genehmigungen deaktivieren.',
            },
            invoices: {
                title: 'Rechnungen',
            ...
            categories: {
                title: 'Kategorien',
                subtitle: 'Ausgaben erfassen und organisieren.',
            },
            tags: {
                title: 'Stichwörter',
            ...
            taxes: {
                title: 'Steuern',
                subtitle: 'Belege erfassen und erstattungsfähige Steuern zurückfordern.',
            },
            reportFields: {
            ...
            connections: {
                title: 'Buchhaltung',
                subtitle: 'Synchronisieren Sie Ihren Kontenrahmen und mehr.',
            },
            receiptPartners: {
                title: 'Belegpartner',
            ...
            workflowWarningModal: {
                ...
                confirmText: 'Zu Expensify Cards',
            },
            rules: {
                title: 'Regeln',
        ...
        reports: {
            ...
            customReportNamesSubtitle: `<muted-text>Passe Berichtstitel mit unseren <a href="${CONST.CUSTOM_REPORT_NAME_HELP_URL}">umfangreichen Formeln</a> an.</muted-text>`,
        ...
        reportFields: {
            ...
            emptyReportFields: {
                title: 'Du hast noch keine Berichts­felder erstellt',
            ...
            dateAlternateText: 'Füge einen Kalender zur Datumswahl hinzu.',
            dropdownAlternateText: 'Füge eine Liste von Optionen hinzu, aus denen gewählt werden kann.',
            ...
            initialValueInputSubtitle: 'Gib einen Anfangswert ein, der im Berichtsfeld angezeigt werden soll.',
            listValuesInputSubtitle: 'Diese Werte erscheinen im Dropdownfeld deines Berichts. Aktivierte Werte können von Mitgliedern ausgewählt werden.',
            ...
            emptyReportFieldsValues: {
                title: 'Sie haben noch keine Listeneinträge erstellt',
        ...
        tags: {
            ...
            emptyTags: {
                ...
                subtitleHTML: `<muted-text><centered-text>Fügen Sie Tags hinzu, um Projekte, Standorte, Abteilungen und mehr zu verfolgen. <a href="${CONST.IMPORT_TAGS_EXPENSIFY_URL}">Erfahren Sie mehr</a> über die Formatierung von Tag-Dateien für den Import.</centered-text></muted-text>`,
                subtitleWithAccounting: (accountingPageURL: string) =>
            ...
            importedFromAccountingSoftware: 'Die untenstehenden Tags werden importiert von Ihrem',
            glCode: 'Sachkonto-Code',
            updateGLCodeFailureMessage: 'Beim Aktualisieren des Hauptbuchcodes ist ein Fehler aufgetreten, bitte versuche es erneut.',
            tagRules: 'Schlagwortregeln',
            approverDescription: 'Genehmigende Person',
            importTags: 'Tags importieren',
            importTagsSupportingText: 'Verschlüssele deine Ausgaben mit einer oder vielen Tag-Arten.',
            configureMultiLevelTags: 'Konfiguriere deine Liste von Tags für mehrstufige Verschlagwortung.',
            ...
            importMultiLevelTags: {
                ...
                glAdjacentColumn: 'In der angrenzenden Spalte befindet sich ein Hauptbuchkonto-Code.',
            },
            tagLevel: {
            ...
            switchSingleToMultiLevelTagWarning: {
                ...
                prompt1: 'Wenn du die Tag-Ebene wechselst, werden alle aktuellen Tags gelöscht.',
            ...
            cannotMakeAllTagsOptional: {
                ...
                description: `Mindestens ein Tag muss erforderlich bleiben, da deine Workspace-Einstellungen Tags erfordern.`,
            },
            cannotMakeTagListRequired: {
                title: 'Tag-Liste kann nicht als erforderlich festgelegt werden',
                description: 'Sie können eine Tagliste nur dann als erforderlich festlegen, wenn in Ihrer Richtlinie mehrere Tag-Ebenen konfiguriert sind.',
            },
            tagCount: () => ({
                one: '1 Tag',
        ...
        taxes: {
            ...
            value: 'Wert',
            taxReclaimableOn: 'Steuer rückforderbar für',
            taxRate: 'Steuersatz',
            ...
            error: {
                ...
                valuePercentageRange: 'Bitte gib eine gültige Prozentzahl zwischen 0 und 100 ein',
                ...
                updateFailureMessage: 'Bei der Aktualisierung des Steuersatzes ist ein Fehler aufgetreten. Bitte versuche es erneut oder bitte Concierge um Hilfe.',
            ...
            importedFromAccountingSoftware: 'Die Steuern unten werden importiert von Ihrem',
            taxCode: 'Steuercode',
            updateTaxCodeFailureMessage: 'Beim Aktualisieren des Steuercodes ist ein Fehler aufgetreten. Bitte versuche es erneut.',
        },
        duplicateWorkspace: {
            title: 'Benenne deinen neuen Arbeitsbereich',
            ...
            confirmTitle: ({newWorkspaceName, totalMembers}: {newWorkspaceName?: string; totalMembers?: number}) =>
                `Sie sind dabei, ${newWorkspaceName ?? ''} mit ${totalMembers ?? 0} Mitgliedern des ursprünglichen Arbeitsbereichs zu erstellen und zu teilen.`,
            error: 'Beim Duplizieren Ihres neuen Arbeitsbereichs ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',
        },
        emptyWorkspace: {
            title: 'Du hast keine Workspaces',
        ...
        people: {
            ...
            removeMembersWarningPrompt: ({memberName, ownerName}: RemoveMembersWarningPrompt) =>
                `${memberName} ist ein*e Genehmigende*r in diesem Arbeitsbereich. Wenn du diesen Arbeitsbereich nicht mehr mit dieser Person teilst, ersetzen wir sie im Genehmigungsworkflow durch den/die Arbeitsbereichseigentümer*in ${ownerName}`,
            removeMembersTitle: () => ({
            ...
            makeAuditor: () => ({
                one: 'Zum Auditor machen',
                other: 'Prüfende hinzufügen',
            }),
            selectAll: 'Alle auswählen',
            error: {
                genericAdd: 'Beim Hinzufügen dieses Workspace-Mitglieds ist ein Problem aufgetreten',
                cannotRemove: 'Du kannst dich selbst oder die:den Arbeitsbereichsinhaber:in nicht entfernen',
            ...
            removeMemberPromptApprover: ({approver, workspaceOwner}: {approver: string; workspaceOwner: string}) =>
                `Wenn du ${approver} aus diesem Workspace entfernst, ersetzen wir diese Person im Genehmigungsworkflow durch ${workspaceOwner}, den/die Workspace-Inhaber(in).`,
            ...
            removeMemberPromptExporter: ({memberName, workspaceOwner}: {memberName: string; workspaceOwner: string}) =>
                `Wenn du ${memberName} aus diesem Workspace entfernst, ersetzen wir sie/ihn als bevorzugte*n Exporteur*in durch ${workspaceOwner}, die Workspace-Inhaber*in.`,
            ...
            cannotRemoveUserDueToReport: ({memberName}: {memberName: string}) =>
                `${memberName} hat einen ausstehenden zu verarbeitenden Bericht, zu dem eine Aktion erforderlich ist. Bitte fordere sie auf, die erforderliche Aktion abzuschließen, bevor du sie aus dem Workspace entfernst.`,
        },
        card: {
            getStartedIssuing: 'Beginne, indem du deine erste virtuelle oder physische Karte ausstellst.',
            issueCard: 'Karte ausstellen',
            issueNewCard: {
                ...
                findMember: 'Mitglied suchen',
                chooseCardType: 'Kartentyp wählen',
                ...
                giveItNameInstruction: 'Mach sie eindeutig genug, um sie von anderen Karten unterscheiden zu können. Konkrete Anwendungsfälle sind noch besser!',
                cardName: 'Kartenname',
                letsDoubleCheck: 'Lass uns noch einmal überprüfen, ob alles richtig aussieht.',
                ...
                limit: 'Limit',
                limitType: 'Limittyp',
                disabledApprovalForSmartLimitError: 'Bitte aktiviere Genehmigungen in <strong>Workflows > Genehmigungen hinzufügen</strong>, bevor du Smart Limits einrichtest',
            },
            deactivateCardModal: {
        ...
        accounting: {
            settings: 'Einstellungen',
            title: 'Verknüpfungen',
            subtitle: 'Verbinde dein Buchhaltungssystem, um Transaktionen mit deinem Kontenplan zu codieren, Zahlungen automatisch abzugleichen und deine Finanzen synchron zu halten.',
            ...
            talkYourOnboardingSpecialist: 'Chatte mit deiner Setup-Spezialperson.',
            ...
            setup: 'Verbinden',
            lastSync: ({relativeDate}: LastSyncAccountingParams) => `Zuletzt synchronisiert am ${relativeDate}`,
            ...
            claimOffer: {
                ...
                xero: {
                    headline: 'Hol dir Xero 6 Monate lang gratis!',
                ...
                uber: {
                    ...
                    headline: 'Erhalten Sie 5 % Rabatt auf Uber-Fahrten',
                ...
                syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                    switch (stage) {
                        ...
                        case 'intacctImportSyncBillPayments':
                            return 'Abgleich von erstatteten Berichten und Rechnungszahlungen';
                        ...
                        case 'quickbooksDesktopImportApproveCertificate':
                            return 'Zertifikat zur Genehmigung wird importiert';
                        case 'quickbooksDesktopImportDimensions':
                            return 'Dimensionen werden importiert';
                        case 'quickbooksDesktopImportSavePolicy':
                            return 'Importiere Speicherungsrichtlinie';
                        ...
                        case 'netSuiteSyncConnection':
                            return 'Verbindung mit NetSuite wird initialisiert';
                        ...
                        case 'netSuiteImportVendorsTitle':
                            return 'Lieferant:innen importieren';
            ...
            saveHoursOnReconciliation:
                'Sparen Sie jede Buchungsperiode Stunden bei der Abstimmung, indem Expensify fortlaufend Expensify Card‑Abrechnungen und -Ausgleiche für Sie abstimmt.',
            ...
            chooseReconciliationAccount: {
                ...
                settlementAccountReconciliation: ({settlementAccountUrl, lastFourPAN}: SettlementAccountReconciliationParams) =>
                    `Stelle sicher, dass dieses Konto mit deinem <a href="${settlementAccountUrl}">Expensify Card-Abrechnungskonto</a> (endet auf ${lastFourPAN}) übereinstimmt, damit die kontinuierliche Abstimmung ordnungsgemäß funktioniert.`,
            },
        },
        export: {
        ...
        invoices: {
            ...
            invoiceBalanceSubtitle: 'Dies ist Ihr aktueller Saldo aus eingegangenen Rechnungszahlungen. Er wird automatisch auf Ihr Bankkonto überwiesen, wenn Sie eines hinzugefügt haben.',
        ...
        distanceRates: {
            ...
            taxFeatureNotEnabledMessage:
                '<muted-text>Steuern müssen im Arbeitsbereich aktiviert sein, um diese Funktion zu verwenden. Gehe zu <a href="#">Weitere Funktionen</a>, um das zu ändern.</muted-text>',
            ...
            errors: {
                ...
                existingRateName: 'Ein Entfernungsbetrag mit diesem Namen existiert bereits',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            youAreAlmostDone:
                'Sie sind fast fertig mit dem Einrichten Ihres Bankkontos, mit dem Sie Firmenkarten ausgeben, Auslagen erstatten, Rechnungen einziehen und Rechnungen bezahlen können.',
            streamlinePayments: 'Zahlungen rationalisieren',
            ...
            workspaceCurrencyNotSupported: 'Arbeitsbereichswährung nicht unterstützt',
            yourWorkspace: `Ihr Workspace ist auf eine nicht unterstützte Währung eingestellt. Sieh dir die <a href="${CONST.CONNECT_A_BUSINESS_BANK_ACCOUNT_HELP_URL}">Liste der unterstützten Währungen</a> an.`,
...
Möchten Sie diesen Betrag (${amount}) übernehmen, um die Abrechnung für diesen Workspace zu übernehmen? Ihre Zahlungskarte wird sofort belastet.`,
            ...
            subscriptionText: (usersCount: number, finalCount: number) =>
                `Wenn Sie diesen Workspace übernehmen, wird sein Jahresabonnement mit Ihrem aktuellen Abonnement zusammengeführt. Dadurch erhöht sich die Größe Ihres Abonnements um ${usersCount} Mitglieder, sodass Ihre neue Abonnementgröße ${finalCount} beträgt. Möchten Sie fortfahren?`,
            duplicateSubscriptionTitle: 'Warnung: Doppelte Abonnementerkennung',
            duplicateSubscriptionButtonText: 'Weiter',
            duplicateSubscriptionText: (
                email: string,
                workspaceName: string,
            ) => `Es sieht so aus, als ob du versuchst, die Abrechnung für die Workspaces von ${email} zu übernehmen. Dafür musst du jedoch zuerst in all ihren Workspaces Admin sein.

Klicke auf „Weiter“, wenn du die Abrechnung nur für den Workspace ${workspaceName} übernehmen möchtest.

Wenn du die Abrechnung für ihr gesamtes Abonnement übernehmen möchtest, bitte sie zunächst, dich in all ihren Workspaces als Admin hinzuzufügen, bevor du die Abrechnung übernimmst.`,
            ...
            hasFailedSettlementsText: (email: string) =>
                `Sie können die Abrechnung nicht übernehmen, da ${email} einen überfälligen Expensify Card-Ausgleich hat. Bitte bitten Sie diese Person, sich an concierge@expensify.com zu wenden, um das Problem zu lösen. Danach können Sie die Abrechnung für diesen Workspace übernehmen.`,
            ...
            errorDescription: `<muted-text><centered-text>Beim Übertragen der Eigentümerschaft für diesen Workspace ist ein Problem aufgetreten. Versuche es erneut oder <concierge-link>wende dich für Hilfe an Concierge</concierge-link>.</centered-text></muted-text>`,
        },
        exportAgainModal: {
            title: 'Vorsicht!',
            description: ({
...
Möchtest du sie wirklich noch einmal exportieren?`,
        ...
        upgrade: {
            reportFields: {
                title: 'Berichtsfelder',
                description: `Berichtsfelder ermöglichen es Ihnen, Details auf Kopfzeilenebene anzugeben, im Gegensatz zu Tags, die sich auf Ausgaben einzelner Positionen beziehen. Diese Details können unter anderem konkrete Projektnamen, Informationen zu Geschäftsreisen, Standorte und mehr umfassen.`,
            ...
            [CONST.POLICY.CONNECTIONS.NAME.NETSUITE]: {
                title: 'NetSuite',
                description: `Profitiere von automatischer Synchronisierung und reduziere manuelle Eingaben mit der Expensify + NetSuite-Integration. Erhalte umfassende Finanzanalysen in Echtzeit mit nativer und benutzerdefinierter Segmentunterstützung, einschließlich Projekt- und Kundenzuordnung.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.POLICY.CONNECTIONS.NAME.SAGE_INTACCT]: {
                title: 'Sage Intacct',
                description: `Nutzen Sie die automatische Synchronisierung und reduzieren Sie manuelle Eingaben mit der Expensify + Sage Intacct-Integration. Gewinnen Sie detaillierte, aktuelle Finanzanalysen mit benutzerdefinierten Dimensionen sowie einer Spesencodierung nach Abteilung, Klasse, Standort, Kunde und Projekt (Job).`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            [CONST.POLICY.CONNECTIONS.NAME.QBD]: {
                ...
                description: `Profitiere von automatischer Synchronisierung und reduziere manuelle Eingaben mit der Integration von Expensify und QuickBooks Desktop. Erziele maximale Effizienz mit einer Echtzeit-Zwei-Wege-Verbindung und Spesencodierung nach Klasse, Artikel, Kunde und Projekt.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Unsere QuickBooks Desktop-Integration ist nur im Control-Tarif verfügbar, ab <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `pro Mitglied und Monat.` : `pro aktivem Mitglied und Monat.`}</muted-text>`,
            },
            [CONST.UPGRADE_FEATURE_INTRO_MAPPING.approvals.id]: {
                title: 'Erweiterte Genehmigungen',
                description: `Wenn du dem Ganzen weitere Genehmigungsstufen hinzufügen möchtest – oder einfach sicherstellen willst, dass die höchsten Ausgaben noch einmal überprüft werden –, bist du bei uns richtig. Erweiterte Genehmigungen helfen dir, auf jeder Ebene die richtigen Kontrollen einzurichten, damit die Ausgaben deines Teams unter Kontrolle bleiben.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            glCodes: {
                ...
                description: `Fügen Sie Ihren Kategorien und Tags Sachkonten hinzu, um Ausgaben einfach in Ihre Buchhaltungs- und Lohnabrechnungssysteme zu exportieren.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Sachkonten sind nur im Tarif Control verfügbar, beginnend bei <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `pro Mitglied und Monat.` : `pro aktivem Mitglied und Monat.`}</muted-text>`,
            },
            glAndPayrollCodes: {
                title: 'Hauptbuch- und Lohnabrechnungscodes',
                description: `Füge Sachkonten- und Lohnbuchhaltungscodes zu deinen Kategorien hinzu, um Ausgaben einfach in deine Buchhaltungs- und Lohnabrechnungssysteme zu exportieren.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Hauptbuch- und Gehaltsabrechnungscodes sind nur im Control-Tarif verfügbar, beginnend ab <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `pro Mitglied und Monat.` : `pro aktivem Mitglied und Monat.`}</muted-text>`,
            },
            taxCodes: {
                title: 'Steuerschlüssel',
                description: `Füge Steuerschlüssel zu deinen Steuern hinzu, um Auslagen einfach in deine Buchhaltungs- und Lohnabrechnungssysteme zu exportieren.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            companyCards: {
                ...
                description: `Sie müssen weitere Kartenfeeds hinzufügen? Schalten Sie unbegrenzt viele Firmenkarten frei, um Transaktionen von allen großen Kartenanbietern zu synchronisieren.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Dies ist nur im Control-Tarif verfügbar, ab <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `pro Mitglied und Monat.` : `pro aktivem Mitglied und Monat.`}</muted-text>`,
            },
            rules: {
                title: 'Regeln',
...
Fordern Sie Ausgabendetails wie Belege und Beschreibungen an, legen Sie Limits und Standardwerte fest und automatisieren Sie Genehmigungen und Zahlungen – alles an einem Ort.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Regeln sind nur im Control-Tarif verfügbar, ab <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `pro Mitglied und Monat.` : `pro aktivem Mitglied und Monat.`}</muted-text>`,
            },
            perDiem: {
                title: 'Tagespauschale',
                description:
                    'Per Diem ist eine großartige Möglichkeit, Ihre täglichen Kosten bei Geschäftsreisen Ihrer Mitarbeitenden regelkonform und planbar zu halten. Profitieren Sie von Funktionen wie individuellen Sätzen, Standardkategorien und detaillierteren Angaben wie Reisezielen und Untersätzen.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `<muted-text>Tagessätze sind nur im Control-Tarif verfügbar, beginnend ab <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `pro Mitglied und Monat.` : `pro aktivem Mitglied und Monat.`}</muted-text>`,
            },
            travel: {
                title: 'Reisen',
                description:
            ...
            reports: {
                title: 'Berichte',
                description: 'Berichte ermöglichen es dir, Ausgaben für eine einfachere Nachverfolgung und Organisation zu gruppieren.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            multiLevelTags: {
                ...
                description:
                    'Mehrstufige Tags helfen Ihnen, Ausgaben noch präziser zu verfolgen. Weisen Sie jeder Position mehrere Tags zu – etwa für Abteilung, Kunde oder Kostenstelle –, um den vollständigen Kontext jeder Ausgabe zu erfassen. So werden detailliertere Berichte, Genehmigungs-Workflows und Buchhaltungsexporte ermöglicht.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
            ...
            completed: {
                ...
                categorizeMessage: `Du hast dein Abo erfolgreich auf den Collect-Tarif umgestellt. Jetzt kannst du deine Ausgaben kategorisieren!`,
            ...
            commonFeatures: {
                ...
                benefits: {
                    ...
                    toUpgrade: 'Zum Upgrade klickenZum Upgrade klicken',
                ...
                upgradeWorkspaceWarningForRestrictedPolicyCreationPrompt: 'Ihr Unternehmen hat das Erstellen von Workspaces eingeschränkt. Bitte wenden Sie sich für Hilfe an eine*n Admin.',
            },
        },
        downgrade: {
            commonFeatures: {
                ...
                benefits: {
                    ...
                    confirm: 'Bist du sicher, dass du herabstufen und deine Konfigurationen entfernen möchtest?',
        ...
        payAndDowngrade: {
            ...
            subscription:
                'Achtung! Durch diese Aktion wird dein Expensify-Abonnement beendet, dieser Workspace gelöscht und alle Workspace-Mitglieder entfernt. Wenn du diesen Workspace behalten und nur dich selbst entfernen möchtest, lass zuerst eine andere Admin-Person die Abrechnung übernehmen.',
        ...
        restrictedAction: {
            ...
            workspaceOwnerWillNeedToAddOrUpdatePaymentCard: ({workspaceOwnerName}: WorkspaceOwnerWillNeedToAddOrUpdatePaymentCardParams) =>
                `Der/die Arbeitsbereichs-Inhaber·in ${workspaceOwnerName} muss die hinterlegte Zahlungskarte hinzufügen oder aktualisieren, um neue Arbeitsbereichsaktivitäten freizuschalten.`,
            ...
            addPaymentCardToUnlock: 'Füge eine Zahlungsmethode hinzu, um alles freizuschalten!',
            addPaymentCardToContinueUsingWorkspace: 'Füge eine Zahlungskarte hinzu, um diesen Workspace weiter zu verwenden',
            pleaseReachOutToYourWorkspaceAdmin: 'Wende dich bei Fragen bitte an deine(n) Workspace-Administrator(in).',
            chatWithYourAdmin: 'Chatte mit deiner Adminperson',
            chatInAdmins: 'Chat in #admins',
            addPaymentCard: 'Zahlungskarte hinzufügen',
            goToSubscription: 'Zu Abo gehen',
        },
        rules: {
            individualExpenseRules: {
                title: 'Ausgaben',
                subtitle: (categoriesPageLink: string, tagsPageLink: string) =>
                    `<muted-text>Legen Sie Ausgabenlimits und Standardwerte für einzelne Ausgaben fest. Sie können außerdem Regeln für <a href="${categoriesPageLink}">Kategorien</a> und <a href="${tagsPageLink}">Tags</a> erstellen.</muted-text>`,
                ...
                maxExpenseAmountDescription: 'Ausgaben markieren, die diesen Betrag überschreiten, es sei denn, eine Kategorienregel hebt dies auf.',
                maxAge: 'Maximalalter',
                ...
                cashExpenseDefault: 'Standard für Barausgabe',
                cashExpenseDefaultDescription:
                    'Wählen Sie aus, wie Barausgaben erstellt werden sollen. Eine Ausgabe gilt als Barausgabe, wenn sie keine importierte Firmenkartentransaktion ist. Dazu gehören manuell erstellte Ausgaben, Belege, Pauschalen, Entfernungs- und Zeitaufwendungen.',
                ...
                alwaysReimbursableDescription: 'Auslagen werden Mitarbeitenden immer erstattet',
                alwaysNonReimbursable: 'Immer nicht erstattungsfähig',
                alwaysNonReimbursableDescription: 'Spesen werden Mitarbeitenden niemals erstattet',
                billableDefault: 'Standard für verrechenbar',
                ...
                billable: 'Verrechenbar',
                billableDescription: 'Ausgaben werden meist an Kund:innen weiterverrechnet',
                nonBillable: 'Nicht abrechenbar',
                nonBillableDescription: 'Auslagen werden gelegentlich an Kund:innen weiterverrechnet',
                eReceipts: 'E-Belege',
                eReceiptsHint: `Elektronische Belege werden automatisch erstellt [für die meisten Kreditkartentransaktionen in USD](${CONST.DEEP_DIVE_ERECEIPTS}).`,
                attendeeTracking: 'Teilnehmernachverfolgung',
                attendeeTrackingHint: 'Verfolge die Pro-Kopf-Kosten für jede Ausgabe.',
                prohibitedDefaultDescription:
                    'Markiere alle Belege, auf denen Alkohol, Glücksspiel oder andere verbotene Artikel erscheinen. Ausgaben mit Belegen, auf denen diese Posten vorkommen, müssen manuell geprüft werden.',
                ...
                requireCompanyCardDescription: 'Kennzeichne alle Barausgaben, einschließlich Kilometer- und Pauschalspesen.',
            },
            expenseReportRules: {
                title: 'Erweitert',
                ...
                autoApproveCompliantReportsSubtitle: 'Konfigurieren, welche Spesenabrechnungen für die automatische Genehmigung infrage kommen.',
                ...
                randomReportAuditTitle: 'Stichprobenberichtprüfung',
                randomReportAuditDescription: 'Verlangen, dass einige Berichte manuell genehmigt werden, selbst wenn sie für die automatische Genehmigung in Frage kommen.',
                autoPayApprovedReportsTitle: 'Berichte mit Genehmigung automatisch bezahlen',
            ...
            categoryRules: {
                ...
                requireFields: 'Erforderliche Felder',
                ...
                requireAttendees: 'Teilnehmende erforderlich',
                descriptionHint: 'Beschreibungshinweis',
                descriptionHintDescription: (categoryName: string) =>
                    `Mitarbeitende daran erinnern, zusätzliche Informationen zu Ausgaben der Kategorie „${categoryName}“ bereitzustellen. Dieser Hinweis erscheint im Beschreibungsfeld von Ausgaben.`,
                ...
                expenseLimitTypes: {
                    ...
                    expenseSubtitle: 'Markiere Spesenbeträge nach Kategorie. Diese Regel überschreibt die allgemeine Workspace-Regel für den maximalen Spesenbetrag.',
                    daily: 'Kategoriegesamtbetrag',
                    dailySubtitle: 'Gesamtausgaben pro Tag und Kategorie je Spesenbericht markieren.',
                },
                requireReceiptsOver: 'Belege erforderlich über',
                requireReceiptsOverList: {
                    default: (defaultAmount: string) => `${defaultAmount} ${CONST.DOT_SEPARATOR} Standard`,
                    never: 'Belege nie verlangen',
            ...
            customRules: {
                ...
                cardSubtitle: 'Hier ist die Spesenrichtlinie deines Teams hinterlegt, damit alle wissen, was abgedeckt ist.',
            },
        },
        planTypePage: {
            planTypes: {
            ...
            description: 'Wähle einen Tarif, der zu dir passt. Eine detaillierte Liste der Funktionen und Preise findest du in unserer',
            ...
            lockedPlanDescription: ({count, annualSubscriptionEndDate}: WorkspaceLockedPlanTypeParams) => ({
                ...
                other: `Sie haben sich bis zum Ende Ihres jährlichen Abonnements am ${annualSubscriptionEndDate} zu ${count} aktiven Mitgliedern im Control-Tarif verpflichtet. Ab dem ${annualSubscriptionEndDate} können Sie zu einem nutzungsbasierten Abonnement wechseln und zum Collect-Tarif herabstufen, indem Sie die automatische Verlängerung in deaktivieren`,
            }),
    ...
    getAssistancePage: {
        ...
        subtitle: 'Wir sind hier, um deinen Weg zur Größe zu ebnen!',
        description: 'Wähle eine der folgenden Supportoptionen aus:',
        chatWithConcierge: 'Mit Concierge chatten',
        scheduleSetupCall: 'Vereinbare ein Einrichtungsgespräch',
    ...
    newRoomPage: {
        ...
        growlMessageOnRenameError: 'Arbeitsbereichsraum konnte nicht umbenannt werden. Bitte überprüfe deine Verbindung und versuche es erneut.',
        visibilityOptions: {
    ...
    workspaceActions: {
        ...
        removedDefaultBankAccount: ({bankAccountName, maskedBankAccountNumber}: {bankAccountName: string; maskedBankAccountNumber: string}) =>
            `hat das standardmäßige Geschäftskonto „${bankAccountName ? `${bankAccountName}: ` : ''}${maskedBankAccountNumber}“ entfernt`,
        ...
        updateApprovalRule: ({field, name, newApproverEmail, newApproverName, oldApproverEmail, oldApproverName}: UpdatedPolicyApprovalRuleParams) => {
            ...
            return `Genehmigende Person für ${field} „${name}“ in ${formatApprover(newApproverName, newApproverEmail)} geändert (zuvor ${formatApprover(oldApproverName, oldApproverEmail)})`;
        },
        ...
        updateCategory: ({oldValue, categoryName}: UpdatedPolicyCategoryParams) => `${oldValue ? 'deaktiviert' : 'aktiv'} die Kategorie „${categoryName}“`,
        ...
        updateCategoryGLCode: ({oldValue, categoryName, newValue}: UpdatedPolicyCategoryGLCodeParams) => {
            if (!oldValue) {
                return `hat den Sachkonto-Code „${newValue}“ zur Kategorie „${categoryName}“ hinzugefügt`;
            }
            if (!newValue && oldValue) {
                return `hat den Sachkonto-Code „${oldValue}“ aus der Kategorie „${categoryName}“ entfernt`;
            }
            return `hat den SKR-Code der Kategorie „${categoryName}“ auf „${newValue}“ geändert (zuvor „${oldValue}“)`;
        },
        ...
        updateCategoryMaxExpenseAmount: ({categoryName, oldAmount, newAmount}: UpdatedPolicyCategoryMaxExpenseAmountParams) => {
            ...
            if (oldAmount && !newAmount) {
                return `den Maximalbetrag von ${oldAmount} aus der Kategorie „${categoryName}“ entfernt`;
            }
        ...
        updateCategoryExpenseLimitType: ({categoryName, oldValue, newValue}: UpdatedPolicyCategoryExpenseLimitTypeParams) => {
            ...
            return `hat den Limittyp der Kategorie „${categoryName}“ in ${newValue} geändert (vorher ${oldValue})`;
        },
        ...
        updateTagEnabled: ({tagListName, tagName, enabled}: UpdatedPolicyTagParams) => `${enabled ? 'aktiv' : 'deaktiviert'} das Tag „${tagName}“ auf der Liste „${tagListName}“`,
        ...
        updateTag: ({tagListName, newValue, tagName, updatedField, oldValue}: UpdatedPolicyTagFieldParams) => {
            if (oldValue) {
                return `hat die Kategorie „${tagName}“ in der Liste „${tagListName}“ aktualisiert, indem das Feld ${updatedField} auf „${newValue}“ geändert wurde (zuvor „${oldValue}“)`;
            }
            return `hat das Tag „${tagName}“ in der Liste „${tagListName}“ aktualisiert, indem ein(e) ${updatedField} mit „${newValue}“ hinzugefügt wurde`;
        },
        updateCustomUnit: ({customUnitName, newValue, oldValue, updatedField}: UpdatePolicyCustomUnitParams) =>
            `hat die/den ${customUnitName} ${updatedField} auf „${newValue}“ geändert (zuvor „${oldValue}“)`,
        updateCustomUnitTaxEnabled: ({newValue}: UpdatePolicyCustomUnitTaxEnabledParams) => `${newValue ? 'aktiv' : 'deaktiviert'} Steuerverfolgung bei Entfernungsraten`,
        ...
        updatedCustomUnitTaxRateExternalID: ({customUnitRateName, newValue, newTaxPercentage, oldTaxPercentage, oldValue}: UpdatedPolicyCustomUnitTaxRateExternalIDParams) => {
            ...
            return `die Steuerquote „${newValue} (${newTaxPercentage})“ zum Distanzsatz „${customUnitRateName}“ hinzugefügt`;
        },
        ...
        updatedCustomUnitRateEnabled: ({customUnitName, customUnitRateName, newValue}: UpdatedPolicyCustomUnitRateEnabledParams) => {
            return `${newValue ? 'aktiv' : 'deaktiviert'} den ${customUnitName}-Satz „${customUnitRateName}“`;
        },
        ...
        updateReportFieldDefaultValue: ({defaultValue, fieldName}: UpdatedPolicyReportFieldDefaultValueParams) =>
            `Standardwert des Berichtfelds „${fieldName}“ auf „${defaultValue}“ festlegen`,
        ...
        updateReportFieldOptionDisabled: ({fieldName, optionName, optionEnabled}: PolicyDisabledReportFieldOptionParams) =>
            `${optionEnabled ? 'aktiv' : 'deaktiviert'} die Option „${optionName}“ für das Berichtsfeld „${fieldName}“`,
        updateReportFieldAllOptionsDisabled: ({fieldName, optionName, allEnabled, toggledOptionsCount}: PolicyDisabledReportFieldAllOptionsParams) => {
            if (toggledOptionsCount && toggledOptionsCount > 1) {
                return `${allEnabled ? 'aktiv' : 'deaktiviert'} alle Optionen für das Berichts­feld „${fieldName}“`;
            }
            return `${allEnabled ? 'aktiv' : 'deaktiviert'} die Option „${optionName}“ für das Berichtsfeld „${fieldName}“ und mache alle Optionen ${allEnabled ? 'aktiv' : 'deaktiviert'}`;
        },
        ...
        updateMonthlyOffset: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => {
            if (!oldValue) {
                return `Lege das monatliche Berichtseinreichungsdatum auf „${newValue}“ fest`;
            }
            return `das Datum für die monatliche Berichtsabgabe auf „${newValue}“ aktualisiert (zuvor „${oldValue}“)`;
        },
        updateDefaultBillable: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) =>
            `aktualisiert „Auslagen an Kunden weiterberechnen“ zu „${newValue}“ (zuvor „${oldValue}“)`,
        updateDefaultReimbursable: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `„Barzahlung-Standard“ auf „${newValue}“ aktualisiert (zuvor „${oldValue}“)`,
        updateDefaultTitleEnforced: ({value}: UpdatedPolicyFieldWithValueParam) => `hat „Standardberichtstitel erzwingen“ aktiviert ${value ? 'ein' : 'aus'}`,
        changedCustomReportNameFormula: ({newValue, oldValue}: UpdatedPolicyFieldWithNewAndOldValueParams) =>
            `die benutzerdefinierte Berichtsnamensformel in „${newValue}“ geändert (zuvor „${oldValue}“)`,
        ...
        updateWorkspaceDescription: ({newDescription, oldDescription}: UpdatedPolicyDescriptionParams) =>
            !oldDescription
                ...
                : `hat die Beschreibung dieses Arbeitsbereichs zu „${newDescription}“ aktualisiert (zuvor „${oldDescription}“)`,
        removedFromApprovalWorkflow: ({submittersNames}: RemovedFromApprovalWorkflowParams) => {
            ...
            return {
                one: `hat dich aus dem Genehmigungsprozess und dem Spesenchat von ${joinedNames} entfernt. Bereits eingereichte Berichte bleiben in deinem Posteingang zur Genehmigung verfügbar.`,
                other: `hat dich aus den Genehmigungsabläufen und Ausgaben-Chats von ${joinedNames} entfernt. Zuvor eingereichte Reports bleiben in deinem Posteingang zur Genehmigung verfügbar.`,
            };
        },
        demotedFromWorkspace: (policyName: string, oldRole: string) =>
            `hat Ihre Rolle in ${policyName} von ${oldRole} zu Nutzer geändert. Sie wurden aus allen Ausgaben-Chats der Einreichenden entfernt, außer aus Ihren eigenen.`,
        ...
        forcedCorporateUpgrade: `Dieser Workspace wurde auf den Control‑Tarif hochgestuft. Klicke <a href="${CONST.COLLECT_UPGRADE_HELP_URL}">hier</a> für weitere Informationen.`,
        downgradedWorkspace: 'diesen Workspace auf den Collect-Tarif herabgestuft',
        ...
        updatedFeatureEnabled: ({enabled, featureName}: {enabled: boolean; featureName: string}) => {
            switch (featureName) {
                case 'categories':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Kategorien`;
                case 'tags':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Tags`;
                case 'workflows':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Workflows`;
                case 'distance rates':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Entfernungssätze`;
                case 'accounting':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Buchhaltung`;
                case 'Expensify Cards':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Expensify Cards`;
                case 'company cards':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Firmenkarten`;
                case 'invoicing':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Rechnungsstellung`;
                case 'per diem':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Tagegeld`;
                case 'receipt partners':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Belegpartner`;
                case 'rules':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Regeln`;
                case 'tax tracking':
                    return `${enabled ? 'aktiv' : 'deaktiviert'} Steuerverfolgung`;
                default:
                    return `${enabled ? 'aktiv' : 'deaktiviert'} ${featureName}`;
            }
        },
        updatedAttendeeTracking: ({enabled}: {enabled: boolean}) => `${enabled ? 'aktiv' : 'deaktiviert'} Teilnehmendenverfolgung`,
        changedDefaultApprover: ({newApprover, previousApprover}: {newApprover: string; previousApprover?: string}) =>
            previousApprover ? `Standardgenehmigenden auf ${newApprover} geändert (zuvor ${previousApprover})` : `Standardgenehmigenden in ${newApprover} geändert`,
        changedSubmitsToApprover: ({
            ...
            let text = `den Genehmigungsprozess für ${members} geändert, damit Berichte an ${approver} eingereicht werden`;
            if (wasDefaultApprover && previousApprover) {
                text += `(zuvor Standardfreigebende*r ${previousApprover})`;
            } else if (wasDefaultApprover) {
                text += '(zuvor standardmäßige Freigabeperson)';
        ...
        changedSubmitsToDefault: ({
            ...
            let text = approver
                ? `hat den Genehmigungs-Workflow für ${members} geändert, damit sie Berichte an die/den Standardgenehmiger/in ${approver} einreichen`
        ...
        changedForwardsTo: ({approver, forwardsTo, previousForwardsTo}: {approver: string; forwardsTo: string; previousForwardsTo?: string}) =>
            previousForwardsTo
                ? `hat den Genehmigungs-Workflow für ${approver} geändert, um genehmigte Berichte an ${forwardsTo} weiterzuleiten (zuvor weitergeleitet an ${previousForwardsTo})`
        ...
        removedForwardsTo: ({approver, previousForwardsTo}: {approver: string; previousForwardsTo?: string}) =>
            previousForwardsTo
                ? `hat den Genehmigungsworkflow für ${approver} so geändert, dass genehmigte Berichte nicht mehr weitergeleitet werden (wurden zuvor an ${previousForwardsTo} weitergeleitet)`
        ...
        changedInvoiceCompanyWebsite: ({newValue, oldValue}: {newValue: string; oldValue?: string}) =>
            oldValue ? `hat die Firmenwebseite der Rechnung in „${newValue}“ geändert (zuvor „${oldValue}“)` : `Firmenwebsite der Rechnung auf „${newValue}“ festgelegt`,
        changedReimburser: ({newReimburser, previousReimburser}: UpdatedPolicyReimburserParams) =>
            previousReimburser
                ? `den autorisierten Zahler in „${newReimburser}“ geändert (zuvor „${previousReimburser}“)`
                : `hat den bevollmächtigten Zahlenden in „${newReimburser}“ geändert`,
        updateReimbursementEnabled: ({enabled}: UpdatedPolicyReimbursementEnabledParams) => `${enabled ? 'aktiv' : 'deaktiviert'} Erstattungen`,
        ...
        updateTax: ({oldValue, taxName, updatedField, newValue}: UpdatedPolicyTaxParams) => {
            ...
            switch (updatedField) {
                ...
                case 'enabled': {
                    return `${oldValue ? 'deaktiviert' : 'aktiv'} die Steuer „${taxName}“`;
                }
                default: {
                    return '';
                }
        ...
        changedReceiptRequiredAmount: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `Erforderlichen Belegbetrag auf „${newValue}“ geändert (zuvor „${oldValue}“)`,
        ...
        changedMaxExpenseAmount: ({oldValue, newValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `Höchstbetrag für Ausgaben auf „${newValue}“ geändert (zuvor „${oldValue}“)`,
        ...
        removedMaxExpenseAge: ({oldValue}: UpdatedPolicyFieldWithNewAndOldValueParams) => `maximales Ausgabenalter entfernt (bisher „${oldValue}“ Tage)`,
    },
    roomMembersPage: {
        memberNotFound: 'Mitglied nicht gefunden.',
        useInviteButton: 'Um ein neues Mitglied zum Chat einzuladen, verwende bitte die oben stehende Einladen-Schaltfläche.',
    ...
    task: {
        ...
        messages: {
            ...
            error: 'Sie sind nicht berechtigt, die angeforderte Aktion auszuführen',
        },
        markAsComplete: 'Als erledigt markieren',
        markAsIncomplete: 'Als unvollständig markieren',
        assigneeError: 'Beim Zuweisen dieser Aufgabe ist ein Fehler aufgetreten. Bitte versuche eine andere zuständige Person.',
    ...
    keyboardShortcutsPage: {
        ...
        subtitle: 'Sparen Sie Zeit mit diesen praktischen Tastenkürzeln:',
        shortcuts: {
    ...
    search: {
        ...
        searchResults: {
            ...
            emptyReportResults: {
                ...
                subtitleWithOnlyCreateButton: 'Verwende den grünen Button unten, um einen Bericht zu erstellen.',
            },
            emptyInvoiceResults: {
                title: dedent(`
        ...
        moneyRequestReport: {
            ...
            accessPlaceHolder: 'Zum Öffnen Details anzeigen',
        },
        ...
        exportSearchResults: {
            ...
            description: 'Wow, das sind eine Menge Elemente! Wir bündeln sie, und Concierge schickt dir in Kürze eine Datei.',
        },
    ...
    fileDownload: {
        success: {
            ...
            qrMessage:
                'Überprüfe deinen Fotos- oder Downloads-Ordner auf eine Kopie deines QR-Codes. Profi-Tipp: Füge ihn in eine Präsentation ein, damit dein Publikum ihn scannen und sich direkt mit dir verbinden kann.',
        },
        generalError: {
            title: 'Anlagenfehler',
    ...
    settlement: {
        ...
        failedError: ({link}: {link: string}) => `Wir versuchen diese Zahlung erneut, sobald du dein <a href="${link}">Konto entsperrt hast</a>.`,
    ...
    reportLayout: {
        ...
        selectGroupByOption: 'Wähle, wie die Berichtsausgaben gruppiert werden sollen',
    ...
    report: {
        newReport: {
            ...
            emptyReportConfirmationPrompt: ({workspaceName}: {workspaceName: string}) =>
                `Möchtest du in ${workspaceName} wirklich einen weiteren Bericht erstellen? Du kannst auf deine leeren Berichte zugreifen in`,
        ...
        actions: {
            type: {
                ...
                changeReportPolicy: (toPolicyName: string, fromPolicyName?: string) => {
                    if (!toPolicyName) {
                        return `hat den Arbeitsbereich${fromPolicyName ? `(früher ${fromPolicyName})` : ''} geändert`;
                    }
                ...
                markedReimbursed: ({amount, currency}: MarkedReimbursedParams) => `hat ${currency}${amount} anderswo bezahlt`,
                ...
                selectedForRandomAuditMarkdown: `zufällig ausgewählt zur Prüfung`,
                ...
                updatedCustomField2: ({email, previousValue, newValue}: UpdatedCustomFieldParams) => {
                    ...
                    return !previousValue
                        ...
                        : `hat das benutzerdefinierte Feld 2 von ${email} auf „${newValue}“ geändert (zuvor „${previousValue}“)`;
                },
    ...
    accessibilityHints: {
        navigateToChatsList: 'Zur Chatliste zurückkehren',
    ...
    moderation: {
        ...
        chooseAReason: 'Wählen Sie unten einen Grund für die Meldung aus:',
        spam: 'Spam',
    ...
    actionableMentionTrackExpense: {
        ...
        categorize: 'Kategorisieren',
        share: 'Mit meiner/m Steuerberater/in teilen',
        nothing: 'Im Moment nichts',
    },
    teachersUnitePage: {
        teachersUnite: 'Lehrer vereinigt euch',
        joinExpensifyOrg:
            'Schließ dich Expensify.org an, um Ungerechtigkeit auf der ganzen Welt zu beseitigen. Die aktuelle Kampagne „Teachers Unite“ unterstützt Lehrkräfte überall, indem sie die Kosten für grundlegende Schulmaterialien teilt.',
        ...
        schoolPrincipalVerifyExpense:
            'Expensify.org teilt die Kosten für grundlegende Schulmaterialien, damit Schüler:innen aus einkommensschwachen Haushalten bessere Lernbedingungen haben. Ihre Schulleitung wird gebeten, Ihre Ausgaben zu bestätigen.',
        principalFirstName: 'Vorname der verantwortlichen Person',
        principalLastName: 'Nachname der zeichnungsberechtigten Person',
    ...
    gps: {
        tooltip: 'GPS-Tracking läuft! Wenn du fertig bist, stoppe die Verfolgung unten.',
        ...
        androidBackgroundLocationRequiredModal: {
            ...
            prompt: 'Bitte erlaube den Hintergrundzugriff auf den Standort in den Geräteeinstellungen (Option „Immer zulassen“), um die GPS-Distanzaufzeichnung zu starten.',
        },
        preciseLocationRequiredModal: {
            title: 'Genauer Standort erforderlich',
            prompt: 'Bitte aktiviere „Genauen Standort“ in den Einstellungen deines Geräts, um die GPS-Distanzverfolgung zu starten.',
        },
        desktop: {
            title: 'Entfernung mit deinem Handy erfassen',
            subtitle: 'Erfasse Meilen oder Kilometer automatisch per GPS und verwandle Fahrten sofort in Ausgaben.',
        ...
        fabGpsTripExplained: 'Zur GPS-Ansicht wechseln (Schwebende Aktion)',
    },
    reportCardLostOrDamaged: {
        ...
        reasonError: 'Begründung ist erforderlich',
    ...
    referralProgram: {
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
            ...
            header: 'Starte einen Chat, wirb eine*n Freund*in',
        ...
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.REFER_FRIEND]: {
            header: 'Freund empfehlen',
            body: 'Möchtest du, dass deine Freunde Expensify auch nutzen? Chatte einfach mit ihnen, sende Geld oder teile eine Ausgabe – wir kümmern uns um den Rest. Oder teile einfach deinen Einladungslink!',
        },
        [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SHARE_CODE]: {
            buttonText: 'Freund empfehlen',
            header: 'Freund empfehlen',
            body: 'Möchtest du, dass deine Freunde Expensify auch nutzen? Chatte einfach mit ihnen, sende Geld oder teile eine Ausgabe – wir kümmern uns um den Rest. Oder teile einfach deinen Einladungslink!',
        },
    ...
    systemChatFooterMessage: {
        ...
        default: `Schreibe <concierge-link>${CONST.CONCIERGE_CHAT_NAME}</concierge-link> für Hilfe bei der Einrichtung`,
    },
    violations: {
        ...
        missingComment: 'Beschreibung erforderlich für ausgewählte Kategorie',
        ...
        modifiedAmount: ({type, displayPercentVariance}: ViolationsModifiedAmountParams) => {
            switch (type) {
                ...
                default:
                    ...
                    return 'Betrag höher als der gescannte Beleg';
            }
        },
        modifiedDate: 'Datum weicht vom eingescannten Beleg ab',
        ...
        receiptRequired: ({formattedLimit, category}: ViolationsReceiptRequiredParams) => {
            if (formattedLimit && category) {
                return `Beleg über dem Kategorielimit von ${formattedLimit} erforderlich`;
            }
            if (formattedLimit) {
                return `Beleg erforderlich über ${formattedLimit}`;
            }
            if (category) {
                return `Beleg über Kategorienlimit erforderlich`;
            }
        ...
        rter: ({brokenBankConnection, isAdmin, isTransactionOlderThan7Days, member, rterType, companyCardPageURL}: ViolationsRterParams) => {
            ...
            if (!isTransactionOlderThan7Days) {
                return isAdmin ? `Bitte ${member} darum, es als Barzahlung zu markieren, oder warte 7 Tage und versuche es erneut` : 'Wartet auf Abgleich mit Kartentransaktion.';
            }
            return '';
        },
        brokenConnection530Error: 'Beleg ausstehend aufgrund einer fehlerhaften Bankverbindung',
        ...
        someTagLevelsRequired: ({tagName}: ViolationsTagOutOfPolicyParams = {}) => `${tagName ?? 'Tag'} fehlt`,
        ...
        none: 'Keine',
        taxCodeToKeep: 'Wähle aus, welcher Steuercode beibehalten wird',
        ...
        descriptionToKeep: 'Wähle die Beschreibung aus, die beibehalten werden soll',
        ...
        confirmDetails: `Bestätige die Details, die du beibehältst`,
        ...
        resolvedDuplicates: 'Duplikat wurde gelöst',
    ...
    exitSurvey: {
        ...
        reasons: {
            ...
            [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]: 'Ich verstehe nicht, wie ich New Expensify benutzen soll.',
            [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]: 'Ich verstehe, wie ich das neue Expensify benutze, aber ich ziehe Expensify Classic vor.',
        },
        prompts: {
        ...
        bookACallTitle: 'Möchten Sie mit einer Produktmanagerin oder einem Produktmanager sprechen?',
        benefits: {
        ...
        bookACallTextTop: 'Wenn du zu Expensify Classic wechselst, verzichtest du auf:',
        bookACallTextBottom:
            'Wir würden uns freuen, mit Ihnen zu telefonieren, um den Grund zu verstehen. Sie können einen Termin mit einem unserer Senior Product Manager buchen, um Ihren Bedarf zu besprechen.',
    ...
    subscription: {
        ...
        mobileReducedFunctionalityMessage: 'Du kannst dein Abonnement in der mobilen App nicht ändern.',
        badge: {
        ...
        billingBanner: {
            ...
            policyOwnerAmountOwedOverdue: {
                ...
                subtitle: (date?: string, purchaseAmountOwed?: string) =>
                    date && purchaseAmountOwed
                        ...
                        : 'Bitte füge eine Zahlungskarte hinzu, um den geschuldeten Betrag zu begleichen.',
            },
            ...
            cardExpired: {
                title: 'Ihre Karte konnte nicht belastet werden',
                subtitle: (amountOwed: number) => `Ihre Zahlungskarte ist abgelaufen. Bitte fügen Sie eine neue Zahlungskarte hinzu, um Ihren offenen Saldo von ${amountOwed} zu begleichen.`,
            },
            cardExpireSoon: {
            ...
            retryBillingError: {
                title: 'Ihre Karte konnte nicht belastet werden',
                subtitle:
                    'Bevor du es erneut versuchst, rufe bitte direkt deine Bank an, um Expensify‑Abbuchungen zu autorisieren und alle Sperren aufzuheben. Andernfalls versuche, eine andere Zahlungskarte hinzuzufügen.',
            },
            cardOnDispute: (amountOwed: string, cardEnding: string) =>
                `Sie haben die Belastung über ${amountOwed} für die Karte mit der Endziffer ${cardEnding} angefochten. Ihr Konto bleibt gesperrt, bis die Angelegenheit mit Ihrer Bank geklärt ist.`,
            preTrial: {
                title: 'Kostenlose Testversion starten',
                subtitle: 'Als nächsten Schritt <a href="#">schließe deine Einrichtungs-Checkliste ab</a>, damit dein Team mit dem Einreichen von Ausgaben beginnen kann.',
            },
            trialStarted: {
            ...
            trialEnded: {
                title: 'Deine kostenlose Testversion ist abgelaufen',
                subtitle: 'Füge eine Zahlungsmethode hinzu, um weiterhin alle deine Lieblingsfunktionen nutzen zu können.',
            },
            earlyDiscount: {
                claimOffer: 'Angebot einlösen',
                subscriptionPageTitle: (discountType: number) =>
                    `<strong>${discountType}% Rabatt im ersten Jahr!</strong> Füge einfach eine Zahlungskarte hinzu und starte ein Jahresabonnement.`,
                onboardingChatTitle: (discountType: number) => `Angebot für kurze Zeit: ${discountType}% Rabatt auf dein erstes Jahr!`,
        ...
        cardSection: {
            title: 'Zahlung',
            subtitle: 'Füge eine Karte hinzu, um dein Expensify-Abo zu bezahlen.',
        ...
        yourPlan: {
            ...
            collect: {
                title: 'Einsammeln',
                description: 'Der Kleinunternehmensplan, der Ihnen Spesenverwaltung, Reisen und Chat bietet.',
            ...
            control: {
                ...
                benefit2: 'Mehrstufige Genehmigungsworkflows',
            ...
            saveWithExpensifyDescription: 'Verwende unseren Sparrechner, um zu sehen, wie Cashback von der Expensify Card deine Expensify-Rechnung reduzieren kann.',
            saveWithExpensifyButton: 'Mehr erfahren',
        },
        compareModal: {
            comparePlans: 'Tarife vergleichen',
            subtitle: `<muted-text>Schalte die Funktionen frei, die du brauchst, mit dem passenden Tarif für dich. <a href="${CONST.PRICING}">Sieh dir unsere Preisseite an</a> für eine vollständige Funktionsübersicht aller unserer Tarife.</muted-text>`,
        },
        details: {
        ...
        subscriptionSize: {
            ...
            eachMonth:
                'Jeden Monat deckt dein Abonnement bis zu der oben festgelegten Anzahl aktiver Mitglieder ab. Jedes Mal, wenn du deine Abonnementgröße erhöhst, startest du ein neues 12-monatiges Abonnement mit dieser neuen Größe.',
            note: 'Hinweis: Ein aktives Mitglied ist jede Person, die Ausgabendaten erstellt, bearbeitet, eingereicht, genehmigt, erstattet oder exportiert hat, die mit dem Arbeitsbereich Ihres Unternehmens verknüpft sind.',
            ...
            youAlreadyCommitted: ({size, date}: SubscriptionCommitmentParams) =>
                `Sie haben sich bereits zu einem jährlichen Abonnement mit ${size} aktiven Mitgliedern pro Monat bis ${date} verpflichtet. Sie können ab dem ${date} zu einem nutzungsabhängigen Abonnement wechseln, indem Sie die automatische Verlängerung deaktivieren.`,
            error: {
        ...
        subscriptionSettings: {
            ...
            pricingConfiguration: 'Die Preise hängen von der Konfiguration ab. Wähle für den niedrigsten Preis ein Jahresabonnement und besorge dir die Expensify Card.',
        ...
        requestEarlyCancellation: {
            ...
            subscriptionCanceled: {
                ...
                info: 'Wenn du deine Arbeitsbereiche weiterhin nutzungsbasiert verwenden möchtest, bist du startklar.',
                preventFutureActivity: ({workspacesListRoute}: WorkspacesListRouteParams) =>
                    `Wenn du zukünftige Aktivitäten und Gebühren verhindern möchtest, musst du deinen <a href="${workspacesListRoute}">Workspace bzw. deine Workspaces löschen</a>. Beachte, dass dir beim Löschen deines Workspace bzw. deiner Workspaces alle ausstehenden Aktivitäten in Rechnung gestellt werden, die im aktuellen Kalendermonat angefallen sind.`,
            },
            requestSubmitted: {
    ...
    delegate: {
        ...
        accessLevelDescription: 'Wähle unten eine Zugriffsstufe. Sowohl Vollzugriff als auch Eingeschränkter Zugriff ermöglichen Copilots, alle Unterhaltungen und Ausgaben zu sehen.',
        roleDescription: ({role}: OptionalParam<DelegateRoleParams> = {}) => {
            switch (role) {
                case CONST.DELEGATE_ROLE.ALL:
                    return 'Erlaube einem anderen Mitglied, in deinem Konto alle Aktionen in deinem Namen durchzuführen. Dazu gehören Chat, Einreichungen, Genehmigungen, Zahlungen, Aktualisierungen der Einstellungen und mehr.';
                case CONST.DELEGATE_ROLE.SUBMITTER:
                    return 'Erlaubt einem anderen Mitglied, die meisten Aktionen in deinem Konto in deinem Namen durchzuführen. Ausgenommen sind Freigaben, Zahlungen, Ablehnungen und Sperren.';
                default:
                    return '';
            }
        },
        ...
        makeSureItIsYou: 'Bestätigen Sie Ihre Identität',
        enterMagicCode: (contactMethod: string) =>
    ...
    debug: {
        ...
        reasonRBR: {
            hasErrors: 'Enthält Fehler in den Berichtsdaten oder den Berichtaktionen-Daten',
        ...
        indicatorStatus: {
            ...
            theresWasAProblemDuringAWorkspaceConnectionSync: 'Bei der Synchronisierung der Arbeitsbereichsverbindung ist ein Problem aufgetreten',
    ...
    migratedUserWelcomeModal: {
        ...
        subtitle: 'Es enthält alles, was du an unserem klassischen Erlebnis liebst, plus jede Menge Verbesserungen, die dir das Leben noch einfacher machen:',
        confirmText: "Los geht's!",
        helpText: '2-min-Demo testen',
        features: {
            search: 'Leistungsstärkere Suche auf Mobilgerät, Web und Desktop',
            concierge: 'Integrierte Concierge-KI zur Automatisierung deiner Ausgaben',
    ...
    scheduledCall: {
        ...
        confirmation: {
            ...
            setupSpecialist: 'Ihre Einrichtungsexpert\\*in',
    ...
    testDrive: {
        ...
        modal: {
            ...
            employee: {
                description:
                    '<muted-text>Verschaffe deinem Team <strong>3 kostenlose Monate Expensify!</strong> Gib einfach die E-Mail-Adresse deiner Chefin/deines Chefs unten ein und sende ihr/ihm eine Testausgabe.</muted-text>',
                email: 'Gib die E-Mail-Adresse deiner Vorgesetzten/deines Vorgesetzten ein',
                error: 'Dieses Mitglied besitzt einen Arbeitsbereich, bitte gib ein neues Mitglied zum Testen ein.',
            },
        },
        banner: {
            currentlyTestDrivingExpensify: 'Du probierst Expensify gerade aus',
...
Hey! Ich habe uns gerade *3 Monate gratis* gesichert, um Expensify auszuprobieren – die schnellste Art, Ausgaben abzurechnen.
    ...
    domain: {
        ...
        verifyDomain: {
            ...
            beforeProceeding: ({domainName}: {domainName: string}) =>
                `Bevor du fortfährst, überprüfe, dass du <strong>${domainName}</strong> besitzt, indem du seine DNS-Einstellungen aktualisierst.`,
            accessYourDNS: ({domainName}: {domainName: string}) => `Rufen Sie Ihren DNS-Anbieter auf und öffnen Sie die DNS-Einstellungen für <strong>${domainName}</strong>.`,
        ...
        domainVerified: {
            ...
            header: 'Juhuu! Deine Domain wurde verifiziert',
        ...
        samlFeatureList: {
            ...
            subtitle: ({domainName}: {domainName: string}) =>
                `<muted-text><a href="${CONST.SAML_HELP_URL}">SAML SSO</a> ist eine Sicherheitsfunktion, mit der Sie besser steuern können, wie Mitglieder mit E-Mail-Adressen unter <strong>${domainName}</strong> sich bei Expensify anmelden. Um sie zu aktivieren, müssen Sie sich als autorisierte*r Unternehmensadministrator*in verifizieren.</muted-text>`,
        ...
        goToDomain: 'Gehe zur Domain',
        samlLogin: {
            title: 'SAML-Anmeldung',
            subtitle: `<muted-text>Konfiguriere die Anmeldung für Mitglieder mit <a href="${CONST.SAML_HELP_URL}">SAML Single Sign-On (SSO).</a></muted-text>`,
            enableSamlLogin: 'SAML-Anmeldung aktivieren',
            allowMembers: 'Mitgliederanmeldung mit SAML erlauben.',
        ...
        accessRestricted: {
            ...
            subtitle: (domainName: string) =>
                `Bitte weisen Sie sich als autorisierte*r Unternehmensadministrator*in für <strong>${domainName}</strong> aus, wenn Sie die Kontrolle benötigen über:`,
            companyCardManagement: 'Firmenkartennverwaltung',
        ...
        enhancedSecurity: {
            ...
            subtitle: 'Verlange von Mitgliedern in deiner Domain die Anmeldung über Single Sign-On, schränke das Erstellen von Workspaces ein und mehr.',
            enable: 'Aktivieren',
        },
        domainAdmins: 'Domain-Admins',
        admins: {
            title: 'Admins',
            findAdmin: 'Administrator finden',
            primaryContact: 'Hauptansprechperson',
            addPrimaryContact: 'Primären Kontakt hinzufügen',
            setPrimaryContactError: 'Primären Kontakt kann nicht festgelegt werden. Bitte versuche es später erneut.',
            settings: 'Einstellungen',
            consolidatedDomainBilling: 'Konsolidierte Domain-Abrechnung',
            consolidatedDomainBillingDescription: (domainName: string) =>
                `<comment><muted-text-label>Wenn aktiviert, übernimmt die Hauptkontaktperson die Bezahlung für alle von <strong>${domainName}</strong>-Mitgliedern besessenen Arbeitsbereiche und erhält alle Rechnungsbelege.</muted-text-label></comment>`,
            ...
            revokeAdminAccess: 'Administratorzugriff entziehen',
            cantRevokeAdminAccess: 'Adminzugriff kann der technischen Ansprechperson nicht entzogen werden',
            error: {
                removeAdmin: 'Dieser Benutzer kann nicht als Admin entfernt werden. Bitte versuch es erneut.',
            ...
            resetDomainInfo: `Diese Aktion ist <strong>dauerhaft</strong> und die folgenden Daten werden gelöscht: <br/> <ul><li>Firmenkartenverbindungen und alle nicht eingereichten Ausgaben dieser Karten</li> <li>SAML- und Gruppeneinstellungen</li> </ul> Alle Konten, Workspaces, Berichte, Ausgaben und andere Daten bleiben erhalten. <br/><br/>Hinweis: Sie können diese Domain aus Ihrer Domainliste entfernen, indem Sie die zugehörige E-Mail-Adresse aus Ihren <a href="#">Kontaktmethoden</a> entfernen.`,
        },
        members: {
            title: 'Mitglieder',
            findMember: 'Mitglied suchen',
