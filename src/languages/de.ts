        ...
        recruiting: {
            ...
            filters: {
                ...
                stages: {
                    ...
                    toggleTitle: 'Importauftragsphasen',
                    allSelected: 'Alle Jobphasen',
                    emptySelectionError: 'Bitte wählen Sie mindestens eine Jobphase aus',
                },
                tags: {
                    title: 'Tag',
                    description: 'Wählen Sie die Stichwörter der Kandidat:innen aus, die Sie mit diesem Workspace synchronisieren möchten',
                    toggleTitle: 'Tags importieren',
                    allSelected: 'Alle Tags',
                    emptySelectionError: 'Bitte wählen Sie mindestens einen Tag aus',
                },
                offices: {
                    title: 'Büro',
                    description: 'Wählen Sie die Büros der Kandidat:innen aus, die Sie mit diesem Workspace synchronisieren möchten',
                    toggleTitle: 'Büros importieren (optional)',
