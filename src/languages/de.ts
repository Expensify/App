...
${amount} für ${merchant} – ${date}`,
    ...
    activateCardPage: {
        ...
        fillInAllDetails: 'Bitte füllen Sie alle Details unten aus',
    },
    getPhysicalCard: {
...
Der Control-Tarif beginnt bei 9 $ pro aktivem Mitglied und Monat.`,
        ...
        card: {
            ...
            issueNewCard: {
                ...
                enterShippingAddress: 'Versandadresse eingeben',
                shippingAddressDescription: 'Teilen Sie uns mit, wohin wir die neue Karte schicken sollen.',
                promptCardholder: 'Karteninhaber auffordern',
                promptCardholderDescription: 'Der Karteninhaber bzw. die Karteninhaberin wird aufgefordert, seine bzw. ihre Lieferadresse einzugeben oder zu bestätigen.',
