...
${amount} für ${merchant} – ${date}`,
    ...
    privatePersonalDetails: {
        ...
        legalLastName: 'Rechtlicher Nachname',
        address: 'Adresse',
        homeAddress: 'Heimadresse',
        commuterExclusionsNote: ({workspaceName}: {workspaceName: string}) => `${workspaceName} verwendet diese Adresse für Pendlerausschlüsse.`,
        error: {
...
3. Sobald der Feed aktiviert ist, klicken Sie unten auf „Senden“ und wir kümmern uns um die Einrichtung.`,
        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                optionHomeAndOfficeHelp: 'Ziehe den Arbeitsweg jedes Mitglieds zwischen Zuhause und der Adresse des Arbeitsbereichs von jeder Distanzabrechnung ab.',
                workspaceAddressRequired: {
                    title: 'Ups, nicht so schnell...',
                    prompt: 'Dieser Arbeitsbereich hat noch keine Adresse. Füge eine hinzu, damit Pendelausschlüsse sie verwenden können.',
                    cta: 'Adresse hinzufügen',
                },
                errors: {
