...
const translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryInvoiceRoomPartTwo: `. Verwenden Sie die ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} Schaltfläche, um eine Rechnung zu senden.`,
        ...
        beginningOfChatHistoryPolicyExpenseChatPartThree: `. Verwenden Sie einfach die ${CONST.CUSTOM_EMOJIS.GLOBAL_CREATE} Taste.`,
