        ...
        distanceRates: {
            ...
            commuterExclusions: {
                ...
                workArrangement: {
                    ...
                    officeBasedTitle: 'Büroarbeit',
                    officeBasedHelp: 'Das Mitglied pendelt zu einem Büro. Übliche Arbeitswege werden von der Erstattung ausgeschlossen.',
                    noRegularWorkplaceTitle: 'Kein fester Arbeitsplatz',
                    noRegularWorkplaceHelp: 'Das Mitglied arbeitet remote oder hat keinen festen Arbeitsplatz, daher gelten keine Regeln für den Arbeitsweg.',
                    startingPrompt: {
                        title: 'Typisches Arbeitsmodell festlegen',
                        prompt: 'Wählen Sie das Arbeitsmodell, das auf die meisten aktuellen Mitglieder zutrifft. Sie können Mitglieder später einzeln oder gesammelt aktualisieren.',
                        officeBasedHelp: 'Die meisten Mitglieder pendeln zu einem Büro. Übliche Arbeitswege werden ausgeschlossen.',
                        noRegularWorkplaceHelp: 'Die meisten Mitglieder arbeiten remote, daher gelten Ausschlüsse für den Arbeitsweg meist nicht.',
                        confirm: 'Anwenden',
                    },
                },
            },
...
Fügen Sie weitere Ausgabelimits hinzu, um den Cashflow Ihres Unternehmens zu schützen.`,
    ...
    workspaceActions: {
        ...
        workArrangement: {
            officeBased: 'Büroarbeit',
            noRegularWorkplace: 'kein fester Arbeitsplatz',
            set: ({arrangement}: {arrangement: string}) => `hat das Standard-Arbeitsmodell auf „${arrangement}“ festgelegt`,
            changed: ({arrangement, previousArrangement}: {arrangement: string; previousArrangement: string}) =>
                `hat das Standard-Arbeitsmodell auf „${arrangement}“ geändert (zuvor „${previousArrangement}“)`,
        },
        commuterExclusions: {
