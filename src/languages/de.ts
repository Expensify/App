        ...
        accounting: {
            ...
            defaultVendorHelperText: (isSet: boolean, fallbackVendorName?: string) =>
                isSet || !fallbackVendorName
                    ? `Ausgaben, die nicht automatisch zugeordnet werden, werden standardmäßig diesem Anbieter zugewiesen.`
                    : `Ausgaben, die nicht automatisch zugeordnet werden, werden standardmäßig diesem Anbieter zugewiesen. Andernfalls werden sie als ${fallbackVendorName} exportiert`,
