...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    iou: {
        ...
        error: {
            ...
            allTransactionsPendingDescription: 'Du kannst diesen Bericht nicht einreichen, da alle Transaktionen ausstehend sind. Die Buchung kann ein paar Tage dauern.',
