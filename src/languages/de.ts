...
${amount} für ${merchant} – ${date}`,
        ...
        cardUnlocked: 'Karte entsperrt!',
        cardUnlockedDescription: 'Sie werden möglicherweise aufgefordert, Ihre Karte beim nächsten Einkauf in das Lesegerät zu stecken.',
