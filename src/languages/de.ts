...
${amount} für ${merchant} – ${date}`,
    ...
    events: {
        bookEvents: 'Veranstaltungen buchen',
        title: 'Veranstaltungen',
        emptyTitle: 'Noch keine Veranstaltungen',
        emptySubtitle: 'Veranstaltungen, die du buchen kannst, werden hier angezeigt.',
        error: 'Wir konnten die Veranstaltungen nicht laden.',
