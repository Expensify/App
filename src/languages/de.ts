...
Fordere Spesendetails wie Belege und Beschreibungen an, lege Limits und Standardwerte fest und automatisiere Genehmigungen und Zahlungen – alles an einem Ort.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                ruleSummaryTitleContains: (merchantName: string) => `Wenn Händler „${merchantName}“ enthält`,
                ruleSummaryTitleExact: (merchantName: string) => \`Wenn Händler genau „\${merchantName}" ist\`,
                matchType: 'Übereinstimmungstyp',
                matchTypeContains: 'Enthält',
                matchTypeContainsDescription: 'Übereinstimmung mit Ausgaben, bei denen der Händlername den angegebenen Text enthält (Groß-/Kleinschreibung ignoriert)',
                matchTypeExact: 'Entspricht genau',
                matchTypeExactDescription: 'Übereinstimmung mit Ausgaben, bei denen der Händlername genau dem angegebenen Text entspricht',
