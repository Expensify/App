...
Fügen Sie weitere Ausgabelimits hinzu, um den Cashflow Ihres Unternehmens zu schützen.`,
                ...
                saveRule: 'Regel speichern',
                allow: 'Zulassen',
                spendRuleSectionTitle: 'Ausgaberegel',
                restrictionType: 'Beschränkungstyp',
                restrictionTypeHelpAllow: 'Buchungen werden genehmigt, wenn sie mit einem Händler oder einer Kategorie übereinstimmen und einen Höchstbetrag nicht überschreiten.',
                restrictionTypeHelpBlock: 'Belastungen werden abgelehnt, wenn sie mit einem Händler oder einer Kategorie übereinstimmen oder einen Höchstbetrag überschreiten.',
                ...
                noAllowedMerchants: 'Keine zulässigen Händler',
                addMerchantToAllowSpend: 'Händler hinzufügen, um Ausgaben zu erlauben',
                matchType: 'Übereinstimmungstyp',
                matchTypeContains: 'Enthält',
                matchTypeExact: 'Stimmt genau überein',
                spendCategory: 'Ausgabenkategorie',
                maxAmount: 'Maximalbetrag',
                maxAmountHelp: 'Jede Belastung, die diesen Betrag überschreitet, wird abgelehnt, unabhängig von Händler- und Ausgabenkategorieeinschränkungen.',
                currencyMismatchTitle: 'Währungsabweichung',
                ...
                merchantsMoreCount: ({summary, count}: {summary: string; count: number}) => `${summary}, +${count} weitere`,
                confirmErrorApplyAtLeastOneSpendRuleToOneCard: 'Wenden Sie mindestens eine Ausgabenregel auf eine Karte an',
                confirmErrorCardRequired: 'Karte ist ein Pflichtfeld',
                ...
                categoryOptions: {
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.AUTOMOTIVE]: 'Automobilbranche',
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.OFFICE_SUPPLIES]: 'Büromaterial',
                    ...
                    [CONST.SPEND_RULES.CATEGORIES.TRANSIT_AND_RIDESHARE]: 'Öffentlicher Nahverkehr und Fahrdienste',
