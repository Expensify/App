...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    deviceManagementPage: {
        ...
        description: '[de] Manage all the devices that you have logged into with your Expensify Account.',
        revoke: '[de] Revoke',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        people: {
            ...
            configureGustoSync: '[de] Configure Gusto sync.',
            syncWithGusto: '[de] Sync with Gusto',
            ...
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    ...
                    case 'mergeHRSyncTitle':
                        return '[de] Synchronizing HR Employees';
                    case 'jobDone':
                        return '[de] Waiting for imported data to load';
                    default: {
                        return `[de] Translation missing for stage: ${stage}`;
...
Add more spend rules to protect company cash flow.`,
    ...
    workspaceActions: {
        ...
        updatedCustomUnitRateName: (customUnitName: string, oldValue: string, newValue: string) => `[de] renamed the ${customUnitName} rate "${oldValue}" to "${newValue}"`,
