...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        fixBankAccount: {
            ...
            insufficientFundsBody: 'Testtransaktionen sind aufgrund unzureichender Deckung fehlgeschlagen.<br/>Sobald wieder Geld verfügbar ist, verwenden Sie die Schaltfläche unten.',
