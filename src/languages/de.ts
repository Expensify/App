...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    initialSettingsPage: {
        ...
        helpPage: {
            ...
            helpSiteDescription: '[de] Articles, tutorials, and more',
            ...
            approvedPartnerTeamTitle: '[de] Meet your Approved! partner team',
            approvedPartnerTeamDescription: '[de] A dedicated team focused on helping your firm grow, onboard clients faster, and get expert support whenever you need it.',
            partnerManagerApprovedDescription: '[de] Maximize your partnership and drive referrals',
            accountExecutiveDescription: '[de] Get clients setup successfully',
            accountManagerApprovedDescription: '[de] Ask questions and get client support',
            moreResources: '[de] More resources',
        },
...
${amount} for ${merchant} - ${date}`,
    ...
    workflowsPage: {
        ...
        configureViaGusto: '[de] Configure via Gusto.',
        gustoApprovalWorkflowLockedPrompt: '[de] Approvals are managed by your Gusto integration. To update your approval workflow, head to your Gusto connection settings.',
        goToGustoSettings: '[de] Go to Gusto settings',
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        hr: {
            ...
            gusto: {
                ...
                disconnect: '[de] Disconnect',
                lastSync: (relativeDate: string) => `[de] Last synced ${relativeDate}`,
                syncError: "[de] Can't connect to Gusto",
                disconnectTitle: '[de] Disconnect Gusto',
                disconnectPrompt: '[de] Are you sure you want to disconnect Gusto?',
                ...
                notSet: '[de] Not set',
                approvalModeDescription: '[de] Members and managers are set up to sync with Gusto.',
                approvalModeWarningTitle: '[de] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[de] Are you sure you would like to change the approval mode for this workspace? Learn more about the different Gusto-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[de] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[de] Basic approval',
                        description: '[de] All users submit to a single person for processing and approval.',
                    },
                    manager: {
                        label: '[de] Manager approval',
                        description: '[de] Employees submit reports to their direct manager configured in Gusto.',
                    },
                    custom: {
                        label: '[de] Custom approval',
                        description: '[de] I’ll manually setup approval workflows in Expensify.',
                    },
                },
                syncResults: {
                    title: '[de] Gusto sync results',
                    successTitle: '[de] Successfully synced your Gusto connection!',
                    added: '[de] Added',
                    removed: '[de] Removed',
                    skipped: '[de] Skipped',
                    employeeCount: () => ({
            ...
            zenefits: {
                ...
                disconnect: '[de] Disconnect',
                lastSync: (relativeDate: string) => `[de] Last synced ${relativeDate}`,
                syncError: "[de] Can't connect to TriNet",
                disconnectTitle: '[de] Disconnect TriNet',
                disconnectPrompt: '[de] Are you sure you want to disconnect TriNet?',
                connectionDescription: '[de] Connect TriNet to keep employee approvals in sync with your workspace.',
                approvalMode: '[de] Approval mode',
                finalApprover: '[de] Final approver',
                notSet: '[de] Not set',
                approvalModeDescription: '[de] Members and managers are set up to sync with TriNet.',
                approvalModeWarningTitle: '[de] Change approval mode?',
                approvalModeWarningPrompt: (helpSiteURL: string) =>
                    `[de] Are you sure you would like to change the approval mode for this workspace? Learn more about the different TriNet-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
                approvalModeWarningConfirm: '[de] Change approval mode',
                approvalModes: {
                    basic: {
                        label: '[de] Basic approval',
                    ...
                    manager: {
                        label: '[de] Manager approval',
                        description: '[de] Employees submit reports to their direct manager configured in TriNet.',
                    },
                    custom: {
                        label: '[de] Custom approval',
                        description: "[de] I'll manually setup approval workflows in Expensify.",
    ...
    search: {
        ...
        filters: {
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[de] Central invoicing',
            },
            is: '[de] Is',
            action: {
