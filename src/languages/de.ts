...
const translations: TranslationDeepObject<typeof en> = {
    common: {
        ...
        calendarOpened: '[de] calendar opened',
        send: '[de] Send',
        na: '[de] N/A',
...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    multifactorAuthentication: {
        ...
        revealCardDetail: {
            couldNotReveal: "[de] We couldn't reveal your card details. Please try again.",
        },
    },
    validateCodeModal: {
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            unlockBankAccount: {
                workspaceTitle: '[de] Your business bank account has been locked',
                personalTitle: '[de] Your bank account has been locked',
                workspaceSubtitle: ({policyName}: {policyName: string}) => policyName,
                personalSubtitle: '[de] Wallet',
            },
        },
        freeTrialSection: {
        ...
        yourSpend: {
            title: '[de] Your spend',
            awaitingApproval: '[de] Awaiting approval',
            repaidLast30Days: '[de] Repaid in the last 30 days',
            recentTransactions: ({lastFour}: {lastFour: string}) => `[de] Recent transactions • ${lastFour}`,
        },
        seeMore: ({count}: {count: number}) => `[de] See ${count} more`,
        ...
        gettingStartedSection: {
            ...
            inviteAccountant: '[de] Invite your accountant',
    ...
    spreadsheet: {
        ...
        importCompanyCardTransactionsPendingMessage: '[de] New cards and transactions may take some time to appear, please hang tight.',
    ...
    iou: {
        ...
        movedFromReport: (reportName: string) => `[de] moved an expense from ${reportName}`,
        movedFromReportNoName: '[de] moved an expense',
        movedTransactionTo: (reportUrl: string, reportName: string) => `[de] moved this expense to <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionToAnotherReport: '[de] moved this expense to another report',
        movedTransactionFrom: (reportUrl: string, reportName: string) => `[de] moved this expense from <a href="${reportUrl}">${reportName}</a>`,
        movedTransactionFromAnotherReport: '[de] moved this expense from another report',
        ...
        allTransactionsPendingNextStep: "[de] All transactions are pending. You can't submit this report until they post in a few days.",
        ...
        confirmPaymentReceivedModalTitle: '[de] Confirm payment received',
        receivedPayment: '[de] Received payment',
        receivedPaymentConfirmation: "[de] Please proceed only if you've already received payment outside of Expensify.",
        confirmReceivedPayment: "[de] Yes, I've received payment",
        ...
        updatedTheRequest: (valueName: string, newValueToDisplay: string, oldValueToDisplay: string) => `[de] the ${valueName} to ${newValueToDisplay} (previously ${oldValueToDisplay})`,
        ...
        error: {
            ...
            invalidReadings: '[de] Please enter both start & end readings to continue',
            ...
            unableToSubmitReport: '[de] Unable to submit report',
            allTransactionsPendingDescription: "[de] You can't submit this report because all transactions are pending. They may take a few days to post.",
            failedToSaveOdometerDraft: "[de] Couldn't save your odometer draft. Please try again.",
            ...
            receiptUploadFailedMessage: '[de] Receipt upload failed. Save the receipt, or delete the expense and lose it.',
            saveReceipt: '[de] Save receipt',
        ...
        changeApprover: {
            ...
            reassignedApproverMessage: (managerID: number) => `[de] reassigned the approver to <mention-user accountID="${managerID}"/> via a workflow update`,
            actions: {
    ...
    deviceManagementPage: {
        title: '[de] Device management',
        description:
            '[de] Manage all the devices that you have logged into with your Expensify Account. <a href="https://help.expensify.com/articles/new-expensify/settings/Manage-Logged-in-Devices">Learn more</a>.',
        revoke: '[de] Revoke',
        unknownDevice: '[de] Unknown Device',
    },
    twoFactorAuth: {
        ...
        `),
        screenshotTip: '[de] Tip: Screenshot this to save it to your photo library',
    ...
    walletPage: {
        ...
        cardActive: '[de] Active',
        bankAccountStatus: {
            active: '[de] Active',
            incomplete: '[de] Incomplete',
            pending: '[de] Pending',
            verifying: '[de] Verifying',
            locked: '[de] Locked',
            incompleteDescription: '[de] Finish adding bank account',
            pendingDescription: '[de] Please confirm test transactions',
            verifyingDescription: "[de] We're reviewing your documentation",
            lockedDescription: '[de] This account requires attention',
            finish: '[de] Finish',
            confirm: '[de] Confirm',
            unlock: '[de] Unlock',
        },
        cardFixConnection: '[de] Please fix this connection',
        cardAskAdminToFix: '[de] Please ask an admin to fix this connection',
        cardAdminFixConnection: '[de] Please fix this connection in Company Cards',
        lastSynced: (dateStr: string) => `[de] Last synced ${dateStr}`,
        assignedCards: '[de] Cards',
        assignedCardsDescription: '[de] Transactions from assigned cards sync automatically.',
...
${amount} for ${merchant} - ${date}`,
        ...
        cardUnblocked: '[de] Card unblocked!',
        cardUnblockedDescription: '[de] You may be prompted to insert your card into the reader the next time you make a purchase.',
        pinBlocked: '[de] Your card was blocked due to incorrect PIN entries.',
        unblock: '[de] Unblock',
        unblockCard: '[de] Unblock card',
    ...
    workflowsPage: {
        ...
        configureViaHR: ({provider}: {provider: string}) => `[de] Configure via ${provider}.`,
        hrApprovalWorkflowLockedPrompt: ({provider}: {provider: string}) =>
            `[de] Approvals are managed by your ${provider} integration. To update your approval workflow, head to your ${provider} connection settings.`,
        goToHRSettings: ({provider}: {provider: string}) => `[de] Go to ${provider} settings`,
    ...
    reportFraudConfirmationPage: {
        ...
        descriptionCardNotReplaced: '[de] Your card was permanently deactivated. Please contact an admin to issue a new card.',
    ...
    agentsPage: {
        title: '[de] Agents',
        subtitle: '[de] Create agents to handle your workflow. Skip the manual work and get hours back in your day.',
        newAgent: '[de] New agent',
        emptyAgents: {
            title: '[de] No agents created',
            subtitle: '[de] Stop manually doing stuff. Instruct an agent instead and save yourself lots of time.',
        },
        error: {
            genericAdd: '[de] There was a problem adding this agent',
            genericUpdate: '[de] There was a problem updating this agent',
            updateName: "[de] There was a problem updating this agent's name",
            updatePrompt: "[de] There was a problem updating this agent's instructions",
            updateAvatar: "[de] There was a problem updating this agent's avatar",
        },
    },
    addAgentPage: {
        title: '[de] New agent',
        agentName: '[de] Agent name',
        instructions: '[de] Write custom instructions',
        createAgent: '[de] Create agent',
        editAvatar: '[de] Edit avatar',
        defaultAgentName: (displayName: string) => `[de] ${displayName}'s Agent`,
        defaultPrompt:
            "[de] Reject expenses that are for gambling, movies, or other obvious non-business reasons.\n\nRemind the user to always include a receipt image that makes the tip clear.\n\nApprove the report if it's very similar to previous reports from the same user.\n\nReject reports with more than $500 in travel expenses.",
    },
    editAgentPage: {
        title: '[de] Edit agent',
        agentName: '[de] Agent name',
        instructions: '[de] Write custom instructions',
        deleteAgent: '[de] Delete agent',
        deleteAgentTitle: '[de] Delete agent?',
        deleteAgentMessage: '[de] Are you sure you want to delete this agent? This action cannot be undone.',
    },
    editAgentAvatarPage: {
        title: '[de] Edit avatar',
    },
    editAgentNamePage: {
        title: '[de] Agent name',
    },
    editAgentPromptPage: {
        title: '[de] Write custom instructions',
        error: {
            emptyPrompt: '[de] Please enter instructions for your agent.',
        },
    },
    expenseRulesPage: {
    ...
    validateCodeForm: {
        ...
        avoidScamsMessage: '[de] <strong>Avoid scams. Do not share your code with anyone.</strong> Our team will never call, text, or email you for this code.',
    ...
    onboarding: {
        ...
        listOfWorkspaces: "[de] Here's the list of workspaces you can join.",
        ...
        purpose: {
            ...
            [CONST.ONBOARDING_CHOICES.EMPLOYER]: '[de] Submit expenses to my employer',
            [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]: "[de] Manage my team's expenses",
            [CONST.ONBOARDING_CHOICES.TRACK_BUSINESS]: '[de] Track expenses for my business',
            [CONST.ONBOARDING_CHOICES.TRACK_PERSONAL]: '[de] Organize my personal spending',
        ...
        workEmail2FAError: '[de] This login is an existing account with Two-Factor Authentication (2FA) enabled.',
        mergeBlockScreen: {
            ...
            workAccountClosedSubtitle: '[de] The work account associated with this email is closed. Please contact your company admin to reactivate it, or sign up with a different email.',
        },
        tasks: {
            testDriveAdminTask: {
    ...
    statusPage: {
        ...
        addVacationDelegate: '[de] Add vacation delegate',
...
Thank you for submitting a request to unlock your bank account. Withdrawal requests can be rejected due to insufficient funds, or if the bank account has not been enabled for direct debit. We will review your case and reach out to you if we need anything else to resolve this issue.`,
    ...
    addPersonalBankAccount: {
        ...
        updatePersonalInfo: '[de] Update bank account',
        updatePersonalInfoFailure: '[de] Unable to update bank account information. Please try again later.',
        updateSuccessTitle: '[de] Bank account updated!',
        updateSuccessHeader: '[de] Bank account updated',
        updateSuccessMessage: '[de] Congrats, your bank account is set up and ready to receive reimbursements.',
    },
    ...
    messages: {
        ...
        userIsAlreadyMember: (login: string, name: string) => `[de] ${login} is already a member of ${name}`,
        userIsAlreadyAnAdmin: (login: string, name: string) => `[de] ${login} is already an admin of ${name}`,
    },
    onfidoStep: {
    ...
    workspace: {
        common: {
            ...
            cardAdminAlternateText: '[de] Manage workspace cards.',
            peopleAdminAlternateText: '[de] Manage members and approval workflows.',
            paymentsAdminAlternateText: '[de] Manage workflow payments.',
            reimbursementChoice: {
            ...
            roleName: (role?: string) => {
                switch (role) {
                    ...
                    case CONST.POLICY.ROLE.CARD_ADMIN:
                        return '[de] Card Admin';
                    case CONST.POLICY.ROLE.PEOPLE_ADMIN:
                        return '[de] People Admin';
                    case CONST.POLICY.ROLE.PAYMENTS_ADMIN:
                        return '[de] Payments Admin';
            ...
            travelInvoicing: '[de] Export travel invoicing expenses as',
            travelInvoicingVendor: '[de] Travel vendor',
            travelInvoicingPayableAccount: '[de] Travel payable account',
        },
        createdForClient: {
            title: "[de] You've created a workspace for your client!",
            description: '[de] Great news 🎉. Reach out to us if they need any help with the setup.',
        },
        receiptPartners: {
            uber: {
        ...
        qbo: {
            ...
            bankAccountDescription: '[de] Choose where to send checks from.',
            creditCardAccount: '[de] Credit card account',
            travelInvoicingDescription: '[de] Travel expenses will export as credit card charges to the QuickBooks Online account specified below.',
        ...
        xero: {
            ...
            travelInvoicingDescription: '[de] Travel expenses will export as bank transactions to the Xero account specified below.',
        ...
        sageIntacct: {
            ...
            travelInvoicingDescription: '[de] Travel expenses will export as credit card charges to the Sage Intacct account specified below.',
            creditCardAccount: '[de] Credit card account',
        ...
        certinia: {
            title: '[de] Certinia',
            prerequisites: {
                title: '[de] Before you connect',
                installBundle: '[de] For FFA Connections',
                installBundleDescription: ({href, version}: {href: string; version: string}) =>
                    `[de] Install the Expensify bundle in Salesforce by clicking this link: <a href="${href}">Install FFA Expensify Bundle (Version ${version})</a>`,
                installBundleConfirm: "[de] I've installed the bundle",
                setupContacts: '[de] Set up user and contacts',
                setupContactsBullet1:
                    "[de] Create both a User and a Contact for yourself if these don't already exist in Certinia making sure the email matches your primary email in Expensify.\n\n",
                setupContactsBullet2:
                    "[de] Create contacts for each employee who will be submitting expense reports and for each report approver. Make sure each contact's email address corresponds with the email address on the employee's Expensify account.\n\n",
                setupContactsBullet3: '[de] Set permission controls for your user for each contact/resource.\n\n',
                setupContactsConfirm: "[de] I've set up the user and contacts",
                oauth: '[de] Log in through Salesforce',
                oauthDescription: "[de] To finish setup, you'll have to sign in through Salesforce and Certinia.\n\nUse the button below to continue.",
                connectButton: '[de] Connect to Certinia',
            },
        },
        netsuite: {
            ...
            journalPostingPreference: {
                ...
                values: {
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE]: '[de] Single entry for each expense',
                    [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE]: '[de] Single, itemized entry for each report',
                },
            },
            invoiceItem: {
...
_For more detailed instructions, [visit our help site](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
        ...
        companyCards: {
            ...
            addNewCard: {
                ...
                fileImportDescription: "[de] A manual option if your bank can't send a feed.",
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
                ...
                duplicateFeedModal: {
                    title: '[de] Card feed already connected',
                    prompt: "[de] You can't add the same card feed to the same workspace twice.",
                },
                csvColumns: {
        ...
        expensifyCard: {
            ...
            exportAsCSV: '[de] Export as CSV',
            csvColumnType: '[de] Type',
            csvColumnLimitType: '[de] Limit type',
            csvColumnLimit: '[de] Limit',
            findCard: '[de] Find card',
            newCard: '[de] New card',
            name: '[de] Name',
            lastFour: '[de] Last 4',
            ...
            applyCashbackToBill: '[de] Apply cash back to my Expensify bill',
            applyCashbackToBillDescription: '[de] Cash back from the Expensify Card will be used towards payment for your Expensify bill.',
            frequency: {
                daily: '[de] Daily',
                monthly: '[de] Monthly',
            },
        ...
        moreFeatures: {
                ...
                travelInvoicing: {
                    ...
                    travelInvoicingSection: {
                        ...
                        subsections: {
                            ...
                            provisioningError:
                                "[de] We weren't able to provision some of the members of your workspace for travel invoicing. Please try again later or reach out to Concierge for assistance.",
                        },
                    },
                    disableModal: {
                    ...
                    enabled: '[de] Travel Invoicing enabled!',
            ...
            hrWarningModal: {
                disconnectText: ({integration}: {integration: string}) => `[de] To disable HR, please disconnect ${integration} from this workspace first.`,
            },
        ...
        copyPolicySettings: {
            error: '[de] An error occurred while copying workspace settings. Please try again.',
            title: '[de] Copy settings',
            selectWorkspaces: '[de] Select workspaces',
            description: '[de] Choose the workspaces you want to copy settings to, then select the settings you’d like to copy.',
            searchPlaceholder: '[de] Search workspaces',
        },
        emptyWorkspace: {
        ...
        people: {
            ...
            configureHRSync: (providerName: string) => `[de] Configure ${providerName} sync.`,
            syncWithHR: (providerName: string) => `[de] Sync with ${providerName}`,
            allMembers: '[de] All members',
            admins: '[de] Admins',
            approvers: '[de] Approvers',
            auditors: '[de] Auditors',
            emptyRoleFilter: {
                title: '[de] No members match this filter',
                subtitle: '[de] Invite a member or change the filter above.',
            },
        ...
        accounting: {
            ...
            updateCredentials: '[de] Update credentials',
            claimOffer: {
            ...
            syncTravelInvoicingSettlements: '[de] Sync travel invoicing settlements',
            ...
            chooseReconciliationAccount: {
                ...
                chooseTravelInvoicingBankAccount: '[de] Choose the bank account that your travel invoicing payments will be reconciled against.',
                ...
                travelInvoicingSettlementAccountReconciliation: (lastFourPAN: string) =>
                    `[de] Make sure this account matches your travel invoicing settlement account (ending in ${lastFourPAN}) so Continuous Reconciliation works properly.`,
            },
        },
        hr: {
            title: '[de] HR',
            connections: '[de] Connections',
            subtitle: '[de] Connect HR tools and keep employee approvals in sync.',
            connect: '[de] Connect',
            syncNow: '[de] Sync now',
            disconnect: '[de] Disconnect',
            disconnectTitle: (providerName: string) => `[de] Disconnect ${providerName}`,
            disconnectPrompt: (providerName: string) => `[de] Are you sure you want to disconnect ${providerName}?`,
            alreadyConnectedTitle: '[de] Cannot connect to multiple HR platforms',
            alreadyConnectedPrompt: '[de] You must disconnect your current HR platform before connecting another.',
            lastSync: (relativeDate: string) => `[de] Last synced ${relativeDate}`,
            syncError: (providerName: string) => `[de] Can't connect to ${providerName}`,
            connectionDescription: (providerName: string) => `[de] Connect ${providerName} to keep employee approvals in sync with your workspace.`,
            approvalMode: '[de] Approval mode',
            providerApprovalMode: (providerName: string) => `[de] ${providerName} approval mode`,
            finalApprover: '[de] Final approver',
            providerFinalApprover: (providerName: string) => `[de] ${providerName} final approver`,
            notSet: '[de] Not set',
            syncing: '[de] Syncing employees',
            syncingModalTitle: '[de] Your connection is syncing',
            syncingModalDescription: "[de] The first connection can take some time. You'll be notified of any errors.",
            approvalModeDescription: (providerName: string) => `[de] Members and managers are set up to sync with ${providerName}.`,
            approvalModeWarningTitle: '[de] Change approval mode?',
            approvalModeWarningPrompt: (providerName: string, helpSiteURL: string) =>
                `[de] Are you sure you would like to change the approval mode for this workspace? Learn more about the different ${providerName}-enabled workflow modes in our <a href="${helpSiteURL}">help site</a>.`,
            approvalModeWarningConfirm: '[de] Change approval mode',
            approvalModes: {
                basic: {label: '[de] Basic approval', description: '[de] All users submit to a single person for processing and approval.'},
                manager: {
                    label: '[de] Manager approval',
                    description: (providerName: string) => `[de] Employees submit reports to their direct manager configured in ${providerName}.`,
                },
                custom: {label: '[de] Custom approval', description: "[de] I'll manually setup approval workflows in Expensify."},
            },
            syncStageName: ({stage}: SyncStageNameConnectionsParams) => {
                switch (stage) {
                    case 'gustoSyncTitle':
                        return '[de] Synchronizing Gusto Employees';
                    case 'gustoSyncLoadData':
                        return '[de] Loading data from Gusto';
                    case 'gustoSyncProvisioning':
                        return '[de] Provisioning employees in policy';
                    case 'zenefitsSyncTitle':
                        return '[de] Synchronizing TriNet Employees';
                    case 'zenefitsSyncLoadData':
                        return '[de] Loading data from TriNet';
            ...
            syncResults: {
                title: (provider: string) => `[de] ${provider} sync complete`,
                successTitle: (provider: string) => `[de] Successfully synced your ${provider} connection!`,
                added: '[de] Added',
                removed: '[de] Removed',
                skipped: '[de] Skipped',
                employeeCount: () => ({
                    one: '[de] 1 employee',
                    other: (count: number) => `[de] ${count} employees`,
                }),
            },
            gusto: {
                title: '[de] Gusto',
        ...
        distanceRates: {
            ...
            amountPerUnit: (unit: string) => `[de] Amount per ${unit}`,
            startDate: '[de] Start date',
            endDate: '[de] End date',
            errors: {
                rateNameRequired: '[de] Rate name is required',
                existingRateName: '[de] A distance rate with this name already exists',
                nameRequired: '[de] Name is required',
                amountRequired: '[de] Amount is required',
                startDateMustBeBeforeEndDate: '[de] Start date must be before end date',
            },
        },
        editor: {
        ...
        bankAccount: {
            ...
            yourWorkspace: `[de] Your workspace is set to an unsupported currency. View the <a href="${CONST.ENABLE_GLOBAL_REIMBURSEMENT_HELP_URL}">list of supported currencies</a>.`,
...
Are you sure you want to export them again?`,
        ...
        upgrade: {
            ...
            [CONST.POLICY.CONNECTIONS.NAME.CERTINIA]: {
                title: '[de] Certinia',
                description: `[de] Enjoy automated syncing and reduce manual entries with the Expensify + Certinia integration. Align expense coding dimensions and tax sync with your Certinia setup for clearer financial visibility.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>Our Certinia integration is only available on the Control plan, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            ...
            approvalSubmit: {
                title: '[de] Approvals',
                description: '[de] Centrally configure who all members submit to by enabling approvals.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>Approvals are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            categories: {
                title: '[de] Categories',
            ...
            companyCardSubmit: {
                title: '[de] Company cards',
                description: `[de] Bring your own company card to Expensify to get automatic import, automatic categorization, customizable rule support, and integrated reconciliation.`,
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>Company card import is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            rules: {
                title: '[de] Rules',
...
Require expense details like receipts and descriptions, set limits and defaults, and automate approvals and payments – all in one place.`,
            ...
            travelSubmit: {
                title: '[de] Expensify Travel',
                description: '[de] Book discounted flights, hotels, cars, and trains globally from within Expensify, with duty of care reporting and integrated expense management.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>Expensify Travel is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            reports: {
                title: '[de] Reports',
            ...
            roles: {
                title: '[de] Roles',
                description: '[de] Assign different roles to different members to increase or decrease visibility and control as appropriate.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>Roles are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            payments: {
                title: '[de] Payments',
                description: '[de] Reimburse employees directly from your business bank account.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>Payments are available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            accounting: {
                title: '[de] Accounting',
                description:
                    '[de] Sync categories, tags, tax rates, and more from your accounting system to Expensify, as well as export expense reports and card transactions – no typing (or typos) involved!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>Accounting is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            expensifyCard: {
                title: '[de] Expensify Card',
                description:
                    '[de] Issue company cards (including virtual cards) directly from your own bank account to get realtime spend control with an unbreakable connection, and up to 2% cashback!',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>The Expensify Card is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
                upgradeButton: '[de] Upgrade and enable',
            },
            invoicing: {
                title: '[de] Invoicing',
                description: '[de] Create, send, and track professional invoices, all inside Expensify. Get paid faster with integrated payments and real-time visibility.',
                onlyAvailableOnPlan: ({formattedPrice, hasTeam2025Pricing}: {formattedPrice: string; hasTeam2025Pricing: boolean}) =>
                    `[de] <muted-text>Invoicing is available on the Collect and Control plans, starting at <strong>${formattedPrice}</strong> ${hasTeam2025Pricing ? `[de] per member per month.` : `[de] per active member per month.`}</muted-text>`,
            },
            pricing: {
                perActiveMember: '[de] per active member per month.',
                perMember: '[de] per member per month.',
            },
            note: (subscriptionLink: string) => `[de] <muted-text><a href="${subscriptionLink}">Learn more</a> about our plans and pricing.</muted-text>`,
        ...
        rules: {
            individualExpenseRules: {
                ...
                giftCard: '[de] Gift card purchases',
                handwrittenReceipt: '[de] Handwritten receipts',
...
Add more spend rules to protect company cash flow.`,
        ...
        planTypePage: {
            planTypes: {
                ...
                submit2026: {
                    label: '[de] Submit',
                    description: '[de] For employees looking to submit expenses to their employer.',
                },
            },
            description: "[de] Choose a plan that's right for you.",
            subscriptionLink: '[de] Learn more',
    ...
    workspaceActions: {
        ...
        updatedRequireCompanyCards: ({enabled}: {enabled: boolean}) => `[de] ${enabled ? '[de] enabled' : '[de] disabled'} the company card purchases requirement`,
        ...
        setItemizedReceiptRequiredAmount: (newValue: string) => `[de] set itemized receipt required amount to "${newValue}"`,
        changedItemizedReceiptRequiredAmount: (oldValue: string, newValue: string) => `[de] changed itemized receipt required amount to "${newValue}" (previously "${oldValue}")`,
        removedItemizedReceiptRequiredAmount: (oldValue: string) => `[de] removed itemized receipt required amount (previously "${oldValue}")`,
    ...
    search: {
        ...
        bulkActions: {
            ...
            editMultipleDescription: '[de] Changes will be set for all selected expenses and will override any previously set values.',
            approve: '[de] Approve',
            pay: '[de] Pay',
            delete: '[de] Delete',
            hold: '[de] Hold',
        ...
        filters: {
            ...
            card: {
                ...
                travelInvoicing: '[de] Travel invoicing',
            ...
            withdrawalType: {
                ...
                [CONST.SEARCH.WITHDRAWAL_TYPE.CENTRAL_TRAVEL_INVOICING]: '[de] Travel invoicing',
            },
            is: '[de] Is',
            action: {
        ...
        askConcierge: (message: string) => `[de] Ask Concierge “${message}”`,
        ...
        actions: {
            type: {
                ...
                exportedToIntegration: {
                    ...
                    travelCardLink: '[de] travel card expenses',
    ...
    chronos: {
        ...
        stopTimer: (duration: string) => `[de] Stop Timer (${duration})`,
    ...
    accessibilityHints: {
        ...
        openActionsMenu: '[de] Open actions menu',
        selectAllCategories: '[de] Select all categories',
        selectAllDistanceRates: '[de] Select all distance rates',
        selectAllTags: '[de] Select all tags',
        selectAllTaxes: '[de] Select all taxes',
        selectAllPerDiemRates: '[de] Select all per diem rates',
        selectAllMembers: '[de] Select all members',
        selectAllValues: '[de] Select all values',
        selectAllRules: '[de] Select all rules',
    },
    parentReportAction: {
    ...
    gps: {
        ...
        liveActivity: {
            ...
            lockScreenBadgeText: '[de] Distance',
            lockScreenTrackingText: '[de] Tracking...',
    ...
    violations: {
        ...
        missingTag: (tagName?: string) => `[de] Missing ${tagName ?? '[de] tag'}`,
        ...
        prohibitedExpense: (prohibitedExpenseTypes: string | string[]) => {
            ...
            const getProhibitedExpenseTypeText = (prohibitedExpenseType: string) => {
                switch (prohibitedExpenseType) {
                    ...
                    case 'giftCard':
                        return `[de] gift card purchases`;
                    case 'handwrittenReceipt':
                        return `[de] handwritten receipts`;
                    default:
        ...
        smartscanFailed: ({canEdit = true, missingFields = []}: {canEdit?: boolean; missingFields?: string[]}) => {
            if (missingFields.length > 0) {
                const fieldNames: Record<string, string> = {merchant: '[de] merchant', date: '[de] date', amount: '[de] amount'};
                const translated = missingFields.map((f) => fieldNames[f] ?? f);
                let fieldList = '';
                if (translated.length === 1) {
                    fieldList = translated.at(0) ?? '';
                } else if (translated.length === 2) {
                    fieldList = translated.join('[de]  and ');
                } else {
                    fieldList = `${translated.slice(0, translated.length - 1).join(', ')}, and ${translated.at(-1)}`;
                }
                return `[de] Receipt scanning failed — missing ${fieldList}.${canEdit ? '[de]  Enter details manually.' : ''}`;
            }
            return `[de] Receipt scanning failed.${canEdit ? '[de]  Enter details manually.' : ''}`;
        },
    ...
    exitSurvey: {
        ...
        goBackJustOnce: '[de] Go back just once',
    },
    listBoundary: {
    ...
    delegate: {
        ...
        addCopilot: '[de] Add a copilot to your account',
        membersCanAccessYourAccount: '[de] These members can access your account:',
        youCanAccessTheseAccounts: '[de] You can access these accounts:',
...
Here’s a *test receipt* to show you how it works:`,
    ...
    domain: {
        ...
        members: {
            ...
            error: {
                ...
                moveMemberNotPolicyAdmin:
                    '[de] Cannot move member to the domain group. You must be a Policy Admin for the Preferred Policy set on the domain group you are trying to move this user to.',
            },
        ...
        groups: {
            ...
            createGroupError: '[de] Unable to create this group. Please try again.',
            permissions: '[de] Group permissions',
            createNewGroupButton: '[de] New group',
            createGroupSubmitButton: '[de] Create group',
            expensifyCardPreferredWorkspace: '[de] Expensify Card preferred workspace',
            expensifyCardPreferredWorkspaceDescription:
                '[de] All Expensify Card transactions will be created on the Expensify Card Preferred Workspace instead of the Preferred Workspace. Enabling this feature will override the Preferred Workspace setting for Expensify Card transactions only.',
            strictlyEnforceWorkspaceRules: '[de] Strictly enforce workspace rules',
            strictlyEnforceWorkspaceRulesDescription: '[de] All workspace rules must be met before submitting a report. No manual exceptions allowed.',
            restrictExpenseWorkspaceCreation: '[de] Restrict expense workspace creation/removal',
            restrictExpenseWorkspaceCreationDescription:
                '[de] Prevent members from being able to create an expense workspace or remove themselves from an expense workspace. This is useful for preventing people from using Expensify to submit reports for use outside your domain when combined with strict workspace enforcement.',
            deleteGroup: '[de] Delete Group',
            deleteGroupDangerConfirmationModal: '[de] Delete Group',
            deleteGroupDangerConfirmationModalDescription: (defaultGroupName: string) =>
                `[de] Are you sure? This will reassign all members to the default group (${defaultGroupName}) and can't be undone.`,
            deleteGroupError: '[de] Unable to delete this group. Please try again.',
            preferredWorkspace: '[de] Preferred Workspace',
            preferredWorkspaceDescription: (enabled: boolean) => `[de] All new reports and expenses will be created on ${enabled ? '[de] selected preferred' : '[de] this'} workspace.`,
            preferredWorkspaceSelectDescription: '[de] All new expenses and reports will be created on this workspace.',
            noWorkspacesMessage: '[de] There are no workspaces on this domain. A workspace is required to enable this restriction.',
            restrictDefaultLoginSelection: '[de] Restrict default login selection',
            restrictDefaultLoginSelectionDescription: '[de] Prevent members from changing their login email away from their company domain to avoid policy restrictions.',
            expensifyCardPreferredWorkspaceDisabledMessage: '[de] To enable this setting, please first enable a preferred workspace and set up Expensify Cards on your domain.',
            findGroup: '[de] Find group',
        },
    },
};
