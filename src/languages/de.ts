...
Fordern Sie Spesendetails wie Belege und Beschreibungen an, legen Sie Limits und Standardwerte fest und automatisieren Sie Genehmigungen und Zahlungen – alles an einem Ort.`,
        ...
        rules: {
            ...
            merchantRules: {
                ...
                oneConditionPerRuleTitle: 'Nur eine Bedingung pro Regel',
                alreadyMatchesMerchantPrompt: 'Diese Regel passt bereits auf einen Händler. Setzen Sie die Regel zurück, damit sie stattdessen auf eine Kategorie passt.',
                alreadyMatchesCategoryPrompt: 'Diese Regel passt bereits auf eine Kategorie. Setzen Sie die Regel zurück, damit sie stattdessen auf einen Händler passt.',
                ...
                onlyTaxForCategoryRulesTitle: 'Für Kategorienregeln ist nur Steuer verfügbar',
                onlyTaxForCategoryRulesPrompt:
                    'Kategorienregeln können einen standardmäßigen Steuersatz festlegen. Um andere Standardwerte festzulegen, stimmen Sie stattdessen auf einen Händler ab.',
                clearIncompatibleDefaultsTitle: 'Andere Standardwerte löschen?',
                clearIncompatibleDefaultsPrompt: 'Diese Felder sind mit der Kategorie nicht kompatibel. Möchten Sie alle Felder löschen?',
...
Fügen Sie weitere Ausgabelimits hinzu, um den Cashflow Ihres Unternehmens zu schützen.`,
            ...
            newRule: {
                ...
                createAgentRuleDescription: 'Erstellen Sie flexible Regeln, die bei Bedarf ausgeführt werden.',
            },
