...
${amount} für ${merchant} – ${date}`,
    ...
    expenseRulesPage: {
        ...
        changes: {
            updateBillable: (value: boolean) => `Ausgabe ${value ? 'verrechenbar' : 'nicht abrechenbar'} aktualisieren`,
            updateCategory: (value: string) => `Kategorie auf „${value}“ aktualisieren`,
            updateComment: (value: string) => `Beschreibung in „${value}“ ändern`,
            updateMerchant: (value: string) => `Händler aktualisieren auf „${value}“`,
            updateReimbursable: (value: boolean) => `Ausgabe ${value ? 'erstattungsfähig' : 'nicht erstattungsfähig'} aktualisieren`,
            updateTag: (value: string) => `Tag auf „${value}“ aktualisieren`,
            updateTax: (value: string) => `Steuersatz auf ${value} aktualisieren`,
