...
Fügen Sie weitere Ausgabelimits hinzu, um den Cashflow Ihres Unternehmens zu schützen.`,
        ...
        campfire: {
            ...
            exportNonReimbursable: {label: 'Firmenkartenausgaben exportieren als', values: {label: 'Buchungssätze'}},
            defaultCompanyCardVendor: {
            ...
            companyCardAccount: {label: 'Firmenkartenkonto', description: 'Wählen Sie aus, wohin Firmenkartentransaktionen exportiert werden sollen.'},
            noVendorsFound: 'Keine Anbieter gefunden',
