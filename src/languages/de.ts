...
(e.g. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                fireworksTitle: '[de] All caught up',
                fireworksDescription: '[de] Upcoming to-dos will appear here.',
            },
        },
    ...
    iou: {
        ...
        error: {
            ...
            nonReimbursablePayment: '[de] Cannot pay via Expensify',
            nonReimbursablePaymentDescription: (isMultiple?: boolean) =>
                isMultiple
                    ? "[de] One or more selected reports don't have reimbursable expenses. Double check the expenses, or manually mark as paid."
                    : "[de] The report doesn't have reimbursable expenses. Double check the expenses, or manually mark as paid.",
        },
...
3. Once the feed is enabled, click Submit below and we’ll work on adding it.`,
        ...
        emptyWorkspace: {
            title: '[de] You have no workspaces',
            subtitle: '[de] Track receipts, reimburse expenses, manage travel, send invoices, and more.',
