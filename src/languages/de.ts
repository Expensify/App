...
const translations: TranslationDeepObject<typeof en> = {
  common: {
    ...
    noResultsFoundMatching: (searchString: string) =>
      `Keine Ergebnisse gefunden für „${searchString}“`,
    ...
    conjunctionTo: "bis",
    genericErrorMessage:
      "Ups ... etwas ist schiefgelaufen und Ihre Anfrage konnte nicht abgeschlossen werden. Bitte versuchen Sie es später noch einmal.",
...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
      ...
      requestModified:
        "Diese Anfrage wird gerade von einem anderen Mitglied bearbeitet",
      characterLimitExceedCounter: (length: number, limit: number) =>
        `Zeichenlimit überschritten (${length}/${limit})`,
      dateInvalid: "Bitte wähle ein gültiges Datum aus",
      invalidDateShouldBeFuture:
        "Bitte wähle das heutige oder ein zukünftiges Datum aus",
      invalidTimeShouldBeFuture:
        "Bitte wähle eine Zeit, die mindestens eine Minute in der Zukunft liegt",
      ...
      invalidTimeRange:
        "Bitte gib eine Uhrzeit im 12-Stunden-Format ein (z. B. 2:30 PM).",
    ...
    thisFeatureRequiresInternet:
      "Diese Funktion erfordert eine aktive Internetverbindung.",
    attachmentWillBeAvailableOnceBackOnline:
      "Anhang wird verfügbar, sobald du wieder online bist.",
    errorOccurredWhileTryingToPlayVideo:
      "Beim Versuch, dieses Video abzuspielen, ist ein Fehler aufgetreten.",
    ...
    zipCodeExampleFormat: ({ zipSampleFormat }: ZipCodeExampleFormatParams) =>
      zipSampleFormat ? `z. B. ${zipSampleFormat}` : "",
    ...
    downloadFailedDescription:
      "Ihr Download konnte nicht abgeschlossen werden. Bitte versuchen Sie es später noch einmal.",
    ...
    chatWithAccountManager: (accountManagerDisplayName: string) =>
      `Brauchen Sie etwas Bestimmtes? Chatten Sie mit Ihrer/Ihrem Kundenbetreuer·in, ${accountManagerDisplayName}.`,
    ...
    leaveWorkspaceConfirmation:
      "Wenn du diesen Workspace verlässt, kannst du keine Ausgaben mehr dafür einreichen.",
    leaveWorkspaceConfirmationAuditor:
      "Wenn du diesen Workspace verlässt, kannst du seine Berichte und Einstellungen nicht mehr anzeigen.",
    leaveWorkspaceConfirmationAdmin:
      "Wenn du diesen Workspace verlässt, kannst du seine Einstellungen nicht mehr verwalten.",
    ...
    unstableInternetConnection:
      "Instabile Internetverbindung. Bitte überprüfe dein Netzwerk und versuche es erneut.",
  ...
  lockedAccount: {
    ...
    description:
      "Sie dürfen diese Aktion nicht ausführen, da dieses Konto gesperrt wurde. Bitte wenden Sie sich an concierge@expensify.com, um die nächsten Schritte zu erfahren.",
  },
  location: {
    useCurrent: "Aktuellen Standort verwenden",
    notFound:
      "Wir konnten deinen Standort nicht finden. Bitte versuche es erneut oder gib eine Adresse manuell ein.",
    permissionDenied:
      "Es sieht so aus, als hätten Sie den Zugriff auf Ihren Standort verweigert.",
    please: "Bitte",
  ...
  contact: {
    ...
    importContactsText:
      "Importiere Kontakte von deinem Telefon, damit deine Lieblingsmenschen immer nur einen Fingertipp entfernt sind.",
    importContactsExplanation:
      "damit deine Lieblingsmenschen immer nur einen Fingertipp entfernt sind.",
    importContactsNativeText:
      "Nur noch ein Schritt! Gib uns grünes Licht, um deine Kontakte zu importieren.",
  },
  ...
  attachmentPicker: {
    ...
    expensifyDoesNotHaveAccessToCamera:
      "Expensify kann ohne Zugriff auf deine Kamera keine Fotos aufnehmen. Tippe auf „Einstellungen“, um die Berechtigungen zu aktualisieren.",
    attachmentError: "Anlagenfehler",
    errorWhileSelectingAttachment:
      "Beim Auswählen eines Anhangs ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    errorWhileSelectingCorruptedAttachment:
      "Beim Auswählen eines beschädigten Anhangs ist ein Fehler aufgetreten. Bitte versuchen Sie es mit einer anderen Datei.",
    ...
    sizeExceededWithLimit: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Die Anhangsgröße überschreitet das Limit von ${maxUploadSizeInMB} MB`,
    ...
    notAllowedExtension:
      "Dieser Dateityp ist nicht zulässig. Bitte versuche einen anderen Dateityp.",
    folderNotAllowedMessage:
      "Das Hochladen eines Ordners ist nicht erlaubt. Bitte versuche es mit einer anderen Datei.",
    protectedPDFNotSupported: "Passwortgeschützte PDF wird nicht unterstützt",
    attachmentImageResized:
      "Dieses Bild wurde für die Vorschau verkleinert. Für die volle Auflösung herunterladen.",
    attachmentImageTooLarge:
      "Dieses Bild ist zu groß, um vor dem Hochladen eine Vorschau anzuzeigen.",
    imageDimensionsTooLarge:
      "Die Bildabmessungen sind zu groß zum Verarbeiten. Bitte verwenden Sie ein kleineres Bild.",
    tooManyFiles: (fileLimit: number) =>
      `Sie können jeweils nur bis zu ${fileLimit} Dateien hochladen.`,
    sizeExceededWithValue: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Dateien überschreiten ${maxUploadSizeInMB} MB. Bitte versuche es erneut.`,
    ...
    sizeLimitExceeded: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Dateien dürfen nicht größer als ${maxUploadSizeInMB} MB sein. Größere Dateien werden nicht hochgeladen.`,
    maxFileLimitExceeded:
      "Sie können bis zu 30 Belege auf einmal hochladen. Weitere darüber hinaus werden nicht hochgeladen.",
    unsupportedFileType: (fileType: string) =>
      `${fileType}-Dateien werden nicht unterstützt. Es werden nur unterstützte Dateitypen hochgeladen.`,
    learnMoreAboutSupportedFiles:
      "Erfahren Sie mehr über unterstützte Formate.",
    passwordProtected:
      "Passwortgeschützte PDFs werden nicht unterstützt. Es werden nur unterstützte Dateien hochgeladen.",
  },
  dropzone: {
  ...
  filePicker: {
    ...
    errorWhileSelectingFile:
      "Beim Auswählen einer Datei ist ein Fehler aufgetreten. Bitte versuche es erneut.",
  },
  connectionComplete: {
    title: "Verbindung hergestellt",
    supportingText:
      "Du kannst dieses Fenster schließen und zur Expensify-App zurückkehren.",
  },
  avatarCropModal: {
  ...
  composer: {
    ...
    problemGettingImageYouPasted:
      "Beim Abrufen des von dir eingefügten Bildes ist ein Problem aufgetreten",
    commentExceededMaxLength: (formattedMaxLength: string) =>
      `Die maximale Kommentarlänge beträgt ${formattedMaxLength} Zeichen.`,
    taskTitleExceededMaxLength: (formattedMaxLength: string) =>
      `Die maximale Aufgaben-Titellänge beträgt ${formattedMaxLength} Zeichen.`,
  },
  baseUpdateAppModal: {
  ...
  multifactorAuthentication: {
    reviewTransaction: {
      ...
      requiresYourReview:
        "Eine Expensify Card-Transaktion erfordert unten Ihre Überprüfung.",
      ...
      areYouSureToDeny:
        "Bist du sicher? Die Transaktion wird abgelehnt, wenn du diesen Bildschirm schließt.",
      ...
      youNeedToTryAgainAtMerchant:
        "Diese Transaktion wurde nicht verifiziert, daher haben wir sie abgelehnt. Bitte versuch es erneut direkt beim Händler.",
      goBackToTheMerchant:
        "Gehe zurück zur Händlerseite, um die Transaktion fortzusetzen.",
      attemptedTransaction: "Versuchte Transaktion",
      transactionFailed: "Transaktion fehlgeschlagen",
      transactionCouldNotBeCompleted:
        "Ihre Transaktion konnte nicht abgeschlossen werden. Bitte versuchen Sie es erneut beim Händler.",
    ...
    biometricsTest: {
      ...
      successfullyAuthenticatedUsing: ({
        ...
        `Du hast dich erfolgreich mit ${authType} authentifiziert.`,
      troubleshootBiometricsStatus: ({
        registered,
      }: MultifactorAuthenticationTranslationParams) =>
        `Biometrie (${registered ? "Registriert" : "Nicht registriert"})`,
      yourAttemptWasUnsuccessful:
        "Dein Authentifizierungsversuch war nicht erfolgreich.",
      youCouldNotBeAuthenticated: "Du konntest nicht authentifiziert werden",
      areYouSureToReject:
        "Sind Sie sicher? Der Authentifizierungsversuch wird abgelehnt, wenn Sie diesen Bildschirm schließen.",
    ...
    pleaseEnableInSystemSettings: {
      start:
        "Bitte aktiviere die Gesichts-/Fingerabdrucküberprüfung oder richte einen Gerätecode auf deinem Gerät ein",
      link: "Systemeinstellungen",
      end: ".",
    },
    oops: "Ups, da ist etwas schiefgelaufen",
    looksLikeYouRanOutOfTime:
      "Anscheinend ist deine Zeit abgelaufen! Bitte versuche es noch einmal beim Händler.",
    ...
    enableQuickVerification: {
      biometrics:
        "Aktiviere eine schnelle, sichere Verifizierung mit deinem Gesicht oder Fingerabdruck. Keine Passwörter oder Codes erforderlich.",
    },
    revoke: {
      ...
      confirmationPrompt:
        "Bist du sicher? Du brauchst einen magischen Code für die nächste Verifizierung auf jedem Gerät.",
      cta: "Zugriff widerrufen",
      noDevices:
        "Sie haben keine Geräte für die Überprüfung per Gesicht/Fingerabdruck oder Passkey registriert. Wenn Sie welche registrieren, können Sie den Zugriff hier widerrufen.",
      dismiss: "Verstanden",
  ...
  validateCodeModal: {
    ...
    successfulSignInDescription:
      "Wechsle zurück zu deinem ursprünglichen Tab, um fortzufahren.",
    ...
    expiredCodeDescription:
      "Gehe zurück zum ursprünglichen Gerät und fordere einen neuen Code an",
  ...
  customApprovalWorkflow: {
    ...
    description:
      "Ihr Unternehmen verwendet in diesem Workspace einen benutzerdefinierten Genehmigungs-Workflow. Bitte führen Sie diese Aktion in Expensify Classic aus",
  ...
  emptyList: {
    [CONST.IOU.TYPE.CREATE]: {
      ...
      subtitleText:
        "Möchtest du, dass dein Team Expensify auch nutzt? Reiche ihnen einfach eine Ausgabe ein und wir kümmern uns um den Rest.",
    },
  },
  ...
  welcomeText: {
    ...
    anotherLoginPageIsOpenExplanation:
      "Du hast die Anmeldeseite in einem separaten Tab geöffnet. Bitte melde dich in diesem Tab an.",
    welcome: "Willkommen!",
    welcomeWithoutExclamation: "Willkommen",
    phrase2:
      "Geld spricht. Und jetzt, da Chat und Zahlungen an einem Ort sind, ist es auch einfach.",
    phrase3:
      "Deine Zahlungen kommen so schnell bei dir an, wie du deinen Standpunkt klarmachen kannst.",
    enterPassword: "Bitte geben Sie Ihr Passwort ein",
    welcomeNewFace: (login: string) =>
      `${login}, es ist immer schön, ein neues Gesicht hier zu sehen!`,
  ...
  samlSignIn: {
    ...
    orContinueWithMagicCode:
      "Sie können sich auch mit einem magischen Code anmelden",
    useSingleSignOn: "Einmalanmeldung verwenden",
    useMagicCode: "Magischen Code verwenden",
    launching: "Wird gestartet ...",
    oneMoment:
      "Einen Moment, wir leiten dich zum Single-Sign-On-Portal deines Unternehmens weiter.",
  },
  reportActionCompose: {
  ...
  reportActionContextMenu: {
    ...
    editAction: ({ action }: EditActionParams) =>
      `${action?.actionName === CONST.REPORT.ACTIONS.TYPE.IOU ? "Ausgabe" : "Kommentar"} bearbeiten`,
  ...
  reportActionsView: {
    ...
    beginningOfChatHistorySelfDM:
      "Dies ist dein persönlicher Bereich. Nutze ihn für Notizen, Aufgaben, Entwürfe und Erinnerungen.",
    beginningOfChatHistorySystemDM:
      "Willkommen! Lassen Sie uns Ihre Einrichtung vornehmen.",
    ...
    welcomeToRoom: ({ roomName }: WelcomeToRoomParams) =>
      `Willkommen in ${roomName}!`,
    usePlusButton: ({ additionalText }: UsePlusButtonParams) =>
      `Verwende die +‑Taste, um eine Ausgabe zu ${additionalText}.`,
    askConcierge:
      "Dies ist dein Chat mit Concierge, deinem persönlichen KI-Agenten. Ich kann fast alles, probier es aus!",
  ...
  youHaveBeenBanned:
    "Hinweis: Du wurdest vom Chatten in diesem Kanal ausgeschlossen.",
  ...
  reportArchiveReasons: {
    ...
    [CONST.REPORT.ARCHIVE_REASON.ACCOUNT_CLOSED]: ({
      ...
      `Dieser Chat ist nicht mehr aktiv, weil ${displayName} ihr Konto geschlossen hat.`,
  ...
  homePage: {
    ...
    timeSensitiveSection: {
      ...
      offer25off: {
        ...
        subtitle: ({ days }: { days: number }) =>
          `${days} ${days === 1 ? "Tag" : "Tage"} verbleibend`,
      },
      addShippingAddress: {
        title: "Wir benötigen deine Versandadresse",
        subtitle:
          "Geben Sie eine Adresse an, um Ihre Expensify Karte zu erhalten.",
        cta: "Adresse hinzufügen",
      },
      addPaymentCard: {
        title:
          "Fügen Sie eine Zahlungskarte hinzu, um Expensify weiter zu nutzen",
      ...
      activateCard: {
        ...
        subtitle:
          "Validieren Sie Ihre Karte und beginnen Sie mit dem Ausgeben.",
        cta: "Aktivieren",
      },
      reviewCardFraud: {
        ...
        titleWithDetails: ({
          ...
          amount: string;
          merchant: string;
        }) => `Überprüfe mögliche betrügerische ${amount} bei ${merchant}`,
      ...
      fixCompanyCardConnection: {
        title: ({ feedName }: { feedName: string }) =>
          feedName
            ? `${feedName}-Firmenkartenverbindung reparieren`
            : "Firmenkarte reparieren Verbindung der Firmenkarte reparieren",
        defaultSubtitle: "Arbeitsbereich",
        subtitle: ({ policyName }: { policyName: string }) =>
          `${policyName} > Unternehmenskarten`,
      },
      fixAccountingConnection: {
        title: ({ integrationName }: { integrationName: string }) =>
          `${integrationName}-Verbindung reparieren`,
        defaultSubtitle: "Arbeitsbereich",
        subtitle: ({ policyName }: { policyName: string }) =>
          `${policyName} > Buchhaltung`,
      },
      fixPersonalCardConnection: {
        title: ({ cardName }: { cardName?: string }) =>
          cardName
            ? `Verbindung der persönlichen Karte ${cardName} reparieren`
            : "Verbindung der persönlichen Karte reparieren",
        subtitle: "Wallet",
      },
    },
    ...
    discoverSection: {
      ...
      menuItemTitleNonAdmin:
        "Erfahren Sie, wie Sie Ausgaben erstellen und Berichte einreichen.",
      menuItemTitleAdmin:
        "Erfahren Sie, wie Sie Mitglieder einladen, Genehmigungsworkflows bearbeiten und Firmenkarten abstimmen.",
      menuItemDescription: "Sieh dir an, was Expensify in 2 Minuten kann",
    },
    forYouSection: {
      submit: ({ count }: { count: number }) =>
        `${count} ${count === 1 ? "Bericht" : "Berichte"} einreichen`,
      approve: ({ count }: { count: number }) =>
        `${count} ${count === 1 ? "Bericht" : "Berichte"} genehmigen`,
      pay: ({ count }: { count: number }) =>
        `Zahle ${count} ${count === 1 ? "Bericht" : "Berichte"}`,
      export: ({ count }: { count: number }) =>
        `${count} ${count === 1 ? "Bericht" : "Berichte"} exportieren`,
      begin: "Begin",
      emptyStateMessages: {
        thumbsUpStarsTitle: "Sie sind fertig!",
        thumbsUpStarsDescription:
          "Daumen hoch für Sie, bleiben Sie gespannt auf weitere Aufgaben.",
        ...
        cowboyHatDescription:
          "Alle Aufgaben sind erledigt, halten Sie Ausschau nach weiteren.",
        trophy1Title: "Nichts anzuzeigen",
        trophy1Description:
          "Geschafft! Halten Sie Ausschau nach weiteren Aufgaben.",
        palmTreeTitle: "Alles erledigt",
        palmTreeDescription:
          "Zeit zum Entspannen, aber bleiben Sie gespannt auf zukünftige Aufgaben.",
        ...
        targetDescription:
          "Weiter so, Sie bleiben auf Kurs. Schauen Sie später nach weiteren Aufgaben!",
        chairTitle: "Nichts anzuzeigen",
        chairDescription:
          "Entspannen Sie sich, wir listen anstehende Aufgaben hier auf.",
        broomTitle: "Sie sind fertig!",
        broomDescription:
          "Aufgaben sind erledigt, bleiben Sie aber gespannt auf weitere To-dos.",
        ...
        conciergeBotDescription:
          "Biep biep biep biep, schauen Sie später nach weiteren Aufgaben!",
        ...
        flashDescription:
          "Zukünftige Aufgaben werden hier blitzschnell angezeigt.",
        sunglassesTitle: "Nichts anzuzeigen",
        sunglassesDescription:
          "Zeit zum Entspannen, aber bleiben Sie gespannt auf das, was kommt!",
    ...
    upcomingTravelSection: {
      flightTo: ({ destination }: { destination: string }) =>
        `Flug nach ${destination}`,
      trainTo: ({ destination }: { destination: string }) =>
        `Zug nach ${destination}`,
  ...
  spreadsheet: {
    ...
    dragAndDrop:
      "<muted-link>Ziehen Sie Ihre Tabelle hierher und legen Sie sie ab oder wählen Sie unten eine Datei aus. Unterstützte Formate: .csv, .txt, .xls und .xlsx.</muted-link>",
    ...
    chooseSpreadsheet:
      "<muted-link>Wähle eine Tabellenkalkulationsdatei zum Importieren aus. Unterstützte Formate: .csv, .txt, .xls und .xlsx.</muted-link>",
    ...
    fieldNotMapped: (fieldName: string) =>
      `Ups! Ein erforderliches Feld („${fieldName}“) wurde nicht zugeordnet. Bitte überprüfe es und versuche es erneut.`,
    ...
    emptyMappedField: (fieldName: string) =>
      `Ups! Das Feld („${fieldName}“) enthält einen oder mehrere leere Werte. Bitte überprüfe es und versuche es erneut.`,
    ...
    importCategoriesSuccessfulDescription: ({
      ...
      if (added) {
        return added === 1
          ? "1 Kategorie wurde hinzugefügt."
          : `${added} Kategorien wurden hinzugefügt.`;
      }
      return updated === 1
        ? "1 Kategorie wurde aktualisiert."
        : `${updated} Kategorien wurden aktualisiert.`;
    },
    importMembersSuccessfulDescription: ({
      ...
      if (updated) {
        return updated > 1
          ? `${updated} Mitglieder wurden aktualisiert.`
          : "1 Mitglied wurde aktualisiert.";
      }
      return added > 1
        ? `${added} Mitglieder wurden hinzugefügt.`
        : "1 Mitglied wurde hinzugefügt.";
    },
    importTagsSuccessfulDescription: ({ tags }: { tags: number }) =>
      tags > 1
        ? `${tags} Tags wurden hinzugefügt.`
        : "1 Tag wurde hinzugefügt.",
    importMultiLevelTagsSuccessfulDescription:
      "Mehrstufige Tags wurden hinzugefügt.",
    importPerDiemRatesSuccessfulDescription: ({ rates }: { rates: number }) =>
      rates > 1
        ? `${rates} Tagessätze wurden hinzugefügt.`
        : "1 Tagegeldsatz wurde hinzugefügt.",
    importTransactionsSuccessfulDescription: ({
      ...
      transactions > 1
        ? `${transactions} Buchungen wurden importiert.`
        : "1 Transaktion wurde importiert.",
    importFailedTitle: "Import fehlgeschlagen",
    importFailedDescription:
      "Bitte stelle sicher, dass alle Felder korrekt ausgefüllt sind, und versuche es erneut. Wenn das Problem weiterhin besteht, wende dich bitte an Concierge.",
    importDescription:
      "Wähle aus, welche Felder aus deiner Tabelle zugeordnet werden sollen, indem du unten in der Dropdown-Liste neben jeder importierten Spalte klickst.",
    ...
    importSpreadsheetLibraryError:
      "Laden des Tabellenmoduls fehlgeschlagen. Bitte überprüfe deine Internetverbindung und versuche es erneut.",
  ...
  receipt: {
    ...
    alternativeMethodsForwardReceipts: ({ email }: { email: string }) =>
      `<label-text>Leite Belege weiter an <a href="mailto:${email}">${email}</a></label-text>`,
    ...
    alternativeMethodsTextReceipts: ({
      ...
      `<label-text>Belege per SMS an ${phoneNumber} senden (nur US-Nummern)</label-text>`,
    takePhoto: "Foto aufnehmen",
    cameraAccess:
      "Für das Fotografieren von Belegen ist Kamerazugriff erforderlich.",
    ...
    cameraErrorMessage:
      "Beim Aufnehmen eines Fotos ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    locationAccessTitle: "Standortzugriff erlauben",
    locationAccessMessage:
      "Der Zugriff auf deinen Standort hilft uns, deine Zeitzone und Währung überall korrekt zu halten.",
    ...
    deleteConfirmation:
      "Sind Sie sicher, dass Sie diesen Beleg löschen möchten?",
    addReceipt: "Beleg hinzufügen",
    scanFailed:
      "Der Beleg konnte nicht gescannt werden, da Händler, Datum oder Betrag fehlen.",
    crop: "Zuschneiden",
    addAReceipt: {
  ...
  quickAction: {
    ...
    noLongerHaveReportAccess:
      "Sie haben keinen Zugriff mehr auf Ihr bisheriges Ziel für Schnellaktionen. Wählen Sie unten ein neues aus.",
  ...
  iou: {
    ...
    splitDateRange: (startDate: string, endDate: string, count: number) =>
      `${startDate} bis ${endDate} (${count} Tage)`,
    ...
    totalAmountGreaterThanOriginal: (amount: string) =>
      `Der Gesamtbetrag ist um ${amount} höher als die ursprüngliche Ausgabe.`,
    totalAmountLessThanOriginal: (amount: string) =>
      `Der Gesamtbetrag ist um ${amount} geringer als die ursprüngliche Ausgabe.`,
    splitExpenseZeroAmount:
      "Bitte gib einen gültigen Betrag ein, bevor du fortfährst.",
    splitExpenseOneMoreSplit:
      "Keine Aufteilungen hinzugefügt. Füge mindestens eine hinzu, um zu speichern.",
    splitExpenseEditTitle: (amount: string, merchant: string) =>
      `${amount} für ${merchant} bearbeiten`,
    removeSplit: "Aufteilung entfernen",
    splitExpenseCannotBeEditedModalTitle:
      "Diese Ausgabe kann nicht bearbeitet werden",
    splitExpenseCannotBeEditedModalDescription:
      "Genehmigte oder bezahlte Ausgaben können nicht bearbeitet werden",
    splitExpenseDistanceErrorModalDescription:
      "Bitte behebe den Fehler beim Distanzsatz und versuche es erneut.",
    splitExpensePerDiemRateErrorModalDescription:
      "Bitte beheben Sie den Fehler beim Tagessatz und versuchen Sie es erneut.",
    paySomeone: (name?: string) => `${name ?? "jemand"} bezahlen`,
    expense: "Ausgabe",
    ...
    deletedTransaction: (amount: string, merchant: string) =>
      `hat eine Ausgabe gelöscht (${amount} für ${merchant})`,
    movedFromReport: (reportName: string) =>
      `hat eine Ausgabe verschoben${reportName ? `von ${reportName}` : ""}`,
    movedTransactionTo: (reportUrl: string, reportName?: string) =>
      `hat diese Ausgabe verschoben${reportName ? `zu <a href="${reportUrl}">${reportName}</a>` : ""}`,
    movedTransactionFrom: (reportUrl: string, reportName?: string) =>
      `hat diese Ausgabe verschoben${reportName ? `von <a href="${reportUrl}">${reportName}</a>` : ""}`,
    unreportedTransaction: (reportUrl: string) =>
      `hat diese Ausgabe in deinen <a href="${reportUrl}">persönlichen Bereich</a> verschoben`,
    movedAction: (
    ...
    pendingMatchWithCreditCardDescription:
      "Beleg wartet auf Abgleich mit Kartenumsatz. Als Barzahlung markieren, um abzubrechen.",
    markAsCash: "Als Bar markieren",
    routePending: "Routing ausstehend ...",
    automaticallyEnterExpenseDetails:
      "Concierge wird automatisch die Ausgabendetails für Sie eingeben, oder Sie können sie manuell hinzufügen.",
    receiptScanning: () => ({
    ...
    scanMultipleReceiptsDescription:
      "Fotografiere alle deine Belege auf einmal und bestätige dann die Details selbst – oder wir erledigen das für dich.",
    receiptScanInProgress: "Belegscan wird ausgeführt",
    receiptScanInProgressDescription:
      "Beleg-Scan läuft. Später erneut prüfen oder Details jetzt eingeben.",
    ...
    receiptStatusText:
      "Nur du kannst diesen Beleg sehen, während er gescannt wird. Schau später noch einmal vorbei oder gib die Details jetzt ein.",
    receiptScanningFailed:
      "Belegerkennung fehlgeschlagen. Bitte geben Sie die Details manuell ein.",
    transactionPendingDescription:
      "Transaktion ausstehend. Die Buchung kann ein paar Tage dauern.",
    companyInfo: "Unternehmensinfos",
    companyInfoDescription:
      "Wir benötigen noch ein paar weitere Angaben, bevor du deine erste Rechnung senden kannst.",
    yourCompanyName: "Ihr Firmenname",
    yourCompanyWebsite: "Website Ihres Unternehmens",
    yourCompanyWebsiteNote:
      "Wenn Sie keine Website haben, können Sie stattdessen das LinkedIn- oder Social-Media-Profil Ihres Unternehmens angeben.",
    invalidDomainError:
      "Du hast eine ungültige Domain eingegeben. Um fortzufahren, gib bitte eine gültige Domain ein.",
    publicDomainError:
      "Sie haben eine öffentliche Domain eingegeben. Um fortzufahren, geben Sie bitte eine private Domain ein.",
    expenseCount: () => {
      return {
        one: "1 Ausgabe",
    ...
    settlePersonal: (formattedAmount?: string) =>
      formattedAmount
        ? `${formattedAmount} als Privatperson bezahlen`
        : `Mit Privatkonto bezahlen`,
    settleWallet: (formattedAmount?: string) =>
      formattedAmount
        ? `${formattedAmount} mit Wallet bezahlen`
        : `Mit Wallet bezahlen`,
    settlePayment: (formattedAmount: string) => `${formattedAmount} bezahlen`,
    settleBusiness: (formattedAmount?: string) =>
      formattedAmount
        ? `${formattedAmount} als Unternehmen bezahlen`
        : `Mit Geschäftskonto bezahlen`,
    payElsewhere: (formattedAmount?: string) =>
      formattedAmount
        ? `${formattedAmount} als bezahlt markieren`
        : `Als bezahlt markieren`,
    settleInvoicePersonal: (amount?: string, last4Digits?: string) =>
      amount
        ? `${amount} mit persönlichem Konto ${last4Digits} bezahlt`
        : `Mit Privatkonto bezahlt`,
    settleInvoiceBusiness: (amount?: string, last4Digits?: string) =>
      amount
        ? `${amount} mit Geschäftskonto ${last4Digits} bezahlt`
        : `Mit Geschäftskonto bezahlt`,
    payWithPolicy: (policyName: string, formattedAmount?: string) =>
      formattedAmount
        ? `Bezahle ${formattedAmount} über ${policyName}`
        : `Bezahlen über ${policyName}`,
    businessBankAccount: (amount?: string, last4Digits?: string) =>
      amount
        ? `${amount} mit Bankkonto ${last4Digits} bezahlt`
        : `bezahlt mit Bankkonto ${last4Digits}`,
    ...
    expenseAmount: (formattedAmount: string, comment?: string) =>
      `${formattedAmount}${comment ? `für ${comment}` : ""}`,
    submitted: (memo?: string) =>
      `eingereicht${memo ? `, mit dem Vermerk ${memo}` : ""}`,
    ...
    waitingOnBankAccount: ({
      ...
      `hat die Zahlung gestartet, wartet aber darauf, dass ${submitterDisplayName} ein Bankkonto hinzufügt.`,
    ...
    paidElsewhere: ({ payer, comment }: PaidElsewhereParams = {}) =>
      `${payer ? `${payer} ` : ""}als bezahlt markiert${comment ? `und sagt „${comment}“` : ""}`,
    paidWithExpensify: (payer?: string) =>
      `${payer ? `${payer} ` : ""}mit Wallet bezahlt`,
    ...
    pendingConversionMessage:
      "Die Gesamtsumme wird aktualisiert, sobald du wieder online bist",
    changedTheExpense: "hat die Ausgabe geändert",
    setTheRequest: (valueName: string, newValueToDisplay: string) =>
      `den Wert ${valueName} auf ${newValueToDisplay}`,
    ...
    removedTheRequest: (valueName: string, oldValueToDisplay: string) =>
      `der/die/das ${valueName} (zuvor ${oldValueToDisplay})`,
    updatedTheRequest: ({
      valueName,
      newValueToDisplay,
      oldValueToDisplay,
    }: UpdatedTheRequestParams) =>
      `die/den/das ${valueName} auf ${newValueToDisplay} (zuvor ${oldValueToDisplay})`,
    ...
    basedOnMCC: ({ rulesLink }: { rulesLink: string }) =>
      rulesLink
        ? `basierend auf den <a href="${rulesLink}">Workspace-Regeln</a>`
        : "basierend auf dem Workspace-Regelwerk",
    ...
    invoiceReportName: ({
      ...
      `Rechnungsbericht Nr. ${linkedReportID}`,
    threadPaySomeoneReportName: (formattedAmount: string, comment?: string) =>
      `${formattedAmount} gesendet${comment ? `für ${comment}` : ""}`,
    ...
    error: {
      invalidCategoryLength:
        "Der Kategoriename überschreitet 255 Zeichen. Bitte kürzen Sie ihn oder wählen Sie eine andere Kategorie.",
      invalidTagLength:
        "Der Tagname überschreitet 255 Zeichen. Bitte kürzen Sie ihn oder wählen Sie einen anderen Tag.",
      invalidAmount: "Bitte gib vor dem Fortfahren einen gültigen Betrag ein",
      invalidDistance:
        "Bitte gib eine gültige Entfernung ein, bevor du fortfährst",
      ...
      distanceAmountTooLarge:
        "Der Gesamtbetrag ist zu hoch. Verringere die Entfernung oder reduziere den Satz.",
      distanceAmountTooLargeReduceDistance:
        "Der Gesamtbetrag ist zu hoch. Verringere die Entfernung.",
      distanceAmountTooLargeReduceRate:
        "Der Gesamtbetrag ist zu hoch. Reduziere den Satz.",
      odometerReadingTooLarge: (formattedMax: string) =>
        `Kilometerstände dürfen ${formattedMax} nicht überschreiten.`,
      invalidIntegerAmount:
        "Bitte gib einen vollen Dollarbetrag ein, bevor du fortfährst",
      invalidTaxAmount: (amount: string) =>
        `Der maximale Steuerbetrag ist ${amount}`,
      invalidSplit:
        "Die Summe der Aufteilungen muss dem Gesamtbetrag entsprechen",
      invalidSplitParticipants:
        "Bitte gib für mindestens zwei Teilnehmende einen Betrag größer als null ein",
      invalidSplitYourself:
        "Bitte gib für deine Aufteilung einen von null verschiedenen Betrag ein",
      ...
      genericCreateFailureMessage:
        "Unerwarteter Fehler beim Einreichen dieser Ausgabe. Bitte versuche es später noch einmal.",
      genericCreateInvoiceFailureMessage:
        "Unerwarteter Fehler beim Senden dieser Rechnung. Bitte versuche es später noch einmal.",
      genericHoldExpenseFailureMessage:
        "Unerwarteter Fehler beim Zurückhalten dieser Ausgabe. Bitte versuche es später erneut.",
      genericUnholdExpenseFailureMessage:
        "Unerwarteter Fehler beim Aufheben der Sperre für diese Ausgabe. Bitte versuche es später noch einmal.",
      receiptDeleteFailureError:
        "Unerwarteter Fehler beim Löschen dieses Belegs. Bitte versuche es später noch einmal.",
      ...
      receiptFailureMessageShort:
        "Beim Hochladen Ihres Belegs ist ein Fehler aufgetreten.",
      genericDeleteFailureMessage:
        "Unerwarteter Fehler beim Löschen dieses Belegs. Bitte versuche es später erneut.",
      genericEditFailureMessage:
        "Unerwarteter Fehler beim Bearbeiten dieser Ausgabe. Bitte versuche es später noch einmal.",
      ...
      atLeastTwoDifferentWaypoints:
        "Bitte gib mindestens zwei verschiedene Adressen ein",
      splitExpenseMultipleParticipantsErrorMessage:
        "Eine Ausgabe kann nicht zwischen einem Workspace und anderen Mitgliedern aufgeteilt werden. Bitte aktualisiere deine Auswahl.",
      invalidMerchant: "Bitte gib einen gültigen Händler ein",
      atLeastOneAttendee:
        "Mindestens eine teilnehmende Person muss ausgewählt werden",
      ...
      invalidRate:
        "Satz nicht gültig für diesen Workspace. Bitte wähle einen verfügbaren Satz aus dem Workspace aus.",
      endDateBeforeStartDate:
        "Das Enddatum darf nicht vor dem Startdatum liegen",
      endDateSameAsStartDate:
        "Das Enddatum darf nicht mit dem Startdatum übereinstimmen",
    ...
    dismissReceiptErrorConfirmation:
      "Achtung! Wenn du diesen Fehler schließt, wird deine hochgeladene Quittung vollständig entfernt. Bist du sicher?",
    ...
    selectUnreportedExpense:
      "Wähle mindestens eine Ausgabe aus, um sie dem Bericht hinzuzufügen.",
    emptyStateUnreportedExpenseTitle: "Keine nicht gemeldeten Ausgaben",
    emptyStateUnreportedExpenseSubtitle:
      "Sie scheinen keine nicht eingereichten Ausgaben zu haben. Erstellen Sie unten eine.",
    ...
    expenseOnHold:
      "Diese Ausgabe wurde zurückgestellt. Bitte lies die Kommentare, um die nächsten Schritte zu erfahren.",
    expensesOnHold:
      "Alle Ausgaben wurden angehalten. Bitte prüfen Sie die Kommentare für die nächsten Schritte.",
    expenseDuplicate:
      "Diese Ausgabe hat ähnliche Details wie eine andere. Bitte überprüfe die Duplikate, um fortzufahren.",
    someDuplicatesArePaid:
      "Einige dieser Duplikate wurden bereits genehmigt oder bezahlt.",
    reviewDuplicates: "Duplikate prüfen",
    keepAll: "Alle behalten",
    noDuplicatesTitle: "Alles erledigt!",
    noDuplicatesDescription:
      "Es gibt hier keine doppelten Transaktionen zur Überprüfung.",
    confirmApprove: "Genehmigungsbetrag bestätigen",
    confirmApprovalAmount:
      "Nur regelkonforme Ausgaben genehmigen oder den gesamten Bericht genehmigen.",
    confirmApprovalAllHoldAmount: () => ({
      one: "Diese Ausgabe ist zurückgestellt. Möchtest du sie trotzdem genehmigen?",
      other:
        "Diese Ausgaben sind zurückgestellt. Möchtest du sie trotzdem genehmigen?",
    }),
    confirmPay: "Zahlungsbetrag bestätigen",
    confirmPayAmount:
      "Bezahle, was nicht zurückgestellt ist, oder bezahle den gesamten Bericht.",
    confirmPayAllHoldAmount: () => ({
      one: "Diese Ausgabe ist angehalten. Möchtest du trotzdem bezahlen?",
      other:
        "Diese Ausgaben sind angehalten. Möchtest du sie trotzdem bezahlen?",
    }),
    payOnly: "Nur zahlen",
    approveOnly: "Nur genehmigen",
    holdEducationalTitle: "Soll diese Ausgabe zurückgestellt werden?",
    whatIsHoldExplain:
      "Hold ist wie ein „Pause“-Knopf für eine Ausgabe, bis du bereit bist, sie einzureichen.",
    holdIsLeftBehind:
      "Zurückgehaltene Ausgaben werden ausgelassen, selbst wenn du einen gesamten Bericht einreichst.",
    unholdWhenReady:
      "Gib Ausgaben wieder frei, wenn du bereit bist, sie einzureichen.",
    changePolicyEducational: {
      title: "Du hast diesen Bericht verschoben!",
      description:
        "Überprüfe diese Punkte sorgfältig, da sie sich beim Verschieben von Berichten in einen neuen Workspace häufig ändern.",
      reCategorize:
        "<strong>Kategorisiere alle Ausgaben neu</strong>, um die Regeln des Arbeitsbereichs einzuhalten.",
      workflows:
        "Für diesen Bericht gilt jetzt möglicherweise ein anderer <strong>Genehmigungs-Workflow.</strong>",
    },
    ...
    chooseARate:
      "Wähle einen Rückerstattungssatz pro Meile oder Kilometer für den Workspace aus",
    ...
    bookingPendingDescription:
      "Diese Buchung ist ausstehend, weil sie noch nicht bezahlt wurde.",
    bookingArchived: "Diese Buchung ist archiviert",
    bookingArchivedDescription:
      "Diese Buchung ist archiviert, weil das Reisedatum verstrichen ist. Füge bei Bedarf eine Ausgabe für den endgültigen Betrag hinzu.",
    ...
    deleteSubrateConfirmation:
      "Möchtest du diesen Untertarif wirklich löschen?",
    quantity: "Menge",
    ...
    reject: {
      ...
      educationalText:
        "Wenn du noch nicht bereit bist, eine Ausgabe zu genehmigen oder zu bezahlen, kannst du sie zurückstellen oder ablehnen.",
      holdExpenseTitle:
        "Belege zurückstellen, um vor der Genehmigung oder Zahlung weitere Details anzufordern.",
      approveExpenseTitle:
        "Genehmige andere Ausgaben, während zurückgehaltene Ausgaben dir weiterhin zugewiesen bleiben.",
      heldExpenseLeftBehindTitle:
        "Zurückgehaltene Ausgaben werden ausgelassen, wenn du einen gesamten Bericht genehmigst.",
      rejectExpenseTitle:
        "Lehne eine Ausgabe ab, die du nicht genehmigen oder bezahlen möchtest.",
      reasonPageTitle: "Ausgabe ablehnen",
      reasonPageDescription:
        "Erkläre, warum du diese Ausgabe nicht genehmigen wirst.",
      rejectReason: "Ablehnungsgrund",
      markAsResolved: "Als gelöst markieren",
      rejectedStatus:
        "Diese Ausgabe wurde abgelehnt. Wir warten darauf, dass du die Probleme behebst und als gelöst markierst, um das Einreichen zu ermöglichen.",
      reportActions: {
    ...
    moveExpensesError:
      "Sie können Pauschalspesen nicht in Berichte anderer Arbeitsbereiche verschieben, da die Pauschalsätze je nach Arbeitsbereich unterschiedlich sein können.",
    changeApprover: {
      ...
      changedApproverMessage: (managerID: number) =>
        `Genehmigenden in <mention-user accountID="${managerID}"/> geändert`,
      actions: {
        addApprover: "Genehmiger hinzufügen",
        addApproverSubtitle:
          "Füge dem bestehenden Workflow eine weitere genehmigende Person hinzu.",
        bypassApprovers: "Genehmigende umgehen",
        bypassApproversSubtitle:
          "Sich selbst als finale:n Genehmiger:in zuweisen und alle verbleibenden Genehmiger:innen überspringen.",
      },
      addApprover: {
        subtitle:
          "Wählen Sie eine zusätzliche genehmigende Person für diesen Bericht, bevor wir ihn durch den restlichen Genehmigungsworkflow leiten.",
      },
    },
    chooseWorkspace: "Wähle einen Arbeitsbereich",
    routedDueToDEW: (to: string) =>
      `Report aufgrund des benutzerdefinierten Genehmigungsworkflows an ${to} weitergeleitet`,
    timeTracking: {
      hoursAt: (hours: number, rate: string) =>
        `${hours} ${hours === 1 ? "Stunde" : "Stunden"} @ ${rate} / Stunde`,
      hrs: "Std.",
      hours: "Stunden",
      ratePreview: (rate: string) => `${rate} / Stunde`,
      amountTooLargeError:
        "Der Gesamtbetrag ist zu hoch. Verringere die Stunden oder reduziere den Satz.",
    },
    ...
    rulesModifiedFields: {
      reimbursable: (value: boolean) =>
        value
          ? "hat die Ausgabe als „erstattungsfähig“ markiert"
          : "hat die Ausgabe als „nicht erstattungsfähig“ markiert",
      billable: (value: boolean) =>
        value
          ? "hat die Ausgabe als „verrechenbar“ markiert"
          : "hat die Ausgabe als „nicht abrechenbar“ markiert",
      tax: (value: string, isFirst: boolean) =>
        isFirst
          ? `Steuersatz auf „${value}“ festlegen`
          : `Steuersatz auf „${value}“`,
      reportName: (value: string) =>
        `hat diese Ausgabe in den Bericht „${value}“ verschoben`,
      common: (
        key:
        ...
        return isFirst
          ? `setze ${field} auf „${value}“`
          : `${field} zu „${value}“`;
      },
      formatPersonalRules: (fragments: string, route: string) =>
        `${fragments} über <a href="${route}">Regeln für persönliche Ausgaben</a>`,
      formatPolicyRules: (fragments: string, route: string) =>
        `${fragments} über <a href="${route}">Workspace-Regeln</a>`,
    },
    failedToAutoSubmitViaDEW: (reason: string) =>
      `Senden des Berichts über <a href="${CONST.SELECT_WORKFLOWS_HELP_URL}">Übermittlungen verzögern</a> fehlgeschlagen. ${reason}`,
    failedToSubmitViaDEW: (reason: string) =>
      `Der Bericht konnte nicht übermittelt werden. ${reason}`,
    failedToAutoApproveViaDEW: (reason: string) =>
      `Genehmigung über <a href="${CONST.CONFIGURE_EXPENSE_REPORT_RULES_HELP_URL}">Workspace-Regeln</a> fehlgeschlagen. ${reason}`,
    failedToApproveViaDEW: (reason: string) =>
      `Genehmigung fehlgeschlagen. ${reason}`,
  ...
  transactionMerge: {
    ...
    confirmationPage: {
      ...
      pageTitle:
        "Bestätige die Details, die du behältst. Die Details, die du nicht behältst, werden gelöscht.",
  ...
  loginField: {
    numberHasNotBeenValidated:
      "Die Nummer wurde noch nicht verifiziert. Klicke auf die Schaltfläche, um den Bestätigungslink per SMS erneut zu senden.",
    emailHasNotBeenValidated:
      "Die E‑Mail wurde noch nicht verifiziert. Klicke auf die Schaltfläche, um den Bestätigungslink per SMS erneut zu senden.",
  },
  avatarWithImagePicker: {
    ...
    deleteWorkspaceError:
      "Entschuldigung, beim Löschen deines Arbeitsbereichsavatars ist ein unerwartetes Problem aufgetreten",
    sizeExceeded: ({ maxUploadSizeInMB }: SizeExceededParams) =>
      `Das ausgewählte Bild überschreitet die maximale Uploadgröße von ${maxUploadSizeInMB} MB.`,
    ...
    notAllowedExtension: ({ allowedExtensions }: NotAllowedExtensionParams) =>
      `Das Profilbild muss einer der folgenden Typen sein: ${allowedExtensions.join(", ")}.`,
  },
  avatarPage: {
  ...
  nextStep: {
    ...
    eta: {
      ...
      [CONST.NEXT_STEP.ETA_KEY.SEMI_MONTHLY]:
        "am 1. und 16. eines jeden Monats",
  ...
  profilePage: {
    ...
    timezone: "Zeitzone",
    invalidFileMessage:
      "Ungültige Datei. Bitte versuchen Sie ein anderes Bild.",
    avatarUploadFailureMessage:
      "Beim Hochladen des Avatars ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    online: "Online",
    offline: "Offline",
    ...
    publicSection: {
      title: "Öffentlich",
      subtitle:
        "Diese Angaben werden in deinem öffentlichen Profil angezeigt. Jede:r kann sie sehen.",
    },
    privateSection: {
      title: "Privat",
      subtitle:
        "Diese Angaben werden für Reisen und Zahlungen verwendet. Sie werden niemals in deinem öffentlichen Profil angezeigt.",
    },
  },
  securityPage: {
    title: "Sicherheitsoptionen",
    subtitle:
      "Aktiviere die Zwei-Faktor-Authentifizierung, um dein Konto zu schützen.",
    goToSecurity: "Zur Sicherheitsseite zurückkehren",
  },
  shareCodePage: {
    title: "Ihr Code",
    subtitle:
      "Lade Mitglieder zu Expensify ein, indem du deinen persönlichen QR-Code oder Empfehlungslink teilst.",
  },
  pronounsPage: {
    pronouns: "Pronomen",
  ...
  contacts: {
    ...
    featureRequiresValidate:
      "Für diese Funktion müssen Sie Ihr Konto verifizieren.",
    ...
    enterMagicCode: (contactMethod: string) =>
      `Bitte gib den magischen Code ein, der an ${contactMethod} gesendet wurde. Er sollte innerhalb einer oder zwei Minuten ankommen.`,
    ...
    removeAreYouSure:
      "Sind Sie sicher, dass Sie diese Kontaktmethode entfernen möchten? Diese Aktion kann nicht rückgängig gemacht werden.",
    failedNewContact:
      "Das Hinzufügen dieser Kontaktmethode ist fehlgeschlagen.",
    genericFailureMessages: {
      requestContactMethodValidateCode:
        "Senden eines neuen Magic-Codes fehlgeschlagen. Bitte warten Sie einen Moment und versuchen Sie es erneut.",
      validateSecondaryLogin:
        "Falscher oder ungültiger Magic-Code. Bitte versuche es erneut oder fordere einen neuen Code an.",
      deleteContactMethod:
        "Kontaktmethode konnte nicht gelöscht werden. Bitte wende dich für Hilfe an Concierge.",
      setDefaultContactMethod:
        "Fehler beim Festlegen einer neuen Standardkontaktmethode. Bitte wende dich für Hilfe an Concierge.",
      addContactMethod:
        "Diese Kontaktmethode konnte nicht hinzugefügt werden. Bitte wende dich für Hilfe an Concierge.",
    ...
    yourDefaultContactMethodRestrictedSwitch:
      "Dies ist Ihre derzeitige standardmäßige Kontaktmethode. Ihr Unternehmen hat das Entfernen oder Ändern eingeschränkt.",
  },
  pronouns: {
    coCos: "Co / Cos",
  ...
  updateRequiredView: {
    ...
    pleaseInstall:
      "Bitte auf die neueste Version von New Expensify aktualisieren",
    pleaseInstallExpensifyClassic:
      "Bitte installiere die neueste Version von Expensify",
    toGetLatestChanges:
      "Für Mobilgeräte lade die neueste Version herunter und installiere sie. Für das Web aktualisiere deinen Browser.",
  ...
  initialSettingsPage: {
    ...
    aboutPage: {
      description:
        "Die neue Expensify-App wird von einer Community aus Open-Source-Entwickler:innen aus der ganzen Welt entwickelt. Hilf uns, die Zukunft von Expensify zu gestalten.",
    ...
    troubleshoot: {
      ...
      confirmResetDescription:
        "Alle nicht gesendeten Entwurfsnachrichten gehen verloren, aber alle anderen Daten sind sicher.",
      ...
      simulateFailingNetworkRequests:
        "Fehlgeschlagene Netzwerk­anfragen simulieren",
      ...
      maskExportOnyxStateData:
        "Empfindliche Mitgliedsdaten beim Export des Onyx-Status maskieren",
      ...
      usingImportedState:
        "Du verwendest importierten Status. Tippe hier, um ihn zu löschen.",
      debugMode: "Debug-Modus",
      invalidFile: "Ungültige Datei",
      invalidFileDescription:
        "Die Datei, die Sie zu importieren versuchen, ist ungültig. Bitte versuchen Sie es erneut.",
      ...
      sentryHighlightedSpanOpsPlaceholder:
        "ui.interaktion.klick, navigation, ui.laden",
    },
    security: "Sicherheit",
    signOut: "Abmelden",
    restoreStashed: "Gespeicherten Login wiederherstellen",
    signOutConfirmationText:
      "Alle Offline-Änderungen gehen verloren, wenn du dich abmeldest.",
    versionLetter: "v",
  ...
  closeAccountPage: {
    ...
    reasonForLeavingPrompt:
      "Wir würden es sehr bedauern, wenn du gehst! Würdest du uns bitte sagen, warum, damit wir uns verbessern können?",
    enterMessageHere: "Nachricht hier eingeben",
    closeAccountWarning:
      "Das Schließen Ihres Kontos kann nicht rückgängig gemacht werden.",
    closeAccountPermanentlyDeleteData:
      "Möchtest du dein Konto wirklich löschen? Dadurch werden alle offenen Ausgaben dauerhaft gelöscht.",
    enterDefaultContactToConfirm:
      "Bitte gib deine Standard-Kontaktmethode ein, um zu bestätigen, dass du dein Konto schließen möchtest. Deine Standard-Kontaktmethode ist:",
    ...
    enterYourDefaultContactMethod:
      "Bitte gib deine Standard-Kontaktmethode ein, um dein Konto zu schließen.",
  },
  mergeAccountsPage: {
    mergeAccount: "Konten zusammenführen",
    accountDetails: {
      accountToMergeInto: (login: string) =>
        `Gib das Konto ein, das du mit <strong>${login}</strong> zusammenführen möchtest.`,
      notReversibleConsent:
    ...
    accountValidate: {
      ...
      enterMagicCode: (login: string) =>
        `Um fortzufahren, gib bitte den magischen Code ein, der an <strong>${login}</strong> gesendet wurde.`,
      errors: {
        incorrectMagicCode:
          "Falscher oder ungültiger Magic-Code. Bitte versuche es erneut oder fordere einen neuen Code an.",
        fallback:
    ...
    mergePendingSAML: {
      ...
      limitedSupport:
        "Wir unterstützen das Zusammenführen von Konten in New Expensify noch nicht. Bitte führe diese Aktion stattdessen in Expensify Classic aus.",
      reachOutForHelp:
        "<muted-text><centered-text>Wende dich bei Fragen gerne an den <concierge-link>Concierge</concierge-link>!</centered-text></muted-text>",
      goToExpensifyClassic: "Zu Expensify Classic wechseln",
    },
    ...
    mergeFailureTooManyAttempts: {
      ...
      description:
        "Es gab zu viele Versuche, Konten zusammenzuführen. Bitte versuche es später erneut.",
    },
    mergeFailureUnvalidatedAccount: {
      description:
        "Sie können nicht mit anderen Konten zusammenführen, weil dieses Konto nicht verifiziert ist. Bitte verifizieren Sie das Konto und versuchen Sie es erneut.",
    },
    mergeFailureSelfMerge: {
      description:
        "Ein Konto kann nicht mit sich selbst zusammengeführt werden.",
    },
  ...
  lockAccountPage: {
    ...
    domainAdminsDescription:
      "Für Domain-Admins: Dadurch werden auch alle Aktivitäten der Expensify Karte und alle Administratoraktionen in Ihrer/Ihren Domain(s) pausiert.",
    areYouSure: "Möchtest du dein Expensify-Konto wirklich sperren?",
    onceLocked:
      "Sobald Ihr Konto gesperrt ist, wird es eingeschränkt, bis eine Entsperrungsanfrage gestellt und eine Sicherheitsprüfung durchgeführt wurde",
    unlockTitle: "Wir haben Ihre Anfrage erhalten",
    unlockDescription:
      "Wir überprüfen das Konto, um sicherzustellen, dass es sicher entsperrt werden kann, und melden uns bei Fragen über Concierge.",
  },
  ...
  unlockAccountPage: {
    ...
    chatToConciergeToUnlock:
      "Chatte mit Concierge, um Sicherheitsbedenken zu klären und dein Konto zu entsperren.",
    chatWithConcierge: "Mit Concierge chatten",
  },
  twoFactorAuth: {
    ...
    explainProcessToRemove:
      "Um die Zwei-Faktor-Authentifizierung (2FA) zu deaktivieren, gib bitte einen gültigen Code aus deiner Authentifizierungs-App ein.",
    explainProcessToRemoveWithRecovery:
      "Um die Zwei-Faktor-Authentifizierung (2FA) zu deaktivieren, gib bitte einen gültigen Wiederherstellungscode ein.",
    disabled: "Die Zwei-Faktor-Authentifizierung ist jetzt deaktiviert",
    noAuthenticatorApp:
      "Sie benötigen keine Authentifizierungs-App mehr, um sich bei Expensify anzumelden.",
    ...
    codesLoseAccess: dedent(`
        ...
        `),
    errorStepCodes:
      "Bitte kopiere oder lade die Codes herunter, bevor du fortfährst",
    stepVerify: "Bestätigen",
    scanCode: "Scanne den QR-Code mit deinem",
    authenticatorApp: "Authentifizierungs-App",
    addKey:
      "Oder füge diesen geheimen Schlüssel zu deiner Authentifizierungs-App hinzu:",
    enterCode:
      "Gib dann den sechsstelligen Code ein, der von deiner Authentifizierungs-App generiert wurde.",
    stepSuccess: "Fertig",
    ...
    pleaseEnableTwoFactorAuth:
      "Bitte aktiviere die Zwei-Faktor-Authentifizierung.",
    twoFactorAuthIsRequiredDescription:
      "Aus Sicherheitsgründen erfordert Xero eine Zwei-Faktor-Authentifizierung, um die Integration zu verbinden.",
    twoFactorAuthIsRequiredForAdminsHeader:
      "Zwei-Faktor-Authentifizierung erforderlich",
    twoFactorAuthIsRequiredForAdminsTitle:
      "Bitte aktiviere die Zwei-Faktor-Authentifizierung",
    twoFactorAuthIsRequiredXero:
      "Ihre Xero-Buchhaltungsverbindung erfordert eine Zwei-Faktor-Authentifizierung.",
    twoFactorAuthIsRequiredCompany:
      "Ihr Unternehmen verlangt eine Zwei-Faktor-Authentifizierung.",
    twoFactorAuthCannotDisable: "2FA kann nicht deaktiviert werden",
    twoFactorAuthRequired:
      "Die Zwei-Faktor-Authentifizierung (2FA) ist für Ihre Xero-Verbindung erforderlich und kann nicht deaktiviert werden.",
  },
  recoveryCodeForm: {
    error: {
      pleaseFillRecoveryCode: "Bitte gib deinen Wiederherstellungscode ein",
      incorrectRecoveryCode:
        "Falscher Wiederherstellungscode. Bitte versuche es erneut.",
    },
  ...
  twoFactorAuthForm: {
    error: {
      ...
      incorrect2fa:
        "Falscher Zwei-Faktor-Authentifizierungscode. Bitte versuche es erneut.",
    },
  },
  ...
  privateNotes: {
    ...
    personalNoteMessage:
      "Notizen zu diesem Chat hier festhalten. Nur du kannst diese Notizen hinzufügen, bearbeiten oder anzeigen.",
    sharedNoteMessage:
      "Führe hier Notizen zu diesem Chat. Expensify-Mitarbeitende und andere Mitglieder mit der Domain team.expensify.com können diese Notizen einsehen.",
  ...
  billingCurrency: {
    ...
    paymentCurrencyDescription:
      "Wähle eine standardisierte Währung, in die alle privaten Ausgaben umgerechnet werden sollen",
  ...
  addDebitCardPage: {
    ...
    error: {
      ...
      securityCode: "Bitte gib einen gültigen Sicherheitscode ein",
      addressStreet:
        "Bitte gib eine gültige Rechnungsadresse ein, die kein Postfach ist",
      addressState: "Bitte wählen Sie einen Bundesstaat aus",
      addressCity: "Bitte geben Sie eine Stadt ein",
      genericFailureMessage:
        "Beim Hinzufügen Ihrer Karte ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.",
  ...
  walletPage: {
    ...
    error: {
      notOwnerOfBankAccount:
        "Beim Festlegen dieses Bankkontos als deine Standardzahlungsmethode ist ein Fehler aufgetreten",
      invalidBankAccount: "Dieses Bankkonto ist vorübergehend gesperrt",
      notOwnerOfFund:
        "Beim Festlegen dieser Karte als deine Standardzahlungsmethode ist ein Fehler aufgetreten",
      setDefaultFailure:
        "Etwas ist schiefgelaufen. Bitte chatte mit Concierge, um weitere Unterstützung zu erhalten.",
    },
    addBankAccountFailure:
      "Beim Hinzufügen Ihres Bankkontos ist ein unerwarteter Fehler aufgetreten. Bitte versuchen Sie es erneut.",
    getPaidFaster: "Schneller bezahlt werden",
    addPaymentMethod:
      "Fügen Sie eine Zahlungsmethode hinzu, um Zahlungen direkt in der App zu senden und zu empfangen.",
    ...
    sendAndReceiveMoney:
      "Sende und empfange Geld mit Freunden. Nur für US-Bankkonten.",
    enableWallet: "Wallet aktivieren",
    addBankAccountToSendAndReceive:
      "Füge ein Bankkonto hinzu, um Zahlungen zu senden oder zu empfangen.",
    ...
    walletActivationPending:
      "Wir überprüfen gerade Ihre Angaben. Bitte schauen Sie in ein paar Minuten noch einmal vorbei!",
    walletActivationFailed:
      "Leider kann Ihre Wallet derzeit nicht aktiviert werden. Bitte chatten Sie mit Concierge, um weitere Unterstützung zu erhalten.",
    addYourBankAccount: "Füge dein Bankkonto hinzu",
    addBankAccountBody:
      "Verbinden wir dein Bankkonto mit Expensify, damit du so einfach wie nie zuvor Zahlungen direkt in der App senden und empfangen kannst.",
    chooseYourBankAccount: "Wähle dein Bankkonto aus",
    chooseAccountBody:
      "Stellen Sie sicher, dass Sie die richtige Option auswählen.",
    ...
    shareBankAccountTitle:
      "Wähle die Admins aus, mit denen dieses Bankkonto geteilt werden soll:",
    shareBankAccountSuccess: "Bankkonto geteilt!",
    shareBankAccountSuccessDescription:
      "Die ausgewählten Admins erhalten eine Bestätigungsnachricht von Concierge.",
    shareBankAccountFailure:
      "Beim Versuch, das Bankkonto zu teilen, ist ein unerwarteter Fehler aufgetreten. Bitte versuche es erneut.",
    shareBankAccountEmptyTitle: "Keine Administratoren verfügbar",
    shareBankAccountEmptyDescription:
      "Es gibt keine Arbeitsbereich-Admins, mit denen du dieses Bankkonto teilen kannst.",
    shareBankAccountNoAdminsSelected:
      "Bitte wähle eine:n Admin aus, bevor du fortfährst",
    ...
    unshareBankAccountWarning: ({ admin }: { admin?: string | null }) =>
      `${admin} wird den Zugriff auf dieses Geschäftskonto verlieren. Wir schließen dennoch alle laufenden Zahlungen ab.`,
    reachOutForHelp:
      "Sie wird mit der Expensify Karte verwendet. <concierge-link>Wenden Sie sich an Concierge</concierge-link>, wenn Sie sie nicht mehr teilen möchten.",
    unshareErrorModalTitle: "Bankkonto kann nicht freigegeben werden",
    travelCVV: {
      title: "Reise-CVV",
      subtitle: "Verwenden Sie dies bei der Buchung von Reisen",
      description:
        "Verwende diese Karte für deine Expensify Travel-Buchungen. Sie wird beim Bezahlen als “Travel Card” angezeigt.",
    },
  ...
  cardPage: {
    ...
    fixedLimit: {
      ...
      title: ({ formattedLimit }: ViolationsOverLimitParams) =>
        `Sie können bis zu ${formattedLimit} mit dieser Karte ausgeben, danach wird sie deaktiviert.`,
    },
    monthlyLimit: {
    ...
    suspiciousBannerDescription:
      "Wir haben verdächtige Transaktionen auf Ihrer Karte festgestellt. Tippen Sie unten, um sie zu überprüfen.",
    cardLocked:
      "Ihre Karte ist vorübergehend gesperrt, während unser Team das Konto Ihres Unternehmens überprüft.",
    markTransactionsAsReimbursable:
      "Transaktionen als erstattungsfähig markieren",
    markTransactionsDescription:
      "Wenn aktiviert, werden Transaktionen, die von dieser Karte importiert werden, standardmäßig als erstattungsfähig markiert.",
    ...
    cardAddedToWallet: ({ platform }: { platform: "Google" | "Apple" }) =>
      `Zu ${platform} Wallet hinzugefügt`,
    cardDetailsLoadingFailure:
      "Beim Laden der Kartendetails ist ein Fehler aufgetreten. Bitte überprüfe deine Internetverbindung und versuche es erneut.",
    ...
    unexpectedError:
      "Beim Abrufen deiner Expensify-Kartendaten ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    cardFraudAlert: {
      ...
      deactivatedMessage: ({ cardLastFour }: { cardLastFour: string }) =>
        `hat die Karte mit der Endziffer ${cardLastFour} deaktiviert`,
      alertMessage: ({
        cardLastFour,
        amount,
        merchant,
...
${amount} für ${merchant} – ${date}`,
    ...
    freezeDescription:
      "Eine gesperrte Karte kann nicht für Käufe und Transaktionen verwendet werden. Du kannst sie jederzeit entsperren.",
    unfreezeDescription:
    ...
    youFroze: ({ date }: { date: string }) =>
      `Du hast diese Karte am ${date} gesperrt.`,
    frozenBy: ({ person, date }: { person: string; date: string }) =>
      `${person} hat diese Karte am ${date} gesperrt.`,
  },
  workflowsPage: {
    workflowTitle: "Ausgaben",
    workflowDescription:
      "Konfiguriere einen Workflow vom Zeitpunkt der Ausgabe an, einschließlich Genehmigung und Zahlung.",
    submissionFrequency: "Einreichungen",
    submissionFrequencyDescription:
      "Wähle einen benutzerdefinierten Zeitplan zum Einreichen von Ausgaben.",
    submissionFrequencyDateOfMonth: "Tag des Monats",
    disableApprovalPromptDescription:
      "Das Deaktivieren von Genehmigungen löscht alle vorhandenen Genehmigungs-Workflows.",
    ...
    accessibilityLabel: ({
      ...
      `Ausgaben von ${members} und die genehmigende Person ist ${approvers}`,
    addApprovalButton: "Genehmigungsablauf hinzufügen",
    findWorkflow: "Workflow suchen",
    addApprovalTip:
      "Dieser Standard-Workflow gilt für alle Mitglieder, sofern kein spezifischerer Workflow vorhanden ist.",
    approver: "Genehmiger",
    addApprovalsDescription:
      "Zusätzliche Genehmigung einholen, bevor eine Zahlung autorisiert wird.",
    ...
    editor: {
      submissionFrequency:
        "Wähle, wie lange Expensify warten soll, bevor fehlerfreie Ausgaben geteilt werden.",
    },
    frequencyDescription:
      "Wähle, wie häufig Ausgaben automatisch eingereicht werden sollen, oder stelle es auf manuell um",
    frequencies: {
      instant: "Sofort",
      weekly: "Wöchentlich",
      monthly: "Monatlich",
    ...
    approverInMultipleWorkflows:
      "Dieses Mitglied gehört bereits zu einem anderen Genehmigungsworkflow. Alle Aktualisierungen hier werden sich auch dort auswirken.",
    ...
    emptyContent: {
      ...
      expensesFromSubtitle:
        "Alle Workspace-Mitglieder gehören bereits zu einem bestehenden Genehmigungsworkflow.",
      approverSubtitle:
        "Alle Genehmigenden gehören zu einem bestehenden Workflow.",
    },
  },
  workflowsDelayedSubmissionPage: {
    autoReportingFrequencyErrorMessage:
      "Sendehäufigkeit konnte nicht geändert werden. Bitte versuche es erneut oder kontaktiere den Support.",
    monthlyOffsetErrorMessage:
      "Die monatliche Häufigkeit konnte nicht geändert werden. Bitte versuche es erneut oder kontaktiere den Support.",
  },
  ...
  workflowsEditApprovalsPage: {
    ...
    deletePrompt:
      "Möchtest du diesen Genehmigungs-Workflow wirklich löschen? Alle Mitglieder werden anschließend dem Standard-Workflow folgen.",
  },
  ...
  workflowsApproverPage: {
    genericErrorMessage:
      "Die genehmigende Person konnte nicht geändert werden. Bitte versuche es erneut oder kontaktiere den Support.",
  ...
  workflowsApprovalLimitPage: {
    ...
    enterApproverError:
      "Ein Genehmiger ist erforderlich, wenn du ein Berichtslimit festlegst",
    enterBothError:
      "Geben Sie einen Berichtsbetrag und eine zusätzliche genehmigende Person ein",
    forwardLimitDescription: ({
      ...
      `Berichte über ${approvalLimit} werden an ${approverName} weitergeleitet`,
  },
  workflowsPayerPage: {
    title: "Autorisierte zahlende Person",
    genericErrorMessage:
      "Der berechtigte Zahler konnte nicht geändert werden. Bitte versuche es erneut.",
    admins: "Admins",
    payer: "Zahler",
  ...
  reportFraudConfirmationPage: {
    ...
    description:
      "Wir haben Ihre bestehende Karte dauerhaft deaktiviert. Wenn Sie Ihre Kartendetails erneut aufrufen, steht Ihnen eine neue virtuelle Karte zur Verfügung.",
  ...
  activateCardPage: {
    ...
    error: {
      thatDidNotMatch:
        "Das stimmt nicht mit den letzten 4 Ziffern Ihrer Karte überein. Bitte versuchen Sie es erneut.",
      throttled:
  ...
  getPhysicalCard: {
    ...
    nameMessage:
      "Gib deinen Vor- und Nachnamen ein, da dieser auf deiner Karte angezeigt wird.",
    ...
    estimatedDeliveryMessage:
      "Ihre physische Karte wird in 2–3 Werktagen eintreffen.",
    next: "Weiter",
    getPhysicalCard: "Physische Karte bestellen",
  ...
  transferAmountPage: {
    ...
    instantSummary: (rate: string, minAmount: string) =>
      `${rate}% Gebühr (mindestens ${minAmount})`,
    ...
    transferDetailBankAccount:
      "Dein Geld sollte innerhalb der nächsten 1–3 Werktage ankommen.",
    transferDetailDebitCard: "Dein Geld sollte sofort ankommen.",
    failedTransfer:
      "Ihr Saldo ist noch nicht vollständig ausgeglichen. Bitte überweisen Sie auf ein Bankkonto.",
  ...
  expenseRulesPage: {
    ...
    emptyRules: {
      ...
      subtitle:
        "Füge eine Regel hinzu, um die Spesenabrechnung zu automatisieren.",
    },
    changes: {
      billableUpdate: (value: boolean) =>
        `Ausgabe ${value ? "verrechenbar" : "nicht abrechenbar"} aktualisieren`,
      categoryUpdate: (value: string) =>
        `Kategorie auf „${value}“ aktualisieren`,
      commentUpdate: (value: string) =>
        `Beschreibung auf „${value}“ aktualisieren`,
      merchantUpdate: (value: string) => `Händler auf „${value}“ aktualisieren`,
      reimbursableUpdate: (value: boolean) =>
        `Ausgabe ${value ? "erstattungsfähig" : "nicht erstattungsfähig"} aktualisieren`,
      tagUpdate: (value: string) => `Tag auf „${value}“ aktualisieren`,
      taxUpdate: (value: string) => `Steuersatz auf „${value}“ aktualisieren`,
      billable: (value: boolean) =>
        `Ausgabe ${value ? "verrechenbar" : "nicht abrechenbar"}`,
      ...
      reimbursable: (value: boolean) =>
        `Ausgabe ${value ? "erstattungsfähig" : "nicht erstattungsfähig"}`,
      tag: (value: string) => `Tag auf „${value}“`,
      tax: (value: string) => `Steuersatz auf „${value}“`,
      report: (value: string) =>
        `zu einem Bericht mit dem Namen „${value}“ hinzufügen`,
    },
    newRule: "Neue Regel",
    addRule: {
      ...
      merchantHint:
        "Gib . ein, um eine Regel zu erstellen, die für alle Händler gilt",
      ...
      confirmError:
        "Gib ein Händlerunternehmen ein und nimm mindestens eine Aktualisierung vor",
  ...
  preferencesPage: {
    ...
    testSection: {
      ...
      subtitle:
        "Einstellungen zum Debuggen und Testen der App in der Staging-Umgebung.",
    },
    receiveRelevantFeatureUpdatesAndExpensifyNews:
      "Erhalten Sie relevante Funktionsupdates und Expensify-Neuigkeiten",
    muteAllSounds: "Alle Expensify-Sounds stummschalten",
  },
  priorityModePage: {
    priorityMode: "Prioritätsmodus",
    explainerText:
      "Wähle, ob du dich nur auf ungelesene und angeheftete Chats #fokussieren möchtest oder alles anzeigen willst, wobei die neuesten und angehefteten Chats oben stehen.",
    priorityModes: {
      default: {
        label: "Neueste",
  ...
  reportDetailsPage: {
    ...
    successPDF:
      "Dein PDF wurde erstellt! Falls es nicht automatisch heruntergeladen wurde, verwende die Schaltfläche unten.",
  },
  reportDescriptionPage: {
    roomDescription: "Zimmerbeschreibung",
    roomDescriptionOptional: "Zimmerbeschreibung (optional)",
    explainerText:
      "Legen Sie eine benutzerdefinierte Beschreibung für den Raum fest.",
  },
  groupChat: {
    lastMemberTitle: "Achtung!",
    lastMemberWarning:
      "Da du die letzte Person hier bist, wird dieser Chat für alle Mitglieder unzugänglich, wenn du gehst. Bist du sicher, dass du den Chat verlassen möchtest?",
    defaultReportName: ({ displayName }: ReportArchiveReasonsClosedParams) =>
      `Gruppenchat von ${displayName}`,
  },
  languagePage: {
    language: "Sprache",
    aiGenerated:
      "Die Übersetzungen für diese Sprache werden automatisch erzeugt und können Fehler enthalten.",
  },
  themePage: {
    theme: "Design",
    themes: {
    ...
    chooseThemeBelowOrSync:
      "Wählen Sie unten ein Design aus oder synchronisieren Sie es mit den Einstellungen Ihres Geräts.",
  },
  termsOfUse: {
  ...
  validateCodeForm: {
    ...
    requestNewCode: ({ timeRemaining }: { timeRemaining: string }) =>
      `Fordere einen neuen Code an in <a>${timeRemaining}</a>`,
  ...
  passwordForm: {
    ...
    enterYourTwoFactorAuthenticationCodeToContinue:
      "Gib deinen Zwei-Faktor-Authentifizierungscode ein, um fortzufahren",
    forgot: "Passwort vergessen?",
    requiredWhen2FAEnabled: "Erforderlich, wenn 2FA aktiviert ist",
    error: {
      incorrectPassword: "Falsches Passwort. Bitte versuche es erneut.",
      incorrectLoginOrPassword:
        "Falscher Login oder falsches Passwort. Bitte versuche es erneut.",
      incorrect2fa:
        "Falscher Zwei-Faktor-Authentifizierungscode. Bitte versuche es erneut.",
      twoFactorAuthenticationEnabled:
        "Für dieses Konto ist die Zwei-Faktor-Authentifizierung (2FA) aktiviert. Bitte melde dich mit deiner E‑Mail-Adresse oder Telefonnummer an.",
      invalidLoginOrPassword:
        "Ungültiger Benutzername oder Passwort. Bitte versuche es erneut oder setze dein Passwort zurück.",
      ...
      noAccess:
        "Sie haben keinen Zugriff auf diese Anwendung. Bitte fügen Sie Ihren GitHub-Benutzernamen hinzu, um Zugriff zu erhalten.",
      accountLocked:
        "Dein Konto wurde nach zu vielen erfolglosen Versuchen gesperrt. Bitte versuche es in 1 Stunde erneut.",
      fallback:
        "Etwas ist schiefgelaufen. Bitte versuchen Sie es später noch einmal.",
    },
  },
  loginForm: {
    ...
    error: {
      invalidFormatEmailLogin:
        "Die eingegebene E-Mail-Adresse ist ungültig. Bitte korrigiere das Format und versuche es erneut.",
    },
    cannotGetAccountDetails:
      "Kontodetails konnten nicht abgerufen werden. Bitte melde dich erneut an.",
  ...
  onboarding: {
    ...
    welcomeSignOffTitleManageTeam:
      "Sobald du die Aufgaben oben abgeschlossen hast, können wir weitere Funktionen wie Genehmigungs-Workflows und Regeln erkunden!",
    ...
    explanationModal: {
      ...
      secondaryDescription:
        "Um zurück zu Expensify Classic zu wechseln, tippe einfach auf dein Profilbild > Gehe zu Expensify Classic.",
    },
    getStarted: "Loslegen",
    whatsYourName: "Wie heißt du?",
    peopleYouMayKnow:
      "Personen, die du vielleicht kennst, sind bereits hier! Bestätige deine E-Mail-Adresse, um dich ihnen anzuschließen.",
    ...
    listOfWorkspaces:
      "Hier ist die Liste der Arbeitsbereiche, denen du beitreten kannst. Keine Sorge, du kannst ihnen auch später jederzeit beitreten, wenn du möchtest.",
    workspaceMemberList: ({
      employeeCount,
      policyOwner,
    }: WorkspaceMemberList) =>
      `${employeeCount} Mitglied${employeeCount > 1 ? "s" : ""} • ${policyOwner}`,
    whereYouWork: "Wo arbeitest du?",
    errorSelection: "Wähle eine Option, um fortzufahren",
    purpose: {
      title: "Was möchtest du heute tun?",
      errorContinue:
        "Bitte auf „Weiter“ drücken, um die Einrichtung abzuschließen",
      errorBackButton:
        "Bitte beantworte die Einrichtungsfragen, um die App verwenden zu können",
      [CONST.ONBOARDING_CHOICES.EMPLOYER]:
        "Von meinem Arbeitgeber zurückerstattet werden",
      [CONST.ONBOARDING_CHOICES.MANAGE_TEAM]:
        "Verwalte die Ausgaben meines Teams",
      [CONST.ONBOARDING_CHOICES.PERSONAL_SPEND]:
        "Ausgaben nachverfolgen und budgetieren",
      [CONST.ONBOARDING_CHOICES.CHAT_SPLIT]:
        "Chatten und Ausgaben mit Freunden aufteilen",
    ...
    workEmail: {
      ...
      subtitle:
        "Expensify funktioniert am besten, wenn du deine Arbeits-E-Mail verbindest.",
      explanationModal: {
        descriptionOne: "An Belege@expensify.com zum Scannen weiterleiten",
        descriptionTwo:
          "Schließe dich deinen Kolleg:innen an, die Expensify bereits nutzen",
    ...
    workEmailValidation: {
      ...
      magicCodeSent: ({ workEmail }: WorkEmailResendCodeParams) =>
        `Bitte gib den magischen Code ein, der an ${workEmail} gesendet wurde. Er sollte in ein bis zwei Minuten ankommen.`,
    },
    workEmailValidationError: {
      publicEmail:
        "Bitte gib eine gültige geschäftliche E-Mail-Adresse von einer privaten Domain ein, z. B. mitch@company.com",
      offline:
        "Wir konnten deine geschäftliche E-Mail nicht hinzufügen, da du offenbar offline bist",
    },
    mergeBlockScreen: {
    ...
    tasks: {
      testDriveAdminTask: {
        title: ({ testDriveURL }) =>
          `Machen Sie eine [Probefahrt](${testDriveURL})`,
        description: ({ testDriveURL }) =>
          `[Machen Sie eine kurze Produkttour](${testDriveURL}), um zu sehen, warum Expensify der schnellste Weg ist, Ihre Spesen abzurechnen.`,
      },
      testDriveEmployeeTask: {
        title: ({ testDriveURL }) =>
          `Machen Sie eine [Probefahrt](${testDriveURL})`,
        description: ({ testDriveURL }) =>
          `Machen Sie mit uns eine [Probefahrt](${testDriveURL}) und sichern Sie sich für Ihr Team *3 kostenlose Monate Expensify!*`,
      },
      ...
      createTestDriveAdminWorkspaceTask: {
        title: ({ workspaceConfirmationLink }) =>
          `[Erstelle](${workspaceConfirmationLink}) einen Workspace`,
        description:
          "Erstelle einen Arbeitsbereich und konfiguriere die Einstellungen mit Hilfe deiner Einrichtungsexpertin/deines Einrichtungsexperten!",
      },
      createWorkspaceTask: {
        title: ({ workspaceSettingsLink }) =>
          `[Workspace] erstellen (${workspaceSettingsLink})`,
      ...
      setupCategoriesTask: {
        title: ({ workspaceCategoriesLink }) =>
          `Richte [Kategorien](${workspaceCategoriesLink}) ein`,
...
${
  integrationName && CONST.connectionsVideoPaths[integrationName]
    ...
    : `[Zur Buchhaltung](${workspaceAccountingLink}).`
      ...
      connectCorporateCardTask: {
        title: ({ corporateCardLink }) =>
          `[Geschäftskarten verbinden](${corporateCardLink})`,
      ...
      inviteTeamTask: {
        title: ({ workspaceMembersLink }) =>
          `[your team](${workspaceMembersLink}) einladen`,
      ...
      setupCategoriesAndTags: {
        title: ({ workspaceCategoriesLink, workspaceTagsLink }) =>
          `Richte [Kategorien](${workspaceCategoriesLink}) und [Tags](${workspaceTagsLink}) ein`,
      ...
      setupTagsTask: {
        title: ({ workspaceTagsLink }) =>
          `Richte [Tags](${workspaceTagsLink}) ein`,
        description: ({ workspaceMoreFeaturesLink }) =>
          dedent(`
      ...
      inviteAccountantTask: {
        title: ({ workspaceMembersLink }) =>
          `Laden Sie Ihre(n) [Buchhalter(in)](${workspaceMembersLink}) ein`,
        description: ({ workspaceMembersLink }) =>
          dedent(`
      ...
      reviewWorkspaceSettingsTask: {
        title: ({ workspaceSettingsLink }) =>
          `Überprüfe deine [Workspace-Einstellungen](${workspaceSettingsLink})`,
        description: ({ workspaceSettingsLink }) =>
          dedent(`
    ...
    messages: {
      onboardingEmployerOrSubmitMessage:
        "Geld zurückzubekommen ist so einfach wie das Senden einer Nachricht. Gehen wir die Grundlagen durch.",
      onboardingPersonalSpendMessage:
        "So verfolgen Sie Ihre Ausgaben mit nur wenigen Klicks.",
      ...
      onboardingChatSplitMessage:
        "Rechnungen mit Freund*innen zu teilen ist so einfach wie das Senden einer Nachricht. So geht’s.",
      onboardingAdminMessage:
        "Erfahre, wie du als Admin den Arbeitsbereich deines Teams verwaltest und deine eigenen Ausgaben einreichst.",
      ...
      onboardingTestDriveReceiverMessage:
        "*Du erhältst 3 Monate gratis! Leg unten los.*",
    },
    workspace: {
      title: "Bleib mit einem Workspace organisiert",
      subtitle:
        "Leistungsstarke Tools freischalten, um Ihr Ausgabenmanagement zu vereinfachen – alles an einem Ort. Mit einem Workspace können Sie:",
      explanationModal: {
      ...
      price:
        "Teste es 30 Tage kostenlos und upgrade dann für nur <strong>5 $/Nutzer/Monat</strong>.",
    ...
    inviteMembers: {
      ...
      subtitle:
        "Füge dein Team hinzu oder lade deine Steuerberatung ein. Je mehr, desto besser!",
    },
  },
  featureTraining: {
  ...
  personalDetails: {
    error: {
      ...
      containsReservedWord:
        "Name darf die Wörter Expensify oder Concierge nicht enthalten",
  ...
  privatePersonalDetails: {
    ...
    error: {
      dateShouldBeBefore: (dateString: string) =>
        `Datum muss vor dem ${dateString} liegen`,
      dateShouldBeAfter: (dateString: string) =>
        `Datum muss nach ${dateString} liegen`,
      hasInvalidCharacter: "Name darf nur lateinische Zeichen enthalten",
      incorrectZipFormat: (zipFormat?: string) =>
        `Ungültiges Postleitzahlenformat${zipFormat ? `Zulässiges Format: ${zipFormat}` : ""}`,
  ...
  unlinkLoginForm: {
    ...
    noLongerHaveAccess: (primaryLogin: string) =>
      `Wenn du keinen Zugriff mehr auf ${primaryLogin} hast, trenne bitte die Verknüpfung deiner Konten.`,
  ...
  smsDeliveryFailurePage: {
    ...
    validationSuccess:
      "Deine Nummer wurde bestätigt! Klicke unten, um einen neuen magischen Anmeldecode zu senden.",
    validationFailed: ({
      timeData,
    }: {
      timeData?: {
      ...
      if (timeData.days) {
        timeParts.push(
          `${timeData.days} ${timeData.days === 1 ? "Tag" : "Tage"}`,
        );
      }
      if (timeData.hours) {
        timeParts.push(
          `${timeData.hours} ${timeData.hours === 1 ? "Stunde" : "Stunden"}`,
        );
      }
      if (timeData.minutes) {
        timeParts.push(
          `${timeData.minutes} ${timeData.minutes === 1 ? "Minute" : "Minuten"}`,
        );
      }
      let timeText = "";
  ...
  notFound: {
    chatYouLookingForCannotBeFound:
      "Der Chat, den du suchst, kann nicht gefunden werden.",
    getMeOutOfHere: "Hol mich hier raus",
    iouReportNotFound:
      "Die gesuchten Zahlungsdetails konnten nicht gefunden werden.",
    notHere: "Hm … es ist nicht hier",
    pageNotFound: "Ups, diese Seite konnte nicht gefunden werden",
    noAccess:
      "Dieser Chat oder diese Ausgabe wurde möglicherweise gelöscht oder du hast keinen Zugriff darauf.\n\nBei Fragen wende dich bitte an concierge@expensify.com",
    goBackHome: "Zurück zur Startseite",
    commentYouLookingForCannotBeFound:
      "Der Kommentar, den du suchst, kann nicht gefunden werden.",
  ...
  errorPage: {
    ...
    subtitle:
      "Ihre Anfrage konnte nicht abgeschlossen werden. Bitte versuchen Sie es später noch einmal.",
    wrongTypeSubtitle:
      "Diese Suche ist ungültig. Versuche, deine Suchkriterien anzupassen.",
  },
  statusPage: {
    status: "Status",
    statusExplanation:
      "Füge ein Emoji hinzu, damit Kolleg:innen und Freund:innen leicht sehen, was los ist. Optional kannst du auch eine Nachricht hinzufügen!",
    today: "Heute",
    ...
    vacationDelegateError:
      "Beim Aktualisieren Ihrer Vertretung im Urlaub ist ein Fehler aufgetreten.",
    asVacationDelegate: ({ nameOrEmail }: VacationDelegateParams) =>
      `als Urlaubsvertretung von ${nameOrEmail}`,
    toAsVacationDelegate: (
      submittedToName: string,
      vacationDelegateName: string,
    ) =>
      `an ${submittedToName} als Urlaubsvertretung für ${vacationDelegateName}`,
  ...
  bankAccount: {
    ...
    letsDoubleCheck:
      "Lass uns noch einmal überprüfen, ob alles richtig aussieht.",
    accountEnding: "Konto mit Endziffern",
    thisBankAccount:
      "Dieses Bankkonto wird für Geschäftszahlungen in deinem Workspace verwendet",
    ...
    toGetStarted:
      "Fügen Sie ein Bankkonto hinzu, um Ausgaben zu erstatten, Expensify Karten auszugeben, Rechnungszahlungen zu erhalten und Rechnungen zentral zu bezahlen.",
    plaidBodyCopy:
      "Geben Sie Ihren Mitarbeitenden eine einfachere Möglichkeit, Firmenausgaben zu bezahlen – und erstattet zu bekommen.",
    checkHelpLine:
      "Ihre Bankleitzahl und Kontonummer finden Sie auf einem Scheck für dieses Konto.",
    ...
    hasBeenThrottledError:
      "Beim Hinzufügen Ihres Bankkontos ist ein Fehler aufgetreten. Bitte warten Sie ein paar Minuten und versuchen Sie es erneut.",
    ...
    error: {
      ...
      incorporationDateFuture:
        "Das Gründungsdatum darf nicht in der Zukunft liegen",
      incorporationState: "Bitte wähle einen gültigen Bundesstaat aus",
      industryCode:
        "Bitte geben Sie einen gültigen Branchenschlüssel mit sechs Ziffern ein",
      restrictedBusiness:
        "Bitte bestätigen Sie, dass das Unternehmen nicht auf der Liste der eingeschränkten Unternehmen steht.",
      ...
      routingAndAccountNumberCannotBeSame:
        "Bankleitzahl und Kontonummer dürfen nicht identisch sein",
      ...
      ssnLast4:
        "Bitte gib die letzten 4 gültigen Ziffern der Sozialversicherungsnummer ein",
      ...
      noDefaultDepositAccountOrDebitCardAvailable:
        "Bitte fügen Sie ein Standard-Einzahlungskonto oder eine Debitkarte hinzu",
      validationAmounts:
        "Die von Ihnen eingegebenen Validierungsbeträge sind falsch. Bitte prüfen Sie Ihren Kontoauszug noch einmal und versuchen Sie es erneut.",
      ...
      sameDepositAndWithdrawalAccount:
        "Die Einzahlungs- und Auszahlungskonten sind identisch.",
    },
  },
  addPersonalBankAccount: {
    ...
    accountHolderInformationStepHeader:
      "Wie lauten die Angaben zur kontoinhabenden Person?",
    ...
    confirmationStepSubHeader:
      "Prüfen Sie die untenstehenden Angaben sorgfältig und aktivieren Sie das Kontrollkästchen für die Bedingungen, um zu bestätigen.",
    toGetStarted:
      "Fügen Sie ein persönliches Bankkonto hinzu, um Erstattungen zu erhalten, Rechnungen zu bezahlen oder die Expensify Wallet zu aktivieren.",
  },
  addPersonalBankAccountPage: {
    ...
    successMessage:
      "Glückwunsch, dein Bankkonto ist eingerichtet und bereit, Erstattungen zu empfangen.",
  },
  attachmentView: {
  ...
  messages: {
    ...
    userIsAlreadyMember: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} ist bereits Mitglied von ${name}`,
    userIsAlreadyAnAdmin: ({ login, name }: UserIsAlreadyMemberParams) =>
      `${login} ist bereits Administrator*in von ${name}`,
  },
  onfidoStep: {
    acceptTerms:
      "Indem Sie mit der Anfrage zur Aktivierung Ihres Expensify Wallets fortfahren, bestätigen Sie, dass Sie dies gelesen haben, verstehen und akzeptieren",
    facialScan:
      "Richtlinie und Einverständniserklärung zur Gesichtserfassung von Onfido",
    ...
    genericError:
      "Bei der Verarbeitung dieses Schritts ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    cameraPermissionsNotGranted: "Kamerazugriff aktivieren",
    cameraRequestMessage:
      "Wir benötigen Zugriff auf deine Kamera, um die Bankkontoverifizierung abzuschließen. Bitte aktiviere dies unter Einstellungen > New Expensify.",
    microphonePermissionsNotGranted: "Mikrofonzugriff aktivieren",
    microphoneRequestMessage:
      "Wir benötigen Zugriff auf dein Mikrofon, um die Bankkontoverifizierung abzuschließen. Bitte aktiviere es über Einstellungen > New Expensify.",
    originalDocumentNeeded:
      "Bitte lade ein Originalfoto deines Ausweises hoch und nicht einen Screenshot oder einen Scan.",
    ...
    imageNeedsBetterQuality:
      "Es gibt ein Problem mit der Bildqualität deines Ausweises. Bitte lade ein neues Bild hoch, auf dem dein gesamter Ausweis deutlich zu sehen ist.",
    selfieIssue:
      "Mit deinem Selfie/Video stimmt etwas nicht. Bitte lade ein aktuelles Selfie/Video hoch.",
    selfieNotMatching:
      "Dein Selfie/Video stimmt nicht mit deinem Ausweis überein. Bitte lade ein neues Selfie/Video hoch, auf dem dein Gesicht gut zu erkennen ist.",
    selfieNotLive:
      "Dein Selfie/Video scheint kein Live-Foto/-Video zu sein. Bitte lade ein Live-Selfie/-Video hoch.",
  },
  additionalDetailsStep: {
    headerTitle: "Zusätzliche Details",
    helpText:
      "Wir müssen die folgenden Informationen bestätigen, bevor du mit deinem Wallet Geld senden und empfangen kannst.",
    helpTextIdologyQuestions:
      "Wir müssen dir nur noch ein paar weitere Fragen stellen, um deine Identität endgültig zu bestätigen.",
    ...
    ssnFull9Error:
      "Bitte eine gültige neunstellige Sozialversicherungsnummer eingeben",
    needSSNFull9:
      "Wir können Ihre Sozialversicherungsnummer (SSN) nicht verifizieren. Bitte geben Sie alle neun Ziffern Ihrer SSN ein.",
  ...
  termsStep: {
    ...
    haveReadAndAgreePlain:
      "Ich habe die Informationen gelesen und bin damit einverstanden, elektronische Hinweise zu erhalten.",
    ...
    shortTermsForm: {
      expensifyPaymentsAccount: ({ walletProgram }: WalletProgramParams) =>
        `Die Expensify-Wallet wird von ${walletProgram} herausgegeben.`,
      ...
      atmBalanceInquiry:
        "Geldautomaten-Saldoabfrage (im Netzwerk oder außerhalb des Netzwerks)",
      customerService: "Kundendienst (automatisiert oder Live-Agent)",
      inactivityAfterTwelveMonths:
        "Inaktivität (nach 12 Monaten ohne Transaktionen)",
      weChargeOneFee: "Wir berechnen 1 andere Art von Gebühr. Diese ist:",
      fdicInsurance:
        "Ihre Guthaben sind für eine FDIC-Versicherung berechtigt.",
    ...
    longTermsForm: {
      ...
      sendingFundsDetails:
        "Es fällt keine Gebühr an, wenn du mit deinem Guthaben, Bankkonto oder deiner Debitkarte Geld an eine andere Kontoinhaber*in sendest.",
  ...
  activateStep: {
    ...
    activatedMessage:
      "Glückwunsch, deine Wallet ist eingerichtet und bereit für Zahlungen.",
    checkBackLaterTitle: "Nur eine Minute …",
    checkBackLaterMessage:
      "Wir prüfen Ihre Angaben noch. Bitte schauen Sie später noch einmal vorbei.",
  ...
  companyStep: {
    ...
    subtitle:
      "Fast geschafft! Aus Sicherheitsgründen müssen wir einige Angaben bestätigen:",
    ...
    industryClassification:
      "Unter welcher Branche ist das Unternehmen eingestuft?",
  ...
  personalInfoStep: {
    ...
    enterTheLast4:
      "Wie lauten die letzten vier Ziffern Ihrer Sozialversicherungsnummer?",
    dontWorry:
      "Keine Sorge, wir führen keine persönlichen Bonitätsprüfungen durch!",
    ...
    byAddingThisBankAccount:
      "Durch Hinzufügen dieses Bankkontos bestätigst du, dass du Folgendes gelesen hast, verstehst und akzeptierst",
    ...
    whatsYourSSN:
      "Wie lauten die letzten vier Ziffern Ihrer Sozialversicherungsnummer?",
    noPersonalChecks:
      "Keine Sorge, hier gibt es keine persönlichen Bonitätsprüfungen!",
  ...
  businessInfoStep: {
    ...
    enterYourCompanyTaxIdNumber:
      "Wie lautet die Steuernummer Ihres Unternehmens?",
    taxIDNumber: "Steueridentifikationsnummer",
    taxIDNumberPlaceholder: "9 Ziffern",
    enterYourCompanyWebsite: "Wie lautet die Website Ihres Unternehmens?",
    companyWebsite: "Firmenwebsite",
    enterYourCompanyPhoneNumber:
      "Wie lautet die Telefonnummer Ihres Unternehmens?",
    ...
    selectYourCompanyIncorporationDate:
      "Was ist das Gründungsdatum Ihres Unternehmens?",
    incorporationDate: "Gründungsdatum",
    incorporationDatePlaceholder: "Startdatum (yyyy-mm-dd)",
    incorporationState: "Gründungsstaat",
    pleaseSelectTheStateYourCompanyWasIncorporatedIn:
      "In welchem US-Bundesstaat wurde Ihr Unternehmen gegründet?",
    letsDoubleCheck:
      "Lass uns noch einmal überprüfen, ob alles richtig aussieht.",
    companyAddress: "Firmenadresse",
    listOfRestrictedBusinesses: "Liste der eingeschränkten Unternehmen",
    ...
    whatsTheBusinessContactInformation:
      "Wie lauten die geschäftlichen Kontaktdaten?",
    ...
    whatsTheBusinessAnnualPayment:
      "Wie hoch ist das jährliche Zahlungsvolumen des Unternehmens?",
    whatsYourExpectedAverageReimbursements:
      "Wie hoch ist Ihr erwarteter durchschnittlicher Erstattungsbetrag?",
    ...
    selectAverageReimbursement:
      "Wähle den durchschnittlichen Erstattungsbetrag aus",
  ...
  beneficialOwnerInfoStep: {
    doYouOwn25percent: (companyName: string) =>
      `Besitzen Sie 25 % oder mehr von ${companyName}?`,
    doAnyIndividualOwn25percent: (companyName: string) =>
      `Besitzen einzelne Personen 25 % oder mehr von ${companyName}?`,
    areThereMoreIndividualsWhoOwn25percent: (companyName: string) =>
      `Gibt es noch weitere Personen, die 25 % oder mehr von ${companyName} besitzen?`,
    regulationRequiresUsToVerifyTheIdentity:
      "Vorschriften verpflichten uns, die Identität jeder Person zu überprüfen, die mehr als 25 % des Unternehmens besitzt.",
    companyOwner: "Unternehmensinhaber",
    enterLegalFirstAndLastName:
      "Wie lautet der gesetzliche Name der*des Eigentümer*in?",
    legalFirstName: "Rechtlicher Vorname",
    legalLastName: "Rechtlicher Nachname",
    enterTheDateOfBirthOfTheOwner:
      "Wie lautet das Geburtsdatum des Eigentümers?",
    enterTheLast4:
      "Wie lauten die letzten 4 Ziffern der Sozialversicherungsnummer des Inhabers?",
    last4SSN: "Letzte 4 Ziffern der SSN",
    dontWorry:
      "Keine Sorge, wir führen keine persönlichen Bonitätsprüfungen durch!",
  ...
  ownershipInfoStep: {
    ...
    doesAnyoneOwn: (companyName: string) =>
      `Besitzen einzelne Personen 25 % oder mehr von ${companyName}?`,
    regulationsRequire:
      "Vorschriften verpflichten uns, die Identität jeder Person zu überprüfen, der mehr als 25 % des Unternehmens gehören.",
    legalFirstName: "Rechtlicher Vorname",
    legalLastName: "Rechtlicher Nachname",
    whatsTheOwnersName:
      "Wie lautet der gesetzliche Name der*des Eigentümer*in?",
    ...
    whatPercentage:
      "Wie viel Prozent des Unternehmens gehören dem/der Inhaber:in?",
    ...
    whatAreTheLast:
      "Wie lauten die letzten 4 Ziffern der Sozialversicherungsnummer des Inhabers?",
    whatsYourLast:
      "Wie lauten die letzten 4 Ziffern Ihrer Sozialversicherungsnummer?",
    whatsYourNationality: "Was ist dein Staatsangehörigkeitsland?",
    whatsTheOwnersNationality:
      "In welchem Land ist der/die Inhaber:in Staatsbürger:in?",
    ...
    areThereOther: (companyName: string) =>
      `Gibt es andere Personen, die ${companyName} zu 25 % oder mehr besitzen?`,
    owners: "Eigentümer",
    addCertified:
      "Fügen Sie ein zertifiziertes Organigramm hinzu, das die wirtschaftlich Berechtigten zeigt",
    ...
    acceptedFiles:
      "Akzeptierte Dateiformate: PDF, PNG, JPEG. Die Gesamtdateigröße für jeden Abschnitt darf 5 MB nicht überschreiten.",
  ...
  completeVerificationStep: {
    ...
    certifyTrueAndAccurate:
      "Ich bestätige, dass die angegebenen Informationen wahr und korrekt sind",
    certifyTrueAndAccurateError:
      "Bitte bestätigen Sie, dass die Angaben wahrheitsgemäß und korrekt sind",
    isAuthorizedToUseBankAccount:
      "Ich bin berechtigt, dieses Geschäftskonto für Geschäftsausgaben zu verwenden",
    isAuthorizedToUseBankAccountError:
      "Sie müssen eine vertretungsberechtigte Führungskraft mit Vollmacht zur Führung des Geschäftskontos sein",
  ...
  connectBankAccountStep: {
    ...
    maxAttemptsReached:
      "Die Validierung für dieses Bankkonto wurde aufgrund zu vieler falscher Versuche deaktiviert.",
    ...
    descriptionCTA:
      "Bitte gib unten in die Felder die einzelnen Transaktionsbeträge ein. Beispiel: 1.51.",
    letsChatText:
      "Fast geschafft! Wir brauchen noch kurz deine Hilfe, um ein paar letzte Informationen im Chat zu bestätigen. Bereit?",
    enable2FATitle:
      "Betrug verhindern, Zwei-Faktor-Authentifizierung (2FA) aktivieren",
    enable2FAText:
      "Wir nehmen Ihre Sicherheit ernst. Bitte richten Sie jetzt 2FA ein, um Ihrem Konto eine zusätzliche Schutzebene hinzuzufügen.",
  ...
  countryStep: {
    ...
    yourBusiness:
      "Die Währung Ihres Geschäftskontos muss mit der Währung Ihres Workspaces übereinstimmen.",
  ...
  bankInfoStep: {
    ...
    accountHolderNameDescription:
      "Vollständiger Name der zeichnungsberechtigten Person",
  },
  signerInfoStep: {
    signerInfo: "Unterzeichnerdetails",
    areYouDirector: (companyName: string) =>
      `Sind Sie eine Führungskraft bei ${companyName}?`,
    regulationRequiresUs:
      "Gesetzliche Vorschriften verlangen, dass wir überprüfen, ob die unterzeichnende Person befugt ist, diese Aktion im Namen des Unternehmens vorzunehmen.",
    ...
    personalAddress:
      "Nachweis der privaten Anschrift (z. B. Versorgungsrechnung)",
    letsDoubleCheck:
      "Lass uns noch einmal überprüfen, ob alles richtig aussieht.",
    legalName: "Rechtlicher Name",
    proofOf: "Nachweis der Privatadresse",
    enterOneEmail: (companyName: string) =>
      `Gib die E-Mail-Adresse einer Geschäftsführungsperson von ${companyName} ein`,
    regulationRequiresOneMoreDirector:
      "Vorschriften erfordern mindestens eine weitere:n Geschäftsführer:in als Unterzeichner:in.",
    hangTight: "Einen Moment bitte ...",
    enterTwoEmails: (companyName: string) =>
      `Gib die E-Mail-Adressen von zwei Direktoren bei ${companyName} ein`,
    sendReminder: "Erinnerung senden",
    chooseFile: "Datei auswählen",
    weAreWaiting:
      "Wir warten darauf, dass andere ihre Identität als Geschäftsführende des Unternehmens verifizieren.",
    id: "Ausweiskopie",
    proofOfDirectors: "Nachweis der Direktor(en)",
    proofOfDirectorsDescription:
      "Beispiele: Oncorp-Unternehmensprofil oder Unternehmensregistrierung.",
    codiceFiscale: "Steuernummer",
    codiceFiscaleDescription:
      "Codice Fiscale für Unterzeichnende, Bevollmächtigte und wirtschaftlich Berechtigte.",
    ...
    PDSandFSGDescription: dedent(`
        ...
        `),
    pleaseUpload:
      "Bitte laden Sie unten zusätzliche Unterlagen hoch, damit wir Ihre Identität als Geschäftsführer*in des Unternehmens verifizieren können.",
  ...
  agreementsStep: {
    ...
    regulationRequiresUs:
      "Vorschriften verpflichten uns, die Identität jeder Person zu überprüfen, die mehr als 25 % des Unternehmens besitzt.",
    iAmAuthorized:
      "Ich bin berechtigt, das Geschäftskonto für Geschäftsausgaben zu verwenden.",
    iCertify:
      "Ich bestätige, dass die bereitgestellten Angaben wahr und korrekt sind.",
    ...
    iConsentToThePrivacyNotice:
      'Ich stimme der <a href="https://payments.corpay.com/compliance">Datenschutzerklärung</a> zu.',
  ...
  docusignStep: {
    ...
    pleaseCompleteTheBusinessAccount:
      "Bitte füllen Sie den Antrag auf Lastschrifteinzug für das Geschäftskonto aus",
    ...
    pleaseUpload:
      "Bitte laden Sie das DEFT-Formular und die Docusign-Unterschriftsseite hoch",
    pleaseUploadTheDirect:
      "Bitte lade die Einzugsermächtigungen und die Docusign-Unterschriftsseite hoch",
  },
  finishStep: {
    ...
    enable2FA:
      "Aktiviere die Zwei-Faktor-Authentifizierung (2FA), um Betrug zu verhindern",
    weTake:
      "Wir nehmen Ihre Sicherheit ernst. Bitte richten Sie jetzt 2FA ein, um Ihrem Konto eine zusätzliche Schutzebene hinzuzufügen.",
  ...
  reimbursementAccountLoadingAnimation: {
    ...
    explanationLine:
      "Wir überprüfen gerade Ihre Angaben. Sie können in Kürze mit den nächsten Schritten fortfahren.",
  },
  session: {
    offlineMessageRetry:
      "Anscheinend bist du offline. Bitte prüfe deine Verbindung und versuche es erneut.",
  },
  travel: {
    header: "Reise buchen",
    title: "Reise clever",
    subtitle:
      "Nutze Expensify Travel, um die besten Reiseangebote zu erhalten und all deine geschäftlichen Ausgaben an einem Ort zu verwalten.",
    features: {
      saveMoney: "Spare Geld bei deinen Buchungen",
      alerts:
        "Erhalte Echtzeitbenachrichtigungen, wenn sich deine Reisepläne ändern",
    },
    ...
    termsAndConditions: {
      ...
      error:
        "Sie müssen den Expensify Travel Geschäftsbedingungen zustimmen, um fortzufahren",
    ...
    flightDetails: {
      ...
      layover: (layover: string) =>
        `<muted-text-label>Sie haben einen <strong>${layover} Zwischenstopp</strong> vor diesem Flug</muted-text-label>`,
      takeOff: "Abflug",
      landing: "Landung",
      seat: "Sitz",
      class: "Kabinenklasse",
    ...
    updates: {
      ...
      flightScheduleChangeClosed: (airlineCode: string, startDate?: string) =>
        `Änderung des Flugplans bestätigt: Flug ${airlineCode} startet jetzt um ${startDate}.`,
      flightUpdated: (
        airlineCode: string,
        origin: string,
        destination: string,
      ...
      flightCabinChanged: (airlineCode: string, cabinClass?: string) =>
        `Ihre Kabinenklasse wurde auf ${cabinClass} auf Flug ${airlineCode} aktualisiert.`,
      flightSeatConfirmed: (airlineCode: string) =>
        `Ihre Sitzplatzzuweisung für Flug ${airlineCode} wurde bestätigt.`,
      flightSeatChanged: (airlineCode: string) =>
        `Ihre Sitzplatzzuweisung auf Flug ${airlineCode} wurde geändert.`,
      flightSeatCancelled: (airlineCode: string) =>
        `Ihre Sitzplatzzuweisung auf Flug ${airlineCode} wurde entfernt.`,
      paymentDeclined:
        "Die Zahlung für Ihre Flugbuchung ist fehlgeschlagen. Bitte versuchen Sie es erneut.",
      bookingCancelledByTraveler: (type: string, id = "") =>
        `Sie haben Ihre ${type}-Reservierung ${id} storniert.`,
      bookingCancelledByVendor: (type: string, id = "") =>
        `Der Anbieter hat deine ${type}-Reservierung ${id} storniert.`,
      bookingRebooked: (type: string, id = "") =>
        `Ihre ${type}-Reservierung wurde erneut gebucht. Neue Bestätigungsnummer: ${id}.`,
      bookingUpdated: (type: string) =>
        `Ihre ${type}-Buchung wurde aktualisiert. Prüfen Sie die neuen Details in der Reiseroute.`,
      railTicketRefund: (
        origin: string,
        destination: string,
        startDate: string,
      ...
      railTicketExchange: (
        ...
        `Ihr Bahnticket für ${origin} → ${destination} am ${startDate} wurde umgetauscht.`,
      railTicketUpdate: (
        origin: string,
        destination: string,
        startDate: string,
      ) =>
        `Dein Zugticket von ${origin} nach ${destination} am ${startDate} wurde aktualisiert.`,
      defaultUpdate: (type: string) =>
        `Ihre ${type}-Reservierung wurde aktualisiert.`,
    },
    flightTo: "Flug nach",
    trainTo: "Zug nach",
  ...
  workspace: {
    common: {
      ...
      customFieldHint:
        "Füge benutzerdefinierte Codierung hinzu, die für alle Ausgaben dieses Mitglieds gilt.",
      reports: "Berichte",
      ...
      deleteWithCardsConfirmation:
        "Möchtest du diesen Workspace wirklich löschen? Dadurch werden alle Kartenfeeds und zugewiesenen Karten entfernt.",
      unavailable: "Nicht verfügbiger Arbeitsbereich",
      memberNotFound:
        "Mitglied nicht gefunden. Um ein neues Mitglied zum Arbeitsbereich einzuladen, verwende bitte die Einladungsschaltfläche oben.",
      ...
      mustBeOnlineToViewMembers:
        "Du musst online sein, um die Mitglieder dieses Arbeitsbereichs anzeigen zu können.",
      moreFeatures: "Mehr Funktionen",
      requested: "Angefordert",
      distanceRates: "Kilometersätze",
      defaultDescription: "Ein Ort für all Ihre Belege und Ausgaben.",
      descriptionHint:
        "Teile Informationen über diesen Arbeitsbereich mit allen Mitgliedern.",
      welcomeNote:
        "Bitte nutze Expensify, um deine Belege zur Erstattung einzureichen, danke!",
      subscription: "Abonnement",
      ...
      exportIntegrationSelected: ({
        ...
        `Exportieren nach ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
      letsDoubleCheck:
        "Lass uns noch einmal überprüfen, ob alles richtig aussieht.",
      ...
      connectTo: ({ connectionName }: ConnectionNameParams) =>
        `Mit ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]} verbinden`,
      ...
      lastSyncDate: (connectionName: string, formattedDate: string) =>
        `${connectionName} – Zuletzt synchronisiert am ${formattedDate}`,
      authenticationError: (connectionName: string) =>
        `Verbindung mit ${connectionName} aufgrund eines Authentifizierungsfehlers nicht möglich.`,
      learnMore: "Mehr erfahren",
      memberAlternateText: "Berichte einreichen und freigeben.",
      adminAlternateText:
        "Berichte und Arbeitsbereichseinstellungen verwalten.",
    ...
    receiptPartners: {
      uber: {
        subtitle: (organizationName: string) =>
          organizationName
            ? `Verbunden mit ${organizationName}`
            : "Automatisiere Reise- und Essenslieferkosten in deinem gesamten Unternehmen.",
        ...
        takeBusinessRideMessage:
          "Mach eine Geschäfts­fahrt und deine Uber-Belege werden in Expensify importiert. Los geht’s!",
        all: "Alle",
        linked: "Verknüpft",
        ...
        status: {
          ...
          [CONST.POLICY.RECEIPT_PARTNERS.UBER_EMPLOYEE_STATUS
            .LINKED_PENDING_APPROVAL]: "Ausstehend",
        ...
        centralBillingDescription:
          "Wähle aus, wohin alle Uber-Belege importiert werden sollen.",
        invitationFailure:
          "Mitglied konnte nicht zu Uber for Business eingeladen werden",
        autoInvite: "Neue Workspace-Mitglieder zu Uber for Business einladen",
        autoRemove:
          "Entfernte Mitglieder des Arbeitsbereichs in Uber for Business deaktivieren",
        emptyContent: {
          title: "Keine ausstehenden Einladungen",
          subtitle:
            "Hurra! Wir haben überall gesucht und keine offenen Einladungen gefunden.",
        },
      },
    },
    perDiem: {
      ...
      emptyList: {
        title: "Tagegeld",
        subtitle:
          "Legen Sie Pauschalbeträge fest, um die täglichen Ausgaben der Mitarbeitenden zu steuern. Importieren Sie zu Beginn die Sätze aus einer Tabellenkalkulation.",
      },
      ...
      editDestinationSubtitle: (destination: string) =>
        `Wenn Sie dieses Ziel aktualisieren, wird es für alle ${destination}-Tagespauschalen-Teilbeträge geändert.`,
      editCurrencySubtitle: (destination: string) =>
        `Wenn Sie diese Währung aktualisieren, wird sie für alle ${destination}-Tagesgeld-Teilbeträge geändert.`,
    },
    qbd: {
      exportOutOfPocketExpensesDescription:
        "Legen Sie fest, wie aus eigener Tasche bezahlte Ausgaben nach QuickBooks Desktop exportiert werden.",
      exportOutOfPocketExpensesCheckToggle:
        "Schecks als „später drucken“ markieren",
      exportDescription:
        "Konfigurieren Sie, wie Expensify-Daten nach QuickBooks Desktop exportiert werden.",
      date: "Exportdatum",
      ...
      accountsPayableDescription:
        "Wählen Sie aus, wo Kreditorenrechnungen erstellt werden sollen.",
      bankAccount: "Bankkonto",
      notConfigured: "Nicht konfiguriert",
      bankAccountDescription:
        "Wähle aus, von wo Schecks versendet werden sollen.",
      creditCardAccount: "Kreditkartenkonto",
      exportDate: {
        label: "Exportdatum",
        description:
          "Verwende dieses Datum beim Exportieren von Berichten in QuickBooks Desktop.",
        values: {
          ...
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Exportdatum",
            description:
              "Datum, an dem der Bericht nach QuickBooks Desktop exportiert wurde.",
          },
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_SUBMITTED]: {
            label: "Eingereichtes Datum",
            description:
              "Datum, an dem der Bericht zur Genehmigung eingereicht wurde.",
          },
        },
      },
      ...
      exportJournalEntryDescription:
        "Wir erstellen für jeden Expensify-Bericht einen detaillierten Buchungssatz und buchen ihn auf das untenstehende Konto.",
      ...
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK}Error`]:
          "Schecks sind nicht verfügbar, wenn Standorte aktiviert sind. Bitte wähle eine andere Exportoption.",
        [`${CONST.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY}Error`]:
          "Buchungssätze sind nicht verfügbar, wenn Steuern aktiviert sind. Bitte wähle eine andere Exportoption.",
      },
      noAccountsFound: "Keine Konten gefunden",
      noAccountsFoundDescription:
        "Füge das Konto in QuickBooks Desktop hinzu und synchronisiere die Verbindung erneut",
      qbdSetup: "QuickBooks Desktop-Einrichtung",
      requiredSetupDevice: {
        title: "Von diesem Gerät aus keine Verbindung möglich",
        body1:
          "Sie müssen diese Verbindung von dem Computer aus einrichten, auf dem Ihre QuickBooks Desktop-Unternehmensdatei gespeichert ist.",
        body2:
          "Sobald du verbunden bist, kannst du von überall aus synchronisieren und exportieren.",
      },
      setupPage: {
      ...
      importDescription:
        "Wählen Sie aus, welche Kontierungskonfigurationen aus QuickBooks Desktop nach Expensify importiert werden sollen.",
      classes: "Kategorien",
      items: "Posten",
      customers: "Kunden/Projekte",
      exportCompanyCardsDescription:
        "Legen Sie fest, wie Einkäufe mit der Firmenkarte nach QuickBooks Desktop exportiert werden.",
      defaultVendorDescription:
        "Legen Sie einen Standardanbieter fest, der beim Export auf alle Kreditkartentransaktionen angewendet wird.",
      accountsDescription:
        "Ihr QuickBooks Desktop-Kontenplan wird in Expensify als Kategorien importiert.",
      accountsSwitchTitle:
        "Wählen Sie, ob neue Konten als aktivierte oder deaktivierte Kategorien importiert werden sollen.",
      accountsSwitchDescription:
        "Aktivierte Kategorien stehen Mitgliedern bei der Erstellung ihrer Ausgaben zur Auswahl.",
      classesDescription:
        "Wählen Sie, wie QuickBooks Desktop-Klassen in Expensify behandelt werden sollen.",
      tagsDisplayedAsDescription: "Positionsebene",
      reportFieldsDisplayedAsDescription: "Report-Ebene",
      customersDescription:
        "Wählen Sie aus, wie QuickBooks Desktop-Kunden/Projekte in Expensify behandelt werden sollen.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify wird automatisch jeden Tag mit QuickBooks Desktop synchronisiert.",
        createEntities: "Entitäten automatisch erstellen",
        createEntitiesDescription:
          "Expensify erstellt in QuickBooks Desktop automatisch Kreditoren, wenn sie noch nicht vorhanden sind.",
      },
      itemsDescription:
        "Wählen Sie aus, wie QuickBooks Desktop-Positionen in Expensify verarbeitet werden sollen.",
      accountingMethods: {
        ...
        alternateText: {
          [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL]:
            "Auslagen aus eigener Tasche werden nach endgültiger Genehmigung exportiert",
          [COMMON_CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH]:
            "Auslagenausgaben werden beim Bezahlen exportiert",
        },
      },
    },
    qbo: {
      ...
      importDescription:
        "Wähle aus, welche Buchungskonfigurationen aus QuickBooks Online nach Expensify importiert werden sollen.",
      classes: "Kategorien",
      locations: "Standorte",
      customers: "Kunden/Projekte",
      accountsDescription:
        "Ihr QuickBooks Online-Kontenplan wird in Expensify als Kategorien importiert.",
      accountsSwitchTitle:
        "Wählen Sie, ob neue Konten als aktivierte oder deaktivierte Kategorien importiert werden sollen.",
      accountsSwitchDescription:
        "Aktivierte Kategorien stehen Mitgliedern bei der Erstellung ihrer Ausgaben zur Auswahl.",
      classesDescription:
        "Wählen Sie, wie QuickBooks Online-Klassen in Expensify behandelt werden sollen.",
      customersDescription:
        "Wählen Sie aus, wie QuickBooks Online-Kunden/Projekte in Expensify behandelt werden sollen.",
      locationsDescription:
        "Wählen Sie aus, wie QuickBooks Online-Standorte in Expensify behandelt werden sollen.",
      taxesDescription:
        "Wählen Sie aus, wie QuickBooks Online-Steuern in Expensify behandelt werden sollen.",
      ...
      taxesJournalEntrySwitchNote:
        "QuickBooks Online unterstützt keine Steuern bei Buchungsbelegen. Bitte ändere deine Exportoption auf Lieferantenrechnung oder Scheck.",
      exportDescription:
        "Konfiguriere, wie Expensify-Daten nach QuickBooks Online exportiert werden.",
      date: "Exportdatum",
      exportInvoices: "Rechnungen exportieren nach",
      exportExpensifyCard: "Expensify Karte-Transaktionen exportieren als",
      exportDate: {
        label: "Exportdatum",
        description:
          "Verwenden Sie dieses Datum beim Exportieren von Berichten zu QuickBooks Online.",
        values: {
          [CONST.QUICKBOOKS_EXPORT_DATE.LAST_EXPENSE]: {
            label: "Datum der letzten Ausgabe",
            description: "Datum der letzten Ausgabe im Bericht.",
          ...
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Exportdatum",
            description:
              "Datum, an dem der Bericht nach QuickBooks Online exportiert wurde.",
          },
          [CONST.QUICKBOOKS_EXPORT_DATE.REPORT_SUBMITTED]: {
            label: "Eingereichtes Datum",
            description:
      ...
      exportInvoicesDescription:
        "Verwenden Sie dieses Konto beim Exportieren von Rechnungen nach QuickBooks Online.",
      exportCompanyCardsDescription:
        "Legen Sie fest, wie Unternehmenskartenkäufe nach QuickBooks Online exportiert werden.",
      vendor: "Lieferant",
      defaultVendorDescription:
        "Legen Sie einen Standardanbieter fest, der beim Export auf alle Kreditkartentransaktionen angewendet wird.",
      exportOutOfPocketExpensesDescription:
        "Legen Sie fest, wie Auslagen in QuickBooks Online exportiert werden.",
      exportCheckDescription:
        "Wir erstellen für jeden Expensify-Bericht einen Einzelpostenscheck und senden ihn von dem unten stehenden Bankkonto.",
      exportJournalEntryDescription:
        "Wir erstellen für jeden Expensify-Bericht einen detaillierten Buchungssatz und buchen ihn auf das untenstehende Konto.",
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify wird sich jeden Tag automatisch mit QuickBooks Online synchronisieren.",
        inviteEmployees: "Mitarbeitende einladen",
        inviteEmployeesDescription:
          "QuickBooks Online-Mitarbeiterdatensätze importieren und Mitarbeitende zu diesem Arbeitsbereich einladen.",
        createEntities: "Entitäten automatisch erstellen",
        createEntitiesDescription:
        ...
        accountSelectDescription:
          "Wählen Sie, von welchem Konto Sie Rechnungen bezahlen möchten, und wir erstellen die Zahlung in QuickBooks Online.",
        invoiceAccountSelectorDescription:
          "Wähle aus, wo Rechnungszahlungen eingehen sollen, und wir erstellen die Zahlung in QuickBooks Online.",
      },
      accounts: {
        ...
        [`${CONST.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD}AccountDescription`]:
          "Wähle aus, wohin Debitkartentransaktionen exportiert werden sollen.",
      ...
      exportDestinationAccountsMisconfigurationError: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Wähle ein gültiges Konto für den Export von Lieferantenrechnungen aus",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Wähle ein gültiges Konto für den Export des Buchungssatzes",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Wähle ein gültiges Konto für den Scheckexport",
      },
      exportDestinationSetupAccountsInfo: {
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL]:
          "Um den Export von Kreditorenrechnungen zu verwenden, richte in QuickBooks Online ein Kreditorenkonto ein",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY]:
          "Um den Export von Buchungsjournalen zu verwenden, richte ein Journal-Konto in QuickBooks Online ein",
        [CONST.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK]:
          "Um den Scheck-Export zu verwenden, richte ein Bankkonto in QuickBooks Online ein",
      },
      noAccountsFound: "Keine Konten gefunden",
      noAccountsFoundDescription:
        "Fügen Sie das Konto in QuickBooks Online hinzu und synchronisieren Sie die Verbindung erneut.",
      accountingMethods: {
        label: "Wann exportieren",
        description: "Wähle aus, wann die Ausgaben exportiert werden sollen:",
        values: {
    ...
    xero: {
      ...
      organizationDescription:
        "Wähle die Xero-Organisation aus, aus der du Daten importieren möchtest.",
      importDescription:
        "Wähle aus, welche Kontierungskonfigurationen aus Xero nach Expensify importiert werden sollen.",
      accountsDescription:
        "Ihr Xero-Kontenplan wird in Expensify als Kategorien importiert.",
      accountsSwitchTitle:
        "Wählen Sie, ob neue Konten als aktivierte oder deaktivierte Kategorien importiert werden sollen.",
      accountsSwitchDescription:
        "Aktivierte Kategorien stehen Mitgliedern bei der Erstellung ihrer Ausgaben zur Auswahl.",
      ...
      trackingCategoriesDescription:
        "Wählen Sie aus, wie Xero-Trackingkategorien in Expensify behandelt werden sollen.",
      mapTrackingCategoryTo: (categoryName: string) =>
        `Xero-Kategorie ${categoryName} zuordnen zu`,
      mapTrackingCategoryToDescription: (categoryName: string) =>
        `Wähle, wohin ${categoryName} beim Export nach Xero zugeordnet werden soll.`,
      ...
      taxesDescription:
        "Wählen Sie aus, wie Xero-Steuern in Expensify gehandhabt werden sollen.",
      notImported: "Nicht importiert",
      notConfigured: "Nicht konfiguriert",
      trackingCategoriesOptions: {
        [CONST.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT]:
          "Standardkontakt für Xero",
        [CONST.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG]: "Tags",
        [CONST.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD]:
          "Berichtsfelder",
      },
      exportDescription:
        "Konfigurieren Sie, wie Expensify-Daten nach Xero exportiert werden.",
      ...
      xeroBankAccountDescription:
        "Wählen Sie, wo Spesen als Banktransaktionen verbucht werden.",
      exportExpensesDescription:
        "Berichte werden als Einkaufsrechnung mit dem unten ausgewählten Datum und Status exportiert.",
      purchaseBillDate: "Rechnungsdatum des Einkaufs",
      exportInvoices: "Rechnungen exportieren als",
      salesInvoice: "Verkaufsrechnung",
      exportInvoicesDescription:
        "Verkaufsrechnungen zeigen immer das Datum an, an dem die Rechnung versendet wurde.",
      advancedConfig: {
        autoSyncDescription:
          "Expensify wird sich jeden Tag automatisch mit Xero synchronisieren.",
        purchaseBillStatusTitle: "Status der Einkaufsrechnung",
        reimbursedReportsDescription:
          "Jedes Mal, wenn ein Bericht über Expensify ACH bezahlt wird, wird die entsprechende Rechnungszahlung im untenstehenden Xero-Konto erstellt.",
        ...
        xeroBillPaymentAccountDescription:
          "Wählen Sie, von wo aus Sie Rechnungen bezahlen möchten, und wir erstellen die Zahlung in Xero.",
        invoiceAccountSelectorDescription:
          "Wählen Sie aus, wohin Rechnungzahlungen eingehen sollen, und wir erstellen die Zahlung in Xero.",
      },
      exportDate: {
        label: "Rechnungsdatum des Einkaufs",
        description:
          "Verwenden Sie dieses Datum beim Export von Berichten nach Xero.",
        values: {
          ...
          [CONST.XERO_EXPORT_DATE.REPORT_EXPORTED]: {
            label: "Exportdatum",
            description:
              "Datum, an dem der Bericht nach Xero exportiert wurde.",
          },
      ...
      invoiceStatus: {
        ...
        description:
          "Verwende diesen Status beim Exportieren von Einkaufsrechnungen nach Xero.",
        values: {
      ...
      noAccountsFound: "Keine Konten gefunden",
      noAccountsFoundDescription:
        "Bitte fügen Sie das Konto in Xero hinzu und synchronisieren Sie die Verbindung erneut",
      accountingMethods: {
        label: "Wann exportieren",
        description: "Wähle aus, wann die Ausgaben exportiert werden sollen:",
        values: {
    ...
    sageIntacct: {
      ...
      exportDate: {
        label: "Exportdatum",
        description:
          "Verwende dieses Datum beim Exportieren von Reports nach Sage Intacct.",
        values: {
          ...
          [CONST.SAGE_INTACCT_EXPORT_DATE.EXPORTED]: {
            label: "Exportdatum",
            description:
              "Datum, an dem der Bericht nach Sage Intacct exportiert wurde.",
          },
      ...
      reimbursableExpenses: {
        description:
          "Legen Sie fest, wie aus eigener Tasche bezahlte Ausgaben nach Sage Intacct exportiert werden.",
        values: {
      ...
      nonReimbursableExpenses: {
        description:
          "Legen Sie fest, wie Firmenkarteneinkäufe nach Sage Intacct exportiert werden.",
        values: {
      ...
      exportDescription:
        "Konfigurieren Sie, wie Expensify Daten nach Sage Intacct exportiert.",
      ...
      exportPreferredExporterSubNote:
        "Sobald festgelegt, sieht die bevorzugte exportierende Person die zu exportierenden Berichte in ihrem Konto.",
      noAccountsFound: "Keine Konten gefunden",
      ...
      autoSyncDescription:
        "Expensify wird jeden Tag automatisch mit Sage Intacct synchronisiert.",
      inviteEmployees: "Mitarbeitende einladen",
      inviteEmployeesDescription:
    ...
    netsuite: {
      ...
      subsidiarySelectDescription:
        "Wähle die Tochtergesellschaft in NetSuite aus, aus der du Daten importieren möchtest.",
      exportDescription:
        "Konfigurieren Sie, wie Expensify-Daten nach NetSuite exportiert werden.",
      exportInvoices: "Rechnungen exportieren nach",
      journalEntriesTaxPostingAccount: "Steuerbuchungskonto für Buchungssätze",
      journalEntriesProvTaxPostingAccount:
        "Buchungszeilen-Konto für Provinzsteuerbuchungen",
      ...
      nonReimbursableJournalPostingAccount:
        "Nicht erstattungsfähiges Konto für Buchungssätze",
      reimbursableJournalPostingAccount:
        "Konto für die Verbuchung erstattungsfähiger Posten",
      journalPostingPreference: {
        ...
        values: {
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            ...
            "Einzelner, aufgeschlüsselter Eintrag für jeden Bericht",
          [CONST.NETSUITE_JOURNAL_POSTING_PREFERENCE
            .JOURNALS_POSTING_TOTAL_LINE]: "Einzelner Eintrag für jede Ausgabe",
        },
      },
      invoiceItem: {
        ...
        values: {
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.CREATE]: {
            ...
            description:
              "Wir erstellen beim Export eine „Expensify-Rechnungsposition“ für dich, falls noch keine vorhanden ist.",
          },
          [CONST.NETSUITE_INVOICE_ITEM_PREFERENCE.SELECT]: {
            label: "Vorhandene auswählen",
            description:
              "Wir verknüpfen Rechnungen von Expensify mit dem unten ausgewählten Eintrag.",
          },
        },
      },
      exportDate: {
        label: "Exportdatum",
        description:
          "Verwende dieses Datum beim Exportieren von Berichten nach NetSuite.",
        values: {
          ...
          [CONST.NETSUITE_EXPORT_DATE.EXPORTED]: {
            label: "Exportdatum",
            description:
              "Datum, an dem der Bericht nach NetSuite exportiert wurde.",
          },
        ...
        values: {
          [CONST.NETSUITE_EXPORT_DESTINATION.EXPENSE_REPORT]: {
            ...
            reimbursableDescription:
              "Auslagen aus eigener Tasche werden als Spesenberichte nach NetSuite exportiert.",
            nonReimbursableDescription:
              "Firmenkartenausgaben werden als Spesenabrechnungen nach NetSuite exportiert.",
          },
      ...
      advancedConfig: {
        autoSyncDescription:
          "Expensify wird automatisch jeden Tag mit NetSuite synchronisiert.",
        reimbursedReportsDescription:
        ...
        reimbursementsAccountDescription:
          "Wähle das Bankkonto, das du für Rückerstattungen verwenden möchtest, und wir erstellen die zugehörige Zahlung in NetSuite.",
        collectionsAccount: "Inkassokonto",
        collectionsAccountDescription:
          "Sobald eine Rechnung in Expensify als bezahlt markiert und nach NetSuite exportiert wurde, erscheint sie auf dem untenstehenden Konto.",
        ...
        exportVendorBillsTo: {
          ...
          values: {
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVED_NONE]: "Standardvorgabe für NetSuite",
            [CONST.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL
              .VENDOR_BILLS_APPROVAL_PENDING]: "Ausstehende Genehmigung",
        ...
        error: {
          customFormID:
            "Bitte gib eine gültige numerische benutzerdefinierte Formular-ID ein",
        },
      },
      noAccountsFound: "Keine Konten gefunden",
      noAccountsFoundDescription:
        "Bitte fügen Sie das Konto in NetSuite hinzu und synchronisieren Sie die Verbindung erneut.",
      noVendorsFound: "Keine Anbieter gefunden",
      noVendorsFoundDescription:
        "Bitte fügen Sie Lieferanten in NetSuite hinzu und synchronisieren Sie die Verbindung erneut",
      noItemsFound: "Keine Rechnungspositionen gefunden",
      noItemsFoundDescription:
        "Bitte fügen Sie Rechnungsposten in NetSuite hinzu und synchronisieren Sie die Verbindung erneut",
      noSubsidiariesFound: "Keine Tochtergesellschaften gefunden",
      noSubsidiariesFoundDescription:
        "Bitte füge in NetSuite eine Tochtergesellschaft hinzu und synchronisiere die Verbindung erneut",
      tokenInput: {
        ...
        formSteps: {
          installBundle: {
            ...
            description:
              "Wechsel in NetSuite zu *Customization > SuiteBundler > Search & Install Bundles*, suche nach „Expensify“ und installiere das Bundle.",
          },
          enableTokenAuthentication: {
            title: "Tokenbasierte Authentifizierung aktivieren",
            description:
              "Gehe in NetSuite zu *Setup > Company > Enable Features > SuiteCloud* und aktiviere *token-based authentication*.",
          },
          enableSoapServices: {
            title: "SOAP-Webdienste aktivieren",
            description:
              "Gehe in NetSuite zu *Setup > Company > Enable Features > SuiteCloud* und aktiviere *SOAP Web Services*.",
          },
          createAccessToken: {
          ...
          enterCredentials: {
            ...
            netSuiteAccountIDDescription:
              "Wechsel in NetSuite zu *Setup > Integration > SOAP Web Services Preferences*.",
          },
        },
      },
      import: {
        ...
        expenseCategoriesDescription:
          "Ihre NetSuite-Spesenkategorien werden als Kategorien in Expensify importiert.",
        crossSubsidiaryCustomers: "Konzernübergreifende Kunden/Projekte",
        importFields: {
          departments: {
            title: "Abteilungen",
            subtitle:
              "Wählen Sie aus, wie die NetSuite-*Abteilungen* in Expensify behandelt werden sollen.",
          },
          classes: {
            title: "Kategorien",
            subtitle:
              "Wählen Sie aus, wie *Klassen* in Expensify behandelt werden sollen.",
          },
          locations: {
            title: "Standorte",
            subtitle:
              "Wählen Sie, wie *Standorte* in Expensify behandelt werden sollen.",
          },
        },
        customersOrJobs: {
          title: "Kunden/Projekte",
          subtitle:
            "Wähle aus, wie NetSuite-*Kunden* und *Projekte* in Expensify behandelt werden sollen.",
          ...
          label: (importFields: string[], importType: string) =>
            `${importFields.join("und")}, ${importType}`,
        },
        ...
        importCustomFields: {
          ...
          label: (importedTypes: string[]) =>
            `Importiert als ${importedTypes.join("und")}`,
          requiredFieldError: (fieldName: string) =>
            `Bitte gib ${fieldName} ein`,
          customSegments: {
            ...
            helpText:
              "zur Konfiguration benutzerdefinierter Segmente/Datensätze.",
            emptyTitle:
              "Benutzerdefiniertes Segment oder benutzerdefinierten Datensatz hinzufügen",
            fields: {
              segmentName: "Name",
            ...
            removePrompt:
              "Möchten Sie dieses benutzerdefinierte Segment/den benutzerdefinierten Datensatz wirklich entfernen?",
            addForm: {
              ...
              segmentRecordType:
                "Möchtest du ein benutzerdefiniertes Segment oder einen benutzerdefinierten Datensatz hinzufügen?",
              customSegmentNameTitle:
                "Wie heißt das benutzerdefinierte Segment?",
              customRecordNameTitle:
                "Wie lautet der Name des benutzerdefinierten Datensatzes?",
...
_Für detailliertere Anweisungen [besuchen Sie unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
              customRecordScriptIDTitle:
                "Wie lautet die Transaktionsspalten-ID?",
...
_Für detailliertere Anweisungen [besuchen Sie unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_SEGMENTS})._`,
              customSegmentMappingTitle:
                "Wie soll dieses benutzerdefinierte Segment in Expensify angezeigt werden?",
              customRecordMappingTitle:
                "Wie soll dieser benutzerdefinierte Datensatz in Expensify angezeigt werden?",
            },
            errors: {
              uniqueFieldError: (fieldName: string) =>
                `Ein benutzerdefiniertes Segment/Datensatz mit dieser ${fieldName?.toLowerCase()} existiert bereits`,
            },
          },
          customLists: {
            ...
            removePrompt:
              "Möchtest du diese benutzerdefinierte Liste wirklich entfernen?",
            addForm: {
...
_Für ausführlichere Anweisungen [besuchen Sie unsere Hilfeseite](${CONST.NETSUITE_IMPORT.HELP_LINKS.CUSTOM_LISTS})_.`,
              mappingTitle:
                "Wie soll diese benutzerdefinierte Liste in Expensify angezeigt werden?",
            },
            errors: {
        ...
        importTypes: {
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]: {
            ...
            description:
              "Nicht in Expensify importiert, beim Export angewendet",
          ...
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.TAG]: {
            ...
            footerContent: (importField: string) =>
              `${startCase(importField)} wird für jede einzelne Ausgabe in einem Mitarbeitendenbericht auswählbar sein.`,
          },
          [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]: {
            label: "Berichtsfelder",
            description: "Report-Ebene",
            footerContent: (importField: string) =>
              `${startCase(importField)}-Auswahl wird auf alle Ausgaben im Bericht der Mitarbeitenden angewendet.`,
          },
        },
      },
    },
    intacct: {
      ...
      downloadExpensifyPackage:
        "Lade das Expensify-Paket für Sage Intacct herunter",
      followSteps:
        "Folge den Schritten in unserer Anleitung „How-to: Connect to Sage Intacct“",
      ...
      employeeDefaultDescription:
        "Die Standardabteilung der*des Mitarbeitenden wird auf ihre Ausgaben in Sage Intacct angewendet, sofern eine vorhanden ist.",
      displayedAsTagDescription:
        "Die Abteilung kann für jede einzelne Ausgabe im Bericht eines Mitarbeitenden ausgewählt werden.",
      displayedAsReportFieldDescription:
        "Die Abteilungsauswahl wird auf alle Ausgaben im Bericht einer*s Mitarbeitenden angewendet.",
      toggleImportTitle: (mappingTitle: string) =>
        `Wähle aus, wie Sage Intacct-<strong>${mappingTitle}</strong> in Expensify behandelt werden soll.`,
      expenseTypes: "Ausgabenarten",
      expenseTypesDescription:
        "Ihre Sage Intacct-Spesenarten werden in Expensify als Kategorien importiert.",
      accountTypesDescription:
        "Ihr Sage Intacct-Kontenplan wird in Expensify als Kategorien importiert.",
      importTaxDescription:
        "Steuersatz für Einkäufe aus Sage Intacct importieren.",
      ...
      removeDimensionPrompt:
        "Sind Sie sicher, dass Sie diese benutzerdefinierte Dimension entfernen möchten?",
      ...
      detailedInstructionsRestOfSentence:
        "beim Hinzufügen benutzerdefinierter Dimensionen.",
      userDimensionsAdded: () => ({
    ...
    companyCards: {
      ...
      addNewCard: {
        ...
        howDoYouWantToConnect:
          "Wie möchten Sie Ihre Bankverbindung herstellen?",
        ...
        directFeedDetails:
          "Der einfachste Ansatz. Verbinde dich direkt mit deinen Hauptzugangsdaten. Diese Methode ist am gebräuchlichsten.",
        enableFeed: {
...
3. Sobald der Feed aktiviert ist, klicken Sie unten auf „Senden“ und wir kümmern uns um die Einrichtung.`,
        ...
        amexCorporate:
          "Wähle dies aus, wenn auf der Vorderseite deiner Karten „Corporate“ steht",
        amexBusiness:
          "Wähle dies aus, wenn auf der Vorderseite deiner Karten „Business“ steht",
        amexPersonal: "Wähle dies aus, wenn deine Karten privat sind",
        error: {
          pleaseSelectProvider:
            "Bitte wählen Sie einen Kartenanbieter aus, bevor Sie fortfahren",
          pleaseSelectBankAccount:
            "Bitte wähle ein Bankkonto aus, bevor du fortfährst",
          pleaseSelectBank:
            "Bitte wähle ein Bankkonto aus, bevor du fortfährst",
          pleaseSelectCountry: "Bitte wähle ein Land aus, bevor du fortfährst",
          pleaseSelectFeedType:
            "Bitte wähle einen Feed-Typ aus, bevor du fortfährst",
        },
        exitModal: {
          title: "Funktioniert etwas nicht?",
          prompt:
            "Wir haben bemerkt, dass du das Hinzufügen deiner Karten nicht abgeschlossen hast. Wenn du auf ein Problem gestoßen bist, gib uns bitte Bescheid, damit wir dir helfen können, alles wieder auf Kurs zu bringen.",
      ...
      statementCloseDate: {
        ...
        [CONST.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH]:
          "Benutzerdefinierter Tag des Monats",
      },
      assign: "Zuweisen",
      ...
      chooseCardFor: (assignee: string) =>
        `Wähle eine Karte für <strong>${assignee}</strong>. Du findest die gesuchte Karte nicht? <concierge-link>Gib uns Bescheid.</concierge-link>`,
      ...
      startDateDescription:
        "Wähle dein Import-Startdatum. Wir synchronisieren alle Transaktionen ab diesem Datum.",
      ...
      confirmationDescription:
        "Wir beginnen sofort mit dem Import der Transaktionen.",
      card: "Karte",
      cardName: "Kartenname",
      ...
      assignedCard: (assignee: string, link: string) =>
        `${assignee} wurde ${link} zugewiesen! Importierte Transaktionen werden in diesem Chat angezeigt.`,
      ...
      cardAlreadyAssignedError:
        "Diese Karte ist bereits einem Nutzenden in einem anderen Workspace zugeordnet.",
      importTransactions: {
        title: "Transaktionen aus Datei importieren",
        description:
          "Bitte passe die Einstellungen für deine Datei an, die beim Import angewendet werden.",
    ...
    expensifyCard: {
      issueAndManageCards:
        "Geben Sie Expensify Karten aus und verwalten Sie sie",
      getStartedIssuing:
        "Beginne, indem du deine erste virtuelle oder physische Karte ausstellst.",
      verificationInProgress: "Verifizierung läuft ...",
      verifyingTheDetails:
        "Wir überprüfen ein paar Details. Concierge informiert Sie, sobald Expensify Karten ausgegeben werden können.",
      disclaimer:
      ...
      currentBalanceDescription:
        "Der aktuelle Saldo ist die Summe aller verbuchten Expensify Karte-Transaktionen, die seit dem letzten Abrechnungsdatum erfolgt sind.",
      balanceWillBeSettledOn: (settlementDate: string) =>
        `Der Saldo wird am ${settlementDate} ausgeglichen.`,
      ...
      earnedCashbackDescription:
        "Der Cashback-Saldo basiert auf den abgerechneten monatlichen Ausgaben mit der Expensify Karte in Ihrem Arbeitsbereich.",
      issueNewCard: "Neue Karte ausstellen",
      finishSetup: "Einrichtung abschließen",
      chooseBankAccount: "Bankkonto auswählen",
      chooseExistingBank:
        "Wählen Sie ein bestehendes Geschäftskonto aus, um den Saldo Ihrer Expensify Karte zu bezahlen, oder fügen Sie ein neues Bankkonto hinzu",
      accountEndingIn: "Konto mit Endziffern",
      addNewBankAccount: "Neues Bankkonto hinzufügen",
      settlementAccount: "Verrechnungskonto",
      settlementAccountDescription:
        "Wählen Sie ein Konto aus, um den Saldo Ihrer Expensify Karte zu begleichen.",
      ...
      settlementFrequencyDescription:
        "Wählen Sie, wie oft Sie den Saldo Ihrer Expensify Karte begleichen.",
      ...
      cardPending: ({ name }: { name: string }) =>
        `Die Karte ist derzeit ausstehend und wird ausgestellt, sobald das Konto von ${name} verifiziert wurde.`,
      virtual: "Virtuell",
      physical: "Physisch",
      ...
      monthlyLimitWarning: (limit: number | string) =>
        `Wenn du das Limit dieser Karte auf ${limit} änderst, werden neue Transaktionen bis zum nächsten Monat abgelehnt.`,
      fixedLimitWarning: (limit: number | string) =>
        `Wenn du das Limit dieser Karte auf ${limit} änderst, werden neue Transaktionen abgelehnt.`,
      ...
      issuedCard: (assignee: string) =>
        `hat ${assignee} eine Expensify Karte ausgestellt! Die Karte wird in 2–3 Werktagen ankommen.`,
      issuedCardNoShippingDetails: (assignee: string) =>
        `hat ${assignee} eine Expensify Karte ausgestellt! Die Karte wird versendet, sobald die Versanddaten bestätigt sind.`,
      issuedCardVirtual: (assignee: string, link: string) =>
        `hat ${assignee} eine virtuelle Expensify Karte ausgestellt! Die ${link} kann sofort verwendet werden.`,
      addedShippingDetails: (assignee: string) =>
        `${assignee} hat Versanddetails hinzugefügt. Die Expensify Karte wird in 2–3 Werktagen ankommen.`,
      replacedCard: (assignee: string) =>
        `${assignee} hat ihre Expensify Karte ersetzt. Die neue Karte wird in 2–3 Werktagen ankommen.`,
      replacedVirtualCard: (assignee: string, link: string) =>
        `${assignee} hat ihre virtuelle Expensify Karte ersetzt! Der ${link} kann sofort verwendet werden.`,
      card: "Karte",
      ...
      verifyingBankAccountDescription:
        "Bitte warten Sie, während wir bestätigen, dass dieses Konto zur Ausgabe von Expensify Karten verwendet werden kann.",
      bankAccountVerified: "Bankkonto verifiziert!",
      bankAccountVerifiedDescription:
        "Sie können Ihren Workspace-Mitgliedern jetzt Expensify Karten ausstellen.",
      oneMoreStep: "Noch ein Schritt …",
      oneMoreStepDescription:
        "Es sieht so aus, als müssten wir Ihr Bankkonto manuell verifizieren. Bitte gehen Sie zu Concierge, wo bereits Anweisungen auf Sie warten.",
      gotIt: "Verstanden",
    ...
    categories: {
      ...
      spendCategoriesDescription:
        "Legen Sie fest, wie Händlera usgaben für Kreditkartentransaktionen und gescannte Belege kategorisiert werden.",
      deleteFailureMessage:
        "Beim Löschen der Kategorie ist ein Fehler aufgetreten, bitte versuche es erneut.",
      ...
      subtitle:
        "Verschaffe dir einen besseren Überblick darüber, wofür Geld ausgegeben wird. Verwende unsere Standardkategorien oder füge eigene hinzu.",
      emptyCategories: {
        title: "Sie haben noch keine Kategorien erstellt",
        subtitle:
          "Füge eine Kategorie hinzu, um deine Ausgaben zu organisieren.",
      ...
      updateFailureMessage:
        "Beim Aktualisieren der Kategorie ist ein Fehler aufgetreten, bitte versuche es erneut.",
      createFailureMessage:
        "Beim Erstellen der Kategorie ist ein Fehler aufgetreten, bitte versuche es erneut.",
      ...
      importedFromAccountingSoftware:
        "Die folgenden Kategorien werden importiert aus Ihrem",
      payrollCode: "Lohnabrechnungscode",
      updatePayrollCodeFailureMessage:
        "Beim Aktualisieren des Lohnabrechnungscodes ist ein Fehler aufgetreten, bitte versuche es erneut.",
      glCode: "Hauptbuchcode",
      updateGLCodeFailureMessage:
        "Beim Aktualisieren des Hauptbuchcodes ist ein Fehler aufgetreten, bitte versuche es erneut.",
      importCategories: "Kategorien importieren",
      cannotDeleteOrDisableAllCategories: {
        title:
          "Es können nicht alle Kategorien gelöscht oder deaktiviert werden",
        description: `Mindestens eine Kategorie muss aktiviert bleiben, da dein Workspace Kategorien erfordert.`,
      },
    },
    moreFeatures: {
      subtitle:
        "Verwende die Schalter unten, um beim Wachsen weitere Funktionen zu aktivieren. Jede Funktion wird im Navigationsmenü angezeigt, wo du sie weiter anpassen kannst.",
      spendSection: {
        title: "Ausgaben",
        subtitle:
          "Aktiviere Funktionen, die dir helfen, dein Team zu skalieren.",
      },
      manageSection: {
        title: "Verwalten",
        subtitle:
          "Füge Steuerelemente hinzu, die helfen, Ausgaben im Budget zu halten.",
      },
      earnSection: {
        title: "Verdienen",
        subtitle:
          "Optimieren Sie Ihren Umsatz und lassen Sie sich schneller bezahlen.",
      },
      organizeSection: {
        title: "Organisieren",
        subtitle:
          "Ausgaben gruppieren und analysieren, jede gezahlte Steuer erfassen.",
      },
      integrateSection: {
        title: "Integrieren",
      ...
      perDiem: {
        title: "Tagegeld",
        subtitle:
          "Legen Sie Pauschalspesen fest, um die täglichen Ausgaben der Mitarbeitenden zu steuern.",
      },
      travel: {
        title: "Reisen",
        subtitle:
          "Buchen, verwalten und abstimmen Sie all Ihre Geschäftsreisen.",
        getStarted: {
          title: "Los geht’s mit Expensify Travel",
          subtitle:
            "Wir brauchen nur noch ein paar weitere Informationen zu deinem Unternehmen, dann bist du startklar.",
          ctaText: "Los geht's",
        },
        reviewingRequest: {
          title: "Pack deine Koffer, wir kümmern uns um deine Anfrage …",
          subtitle:
            "Wir prüfen derzeit deine Anfrage zur Aktivierung von Expensify Travel. Keine Sorge, wir sagen dir Bescheid, sobald alles bereit ist.",
          ctaText: "Anfrage gesendet",
        },
        bookOrManageYourTrip: {
          title: "Reisebuchung",
          subtitle:
            "Glückwunsch! Du kannst in diesem Arbeitsbereich jetzt Reisen buchen und verwalten.",
        ...
        settings: {
          autoAddTripName: {
            ...
            subtitle:
              "Reisenamen für in Expensify gebuchte Reisen automatisch zu Spesenbeschreibungen hinzufügen.",
          },
        },
        travelInvoicing: {
          travelBookingSection: {
            title: "Reisebuchung",
            subtitle:
              "Glückwunsch! Du kannst jetzt in diesem Workspace Reisen buchen und verwalten.",
            manageTravelLabel: "Reisen verwalten",
          },
          centralInvoicingSection: {
            title: "Zentrale Rechnungsstellung",
            subtitle:
              "Zentralisiere alle Reisekosten in einer monatlichen Rechnung, statt sie direkt beim Kauf zu bezahlen.",
            ...
            subsections: {
              ...
              settlementFrequencyDescription:
                "Wie oft Expensify Ihr Geschäftskonto belastet, um aktuelle Expensify Travel-Transaktionen zu begleichen.",
            },
          },
          disableModal: {
        ...
        personalDetailsDescription:
          "Um eine Reise zu buchen, gib bitte deinen amtlichen Namen genau so ein, wie er auf deinem amtlichen Ausweis steht.",
      },
      expensifyCard: {
        ...
        disableCardPrompt:
          "Sie können die Expensify Karte nicht deaktivieren, weil sie bereits verwendet wird. Wenden Sie sich an Concierge, um die nächsten Schritte zu erfahren.",
        disableCardButton: "Mit Concierge chatten",
        feed: {
          title: "Holen Sie sich die Expensify Karte",
          subTitle:
            "Optimieren Sie Ihre Geschäftsausgaben und sparen Sie bis zu 50 % bei Ihrer Expensify-Rechnung, plus:",
          features: {
      ...
      companyCards: {
        ...
        feed: {
          ...
          subtitle:
            "Verknüpfe deine vorhandenen Karten für den automatischen Transaktionsimport, Belegabgleich und die Abstimmung.",
          features: {
        ...
        disableCardPrompt:
          "Du kannst Firmenkarten nicht deaktivieren, da diese Funktion verwendet wird. Wende dich an den Concierge, um die nächsten Schritte zu erfahren.",
        disableCardButton: "Mit Concierge chatten",
        cardDetails: "Kartendaten",
        cardNumber: "Kartennummer",
        ...
        integrationExportTitleXero: (integration: string) =>
          `Wähle das ${integration}-Konto, in das Transaktionen exportiert werden sollen.`,
        ...
        unassignCardDescription:
          "Das Entfernen der Zuweisung dieser Karte wird alle nicht eingereichten Transaktionen löschen.",
        removeCard: "Karte entfernen",
        remove: "Entfernen",
        removeCardDescription:
          "Wenn Sie diese Karte entfernen, werden alle nicht eingereichten Transaktionen gelöscht.",
        assignCard: "Karte zuweisen",
        cardFeedName: "Name des Kartenfeeds",
        cardFeedNameDescription:
          "Gib dem Kartenfeed einen eindeutigen Namen, damit du ihn von den anderen unterscheiden kannst.",
        cardFeedTransaction: "Transaktionen löschen",
        cardFeedTransactionDescription:
          "Wähle aus, ob Karteninhaber Kartenumsätze löschen können. Neue Umsätze folgen diesen Regeln.",
        cardFeedRestrictDeletingTransaction:
          "Löschen von Transaktionen einschränken",
        ...
        removeCardFeedDescription:
          "Möchtest du diesen Kartenfeed wirklich entfernen? Dadurch werden alle Karten zugewiesen.",
        error: {
          feedNameRequired: "Name des Kartenfeeds ist erforderlich",
          statementCloseDateRequired:
            "Bitte wählen Sie ein Abrechnungsenddatum aus.",
        },
        corporate: "Löschen von Transaktionen einschränken",
        personal: "Löschen von Transaktionen erlauben",
        setFeedNameDescription:
          "Gib dem Karten-Feed einen eindeutigen Namen, damit du ihn von den anderen unterscheiden kannst",
        setTransactionLiabilityDescription:
          "Wenn aktiviert, können Karteninhaber Kartentransaktionen löschen. Neue Transaktionen folgen dieser Regel.",
        emptyAddedFeedTitle: "Keine Karten in diesem Feed",
        emptyAddedFeedDescription:
          "Stelle sicher, dass sich Karten im Kartenfeed deiner Bank befinden.",
        ...
        giveItNameInstruction:
          "Gib der Karte einen Namen, der sie von anderen abhebt.",
        ...
        noAccountsFoundDescription: (connection: string) =>
          `Bitte fügen Sie das Konto in ${connection} hinzu und synchronisieren Sie die Verbindung erneut.`,
        ...
        statementCloseDateDescription:
          "Teile uns mit, wann dein Kreditkartenkontoauszug abgeschlossen wird, und wir erstellen einen passenden Auszug in Expensify.",
      },
      workflows: {
        title: "Workflows",
        subtitle:
          "Konfigurieren Sie, wie Ausgaben genehmigt und bezahlt werden.",
      ...
      tags: {
        title: "Tags",
        subtitle:
          "Kosten klassifizieren und abrechenbare Ausgaben nachverfolgen.",
      },
      taxes: {
        title: "Steuern",
      ...
      connectionsWarningModal: {
        ...
        featureEnabledText:
          "Um diese Funktion zu aktivieren oder zu deaktivieren, musst du deine Einstellungen für den Buchhaltungsimport ändern.",
        disconnectText:
          "Um die Buchhaltung zu deaktivieren, musst du die Buchhaltungsanbindung von deinem Workspace trennen.",
        manageSettings: "Einstellungen verwalten",
      },
      receiptPartnersWarningModal: {
        featureEnabledTitle: "Uber-Verknüpfung trennen",
        disconnectText:
          "Um diese Funktion zu deaktivieren, trenne bitte zuerst die Uber for Business-Integration.",
      ...
      timeTracking: {
        title: "Zeit",
        subtitle:
          "Legen Sie einen abrechnungsfähigen Stundensatz für die Zeiterfassung fest.",
    ...
    reports: {
      ...
      customNameEmailPhoneExample:
        "E-Mail-Adresse oder Telefonnummer des Mitglieds: {report:submit:from}",
      ...
      preventMembersFromChangingCustomNamesTitle:
        "Mitglieder daran hindern, benutzerdefinierte Berichtstitel zu ändern",
    },
    reportFields: {
      ...
      deleteConfirmation:
        "Sind Sie sicher, dass Sie dieses Berichts­feld löschen möchten?",
      deleteFieldsConfirmation:
        "Möchten Sie diese Berichtsfelder wirklich löschen?",
      emptyReportFields: {
        title: "Du hast noch keine Berichtsfelder erstellt",
        subtitle:
          "Füge ein benutzerdefiniertes Feld (Text, Datum oder Dropdown) hinzu, das in Berichten erscheint.",
      },
      subtitle:
        "Berichtsfelder gelten für alle Ausgaben und können hilfreich sein, wenn du nach zusätzlichen Informationen fragen möchtest.",
      disableReportFields: "Berichtsfelder deaktivieren",
      disableReportFieldsConfirmation:
        "Bist du sicher? Text- und Datumsfelder werden gelöscht und Listen werden deaktiviert.",
      importedFromAccountingSoftware:
        "Die folgenden Berichtsfelder werden importiert aus Ihrem",
      textType: "Text",
      dateType: "Datum",
      dropdownType: "Liste",
      formulaType: "Formel",
      ...
      dropdownAlternateText:
        "Füge eine Liste von Optionen hinzu, aus denen du wählen kannst.",
      formulaAlternateText: "Füge ein Formel­feld hinzu.",
      nameInputSubtitle: "Wähle einen Namen für das Berichtsfeld.",
      typeInputSubtitle:
        "Wähle aus, welchen Typ von Berichts­feld du verwenden möchtest.",
      initialValueInputSubtitle:
        "Geben Sie einen Startwert ein, der im Berichtsfeld angezeigt werden soll.",
      listValuesInputSubtitle:
        "Diese Werte werden in der Dropdown-Liste des Berichtsfelds angezeigt. Aktivierte Werte können von Mitgliedern ausgewählt werden.",
      listInputSubtitle:
        "Diese Werte werden in Ihrer Liste der Berichtsfelder angezeigt. Aktivierte Werte können von Mitgliedern ausgewählt werden.",
      ...
      emptyReportFieldsValues: {
        ...
        subtitle:
          "Füge benutzerdefinierte Werte hinzu, die in Berichten erscheinen.",
      },
      deleteValuePrompt:
        "Sind Sie sicher, dass Sie diesen Listenwert löschen möchten?",
      deleteValuesPrompt:
        "Bist du sicher, dass du diese Listenwerte löschen möchtest?",
      listValueRequiredError: "Bitte gib einen Namen für den Listeneintrag ein",
      existingListValueError:
        "Ein Listenwert mit diesem Namen existiert bereits",
      editValue: "Wert bearbeiten",
      listValues: "Werte auflisten",
      addValue: "Wert hinzufügen",
      existingReportFieldNameError:
        "Ein Berichts­feld mit diesem Namen existiert bereits",
      ...
      circularReferenceError:
        "Dieses Feld kann nicht auf sich selbst verweisen. Bitte aktualisieren.",
      reportFieldInitialValueRequiredError:
        "Bitte wähle einen Anfangswert für ein Berichtsfeld aus",
      genericFailureMessage:
        "Beim Aktualisieren des Berichtfelds ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    },
    tags: {
      tagName: "Tag-Name",
      ...
      findTag: "Tag finden",
      subtitle:
        "Tags bieten detailliertere Möglichkeiten, Kosten zu klassifizieren.",
      ...
      emptyTags: {
        ...
        subtitle:
          "Füge ein Tag hinzu, um Projekte, Standorte, Abteilungen und mehr zu verfolgen.",
      ...
      deleteFailureMessage:
        "Beim Löschen des Tags ist ein Fehler aufgetreten, bitte versuche es erneut",
      tagRequiredError: "Tag-Name ist erforderlich",
      existingTagError: "Ein Tag mit diesem Namen existiert bereits",
      invalidTagNameError:
        "Tag-Name darf nicht 0 sein. Bitte wählen Sie einen anderen Wert.",
      genericFailureMessage:
        "Beim Aktualisieren des Tags ist ein Fehler aufgetreten, bitte versuche es erneut",
      ...
      importTagsSupportingText:
        "Kategorisiere deine Ausgaben mit einem oder mehreren Tags.",
      configureMultiLevelTags:
        "Konfiguriere deine Liste von Tags für mehrstufiges Tagging.",
      ...
      importMultiLevelTags: {
        ...
        glAdjacentColumn:
          "In der angrenzenden Spalte befindet sich ein Hauptbuchcode (GL-Code).",
      },
      tagLevel: {
      ...
      switchSingleToMultiLevelTagWarning: {
        ...
        prompt1:
          "Beim Wechseln der Tag-Ebenen werden alle aktuellen Tags gelöscht.",
      ...
      cannotMakeTagListRequired: {
        ...
        description:
          "Sie können eine Tag-Liste nur dann als erforderlich festlegen, wenn in Ihrer Richtlinie mehrere Tag-Ebenen konfiguriert sind.",
      },
      tagCount: () => ({
        one: "1 Tag",
    ...
    taxes: {
      subtitle:
        "Steuernamen und -sätze hinzufügen und Standardwerte festlegen.",
      ...
      error: {
        ...
        valuePercentageRange:
          "Bitte gib einen gültigen Prozentsatz zwischen 0 und 100 ein",
        customNameRequired: "Benutzerdefinierter Steuername ist erforderlich",
        deleteFailureMessage:
          "Beim Löschen des Steuersatzes ist ein Fehler aufgetreten. Bitte versuche es erneut oder bitte Concierge um Hilfe.",
        updateFailureMessage:
          "Beim Aktualisieren des Steuersatzes ist ein Fehler aufgetreten. Bitte versuche es erneut oder bitte Concierge um Hilfe.",
        createFailureMessage:
          "Beim Erstellen des Steuersatzes ist ein Fehler aufgetreten. Bitte versuche es erneut oder bitte Concierge um Hilfe.",
        updateTaxClaimableFailureMessage:
          "Der erstattungsfähige Anteil muss geringer sein als der Betrag des Kilometerpauschalsatzes",
      },
      deleteTaxConfirmation:
        "Sind Sie sicher, dass Sie diese Steuer löschen möchten?",
      deleteMultipleTaxConfirmation: (taxAmount: number) =>
        `Möchtest du die Steuern in Höhe von ${taxAmount} wirklich löschen?`,
      actions: {
        delete: "Satz löschen",
      ...
      importedFromAccountingSoftware:
        "Die Steuern unten werden importiert aus Ihrer",
      taxCode: "Steuerschlüssel",
      updateTaxCodeFailureMessage:
        "Beim Aktualisieren des Steuercodes ist ein Fehler aufgetreten, bitte versuche es erneut.",
    },
    duplicateWorkspace: {
      title: "Benennen Sie Ihren neuen Arbeitsbereich",
      selectFeatures: "Zu kopierende Funktionen auswählen",
      whichFeatures:
        "Welche Funktionen möchtest du in deinen neuen Arbeitsbereich übernehmen?",
      ...
      error:
        "Beim Duplizieren deines neuen Workspace ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    },
    emptyWorkspace: {
      title: "Du hast keine Arbeitsbereiche",
      subtitle:
        "Belege erfassen, Auslagen erstatten, Reisen verwalten, Rechnungen versenden und mehr.",
    ...
    new: {
      ...
      myGroupWorkspace: ({ workspaceNumber }: { workspaceNumber?: number }) =>
        `Mein Gruppen-Arbeitsbereich${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
      workspaceName: (userName: string, workspaceNumber?: number) =>
        `Workspace von ${userName}${workspaceNumber ? ` ${workspaceNumber}` : ""}`,
    },
    people: {
      genericFailureMessage:
        "Beim Entfernen eines Mitglieds aus dem Workspace ist ein Fehler aufgetreten, bitte versuche es erneut",
      ...
      removeMemberPrompt: (memberName: string) =>
        `Möchtest du ${memberName} wirklich entfernen?`,
      ...
      error: {
        genericAdd:
          "Beim Hinzufügen dieses Workspace-Mitglieds ist ein Problem aufgetreten",
        cannotRemove:
          "Du kannst dich selbst oder den/die Workspace-Inhaber:in nicht entfernen",
        genericRemove:
          "Beim Entfernen dieses Workspace-Mitglieds ist ein Problem aufgetreten",
      },
      addedWithPrimary:
        "Einige Mitglieder wurden mit ihren primären Anmeldungen hinzugefügt.",
      invitedBySecondaryLogin: (secondaryLogin: string) =>
        `Hinzugefügt durch sekundären Login ${secondaryLogin}.`,
      workspaceMembersCount: ({ count }: WorkspaceMembersCountParams) =>
        `Gesamtzahl der Workspace-Mitglieder: ${count}`,
    ...
    card: {
      ...
      issueNewCard: {
        ...
        smartLimitDescription:
          "Bis zu einem bestimmten Betrag ausgeben, bevor eine Genehmigung erforderlich ist",
        monthly: "Monatlich",
        monthlyDescription: "Bis zu einem bestimmten Betrag pro Monat ausgeben",
        fixedAmount: "Fester Betrag",
        fixedAmountDescription:
          "Bis zu einem bestimmten Betrag einmal ausgeben",
        setLimit: "Limit festlegen",
        cardLimitError:
          "Bitte gib einen Betrag ein, der kleiner als 21.474.836 $ ist",
        giveItName: "Gib ihm einen Namen",
        giveItNameInstruction:
          "Gestalte sie eindeutig genug, um sie von anderen Karten unterscheiden zu können. Konkrete Anwendungsfälle sind sogar noch besser!",
        cardName: "Kartenname",
        letsDoubleCheck:
          "Lass uns noch einmal überprüfen, ob alles richtig aussieht.",
        ...
        disabledApprovalForSmartLimitError:
          "Bitte aktivieren Sie Genehmigungen unter <strong>Workflows > Genehmigungen hinzufügen</strong>, bevor Sie Smart Limits einrichten",
        ...
        validFromTo: ({
          ...
          startDate: string;
          endDate: string;
        }) => `Gültig vom ${startDate} bis ${endDate}`,
        ...
        combineWithExpiration:
          "Mit Ablaufoptionen kombinieren für zusätzliche Ausgabenkontrolle",
        ...
        setExpiryDateDescription:
          "Die Karte läuft ab, wie auf der Karte angegeben",
        amount: "Betrag",
      },
      deactivateCardModal: {
        ...
        deactivateConfirmation:
          "Wenn du diese Karte deaktivierst, werden alle zukünftigen Transaktionen abgelehnt und dies kann nicht rückgängig gemacht werden.",
      },
    },
    accounting: {
      settings: "Einstellungen",
      title: "Verknüpfungen",
      subtitle:
        "Verbinde dein Buchhaltungssystem, um Transaktionen mit deinem Kontenrahmen zu kodieren, Zahlungen automatisch abzugleichen und deine Finanzen synchron zu halten.",
      ...
      talkYourOnboardingSpecialist:
        "Chatte mit deiner Einrichtungsexpertin/deinem Einrichtungsexperten.",
      ...
      goToODToSettings:
        "Wechsle zu Expensify Classic, um deine Einstellungen zu verwalten.",
      setup: "Verbinden",
      lastSync: (relativeDate: string) =>
        `Zuletzt synchronisiert ${relativeDate}`,
      ...
      connectTitle: ({ connectionName }: ConnectionNameParams) =>
        `${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName] ?? "Buchhaltungsintegration"} verbinden`,
      ...
      importTypes: {
        ...
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD]:
          "Als Berichtsfelder importiert",
        [CONST.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT]:
          "Standardmäßige NetSuite-Mitarbeiterperson",
      },
      disconnectPrompt: ({
        connectionName,
      }: OptionalParam<ConnectionNameParams> = {}) => {
      ...
      claimOffer: {
        ...
        xero: {
          ...
          description:
            "<muted-text><centered-text>Neu bei Xero? Expensify-Kund*innen erhalten 6 Monate kostenlos. Fordern Sie unten Ihr Angebot an.</centered-text></muted-text>",
      ...
      autoSync: "Automatische Synchronisierung",
      autoSyncDescription:
        "NetSuite und Expensify automatisch jeden Tag synchronisieren. Finalisierte Berichte in Echtzeit exportieren",
      ...
      chooseReconciliationAccount: {
        chooseBankAccount:
          "Wählen Sie das Bankkonto aus, mit dem Ihre Zahlungen mit der Expensify Karte abgeglichen werden.",
    ...
    invoices: {
      ...
      bankAccountsSubtitle:
        "Füge ein Bankkonto hinzu, um Rechnungen zu bezahlen und zu empfangen.",
    },
    invite: {
      ...
      genericFailureMessage:
        "Beim Einladen des Mitglieds in den Workspace ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    ...
    inviteMessage: {
      confirmDetails: "Details bestätigen",
      inviteMessagePrompt:
        "Machen Sie Ihre Einladung mit einer Nachricht unten noch besonderer!",
      personalMessagePrompt: "Nachricht",
      genericFailureMessage:
        "Beim Einladen des Mitglieds in den Workspace ist ein Fehler aufgetreten. Bitte versuche es erneut.",
      inviteNoMembersError:
        "Bitte wähle mindestens ein Mitglied zum Einladen aus",
      joinRequest: ({
        user,
        workspaceName,
      }: {
        user: string;
        workspaceName: string;
      }) => `${user} hat beantragt, ${workspaceName} beizutreten`,
    },
    distanceRates: {
      oopsNotSoFast: "Ups! Nicht so schnell ...",
      workspaceNeeds:
        "Ein Arbeitsbereich benötigt mindestens einen aktivierten Entfernungssatz.",
      distance: "Entfernung",
      centrallyManage:
        "Tarife zentral verwalten, in Meilen oder Kilometern nachverfolgen und eine Standardkategorie festlegen.",
      rate: "Bewerten",
      addRate: "Satz hinzufügen",
    ...
    editor: {
      ...
      nameInputHelpText:
        "Dies ist der Name, den du in deinem Arbeitsbereich siehst.",
      nameIsRequiredError: "Du musst deinem Workspace einen Namen geben",
      currencyInputLabel: "Standardwährung",
      currencyInputHelpText:
        "Alle Ausgaben in diesem Workspace werden in diese Währung umgerechnet.",
      ...
      save: "Speichern",
      genericFailureMessage:
        "Beim Aktualisieren des Arbeitsbereichs ist ein Fehler aufgetreten. Bitte versuche es erneut.",
      avatarUploadFailureMessage:
        "Beim Hochladen des Avatars ist ein Fehler aufgetreten. Bitte versuche es erneut.",
      addressContext:
        "Für die Aktivierung von Expensify Travel ist eine Workspace-Adresse erforderlich. Bitte gib eine Adresse ein, die deinem Unternehmen zugeordnet ist.",
    ...
    bankAccount: {
      ...
      connectBankAccountNote:
        "Hinweis: Private Bankkonten können nicht für Zahlungen in Arbeitsbereichen verwendet werden.",
      oneMoreThing: "Noch etwas!",
      allSet: "Alles erledigt!",
      accountDescriptionWithCards:
        "Dieses Bankkonto wird verwendet, um Firmenkarten auszugeben, Ausgaben zu erstatten, Rechnungen einzuziehen und Zahlungen zu leisten.",
      ...
      clearProgress:
        "Wenn du neu beginnst, wird dein bisheriger Fortschritt gelöscht.",
      areYouSure: "Bist du sicher?",
      ...
      chooseAnExisting:
        "Wähle ein bestehendes Bankkonto zum Bezahlen von Ausgaben oder füge ein neues hinzu.",
    },
    changeOwner: {
      changeOwnerPageTitle: "Besitz übertragen",
      addPaymentCardTitle:
        "Gib deine Zahlungskarte ein, um die Inhaberschaft zu übertragen",
      addPaymentCardButtonText:
        "Bedingungen akzeptieren & Zahlungskarte hinzufügen",
...
Wenn du die Abrechnung für das gesamte Abonnement übernehmen willst, bitte sie zuerst, dich in allen ihren Arbeitsbereichen als Admin hinzuzufügen, bevor du die Abrechnung übernimmst.`,
      ...
      failedToClearBalanceText:
        "Wir konnten den Saldo nicht ausgleichen. Bitte versuche es später noch einmal.",
      successTitle: "Juhu! Alles fertig.",
      successDescription:
        "Sie sind jetzt der/die Besitzer:in dieses Arbeitsbereichs.",
...
Möchten Sie sie wirklich noch einmal exportieren?`,
    ...
    upgrade: {
      ...
      categories: {
        title: "Kategorien",
        description:
          "Kategorien ermöglichen es dir, Ausgaben nachzuverfolgen und zu organisieren. Verwende unsere Standardkategorien oder füge deine eigenen hinzu.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
...
Fordern Sie Spesendetails wie Belege und Beschreibungen an, legen Sie Limits und Standardwerte fest und automatisieren Sie Genehmigungen und Zahlungen – alles an einem Ort.`,
      ...
      reports: {
        title: "Berichte",
        description:
          "Berichte ermöglichen es dir, Ausgaben zur einfacheren Nachverfolgung und Organisation zu gruppieren.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      distanceRates: {
        title: "Kilometersätze",
        description:
          "Erstelle und verwalte deine eigenen Sätze, verfolge Entfernungen in Meilen oder Kilometern und lege Standardkategorien für Fahrtkosten fest.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      auditor: {
        title: "Prüfer",
        description:
          "Prüfer erhalten schreibgeschützten Zugriff auf alle Berichte für vollständige Transparenz und Compliance-Überwachung.",
        onlyAvailableOnPlan: ({
          formattedPrice,
          hasTeam2025Pricing,
        }: {
      ...
      commonFeatures: {
        ...
        benefits: {
          ...
          benefit1:
            "Erweiterte Buchhaltungsverbindungen (NetSuite, Sage Intacct und mehr)",
          ...
          selectWorkspace:
            "wähle einen Workspace aus und ändere den Plantyp in",
        },
    ...
    downgrade: {
      commonFeatures: {
        ...
        benefits: {
          ...
          confirm:
            "Bist du sicher, dass du ein Downgrade durchführen und deine Konfigurationen entfernen möchtest?",
          warning: "Dies kann nicht rückgängig gemacht werden.",
          benefit1:
            "Buchhaltungsverbindungen (außer QuickBooks Online und Xero)",
          benefit2: "Intelligente Ausgabenregeln",
          benefit3: "Genehmigungs-Workflows mit mehreren Ebenen",
          benefit4: "Erweiterte Sicherheitskontrollen",
          headsUp: "Achtung!",
      ...
      completed: {
        ...
        description:
          "Sie haben andere Workspaces im Control-Tarif. Um zum Collect-Tarif abgerechnet zu werden, müssen Sie alle Workspaces herabstufen.",
        gotIt: "Verstanden, danke",
      },
    },
    payAndDowngrade: {
      ...
      description1: (formattedAmount: string) =>
        `Ihre letzte Rechnung für dieses Abonnement beträgt <strong>${formattedAmount}</strong>`,
      description2: (date: string) =>
        `Sieh dir unten deine Aufschlüsselung für den ${date} an:`,
      subscription:
      ...
      genericFailureMessage:
        "Beim Bezahlen deiner Rechnung ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    },
    restrictedAction: {
      restricted: "Eingeschränkt",
      actionsAreCurrentlyRestricted: (workspaceName: string) =>
        `Aktionen im Workspace ${workspaceName} sind derzeit eingeschränkt`,
      ...
      youWillNeedToAddOrUpdatePaymentCard:
        "Du musst die hinterlegte Zahlungskarte hinzufügen oder aktualisieren, um neue Aktivitäten im Workspace freizuschalten.",
      addPaymentCardToUnlock:
        "Füge eine Zahlungskarte hinzu, um das freizuschalten!",
      addPaymentCardToContinueUsingWorkspace:
        "Füge eine Zahlungsmethode hinzu, um diesen Workspace weiterhin zu verwenden",
      pleaseReachOutToYourWorkspaceAdmin:
        "Bitte wende dich bei Fragen an deine Workspace-Admin.",
    ...
    rules: {
      individualExpenseRules: {
        ...
        receiptRequiredAmountDescription:
          "Belege verlangen, wenn die Ausgaben diesen Betrag überschreiten, außer wenn dies durch eine Kategorienregel außer Kraft gesetzt wird.",
        receiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `Der Betrag darf den für den detaillierten Beleg erforderlichen Betrag (${amount}) nicht überschreiten`,
        itemizedReceiptRequiredAmount:
          "Erforderlicher Betrag für detaillierte Quittung",
        itemizedReceiptRequiredAmountDescription:
          "Postenweise Belege verlangen, wenn die Ausgaben diesen Betrag überschreiten, es sei denn, eine Kategorienregel hebt dies auf.",
        itemizedReceiptRequiredAmountError: ({ amount }: { amount: string }) =>
          `Der Betrag darf nicht niedriger sein als der für reguläre Belege erforderliche Betrag (${amount})`,
        maxExpenseAmount: "Maximaler Spesenbetrag",
        maxExpenseAmountDescription:
          "Kennzeichne Ausgaben, die diesen Betrag überschreiten, es sei denn, sie werden von einer Kategorienregel außer Kraft gesetzt.",
        maxAge: "Maximalalter",
        maxExpenseAge: "Maximales Spesenalter",
        maxExpenseAgeDescription:
          "Ausgaben markieren, die älter als eine bestimmte Anzahl von Tagen sind.",
        maxExpenseAgeDays: () => ({
          one: "1 Tag",
        ...
        billable: "Abrechenbar",
        billableDescription:
          "Spesen werden meist an Kund:innen weiterberechnet",
        nonBillable: "Nicht abrechenbar",
        nonBillableDescription:
          "Spesen werden gelegentlich an Kund:innen weiterberechnet",
        eReceipts: "eBelege",
        ...
        requireCompanyCardDescription:
          "Kennzeichne alle Barausgaben, einschließlich Kilometer- und Tagegeldspesen.",
        requireCompanyCardDisabledTooltip:
          "Aktiviere Firmenkarten (unter Weitere Funktionen), um dies freizuschalten.",
      },
      expenseReportRules: {
        title: "Erweitert",
        subtitle:
          "Automatisiere die Einhaltung von Spesenrichtlinien, Genehmigungen und Zahlungen.",
        preventSelfApprovalsTitle: "Selbstgenehmigungen verhindern",
        preventSelfApprovalsSubtitle:
          "Verhindere, dass Workspace-Mitglieder ihre eigenen Spesenabrechnungen genehmigen.",
        autoApproveCompliantReportsTitle:
          "Konforme Berichte automatisch genehmigen",
        autoApproveCompliantReportsSubtitle:
          "Konfiguriere, welche Spesenabrechnungen für die automatische Genehmigung infrage kommen.",
        autoApproveReportsUnderTitle:
          "Berichte automatisch genehmigen, wenn alle Ausgaben unter",
        autoApproveReportsUnderDescription:
          "Vollständig konforme Spesenabrechnungen, bei denen alle Ausgaben unter diesem Betrag liegen, werden automatisch genehmigt.",
        randomReportAuditTitle: "Stichprobenprüfung von Berichten",
        randomReportAuditDescription:
          "Verlange, dass einige Berichte manuell genehmigt werden, selbst wenn sie für die automatische Genehmigung infrage kommen.",
        autoPayApprovedReportsTitle: "Genehmigte Berichte automatisch bezahlen",
        autoPayApprovedReportsSubtitle:
          "Legen Sie fest, welche Spesenabrechnungen für die automatische Zahlung infrage kommen.",
        autoPayApprovedReportsLimitError: (currency?: string) =>
          `Bitte gib einen Betrag ein, der kleiner als ${currency ?? ""}20.000 ist`,
        autoPayApprovedReportsLockedSubtitle:
          "Gehe zu „Weitere Funktionen“ und aktiviere Workflows, dann füge Zahlungen hinzu, um diese Funktion freizuschalten.",
        autoPayReportsUnderTitle: "Berichte für automatische Bezahlung unter",
        autoPayReportsUnderDescription:
          "Vollständig konforme Spesenabrechnungen unter diesem Betrag werden automatisch bezahlt.",
        unlockFeatureEnableWorkflowsSubtitle: (featureName: string) =>
          `Füge ${featureName} hinzu, um diese Funktion freizuschalten.`,
      ...
      merchantRules: {
        title: "Händler",
        subtitle:
          "Legen Sie Händlerregeln fest, damit Spesen korrekt codiert ankommen und weniger Nachbearbeitung erfordern.",
        ...
        expensesExactlyMatching:
          "Für Ausgaben mit genau folgender Übereinstimmung:",
        ...
        previewMatchesEmptyStateSubtitle:
          "Keine nicht eingereichten Ausgaben entsprechen dieser Regel.",
        deleteRule: "Regel löschen",
        deleteRuleConfirmation:
          "Sind Sie sicher, dass Sie diese Regel löschen möchten?",
        ruleSummaryTitle: (merchantName: string, isExactMatch: boolean) =>
          `Wenn Händler ${isExactMatch ? "stimmt genau überein" : "enthält"} „${merchantName}“`,
        ruleSummarySubtitleMerchant: (merchantName: string) =>
          `Händler in „${merchantName}“ umbenennen`,
        ruleSummarySubtitleUpdateField: (
          fieldName: string,
          fieldValue: string,
        ) => `${fieldName} auf „${fieldValue}“ aktualisieren`,
        ruleSummarySubtitleReimbursable: (reimbursable: boolean) =>
          `Als „${reimbursable ? "erstattungsfähig" : "nicht erstattungsfähig"}“ markieren`,
        ruleSummarySubtitleBillable: (billable: boolean) =>
          `Als „${billable ? "verrechenbar" : "nicht abrechenbar"}“ markieren`,
        ...
        duplicateRulePrompt: (merchantName: string) =>
          `Ihre bestehende Regel für „${merchantName}“ hat Vorrang vor dieser. Trotzdem speichern?`,
        saveAnyway: "Trotzdem speichern",
        applyToExistingUnsubmittedExpenses:
          "Auf bestehende nicht eingereichte Ausgaben anwenden",
      },
      categoryRules: {
        ...
        requiredFieldsDescription: (categoryName: string) =>
          `Dies gilt für alle Ausgaben, die der Kategorie <strong>${categoryName}</strong> zugeordnet sind.`,
        ...
        flagAmountsOverDescription: (categoryName: string) =>
          `Gilt für die Kategorie „${categoryName}“.`,
        flagAmountsOverSubtitle:
          "Dadurch wird der Höchstbetrag für alle Ausgaben überschrieben.",
        expenseLimitTypes: {
          expense: "Einzelne Ausgabe",
          expenseSubtitle:
            "Betrag von Ausgaben nach Kategorie kennzeichnen. Diese Regel überschreibt die allgemeine Arbeitsbereichsregel für den maximalen Ausgabenbetrag.",
          daily: "Kategoriesumme",
          dailySubtitle:
            "Markiere die gesamte tägliche Kategorienaussage pro Spesenbericht.",
        },
        requireReceiptsOver: "Belege erforderlich über",
        requireReceiptsOverList: {
          default: (defaultAmount: string) =>
            `${defaultAmount} ${CONST.DOT_SEPARATOR} Standard`,
          never: "Belege niemals verlangen",
          always: "Belege immer erforderlich",
        },
        requireItemizedReceiptsOver:
          "Detaillierte Belege erforderlich für Beträge über",
      ...
      customRules: {
        ...
        cardSubtitle:
          "Hier ist die Spesenrichtlinie deines Teams hinterlegt, damit alle denselben Stand haben, was abgedeckt ist.",
      },
    },
    planTypePage: {
      planTypes: {
      ...
      description:
        "Wähle ein passendes Abo für dich. Eine detaillierte Liste der Funktionen und Preise findest du in unserem",
  ...
  newRoomPage: {
    ...
    restrictedDescription:
      "Personen in deinem Arbeitsbereich können diesen Raum finden",
    ...
    roomNameReservedError: (reservedName: string) =>
      `${reservedName} ist ein Standardraum in allen Arbeitsbereichen. Bitte wähle einen anderen Namen.`,
    roomNameInvalidError:
      "Raumnamen dürfen nur Kleinbuchstaben, Zahlen und Bindestriche enthalten",
    ...
    renamedRoomAction: (
      ...
      return isExpenseReport
        ? `${actor}umbenannt in „${newName}“ (zuvor „${oldName}“)`
        : `${actor}hat diesen Raum in „${newName}“ umbenannt (zuvor „${oldName}“)`;
    },
    roomRenamedTo: (newName: string) => `Raum in ${newName} umbenannt`,
    social: "sozial",
    selectAWorkspace: "Arbeitsbereich auswählen",
    growlMessageOnRenameError:
      "Arbeitsbereichsraum kann nicht umbenannt werden. Bitte überprüfe deine Verbindung und versuche es erneut.",
    visibilityOptions: {
  ...
  workspaceActions: {
    ...
    changedCompanyAddress: ({
      ...
      previousAddress
        ? `hat die Firmenadresse in „${newAddress}“ geändert (zuvor „${previousAddress}“)`
        : `Firmenadresse auf „${newAddress}“ festlegen`,
    addApprovalRule: (
    ...
    addCategory: (categoryName: string) =>
      `Kategorie „${categoryName}“ hinzugefügt`,
    deleteCategory: (categoryName: string) =>
      `hat die Kategorie „${categoryName}“ entfernt`,
    updateCategory: (categoryName: string, oldValue: boolean) =>
      `${oldValue ? "deaktiviert" : "aktiviert"} die Kategorie „${categoryName}“`,
    ...
    setCategoryName: (oldName: string, newName: string) =>
      `hat die Kategorie „${oldName}“ in „${newName}“ umbenannt`,
    ...
    updateTagListName: (oldName: string, newName: string) =>
      `hat den Schlagwortlistennamen in „${newName}“ geändert (zuvor „${oldName}“)`,
    addTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `den Tag „${tagName}“ zur Liste „${tagListName}“ hinzugefügt`,
    updateTagName: ({
      tagListName,
      newName,
      oldName,
    ...
    updateTagEnabled: ({
      ...
      `${enabled ? "aktiviert" : "deaktiviert"} das Tag „${tagName}“ in der Liste „${tagListName}“`,
    deleteTag: ({ tagListName, tagName }: UpdatedPolicyTagParams) =>
      `hat das Tag „${tagName}“ aus der Liste „${tagListName}“ entfernt`,
    deleteMultipleTags: ({ count, tagListName }: UpdatedPolicyTagParams) =>
      `„${count}“ Tags aus der Liste „${tagListName}“ entfernt`,
    updateTag: ({
      tagListName,
      newValue,
      tagName,
    ...
    updateCustomUnitTaxEnabled: ({
      ...
      `${newValue ? "aktiviert" : "deaktiviert"} Steuerverfolgung bei Entfernungsraten`,
    addCustomUnitRate: (customUnitName: string, rateName: string) =>
      `hat einen neuen ${customUnitName}-Satz „${rateName}“ hinzugefügt`,
    ...
    deleteCustomUnitRate: ({
      ...
      `hat den „${customUnitName}“-Satz „${rateName}“ entfernt`,
    addedReportField: ({
      fieldType,
      fieldName,
    }: AddedOrDeletedPolicyReportFieldParams) =>
      `${fieldType}-Berichtsfenster „${fieldName}“ hinzugefügt`,
    ...
    addedReportFieldOption: (fieldName: string, optionName: string) =>
      `die Option „${optionName}“ zum Berichtsfeld „${fieldName}“ hinzugefügt`,
    removedReportFieldOption: (fieldName: string, optionName: string) =>
      `hat die Option „${optionName}“ aus dem Berichtsfeld „${fieldName}“ entfernt`,
    ...
    deleteReportField: ({
      ...
      fieldType: string;
      fieldName?: string;
    }) => `${fieldType}-Berichts-Feld „${fieldName}“ entfernt`,
    preventSelfApproval: ({
      oldValue,
      newValue,
    }: UpdatedPolicyPreventSelfApprovalParams) =>
    ...
    renamedWorkspaceNameAction: (oldName: string, newName: string) =>
      `hat den Namen dieses Workspaces zu „${newName}“ geändert (zuvor „${oldName}“)`,
    updateDefaultReimbursable: (oldValue: string, newValue: string) =>
      `„Standard für Barausgaben“ auf „${newValue}“ aktualisiert (zuvor „${oldValue}“)`,
    updateDefaultTitleEnforced: (value: boolean) =>
      `„Standard-Berichtstitel erzwingen“ aktiviert ${value ? "an" : "aus"}`,
    ...
    updatedWorkspaceCurrencyAction: (
      ...
      `Standardwährung auf ${newCurrency} aktualisiert (zuvor ${oldCurrency})`,
    ...
    updateApprovalMode: ({ newValue, oldValue }: ChangeFieldParams) =>
      `hat den Genehmigungsmodus auf „${newValue}“ aktualisiert (zuvor „${oldValue}“)`,
    ...
    downgradedWorkspace:
      "hat diesen Workspace auf den Collect-Tarif heruntergestuft",
    ...
    updatedAttendeeTracking: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "aktiviert" : "deaktiviert"} Teilnehmenden-Tracking`,
    updatedAutoPayApprovedReports: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "aktiviert" : "deaktiviert"} automatisch bezahlte genehmigte Berichte`,
    setAutoPayApprovedReportsLimit: ({ newLimit }: { newLimit: string }) =>
      `automatisch bezahlte genehmigte Berichte auf den Schwellenwert „${newLimit}“ festlegen`,
    ...
    removedAutoPayApprovedReportsLimit:
      "den Schwellenwert für automatisch zu zahlende genehmigte Berichte entfernt",
    ...
    changedInvoiceCompanyName: ({
      ...
      oldValue
        ? `hat den Firmennamen der Rechnung in „${newValue}“ geändert (zuvor „${oldValue}“)`
        : `setze den Rechnungsfirmennamen auf „${newValue}“`,
    changedInvoiceCompanyWebsite: ({
      ...
      oldValue
        ? `hat die Unternehmenswebsite der Rechnung in „${newValue}“ geändert (zuvor „${oldValue}“)`
        : `Rechnungsunternehmens-Website auf „${newValue}“ festlegen`,
    changedReimburser: ({
      newReimburser,
      previousReimburser,
    }: UpdatedPolicyReimburserParams) =>
    ...
    updateReimbursementEnabled: ({
      ...
      `${enabled ? "aktiviert" : "deaktiviert"} Rückerstattungen`,
    updateCustomTaxName: ({
      oldName,
      newName,
    }: UpdatedPolicyCustomTaxNameParams) =>
      `benutzerdefinierten Steuernamen in „${newName}" geändert (zuvor „${oldName}")`,
    updateCurrencyDefaultTax: ({
      oldName,
      newName,
    }: UpdatedPolicyCurrencyDefaultTaxParams) =>
      `Standard-Steuerbetrag der Workspace-Währung auf „${newName}" geändert (zuvor „${oldName}")`,
    ...
    addTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `die Steuer „${taxName}" hinzugefügt`,
    deleteTax: ({ taxName }: UpdatedPolicyTaxParams) =>
      `hat die Steuer „${taxName}“ entfernt`,
    updateTax: ({
      oldValue,
      taxName,
      updatedField,
    ...
    setReceiptRequiredAmount: (newValue: string) =>
      `Belegpflichtigen Betrag auf „${newValue}“ festlegen`,
    changedReceiptRequiredAmount: (oldValue: string, newValue: string) =>
      `Belegpflichtbetrag auf „${newValue}“ geändert (zuvor „${oldValue}“)`,
    removedReceiptRequiredAmount: (oldValue: string) =>
      `Belegpflichtigen Betrag entfernt (zuvor „${oldValue}“)`,
    setMaxExpenseAmount: (newValue: string) =>
      `maximalen Ausgabenbetrag auf „${newValue}“ festlegen`,
    changedMaxExpenseAmount: (oldValue: string, newValue: string) =>
      `hat den maximalen Ausgabenbetrag auf „${newValue}“ geändert (zuvor „${oldValue}“)`,
    removedMaxExpenseAmount: (oldValue: string) =>
      `maximale Ausgabenhöhe entfernt (zuvor „${oldValue}“)`,
    setMaxExpenseAge: (newValue: string) =>
      `maximales Ausgabenalter auf „${newValue}“ Tage festlegen`,
    changedMaxExpenseAge: (oldValue: string, newValue: string) =>
      `maximales Ausgabenalter auf „${newValue}“ Tage geändert (zuvor „${oldValue}“)`,
    updateCategories: ({ count }: UpdatedPolicyCategoriesParams) =>
      `${count} Kategorien aktualisiert`,
    updateTagList: ({ tagListName }: UpdatedPolicyTagListParams) =>
      `Tags in der Liste „${tagListName}“ aktualisiert`,
    ...
    importCustomUnitRates: ({
      ...
      `importierte Preise für benutzerdefinierte Einheit „${customUnitName}“`,
    ...
    addBudget: ({
      ...
      const thresholdSuffix =
        typeof notificationThreshold === "number"
          ? `mit Benachrichtigungsschwelle von „${notificationThreshold}%“`
          : "";
    ...
    updateBudget: ({
      ...
      if (frequencyChanged) {
        changesList.push(
          `Budgetfrequenz auf „${newFrequency}“ geändert (zuvor „${oldFrequency}“)`,
        );
      }
      if (sharedChanged) {
        changesList.push(
          `hat das gesamte Arbeitsbereichsbudget auf „${newShared}“ geändert (zuvor „${oldShared}“)`,
        );
      }
      if (individualChanged) {
        changesList.push(
          `individuelles Budget auf „${newIndividual}“ geändert (zuvor „${oldIndividual}“)`,
        );
      }
      if (thresholdChanged) {
        changesList.push(
          `Benachrichtigungsschwelle auf „${newNotificationThreshold}%“ geändert (zuvor „${oldNotificationThreshold}%“)`,
        );
      }
      if (
        !frequencyChanged &&
    ...
    }) => `„${prohibitedExpense}“ zu verbotenen Ausgaben hinzugefügt`,
    removedProhibitedExpense: ({
      prohibitedExpense,
    }: {
      prohibitedExpense: string;
    }) => `„${prohibitedExpense}“ aus verbotenen Ausgaben entfernt`,
    ...
    setAutoJoin: ({ enabled }: { enabled: boolean }) =>
      `${enabled ? "aktiviert" : "deaktiviert"} Vorabgenehmigung von Arbeitsbereich-Beitrittsanfragen`,
    updatedDefaultTitle: ({
      newDefaultTitle,
      oldDefaultTitle,
    }: UpdatedPolicyDefaultTitleParams) =>
    ...
    updatedAutoHarvesting: ({ enabled }: UpdatedPolicyAutoHarvestingParams) =>
      `${enabled ? "aktiviert" : "deaktiviert"} geplante Einreichung`,
    ...
    removedMaxExpenseAge: (oldValue: string) =>
      `maximales Spesenalter entfernt (zuvor „${oldValue}“ Tage)`,
  },
  roomMembersPage: {
    memberNotFound: "Mitglied nicht gefunden.",
    useInviteButton:
      "Um ein neues Mitglied zum Chat einzuladen, verwende bitte die Einladungsschaltfläche oben.",
    ...
    removeMembersPrompt: ({ memberName }: { memberName: string }) => ({
      ...
      other:
        "Möchtest du die ausgewählten Mitglieder wirklich aus dem Raum entfernen?",
    }),
    error: {
      genericAdd:
        "Beim Hinzufügen dieses Raummitglieds ist ein Problem aufgetreten",
    },
  },
  newTaskPage: {
    assignTask: "Aufgabe zuweisen",
    ...
    pleaseEnterTaskDestination:
      "Bitte wählen Sie aus, wo Sie diese Aufgabe teilen möchten",
  },
  task: {
    task: "Aufgabe",
    title: "Titel",
    ...
    messages: {
      ...
      error:
        "Sie haben keine Berechtigung, die angeforderte Aktion auszuführen",
    },
    markAsComplete: "Als erledigt markieren",
    markAsIncomplete: "Als unvollständig markieren",
    assigneeError:
      "Beim Zuweisen dieser Aufgabe ist ein Fehler aufgetreten. Bitte versuchen Sie eine andere zuständige Person.",
    genericCreateTaskFailureMessage:
      "Beim Erstellen dieser Aufgabe ist ein Fehler aufgetreten. Bitte versuche es später erneut.",
  ...
  search: {
    ...
    searchResults: {
      ...
      emptyExpenseResults: {
        ...
        subtitle:
          "Erstelle eine Ausgabe oder mache eine Probefahrt mit Expensify, um mehr zu erfahren.",
        subtitleWithOnlyCreateButton:
          "Verwende die grüne Schaltfläche unten, um eine Ausgabe zu erstellen.",
      },
      emptyReportResults: {
        title: "Du hast noch keine Berichte erstellt",
        subtitle:
          "Erstelle einen Bericht oder mache eine Probefahrt mit Expensify, um mehr zu erfahren.",
        subtitleWithOnlyCreateButton:
          "Verwende die grüne Schaltfläche unten, um einen Bericht zu erstellen.",
      },
      emptyInvoiceResults: {
        title: dedent(`
                ...
                `),
        subtitle:
          "Sende eine Rechnung oder mache eine Probefahrt mit Expensify, um mehr zu erfahren.",
        subtitleWithOnlyCreateButton:
          "Verwende die grüne Schaltfläche unten, um eine Rechnung zu senden.",
      },
      emptyTripResults: {
    ...
    bulkActions: {
      ...
      reject: "Ablehnen",
      noOptionsAvailable:
        "Für die ausgewählte Ausgabengruppe sind keine Optionen verfügbar.",
    },
    ...
    filters: {
      ...
      amount: {
        ...
        between: (greaterThan: string, lessThan: string) =>
          `Zwischen ${greaterThan} und ${lessThan}`,
      ...
      card: {
        ...
        cardFeedNameCSV: ({ cardFeedLabel }: { cardFeedLabel?: string }) =>
          `Alle importierten CSV-Karten${cardFeedLabel ? ` - ${cardFeedLabel}` : ""}`,
      },
    ...
    exportSearchResults: {
      ...
      description:
        "Wow, das sind aber viele Elemente! Wir bündeln sie, und Concierge schickt dir in Kürze eine Datei.",
    },
  ...
  fileDownload: {
    ...
    permissionError: {
      ...
      message:
        "Expensify kann Anhänge ohne Speicherzugriff nicht speichern. Tippe auf „Einstellungen“, um die Berechtigungen zu aktualisieren.",
    },
  },
  settlement: {
    status: {
    ...
    failedError: ({ link }: { link: string }) =>
      `Wir versuchen diese Abrechnung erneut, sobald du <a href="${link}">dein Konto entsperrst</a>.`,
    withdrawalInfo: ({
      date,
      withdrawalID,
    }: {
      date: string;
      withdrawalID: number;
    }) => `${date} • Auszahlungs-ID: ${withdrawalID}`,
  },
  reportLayout: {
    reportLayout: "Berichts-Layout",
    groupByLabel: "Gruppieren nach:",
    selectGroupByOption:
      "Wähle aus, wie die Berichtsausgaben gruppiert werden sollen",
    uncategorized: "Nicht kategorisiert",
    noTag: "Kein Tag",
    selectGroup: ({ groupName }: { groupName: string }) =>
      `Alle Ausgaben in ${groupName} auswählen`,
    groupBy: {
      category: "Kategorie",
      tag: "Tag",
    },
  ...
  report: {
    ...
    genericCreateReportFailureMessage:
      "Unerwarteter Fehler beim Erstellen dieses Chats. Bitte versuchen Sie es später erneut.",
    genericAddCommentFailureMessage:
      "Unerwarteter Fehler beim Senden des Kommentars. Bitte versuche es später noch einmal.",
    genericUpdateReportFieldFailureMessage:
      "Unerwarteter Fehler beim Aktualisieren des Feldes. Bitte versuchen Sie es später noch einmal.",
    genericUpdateReportNameEditFailureMessage:
      "Unerwarteter Fehler beim Umbenennen des Berichts. Bitte versuche es später noch einmal.",
    noActivityYet: "Noch keine Aktivität",
    connectionSettings: "Verbindungseinstellungen",
    actions: {
      type: {
        changeField: ({ oldValue, newValue, fieldName }: ChangeFieldParams) =>
          `${fieldName} auf „${newValue}“ geändert (zuvor „${oldValue}“)`,
        changeFieldEmpty: ({ newValue, fieldName }: ChangeFieldParams) =>
          `setze ${fieldName} auf „${newValue}“`,
        ...
        changeType: (oldType: string, newType: string) =>
          `Typ von ${oldType} zu ${newType} geändert`,
        ...
        exportedToIntegration: {
          ...
          automaticActionOne: (label: string) =>
            `exportiert nach ${label} über`,
          automaticActionTwo: "Buchhaltungseinstellungen",
          manual: (label: string) =>
            `hat diesen Bericht als manuell nach ${label} exportiert markiert.`,
          ...
          pending: (label: string) =>
            `hat begonnen, diesen Bericht nach ${label} zu exportieren...`,
        },
        integrationsMessage: (
          errorMessage: string,
          label: string,
        ...
        markedReimbursed: (amount: string, currency: string) =>
          `hat ${currency}${amount} anderweitig bezahlt`,
        markedReimbursedFromIntegration: ({
          amount,
          currency,
        }: MarkReimbursedFromIntegrationParams) =>
          `${currency}${amount} über Integration bezahlt`,
        ...
        addEmployee: (email: string, role: string) =>
          `${email} als ${role === "member" ? "a" : "an"} ${role} hinzugefügt`,
        updateRole: ({ email, currentRole, newRole }: UpdateRoleParams) =>
          `hat die Rolle von ${email} in ${newRole} geändert (zuvor ${currentRole})`,
        updatedCustomField1: (
          email: string,
          newValue: string,
        ...
        leftWorkspace: (nameOrEmail: string) =>
          `${nameOrEmail} hat den Arbeitsbereich verlassen`,
        removeMember: (email: string, role: string) =>
          `${role} ${email} entfernt`,
        removedConnection: ({ connectionName }: ConnectionNameParams) =>
          `Verbindung zu ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]} entfernt`,
        addedConnection: ({ connectionName }: ConnectionNameParams) =>
          `verbunden mit ${CONST.POLICY.CONNECTIONS.NAME_USER_FRIENDLY[connectionName]}`,
        ...
        leftTheChatWithName: (nameOrEmail: string) =>
          `${nameOrEmail ? `${nameOrEmail}: ` : ""} hat den Chat verlassen`,
      ...
      error: {
        invalidCredentials:
          "Ungültige Anmeldedaten, bitte überprüfen Sie die Konfiguration Ihrer Verbindung.",
      },
    },
  },
  chronos: {
    oooEventSummaryFullDay: (summary: string, dayCount: number, date: string) =>
      `${summary} für ${dayCount} ${dayCount === 1 ? "Tag" : "Tage"} bis ${date}`,
    oooEventSummaryPartialDay: (
      summary: string,
      timePeriod: string,
      date: string,
    ) => `${summary} von ${timePeriod} am ${date}`,
  },
  footer: {
    features: "Funktionen",
  ...
  moderation: {
    flagDescription:
      "Alle markierten Nachrichten werden zur Überprüfung an eine Moderation gesendet.",
    ...
    inconsiderateDescription:
      "Beleidigende oder respektlose Formulierung mit fragwürdigen Absichten",
    intimidation: "Einschüchterung",
    intimidationDescription:
      "Aggressives Verfolgen einer Agenda trotz berechtigter Einwände",
    bullying: "Mobbing",
    bullyingDescription:
      "Eine einzelne Person ins Visier nehmen, um Gehorsam zu erzwingen",
    harassment: "Belästigung",
    harassmentDescription:
      "Rassistisches, frauenfeindliches oder anderweitig diskriminierendes Verhalten",
    assault: "Angriff",
    assaultDescription:
      "Gezielter emotionaler Angriff mit der Absicht, Schaden zuzufügen",
    flaggedContent:
      "Diese Nachricht wurde als Verstoß gegen unsere Community-Regeln markiert und der Inhalt wurde ausgeblendet.",
    hideMessage: "Nachricht ausblenden",
    revealMessage: "Nachricht anzeigen",
    levelOneResult:
      "Sendet anonyme Warnung und Nachricht wird zur Überprüfung gemeldet.",
    levelTwoResult:
      "Nachricht im Kanal verborgen, anonyme Warnung hinzugefügt und Nachricht zur Überprüfung gemeldet.",
    levelThreeResult:
      "Nachricht aus dem Kanal entfernt, anonyme Warnung gesendet und Nachricht zur Überprüfung gemeldet.",
  },
  ...
  teachersUnitePage: {
    ...
    getInTouch:
      "Ausgezeichnet! Bitte teile ihre Kontaktdaten, damit wir sie erreichen können.",
  ...
  distance: {
    ...
    mapPending: {
      ...
      errorSubtitle:
        "Beim Laden der Karte ist ein Fehler aufgetreten. Bitte versuche es erneut.",
    },
    error: {
      selectSuggestedAddress:
        "Bitte wählen Sie eine vorgeschlagene Adresse aus oder verwenden Sie den aktuellen Standort",
    },
    odometer: {
      ...
      startMessageWeb:
        "Füge ein Foto deines Kilometerzählers vom <strong>Beginn</strong> deiner Fahrt hinzu. Ziehe eine Datei hierher oder wähle eine zum Hochladen aus.",
      endMessageWeb:
        "Fügen Sie ein Foto Ihres Kilometerzählers vom <strong>Ende</strong> Ihrer Fahrt hinzu. Ziehen Sie eine Datei hierher oder wählen Sie eine zum Hochladen aus.",
      ...
      deleteOdometerPhotoConfirmation:
        "Möchtest du dieses Kilometerzählerfoto wirklich löschen?",
      cameraAccessRequired:
        "Für das Aufnehmen von Bildern ist der Kamerazugriff erforderlich.",
      snapPhotoStart:
        "<muted-text-label>Machen Sie zu <strong>Beginn</strong> Ihrer Fahrt ein Foto von Ihrem Kilometerzähler.</muted-text-label>",
      snapPhotoEnd:
        "<muted-text-label>Machen Sie ein Foto von Ihrem Kilometerzähler am <strong>Ende</strong> Ihrer Fahrt.</muted-text-label>",
    },
  },
  gps: {
    error: {
      ...
      failedToGetPermissions:
        "Erforderliche Standortberechtigungen konnten nicht abgerufen werden.",
    },
    ...
    discardDistanceTrackingModal: {
      ...
      prompt:
        "Bist du sicher? Dadurch wird dein aktueller Ablauf verworfen und das kann nicht rückgängig gemacht werden.",
      confirm: "Entfernungsverfolgung verwerfen",
    },
    zeroDistanceTripModal: {
      title: "Ausgabe kann nicht erstellt werden",
      prompt:
        "Sie können keine Ausgabe mit demselben Start- und Zielort erstellen.",
    },
    locationRequiredModal: {
      title: "Standortzugriff erforderlich",
      prompt:
        "Bitte erlaube den Standortzugriff in den Einstellungen deines Geräts, um die GPS‑Streckenverfolgung zu starten.",
      allow: "Zulassen",
    },
    androidBackgroundLocationRequiredModal: {
      title: "Standortzugriff im Hintergrund erforderlich",
      prompt:
        "Bitte erlaube in den Geräteeinstellungen den Zugriff auf deinen Standort im Hintergrund (Option „Immer zulassen“), um die GPS-Distanzverfolgung zu starten.",
    },
    preciseLocationRequiredModal: {
      title: "Genaue Standortangabe erforderlich",
      prompt:
        "Bitte aktiviere in den Einstellungen deines Geräts die Option „Genauer Standort“, um die GPS‑Streckenverfolgung zu starten.",
    },
    desktop: {
      title: "Strecke auf deinem Handy verfolgen",
      subtitle:
        "Streckenkilometer automatisch per GPS erfassen und Fahrten sofort in Ausgaben umwandeln.",
    ...
    continueGpsTripModal: {
      ...
      prompt:
        "Es sieht so aus, als ob die App während deiner letzten GPS-Fahrt geschlossen wurde. Möchtest du die Aufzeichnung dieser Fahrt fortsetzen?",
    ...
    signOutWarningTripInProgress: {
      title: "GPS-Tracking läuft",
      prompt:
        "Bist du sicher, dass du die Reise verwerfen und dich abmelden möchtest?",
      confirm: "Verwerfen und abmelden",
    },
    switchToODWarningTripInProgress: {
      title: "GPS-Tracking läuft",
      prompt:
        "Sind Sie sicher, dass Sie die GPS-Verfolgung beenden und zu Expensify Classic wechseln möchten?",
  ...
  reportCardLostOrDamaged: {
    ...
    confirmAddressTitle:
      "Bitte bestätigen Sie die Postanschrift für Ihre neue Karte.",
    cardDamagedInfo:
      "Ihre neue Karte kommt in 2–3 Werktagen an. Ihre aktuelle Karte funktioniert weiter, bis Sie Ihre neue Karte aktivieren.",
    cardLostOrStolenInfo:
      "Ihre aktuelle Karte wird dauerhaft deaktiviert, sobald Ihre Bestellung aufgegeben wurde. Die meisten Karten treffen innerhalb weniger Werktage ein.",
    address: "Adresse",
    ...
    successDescription:
      "Du musst sie aktivieren, sobald sie in ein paar Werktagen ankommt. In der Zwischenzeit kannst du eine virtuelle Karte verwenden.",
  },
  eReceipt: {
  ...
  referralProgram: {
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.START_CHAT]: {
      buttonText:
        "Beginne einen Chat, <success><strong>empfiehl eine:n Freund:in</strong></success>.",
    ...
    [CONST.REFERRAL_PROGRAM.CONTENT_TYPES.SUBMIT_EXPENSE]: {
      buttonText:
        "Reiche eine Ausgabe ein, <success><strong>wirb dein Team</strong></success>.",
  ...
  violations: {
    ...
    overAutoApprovalLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Ausgabe überschreitet das Auto-Genehmigungslimit von ${formattedLimit}`,
    overCategoryLimit: ({
      formattedLimit,
    }: ViolationsOverCategoryLimitParams) =>
      `Betrag über dem Kategorie-Limit von ${formattedLimit}/Person`,
    overLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Betrag über dem Limit von ${formattedLimit}/Person`,
    overTripLimit: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Betrag über dem Limit von ${formattedLimit}/Reise`,
    overLimitAttendee: ({ formattedLimit }: ViolationsOverLimitParams) =>
      `Betrag über dem Limit von ${formattedLimit}/Person`,
    perDayLimit: ({ formattedLimit }: ViolationsPerDayLimitParams) =>
      `Betrag über dem täglichen Kategorienlimit von ${formattedLimit}/Person`,
    ...
    itemizedReceiptRequired: ({
      ...
      `Einzelpostenbeleg erforderlich${formattedLimit ? `über ${formattedLimit}` : ""}`,
    prohibitedExpense: ({
    ...
    rter: ({
      ...
      if (!isTransactionOlderThan7Days) {
        return isAdmin
          ? `Bitte ${member} darum, es als Barzahlung zu markieren, oder warte 7 Tage und versuche es dann erneut`
          : "Wartet auf Abgleich mit Kartentransaktion.";
      }
      return "";
    },
    brokenConnection530Error:
      "Beleg ausstehend wegen unterbrochener Bankverbindung",
    ...
    memberBrokenConnectionError:
      "Beleg ausstehend aufgrund einer unterbrochenen Bankverbindung. Bitte wende dich an eine Workspace-Admin, um das Problem zu beheben.",
    markAsCashToIgnore:
      "Als Barzahlung markieren, um sie zu ignorieren und Zahlung anzufordern.",
    smartscanFailed: ({ canEdit = true }) =>
      `Beleg-Scan fehlgeschlagen.${canEdit ? "Details manuell eingeben." : ""}`,
    receiptGeneratedWithAI: "Mögliche KI-generierte Quittung",
    someTagLevelsRequired: ({ tagName }: ViolationsTagOutOfPolicyParams = {}) =>
      `Fehlende ${tagName ?? "Tag"}`,
    tagOutOfPolicy: ({ tagName }: ViolationsTagOutOfPolicyParams = {}) =>
      `${tagName ?? "Tag"} nicht mehr gültig`,
    taxAmountChanged: "Steuerbetrag wurde geändert",
    taxOutOfPolicy: ({ taxName }: ViolationsTaxOutOfPolicyParams = {}) =>
      `${taxName ?? "Steuer"} nicht mehr gültig`,
    ...
    descriptionToKeep:
      "Wählen Sie aus, welche Beschreibung beibehalten werden soll",
  ...
  reportViolations: {
    ...
    reportContainsExpensesWithViolations:
      "Der Bericht enthält Ausgaben mit Verstößen.",
  },
  violationDismissal: {
    rter: {
  ...
  exitSurvey: {
    ...
    reasonPage: {
      ...
      subtitle:
        "Bevor du gehst, sag uns bitte, warum du zu Expensify Classic wechseln möchtest.",
    },
    reasons: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "Ich benötige eine Funktion, die nur in Expensify Classic verfügbar ist.",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]:
        "Ich verstehe nicht, wie ich New Expensify verwenden soll.",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Ich verstehe, wie man das neue Expensify verwendet, aber ich bevorzuge das klassische Expensify.",
    },
    prompts: {
      [CONST.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE]:
        "Welche Funktion benötigen Sie, die in New Expensify noch nicht verfügbar ist?",
      [CONST.EXIT_SURVEY.REASONS.DONT_UNDERSTAND]: "Was möchten Sie tun?",
      [CONST.EXIT_SURVEY.REASONS.PREFER_CLASSIC]:
        "Warum bevorzugst du Expensify Classic?",
    },
    responsePlaceholder: "Ihre Antwort",
    thankYou: "Danke für das Feedback!",
    thankYouSubtitle:
      "Ihre Antworten helfen uns, ein besseres Produkt zu entwickeln, mit dem Sie mehr erledigen können. Vielen Dank!",
    goToExpensifyClassic: "Zu Expensify Classic wechseln",
    ...
    quickTipSubTitle:
      "Du kannst direkt zu Expensify Classic gehen, indem du expensify.com besuchst. Setze ein Lesezeichen dafür, um eine schnelle Abkürzung zu haben!",
    ...
    benefits: {
      [CONST.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY]:
        "Direktes Chatten zu Ausgaben und Berichten",
      [CONST.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE]:
        "Alles mobil erledigen können",
      [CONST.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE]:
        "Reisen und Ausgaben mit der Geschwindigkeit eines Chats",
    },
    bookACallTextTop:
      "Wenn Sie zu Expensify Classic wechseln, verzichten Sie auf Folgendes:",
    bookACallTextBottom:
  ...
  systemMessage: {
    mergedWithCashTransaction:
      "hat eine Quittung mit dieser Transaktion abgeglichen",
  },
  subscription: {
    authenticatePaymentCard: "Zahlungskarte authentifizieren",
    mobileReducedFunctionalityMessage:
      "In der mobilen App kannst du dein Abonnement nicht ändern.",
    badge: {
      freeTrial: (numOfDays: number) =>
        `Kostenlose Testversion: Noch ${numOfDays} ${numOfDays === 1 ? "Tag" : "Tage"} übrig`,
    },
    billingBanner: {
      policyOwnerAmountOwed: {
        title: "Ihre Zahlungsinformationen sind veraltet",
        subtitle: (date: string) =>
          `Aktualisiere deine Zahlungskarte bis zum ${date}, um weiterhin alle deine Lieblingsfunktionen nutzen zu können.`,
      },
      ...
      policyOwnerUnderInvoicingOverdue: {
        title: "Ihre Zahlungsinformationen sind veraltet",
        subtitle:
          "Ihre Zahlung ist überfällig. Bitte begleichen Sie Ihre Rechnung.",
      },
      ...
      preTrial: {
        ...
        subtitle:
          'Als nächsten Schritt <a href="#">schließe deine Einrichtungs-Checkliste ab</a>, damit dein Team mit der Spesenerfassung beginnen kann.',
      },
      trialStarted: {
        title: (numOfDays: number) =>
          `Testversion: Noch ${numOfDays} ${numOfDays === 1 ? "Tag" : "Tage"} übrig!`,
        subtitle:
          "Füge eine Zahlungskarte hinzu, um alle deine Lieblingsfunktionen weiterhin nutzen zu können.",
      },
      trialEnded: {
      ...
      earlyDiscount: {
        ...
        onboardingChatTitle: (discountType: number) =>
          `Zeitlich begrenztes Angebot: ${discountType}% Rabatt auf dein erstes Jahr!`,
        subtitle: (
          days: number,
          hours: number,
          minutes: number,
    ...
    cardSection: {
      title: "Zahlung",
      subtitle:
        "Füge eine Karte hinzu, um dein Expensify-Abonnement zu bezahlen.",
      addCardButton: "Zahlungskarte hinzufügen",
      cardInfo: (name: string, expiration: string, currency: string) =>
        `Name: ${name}, Ablaufdatum: ${expiration}, Währung: ${currency}`,
      cardNextPayment: (nextPaymentDate: string) =>
        `Ihr nächstes Zahlungsdatum ist der ${nextPaymentDate}.`,
    ...
    yourPlan: {
      ...
      asLowAs: ({ price }: YourPlanPriceValueParams) =>
        `schon ab ${price} pro aktivem Mitglied/Monat`,
      pricePerMemberMonth: ({ price }: YourPlanPriceValueParams) =>
        `${price} pro Mitglied/Monat`,
      pricePerMemberPerMonth: ({ price }: YourPlanPriceValueParams) =>
        `${price} pro Mitglied und Monat`,
      perMemberMonth: "pro Mitglied/Monat",
      collect: {
        title: "Einziehen",
        description:
          "Der Kleinunternehmens-Tarif, der dir Spesen, Reisen und Chat bietet.",
        priceAnnual: ({ lower, upper }: YourPlanPriceParams) =>
          `Von ${lower}/aktivem Mitglied mit der Expensify Karte, ${upper}/aktivem Mitglied ohne die Expensify Karte.`,
      ...
      saveWithExpensifyDescription:
        "Verwenden Sie unseren Einsparungsrechner, um zu sehen, wie das Cashback der Expensify Karte Ihre Expensify Rechnung reduzieren kann.",
    ...
    details: {
      ...
      zeroCommitment:
        "Keine Verpflichtung zum vergünstigten Jahresabonnementpreis",
    },
    subscriptionSize: {
      title: "Abonnementgröße",
      yourSize:
        "Die Größe Ihres Abonnements ist die Anzahl offener Plätze, die in einem bestimmten Monat von beliebigen aktiven Mitgliedern belegt werden können.",
      eachMonth:
      ...
      youCantDowngrade:
        "Sie können Ihr Jahresabonnement während der Laufzeit nicht herabstufen.",
      ...
      error: {
        ...
        sameSize:
          "Bitte gib eine andere Zahl als deine aktuelle Abonnementgröße ein",
      },
    },
    paymentCard: {
      addPaymentCard: "Zahlungskarte hinzufügen",
      ...
      security:
        "Expensify ist PCI-DSS-konform, verwendet eine Verschlüsselung auf Bankniveau und setzt redundante Infrastruktur ein, um Ihre Daten zu schützen.",
    ...
    expensifyCode: {
      ...
      enterCode:
        "Geben Sie einen Expensify-Code ein, um ihn auf Ihr Abonnement anzuwenden.",
      apply: "Anwenden",
      error: {
    ...
    subscriptionSettings: {
      ...
      saveUpTo: (amountWithCurrency: string) =>
        `Spare bis zu ${amountWithCurrency}/Monat pro aktivem Mitglied`,
      ...
      whatsMainReason:
        "Was ist der Hauptgrund, warum du die automatische Verlängerung deaktivierst?",
      renewsOn: (date: string) => `Verlängert sich am ${date}.`,
      pricingConfiguration:
        "Die Preise hängen von der Konfiguration ab. Wählen Sie für den niedrigsten Preis ein Jahresabonnement und nutzen Sie die Expensify Karte.",
      ...
      changesBasedOn:
        "Dies ändert sich basierend auf Ihrer Nutzung der Expensify Karte und den untenstehenden Abooptionen.",
    },
    requestEarlyCancellation: {
      title: "Frühzeitige Kündigung anfordern",
      subtitle:
        "Was ist der Hauptgrund, warum du eine vorzeitige Kündigung beantragst?",
  ...
  delegate: {
    ...
    membersCanAccessYourAccount:
      "Diese Mitglieder haben Zugriff auf Ihr Konto:",
    youCanAccessTheseAccounts:
      "Du kannst auf diese Konten über den Kontowechsel zugreifen:",
    ...
    genericError:
      "Ups, etwas ist schiefgelaufen. Bitte versuche es noch einmal.",
    ...
    accessLevelDescription:
      "Wähle unten eine Zugriffsstufe. Sowohl Vollzugriff als auch Eingeschränkter Zugriff ermöglichen es Copilots, alle Unterhaltungen und Ausgaben zu sehen.",
    ...
    removeCopilotConfirmation:
      "Sind Sie sicher, dass Sie diesen Copilot entfernen möchten?",
    ...
    enterMagicCodeUpdate: (contactMethod: string) =>
      `Bitte gib den magischen Code ein, der an ${contactMethod} gesendet wurde, um deinen Copilot zu aktualisieren.`,
  ...
  debug: {
    ...
    invalidProperty: ({ propertyName, expectedType }: InvalidPropertyParams) =>
      `Ungültige Eigenschaft: ${propertyName} – Erwartet: ${expectedType}`,
    invalidValue: ({ expectedValues }: InvalidValueParams) =>
      `Ungültiger Wert – erwartet: ${expectedValues}`,
    ...
    reasonVisibleInLHN: {
      ...
      hasAddWorkspaceRoomErrors:
        "Hat Fehler beim Hinzufügen des Arbeitsbereichsraums",
    ...
    reasonGBR: {
      ...
      isWaitingForAssigneeToCompleteAction:
        "Wartet darauf, dass die zuständige Person die Aktion ausführt",
      hasChildReportAwaitingAction:
        "Hat untergeordneten Bericht mit ausstehender Aktion",
      hasMissingInvoiceBankAccount:
        "Hat fehlendes Rechnungskonto für Banküberweisung",
      hasUnresolvedCardFraudAlert:
        "Hat eine nicht gelöste Kartenbetrugswarnung",
    ...
    indicatorStatus: {
      theresAReportAwaitingAction:
        "Es gibt einen Bericht, der auf eine Aktion wartet",
      theresAReportWithErrors: "Es gibt einen Bericht mit Fehlern",
      theresAWorkspaceWithCustomUnitsErrors:
        "Es gibt einen Workspace mit Fehlern bei benutzerdefinierten Einheiten",
      theresAProblemWithAWorkspaceMember:
        "Es gibt ein Problem mit einem Workspace-Mitglied",
      theresAProblemWithAWorkspaceQBOExport:
        "Es gab ein Problem mit einer Exporteinstellung für die Workspace-Verbindung.",
      theresAProblemWithAContactMethod:
        "Es gibt ein Problem mit einer Kontaktmethode",
      aContactMethodRequiresVerification:
        "Eine Kontaktmethode erfordert eine Verifizierung",
      theresAProblemWithAPaymentMethod:
        "Es gibt ein Problem mit einer Zahlungsmethode",
      theresAProblemWithAWorkspace:
        "Es gibt ein Problem mit einem Arbeitsbereich",
      theresAProblemWithYourReimbursementAccount:
        "Es gibt ein Problem mit deinem Erstattungskonto",
      theresABillingProblemWithYourSubscription:
        "Es gibt ein Abrechnungsproblem mit deinem Abonnement",
      yourSubscriptionHasBeenSuccessfullyRenewed:
        "Dein Abonnement wurde erfolgreich verlängert",
      theresWasAProblemDuringAWorkspaceConnectionSync:
        "Während der Synchronisierung der Workspace-Verbindung ist ein Problem aufgetreten",
      theresAProblemWithYourWallet: "Es gibt ein Problem mit deinem Wallet",
      theresAProblemWithYourWalletTerms:
        "Es gibt ein Problem mit deinen Wallet-Bedingungen",
    },
  },
  emptySearchView: {
  ...
  migratedUserWelcomeModal: {
    ...
    subtitle:
      "Es enthält alles, was du an unserem klassischen Erlebnis liebst, plus jede Menge Upgrades, die dein Leben noch einfacher machen:",
  ...
  productTrainingTooltip: {
    ...
    saveSearchTooltip:
      "<tooltip><strong>Benenne deine gespeicherten Suchen um</strong> – hier!</tooltip>",
    accountSwitcher:
      "<tooltip>Greifen Sie hier auf Ihre <strong>Copilot-Konten</strong> zu</tooltip>",
    scanTestTooltip: {
      main: "<tooltip><strong>Scanne unseren Testbeleg</strong>, um zu sehen, wie es funktioniert!</tooltip>",
      manager:
        "<tooltip>Wähle unseren <strong>Testmanager</strong>, um es auszuprobieren!</tooltip>",
      confirmation:
        "<tooltip>Jetzt <strong>reiche deine Ausgabe ein</strong> und sieh zu, wie die Magie passiert!</tooltip>",
      tryItOut: "Probiere es aus",
    },
    outstandingFilter:
      "<tooltip>Nach Ausgaben filtern,\ndie <strong>genehmigt werden müssen</strong></tooltip>",
    scanTestDriveTooltip:
      "<tooltip>Sende diese Quittung, um\n<strong>die Probefahrt abzuschließen!</strong></tooltip>",
    gpsTooltip:
      "<tooltip>GPS-Tracking läuft! Wenn du fertig bist, stoppe die Aufzeichnung unten.</tooltip>",
    hasFilterNegation:
      "<tooltip>Suchen Sie nach Ausgaben ohne Belege mit <strong>-has:receipt</strong>.</tooltip>",
  },
  ...
  scheduledCall: {
    book: {
      ...
      slots: ({ date }: { date: string }) =>
        `<muted-text>Verfügbare Zeiten für <strong>${date}</strong></muted-text>`,
    },
    confirmation: {
      title: "Anruf bestätigen",
      description:
        "Stell sicher, dass die Details unten für dich gut aussehen. Sobald du den Anruf bestätigst, senden wir dir eine Einladung mit weiteren Informationen.",
  ...
  autoSubmitModal: {
    ...
    submittedExpensesDescription:
      "Diese Ausgaben wurden an Ihre*n Genehmiger*in gesendet, können aber noch bearbeitet werden, bis sie genehmigt sind.",
    pendingExpensesTitle: "Ausstehende Ausgaben wurden verschoben",
    pendingExpensesDescription:
      "Alle ausstehenden Kartenausgaben wurden in einen separaten Bericht verschoben, bis sie gebucht werden.",
  },
  testDrive: {
    quickAction: {
    ...
    modal: {
      ...
      description:
        "Machen Sie eine kurze Produkttour, um sich schnell zurechtzufinden.",
      ...
      employee: {
        ...
        error:
          "Dieses Mitglied besitzt einen Arbeitsbereich, bitte gib ein neues Mitglied zum Testen ein.",
      },
    },
    banner: {
    ...
    employeeInviteMessage: (
      name: string,
    ) => `# ${name} hat dich eingeladen, Expensify zu testen
...
Hier ist ein *Testbeleg*, um dir zu zeigen, wie es funktioniert:`,
  ...
  domain: {
    ...
    verifyDomain: {
      ...
      accessYourDNS: ({ domainName }: { domainName: string }) =>
        `Greife auf deinen DNS-Anbieter zu und öffne die DNS-Einstellungen für <strong>${domainName}</strong>.`,
      addTXTRecord: "Fügen Sie den folgenden TXT-Eintrag hinzu:",
      saveChanges:
        "Änderungen speichern und hierher zurückkehren, um Ihre Domain zu verifizieren.",
      ...
      warning:
        "Nach der Verifizierung erhalten alle Expensify-Mitglieder in Ihrer Domain eine E-Mail, dass ihre Konten unter Ihrer Domain verwaltet werden.",
      codeFetchError: "Bestätigungscode konnte nicht abgerufen werden",
      genericError:
        "Wir konnten Ihre Domain nicht verifizieren. Bitte versuchen Sie es erneut und wenden Sie sich an Concierge, wenn das Problem weiterhin besteht.",
    },
    domainVerified: {
    ...
    samlLogin: {
      ...
      anyMemberWillBeRequired:
        "Alle Mitglieder, die sich mit einer anderen Methode angemeldet haben, müssen sich über SAML erneut authentifizieren.",
      enableError:
        "SAML-Aktivierungseinstellung konnte nicht aktualisiert werden",
      requireError:
        "SAML-Anforderungseinstellung konnte nicht aktualisiert werden",
      disableSamlRequired: "Deaktivierung von SAML erforderlich",
      oktaWarningPrompt:
        "Bist du sicher? Dadurch wird auch Okta SCIM deaktiviert.",
      requireWithEmptyMetadataError:
        "Bitte fügen Sie unten die Metadaten des Identitätsanbieters hinzu, um dies zu aktivieren",
    ...
    addDomain: {
      ...
      subtitle:
        "Gib den Namen der privaten Domain ein, auf die du zugreifen möchtest (z. B. expensify.com).",
    ...
    domainAdded: {
      ...
      description:
        "Als Nächstes müssen Sie den Besitz der Domain verifizieren und Ihre Sicherheitseinstellungen anpassen.",
      configure: "Konfigurieren",
    },
    enhancedSecurity: {
      title: "Erhöhte Sicherheit",
      subtitle:
        "Mitglieder Ihrer Domain verpflichten, sich über Single Sign-On anzumelden, die Erstellung von Workspaces einschränken und mehr.",
      enable: "Aktivieren",
    },
    ...
    admins: {
      ...
      setPrimaryContactError:
        "Primären Kontakt konnte nicht festgelegt werden. Bitte versuche es später erneut.",
      ...
      consolidatedDomainBillingError:
        "Die konsolidierte Domain-Abrechnung konnte nicht geändert werden. Bitte versuchen Sie es später noch einmal.",
      addAdmin: "Admin hinzufügen",
      addAdminError:
        "Dieses Mitglied kann nicht als Admin hinzugefügt werden. Bitte versuche es erneut.",
      revokeAdminAccess: "Adminzugriff widerrufen",
      cantRevokeAdminAccess:
        "Adminzugriff kann beim technischen Kontakt nicht widerrufen werden",
      error: {
        removeAdmin:
          "Dieser Benutzer kann nicht als Admin entfernt werden. Bitte versuche es erneut.",
        removeDomain:
          "Diese Domain kann nicht entfernt werden. Bitte versuche es erneut.",
        removeDomainNameInvalid:
          "Bitte geben Sie Ihren Domainnamen ein, um ihn zurückzusetzen.",
      },
      resetDomain: "Domain zurücksetzen",
      resetDomainExplanation: ({ domainName }: { domainName?: string }) =>
        `Bitte gib zur Bestätigung des Zurücksetzens der Domain <strong>${domainName}</strong> ein.`,
    ...
    members: {
      ...
      error: {
        removeMember:
          "Dieser Benutzer kann nicht entfernt werden. Bitte versuche es erneut.",
        addMember:
          "Dieses Mitglied kann nicht hinzugefügt werden. Bitte versuche es erneut.",
        vacationDelegate:
          "Dieser Benutzer kann nicht als Urlaubsvertretung festgelegt werden. Bitte versuche es erneut.",
      },
      ...
      cannotSetVacationDelegateForMember: (email: string) =>
        `Du kannst keine Urlaubsvertretung für ${email} festlegen, weil sie derzeit die Vertretung für folgende Mitglieder sind:`,
    },
    common: {
      settings: "Einstellungen",
      ...
      forceTwoFactorAuthError:
        "Die Erzwingung der Zwei-Faktor-Authentifizierung konnte nicht geändert werden. Bitte versuche es später erneut.",
  ...
  proactiveAppReview: {
    ...
    description:
      "Lass es uns wissen, damit wir dir helfen können, deine Abrechnungserfahrung noch besser zu machen.",
    positiveButton: "Ja!",
