...
${amount} für ${merchant} – ${date}`,
    ...
    onboarding: {
        ...
        peopleYouMayKnow: 'Prüfen Sie, ob Ihr Team bereits hier ist',
        workspaceYouMayJoin: (domain: string, email: string) =>
            `Bestätigen Sie Ihre E-Mail-Adresse, um zu prüfen, ob jemand von ${domain} einen Workspace hat, dem Sie beitreten können. Geben Sie den magischen Code ein, der an ${email} gesendet wurde.`,
