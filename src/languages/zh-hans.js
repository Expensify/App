...
var translations = {
    ...
    reportActionsView: {
        ...
        beginningOfChatHistoryDomainRoomPartOne: function (_a) {
            ...
            return "\u6B64\u804A\u5929\u662F\u4E0E ".concat(domainRoom, " \u57DF\u4E0A\u7684\u6240\u6709 Expensify \u6210\u5458\u8FDB\u884C\u7684\u3002");
        },
        ...
        beginningOfChatHistoryAnnounceRoomPartOne: function (_a) {
            var workspaceName = _a.workspaceName;
            return "\u6B64\u804A\u5929\u662F\u4E0E".concat(workspaceName, "\u4E2D\u7684\u6240\u6709\u4EBA\u8FDB\u884C\u7684\u3002");
        },
    ...
    iou: {
        ...
        deletedTransaction: function (_a) {
            var amount = _a.amount, merchant = _a.merchant;
            return "\u5728\u6B64\u62A5\u544A\u4E2D\u5220\u9664\u4E86\u4E00\u7B14\u8D39\u7528\uFF0C".concat(merchant, " - ").concat(amount);
        },
        ...
        settlePersonal: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "\u4EE5\u4E2A\u4EBA\u8EAB\u4EFD\u652F\u4ED8".concat(formattedAmount) : "\u4EE5\u4E2A\u4EBA\u8EAB\u4EFD\u652F\u4ED8");
        },
        ...
        settleBusiness: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "\u4EE5\u4F01\u4E1A\u8EAB\u4EFD\u652F\u4ED8".concat(formattedAmount) : "\u4EE5\u4F01\u4E1A\u8EAB\u4EFD\u652F\u4ED8");
        },
        payElsewhere: function (_a) {
            var formattedAmount = _a.formattedAmount;
            return (formattedAmount ? "\u5728\u5176\u4ED6\u5730\u65B9\u652F\u4ED8".concat(formattedAmount) : "\u5728\u5176\u4ED6\u5730\u65B9\u652F\u4ED8");
        },
        nextStep: '下一步',
        finished: '完成',
        flip: '翻转',
        ...
        waitingOnBankAccount: function (_a) {
            ...
            return "\u5F00\u59CB\u7ED3\u7B97\u3002\u5728".concat(submitterDisplayName, "\u6DFB\u52A0\u94F6\u884C\u8D26\u6237\u4E4B\u524D\uFF0C\u4ED8\u6B3E\u5C06\u88AB\u6401\u7F6E\u3002");
        },
        ...
        paidElsewhere: function (_a) {
            ...
            return "".concat(payer ? "".concat(payer, " ") : '', "\u5728\u5176\u4ED6\u5730\u65B9\u652F\u4ED8");
        },
        paidWithExpensify: function (_a) {
            var _b = _a === void 0 ? {} : _a, payer = _b.payer;
            return "".concat(payer ? "".concat(payer, " ") : '', "\u901A\u8FC7Expensify\u652F\u4ED8");
        },
    ...
    termsOfUse: {
        ...
        phrase3: '和',
        phrase4: '隐私',
        phrase5: "\u8D44\u91D1\u4F20\u8F93\u7531".concat(CONST_1.default.WALLET.PROGRAM_ISSUERS.EXPENSIFY_PAYMENTS, "\uFF08NMLS ID:2017010\uFF09\u6839\u636E\u5176\u63D0\u4F9B"),
        phrase6: '许可证',
    },
    validateCodeForm: {
    ...
    onboarding: {
        ...
        tasks: {
            ...
            setupCategoriesAndTags: {
                title: function (_a) {
                    ...
                    return "\u8BBE\u7F6E\u3010\u5206\u7C7B\u3011(".concat(workspaceCategoriesLink, ")\u548C\u3010\u6807\u7B7E\u3011(").concat(workspaceMoreFeaturesLink, ")");
                },
                description: function (_a) {
            ...
            setupTagsTask: {
                title: function (_a) {
                    ...
                    return "\u8BBE\u7F6E\u3010\u6807\u7B7E\u3011(".concat(workspaceMoreFeaturesLink, ")");
                },
                description: function (_a) {
                    var workspaceMoreFeaturesLink = _a.workspaceMoreFeaturesLink;
        ...
        messages: {
            ...
            onboardingMangeTeamMessage: function (_a) {
                ...
                return "\u4EE5\u4E0B\u662F\u6211\u4E3A\u60A8\u516C\u53F8\u8FD9\u4E2A\u89C4\u6A21\u3001\u5177\u6709 ".concat(onboardingCompanySize, " \u4E2A\u63D0\u4EA4\u4EBA\u7684\u516C\u53F8\u63A8\u8350\u7684\u4EFB\u52A1\u5217\u8868\uFF1A");
            },
    ...
    workspace: {
        ...
        qbd: {
            ...
            accounts: (_f = {},
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = '信用卡',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = '供应商账单',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = '日记条目',
                _f[CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = '检查',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CHECK, "Description")] = '我们将为每个Expensify报告创建一张分项支票，并从以下银行账户发送。',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = '我们会自动将信用卡交易中的商家名称与QuickBooks中的任何对应供应商匹配。如果没有供应商存在，我们将创建一个“信用卡杂项”供应商进行关联。',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = '我们将为每个Expensify报告创建一份逐项列出的供应商账单，其中包含最后一笔费用的日期，并将其添加到下面的账户中。如果该期间已关闭，我们将发布到下一个开放期间的第一天。',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = '选择导出信用卡交易的目的地。',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = '选择一个供应商以应用于所有信用卡交易。',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "AccountDescription")] = '选择从哪里发送支票。',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = '启用位置时，供应商账单不可用。请选择其他导出选项。',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = '启用位置时无法使用支票。请选择其他导出选项。',
                _f["".concat(CONST_1.default.QUICKBOOKS_DESKTOP_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = '启用税收时，日记分录不可用。请选择其他导出选项。',
                _f),
        ...
        qbo: {
            ...
            accounts: (_h = {},
                _h[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD] = '借记卡',
                _h[CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD] = '信用卡',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = '供应商账单',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = '日记条目',
                _h[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = '检查',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "Description")] = '我们会自动将借记卡交易中的商户名称与QuickBooks中的任何相应供应商匹配。如果不存在供应商，我们将创建一个“借记卡杂项”供应商进行关联。',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "Description")] = '我们会自动将信用卡交易中的商家名称与QuickBooks中的任何对应供应商匹配。如果没有供应商存在，我们将创建一个“信用卡杂项”供应商进行关联。',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Description")] = '我们将为每个Expensify报告创建一份逐项列出的供应商账单，其中包含最后一笔费用的日期，并将其添加到下面的账户中。如果该期间已关闭，我们将发布到下一个开放期间的第一天。',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.DEBIT_CARD, "AccountDescription")] = '选择导出借记卡交易的位置。',
                _h["".concat(CONST_1.default.QUICKBOOKS_NON_REIMBURSABLE_EXPORT_ACCOUNT_TYPE.CREDIT_CARD, "AccountDescription")] = '选择导出信用卡交易的目的地。',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "AccountDescription")] = '选择一个供应商以应用于所有信用卡交易。',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL, "Error")] = '启用位置时，供应商账单不可用。请选择其他导出选项。',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK, "Error")] = '启用位置时无法使用支票。请选择其他导出选项。',
                _h["".concat(CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY, "Error")] = '启用税收时，日记分录不可用。请选择其他导出选项。',
                _h),
            exportDestinationAccountsMisconfigurationError: (_j = {},
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = '选择一个有效的账户进行供应商账单导出',
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = '选择一个有效的账户进行日记账导出',
                _j[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = '选择一个有效的账户进行支票导出',
                _j),
            exportDestinationSetupAccountsInfo: (_k = {},
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.VENDOR_BILL] = '要使用供应商账单导出，请在QuickBooks Online中设置应付账款账户。',
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.JOURNAL_ENTRY] = '要使用分录导出，请在QuickBooks Online中设置一个分录账户。',
                _k[CONST_1.default.QUICKBOOKS_REIMBURSABLE_ACCOUNT_TYPE.CHECK] = '要使用支票导出，请在QuickBooks Online中设置一个银行账户。',
                _k),
            noAccountsFound: '未找到账户',
            ...
            accountingMethods: {
                ...
                values: (_l = {},
                    _l[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = '应计',
                    _l[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = '现金',
                    _l),
                alternateText: (_m = {},
                    _m[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.ACCRUAL] = '自付费用将在最终批准时导出',
                    _m[expensify_common_1.CONST.INTEGRATIONS.ACCOUNTING_METHOD.CASH] = '自付费用将在支付时导出',
                    _m),
            },
        },
        workspaceList: {
        ...
        xero: {
            ...
            trackingCategoriesOptions: (_o = {},
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.DEFAULT] = 'Xero 联系人默认值',
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.TAG] = '标签',
                _o[CONST_1.default.XERO_CONFIG.TRACKING_CATEGORY_OPTIONS.REPORT_FIELD] = '报告字段',
                _o),
            ...
            invoiceStatus: {
                ...
                values: (_q = {},
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.DRAFT] = '草稿',
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_APPROVAL] = '等待批准',
                    _q[CONST_1.default.XERO_CONFIG.INVOICE_STATUS.AWAITING_PAYMENT] = '等待付款',
                    _q),
            },
            noAccountsFound: '未找到账户',
        ...
        sageIntacct: {
            ...
            reimbursableExpenses: {
                ...
                values: (_s = {},
                    _s[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.EXPENSE_REPORT] = '费用报告',
                    _s[CONST_1.default.SAGE_INTACCT_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = '供应商账单',
                    _s),
            },
            nonReimbursableExpenses: {
                description: '设置公司卡购买如何导出到 Sage Intacct。',
                values: (_t = {},
                    _t[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.CREDIT_CARD_CHARGE] = '信用卡',
                    _t[CONST_1.default.SAGE_INTACCT_NON_REIMBURSABLE_EXPENSE_TYPE.VENDOR_BILL] = '供应商账单',
                    _t),
            },
            creditCardAccount: '信用卡账户',
            defaultVendor: '默认供应商',
        ...
        netsuite: {
            ...
            journalPostingPreference: {
                label: '过账偏好设置',
                values: (_u = {},
                    _u[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_INDIVIDUAL_LINE] = '每个报告的单项明细条目',
                    _u[CONST_1.default.NETSUITE_JOURNAL_POSTING_PREFERENCE.JOURNALS_POSTING_TOTAL_LINE] = '每笔费用的单项录入',
                    _u),
            },
            invoiceItem: {
                label: '发票项目',
            ...
            advancedConfig: {
                ...
                exportReportsTo: {
                    ...
                    values: (_y = {},
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_NONE] = 'NetSuite 默认偏好设置',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_SUPERVISOR_APPROVED] = '仅限主管批准',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_ACCOUNTING_APPROVED] = '仅会计批准',
                        _y[CONST_1.default.NETSUITE_REPORTS_APPROVAL_LEVEL.REPORTS_APPROVED_BOTH] = '主管和会计已批准',
                        _y),
                },
                accountingMethods: {
                    label: '何时导出',
                ...
                exportVendorBillsTo: {
                    ...
                    values: (_1 = {},
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED_NONE] = 'NetSuite 默认偏好设置',
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVAL_PENDING] = '待批准',
                        _1[CONST_1.default.NETSUITE_VENDOR_BILLS_APPROVAL_LEVEL.VENDOR_BILLS_APPROVED] = '批准发布',
                        _1),
                },
                exportJournalsTo: {
                    label: '日记分录审批级别',
                    ...
                    values: (_2 = {},
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED_NONE] = 'NetSuite 默认偏好设置',
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVAL_PENDING] = '待批准',
                        _2[CONST_1.default.NETSUITE_JOURNALS_APPROVAL_LEVEL.JOURNALS_APPROVED] = '批准发布',
                        _2),
                },
                error: {
        ...
        companyCards: {
            ...
            statementCloseDate: (_4 = {},
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_DAY_OF_MONTH] = '本月最后一天',
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.LAST_BUSINESS_DAY_OF_MONTH] = '本月最后一个工作日',
                _4[CONST_1.default.COMPANY_CARDS.STATEMENT_CLOSE_DATE.CUSTOM_DAY_OF_MONTH] = '本月自定义日期',
                _4),
            assignCard: '分配卡片',
            findCard: '查找卡片',
            cardNumber: '卡号',
        ...
        accounting: {
            ...
            importTypes: (_5 = {},
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.IMPORTED] = '已导入',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.TAG] = '导入为标签',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.DEFAULT] = '已导入',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NOT_IMPORTED] = '未导入',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NONE] = '未导入',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.REPORT_FIELD] = '作为报告字段导入',
                _5[CONST_1.default.INTEGRATION_ENTITY_MAP_TYPES.NETSUITE_DEFAULT] = 'NetSuite 员工默认值',
                _5),
        ...
        upgrade: (_6 = {
            ...
            _6.upgradeToUnlock = '解锁此功能',
            _6.completed = {
                headline: "\u60A8\u7684\u5DE5\u4F5C\u533A\u5DF2\u5347\u7EA7\uFF01",
                successMessage: function (_a) {
                    var policyName = _a.policyName;
                    return "\u60A8\u5DF2\u6210\u529F\u5C06 ".concat(policyName, " \u5347\u7EA7\u5230 Control \u8BA1\u5212\uFF01");
                },
        ...
        rules: {
            ...
            expenseReportRules: {
                ...
                unlockFeatureEnableWorkflowsSubtitle: function (_a) {
                    ...
                    return "\u5E76\u542F\u7528\u5DE5\u4F5C\u6D41\u7A0B\uFF0C\u7136\u540E\u6DFB\u52A0".concat(featureName, "\u4EE5\u89E3\u9501\u6B64\u529F\u80FD\u3002");
                },
                enableFeatureSubtitle: function (_a) {
                    var featureName = _a.featureName;
                    return "\u5E76\u542F\u7528".concat(featureName, "\u4EE5\u89E3\u9501\u6B64\u529F\u80FD\u3002");
                },
            },
            categoryRules: {
                title: '类别规则',
    ...
    search: {
        ...
        filters: {
            date: {
                ...
                presets: (_7 = {},
                    _7[CONST_1.default.SEARCH.DATE_PRESETS.NEVER] = '从未',
                    _7[CONST_1.default.SEARCH.DATE_PRESETS.LAST_MONTH] = '上个月',
                    _7),
            },
            status: '状态',
            keyword: '关键词',
        ...
        actions: {
            type: {
                ...
                changeReportPolicy: function (_a) {
                    ...
                    return "\u5C06\u5DE5\u4F5C\u533A\u66F4\u6539\u4E3A".concat(toPolicyName).concat(fromPolicyName ? "\uFF08\u4E4B\u524D\u4E3A ".concat(fromPolicyName, "\uFF09") : '');
                },
                ...
                delegateSubmit: function (_a) {
                    ...
                    return "\u7531\u4E8E".concat(originalManager, "\u6B63\u5728\u4F11\u5047\uFF0C\u5DF2\u5C06\u6B64\u62A5\u544A\u53D1\u9001\u7ED9").concat(delegateUser, "\u3002");
                },
                exportedToCSV: "\u5BFC\u51FA\u4E3ACSV",
                exportedToIntegration: {
                    automatic: function (_a) {
                        var label = _a.label;
                        return "\u5BFC\u51FA\u5230".concat(label);
                    },
    ...
    violations: {
        ...
        autoReportedRejectedExpense: function (_a) {
            ...
            return "".concat(rejectedBy, " \u62D2\u7EDD\u4E86\u6B64\u8D39\u7528\uFF0C\u5E76\u9644\u4E0A\u8BC4\u8BBA\uFF1A\u201C").concat(rejectReason, "\u201D");
        },
        ...
        receiptNotSmartScanned: '费用详情和收据已手动添加。请核实详情。<a href="https://help.expensify.com/articles/expensify-classic/reports/Automatic-Receipt-Audit">了解更多</a>关于所有收据的自动审核。',
    ...
    exitSurvey: {
        ...
        reasons: (_11 = {},
            _11[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = '我需要一个只有在 Expensify Classic 中才有的功能。',
            _11[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = '我不明白如何使用 New Expensify。',
            _11[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = '我了解如何使用 New Expensify，但我更喜欢 Expensify Classic。',
            _11),
        prompts: (_12 = {},
            _12[CONST_1.default.EXIT_SURVEY.REASONS.FEATURE_NOT_AVAILABLE] = '在 New Expensify 中，您需要哪些尚未提供的功能？',
            _12[CONST_1.default.EXIT_SURVEY.REASONS.DONT_UNDERSTAND] = '你想要做什么？',
            _12[CONST_1.default.EXIT_SURVEY.REASONS.PREFER_CLASSIC] = '您为什么更喜欢 Expensify Classic？',
            _12),
        ...
        benefits: (_13 = {},
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.CHATTING_DIRECTLY] = '直接在费用和报告上聊天',
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.EVERYTHING_MOBILE] = '能够在移动设备上完成所有操作',
            _13[CONST_1.default.EXIT_SURVEY.BENEFIT.TRAVEL_EXPENSE] = '以聊天的速度处理差旅和费用',
            _13),
        ...
        billingBanner: {
            ...
            cardAuthenticationRequired: {
                ...
                subtitle: function (_a) {
                    ...
                    return "\u60A8\u7684\u652F\u4ED8\u5361\u5C1A\u672A\u5B8C\u5168\u8BA4\u8BC1\u3002\u8BF7\u5B8C\u6210\u8BA4\u8BC1\u8FC7\u7A0B\u4EE5\u6FC0\u6D3B\u4EE5".concat(cardEnding, "\u7ED3\u5C3E\u7684\u652F\u4ED8\u5361\u3002");
                },
            },
            insufficientFunds: {
                title: '您的卡无法扣款',
    ...
    delegate: {
        ...
        notAllowedMessageEnd: function (_a) {
            ...
            return "\u5BF9\u4E8E".concat(accountOwnerEmail, "\uFF0C\u60A8\u6CA1\u6709\u6743\u9650\u6267\u884C\u6B64\u64CD\u4F5C\u3002\u62B1\u6B49\uFF01");
        },
