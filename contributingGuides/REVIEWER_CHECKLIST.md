...
- [ ] If a new page is added, I verified it's using the `ScrollView` component to make it scrollable in landscape mode or when more elements are added to the page.
