...
- [ ] I verified proper code patterns were followed (see [Reviewing the code](https://github.com/Expensify/App/blob/main/contributingGuides/PR_REVIEW_GUIDELINES.md#reviewing-the-code))
    ...
    - [ ] I verified that icons and illustrations use lazy loading (no direct imports from `@components/Icon/Illustrations` or `@components/Icon/Expensicons` unless exception is documented). See [Lazy Icons and Illustrations docs](https://github.com/Expensify/App/blob/main/docs/LAZY_ICONS_AND_ILLUSTRATIONS.md) for details.
