...
- [ ] If the PR modifies code that runs when editing or sending messages, I tested and verified there is no unexpected behavior for all types of markdown - URLs, single line code, code blocks, quotes, headings, lists (unordered and ordered), bold, underline, and italic.
