...
| `pusher_ping_pong`    | ❌ | **Deprecated.** The time it took to receive a PONG event through Pusher. The HTTP `PusherPing` heartbeat this measured was removed - the Pusher SDK already runs its own websocket connection check.<br><br>**Platforms:** All      | n/a     | n/a     |
