...
4. You can propose solutions on any issue at at any time, but if you propose solutions to jobs before the `Help Wanted` is label applied, you do so at your own risk. Proposals will not be reviewed until the label is added and there is always a chance that we might not add the label or hire an external contributor for the job.
