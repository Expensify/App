...
4. If you propose solutions to jobs without the Help Wanted label applied, know that the proposals will not be reviewed till the label is added and that we might never add the label, thus never hire a contributor
