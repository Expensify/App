...
How to propose a job in the Expensify/App repo
    ...
    4. Fill out the required fields with the details of the bug you've found or enhancement suggestion.
    5. Add the `AutoAssignerTriage` label to your issue.
    6. Submit the issue. 
    7. After the issue is submitted, add a comment to the issue with your proposed solution.
    8. Wait until a member of the Expensify team responds on your issue with next steps.
    9. Start your PR to solve the bug or enhancement. 
...
## Working on Expensify Jobs posted in Upwork
