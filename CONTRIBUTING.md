...
**Problem:** The app start up time has regressed because we introduced "Feature" in PR #12345 and is now 1042ms slower because `SomeComponent` is re-rendering 42 times.
**Solution:** Start up time will decrease by 1042ms if we prevent the re-rendering of this component.
