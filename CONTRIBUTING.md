...
## Asking Questions
If you have any general questions, please ask in the #expensify-open-source Slack channel. To request an invite to the channel, just email contributors@expensify.com with the subject `Slack Channel Invite` and well send you an invite! The Expensify team will not be able to respond to direct messages in Slack.
